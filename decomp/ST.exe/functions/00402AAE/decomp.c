...
undefined4 thunk_FUN_004e76e0(int param_1,uint *param_2,undefined1 param_3)
...
LAB_004e7823:
      ...
      if (*puVar9 != 0) {
        ...
        puStack_c = (uint *)((int)&DAT_00800bd0 + _param_3 * 5);
        do {
          iVar8 = *piVar11;
          iVar7 = 0;
          puVar3 = puVar9;
          ...
          *puStack_c = *puVar9;
          *(char *)(puStack_c + 1) = (char)puVar9[1];
          _param_3 = _param_3 + 1;
          puStack_c = (uint *)((int)puStack_c + 5);
LAB_004e789c:
