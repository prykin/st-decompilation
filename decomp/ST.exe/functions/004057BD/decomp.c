...
void thunk_FUN_00504b80(int param_1)

{
  ...
  if (iVar2 == 0) {
    ...
    thunk_FUN_00540760(*(undefined4 **)(iStack_8 + 0x194),param_1 + 5,0x65,'\x01',pbVar4);
    FUN_00710a90(*(int *)(iStack_8 + 0x194),0,param_1 + 2,0x52,0xb2,10);
    iVar11 = -1;
    iVar10 = -1;
    uVar9 = 0;
    iVar8 = -1;
