...
int thunk_FUN_0069c790(int param_1,int param_2,uint param_3,uint param_4)

{
  ...
  if (param_3 < *(uint *)(param_1 + 0xc)) {
    iStack_8 = *(int *)(param_1 + 8) * param_3 + *(int *)(param_1 + 0x1c);
  }
  else {
    iStack_8 = 0;
  }
  ...
  if ((iStack_8 != 0) && (iVar5 != 0)) {
    ...
    if (0 < (int)uVar2) {
      do {
        ...
        iVar3 = *piVar1;
        uVar2 = thunk_FUN_0069c710(param_2,iVar3,iStack_8);
        if (-1 < (int)uVar2) {
