...
uint __thiscall thunk_FUN_006001e0(void *this,int param_1)
  ...
  *(undefined2 *)(iVar5 + *(int *)((int)this + 0x233) + 0x16) =
  ...
  if (iVar2 < *(int *)(iVar5 + 0x46 + iVar3)) {
    ...
    *(undefined2 *)(iVar5 + iVar3 + 10) =
    ...
    iVar3 = thunk_FUN_005fe280(psVar1,*(int *)(DAT_00802a38 + 0xe4),(int *)auStack_c,
                               (int *)auStack_10,(int *)auStack_14);
    if (iVar3 == 0) goto LAB_0060033c;
    *(undefined2 *)(iVar5 + 6 + *(int *)((int)this + 0x233)) = auStack_c[0];
    *(undefined2 *)(iVar5 + 8 + *(int *)((int)this + 0x233)) = auStack_10[0];
    *(undefined2 *)(iVar5 + 10 + *(int *)((int)this + 0x233)) = auStack_14[0];
  }
    ...
    if (uVar4 != 5) {
      ...
      if ((*(int **)((int)this + 0x1e9) != (int *)0x0) &&
         (iVar3 = (**(code **)(**(int **)((int)this + 0x1e9) + 0xe0))
                            (*(undefined4 *)((int)this + 0x1ed),(int)&param_1 + 2,&sStack_6,
                             &sStack_8,&uStack_18), iVar3 == 0)) {
        *(int *)((int)this + 0x1f5) = (int)param_1._2_2_;
        *(int *)((int)this + 0x1f9) = (int)sStack_6;
        *(int *)((int)this + 0x1fd) = (int)sStack_8;
        *(undefined2 *)(iVar5 + 6 + *(int *)((int)this + 0x233)) =
        ...
        *(undefined4 *)((int)this + 0x1f1) = uStack_18;
        return 2;
      }
    }
