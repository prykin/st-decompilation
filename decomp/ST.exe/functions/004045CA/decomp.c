...

{
  ...
  *(undefined4 *)(pCStack_10 + 0x53eb) = *(undefined4 *)(pCStack_10 + 0x228);
  *(undefined4 *)(pCStack_10 + 0x53ef) = *(undefined4 *)(pCStack_10 + 0x22c);
  uVar8 = 0xffffffff;
  pCVar10 = pCStack_10 + 0x124;
  do {
    pCVar11 = pCVar10;
    if (uVar8 == 0) break;
    uVar8 = uVar8 - 1;
  ...
  cMf32::RecGet(*(cMf32 **)(pCStack_10 + 0x234),0xc,s_TEXTURE_DSCR_007cd130,(int *)&puStack_8,1);
  thunk_FUN_00693710(*puStack_8);
  cMf32::RecMemFree(*(cMf32 **)(pCVar3 + 0x234),(uint *)&puStack_8);
  ...
  *(int **)(pCVar3 + 8) = piVar6;
  ...
  thunk_FUN_0069ff90((int)pCVar3);
  iStack_20 = *(int *)(pCVar3 + 0x228);
  uStack_1c = *(undefined4 *)(pCVar3 + 0x22c);
  uStack_18 = 6;
  thunk_FUN_0069ff90((int)pCVar3);
  thunk_FUN_006945c0(pCVar3 + 0x1bef,&iStack_20);
  thunk_FUN_0069ff90((int)pCVar3);
