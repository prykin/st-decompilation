...

{
  ...
  if ((g_anonShape_GLOBAL_0080759C_9638EF10_0080759C != (AnonShape_GLOBAL_0080759C_9638EF10 *)0x0)
     && (param_4 != (BITMAPINFO *)0x0)) {
    local_48.previous = g_currentExceptionFrame;
    g_currentExceptionFrame = &local_48;
    errorCode = Library::MSVCRT::__setjmp3(local_48.jumpBuffer,0);
    if (errorCode == 0) {
      if (param_3 == '\x01') {
        FUN_006b48a0((int *)g_anonShape_GLOBAL_0080759C_9638EF10_0080759C,param_1,param_2,param_4,
                     (uint *)0x0,param_5);
      }
      else if (param_3 == '\x06') {
        Library::DKW::DDX::FUN_006b82e0
                  (g_anonShape_GLOBAL_0080759C_9638EF10_0080759C,param_1,param_2,(byte *)param_4,0,0
