  ...
  if (param_8 != 0) {
    ...
    if (iVar2 == 0) {
      ...
      Library::DKW::DDX::FUN_006c6470
                (param_1,(int)puStack_8 + param_4 + -0x14,param_5 + 0x11c,puStack_8 + 10,0x19,4,
                 *(undefined4 *)(DAT_0081176c + 0x140));
      Library::DKW::DDX::FUN_006c6470
                (param_1,(int)puStack_8 + param_4 + -0x12,param_5 + 0x11e,puStack_8 + 9,0x15,4,
                 *(undefined4 *)(DAT_0081176c + 0x140));
      Library::DKW::DDX::FUN_006c6470
      ...
      Library::DKW::DDX::FUN_006c6470
                (param_1,iVar2 + 0xf,param_5 + 0x157,puStack_8,0x19,4,
                 *(undefined4 *)(DAT_0081176c + 0x140));
      Library::DKW::DDX::FUN_006c6470
                (param_1,iVar2 + 0x11,param_5 + 0x159,puStack_8 + -1,0x15,4,
                 *(undefined4 *)(DAT_0081176c + 0x140));
