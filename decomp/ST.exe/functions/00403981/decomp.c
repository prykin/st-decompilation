...
void thunk_FUN_005952b0(int param_1,undefined4 param_2,undefined4 param_3,int param_4,int param_5,
...

{
  ...
  if (param_8 != 0) {
    ...
    if (iVar2 == 0) {
      ...
      thunk_FUN_00540890(0,iVar2,param_5 + 0x11a,(int)(puStack_8 + -10),0x14,puVar3,uVar5,uVar6,
                         pvVar7,uVar8);
