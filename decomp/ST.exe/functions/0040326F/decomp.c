...
undefined4 * __cdecl thunk_FUN_00540c40(void *param_1,uint *param_2,uint *param_3,int param_4)

{
  ...
  if ((param_1 != (void *)0x0) && (param_2 != (uint *)0x0)) {
    ...
    if (param_4 < iVar2) {
      if (param_3 != (uint *)0x0) {
        iStack_8 = FUN_00711110(param_1,param_3);
      }
      puVar8 = param_2;
      iVar2 = iStack_8;
      if (param_4 < iStack_8) goto LAB_00540d59;
      while (iVar2 < param_4) {
        ...
        iVar2 = iVar5 + iStack_8;
      }
      Library::MSVCRT::_strncpy((char *)&DAT_008016f0,(char *)param_2,iStack_c - 1);
      uVar3 = 0xffffffff;
      *(undefined1 *)((int)&DAT_008016ec + iStack_c + 3) = 0;
      do {
        puVar8 = param_3;
        if (uVar3 == 0) break;
        uVar3 = uVar3 - 1;
