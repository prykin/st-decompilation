...
FUN_005f23d0(void *this,int param_1,int param_2,int param_3,undefined4 param_4,int param_5,
            int param_6)
      ...
      if ((((((DAT_0080874d != -1) && (*(int *)((int)DAT_00802a88 + 0xf8) != 0)) &&
            ((thunk_FUN_00558c00(DAT_00802a88,
                                 *(Global_sub_00558C00_param_1Enum *)((int)DAT_00802a88 + 0x10c),
                                 iVar5,iVar4,&param_6,&param_3), pvVar2 = DAT_00802a88, -1 < param_6
         ...
         ((((*(int *)((int)DAT_00802a88 + 0xf8) != 0 &&
            (thunk_FUN_00558c00(DAT_00802a88,
                                *(Global_sub_00558C00_param_1Enum *)((int)DAT_00802a88 + 0x10c),
                                iVar5 + 1,param_2,&param_5,&local_10), pvVar1 = DAT_00802a88,
            -1 < param_5)) &&
           ((param_5 < *(int *)((int)pvVar2 + 0x30) &&
            (((local_10 = local_10 + DAT_0079aed0, -1 < local_10 &&
              (local_10 < *(int *)((int)pvVar2 + 0x34))) && (*(int *)((int)pvVar2 + 0x4c) != 0))))))
        ...
        iVar3 = param_1;
        pvVar2 = DAT_00802a88;
        if (((((-1 < local_14) && (local_14 < *(int *)((int)pvVar1 + 0x30))) &&
             ((local_18 = local_18 + DAT_0079aed0, iVar5 = iVar3, -1 < local_18 &&
              ((((local_18 < *(int *)((int)pvVar1 + 0x34) && (*(int *)((int)pvVar1 + 0x4c) != 0)) &&
                (*(char *)(local_18 * *(int *)((int)pvVar1 + 0x30) + *(int *)((int)pvVar1 + 0x4c) +
                          local_14) == '\0')) &&
           ...
           ((local_1c < *(int *)((int)pvVar2 + 0x34) &&
            ((*(int *)((int)pvVar2 + 0x4c) != 0 &&
             (*(char *)(local_1c * *(int *)((int)pvVar2 + 0x30) + *(int *)((int)pvVar2 + 0x4c) +
                       param_1) == '\0')))))) goto cf_common_exit_005F26AF;
      }
    }
    else {
