...
undefined4 __fastcall thunk_FUN_004d9820(int *param_1)
    ...
    if (iVar7 < param_1[0x16d] + 0xd) {
      do {
        if (((-1 < iVar7) && (iVar7 < DAT_007fb242)) &&
          ...
          do {
            if (((-1 < iVar9) && (iVar9 < sVar4)) && (iStack_8 = 0, 0 < sVar5)) {
              do {
                sVar8 = (short)iVar9;
                if ((((-1 < sVar8) && (sVar8 < sVar4)) &&
                    (((sVar6 = (short)iVar7, -1 < sVar6 &&
                      ((((sVar6 < DAT_007fb242 && (sVar2 = (short)iStack_8, -1 < sVar2)) &&
                        (sVar2 < sVar5)) &&
