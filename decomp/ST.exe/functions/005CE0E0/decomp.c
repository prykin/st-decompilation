...
LAB_005cee1a:
          ...
          case 0x1c:
            if (DAT_00808aab != *(uint *)&local_c[2].field_0x1c) {
              ...
              local_11 = !bVar28;
              thunk_FUN_00571a30((RecoveredRecordView_00571A30_BA76E758 *)&DAT_008087b6,
                                 (RecoveredRecordView_00571A30_CCE71750 *)local_c,'\x01');
              DAT_0080734b = DAT_00808aa8;
              local_34 = PTR_0080c502->count;
              local_10 = nullptr;
              if (0 < (int)local_34) {
                bVar28 = (int *)local_34 != nullptr;
                do {
                  if (bVar28) {
...
LAB_005cf387:
      ...
      case 0x1a:
        if (local_c->field_0002 == '\x04') {
          ...
          puVar26 = (byte *)(&local_c->field_0022);
          ...
          UpdatePing(this_00,local_18,*puVar26);
        }
        break;
      case 0x1d:
...
LAB_005ce59f:
      ...
      case 0x25:
        ...
        if (((3 < local_2c) && (DAT_00807361 != '\0')) && (this_00->field_2243 != '\0')) {
          pRVar2 = (RecoveredRecordView_005DE670_1BE39CFA *)this_00->array_00BC[0xc].field_01DB;
          if ((pRVar2->field_069A == (LPVOID)0x0) &&
             (thunk_FUN_005de670(pRVar2),
...
LAB_005ce8db:
                if ((pRVar10 != nullptr) &&
                  ...
                  PrepareAFT(this_00,pRVar10,(uint *)local_c);
                  bVar28 = true;
                  goto LAB_005ce8fe;
                }
                uVar20 = uVar20 + 1;
...
LAB_005cf496:
            ...
            local_38 = Library::DKW::LIB::MemAlloc(local_34);
            piVar24 = local_10;
            *local_38 = DAT_008087be;
            ...
            FUN_00715360(g_int_00811764,*local_10,'&',(char *)local_38,local_34,1,0xffffffff);
