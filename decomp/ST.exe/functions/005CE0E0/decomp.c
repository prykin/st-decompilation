...

{
  ...
  iVar4 = __setjmp3(local_144,0,unaff_EDI,unaff_ESI);
  this_00 = local_5c;
  if (iVar4 != 0) {
    DAT_00858df8 = local_148;
    iVar8 = FUN_006ad4d0(s_E____titans_Start_settmobj_cpp_007cd258,0x4a9,0,iVar4,&DAT_007a4ccc);
    if (iVar8 != 0) {
      pcVar3 = (code *)swi(3);
      uVar7 = (*pcVar3)();
      return uVar7;
    }
    FUN_006a5e40(iVar4,0,0x7cd258,0x4a9);
    return 0;
  }
