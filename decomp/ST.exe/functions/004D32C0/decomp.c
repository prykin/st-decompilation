    ...
    if ((this->field_001C & 0x4000) != 0) {
      ...
      if (iVar9 == 0x15) {
        if (((param_1->field_01F1 & 0x4000) == 0) && (param_1->field_02EC == CASE_2)) {
          puVar13 = &param_1->field_01D5;
          thunk_FUN_004abce0(puVar13,0xe,*(int *)(&DAT_0079104c + *(int *)&param_1->field_0x368 * 4)
                             ,*(int *)(&DAT_0079104c + *(int *)&param_1->field_0x368 * 4),'\0');
          STT3DSprC::SetCurFase
                    ((STT3DSprC *)puVar13,'\x0e',
                     *(uint *)(&DAT_0079104c + *(int *)&param_1->field_0x368 * 4));
          STT3DSprC::StartShow((STT3DSprC *)puVar13,0xe,g_playSystem_00802A38->field_00E4);
          STT3DSprC::sub_004ACEF0((STT3DSprC *)puVar13,DAT_008073cc);
          ...
          thunk_FUN_004abce0(puVar13,0x10,
                             *(int *)(&DAT_0079104c + *(int *)&param_1->field_0x368 * 4),
                             *(int *)(&DAT_0079104c + *(int *)&param_1->field_0x368 * 4),'\0');
          STT3DSprC::SetCurFase
                    ((STT3DSprC *)puVar13,'\x10',
                     *(uint *)(&DAT_0079104c + *(int *)&param_1->field_0x368 * 4));
          ...
          if ((*(int *)&param_1->field_0x2a8 < 100) || (param_1->field_02E8 != 0)) {
            puVar13 = &param_1->field_01D5;
            STT3DSprC::StopShow((STT3DSprC *)puVar13,0xe);
            STT3DSprC::StopShow((STT3DSprC *)puVar13,0xd);
            STT3DSprC::StopShow((STT3DSprC *)puVar13,0xc);
            STT3DSprC::StopShow((STT3DSprC *)puVar13,0x10);
            iVar12 = param_1->vfunc_08();
            if (iVar12 != 0) {
            ...
            thunk_FUN_004abce0(puVar13,0xe,uVar2,uVar2,'\0');
            STT3DSprC::SetCurFase((STT3DSprC *)puVar13,'\x0e',uVar2);
            STT3DSprC::StartShow((STT3DSprC *)puVar13,0xe,g_playSystem_00802A38->field_00E4);
            if (**(int **)&param_1->field_01F5->field_0x1d4 < (int)uVar2) {
              uVar2 = 0;
            }
            thunk_FUN_004abce0(puVar13,0xd,uVar2,uVar2,'\0');
            STT3DSprC::SetCurFase((STT3DSprC *)puVar13,'\r',uVar2);
            STT3DSprC::StartShow((STT3DSprC *)puVar13,0xd,g_playSystem_00802A38->field_00E4);
            if (*(char **)(PTR_PTR_007bb198 +
                          (*(int *)&param_1->field_0x368 * 3 + *(int *)&param_1->field_0x36c) * 0xc
                          + 8) != (char *)0x0) {
              iVar12 = STT3DSprC::LoadSequence
                                 ((STT3DSprC *)puVar13,0xc,DAT_0080678c,
                                  *(char **)(PTR_PTR_007bb198 +
                                            (*(int *)&param_1->field_0x368 * 3 +
              ...
              uVar2 = *(uint *)(PTR_DAT_007b8310 +
                               (iVar12 + (*(int *)&param_1->field_0x368 * 3 +
                                         *(int *)&param_1->field_0x36c) * 4) * 8);
              thunk_FUN_004abce0(puVar13,0xc,uVar2,uVar2,'\0');
              STT3DSprC::SetCurFase((STT3DSprC *)puVar13,'\f',uVar2);
          ...
          STT3DSprC::StopShow((STT3DSprC *)puVar13,*(byte *)&param_1->field_02F0);
          STT3DSprC::UnLoadSequence((STT3DSprC *)puVar13,*(byte *)&param_1->field_02F0);
          thunk_FUN_004ad5e0((STT3DSprC *)puVar13);
          if (*(int *)&param_1->field_0x370 != 0) {
            STT3DSprC::StopShow((STT3DSprC *)puVar13,*(char *)&param_1->field_02F0 - 1);
            STT3DSprC::UnLoadSequence((STT3DSprC *)puVar13,*(char *)&param_1->field_02F0 - 1);
          }
        }
      }
...
LAB_004d3b23:
        ...
        thunk_FUN_004abce0(puVar13,*(byte *)&param_1->field_02F0,
                           *(int *)(*(int *)&param_1->field_0x364 + iVar12 * 8),
                           *(int *)(*(int *)&param_1->field_0x364 + 4 + iVar12 * 8),'\0');
        STT3DSprC::SetCurFase
                  ((STT3DSprC *)puVar13,*(char *)&param_1->field_02F0,
                   *(uint *)(*(int *)&param_1->field_0x364 +
                            (param_1->field_02EC + param_1->field_0241 * 4) * 8));
        STT3DSprC::StartShow
                  ((STT3DSprC *)puVar13,*(byte *)&param_1->field_02F0,
                   g_playSystem_00802A38->field_00E4);
        iVar12 = param_1->field_02EC + param_1->field_0241 * 4;
        thunk_FUN_004abce0(puVar13,*(char *)&param_1->field_02F0 - 1,
                           *(int *)(*(int *)&param_1->field_0x364 + iVar12 * 8),
                           *(int *)(*(int *)&param_1->field_0x364 + 4 + iVar12 * 8),'\0');
        STT3DSprC::SetCurFase
                  ((STT3DSprC *)puVar13,*(char *)&param_1->field_02F0 + -1,
                   *(uint *)(*(int *)&param_1->field_0x364 +
                            (param_1->field_02EC + param_1->field_0241 * 4) * 8));
...
LAB_004d3f38:
              ...
              puVar13 = &param_1->field_01D5;
              thunk_FUN_004ac6b0(puVar13,*(char *)&param_1->field_02F0);
              iVar12 = param_1->field_02EC + param_1->field_0241 * 4;
              thunk_FUN_004abce0(puVar13,*(byte *)&param_1->field_02F0,
                                 *(int *)(*(int *)&param_1->field_0x364 + iVar12 * 8),
                                 *(int *)(*(int *)&param_1->field_0x364 + 4 + iVar12 * 8),'\0');
              ...
              STT3DSprC::StartShow
                        ((STT3DSprC *)puVar13,*(byte *)&param_1->field_02F0,
                         g_playSystem_00802A38->field_00E4);
              if (*(int *)&param_1->field_0x370 != 0) {
                thunk_FUN_004ac6b0(puVar13,*(char *)&param_1->field_02F0 + -1);
                iVar12 = param_1->field_02EC + param_1->field_0241 * 4;
                thunk_FUN_004abce0(puVar13,*(char *)&param_1->field_02F0 - 1,
                                   *(int *)(*(int *)&param_1->field_0x364 + iVar12 * 8),
                                   *(int *)(*(int *)&param_1->field_0x364 + 4 + iVar12 * 8),'\0');
            ...
            puVar13 = (undefined4 *)&param_1->field_0x350;
            piVar8 = (int *)&param_1->field_0x308;
            local_14 = 3;
            do {
              if (*piVar8 != 0) {
                *piVar8 = 0;
                thunk_FUN_004ad430((STT3DSprC *)*puVar13);
              }
              puVar13 = puVar13 + 1;
              piVar8 = piVar8 + 4;
              local_14 = local_14 - 1;
      ...
      case CASE_3:
        if (((param_1->field_035C->field_001C & 0x4000) == 0) &&
          ...
          *(undefined4 *)&param_1->field_0x2e0 = 1;
          uVar2 = thunk_FUN_004ac910(puVar13,*(char *)&param_1->field_02F0);
          STT3DSprC::StopShow((STT3DSprC *)puVar13,*(byte *)&param_1->field_02F0);
          STT3DSprC::UnLoadSequence((STT3DSprC *)puVar13,*(byte *)&param_1->field_02F0);
          if (*(int *)&param_1->field_0x370 != 0) {
            STT3DSprC::StopShow((STT3DSprC *)puVar13,*(char *)&param_1->field_02F0 - 1);
          ...
          STT3DSprC::UnLoadSequence((STT3DSprC *)puVar13,(byte)iVar12);
          uVar6 = param_1->field_02F4;
          iVar12 = thunk_FUN_004ad650((STT3DSprC *)puVar13);
          uVar4 = thunk_FUN_004ad650(param_1->field_035C);
          ...
          if (((iVar12 != 0x6c) || (param_1->field_0251 != 3)) &&
            ...
            if (*(int *)&param_1->field_0x370 == 0) {
              if (iVar12 == 0) {
                iVar12 = STT3DSprC::LoadSequence
                                   ((STT3DSprC *)puVar13,*(byte *)&param_1->field_02F0,DAT_0080678c,
                                    "tlo_emb2",0x1d);
                if (iVar12 != 0) {
                  iVar9 = 0x342;
...
cf_error_exit_004D428D:
            ...
            thunk_FUN_004abce0(puVar13,*(byte *)&param_1->field_02F0,
                               *(int *)(*(int *)&param_1->field_0x364 + iVar12 * 8),
                               *(int *)(*(int *)&param_1->field_0x364 + 4 + iVar12 * 8),'\0');
            STT3DSprC::SetCurFase((STT3DSprC *)puVar13,*(char *)&param_1->field_02F0,uVar2);
            STT3DSprC::StartShow
                      ((STT3DSprC *)puVar13,*(byte *)&param_1->field_02F0,
                       g_playSystem_00802A38->field_00E4);
            if (*(int *)&param_1->field_0x370 != 0) {
              ...
              thunk_FUN_004abce0(puVar13,*(char *)&param_1->field_02F0 - 1,
                                 *(int *)(*(int *)&param_1->field_0x364 + iVar12 * 8),
                                 *(int *)(*(int *)&param_1->field_0x364 + 4 + iVar12 * 8),'\0');
              STT3DSprC::SetCurFase((STT3DSprC *)puVar13,*(char *)&param_1->field_02F0 + -1,uVar2);
              cVar1 = *(char *)&param_1->field_02F0;
              uVar2 = g_playSystem_00802A38->field_00E4;
              goto LAB_004d4378;
            }
...
LAB_004d43f5:
        ...
        if (*(int *)&param_1->field_0x2b0 + uVar2 <= g_playSystem_00802A38->field_00E4) {
          ...
          *(undefined4 *)&param_1->field_0x2b4 = 1;
          ...
          if (*(int *)&param_1->field_0x2a8 < 100) {
            ...
            iVar15 = *(int *)(&DAT_007e1c50 + iVar12) - param_1->field_02D0;
            ...
            thunk_FUN_004d76e0(*(char *)&param_1->field_0024,0,param_1->field_0018,iVar9,iVar15,
                               iVar11,iVar12);
          }
        }
      }
            ...
            if (*(int *)(iVar12 + 0x210) < *(int *)(iVar12 + 0x20c)) {
              ...
              if (iVar12 + -1 == 0) {
                *piVar14 = 0;
                uVar2 = param_1->field_001C * 0x41c64e6d + 0x3039;
                param_1->field_001C = uVar2;
                piVar14[1] = (uVar2 >> 0x10) % 0x65 + 0x19 + g_playSystem_00802A38->field_00E4;
                thunk_FUN_004ad430((STT3DSprC *)*piVar8);
              }
            }
          }
  ...
  puVar13 = &param_1->field_01D5;
  iVar12 = thunk_FUN_004ac910(puVar13,'\x06');
  if ((iVar12 < *(int *)&param_1->field_01F5->field_0xec) ||
     (iVar12 = thunk_FUN_004ac910(puVar13,'\a'), iVar12 < *(int *)&param_1->field_01F5->field_0x110)
     ) {
    param_1->vfunc_D8();
    iVar12 = thunk_FUN_004ac910(puVar13,'\x06');
    if (iVar12 == 0x11) {
      ...
      if (iVar12 == 0x23) {
        ...
        iVar12 = STT3DSprC::LoadSequence((STT3DSprC *)puVar13,7,DAT_00806764,text,0x1d);
        if (iVar12 != 0) {
          return 0xffff;
        }
        STT3DSprC::StartShow((STT3DSprC *)puVar13,7,g_playSystem_00802A38->field_00E4);
      }
    }
  }
  else {
