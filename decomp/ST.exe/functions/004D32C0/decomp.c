    ...
    if ((pSVar12->field_001C & 0x4000) != 0) {
      ...
      if (iVar4 == 0x15) {
        if (((*(uint *)((int)param_1 + 0x1f1) & 0x4000) == 0) && (param_1[0xbb] == 2)) {
          ...
          STT3DSprC::SetCurFase(pSVar12,'\x0e',*(uint *)(&DAT_0079104c + param_1[0xda] * 4));
          ...
          thunk_FUN_004abce0(pSVar12,0x10,*(int *)(&DAT_0079104c + param_1[0xda] * 4),
                             *(int *)(&DAT_0079104c + param_1[0xda] * 4),'\0');
          STT3DSprC::SetCurFase(pSVar12,'\x10',*(uint *)(&DAT_0079104c + param_1[0xda] * 4));
          ...
          if ((param_1[0xaa] < 100) || (param_1[0xba] != 0)) {
            ...
            if ((*(char **)(PTR_PTR_007bb198 + (param_1[0xda] * 3 + param_1[0xdb]) * 0xc) !=
                 (char *)0x0) &&
               (iVar10 = STT3DSprC::LoadSequence
            ...
            thunk_FUN_004abce0(pSVar12,0xe,uVar2,uVar2,'\0');
            STT3DSprC::SetCurFase(pSVar12,'\x0e',uVar2);
            STT3DSprC::StartShow(pSVar12,0xe,DAT_00802a38->field_00E4);
            if (**(int **)(*(int *)((int)param_1 + 0x1f5) + 0x1d4) < (int)uVar2) {
              uVar2 = 0;
            }
            thunk_FUN_004abce0(pSVar12,0xd,uVar2,uVar2,'\0');
            STT3DSprC::SetCurFase(pSVar12,'\r',uVar2);
            STT3DSprC::StartShow(pSVar12,0xd,DAT_00802a38->field_00E4);
            if (*(char **)(PTR_PTR_007bb198 + (param_1[0xda] * 3 + param_1[0xdb]) * 0xc + 8) !=
                (char *)0x0) {
              iVar10 = STT3DSprC::LoadSequence
              ...
              uVar2 = *(uint *)(PTR_DAT_007b8310 +
                               (iVar10 + (param_1[0xda] * 3 + param_1[0xdb]) * 4) * 8);
              thunk_FUN_004abce0(pSVar12,0xc,uVar2,uVar2,'\0');
              STT3DSprC::SetCurFase(pSVar12,'\f',uVar2);
          ...
          if ((99 < param_1[0xaa]) && (param_1[0xba] == 0)) {
            ...
            STAllPlayersC::ReplaceObject
                      (g_sTAllPlayers_007FA174,
                       CONCAT31((int3)((uint)local_18 >> 8),(char)param_1[9]),
    ...
    if (*(int *)(*(int *)((int)param_1 + 0x1f5) + 0x18 + param_1[0xbc] * 0x24) ==
      ...
      case 0:
        ...
        if (*(int *)((int)param_1 + 0x241) == 0) {
          ...
          wsprintfA(local_7c,s_si_emb3_id_1d_007bf4e4,param_1[9]);
          iVar10 = STT3DSprC::LoadSequence
...
LAB_004d3b23:
            RaiseInternalException
                      (iVar10,g_overwriteContext_007ED77C,
                       s_E____titans_Artem_TLO_embryo_cpp_007bf4bc,iVar4);
          }
        }
          ...
          wsprintfA(local_7c,s_si_emb2_id_1d_007bf500,param_1[9]);
          iVar10 = STT3DSprC::LoadSequence
                             ((STT3DSprC *)((int)param_1 + 0x1d5),(-(param_1[0xdc] != 0) & 3U) + 5,
                              DAT_0080678c,local_7c,0x1d);
          if (iVar10 != 0) {
        ...
        uVar14 = DAT_00802a38->field_00E4;
LAB_004d4378:
        STT3DSprC::StartShow((STT3DSprC *)((int)param_1 + 0x1d5),cVar1 - 1,uVar14);
        break;
      case 1:
...
LAB_004d3f76:
      ...
      case 3:
        if (((*(uint *)(param_1[0xd7] + 0x1c) & 0x4000) == 0) && (param_1[0xb8] == 0)) {
          pSVar12 = (STT3DSprC *)((int)param_1 + 0x1d5);
          param_1[0xb8] = 1;
          uVar2 = thunk_FUN_004ac910(pSVar12,(char)param_1[0xbc]);
          STT3DSprC::StopShow(pSVar12,*(byte *)(param_1 + 0xbc));
          STT3DSprC::UnLoadSequence(pSVar12,*(byte *)(param_1 + 0xbc));
          if (param_1[0xdc] != 0) {
            STT3DSprC::StopShow(pSVar12,(char)param_1[0xbc] - 1);
          ...
          uVar3 = thunk_FUN_004ad650(param_1[0xd7]);
          FUN_006ea340(*(void **)((int)param_1 + 0x211),uVar3,iVar10,uVar5);
              ...
              if (iVar10 == 0) {
                ...
                if (iVar10 != 0) {
                  ...
                  goto cf_error_exit_004D428D;
                      ...
                      (iVar10 = STT3DSprC::LoadSequence
                                          (pSVar12,*(byte *)(param_1 + 0xbc),DAT_0080678c,
                                           s_tlo_emb3_007ad440,0x1d), iVar10 != 0)) {
                iVar4 = 0x343;
cf_error_exit_004D428D:
              ...
              iVar10 = STT3DSprC::LoadSequence
                                 (pSVar12,*(byte *)(param_1 + 0xbc),DAT_0080678c,s_si_emb3_007bf4f4,
                                  0x1d);
              if (iVar10 != 0) {
                RaiseInternalException
                          (iVar10,g_overwriteContext_007ED77C,
              ...
              iVar10 = STT3DSprC::LoadSequence
                                 (pSVar12,*(byte *)(param_1 + 0xbc),DAT_0080678c,s_si_emb2_007bf510,
                                  0x1d);
              if (iVar10 != 0) {
                RaiseInternalException
                          (iVar10,g_overwriteContext_007ED77C,
            ...
            thunk_FUN_004abce0(pSVar12,*(byte *)(param_1 + 0xbc),
                               *(int *)(param_1[0xd9] + iVar10 * 8),
                               *(int *)(param_1[0xd9] + 4 + iVar10 * 8),'\0');
            STT3DSprC::SetCurFase(pSVar12,(char)param_1[0xbc],uVar2);
            STT3DSprC::StartShow(pSVar12,*(byte *)(param_1 + 0xbc),DAT_00802a38->field_00E4);
            if (param_1[0xdc] != 0) {
              thunk_FUN_004ac6b0(pSVar12,(char)param_1[0xbc] + -1);
              iVar10 = param_1[0xbb] + *(int *)((int)param_1 + 0x241) * 4;
              thunk_FUN_004abce0(pSVar12,(char)param_1[0xbc] - 1,
                                 *(int *)(param_1[0xd9] + iVar10 * 8),
                                 *(int *)(param_1[0xd9] + 4 + iVar10 * 8),'\0');
              STT3DSprC::SetCurFase(pSVar12,(char)param_1[0xbc] + -1,uVar2);
              cVar1 = (char)param_1[0xbc];
              uVar14 = DAT_00802a38->field_00E4;
              goto LAB_004d4378;
            }
  ...
  if ((iVar10 < *(int *)(*(int *)((int)param_1 + 0x1f5) + 0xec)) ||
    ...
    if (iVar10 == 0x11) {
      ...
      if (iVar10 == 0x23) {
        ...
        iVar10 = STT3DSprC::LoadSequence(pSVar12,7,DAT_00806764,text,0x1d);
        if (iVar10 != 0) {
          return 0xffff;
        }
    ...
    local_30 = 0;
    local_2c = 10;
    STJellyGunC::sub_006E60A0((STJellyGunC *)param_1,local_3c);
  }
LAB_004d4d4f:
