...
void FUN_00433e90(uint *param_1,int param_2,int param_3,int param_4)
...
LAB_00434c92:
      ...
      *(undefined4 *)((int)&DAT_007f4fd3 + iVar3) = 0x19a;
      ...
      if (iVar5 < 0x19b) {
        ...
        thunk_FUN_0044b280(cVar11,1,1,puVar4,(int *)&local_8,(int *)0x0,(int *)0x0);
          ...
          if (iVar5 == 0x3c) {
            ...
            if (iVar5 < 1) {
              if (iVar5 < 0) {
                ...
                uVar6 = thunk_FUN_0044b280(cVar11,0,1,puVar4,(int *)&local_8,(int *)0x0,(int *)0x0);
