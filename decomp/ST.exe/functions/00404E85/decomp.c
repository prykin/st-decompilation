...
void __thiscall thunk_FUN_00517a50(void *this,int param_1,uint param_2,char param_3)

{
  ...
  pbStack_c = (byte *)0x0;
  pvStack_20 = this;
  pbStack_10 = (byte *)FUN_0070b3a0(*(int *)((int)this + 0x248),4);
  uVar12 = 0;
  do {
  ...
  if (pbVar13 != (byte *)0x0) {
    ...
    if (iVar3 == 0) {
      if (param_3 == '\0') {
        cVar1 = *(char *)((int)pvStack_20 + 0x1a1);
        if (((cVar1 == '\0') || (cVar1 == '\x06')) || (cVar1 == '\n')) {
          *(char *)((int)pvStack_20 + 0x1a2) = cVar1;
          *(undefined4 *)((int)pvStack_20 + 0x1ab) = *(undefined4 *)((int)pvStack_20 + 0x1a3);
        }
        else {
          *(undefined1 *)((int)pvStack_20 + 0x1a2) = 0;
          *(undefined4 *)((int)pvStack_20 + 0x1ab) = 0;
        }
        *(undefined1 *)((int)pvStack_20 + 0x1a1) = 1;
        *(int *)((int)pvStack_20 + 0x1a3) = param_1;
        *(uint *)((int)pvStack_20 + 0x1a7) = param_2;
        *(undefined2 *)((int)pvStack_20 + 0x1af) = 0x32;
        *(undefined2 *)((int)pvStack_20 + 0x1b1) = 5;
        if (*(int *)((int)pvStack_20 + 0x178) != 0) {
          *(undefined4 *)((int)pvStack_20 + 0x28) = 0x4202;
          *(undefined2 *)((int)pvStack_20 + 0x2c) = 0;
          *(undefined2 *)((int)pvStack_20 + 0x2e) = 2;
          *(int *)((int)pvStack_20 + 0x30) = *(int *)((int)pvStack_20 + 0x178);
          if (DAT_00802a30 != (undefined4 *)0x0) {
            (**(code **)*DAT_00802a30)((int)pvStack_20 + 0x18);
          }
        }
      }
      ...
      bVar15 = (byte)param_2;
      thunk_FUN_00515650(&iStack_8,param_1,bVar15,0);
      FUN_00710a90(*(int *)((int)this_00 + 0x218),0,0,iStack_8,200,0xf);
      uVar17 = 3;
      iVar16 = -1;
      iVar3 = -3;
      puVar5 = (uint *)FUN_006b0140(0x5627,DAT_00807618);
      FUN_007119c0(puVar5,iVar3,iVar16,uVar17);
      FUN_00710a90(*(int *)((int)this_00 + 0x218),0,0xcd,iStack_8,0xcf,0xf);
      pbVar13 = pbStack_c;
      uVar9 = (DAT_0080874e != '\x03') - 1 & 5;
      iVar16 = -1;
      iVar3 = 1;
      puVar5 = (uint *)FUN_006b0140(*(UINT *)(pbStack_c + 5),DAT_00807618);
      ...
      pbVar7 = pbStack_c;
      iStack_8 = iStack_8 + 0xf;
      uVar9 = thunk_FUN_00526ba0(*(undefined4 *)(pbStack_c + 9),*pbStack_c);
      pbVar13 = (byte *)FUN_0070b3a0(*(int *)((int)this_00 + 0x240),uVar9);
      thunk_FUN_00540760(*(undefined4 **)((int)this_00 + 0x218),0xcd,iStack_8,'\x01',pbVar13);
      pbVar13 = pbStack_10;
      thunk_FUN_00540760(*(undefined4 **)((int)this_00 + 0x218),0xcb,iStack_8 + -2,'\x06',pbStack_10
                        );
      uStack_3c = 0xcb;
      ...
      uStack_2c = 2;
      uStack_2b = *(undefined4 *)(pbVar7 + 9);
      uStack_27 = param_2;
      FUN_006ae1c0(*(uint **)((int)this_00 + 0x1d7),&uStack_3c);
      ...
      if (*(int *)(pbVar7 + 0xd) != 0) {
        ...
        pbVar7 = pbStack_c;
        iStack_8 = iStack_8 + 0xf;
        uVar9 = thunk_FUN_00526ba0(*(undefined4 *)(pbStack_c + 0xd),*pbStack_c);
        pbVar13 = (byte *)FUN_0070b3a0(*(int *)((int)this_00 + 0x23c),uVar9);
        thunk_FUN_00540760(*(undefined4 **)((int)this_00 + 0x218),0xcd,iStack_8,'\x01',pbVar13);
        pbVar13 = pbStack_10;
        thunk_FUN_00540760(*(undefined4 **)((int)this_00 + 0x218),0xcd,iStack_8,'\x06',pbStack_10);
        uStack_3c = 0xcd;
        uStack_34 = *(undefined4 *)(pbVar13 + 4);
        iStack_38 = iStack_8;
        uStack_30 = *(undefined4 *)(pbVar13 + 8);
        uStack_2c = 3;
        uStack_2b = *(undefined4 *)(pbVar7 + 0xd);
        uStack_27 = (uint)*pbVar7;
        FUN_006ae1c0(*(uint **)((int)this_00 + 0x1d7),&uStack_3c);
        iStack_8 = iStack_8 + *(int *)(pbVar13 + 8);
      }
      FUN_00710a90(*(int *)((int)this_00 + 0x218),0,0,iStack_8,200,0xf);
      ...
      do {
        ...
        if (*(int *)pbVar13 != 0) {
          ...
          pbVar13 = pbStack_14;
          iStack_8 = iStack_8 + 0xf;
          uVar11 = thunk_FUN_00526ba0(*(undefined4 *)pbStack_14,*pbStack_c);
          pbVar7 = (byte *)FUN_0070b3a0(*(int *)((int)this_00 + 0x240),uVar11);
          thunk_FUN_00540760(*(undefined4 **)((int)this_00 + 0x218),0xcd,iStack_8,'\x01',pbVar7);
          pbVar7 = pbStack_10;
          thunk_FUN_00540760(*(undefined4 **)((int)this_00 + 0x218),0xcb,iStack_8 + -2,'\x06',
                             pbStack_10);
          uStack_3c = 0xcb;
          uStack_34 = *(undefined4 *)(pbVar7 + 4);
          iStack_38 = iStack_8 + -2;
          uStack_30 = *(undefined4 *)(pbVar7 + 8);
          uStack_2c = 2;
          ...
          iVar16 = -1;
          iVar3 = 1;
          puVar5 = (uint *)FUN_006b0140((-(uint)(*pbStack_18 != 0) & 0xffffffef) + 0x5641,
                                        DAT_00807618);
      ...
      thunk_FUN_00511ab0(this_00,iStack_8,uVar9);
      uVar10 = uVar9 & 0xffff;
      FUN_00710a90(*(int *)((int)this_00 + 0x218),0,0xcd,iStack_8,0xcf,uVar10 + 2);
      ...
      iVar16 = -1;
      iVar3 = 1;
      puVar5 = (uint *)FUN_006b0140(0x273f - (*(int *)(pbStack_c + 0x1f) != 0),DAT_00807618);
      FUN_007119c0(puVar5,iVar3,iVar16,uVar9);
      iStack_8 = iStack_8 + 0xf;
      if (*(int *)(pbVar13 + 0x1f) != 0) {
        thunk_FUN_00511ab0(this_00,iStack_8,0xf);
        FUN_00710a90(*(int *)((int)this_00 + 0x218),0,0,iStack_8,200,0xf);
        uVar17 = 3;
        iVar16 = -1;
        iVar3 = -3;
        ...
        pbVar7 = pbStack_10;
        iStack_8 = iStack_8 + 0xf;
        thunk_FUN_00511ab0(this_00,iStack_8,CONCAT22(extraout_var,*(undefined2 *)(pbStack_10 + 8)));
        pbVar13 = pbStack_c;
        uVar9 = thunk_FUN_00526ba0(*(undefined4 *)(pbStack_c + 0x1f),*pbStack_c);
        pbVar8 = (byte *)FUN_0070b3a0(*(int *)((int)this_00 + 0x23c),uVar9);
        thunk_FUN_00540760(*(undefined4 **)((int)this_00 + 0x218),0xcd,iStack_8,'\x01',pbVar8);
        thunk_FUN_00540760(*(undefined4 **)((int)this_00 + 0x218),0xcd,iStack_8,'\x06',pbVar7);
        uStack_3c = 0xcd;
        uStack_34 = *(undefined4 *)(pbVar7 + 4);
        iStack_38 = iStack_8;
        uStack_30 = *(undefined4 *)(pbVar7 + 8);
      ...
      if (*(int *)(pbVar13 + 0x23) != 0) {
        ...
        thunk_FUN_00511ab0(this_00,iStack_8,CONCAT22(extraout_var_00,*(undefined2 *)(iVar3 + 8)));
        pbVar7 = pbStack_c;
        uVar9 = thunk_FUN_00526ba0(*(undefined4 *)(pbStack_c + 0x23),*pbStack_c);
        pbVar13 = (byte *)FUN_0070b3a0(*(int *)((int)this_00 + 0x240),uVar9);
        thunk_FUN_00540760(*(undefined4 **)((int)this_00 + 0x218),0xcd,iStack_8,'\x01',pbVar13);
        pbVar13 = pbStack_10;
        thunk_FUN_00540760(*(undefined4 **)((int)this_00 + 0x218),0xcb,iStack_8 + -2,'\x06',
        ...
        uStack_30 = *(undefined4 *)(pbVar13 + 8);
        uStack_2c = 2;
        uStack_2b = *(undefined4 *)(pbVar7 + 0x23);
        uStack_27 = (uint)*pbVar7;
        FUN_006ae1c0(*(uint **)((int)this_00 + 0x1d7),&uStack_3c);
        iStack_8 = iStack_8 + *(int *)(pbVar13 + 8);
      }
      thunk_FUN_00515e30(this_00,&iStack_8,'\x01',param_1,param_2);
