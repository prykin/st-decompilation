...
int FUN_0044ab90(undefined4 param_1,uint param_2,int param_3,char param_4,uint *param_5,
                undefined4 param_6)

{
  ...
  if (param_2 == 0) {
    ...
    if (param_2 != 1) {
      iVar2 = FUN_006ad4d0(s_E____titans_wlad_to_allpl_cpp_007a6004,0x2fde,0,0,&DAT_007a4ccc);
      if (iVar2 == 0) {
        return -1;
      }
      pcVar1 = (code *)swi(3);
...
LAB_0044ac57:
    ...
    param_2 = uVar5;
    FUN_006afe40((int *)&local_c,param_5);
    if (0 < (int)uVar5) {
      do {
        FUN_006acc70((int)local_c,uVar6,(undefined4 *)((int)&param_6 + 2));
        if (param_6._2_2_ == -1) {
      ...
      if (uVar5 != 0) {
        ...
        do {
          if (((*(int *)((int)piVar3 + -10) == iVar2) &&
            ...
            FUN_006afe40((int *)&local_10,puVar4);
            FUN_006afe40((int *)&local_8,(uint *)*piVar3);
            uVar6 = 0;
            if (0 < iVar7) {
              do {
                FUN_006acc70((int)local_8,uVar6,(undefined4 *)((int)&param_1 + 2));
                if (param_1._2_2_ == -1) {
                  FUN_006b0c70((int)local_8,uVar6);
                  iVar7 = iVar7 + -1;
                  uVar6 = uVar6 - 1;
                }
                uVar6 = uVar6 + 1;
...
LAB_0044ae21:
  iVar2 = FUN_006ad4d0(s_E____titans_wlad_to_allpl_cpp_007a6004,0x3019,0,0,&DAT_007a4ccc);
  if (iVar2 == 0) {
    return -1;
  }
  pcVar1 = (code *)swi(3);
