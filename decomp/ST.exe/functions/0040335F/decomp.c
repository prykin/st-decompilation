...
undefined4 * thunk_FUN_005f1e40(int param_1,int param_2,int param_3,int param_4,int param_5)

{
  ...
  if (param_1 == 0) {
    puVar2 = FUN_006e9000(DAT_00807598,**(undefined4 **)((int)puVar1 + 0x21),0x5a,0x35,
  ...
  puVar2 = FUN_006e9000(DAT_00807598,**(undefined4 **)((int)puVar1 + 0x21),0x78,0x56,
