...

{
  ...
  if (iVar3 == 0) {
    ...
    pRVar4_mg0 = FUN_0070b3a0((RecoveredGlobalRecordView_0081175C *)pCVar2->field_02D2,
                              (uint)local_c & 0xff);
    /* ST_CALLSITE[00504545]: CALL 0x00403229; direct=00403229 DibPut */
    DibPut((RecoveredSourceFamily_dibcopy *)pCVar2->field_0194,param_1 + 3,0x53,'\x01',pRVar4_mg0);
    if (pCVar2->field_0BF5 == CASE_38) {
    ...
    pcVar4 = LoadResourceString(0x2721,g_hINSTANCE_00807618);
    Library::MSVCRT::_strncpy(_Dest,pcVar4,_Count);
    ...
    pcVar4 = LoadResourceString(local_8,g_hINSTANCE_00807618);
    ...
    pRVar6 = ccFntTy::CreateSurf(pCVar2->field_01C4,pCVar2->field_0194,0,iVar3,0x6d,0x75,0xe,0);
    if (pRVar6 != nullptr) {
      ...
      DibPut((RecoveredSourceFamily_dibcopy *)pCVar2->field_0194,iVar3,0x6f,'\x01',pRVar6);
