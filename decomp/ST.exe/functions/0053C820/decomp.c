...
void __thiscall
ResearchPanelTy::PaintUpdBut(ResearchPanelTy *this,RecoveredRecordView_004EF320_A54422CD *param_1)

{
  ...
  if (iVar5 == 0) {
    if ((local_8 == nullptr) || (local_8[8] == CASE_0)) {
      pRVar9 = (RecoveredGlobalRecordView_0081175C *)local_10->field_018C;
    }
    else {
      pRVar9 = (RecoveredGlobalRecordView_0081175C *)local_10->field_0188;
    }
    ...
    pBVar8 = FUN_0070b3a0(pRVar9,local_c);
    iVar6 = local_14;
    iVar3 = local_18;
    ...
    if ((param_1->field_0014 == 3) && (local_8 != nullptr)) {
      ...
      DibPut((RecoveredSourceFamily_dibcopy *)pRVar7->field_0068,iVar3,iVar6,'\x06',
             (RecoveredRecordView_006B84D0_87AF9D9B *)pBVar8);
    }
