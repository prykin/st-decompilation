...

{
  ...
  local_8 = iVar4;
  iVar3 = thunk_FUN_005ff3a0(this,&local_1c,&sStack_1a,&sStack_18);
  iVar5 = param_2;
  if (iVar3 == 0) {
  ...
  while( true ) {
    ...
    if (((iVar4 != 0) &&
        (iVar4 = thunk_FUN_005fe360((short *)(*(int *)((int)this + 0x233) + param_1 * 0x52),
                                    (int)local_1c,(int)sStack_1a,sStack_18,(int)local_14,
                                    (int)local_12,local_10[0]), -1 < iVar4)) &&
       (bVar2 = thunk_FUN_005fe5d0(this,param_1,&local_1c,(int)&local_14),
