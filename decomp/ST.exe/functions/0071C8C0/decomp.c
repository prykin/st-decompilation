...

{
  ...
  iVar2 = __setjmp3(local_5c,0,unaff_ESI,unaff_EBX);
  if (iVar2 != 0) {
    DAT_00858df8 = (undefined4 *)local_60;
    iVar4 = FUN_006ad4d0(s_E__Ourlib_Sinput_cpp_007f092c,0x280,0,iVar2,&DAT_007a4ccc);
    if (iVar4 != 0) {
      pcVar1 = (code *)swi(3);
      iVar2 = (*pcVar1)();
      return iVar2;
    }
    FUN_006a5e40(iVar2,0,0x7f092c,0x281);
    return iVar2;
  }
  if (param_1 != 0) {
    ...
    if (iVar2 == 0) {
      ...
      FUN_006a5e40(-4,DAT_007ed77c,0x7f092c,0x27c);
    }
  }
  DAT_00858df8 = (undefined4 *)local_60;
  return local_10;
