...

{
  ...
  *(undefined4 *)(this + 0x61) = uVar7;
  ...
  iVar8 = __setjmp3(local_c4,0,unaff_EDI,unaff_ESI);
  this_00 = local_44;
  if (iVar8 != 0) {
    DAT_00858df8 = local_c8;
    iVar9 = FUN_006ad4d0(s_E____titans_Start_settsobj_cpp_007cd544,0x27d,0,iVar8,&DAT_007a4ccc);
    if (iVar9 != 0) {
      pcVar4 = (code *)swi(3);
      uVar7 = (*pcVar4)();
      return uVar7;
    }
    FUN_006a5e40(iVar8,0,0x7cd544,0x27d);
    return 0xffff;
  }
  ...
  if (uVar20 < 0x6505) {
    if (uVar20 == 0x6504) {
      ...
      if ((uVar20 != 0xffffffff) && (iVar8 = *(int *)(this_00 + 0x1f84), iVar8 != 0)) {
        iVar9 = *(int *)(this_00 + 0x1e2f);
        ...
        iVar8 = *(int *)(this_00 + 0x1f84);
        uVar20 = *(int *)(param_1 + 0x18) + 1;
        bVar26 = uVar20 < *(uint *)(iVar8 + 0xc);
      ...
      if ((uVar20 != 0xffffffff) && (iVar8 = *(int *)(this_00 + 0x1f84), iVar8 != 0)) {
        ...
        (**(code **)(*(int *)this_00 + 0x2c))();
            ...
            (iVar8 = *(int *)(this_00 + 0x1f84), iVar8 != 0)) {
      iVar9 = *(int *)(this_00 + 0x1e2f);
      if (uVar20 < *(uint *)(iVar9 + 0xc)) {
        iVar9 = *(int *)(iVar9 + 8) * uVar20 + *(int *)(iVar9 + 0x1c);
      }
        ...
        if ((*(int *)(iVar9 + 0x104) == 2) && (uVar17 = 0, 0 < (int)uVar20)) {
          ...
          do {
            ...
            if ((iVar12 != 0) && (*(char *)(iVar12 + 4) == '\x02')) {
              SVar16 = *(SettMapTy *)(this_00 + 0x1e26);
              if ((SVar16 == (SettMapTy)0x6) ||
                 ((SVar16 == (SettMapTy)0x1 || (SVar16 == (SettMapTy)0x2)))) {
      ...
      if (0 < (int)uVar20) {
        ...
        do {
          ...
          if (((pcVar10 != (char *)0x0) && (*pcVar10 != '\0')) &&
             ((pcVar10[4] != '\0' &&
              ((pcVar10[4] != '\x01' || (*(SettMapTy *)(this_00 + 0x1e26) == (SettMapTy)0x2)))))) {
...
LAB_005d5b7e:
              ...
              local_11c = *(undefined4 *)(this_00 + 0x61);
              if (bVar1 == 2) {
                local_120 = CONCAT13(1,CONCAT12(1,(undefined2)local_120));
              }
              else {
                local_120 = CONCAT13(1,CONCAT12((bVar1 != 3) + -1,(undefined2)local_120)) &
                            0xff02ffff;
              }
              pcVar10 = local_164;
      ...
      if (*(SettMapTy *)(this_00 + 0x1e26) == (SettMapTy)0x6) {
        if ((*(int *)(this_00 + 0x1f47) == 0) && (*(int *)(param_1 + 0x14) == 0)) {
          ...
          *(SettMapTy *)(this_00 + 0x21e5) = (SettMapTy)0x1;
          *(SettMapTy *)(this_00 + 0x21e4) = (SettMapTy)0x1;
          *(SettMapTy *)(this_00 + 0x21e7) = (SettMapTy)0x1;
          *(SettMapTy *)(this_00 + 0x21e3) = (SettMapTy)0x1;
          *(SettMapTy *)(this_00 + 0x21e1) = (SettMapTy)0x1;
          (**(code **)(*(int *)this_00 + 8))();
        ...
        pcVar10 = pcVar23 + -uVar20;
        pcVar23 = (char *)&DAT_0080ee1a;
        DAT_008087a0 = *(SettMapTy *)(this_00 + 0x1e26);
        for (uVar17 = uVar20 >> 2; uVar17 != 0; uVar17 = uVar17 - 1) {
          *(undefined4 *)pcVar23 = *(undefined4 *)pcVar10;
          pcVar10 = pcVar10 + 4;
          pcVar23 = pcVar23 + 4;
        ...
        *(SettMapTy *)(this_00 + 0x21e4) = (SettMapTy)0x1;
        *(SettMapTy *)(this_00 + 0x21e7) = (SettMapTy)0x1;
        *(SettMapTy *)(this_00 + 0x21e2) = (SettMapTy)0x1;
        *(SettMapTy *)(this_00 + 0x21e1) = (SettMapTy)0x1;
        (**(code **)(*(int *)this_00 + 8))();
        if (*(MMsgTy **)(*(int *)(this_00 + 0x1a5b) + 0x2e6) != (MMsgTy *)0x0) {
          MMsgTy::HidePanel(*(MMsgTy **)(*(int *)(this_00 + 0x1a5b) + 0x2e6),1,0,1);
  ...
  uVar20 = *(uint *)(param_1 + 0x10);
  if (((0x69fe < uVar20) && (uVar20 < 0x6a7f)) && (*(SettMapTy *)(this_00 + 0x65) == (SettMapTy)0x1)
     ) {
    iVar8 = *(int *)(this_00 + 0x1f84);
    local_c = uVar20 - 0x69ff >> 3;
    if ((iVar8 == 0) || (*(uint *)(iVar8 + 0xc) <= *(int *)(this_00 + 0x1f88) + local_c)) {
      local_14 = (char *)0x0;
    }
    else {
      local_14 = (char *)(*(int *)(iVar8 + 8) * (*(int *)(this_00 + 0x1f88) + local_c) +
                         *(int *)(iVar8 + 0x1c));
    }
    uVar17 = 0;
    if (local_14 != (char *)0x0) {
      ...
      case 1:
        ...
        bVar1 = local_14[2];
        iVar8 = *(int *)(this_00 + 0x1f88) + local_c;
        uVar20 = 0;
        *(undefined4 *)(this_00 + 0x2171) = 0x6502;
        *(undefined1 *)((int)&local_40 + (uint)bVar1) = 1;
        *(int *)(this_00 + 0x2179) = iVar8;
        *(undefined4 *)(this_00 + 0x2191) = 0x6503;
        ...
        *(undefined4 *)(this_00 + 0x21c5) = 0x124;
        *(undefined4 *)(this_00 + 0x21cd) = 0x1e;
        *(undefined4 *)(this_00 + 0x21a5) = 0x12;
        *(uint *)(this_00 + 0x21c9) = local_c * 0x19 + 0x41;
LAB_005d619b:
        (**(code **)(**(int **)(this_00 + 0xc) + 8))(0x100ef,0,0,(SettMapTy *)(this_00 + 0x2161),0);
        break;
      case 2:
        *(undefined4 *)(this_00 + 0x2171) = 0x6504;
        *(uint *)(this_00 + 0x2179) = *(int *)(this_00 + 0x1f88) + local_c;
        ...
        *(undefined4 *)(*(int *)(this_00 + 0x1e2f) + 0xc) = 0;
        ...
        uVar20 = ~uVar20;
        pSVar21 = (SettMapTy *)(pcVar23 + -uVar20);
        pSVar25 = (SettMapTy *)(this_00 + 0x1e33);
        for (uVar17 = uVar20 >> 2; uVar17 != 0; uVar17 = uVar17 - 1) {
          *(uint *)pSVar25 = *(uint *)pSVar21;
          pSVar21 = pSVar21 + 4;
          pSVar25 = pSVar25 + 4;
        }
        for (uVar20 = uVar20 & 3; uVar20 != 0; uVar20 = uVar20 - 1) {
        ...
        *(undefined4 *)(this_00 + 0x21a9) = *(undefined4 *)(*(int *)(this_00 + 0x1e2f) + 0xc);
        bVar1 = local_14[3];
        *(undefined4 *)(this_00 + 0x21c5) = 0x143;
        *(undefined4 *)(this_00 + 0x21cd) = 0x78;
        *(uint *)(this_00 + 0x21a1) = bVar1 - 1;
        *(uint *)(this_00 + 0x21c9) = local_c * 0x19 + 0x41;
        iVar8 = *(int *)(DAT_0081176c + 0x34);
        if (*(int *)(iVar8 + 0xa0) != 0) {
          FUN_00710790(iVar8);
        }
        *(undefined4 *)(this_00 + 0x21a5) = *(undefined4 *)(iVar8 + 0x8a);
LAB_005d6676:
        (**(code **)(**(int **)(this_00 + 0xc) + 8))(0x100ef,0,0,(SettMapTy *)(this_00 + 0x2161),0);
        break;
      case 3:
        *(undefined4 *)(this_00 + 0x2171) = 0x6505;
        *(uint *)(this_00 + 0x2179) = *(int *)(this_00 + 0x1f88) + local_c;
        *(undefined4 *)(this_00 + 0x2191) = 0x6500;
        *(undefined4 *)(*(int *)(this_00 + 0x1e2f) + 0xc) = 0;
        if (*local_14 != '\0') {
          uVar20 = 0;
          local_8 = (char *)0x0;
          if ((*(SettMapTy *)(this_00 + 0x1e26) == (SettMapTy)0x2) && (local_14[4] == '\x02'))
          break;
          iVar8 = *(int *)(this_00 + 0x1f84);
          ...
          if (0 < (int)uVar17) {
            do {
              ...
              uVar20 = uVar20 + 1;
              bVar26 = uVar20 < uVar17;
            } while ((int)uVar20 < (int)uVar17);
          }
          if ((*(SettMapTy *)(this_00 + 0x1e26) != (SettMapTy)0x2) && (2 < (int)local_8)) {
            ...
            pSVar25 = (SettMapTy *)(this_00 + 0x1e33);
            for (uVar17 = uVar20 >> 2; uVar17 != 0; uVar17 = uVar17 - 1) {
              *(undefined4 *)pSVar25 = *(undefined4 *)pSVar21;
              pSVar21 = pSVar21 + 4;
              pSVar25 = pSVar25 + 4;
            }
            for (uVar20 = uVar20 & 3; uVar20 != 0; uVar20 = uVar20 - 1) {
        ...
        *(undefined4 *)(this_00 + 0x21c5) = 0x15d;
        *(undefined4 *)(this_00 + 0x21a9) = uVar7;
        *(undefined4 *)(this_00 + 0x21cd) = 0x5f;
        *(uint *)(this_00 + 0x21c9) = local_c * 0x19 + 0x41;
        iVar8 = *(int *)(DAT_0081176c + 0x34);
        if (*(int *)(iVar8 + 0xa0) != 0) {
          FUN_00710790(iVar8);
        ...
        *(undefined4 *)(this_00 + 0x21a5) = *(undefined4 *)(iVar8 + 0x8a);
        if (1 < *(int *)(this_00 + 0x21a9)) goto LAB_005d6676;
        break;
      case 5:
        if (DAT_00808a8f != '\0') {
          local_8 = (char *)0x1;
          ...
          SVar16 = (SettMapTy)0x0;
          iVar9 = 0;
          do {
            if (*(char *)((int)&local_38 + iVar9) != '\0') {
              SVar16 = (SettMapTy)((char)SVar16 + 1);
            }
            iVar9 = iVar9 + 1;
          } while (iVar9 < 8);
          SVar2 = *(SettMapTy *)(this_00 + 0x211c);
joined_r0x005d6701:
          if ((byte)SVar16 < (byte)SVar2) {
            iVar9 = 0;
            do {
              if (*(char *)((int)&local_38 + iVar9) == '\0') {
          ...
          if (0 < *(int *)(iVar8 + 0xc)) {
            local_2c = (undefined1 *)(*(int *)(this_00 + 0x1f88) + local_c);
            bVar26 = *(int *)(iVar8 + 0xc) != 0;
            do {
              if (bVar26) {
                pcVar10 = (char *)(*(int *)(iVar8 + 8) * uVar20 + *(int *)(iVar8 + 0x1c));
...
LAB_005d6784:
          ...
          uVar20 = 0;
          *(undefined4 *)(this_00 + 0x2171) = 0x6501;
          *(uint *)(this_00 + 0x2179) = *(int *)(this_00 + 0x1f88) + local_c;
          *(undefined4 *)(this_00 + 0x2191) = 0x6500;
          *(undefined4 *)(this_00 + 0x21a1) = 0;
          *(undefined4 *)(*(int *)(this_00 + 0x1e2f) + 0xc) = 0;
          ...
          SVar16 = *(SettMapTy *)(this_00 + 0x1e26);
          *(undefined4 *)(this_00 + 0x21a9) = *(undefined4 *)(*(int *)(this_00 + 0x1e2f) + 0xc);
          if (((SVar16 == (SettMapTy)0x6) || (SVar16 == (SettMapTy)0x1)) ||
             (uVar7 = 0x26b, SVar16 == (SettMapTy)0x2)) {
            uVar7 = 0x2ab;
          }
          *(undefined4 *)(this_00 + 0x21c5) = uVar7;
          *(undefined4 *)(this_00 + 0x21cd) = 0x46;
          *(uint *)(this_00 + 0x21c9) = local_c * 0x19 + 0x41;
          iVar8 = *(int *)(DAT_0081176c + 0x34);
          if (*(int *)(iVar8 + 0xa0) != 0) {
            FUN_00710790(iVar8);
        ...
        if (DAT_0080874d != 0xff) {
          bVar1 = local_14[2];
          local_c = CONCAT31(uVar5 >> 3,bVar1);
          if ((bVar1 != 0xff) && (DAT_0080874d != bVar1)) {
            if (local_14[4] == '\x04') {
              local_2c = (undefined1 *)CONCAT31(local_2c._1_3_,bVar1);
              ...
              thunk_FUN_0056a960(&DAT_00807620,uVar20,bVar1);
            }
            (**(code **)(*(int *)this_00 + 0x2c))();
          }
        }
  ...
  local_20 = 0;
  if ((iVar8 == 0) || (*(uint *)(iVar8 + 0xc) <= *(int *)(this_00 + 0x1f88) + uVar17)) {
    pcVar10 = (char *)0x0;
  }
  else {
    pcVar10 = (char *)(*(int *)(iVar8 + 8) * (*(int *)(this_00 + 0x1f88) + uVar17) +
                      *(int *)(iVar8 + 0x1c));
  }
  local_28 = uVar17;
  FUN_006b4170(*(int *)(this_00 + uVar17 * 4 + 0x20f4),0,*piVar3 + -0x113,0,piVar3[2],piVar3[3],0xff
              );
  ...
  case (undefined1 *)0x1:
    if (*pcVar10 != '\0') {
      ...
      local_18 = local_18 + -2;
      MMObjTy::PaintButDib
                ((MMObjTy *)this_00,*(int *)(this_00 + uVar17 * 4 + 0x20f4),&local_24,0,
      ...
      if (pcVar10[2] != -1) {
        ...
        FUN_006b4170(*(int *)(this_00 + uVar17 * 4 + 0x20f4),0,local_24 + 2,local_20 + 2,
  ...
  case (undefined1 *)0x2:
    if (*pcVar10 == '\0') break;
    MMObjTy::PaintButDib
              ((MMObjTy *)this_00,*(int *)(this_00 + uVar17 * 4 + 0x20f4),&local_24,2,
               (-(*(short *)(param_1 + 0x14) != 0) & 0xfcU) + 0x23,0x67);
    ccFntTy::SetSurf(*(ccFntTy **)(DAT_0081176c + 0x34),*(int *)(this_00 + uVar17 * 4 + 0x20f4),0,
...
LAB_005d6c37:
  ...
  case (undefined1 *)0x4:
    MMObjTy::PaintButDib
              ((MMObjTy *)this_00,*(int *)(this_00 + uVar17 * 4 + 0x20f4),&local_24,2,0x67,0x67);
    if (pcVar10[4] == '\x02') {
      ccFntTy::SetSurf(*(ccFntTy **)(DAT_0081176c + 0x34),*(int *)(this_00 + uVar17 * 4 + 0x20f4),0,
                       local_24,local_20,local_1c,local_18);
      uVar7 = 2;
    ...
    iVar8 = local_1c;
LAB_005d6d70:
    puVar13 = thunk_FUN_00540c40(*(void **)(DAT_0081176c + 0x34),puVar13,puVar27,iVar8);
  ...
  case (undefined1 *)0x5:
    if ((*pcVar10 != '\0') &&
      ...
      if (DAT_00808a8f == '\0') {
        if (((DAT_0080874d != 0xff) && (bVar1 = pcVar10[2], bVar1 != 0xff)) &&
           (DAT_0080874d != bVar1)) {
          local_28 = 0xffffffff;
          local_2c = (undefined1 *)CONCAT31(local_2c._1_3_,bVar1);
          ...
          if (-1 < iVar8 + -1) {
            pbVar15 = (byte *)FUN_0070b3a0(*(int *)(this_00 + 0x1f4b),iVar8 + -1);
            thunk_FUN_00540760(*(undefined4 **)(this_00 + uVar17 * 4 + 0x20f4),
        ...
        ccFntTy::SetSurf(*(ccFntTy **)(DAT_0081176c + 0x34),*(int *)(this_00 + uVar17 * 4 + 0x20f4),
                         0,local_24,local_20,local_1c,local_18);
        ccFntTy::WrStr(*(ccFntTy **)(DAT_0081176c + 0x34),&DAT_0080f33a,-1,-1,2);
      }
    }
  }
switchD_005d6abd_default:
  FUN_006b35d0(DAT_008075a8,*(uint *)(this_00 + uVar17 * 4 + 0x20cc));
