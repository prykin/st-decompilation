...

{
  ...
  iVar12 = STAppC::sub_006E51B0(this->field_0010);
      ...
      if (0 < (int)uVar28) {
        ...
        do {
             ...
             ((pcVar14[4] != '\0' && ((pcVar14[4] != '\x01' || (this_00->field_1E26 == CASE_2))))))
          {
            ...
            pcVar31 = &g_bulkInitializedRecords_008087C7[(byte)pcVar14[2]].field_0x1;
      ...
      if (this_00->field_1E26 == CASE_6) {
        if ((this_00->field_1F47 == 0) && ((message->arg0).u32 == 0)) {
          ...
          if (*(int *)(pMVar7 + 0x2e6) != 0) {
            ...
            iVar12 = MMsgTy::SetMessage(*(MMsgTy **)(pMVar7 + 0x2e6),0x251f,'\x01',local_64,local_84
                                        ,nullptr,0,0);
            if (iVar12 != 0) {
...
LAB_005d619b:
      ...
      case 2:
        ...
        if (pcVar20->field_00A0 != 0) {
          FUN_00710790((RecoveredRecordView_00710790_7768A573 *)pcVar20);
        }
...
LAB_005d6784:
          ...
          do {
            ...
            if (puVar24[uVar28 + 0x41] != '\0') {
              ...
              wsprintfA(&this_00->field_1E33,"%s%c",pcVar15,iVar12);
              this_00->field_1F37 = uVar28;
  ...
  local_28 = uVar28;
  FUN_006b4170(this_00->field_20F4[uVar28],0,*piVar9 + -0x113,0,piVar9[2],piVar9[3],0xff);
  ...
  case 0x1:
    if (*(char *)pAVar33 != '\0') {
      ...
      MMObjTy::PaintButDib
                ((MMObjTy *)this_00,(int)this_00->field_20F4[uVar28],&local_24,0,
      ...
      if (pAVar33->field_0x2 != -1) {
        ...
        FUN_006b4170(this_00->field_20F4[uVar28],0,local_24 + 2,local_20 + 2,local_1c + -4,
                     local_18 + -4,bVar22);
      }
    }
    break;
  case 0x2:
    ...
    MMObjTy::PaintButDib
              ((MMObjTy *)this_00,(int)this_00->field_20F4[uVar28],&local_24,2,
               (-((message->arg0).words.low != 0) & 0xfcU) + 0x23,0x67);

    ccFntTy::SetSurf(g_startSystem_0081176C->field_0034,(int)this_00->field_20F4[uVar28],0,local_24,
...
LAB_005d6c37:
  ...
  case 0x3:
    ...
    iVar36 = -1;
    iVar23 = -1;
    pcVar14 = &DAT_007c2310;
    iVar12 = local_1c;

    puVar34 = STPointerBoundaryCast<uint *>(thunk_FUN_005cbbe0(this_00,pAVar33));
    goto LAB_005d6d70;
  case 0x4:
    /* ST_CALLSITE[005D6CFA]: CALL 0x00404c5f; direct=00404C5F MMObjTy::PaintButDib */
    MMObjTy::PaintButDib((MMObjTy *)this_00,(int)this_00->field_20F4[uVar28],&local_24,2,0x67,0x67);
    if (pAVar33->field_0x4 == '\x02') {

      ccFntTy::SetSurf(g_startSystem_0081176C->field_0034,(int)this_00->field_20F4[uVar28],0,
      ...
      pcVar20 = thunk_FUN_00540c40((RecoveredRecord_00540C40_D825DD02 *)
                                   g_startSystem_0081176C->field_0034,(uint *)&pAVar33->field_0xa,
                                   (uint *)&CHAR___007c7274,local_1c);

      ccFntTy::WrStr(g_startSystem_0081176C->field_0034,(char *)pcVar20,iVar12,iVar23,uVar27);
      break;
    }
...
LAB_005d6d70:
    ...
    pcVar20 = thunk_FUN_00540c40((RecoveredRecord_00540C40_D825DD02 *)
                                 g_startSystem_0081176C->field_0034,puVar34,(uint *)pcVar14,iVar12);

    ccFntTy::WrStr(g_startSystem_0081176C->field_0034,(char *)pcVar20,iVar23,iVar36,uVar27);
    break;
  case 0x5:
    if ((*(char *)pAVar33 != '\0') &&
      ...
      if (DAT_00808a8f == '\0') {
        if (((DAT_0080874d != 0xff) && (bVar22 = pAVar33->field_0x2, bVar22 != 0xff)) &&
          ...
          if (-1 < iVar12 + -1) {
            ...
            pRVar21 = FUN_0070b3a0((RecoveredGlobalRecordView_0081175C *)this_00->field_1F4B,
                                   iVar12 + -1);
            /* ST_CALLSITE[005D6FB6]: CALL 0x00403229; direct=00403229 DibPut */
            DibPut(this_00->field_20F4[uVar28],
