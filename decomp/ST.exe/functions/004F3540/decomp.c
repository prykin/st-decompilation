...
void FUN_004f3540(byte param_1,int param_2,byte param_3,char *param_4,undefined *param_5)

{
  ...
  case 1:
    if (*(int *)(local_8 + 0x134) != 0) {
      iVar7 = *(int *)(local_8 + 0x94 + uVar3 * 4);
      break;
    }
    goto LAB_004f3636;
  default:
...
LAB_004f3636:
  ...
  thunk_FUN_00540760(*(undefined4 **)(local_8 + 0x180 + uVar3 * 4),
                     *local_10 - *(int *)(local_8 + 0x3c + uVar3 * 4),iVar8 - iVar7,param_3,
                     (byte *)local_c);
