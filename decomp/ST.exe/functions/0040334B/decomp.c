...

{
  ...
  if (iVar3 == 0) {
    ...
    ccFntTy::SetSurf(*(ccFntTy **)(pFVar2 + 0x1a73),*(int *)(pFVar2 + 0x1ac0),0,0x104,0x93,0x96,0x14
                    );
    uVar9 = 2;
    iVar8 = -1;
    iVar3 = 0;
    puVar5 = (uint *)FUN_006b0140(0x2551,DAT_00807618);
    ccFntTy::WrStr(*(ccFntTy **)(pFVar2 + 0x1a73),puVar5,iVar3,iVar8,uVar9);
    FUN_006c7570(*(int *)(pFVar2 + 0x1ac0),0,0xe6,0x93,(undefined4 *)0x16,0x14,2,0xf);
  ...
  DAT_00858df8 = (undefined4 *)uStack_4c;
  iVar8 = FUN_006ad4d0(s_E____titans_Start_fsgs_obj_cpp_007cbf70,0x3c0,0,iVar3,&DAT_007a4ccc);
  if (iVar8 != 0) {
    pcVar1 = (code *)swi(3);
    (*pcVar1)();
    return;
  }
  FUN_006a5e40(iVar3,0,0x7cbf70,0x3c0);
  return;
}
