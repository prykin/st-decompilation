...

{
  ...
  if (iVar2 == 0) {
    ...
    FUN_00710a90(*(int *)(iStack_8 + 0x1ac0),0,0x104,0x93,0x96,0x14);
    uVar8 = 2;
    iVar7 = -1;
    iVar2 = 0;
    puVar4 = (uint *)FUN_006b0140(0x2551,DAT_00807618);
    FUN_007119c0(puVar4,iVar2,iVar7,uVar8);
    FUN_006c7570(*(int *)(iStack_8 + 0x1ac0),0,0xe6,0x93,(undefined4 *)0x16,0x14,2,0xf);
