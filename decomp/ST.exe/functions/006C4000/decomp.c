...

{
  ...
  if (((*(uint *)(param_1 + 4) & 0x40000000) != 0) && ((*(uint *)(param_1 + 4) & 0x20000000) == 0))
  {
    ...
    exceptionCode = (**(code **)(**(int **)(param_1 + 0x60) + 0x20))(*(int **)(param_1 + 0x60),0,0);
    if (exceptionCode == 0) {
      ...
      *(undefined4 *)(param_1 + 0x104) = 0;
      exceptionCode = (**(code **)(**(int **)(param_1 + 0x5c) + 0x1c))(*(int **)(param_1 + 0x5c));
      if (-1 < exceptionCode) {
        exceptionCode = 0;
...
LAB_006c40d5:
  ...
  if (exceptionCode != 0) {
    RaiseInternalException(exceptionCode,DAT_007ed77c,s_E__DKW_DV_C_dvideo_cpp_007ede80,0x308);
