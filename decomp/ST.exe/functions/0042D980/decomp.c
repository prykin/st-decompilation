...

{
  ...
  if (g_playerRuntime[uVar6].field324_0x203 == 0) {
    iVar3 = g_playerRuntime[uVar6].tempSlots[0][0].objectType;
    if (iVar3 == 0) {
    ...
    if (iVar3 == 0x3c) {
      pDVar1 = g_playerRuntime[uVar6].tempSlots[0][0].objectIds;
      iVar8 = 0;
      iVar3 = 0;
      uVar6 = pDVar1->count;
      iVar9 = 0;
      ...
      if (0 < (int)uVar6) {
        do {
          FUN_006acc70((AnonShape_006ACC70_C8641025 *)pDVar1,local_18,&local_14);
          if ((short)local_14 != -1) {
            local_1c = local_1c + 1;
            pSVar5 = (STFishC *)
...
joined_r0x0042de37:
    ...
    if (iVar3 == 0x1ae) {
      pSVar5 = (STFishC *)
               GetObjPtr(g_sTAllPlayers_007FA174,
                         CONCAT31(uVar7,(char)g_playerRuntime[uVar6].tempSlots[0][0].playerId),
                         (uint)(ushort)g_playerRuntime[uVar6].tempSlots[0][0].objectId,CASE_3);
      STFishC::sub_004162B0
                (pSVar5,(undefined2 *)&local_8,(undefined2 *)&local_c,(undefined2 *)&local_10);
      if (param_1 != (undefined2 *)0x0) {
  ...
  if (g_playerRuntime[uVar6].field324_0x203 == 1) {
    iVar3 = g_playerRuntime[uVar6].tempSlots[1][0].objectType;
    if (0x19a < iVar3) {
      if (iVar3 == 0x1a4) {
        SVar10 = CASE_5;
LAB_0042da27:
        pSVar5 = (STFishC *)
                 GetObjPtr(g_sTAllPlayers_007FA174,
                           CONCAT31(uVar7,(char)g_playerRuntime[uVar6].tempSlots[1][0].playerId),
                           (uint)(ushort)g_playerRuntime[uVar6].tempSlots[1][0].objectId,SVar10);
        STFishC::sub_004162B0
                  (pSVar5,(undefined2 *)&local_8,(undefined2 *)&local_c,(undefined2 *)&local_10);
      }
      else {
...
LAB_0042dbdf:
        ...
        pSVar5 = (STFishC *)
                 GetObjPtr(g_sTAllPlayers_007FA174,
                           CONCAT31(uVar7,(char)g_playerRuntime[uVar6].tempSlots[1][0].playerId),
                           (uint)(ushort)g_playerRuntime[uVar6].tempSlots[1][0].objectId,CASE_6);
        STFishC::sub_004162B0
                  (pSVar5,(undefined2 *)&local_8,(undefined2 *)&local_c,(undefined2 *)&local_10);
      }
      if (param_1 != (undefined2 *)0x0) {
...
joined_r0x0042dc56:
    ...
    if (iVar3 == 0x19a) {
      pDVar1 = g_playerRuntime[uVar6].tempSlots[1][0].objectIds;
      iVar8 = 0;
      iVar3 = 0;
      uVar6 = pDVar1->count;
      iVar9 = 0;
    ...
    if (iVar3 != 0) {
      if (iVar3 == 0x5a) {
        pSVar5 = (STFishC *)
                 GetObjPtr(g_sTAllPlayers_007FA174,
                           CONCAT31(uVar7,(char)g_playerRuntime[uVar6].tempSlots[1][0].playerId),
                           (uint)(ushort)g_playerRuntime[uVar6].tempSlots[1][0].objectId,CASE_4);
        STFishC::sub_004162B0
                  (pSVar5,(undefined2 *)&local_8,(undefined2 *)&local_c,(undefined2 *)&local_10);
        if (param_1 != (undefined2 *)0x0) {
          *param_1 = (undefined2)local_8;
