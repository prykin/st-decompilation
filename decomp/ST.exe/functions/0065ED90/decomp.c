...
int __thiscall
SubmarineTitans::Recovered::HiddenThis::RecoveredReceiver_0065ED90::FUN_0065ed90
...

{
  ...
  psVar1 = param_2;
  local_10 = this;
  iVar4 = thunk_FUN_0065e700(this,&local_c,&local_8,&local_c,&local_1c);
  if (iVar4 != 0) {
    return -4;
  }
  ...
  local_18 = iVar4;
  iVar3 = FUN_006aced8(local_8,local_c,iVar7,iVar4);
  if (iVar3 < 8) {
    return -4;
  }
