...

{
  ...
  if (iVar3 != 0) {
    ...
    iVar5 = ReportDebugMessage(s_E__Ourlib__sviewer_cpp_007f0a68,0x108,0,iVar3,&DAT_007a4ccc,
    ...
    RaiseInternalException(iVar3,0,s_E__Ourlib__sviewer_cpp_007f0a68,0x109);
    return 0xffff;
  }
  switch(param_1[4]) {
  case 0:
