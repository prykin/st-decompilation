...
void thunk_FUN_005e6770(undefined4 param_1,undefined4 param_2)

{
  ...
  if (iVar4 == 0) {
    _DAT_0080f32e = 0;
    *(undefined4 *)((int)pvStack_c + 0x1a64) = param_1;
    *(undefined4 *)((int)pvStack_c + 0x1a68) = param_2;
    puVar5 = FUN_006b54f0((uint *)0x0,10,10);
    *(uint **)((int)pvStack_c + 0x1af0) = puVar5;
    ...
    *(int *)((int)pvStack_c + 0x5d) = iVar4;
    FUN_006bc360(iVar4,auStack_668,(int *)0x0);
    *(undefined4 *)(*(int *)((int)pvStack_c + 0x1a5b) + 0x140) = 0x1f;
    FUN_00718780((int)auStack_668,0,0x100,0x8b,0x15,
    ...
    *(uint **)(DAT_0081176c + 0x548) = puVar5;
    if (*(int *)(DAT_0081176c + 0x389) != 0) {
      *(undefined4 *)((int)pvStack_c + 0x2d) = 0x28;
      *(undefined2 *)((int)pvStack_c + 0x31) = 1;
      *(undefined2 *)((int)pvStack_c + 0x33) = *(undefined2 *)(*(int *)(DAT_0081176c + 0x548) + 8);
      FUN_006e6080(pvStack_c,2,*(undefined4 *)(DAT_0081176c + 0x389),
                   (undefined4 *)((int)pvStack_c + 0x1d));
      *(undefined4 *)((int)pvStack_c + 0x2d) = 0x22;
      *(undefined2 *)((int)pvStack_c + 0x33) = 0;
      *(undefined2 *)((int)pvStack_c + 0x31) = 0;
      FUN_006e6080(pvStack_c,2,*(undefined4 *)(DAT_0081176c + 0x389),
                   (undefined4 *)((int)pvStack_c + 0x1d));
    }
    thunk_FUN_005e79b0('\x01');
    iVar4 = 1;
    puVar9 = (undefined4 *)(*(int *)((int)pvStack_c + 0x5d) + 0x28);
    uVar8 = FUN_006b4fe0(*(int *)((int)pvStack_c + 0x5d));
    iVar4 = FUN_006b50c0(0x1e4,399,(uint)*(ushort *)(*(int *)((int)pvStack_c + 0x5d) + 0xe),uVar8,
                         puVar9,iVar4);
    *(int *)((int)pvStack_c + 0x1aec) = iVar4;
    ...
    puVar5 = (uint *)((int)pvStack_c + 0x1a94);
    do {
      FUN_006b2330((uint)DAT_008075a8,puVar5,0x31,0x402211,
                   *(uint *)(*(int *)((int)pvStack_c + 0x1aec) + 4),0x13,(uint)pvStack_c);
    ...
    thunk_FUN_005e9b50();
    FUN_006b2330((uint)DAT_008075a8,&uStack_8,0x32,0x403099,0x204,0x19d,
                 *(int *)((int)pvStack_c + 0x1a5b) + 0x140);
    ...
    *(undefined1 **)((int)pvStack_c + 0x1af8) = puVar10;
    if (puVar10 != (undefined1 *)0x0) {
      uVar11 = 0;
      cVar13 = '\x01';
      uVar8 = 0x10;
      ...
      if (uVar8 != 0) {
        iVar4 = *(int *)((int)pvStack_c + 0x1af8);
        *(undefined1 *)(iVar4 + 2) = 1;
        *(undefined4 *)(iVar4 + 0x17) = *(undefined4 *)(iVar4 + 0x13);
        uVar8 = *(uint *)(*(int *)((int)pvStack_c + 0x1af8) + 3);
        if (-1 < (int)uVar8) {
    ...
    if ((*(int *)((int)pvStack_c + 0x1a64) == 0) || (*(int *)((int)pvStack_c + 0x1a68) != 0)) {
      ...
      *(undefined1 **)((int)pvStack_c + 0x1b00) = puVar10;
      if (puVar10 != (undefined1 *)0x0) {
        uVar11 = 0;
        cVar13 = '\x01';
        uVar8 = 0x10;
        ...
        if (uVar8 != 0) {
          iVar4 = *(int *)((int)pvStack_c + 0x1b00);
          *(undefined1 *)(iVar4 + 2) = 1;
          *(undefined4 *)(iVar4 + 0x17) = *(undefined4 *)(iVar4 + 0x13);
          uVar8 = *(uint *)(*(int *)((int)pvStack_c + 0x1b00) + 3);
          if (-1 < (int)uVar8) {
            FUN_006b3af0(DAT_008075a8,uVar8);
          }
    ...
    if (*(int *)((int)pvStack_c + 0x1a64) == 0) {
      ...
      *(undefined1 **)((int)pvStack_c + 0x1afc) = puVar10;
      if (puVar10 != (undefined1 *)0x0) {
        uVar11 = 0;
        cVar13 = '\x01';
        uVar8 = 0x10;
        ...
        if (uVar8 != 0) {
          iVar4 = *(int *)((int)pvStack_c + 0x1afc);
          *(undefined1 *)(iVar4 + 2) = 1;
          *(undefined4 *)(iVar4 + 0x17) = *(undefined4 *)(iVar4 + 0x13);
          uVar8 = *(uint *)(*(int *)((int)pvStack_c + 0x1afc) + 3);
          if (-1 < (int)uVar8) {
            FUN_006b3af0(DAT_008075a8,uVar8);
          }
          if (*(uint *)(DAT_0081176c + 0x560) != 0xffffffff) {
    ...
    pcVar1 = *(char **)((int)pvStack_c + 0x1af8);
    if (((pcVar1 != (char *)0x0) && (*pcVar1 != '\0')) && (-1 < (int)*(uint *)(pcVar1 + 3))) {
      FUN_006b3430(DAT_008075a8,*(uint *)(pcVar1 + 3));
    }
    pcVar1 = *(char **)((int)pvStack_c + 0x1b00);
    if (((pcVar1 != (char *)0x0) && (*pcVar1 != '\0')) && (-1 < (int)*(uint *)(pcVar1 + 3))) {
      FUN_006b3430(DAT_008075a8,*(uint *)(pcVar1 + 3));
    }
    pcVar1 = *(char **)((int)pvStack_c + 0x1afc);
    if (((pcVar1 != (char *)0x0) && (*pcVar1 != '\0')) && (-1 < (int)*(uint *)(pcVar1 + 3))) {
      FUN_006b3430(DAT_008075a8,*(uint *)(pcVar1 + 3));
    }
    thunk_FUN_005e9a40(pvStack_c);
    this = DAT_00802a30;
    if (DAT_00802a30 != (void *)0x0) {
    ...
    *(undefined1 *)((int)pvStack_c + 0x65) = 3;
    puVar9 = &uStack_268;
    ...
    *(undefined2 *)puVar9 = 0;
    iVar4 = *(int *)((int)pvStack_c + 0x1a5b);
    *(undefined1 *)((int)puVar9 + 2) = 0;
    uStack_194 = 2;
    uStack_16d = 2;
    uStack_198 = *(undefined4 *)((int)pvStack_c + 8);
    uStack_1a5 = 0x2340;
    iStack_169 = (-(uint)(DAT_008067a0 != '\0') & 4) + 0x694d;
    uStack_190 = 0x6943;
    uStack_17e = 0x24bc;
    uStack_171 = uStack_198;
    if (*(int *)(iVar4 + 0x2e6) != 0) {
      ...
      *(undefined4 *)(*(int *)(*(int *)((int)pvStack_c + 0x1a5b) + 0x2e6) + 0x1cab) =
      ...
      thunk_FUN_005b87d0(*(void **)(*(int *)((int)pvStack_c + 0x1a5b) + 0x2e6),0,(int)&uStack_268,0,
                         0);
      thunk_FUN_005b9010(*(void **)(*(int *)((int)pvStack_c + 0x1a5b) + 0x2e6),(int)auStack_6c);
    }
