...

{
  ...
  if (iVar4 == 0) {
    _DAT_0080f32e = 0;
    *(undefined4 *)(pWStack_c + 0x1a64) = param_1;
    *(undefined4 *)(pWStack_c + 0x1a68) = param_2;
    ...
    *(undefined4 *)(*(int *)(this_01 + 0x1a5b) + 0x140) = 0x1f;
    FUN_00718780((int)auStack_668,0,0x100,0x8b,0x15,
                 (undefined4 *)(*(int *)(this_01 + 0x1a5b) + 0x144));
    ...
    *(undefined1 **)(this_01 + 0x1af8) = puVar10;
    ...
    if (*(int *)(this_01 + 0x1a64) == 0) {
      FUN_006b2330((uint)DAT_008075a8,&uStack_8,0x32,0x403b61,400,0x62,
                   *(int *)(this_01 + 0x1a5b) + 0x140);
      Library::DKW::DDX::FUN_006b3640(DAT_008075a8,uStack_8,0xffffffff,200,0x1f1);
    ...
    *(undefined1 *)((int)puVar9 + 2) = 0;
    uStack_194 = 2;
    uStack_16d = 2;
    uStack_198 = *(undefined4 *)(this_01 + 8);
    uStack_1a5 = 0x2340;
    ...
    if (*(int *)(iVar4 + 0x2e6) != 0) {
      ...
      *(undefined4 *)(*(int *)(*(int *)(this_01 + 0x1a5b) + 0x2e6) + 0x1cab) =
      ...
      MMsgTy::SetPanel(*(MMsgTy **)(*(int *)(this_01 + 0x1a5b) + 0x2e6),0,(int)&uStack_268,0,0);
      MMsgTy::StatePanel(*(MMsgTy **)(*(int *)(this_01 + 0x1a5b) + 0x2e6),(int)auStack_6c);
    }
