...

{
  ...
  if (iVar3 != 0) {
    ...
    iVar6 = ReportDebugMessage("E:\\__titans\\wlad\\to_grpb.cpp",0xaa0,0,iVar3,"%s",
                               "STGroupBoatC::GrpLoadObj");
    if (iVar6 != 0) {
  ...
  if (0 < (int)local_10) {
    do {
      ...
      if ((short)local_c != -1) {
        ...
        iVar3 = (**(code **)&local_8->vtable->field_0xf8)();
        if (iVar3 != 0) {
          iVar3 = thunk_FUN_00490d90((int)local_8);
          if (iVar3 == 0) {
            /* ST_PSEUDO[raw_indirect_call]: expected typed vtable/callback call with explicit __thiscall receiver */
            iVar3 = (*(code *)local_8->vtable->field_002C)();
...
LAB_0049e26d:
  if (PTR_00802a38->field_00E4 % 0x14 == 0) {
    uVar10 = 0;
    if (0 < (int)local_10) {
      do {
        ...
        if ((short)local_c != -1) {
          ...
          /* ST_PSEUDO[raw_indirect_call]: expected typed vtable/callback call with explicit __thiscall receiver */
          if ((iVar3 != 0) &&
             (((iVar3 = (*(code *)local_8->vtable->field_002C)(), iVar3 == 7 || (iVar3 == 0x13)) ||
              (iVar3 == 0x1b)))) {
            local_28 = 1;
