...
undefined4 __thiscall FUN_0049dfa0(void *this,int param_1)

{
  ...
  *(undefined4 *)((int)local_30 + 0x65) = 0;
  iVar3 = FUN_006e62d0(DAT_00802a38,*(int *)((int)local_30 + 0x178),(int *)&local_8);
  if (iVar3 == -4) {
    return 0;
  }
  thunk_FUN_004162f0(local_8,(undefined2 *)((int)pvVar2 + 0x2a3),(undefined2 *)((int)pvVar2 + 0x2a5)
                     ,(undefined2 *)((int)pvVar2 + 0x2a7));
  local_20 = 0;
  *(int *)((int)pvVar2 + 0x2a9) = local_8[6];
      ...
      if ((short)local_c != -1) {
        ...
        if (iVar3 != 0) {
          ...
          if (iVar3 == 0) {
            ...
            local_3c = *(undefined2 *)((int)pvVar2 + 0x2a3);
            local_3a = *(undefined2 *)((int)pvVar2 + 0x2a5);
            local_38 = *(undefined2 *)((int)pvVar2 + 0x2a7);
            local_36 = *(undefined4 *)((int)pvVar2 + 0x2a9);
