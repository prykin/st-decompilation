...
/* [STMethodOwnerApplier] Structural method owner recovered as MAdvTy.
   ...
   Evidence: 00590860 returns return of sub_006E60A0 @ 00590899 */

int __thiscall MAdvTy::sub_00590860(MAdvTy *this)

{
  ...
  iVar1 = sub_006E60A0(this,(undefined4 *)&this->field_0x18);
  return iVar1;
}
