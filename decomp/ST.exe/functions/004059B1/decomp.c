...

{
  ...
  if (iVar2 == 0) {
    ...
    if (*(char *)(iStack_8 + 0x1ee3) == '\0') {
      ...
      wsprintfA((LPSTR)(*(int *)(iStack_8 + 0x1a5b) + 0x3c),pCVar4,uVar8,uVar9,uVar6);
      thunk_FUN_00540890(0,0,0x240,800,0x18,(uint *)(*(int *)(iStack_8 + 0x1a5b) + 0x3c),0xfffffffe,
                         0xffffffff,*(void **)(DAT_0081176c + 0x34),0);
    }
    else if (*(char *)(iStack_8 + 0x1ee3) == '\x01') {
      pvVar10 = *(void **)(DAT_0081176c + 0x30);
      uVar9 = 0xffffffff;
      uVar8 = 0xfffffffe;
