...

{
  ...
  if (iVar3 == 0) {
    ...
    pMVar2 = pMStack_8;
    if (pMStack_8[0x1ee3] == (MainMenuTy)0x0) {
      uVar12 = 0;
    ...
    else if (pMStack_8[0x1ee3] == (MainMenuTy)0x1) {
      pvVar11 = *(void **)(DAT_0081176c + 0x30);
      uVar10 = 0xffffffff;
      uVar9 = 0xfffffffe;
    ...
    if (pMVar2[0x9a] != (MainMenuTy)0x0) {
      ...
      do {
        if (*(uint *)(pMVar8 + -0x18) != 0xffffffff) {
          FUN_006b3730(*(uint **)(pMVar8 + 0x2c),*(uint *)(pMVar8 + -0x18),*(uint *)(pMVar8 + -0x14)
                       ,*(uint *)pMVar8,*(uint *)(pMVar8 + 4));
        }
        if ((pMVar2[0x65] == (MainMenuTy)0x1) && (*(uint *)(pMVar8 + 0x79) != 0xffffffff)) {
          FUN_006b3730(*(uint **)(pMVar8 + 0xbd),*(uint *)(pMVar8 + 0x79),*(uint *)(pMVar8 + 0x7d),
  ...
  DAT_00858df8 = puStack_4c;
  iVar6 = FUN_006ad4d0(s_E____titans_Start_main_obj_cpp_007cc8e8,0x7e,0,iVar3,&DAT_007a4ccc);
  if (iVar6 != 0) {
    pcVar1 = (code *)swi(3);
    (*pcVar1)();
    return;
  }
  FUN_006a5e40(iVar3,0,0x7cc8e8,0x7e);
  return;
}
