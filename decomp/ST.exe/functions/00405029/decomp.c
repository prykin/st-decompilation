...
undefined4 __fastcall thunk_FUN_005f07a0(void *param_1)
          ...
          if (iVar5 != 0) {
            ...
            if (iVar5 != 0) {
              ...
              if (CONCAT31(extraout_var_00,bVar3) != 0) {
                ...
                iVar5 = thunk_FUN_005ecd70(param_1,(sStack_6 + 1) * 0xc9,(sStack_8 + 1) * 0xc9,
                                           sStack_a * 0xc9 + 0x96,*(int *)((int)param_1 + 0x2ba),
                                           '\x01',0x3c);
                if (iVar5 != 0) {
                  return 1;
                }
