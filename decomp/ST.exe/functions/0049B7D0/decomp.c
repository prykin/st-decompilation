...

{
  ...
  if (0 < (int)local_1c) {
    do {
      ...
      DArrayGetElement(this->field_0029,local_20,&local_18);
      if ((ushort)local_18 != 0xffff) {
        ...
        STFishC::sub_004162F0
                  (pSVar7,(short *)((int)&param_1 + 2),(short *)&local_10,(short *)&local_14);
  ...
  uVar13 = 1;
  if (1 < (int)local_28) {
    local_34 = (RecoveredRecordView_00413AF0_B98DB3AE *)this->field_0103;
    ...
    if (-1 < (int)local_28) {
      ...
      if (0 < (int)local_1c) {
        do {
          ...
          DArrayGetElement(this->field_0029,uVar13,&local_18);
          if ((ushort)local_18 != 0xffff) {
