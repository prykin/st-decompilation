...

{
  ...
  *(undefined4 *)&this->field_0x65 = 0;
  ...
  this->field_0236 = 1;
  this->field_023E = 0;
  *(undefined4 *)&this->field_0x23a = 0;
  this->field_0242 = 0;
  *(undefined4 *)&this->field_0x246 = *(undefined4 *)&this->field_0x107;
  local_2c = *(uint *)(*(byte **)&this->field_0x103 + 0xc);
  local_28 = local_2c;
  if ((int)local_2c < 1) {
    FUN_006ae110(*(byte **)&this->field_0x103);
    *(undefined4 *)&this->field_0x103 = 0;
    return 0;
  }
  uVar10 = 0;
  iVar3 = -30000;
  ...
  if (0 < (int)local_2c) {
    do {
      if ((uVar10 < local_2c) &&
         (psVar4 = (short *)(*(int *)(*(int *)&this->field_0x103 + 8) * uVar10 +
                            *(int *)(*(int *)&this->field_0x103 + 0x1c)), psVar4 != (short *)0x0)) {
        iVar7 = (int)*psVar4;
        if (iVar7 < local_c) {
          local_c = iVar7;
        }
  ...
  if (*(int *)(*(int *)&this->field_0x103 + 0xc) == 0) {
    psVar4 = (short *)0x0;
  }
  else {
    psVar4 = *(short **)(*(int *)&this->field_0x103 + 0x1c);
  }
  FUN_006ab090((int)DAT_007fb238,local_2c,local_20,5,*psVar4 - local_c,psVar4[1] - local_8,
               (int)psVar4[2],-1,-1,-1);
  uVar10 = 1;
  if (1 < (int)local_28) {
    local_34 = *(int *)&this->field_0x103;
...
joined_r0x0049bc58:
    local_28 = local_28 - 1;
    if (-1 < (int)local_28) {
      FUN_006acc70(*(int *)&this->field_0x103,local_28,(undefined4 *)&local_3c);
      ...
      if (0 < local_1c) {
        do {
          ...
          if ((short)local_18 != -1) {
            ...
            {
              FUN_006b0c70(*(int *)&this->field_0x103,local_28);
              break;
            }
          }
          uVar10 = uVar10 + 1;
    ...
    if (*(int *)(*(byte **)&this->field_0x103 + 0xc) == 0) {
      FUN_006ae110(*(byte **)&this->field_0x103);
      *(undefined4 *)&this->field_0x103 = 0;
      return 0;
    }
  ...
  puVar6 = Library::DKW::TBL::FUN_006ae290
                     ((uint *)0x0,*(uint *)(*(int *)&this->field_0x103 + 0xc),6,1);
  iVar3 = *(int *)&this->field_0x103;
  ...
  *(int *)&this->field_0x23a = ((this->field_0242 * 0xc9) / (int)(uint)bVar2) / 3;
