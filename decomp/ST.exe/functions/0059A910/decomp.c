...

{
  ...
  if (iVar4 == 0) {
    ...
    iVar9 = -1;
    iVar4 = -1;
    puVar6 = (uint *)LoadResourceString(0x259d,g_hINSTANCE_00807618);
    ccFntTy::WrStr(pFVar3->field_1A73,puVar6,iVar4,iVar9,uVar8);
    ccFntTy::SetSurf(pFVar3->field_1A73,(int)pFVar3->field_1AC0,0,0x19,0xde,0x50,0x14);
    uVar8 = 2;
    iVar9 = -1;
    iVar4 = 0;
    puVar6 = (uint *)LoadResourceString(0x259f,g_hINSTANCE_00807618);
    ccFntTy::WrStr(pFVar3->field_1A73,puVar6,iVar4,iVar9,uVar8);
    ...
    iVar9 = -1;
    iVar4 = 0;
    puVar6 = (uint *)LoadResourceString(0x25a0,g_hINSTANCE_00807618);
    ccFntTy::WrStr(pFVar3->field_1A73,puVar6,iVar4,iVar9,uVar8);
    ...
    iVar9 = -1;
    iVar4 = 0;
    puVar6 = (uint *)LoadResourceString(0x25a5,g_hINSTANCE_00807618);
    ccFntTy::WrStr(pFVar3->field_1A73,puVar6,iVar4,iVar9,uVar8);
    ...
    iVar9 = -1;
    iVar4 = 0;
    puVar6 = (uint *)LoadResourceString(0x25a1,g_hINSTANCE_00807618);
    ccFntTy::WrStr(pFVar3->field_1A73,puVar6,iVar4,iVar9,uVar8);
    ...
    iVar9 = -1;
    iVar4 = 0;
    puVar6 = (uint *)LoadResourceString(0x25a4,g_hINSTANCE_00807618);
    ccFntTy::WrStr(pFVar3->field_1A73,puVar6,iVar4,iVar9,uVar8);
    ...
    iVar9 = -1;
    iVar4 = 0;
    puVar6 = (uint *)LoadResourceString(0x25a3,g_hINSTANCE_00807618);
    ccFntTy::WrStr(pFVar3->field_1A73,puVar6,iVar4,iVar9,uVar8);
    ...
    iVar9 = -1;
    iVar4 = 0;
    puVar6 = (uint *)LoadResourceString(0x25a2,g_hINSTANCE_00807618);
    ccFntTy::WrStr(pFVar3->field_1A73,puVar6,iVar4,iVar9,uVar8);
    ...
    iVar9 = -1;
    iVar4 = -1;
    puVar6 = (uint *)LoadResourceString(0x259e,g_hINSTANCE_00807618);
    ccFntTy::WrStr(pFVar3->field_1A73,puVar6,iVar4,iVar9,uVar8);
