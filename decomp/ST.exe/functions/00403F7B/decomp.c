...
int thunk_FUN_0065f660(short *param_1,int param_2)

{
  ...
  if (0 < param_2) {
    ...
    do {
      ...
      sVar2 = param_1[4];
      if (sVar1 < 0) {
        iVar6 = *(int *)((int)pvStack_c + 0x1c);
      }
      else {
        iVar6 = *(int *)((int)pvStack_c + 0x1c);
      }
      uVar7 = iVar6 * 0x41c64e6d + 0x3039;
      *(uint *)((int)pvStack_c + 0x1c) = uVar7;
      sVar3 = param_1[3];
      sVar4 = *param_1;
      if (sVar4 < 0) {
        iVar6 = *(int *)((int)pvStack_c + 0x1c);
      ...
      *(uint *)((int)pvStack_c + 0x1c) = uVar8;
      ...
      if ((iVar6 != 0) && (iVar6 = thunk_FUN_0065f5c0(pvStack_c,asStack_20), iVar6 != 0)) {
        DAT_00858df8 = (undefined4 *)uStack_64;
        return 0;
      }
      iStack_8 = iStack_8 + 1;
