...

{
  ...
  if (sVar1 < 0) {
    SStack_10.x = (short)((sVar1 / 0xc9 + (sVar1 >> 0xf)) -
                         (short)((longlong)(int)sVar1 * 0x28c1979 >> 0x3f)) + -1;
  }
  else {
    SStack_10.x = (int)(short)((sVar1 / 0xc9 + (sVar1 >> 0xf)) -
                              (short)((longlong)(int)sVar1 * 0x28c1979 >> 0x3f));
  }
  sVar1 = *(short *)((int)this + 0x25c);
  if (sVar1 < 0) {
    SStack_10.y = (short)((sVar1 / 0xc9 + (sVar1 >> 0xf)) -
                         (short)((longlong)(int)sVar1 * 0x28c1979 >> 0x3f)) + -1;
  }
  else {
    SStack_10.y = (int)(short)((sVar1 / 0xc9 + (sVar1 >> 0xf)) -
                              (short)((longlong)(int)sVar1 * 0x28c1979 >> 0x3f));
  }
