...
int __fastcall thunk_FUN_005f4fa0(void *param_1)

{
  ...
  bVar3 = false;
  iVar5 = 0;
  if ((*(int *)((int)param_1 + 0x169) != 0) && (iStack_8 = 0, 0 < *(int *)((int)param_1 + 0x10d))) {
    do {
      uVar8 = iStack_8 * *(int *)((int)param_1 + 0x109);
      if (*(uint *)(DAT_00802a38 + 0xe4) < *(uint *)((int)param_1 + iStack_8 * 4 + 0x159)) {
        iStack_c = 1;
      }
      else {
        *(int *)((int)param_1 + iStack_8 * 4 + 0x139) =
             *(int *)((int)param_1 + iStack_8 * 4 + 0x139) + *(int *)((int)param_1 + 0x125);
        iVar5 = *(int *)((int)param_1 + iStack_8 * 4 + 0x149) + *(int *)((int)param_1 + 0x121);
        *(int *)((int)param_1 + iStack_8 * 4 + 0x149) = iVar5;
        if ((iStack_8 == 0) && (iVar5 = iVar5 / 200, iVar5 != *(int *)((int)param_1 + 0x129))) {
        ...
        if (0 < *(int *)((int)param_1 + 0x109)) {
          do {
            ...
            if (((uVar8 < *(uint *)(iVar5 + 0xc)) &&
              ...
              *(int *)(pcVar9 + 2) =
                   (*(int *)(pcVar9 + 0x12) * *(int *)((int)param_1 + iStack_8 * 4 + 0x139)) / 10000
                   + *(int *)((int)param_1 + 0x111);
              iVar5 = *(int *)(pcVar9 + 2);
              *(int *)(pcVar9 + 6) =
                   (*(int *)(pcVar9 + 0x16) * *(int *)((int)param_1 + iStack_8 * 4 + 0x139)) / 10000
                   + *(int *)((int)param_1 + 0x115);
              iVar1 = *(int *)((int)param_1 + iStack_8 * 4 + 0x149);
              *(int *)(pcVar9 + 10) = iVar1;
              sVar6 = (short)(iVar5 >> 0x1f);
              if (iVar5 < 0) {
                sStack_18 = (((short)(iVar5 / 0xc9) + sVar6) -
              ...
              if (iVar2 < 0) {
                sStack_14 = (((short)(iVar2 / 0xc9) + sVar6) -
              ...
              if ((((iVar5 < 0) || (DAT_007fb240 <= iVar5)) ||
                 ...
                 (bVar4 = thunk_FUN_004961b0(sStack_18,sStack_14,sVar6), uVar7 = extraout_EDX,
              ...
              if ((iStack_c == 0) && (*pcVar9 != '\x02')) {
                iStack_c = 1;
              }
              if (((iStack_8 == 0) && (!bVar3)) && (*pcVar9 != '\x02')) {
                bVar3 = true;
              }
            }
LAB_005f528b:
            ...
            uVar8 = uVar8 + 1;
          } while (iStack_20 < *(int *)((int)param_1 + 0x109));
        }
      }
      iStack_8 = iStack_8 + 1;
      iVar5 = iStack_c;
    } while (iStack_8 < *(int *)((int)param_1 + 0x10d));
  }
  return iVar5;
}
