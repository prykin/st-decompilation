...

{
  ...
  if ((((((-1 < (int)param_2) && ((int)param_2 < *param_1)) && (-1 < param_3)) &&
    ...
    puVar1 = thunk_FUN_006a3390(param_2,param_3,param_4,param_5);
    thunk_FUN_006a3420(param_7,puVar1);

    iVar2 = thunk_FUN_006a1370(param_1,param_4,param_5,param_6,&local_c);

    iVar2 = thunk_FUN_006a24e0((ushort *)&local_c,(short)iVar2,param_7,param_6,0xff);
    if (iVar2 == 0) {
    ...
    iVar2 = thunk_FUN_006a1370(param_1,param_2,param_3,param_6,&local_c);
