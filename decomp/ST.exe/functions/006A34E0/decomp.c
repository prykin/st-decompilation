...

{
  ...
  if ((((((-1 < (int)param_2) && ((int)param_2 < *param_1)) && (-1 < param_3)) &&
    ...
    iVar2 = thunk_FUN_006a1370(param_1,param_4,param_5,param_6,(int)local_c);
    iVar2 = thunk_FUN_006a24e0(local_c,(short)iVar2,param_7,param_6,0xff);
    if (iVar2 == 0) {
    ...
    iVar2 = thunk_FUN_006a1370(param_1,param_2,param_3,param_6,(int)local_c);
    iVar2 = thunk_FUN_006a24e0(local_c,(short)iVar2,param_7,param_6,0xff);
    if (iVar2 == 0) {
