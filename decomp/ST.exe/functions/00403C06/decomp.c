...

{
  ...
  if ((uint)param_1[0x13a] <= *(uint *)((int)DAT_00802a38 + 0xe4)) {
    ...
    if (0 < param_1[0x139]) {
      do {
        iVar10 = iStack_c;
        if (param_1[iStack_c + 0x134] == 0) {
          iStack_c = iVar10;
          if (iStack_10 == 0) {
            iStack_10 = 1;
            puStack_8 = Library::DKW::TBL::FUN_006ae290((uint *)0x0,10000,0xc,10);
            iVar10 = 0;
            uVar8 = _DAT_007fb240;
            if (0 < DAT_007fb242) {
              do {
                         ...
                         ((((sVar2 < 0 || (DAT_007fb242 <= sVar2)) || (sVar13 < 0)) ||
                          ((DAT_007fb244 <= sVar13 ||
                           (*(int *)(DAT_007fb248 + 4 +
                                    ((int)sVar2 * (int)sVar3 + (int)sVar13 * (int)DAT_007fb246) * 8)
                            == 0)))))))))) {
                      pSStack_20 = (STSharkC *)0x0;
                      iStack_1c = iVar10;
                      iStack_18 = iVar4;
                      Library::DKW::TBL::FUN_006ae1c0(puStack_8,&pSStack_20);
                    }
            ...
            if (puStack_8[3] != 0) {
              uVar5 = param_1[7] * 0x41c64e6d + 0x3039;
              param_1[7] = uVar5;
              FUN_006acc70((int)puStack_8,(uVar5 >> 0x10) % puStack_8[3],&pSStack_20);
              ...
              iVar10 = STSharkC::CreateShark
                                 (pSStack_20,(int)pSStack_20,iStack_1c,iStack_18,iVar10,iVar9,iVar4,
                                  iVar6,0,param_1[9]);
          ...
          iVar4 = FUN_006e62d0(DAT_00802a38,param_1[iStack_c + 0x134],(int *)0x0);
          iStack_c = iVar10;
          if (iVar4 != 0) {
