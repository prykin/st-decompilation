...

{
  ...
  if (iVar3 != 0) {
    ...
    iVar12 = FUN_006ad4d0(s_E____titans_ai_ai_creat_cpp_007d2880,0x10a,0,iVar3,&DAT_007a4ccc);
    if (iVar12 != 0) {
      pcVar2 = (code *)swi(3);
      (*pcVar2)();
      return;
    ...
    FUN_006a5e40(iVar3,0,0x7d2880,0x10c);
    return;
  }
  if (DAT_00802a38 == 0) {
    FUN_006a5e40(-0x34,DAT_007ed77c,0x7d2880,0x9d);
  }
  if (DAT_0080879c == 0) {
