...

{
  ...
  if (local_EAX_82 != 0) {
    ...
    if (local_EAX_11609 == 0) {
      RaiseInternalException(local_EAX_82,0,"E:\\__titans\\Artem\\TLO_ai_fnd.cpp",0x3c2);
      ExceptionList = local_14;
      return local_EAX_82;
    }
  ...
  if (param_2[3] == 0) {
    pDVar10_mg0 = Library::DKW::TBL::DArrayCreate(nullptr,10,0x14,10);
    param_2[3] = (int)pDVar10_mg0;
  }
  if (param_2[5] == 0) {
    pDVar10_mg1 = Library::DKW::TBL::DArrayCreate(nullptr,10,0x14,10);
...
cf_break_loop_004B60CD:
    if (local_20_mg0 != nullptr) {
      DArrayDestroy(local_20_mg0);
    }
    puVar29 = local_24c;
    iVar20 = 0x42;
    do {
      if ((DArrayTy *)*puVar29 != nullptr) {
        DArrayDestroy((DArrayTy *)*puVar29);
      }
      puVar29 = puVar29 + 1;
      iVar20 = iVar20 + -1;
    } while (iVar20 != 0);
  ...
  if (local_4c[2] != 0) {
    *(undefined4 *)(&stack0xfffffc90 + iVar20) = 10;
    *(undefined4 *)(&stack0xfffffc8c + iVar20) = 0xc;
    *(undefined4 *)(&stack0xfffffc88 + iVar20) = 10;
    *(undefined4 *)(&stack0xfffffc84 + iVar20) = 0;
    *(undefined4 *)(&stack0xfffffc80 + iVar20) = 0x4b3e49;
    pDVar10_mg7 = Library::DKW::TBL::DArrayCreate
                            (*(DArrayTy **)(&stack0xfffffc84 + iVar20),
                             *(uint *)(&stack0xfffffc88 + iVar20),
    ...
    if ((g_array_007FA16C != nullptr) && (uVar24 = 0, 0 < (int)g_array_007FA16C->count)) {
      do {
        ...
        *(short **)(&stack0xfffffc88 + iVar20) = local_7c;
        pSVar5 = local_58;
        *(undefined4 *)(&stack0xfffffc84 + iVar20) = 0x4b3e89;
        /* ST_CALLSITE[004B3E84]: CALL 0x004018c5; direct=004018C5 STFishC::sub_004162B0 */
        STFishC::sub_004162B0
                  (pSVar5,*(short **)(&stack0xfffffc88 + iVar20),
                   *(short **)(&stack0xfffffc8c + iVar20),*(short **)(&stack0xfffffc90 + iVar20));
  ...
  if (local_4c[3] != 0) {
    ...
    *(undefined4 *)(&stack0xfffffc88 + iVar20) = 10;
    *(undefined4 *)(&stack0xfffffc84 + iVar20) = 0;
    *(undefined4 *)(&stack0xfffffc80 + iVar20) = 0x4b3f81;
    local_184_mg0 =
         Library::DKW::TBL::DArrayCreate
                   (*(DArrayTy **)(&stack0xfffffc84 + iVar20),*(uint *)(&stack0xfffffc88 + iVar20),
                    *(uint *)(&stack0xfffffc8c + iVar20),*(uint *)(&stack0xfffffc90 + iVar20));
    ...
    if ((pDVar11 != nullptr) && (uVar24 = 0, 0 < (int)pDVar11->count)) {
      do {
        ...
        *(short **)(&stack0xfffffc88 + iVar20) = local_7c;
        pSVar5 = local_58;
        *(undefined4 *)(&stack0xfffffc84 + iVar20) = 0x4b3fd7;
  ...
  *(undefined4 *)(&stack0xfffffc90 + iVar20) = 10;
  *(undefined4 *)(&stack0xfffffc8c + iVar20) = 0x30;
  *(undefined4 *)(&stack0xfffffc88 + iVar20) = 10;
  *(undefined4 *)(&stack0xfffffc84 + iVar20) = 0;
  *(undefined4 *)(&stack0xfffffc80 + iVar20) = 0x4b40eb;
  local_20_mg0 = Library::DKW::TBL::DArrayCreate
                           (*(DArrayTy **)(&stack0xfffffc84 + iVar20),
                            *(uint *)(&stack0xfffffc88 + iVar20),
                            *(uint *)(&stack0xfffffc8c + iVar20),
                            *(uint *)(&stack0xfffffc90 + iVar20));
      ...
      *(undefined4 *)(&stack0xfffffc90 + iVar20) = 0x4b47b2;
      ...
      while (local_58 = pSVar5, -1 < local_EAX_5085) {
        if (pSVar5 != nullptr) {
          ...
          *(short **)(&stack0xfffffc8c + iVar20) = local_8c;
          *(short **)(&stack0xfffffc88 + iVar20) = local_7c;
          *(undefined4 *)(&stack0xfffffc84 + iVar20) = 0x4b47da;
...
LAB_004b4bd1:
                    if (bVar31) {
                      *(uint *)(&stack0xfffffc90 + iVar20) = param_1;
                      *(undefined4 *)(&stack0xfffffc8c + iVar20) = 0x4b4be8;
                      /* ST_CALLSITE[004B4BE3]: CALL 0x004049b7; direct=004049B7 LookupRecordByte */
                      bVar8 = LookupRecordByte((&stack0xfffffc90)[iVar20]);
                      pDVar25 = local_184_mg0;
                      pDVar11 = local_22c;
                      local_270 = 0;
                      if (bVar8 == 3) {
...
LAB_004b4f55:
                        ...
                        *(uint *)(&stack0xfffffc90 + iVar20) = param_1;
                        *(undefined4 *)(&stack0xfffffc8c + iVar20) = 0x4b4c91;
                        /* ST_CALLSITE[004B4C8C]: CALL 0x004049b7; direct=004049B7 LookupRecordByte */
                        local_AL_6332 = LookupRecordByte((&stack0xfffffc90)[iVar20]);
                        ...
                        *(undefined4 *)(&stack0xfffffc90 + iVar20) = 0x4b4faa;
                        ...
                        while (local_20_mg0 = pDVar11, -1 < iVar27) {
                          ...
                          if (iVar15 == 4) {
                            ...
                            local_98 = local_138;
                            local_94 = local_254[0];
                            *(Global_sub_004B1120_param_2Enum **)(&stack0xfffffc90 + iVar20) =
                                 &local_a0;
                          ...
                          {
                            *(uint *)(&stack0xfffffc90 + iVar20) = param_1;
                            *(undefined4 *)(&stack0xfffffc8c + iVar20) = 0x4b55e5;
                            /* ST_CALLSITE[004B55E0]: CALL 0x004049b7; direct=004049B7 LookupRecordByte */
                            local_AL_8720 = LookupRecordByte((&stack0xfffffc90)[iVar20]);
...
LAB_004b5635:
                              ...
                              *(uint *)(&stack0xfffffc90 + iVar20) = param_1;
                              *(undefined4 *)(&stack0xfffffc8c + iVar20) = 0x4b562d;
                              /* ST_CALLSITE[004B5628]: CALL 0x004049b7; direct=004049B7 LookupRecordByte */
                              local_AL_8792 = LookupRecordByte((&stack0xfffffc90)[iVar20]);
                            ...
                            if (bVar31) {
                              ...
                              *(undefined4 *)(&stack0xfffffc88 + iVar20) = 0x4b5844;
                              ...
                              if (*piVar18 == 0) {
                                ...
                                *(undefined4 *)(&stack0xfffffc88 + iVar20) = 10;
                                *(undefined4 *)(&stack0xfffffc84 + iVar20) = 0;
                                *(undefined4 *)(&stack0xfffffc80 + iVar20) = 0x4b586a;
                                pDVar10_mgE = Library::DKW::TBL::DArrayCreate
                                                        (*(DArrayTy **)(&stack0xfffffc84 + iVar20),
                                                         *(uint *)(&stack0xfffffc88 + iVar20),
                                                         *(uint *)(&stack0xfffffc8c + iVar20),
                                                         *(uint *)(&stack0xfffffc90 + iVar20));
                            ...
                            if (bVar31) {
                              ...
                              *(undefined4 *)(&stack0xfffffc88 + iVar20) = 0x4b59b1;
                              ...
                              if (*piVar18 == 0) {
                                ...
                                *(undefined4 *)(&stack0xfffffc88 + iVar20) = 10;
                                *(undefined4 *)(&stack0xfffffc84 + iVar20) = 0;
                                *(undefined4 *)(&stack0xfffffc80 + iVar20) = 0x4b59d7;
                                pDVar10_mg10 = Library::DKW::TBL::DArrayCreate
                                                         (*(DArrayTy **)(&stack0xfffffc84 + iVar20),
                                                          *(uint *)(&stack0xfffffc88 + iVar20),
                                                          *(uint *)(&stack0xfffffc8c + iVar20),
                                                          *(uint *)(&stack0xfffffc90 + iVar20));
...
LAB_004b52b6:
                            ...
                            if (bVar31) {
                              ...
                              *(undefined4 *)(&stack0xfffffc88 + iVar20) = 0x4b5b1e;
                              ...
                              if (*piVar18 == 0) {
                                ...
                                *(undefined4 *)(&stack0xfffffc88 + iVar20) = 10;
                                *(undefined4 *)(&stack0xfffffc84 + iVar20) = 0;
                                *(undefined4 *)(&stack0xfffffc80 + iVar20) = 0x4b5b44;
                                pDVar10_mg12 = Library::DKW::TBL::DArrayCreate
                                                         (*(DArrayTy **)(&stack0xfffffc84 + iVar20),
                                                          *(uint *)(&stack0xfffffc88 + iVar20),
                                                          *(uint *)(&stack0xfffffc8c + iVar20),
                                                          *(uint *)(&stack0xfffffc90 + iVar20));
                          ...
                          if (*(int *)(&DAT_00790888 + local_108[0] * 4) == 10) {
                            ...
                            *(undefined4 *)(&stack0xfffffc90 + iVar20) = 0;
                            *(Global_sub_004B1120_param_2Enum *)(&stack0xfffffc8c + iVar20) =
                                 GVar17 - 0x32;
                            ...
                            if (uVar24 != 0) {
                              ...
                              *(undefined4 *)(&stack0xfffffc88 + iVar20) = 0x4b5c85;
                              ...
                              if (*piVar18 == 0) {
                                ...
                                *(undefined4 *)(&stack0xfffffc88 + iVar20) = 10;
                                *(undefined4 *)(&stack0xfffffc84 + iVar20) = 0;
                                *(undefined4 *)(&stack0xfffffc80 + iVar20) = 0x4b5cab;
                                pDVar10_mg14 = Library::DKW::TBL::DArrayCreate
                                                         (*(DArrayTy **)(&stack0xfffffc84 + iVar20),
                                                          *(uint *)(&stack0xfffffc88 + iVar20),
                                                          *(uint *)(&stack0xfffffc8c + iVar20),
                                                          *(uint *)(&stack0xfffffc90 + iVar20));
              ...
              if (uVar24 == param_1) {
                *(ushort *)(puVar30 + iVar28 * 2) =
                ...
                if (((iVar28 == 7) || (iVar28 == 8)) || (iVar28 == 9)) {
                  ...
                  *(short **)(&stack0xfffffc88 + iVar20) = local_7c;
                  pSVar5 = local_58;
                  *(undefined4 *)(&stack0xfffffc84 + iVar20) = 0x4b445f;
                  /* ST_CALLSITE[004B445A]: CALL 0x004018c5; direct=004018C5 STFishC::sub_004162B0 */
                  STFishC::sub_004162B0
                            (pSVar5,*(short **)(&stack0xfffffc88 + iVar20),
                             *(short **)(&stack0xfffffc8c + iVar20),
                             *(short **)(&stack0xfffffc90 + iVar20));
                  if (((local_7c[0] == local_11c) && (local_8c[0] == local_138)) &&
                    ...
                    if (*piVar18 == 0) {
                      ...
                      *(undefined4 *)(&stack0xfffffc88 + iVar20) = 10;
                      *(undefined4 *)(&stack0xfffffc84 + iVar20) = 0;
                      *(undefined4 *)(&stack0xfffffc80 + iVar20) = 0x4b44b4;
                      pDVar10_mg9 = Library::DKW::TBL::DArrayCreate
                                              (*(DArrayTy **)(&stack0xfffffc84 + iVar20),
                                               *(uint *)(&stack0xfffffc88 + iVar20),
                                               *(uint *)(&stack0xfffffc8c + iVar20),
                                               *(uint *)(&stack0xfffffc90 + iVar20));
                  ...
                  *(short **)(&stack0xfffffc88 + iVar20) = local_7c;
                  pSVar5 = local_58;
                  *(undefined4 *)(&stack0xfffffc84 + iVar20) = 0x4b43c9;
