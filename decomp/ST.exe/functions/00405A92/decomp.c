...
void __thiscall thunk_FUN_00444e70(void *this,undefined4 *param_1)
  ...
  *(undefined4 *)((int)this + 0x1c) = *param_1;
  do {
    ...
    do {
      if (*piStack_10 == -1) {
        *(undefined4 *)((int)&DAT_007f4e2f + iVar5 + iVar6) = 0;
        ...
        uVar1 = FUN_006b0060((uint *)0x0,(uint *)(*piStack_10 + (int)param_1));
    ...
    *(int *)((int)&DAT_007f4e47 + iVar5) = piVar4[0xb];
    ...
    piStack_10 = piStack_8 + 0x5b;
    do {
      piVar4[-1] = piStack_10[-1];
      *piVar4 = *piStack_10;
      *(short *)(piVar4 + 1) = (short)piStack_10[1];
      *(undefined2 *)((int)piVar4 + 10) = *(undefined2 *)((int)piStack_10 + 0xe);
      if (*(int *)((int)piStack_10 + 6) == -1) {
        *(undefined4 *)((int)piVar4 + 6) = 0;
      }
      else {
        uVar1 = FUN_006b0060((uint *)0x0,(uint *)(*(int *)((int)piStack_10 + 6) + (int)param_1));
        *(undefined4 *)((int)piVar4 + 6) = uVar1;
      }
      piVar4[0x13] = piStack_10[0x18];
      piVar4[0x14] = piStack_10[0x19];
      *(short *)(piVar4 + 0x15) = (short)piStack_10[0x1a];
      *(undefined2 *)((int)piVar4 + 0x5a) = *(undefined2 *)((int)piStack_10 + 0x72);
      if (*(int *)((int)piStack_10 + 0x6a) == -1) {
        *(undefined4 *)((int)piVar4 + 0x56) = 0;
      }
      else {
        uVar1 = FUN_006b0060((uint *)0x0,(uint *)(*(int *)((int)piStack_10 + 0x6a) + (int)param_1));
    ...
    piStack_14 = piVar10 + 0x8e;
    *(int *)((int)&DAT_007f5023 + iVar5) = piVar10[0x8c];
    piVar4 = (int *)((int)&DAT_007f502b + iVar5);
    piStack_10 = (int *)0xa;
    do {
      piVar4[-1] = piStack_14[-1];
      *piVar4 = *piStack_14;
      *(short *)(piVar4 + 1) = (short)piStack_14[1];
      *(undefined2 *)((int)piVar4 + 10) = *(undefined2 *)((int)piStack_14 + 0xe);
      if (*(int *)((int)piStack_14 + 6) == -1) {
        *(undefined4 *)((int)piVar4 + 6) = 0;
      }
      else {
        uVar1 = FUN_006b0060((uint *)0x0,(uint *)(*(int *)((int)piStack_14 + 6) + (int)param_1));
        *(undefined4 *)((int)piVar4 + 6) = uVar1;
      }
    ...
    *(undefined4 *)((int)&DAT_007f55f6 + iVar5) = *(undefined4 *)((int)piStack_8 + 0x827);
    puVar8 = (undefined4 *)((int)piStack_8 + 0x82b);
    ...
    *(undefined4 *)((int)&DAT_007f5792 + iVar5) = *(undefined4 *)((int)piStack_8 + 0x9c3);
    *(undefined4 *)((int)&DAT_007f5796 + iVar5) = *(undefined4 *)((int)piStack_8 + 0x9c7);
    puVar8 = (undefined4 *)((int)piStack_8 + 0x9cb);
    ...
    *(undefined4 *)((int)&DAT_007f57b6 + iVar5) = *(undefined4 *)((int)piStack_8 + 0x9e3);
    *(undefined4 *)((int)&DAT_007f57ba + iVar5) = *(undefined4 *)((int)piStack_8 + 0x9e7);
    *(undefined4 *)((int)&DAT_007f57be + iVar5) = *(undefined4 *)((int)piStack_8 + 0x9eb);
    piStack_14 = (int *)0x6;
    puVar8 = (undefined4 *)((int)piStack_8 + 0x9ef);
    ...
    piVar4 = (int *)((int)piStack_8 + 0xa77);
    piStack_10 = (int *)0x0;
    do {
    ...
    puVar8 = (undefined4 *)((int)piStack_8 + 0xa17);
    ...
    puVar8 = (undefined4 *)((int)piStack_8 + 0xa2b);
    ...
    puVar8 = (undefined4 *)((int)piStack_8 + 0xa4b);
    ...
    *(undefined4 *)((int)&DAT_007f582a + iVar5) = *(undefined4 *)((int)piStack_8 + 0xa73);
    if (*(int *)((int)piStack_8 + 0xa6b) == -1) {
      ...
      *(uint **)((int)&DAT_007f5816 + iVar5) = puVar2;
      piStack_10 = (int *)0x0;
      if (uVar7 != 0) {
        piVar4 = (int *)((int)param_1 + *(int *)((int)piStack_8 + 0xa6b) + 0x10);
        do {
          uStack_20 = 0;
          if (piVar4[-4] != -1) {
            uStack_20 = FUN_006b0060((uint *)0x0,(uint *)(piVar4[-4] + (int)param_1));
          }
          uStack_1c = 0;
          if (piVar4[-2] != -1) {
            uStack_1c = FUN_006b0060((uint *)0x0,(uint *)(piVar4[-2] + (int)param_1));
          }
          uStack_18 = 0;
          if (*piVar4 != -1) {
    ...
    iVar5 = iVar5 + 0xa62;
    piVar4 = (int *)((int)piStack_8 + 0xaab);
  } while (iVar5 < 0x5310);
