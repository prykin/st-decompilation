...

{
  ...
  if ((*(uint *)(param_1 + 0xc) & 0x1100) != 0x100) {
    ...
    if (iVar2 != 0) {
      iVar3 = param_7 + ((local_30 - *(int *)(param_1 + 0x10)) - param_2);
      ...
      if (exceptionCode == 0) {
        ...
        FUN_006dac70((undefined1 *)
                     ...
                     *(int *)(param_1 + 0x478),
                     (byte *)(((int)(iVar3 + (iVar3 >> 0x1f & 7U)) >> 3) +
                             param_4 + ((int)((iVar2 >> 0x1f & 7U) + iVar2) >> 3)),param_5,
                     (byte)iVar3,param_9,param_10,param_11);
        local_8 = 0xffffffff;
    ...
    if (exceptionCode != 0) {
      RaiseInternalException(exceptionCode,DAT_007ed77c,s_E__DKW_DDX_C_ddbitmpu_c_007ee400,0x177);
      ExceptionList = local_14;
