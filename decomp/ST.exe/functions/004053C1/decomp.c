  ...
  if (exceptionCode == 0) {
    ...
    *(undefined4 *)((int)puStack_8 + 0x23f) = 0x3fffffff;
    if (*(int *)((int)puStack_8 + 0x1eb) == 0) {
      puVar1 = FUN_006ae290((uint *)0x0,10,0x2c,10);
      *(uint **)((int)puStack_8 + 0x1eb) = puVar1;
    }
    if (*(int *)((int)puStack_8 + 0x203) == 0) {
      puVar1 = FUN_006ae290((uint *)0x0,10,0x14,10);
      *(uint **)((int)puStack_8 + 0x203) = puVar1;
    }
    if (*(int *)((int)puStack_8 + 0x20f) == 0) {
      puVar1 = FUN_006ae290((uint *)0x0,10,0xc,10);
      *(uint **)((int)puStack_8 + 0x20f) = puVar1;
    }
