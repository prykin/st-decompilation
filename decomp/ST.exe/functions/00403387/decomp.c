...
uint * __cdecl thunk_FUN_0067e7e0(int param_1,int param_2)

{
  ...
  puVar12 = (undefined4 *)auStack_33c;
  ...
  do {
    ...
    if (puStack_c != (ushort *)0x0) {
      ...
      if (iStack_18 == 0) {
        ...
        wsprintfA(acStack_c8,(LPCSTR)abStack_5c,iVar7);
      }
      uVar8 = 0;
      uStack_a8 = *(uint *)(puStack_c + 0x29);
      if (uStack_a8 == 0) {
        uStack_a8 = 1;
      }
      uStack_a4 = 0;
      ...
      if (param_2 != 0) {
        ...
        if (0 < (int)uVar9) {
          ...
          do {
            if (bVar16) {
              iVar7 = puStack_10[2] * uVar8 + puStack_10[7];
            }
            else {
              iVar7 = 0;
            }
            if ((iVar7 != 0) && ((*(uint *)(iVar7 + 0x90) & uStack_a8) != 0)) {
        ...
        if (((bVar4) && (iStack_14 != 0)) && (iStack_1c != 0)) {
          bVar4 = true;
        }
        else {
          bVar4 = false;
