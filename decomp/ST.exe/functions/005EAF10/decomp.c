  ...
  if (local_EAX_16 != 0xffff) {
    ...
    if (iVar8 == 0) {
      ...
      if (MESS_TORPHIT < SVar4) {
        ...
        case MESS_HITKILL:
          ...
          case 3:
            ...
            uVar10 = thunk_FUN_004ad650((STT3DSprC *)&this_00->vtable_at_1d5);
            thunk_FUN_006377b0(uVar10,iVar18,iVar19,iVar20,iVar13,uVar21);
            g_currentExceptionFrame = local_60.previous;
            return 0;
          case 5:
          ...
          default:
            ...
            if (-1 < this_00->field_02D6) {
              ...
              STT3DSprC::sub_004AD430((STT3DSprC *)&this_00->vtable_at_1d5);
            }
      ...
      if (SVar4 == MESS_SHARED_0003) {
        ...
        STAllPlayersC::UnRegisterArtefact
                  (g_allPlayers_007FA174,CONCAT22(extraout_var,this_00->field_0032),
                   (RecoveredRecordView_00449E60_60F0F4F3 *)this_00);
        g_currentExceptionFrame = local_60.previous;
        return 0;
      }
      if (SVar4 != MESS_ID_NONE) {
        ...
        iVar13 = thunk_FUN_005ebd80((RecoveredRecordView_005EBD80_8404A6E9 *)local_8);
        if (iVar13 == 0) {
        ...
        if (g_allPlayers_007FA174 != nullptr) {
          ...
          thunk_FUN_005ec6a0((RecoveredRecordView_005EC6A0_14461677 *)this_00);
        }
      ...
      uVar9 = thunk_FUN_005ee6e0((RecoveredRecordView_005EE6E0_769300DA *)local_8);
      ...
      if ((char)uVar9 != '\0') {
        ...
        thunk_FUN_005f0310((RecoveredRecordView_005F0310_7C41AA23 *)this_00);
        g_currentExceptionFrame = local_60.previous;
        return 0;
      }
