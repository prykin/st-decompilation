...
undefined4 FUN_005eaf10(int param_1)

{
  ...
  if (iVar7 != 0xffff) {
    ...
    if (iVar7 == 0) {
      ...
      if (0x110 < uVar9) {
        uVar12 = (undefined3)((uint)param_1 >> 8);
        switch(uVar9) {
        case 0x112:
        ...
        case 0x128:
          ...
          *(undefined1 *)((int)local_8 + 0x315) = *(undefined1 *)(iVar7 + 0x18);
          if (((*(char *)((int)local_8 + 0x24e) != '\0') && (*(short *)((int)local_8 + 0x2ab) != -1)
                    ...
                    (this = (void *)thunk_FUN_0042b620(CONCAT31(uVar12,*(undefined1 *)
                                                                        ((int)local_8 + 0x2a3)),
          ...
          case 3:
            ...
            *(undefined4 *)((int)local_8 + 0x23a) = 5;
            ...
            thunk_FUN_006377b0(uVar9,iVar17,iVar18,iVar10,iVar7,uVar19);
            DAT_00858df8 = (undefined4 ****)local_60;
            return 0;
          case 5:
      ...
      if (uVar9 == 3) {
        ...
        thunk_FUN_005f0d00((int)local_8);
        thunk_FUN_00449e60(CONCAT22(extraout_var_00,*(undefined2 *)((int)local_8 + 0x32)),
                           (uint)local_8);
        DAT_00858df8 = (undefined4 ****)local_60;
        return 0;
      }
      if (uVar9 != 0) {
        ...
        puVar4 = *(undefined4 **)(param_1 + 0x14);
        if (puVar4[3] == 2) {
          iVar7 = thunk_FUN_005ec4a0(local_8,puVar4);
          if (iVar7 < 0) {
            DAT_00858df8 = (undefined4 ****)local_60;
            return 0;
          }
          ...
          if ((DAT_007fa174 != 0) &&
             (iVar7 = thunk_FUN_00449ce0(*(ushort *)((int)local_8 + 0x32),local_8), iVar7 != 0)) {
            thunk_FUN_005ebcb0(local_8);
          }
          thunk_FUN_005ef5f0((int)local_8);
          thunk_FUN_005eeff0(local_8,0);
          if (*(char *)((int)local_8 + 0x2b9) == '\0') {
            DAT_00858df8 = (undefined4 ****)local_60;
            return 0;
          }
          thunk_FUN_004ad460((void *)((int)local_8 + 0x1d5),0);
          *(undefined1 *)((int)local_8 + 0x2b9) = 1;
          *(undefined1 *)((int)local_8 + 0x2de) = 0;
          DAT_00858df8 = (undefined4 ****)local_60;
          return 0;
        }
        puVar13 = puVar4;
        ...
        *(undefined1 *)puVar15 = *(undefined1 *)puVar13;
        if (puVar4[3] == 0) {
          *(int *)((int)local_8 + 0x46b) = (int)*(short *)((int)local_8 + 0x34a);
          *(int *)((int)local_8 + 0x46f) = (int)(short)local_8[0xd3];
          *(int *)((int)local_8 + 0x473) = (int)*(short *)((int)local_8 + 0x34e);
          *(short *)((int)local_8 + 0x34a) = *(short *)((int)local_8 + 0x34a) * 0xc9 + 100;
          *(short *)(local_8 + 0xd3) = (short)local_8[0xd3] * 0xc9 + 100;
          *(short *)((int)local_8 + 0x34e) = *(short *)((int)local_8 + 0x34e) * 200 + 100;
        }
        ...
        if (DAT_007fa174 != 0) {
          iVar7 = thunk_FUN_00449ce0(0xffff,local_8);
          if (iVar7 != 0) {
            thunk_FUN_005ebcb0(local_8);
            DAT_00858df8 = (undefined4 ****)local_60;
            return 0;
          ...
          *(undefined1 *)(local_8 + 0xb9) = 1;
          thunk_FUN_005ec6a0((int)local_8);
        }
        if (*(int *)((int)local_8 + 0x346) != 3) {
          if (*(int *)((int)local_8 + 0x346) != 5) {
            DAT_00858df8 = (undefined4 ****)local_60;
            return 0;
          }
        ...
        thunk_FUN_006377b0(*(uint *)((int)local_8 + 0x1ed),1,(int)*(short *)((int)local_8 + 0x34a),
                           (int)(short)local_8[0xd3],(int)*(short *)((int)local_8 + 0x34e),0x13);
        DAT_00858df8 = (undefined4 ****)local_60;
        return 0;
      }
      if (*(int *)((int)local_8 + 0x23a) == 6) {
      ...
      uVar8 = thunk_FUN_005ee6e0(local_8);
      *(char *)((int)local_8 + 0x2de) = (char)uVar8;
      if ((char)uVar8 != '\0') {
        ...
        *(undefined4 *)((int)local_8 + 0x2c6) = *(undefined4 *)((int)local_8 + 0x27f);
        ...
        thunk_FUN_005eeff0(local_8,0);
        if ((char)local_8[200] == '\0') {
          DAT_00858df8 = (undefined4 ****)local_60;
          return 0;
        }
        thunk_FUN_005f0310(local_8);
        DAT_00858df8 = (undefined4 ****)local_60;
        return 0;
      }
      if (*(int *)((int)local_8 + 0x23a) != 6) {
    ...
    DAT_00858df8 = (undefined4 ****)local_60;
    iVar10 = FUN_006ad4d0(s_E____titans_nick_to_artf_cpp_007ce4ec,0x1b2,0,iVar7,&DAT_007a4ccc);
    if (iVar10 != 0) {
      pcVar5 = (code *)swi(3);
      uVar8 = (*pcVar5)();
      return uVar8;
    }
    FUN_006a5e40(iVar7,0,0x7ce4ec,0x1b4);
  }
  return 0xffff;
...
switchD_005eb5ad_caseD_129:
  ...
  if ((*(short *)((int)local_8 + 0x2ab) == -1) &&
     (iVar7 = FUN_006e62d0(DAT_00802a38,iVar7,&local_14), uVar12 = extraout_var, iVar7 != -4)) {
    iVar7 = CONCAT22((short)((uint)iVar7 >> 0x10),*(undefined2 *)(local_14 + 0x32));
    *(undefined2 *)((int)local_8 + 0x2ab) = *(undefined2 *)(local_14 + 0x32);
  }
  if (*(short *)((int)local_8 + 0x2ab) == -1) {
    DAT_00858df8 = (undefined4 ****)local_60;
    return 0;
  }
  uVar9 = *(uint *)((int)local_8 + 0x2ad);
  if ((uVar9 != 0) ||
     (uVar9 = thunk_FUN_0042b620(CONCAT31(uVar12,*(undefined1 *)((int)local_8 + 0x2a3)),
                                 CONCAT22((short)((uint)iVar7 >> 0x10),
                                          *(short *)((int)local_8 + 0x2ab)),1), uVar9 != 0)) {
    *(int *)((int)local_8 + 0x277) = (int)*(short *)(uVar9 + 0x41);
    *(int *)((int)local_8 + 0x27b) = (int)*(short *)(uVar9 + 0x43);
    *(int *)((int)local_8 + 0x27f) = (int)*(short *)(uVar9 + 0x45);
    *(int *)((int)local_8 + 0x2ba) = (int)*(short *)(uVar9 + 0x6c) / 0xf;
    piVar14 = (int *)(uVar9 + 0x34);
    piVar16 = local_8 + 0xd;
    ...
    *(undefined2 *)((int)local_8 + 0x6e) = 0x2f;
    *(undefined4 *)((int)local_8 + 0x2be) = *(undefined4 *)((int)local_8 + 0x277);
    *(undefined4 *)((int)local_8 + 0x2c2) = *(undefined4 *)((int)local_8 + 0x27b);
    *(undefined4 *)((int)local_8 + 0x2c6) = *(undefined4 *)((int)local_8 + 0x27f);
  }
