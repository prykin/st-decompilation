    ...
    if (iVar6 == 0) {
        ...
        case 0x128:
          ...
          case 3:
            ...
            *(int *)&this_00->field_0x2e0 = PTR_00802a38->field_00E4 + 0x15;
            ...
            thunk_FUN_006377b0(uVar8,iVar16,iVar17,iVar10,iVar6,uVar18);
            g_currentExceptionFrame = local_60.previous;
            return 0;
          case 5:
      ...
      if (uVar8 == 3) {
        ...
        STAllPlayersC::UnRegisterArtefact
                  (g_sTAllPlayers_007FA174,CONCAT22(extraout_var,this_00->field_0032),
...
switchD_005eb5ad_caseD_129:
  ...
  if ((local_8->field_02AB == -1) &&
     (iVar6 = FUN_006e62d0(PTR_00802a38,iVar6,&local_14), iVar6 != -4)) {
    /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
  ...
  if ((pSVar9 != (STGameObjC *)0x0) ||
     (pSVar9 = STAllPlayersC::GetObjPtr
                         (g_sTAllPlayers_007FA174,this_00->field_02A3,
    ...
    puVar13 = (undefined4 *)&pSVar9->field_0x34;
