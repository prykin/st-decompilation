...

{
  ...
  if (param_1 == '\0') {
    ...
    StartServTy::WrTextDDX(this_02,0,0xe9,0x14,0x14c,0x18,pcVar4,uVar14,uVar18,pcVar20,uVar22);
    ...
    wsprintfA((LPSTR)(this_00->field_1A5B + 0x3c),pcVar4,uVar14,uVar22,uVar18);
    ...
    StartServTy::WrTextDDX(this_01,0,0xe9,0x14,0x14c,0x18,pcVar4,uVar14,uVar18,pcVar20,uVar22);
  }
  if (param_2 != 0) {
...
LAB_005b4465:
    ...
    StartServTy::WrTextDDX(this_03,0,0xe9,0x14,0x14c,0x18,pcVar4,uVar14,uVar18,pcVar20,uVar22);
  }
