...
void __thiscall FUN_005b3d60(void *this,char param_1,int param_2)

{
  ...
  local_c = this;
  iVar9 = __setjmp3(local_4c,0,unaff_EDI,unaff_ESI);
  this_00 = local_c;
  if (iVar9 != 0) {
    DAT_00858df8 = local_50;
  ...
  *(char *)((int)local_c + 0x1ee3) = param_1;
  if (param_1 == '\0') {
    uVar20 = 0xffffffff;
    uVar18 = 7;
    iVar17 = -1;
    iVar16 = -1;
    iVar15 = 1;
    *(undefined1 *)((int)local_c + 0x9a) = 5;
    uVar13 = 0xffffffff;
    *(undefined4 *)((int)local_c + 0xbc) = 0x2334;
    iVar9 = *(int *)((int)local_c + 0x174);
    uVar12 = 0xfffffffe;
    iVar11 = 0x28;
    iVar5 = 0x8c;
    ...
    *(undefined1 *)((int)local_c + 0x9a) = 5;
    uVar13 = 0xffffffff;
    *(undefined4 *)((int)local_c + 0xbc) = 0x233c;
    iVar9 = *(int *)((int)local_c + 0x174);
    uVar12 = 0xfffffffe;
    iVar11 = 0x28;
    iVar5 = 0x8c;
    ...
    *(undefined1 *)((int)puVar7 + 2) = 0;
    local_155 = *(undefined4 *)((int)this_00 + 8);
    ...
    *(undefined4 *)((int)this_00 + 0x8c1) = 1;
    ...
    if (pvVar19 != (void *)0x0) {
      thunk_FUN_005b87d0(pvVar19,0,(int)&local_24c,0,0);
    }
    FUN_006ba9e0(DAT_0080759c,0xe9,0x14,0x14c,0x18,0);
    uVar18 = 0;
    pvVar19 = *(void **)(DAT_0081176c + 0x30);
