...

{
  ...
  do {
    ...
    FUN_006ab060((LPVOID *)(param_1 + 0x108));
    param_1[0x10a] = 0;
    param_1[0x10b] = 0;
    param_1[0x10c] = 0;
    param_1[0x10d] = 0;
    ...
    *(undefined4 *)((int)param_1 + 0x4da) = 0;
    FUN_006ab060((LPVOID *)(param_1 + 0xe2));
    if (param_1[199] != 0) {
      uVar1 = 0;
      if (0 < param_1[0xc4]) {
        do {
          ...
          FUN_006a5e90(*(short **)(iVar2 + 0xec + param_1[199]));
          uVar1 = uVar1 + 1;
          iVar2 = iVar2 + 0x114;
        } while ((int)uVar1 < param_1[0xc4]);
      }
      FUN_006ab060((LPVOID *)(param_1 + 199));
      FUN_006ab060((LPVOID *)(param_1 + 0xcc));
    }
    param_1[0xb8] = 0;
    *param_1 = 0;
    param_1[0xc4] = 0;
    ...
    param_1[0xb7] = 0;
    param_1[0xaa] = 0;
    FUN_006ab060((LPVOID *)(param_1 + 2));
    FUN_006ab060((LPVOID *)(param_1 + 4));
    FUN_006ab060((LPVOID *)(param_1 + 6));
    FUN_006ab060((LPVOID *)(param_1 + 0x56));
    FUN_006ab060((LPVOID *)(param_1 + 0x55));
    FUN_006ab060((LPVOID *)(param_1 + 7));
    FUN_006ab060((LPVOID *)(param_1 + 0xd4));
    FUN_006ab060((LPVOID *)(param_1 + 0xd5));
    FUN_006ab060((LPVOID *)(param_1 + 0xac));
