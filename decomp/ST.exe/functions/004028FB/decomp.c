...

{
  ...
  if (iVar3 != 0) {
    ...
    if (iVar3 != -0x5001fff7) {
      iVar5 = FUN_006ad4d0(s_E____titans_wlad_to_allpl_cpp_007a6004,0x10e,0,iVar3,&DAT_007a4ccc);
      if (iVar5 != 0) {
        pcVar2 = (code *)swi(3);
        (*pcVar2)();
        return;
      }
      FUN_006a5e40(iVar3,0,0x7a6004,0x10f);
    }
    return;
  }
  if (((((param_6 == (int *)0x0) && (param_7 == (int *)0x0)) && (param_8 == (int *)0x0)) &&
    ...
    FUN_006a5e40(-0x5001fff7,DAT_007ed77c,0x7a6004,0xb7);
  }
  ...
  if (0 < iStack_8) {
    iStack_10 = 0;
    do {
      piVar7 = *(int **)(iVar3 + 4 + (int)puStack_c);
      uVar1 = piVar7[8];
      if (uVar1 < 0x1a5) {
        if (uVar1 == 0x1a4) {
...
LAB_0042b01f:
          ...
          if (((param_14 != (int *)0x0) &&
              (*(int *)(iVar3 + (int)puStack_c) == *(int *)((int)piVar7 + 0x1ed))) &&
