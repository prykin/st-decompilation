...

{
  ...
  if (((SVar2 == CASE_6) || (SVar2 == CASE_7)) || (SVar2 == CASE_E)) {
    ...
    if (DAT_0080877e != '\0') {
      ...
      uVar8 = MMObjTy::CreateSprBut((MMObjTy *)this_00,1,1,0x24,0x1b4,0xcc,0x1e,0x6905,0x6985);
    ...
    pcVar6 = Library::Ourlib::MF32INT::FUN_006f0ec0(0x345,(byte *)&CHAR_00h_0080ed16,0,0,0);
