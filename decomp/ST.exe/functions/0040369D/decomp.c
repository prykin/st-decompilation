...
short thunk_FUN_00435b90(uint param_1,int param_2,undefined4 param_3,int *param_4,undefined4 param_5
                        ,undefined4 param_6)

{
  ...
  if (0 < iVar9) {
    ...
    if (iStack_c == 1) {
      piVar7 = (int *)STAllPlayersC::GetObjPtr(in_ECX,uVar4,uStack_10,1);
