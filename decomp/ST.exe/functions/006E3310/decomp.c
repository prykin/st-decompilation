...

{
  ...
  if ((-1 < param_1) && (piVar4 = param_2, -1 < (int)param_2)) {
    ...
    if ((-1 < iVar3) && (iVar1 = *(int *)&this->field_0x284, iVar3 < iVar1)) {
      piVar4 = (int *)((int)param_2 / iVar2);
      if ((-1 < (int)piVar4) && ((int)piVar4 < iVar1)) {
        iVar6 = 5;
        piVar5 = (int *)(*(int *)&this->field_0x280 + 0x459 +
                        (*(int *)&this->field_0x288 * 5 + iVar3 + iVar1 * (int)piVar4) * 4);
        do {
          piVar4 = (int *)*piVar5;
          ...
          iVar6 = iVar6 + -1;
          piVar5 = piVar5 + -*(int *)&this->field_0x288;
        } while (0 < iVar6);
      }
    }
  }
