...
void __thiscall FUN_00515e30(void *this,int *param_1,char param_2,int param_3,int param_4)

{
  ...
  local_28 = *(undefined4 *)(*(int *)((int)this + 0x24c) + 8);
  local_18 = *(int *)(*(int *)((int)this + 0x24c) + 4);
  local_14 = 1;
          ...
          if (local_24 != 0) {
            ...
            do {
              if (((*(char *)((int)piVar5 + -1) == local_5) && (*piVar5 == *local_c)) &&
                 (piVar5[1] == local_c[1])) {
                FUN_00710a90(*(int *)((int)this_00 + 0x218),0,local_18 + 0x5f,*param_1,
                             0x13d - local_18,0xf);
...
LAB_0051607e:
  ...
  local_2f = local_c[1];
  local_44 = 0x50;
  FUN_006ae1c0(*(uint **)((int)this_00 + 0x1d7),&local_44);
  local_1c = local_1c + 1;
