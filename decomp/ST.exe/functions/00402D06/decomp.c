...
int thunk_FUN_005f3940(int param_1,int param_2,int param_3)

{
  ...
  if ((((*(int *)(DAT_00807598 + 0x48) <= iVar4) && (iVar4 <= *(int *)(DAT_00807598 + 0x58))) &&
    ...
    iStack_8 = (&DAT_0079aed0)[param_2] + iStack_8;
    if (iStack_8 < 0) {
      return iVar3;
    }
    if (*(int *)((int)pvVar2 + 0x34) <= iStack_8) {
      return iVar3;
    }
    if (*(int *)((int)pvVar2 + 0x4c) == 0) {
      return iVar3;
    }
    if (*(char *)(iStack_8 * *(int *)((int)pvVar2 + 0x30) + *(int *)((int)pvVar2 + 0x4c) + param_3)
        != '\0') {
      return iVar3;
    }
  }
