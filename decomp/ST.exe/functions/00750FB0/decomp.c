...

{
  ...
  local_EAX_64 = FUN_00753c80((AnonShape_00753C80_4C8E695D *)param_1,(int)STField<short>(iVar3,0x8));
  if (-1 < local_EAX_64) {
    iVar1 = FUN_00753c80((AnonShape_00753C80_4C8E695D *)param_1,(int)STField<short>(iVar3,0x8));
    ...
    while (iVar2 != -1) {
      ...
      local_EAX_125 =
           FUN_00753c80((AnonShape_00753C80_4C8E695D *)param_1,(int)STField<short>(iVar3,0x8));
