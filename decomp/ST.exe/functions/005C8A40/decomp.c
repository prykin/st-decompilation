          ...
          *(uint *)(this_00 + 0x1dad) = uVar14;
          if (*(uint *)(this_00 + 0x1d91) != 0xffffffff) {
            Library::DKW::DDX::FUN_006b3730
                      (*(uint **)(this_00 + 0x1dd5),*(uint *)(this_00 + 0x1d91),
...
LAB_005c8ecc:
        ...
        case 0:
          ...
          *(undefined4 *)(this_00 + 0x2d) = 5;
          ...
          if ((DAT_008067a0 != '\0') && (DAT_00811764 != 0)) {
            ...
            *(undefined4 *)(this_00 + 0x1a82) = local_64;
            *(undefined4 *)(this_00 + 0x1a86) = local_60;
            Library::MSVCRT::_strncpy((char *)(this_00 + 0x1a8a),(char *)&DAT_0080c3c3,0x1d5);
    ...
    case 0x6545:
      ...
      *(undefined4 *)(this_00 + 0x1f37) = 0;
      Library::DKW::TBL::FUN_006ae1c0(*(uint **)(this_00 + 0x1e2f),(undefined4 *)(this_00 + 0x1e33))
      ;
    ...
    case 0x6546:
      if (this_00[0x65] == (SettMapTy)0x1) {
        ...
        *(undefined4 *)(this_00 + 0x1f37) = 100;
        ...
        Library::DKW::TBL::FUN_006ae1c0(*(uint **)(this_00 + 0x1e2f),(undefined4 *)pSVar17);
  ...
  case 0x6901:
    if (this_00[0x65] == (SettMapTy)0x1) {
      if ((DAT_00807dd1 & 0xffff0000) == 0xd0dd0000) {
        ...
        local_c = *(int **)(*(int *)(this_00 + 0x1f7c) + 0xc);
      }
      *(undefined4 *)(this_00 + 0x2171) = 0x64ff;
      *(int *)(this_00 + 0x2179) = *(int *)(param_1 + 0x10) + -0x68ff;
      *(undefined4 *)(this_00 + 0x2191) = 0x6500;
...
LAB_005c9c8a:
  ...
  case 0x6947:
    ...
    if (*(int *)(*(int *)(this_00 + 0x1a5b) + 0x2e6) != 0) {
      ...
      local_50 = 0;
      local_4c = 0;
      thunk_FUN_005b8f40(*(void **)(*(int *)(this_00 + 0x1a5b) + 0x2e6),&local_58);
    }
    break;
  case 0x6948:
  ...
  case 0x694f:
    ...
    if (*(int *)(*(int *)(this_00 + 0x1a5b) + 0x2e6) != 0) {
      ...
      local_40 = 0;
      local_3c = 0;
      thunk_FUN_005b8f40(*(void **)(*(int *)(this_00 + 0x1a5b) + 0x2e6),&local_48);
    }
    break;
  case 0x6951:
...
LAB_005c9e75:
  ...
  case 0x6984:
    ...
    local_c = *(int **)(*(int *)(this_00 + 0x1e2b) + 4);
    local_34 = *(int *)(*(int *)(this_00 + 0x1e2b) + 8);
    switch(uVar14) {
    case 0x697f:
      if (this_00[0x1f57] == (SettMapTy)0x0) {
        UVar22 = 0x234b;
    ...
    case 0x6980:
      uVar5 = FUN_006b0140(0x2354,DAT_00807618);
      wsprintfA((LPSTR)local_98,s__d__s_007c2864,(uint)(byte)this_00[0x1f5c],uVar5);
      goto LAB_005ca73b;
    case 0x6981:
      iVar6 = *(int *)(this_00 + 0x1f7c);
...
LAB_005ca73b:
    ...
    local_24 = local_8[3];
    MMObjTy::PaintButDib
              ((MMObjTy *)this_00,*(int *)(this_00 + 0x1c67),&local_30,2,
               (-(*(short *)(param_1 + 0x14) != 0) & 0xfcU) + 0x23,0x67);
    thunk_FUN_00540760(*(undefined4 **)(this_00 + 0x1c67),(local_28 - (int)local_c) + -8 + local_30,
                       (local_24 - local_34) / 2 + local_2c,'\x06',*(byte **)(this_00 + 0x1e2b));
    ...
    ccFntTy::WrStr(*(ccFntTy **)(DAT_0081176c + 0x34),local_98,-1,-1,iVar6);
    FUN_006b35d0(DAT_008075a8,*(uint *)(this_00 + 0x1f80));
...
switchD_005c8bd0_caseD_6120:
  ...
  MMObjTy::PaintButDib
            ((MMObjTy *)this_00,*(int *)(this_00 + 0x1e1e),&local_1c,2,
             (-(*(short *)(param_1 + 0x14) != 0) & 0xfcU) + 0x23,0x67);
  switch(uVar14) {
  case 0x657f:
    SVar1 = this_00[0x1e26];
    ...
    ccFntTy::SetSurf(*(ccFntTy **)(DAT_0081176c + 0x34),*(int *)(this_00 + 0x1e1e),0,local_1c,
