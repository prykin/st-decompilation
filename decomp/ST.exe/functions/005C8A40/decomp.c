...
undefined4 __thiscall FUN_005c8a40(void *this,int param_1)
        ...
        case 0:
          ...
          *(undefined4 *)((int)this_00 + 0x2d) = 5;
          ...
          if ((DAT_008067a0 != '\0') && (DAT_00811764 != 0)) {
            ...
            *(undefined4 *)((int)this_00 + 0x1a82) = local_64;
            *(undefined4 *)((int)this_00 + 0x1a86) = local_60;
        ...
        *(undefined4 *)(*(int *)((int)this_00 + 0x1e2f) + 0xc) = 0;
        ...
        if (piVar16[3] != 0) {
          do {
            ...
            if (pcVar8 != (char *)0x0) {
              *(int **)((int)this_00 + 0x1f37) = local_8;
              uVar14 = 0xffffffff;
              do {
                pcVar18 = pcVar8;
                if (uVar14 == 0) break;
...
LAB_005c9c8a:
  ...
  case 0x6947:
    ...
    if (*(int *)(*(int *)((int)this_00 + 0x1a5b) + 0x2e6) != 0) {
      ...
      local_50 = 0;
      local_4c = 0;
      thunk_FUN_005b8f40(*(void **)(*(int *)((int)this_00 + 0x1a5b) + 0x2e6),&local_58);
    }
    break;
  case 0x6948:
  ...
  case 0x694f:
    ...
    *(undefined1 *)(this_00 + 0x879) = 0;
    ...
    if (*(int *)(*(int *)((int)this_00 + 0x1a5b) + 0x2e6) != 0) {
      ...
      local_40 = 0;
      local_3c = 0;
      thunk_FUN_005b8f40(*(void **)(*(int *)((int)this_00 + 0x1a5b) + 0x2e6),&local_48);
    }
    break;
  case 0x6951:
...
LAB_005c9e75:
  ...
  case 0x6984:
    ...
    local_c = *(int **)(*(int *)((int)this_00 + 0x1e2b) + 4);
    local_34 = *(int *)(*(int *)((int)this_00 + 0x1e2b) + 8);
    switch(uVar14) {
    case 0x697f:
      if (*(char *)((int)this_00 + 0x1f57) == '\0') {
        UVar20 = 0x234b;
    ...
    case 0x6980:
      uVar5 = FUN_006b0140(0x2354,DAT_00807618);
      wsprintfA((LPSTR)local_98,s__d__s_007c2864,(uint)*(byte *)(this_00 + 0x7d7),uVar5);
      goto LAB_005ca73b;
    case 0x6981:
      iVar6 = this_00[0x7df];
...
LAB_005ca73b:
    ...
    FUN_007119c0(local_98,-1,-1,iVar6);
    FUN_006b35d0(DAT_008075a8,this_00[0x7e0]);
...
switchD_005c8bd0_caseD_6120:
  ...
  thunk_FUN_005b5a30(*(int *)((int)this_00 + 0x1e1e),&local_1c,2,
                     (-(*(short *)(param_1 + 0x14) != 0) & 0xfcU) + 0x23,0x67);
  switch(uVar14) {
  case 0x657f:
    cVar4 = *(char *)((int)this_00 + 0x1e26);
    ...
    FUN_00710a90(*(int *)((int)this_00 + 0x1e1e),0,local_1c,local_18,local_14,local_10);
    if (*(short *)(param_1 + 0x14) == 1) {
      iVar6 = 2;
    }
    else {
