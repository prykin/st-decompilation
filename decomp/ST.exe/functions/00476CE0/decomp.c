...
cf_common_exit_00476DBA:
        sub_00481520(this,iVar7,iVar17,iVar9);
        ...
        do {
          for (; (int)sVar21 <= sVar20 + 1; sVar21 = sVar21 + 1) {
            if ((((((sVar18 != this->field_0047) || (sVar21 != this->field_0049)) &&
                  (sVar5 = *(short *)&this->field_0x60d + 1, -1 < sVar18)) &&
                 ((sVar18 < g_worldGrid.sizeX && (-1 < sVar21)))) && (sVar21 < g_worldGrid.sizeY))
               && (((-1 < sVar5 && (sVar5 < g_worldGrid.sizeZ)) &&
                   ((pSVar2 = g_worldGrid.cells
                              [(int)g_worldGrid.sizeX * (int)sVar21 +
                               iVar17 + (int)sVar5 * (int)g_worldGrid.planeStride].objects[0],
  ...
  if (SVar1 == CASE_2) {
    if (*(int *)&this->field_0x615 == 0) {
      ...
      iVar17 = CONCAT22((short)((uint)iVar9 >> 0x10),*(short *)&this->field_0x60b + 1) * 0xc9;
      /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
      iVar10 = CONCAT22((short)((uint)iVar17 >> 0x10),*(short *)&this->field_0x609 + 1);
      iVar7 = iVar10 * 0xc9;
      ...
      uVar6 = (*this->vtable->vfunc_10)
                        (CONCAT22(uVar6,this->field_0041),
                         ...
                         CONCAT22(uVar6,this->field_0045),iVar7,iVar17,iVar9);
          ...
          if (DAT_0080732c == 1) {
            ...
            TraksClassTy::TraksCreate
                      (g_traksClass_00802A7C,1,2,7,
                       ...
                       (int)local_18,sVar18,sVar20,sVar21,sVar5,sVar22,sVar23,iVar7,sVar24,bVar25);
          }
          else {
...
cf_common_exit_00477B2E:
      ...
      if (*(int *)&this->field_0x615 == 0) {
        ...
        /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
        iVar17 = CONCAT22((short)((uint)iVar7 >> 0x10),*(short *)&this->field_0x603 * 0xc9) + 100;
        uVar6 = (undefined2)((uint)iVar9 >> 0x10);
        /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
        uVar6 = (*this->vtable->vfunc_10)
                          (CONCAT22(uVar6,this->field_0041),
                           CONCAT22((short)((uint)iVar17 >> 0x10),this->field_0043),
                           CONCAT22(uVar6,this->field_0045),iVar17,iVar9,iVar7);
        *(undefined2 *)&this->field_0x60f = uVar6;
        *(undefined4 *)&this->field_0x615 = 1;
      }
      if (*(int *)&this->field_0x615 == 1) {
      ...
      if (*(int *)&this->field_0x615 == 3) {
        ...
        /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
        uVar26 = CONCAT31((int3)((uint)extraout_EDX >> 8),this->field_0x2bf);
        param_1 = 0;
        if (this->field_0x2bf != '\0') {
          do {
            puVar12 = (undefined4 *)
