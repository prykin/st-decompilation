...

{
  ...
  if (iVar3 == 0) {
    ...
    ccFntTy::SetSurf(*(ccFntTy **)&pFVar2->field_0x1a73,pFVar2->field_1AC0,0,0x19,0x48,0xb4,0x14);
    uVar9 = 2;
    iVar8 = -1;
    iVar3 = 0;
    ...
    ccFntTy::SetSurf(*(ccFntTy **)&pFVar2->field_0x1a73,pFVar2->field_1AC0,0,0xeb,0x48,0xb4,0x14);
    uVar9 = 2;
    iVar8 = -1;
    iVar3 = 0;
    ...
    ccFntTy::SetSurf(*(ccFntTy **)&pFVar2->field_0x1a73,pFVar2->field_1AC0,0,0x19,0x70,0x6e,0x14);
    uVar9 = 2;
    iVar8 = -1;
    iVar3 = 0;
    ...
    ccFntTy::SetSurf(*(ccFntTy **)&pFVar2->field_0x1a73,pFVar2->field_1AC0,0,0xa5,0x70,0x6e,0x14);
    uVar9 = 2;
    iVar8 = -1;
    iVar3 = 0;
    ...
    ccFntTy::SetSurf(*(ccFntTy **)&pFVar2->field_0x1a73,pFVar2->field_1AC0,0,0x131,0x70,0x6e,0x14);
    uVar9 = 2;
    iVar8 = -1;
    iVar3 = 0;
    ...
    ccFntTy::SetSurf(*(ccFntTy **)&pFVar2->field_0x1a73,pFVar2->field_1AC0,0,0x19,0x98,0x186,0x14);
    uVar9 = 2;
    iVar8 = -1;
    iVar3 = 0;
