...
void __thiscall FUN_004ff110(void *this,int param_1)

{
  ...
  if (param_1 == 0) {
    local_8 = (undefined1 *)((int)this + 0xc51);
  }
  else {
    local_8 = (undefined1 *)((int)this + 0xb63);
  }
  local_c = CONCAT31(local_c._1_3_,param_1 == 0);
  local_58 = DAT_00858df8;
  DAT_00858df8 = &local_58;
  local_10 = this;
  iVar6 = __setjmp3(local_54,0,unaff_EDI,unaff_ESI);
  puVar4 = local_8;
  uVar2 = local_c;
  this_00 = local_10;
  if (iVar6 == 0) {
    uVar10 = local_c & 0xff;
    cVar1 = *(char *)(uVar10 + 0x2ec + (int)local_10);
    if (cVar1 == '\x01') {
      ...
      uVar11 = 6;
      if (DAT_0080731a != 0) {
        pbVar8 = (byte *)thunk_FUN_00526100(local_8,1);
      ...
      pbVar8 = (byte *)thunk_FUN_00526100(local_8,0);
      puVar9 = FUN_00709af0(DAT_00806794,0x1f,pbVar8,uVar11,bVar5,iVar6,iVar12,puVar13);
      *(ushort **)((int)this_00 + uVar10 * 4 + 0x2e2) = puVar9;
      *(undefined1 *)(uVar10 + 0x2ea + (int)this_00) = 0;
