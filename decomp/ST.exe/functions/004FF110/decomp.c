...

{
  ...
  if (param_1 == 0) {
    local_8 = (RecoveredRecord_00526100_020D84E3 *)&this->field_0C51;
  }
  else {
    local_8 = (RecoveredRecord_00526100_020D84E3 *)&this->field_0B63;
  }
    ...
    if (cVar1 == '\x01') {
      ...
      if (DAT_0080731a != 0) {
        ...
        *(undefined1 *)((int)this_00->field_0308 + (uVar9 - 0x1e)) = 0;
        pcVar7 = thunk_FUN_00526100(pRVar4,0);
      ...
      *(undefined1 *)((int)this_00->field_0308 + (uVar9 - 0x1e)) = 0;
      ...
      sub_004F1890(this_00,(byte)uVar3);
