...

{
  ...
  uVar5 = 0;
  local_8 = 0;
  pDVar4 = (DArrayTy *)g_playerRuntime[(int)param_1].field6_0x9;
...
LAB_004dfd49:
        ...
        pDVar4 = (DArrayTy *)g_playerRuntime[(int)piVar1].field6_0x9;
        uVar5 = uVar5 + 1;
      } while (uVar5 < pDVar4->count);
    }
    uVar5 = 0;
    pDVar4 = *(DArrayTy **)&g_playerRuntime[(int)piVar1].field_0x9d2;
    iVar3 = 0;
    if (pDVar4 == (DArrayTy *)0x0) {
      if (local_10 != 0) {
        return 1;
