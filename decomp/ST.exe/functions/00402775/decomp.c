...

{
  ...
  if ((DAT_0080c4f7 == 1) && (*(int *)(this + 0x24b) != 0)) {
    ...
    if (iVar4 == 0) {
      ...
      if (*(uint *)(pCStack_10 + 0x24f) < uVar11) {
        do {
          ...
          case 2:
            ...
            if (iVar4 < (int)pcStack_c) {
              do {
                ...
                thunk_FUN_005411a0((int)puStack_8,pcVar7,&DAT_007c2260);
                iVar4 = iVar4 + 1;
              } while (iVar4 < (int)pcStack_c);
            }
            puVar5 = ccFntTy::FormIndentSarr
                               (*(ccFntTy **)(pCVar3 + 0x1d4),(int)puStack_8,
            ...
            if (puVar12[5] == '\0') {
              ...
              if (pbVar6 != (byte *)0x0) {
                ccFntTy::WrSarr(*(ccFntTy **)(pCVar3 + 0x1d4),(int)puStack_8,0,-1,0,0,0);
              ...
              *(cTypingTy **)(pCVar3 + 0x1d8) = this_00;
              iVar4 = cTypingTy::TypingInitSarr
                                (this_00,(int)puStack_8,*(void **)(pCVar3 + 0x1d4),0,0,0,0x226,0x55,
                                 0,0,0,1,2,0xff);
...
LAB_004f9a8a:
                ...
                *(short **)pCVar1 = psVar8;
                ...
                psVar8 = FUN_0070b430(DAT_00806758,pcStack_c,6,0,0);
                *(short **)pCVar1 = psVar8;
                if (psVar8 == (short *)0x0) {
                  bVar14 = 6;
                  bVar13 = 0;
