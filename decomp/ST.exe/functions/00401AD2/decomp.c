...
void __thiscall thunk_FUN_0052afe0(void *this,byte param_1,float param_2,float param_3)

{
  ...
  *(int *)((int)this + 0x23b) = iVar5;
  if (*(int *)((int)this + 0xdb3) == 0) {
    iVar5 = 0;
    piVar7 = aiStack_30;
    fStack_c = (float)(int)*DAT_00806750 * _DAT_007904f8;
    fStack_10 = (float)(int)DAT_00806750[1] * _DAT_007904f8;
    fVar2 = _DAT_0079034c;
    do {
      ...
      fStack_8 = fVar4 * fVar4 + fVar3 * fVar3;
      if (fVar2 < fStack_8) {
        iVar8 = iVar5;
        fVar2 = fStack_8;
      }
    ...
    if (fVar2 != _DAT_0079034c) {
      ...
      *(undefined1 *)((int)this + 0xdcd) = 0;
      fStack_8 = (float)iVar5 * fStack_c * (float)_DAT_007901c0;
      iVar8 = aiStack_30[iVar8 * 2 + 1];
      *(float *)((int)this + 0xdd6) = fStack_8;
      *(float *)((int)this + 0xdce) = param_2;
      fVar2 = (float)iVar8 * fStack_10 * (float)_DAT_007901c0;
      *(float *)((int)this + 0xdda) = fVar2;
      fVar3 = (float)_DAT_0079acd8;
      *(float *)((int)this + 0xdd2) = param_3;
      fVar3 = (param_2 - fStack_8) * fVar3 * (float)_DAT_0079acc8;
      ...
      *(float *)((int)this + 0xdea) = fVar3 * _DAT_0079acb8;
      FUN_006e6540((int)puVar6,fStack_8,fVar2,-1);
