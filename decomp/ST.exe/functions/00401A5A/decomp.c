...
void thunk_FUN_005e4300(int *param_1,UINT param_2,int param_3,int param_4,short param_5)

{
  ...
  if (param_1 != (int *)0x0) {
    ...
    _cStack_8 = CONCAT31(uStack_7,cVar6);
    ...
    if (iVar3 == 0) {
      ...
      if (param_4 != 0) {
        FUN_006c7570(*param_1,0,2,2,puStack_c + -1,(int)(puVar2 + -1),iVar3,(byte)_cStack_8);
      }
      FUN_006c7570(*param_1,0,0,0,puStack_c,(int)puVar2,iVar3,(byte)_cStack_8);
      if (param_2 != 0) {
