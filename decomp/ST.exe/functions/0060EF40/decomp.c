...

{
  ...
  puVar9 = &stack0xffffff38 + iVar13;
  local_1c = &stack0xffffff38 + iVar13;
  local_54 = &stack0xffffff38 + iVar13;
  puVar15 = (byte *)(&stack0xffffff38 + iVar13);
...
LAB_0060f21b:
              ...
              *(undefined4 *)(puVar9 + -0x10) = 0x60f22c;
              iVar1 = thunk_FUN_004961b0(*(short *)(puVar9 + -0xc),*(short *)(puVar9 + -8),
                                         *(short *)(puVar9 + -4));
              if (iVar1 == 0) {
LAB_0060f230:
              ...
              pcVar2 = pSVar11->vtable[5].slots_00_28[2];
  ...
  *(undefined4 *)(puVar9 + -0x18) = 0x60f28e;
  thunk_FUN_00615bb0(*(Global_sub_00615BB0_param_1Enum *)(puVar9 + -0x14),
      ...
      if (local_4c <= local_40 + 1) {
        do {
          if ((-1 < local_4c) && (local_4c < 5)) {
            local_b8[0] = local_60[iVar13 * 2] + local_20;
            local_74 = local_60[iVar13 * 2 + 1] + local_2c;
            *(undefined2 *)
             (local_54 +
  ...
  if (local_6c == nullptr) {
    ...
    if (*(int *)puVar1 == 0) {
      ...
      *(undefined4 *)(puVar9 + -8) = 0x60f3ca;
      pvVar4 = Library::DKW::LIB::MemAlloc(*(uint *)(puVar9 + -4));
      *(void **)puVar1 = pvVar4;
    }
    else {
    ...
    *(int *)&this->field_0x2d5 = local_68[0] + 1;
    ...
    if (1 < local_68[0] + -1) {
      do {
        ...
        *(undefined4 *)(puVar9 + -0x40) = 0x60f549;
        uVar5 = thunk_FUN_0060f940(*(int *)(puVar9 + -0x3c),*(int *)(puVar9 + -0x38),
    ...
    if (1 < local_68[0]) {
      ...
      *(undefined4 *)(puVar9 + -0x14) = 0x60f64f;
      thunk_FUN_00615860(*(int *)(puVar9 + -0x10),*(int **)(puVar9 + -0xc),*(int **)(puVar9 + -8),
                         *(int **)(puVar9 + -4));
      iVar3 = *(int *)puVar1;
      *(int *)(puVar9 + -4) =
      ...
      *(undefined4 *)(puVar9 + -0x28) = 0x60f6d4;
      thunk_FUN_00615e70(this,*(int *)(puVar9 + -0x24),*(int *)(puVar9 + -0x20),
