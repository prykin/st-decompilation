        ...
        if (iVar2 < local_84) {
          do {
            ...
            if (((pSVar10 == nullptr) ||
              ...
              iVar1 = thunk_FUN_004961b0(sVar11,(short)local_50,(short)local_4c);
...
LAB_0060f230:
  ...
  if (local_6c == nullptr) {
    ...
    if (*(int *)slotStorage == 0) {
      pvVar3 = Library::DKW::LIB::MemAlloc((local_68[0] + 1) * 0x1c);
    ...
    *(int *)&this->field_0x2d5 = local_68[0] + 1;
    ...
    if (1 < local_68[0] + -1) {
      do {
        ...
        uVar5 = thunk_FUN_0060f940((int)*(short *)&pAVar4->field_0x6,
