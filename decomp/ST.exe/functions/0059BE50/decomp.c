...
void __fastcall FUN_0059be50(void *param_1)

{
  int iVar1;
  
  *(undefined4 *)((int)param_1 + 0x1a6b) = 0;
  *(undefined4 *)((int)param_1 + 0x29) = 2;
  ...
  case 7:
    ...
    *(undefined4 *)((int)param_1 + 0x31) = 0x39;
    if (*(int *)((int)param_1 + 0x1ac8) != 0) {
      FUN_006e6080(param_1,2,*(int *)((int)param_1 + 0x1ac8),(undefined4 *)((int)param_1 + 0x1d));
    }
    if (*(int *)((int)param_1 + 0x1acc) != 0) {
    ...
    *(undefined4 *)((int)param_1 + 0x31) = 0xd8;
    if (*(int *)((int)param_1 + 0x1ae4) != 0) {
      FUN_006e6080(param_1,2,*(int *)((int)param_1 + 0x1ae4),(undefined4 *)((int)param_1 + 0x1d));
    }
    *(undefined4 *)((int)param_1 + 0x2d) = 0x20;
  ...
  case 8:
    ...
    *(undefined4 *)((int)param_1 + 0x31) = 0;
    ...
    iVar1 = *(int *)((int)param_1 + 0x1b24);
joined_r0x0059c1b1:
    if (iVar1 != 0) {
      FUN_006e6080(param_1,2,iVar1,(undefined4 *)((int)param_1 + 0x1d));
    }
    iVar1 = *(int *)((int)param_1 + 0x1b20);
    *(undefined4 *)((int)param_1 + 0x31) = 0;
LAB_0059c1ca:
    if (iVar1 != 0) {
      FUN_006e6080(param_1,2,iVar1,(undefined4 *)((int)param_1 + 0x1d));
