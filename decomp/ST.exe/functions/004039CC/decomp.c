...

{
  ...
  if (iVar3 == 0) {
    ...
    if (*(int *)((int)pvStack_8 + 0x1cf) < *(int *)(iVar3 + 0xc) + -1) {
      uVar5 = *(int *)((int)pvStack_8 + 0x1cf) + 1;
      *(uint *)((int)pvStack_8 + 0x1cf) = uVar5;
      ...
      if (puVar6 != (undefined1 *)0x0) {
        ...
        *(undefined4 *)((int)pvStack_8 + 0x1a3) = 0;
        ...
        case 0:
          ...
          return;
        case 1:
          thunk_FUN_00517a50(pvStack_8,(int)pvVar1,uVar5,'\0');
          DAT_00858df8 = (undefined4 *)uStack_4c;
          return;
        case 2:
        ...
        case 3:
          ...
          return;
        case 4:
          thunk_FUN_0051b5a0(pvStack_8,(int)pvVar1,uVar5,'\0');
          DAT_00858df8 = (undefined4 *)uStack_4c;
          return;
        case 5:
          thunk_FUN_00516a40(pvStack_8,(uint)pvVar1,(byte)uVar5,'\0');
          DAT_00858df8 = (undefined4 *)uStack_4c;
          return;
        case 6:
        ...
        case 10:
          ...
          return;
        case 0xb:
          thunk_FUN_0051c980(pvStack_8,(int)pvVar1,uVar5,'\0');
          DAT_00858df8 = (undefined4 *)uStack_4c;
          return;
        case 0xc:
