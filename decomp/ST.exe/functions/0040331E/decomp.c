...
undefined4 __thiscall thunk_FUN_004a7e30(void *this,int param_1)

{
  ...
  if (*(int *)((int)this + 0x236) == 1) {
    ...
    if (iVar5 == *(int *)(iVar1 + 0xc) + -1) {
      ...
      *(uint *)((int)this + 0x232) = iVar5 - 1U;
      FUN_006acc70(iVar1,iVar5 - 1U,&uStack_14);
      bVar2 = thunk_FUN_00430750(8);
      uVar4 = (uint)bVar2;
      iStack_e = iStack_e * 0xc9;
    }
    else {
      *(undefined4 *)((int)this + 0x23e) = 0;
      *(uint *)((int)this + 0x232) = iVar5 + 1U;
    ...
    if (*(int *)((int)this + 0x232) == 0) {
      ...
      *(undefined4 *)((int)this + 0x23e) = 0;
      FUN_006acc70(*(int *)((int)this + 0x22a),1,&uStack_14);
      bVar2 = thunk_FUN_00430750(8);
    }
    else {
      ...
      *(undefined4 *)((int)this + 0x23e) = 0;
      FUN_006acc70(*(int *)((int)this + 0x22a),uVar4,&uStack_14);
      bVar2 = thunk_FUN_00430750(8);
      iStack_a = iStack_e;
    }
    uVar4 = (uint)bVar2;
  ...
  *(int *)((int)this + 0x23a) = (iStack_e / (int)uVar4) / 3;
