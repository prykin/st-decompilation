...
void __cdecl FUN_00731ba0(uint *param_1,int param_2)
  ...
  if (*piVar2 == 0) {
    if (DAT_0085a5b8 != (uint *)0x0) {
      ...
      *(char *)(DAT_0085a5b8[4] + 0x43) = *(char *)(DAT_0085a5b8[4] + 0x43) + -1;
      ...
      if (DAT_0085a5b8[2] == 0xffffffff) {
        VirtualFree((LPVOID)DAT_0085a5b8[3],0,0x8000);
        ...
        if (DAT_0085a5b8 < param_1) {
          param_1 = param_1 + -5;
        }
        DAT_0085a5b4 = DAT_0085a5c0;
      }
    }
    DAT_0085a5b8 = param_1;
    DAT_0085a5b0 = uVar8;
  }
  return;
}
