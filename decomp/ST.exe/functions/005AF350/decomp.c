...

{
  ...
  if (*(uint *)((int)local_c + 0x1c83) != 0) {
    FUN_006e56b0(*(void **)((int)local_c + 0xc),*(uint *)((int)local_c + 0x1c83));
  }
  *(undefined4 *)((int)local_c + 0x1c83) = 0;
  FUN_006b3af0(DAT_008075a8,*(uint *)((int)local_c + 0x1c87));
  ...
  if (*(uint *)((int)local_c + 0x1a6c) != 0) {
    FUN_006e56b0(*(void **)((int)local_c + 0xc),*(uint *)((int)local_c + 0x1a6c));
  }
  *(undefined4 *)((int)local_c + 0x1a6c) = 0;
  if (*(int *)((int)local_c + 0x20b8) != 0) {
    thunk_FUN_005aafb0();
    FUN_0072e2b0(*(undefined4 **)((int)local_c + 0x20b8));
    *(undefined4 *)((int)local_c + 0x20b8) = 0;
  }
  ...
  *(undefined1 **)((int)local_c + 0x20b8) = puVar3;
  if (puVar3 != (undefined1 *)0x0) {
    uVar8 = 0;
    cVar7 = '\x01';
    uVar6 = 0x10;
    ...
    if (uVar6 != 0) {
      iVar2 = *(int *)((int)local_c + 0x20b8);
      *(undefined1 *)(iVar2 + 2) = 0;
      *(undefined4 *)(iVar2 + 0x17) = 0xffffffff;
      uVar6 = *(uint *)(*(int *)((int)local_c + 0x20b8) + 3);
      if (-1 < (int)uVar6) {
  ...
  if (*(uint *)((int)local_c + 0x1a74) != 0xffffffff) {
    FUN_006b3af0(*(int **)((int)local_c + 0x1ab8),*(uint *)((int)local_c + 0x1a74));
  }
  if (*(uint *)((int)local_c + 0x1b05) != 0xffffffff) {
    FUN_006b3af0(*(int **)((int)local_c + 0x1b49),*(uint *)((int)local_c + 0x1b05));
  }
  if (*(uint *)((int)local_c + 0x1b96) != 0xffffffff) {
    FUN_006b3af0(*(int **)((int)local_c + 0x1bda),*(uint *)((int)local_c + 0x1b96));
  }
  puVar4 = (uint *)((int)local_c + 0x1c23);
  local_8 = 0x16;
  do {
  ...
  if (*(char *)((int)local_c + 0x20b4) == '\0') {
    ...
    *(uint **)(DAT_0081176c + 0x548) = puVar4;
    if (*(int *)((int)local_c + 0x20bc) != 0) {
      thunk_FUN_005aafb0();
      FUN_0072e2b0(*(undefined4 **)((int)local_c + 0x20bc));
      *(undefined4 *)((int)local_c + 0x20bc) = 0;
    }
    puVar3 = (undefined1 *)FUN_0072e530(0x33);
    if (puVar3 == (undefined1 *)0x0) {
      puVar3 = (undefined1 *)0x0;
    ...
    *(undefined1 **)((int)local_c + 0x20bc) = puVar3;
    if (puVar3 != (undefined1 *)0x0) {
      uVar8 = 0;
      cVar7 = '\x01';
      uVar6 = 0x10;
      ...
      if (uVar6 != 0) {
        iVar2 = *(int *)((int)local_c + 0x20bc);
        *(undefined1 *)(iVar2 + 2) = 0;
        *(undefined4 *)(iVar2 + 0x17) = 0xffffffff;
        uVar6 = *(uint *)(*(int *)((int)local_c + 0x20bc) + 3);
        if (-1 < (int)uVar6) {
          FUN_006b3430(DAT_008075a8,uVar6);
        }
        thunk_FUN_005ab0a0();
  ...
  if (*(char *)((int)local_c + 0x20b7) == '\0') {
    ...
    *(undefined4 *)((int)local_c + 0x31) = 0;
    ...
    if (*(int *)((int)local_c + 0x20c0) != 0) {
      thunk_FUN_005aafb0();
      FUN_0072e2b0(*(undefined4 **)((int)local_c + 0x20c0));
      *(undefined4 *)((int)local_c + 0x20c0) = 0;
    }
    puVar3 = (undefined1 *)FUN_0072e530(0x33);
    if (puVar3 == (undefined1 *)0x0) {
      puVar3 = (undefined1 *)0x0;
    ...
    *(undefined1 **)((int)local_c + 0x20c0) = puVar3;
    if (puVar3 != (undefined1 *)0x0) {
      uVar8 = 0;
      cVar7 = '\x01';
      uVar6 = 0x10;
      ...
      if (uVar6 != 0) {
        iVar2 = *(int *)((int)local_c + 0x20c0);
        *(undefined1 *)(iVar2 + 2) = 0;
        *(undefined4 *)(iVar2 + 0x17) = 0xffffffff;
        uVar6 = *(uint *)(*(int *)((int)local_c + 0x20c0) + 3);
        if (-1 < (int)uVar6) {
          FUN_006b3430(DAT_008075a8,uVar6);
        }
        thunk_FUN_005ab0a0();
