...

{
  ...
  if (pHVar4 != (HoloTy *)0x0) {
    ...
    uVar7 = HoloTy::Init(this_00->field_20B8,CASE_2,0x112,0x38,iVar3,iVar6,uVar7,cVar8,uVar9);
    if (uVar7 != 0) {
  ...
  if (this_00->field_20B4 == '\0') {
    ...
    *(undefined4 *)&this_00->field_0x31 = 0;
    ...
    if (pHVar4 != (HoloTy *)0x0) {
      ...
      uVar7 = HoloTy::Init(this_00->field_20BC,CASE_4,10,0xb4,iVar3,iVar6,uVar7,cVar8,uVar9);
      if (uVar7 != 0) {
  ...
  if (this_00->field_20B7 == '\0') {
    ...
    *(undefined4 *)&this_00->field_0x31 = 0;
    ...
    if (pHVar4 != (HoloTy *)0x0) {
      ...
      uVar7 = HoloTy::Init(this_00->field_20C0,CASE_1,200,0x1f1,iVar3,iVar6,uVar7,cVar8,uVar9);
      if (uVar7 != 0) {
