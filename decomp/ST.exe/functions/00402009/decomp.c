...
undefined4 __thiscall thunk_FUN_00660a40(void *this,short param_1,short param_2,short param_3)
  ...
  *(undefined4 *)((int)this + 0xa7) = 0;
  if (((((-1 < param_1) && (param_1 < DAT_007fb240)) && (-1 < param_2)) &&
    ...
    iVar1 = *(int *)(DAT_007fb248 +
                    ...
                    (int)param_1) * 8);
    if (iVar1 != 0) {
      uStack_8 = *(undefined4 *)(iVar1 + 0x18);
      if ((*(short *)((int)this + 0x7d) != -2) && (DAT_007fa174 != 0)) {
        piVar2 = (int *)thunk_FUN_0042b760(CONCAT31((int3)((uint)DAT_007fb248 >> 8),
                                           ...
                                           CONCAT22((short)((uint)uStack_8 >> 0x10),
                                                    *(short *)((int)this + 0x7d)));
        if (piVar2 != (int *)0x0) {
          (**(code **)(*piVar2 + 8))(0xb,&uStack_8);
          return 0;
        }
      }
    }
