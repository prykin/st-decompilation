...

{
  ...
  *(int *)(pHStack_14 + 7) = param_4;
  if (param_4 != 0) {
    *(int *)(pHStack_14 + 0x23) = param_2;
    *(int *)(pHStack_14 + 0x27) = param_3;
    pHStack_14[1] = param_1;
    *(undefined4 *)(pHStack_14 + 0x2b) = *(undefined4 *)(param_4 + 4);
    iVar3 = *(int *)(param_4 + 8);
    *(int *)(pHStack_14 + 0x2f) = iVar3;
    switch(param_1) {
    case (HoloTy)0x1:
      iStack_c = *(int *)(pHStack_14 + 0x2b);
    ...
    case (HoloTy)0x3:
      ...
      break;
    case (HoloTy)0x4:
      uStack_8 = *(int *)(pHStack_14 + 0x2b) + param_2;
      iStack_c = iVar3;
    }
    *(uint *)(pHStack_14 + 0x13) = param_6 & 0xff;
    *(uint *)(pHStack_14 + 0x1f) = uStack_8;
    puVar4 = CalcHologram(pHStack_14,(uint *)(pHStack_14 + 0xf),uStack_8,iStack_c,param_5,
