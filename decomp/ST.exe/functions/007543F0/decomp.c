...

{
  ...
  do {
    ...
    iVar3_mg1 = (int)FUN_00753b80((RecoveredRecordView_00750F20_49A60217 *)param_1,
                                  *(undefined4 *)
                                   (&param_1->field_000C[2].field_0x0 + (int)puVar4 * 8),(int)puVar4
                                 );
    FUN_007561d0((RecoveredRecordView_00753C80_637B4E8C *)param_1,
    ...
    while (iVar2 != -1) {
      ...
      iVar3_mg1 = (int)FUN_00753b80((RecoveredRecordView_00750F20_49A60217 *)param_1,iVar2,
                                    (int)param_1->field_000C->field_001C);

      iVar4 = FUN_00753c80((RecoveredRecordView_00753C80_637B4E8C *)param_1,
    ...
    if (*(int *)(&pAVar3[2].field_0x4 + (int)puVar4 * 8) == -1) {
      do {
        if (puVar4 == nullptr) {
          FUN_00750f20((RecoveredRecordView_00750F20_49A60217 *)param_1,0,0);
          return -4;
        }
