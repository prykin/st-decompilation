...

{
  ...
  iVar6 = __setjmp3(IStack_138.jumpBuffer,0,unaff_EDI,unaff_ESI);
  pSVar19 = pSStack_34;
  if (iVar6 == 0) {
    *(int *)pSStack_34 = 1;
  ...
  iVar6 = __setjmp3(IStack_248.jumpBuffer,0,unaff_EDI,unaff_ESI);
  pSVar19 = pSStack_c;
  if (iVar6 == 0) {
  ...
  iVar6 = __setjmp3(IStack_1c0.jumpBuffer,0,unaff_EDI,unaff_ESI);
  if (iVar6 == 0) {
  ...
  iVar6 = __setjmp3(IStack_f4.jumpBuffer,0,unaff_EDI,unaff_ESI);
  pSVar19 = pSStack_c;
      ...
      *(int *)(pSVar19 + 0x8552) = *(char *)(*(int *)(DAT_00857168 + 4) + 5) + -0x30;
      ...
      if (iVar6 == 0) {
        ...
        case 0x62:
          ...
          iVar6 = __setjmp3(IStack_204.jumpBuffer,0,unaff_EDI,unaff_ESI);
          pSVar19 = pSStack_c;
          if (iVar6 == 0) {
...
switchD_0056b4ce_caseD_57:
  ...
  case '~':
    if (*(int *)(DAT_00857168 + 8) != 0) {
      ...
      iVar6 = __setjmp3(IStack_17c.jumpBuffer,0,pSVar18,puVar24);
      pSVar19 = pSStack_c;
      if (iVar6 == 0) {
