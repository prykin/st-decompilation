...
undefined4 thunk_FUN_0056adc0(HINSTANCE param_1,undefined4 param_2,undefined4 param_3,int param_4)

{
  ...
  iVar7 = __setjmp3(auStack_ac,0,unaff_EDI,unaff_ESI);
  iStack_30 = iVar7;
  if (iVar7 != 0) {
    DAT_00858df8 = ppuStack_b0;
    (**(code **)(*piStack_c + 4))();
  ...
  piStack_34 = piStack_c + 0xe;
  pHStack_40 = DAT_00806748;
  ppuStack_138 = DAT_00858df8;
  DAT_00858df8 = &ppuStack_138;
  iVar7 = __setjmp3(auStack_134,0,unaff_EDI,unaff_ESI);
  piVar20 = piStack_34;
  if (iVar7 == 0) {
    *piStack_34 = 1;
    iVar7 = FUN_006b7920(piStack_34 + 1,(DWORD_PTR)pHStack_40);
    if (iVar7 != 0) {
      *piVar20 = 0;
    }
    DAT_00858df8 = ppuStack_138;
  ...
  iVar7 = thunk_FUN_00571e40(piStack_c + 0xe,1);
  if (iVar7 == 0) {
    FUN_006a5e40(-0x5001fff6,DAT_007ed77c,0x7ca0c8,0x159);
  }
  ppuStack_248 = DAT_00858df8;
  DAT_00858df8 = &ppuStack_248;
  iVar7 = __setjmp3(auStack_244,0,unaff_EDI,unaff_ESI);
  piVar20 = piStack_c;
  if (iVar7 == 0) {
    piVar24 = piStack_c + 0x18;
    pbVar1 = (byte *)((int)piStack_c + 0x7d1a);
  ...
  iVar7 = __setjmp3(auStack_1bc,0,unaff_EDI,unaff_ESI);
  if (iVar7 == 0) {
  ...
  DVar9 = timeGetTime();
  FUN_0072e6b0(DVar9);
  thunk_FUN_005672a0(piStack_c + 0xe,DAT_00856d78);
  ppuStack_f4 = DAT_00858df8;
  DAT_00858df8 = &ppuStack_f4;
  iVar7 = __setjmp3(auStack_f0,0,unaff_EDI,unaff_ESI);
  piVar20 = piStack_c;
  ...
  *(uint **)((int)piVar20 + 0x4eda) = puVar8;
  ...
  if (pcVar11 == (char *)0x0) {
    if ((DAT_00807330 & 1) != 0) {
      ...
      puVar8 = thunk_FUN_00683c70((uint *)((int)piVar20 + 0x7d1a),&stack0xfffffaa0,&iStack_38,
      ...
      if (iVar7 == 0) {
        ...
        case 0x62:
          ...
          *(undefined1 *)((int)piVar20 + 0x1163) = 2;
          ...
          iVar7 = __setjmp3(auStack_200,0,unaff_EDI,unaff_ESI);
          if (iVar7 == 0) {
            puVar10 = FUN_006f0ec0(0x345,(byte *)((int)piStack_c + 0x76f6),0,0,0);
            iStack_3c = (int)piStack_c + 0x1196;
            FUN_006f1ce0(0,PTR_s_DESCRIPTOR_0079b080,&iStack_3c,0);
          ...
          thunk_FUN_0056ef50((int)piStack_c);
          thunk_FUN_0056f040((int)piStack_c);
          thunk_FUN_0056ebe0((int)piStack_c);
          *(undefined4 *)((int)piStack_c + 0x7d0e) = 0;
          piVar20 = piStack_c;
          break;
        default:
...
switchD_0056b4ce_caseD_57:
    ...
    if (*(char **)(DAT_00857168 + 8) != (char *)0x0) {
      ...
      if (iVar7 != -2) {
        ...
        if ((hFile != (HANDLE)0xffffffff) &&
          ...
          WriteFile(hFile,piVar20 + 0x44d,4,&DStack_44,(LPOVERLAPPED)0x0);
          CloseHandle(hFile);
  ...
  case '~':
    if (*(int *)(DAT_00857168 + 8) != 0) {
      ...
      iVar7 = __setjmp3(auStack_178,0,pCVar19,puVar26);
      if (iVar7 == 0) {
        puVar10 = FUN_006f0ec0(0x345,(byte *)((int)piStack_c + 0x76f6),2,0,0);
        pbStack_8 = (byte *)((int)piStack_c + 0x1196);
        FUN_006f1ce0(0,PTR_s_DESCRIPTOR_0079b080,(int *)&pbStack_8,0);
        *(undefined4 *)((int)piStack_c + 0x119a) = 0x8f000805;
        FUN_006f13f0(0,PTR_s_DESCRIPTOR_0079b080,(byte *)((int)piStack_c + 0x1196),0x1999,
  ...
  if ((*(char *)((int)piVar20 + 0xe26) == '\0') && (iStack_1c != 0x6104)) {
    iStack_1c = 0x6123;
  }
LAB_0056c034:
  (**(code **)(*piVar20 + 0x18))();
