  ...
  if (((((-1 < (short)local_8) && ((short)local_8 < g_worldGrid.sizeX)) && (-1 < STPiece<2,2>(local_8))) &&
      ((((STPiece<2,2>(local_8) < g_worldGrid.sizeY && (-1 < sVar1)) &&
        ((sVar1 < g_worldGrid.sizeZ &&
         ((this_00 = (RecoveredRecord_004DD740_33371182 *)
                     STGridAt3D(g_worldGrid, local_8, STPiece<2,2>(local_8), sVar1).objects[0],
          this_00 != nullptr &&
     ...
     (((*(int *)&this_00->field_0x18 == STField<int>(this,0x255) &&
       ...
       (iVar3 = thunk_FUN_004dd740(this_00), iVar3 == 0)) &&
    ...
    iVar2 = thunk_FUN_004ad650((STT3DSprC *)&this_00->field_0x1d5);
    *param_2 = iVar2;
