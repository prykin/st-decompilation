...
void __cdecl thunk_FUN_00638230(undefined4 param_1,int param_2,int param_3,int param_4,int param_5)

{
  ushort *puVar1;
  uint uStack_8;
  
  puVar1 = FUN_00709af0(DAT_00806774,0x1d,(byte *)s_rippleM_007d1c98,0xffffffff,0,1,0,
                        (undefined4 *)0x0);
  if ((puVar1 != (ushort *)0x0) && (DAT_00807598 != (void *)0x0)) {
    ...
    FUN_006ea8a0(DAT_00807598,uStack_8,0,2,0);
    ...
    FUN_006ea4e0(DAT_00807598,uStack_8,1,*(int *)((int)puVar1 + 9) / 2,
                 *(int *)((int)puVar1 + 0xd) / 2 + -0x17);
    FUN_006ea050(DAT_00807598,uStack_8,1,0xffffffff,param_2);
