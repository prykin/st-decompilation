...
int __fastcall thunk_FUN_006101b0(int *param_1)
...
LAB_00610347:
  ...
  case 2:
  case 4:
    iVar13 = thunk_FUN_006139a0(param_1,&iStack_10,&iStack_14,&iStack_18);
    if (iVar13 == 0) {
LAB_006121e1:
      thunk_FUN_0060ec00(param_1);
      param_1[0x83] = 9;
    ...
    *(undefined2 *)(param_1 + 0x99) = *(undefined2 *)((int)param_1 + 0x25e);
    sVar7 = (short)iStack_10;
    *(short *)((int)param_1 + 0x25a) = sVar7;
    iStack_20 = (int)sVar7;
    sVar11 = (short)iStack_14;
    *(short *)(param_1 + 0x97) = sVar11;
    sVar10 = (short)iStack_18;
    *(short *)((int)param_1 + 0x25e) = sVar10;
    ...
    iStack_24 = (int)sVar11;
    if (sVar11 < 0) {
      iVar8 = (short)((sVar11 / 0xc9 + (sVar11 >> 0xf)) -
                     (short)((longlong)iStack_24 * 0x28c1979 >> 0x3f)) + -1;
    }
    else {
      iVar8 = (int)(short)((sVar11 / 0xc9 + (sVar11 >> 0xf)) -
                          (short)((longlong)iStack_24 * 0x28c1979 >> 0x3f));
    }
    iVar9 = (int)sVar10;
    if (sVar10 < 0) {
    ...
    if ((((*(short *)((int)param_1 + 0x215) == iVar13) &&
        ...
        ) || (uStack_8 = (uint)(*(int *)((int)param_1 + 0x1f7) == 2),
             iVar13 = iStack_20 - (short)((short)iVar13 * 0xc9 + 100),
             iVar8 = iStack_24 - (short)((short)iVar8 * 0xc9 + 100), iVar9 = iVar9 + iVar3 * -0xc9,
             iVar9 = iVar9 * iVar9,
             0x2773 < ((int)(iVar9 + (iVar9 >> 0x1f & 3U)) >> 2) + iVar8 * iVar8 + iVar13 * iVar13))
    {
      ...
      uVar6 = thunk_FUN_00601500((void *)((int)param_1 + 0x2eb),iStack_10,iStack_14,iStack_18,
                                 ...
                                 *(undefined2 *)((int)param_1 + 0x1ff),0xb0,uStack_8,0);
      if (0 < (int)uVar6) {
        if (uVar6 == 5) {
          thunk_FUN_0060ec00(param_1);
          param_1[0x83] = 9;
...
LAB_00610911:
      ...
      if (iVar13 == 0) {
LAB_00610969:
        iStack_24 = (int)(short)param_1[0x99];
        fStack_3c = (float)(int)(short)param_1[0x98] * _DAT_007904f8 * _DAT_007904f0;
        fStack_38 = (float)(int)*(short *)((int)param_1 + 0x262) * _DAT_007904f8 * _DAT_007904f0;
        fStack_34 = (float)iStack_24 * _DAT_007904f8 * _DAT_007904f0;
        FUN_006e25d0(DAT_00807598,&iStack_68);
        iStack_24 = (int)*(short *)((int)param_1 + 0x25e);
        fStack_48 = (float)(int)*(short *)((int)param_1 + 0x25a) * _DAT_007904f8 * _DAT_007904f0;
        fStack_44 = (float)(int)(short)param_1[0x97] * _DAT_007904f8 * _DAT_007904f0;
        fStack_40 = (float)iStack_24 * _DAT_007904f8 * _DAT_007904f0;
        FUN_006e25d0(DAT_00807598,&iStack_58);
        sVar7 = (**(code **)(*param_1 + 0x14))
                          (iStack_68 >> 0x10,iStack_64 >> 0x10,iStack_60 >> 0x10,iStack_58 >> 0x10,
                           iStack_54 >> 0x10,iStack_50 >> 0x10);
      ...
      if (DAT_00802a88 != (void *)0x0) {
        ...
        if (iVar13 < 0) {
          uStack_c = (int)(short)(((short)(iVar13 / 200) + sVar7) -
                                 (short)((longlong)iVar13 * 0x51eb851f >> 0x3f)) - 1;
        }
        else {
          uStack_c = (uint)(short)(((short)(iVar13 / 200) + sVar7) -
        ...
        if (((DAT_0080874d != -1) && (*(int *)((int)DAT_00802a88 + 0xf8) != 0)) &&
           ((thunk_FUN_00558c00(DAT_00802a88,*(undefined4 *)((int)DAT_00802a88 + 0x10c),iVar8,iVar13
                                ,&iStack_24,&iStack_20), -1 < (int)uStack_c &&
            ((((int)uStack_c < 5 && (-1 < iStack_24)) &&
             (iVar13 = *(int *)((int)pvVar12 + 0x30), iStack_24 < iVar13)))))) {
          iVar8 = (&DAT_0079aed0)[uStack_c];
LAB_00611039:
          iVar8 = iVar8 + iStack_20;
          if (((iVar8 < 0) || (*(int *)((int)pvVar12 + 0x34) <= iVar8)) ||
             (*(int *)((int)pvVar12 + 0x4c) == 0)) goto LAB_00611c0f;
          cVar2 = *(char *)(iVar8 * iVar13 + iStack_24 + *(int *)((int)pvVar12 + 0x4c));
...
LAB_00610d9f:
        iStack_24 = (int)(short)param_1[0x99];
        fStack_48 = (float)(int)(short)param_1[0x98] * _DAT_007904f8 * _DAT_007904f0;
        fStack_44 = (float)(int)*(short *)((int)param_1 + 0x262) * _DAT_007904f8 * _DAT_007904f0;
        fStack_40 = (float)iStack_24 * _DAT_007904f8 * _DAT_007904f0;
        FUN_006e25d0(DAT_00807598,&iStack_58);
        iStack_24 = (int)*(short *)((int)param_1 + 0x25e);
        fStack_3c = (float)(int)*(short *)((int)param_1 + 0x25a) * _DAT_007904f8 * _DAT_007904f0;
        fStack_38 = (float)(int)(short)param_1[0x97] * _DAT_007904f8 * _DAT_007904f0;
        fStack_34 = (float)iStack_24 * _DAT_007904f8 * _DAT_007904f0;
        FUN_006e25d0(DAT_00807598,&iStack_68);
        sVar7 = (**(code **)(*param_1 + 0x14))
                          (iStack_58 >> 0x10,iStack_54 >> 0x10,iStack_50 >> 0x10,iStack_68 >> 0x10,
                           iStack_64 >> 0x10,iStack_60 >> 0x10);
        *(undefined4 *)((int)param_1 + 0x237) = *(undefined4 *)(&DAT_007d2138 + sVar7 * 4);
      }
      else if (iVar13 == 1) {
        iVar13 = *(int *)((int)param_1 + 0x237) + 1;
    ...
    break;
  case 3:
    iVar13 = thunk_FUN_006164e0(param_1,&iStack_10,&iStack_14,&iStack_18);
    if (iVar13 < 1) {
      ...
      *(undefined2 *)(param_1 + 0x9c) = 0xffff;
      ...
      iStack_1c = thunk_FUN_006173a0(param_1,10,&iStack_10,&iStack_14,&iStack_18);
      if (0 < iStack_1c) {
        return iStack_1c;
      }
      goto LAB_006121e1;
...
LAB_00611304:
    ...
    if (DAT_00802a88 != (void *)0x0) {
      ...
      if (((((DAT_0080874d == -1) || (*(int *)((int)DAT_00802a88 + 0xf8) == 0)) ||
           (thunk_FUN_00558c00(DAT_00802a88,*(undefined4 *)((int)DAT_00802a88 + 0x10c),iVar8,iVar13,
                               &iStack_24,&iStack_20), (int)uStack_c < 0)) ||
          (((4 < (int)uStack_c || (iStack_24 < 0)) ||
           ((*(int *)((int)pvVar12 + 0x30) <= iStack_24 ||
            ((iVar13 = (&DAT_0079aed0)[uStack_c] + iStack_20, iVar13 < 0 ||
             (*(int *)((int)pvVar12 + 0x34) <= iVar13)))))))) ||
         ((*(int *)((int)pvVar12 + 0x4c) == 0 ||
          (*(char *)(iVar13 * *(int *)((int)pvVar12 + 0x30) + *(int *)((int)pvVar12 + 0x4c) +
                    iStack_24) != '\0')))) goto LAB_00611c0f;
...
LAB_006115da:
    ...
    break;
  case 5:
    iVar13 = thunk_FUN_00616f60(param_1,&iStack_10,&iStack_14,&iStack_18);
    if (iVar13 == 0) {
      return iStack_1c;
    }
    *(short *)((int)param_1 + 0x262) = (short)param_1[0x97];
...
LAB_0061196b:
    ...
    if (DAT_00802a88 != (void *)0x0) {
      ...
      if ((((DAT_0080874d == -1) || (*(int *)((int)DAT_00802a88 + 0xf8) == 0)) ||
          ((thunk_FUN_00558c00(DAT_00802a88,*(undefined4 *)((int)DAT_00802a88 + 0x10c),iVar8,iVar13,
                               &iStack_24,&iStack_20), (int)uStack_c < 0 ||
           ((((4 < (int)uStack_c || (iStack_24 < 0)) || (*(int *)((int)pvVar12 + 0x30) <= iStack_24)
             ) || ((iVar13 = (&DAT_0079aed0)[uStack_c] + iStack_20, iVar13 < 0 ||
                   (*(int *)((int)pvVar12 + 0x34) <= iVar13)))))))) ||
         (*(int *)((int)pvVar12 + 0x4c) == 0)) goto LAB_00611c0f;
...
LAB_00611c0f:
  ...
  case 6:
    ...
    thunk_FUN_00615860((int)*(short *)((int)param_1 + 0x1f5),&iStack_30,&iStack_2c,&iStack_28);
    uVar5 = thunk_FUN_00613140(param_1,((int)(iStack_30 + (iStack_30 >> 0x1f & 0x3ffU)) >> 10) +
                                       (int)*(short *)((int)param_1 + 0x1e9),
                               ((int)(iStack_2c + (iStack_2c >> 0x1f & 0x3ffU)) >> 10) +
                               (int)*(short *)((int)param_1 + 0x1eb),
                               ((int)(iStack_28 + (iStack_28 >> 0x1f & 0x3ffU)) >> 10) +
                               (int)*(short *)((int)param_1 + 0x1ed),
                               (int)*(short *)((int)param_1 + 0x1e9),
                               (int)*(short *)((int)param_1 + 0x1eb),
                               (int)*(short *)((int)param_1 + 0x1ed));
  ...
  case 7:
    if ((*(char *)((int)param_1 + 0x2e9) != '\0') &&
      ...
      iStack_24 = thunk_FUN_004ac910(*(void **)((int)param_1 + 0x252),'\x0e');
      if (0xe < iVar13) {
        if (iVar13 == 0xf) {
          STT3DSprC::StartShow
      ...
      sVar7 = (short)(iVar13 >> 0x1f);
      if (iVar13 < 0) {
        iStack_24 = (short)(((short)(iVar13 / 200) + sVar7) -
                           (short)((longlong)iVar13 * 0x51eb851f >> 0x3f)) + -1;
      }
      else {
        iStack_24 = (int)(short)(((short)(iVar13 / 200) + sVar7) -
                                (short)((longlong)iVar13 * 0x51eb851f >> 0x3f));
      }
      iVar13 = *(int *)((int)param_1 + 0x22f);
      sVar7 = (short)(iVar13 >> 0x1f);
      ...
      if ((((((DAT_0080874d != -1) && (*(int *)((int)DAT_00802a88 + 0xf8) != 0)) &&
            (thunk_FUN_00558c00(DAT_00802a88,*(undefined4 *)((int)DAT_00802a88 + 0x10c),iVar8,iVar13
                                ,&iStack_20,(int *)&uStack_c), -1 < iStack_24)) &&
           ((iStack_24 < 5 && (-1 < iStack_20)))) &&
          (((iStack_20 < *(int *)((int)pvVar12 + 0x30) &&
            ((iVar13 = (&DAT_0079aed0)[iStack_24] + uStack_c, -1 < iVar13 &&
  ...
  case 8:
    ...
    *(short *)(param_1 + 0x97) = sVar10;
    ...
    uStack_8 = CONCAT22(sVar7,(undefined2)uStack_8);
    *(short *)((int)param_1 + 0x25e) = sVar7;
    if (0x648 < iVar13) {
      ...
      *(undefined2 *)(param_1 + 0x9c) = 0xffff;
      ...
      param_1[0xa5] = (uVar6 >> 0x10) % 0xb + 10 + *(int *)(DAT_00802a38 + 0xe4);
      param_1[0xa6] = *(int *)(DAT_00802a38 + 0xe4);
      iStack_1c = thunk_FUN_006173a0(param_1,iVar13,&iStack_10,&iStack_14,&iStack_18);
      if (0 < iStack_1c) {
        *(undefined2 *)((int)param_1 + 0x25a) = (undefined2)iStack_10;
        *(undefined2 *)(param_1 + 0x97) = (undefined2)iStack_14;
        *(undefined2 *)((int)param_1 + 0x25e) = (undefined2)iStack_18;
        return iStack_1c;
      }
      goto LAB_006121e1;
    }
...
LAB_00612459:
    ...
    if (DAT_00802a88 != (void *)0x0) {
      ...
      if ((((((DAT_0080874d == -1) || (*(int *)((int)DAT_00802a88 + 0xf8) == 0)) ||
            (thunk_FUN_00558c00(DAT_00802a88,*(undefined4 *)((int)DAT_00802a88 + 0x10c),iVar8,iVar13
                                ,&iStack_20,(int *)&uStack_c), iStack_24 < 0)) ||
           ((4 < iStack_24 || (iStack_20 < 0)))) || (*(int *)((int)pvVar12 + 0x30) <= iStack_20)) ||
         (((iVar13 = (&DAT_0079aed0)[iStack_24] + uStack_c, iVar13 < 0 ||
