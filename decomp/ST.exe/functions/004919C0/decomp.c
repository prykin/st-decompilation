...
undefined4
FUN_004919c0(short param_1,short param_2,short param_3,short param_4,short param_5,short param_6,
            undefined2 *param_7,undefined2 *param_8,undefined2 *param_9,short *param_10,
...
LAB_00491b42:
  ...
  do {
    local_8 = *(int *)((int)local_20 + iVar9) * (int)DAT_007fb27e;
    if (0 < *(short *)((int)DAT_007fb238 + (local_8 + iVar10 + (int)param_4) * 2)) {
      ...
      do {
        ...
        if ((((-1 < iVar4) && (iVar4 <= DAT_007fb278 + -1)) && (iVar8 = piVar3[1], -1 < iVar8)) &&
          ...
          iVar4 = iVar8 * DAT_007fb278 + local_8 + iVar4;
...
LAB_00491c08:
              if (*(int *)((int)local_48 + iVar9) != 0) goto LAB_00491c1c;
            }
            if (iVar8 < _param_3) {
              *(int *)((int)local_48 + iVar9 + 0x14) = iVar11;
              _param_3 = iVar8;
        ...
        if (iVar11 != -1) {
          if ((iVar10 == -1) || ((*(int *)((int)local_48 + iVar9) == 1 && (local_48[iVar10] == 0))))
          {
            _param_3 = (int)*(short *)((int)DAT_007fb238 +
                                      (*(int *)((int)local_64 + iVar11 * 8) * (int)DAT_007fb278 +
                                       *(int *)((int)local_20 + iVar9) * (int)DAT_007fb27e +
                                      (&local_68)[iVar11 * 2]) * 2);
            iVar10 = _param_6;
          }
