...
void __fastcall FUN_005f4680(int param_1)
  ...
  if (DAT_00802a88 != (void *)0x0) {
    ...
    *(int *)(param_1 + 0xab) = iVar5;
    ...
    if (local_8 == 0) {
      ...
      iVar5 = ((*(int *)(param_1 + 0x9f) - *(int *)(param_1 + 0x93)) * 0x28) / local_8 +
              *(int *)(param_1 + 0x93);
      iVar3 = ((*(int *)(param_1 + 0xa3) - *(int *)(param_1 + 0x97)) * 0x28) / local_8 +
              *(int *)(param_1 + 0x97);
