...
undefined4 __cdecl
thunk_FUN_006a17b0(int *param_1,int param_2,int param_3,int param_4,int param_5,ushort *param_6,
...

{
  ...
  if (iVar2 != 0) {
    ...
    do {
      param_4 = 0;
      piStack_8 = &DAT_007df82c;
      do {
        iVar2 = piStack_8[-1] + param_2;
        iVar6 = *piStack_8 + param_3;
        if ((((-1 < iVar2) && (iVar2 < *param_1)) && (-1 < iVar6)) &&
          ...
          iVar3 = thunk_FUN_006a1370(param_1,iVar2,iVar6,iVar1,(undefined4 *)&uStack_14);
          iVar3 = thunk_FUN_006a24e0(&uStack_14,iVar1,param_6,(int)(short)iVar3,param_5);
          if (iVar3 != 0) {
            if (param_5 == 0xff) {
            ...
            if (param_5 == 0xff) {
              ...
              uVar4 = CONCAT22(uStack_12,uStack_14);
            }
