...
void __thiscall FUN_005a3ab0(void *this,byte *param_1,uint param_2,byte *param_3)
...
LAB_005a3b63:
    if (iVar5 == 0) {
      ...
      if (iVar5 == 0) {
        ...
        pvVar3 = local_14;
        if (pbVar4 != (byte *)0x0) {
          FUN_006b6020(*(int *)((int)local_14 + 0x1af8),0,(char *)pbVar4);
