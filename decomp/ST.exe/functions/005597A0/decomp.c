...

{
  ...
  if ((((this->field_0114 != 0) && (-1 < param_5)) && (param_4 < 8)) &&
    ...
    local_14 = this;
    if (*(int *)(&this->field_0x54 + param_4 * 4) == 0) {
      ...
      if (iVar4 != 0) {
        ...
        iVar4 = ReportDebugMessage(s_E____titans_grig_visible_cpp_007c92cc,0x293,0,iVar4,
                                   &DAT_007a4ccc,s_VisibleClassTy__SetZoneDes_007c93bc);
        if (iVar4 == 0) {
          return;
        }
        pcVar2 = (code *)swi(3);
      ...
      *(undefined4 **)(&this->field_0x54 + param_4 * 4) = puVar5;
      g_currentExceptionFrame = local_60.previous;
    }
    if ((param_7 & 0x1000) != 0) {
        ...
        do {
          ...
          do {
            if ((puVar6 == (undefined *)0x0) || (local_8[iVar7] != '\0')) {
              ...
              if (bVar3) {
                iVar8 = this->field_0020 * iVar4 + *(int *)(&this->field_0x54 + param_4 * 4);
