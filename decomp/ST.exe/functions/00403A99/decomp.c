...

{
  ...
  if (uVar4 == 0) {
    ...
    if (uVar5 == 0) {
      ...
      uStack_48 = __alldiv((uint)(lVar24 - lVar22),(uint)((ulonglong)(lVar24 - lVar22) >> 0x20),
                           (uint)(lVar23 + lVar26),(uint)((ulonglong)(lVar23 + lVar26) >> 0x20));
      lVar24 = __allmul((uint)(uStack_48 - lStack_60),
    ...
    uStack_48 = __alldiv((uint)(lVar24 + lVar26),(uint)((ulonglong)(lVar24 + lVar26) >> 0x20),uVar4,
                         uVar17);
  ...
  lVar22 = __allmul(uVar8 - (uint)uStack_48,iVar13,uVar8 - (uint)uStack_48,iVar13);
