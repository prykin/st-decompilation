...

{
  ...
  if (param_3 == '\0') {
    ...
    local_44[0x1a1] = (HelpPanelTy)0x5;
    *(uint *)(local_44 + 0x1a3) = param_1;
    *(uint *)(local_44 + 0x1a7) = (uint)param_2;
  ...
  ccFntTy::SetSurf(*(ccFntTy **)(this_00 + 0x1e0),*(int *)(this_00 + 0x218),0,0x96,local_8,0x106,0xf
                  );
...
LAB_00516f6b:
  ...
  ccFntTy::WrStr(*(ccFntTy **)(this_00 + 0x1e0),puVar10,iVar7,iVar19,uVar21);
  ccFntTy::SetSurf(*(ccFntTy **)(this_00 + 0x1e8),*(int *)(this_00 + 0x218),0,0x96,local_8 + -3,
                   0x106,0x14);
  local_38 = (uint)param_2;
  ...
  local_40 = FUN_0070b3a0(*(int *)(this_00 + 0x238),
                          (-(uint)((char)local_c != '\x03') & 0xfffffffe) + 4);
  if (local_40 != 0) {
    FUN_006b5440(*(int *)(this_00 + 0x218),0,0xb4,local_8,local_40,0,0x3a);
    local_34 = 0xb4;
     ...
     ((thunk_FUN_004e6e10(local_18,param_1,&local_10,&local_14), local_10 != 0 || (local_14 != 0))))
  {
    ...
    if (local_10 != 0) {
      ...
      thunk_FUN_00540760(*(undefined4 **)(this_00 + 0x218),0x96,local_8,'\x01',pbVar9);
      pbVar9 = local_3c;
      thunk_FUN_00540760(*(undefined4 **)(this_00 + 0x218),0x94,local_8 + -2,'\x06',local_3c);
      local_34 = 0x94;
