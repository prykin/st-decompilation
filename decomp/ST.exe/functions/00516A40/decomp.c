...

{
  ...
  iVar17 = -1;
  iVar6 = -3;
  puVar9 = (uint *)LoadResourceString(0x5622,g_hINSTANCE_00807618);
  ...
  if ((char)local_c == DAT_0080874e) {
    ...
    if (iVar6 != 0) {
      ...
      if ((int)(uint)param_2 <= CONCAT31(extraout_var,uVar4)) {
        ...
        if (CONCAT31(extraout_var_00,uVar4) <= iVar6) {
          ...
          iVar17 = -1;
          iVar6 = 1;
          puVar9 = (uint *)LoadResourceString(0x5d56,g_hINSTANCE_00807618);
          ccFntTy::WrStr(this_00->field_01E0,puVar9,iVar6,iVar17,uVar12);
          iVar6 = 2;
          goto LAB_00516f08;
        }
        ...
        if (iVar6 == 0) {
          ...
          if (iVar6 == 0) {
            ...
            iVar17 = -1;
            iVar6 = 1;
            puVar9 = (uint *)LoadResourceString(0x5d55,g_hINSTANCE_00807618);
            ccFntTy::WrStr(this_00->field_01E0,puVar9,iVar6,iVar17,uVar12);
            iVar6 = 1;
            goto LAB_00516eb8;
          }
    ...
    iVar17 = -1;
    iVar6 = 1;
    puVar9 = (uint *)LoadResourceString(0x5d52,g_hINSTANCE_00807618);
    ccFntTy::WrStr(this_00->field_01E0,puVar9,iVar6,iVar17,uVar12);
    iVar6 = 1;
  }
  else {
    ...
    if (iVar6 < CONCAT31(extraout_var_01,uVar4)) {
      ...
      if (iVar6 == 0) {
        ...
        if (iVar6 != 0) {
          ...
          iVar17 = -1;
          iVar6 = 1;
          puVar9 = (uint *)LoadResourceString(0x5d54,g_hINSTANCE_00807618);
          ccFntTy::WrStr(this_00->field_01E0,puVar9,iVar6,iVar17,uVar12);
          iVar6 = 3;
LAB_00516eb8:
        ...
        iVar17 = -1;
        iVar6 = 1;
        puVar9 = (uint *)LoadResourceString(0x5d53,g_hINSTANCE_00807618);
        ccFntTy::WrStr(this_00->field_01E0,puVar9,iVar6,iVar17,uVar12);
        iVar6 = 3;
      }
LAB_00516f08:
...
LAB_00516f6b:
  ...
  iVar17 = -1;
  iVar6 = -3;
  puVar9 = (uint *)LoadResourceString(0x5623,g_hINSTANCE_00807618);
  ccFntTy::WrStr(this_00->field_01E0,puVar9,iVar6,iVar17,uVar12);
  ccFntTy::SetSurf(this_00->field_01E0,(int)this_00->field_0218,0,0x96,local_8,0x106,0xf);
  uVar12 = (DAT_0080874e != '\x03') - 1 & 5;
  iVar17 = -1;
  ...
  UVar7 = thunk_FUN_005293c0(GVar16);
  ...
  iVar17 = -1;
  iVar6 = -3;
  puVar9 = (uint *)LoadResourceString(0x55f7,g_hINSTANCE_00807618);
  ccFntTy::WrStr(this_00->field_01E0,puVar9,iVar6,iVar17,uVar12);
  ...
  iVar18 = -1;
  iVar17 = -3;
  puVar9 = (uint *)LoadResourceString(0x5624,g_hINSTANCE_00807618);
  ccFntTy::WrStr(this_00->field_01E0,puVar9,iVar17,iVar18,uVar12);
  ccFntTy::SetSurf(this_00->field_01E0,(int)this_00->field_0218,0,0x96,local_8,0x106,0xf);
  ...
  iVar17 = -1;
  iVar6 = -3;
  puVar9 = (uint *)LoadResourceString(0x5625,g_hINSTANCE_00807618);
  ccFntTy::WrStr(this_00->field_01E0,puVar9,iVar6,iVar17,uVar12);
  ccFntTy::SetSurf(this_00->field_01E0,(int)this_00->field_0218,0,0x96,local_8,0x106,0xf);
  UVar7 = 0x5d57;
     ...
     ((thunk_FUN_004e6e10(local_18,param_1,&local_10,&local_14), local_10 != 0 || (local_14 != 0))))
  {
    ...
    iVar17 = -1;
    iVar6 = -3;
    puVar9 = (uint *)LoadResourceString(0x5626,g_hINSTANCE_00807618);
    ccFntTy::WrStr(this_00->field_01E0,puVar9,iVar6,iVar17,uVar12);
    if (local_10 != 0) {
      ccFntTy::SetSurf(this_00->field_01E0,(int)this_00->field_0218,0,0x96,local_8,0x106,0xf);
      pHVar15 = g_hINSTANCE_00807618;
