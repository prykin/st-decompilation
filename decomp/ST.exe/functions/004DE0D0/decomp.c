...

{
  ...
  pDVar1 = g_playerRuntime[*(int *)(param_1 + 0x24)].field2164_0x9ce;
  if (pDVar1 != (DArrayTy *)0x0) {
      ...
      do {
        ...
        if (local_8 == param_1) {
          FUN_006b0c70((AnonShape_006B0C70_7C4FE646 *)
                       g_playerRuntime[*(int *)(param_1 + 0x24)].field2164_0x9ce,uVar2);
          break;
        }
        uVar2 = uVar2 + 1;
        pDVar1 = g_playerRuntime[*(int *)(param_1 + 0x24)].field2164_0x9ce;
    ...
    if ((g_playerRuntime[*(int *)(param_1 + 0x24)].field2164_0x9ce)->count == 0) {
      FUN_006ae110((byte *)g_playerRuntime[*(int *)(param_1 + 0x24)].field2164_0x9ce);
