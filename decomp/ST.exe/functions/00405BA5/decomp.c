...

{
  ...
  if (*(int *)((int)param_1 + 0x5ff) == 0) {
    ...
    *(undefined4 *)((int)param_1 + 0x5ff) = uVar2;
    ...
    if (iVar3 != 0) {
      FUN_006a5e40(iVar3,DAT_007ed77c,0x7bf618,0x3e);
    }
  }
  ...
  if (param_1[0x134] == 4) {
    ...
    if (iVar3 != 0) {
      FUN_006a5e40(iVar3,DAT_007ed77c,0x7bf618,0x57);
    }
