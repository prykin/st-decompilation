...
undefined4 __fastcall thunk_FUN_004d9c80(int *param_1)

{
  ...
  if (*(int *)((int)param_1 + 0x5ff) == 0) {
    ...
    *(STT3DSprC **)((int)param_1 + 0x5ff) = this;
    ...
    if (iVar2 != 0) {
      RaiseInternalException(iVar2,DAT_007ed77c,s_E____titans_Artem_TLO_htech_cpp_007bf618,0x3e);
    }
  }
  ...
  if (param_1[0x134] == 4) {
    wsprintfA((LPSTR)abStack_108,&DAT_007a4ccc,s_lasbom_007bf610);
    iVar2 = STT3DSprC::LoadSequence
                      (*(STT3DSprC **)((int)param_1 + 0x5ff),0xe,DAT_00806774,abStack_108,0x1d);
    if (iVar2 != 0) {
      RaiseInternalException(iVar2,DAT_007ed77c,s_E____titans_Artem_TLO_htech_cpp_007bf618,0x57);
    }
    ...
    param_1[0x136] = iVar2;
    iStack_8 = *(int *)(&DAT_00798eb8 + iVar4) + (int)*(short *)((int)param_1 + 0x41);
