...
undefined8 __cdecl FUN_0072ff20(byte *param_1)

{
  ...
  while( true ) {
    if (DAT_007f148c < 2) {
      local_18 = *(ushort *)(PTR_DAT_007f1280 + (uint)*param_1 * 2) & 8;
    }
    else {
      local_18 = FUN_00730610((uint)*param_1,8);
    }
    if (local_18 == 0) break;
    param_1 = param_1 + 1;
  }
  ...
  while( true ) {
    if (DAT_007f148c < 2) {
      local_1c = *(ushort *)(PTR_DAT_007f1280 + local_8 * 2) & 4;
    }
    else {
      local_1c = FUN_00730610(local_8,4);
    }
    if (local_1c == 0) break;
