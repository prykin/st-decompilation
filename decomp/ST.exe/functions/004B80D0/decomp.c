        ...
        if (local_8 < local_8 + iVar5) {
          do {
            ...
            if (iVar8 < iVar8 + iVar5) {
              do {
                iVar7 = thunk_FUN_004960d0((short)iVar8,(short)local_8,*(short *)(this_01 + 0x5b8));
                if (iVar7 != 0) {
            ...
            local_8 = local_8 + 1;
          } while (local_8 < *(int *)(this_01 + 0x5b4) + iVar5);
        }
      ...
      if (sVar4 != 0) {
        ...
        if (local_8 < local_8 + iVar5) {
          do {
            ...
            if (iVar8 < iVar8 + iVar5) {
              do {
                iVar7 = thunk_FUN_00496140((short)iVar8,(short)local_8,*(short *)(this_01 + 0x5b8));
                if (iVar7 != 0) {
                  RaiseInternalException
