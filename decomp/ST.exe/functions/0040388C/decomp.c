...
void __thiscall
thunk_FUN_00558dc0(void *this,int param_1,int param_2,undefined *param_3,uint param_4,
                  undefined *param_5,int param_6,uint param_7)
  ...
  if ((((*(int *)((int)this + 0x114) != 0) && (-1 < (int)param_5)) && (param_4 < 8)) &&
    ...
    if (*(char *)(uVar7 + 0xfc + (int)this) != '\0') {
      ...
      if (((puVar8 != (undefined *)0x0) && (*(int *)((int)this + 0x38) != 0)) &&
         (((param_7 & 1) != 0 && (iVar11 = 0, puVar9 = param_5, puStack_c = puVar8, 0 < iVar5)))) {
        do {
          iVar10 = 0;
          do {
            if (puStack_c[iVar10] != '\0') {
