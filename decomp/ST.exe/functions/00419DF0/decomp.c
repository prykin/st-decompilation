...

{
  ...
  AnonPointee_STGameObjC_0199 *pAVar5;
  AnonPointee_STGameObjC_01AD *pAVar6;
  AnonPointee_STGameObjC_01B1 *pAVar7;
  AnonPointee_STGameObjC_01C5 *pAVar8;
  AnonPointee_STGameObjC_01C9 *pAVar9;
  ...
  if (this->field_01CD == 0) {
    this->field_01CD = 1;
    iVar3 = Library::DKW::LIB::FUN_006aac70(0x36);
    this->field_011D = iVar3;
    iVar3 = Library::DKW::LIB::FUN_006aac70(0x36);
    this->field_0121 = iVar3;
    iVar3 = Library::DKW::LIB::FUN_006aac70(0x5c);
    this->field_0125 = iVar3;
    iVar3 = Library::DKW::LIB::FUN_006aac70(0x5c);
    this->field_0129 = iVar3;
    uVar1 = this->field_0020;
    if (uVar1 < 0x1af) {
      if (uVar1 == 0x1ae) {
        pAVar6 = (AnonPointee_STGameObjC_01AD *)Library::DKW::LIB::FUN_006aac70(0xb);
        this->field_01AD = pAVar6;
        pAVar7 = (AnonPointee_STGameObjC_01B1 *)Library::DKW::LIB::FUN_006aac70(0xb);
        this->field_01B1 = pAVar7;
        pAVar8 = (AnonPointee_STGameObjC_01C5 *)Library::DKW::LIB::FUN_006aac70(6);
        this->field_01C5 = pAVar8;
        pAVar9 = (AnonPointee_STGameObjC_01C9 *)Library::DKW::LIB::FUN_006aac70(6);
        this->field_01C9 = pAVar9;
      }
      else if (uVar1 < 0x173) {
        if (uVar1 != 0x172) {
          if (uVar1 == 0x14) {
            ...
            this->field_017D = 0;
            this->field_0181 = 0;
            pAVar4 = (AnonPointee_STGameObjC_0195 *)Library::DKW::LIB::FUN_006aac70(0x13);
            this->field_0195 = pAVar4;
            pAVar5 = (AnonPointee_STGameObjC_0199 *)Library::DKW::LIB::FUN_006aac70(0x13);
            this->field_0199 = pAVar5;
            pAVar6 = (AnonPointee_STGameObjC_01AD *)Library::DKW::LIB::FUN_006aac70(0xb);
            this->field_01AD = pAVar6;
            pAVar7 = (AnonPointee_STGameObjC_01B1 *)Library::DKW::LIB::FUN_006aac70(0xb);
            this->field_01B1 = pAVar7;
            iVar3 = Library::DKW::LIB::FUN_006aac70(0x240);
            this->field_01BD = iVar3;
            iVar3 = Library::DKW::LIB::FUN_006aac70(0x240);
            this->field_01C1 = iVar3;
          }
...
cf_common_exit_00419F6C:
        iVar3 = ReportDebugMessage("E:\\__titans\\wlad\\Tc_gobj.cpp",0x54d,0,0,"%s",
      ...
      if (uVar1 == 1000) {
        ...
        this->field_0155 = 0;
        this->field_0159 = 0;
        iVar3 = Library::DKW::LIB::FUN_006aac70(0x129);
        this->field_0185 = iVar3;
        iVar3 = Library::DKW::LIB::FUN_006aac70(0x129);
        this->field_0189 = iVar3;
  ...
  *(undefined2 *)puVar17 = *(undefined2 *)puVar16;
    ...
    if (uVar1 < 0x173) {
      ...
      if (uVar1 == 0x14) {
        ...
        *puVar16 = 0;
        ...
        pAVar5 = this->field_0199;
        pAVar4 = this->field_0195;
        pAVar4->field_0000 = pAVar5->field_0000;
        pAVar4->field_0004 = pAVar5->field_0004;
        pAVar4->field_0008 = pAVar5->field_0008;
        pAVar4->field_000C = pAVar5->field_000C;
        pAVar4->field_0010 = pAVar5->field_0010;
        pAVar4->field_0012 = pAVar5->field_0012;
        /* ST_PSEUDO[raw_indirect_call]: expected typed vtable/callback call with explicit __thiscall receiver */
        (*(code *)this->vtable->field_0058)(this->field_01B1);
        pAVar7 = this->field_01B1;
        pAVar6 = this->field_01AD;
  ...
  iVar3 = ReportDebugMessage("E:\\__titans\\wlad\\Tc_gobj.cpp",0x5a5,0,0,"%s",
                             "STGameObjC::SetSelfCheckFlag unknown game type");
  if (iVar3 == 0) {
    return;
  }
