...
void __thiscall FUN_00690650(void *this,int param_1)
...
LAB_00690763:
  if ((bVar12) && (*(short *)(param_1 + 0x1a) != -1)) {
    ...
    local_c = this;
    iVar7 = __setjmp3(local_94,0,unaff_EDI,unaff_ESI);
    this_00 = local_c;
    if (iVar7 == 0) {
      if (DAT_007fa174 == 0) {
        uVar8 = 0;
        ...
        uVar8 = thunk_FUN_0042b620((uint)*(byte *)((int)local_c + 0x24),local_10,1);
      }
            ...
            do {
              ...
              if ((iVar10 != 0) && (*(int *)(iVar10 + 4) != 0)) {
                ...
                if ('\0' < local_4c) {
                  ...
                  FUN_006ae1c0(*(uint **)((int)local_c + 0xc9),(undefined4 *)&local_1c);
                  DAT_00858df8 = (undefined4 *)local_98;
                  return;
                }
              }
              local_8 = local_8 + 1;
              iVar10 = *(int *)((int)local_c + 0xa5);
