...
undefined4 __thiscall thunk_FUN_006164e0(void *this,int *param_1,int *param_2,int *param_3)

{
  ...
  iVar2 = thunk_FUN_00616280(this,&iStack_10,&iStack_14,&iStack_18);
  if (iVar2 < 0) {
    return 0xffffffff;
  }
  iVar5 = *(int *)((int)this + 0x298);
  iVar6 = *(int *)(DAT_00802a38 + 0xe4);
  iStack_8 = (int)*(short *)((int)this + 0x25a);
  iStack_c = (int)*(short *)((int)this + 0x25c);
  *(int *)((int)this + 0x298) = iVar6;
  iVar2 = (int)*(short *)((int)this + 0x25e);
  iVar3 = iStack_10 - *(short *)((int)this + 0x2cb);
  iVar4 = iStack_14 - *(short *)((int)this + 0x2cd);
  iVar6 = (iVar6 - iVar5) * *(int *)((int)this + 0x288);
  iVar5 = iStack_18 - *(short *)((int)this + 0x2cf);
  if (0xe1 < iVar5 * iVar5 + iVar4 * iVar4 + iVar3 * iVar3) {
    if ((iStack_18 - iVar2) * *(int *)((int)this + 0x284) +
        (iStack_14 - iStack_c) * *(int *)((int)this + 0x280) +
        (iStack_10 - iStack_8) * *(int *)((int)this + 0x27c) < 0) {
      ...
      fVar8 = thunk_FUN_00616400((int)this,iStack_10,iStack_14,iStack_18);
      if (fVar8 != (float10)_DAT_0079034c) {
        sVar1 = *(short *)((int)this + 0x25a);
        lVar9 = __ftol();
        iStack_8 = (int)*(short *)((int)this + 0x25c);
        lVar10 = __ftol();
        iStack_c = (int)*(short *)((int)this + 0x25e);
        lVar11 = __ftol();
        iVar2 = FUN_006acf0d((int)sVar1,iStack_8,iStack_c,iStack_10,iStack_14,iStack_18);
        iVar2 = (iVar2 << 3) / *(int *)((int)this + 0x288);
        if (iVar2 != 0) {
          *(short *)((int)this + 0x26c) = (short)(((iStack_10 - (int)lVar9) * 8) / iVar2);
          *(short *)((int)this + 0x26e) = (short)(((iStack_14 - (int)lVar10) * 8) / iVar2);
          *(short *)((int)this + 0x270) = (short)(((iStack_18 - (int)lVar11) * 8) / iVar2);
        }
      }
      *(undefined1 *)((int)this + 0x29c) = 0;
      iStack_8 = (*(int *)((int)this + 0x27c) * iVar6) / 10000 + (int)*(short *)((int)this + 0x25a);
      iStack_c = (*(int *)((int)this + 0x280) * iVar6) / 10000 + (int)*(short *)((int)this + 0x25c);
      ...
      if (((sVar1 != 0) || (*(short *)((int)this + 0x26e) != 0)) ||
        ...
        iVar6 = FUN_006acf0d((int)*(short *)((int)this + 0x25a),(int)*(short *)((int)this + 0x25c),
                             (int)*(short *)((int)this + 0x25e),iStack_8,iStack_c,iVar2);
        if (iVar6 != 0) {
          *(int *)((int)this + 0x27c) = ((iStack_8 - *(short *)((int)this + 0x25a)) * 10000) / iVar6
          ;
