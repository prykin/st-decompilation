        ...
        if ((*(int *)((int)this + 0x74a) <= (int)*(short *)(DAT_00806724 + 0x23) / 2) &&
          ...
          do {
            ...
            if (DAT_0080732c == 1) {
              ...
              bVar26 = 0;
              lVar17 = __ftol();
              iVar15 = (int)sStack_1c +
                       *(short *)((int)this + 0x45) + iStack_10 + (int)(short)lVar17;
              iVar7 = (int)*(short *)((int)this + 0x43) - (int)uStack_20._2_2_;
              iVar10 = (int)(short)uStack_20 + iVar6 + *(short *)((int)this + 0x41);
            }
            else {
              iVar15 = (int)sStack_1c + iStack_10 + *(short *)((int)this + 0x45);
    ...
    if (((int)uVar13 <= (int)*(short *)(DAT_00806724 + 0x23) / 2) &&
      ...
      do {
        ...
        if (DAT_0080732c == 1) {
          ...
          bVar26 = 0;
          lVar17 = __ftol();
          iVar15 = (int)sStack_1c + *(short *)((int)this + 0x45) + iStack_18 + (int)(short)lVar17;
          iVar7 = (int)*(short *)((int)this + 0x43) - (int)uStack_20._2_2_;
          iVar10 = (int)(short)uStack_20 + iVar6 + *(short *)((int)this + 0x41);
        }
        else {
          iVar15 = (int)sStack_1c + iStack_18 + *(short *)((int)this + 0x45);
          uStack_20._2_2_ = (short)((uint)uVar2 >> 0x10);
          iVar7 = (int)*(short *)((int)this + 0x43) - (int)uStack_20._2_2_;
          uStack_20._0_2_ = (short)uVar2;
          iVar10 = (int)(short)uStack_20 + iVar6 + *(short *)((int)this + 0x41);
