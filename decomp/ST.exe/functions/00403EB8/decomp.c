        ...
        if ((*(int *)(this + 0x74a) <= (int)*(short *)(DAT_00806724 + 0x23) / 2) &&
          ...
          do {
            ...
            if (DAT_0080732c == 1) {
              ...
              iVar16 = (int)sStack_1c + *(short *)(this + 0x45) + iStack_10 + (int)(short)lVar18;
              iVar7 = (int)*(short *)(this + 0x43) - (int)uStack_20._2_2_;
              iVar10 = (int)(short)uStack_20 + iVar6 + *(short *)(this + 0x41);
            }
            else {
              iVar16 = (int)sStack_1c + iStack_10 + *(short *)(this + 0x45);
              uStack_20._2_2_ = (short)((uint)uVar2 >> 0x10);
              iVar7 = (int)*(short *)(this + 0x43) - (int)uStack_20._2_2_;
              uStack_20._0_2_ = (short)uVar2;
              iVar10 = (int)(short)uStack_20 + iVar6 + *(short *)(this + 0x41);
            }
        ...
        if (*(int *)(DAT_00802a38 + 0xe4) == *(int *)(this + 0x574) + *(int *)(this + 0x578)) {
          ...
          *(uint *)(this + 0x1c) = uVar1;
          uStack_20 = CONCAT22((short)((uVar1 >> 0x10) %
                               ...
                               (short)iVar6);
          puVar9 = (undefined4 *)thunk_FUN_0041dc40(auStack_28,uStack_20,0,*(short *)(this + 0x6c));
          uVar2 = *puVar9;
          sStack_1c = *(short *)(puVar9 + 1);
          uStack_20._2_2_ = (short)((uint)uVar2 >> 0x10);
          iVar25 = (int)uStack_20._2_2_;
          uStack_20._0_2_ = (short)uVar2;
          iVar6 = (int)(short)uStack_20;
          uStack_20 = uVar2;
    ...
    if (((int)uVar13 <= (int)*(short *)(DAT_00806724 + 0x23) / 2) &&
      ...
      do {
        ...
        if (DAT_0080732c == 1) {
          ...
          bVar27 = 0;
          lVar18 = Library::MSVCRT::__ftol();
          iVar16 = (int)sStack_1c + *(short *)(this + 0x45) + iStack_18 + (int)(short)lVar18;
          iVar7 = (int)*(short *)(this + 0x43) - (int)uStack_20._2_2_;
          iVar10 = (int)(short)uStack_20 + iVar6 + *(short *)(this + 0x41);
        }
        else {
          iVar16 = (int)sStack_1c + iStack_18 + *(short *)(this + 0x45);
          uStack_20._2_2_ = (short)((uint)uVar2 >> 0x10);
          iVar7 = (int)*(short *)(this + 0x43) - (int)uStack_20._2_2_;
          uStack_20._0_2_ = (short)uVar2;
          iVar10 = (int)(short)uStack_20 + iVar6 + *(short *)(this + 0x41);
