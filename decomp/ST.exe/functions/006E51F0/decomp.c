...

{
  ...
  if (iVar2 == 0) {
    ...
    if (iVar2 != 0) {
      RaiseInternalException(iVar2,DAT_007ed77c,s_E__Ourlib_Sapp_cpp_007ee78c,0x364);
    }
    g_currentExceptionFrame = pIVar5;
    return 0;
  }
  g_currentExceptionFrame = pIVar5;
  iVar4 = ReportDebugMessage(s_E__Ourlib_Sapp_cpp_007ee78c,0x366,0,iVar2,&DAT_007a4ccc,
  ...
  RaiseInternalException(iVar2,0,s_E__Ourlib_Sapp_cpp_007ee78c,0x367);
  return iVar2;
}
