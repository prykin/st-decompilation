...

{
  ...
  local_1c = *(uint **)((int)&DAT_007f4e24 + iVar6 + 1);
  local_28 = *(uint **)((int)&DAT_007f4e29 + iVar6);
  local_24 = *(uint **)((int)&DAT_007f5107 + iVar6);
  local_94.previous = g_currentExceptionFrame;
  g_currentExceptionFrame = &local_94;
  local_18 = this;
  iVar6 = Library::MSVCRT::__setjmp3(local_94.jumpBuffer,0,unaff_EDI,unaff_ESI);
  if (iVar6 != 0) {
    ...
    if (iVar13 == 0) {
      RaiseInternalException(iVar6,0,s_E____titans_wlad_to_allpl_cpp_007a6004,0x67f);
      return 0xffffffff;
    }
    pcVar1 = (code *)swi(3);
    uVar9 = (*pcVar1)();
  ...
  if (param_4 == (int *)0x0) {
    RaiseInternalException(-0x5001fffc,DAT_007ed77c,s_E____titans_wlad_to_allpl_cpp_007a6004,0x5bd);
  }
  puVar4 = local_28;
  if ((short)param_3 == -1) {
    uVar12 = local_28[3];
    ...
    if (CONCAT31(extraout_var,bVar5) == 1) {
      RaiseInternalException
                (-0x5001fffa,DAT_007ed77c,s_E____titans_wlad_to_allpl_cpp_007a6004,0x5c0);
    }
                ...
                if (((&DAT_00800ff0)[iVar8 + 0x41U >> 5] & 1 << ((byte)(iVar8 + 0x41U) & 0x1f)) == 0
                  ...
                  if ((*(uint *)(&DAT_00801460 + (iVar8 + 0x41U >> 5) * 4) &
                    ...
                    if (((&DAT_00800fe0)[iVar8 + 0x41U >> 5] & 1 << ((byte)(iVar8 + 0x41U) & 0x1f))
                        == 0) {
                      iVar13 = ReportDebugMessage(s_E____titans_wlad_to_allpl_cpp_007a6004,0x613,0,0
                                                  ,&DAT_007a4ccc,
                ...
                if (((&DAT_00801430)[iVar8 - 0x32U >> 5] & 1 << ((byte)(iVar8 - 0x32U) & 0x1f)) == 0
                  ...
                  if (((&DAT_00801440)[iVar8 - 0x32U >> 5] & 1 << ((byte)(iVar8 - 0x32U) & 0x1f)) ==
                    ...
                    if (((&DAT_00800f60)[iVar8 - 0x32U >> 5] & 1 << ((byte)(iVar8 - 0x32U) & 0x1f))
                        == 0) {
                      iVar13 = ReportDebugMessage(s_E____titans_wlad_to_allpl_cpp_007a6004,0x653,0,0
                                                  ,&DAT_007a4ccc,
...
LAB_0042eb3e:
    ...
    local_44 = 1;
    local_3c = uVar12;
    (**(code **)(*DAT_00802a38 + 8))(0x10ff,local_10,&local_c,local_50,0);
    Library::DKW::TBL::FUN_006ae140(local_1c,uVar12,&local_c);
    iVar6 = param_5;
  }
  else {
...
LAB_0042ebf6:
  ...
  if (iVar6 == 0x1d) {
    if (local_24 == (uint *)0x0) {
      local_24 = Library::DKW::TBL::FUN_006ae290((uint *)0x0,1,2,1);
      *(uint **)((int)&DAT_007f5107 + (char)param_1 * 0xa62) = local_24;
    }
    puVar4 = local_24;
    uVar12 = local_24[3];
    uVar2 = uVar12;
