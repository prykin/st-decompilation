...
thunk_FUN_004c7cc0(void *this,int param_1,uint param_2,uint param_3,int param_4,undefined4 param_5,
      ...
      *(int *)((int)this + 0x36d) = iVar4;
      if (iVar4 == 0) {
        *(int *)((int)this + 0x365) = *(int *)((int)this + 0x361);
        iVar4 = thunk_FUN_004c90c0((int)this);
        if (iVar4 == 0) {
    ...
    if (iVar4 != 0) {
      ...
      if ((iVar4 == 0) || (bVar3 = thunk_FUN_004c7c20((int)this), CONCAT31(extraout_var,bVar3) == 0)
        ...
        if (*(int *)((int)this + 0x361) == 0) {
          ...
          *(uint *)((int)this + 0x369) = param_2;
          *(undefined4 *)((int)this + 0x38c) = *(undefined4 *)(DAT_00802a38 + 0xe4);
