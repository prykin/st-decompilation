...

{
  ...
  if (iVar3 == 0) {
    ...
    iVar3 = 1;
    bVar8 = 0;
    pCVar4 = FUN_006f2c00(&DAT_007cbc5c,1,(uint)(*(char *)((int)pvStack_8 + 0x5d) != '\0'));
    uVar5 = FUN_0070a9f0(DAT_00806780,pCVar4,bVar8,iVar3);
    *(undefined4 *)((int)pvStack_8 + 0x5e) = uVar5;
    puVar7 = (undefined4 *)((int)pvStack_8 + 0x18);
    ...
    *(undefined4 *)((int)pvStack_8 + 0x28) = 0x13;
    ...
    thunk_FUN_00590580();
    thunk_FUN_0055ddf0(DAT_0080759c,DAT_008075a8,*(int *)((int)pvStack_8 + 0x5e),10,2);
    this = DAT_00802a30;
    if (DAT_00802a30 != (void *)0x0) {
