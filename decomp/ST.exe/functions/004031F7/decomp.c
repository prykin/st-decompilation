...
void thunk_FUN_005bc050(char param_1)

{
  ...
  if (param_1 != '\0') {
    if (*(uint *)(iStack_c + 0x1a73) != 0) {
      FUN_006e56b0(*(void **)(iStack_c + 0xc),*(uint *)(iStack_c + 0x1a73));
    }
    *(undefined4 *)(iStack_c + 0x1a73) = 0;
    *(undefined4 *)(iStack_c + 0x1a61) = 0;
    FUN_006b5f80(DAT_008075a8,0x79,0x51,0x22e,0x145);
    if (*(int *)(iStack_c + 0x1c96) != 0) {
      thunk_FUN_005aafb0();
      FUN_0072e2b0(*(undefined4 **)(iStack_c + 0x1c96));
      *(undefined4 *)(iStack_c + 0x1c96) = 0;
    }
    ...
    *(undefined1 **)(iStack_c + 0x1c96) = puVar3;
    if (puVar3 != (undefined1 *)0x0) {
      uVar9 = 0;
      cVar8 = '\x01';
      uVar7 = 0x10;
      ...
      if (uVar7 != 0) {
        iVar2 = *(int *)(iStack_c + 0x1c96);
        *(undefined1 *)(iVar2 + 2) = 0;
        *(undefined4 *)(iVar2 + 0x17) = 0xffffffff;
        uVar7 = *(uint *)(*(int *)(iStack_c + 0x1c96) + 3);
        if (-1 < (int)uVar7) {
    ...
    if (*(uint *)(iStack_c + 0x1a7b) != 0xffffffff) {
      FUN_006b3af0(*(int **)(iStack_c + 0x1abf),*(uint *)(iStack_c + 0x1a7b));
    }
    if (*(uint *)(iStack_c + 0x1b0c) != 0xffffffff) {
      FUN_006b3af0(*(int **)(iStack_c + 0x1b50),*(uint *)(iStack_c + 0x1b0c));
    }
    if (*(uint *)(iStack_c + 0x1b9d) != 0xffffffff) {
      FUN_006b3af0(*(int **)(iStack_c + 0x1be1),*(uint *)(iStack_c + 0x1b9d));
    }
    puVar5 = (uint *)(iStack_c + 0x1c2a);
    uStack_8 = 0x16;
    do {
  ...
  if (*(uint *)(iStack_c + 0x1c86) != 0) {
    FUN_006e56b0(*(void **)(iStack_c + 0xc),*(uint *)(iStack_c + 0x1c86));
    *(undefined4 *)(iStack_c + 0x1c86) = 0;
    FUN_006b5f80(DAT_008075a8,0x79,0x197,0x22e,0x2e);
    if (*(int *)(iStack_c + 0x1c9a) != 0) {
      thunk_FUN_005aafb0();
      FUN_0072e2b0(*(undefined4 **)(iStack_c + 0x1c9a));
      *(undefined4 *)(iStack_c + 0x1c9a) = 0;
    }
    puVar3 = (undefined1 *)FUN_0072e530(0x33);
    if (puVar3 == (undefined1 *)0x0) {
      puVar3 = (undefined1 *)0x0;
    ...
    *(undefined1 **)(iStack_c + 0x1c9a) = puVar3;
    if (puVar3 != (undefined1 *)0x0) {
      uVar9 = 0;
      cVar8 = '\x01';
      uVar7 = 0x10;
      ...
      if (uVar7 != 0) {
        iVar2 = *(int *)(iStack_c + 0x1c9a);
        *(undefined1 *)(iVar2 + 2) = 0;
        *(undefined4 *)(iVar2 + 0x17) = 0xffffffff;
        uVar7 = *(uint *)(*(int *)(iStack_c + 0x1c9a) + 3);
        if (-1 < (int)uVar7) {
          FUN_006b3430(DAT_008075a8,uVar7);
        }
        thunk_FUN_005ab0a0();
    ...
    thunk_FUN_00540620(0x79,0x197,0x79,0x197,0x22e,(byte *)0x2e,'\x01',
                       *(BITMAPINFO **)(DAT_0081176c + 0x2c));
    FUN_006b3af0(DAT_008075a8,*(uint *)(iStack_c + 0x1c8a));
  }
  if (DAT_00802a30 != 0) {
    if (*(int *)(DAT_00802a30 + 0xa9) == 0) {
