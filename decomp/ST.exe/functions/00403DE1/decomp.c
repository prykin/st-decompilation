...
int __thiscall thunk_FUN_004e2340(void *this,uint param_1,int param_2,undefined4 *param_3)

{
  ...
  if ((*(int *)((int)this + param_1 * 0x28 + 0x4d0) == param_2) &&
    ...
    if ((uint)(iVar5 + iVar4) <= *(uint *)(DAT_00802a38 + 0xe4)) {
      param_1 = ((*(uint *)(DAT_00802a38 + 0xe4) - iVar5) *
      ...
      do {
        ...
        if ((0 < iVar5) && (iStack_8 = -iVar5, iStack_8 < 0)) {
          iStack_8 = 0;
        }
        iVar5 = *(int *)((int)this + uVar3 * 0x28 + 0x4f0);
        if ((0 < iVar5) && (iStack_c = -iVar5, iStack_c < 0)) {
          iStack_c = 0;
        }
        ...
        if ((((iStack_8 == 0) ||
             (iVar4 = thunk_FUN_004d7b10(*(char *)((int)this + 0x24),4), iStack_8 <= iVar4)) &&
            ((iStack_c == 0 ||
             (iVar4 = thunk_FUN_004d7b50(*(char *)((int)this + 0x24),4), iStack_c <= iVar4)))) &&
           ((param_2 == 0 ||
            (iVar4 = thunk_FUN_004d7b90(*(char *)((int)this + 0x24),4), param_2 <= iVar4)))) {
          if (iStack_8 != 0) {
            *(int *)((int)this + uVar3 * 0x28 + 0x4ec) =
                 *(int *)((int)this + uVar3 * 0x28 + 0x4ec) + iStack_8;
            thunk_FUN_004d7c10(*(char *)((int)this + 0x24),4,*(int *)((int)this + 0x18),iStack_8);
          }
          if (iStack_c != 0) {
            *(int *)((int)this + uVar3 * 0x28 + 0x4f0) =
                 *(int *)((int)this + uVar3 * 0x28 + 0x4f0) + iStack_c;
            thunk_FUN_004d7d30(*(char *)((int)this + 0x24),4,*(int *)((int)this + 0x18),iStack_c);
          }
          if (param_2 != 0) {
      ...
      *(undefined4 *)((int)this + uVar3 * 0x28 + 0x4e8) = *(undefined4 *)(DAT_00802a38 + 0xe4);
      if (*(int *)((int)this + 0x524) + 0x19U < *(uint *)(DAT_00802a38 + 0xe4)) {
        *(uint *)((int)this + 0x524) = *(uint *)(DAT_00802a38 + 0xe4);
