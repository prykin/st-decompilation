...
undefined4 __fastcall thunk_FUN_005f8d10(int *param_1)
  ...
  case 0:
    ...
    if (*(char *)((int)param_1 + 0x29d) == '\x01') {
      if (*(char *)((int)param_1 + 699) == '\x01') {
        thunk_FUN_004162b0(param_1,&sStack_a,&sStack_8,&sStack_6);
        if ((((int)sStack_a == *(int *)((int)param_1 + 0x291)) &&
            ((int)sStack_8 == *(int *)((int)param_1 + 0x295))) &&
           ((int)sStack_6 == *(int *)((int)param_1 + 0x299))) {
