...
void __fastcall FUN_0058e570(int *param_1)
      ...
      *(uint *)((int)param_1 + 599) = CONCAT31(extraout_var_00,bVar5);
      ...
      if (((*(short *)((int)param_1 + 0x47) != sVar3) || (*(short *)((int)param_1 + 0x49) != sVar2))
         || ((*(short *)((int)param_1 + 0x4b) != sVar1 ||
             (puVar8 = (undefined4 *)
                       thunk_FUN_0042b620(CONCAT31((int3)((uint)local_10 >> 8),
                                                   *(undefined1 *)((int)param_1 + 0x249)),
...
LAB_0058e87e:
      ...
      *(undefined4 *)((int)param_1 + 0x23d) = 0;
      iVar6 = thunk_FUN_004ab880(8,DAT_00806764,(byte *)s_expshark_007cbb28,0x1d);
      if (iVar6 != 0) {
        return;
      }
...
LAB_0058e925:
  if ((*(int *)((int)param_1 + 599) != 4) && (*(int *)((int)param_1 + 599) != 7)) {
    ...
    thunk_FUN_004abf00('\x0e',local_10);
