    ...
    *(int *)(this + 0x47f) = iVar9;
    if (*(uint *)(this + 0x48b) == 0xffff) {
      ...
      if ((((local_8 != (int *)0x0) && (iVar9 = (**(code **)(*local_8 + 0xf8))(), iVar9 == 1)) &&
         ...
         ((iVar9 = (**(code **)(*local_8 + 0xf4))(*(undefined4 *)(this + 0x24)), iVar9 == 1 &&
    ...
    *(undefined4 *)(this + 0x47f) = 0;
    ...
    case 0:
      ...
      if (puVar3 != (uint *)0x0) {
        ...
        local_20 = thunk_FUN_0040c080(this_00,(uint)*(ushort *)(this + 0x32),(int)puVar3);
        local_18 = 0;
        if (0 < (int)puVar3[3]) {
          do {
            ...
            if ((iVar9 != -4) && (iVar9 < 9)) {
              ...
              if ((iVar9 != 0) &&
                 ((iVar9 = (**(code **)(*local_8 + 0xf0))(), iVar9 != 0 &&
                  (iVar9 = (**(code **)(*local_8 + 0xf4))(*(undefined4 *)(this + 0x24)), iVar9 != 0)
                  ))) {
                ...
                if ((((uint)*(ushort *)((int)local_8 + 0x32) == *(uint *)(this + 0x48b)) &&
                    (local_8[9] == *(int *)(this + 0x487))) &&
                   (((*(int *)(this + 0x483) == 1 &&
                     (((iVar9 = local_8[8], iVar9 == 0x14 || (iVar9 == 1000)) || (iVar9 == 0x3e9))))
                    || ((*(int *)(this + 0x483) == 3 && (local_8[8] == 0x1ae)))))) {
                ...
                iVar6 = FUN_006acf0d((int)*(short *)(this + 0x41),(int)*(short *)(this + 0x43),
                                     (int)*(short *)(this + 0x45),(int)(short)local_14,
                                     (int)(short)local_10,(int)(short)local_c);
                if ((iVar6 == 0) ||
                   (uVar4 = (int)(short)local_c - (int)*(short *)(this + 0x45),
                  ...
                  if (this[0x2b2] != (STBoatC)0x0) {
                    ...
                    do {
                      ...
                      if (*(int *)(this + 0x736) == 0) {
                        iVar6 = STSprGameObjC::CheckRay
                                          ((STSprGameObjC *)this,sVar12,sVar11,(short)local_28,
                                           sVar13,sVar14,(short)local_c,*(int *)(this + 0x79a),
                                           (int *)0x0,0);
                        iVar9 = local_38;
                      }
                      else {
                      ...
                      local_2c = local_2c + 1;
                      local_30 = local_30 + 6;
                    } while (local_2c < (int)(uint)(byte)this[0x2b2]);
                  }
                  iVar9 = iVar9 + 200;
                }
LAB_00489dfc:
                if (((local_8[8] != 0x1ae) && (iVar6 = *(int *)(this + 0x47b), iVar6 != 0)) &&
                ...
                if (local_34 < iVar9) {
                  *(int *)(this + 0x487) = local_8[9];
                  *(uint *)(this + 0x48b) = (uint)*(ushort *)((int)local_8 + 0x32);
                  *(uint *)(this + 0x483) = (-(uint)(local_8[8] != 0x1ae) & 0xfffffffe) + 3;
                  local_34 = iVar9;
                }
              }
            }
            ...
            if (((iVar9 != 0) && (iVar9 = (**(code **)(*local_8 + 0xf0))(), iVar9 != 0)) &&
                 ...
                 uVar10 = (int)uVar4 >> 0x1f, (int)(((uVar4 ^ uVar10) - uVar10) * 10) / iVar9 < 4))
              {
                ...
                if (this[0x2b2] != (STBoatC)0x0) {
                  ...
                  do {
                    puVar5 = (undefined4 *)
                             thunk_FUN_0041dc40(local_58,*(undefined4 *)(local_30 + -2),
                                                *(ushort *)(local_30 + 2),(short)local_24);
                    local_40 = (short)*puVar5;
                    uStack_3e = (ushort)((uint)*puVar5 >> 0x10);
                    sVar11 = *(short *)(this + 0x43) - uStack_3e;
                    ...
                    if (*(int *)(this + 0x736) == 0) {
                      iVar6 = STSprGameObjC::CheckRay
                                        ((STSprGameObjC *)this,sVar12,sVar11,(short)local_28,sVar13,
                                         sVar14,(short)local_c,*(int *)(this + 0x79a),(int *)0x0,0);
                      iVar9 = local_38;
                    }
                    else {
                      iVar6 = STSprGameObjC::CheckRay
                                        ((STSprGameObjC *)this,sVar12,sVar11,(short)local_28,sVar13,
                                         sVar14,(short)local_c,*(int *)(this + 0x79a),(int *)0x0,1);
                      iVar9 = local_38;
                    }
                    local_38 = iVar9;
