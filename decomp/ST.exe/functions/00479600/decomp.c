...
LAB_0047b2dc:
      ...
      case 1:
        ...
        if (((local_8 != (int *)0x0) && (local_8[6] == *(int *)((int)this + 0x63f))) &&
           (iVar8 = (**(code **)(*local_8 + 0xf8))(), iVar8 != 0)) {
          if (*(int *)((int)this + 0x635) != 1) {
            return 2;
          }
          sVar17 = *(short *)((int)this + 0x643);
              ...
              if (*(int *)((int)this + 0x667) == 0) {
                ...
                if ((((iVar8 == 7) || (iVar8 == 0x13)) || (iVar8 == 0x1b)) &&
                   ((*(int *)((int)this + 0x7ca) != 0 &&
                    (iVar8 = FUN_006e62d0(DAT_00802a38,*(int *)((int)this + 0x7ca),(int *)&local_8),
                    iVar8 != -4)))) {
                  ...
                  uVar25 = 0;
                  iVar12 = 0;
                  uVar10 = thunk_FUN_004ad650((int)local_8 + 0x1d5);
                }
                else {
                  iVar22 = (int)*(short *)((int)this + 0x45);
                  iVar8 = (int)*(short *)((int)this + 0x43);
...
LAB_0047acdc:
            ...
            *(uint *)((int)this + 0x1c) = uVar25;
            ...
            if ((*(int *)((int)this + 0x74a) <= (int)*(short *)(DAT_00806724 + 0x23) / 2) &&
              ...
              do {
                ...
                if (DAT_0080732c == 1) {
                  ...
                  lVar16 = __ftol();
                  iVar15 = (int)local_24 +
                           *(short *)((int)this + 0x45) + local_20 + (int)(short)lVar16;
                  iVar9 = (int)*(short *)((int)this + 0x43) - (int)local_28._2_2_;
                  iVar12 = (int)(short)local_28 + iVar8 + *(short *)((int)this + 0x41);
                }
                else {
                  iVar15 = (int)local_24 + local_20 + *(short *)((int)this + 0x45);
            ...
            if ((local_8 != (int *)0x0) &&
               (iVar8 = local_8[6], iVar8 == *(int *)((int)this + 0x63f))) {
              iVar22 = (**(code **)(*local_8 + 0xf8))();
              iVar8 = 0;
              if (iVar22 != 0) {
...
joined_r0x0047b202:
              ...
              if (local_8[0x10b] != 0) {
                ...
                if (piVar13 != (int *)0x0) {
                  *piVar13 = local_8[0x10e];
                }
              }
              if (local_8[0x10b] == 0) {
                uVar10 = CONCAT22((short)((uint)local_8 >> 0x10),*(short *)((int)this + 0x647) + 1);
                iVar8 = CONCAT22((short)((uint)((int)this + 0x651) >> 0x10),
                                 *(undefined2 *)((int)this + 0x643));
          ...
          if ((*(int *)((int)this + 0x74a) <= (int)*(short *)(DAT_00806724 + 0x23) / 2) &&
            ...
            do {
              ...
              if (DAT_0080732c == 1) {
                ...
                lVar16 = __ftol();
                iVar15 = (int)local_24 +
                         *(short *)((int)this + 0x45) + local_18 + (int)(short)lVar16;
                iVar9 = (int)*(short *)((int)this + 0x43) - (int)local_28._2_2_;
                iVar12 = (int)(short)local_28 + iVar8 + *(short *)((int)this + 0x41);
              }
              else {
                iVar15 = (int)local_24 + local_18 + *(short *)((int)this + 0x45);
                local_28._2_2_ = (short)((uint)uVar4 >> 0x10);
                iVar9 = (int)*(short *)((int)this + 0x43) - (int)local_28._2_2_;
                local_28._0_2_ = (short)uVar4;
                iVar12 = (int)(short)local_28 + iVar8 + *(short *)((int)this + 0x41);
