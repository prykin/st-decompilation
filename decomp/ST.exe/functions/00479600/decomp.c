  ...
  if ((param_1 == 0) || (param_1 == 1)) {
    ...
    *(undefined4 *)&this->field_0x64d = 0;
    ...
    if (iVar9 == 0) {
      ...
      if (((((sVar18 < 0) || (g_worldGrid.sizeX <= sVar18)) || (sVar15 < 0)) ||
          ((g_worldGrid.sizeY <= sVar15 || (sVar19 < 0)))) || (g_worldGrid.sizeZ <= sVar19)) {
        local_8 = (STWorldObject *)0x0;
      }
      else {
        local_8 = g_worldGrid.cells
                  [(int)g_worldGrid.planeStride * (int)sVar19 + (int)sVar15 * (int)g_worldGrid.sizeX
                   + (int)sVar18].objects[0];
      }
      if (local_8 == (STWorldObject *)0x0) {
        return 0;
      }
      iVar9 = (*local_8->vtable->GetObjectTypeId)(local_8);
      if (iVar9 != 0x37) {
        return 0;
      }
      ...
      if (((sVar18 < 0) || (g_worldGrid.sizeX <= sVar18)) ||
         (((sVar15 < 0 || ((g_worldGrid.sizeY <= sVar15 || (sVar19 < 0)))) ||
    ...
    *(undefined4 *)((int)&this->field_0666 + 1) = 0;
    ...
    if (iVar9 == 0) {
      ...
      case 0:
          ...
          if ((((sVar18 < 0) || (g_worldGrid.sizeX <= sVar18)) ||
            ...
            local_8 = g_worldGrid.cells
                      [(int)g_worldGrid.planeStride * (int)sVar19 +
                       (int)sVar15 * (int)g_worldGrid.sizeX + (int)sVar18].objects[0];
          }
          if (local_8 == (STWorldObject *)0x0) {
            return 0;
          }
        ...
        bVar7 = sub_004939B0(this,(short *)&this->field_0x651,(short *)&this->field_0x653,
                             (short *)&this->field_0x655);
        if ((CONCAT31(extraout_var,bVar7) != 1) ||
           (iVar9 = thunk_FUN_004e91e0(local_8,this), iVar9 != 1)) {
LAB_00479e39:
          ...
          if (iVar9 != 3) {
            if (iVar9 == 4) {
              if (*(int *)((int)&this->field_0666 + 1) == 0) {
                ...
                if ((((SVar5 == CASE_7) || (SVar5 == CASE_13)) || (SVar5 == CASE_1B)) &&
                   ((this->field_07CA != 0 &&
                    (iVar9 = FUN_006e62d0(PTR_00802a38,this->field_07CA,(int *)&local_8),
                    iVar9 != -4)))) {
                  ...
                  uVar26 = 0;
                  iVar13 = 0;
                  uVar11 = thunk_FUN_004ad650((int)((int)&local_8[0xd].vtable + 1));
                }
                else {
                  iVar23 = (int)this->field_0045;
                  iVar9 = (int)this->field_0043;
            ...
            if (iVar9 == 5) {
              ...
              if ((*(int *)((int)&this->field_0666 + 1) == 3) &&
                ...
                *(undefined4 *)&this->field_0x742 = 0;
                if ((sVar18 < 0) ||
                   ((((g_worldGrid.sizeX <= sVar18 || (sVar15 < 0)) || (g_worldGrid.sizeY <= sVar15)
...
LAB_0047acdc:
            ...
            if (iVar9 != 6) {
              ...
              SubmarineTitans::Recovered::HiddenThis::AnonReceiver_0048DFD0::thunk_FUN_0048dfd0
                        ((AnonReceiver_0048DFD0 *)this,iVar23,iVar9,uVar11,iVar23,iVar9,
                         (int *)uVar11,1,(short *)&this->field_0x651,(short *)&this->field_0x653,
                         (short *)&this->field_0x655);
              goto LAB_0047b2dc;
            }
            if (*(int *)((int)&this->field_0666 + 1) == 0) {
            ...
            if (iVar9 == 1) {
              uVar11 = sub_004176C0(this,*(short *)((int)&this->field_065E + 3));
            ...
            uVar11 = this->field_001C * 0x41c64e6d + 0x3039;
            this->field_001C = uVar11;
            uVar26 = this->field_001C * 0x41c64e6d + 0x3039;
            this->field_001C = uVar26;
            ...
            if (((int)this->field_074A <= (int)*(short *)(DAT_00806724 + 0x23) / 2) &&
              ...
              do {
                ...
                TraksClassTy::TraksCreate
                          (g_traksClass_00802A7C,1,2,7,iVar13,iVar10 + ((uVar11 >> 0x10) % 7 - 3),
                           iVar16,sVar18,sVar19,sVar15,sVar20,sVar21,sVar22,iVar23,sVar24,bVar25);
            ...
            if ((local_8 != (STWorldObject *)0x0) &&
              ...
              iVar23 = (*local_8->vtable[5].slots_00_28[2])();
              iVar9 = 0;
              if (iVar23 != 0) {
            ...
            if ((pSVar14 == (STWorldObject *)0x0) ||
               (iVar9 = *(int *)&pSVar14->field_0x18, iVar9 != this->field_0649)) {
LAB_0047b1c5:
              iVar23 = CONCAT22((short)((uint)pSVar14 >> 0x10),this->field_0645);
              uVar11 = CONCAT22((short)((uint)iVar9 >> 0x10),this->field_0647 + 1);
              iVar9 = CONCAT22((short)((uint)&this->field_0x651 >> 0x10),this->field_0643);
              iVar9 = SubmarineTitans::Recovered::HiddenThis::AnonReceiver_0048DFD0::
                      thunk_FUN_0048dfd0((AnonReceiver_0048DFD0 *)this,iVar9,iVar23,uVar11,iVar9,
                                         iVar23,(int *)uVar11,2,(short *)&this->field_0x651,
                                         (short *)&this->field_0x653,(short *)&this->field_0x655);
joined_r0x0047b202:
              if (iVar9 == 0) {
              ...
              iVar23 = (*pSVar14->vtable[5].slots_00_28[2])();
              iVar9 = 0;
              ...
              if (*(int *)&local_8[0x1d].field_0x18 == 0) {
                ...
                iVar9 = CONCAT22((short)((uint)&this->field_0x651 >> 0x10),this->field_0643);
                iVar9 = SubmarineTitans::Recovered::HiddenThis::AnonReceiver_0048DFD0::
                        thunk_FUN_0048dfd0((AnonReceiver_0048DFD0 *)this,iVar9,
                                           (uint)(ushort)this->field_0645,uVar11,iVar9,
...
cf_common_exit_0047A369:
    ...
    sub_00481520(this,(int)sVar18,(int)sVar19,iVar9);
  }
  sub_00460260(this,0);
