  ...
  if ((param_1 == 0) || (param_1 == 1)) {
    ...
    *(undefined4 *)(this + 0x64d) = 0;
    ...
    if (iVar6 == 0) {
      ...
      iVar6 = (**(code **)(*local_8 + 0x2c))();
      if (iVar6 != 0x37) {
        return 0;
      }
      *(int *)(this + 0x63f) = local_8[6];
    }
    else {
      if (iVar6 != 1) {
        if (iVar6 != 2) {
      ...
      case 0:
        *(undefined4 *)(this + 0xb7) = 0;
        if (*(int *)(this + 0x635) == 1) {
          ...
          if (local_8[6] != *(int *)(this + 0x649)) {
            return 0;
          }
          iVar6 = (**(code **)(*local_8 + 0xf8))();
          if (iVar6 == 0) {
            return 0;
          }
        }
        ...
        if ((CONCAT31(extraout_var,bVar4) != 1) ||
           (iVar6 = thunk_FUN_004e91e0(local_8,(int *)this), iVar6 != 1)) {
LAB_00479e39:
...
LAB_0047b2dc:
      ...
      case 1:
        ...
        if (((local_8 != (int *)0x0) && (local_8[6] == *(int *)(this + 0x63f))) &&
           (iVar6 = (**(code **)(*local_8 + 0xf8))(), iVar6 != 0)) {
          if (*(int *)(this + 0x635) != 1) {
            return 2;
          }
          sVar16 = *(short *)(this + 0x643);
          ...
          if (((local_8 != (int *)0x0) && (local_8[6] == *(int *)(this + 0x649))) &&
             (iVar6 = (**(code **)(*local_8 + 0xf8))(), iVar6 != 0)) {
            return 2;
          }
        }
...
LAB_00479ba6:
      ...
      if (iVar6 == 1) {
        *(int *)(this + 0x65d) = *(int *)(this + 0x65d) + 1;
        ...
        iVar6 = thunk_FUN_004e91e0(local_8,(int *)this);
        if (iVar6 != 1) {
          return 2;
        }
        *(undefined4 *)(this + 0x663) = 2;
            ...
            if (iVar6 == 4) {
              if (*(int *)(this + 0x667) == 0) {
                ...
                if ((((iVar6 == 7) || (iVar6 == 0x13)) || (iVar6 == 0x1b)) &&
                   ((*(int *)(this + 0x7ca) != 0 &&
                    (iVar6 = FUN_006e62d0(DAT_00802a38,*(int *)(this + 0x7ca),(int *)&local_8),
                    iVar6 != -4)))) {
              ...
              if ((*(int *)(this + 0x667) == 1) &&
                ...
                *(short *)(this + 0x45) = sVar12;
                local_20 = (int)sVar16;
                thunk_FUN_004ad3c0(this + 0x1d5,(float)local_20 * _DAT_007904f8 * _DAT_007904f0,
...
LAB_0047acdc:
            ...
            *(uint *)(this + 0x1c) = uVar24;
            ...
            if ((*(int *)(this + 0x74a) <= (int)*(short *)(DAT_00806724 + 0x23) / 2) &&
              ...
              do {
                puVar9 = (undefined4 *)
                         thunk_FUN_0041dc40(local_30,*(undefined4 *)local_10,
                ...
                if (DAT_0080732c == 1) {
                  ...
                  iVar13 = (int)local_24 + *(short *)(this + 0x45) + local_20 + (int)(short)lVar15;
                  iVar7 = (int)*(short *)(this + 0x43) - (int)local_28._2_2_;
                  iVar10 = (int)(short)local_28 + iVar6 + *(short *)(this + 0x41);
                }
                else {
                  iVar13 = (int)local_24 + local_20 + *(short *)(this + 0x45);
                  local_28._2_2_ = (short)((uint)uVar2 >> 0x10);
                  iVar7 = (int)*(short *)(this + 0x43) - (int)local_28._2_2_;
                  local_28._0_2_ = (short)uVar2;
                  iVar10 = (int)(short)local_28 + iVar6 + *(short *)(this + 0x41);
                }
            ...
            if ((local_8 != (int *)0x0) && (iVar6 = local_8[6], iVar6 == *(int *)(this + 0x63f))) {
              iVar21 = (**(code **)(*local_8 + 0xf8))();
              iVar6 = 0;
              if (iVar21 != 0) {
                iVar6 = thunk_FUN_004e95c0(local_8,(int)this);
              }
            }
            sVar16 = *(short *)(this + 0x643);
...
joined_r0x0047b202:
              ...
              if (local_8[0x10b] != 0) {
                if (this + 0x651 != (STBoatC *)0x0) {
                  *(int *)(this + 0x651) = local_8[0x10c];
                }
                if (pSVar1 != (STBoatC *)0x0) {
                  *(int *)pSVar1 = local_8[0x10d];
                }
                if (pSVar14 != (STBoatC *)0x0) {
                  *(int *)pSVar14 = local_8[0x10e];
                }
              }
              if (local_8[0x10b] == 0) {
                uVar8 = CONCAT22((short)((uint)local_8 >> 0x10),*(short *)(this + 0x647) + 1);
                iVar6 = CONCAT22((short)((uint)(this + 0x651) >> 0x10),*(undefined2 *)(this + 0x643)
                                );
          ...
          if ((*(int *)(this + 0x74a) <= (int)*(short *)(DAT_00806724 + 0x23) / 2) &&
            ...
            do {
              ...
              if (DAT_0080732c == 1) {
                ...
                bVar23 = 0;
                lVar15 = Library::MSVCRT::__ftol();
                iVar13 = (int)local_24 + *(short *)(this + 0x45) + local_18 + (int)(short)lVar15;
                iVar7 = (int)*(short *)(this + 0x43) - (int)local_28._2_2_;
                iVar10 = (int)(short)local_28 + iVar6 + *(short *)(this + 0x41);
              }
              else {
                iVar13 = (int)local_24 + local_18 + *(short *)(this + 0x45);
                local_28._2_2_ = (short)((uint)uVar2 >> 0x10);
                iVar7 = (int)*(short *)(this + 0x43) - (int)local_28._2_2_;
                local_28._0_2_ = (short)uVar2;
                iVar10 = (int)(short)local_28 + iVar6 + *(short *)(this + 0x41);
...
LAB_0047a385:
            ...
            if (((local_8 != (int *)0x0) && (local_8[6] == *(int *)(this + 0x63f))) &&
               ((iVar6 = (**(code **)(*local_8 + 0xf8))(), iVar6 != 0 &&
                ((local_8[0x12d] == 0 && (*(int *)((int)local_8 + 0x245) != 6)))))) {
              *(undefined4 *)(this + 0x742) = 1;
              thunk_FUN_004e9650(local_8,(undefined4 *)(this + 0x657),(undefined4 *)(this + 0x659),
                                 (undefined4 *)(this + 0x65b));
              thunk_FUN_004e96c0(local_8,*(int **)(this + 0x18));
