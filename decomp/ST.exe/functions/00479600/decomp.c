  ...
  if ((param_1 == 0) || (param_1 == 1)) {
    ...
    *(undefined4 *)&this->field_0x64d = 0;
    ...
    if (iVar10 == 0) {
      ...
      if (iVar10 != 1) {
        if (iVar10 != 2) {
          iVar10 = ReportDebugMessage(s_E____titans_wlad_To_boat_cpp_007a9d3c,0x351b,0,0,
        ...
        thunk_FUN_004b2520(*(uint *)&this->field_0x24,this->field_06F7,(int)(short)this->field_0643,
                           ...
                           (undefined4 *)psVar1,uVar12 >> 0x10,(int *)&this->field_0x64d);
        if (*(short *)puVar2 < 0) {
          return 0;
        }
...
LAB_0047b2dc:
      ...
      case 3:
        ...
        break;
      case -1:
        iVar10 = ReportDebugMessage(s_E____titans_wlad_To_boat_cpp_007a9d3c,0x3525,0,0,&DAT_007a4ccc
          ...
          if (iVar10 != 3) {
            if (iVar10 == 4) {
              ...
              if ((*(int *)((int)&this->field_0666 + 1) == 1) &&
                 (iVar10 = *(int *)((int)&this->field_065A + 3) + 1,
                 *(int *)((int)&this->field_065A + 3) = iVar10, iVar10 == 0x16)) {
              ...
              if ((*(int *)((int)&this->field_0666 + 1) == 3) &&
                 (iVar10 = *(int *)((int)&this->field_065A + 3) + 1,
                 *(int *)((int)&this->field_065A + 3) = iVar10, iVar10 == 10)) {
...
LAB_0047acdc:
                iVar10 = thunk_FUN_004b2d10((byte)*(undefined4 *)&this->field_0x24,this->field_06F7,
            ...
            if (iVar10 != 6) {
              if (iVar10 != 7) {
                iVar10 = ReportDebugMessage(s_E____titans_wlad_To_boat_cpp_007a9d3c,0x3744,0,0,
                                            &DAT_007a4ccc,
                                            s_STBoatC__Teleport___incorrect_en_007ab3e8);
                if (iVar10 == 0) {
                  return -1;
                }
                STDebugBreak(); /* noreturn in standalone pseudocode */
            ...
            if (*(int *)((int)&this->field_0666 + 1) == 0) {
              iVar10 = (ushort)(*(short *)((int)&this->field_065A + 1) * 200) + 100;
              /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
            ...
            iVar10 = *(int *)((int)&this->field_0666 + 1);
            if (iVar10 == 1) {
              uVar12 = sub_004176C0(this,*(short *)((int)&this->field_065E + 3));
              uVar12 = sub_00417910(this,(short)uVar12);
              if (uVar12 == 0xffffffff) {
                iVar10 = ReportDebugMessage(s_E____titans_wlad_To_boat_cpp_007a9d3c,0x36e3,0,0,
                                            &DAT_007a4ccc,
                                            s_STBoatC__Teleport_TELEPORT_OMOVE_007ab440);
                if (iVar10 == 0) {
                  return -1;
                }
                STDebugBreak(); /* noreturn in standalone pseudocode */
            ...
            if (local_14 == -1) {
              iVar10 = ReportDebugMessage(s_E____titans_wlad_To_boat_cpp_007a9d3c,0x370a,0,0,
...
cf_common_exit_0047ADB5:
          ...
          if (iVar10 == 1) {
            ...
            uVar12 = sub_00417910(this,(short)uVar12);
            if (uVar12 == 0xffffffff) {
              iVar10 = ReportDebugMessage(s_E____titans_wlad_To_boat_cpp_007a9d3c,0x35f4,0,0,
...
joined_r0x0047ada9:
          ...
          if (local_14 == -1) {
            iVar10 = ReportDebugMessage(s_E____titans_wlad_To_boat_cpp_007a9d3c,0x361b,0,0,
...
cf_common_exit_0047A369:
        ...
        case 3:
          ...
          break;
        case -1:
          iVar10 = ReportDebugMessage(s_E____titans_wlad_To_boat_cpp_007a9d3c,0x3596,0,0,
