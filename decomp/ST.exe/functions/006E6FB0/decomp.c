  ...
  if ((*(int *)((int)this + 0xa8) < 4) && (*(int *)((int)this + 0x280) != 0)) {
    ...
    if (param_4 != 0) {
      ...
      for (puVar3 = *(undefined4 **)((int)this + 0x452); puVar3 != (undefined4 *)0x0;
        ...
        FUN_006b5b10(param_1,0,local_18 + param_2,iVar6 + param_3,local_8 + param_2,iVar5 + param_3,
                     (byte)puVar3[6],0xd);
...
LAB_006e7ff9:
      ...
      if (0 < *(int *)((int)this + 1000)) {
        ...
        if (iVar5 < iVar6) {
          ...
          FUN_006b5b10(param_1,0,iVar5,iVar10,iVar6,iVar10,(byte)*(undefined4 *)((int)this + 0x3e4),
                       0xd);
        }
      }
      if ((*(int *)((int)this + 0x3f4) < *(int *)((int)this + 0x3dc) + -1) &&
        ...
        FUN_006b5b10(param_1,0,*(int *)((int)this + 0x3f8) + param_2,iVar6,
                     *(int *)((int)this + 0x3fc) + param_2,iVar6,
      ...
      if ((0 < *(int *)((int)this + 0x400)) &&
        ...
        FUN_006b5b10(param_1,0,iVar6,*(int *)((int)this + 0x404) + param_3,iVar6,
      ...
      if (*(int *)((int)this + 0x40c) < *(int *)((int)this + 0x3dc) + -1) {
        if (*(int *)((int)this + 0x410) < *(int *)((int)this + 0x414)) {
          ...
          FUN_006b5b10(param_1,0,iVar6,*(int *)((int)this + 0x410) + param_3,iVar6,
