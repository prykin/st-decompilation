...

{
  ...
  iVar2 = __setjmp3(local_48,0,unaff_ESI,uVar9);
  if (iVar2 != 0) {
  ...
  if (DAT_0080874e == '\x03') {
    ...
    if (*(int *)(local_8 + 0xc4d) == 0) goto LAB_00504f81;
    FUN_00710a90(*(int *)(local_8 + 0x194),0,0x10,0x8e,*(int *)(*(int *)(local_8 + 0x9f1) + 4),0xb);
    UVar5 = *(UINT *)(local_8 + 0xc4d);
  }
  else {
    thunk_FUN_00540760(*(undefined4 **)(local_8 + 0x194),4,0x89,'\x01',*(byte **)(local_8 + 0x9f1));
    if (*(int *)(local_8 + 0xc4d) == 0) goto LAB_00504f81;
    FUN_00710a90(*(int *)(local_8 + 0x194),0,6,0x8b,200,0xb);
    UVar5 = *(UINT *)(local_8 + 0xc4d);
  }
  iVar8 = -1;
  iVar7 = -1;
...
LAB_00504f81:
  if (-1 < (int)*(uint *)(local_8 + 0x15c)) {
    FUN_006b3640(DAT_008075a8,*(uint *)(local_8 + 0x15c),0xffffffff,*(uint *)(local_8 + 0x50),
                 *(uint *)(local_8 + 0xa8));
  }
  DAT_00858df8 = (undefined1 *)uVar9;
  return;
