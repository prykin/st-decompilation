  ...
  if (iVar4 == 2) {
    ...
    if (*(int *)(this + 0x615) == 3) {
      ...
      if (this[0x2bf] != (STBoatC)0x0) {
        do {
          puVar9 = (undefined4 *)
                   thunk_FUN_0041dc40(auStack_24,*(undefined4 *)(this + (short)param_1 * 6 + 0x2b3),
          ...
          if (DAT_0080732c == 1) {
            ...
            *(uint *)(this + 0x1c) = uVar10;
            ...
            sVar14 = 0;
            *(uint *)(this + 0x1c) = uStack_14;
            lVar16 = Library::MSVCRT::__ftol();
            TraksClassTy::TraksCreate
                      (DAT_00802a7c,1,2,7,
                       (uStack_14 >> 0x10) % 7 + (int)*(short *)(this + 0x41) + -3 +
                       (int)(short)uStack_1c,
                       (((uVar10 >> 0x10) % 7 + (int)*(short *)(this + 0x43)) - (int)uStack_1c._2_2_
                       ) + -3,(int)(short)lVar16 + (uVar8 >> 0x10) % 7 +
                              (int)*(short *)(this + 0x45) + -3 + (int)sStack_18,sVar14,sVar17,
                       sVar18,sVar2,sVar19,sVar20,iVar4,sVar21,bVar22);
...
LAB_00477b2e:
          ...
          do {
            puVar9 = (undefined4 *)
                     thunk_FUN_0041dc40(auStack_24,
                                        *(undefined4 *)(this + (short)param_1 * 6 + 0x2b3),
                                        *(undefined2 *)(this + (short)param_1 * 6 + 0x2b7),
                                        *(short *)(this + 0x6c));
            uVar23 = *puVar9;
            sStack_18 = *(short *)(puVar9 + 1);
              ...
              *(uint *)(this + 0x1c) = uStack_14;
              ...
              TraksClassTy::TraksCreate
                        (DAT_00802a7c,1,2,7,
                         ...
                         -3 + (int)sStack_18,sVar14,sVar17,sVar18,sVar2,sVar19,sVar20,iVar4,sVar21,
                         bVar22);
              ...
              *(uint *)(this + 0x1c) = uVar8;
              ...
              TraksClassTy::TraksCreate
                        (DAT_00802a7c,1,2,7,
                         (uVar8 >> 0x10) % 7 + (int)*(short *)(this + 0x41) + -3 + iVar13,
                         (((uVar11 >> 0x10) % 7 + (int)*(short *)(this + 0x43)) - iVar4) + -3,
                         (uVar10 >> 0x10) % 7 + (int)*(short *)(this + 0x45) + -3 + (int)sStack_18,0
                         ,0,0,0,0,0,-1,0,0);
    ...
    if (iVar4 == 1) {
      if (DAT_008117bc != (undefined4 *)0x0) {
        ...
        uStack_34 = 0x5dd4;
        uStack_2c = CONCAT22(*(undefined2 *)(this + 0x32),*(undefined2 *)(this + 0x24));
