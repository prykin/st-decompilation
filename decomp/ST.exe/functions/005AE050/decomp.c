...

{
  ...
  *(uint **)(DAT_0081176c + 0x548) = puVar6;
  if ((0 < (int)(*(int *)(*(int *)(local_10 + 0x1c97) + 8) +
    ...
    pCVar14 = local_10;
    if (iVar4 == 0) {
      local_14 = (cMf32 *)FUN_006f0ec0(0x345,(byte *)(local_10 + 0x1faf),0,0,0);
    }
    pcVar8 = local_14;
  ...
  if ((local_10[0x1a5f] == (ChooseMapTy)0x3) &&
    ...
    iVar4 = Library::MSVCRT::__setjmp3(local_100.jumpBuffer,0,unaff_EDI,unaff_ESI);
    pCVar14 = local_10;
    if (iVar4 == 0) {
      pcVar8 = (cMf32 *)FUN_006f0ec0(0x345,(byte *)(local_10 + 0x1faf),0,0,0);
      local_14 = pcVar8;
      ...
      puVar5 = cMf32::RecGet(pcVar8,0xc,PTR_s_MISSION_0079c064,(int *)&local_8,0);
      pcVar8 = local_14;
