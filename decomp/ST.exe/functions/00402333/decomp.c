...
undefined4 __cdecl
thunk_FUN_0062cac0(int *param_1,int param_2,int param_3,int param_4,undefined4 param_5,int param_6,
    ...
    *(int *)((int)param_1 + 0x3d) = (int)*(short *)(param_6 + 2 + param_7 * 4);
    ...
    if ((float)-param_1[3] < fVar1) {
      ...
      *param_8 = (short)lVar3 + (short)*param_1;
      ...
      thunk_FUN_00556760(DAT_00802a7c,3,0,0,(int)lVar3 + *param_1,param_1[1] + (int)lVar4,
