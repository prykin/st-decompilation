...
void __fastcall thunk_FUN_005325b0(void *param_1)

{
  ...
  *(undefined4 *)((int)param_1 + 0x2c) = 0;
  ...
  if (*(byte **)((int)pvStack_8 + 0x2fd) != (byte *)0x0) {
    FUN_006ae110(*(byte **)((int)pvStack_8 + 0x2fd));
  }
  *(undefined4 *)((int)pvVar11 + 0x2fd) = 0;
  ppuStack_94 = DAT_00858df8;
  DAT_00858df8 = &ppuStack_94;
  iVar4 = __setjmp3(auStack_90,0,unaff_EDI,unaff_ESI);
  if (iVar4 != 0) {
    DAT_00858df8 = ppuStack_94;
    puVar6 = FUN_006ae290((uint *)0x0,1,0x98,1);
    *(uint **)((int)pvStack_8 + 0x2fd) = puVar6;
    pvVar11 = pvStack_8;
    goto LAB_00532758;
  }
...
LAB_00532758:
  ...
  uStack_c0 = 1;
  FUN_006b11d0(*(uint **)((int)pvVar11 + 0x2fd),0,(undefined4 *)acStack_12c);
  ...
  if (iVar4 == 0) {
    ...
    *(undefined4 *)((int)pvVar11 + 0x2c) = 0;
    ...
    if (*(int *)(iVar4 + 0xc) != 0) {
      ...
      do {
        pbVar12 = (byte *)(*(int *)(iVar4 + 8) * uStack_c + *(int *)(iVar4 + 0x1c));
LAB_00532855:
...
LAB_00532883:
        if (iVar4 == 0) {
          *(uint *)((int)pvVar11 + 0x2c) = uStack_c;
          *(undefined4 *)((int)pvVar11 + 0x28) = 0x22;
