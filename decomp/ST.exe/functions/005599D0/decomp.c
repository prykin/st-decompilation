...

{
  ...
  if ((((this->field_0114 != 0) && (-1 < (int)param_5)) && (param_4 < 8)) &&
     (((g_playSystem_00802A38 == (STPlaySystemC *)0x0 || ((byte)(&DAT_008087e9)[param_4 * 0x51] < 8)
       ) && ((&this->field_0054)[param_4] != 0)))) {
    sub_0055BBC0(this,2,(short)param_1,(short)param_2,param_3,param_4,(char)param_5,param_6);
      ...
      do {
        ...
        do {
          if (((puVar3 == (undefined *)0x0) || (param_5[iVar4] != '\0')) &&
            ...
            iVar6 = iVar8 * this->field_0020 + (&this->field_0054)[param_4];
