...
void __fastcall FUN_004ef140(AnonShape_004EF140_16642BA0 *param_1)

{
  ...
  if (*(int *)(&param_1->field_0x27a + (uint)param_1->field_0278 * 4) != 0) {
    local_c = (UINT *)&param_1->field_0x1b6;
...
LAB_004ef270:
      ...
      if ((((param_1->field_002C != 0) &&
           (iVar3 = *(int *)(&param_1->field_0x27a + (uint)param_1->field_0278 * 4), iVar3 != 0)) &&
