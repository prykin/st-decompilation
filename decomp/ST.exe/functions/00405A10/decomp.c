...
uint __cdecl thunk_FUN_0067f5e0(byte *param_1)

{
  ...
  uVar3 = __setjmp3(auStack_48,0,unaff_EDI,unaff_ESI);
  if (uVar3 != 0) {
...
LAB_0067f671:
  if ((int)uVar3 < 0) {
    ...
    uStack_8 = 0;
    uVar6 = FUN_006ae1c0(DAT_00848a28,&uStack_8);
    if (uVar6 != uVar3) {
      FUN_006a5e40(-5,DAT_007ed77c,0x7d55d8,0x126);
    }
  }
  DAT_00858df8 = (undefined4 *)uStack_4c;
  return uVar3;
