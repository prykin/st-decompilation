...

{
  ...
  local_8 = (ushort *)0x0;
  local_10 = *(int *)(iVar6 + 0xc) - this->field_003C;
  ...
  if (param_2 != (undefined *)0x0) {
    ...
    local_14 = this;
    piVar3 = (int *)Library::MSVCRT::__setjmp3(local_58.jumpBuffer,0,unaff_EDI,unaff_ESI);
    if (piVar3 == (int *)0x0) {
      iVar7 = 1;
    ...
    g_currentExceptionFrame = local_58.previous;
    iVar6 = ReportDebugMessage(s_E____titans_Andrey_specpan_cpp_007c7870,0x255,0,(int)piVar3,
    ...
    RaiseInternalException((int)piVar3,0,s_E____titans_Andrey_specpan_cpp_007c7870,0x255);
  }
  return;
}
