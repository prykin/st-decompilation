...

{
  ...
  if ((param_1 == 0) || (pSVar9 = this, param_1 == 1)) {
    ...
    *(int *)(this + 0x58e) = param_1;
    ...
    if ((piStack_c == (int *)0x0) || (piStack_c[6] != param_1)) {
      iVar8 = FUN_006e62d0(DAT_00802a38,param_1,(int *)&piStack_c);
      if (iVar8 == -4) {
        return 0;
      }
      thunk_FUN_004162f0(piStack_c,(undefined2 *)pSVar9,(undefined2 *)(this + 0x58a),
                         (undefined2 *)(this + 0x58c));
    }
    iVar8 = (**(code **)(*piStack_c + 0xf8))();
    if (iVar8 == 0) {
      return 0;
    }
    iVar8 = (**(code **)(*piStack_c + 0xa4))();
    if (iVar8 == 1) {
      return 0;
    }
    iVar8 = GetCellForLoading(this,*(short *)(this + 0x5b),*(short *)(this + 0x5d),
                              *(short *)(this + 0x5f),*(short *)pSVar9,*(short *)(this + 0x58a),
                              *(short *)(this + 0x58c),&sStack_6,&sStack_8,
    ...
    if (((*(short *)(this + 0x5b) != sStack_6) || (*(short *)(this + 0x5d) != sStack_8)) ||
      ...
      *(undefined4 *)(this + 0x596) = 0;
      ...
      if (iVar8 == -1) {
        ...
        sVar15 = (short)iStack_10;
      }
      thunk_FUN_00481520(this,(int)sStack_6,(int)sStack_8,(int)sVar15);
  ...
  if (*(int *)(this + 0x596) == 0) {
    ...
    case 3:
      ...
      if ((((piStack_c == (int *)0x0) || (piStack_c[6] != *(int *)(this + 0x58e))) &&
          (iVar8 = FUN_006e62d0(DAT_00802a38,*(int *)(this + 0x58e),(int *)&piStack_c), iVar8 == -4)
          ) || ((iVar8 = (**(code **)(*piStack_c + 0xa4))(), iVar8 == 1 ||
                (iVar8 = (**(code **)(*piStack_c + 0xc0))(), iVar8 == 1)))) goto LAB_004743a5;
      thunk_FUN_004162f0(piStack_c,(undefined2 *)(this + 0x588),(undefined2 *)(this + 0x58a),
                         (undefined2 *)(this + 0x58c));
      iVar8 = GetCellForLoading(this,*(short *)(this + 0x5b),*(short *)(this + 0x5d),
                                *(short *)(this + 0x5f),*(short *)(this + 0x588),
                                *(short *)(this + 0x58a),*(short *)(this + 0x58c),&sStack_6,
                                &sStack_8,(undefined2 *)((int)&param_1 + 2),(short *)&iStack_18,
                                (short *)&iStack_14,(undefined2 *)&iStack_10);
      if (iVar8 == -2) goto LAB_004743a5;
      if (((*(short *)(this + 0x5b) != sStack_6) || (*(short *)(this + 0x5d) != sStack_8)) ||
         (*(short *)(this + 0x5f) != param_1._2_2_)) {
        if (iVar8 == -1) {
          iVar4 = (int)(short)iStack_10;
          iVar8 = (int)(short)iStack_14;
          iVar10 = (int)(short)iStack_18;
        }
        else {
  ...
  if (iVar8 == 1) {
    ...
    if (iVar8 == 0) {
      ...
      iVar8 = (**(code **)(*piStack_c + 0xa4))();
      if ((iVar8 == 1) || (iVar8 = (**(code **)(*piStack_c + 0xc0))(), iVar8 == 1)) {
LAB_004743a5:
...
LAB_004736e2:
      ...
      uVar13 = (**(code **)(*piStack_c + 0xa8))(*(undefined4 *)(this + 0x18));
      iVar8 = (int)((ulonglong)uVar13 >> 0x20);
      uVar12 = extraout_var_03;
      if ((int)uVar13 == 1) {
        *(undefined4 *)(this + 0x596) = 2;
        iVar4 = *piStack_c;
        iVar8 = iStack_18 * 0xc9 + 100;
        uVar2 = (undefined2)((uint)(iStack_18 * 0x19) >> 0x10);
        uVar3 = (**(code **)(*(int *)this + 0x10))
                          (CONCAT22(uVar2,*(undefined2 *)(this + 0x41)),
                           CONCAT22((short)((uint)iVar8 >> 0x10),*(undefined2 *)(this + 0x43)),
                           CONCAT22(uVar2,*(undefined2 *)(this + 0x45)),iVar8,iStack_14 * 0xc9 + 100
                           ,iStack_10 * 200 + 100);
        (**(code **)(iVar4 + 0xb0))
                  (*(undefined4 *)(this + 0x18),iStack_18,iStack_14,iStack_10,uVar3);
        return 2;
      }
    }
  ...
  if (iVar8 == 3) {
    ...
    if (*(int *)(this + 0x59a) == 3) {
      ...
      if (this[0x2bf] != (STBoatC)0x0) {
        pSStack_20 = this + 0x2b3;
        do {
          puVar6 = (undefined4 *)
                   thunk_FUN_0041dc40(auStack_40,*(undefined4 *)pSStack_20,
                                      *(undefined2 *)(pSStack_20 + 4),*(short *)(this + 0x6c));
          uStack_38 = *puVar6;
          sStack_34 = *(short *)(puVar6 + 1);
          if (DAT_0080732c == 1) {
            bVar22 = 0;
            sVar21 = 0;
            iVar10 = -1;
            ...
            *(uint *)(this + 0x1c) = uVar7;
            uStack_30 = uVar7 * 0x41c64e6d + 0x3039;
            sVar16 = 0;
            *(uint *)(this + 0x1c) = uStack_30;
            sVar15 = 0;
            lVar14 = Library::MSVCRT::__ftol();
            iVar8 = (int)(short)lVar14 + (uVar5 >> 0x10) % 7 + (int)*(short *)(this + 0x45) + -3 +
                    (int)sStack_34;
            iVar4 = ((uVar7 >> 0x10) % 7 + (int)*(short *)(this + 0x43)) - (int)uStack_38._2_2_;
            uVar5 = uStack_30;
          }
          else {
            ...
            *(uint *)(this + 0x1c) = uVar5;
            ...
            sVar16 = 0;
            sVar15 = 0;
            iVar8 = (uVar7 >> 0x10) % 7 + (int)*(short *)(this + 0x45) + -3 + (int)sStack_34;
            uStack_38._2_2_ = (short)((uint)uStack_38 >> 0x10);
            iVar4 = ((uVar11 >> 0x10) % 7 + (int)*(short *)(this + 0x43)) - (int)uStack_38._2_2_;
          }
          TraksClassTy::TraksCreate
                    (DAT_00802a7c,1,2,7,
                     (uVar5 >> 0x10) % 7 + (int)*(short *)(this + 0x41) + -3 + (int)(short)uStack_38
                     ,iVar4 + -3,iVar8,sVar15,sVar16,sVar17,sVar18,sVar19,sVar20,iVar10,sVar21,
                     bVar22);
          uVar5 = (uint)(byte)this[0x2bf];
          iStack_1c = iStack_1c + 1;
          pSStack_20 = pSStack_20 + 6;
          uVar2 = extraout_var_15;
        } while (iStack_1c < (int)uVar5);
      }
    ...
    if ((*(int *)(this + 0x59a) == 4) && (*(short *)(this + 0x6e) == 0x2f)) {
      ...
      if (((piStack_c != (int *)0x0) && (piStack_c[6] == *(int *)(this + 0x58e))) &&
         ((iVar8 = (**(code **)(*piStack_c + 0xa4))(), iVar8 != 1 &&
          (iVar8 = (**(code **)(*piStack_c + 0xc0))(), iVar8 != 1)))) {
        (**(code **)(*piStack_c + 0xb4))();
    ...
    if (*(int *)(this + 0x59a) == 8) {
      ...
      if (this[0x2bf] != (STBoatC)0x0) {
        ...
        do {
          ...
          iStack_1c = iStack_1c + 1;
          pSStack_20 = pSStack_20 + 6;
        } while (iStack_1c < (int)(uint)(byte)this[0x2bf]);
      }
      if (iStack_24 == -1) {
