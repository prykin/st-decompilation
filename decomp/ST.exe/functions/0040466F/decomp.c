...

{
  ...
  if (iVar2 == 0) {
    if (*(uint *)(iStack_8 + 0x184) != 0) {
      FUN_006e56b0(*(void **)(iStack_8 + 0xc),*(uint *)(iStack_8 + 0x184));
    }
    *(undefined4 *)(iStack_8 + 0x184) = 0;
    DAT_008016e0 = 0;
    if (*(uint **)(iStack_8 + 0x17c) != (uint *)0x0) {
      FUN_00710560(*(uint **)(iStack_8 + 0x17c));
      *(undefined4 *)(iStack_8 + 0x17c) = 0;
    }
    if (*(int *)(iStack_8 + 0x180) != 0) {
      FUN_006f20e0((uint *)(iStack_8 + 0x180));
    }
