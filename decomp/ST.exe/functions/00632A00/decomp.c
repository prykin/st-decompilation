...

{
  ...
  piVar5 = local_18;
  if (iVar2 == 0) {
    if (*(int *)((int)local_18 + 0x11) == 3) {
      iVar2 = *(int *)((int)local_18 + 0x25);
      if (iVar2 < 4) {
    ...
    if (*piVar5 != 0) {
      local_20 = *(int *)((int)piVar5 + 0x19);
      local_24 = *(int *)(*piVar5 + 0xc);
      local_1c = 0;
      if (0 < local_24) {
        do {
          iVar2 = *piVar5;
          ...
          if (piVar6 != (int *)0x0) {
            if (*(int *)((int)piVar5 + 0x11) == 3) {
              if (*(int *)((int)piVar5 + 0x25) == *piVar6) {
                local_8 = local_10;
            ...
            if ((*(int *)((int)piVar5 + 0x11) == 1) && (local_20 <= (int)local_1c)) {
              local_8 = local_10;
              *(undefined4 *)((int)piVar6 + 0x1d) = *(undefined4 *)local_10;
              puVar3 = local_10;
            }
            if ((*(int *)((int)piVar5 + 0x11) == 4) &&
               (((int)local_1c < *(int *)((int)piVar5 + 0x1d) ||
                (puVar3 = local_10, local_8 = local_10,
                *(int *)((int)piVar5 + 0x1d) * 2 <= (int)local_1c)))) {
              puVar3 = local_14;
              local_8 = local_14;
            }
