...
int __cdecl
FUN_00718f40(undefined4 *param_1,undefined4 *param_2,uint param_3,UINT param_4,int param_5,
...

{
  ...
  if (iVar2 != 0) {
    ...
    iVar3 = FUN_006ad4d0(s_E__Ourlib_Palette_cpp_007f0718,0x151,0,iVar2,&DAT_007a4ccc);
    if (iVar3 != 0) {
      pcVar1 = (code *)swi(3);
      iVar2 = (*pcVar1)();
      return iVar2;
    }
    FUN_006a5e40(iVar2,0,0x7f0718,0x152);
    return iVar2;
  }
