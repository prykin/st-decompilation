...
int thunk_FUN_0068fd00(uint *param_1)

{
  ...
  if (99 < *param_1) {
    switch(*param_1) {
    case 0x6a:
      *(uint *)((int)pvStack_8 + 0x9d) = param_1[2];
      thunk_FUN_00690230(pvStack_8,param_1);
      DAT_00858df8 = (undefined4 *)uStack_80;
      return 0;
    case 0x6c:
      if ((char)param_1[2] == '\0') {
        ...
        auStack_3c[0] = 0x6d;
        uStack_30 = 1;
        auStack_3c[1] = *(undefined4 *)((int)pvStack_8 + 300);
        ...
        thunk_FUN_00690230(pvStack_8,auStack_3c);
        DAT_00858df8 = (undefined4 *)uStack_80;
        return 0;
      }
      break;
    ...
    case 0x74:
      ...
      return 0;
    case 0x6f:
      iVar3 = thunk_FUN_0068e850(pvStack_8,param_1[3]);
      param_1[2] = param_1[2] + iVar3;
      iVar3 = thunk_FUN_0068e610(pvStack_8,param_1[3]);
      param_1[2] = param_1[2] + iVar3;
      DAT_00858df8 = (undefined4 *)uStack_80;
      return 0;
    case 0x70:
      uVar5 = 0;
      iVar3 = *(int *)((int)pvStack_8 + 0xa5);
      if (0 < *(int *)(iVar3 + 0xc)) {
      ...
      break;
    case 0x71:
      uVar5 = *(int *)(*(int *)((int)pvStack_8 + 0xa5) + 0xc) - 1;
      if (-1 < (int)uVar5) {
        do {
          iVar3 = *(int *)((int)pvStack_8 + 0xa5);
          ...
          if ((iVar3 != 0) && (*(int *)(iVar3 + 4) != 0)) {
            ...
            FUN_006b0c70(*(int *)((int)pvStack_8 + 0xa5),uVar5);
          }
          uVar5 = uVar5 - 1;
        } while (-1 < (int)uVar5);
        DAT_00858df8 = (undefined4 *)uStack_80;
