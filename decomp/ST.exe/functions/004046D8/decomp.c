...

{
  ...
  if (iVar5 == 0) {
    ...
    *(int *)(pcStack_8 + 0x18) = param_2;
    if (param_3 < 1) {
      param_3 = *(int *)(*(int *)pcStack_8 + 4);
    }
    *(int *)(pcStack_8 + 0x1c) = param_3;
    if (param_4 < 1) {
      param_4 = *(int *)(*(int *)pcStack_8 + 8);
    }
    *(int *)(pcStack_8 + 0x20) = param_4;
    iVar5 = *(int *)(pcStack_8 + 4);
    *(int *)(pcStack_8 + 0xc) = 0;
    *(int *)(pcStack_8 + 0x10) = 0;
    *(int *)(pcStack_8 + 0x38) = 0;
