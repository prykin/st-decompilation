  ...
  if (param_1 != 0) {
    ...
    if (pSVar7->field_00C6 < 0) {
      ST3DSMAPContext::sub_006E8660
                (g_sT3DSMAPContext_00807598,piVar1,2,0,*(uint *)((int)puVar9 + 9),
    ...
    ST3DSMAPContext::sub_006E98E0
              (g_sT3DSMAPContext_00807598,*piVar1,0,*(int *)puVar9,*(int *)((int)puVar9 + 0x21),1);
    ...
    if (*(byte *)&pSVar7->field_0014 < 4) {
      ...
      ST3DSMAPContext::sub_006E98E0
                (g_sT3DSMAPContext_00807598,*piVar1,1,*(int *)puVar9,*(int *)((int)puVar9 + 0x21),1);
