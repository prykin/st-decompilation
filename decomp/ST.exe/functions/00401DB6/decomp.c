...
void __fastcall thunk_FUN_00679600(void *param_1)

{
  ...
  uStack_14 = *(uint *)((int)param_1 + 0x640);
  if (8 < uStack_14) {
  ...
  if ((uVar4 != uVar7) && (uVar4 != 0xff)) {
    cVar2 = (char)uVar4;
    pbStack_10 = (byte *)CONCAT31(pbStack_10._1_3_,cVar2);
    _bStack_c = CONCAT31(uStack_b,(char)uVar7);
    if (DAT_00808a8f == '\0') {
      if (cVar2 == (char)uVar7) {
LAB_0067971a:
        iVar6 = 0;
    ...
    if ((bVar10) && (sVar3 = thunk_FUN_0043e460(cVar2), param_1 = pvStack_8, sVar3 != 0))
    goto LAB_0067989b;
  }
  iVar6 = 0;
  piVar8 = &iStack_1a8;
  pbStack_10 = &DAT_008087e9;
  param_1 = pvStack_8;
  do {
    uVar4 = (uint)*pbStack_10;
    if ((uVar4 != 0xff) && (uVar7 = *(uint *)((int)param_1 + 0x5d7), uVar4 != uVar7)) {
      _bStack_c = CONCAT31(uStack_b,(byte)uVar7);
      if (DAT_00808a8f == '\0') {
        if (*pbStack_10 == (byte)uVar7) {
          iVar5 = 0;
        }
        else {
          uVar7 = uVar7 & 0xff;
    ...
    pbStack_10 = pbStack_10 + 0x51;
  } while ((int)pbStack_10 < 0x808a71);
  if (iVar6 < 1) {
    *(undefined4 *)((int)param_1 + 0x640) = 0xff;
  }
  else {
    iVar6 = thunk_FUN_00423220((void *)((int)param_1 + 0xa4),&iStack_1a8,iVar6);
    *(undefined4 *)((int)param_1 + 0x640) = auStack_1a4[iVar6 * 0xb];
  }
LAB_0067989b:
  uVar4 = *(uint *)((int)param_1 + 0x640);
  if (uVar4 != uStack_14) {
    ...
    auStack_48[1] = *(undefined4 *)((int)param_1 + 0x6fe);
    auStack_48[0] = 0x6a;
    auStack_48[2] = uVar4;
    thunk_FUN_0067a020(param_1,auStack_48,-1);
