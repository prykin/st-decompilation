...
void thunk_FUN_0052d200(uint param_1)

{
  ...
  if (iVar2 == 0) {
    uVar4 = param_1 & 0xff;
    FUN_00710a90(*(int *)(iStack_8 + 0x90),0,0,uVar4 * 0x13,*(int *)(*(int *)(iStack_8 + 0x90) + 4),
                 0x13);
    if ((int)uVar4 < *(int *)(*(int *)(iStack_8 + 0x98) + 8)) {
      puVar5 = *(uint **)(*(int *)(*(int *)(iStack_8 + 0x98) + 0x14) + uVar4 * 4);
    }
    else {
      puVar5 = (uint *)0x0;
    }
