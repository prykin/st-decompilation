...
undefined4 FUN_006452a0(int param_1,uint param_2)

{
  ...
  if (param_2 == 0xffffffff) {
    local_10[0] = param_1;
    local_10[1] = 0;
    FUN_006ae1c0(*(uint **)(local_10[2] + 0x241),local_10);
    DAT_00858df8 = (undefined4 *)local_54;
    return 0;
  }
  FUN_006acc70(*(int *)(local_10[2] + 0x241),param_2,local_10);
  if (local_10[0] == param_1) {
    local_10[1] = 0;
    FUN_006ae140(*(uint **)(local_10[2] + 0x241),param_2,local_10);
    DAT_00858df8 = (undefined4 *)local_54;
    return 0;
  }
