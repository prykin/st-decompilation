...
void __thiscall FUN_005dfa30(void *this,char param_1,undefined1 param_2)

{
  ...
  *(char *)((int)local_10 + 0x6e) = param_1;
  if (param_1 == '\0') {
    *(undefined1 *)((int)local_10 + 0x6f) = param_2;
  }
  else {
    *(undefined1 *)((int)local_10 + 0x6f) = 0;
  }
  if (*(char *)((int)local_10 + 0x6e) == '\x01') {
  ...
  *(ushort **)((int)pvVar3 + 0x81) = puVar6;
  ...
  FUN_006bc360(*(int *)((int)pvVar3 + 0x5d),local_5a8,(int *)0x0);
  FUN_00718780((int)local_5a8,0,0x100,0x1a,0x10,(undefined4 *)((int)pvVar3 + 0x91));
  FUN_00718780((int)local_5a8,0,0x100,0x2e,0x10,(undefined4 *)((int)pvVar3 + 0x191));
  ...
  *(undefined4 *)(iVar4 + 0x5c) = 0;
  ...
  local_c = (int)pvVar3 + 0x653;
  *(undefined4 *)((int)pvVar3 + 0x8d) = uVar9;
  puVar7 = (uint *)((int)pvVar3 + 0x2a5);
  local_8 = (undefined4 *)0x5;
  do {
    FUN_006b2330((uint)DAT_008075a8,puVar7,0x31,0x402f63,0,0,local_c);
