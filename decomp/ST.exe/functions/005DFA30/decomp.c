...

{
  ...
  if (pMVar3->field_006E == '\0') {
    ...
    pcVar4 = STPointerBoundaryCast<cMf32 *>(Library::Ourlib::MF32INT::FUN_006f0ec0(0x345,(byte *)&CHAR_00h_0080ed16,0,0,0));
  }
  else {
    /* ST_CALLSITE[005DFAD7]: CALL dword ptr [0x0085bde8] */
    wsprintfA((LPSTR)&DAT_0080f33a,"%s%s",&CHAR_00h_00807680,&CHAR_00h_0080c52e);

    pcVar4 = STPointerBoundaryCast<cMf32 *>(Library::Ourlib::MF32INT::FUN_006f0ec0(0x345,(byte *)&DAT_0080f33a,0,0,0));
  }
  ...
  pMVar6 = Library::Ourlib::MFDARR::mfDarLoad(pcVar4,pcVar17_mg1,0);
  ...
  puVar5 = FUN_0070a9f0(g_cMf32_00806780,pcVar8,bVar17,iVar10);
  ...
  Library::DKW::DDX::FUN_006b3640((int *)g_ddxContext_008075A8,*puVar15,0xffffffff,0,0);
  FUN_006b3af0((int *)g_ddxContext_008075A8,*puVar15);
  pDVar9 = Library::DKW::TBL::DArrayCreateTracked(nullptr,10,0x9e,10,0x405de4);
  pMVar3->field_064B = pDVar9;
  pDVar9 = Library::DKW::TBL::DArrayCreateTracked(nullptr,10,0x3e,10,0x40365c);
  ...
  if (g_cursorClass_00802A30 != nullptr) {
    ...
    CursorClassTy::SetGCType(this_00,CASE_0,iVar1,iVar10);
