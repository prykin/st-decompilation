  ...
  case CASE_3:
    ...
    MMMObjTy::OutBSlProc
              ((MMMObjTy *)g_dDXContext_0080759C,(int)g_dDXContext_0080759C,(MMMObjTy *)0x0,
               (MMMObjTy *)0x0,0x22,0x72,0x2e1,0x14c,&this_00->field_1A5B->field_0140);
    g_currentExceptionFrame = local_50.previous;
    return;
  case CASE_4:
LAB_00596d69:
...
LAB_00596d7a:
  ...
  case CASE_6:
    ...
    OutTRGlProc((FSGSTy *)this_02,(AnonShape_GLOBAL_0080759C_9638EF10 *)g_dDXContext_0080759C,
                (MMMObjTy *)0x0,(MMMObjTy *)0x0,(StartServTy *)0x1e9,0x5e,0x124,0x175,(int)this_02);
    g_currentExceptionFrame = local_50.previous;
    return;
  case CASE_7:
LAB_00596d8b:
  ...
  case CASE_8:
    ...
    if ((this_00->field_1F2F == (HoloTy *)0x0) && (param_1 == '\0')) {
      OutSGlProc((FSGSTy *)g_dDXContext_0080759C,
                 (AnonShape_GLOBAL_0080759C_9638EF10 *)g_dDXContext_0080759C,(MMMObjTy *)0x0,
                 (MMMObjTy *)0x0,0x199,0x5e,0x174,0x175,(int)&this_00->field_1A5B->field_0140);
      /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
      pFVar3 = extraout_ECX;
    }
    if (this_00->field_1F2B != (HoloTy *)0x0) {
    ...
    MMMObjTy::OutBSlProc
              ((MMMObjTy *)pFVar3,(int)g_dDXContext_0080759C,(MMMObjTy *)0x0,(MMMObjTy *)0x0,0x13,
  ...
  case CASE_9:
    ...
    OutLadProc((FSGSTy *)g_dDXContext_0080759C,(int)g_dDXContext_0080759C,(MMMObjTy *)0x0,
               (MMMObjTy *)0x0,0x22,0x5e,(FSGSTy *)0x2e1,0x175);
    /* ST_PSEUDO[unresolved_register_input]: candidate live-in register: verify boundary, SEH/setjmp ABI, or convention */
...
LAB_00596d9c:
  ...
  if ((this_00->field_1F23 == (HoloTy *)0x0) && (param_1 == '\0')) {
    ...
    OutTRGlProc(pFVar3,(int)g_dDXContext_0080759C,(MMMObjTy *)0x0,(MMMObjTy *)0x0,0xb4,
