...
void __cdecl FUN_006a49c0(undefined4 *param_1,int param_2)
    ...
    if (iVar3 == 0) {
      ...
      if (((((uVar8 & 0xffff) != 4) && (uVar8 != 1)) && ((uVar8 & 0xffff) != 2)) && (uVar8 != 3)) {
        ...
        iVar3 = ReportDebugMessage(s_E____titans_Crt__Dbgheap_c_007ec1d0,0x472,0,0,&DAT_007a4ccc,
                                   local_88,puVar13,pcVar14,uVar15,uVar16,puVar6,uVar17,puVar5);
        if (iVar3 != 0) {
          pcVar1 = (code *)swi(3);
          (*pcVar1)();
          return;
      ...
      if ((DAT_007ec178 & 4) == 0) {
        ...
        if (iVar3 == 0) {
          ...
          iVar3 = ReportDebugMessage(s_E____titans_Crt__Dbgheap_c_007ec1d0,0x486,0,0,&DAT_007a4ccc,
                                     local_88,puVar13,pcVar14,uVar16,uVar15,puVar6,uVar17,puVar5);
          if (iVar3 != 0) {
            pcVar1 = (code *)swi(3);
            (*pcVar1)();
            return;
...
LAB_006a4c4a:
      ...
      if (iVar3 != param_2) {
        ...
        iVar3 = ReportDebugMessage(s_E____titans_Crt__Dbgheap_c_007ec1d0,0x4ab,0,0,&DAT_007a4ccc,
                                   local_88,puVar13,pcVar14,puVar5,uVar16,puVar7,uVar17,puVar6);
        if (iVar3 != 0) {
          pcVar1 = (code *)swi(3);
          (*pcVar1)();
          return;
