...
bool thunk_FUN_0040ce20(undefined4 param_1,int param_2,int *param_3,int *param_4,int *param_5,
                       uint *param_6)

{
  ...
  iStack_14 = 1;
  do {
    if (*(int *)(param_2 + 0xa3) - *(int *)(param_2 + 0xa7) <= iStack_14) break;
    iStack_1c = 0;
    psVar8 = (short *)(*(int *)(param_2 + 0x9f) + (*(int *)(param_2 + 0xa7) + iStack_14) * 0x48);
    do {
      if (*psVar8 == -1) break;
      ...
      if ((uVar4 != 0xffe) &&
         ((psVar8[3] < sVar2 ||
          (((psVar8[3] == sVar2 && (uVar4 == *(uint *)(param_2 + 0xaf))) && (iStack_14 < 2)))))) {
