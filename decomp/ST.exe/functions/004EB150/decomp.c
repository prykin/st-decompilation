    ...
    if ((char)iVar5 != '\x03') {
      ...
      while( true ) {
        do {
          piVar6[1] = *piVar6;
          piVar7 = piVar6 + 2;
          iVar1 = iVar5 + (param_1 + g_packedRecords_A62x8[iVar3].field2332_0x9c6 * 2) * 2;
