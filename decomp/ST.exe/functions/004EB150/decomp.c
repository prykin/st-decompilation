...

{
  ...
  *(uint *)((int)this + 0x1c) = uVar4;
  if ((uVar4 >> 0x10) % 0x385 + 0x834 + g_playerRuntime[param_1].field2276_0x9c2 <=
    ...
    if ((char)iVar5 != '\x03') {
      if (((uint)PTR_00802a38->field_00E4 < 30000) ||
         (0 < (int)g_playerRuntime[param_1].field2277_0x9c6)) {
        if ((59999 < (uint)PTR_00802a38->field_00E4) &&
           ((int)g_playerRuntime[param_1].field2277_0x9c6 < 2)) {
          g_playerRuntime[param_1].field2277_0x9c6 = 2;
        }
        param_1 = 0;
        iVar5 = 0;
        piVar6 = &g_playerRuntime[iVar3].field2253_0x9a2;
      }
      else {
        g_playerRuntime[param_1].field2277_0x9c6 = 1;
        param_1 = 0;
        iVar5 = 0;
        piVar6 = &g_playerRuntime[iVar3].field2253_0x9a2;
      }
      while( true ) {
        do {
          piVar6[1] = *piVar6;
          piVar7 = piVar6 + 2;
          iVar1 = iVar5 + (param_1 + g_playerRuntime[iVar3].field2277_0x9c6 * 2) * 2;
