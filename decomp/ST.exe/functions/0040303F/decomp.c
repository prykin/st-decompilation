...

{
  ...
  if (param_8 != 0) {
    ...
    if (errorCode == 0) {
      ...
      StartServTy::WrTextDDX
                (this_00,0,param_4 + 10,(int)this_00,iStack_8,0xf,puVar2,uVar4,uVar5,pvVar6,uVar7);
      ...
      StartServTy::WrTextDDX
                ((StartServTy *)param_4,0,param_4 + 10,param_5 + -0x2f + param_7,iStack_8,0xf,puVar2
