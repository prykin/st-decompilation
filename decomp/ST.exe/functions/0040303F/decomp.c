...

{
  ...
  if (param_8 != 0) {
    ...
    if (iVar2 == 0) {
      ...
      StartServTy::WrTextDDX
                (this_00,0,param_4 + 10,(int)this_00,iStack_8,0xf,puVar3,uVar5,uVar6,pvVar7,uVar8);
      ...
      StartServTy::WrTextDDX
                ((StartServTy *)param_4,0,param_4 + 10,param_5 + -0x2f + param_7,iStack_8,0xf,puVar3
