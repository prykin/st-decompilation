...
void __fastcall thunk_FUN_00533b80(void *param_1)

{
  ...
  if ((DAT_008067a0 != '\0') && (*(short *)((int)param_1 + 0x172) != 2)) {
    ...
    {
      FUN_006b55f0(*(undefined4 **)((int)param_1 + 0x68),0,0x1d,0x13,*(int *)((int)param_1 + 0x184),
                   0,0x1d,0x13,0xee,0x6a);
      FUN_00710a90(*(int *)((int)param_1 + 0x68),0,0x1d,0x13,0xee,0x6a);
      if (DAT_008067a0 == '\0') {
        UVar3 = 0x3e84;
      }
      else {
      ...
      *(UINT *)((int)param_1 + 0x1a5) = UVar3;
      ...
      FUN_00711b70(puVar2,iVar4,iVar5,uVar1,iVar6,iVar7);
      FUN_006b3640(DAT_008075a8,*(uint *)((int)param_1 + 0x60),0xffffffff,
    ...
    if (*(char *)((int)param_1 + 0x1a4) == '\x01') {
      ...
      if (*(int *)((int)param_1 + 0x1c1) != 0) {
        FUN_006e6080(param_1,2,*(int *)((int)param_1 + 0x1c1),auStack_24);
      }
    }
  }
  return;
