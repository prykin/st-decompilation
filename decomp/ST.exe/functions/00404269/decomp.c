...
void __thiscall thunk_FUN_005a2380(void *this,undefined4 *param_1)

{
  ...
  if ((*(char *)((int)this + 0x1a5f) == '\x06') && (*(char *)((int)this + 0x1a60) == '\0')) {
    ...
    this_00 = pvStack_c;
    if (iVar4 == 0) {
      *(undefined4 *)((int)pvStack_c + 0x2d) = 0x26;
      FUN_006e6080(pvStack_c,2,*(undefined4 *)((int)pvStack_c + 0x1b20),
                   (undefined4 *)((int)pvStack_c + 0x1d));
      puVar2 = *(uint **)((int)this_00 + 0x1ea6);
      if ((uint)*(ushort *)((int)this_00 + 0x31) < puVar2[3]) {
        puStack_8 = (undefined4 *)(puVar2[2] * (uint)*(ushort *)((int)this_00 + 0x31) + puVar2[7]);
      }
      else {
      ...
      *(undefined4 *)((int)this_00 + 0x31) = uVar5;
      FUN_006e6080(this_00,2,*(undefined4 *)((int)this_00 + 0x1b20),
                   (undefined4 *)((int)this_00 + 0x1d));
      if (puStack_8 != (undefined4 *)0x0) {
        uVar7 = 0;
        puStack_8 = *(undefined4 **)(*(int *)((int)this_00 + 0x1ea6) + 0xc);
        if (puStack_8 != (undefined4 *)0x0) {
          if (puStack_8 == (undefined4 *)0x0) {
            pbVar9 = (byte *)0x0;
            goto LAB_005a252f;
