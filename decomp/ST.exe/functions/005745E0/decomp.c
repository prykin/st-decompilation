...
cf_break_loop_00574651:
      ...
      *(undefined2 *)(param_2 + 2) = 0;
      pAVar3 = PTR_0080760c;
      puVar1 = &PTR_0080760c->field_0140;
      *param_2 = PTR_0080760c->field_0140;
      *puVar1 = param_2;
      pAVar3->field_013C = pAVar3->field_013C + 1;
      FUN_006ddbe0((AnonShape_GLOBAL_00807598_0C6808FB *)PTR_0080760c);
      PTR_0080760c->field_0124 = 3;
      FUN_006ddd50(PTR_0080760c);
      PTR_0080760c->field_0124 = 4;
      FUN_006ddd50(PTR_0080760c);
      pAVar3 = PTR_0080760c;
      PTR_0080760c->field_0140 = 0;
      pAVar3->field_013C = 0;
        ...
        do {
          ...
          if (uVar7 != 0) {
            do {
              ...
              uVar9 = 0;
              if (uVar7 != 0) {
                pcVar10 = (char *)(PTR_0080760c->field_0028 * iVar6 + PTR_0080760c->field_000C +
                                  local_20);
                do {
                  if (*pcVar10 != '\0') {
                    if (*pcVar10 == -1) {
