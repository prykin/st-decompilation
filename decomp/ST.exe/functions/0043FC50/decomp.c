...
void FUN_0043fc50(undefined1 param_1,int param_2)

{
  ...
  case 1:
    ...
    *(undefined4 *)((int)&DAT_007f50c7 + (uint)DAT_0080874d * 0xa62) =
    ...
    thunk_FUN_004fa870(DAT_00801688,1);
    goto LAB_0043fd36;
  case 2:
    if ((param_2 != 0) &&
...
LAB_0043fd36:
    if (DAT_00801688 != (void *)0x0) {
      thunk_FUN_004fa870(DAT_00801688,2);
      return;
    }
    break;
  case 4:
    if (((param_2 == 0) ||
      ...
      thunk_FUN_004fa870(DAT_00801688,4);
      return;
    }
    break;
  case 5:
    if (((param_2 == 0) ||
        (*(int *)((int)&DAT_007f50d3 + (uint)DAT_0080874d * 0xa62) != *(int *)(DAT_00802a38 + 0xe4))
                   ...
                   *(undefined4 *)(DAT_00802a38 + 0xe4), DAT_00801688 != (void *)0x0)) {
      thunk_FUN_004fa870(DAT_00801688,5);
      return;
    }
    break;
  case 6:
    if (((param_2 == 0) ||
        (*(int *)((int)&DAT_007f50d7 + (uint)DAT_0080874d * 0xa62) != *(int *)(DAT_00802a38 + 0xe4))
                   ...
                   *(undefined4 *)(DAT_00802a38 + 0xe4), DAT_00801688 != (void *)0x0)) {
      thunk_FUN_004fa870(DAT_00801688,6);
      return;
    }
    break;
  case 7:
    if (((param_2 == 0) ||
        (*(int *)((int)&DAT_007f50db + (uint)DAT_0080874d * 0xa62) != *(int *)(DAT_00802a38 + 0xe4))
                   ...
                   *(undefined4 *)(DAT_00802a38 + 0xe4), DAT_00801688 != (void *)0x0)) {
      thunk_FUN_004fa870(DAT_00801688,7);
      return;
    }
    break;
  case 8:
  ...
  case 0xe:
    if (((param_2 == 0) ||
        (*(int *)((int)&DAT_007f50f7 + (uint)DAT_0080874d * 0xa62) != *(int *)(DAT_00802a38 + 0xe4))
                   ...
                   *(undefined4 *)(DAT_00802a38 + 0xe4), DAT_00801688 != (void *)0x0)) {
      thunk_FUN_004fa870(DAT_00801688,0xe);
      return;
    }
    break;
  case 0xf:
    if (((param_2 == 0) ||
        (*(int *)((int)&DAT_007f50fb + (uint)DAT_0080874d * 0xa62) != *(int *)(DAT_00802a38 + 0xe4))
                   ...
                   *(undefined4 *)(DAT_00802a38 + 0xe4), DAT_00801688 != (void *)0x0)) {
      thunk_FUN_004fa870(DAT_00801688,0xf);
      return;
    }
    break;
  case 0x10:
