...
void thunk_FUN_005ba8b0(char param_1)

{
  ...
  if ((*(int *)(iStack_8 + 0x1c96) == 0) && (param_1 == '\0')) {
    thunk_FUN_005b9860(DAT_0080759c,0,0,0x79,0x51,0x22e,0x145,iStack_8);
  }
  uVar8 = 0;
  pvVar7 = *(void **)(DAT_0081176c + 0x30);
  uVar6 = 0xffffffff;
  uVar5 = 0xfffffffe;
  if (*(char *)(iStack_8 + 0x1a5f) == '\x01') {
  ...
  thunk_FUN_00540890(0,0xe9,0x14,0x14c,0x18,puVar3,uVar5,uVar6,pvVar7,uVar8);
  if ((*(int *)(iStack_8 + 0x1c9a) == 0) && (param_1 == '\0')) {
