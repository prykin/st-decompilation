...

{
  ...
  STT3DSprC::LoadSequence((STT3DSprC *)this,8,PTR_00806774,"Expb22",0x1d);
  STT3DSprC::LoadSequence((STT3DSprC *)this,10,PTR_00806774,"expmask3",0x1d);
  uVar4 = 0x45;
  uVar3 = 0x5a;
  iVar2 = 1;
  ...
  iVar2 = STT3DSprC::LoadSequence((STT3DSprC *)this,9,PTR_00806764,"expl_bbt0",0x1d);
  if (iVar2 == 0) {
