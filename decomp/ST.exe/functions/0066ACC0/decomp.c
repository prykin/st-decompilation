...

{
  ...
  iVar10 = __setjmp3(local_260.jumpBuffer,0,unaff_EDI,unaff_ESI);
  if (iVar10 != 0) {
...
joined_r0x0066b1d2:
        ...
        case 0x7de:
          ...
          if (DAT_00801688 != (void *)0x0) {
            thunk_FUN_004f91a0(DAT_00801688,(byte)local_50[0]._0_1_,&local_1d,(int *)&local_8);
          }
          local_14 = FUN_006aac10(4);
...
LAB_0066bff3:
    ...
    case 0x7ea:
      ...
      local_14 = FUN_006aac10(4);
      *local_14 = (uint)(byte)local_50[0][0x809950];
      break;
    case 0x7eb:
      local_14 = FUN_006aac10(4);
...
switchD_0066cedf_caseD_3:
    ...
    case 0x7f4:
      ...
      puVar19 = (uint *)(param_1 + 5);
      uVar11 = (**(code **)*local_64)(puVar19,local_50);
      pAVar12 = (AiFltClassTy *)thunk_FUN_00668f50(local_64,(char *)local_8,uVar11,puVar19);
      pcVar21 = (char *)0x0;
      if (0 < (int)pAVar12) {
        local_c = param_1 + 10;
        ppAVar23 = local_50;
...
LAB_0066dced:
  ...
  case 0x818:
    ...
    local_14 = FUN_006aac10(4);
    *local_14 = (uint)(byte)*(AiFltClassTy *)((int)&DAT_00798fd8 + (int)local_8);
    break;
  case 0x819:
  case 0x81b:
  case 0x81c:
    ...
    if (iVar10 == 1) {
      ...
      if (sVar3 == 0x81c) {
        ...
        if ((iVar10 == 0) &&
           (iVar10 = thunk_FUN_004e7f20((int)local_50[0],(int)pcVar21,(int)pAVar12), iVar10 == 0)) {
          local_14 = FUN_006aac10(4);
          *local_14 = 0;
        }
        else {
  ...
  case 0x81d:
    ...
    local_14 = FUN_006aac10(4);
    *local_14 = *(uint *)(&DAT_007e481c + (int)(local_8 + (int)local_c * 4) * 4);
    break;
  case 0x82a:
    if ((*param_1 != '\x04') && (*param_1 != '\x01')) {
      pcVar21 = thunk_FUN_00674af0(iVar10);
    ...
    iVar10 = thunk_FUN_0066ab60((char)local_50[0]._0_1_,pbVar15,pbVar14);
    local_14 = FUN_006aac10(4);
    if (iVar10 == 0) {
      *local_14 = 0xffffffff;
    }
  ...
  case 0x82f:
    ...
    if (0 < iVar10) {
      ...
      do {
        ...
        puVar16 = puVar16 + 1;
        iVar10 = iVar10 + -1;
        local_8 = (AiFltClassTy *)((uint)local_8 | 1 << ((byte)uVar18 & 0x1f));
      } while (iVar10 != 0);
    }
    local_c = (char *)0xffffffff;
    uVar11 = (**(code **)*local_64)(param_1 + 5);
