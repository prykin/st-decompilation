...
void FUN_005dc730(int param_1,char *param_2,int param_3)
...
LAB_005dc828:
        thunk_FUN_005411a0(*(int *)(local_8 + 0x548),pcVar8,s_____s_007c72b4);
        iVar3 = iVar3 + 1;
      } while (iVar3 < (int)DAT_0080c4cb[2]);
    }
    iVar3 = *(int *)(local_8 + 0x34);
    *(undefined4 *)(iVar3 + 0x7e) = 1;
    puVar5 = (undefined2 *)(iVar3 + 0x9e);
    *puVar5 = 0;
    *(undefined1 *)puVar5 = DAT_007cc854;
    local_c = FUN_007126e0(*(int *)(local_8 + 0x548),(uint *)s________________007c21d8,
                           (uint *)&DAT_007c21ec,*(int *)(*(int *)(local_8 + 0x544) + 4) + -0x14,0,
...
LAB_005dca07:
          FUN_006b5aa0(*(int *)(local_8 + 0x548),pcVar8);
          iVar3 = iVar3 + 1;
    ...
    local_1c = 0x28;
    local_18 = CONCAT22(*(undefined2 *)(*(int *)(local_8 + 0x548) + 8),1);
    if (*(int *)(local_8 + 0x389) != 0) {
      FUN_006e5970(2,*(int *)(local_8 + 0x389),(int)local_2c);
    }
    local_1c = 0x22;
    local_18 = 0;
    if (*(int *)(local_8 + 0x389) != 0) {
