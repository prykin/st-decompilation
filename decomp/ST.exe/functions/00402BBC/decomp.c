...

{
  ...
  uint uStack_14;
  uint *puStack_10;
  SystemClassTy *pSStack_c;
  char cStack_5;
  
  puVar7 = auStack_34;
  pSStack_c = (SystemClassTy *)this;
  ...
  iVar6 = Library::MSVCRT::__setjmp3(IStack_78.jumpBuffer,0,unaff_EDI,unaff_ESI);
  if (iVar6 == 0) {
    if ((param_1 != 0) &&
       (puVar2 = Library::DKW::TBL::FUN_006b54f0((uint *)0x0,2,1), this_00 = pSStack_c,
       puVar2 != (uint *)0x0)) {
      cStack_5 = '\0';
      uStack_24 = 0x26;
      puStack_10 = puVar2;
      SystemClassTy::SendMessage(pSStack_c,2,(int)pSStack_c[0x2a].objects,(int)auStack_34);
      ...
      Library::DKW::TBL::FUN_006b5aa0((int)puVar2,(char *)&DAT_0080f33a);
      puVar3 = ccFntTy::FormSarr((ccFntTy *)this_00[1].systemId,(int)puVar2,
                                 (uint *)s________________007c21d8,
                                 *(int *)(*(int *)((int)&this_00[0x33].parentSystem + 2) + 4),0,
                                 0xffffffff,1);
      if (puVar3 != (uint *)0x0) {
        if (puVar3[2] != 0) {
          ccFntTy::SepColorStrInSarr((ccFntTy *)this_00[1].systemId,puVar3,puVar3);
        }
        iVar6 = 0;
        if (0 < (int)puVar3[2]) {
          if ((int)puVar3[2] < 1) {
...
LAB_005dd982:
      ...
      SystemClassTy::SendMessage(this_00,2,(int)this_00[0x2a].objects,(int)auStack_34);
      uStack_24 = 0x22;
      uStack_20 = 0;
      if (cStack_5 == '\0') {
