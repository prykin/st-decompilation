  ...
  if ((*(uint *)(*(int *)(*(int *)&this->field_0x288 + 0x28) + 0xc) & 0x100) == 0) {
    ...
    if (((STField<uint>(iVar4,0x4) & 8) == 0) &&
      ...
      if ((*(int *)(STField<int>(iVar4,0x28) + 0x20) < 0x11) && (STField<ushort>(iVar8,0x3E) < 0x11)) {
        ...
        BVar6 = IsBadReadPtr((uint *)(((STField<int>(iVar8,0x38) - STField<int>(iVar4,0xC)) -
...
LAB_006d68c8:
          ...
          SetViewportOrgEx(local_b4[0],STField<int>(iVar4,0x10),STField<int>(iVar4,0x14),(LPPOINT)0x0);
          /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
          ...
          *(int **)(*(int *)(*(int *)&this->field_0x288 + 0x28) + 0x480) = piVar3;
          ...
          StretchDIBits(local_b4[0],local_a8,local_a4,local_a0,local_9c,STField<int>(iVar4,0x8),
