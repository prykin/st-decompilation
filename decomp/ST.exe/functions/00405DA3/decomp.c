  ...
  if ((param_1 == 1) || (param_1 == 0)) {
    ...
    *(undefined4 *)(pSStack_30 + 0x65) = 0;
    ...
    if (*(int *)(pSVar2 + 0x164) == 0) {
      Library::DKW::TBL::FUN_006afe40((int *)&puStack_8,*(uint **)(pSVar2 + 0x168));
    }
    if (*(int *)(pSVar2 + 0x164) == 1) {
      ...
      if (0 < iStack_14) {
        Library::DKW::TBL::FUN_006afe40((int *)&puStack_8,puStack_1c);
      }
      if (0 < iStack_18) {
        if (iStack_14 == 0) {
          Library::DKW::TBL::FUN_006afe40((int *)&puStack_8,puStack_10);
        }
        else {
          uVar9 = 0;
          if (0 < iStack_18) {
            do {
              ...
              Library::DKW::TBL::FUN_006ae1c0(puStack_8,&uStack_c);
              uVar9 = uVar9 + 1;
      ...
      do {
        ...
        if ((short)uStack_c != -1) {
          ...
          if (iVar3 == 0) {
            ...
            STBoatC::CmdToObj(pSVar5,3,&uStack_24);
          }
          else {
            if (puVar4 == (uint *)0x0) {
  ...
  if (0 < (int)uStack_20) {
    do {
      ...
      if ((short)uStack_c != -1) {
        ...
        iVar3 = thunk_FUN_0045ff10((int)pSVar5);
        if ((iVar3 == 5) || (uVar7 = STBoatC::CheckPBoxCmd(pSVar5,5), uVar7 == 1)) break;
      }
      uVar9 = uVar9 + 1;
