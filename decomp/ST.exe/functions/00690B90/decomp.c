...

{
  ...
  if (iVar4 == 0) {
    *(undefined4 *)((int)local_14 + 300) = *(undefined4 *)((int)DAT_00802a38 + 0xe4);
    uVar1 = *(uint *)(param_1 + 0x10);
    if (uVar1 < 0x110) {
      if (uVar1 == 0x10f) {
        local_c = 0;
        local_10 = (byte *)thunk_FUN_0068e050(&local_c);
        ...
        if (*(int *)((int)local_14 + 0x99) == 0) {
          *(undefined4 *)((int)local_14 + 0x99) = 1;
          thunk_FUN_00690a40((int)local_14);
        }
        else {
          thunk_FUN_00690ab0((int)local_14);
          thunk_FUN_0068ec70((int)local_14);
        }
      }
      else if (uVar1 == 2) {
        ...
        thunk_FUN_0068dc80(puVar2);
        if (puVar2[3] == 0) {
          *(undefined4 *)((int)local_14 + 0x1c) = DAT_00808754;
        }
        else {
          *(undefined4 *)((int)local_14 + 0x1c) = *(undefined4 *)((int)local_14 + 0x7e);
        }
        if (puVar2[3] == 0) {
          thunk_FUN_0068f7e0();
        }
      ...
      thunk_FUN_00690650(local_14,param_1);
    }
    FUN_006e5fd0();
