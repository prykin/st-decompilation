...

{
  ...
  iVar2 = FUN_006e62d0(DAT_00802a38,*(int *)(this + 0x58e),(int *)&piStack_14);
  if (iVar2 != -4) {
    (**(code **)(*piStack_14 + 0xac))(*(undefined4 *)(this + 0x18));
    thunk_FUN_004162f0(piStack_14,(undefined2 *)(this + 0x588),(undefined2 *)(this + 0x58a),
