...

{
  ...
  if ((*(int *)(param_1 + 0x4d0) == 3) || (*(int *)(param_1 + 0x4d0) == 2)) {
    ...
    STT3DSprC::SetCurFase(*(STT3DSprC **)(param_1 + 0x5ff),'\x0e',iVar4);
    STT3DSprC::SetCurFase(*(STT3DSprC **)(param_1 + 0x5ff),'\f',iVar4);
    ...
    if (iVar4 != -2) {
      ...
      STT3DSprC::SetCurFase(*(STT3DSprC **)(param_1 + 0x5ff),'\r',iVar2);
      STT3DSprC::StartShow
