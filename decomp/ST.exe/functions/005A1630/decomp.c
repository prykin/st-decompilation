    ...
    if (iVar4 == 0) {
      if (DAT_00802a30 != (CursorClassTy *)0x0) {
        ...
        *(undefined2 *)&this_01[0xb].field_0x48 = 0xffff;
        CursorClassTy::SetGCType(this_01,CASE_0,uVar1,uVar10);
      ...
      if (param_1 != 0) {
        DAT_0080fb76 = 1;
        *(undefined4 *)&local_8->field_0x4d = 0x7102;
        *(undefined4 *)&local_8->field_0x49 = 1;
        FUN_006e6020(local_8,(undefined4 *)&local_8->field_0x3d);
        g_currentExceptionFrame = local_6c.previous;
        return;
      }
      iVar4 = local_8->field_1AC0;
      ...
      ccFntTy::WrTxt(*(ccFntTy **)&pFVar3->field_0x1a73,puVar6,iVar4,iVar9,uVar10,iVar11,iVar12);
      FUN_006b35d0(DAT_008075a8,pFVar3->field_1ABC);
      iVar4 = *(int *)&pFVar3->field_0x1a5b;
      puVar5 = local_28;
      for (iVar9 = 8; iVar9 != 0; iVar9 = iVar9 + -1) {
        *puVar5 = 0;
        puVar5 = puVar5 + 1;
      }
      local_28[2] = *(undefined4 *)&pFVar3->field_0x8;
      local_28[3] = 2;
      local_28[4] = 0x6956;
      this_00 = *(MMsgTy **)(iVar4 + 0x2e6);
