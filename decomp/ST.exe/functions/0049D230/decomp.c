...
undefined4 __thiscall FUN_0049d230(void *this,int param_1)

{
  ...
  if ((param_1 == 0) || (param_1 == 1)) {
    uVar12 = 0;
    puVar14 = (undefined4 *)((int)local_2c + 0x89);
    for (iVar7 = 0x15; iVar7 != 0; iVar7 = iVar7 + -1) {
      *puVar14 = 0;
      puVar14 = puVar14 + 1;
    }
    *(undefined4 *)((int)local_2c + 0x65) = 0;
    local_20 = 0;
    *(undefined4 *)((int)local_2c + 0x295) = *(undefined4 *)((int)local_2c + 0x156);
    *(undefined2 *)((int)local_2c + 0x299) = *(undefined2 *)((int)local_2c + 0x15a);
    local_34 = *(undefined2 *)((int)local_2c + 0x156);
    local_38 = *(undefined4 *)(DAT_00802a38 + 0xe4);
    local_30 = *(undefined2 *)((int)local_2c + 0x15a);
    local_32 = *(undefined2 *)((int)local_2c + 0x158);
    puVar9 = local_14;
    local_24 = local_38;
    if (local_10 != 0) {
      do {
        ...
        do {
          ...
          if ((short)local_8 != -1) {
            piVar8 = (int *)thunk_FUN_0042b620(CONCAT31((int3)((uint)extraout_ECX >> 8),
                                                        *(undefined1 *)((int)pvVar5 + 0x24)),local_8
                                               ,1);
            if (piVar8 == (int *)0x0) {
