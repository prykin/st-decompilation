...
undefined4 * FUN_006f2860(undefined4 *param_1)

{
  ...
  if (iVar2 != 0) {
    ...
    iVar4 = FUN_006ad4d0(s_E__Ourlib_Mf32int_cpp_007efaa4,0x321,0,iVar2,&DAT_007a4ccc);
    if (iVar4 != 0) {
      pcVar1 = (code *)swi(3);
      puVar5 = (undefined4 *)(*pcVar1)();
      return puVar5;
    }
    FUN_006a5e40(iVar2,0,0x7efaa4,0x323);
