...

{
  ...
  if (iVar1 == 0) {
    *param_3 = 0;
    ...
    if (((hmxobj != (HMIXEROBJ)0x0) &&
      ...
      exceptionCode = mixerGetControlDetailsA(hmxobj,&local_20,0);
      if (exceptionCode != 0) {
        RaiseInternalException(exceptionCode,DAT_007ed77c,s_E__DKW_SND_C_mixer_cpp_007edbe8,0xe2);
      }
      *param_3 = local_8;
    }
  ...
  g_currentExceptionFrame = local_64.previous;
  RaiseInternalException(iVar1,0,s_E__DKW_SND_C_mixer_cpp_007edbe8,0xe8);
  return 0xffffffff;
}
