...

{
  ...
  if (iVar2 != 0) {
    ...
    iVar6 = FUN_006ad4d0(s_E____titans_Start_load_obj_cpp_007cc728,0x3ea,0,iVar2,&DAT_007a4ccc);
    if (iVar6 != 0) {
      pcVar1 = (code *)swi(3);
      (*pcVar1)();
      return;
  ...
  this_00 = pCStack_c;
  thunk_FUN_00540dc0(0,*(undefined4 *)(pCStack_c + 8),2,0xc0a1,2,0x1c,0,0,0,0,0,0);
