...

{
  ...
  if (iVar2 != 0) {
    ...
    iVar5 = FUN_006ad4d0(s_E____titans_Start_load_obj_cpp_007cc728,0x3ea,0,iVar2,&DAT_007a4ccc);
    if (iVar5 != 0) {
      pcVar1 = (code *)swi(3);
      (*pcVar1)();
      return;
    }
    FUN_006a5e40(iVar2,0,0x7cc728,0x3ea);
    return;
  }
  if (DAT_00802a30 != 0) {
  ...
  thunk_FUN_00540dc0(0,*(undefined4 *)((int)pvStack_c + 8),2,0xc0a1,2,0x1c,0,0,0,0,0,0);
  if (*(uint *)((int)pvStack_c + 0x1c83) != 0) {
    FUN_006e56b0(*(void **)((int)pvStack_c + 0xc),*(uint *)((int)pvStack_c + 0x1c83));
  }
  *(undefined4 *)((int)pvStack_c + 0x1c83) = 0;
  FUN_006b3af0(DAT_008075a8,*(uint *)((int)pvStack_c + 0x1c87));
  FUN_006b5f80(DAT_008075a8,0x112,0x38,0x204,0x19d);
  thunk_FUN_005b68b0(DAT_0080759c,0,0,0x112,0x38,0x204,0x19d,
                     (undefined4 *)(*(int *)((int)pvStack_c + 0x1a5b) + 0x140));
  if (*(uint *)((int)pvStack_c + 0x1a6c) != 0) {
    FUN_006e56b0(*(void **)((int)pvStack_c + 0xc),*(uint *)((int)pvStack_c + 0x1a6c));
  }
  *(undefined4 *)((int)pvStack_c + 0x1a6c) = 0;
  if (*(int *)((int)pvStack_c + 0x20b8) != 0) {
    thunk_FUN_005aafb0();
    FUN_0072e2b0(*(undefined4 **)((int)pvStack_c + 0x20b8));
    *(undefined4 *)((int)pvStack_c + 0x20b8) = 0;
  }
  ...
  *(undefined1 **)((int)pvStack_c + 0x20b8) = puVar3;
  if (puVar3 != (undefined1 *)0x0) {
    uVar8 = 0;
    cVar7 = '\x01';
    uVar6 = 0x10;
    ...
    if (uVar6 != 0) {
      iVar2 = *(int *)((int)pvStack_c + 0x20b8);
      *(undefined1 *)(iVar2 + 2) = 0;
      *(undefined4 *)(iVar2 + 0x17) = 0xffffffff;
      uVar6 = *(uint *)(*(int *)((int)pvStack_c + 0x20b8) + 3);
      if (-1 < (int)uVar6) {
  ...
  if (*(uint *)((int)pvStack_c + 0x1a74) != 0xffffffff) {
    FUN_006b3af0(*(int **)((int)pvStack_c + 0x1ab8),*(uint *)((int)pvStack_c + 0x1a74));
  }
  if (*(uint *)((int)pvStack_c + 0x1b05) != 0xffffffff) {
    FUN_006b3af0(*(int **)((int)pvStack_c + 0x1b49),*(uint *)((int)pvStack_c + 0x1b05));
  }
  if (*(uint *)((int)pvStack_c + 0x1b96) != 0xffffffff) {
    FUN_006b3af0(*(int **)((int)pvStack_c + 0x1bda),*(uint *)((int)pvStack_c + 0x1b96));
  }
  puVar4 = (uint *)((int)pvStack_c + 0x1c23);
  iStack_8 = 0x16;
  do {
  ...
  if (*(char *)((int)pvStack_c + 0x20b4) == '\0') {
    ...
    *(undefined4 *)((int)pvStack_c + 0x31) = 0;
    ...
    if (*(uint *)(DAT_0081176c + 0x389) != 0) {
      FUN_006e56b0(*(void **)((int)pvStack_c + 0xc),*(uint *)(DAT_0081176c + 0x389));
    }
    ...
    *(uint **)(DAT_0081176c + 0x548) = puVar4;
    if (*(int *)((int)pvStack_c + 0x20bc) != 0) {
      thunk_FUN_005aafb0();
      FUN_0072e2b0(*(undefined4 **)((int)pvStack_c + 0x20bc));
      *(undefined4 *)((int)pvStack_c + 0x20bc) = 0;
    }
    puVar3 = (undefined1 *)FUN_0072e530(0x33);
    if (puVar3 == (undefined1 *)0x0) {
      puVar3 = (undefined1 *)0x0;
    ...
    *(undefined1 **)((int)pvStack_c + 0x20bc) = puVar3;
    if (puVar3 != (undefined1 *)0x0) {
      uVar8 = 0;
      cVar7 = '\x01';
      uVar6 = 0x10;
      ...
      if (uVar6 != 0) {
        iVar2 = *(int *)((int)pvStack_c + 0x20bc);
        *(undefined1 *)(iVar2 + 2) = 0;
        *(undefined4 *)(iVar2 + 0x17) = 0xffffffff;
        uVar6 = *(uint *)(*(int *)((int)pvStack_c + 0x20bc) + 3);
        if (-1 < (int)uVar6) {
          FUN_006b3430(DAT_008075a8,uVar6);
        }
        thunk_FUN_005ab0a0();
  ...
  if (*(char *)((int)pvStack_c + 0x20b7) == '\0') {
    *(undefined4 *)((int)pvStack_c + 0x2d) = 0x20;
    *(undefined4 *)((int)pvStack_c + 0x31) = 0;
    if (*(int *)(DAT_0081176c + 0x54c) != 0) {
      FUN_006e6080(pvStack_c,2,*(int *)(DAT_0081176c + 0x54c),(undefined4 *)((int)pvStack_c + 0x1d))
      ;
    }
    *(undefined4 *)((int)pvStack_c + 0x31) = 0;
    if (*(int *)(DAT_0081176c + 0x550) != 0) {
      FUN_006e6080(pvStack_c,2,*(int *)(DAT_0081176c + 0x550),(undefined4 *)((int)pvStack_c + 0x1d))
      ;
    }
  }
  else {
    if (*(uint *)(DAT_0081176c + 0x54c) != 0) {
      FUN_006e56b0(*(void **)((int)pvStack_c + 0xc),*(uint *)(DAT_0081176c + 0x54c));
      *(undefined4 *)(DAT_0081176c + 0x54c) = 0;
    }
    if (*(uint *)(DAT_0081176c + 0x550) != 0) {
      FUN_006e56b0(*(void **)((int)pvStack_c + 0xc),*(uint *)(DAT_0081176c + 0x550));
      *(undefined4 *)(DAT_0081176c + 0x550) = 0;
    }
    if (*(int *)((int)pvStack_c + 0x20c0) != 0) {
      thunk_FUN_005aafb0();
      FUN_0072e2b0(*(undefined4 **)((int)pvStack_c + 0x20c0));
      *(undefined4 *)((int)pvStack_c + 0x20c0) = 0;
    }
    puVar3 = (undefined1 *)FUN_0072e530(0x33);
    if (puVar3 == (undefined1 *)0x0) {
      puVar3 = (undefined1 *)0x0;
    ...
    *(undefined1 **)((int)pvStack_c + 0x20c0) = puVar3;
    if (puVar3 != (undefined1 *)0x0) {
      uVar8 = 0;
      cVar7 = '\x01';
      uVar6 = 0x10;
      ...
      if (uVar6 != 0) {
        iVar2 = *(int *)((int)pvStack_c + 0x20c0);
        *(undefined1 *)(iVar2 + 2) = 0;
        *(undefined4 *)(iVar2 + 0x17) = 0xffffffff;
        uVar6 = *(uint *)(*(int *)((int)pvStack_c + 0x20c0) + 3);
        if (-1 < (int)uVar6) {
          FUN_006b3430(DAT_008075a8,uVar6);
        }
        thunk_FUN_005ab0a0();
