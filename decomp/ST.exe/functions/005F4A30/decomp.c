...

{
  ...
  if (local_c != 0) {
    uVar4 = param_2 & 0xff;
    local_14 = mfRLoad(DAT_00806764,CASE_1D,local_10[uVar4],0xffffffff,0,1,0,(undefined4 *)0x0);
    ...
    FUN_006e98e0(DAT_00807598,*puVar1,0,*(undefined4 *)local_14,*(int *)((int)local_14 + 0x21),1);
