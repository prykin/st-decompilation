...

{
  ...
  if (*(int *)(this + 0x114) != 0) {
    ...
    this_00 = pVStack_c;
    if (iVar3 == 0) {
      uStack_8 = *(uint *)(*(int *)(pVStack_c + 0xf4) + 0xc);
      while (uStack_8 = uStack_8 - 1, -1 < (int)uStack_8) {
        iVar3 = *(int *)(this_00 + 0xf4);
        ...
        if (((uint)(piVar6[5] + piVar6[6]) <= *(uint *)(this_00 + 0x108)) &&
           (((*(uint *)(this_00 + 0x108) - piVar6[5]) - piVar6[6]) % 7 == 0)) {
          ...
          piVar6[3] = (int)puVar4;
          if ((int)puVar4 < 0) {
            FUN_006b0c70(*(int *)(this_00 + 0xf4),uStack_8);
            uStack_8 = uVar2;
          }
          else {
