...
uint __thiscall thunk_FUN_006226c0(void *this,uint param_1,int param_2)
    ...
    if ((DAT_0080874d == 0xff) ||
       ((((((uVar3 = 0, *(int *)((int)DAT_00802a88 + 0xf8) == 0 ||
            (uVar3 = thunk_FUN_00558c00(DAT_00802a88,*(undefined4 *)((int)DAT_00802a88 + 0x10c),
                                        ...
                                        (int)*(short *)((int)this + 0x49),&param_2,(int *)&pvStack_8
                                       ), iVar4 < 0)) || (4 < iVar4)) ||
          ((param_2 < 0 || (*(int *)((int)pvVar1 + 0x30) <= param_2)))) ||
         ((uVar3 = (&DAT_0079aed0)[iVar4] + (int)pvStack_8, (int)uVar3 < 0 ||
