...
void __cdecl FUN_00553a70(int param_1,int param_2,int param_3,uint param_4,int param_5)

{
  ...
  if ((((param_3 != 0) && (-1 < param_1)) && (param_1 < (int)param_4)) &&
    ...
    thunk_FUN_00553390(param_1,param_2,(byte *)param_3,param_4,param_5,0);
