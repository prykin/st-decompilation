...
LAB_006b719c:
  while( true ) {
    while( true ) {
      ...
      local_8 = (short *)Library::DKW::LIB::FUN_006aac70(local_c);
    ...
    param_1[1] = local_10;
    param_1[2] = (uint)*(byte *)((int)local_8 + 1);
    param_1[3] = (int)local_8[1];
    param_1[4] = local_c + -8;
    iVar2 = Library::DKW::LIB::FUN_006aac70(*(int *)(local_8 + 2));
    param_1[5] = iVar2;
    uVar5 = param_1[4];
    psVar6 = local_8 + 4;
    puVar3 = (undefined4 *)param_1[5];
    for (uVar4 = uVar5 >> 2; uVar4 != 0; uVar4 = uVar4 - 1) {
      *puVar3 = *(undefined4 *)psVar6;
      psVar6 = psVar6 + 2;
      puVar3 = puVar3 + 1;
    }
    for (uVar5 = uVar5 & 3; uVar5 != 0; uVar5 = uVar5 - 1) {
      *(char *)puVar3 = (char)*psVar6;
...
code_r0x006b72b1:
  param_1 = (int *)FUN_006b73e0(piVar1[0x14],local_10);
  if (param_1 != (int *)0x0) {
    if (((char)param_1[2] == *(char *)((int)local_8 + 1)) && ((int)local_8[1] == param_1[3] + -1)) {
