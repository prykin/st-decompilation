...
LAB_006b719c:
  while( true ) {
    while( true ) {
      ...
      local_8 = (char *)FUN_006aac70(local_c);
    ...
    if (*local_8 != '\x05') break;
    param_1 = (int *)FUN_006b73e0(piVar1[0x14],local_10);
    if (param_1 == (int *)0x0) {
      param_1 = (int *)FUN_006aac70(0x18);
      if (param_1 == (int *)0x0) {
        return -2;
      }
      FUN_006b9910(piVar1 + 0x14,param_1);
    }
    else {
      FUN_006a5e90((undefined4 *)param_1[5]);
    }
    param_1[1] = local_10;
    param_1[2] = (uint)(byte)local_8[1];
    param_1[3] = (int)*(short *)(local_8 + 2);
    param_1[4] = local_c + -8;
    iVar2 = FUN_006aac70(*(int *)(local_8 + 4));
    param_1[5] = iVar2;
    uVar5 = param_1[4];
    pcVar6 = local_8 + 8;
  ...
  if (*local_8 == '\x06') goto code_r0x006b72b1;
  goto LAB_006b7373;
code_r0x006b72b1:
  param_1 = (int *)FUN_006b73e0(piVar1[0x14],local_10);
  if (param_1 != (int *)0x0) {
    if (((char)param_1[2] == local_8[1]) && ((int)*(short *)(local_8 + 2) == param_1[3] + -1)) {
      param_1[3] = param_1[3] + -1;
      pcVar6 = local_8 + 8;
      pcVar7 = (char *)(param_1[5] + param_1[4]);
      ...
      if (param_1[3] == 0) {
        FUN_006ab060(&local_8);
        local_8 = (char *)param_1[5];
        local_c = param_1[4];
        FUN_006b98c0(piVar1 + 0x14,param_1);
        FUN_006ab060(&param_1);
LAB_006b7373:
        puVar3 = (undefined4 *)FUN_006aac70(0x14);
