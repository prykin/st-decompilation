...
int __thiscall thunk_FUN_00622990(void *this,uint *param_1)

{
  ...
  puStack_10 = (undefined4 *)Library::DKW::LIB::FUN_006aac70(0x109);
  ...
  *(uint *)((int)puStack_10 + 0x109) = uStack_8;
  puVar4 = (undefined4 *)((int)puStack_10 + 0x10d);
  puVar6 = puStack_14;
  puVar8 = puVar4;
