...
undefined4 __cdecl thunk_FUN_004b31c0(int *param_1,int param_2)

{
  ...
  if (DAT_007fa170 != 0) {
    *(undefined4 *)(DAT_007fa170 + 4) = 0;
    iVar3 = FUN_006b1190(DAT_007fa170,&iStack_c);
    iVar4 = param_2;
    while (-1 < iVar3) {
      if ((((iStack_c != 0) && (*(int **)(iStack_c + 0x24) == piVar1)) &&
          ((iVar4 == 0 || (*(int *)(iStack_c + 0x18) != iVar4)))) &&
         ((((*(int *)(iStack_c + 0x2ec) == 3 || (*(int *)(iStack_c + 0x2a0) != 0)) ||
           (*(int *)(iStack_c + 0x2e0) != 0)) || (*(int *)(iStack_c + 0x2dc) != 0)))) {
        iStack_8 = iStack_8 + 1;
      }
      iVar3 = FUN_006b1190(DAT_007fa170,&iStack_c);
      iVar5 = iStack_8;
