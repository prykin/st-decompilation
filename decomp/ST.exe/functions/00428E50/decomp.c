...
LAB_00428e95:
  ...
  iVar13 = (int)lVar21;
  uVar12 = iVar13 + 3U & 0xfffffffc;
  dVar1 = (double)(_DAT_007904f8 / (_DAT_007ac580 / (float)DAT_00807570) + (float)_DAT_007901c0);
  local_e8 = uVar12;
  local_14 = iVar13;
  fVar20 = Library::MSVCRT::FUN_0072e150(SUB84(dVar1,0),(uint)((ulonglong)dVar1 >> 0x20));
  local_b4 = (double)((float10)_DAT_00790580 / fVar20);
  dVar1 = _DAT_00790570 / local_b4 + _DAT_007901c0;
  Library::MSVCRT::FUN_0072e150(SUB84(dVar1,0),(uint)((ulonglong)dVar1 >> 0x20));
  lVar21 = Library::MSVCRT::__ftol();
  local_c4 = (uint)lVar21;
  dVar1 = (double)local_14;
  local_14 = uVar12 - iVar13;
  ST3DSMAPContext::sub_006DC050
            (pSVar7,0,0,0,uVar12,local_c4,-14.14213562373,
             ((double)(int)(uVar12 - iVar13) * (_DAT_00790590 / dVar1) + _DAT_00790590) -
  ...
  if (0 < *(int *)((int)param_1 + 0x455)) {
    ...
    do {
      ...
      local_40 = local_40 + 1;
    /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
    } while (iVar13 < *(int *)((int)param_1 + 0x455));
  }
  ...
  do {
    ...
    *(int *)(PTR_DAT_007a5250 + (int)piVar14 * 4) = (local_e0 >> 0x10) - (local_f4 >> 0x10);
    local_48 = (int *)((int)piVar14 + 1);
  } while ((int)local_48 < 6);
  local_2c = 2;
  piVar14 = &DAT_007f4db8;
  do {
    local_14 = local_2c + -2;
    dVar1 = (double)((float)local_2c * _DAT_007904f8);
    /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
    local_c0._4_4_ = (int)((ulonglong)dVar1 >> 0x20);
    /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
          ...
          if (piVar14 != nullptr) {
            *(uint *)&pRVar3->field_0x18 = uVar12;
            ...
            if (0 < pRVar3->field_0024) {
              do {
                if ((*(byte *)(piVar14[2] + iVar13) & local_50) != 0) {
                  pbVar10 = (byte *)(pRVar3->field_003C + iVar13);
                  *pbVar10 = *pbVar10 | local_50;
                }
                iVar13 = iVar13 + 1;
              } while (iVar13 < pRVar3->field_0024);
            }
            goto LAB_004293c6;
          }
LAB_004292e2:
    ...
    if (0 < *(int *)((int)param_1 + 0x455)) {
      ...
      do {
        ...
        if (pAVar4 != nullptr) {
          ...
          iVar13 = (int)*(short *)&pAVar4->field_0x6 / 2;
...
LAB_0042958f:
            iVar13 = *local_8;
            if ((iVar13 == 0) ||
               (iVar17 = (int)*(short *)(iVar13 + 8) - (uint)*(byte *)(iVar13 + 0x48),
               iVar9 + 3 < iVar17)) goto cf_continue_loop_004296CF;
            if (*(uint *)(iVar13 + 0x18) < local_44->count) {
              /* ST_PSEUDO[dynamic_array_indexing]: expected DArrayAt<T>(array, index) (runtime elementSize cannot be a static C array) */
              pvVar15 = (void *)(local_44->elementSize * *(uint *)(iVar13 + 0x18) +
                                (int)local_44->data);
            }
            else {
              pvVar15 = nullptr;
            }
            local_60 = *(int *)((int)pvVar15 + 0xc);
            local_5c = *(int *)((int)pvVar15 + 0x10) +
                       *(int *)(PTR_DAT_007a5250 + (iVar17 - local_24) * 4);
            local_58 = *(int *)((int)pvVar15 + 0x14);
            local_54 = *(undefined4 *)((int)pvVar15 + 0x18);
            local_18 = pvVar15;
            iVar13 = FUN_006b0460(&local_a0,(int *)((int)pvVar8 + 0xc),&local_60);
            if (iVar13 == 0) goto cf_continue_loop_004296CF;
            if (2 < (int)local_10->field_0024) {
              iVar13 = *(int *)((int)pvVar8 + 0x14);
              local_20 = (undefined4 *)local_30->field_000C;
              iVar9 = *(int *)((int)pvVar8 + 0x10);
              iVar17 = *(int *)((int)pvVar8 + 0xc);
              local_4c = (((local_9c - local_5c) * local_58 + *(int *)((int)pvVar15 + 4)) - local_60
                         ) + local_a0;
              if (local_3c != 0) {
                uVar11 = *(int *)((int)pvVar8 + 0x18) * iVar13;
                puVar16 = *(undefined4 **)((int)pvVar8 + 4);
                puVar18 = local_20;
                ...
                local_3c = 0;
                for (uVar11 = uVar11 & 3; pvVar15 = local_18, uVar11 != 0; uVar11 = uVar11 - 1) {
              ...
              uVar12 = thunk_FUN_00428ce0((int)((int)local_20 +
                                               local_a0 + ((local_9c - iVar9) * iVar13 - iVar17)),
                                          *(int *)((int)pvVar8 + 0x14),local_4c,
                                          *(int *)((int)pvVar15 + 0x14),local_98,local_94,
            ...
            *(byte *)local_10->field_003C = *(byte *)local_10->field_003C | local_50;
            iVar13 = local_10->field_003C;
LAB_00429d7a:
            *(byte *)(iVar13 + 1) = *(byte *)(iVar13 + 1) | local_50;
            iVar9 = local_64;
            goto LAB_00429d7d;
          }
/* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
LAB_00429715:
          ...
          iVar9 = (local_7c + iVar13) * local_38 + local_b8;
          ...
          do {
            ...
            if (((-1 < local_64 + local_8c) && (local_64 + local_8c < local_38)) &&
              ...
              do {
                ...
                if ((iVar13 != 0) &&
                  ...
                  local_60 = *(int *)((int)pvVar15 + 0xc) - local_c8;
                  local_5c = *(int *)((int)pvVar15 + 0x10) +
                             *(int *)(PTR_DAT_007a5250 +
                                     (((int)*(short *)(iVar13 + 8) - (uint)*(byte *)(iVar13 + 0x48))
                  ...
                  iVar13 = FUN_006b0460(&local_a0,(int *)((int)pvVar8 + 0xc),&local_60);
                  if (iVar13 != 0) {
                    iVar13 = *(int *)((int)pvVar8 + 0x10);
                    iVar9 = *(int *)((int)pvVar8 + 0x14);
                    local_20 = (undefined4 *)local_30->field_000C;
                    iVar17 = *(int *)((int)pvVar8 + 0xc);
                    local_4c = (((local_9c - local_5c) * local_58 + *(int *)((int)pvVar15 + 4)) -
                               local_60) + local_a0;
                    if (local_3c != 0) {
                      uVar11 = *(int *)((int)pvVar8 + 0x18) * iVar9;
                      puVar16 = *(undefined4 **)((int)pvVar8 + 4);
                      puVar18 = local_20;
                      for (uVar12 = uVar11 >> 2; uVar12 != 0; uVar12 = uVar12 - 1) {
                        *puVar18 = *puVar16;
            ...
            local_64 = iVar9;
            iVar13 = local_a8 + local_68;
            /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
            local_b4 = (double)CONCAT44(iVar13,(undefined4)local_b4);
                ...
                do {
                  ...
                  if ((iVar13 != 0) &&
                    ...
                    local_5c = *(int *)((int)pvVar15 + 0x10) +
                               *(int *)(PTR_DAT_007a5250 +
                                       (((int)*(short *)(iVar13 + 8) -
                                        (uint)*(byte *)(iVar13 + 0x48)) - local_24) * 4) + *local_70
                    ;
                    local_58 = *(int *)((int)pvVar15 + 0x14);
                    local_54 = *(undefined4 *)((int)pvVar15 + 0x18);
                    local_18 = pvVar15;
                    ...
                    if (iVar13 != 0) {
                      if ((int)local_10->field_0024 < 3) {
                        ...
                        if (local_3c != 0) {
                          ...
                          local_3c = 0;
                          for (uVar11 = uVar11 & 3; pvVar15 = local_18, uVar11 != 0;
                              uVar11 = uVar11 - 1) {
                            *(undefined1 *)puVar18 = *(undefined1 *)puVar16;
                            puVar16 = (undefined4 *)((int)puVar16 + 1);
                            puVar18 = (undefined4 *)((int)puVar18 + 1);
                ...
                do {
                  ...
                  if ((iVar13 != 0) &&
                    ...
                    local_5c = *(int *)((int)pvVar15 + 0x10) +
                               *(int *)(PTR_DAT_007a5250 +
                                       (((int)*(short *)(iVar13 + 8) -
                                        (uint)*(byte *)(iVar13 + 0x48)) - local_24) * 4) +
                               local_70[1];
                    local_58 = *(int *)((int)pvVar15 + 0x14);
                    local_54 = *(undefined4 *)((int)pvVar15 + 0x18);
                    local_18 = pvVar15;
            ...
            if (0 < (int)local_10->field_0024) {
              ...
              do {
                if ((*(byte *)(local_10->field_0028 + iVar9) & local_9) != 0) {
                  *(byte *)(local_10->field_003C + iVar13) =
                       *(byte *)(local_10->field_003C + iVar13) | (byte)local_2c;
                }
                iVar13 = iVar13 + 1;
                iVar9 = iVar9 + 0x1c;
              } while (iVar13 < (int)local_10->field_0024);
            }
          }
          else {
            thunk_FUN_00428dc0((uint *)local_30->field_000C,*(int *)((int)pvVar8 + 0x14),
                               *(int *)((int)pvVar8 + 0x18),local_10->field_003C,
