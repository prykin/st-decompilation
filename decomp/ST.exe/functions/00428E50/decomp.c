...
LAB_00428e95:
  ...
  local_14 = uVar9 - iVar10;
  ST3DSMAPContext::sub_006DC050
            (pSVar5,0,0,0,uVar9,local_c4,-14.14213562373,
             ((double)(int)(uVar9 - iVar10) * (_DAT_00790590 / dVar1) + _DAT_00790590) -
  ...
  if (0 < *(int *)((int)param_1 + 0x455)) {
    ...
    do {
      iVar7 = *local_40;
      if (iVar7 != 0) {
        pvVar6 = Library::DKW::LIB::MemAllocClear(*(uint *)(iVar7 + 0x24));
        *(void **)(iVar7 + 0x3c) = pvVar6;
      }
      iVar10 = iVar10 + 1;
      local_40 = local_40 + 1;
    /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
  ...
  do {
    piVar11 = local_48;
    ST3DSMAPContext::sub_006E25D0(pSVar5,&local_e4);
    *(int *)(PTR_DAT_007a5250 + (int)piVar11 * 4) = (local_e0 >> 0x10) - (local_f4 >> 0x10);
    local_48 = (int *)((int)piVar11 + 1);
  } while ((int)local_48 < 6);
  local_2c = 2;
  piVar11 = &DAT_007f4db8;
  do {
    local_14 = local_2c + -2;
    local_c0 = (double)((float)local_2c * _DAT_007904f8);
    local_b4 = (double)((float)local_14 * _DAT_007904f8);
    ST3DSMAPContext::sub_006E25D0(pSVar5,&local_e4);
    piVar11[-1] = (local_e0 >> 0x10) - (local_f4 >> 0x10);
    ST3DSMAPContext::sub_006E25D0(pSVar5,&local_e4);
    *piVar11 = (local_e0 >> 0x10) - (local_f4 >> 0x10);
    ST3DSMAPContext::sub_006E25D0(pSVar5,&local_e4);
    piVar11[1] = (local_e0 >> 0x10) - (local_f4 >> 0x10);
    piVar11 = piVar11 + 3;
    local_2c = local_2c + 2;
  } while ((int)piVar11 < 0x7f4dc5);
      ...
      do {
        ...
        if (puVar13 != nullptr) {
          if (g_cLoading_00802A58 != nullptr) {
            local_a4 = local_a4 + 1;
            uVar9 = local_a4 & 0x8000000f;
            bVar16 = uVar9 == 0;
            if ((int)uVar9 < 0) {
              bVar16 = (uVar9 - 1 | 0xfffffff0) == 0xffffffff;
            }
            if (bVar16) {
              cLoadingTy::SetState
          ...
          uVar9 = 0;
          while( true ) {
            /* ST_PSEUDO[dynamic_array_indexing]: expected DArrayAt<T>(local_44, uVar9) (runtime stride) */
            if ((local_44->count <= uVar9) ||
               (piVar11 = (int *)(local_44->elementSize * uVar9 + (int)local_44->data),
               piVar11 == nullptr)) goto LAB_004292e2;
            if (puVar13[10] == *piVar11) break;
            uVar9 = uVar9 + 1;
          }
          if (piVar11 != nullptr) {
            puVar13[6] = uVar9;
            ...
            if (0 < (int)puVar13[9]) {
              do {
                if ((*(byte *)(piVar11[2] + iVar10) & local_50) != 0) {
                  *(byte *)(puVar13[0xf] + iVar10) = *(byte *)(puVar13[0xf] + iVar10) | local_50;
                }
                iVar10 = iVar10 + 1;
              } while (iVar10 < (int)puVar13[9]);
            }
            goto LAB_004293c6;
          }
LAB_004292e2:
          local_14 = (int)*(short *)((int)puVar13 + 6);
          uVar2 = *(undefined2 *)(puVar13 + 1);
          local_48 = (int *)(int)*(short *)(puVar13 + 2);
          *(undefined2 *)(puVar13 + 1) = 0;
          *(undefined2 *)((int)puVar13 + 6) = 0;
          *(ushort *)(puVar13 + 2) = (ushort)*(byte *)(puVar13 + 0x12);
          *puVar13 = pSVar5->field_0140;
          pSVar5->field_0140 = puVar13;
          ...
          pSVar5->field_013C = 0;
          *(undefined2 *)((int)puVar13 + 6) = (undefined2)local_14;
          *(undefined2 *)(puVar13 + 2) = local_48._0_2_;
          *(undefined2 *)(puVar13 + 1) = uVar2;
          local_110 = thunk_FUN_00428b20((int *)pSVar5->field_000C,local_e8,local_c4,local_108);
          local_114 = puVar13[10];
          local_10c = puVar13[0xf];
          iVar10 = Library::DKW::TBL::DArrayAppend(local_44,&local_114);
          puVar13[6] = iVar10;
        }
LAB_004293c6:
        local_28 = local_28 + 1;
      ...
      do {
        ...
        if (pAVar3 != nullptr) {
          ...
          if (*(uint *)&pAVar3->field_0x18 < local_44->count) {
            ...
            pvVar6 = (void *)(local_44->elementSize * *(uint *)&pAVar3->field_0x18 +
                             (int)local_44->data);
          }
          else {
            pvVar6 = nullptr;
          ...
          uVar9 = (uint)(byte)pAVar3[1].field_0008;
          iVar7 = (int)pAVar3->field_0008;
          local_24 = iVar7 - uVar9;
          iVar10 = (int)*(short *)&pAVar3->field_0x6 / 2;
          if (((*(ushort *)&pAVar3[1].field_0xe & 0x2000) == 0) ||
             (local_ac = 0, (*(ushort *)&pAVar3[1].field_0xe & 0xf) != 0)) {
            local_ac = uVar9;
          }
          local_28 = (int *)(iVar10 * local_38);
          local_b8 = local_80 * 5;
          local_3c = 1;
...
LAB_0042958f:
            iVar10 = *local_8;
            if ((iVar10 == 0) ||
               (iVar14 = (int)*(short *)(iVar10 + 8) - (uint)*(byte *)(iVar10 + 0x48),
               iVar7 + 3 < iVar14)) goto cf_continue_loop_004296CF;
            if (*(uint *)(iVar10 + 0x18) < local_44->count) {
              /* ST_PSEUDO[dynamic_array_indexing]: expected DArrayAt<T>(array, index) (runtime elementSize cannot be a static C array) */
              pvVar12 = (void *)(local_44->elementSize * *(uint *)(iVar10 + 0x18) +
                                (int)local_44->data);
            }
            else {
              pvVar12 = nullptr;
            }
            local_60 = *(int *)((int)pvVar12 + 0xc);
            local_5c = *(int *)((int)pvVar12 + 0x10) +
                       *(int *)(PTR_DAT_007a5250 + (iVar14 - local_24) * 4);
            local_58 = *(int *)((int)pvVar12 + 0x14);
            local_54 = *(undefined4 *)((int)pvVar12 + 0x18);
            local_18 = pvVar12;
            iVar10 = FUN_006b0460(&local_a0,(int *)((int)pvVar6 + 0xc),&local_60);
            if (iVar10 == 0) goto cf_continue_loop_004296CF;
            if (2 < (int)local_10->field_0024) {
              iVar10 = *(int *)((int)pvVar6 + 0x14);
              local_20 = (undefined4 *)local_30->field_000C;
              iVar7 = *(int *)((int)pvVar6 + 0x10);
              iVar14 = *(int *)((int)pvVar6 + 0xc);
              local_4c = (((local_9c - local_5c) * local_58 + *(int *)((int)pvVar12 + 4)) - local_60
                         ) + local_a0;
              if (local_3c != 0) {
                uVar8 = *(int *)((int)pvVar6 + 0x18) * iVar10;
                puVar13 = *(undefined4 **)((int)pvVar6 + 4);
                puVar15 = local_20;
                ...
                local_3c = 0;
                for (uVar8 = uVar8 & 3; pvVar12 = local_18, uVar8 != 0; uVar8 = uVar8 - 1) {
              ...
              /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
              uVar9 = thunk_FUN_00428ce0((int)((int)local_20 +
                                              local_a0 + ((local_9c - iVar7) * iVar10 - iVar14)),
                                         *(int *)((int)pvVar6 + 0x14),local_4c,
                                         *(int *)((int)pvVar12 + 0x14),local_98,local_94,
            ...
            *(byte *)local_10->field_003C = *(byte *)local_10->field_003C | local_50;
            iVar10 = local_10->field_003C;
LAB_00429d7a:
            *(byte *)(iVar10 + 1) = *(byte *)(iVar10 + 1) | local_50;
            iVar7 = local_64;
            goto LAB_00429d7d;
          }
/* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
LAB_00429715:
          ...
          iVar7 = (local_7c + iVar10) * local_38 + local_b8;
          local_70 = &DAT_007f4db8;
          do {
            local_78 = iVar10;
            local_68 = local_64;
            if ((((local_64 < 0) || (local_38 <= local_64)) || (iVar10 < 0)) || (local_38 <= iVar10)
               ) break;
            if (((-1 < local_64 + local_8c) && (local_64 + local_8c < local_38)) &&
               ((-1 < local_7c + iVar10 &&
                ((local_7c + iVar10 < local_38 &&
              ...
              do {
                ...
                if ((iVar10 != 0) &&
                  ...
                  local_60 = *(int *)((int)pvVar12 + 0xc) - local_c8;
                  local_5c = *(int *)((int)pvVar12 + 0x10) +
                             *(int *)(PTR_DAT_007a5250 +
                                     (((int)*(short *)(iVar10 + 8) - (uint)*(byte *)(iVar10 + 0x48))
                  ...
                  iVar10 = FUN_006b0460(&local_a0,(int *)((int)pvVar6 + 0xc),&local_60);
                  if (iVar10 != 0) {
                    iVar10 = *(int *)((int)pvVar6 + 0x10);
                    iVar7 = *(int *)((int)pvVar6 + 0x14);
                    local_20 = (undefined4 *)local_30->field_000C;
                    iVar14 = *(int *)((int)pvVar6 + 0xc);
                    local_4c = (((local_9c - local_5c) * local_58 + *(int *)((int)pvVar12 + 4)) -
                               local_60) + local_a0;
                    if (local_3c != 0) {
                      uVar8 = *(int *)((int)pvVar6 + 0x18) * iVar7;
                      puVar13 = *(undefined4 **)((int)pvVar6 + 4);
                      puVar15 = local_20;
                      for (uVar9 = uVar8 >> 2; uVar9 != 0; uVar9 = uVar9 - 1) {
                        *puVar15 = *puVar13;
            ...
            local_64 = iVar7;
            iVar10 = local_a8 + local_68;
            /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
            local_b4 = (double)CONCAT44(iVar10,(undefined4)local_b4);
            if ((((-1 < iVar10) && (iVar10 < local_38)) && (-1 < local_6c + local_78)) &&
                ...
                do {
                  ...
                  if ((iVar10 != 0) &&
                    ...
                    local_5c = *(int *)((int)pvVar12 + 0x10) +
                               *(int *)(PTR_DAT_007a5250 +
                                       (((int)*(short *)(iVar10 + 8) -
                                        (uint)*(byte *)(iVar10 + 0x48)) - local_24) * 4) + *local_70
                    ;
                    local_58 = *(int *)((int)pvVar12 + 0x14);
                    local_54 = *(undefined4 *)((int)pvVar12 + 0x18);
                    local_18 = pvVar12;
                ...
                do {
                  ...
                  if ((iVar10 != 0) &&
                    ...
                    local_5c = *(int *)((int)pvVar12 + 0x10) +
                               *(int *)(PTR_DAT_007a5250 +
                                       (((int)*(short *)(iVar10 + 8) -
                                        (uint)*(byte *)(iVar10 + 0x48)) - local_24) * 4) +
                               local_70[1];
                    local_58 = *(int *)((int)pvVar12 + 0x14);
                    local_54 = *(undefined4 *)((int)pvVar12 + 0x18);
                    local_18 = pvVar12;
...
LAB_00429d7d:
            ...
            if (0 < (int)local_10->field_0024) {
              ...
              do {
                if ((*(byte *)(local_10->field_0028 + iVar7) & local_9) != 0) {
                  *(byte *)(local_10->field_003C + iVar10) =
                       *(byte *)(local_10->field_003C + iVar10) | (byte)local_2c;
                }
                iVar10 = iVar10 + 1;
                iVar7 = iVar7 + 0x1c;
              } while (iVar10 < (int)local_10->field_0024);
            }
          }
          else {
            thunk_FUN_00428dc0((uint *)local_30->field_000C,*(int *)((int)pvVar6 + 0x14),
                               *(int *)((int)pvVar6 + 0x18),local_10->field_003C,
    ...
    while (uVar9 = array->iteratorIndex, uVar9 < array->count) {
      /* ST_PSEUDO[dynamic_array_indexing]: expected DArrayAt<T>(array, uVar9) (runtime stride) */
      pvVar6 = (void *)(array->elementSize * uVar9 + (int)array->data);
      array->iteratorIndex = uVar9 + 1;
      if (pvVar6 == nullptr) break;
      FUN_006a5e90(*(short **)((int)pvVar6 + 4));
    }
    DArrayDestroy(array);
    local_9 = local_9 << 1;
