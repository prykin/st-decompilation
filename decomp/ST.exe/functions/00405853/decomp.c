...
void __fastcall thunk_FUN_005f5440(int param_1)
  ...
  if (*(int *)(param_1 + 0x169) != 0) {
    ...
    if (0 < iVar1) {
      do {
        ...
        if (((uStack_c < *(uint *)(iVar5 + 0xc)) &&
            (pcVar6 = (char *)(*(int *)(iVar5 + 8) * uStack_c + *(int *)(iVar5 + 0x1c)),
          ...
          if (DAT_00802a88 != (void *)0x0) {
            ...
            if ((((DAT_0080874d == -1) || (*(int *)((int)DAT_00802a88 + 0xf8) == 0)) ||
                ((thunk_FUN_00558c00(DAT_00802a88,*(undefined4 *)((int)DAT_00802a88 + 0x10c),iVar4,
                                     iVar5,&iStack_10,&iStack_14), iStack_8 < 0 ||
                 ((4 < iStack_8 || (iStack_10 < 0)))))) ||
               ((*(int *)((int)pvVar3 + 0x30) <= iStack_10 ||
                ((((iVar5 = (&DAT_0079aed0)[iStack_8] + iStack_14, iVar5 < 0 ||
