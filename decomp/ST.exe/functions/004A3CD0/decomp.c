...

{
  ...
  if (iVar4 == 0) {
        ...
        if ((short)local_8 != -1) {
          piVar5 = (int *)STAllPlayersC::GetObjPtr
                                    (g_sTAllPlayers_007FA174,
                                     CONCAT31((int3)((uint)extraout_EDX >> 8),pSVar3->field_0024),
                                     local_8,CASE_1);
          if (piVar5 == (int *)0x0) {
            iVar4 = ReportDebugMessage(s_E____titans_wlad_to_grpb_cpp_007abe3c,0x1191,0,0,
          ...
          pDVar8 = local_c;
          if (((iVar4 != 9) &&
              (iVar4 = (**(code **)(*piVar5 + 0x2c))(), pDVar8 = local_c, iVar4 != 0x15)) &&
             (iVar4 = thunk_FUN_00486b40((int)piVar5), pDVar8 = local_c, iVar4 != 0)) {
            pDVar8 = local_20;
          }
    ...
    if (local_20->count == 0) {
      ...
      if ((dVar1 != 0) && (uVar12 = 0, 0 < (int)dVar1)) {
        do {
          uVar6 = FUN_006acc70((AnonShape_006ACC70_C8641025 *)local_c,uVar12,&local_8);
          pSVar7 = (STBoatC *)
                   STAllPlayersC::GetObjPtr
                             (g_sTAllPlayers_007FA174,
                              CONCAT31((int3)(uVar6 >> 8),pSVar3->field_0024),local_8,CASE_1);
    ...
    pDVar8 = (DArrayTy *)
             STAllPlayersC::_AssignDocks
                       (g_sTAllPlayers_007FA174,
                        CONCAT31((int3)((uint)pDVar8 >> 8),pSVar3->field_0024),param_2,local_20);
    local_28 = pDVar8;
    ...
    if (0 < (int)local_30) {
      do {
        FUN_006acc70((AnonShape_006ACC70_C8641025 *)pDVar8,uVar12,(undefined4 *)&local_38);
        uVar6 = CONCAT22(uStack_34,sStack_36);
        if (sStack_36 == -1) {
          pSVar7 = (STBoatC *)
                   STAllPlayersC::GetObjPtr
                             (g_sTAllPlayers_007FA174,
                              CONCAT31((int3)((uint)extraout_ECX >> 8),pSVar3->field_0024),
          ...
          pSVar9 = (STFishC *)
                   STAllPlayersC::GetObjPtr
                             (g_sTAllPlayers_007FA174,
                              CONCAT31((int3)(uVar6 >> 8),pSVar3->field_0024),uVar6,CASE_1);
                   ...
                   STAllPlayersC::GetObjPtr
                             (g_sTAllPlayers_007FA174,
                              CONCAT31((int3)(CONCAT22(extraout_var,local_18[0]) >> 8),
                                       pSVar3->field_0024),CONCAT22(sStack_36,local_38),CASE_1);
          ...
          pSVar9 = (STFishC *)
                   STAllPlayersC::GetObjPtr
                             (g_sTAllPlayers_007FA174,
                              CONCAT31((int3)((uint)extraout_EDX_02 >> 8),pSVar3->field_0024),uVar6,
                              CASE_1);
          uVar10 = STFishC::sub_004162B0(pSVar9,local_1c,local_18,local_14);
          this_00 = (void *)STAllPlayersC::GetObjPtr
                                      (g_sTAllPlayers_007FA174,
                                       CONCAT31((int3)((uint)uVar10 >> 8),pSVar3->field_0024),
    ...
    if ((dVar1 != 0) && (uVar12 = 0, pDVar8 = local_28, 0 < (int)dVar1)) {
      do {
        ...
        pSVar7 = (STBoatC *)
                 STAllPlayersC::GetObjPtr
                           (g_sTAllPlayers_007FA174,
                            CONCAT31((int3)((uint)extraout_EDX_03 >> 8),pSVar3->field_0024),local_8,
                            CASE_1);
        STBoatC::CmdToObj(pSVar7,CASE_3,&local_10);
        uVar12 = uVar12 + 1;
        pDVar8 = local_28;
  ...
  if (iVar4 == -0x5001fff7) {
    ...
    iVar11 = ReportDebugMessage(s_E____titans_wlad_to_grpb_cpp_007abe3c,0x11d8,0,iVar4,&DAT_007a4ccc
    ...
    RaiseInternalException(iVar4,0,s_E____titans_wlad_to_grpb_cpp_007abe3c,0x11d9);
  }
  return;
}
