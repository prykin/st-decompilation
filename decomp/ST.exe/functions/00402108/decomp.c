    ...
    if (iVar4 == 0) {
      ...
      if (param_3 == 1) {
          ...
          if (piVar7 != (int *)0x0) {
            ...
            do {
              ...
              *(undefined1 *)(iVar4 + 0x29 + *(int *)(pFVar12 + 0x1a97)) = *puVar1;
              iVar9 = iVar4 + 2;
              iVar4 = iVar4 + 4;
              puVar1[*(int *)(pFVar12 + 0x1a97) + (0xa8 - (int)(auStack_860 + 1))] =
        ...
        *(undefined4 *)(pFVar12 + 0x1aa3) = 0;
        ...
        iVar4 = Library::MSVCRT::__setjmp3(IStack_e0.jumpBuffer,0,unaff_EDI,unaff_ESI);
        pFVar12 = pFStack_c;
        if (iVar4 == 0) {
          puVar5 = (undefined4 *)Library::DKW::LIB::FUN_006aac70(param_4);
          pFVar12 = pFStack_c;
          *(undefined4 **)(pFStack_c + 0x1a9b) = puVar5;
          if (puVar5 != (undefined4 *)0x0) {
            ...
            puVar5 = Library::DKW::GPC::FUN_006c7dc0(*(undefined4 *)(pFStack_c + 0x1a9b));
            ...
            if (puVar5 != (undefined4 *)0x0) {
              ...
              do {
                ...
                *(undefined1 *)(iVar4 + 0x29 + *(int *)(pFVar12 + 0x1a97)) = *puVar1;
                iVar9 = iVar4 + 2;
                iVar4 = iVar4 + 4;
                puVar1[*(int *)(pFVar12 + 0x1a97) + (0xa8 - (int)(auStack_460 + 1))] =
