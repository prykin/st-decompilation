...

{
  ...
  pCStack_124 = this;
  iVar7 = __setjmp3(auStack_2c4,0,unaff_EDI,unaff_ESI);
  pCVar6 = pCStack_124;
  if (iVar7 != 0) {
  ...
  if (DAT_00807598 != (void *)0x0) {
    uStack_148 = *(undefined4 *)(pCStack_124 + 0xef);
    uStack_144 = *(undefined4 *)(pCStack_124 + 0xf3);
    iStack_140 = iVar7;
    FUN_006e25d0(DAT_00807598,&iStack_218);
    *(int *)(pCVar6 + 0xdf) = iStack_218 >> 0x10;
    *(int *)(pCVar6 + 0xe7) =
         (*(int *)(pCVar6 + 0xc5) - *(int *)(pCVar6 + 0x4b2)) - (iStack_218 >> 0x10);
    *(int *)(pCVar6 + 0xe3) = iStack_214 >> 0x10;
    *(int *)(pCVar6 + 0xeb) =
         (*(int *)(pCVar6 + 0xc9) - *(int *)(pCVar6 + 0x4b6)) - (iStack_214 >> 0x10);
  }
  if (DAT_00802a38 == 0) {
    DAT_00858df8 = (undefined4 *)uStack_2c8;
    return;
  ...
  case 1:
    ...
    case 0x2b:
      if (param_1 != 0) {
        ...
        if (DAT_007fa174 != (STAllPlayersC *)0x0) {
          puStack_4c = STAllPlayersC::GetScrObjList
                                 (DAT_007fa174,(*(int *)(pCVar6 + 0x4a2) == 10) + 1,
                                  *(int *)(pCVar6 + 0xdf),*(int *)(pCVar6 + 0xe3),
                                  *(int *)(pCVar6 + 0xe7),*(int *)(pCVar6 + 0xeb),(int *)&uStack_9c)
          ;
        }
        if (puStack_4c != (ushort *)0x0) {
          ...
          if (pcStack_94 != (char *)0x0) {
            *pcStack_94 = (*(int *)(pCVar6 + 0x4a2) == 10) + '\x01';
            puVar10 = puStack_4c;
            pcVar11 = pcStack_94 + 1;
            for (uVar9 = uStack_9c >> 2; uVar9 != 0; uVar9 = uVar9 - 1) {
    ...
    case 5:
      if (param_1 != 0) {
        ...
        if (DAT_007fa174 != (STAllPlayersC *)0x0) {
          puStack_1c = STAllPlayersC::GetScrObjList
                                 (DAT_007fa174,3,*(int *)(pCVar6 + 0xdf),*(int *)(pCVar6 + 0xe3),
                                  *(int *)(pCVar6 + 0xe7),*(int *)(pCVar6 + 0xeb),(int *)&uStack_a8)
          ;
        }
        if (puStack_1c != (ushort *)0x0) {
          ...
          if (puStack_18 != (undefined4 *)0x0) {
            *(undefined1 *)puStack_18 = 3;
            puVar10 = puStack_1c;
            puVar14 = (undefined4 *)((int)puStack_18 + 1);
            for (uVar9 = uStack_a8 >> 2; uVar9 != 0; uVar9 = uVar9 - 1) {
      ...
      puVar14 = (undefined4 *)auStack_1e4;
      ...
      *(undefined1 *)puVar14 = 0;
      ...
      auStack_1e4[0] = 1;
      uStack_1c7 = *(undefined4 *)(*(int *)(pCVar6 + 0x49a) + 0x18);
      puVar15 = (uint *)auStack_1e4;
      puVar14 = (undefined4 *)0x17;
      goto LAB_0054a19a;
    case 0xe:
      if (DAT_007fb2ac != 0) {
        uStack_b8 = *(undefined4 *)(pCVar6 + 0x4aa);
        uStack_b4 = 0;
        uStack_b0 = 0;
        uStack_ac = 0;
        if (*(int *)(DAT_007fb2ac + 0x24) != 0) {
          ...
          if (*(int *)(DAT_007fb2ac + 0x24) != 0) {
            ...
            iVar7 = FUN_006e1dd0(DAT_00807598,*(int *)(pCVar6 + 0xc5) - *(int *)(pCVar6 + 0x4b2),
                                 *(int *)(pCVar6 + 0xc9) - *(int *)(pCVar6 + 0x4b6),&fStack_10,
    ...
    case 0x2c:
        ...
        if (puStack_54 != (undefined4 *)0x0) {
          ...
          if (puStack_24 != (undefined4 *)0x0) {
            *(undefined1 *)puStack_24 = 4;
            puVar14 = puStack_54;
            puVar12 = (undefined4 *)((int)puStack_24 + 1);
            for (uVar9 = uStack_a4 >> 2; uVar9 != 0; uVar9 = uVar9 - 1) {
              *puVar12 = *puVar14;
              puVar14 = puVar14 + 1;
              puVar12 = puVar12 + 1;
            }
      ...
      break;
    case 0x4e:
      uStack_f4 = (uint)(byte)pCVar6[0x4aa];
      uStack_f0 = 0;
      uStack_ec = 0;
      uStack_e8 = 0;
      uStack_e4 = 0;
      ...
      puVar15 = &uStack_f4;
      uStack_e8._1_3_ = (undefined3)*(undefined4 *)(pCVar6 + 0xf7);
      uStack_e8 = CONCAT31(uStack_e8._1_3_,(char)((ulonglong)lVar13 >> 0x18));
      uStack_e4 = (undefined1)((uint)*(undefined4 *)(pCVar6 + 0xf7) >> 0x18);
      goto LAB_0054a196;
    }
    break;
  case 2:
  ...
  case 0xc:
      ...
      if (puStack_3c != (ushort *)0x0) {
        ...
        if (puStack_20 != (ushort *)0x0) {
          *(char *)puStack_20 = (*(short *)(pCVar6 + 0x494) == 0xc) + '\x01';
          puVar10 = puStack_3c;
          puVar14 = (undefined4 *)((int)puStack_20 + 1);
          for (uVar9 = uStack_98 >> 2; uVar9 != 0; uVar9 = uVar9 - 1) {
            *puVar14 = *(undefined4 *)puVar10;
            puVar10 = puVar10 + 2;
            puVar14 = puVar14 + 1;
          }
    ...
    puVar14 = (undefined4 *)auStack_120;
    ...
    if (*(void **)(pCVar6 + 0x49a) == (void *)0x0) {
      ...
      puVar15 = (uint *)auStack_120;
      auStack_120[0] = 3;
      puVar14 = (undefined4 *)0x16;
    }
    else {
      thunk_FUN_004162b0(*(void **)(pCVar6 + 0x49a),(undefined2 *)auStack_5e,
                         (undefined2 *)auStack_30,(undefined2 *)abStack_32);
      uStack_11b = auStack_5e[0];
      uStack_11a = auStack_30[0];
      bStack_119 = abStack_32[0];
      auStack_120[0] = (*(short *)(pCVar6 + 0x494) != 0xc) - 1U & 5;
      auStack_120._1_4_ = *(undefined4 *)(*(int *)(pCVar6 + 0x49a) + 0x18);
      puVar15 = (uint *)auStack_120;
      puVar14 = (undefined4 *)0x16;
    }
    goto LAB_0054a19a;
  ...
  case 0xb:
    pvVar3 = *(void **)(pCVar6 + 0x49a);
    if (pvVar3 == (void *)0x0) break;
    puVar14 = (undefined4 *)auStack_160;
    for (iVar7 = 6; iVar7 != 0; iVar7 = iVar7 + -1) {
      *puVar14 = 0;
      puVar14 = puVar14 + 1;
    }
    ...
    auStack_160[0] = 1;
    auStack_160._1_4_ = *(undefined4 *)(*(int *)(pCVar6 + 0x49a) + 0x18);
  ...
  case 0xe:
    if (param_1 != 0) {
      if (sVar1 == 0xd) {
        ...
        if (DAT_007fa174 != (STAllPlayersC *)0x0) {
          puStack_44 = STAllPlayersC::GetScrObjList
                                 (DAT_007fa174,3,*(int *)(pCVar6 + 0xdf),*(int *)(pCVar6 + 0xe3),
                                  *(int *)(pCVar6 + 0xe7),*(int *)(pCVar6 + 0xeb),(int *)&uStack_a0)
          ;
        }
        if (puStack_44 != (ushort *)0x0) {
          ...
          if (puStack_14 != (ushort *)0x0) {
            *(undefined1 *)puStack_14 = 3;
            puVar10 = puStack_44;
            puVar14 = (undefined4 *)((int)puStack_14 + 1);
            for (uVar9 = uStack_a0 >> 2; uVar9 != 0; uVar9 = uVar9 - 1) {
              *puVar14 = *(undefined4 *)puVar10;
              puVar10 = puVar10 + 2;
              puVar14 = puVar14 + 1;
            }
    ...
    pvVar3 = *(void **)(pCVar6 + 0x49a);
    if (pvVar3 == (void *)0x0) break;
    puVar14 = (undefined4 *)auStack_1c0;
    for (iVar7 = 8; iVar7 != 0; iVar7 = iVar7 + -1) {
      *puVar14 = 0;
      puVar14 = puVar14 + 1;
    }
    *(undefined1 *)puVar14 = 0;
    ...
    auStack_1c0[0] = 1;
    uStack_1a3 = *(undefined4 *)(*(int *)(pCVar6 + 0x49a) + 0x18);
    puVar15 = (uint *)auStack_1c0;
    puVar14 = (undefined4 *)0x17;
    goto LAB_0054a19a;
  case 0xf:
  case 0x10:
  ...
  case 0x13:
    ...
    thunk_FUN_004162b0(*(void **)(pCVar6 + 0x49a),&uStack_cf,&uStack_cd,&uStack_cb);
    puVar15 = (uint *)&cStack_d0;
    puVar14 = (undefined4 *)0x1f;
    goto LAB_0054a19a;
  case 0x14:
    if (DAT_007fb2ac != 0) {
      uStack_c8 = *(undefined4 *)(pCVar6 + 0x4aa);
      uStack_c4 = 0;
      uStack_c0 = 0;
      uStack_bc = 0;
      if (*(int *)(DAT_007fb2ac + 0x24) != 0) {
  ...
  case 0x18:
    pvVar3 = *(void **)(pCVar6 + 0x49a);
    if (pvVar3 == (void *)0x0) break;
    puVar14 = (undefined4 *)auStack_260;
    for (iVar7 = 8; iVar7 != 0; iVar7 = iVar7 + -1) {
      *puVar14 = 0;
      puVar14 = puVar14 + 1;
    }
    *(undefined1 *)puVar14 = 0;
    ...
    auStack_260[0] = ((*(short *)(pCVar6 + 0x494) != 0x18) - 1U & 0xeb) + 0x18;
    puVar15 = (uint *)auStack_260;
    puVar14 = (undefined4 *)0x17;
    goto LAB_0054a19a;
  case 0x17:
    if (*(int *)(pCVar6 + 0x49a) == 0) break;
    uVar4 = *(undefined4 *)(*(int *)(pCVar6 + 0x49a) + 0x18);
    puVar15 = (uint *)&uStack_78;
  ...
  case 0x1b:
    pvVar3 = *(void **)(pCVar6 + 0x49a);
    if (pvVar3 == (void *)0x0) break;
    puVar14 = (undefined4 *)auStack_23c;
    for (iVar7 = 8; iVar7 != 0; iVar7 = iVar7 + -1) {
      *puVar14 = 0;
      puVar14 = puVar14 + 1;
    }
    *(undefined1 *)puVar14 = 0;
    ...
    puVar15 = (uint *)auStack_23c;
    auStack_23c[0] = 0x13;
    puVar14 = (undefined4 *)0x17;
    goto LAB_0054a19a;
  case 0x1c:
    uStack_108 = (uint)(byte)pCVar6[0x4aa];
    uStack_104 = 0;
    uStack_100 = 0;
    uStack_fc = 0;
    uStack_f8 = 0;
    ...
    puVar15 = &uStack_108;
    uStack_fc._1_3_ = (undefined3)*(undefined4 *)(pCVar6 + 0xf7);
    uStack_fc = CONCAT31(uStack_fc._1_3_,(char)((ulonglong)lVar13 >> 0x18));
    uStack_f8 = (undefined1)((uint)*(undefined4 *)(pCVar6 + 0xf7) >> 0x18);
LAB_0054a196:
  ...
  case 0x1d:
    ...
    uStack_e0 = 2;
    cStack_d4 = 0;
    thunk_FUN_004162b0(*(void **)(pCVar6 + 0x49a),&sStack_64,&sStack_4e,&sStack_7a);
...
LAB_00549b36:
  ...
  case 0x1e:
    ...
    uStack_27 = 0;
    uStack_26 = 0;
    thunk_FUN_004162b0(*(void **)(pCVar6 + 0x49a),&uStack_5c,&uStack_5a,&uStack_34);
    uStack_2b = uStack_5c;
    puVar15 = (uint *)&uStack_2c;
...
LAB_0054a19a:
  ...
  case 0x1f:
    ...
    *(undefined1 *)puVar14 = 0;
    ...
    uStack_267 = *(undefined4 *)(iVar7 + 0x18);
