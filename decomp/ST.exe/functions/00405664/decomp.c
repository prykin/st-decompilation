...
void __fastcall thunk_FUN_0053c620(void *param_1)

{
  ...
  if (*(int *)((int)param_1 + (uint)*(byte *)((int)param_1 + 0x278) * 4 + 0x27a) != 0) {
    puStack_8 = (undefined4 *)((int)param_1 + 0x1b6);
    ...
    do {
      *(undefined4 *)((int)param_1 + 0x28) = 0x21;
      ...
      uVar1 = (uint)((uint)(iStack_c + *(int *)((int)param_1 + 0x199)) <
...
LAB_0053c75b:
      ...
      if ((*(int *)((int)param_1 + 0x2c) != 0) &&
         ...
         iVar4 != 0)) {
        uVar3 = *(int *)((int)param_1 + 0x199) + iStack_c;
        uVar1 = *(uint *)(iVar4 + 0xc);
        if ((uVar3 < uVar1) &&
           (puVar5 = (undefined4 *)(*(int *)(iVar4 + 8) * uVar3 + *(int *)(iVar4 + 0x1c)),
           puVar5 != (undefined4 *)0x0)) {
          *(char *)((int)puStack_8 + -1) = (*(char *)(puVar5 + 2) == '\0') + '\x03';
          ...
          *puStack_8 = uVar2;
          ...
          if (*(char *)(puVar5 + 2) == '\0') {
            ...
            *(undefined2 *)puVar7 = *(undefined2 *)puVar5;
            ...
            puStack_8[2] = *(undefined4 *)((int)puVar5 + 10);
            puStack_8[3] = *(undefined4 *)((int)puVar5 + 0xe);
          }
        }
      }
      iStack_c = iStack_c + 1;
      puVar6 = puVar6 + 1;
      puStack_8 = (undefined4 *)((int)puStack_8 + 0x27);
