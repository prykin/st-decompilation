  ...
  if (iVar5 == 0x35) {
    do {
      if (puVar7[(int)(&PTR_DAT_007bfc04)[*(int *)((int)this + 0x239)]] == '\0') {
        iVar5 = thunk_FUN_004e60d0(*(int *)((int)this + 0x24),(int)puVar7);
        iVar5 = thunk_FUN_004e7f20(*(int *)((int)this + 0x24),(int)puVar7,iVar5 + 1);
      }
      else {
        iVar5 = thunk_FUN_004e5910(*(int *)((int)this + 0x24),(uint)puVar7);
      }
      if (iVar5 != 0) {
        ...
        if ((iVar5 < CONCAT31(extraout_var_01,uVar1)) &&
           (((*(int *)((int)this + 0x361) != 2 || (*(undefined1 **)((int)this + 0x369) != puVar7))
            && (iVar5 = thunk_FUN_004e5f90(*(int *)((int)this + 0x24),(uint)puVar7), iVar5 == 0))))
        {
...
LAB_004e3526:
          ...
          local_3f = LookupRecordByte(*(char *)((int)this + 0x24));
          puVar11 = local_36;
          iVar5 = thunk_FUN_004e60d0(*(int *)((int)this + 0x24),(int)puVar7);
          thunk_FUN_004e68a0(*(byte **)((int)this + 0x24),puVar7,iVar5 + 1,puVar11);
          if (puVar7[(int)(&PTR_DAT_007bfc04)[*(int *)((int)this + 0x239)]] == '\0') {
    ...
    do {
      ...
      iVar5 = thunk_FUN_004e5910(*(int *)((int)this + 0x24),*puVar8);
      if (iVar5 != 0) {
        uVar1 = thunk_FUN_004e6140(*(int *)((int)this + 0x24),*puVar8);
        iVar5 = thunk_FUN_004e60d0(*(int *)((int)this + 0x24),*puVar8);
        /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
        if (((iVar5 < CONCAT31(extraout_var,uVar1)) &&
            ((*(int *)((int)this + 0x361) != 2 || (*(uint *)((int)this + 0x369) != *puVar8)))) &&
           (iVar5 = thunk_FUN_004e5f90(*(int *)((int)this + 0x24),*puVar8), iVar5 == 0)) {
...
LAB_004e336e:
            ...
            bVar2 = thunk_FUN_004e5c40(*(byte **)((int)this + 0x24),*puVar8);
            local_40 = '\x01';
            /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
          ...
          puVar11 = local_36;
          iVar5 = thunk_FUN_004e60d0(*(int *)((int)this + 0x24),*puVar8);
          thunk_FUN_004e68a0(*(byte **)((int)this + 0x24),(undefined1 *)*puVar8,iVar5 + 1,puVar11);
