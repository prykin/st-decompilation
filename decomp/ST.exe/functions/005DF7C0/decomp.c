...
void FUN_005df7c0(int *param_1,int param_2,undefined4 param_3,int param_4,int param_5,
...
LAB_005df7f3:
    ...
    DAT_00858df8 = (undefined4 *)local_4c;
    iVar4 = FUN_006ad4d0(s_E____titans_Start_task_obj_cpp_007cd994,0x4d,0,iVar3,&DAT_007a4ccc);
    if (iVar4 != 0) {
      pcVar2 = (code *)swi(3);
      (*pcVar2)();
      return;
    }
    FUN_006a5e40(iVar3,0,0x7cd994,0x4d);
  }
  return;
}
