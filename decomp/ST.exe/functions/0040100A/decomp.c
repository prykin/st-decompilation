...

{
  ...
  if (puStack_60 != (uint *)0x0) {
    ...
    if (iVar3 == 0) {
      ...
      puStack_48 = FUN_006ae290((uint *)0x0,1,4,1);
      ...
      if (puStack_1c != (uint *)0x0) {
        ...
        if (0 < (int)puVar4) {
          do {
            ...
            if (iStack_4e != 1) {
              iStack_4e = 1;
              FUN_006ae140(puVar8,uStack_8,(undefined4 *)&uStack_54);
              puStack_c = FUN_006ae290((uint *)0x0,1,4,1);
              FUN_006ae1c0(puStack_c,&uStack_8);
              uStack_58 = FUN_006ae1c0(puStack_48,&puStack_c);
...
LAB_0044738a:
      ...
      *(uint **)((int)&DAT_007f5822 + iVar3) = puVar4;
              ...
              if (7 < (int)uStack_2c) {
                ...
                if ((int)uVar7 < (int)(uVar7 + uStack_2c)) {
                  do {
                    ...
                    FUN_006ae1c0(puStack_c,&uStack_34);
                    uVar10 = uVar10 + 1;
      ...
      uVar7 = uStack_3c;
      puVar4 = FUN_006ae290((uint *)0x0,uStack_3c,4,1);
      *(uint **)((int)&DAT_007f5826 + iStack_5c) = puVar4;
      uStack_8 = 0;
      puStack_40 = puVar4;
      if (0 < (int)uVar7) {
        do {
          puStack_c = FUN_006ae290((uint *)0x0,0,0x18,1);
          FUN_006ae1c0(puVar4,&puStack_c);
          uStack_8 = uStack_8 + 1;
        } while ((int)uStack_8 < (int)uVar7);
      }
          ...
          if (puStack_c[3] != 0) {
            ...
            if (piStack_28 != (int *)0x0) {
              ...
              if (puVar4 != (uint *)0x0) {
                ...
                puVar8 = puStack_14;
                if (puVar4[3] != 0) {
                  puVar4 = FUN_006ae290((uint *)0x0,(uint)puStack_14,4,1);
                  FUN_006ae140(puVar4,(int)puVar8 - 1,&iStack_44);
                  ...
                  while (puStack_1c = puVar12, puStack_14 = puVar2, puStack_1c != (uint *)0x0) {
                    ...
                    if (0 < (int)puVar2) {
                      do {
                        ...
                        if (iStack_44 != 1) {
                          iStack_44 = 1;
                          FUN_006ae140(puVar4,uVar7,&iStack_44);
                          ...
                          puStack_88 = (uint *)0x0;
                          uStack_58 = FUN_006ae1c0(puStack_c,&uStack_9c);
                      ...
                      do {
                        ...
                        if (iStack_44 != 1) {
                          ...
                          if (((int)(((int)sStack_38 - (int)sStack_e ^ uVar10) - uVar10) < 3) &&
                            ...
                            FUN_006ae140(puStack_c,uStack_58,&uStack_9c);
                    ...
                    if (uVar7 != 0) {
                      ...
                      if (7 < (int)uStack_2c) {
                        ...
                        if (puStack_88 == (uint *)0x0) {
                          puStack_88 = FUN_006ae290((uint *)0x0,1,2,1);
                        }
                        uVar9 = uVar10;
                        if ((int)uVar10 < (int)(uVar10 + uStack_2c)) {
                          do {
                            ...
                            FUN_006ae1c0(puStack_88,&uStack_34);
                            uVar9 = uVar9 + 1;
      ...
      *(undefined4 *)((int)&DAT_007f582a + iStack_5c) = *(undefined4 *)(DAT_00802a38 + 0xe4);
        ...
        if (0 < (int)uVar7) {
          do {
            ...
            if (puStack_70 != (uint *)0x0) {
              ...
              puStack_70 = FUN_006ae290((uint *)0x0,1,4,1);
              FUN_006ae140(puVar4,uStack_8,&iStack_78);
            }
            uStack_8 = uStack_8 + 1;
          } while ((int)uStack_8 < (int)uVar7);
        }
      ...
      DAT_00858df8 = (undefined4 *)uStack_e4;
      return;
    }
    DAT_00858df8 = (undefined4 *)uStack_e4;
    if (iVar3 != -0x5001fff7) {
      iVar6 = FUN_006ad4d0(s_E____titans_wlad_to_allpl_cpp_007a6004,0x2b90,0,0,&DAT_007a4ccc);
      if (iVar6 != 0) {
        pcVar1 = (code *)swi(3);
        (*pcVar1)();
        return;
      }
      FUN_006a5e40(iVar3,0,0x7a6004,0x2b91);
    }
  }
  return;
LAB_00447106:
...
LAB_00447196:
      uStack_22 = 1;
      FUN_006ae1c0(puStack_70,(undefined4 *)&uStack_24);
    }
    else {
      uVar9 = 0;
      if (0 < (int)uVar7) {
        do {
          ...
          if (uStack_24 == uVar10) {
            ...
            FUN_006ae140(puStack_70,uVar9,(undefined4 *)&uStack_24);
            break;
          }
          uVar9 = uVar9 + 1;
