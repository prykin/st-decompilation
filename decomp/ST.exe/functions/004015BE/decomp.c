...
void __thiscall thunk_FUN_005a3540(void *this,int param_1,int *param_2)

{
  ...
  bool bVar13;
  uint *puVar14;
  undefined4 auStack_2bc [11];
  byte abStack_290 [560];
      ...
      do {
        if (param_1 == 0) {
          ...
          *(undefined4 *)((int)pvVar4 + 0x31) = uVar6;
          ...
          if (puStack_c != (undefined4 *)0x0) {
            uVar8 = 0;
            uStack_8 = *(uint *)(*(int *)((int)pvVar4 + 0x1ebe) + 0xc);
            if (uStack_8 != 0) {
              if (uStack_8 == 0) {
                iVar5 = 0;
                goto LAB_005a37da;
          ...
          if (iVar5 == 0x100) {
            if (*(int *)((int)pvVar4 + 0x1ec6) != -1) {
              if ((char)param_2[0x1f] != '\0') {
                ...
                if (uStack_8 == *(int *)((int)pvVar4 + 0x1ec6)) {
                  puVar14 = *(uint **)((int)pvVar4 + 0x1ebe);
                  goto LAB_005a36e9;
                }
              }
