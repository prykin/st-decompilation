  ...
  if (iVar13 == 0) {
    ...
    case 2:
      ...
      if ((*(uint *)(iVar13 + 0x24) < 8) &&
        ...
        SVar2 = this[0x24];
        pSStack_10 = (STBoatC *)CONCAT31(pSStack_10._1_3_,SVar1);
        iStack_1c = CONCAT31(iStack_1c._1_3_,SVar2);
        if (DAT_00808a8f == '\0') {
          if (SVar1 == SVar2) {
LAB_0046b5ac:
            iVar13 = 0;
    ...
    if (iVar13 == 2) {
      ...
      if (*(int *)(this + 0x50c) == 3) {
        ...
        if (this[0x2bf] != (STBoatC)0x0) {
          ...
          do {
            puVar11 = (undefined4 *)
                      thunk_FUN_0041dc40(auStack_4c,*(undefined4 *)pSStack_10,
                                         *(undefined2 *)(pSStack_10 + 4),*(short *)(this + 0x6c));
            uStack_c = *puVar11;
            sStack_8 = *(short *)(puVar11 + 1);
            if (DAT_0080732c == 1) {
              bVar27 = 0;
              sVar26 = 0;
              ...
              *(uint *)(this + 0x1c) = uVar12;
              sVar22 = 0;
              sVar21 = 0;
              uStack_24 = uVar12 * 0x41c64e6d + 0x3039;
              sVar20 = 0;
              *(uint *)(this + 0x1c) = uStack_24;
              lVar19 = Library::MSVCRT::__ftol();
              iVar13 = (int)(short)lVar19 + (uVar10 >> 0x10) % 7 + (int)*(short *)(this + 0x45) + -3
                       + (int)sStack_8;
              iVar16 = ((uVar12 >> 0x10) % 7 + (int)*(short *)(this + 0x43)) - (int)uStack_c._2_2_;
              uVar10 = uStack_24;
            }
            else {
              ...
              *(uint *)(this + 0x1c) = uVar10;
              iVar13 = (uVar12 >> 0x10) % 7 + (int)*(short *)(this + 0x45) + -3 + (int)sStack_8;
              uStack_c._2_2_ = (short)((uint)uStack_c >> 0x10);
              iVar16 = ((uVar15 >> 0x10) % 7 + (int)*(short *)(this + 0x43)) - (int)uStack_c._2_2_;
            }
            TraksClassTy::TraksCreate
                      (DAT_00802a7c,1,2,7,
                       (uVar10 >> 0x10) % 7 + (int)*(short *)(this + 0x41) + -3 +
                       (int)(short)uStack_c,iVar16 + -3,iVar13,sVar20,sVar21,sVar22,sVar23,sVar24,
                       sVar25,iVar8,sVar26,bVar27);
            iStack_20 = iStack_20 + 1;
            pSStack_10 = pSStack_10 + 6;
          } while (iStack_20 < (int)(uint)(byte)this[0x2bf]);
        }
        if (iStack_1c == -1) {
...
LAB_0046b6e2:
    ...
    if (iVar13 == 5) {
      ...
      *(undefined1 *)((int)puVar11 + 2) = 0;
      uStack_d4 = *(undefined4 *)(this + 0x24);
      uStack_b0 = *(undefined4 *)(this + 0x4e3);
      iStack_a8 = (int)*(short *)(this + 0x4df);
      iStack_a4 = (int)*(short *)(this + 0x4e1);
      uStack_9c = *(undefined4 *)(this + 0x4e7);
      iStack_6d = (int)*(short *)(this + 0x6c);
      uStack_a0 = (uint)*(ushort *)(this + 0x4fa);
      uStack_85 = 100;
      uStack_81 = 100;
      uStack_89 = *(undefined4 *)(this + 0x18);
      uStack_cc = 1;
      uStack_d0 = 1;
      uStack_d8 = 0x3e9;
      uStack_b8 = 1;
      ...
      uStack_c0 = uStack_d4;
      uStack_b4 = uVar7;
      iStack_ac = (int)sVar20;
      Library::MSVCRT::_strncpy(acStack_98,(char *)(this + 0x4eb),0xe);
      uStack_8a = 0;
      if (*(int *)(this + 0x502) == 0) {
        iVar13 = thunk_FUN_004ae0b0((int)*(short *)(this + 0x4dd),(int)*(short *)(this + 0x4df),
                                    (int)*(short *)(this + 0x4e1),*(int *)(this + 0x4e3),
        ...
        uVar7 = extraout_EDX;
        if ((iVar13 != 0) &&
           (STPlaySystemC::CreateGameObject(*(STPlaySystemC **)(this + 0xc),0x3e9,0,0,&uStack_d8,0),
