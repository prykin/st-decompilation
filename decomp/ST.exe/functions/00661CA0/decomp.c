      ...
      if ((0x31 < (int)local_c) && ((int)local_c < 0x74)) {
        ...
        if (0 < (int)local_24) {
          ...
          do {
            ...
            if (puVar4[10] == 0) {
              ...
              do {
                if (*puVar10 == local_c) {
                  ...
                  *(short *)((int)puVar4 + 0xe) = local_18[0];
                  *(short *)(puVar4 + 4) = local_1c[0];
                  *(undefined2 *)((int)puVar4 + 0x12) = local_6;
                  puVar4[9] = 0;
                  goto LAB_00661e5f;
                }
                iVar7 = iVar7 + 1;
            ...
            uVar3 = uVar3 + 1;
            bVar11 = uVar3 < local_24;
          } while ((int)uVar3 < (int)local_24);
        }
      }
        ...
        if (*(int *)((int)local_10 + 0x81e) != 0) {
          ...
          if (0 < (int)uVar3) {
            ...
            do {
              ...
              if ((*(int *)(iVar5 + 0x28) == 0) &&
                 (*(int *)(iVar5 + 0x24) == *(int *)((int)local_10 + 0x81e))) {
...
LAB_00661e5f:
      if (((0x31 < (int)local_c) && ((int)local_c < 0x74)) && (*(int *)(param_1 + 0x284) != 0)) {
        ...
        local_64[0] = 0x6c;
        local_5c = 0;
        iVar7 = (**(code **)(*local_10 + 0x2c))();
        iVar7 = thunk_FUN_006753a0(iVar7);
        local_5b = (undefined1)iVar7;
        psStack_5a = &local_30;
        thunk_FUN_0068fd00(local_64);
      }
      if (((0 < (int)local_c) && ((int)local_c < 0x29)) && (*(short *)(param_1 + 0x7b) == -0x8000))
      {
        ...
        if (*(void **)(param_1 + 0x284) != (void *)0x0) {
          pvVar6 = (void *)thunk_FUN_0068e290(*(void **)(param_1 + 0x284),(short)local_10[0x207]);
          if (local_20 != 0) {
            uVar3 = *(uint *)(local_20 + 0x65c);
            *(uint *)(local_20 + 0x65c) = uVar3 + 1;
          }
          if (pvVar6 != (void *)0x0) {
            thunk_FUN_006616b0(pvVar6,local_c,uVar3);
          }
          *(uint *)((int)local_10 + 0x81e) = uVar3;
        }
      }
    }
    else {
    ...
    uVar3 = thunk_FUN_00674fb0(local_c);
