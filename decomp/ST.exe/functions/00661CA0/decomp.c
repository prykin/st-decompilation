...
LAB_00661e5f:
      ...
      if (((0 < (int)local_c) && ((int)local_c < 0x29)) && (*(short *)(param_1 + 0x7b) == -0x8000))
      {
        ...
        if (*(void **)(param_1 + 0x284) != (void *)0x0) {
          pvVar8 = (void *)thunk_FUN_0068e290(*(void **)(param_1 + 0x284),
