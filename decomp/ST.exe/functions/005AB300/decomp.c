...

{
  ...
  ushort *puVar10;
  uint *puVar11;
  AnonPointee_ChooseMapTy_1C7B *pAVar12;
  undefined4 *puVar13;
  HoloTy *pHVar14;
  ...
  case CASE_5:
    local_c = 0xffffffff;
    pcVar18 = PTR_s_CUSTOM__0079c050;
    do {
      pcVar20 = pcVar18;
      if (local_c == 0) break;
      local_c = local_c - 1;
  ...
  case CASE_3:
    uVar16 = 0xffffffff;
    pcVar18 = PTR_s_MISSIONS__0079c054;
    do {
      pcVar20 = pcVar18;
      if (uVar16 == 0) break;
      uVar16 = uVar16 - 1;
...
switchD_005ab3e3_caseD_9:
    uVar16 = 0xffffffff;
    pcVar19 = PTR_s_SAVEGAME__0079c04c;
    do {
      pcVar18 = pcVar19;
      if (uVar16 == 0) break;
      uVar16 = uVar16 - 1;
...
LAB_005ab4dc:
    pcVar19 = pcVar19 + -1;
    for (uVar17 = local_c >> 2; uVar16 = local_c, uVar17 != 0; uVar17 = uVar17 - 1) {
      *(undefined4 *)pcVar19 = *(undefined4 *)pcVar20;
      pcVar20 = pcVar20 + 4;
      pcVar19 = pcVar19 + 4;
    }
LAB_005ab4e5:
  ...
  pvVar8 = FindFirstChangeNotificationA(&this_02->field_1DA7,0,1);
  this_02->field_1C8F = pvVar8;
...
switchD_005ab66b_caseD_6:
      ...
      default:
        ...
        puVar11 = Library::DKW::TBL::FUN_006b54f0((uint *)0x0,10,10);
        PTR_0081176c->field_0548 = puVar11;
        uVar16 = param_2 - 1;
        ...
        pAVar12 = (AnonPointee_ChooseMapTy_1C7B *)
                  FUN_006b50c0(0x1e4,399,(uint)*(ushort *)(this_02->field_005D + 0xe),uVar16,puVar13
                               ,iVar7);
        this_02->field_1C7B = pAVar12;
        uVar16 = pAVar12[1].field_0008;
        if (uVar16 == 0) {
          uVar16 = ((uint)*(ushort *)&pAVar12[1].field_0x2 * pAVar12->field_0004 + 0x1f >> 3 &
                   0x1ffffffc) * pAVar12->field_0008;
        }
        puVar13 = (undefined4 *)FUN_006b4fa0((int)pAVar12);
        for (uVar17 = uVar16 >> 2; uVar17 != 0; uVar17 = uVar17 - 1) {
          *puVar13 = 0;
          puVar13 = puVar13 + 1;
        }
        puVar11 = &this_02->field_1C23;
        for (uVar16 = uVar16 & 3; uVar16 != 0; uVar16 = uVar16 - 1) {
        ...
        uVar16 = 0x3f;
        do {
          FUN_006b2330((uint)DAT_008075a8,puVar11,0x31,0x40213a,this_02->field_1C7B->field_0004,0x13
                       ,(uint)this_02);
          Library::DKW::DDX::FUN_006b3640(DAT_008075a8,*puVar11,0xffffffff,0x114,uVar16);
          uVar16 = uVar16 + 0x13;
          puVar11 = puVar11 + 1;
        ...
        this_02->field_20B8 = pHVar14;
        if (pHVar14 != (HoloTy *)0x0) {
          uVar17 = 0;
          cVar22 = '\x01';
          uVar16 = 0x10;
          iVar21 = 1;
          iVar7 = Library::DKW::DDX::FUN_006bf9f0(DAT_008075a8,0x112,0x38,0x204,0x19d);
          uVar16 = HoloTy::Init(this_02->field_20B8,CASE_2,0x112,0x38,iVar7,iVar21,uVar16,cVar22,
                                uVar17);
          if (uVar16 != 0) {
            pHVar14 = this_02->field_20B8;
            pHVar14->field_0002 = 1;
            pHVar14->field_0017 = pHVar14->field_0013;
            uVar16 = this_02->field_20B8->field_0003;
            if (-1 < (int)uVar16) {
        ...
        if (this_02->field_20B4 == '\0') {
          ...
          this_02->field_20BC = pHVar14;
          if (pHVar14 != (HoloTy *)0x0) {
            uVar17 = 0;
            cVar22 = '\x01';
            uVar16 = 0x10;
            iVar21 = 1;
            iVar7 = Library::DKW::DDX::FUN_006bf9f0(DAT_008075a8,10,0xb4,0xf9,0x121);
            uVar16 = HoloTy::Init(this_02->field_20BC,CASE_4,10,0xb4,iVar7,iVar21,uVar16,cVar22,
                                  uVar17);
            if (uVar16 != 0) {
              pHVar14 = this_02->field_20BC;
              pHVar14->field_0002 = 1;
              pHVar14->field_0017 = pHVar14->field_0013;
              uVar16 = this_02->field_20BC->field_0003;
              if (-1 < (int)uVar16) {
                FUN_006b3af0(DAT_008075a8,uVar16);
              }
              if (PTR_0081176c->field_0391 != 0xffffffff) {
        ...
        if (this_02->field_20B7 == '\0') {
          ...
          this_02->field_20C0 = pHVar14;
          if (pHVar14 != (HoloTy *)0x0) {
            uVar17 = 0;
            cVar22 = '\x01';
            uVar16 = 0x10;
            iVar21 = 1;
            iVar7 = Library::DKW::DDX::FUN_006bf9f0(DAT_008075a8,200,0x1f1,400,0x62);
            uVar16 = HoloTy::Init(this_02->field_20C0,CASE_1,200,0x1f1,iVar7,iVar21,uVar16,cVar22,
                                  uVar17);
            if (uVar16 != 0) {
              pHVar14 = this_02->field_20C0;
              pHVar14->field_0002 = 1;
              pHVar14->field_0017 = pHVar14->field_0013;
              uVar16 = this_02->field_20C0->field_0003;
              if (-1 < (int)uVar16) {
                FUN_006b3af0(DAT_008075a8,uVar16);
              }
              if (PTR_0081176c->field_0560 != 0xffffffff) {
        ...
        pAVar15 = (AnonPointee_ChooseMapTy_1C8B *)
                  FUN_006b50c0(0x172,0x18,(uint)*(ushort *)(this_02->field_005D + 0xe),uVar16,
                               puVar13,iVar7);
        this_02->field_1C8B = pAVar15;
        uVar16 = pAVar15[1].field_0008;
        if (uVar16 == 0) {
          uVar16 = ((uint)*(ushort *)&pAVar15[1].field_0x2 * pAVar15->field_0004 + 0x1f >> 3 &
                   0x1ffffffc) * pAVar15->field_0008;
        }
        puVar13 = (undefined4 *)FUN_006b4fa0((int)pAVar15);
        for (uVar17 = uVar16 >> 2; uVar17 != 0; uVar17 = uVar17 - 1) {
          *puVar13 = 0xffffffff;
          puVar13 = puVar13 + 1;
        }
        ...
        pAVar15 = this_02->field_1C8B;
        puVar13 = &this_02->field_1C87;
        FUN_006b2330((uint)DAT_008075a8,puVar13,0x31,0x404acf,pAVar15->field_0004,
                     pAVar15->field_0008,(uint)pAVar15);
        Library::DKW::DDX::FUN_006b3640(DAT_008075a8,*puVar13,0xffffffff,0x112,0x1d3);
        ...
        pHVar14 = this_02->field_20B8;
        if (((pHVar14 != (HoloTy *)0x0) && (pHVar14->field_0000 != '\0')) &&
           (-1 < (int)pHVar14->field_0003)) {
          Library::DKW::DDX::FUN_006b3430(DAT_008075a8,pHVar14->field_0003);
        }
        pHVar14 = this_02->field_20BC;
        if (((pHVar14 != (HoloTy *)0x0) && (pHVar14->field_0000 != '\0')) &&
           (-1 < (int)pHVar14->field_0003)) {
        ...
        if (PTR_00802a30 != (CursorClassTy *)0x0) {
          ...
          CursorClassTy::SetGCType(this_01,CASE_0,uVar4,uVar9);
      ...
      if (pSVar5->field_02E6 != (MMsgTy *)0x0) {
        ...
        *(undefined2 *)puVar13 = 0xffff;
        MMsgTy::SetPanel(pSVar5->field_02E6,0,(int)&local_20c,0,0);
