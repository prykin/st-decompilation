...
void FUN_005ab300(undefined1 param_1,byte param_2)

{
  ...
  local_250 = DAT_00858df8;
  DAT_00858df8 = &local_250;
  iVar4 = __setjmp3(local_24c,0,unaff_EDI,unaff_ESI);
  if (iVar4 != 0) {
    DAT_00858df8 = local_250;
  ...
  *(undefined1 *)((int)local_10 + 0x1a5f) = param_1;
  ...
  uVar11 = 0xffffffff;
  pcVar13 = (char *)((int)local_10 + 0x1ca3);
  ...
  switch(*(undefined1 *)((int)local_10 + 0x1a5f)) {
  case 1:
  case 2:
  case 4:
  case 5:
...
switchD_005ab3e3_caseD_9:
    ...
    FUN_006b8280((char *)((int)local_10 + 0x1ca3),(char *)((int)local_10 + 0x1ca3));
    break;
  case 0x13:
...
LAB_005ab4e5:
  ...
  uVar11 = 0xffffffff;
  pcVar13 = (char *)((int)local_10 + 0x1da7);
  pcVar14 = (char *)((int)local_10 + 0x1ca3);
  do {
    pcVar15 = pcVar14;
    if (uVar11 == 0) break;
    uVar11 = uVar11 - 1;
  ...
  pvVar5 = FindFirstChangeNotificationA((LPCSTR)((int)local_10 + 0x1da7),0,1);
  *(HANDLE *)((int)local_10 + 0x1c8f) = pvVar5;
  if (pvVar5 == (HANDLE)0xffffffff) {
    *(undefined4 *)((int)local_10 + 0x1c8f) = 0;
  }
  FUN_006b8280((char *)((int)local_10 + 0x1ca3),(char *)((int)local_10 + 0x1ca3));
  FUN_006b8280((char *)((int)local_10 + 0x1da7),(char *)((int)local_10 + 0x1da7));
  uVar6 = FUN_0070a9f0(DAT_00806780,s_LOADSINGLE_007cc79c,0,1);
  *(undefined4 *)(DAT_0081176c + 0x2c) = uVar6;
  *(undefined4 *)((int)local_10 + 0x5d) = *(undefined4 *)(DAT_0081176c + 0x2c);
  FUN_006bc360(*(int *)(DAT_0081176c + 0x2c),local_86c,(int *)0x0);
  *(undefined4 *)(*(int *)((int)local_10 + 0x1a5b) + 0x140) = 0x1f;
  FUN_00718780((int)local_86c,0,0x100,0x8b,0x15,
               (undefined4 *)(*(int *)((int)local_10 + 0x1a5b) + 0x144));
  puVar7 = FUN_00709af0(DAT_00806784,0xb,(byte *)s_FILE_LIST_007cc084,0xffffffff,0,1,0,
                        (undefined4 *)0x0);
  *(ushort **)((int)local_10 + 0x1c7f) = puVar7;
  ...
  *(undefined4 *)((int)local_10 + 0x20b3) = 0x1010101;
  *(undefined1 *)((int)local_10 + 0x20b7) = 1;
  switch(*(undefined1 *)((int)local_10 + 0x1a5f)) {
  case 1:
  case 2:
  case 3:
...
switchD_005ab64d_caseD_1:
    *(undefined1 *)((int)local_10 + 0x20b7) = 0;
...
switchD_005ab66b_caseD_6:
      ...
      case 5:
      case 0x14:
        *(undefined1 *)((int)local_10 + 0x20b4) = 0;
      case 6:
      case 7:
        *(undefined1 *)((int)local_10 + 0x20b5) = 0;
      default:
        ...
        *(uint **)(DAT_0081176c + 0x548) = puVar8;
        ...
        if (*(int *)(DAT_0081176c + 0x389) != 0) {
          *(undefined4 *)((int)local_10 + 0x2d) = 0x28;
          *(undefined2 *)((int)local_10 + 0x31) = 1;
          *(undefined2 *)((int)local_10 + 0x33) =
               *(undefined2 *)(*(int *)(DAT_0081176c + 0x548) + 8);
          FUN_006e6080(local_10,2,*(undefined4 *)(DAT_0081176c + 0x389),
                       (undefined4 *)((int)local_10 + 0x1d));
          *(undefined4 *)((int)local_10 + 0x2d) = 0x22;
          *(undefined2 *)((int)local_10 + 0x31) = 0;
          *(undefined2 *)((int)local_10 + 0x33) = 0;
          FUN_006e6080(local_10,2,*(undefined4 *)(DAT_0081176c + 0x389),
                       (undefined4 *)((int)local_10 + 0x1d));
          uVar11 = local_c;
        }
        ...
        if (*(int *)(*(int *)((int)local_10 + 0x1a5b) + 0x2e6) != 0) {
          thunk_FUN_005b7210();
          *(undefined4 *)(*(int *)(*(int *)((int)local_10 + 0x1a5b) + 0x2e6) + 0x1cab) =
               *(undefined4 *)((int)local_10 + 8);
        }
        thunk_FUN_005ad050('\x01');
        FUN_007158a0(DAT_008075a8,0x31,'\a',(undefined4 *)0x0,0,0);
        (**(code **)(*(int *)((int)local_10 + 0x1a70) + 4))
                  (DAT_00806784,7,0,s_MM_SLDUP_007cc04c,0xffffffff);
        *(undefined4 *)((int)local_10 + 0x1a8c) = 0x2f8;
        *(undefined4 *)((int)local_10 + 0x1a90) = 0x3c;
        *(undefined4 *)((int)local_10 + 0x1a78) = 0;
        FUN_007158a0(DAT_008075a8,0x31,'\a',(undefined4 *)0x0,0,0);
        (**(code **)(*(int *)((int)local_10 + 0x1b01) + 4))
                  (DAT_00806784,7,0,s_MM_SLDDN_007cc040,0xffffffff);
        *(undefined4 *)((int)local_10 + 0x1b1d) = 0x2f8;
        *(undefined4 *)((int)local_10 + 0x1b21) = 0x1b8;
        *(undefined4 *)((int)local_10 + 0x1b09) = 0;
        FUN_007158a0(DAT_008075a8,0x31,'\a',(undefined4 *)0x0,0,0);
        (**(code **)(*(int *)((int)local_10 + 0x1b92) + 4))
                  (DAT_00806784,7,0,s_MM_SLDT_007cc034,0xffffffff);
        iVar4 = 1;
        *(undefined4 *)((int)local_10 + 0x1bae) = 0x2fe;
        *(undefined4 *)((int)local_10 + 0x1bb2) = 0x5c;
        puVar9 = (undefined4 *)(*(int *)((int)local_10 + 0x5d) + 0x28);
        *(undefined4 *)((int)local_10 + 0x1b9a) = 0;
        uVar11 = FUN_006b4fe0(*(int *)((int)local_10 + 0x5d));
        iVar4 = FUN_006b50c0(0x1e4,399,(uint)*(ushort *)(*(int *)((int)local_10 + 0x5d) + 0xe),
                             uVar11,puVar9,iVar4);
        *(int *)((int)local_10 + 0x1c7b) = iVar4;
        ...
        puVar8 = (uint *)((int)local_10 + 0x1c23);
        for (uVar11 = uVar11 & 3; uVar11 != 0; uVar11 = uVar11 - 1) {
          *(undefined1 *)puVar9 = 0;
        ...
        *(undefined1 **)((int)local_10 + 0x20b8) = puVar10;
        if (puVar10 != (undefined1 *)0x0) {
          uVar12 = 0;
          cVar17 = '\x01';
          uVar11 = 0x10;
          ...
          if (uVar11 != 0) {
            iVar4 = *(int *)((int)local_10 + 0x20b8);
            *(undefined1 *)(iVar4 + 2) = 1;
            *(undefined4 *)(iVar4 + 0x17) = *(undefined4 *)(iVar4 + 0x13);
            uVar11 = *(uint *)(*(int *)((int)local_10 + 0x20b8) + 3);
            if (-1 < (int)uVar11) {
              FUN_006b3af0(DAT_008075a8,uVar11);
            }
            if (*(uint *)((int)local_10 + 0x1a74) != 0xffffffff) {
              FUN_006b3af0(*(int **)((int)local_10 + 0x1ab8),*(uint *)((int)local_10 + 0x1a74));
            }
            if (*(uint *)((int)local_10 + 0x1b05) != 0xffffffff) {
              FUN_006b3af0(*(int **)((int)local_10 + 0x1b49),*(uint *)((int)local_10 + 0x1b05));
            }
            if (*(uint *)((int)local_10 + 0x1b96) != 0xffffffff) {
              FUN_006b3af0(*(int **)((int)local_10 + 0x1bda),*(uint *)((int)local_10 + 0x1b96));
            }
            puVar8 = (uint *)((int)local_10 + 0x1c23);
            iVar4 = 0x16;
            do {
        ...
        if (*(char *)((int)local_10 + 0x20b4) == '\0') {
          ...
          *(undefined1 **)((int)local_10 + 0x20bc) = puVar10;
          if (puVar10 != (undefined1 *)0x0) {
            uVar12 = 0;
            cVar17 = '\x01';
            uVar11 = 0x10;
            ...
            if (uVar11 != 0) {
              iVar4 = *(int *)((int)local_10 + 0x20bc);
              *(undefined1 *)(iVar4 + 2) = 1;
              *(undefined4 *)(iVar4 + 0x17) = *(undefined4 *)(iVar4 + 0x13);
              uVar11 = *(uint *)(*(int *)((int)local_10 + 0x20bc) + 3);
              if (-1 < (int)uVar11) {
                FUN_006b3af0(DAT_008075a8,uVar11);
              }
              if (*(uint *)(DAT_0081176c + 0x391) != 0xffffffff) {
        ...
        if (*(char *)((int)local_10 + 0x20b7) == '\0') {
          cVar17 = *(char *)((int)local_10 + 0x1a5f);
          ...
          *(undefined1 **)((int)local_10 + 0x20c0) = puVar10;
          if (puVar10 != (undefined1 *)0x0) {
            uVar12 = 0;
            cVar17 = '\x01';
            uVar11 = 0x10;
            ...
            if (uVar11 != 0) {
              iVar4 = *(int *)((int)local_10 + 0x20c0);
              *(undefined1 *)(iVar4 + 2) = 1;
              *(undefined4 *)(iVar4 + 0x17) = *(undefined4 *)(iVar4 + 0x13);
              uVar11 = *(uint *)(*(int *)((int)local_10 + 0x20c0) + 3);
              if (-1 < (int)uVar11) {
                FUN_006b3af0(DAT_008075a8,uVar11);
              }
              if (*(uint *)(DAT_0081176c + 0x560) != 0xffffffff) {
        ...
        puVar9 = (undefined4 *)(*(int *)((int)local_10 + 0x5d) + 0x28);
        uVar11 = FUN_006b4fe0(*(int *)((int)local_10 + 0x5d));
        iVar4 = FUN_006b50c0(0x172,0x18,(uint)*(ushort *)(*(int *)((int)local_10 + 0x5d) + 0xe),
                             uVar11,puVar9,iVar4);
        *(int *)((int)local_10 + 0x1c8b) = iVar4;
        uVar11 = *(uint *)(iVar4 + 0x14);
        if (uVar11 == 0) {
          uVar11 = ((uint)*(ushort *)(iVar4 + 0xe) * *(int *)(iVar4 + 4) + 0x1f >> 3 & 0x1ffffffc) *
                   *(int *)(iVar4 + 8);
        ...
        FUN_006b5b10(*(int *)((int)local_10 + 0x1c8b),0,0,1,
                     *(int *)(*(int *)((int)local_10 + 0x1c8b) + 4) + -1,1,
                     (byte)*(undefined4 *)(*(int *)((int)local_10 + 0x1a5b) + 0x140),0xd);
        uVar11 = *(uint *)((int)local_10 + 0x1c8b);
        puVar8 = (uint *)((int)local_10 + 0x1c87);
        ...
        case 0x13:
          break;
        default:
          thunk_FUN_0055ddf0(DAT_0080759c,DAT_008075a8,*(int *)((int)local_10 + 0x5d),10,2);
        }
        pcVar13 = *(char **)((int)local_10 + 0x20b8);
        if (((pcVar13 != (char *)0x0) && (*pcVar13 != '\0')) && (-1 < (int)*(uint *)(pcVar13 + 3)))
        {
          FUN_006b3430(DAT_008075a8,*(uint *)(pcVar13 + 3));
        }
        pcVar13 = *(char **)((int)local_10 + 0x20bc);
        if (((pcVar13 != (char *)0x0) && (*pcVar13 != '\0')) && (-1 < (int)*(uint *)(pcVar13 + 3)))
        {
          FUN_006b3430(DAT_008075a8,*(uint *)(pcVar13 + 3));
        }
        pcVar13 = *(char **)((int)local_10 + 0x20c0);
        if (((pcVar13 != (char *)0x0) && (*pcVar13 != '\0')) && (-1 < (int)*(uint *)(pcVar13 + 3)))
        {
          FUN_006b3430(DAT_008075a8,*(uint *)(pcVar13 + 3));
        }
        ...
        uVar1 = *(undefined1 *)((int)local_10 + 0x1a5f);
        *(undefined2 *)puVar9 = 0;
        *(undefined1 *)((int)puVar9 + 2) = 0;
        local_13c = *(undefined4 *)((int)local_10 + 8);
        *(undefined1 *)((int)local_10 + 0x65) = 3;
        local_149 = 0x2340;
        local_138 = 2;
        local_134 = 0x6943;
        local_122 = 0x24bc;
      ...
      if (*(int *)(iVar4 + 0x2e6) != 0) {
        ...
        *(undefined2 *)puVar9 = 0xffff;
        thunk_FUN_005b87d0(*(void **)(iVar4 + 0x2e6),0,(int)&local_20c,0,0);
        thunk_FUN_005b9010(*(void **)(*(int *)((int)local_10 + 0x1a5b) + 0x2e6),(int)local_26c);
      }
      ...
      thunk_FUN_005b6730(local_10,0xb,'\0',-1);
      DAT_00858df8 = local_250;
      return;
    }
  }
