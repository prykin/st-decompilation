...

{
  ...
  if (iVar5 != 0) {
    ...
    iVar18 = ReportDebugMessage("E:\\__titans\\Andrey\\cpanel.cpp",0x2c9,0,iVar5,"%s"
                                ,"CPanelTy::PaintTV");
    if (iVar18 == 0) {
  ...
  do {
    ...
    case 1:
      if ((DAT_0080731a != 0) &&
        ...
        if ((bVar11 & 8) < 0xb) {
          uVar7 = bVar11 & 8;
          uVar14 = (&this_00->field_0148)[uVar7];
joined_r0x004f81d1:
          if (-1 < (int)uVar14) {
            Library::DKW::DDX::FUN_006b3640
                      ((int *)PTR_008075a8,uVar14,0xffffffff,(&this_00->field_003C)[uVar7],
    ...
    case 3:
      if (0x31 < (uint)(this_00->field_0038 - (&this_00->field_02EE)[uVar14])) {
        pcVar8 = &this_00->field_02EA + uVar14;
        (&this_00->field_02EE)[uVar14] = this_00->field_0038;
        if (*pcVar8 == '\0') {
          ...
          puVar9 = Library::Ourlib::MFRLOAD::mfRLoad
                             (DAT_00806794,CASE_1F,text,uVar7,bVar11,iVar5,iVar18,puVar19);
        ...
        if ((bVar11 & 8) < 0xb) {
          uVar14 = bVar11 & 8;
          if (-1 < (&this_00->field_0148)[uVar14]) {
            Library::DKW::DDX::FUN_006b3640
                      ((int *)PTR_008075a8,(&this_00->field_0148)[uVar14],0xffffffff,
                       (&this_00->field_003C)[uVar14],(&this_00->field_0094)[uVar14]);
          }
        }
    ...
    case 4:
      if (0x31 < (uint)(this_00->field_0038 - (&this_00->field_02EE)[uVar14])) {
        pbVar2 = &this_00->field_02EA + uVar14;
        (&this_00->field_02EE)[uVar14] = this_00->field_0038;
        bVar11 = *pbVar2;
        *pbVar2 = bVar11 + 1;
        if ((byte)(bVar11 + 1) == 5) {
    ...
    case 5:
      if (0x41 < (uint)(this_00->field_0038 - (&this_00->field_02EE)[uVar14])) {
        ...
        bVar11 = *pbVar2;
        *pbVar2 = bVar11 + 1;
        local_18 = &this_00->field_02E2 + uVar14;
      ...
      do {
        ...
        if (bVar11 == 1) {
          ...
          if (0x31 < (uint)(this_00->field_0038 - *piVar13)) {
            *piVar13 = this_00->field_0038;
            if (*(byte *)ppuVar15 == 0) {
              ...
              puVar9 = Library::Ourlib::MFRLOAD::mfRLoad
                                 (DAT_00806794,CASE_1F,pcVar8,uVar14,bVar11,iVar5,iVar18,puVar19);
              piVar13[-0x12] = (int)puVar9;
              *(byte *)(ppuVar15 + 3) = 1;
              *(byte *)ppuVar15 = 0;
            }
            else {
              *(byte *)ppuVar15 = *(byte *)ppuVar15 - 1;
            }
            thunk_FUN_004f1c80(this_00,local_c,(uint)local_10);
            bVar11 = ((char)local_c == '\0') + 9;
            /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
          ...
          *piVar13 = this_00->field_0038;
          ...
          bVar4 = bVar11 + 1;
          *(byte *)ppuVar15 = bVar4;
          if (*(short *)piVar13[-0x12] <= (short)(ushort)bVar4) {
            *(byte *)ppuVar15 = bVar11;
            *(byte *)(ppuVar15 + 3) = 2;
          }
          thunk_FUN_004f1c80(this_00,local_c,(uint)local_10);
          bVar11 = ((char)local_c == '\0') + 9;
...
joined_r0x004f861b:
        ...
        piVar13 = piVar13 + 6;
        ppuVar15 = (ushort **)((int)ppuVar15 + 6);
        /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
        local_c = CONCAT31(local_c._1_3_,bVar11);
      } while (bVar11 < 2);
  ...
  iVar5 = FUN_006b33f0(PTR_008075a8,this_00->field_017C);
  if (iVar5 == 0) {
    g_currentExceptionFrame = local_74.previous;
    return;
  }
  ...
  case CASE_5:
    ...
    this_00->field_0261 = this_00->field_0038;
    this_00->field_025F = bVar11;
    if ((short)(ushort)bVar11 < **ppsVar1) goto LAB_004f88e6;
    ...
    if (this_00->field_0285 == '\0') {
      ...
      *ppsVar1 = psVar10;
      pcVar17 = g_cMf32_00806798;
      if (psVar10 == (short *)0x0) goto LAB_004f8860;
    }
    else {
LAB_004f8860:
      psVar10 = Library::Ourlib::MFIMG::mfQmtLoad(pcVar17,&this_00->field_0x265,6,0,(short *)0x0);
      *ppsVar1 = psVar10;
    }
    if (*ppsVar1 == (short *)0x0) {
      psVar10 = (short *)0x1;
...
cf_common_join_004F88ED:
  if (((this_00->field_01D8 != 0) && ((g_playSystem_00802A38->field_00E4 & 1) != 0)) &&
    ...
    uVar14 = FUN_007140e0((void *)this_00->field_01D8,1,'\0');
    if (uVar14 != 0) {
      FUN_006b5440((int)this_00->field_01B4,0,100,5,uVar14,0,0xff);
    }
    ...
    if (this_00->field_01E0 != '\0') {
      ...
      bVar16 = uVar14 == 0;
      if ((int)uVar14 < 0) {
        bVar16 = (uVar14 - 1 | 0xfffffffe) == 0xffffffff;
      }
      if (bVar16) {
