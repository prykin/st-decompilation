...

{
  ...
  undefined1 *puVar3;
  short *psVar4;
  AnonShape_00497920_894F87D6 *pAVar5;
  int iVar6;
  int iVar7;
  int iVar8;
  uint uVar9;
  ...
  if (uVar9 == 0) {
    ...
    if (psVar4 != (short *)0x0) {
      ...
      if (pAVar5 == (AnonShape_00497920_894F87D6 *)0x0) {
        ...
        local_8 = 0xffffffff;
        iVar8 = (int)pAVar5->field_0047;
        local_a8 = (int)pAVar5->field_0049;
        local_20 = (int)pAVar5->field_004B;
        uVar9 = 0;
        local_9c = local_a8;
        local_74 = iVar8;
        local_30 = local_20;
        ...
        local_ac = pAVar5->field_0047 + -2;
        if (local_ac < 0) {
          local_ac = 0;
        }
        local_38 = pAVar5->field_0049 + -2;
        if (local_38 < 0) {
          local_38 = 0;
        }
        local_5c = pAVar5->field_004B + -2;
        if (local_5c < 0) {
          local_5c = 0;
        }
        local_b8 = pAVar5->field_0047 + 2;
        if (g_pathingGrid.sizeX <= local_b8) {
          local_b8 = g_pathingGrid.sizeX + -1;
        }
        local_40 = pAVar5->field_0049 + 2;
        if (g_pathingGrid.sizeY <= local_40) {
          local_40 = g_pathingGrid.sizeY + -1;
        }
        local_6c = pAVar5->field_004B + 2;
            ...
            if (local_88 <= local_40) {
              do {
                ...
                for (; iVar7 <= local_b8; iVar7 = iVar7 + 1) {
                  if ((psVar11[iVar7] == 0) &&
                     (iVar8 = thunk_FUN_00497920(pAVar5,iVar7,local_88,local_8c), iVar8 == 0)) {
        ...
        iVar8 = FUN_006ab090((int)local_54,local_2c,local_70,local_68,pAVar5->field_0047 - local_74,
                             pAVar5->field_0049 - local_9c,pAVar5->field_004B - local_20,-1,-1,-1);
        if (iVar8 == 0) {
          local_34 = 0;
          if (0 < (int)local_80) {
            do {
