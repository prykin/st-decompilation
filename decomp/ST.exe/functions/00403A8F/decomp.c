...

{
  ...
  if (iVar2 == 0) {
    ...
    FUN_006b3af0(DAT_008075a8,*(uint *)(iStack_8 + 0x1cb4));
    if (*(uint *)(iStack_8 + 0x1b05) != 0xffffffff) {
      FUN_006b3af0(*(int **)(iStack_8 + 0x1b49),*(uint *)(iStack_8 + 0x1b05));
    }
    if (*(uint *)(iStack_8 + 0x1b96) != 0xffffffff) {
      FUN_006b3af0(*(int **)(iStack_8 + 0x1bda),*(uint *)(iStack_8 + 0x1b96));
    }
    if (*(uint *)(iStack_8 + 0x1c27) != 0xffffffff) {
      FUN_006b3af0(*(int **)(iStack_8 + 0x1c6b),*(uint *)(iStack_8 + 0x1c27));
    }
