...
undefined4 FUN_004ac410(byte param_1)

{
  ...
  if ((uVar4 & *(uint *)(local_8 + 0x1c)) == 0) {
    DAT_00858df8 = (undefined4 *)local_4c;
    return 0;
  }
  FUN_006e9d40(*(void **)(local_8 + 0x3c),*(uint **)(local_8 + 0x18),(int)(char)param_1);
  *(uint *)(local_8 + 0x1c) = *(uint *)(local_8 + 0x1c) & ~uVar4;
  if (param_1 == 0xe) {
    if (*(char *)(local_8 + 0x11) == '\x01') {
      thunk_FUN_004ad5e0(local_8);
      DAT_00858df8 = (undefined4 *)local_4c;
      return 0;
    }
    thunk_FUN_004ad5e0(local_8);
    *(undefined1 *)(local_8 + 0x11) = 0;
  }
  DAT_00858df8 = (undefined4 *)local_4c;
  return 0;
}
