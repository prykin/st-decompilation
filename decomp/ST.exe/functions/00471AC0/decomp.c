...

{
  ...
  if (iVar8 != 0) {
    if (iVar8 == 1) {
      ...
      case 0:
      case 10:
        thunk_FUN_00416270(pvVar5,(undefined2 *)&local_14,&local_18,&local_1c);
...
LAB_00472a3a:
        ...
        sVar3 = (*this->vtable->vfunc_10)
                          (this->field_0041,this->field_0043,this->field_0045,local_14,local_18,
                           local_1c);
        uVar10 = sub_004176C0(this,sVar3);
      ...
      if (iVar8 != 2) {
        if (iVar8 != 3) {
          if (iVar8 == 4) {
            ...
            if (iVar8 != -1) {
              if (iVar8 == 0) {
                iVar8 = FUN_006aadd0((int)this->field_0047,(int)this->field_0049,
...
LAB_00471cbd:
                ...
                if (iVar8 == 1) {
                  ...
                  uVar4 = *(undefined4 *)&local_20->field_0x18;
                  this->field_0471 = uVar4;
                  sVar3 = this->field_004B;
...
LAB_00471ec9:
                    ...
                    iVar11 = this->field_001C * 0x41c64e6d;
  ...
  iVar11 = FUN_006aadd0((int)this->field_0047,(int)this->field_0049,(int)this->field_004B,
...
switchD_00471fe0_caseD_2:
  if ((this->field_082E == 0) && (this->field_048B == 0xffff)) {
    if ((this->field_0475 != this->field_0047) ||
      ...
      iVar8 = FUN_006aadd0((int)this->field_0047,(int)this->field_0049,(int)this->field_004B,
                           (int)(short)this->field_0475,(int)(short)this->field_0477,
                           (int)(short)this->field_0479);
      if ((iVar8 != -4) && (iVar8 < 8)) {
        this->field_082E = 4;
