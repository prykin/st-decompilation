...
undefined4 __fastcall thunk_FUN_004d2760(int *param_1)

{
  ...
  if (param_1[0xa8] != 0) {
    ...
    piVar1 = extraout_EDX;
    if (iVar2 < iVar2 + (int)piStack_8) {
      do {
        iVar4 = *(int *)((int)param_1 + 0x25d);
        if (iVar4 < iVar4 + (int)piStack_8) {
          do {
            thunk_FUN_00496140((short)iVar4,(short)iVar2,*(short *)((int)param_1 + 0x265));
            iVar4 = iVar4 + 1;
          } while (iVar4 < *(int *)((int)param_1 + 0x25d) + (int)piStack_8);
        }
        iVar2 = iVar2 + 1;
        piVar1 = piStack_8;
      } while (iVar2 < *(int *)((int)param_1 + 0x261) + (int)piStack_8);
    }
  ...
  if (DAT_007fa170 != (byte *)0x0) {
    ...
    if (0 < iVar2) {
      do {
        FUN_006acc70((int)DAT_007fa170,uVar3,&piStack_c);
        if (piStack_c == param_1) {
  ...
  if (iVar2 == 100) {
    ...
    if (iVar2 != 0) {
      ...
      if (0 < *(int *)(iVar2 + 0xc)) {
        do {
          FUN_006acc70(iVar2,uVar3,&piStack_8);
          if (piStack_8 == param_1) {
    ...
    if (DAT_007fa16c != (byte *)0x0) {
      ...
      if (0 < iVar2) {
        do {
          FUN_006acc70((int)DAT_007fa16c,uVar3,&piStack_8);
          if (piStack_8 == param_1) {
