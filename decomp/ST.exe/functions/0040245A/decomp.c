...

{
  ...
  if (param_1 != (uint *)0x0) {
    ...
    if (iVar3 == 0) {
      if (param_2 != 0) {
        iVar3 = *(int *)(pWStack_c + 0x1af0);
        uVar8 = *(uint *)(pWStack_c + 0x1af4);
...
LAB_005e7d14:
      ...
      if (iVar3 < 0x16) {
        ...
        iVar9 = 0;
        pWStack_8 = *(WaitTy **)(iVar3 + 0x14);
        if (pWStack_8 == (WaitTy *)0x0) {
          pWStack_8 = (WaitTy *)
                      (((uint)*(ushort *)(iVar3 + 0xe) * *(int *)(iVar3 + 4) + 0x1f >> 3 &
                       0x1ffffffc) * *(int *)(iVar3 + 8));
        }
        puVar7 = (undefined4 *)FUN_006b4fa0(iVar3);
        for (uVar8 = (uint)pWStack_8 >> 2; uVar8 != 0; uVar8 = uVar8 - 1) {
          *puVar7 = 0;
          puVar7 = puVar7 + 1;
        }
        for (uVar8 = (uint)pWStack_8 & 3; uVar8 != 0; uVar8 = uVar8 - 1) {
          *(undefined1 *)puVar7 = 0;
      ...
      if (iVar9 <= *(int *)(*(int *)(pWVar2 + 0x1af0) + 8) + -1) {
        pWStack_8 = pWVar2 + iVar9 * 4 + 0x1a94;
        iVar3 = iVar9 * 0x13;
        do {
          ...
          FUN_006b35d0(DAT_008075a8,*(uint *)pWStack_8);
          iVar9 = iVar9 + 1;
          pWStack_8 = pWStack_8 + 4;
          iVar3 = iVar3 + 0x13;
