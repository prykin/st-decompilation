...

{
  ...
  if (DAT_0080734a != '\0') {
    ...
    pcVar1 = LoadResourceString(0x1d4c - param_1,HINSTANCE_00807618);
    text = LoadResourceString(0x1b5f,HINSTANCE_00807618);
    ...
    if (param_4 < 0) {
      iVar2 = (int)this + 0x92;
      pcVar1 = LoadResourceString(0x1b60,HINSTANCE_00807618);
      wsprintfA((LPSTR)local_404,pcVar1,iVar2,param_3);
    }
    else {
      iVar2 = (int)this + 0x92;
      pcVar1 = LoadResourceString(0x1b61,HINSTANCE_00807618);
