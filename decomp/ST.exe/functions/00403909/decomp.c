...
void __thiscall
thunk_FUN_004db160(void *this,int param_1,undefined4 param_2,int *param_3,int *param_4,int *param_5,
                  int *param_6)
      ...
      *param_6 = piVar5[9];
      ...
      do {
        ...
        *(uint *)((int)pvVar1 + 0x1c) = uVar4;
        ...
        iVar9 = aiStack_60[uVar4];
        iVar3 = iVar3 + -1;
        aiStack_60[uVar4] = aiStack_60[uVar8];
        aiStack_60[uVar8] = iVar9;
      } while (iVar3 != 0);
      iVar3 = 1;
      uVar4 = *(int *)((int)pvStack_c + 0x1c) * 0x41c64e6d + 0x3039;
      *(uint *)((int)pvStack_c + 0x1c) = uVar4;
          ...
          do {
            if ((-1 < iVar9) && (iVar9 < DAT_007fb240)) {
              ...
              if ((((-1 < iVar10) &&
                ...
                iStack_8 = iVar3;
                if (iVar11 != 0) goto LAB_004db690;
              }
LAB_004db3e4:
              iVar10 = *param_4 + (int)param_5;
              if ((((-1 < iVar10) && (iVar10 < DAT_007fb242)) &&
                  (piVar5 = (int *)thunk_FUN_004db980(sVar2,(short)iVar10,(short)iStack_8,0),
                  piVar5 != (int *)0x0)) &&
                 ((piVar5[9] != param_1 &&
                  ((iVar3 = (**(code **)(*piVar5 + 0x2c))(), iVar3 == 0x3c ||
                   (iVar3 = (**(code **)(*piVar5 + 0x2c))(), iVar3 == 0x53)))))) {
        ...
        if (iVar10 <= *param_4 + -1 + (int)param_5) {
          do {
            if ((-1 < iVar10) && (iVar10 < DAT_007fb242)) {
              ...
              if ((-1 < iVar9) &&
                 ((((iVar9 < DAT_007fb240 &&
                    (piVar5 = (int *)thunk_FUN_004db980((short)iVar9,(short)iVar10,(short)iStack_8,0
                                                       ), piVar5 != (int *)0x0)) &&
                   (piVar5[9] != param_1)) &&
                  ((iVar3 = (**(code **)(*piVar5 + 0x2c))(), iVar3 == 0x3c ||
                   (iVar3 = (**(code **)(*piVar5 + 0x2c))(), iVar3 == 0x53)))))) {
