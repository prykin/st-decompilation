...

{
  ...
  puVar6 = (undefined4 *)(local_10 + 0x27a);
  do {
...
LAB_0053c30d:
    ...
    local_20 = local_1fc;
    local_58 = *(undefined4 *)(local_10 + 8);
    local_1c = *(byte *)(local_10 + 0x278) + 1;
    local_68[0] = 1;
    local_68[1] = 1;
    local_18 = 1;
    local_14 = 1;
    ...
    local_30 = 0xc0b4;
    local_38 = local_58;
    (**(code **)(**(int **)(local_10 + 0xc) + 8))(5,local_10 + 0x282,0,local_68,0);
  }
  DAT_00858df8 = (undefined4 *)local_ac;
  return;
}
