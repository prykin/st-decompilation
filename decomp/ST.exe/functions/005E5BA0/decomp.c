...

{
  ...
  if (iVar2 == 0) {
    ...
    *(undefined4 *)&this_00->field_0x71 = 0x14;
    *(undefined4 *)&this_00->field_0x75 = *(undefined4 *)&this_00->field_0x8;
    FUN_006e6000(this_00,3,1,(undefined4 *)&this_00->field_0x61);
    cMf32::RecMemFree(DAT_00806780,(uint *)&this_00->field_0x5d);
