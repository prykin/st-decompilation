...
int FUN_006cef60(int *param_1,RecoveredGlobalRecordView_00854F00 *param_2,
...

{
  ...
  iVar5 = FUN_006cfeb0(&local_38,&local_38,&local_48);
  pbVar2 = local_2c;
  uVar8 = local_30;
  iVar6 = local_34;
  iVar11 = local_38;
  ...
  if ((param_12 & 0xc0000000) != 0) {
    if (param_6 == nullptr) {
      ...
      param_6 = FUN_006b4fa0((RecoveredRecord_006B4FA0_DAC3A217 *)param_5);
    }
    ...
    param_2 = (RecoveredGlobalRecordView_00854F00 *)
...
LAB_006cf209:
    ...
    for (pRVar7 = param_5;
        ...
        pRVar7 = (RecoveredGlobalRecordView_00854F68 *)&pRVar7->field_0xa) {
      if (-1 < *(short *)&pRVar7->field_0x4) {
        ...
        iVar11 = FUN_006cfeb0(&local_60,&local_60,&local_38);
        if (iVar11 != 0) {
          iVar5 = local_60 - iVar5;
          uVar8 = local_5c - iVar9;
          /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
          if (*(int *)(*param_1 + 0x20) == 0x10) {
            pRVar13 = (RecoveredGlobalRecordView_00854F00 *)
...
LAB_006cf37b:
            ...
            local_8c = FUN_006da080(param_1,(uint *)pRVar13,(int)param_3,local_90,iVar11,pbVar2,
            ...
            if ((param_1[0x74] == 0) ||
              ...
              local_8 = 2;
              iVar11 = *(int *)&pRVar3[1].field_0x4 + 7;
              FUN_006d8a60((byte *)pRVar13,(int)param_3,
              ...
              local_8 = 3;
              FUN_006d86e0(pRVar13,(int)param_3,
...
LAB_006cf695:
  if (*(int *)(*param_1 + 0x20) == 0x10) {
    param_2 = (RecoveredGlobalRecordView_00854F00 *)
              (&param_2->field_0x0 + iVar11 * 2 + iVar6 * (int)param_3);
  }
  else {
    param_2 = (RecoveredGlobalRecordView_00854F00 *)
              (&param_2->field_0x0 + iVar6 * (int)param_3 + iVar11);
  }
  ...
  if (uVar10 == 0) {
    ...
    if (*(int *)(*param_1 + 0x20) == 0x10) {
      ...
      FUN_006d3300((uint *)param_2,(int)param_3,(RecoveredRecord_006D3300_0D49F2B9 *)param_5,iVar11,
      ...
      iVar6 = *(int *)&pRVar3[1].field_0x4 + 7;
      FUN_006d2820((byte *)param_2,param_3,(RecoveredRecord_006D2820_5C2BCC8C *)param_5,iVar11,
...
LAB_006cf8ee:
    ...
    local_28 = FUN_006da080(param_1,(uint *)param_2,(int)param_3,0,0,(byte *)param_5,iVar11,uVar14,
    ...
    if ((param_1[0x74] == 0) || ((param_5->field_000D & 3) != 1)) {
      ...
      local_8 = 5;
      iVar6 = *(int *)&pRVar3[1].field_0x4 + 7;
      FUN_006d8a60((byte *)param_2,(int)param_3,(RecoveredRecord_006D8A60_0D169E12 *)param_5,iVar11,
      ...
      local_8 = 6;
      FUN_006d86e0(param_2,(int)param_3,param_5,iVar11,uVar14,uVar8,(uint)pbVar2,
