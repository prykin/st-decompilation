...
int FUN_006cef60(int *param_1,uint *param_2,AnonShape_006B5B10_E0D06CF1 *param_3,int param_4,
                uint *param_5,char *param_6,int param_7,int param_8,int *param_9,int param_10,
                int param_11,uint param_12,undefined1 *param_13)

{
  ...
  if ((param_12 & 0xc0000000) != 0) {
    ...
    uVar7 = (uint)*(ushort *)((int)puVar8 + 0xe) * puVar8[1] + 0x1f >> 3 & 0x1ffffffc;
    param_6 = param_6 + ((puVar8[2] - ((param_9[1] - param_8) + local_34)) - (int)local_2c) * uVar7
                        + (*param_9 - param_7) + local_38;
    param_2 = (uint *)((int)param_2 + (int)(local_2c + local_34 + -1) * (int)param_3 + local_38);
    local_8 = 0;
    FUN_006cebe0((char *)param_2,-(int)param_3,param_6,uVar7,local_30,(int)local_2c,
                 *(char *)(iVar11 + 0x54));
    goto LAB_006cf911;
  }
...
LAB_006cf209:
    ...
    local_2c = local_2c + local_34;
    local_a0 = 0;
    for (puVar8 = param_5; (local_a0 < param_10 && (iVar5 = *(int *)((int)puVar8 + 6), iVar5 != 0));
        puVar8 = (uint *)((int)puVar8 + 10)) {
      if (-1 < (short)puVar8[1]) {
        iVar6 = ((int)(short)*puVar8 - *(int *)(iVar11 + 0x28)) + *(int *)(iVar11 + 0x18);
        iVar12 = ((int)*(short *)((int)puVar8 + 2) - *(int *)(iVar11 + 0x2c)) +
                 *(int *)(iVar11 + 0x1c);
        iVar4 = ((int)*(short *)(iVar5 + 0xe) - *param_9) + iVar6 + param_7;
        ...
        if (iVar5 != 0) {
          ...
          if (uVar10 == 0) {
            ...
            if (*(int *)(*param_1 + 0x20) == 0x10) {
              ...
              /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
              FUN_006d3300((uint *)pAVar13,(int)param_3,*(byte **)((int)puVar8 + 6),iVar4,uVar7,
              ...
              iVar5 = *(int *)(iVar11 + 0xbc) + 7;
              /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
              FUN_006d2820((byte *)pAVar13,param_3,*(byte **)((int)puVar8 + 6),iVar4,uVar7,local_58,
...
LAB_006cf37b:
            ...
            pbVar2 = *(byte **)((int)puVar8 + 6);
            local_90 = (int)(short)*puVar8 + iVar6 + (*(short *)(pbVar2 + 0xe) - local_38) + param_7
            ;
            if (local_90 < 0) {
              local_90 = 0;
            }
            iVar5 = (int)*(short *)((int)puVar8 + 2) +
            ...
            local_8c = FUN_006da080(param_1,(uint *)pAVar13,(int)param_3,local_90,iVar5,pbVar2,iVar4
                                    ,uVar7,local_58,local_54,param_13);
          }
          else if (uVar10 == 1) {
            if ((param_1[0x74] == 0) ||
               (((*(AnonShape_006D86E0_768BB816 **)((int)puVar8 + 6))->field_000D & 3) != 1)) {
              ...
              iVar5 = *(int *)(iVar11 + 0xbc) + 7;
              /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
              FUN_006d8a60((uint *)pAVar13,(int)param_3,*(byte **)((int)puVar8 + 6),iVar4,uVar7,
              ...
              local_8 = 3;
              /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
              FUN_006d86e0(pAVar13,(int)param_3,*(AnonShape_006D86E0_768BB816 **)((int)puVar8 + 6),
                           iVar4,uVar7,local_58,(uint)local_54,(byte)*(undefined4 *)(iVar11 + 0x60),
...
LAB_006cf695:
  if (*(int *)(*param_1 + 0x20) == 0x10) {
    iVar12 = iVar5 * 2 + iVar6 * (int)param_3;
  }
  else {
    iVar12 = iVar6 * (int)param_3 + iVar5;
  }
  ...
  if (uVar10 == 0) {
    ...
    if (*(int *)(*param_1 + 0x20) == 0x10) {
      ...
      FUN_006d3300(param_2,(int)param_3,(byte *)param_5,iVar5,uVar14,uVar7,pbVar2,local_24,
      ...
      iVar6 = *(int *)(iVar11 + 0xbc) + 7;
      FUN_006d2820((byte *)param_2,param_3,(byte *)param_5,iVar5,uVar14,uVar7,(uint)pbVar2,
                   *(int *)(iVar11 + 0xb0),*(byte **)(iVar11 + 0xb8),
                   (int)(iVar6 + (iVar6 >> 0x1f & 7U)) >> 3,
                   (*(int *)(iVar11 + 0x28) - *(int *)(iVar11 + 0x18)) + iVar5,
...
LAB_006cf8ee:
    ...
    local_28 = FUN_006da080(param_1,param_2,(int)param_3,0,0,(byte *)param_5,iVar5,uVar14,uVar7,
                            pbVar2,param_13);
  }
  else if (uVar10 == 1) {
    /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
    if ((param_1[0x74] == 0) || ((*(byte *)((int)param_5 + 0xd) & 3) != 1)) {
      ...
      local_8 = 5;
      iVar6 = *(int *)(iVar11 + 0xbc) + 7;
      FUN_006d8a60(param_2,(int)param_3,(byte *)param_5,iVar5,uVar14,uVar7,(int)pbVar2,
                   (undefined *)(-(uint)((param_12 & 0x100) != 0) & local_20),
                   *(uint *)(iVar11 + 0x60),*(AnonShape_006D8A60_CD460E10 **)(iVar11 + 100),
                   *(undefined **)(iVar11 + 0xb0),*(byte **)(iVar11 + 0xb8),
                   (int)(iVar6 + (iVar6 >> 0x1f & 7U)) >> 3,
      ...
      local_8 = 6;
      FUN_006d86e0((AnonShape_006D86E0_D6D32C07 *)param_2,(int)param_3,
                   (AnonShape_006D86E0_768BB816 *)param_5,iVar5,uVar14,uVar7,(uint)pbVar2,
