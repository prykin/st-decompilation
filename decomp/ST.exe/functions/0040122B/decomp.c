...
int __thiscall
thunk_FUN_00617ca0(void *this,int *param_1,int *param_2,undefined4 *param_3,int *param_4,
    ...
    do {
      ...
      if ((((-1 < iVar6) && (iVar6 <= DAT_007fb240 * 0xc9)) && (-1 < iVar7)) &&
         ((iVar7 <= DAT_007fb242 * 0xc9 &&
          (iStack_14 = thunk_FUN_00617c30(this,iVar6,iVar7), iStack_14 == 1)))) break;
      iStack_10 = iStack_10 + 1;
      uVar5 = uVar5 + 1;
      uVar4 = *(uint *)((int)this + 0x30);
    } while (iStack_10 < (int)uVar4);
    if (iStack_14 != 0) {
      *param_1 = iVar6;
      *param_2 = iVar7;
