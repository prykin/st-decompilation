...

{
  ...
  if (iVar4 == 0) {
    if (*(int *)(local_18 + 0x5f3) != 0) {
      ...
      wsprintfA((LPSTR)local_15c,s__s_1i_007ac908,*(undefined4 *)(pTVar3 + 0x5f3),
                *(undefined4 *)(pTVar3 + 0x5c0));
      iVar4 = STT3DSprC::LoadSequence(pSVar1,0xd,DAT_0080678c,local_15c,0x1d);
      if (iVar4 != 0) {
      ...
      STT3DSprC::SetCurFase(pSVar1,'\r',local_c);
      iVar6 = 0;
      iVar4 = thunk_FUN_004acd30(pSVar1,'\r');
      if (0 < iVar4) {
        do {
          thunk_FUN_004ace00(pSVar1,'\r',iVar6,local_8[iVar6]);
          iVar6 = iVar6 + 1;
          iVar4 = thunk_FUN_004acd30(pSVar1,'\r');
        } while (iVar6 < iVar4);
      }
    ...
    if (((*(int *)(&DAT_00791a10 + *(int *)(pTVar3 + 0x235) * 4) != 0) &&
      ...
      wsprintfA((LPSTR)local_15c,s__s_cover_1i_007ac8ec,*(undefined4 *)(pTVar3 + 0x5f3),
                *(undefined4 *)(pTVar3 + 0x5c0));
      iVar4 = STT3DSprC::LoadSequence(pSVar1,8,DAT_0080678c,local_15c,0x1d);
      if (iVar4 != 0) {
      ...
      STT3DSprC::SetCurFase(pSVar1,'\b',local_c);
      iVar6 = 0;
      iVar4 = thunk_FUN_004acd30(pSVar1,'\b');
      if (0 < iVar4) {
        do {
          thunk_FUN_004ace00(pSVar1,'\b',iVar6,local_8[iVar6]);
          iVar6 = iVar6 + 1;
          iVar4 = thunk_FUN_004acd30(pSVar1,'\b');
        } while (iVar6 < iVar4);
      }
