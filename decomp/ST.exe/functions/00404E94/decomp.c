...

{
  ...
  if (*(uint *)((int)pvStack_10 + 0x215d) != 0) {
    FUN_006e56b0(*(void **)((int)pvStack_10 + 0xc),*(uint *)((int)pvStack_10 + 0x215d));
  }
  *(undefined4 *)((int)pvStack_10 + 0x215d) = 0;
  puVar4 = (uint *)((int)pvStack_10 + 0x1f8c);
  iStack_c = 10;
  do {
    iStack_8 = 8;
    do {
      if (*puVar4 != 0) {
        FUN_006e56b0(*(void **)((int)pvStack_10 + 0xc),*puVar4);
        *puVar4 = 0;
      }
      puVar4 = puVar4 + 1;
      iStack_8 = iStack_8 + -1;
    } while (iStack_8 != 0);
    if (*(uint *)((int)pvStack_10 + 0x211d) != 0) {
      FUN_006e56b0(*(void **)((int)pvStack_10 + 0xc),*(uint *)((int)pvStack_10 + 0x211d));
      *(undefined4 *)((int)pvStack_10 + 0x211d) = 0;
    }
    iStack_c = iStack_c + -1;
  } while (iStack_c != 0);
  if (*(int *)((int)pvStack_10 + 0x21e8) != 0) {
    thunk_FUN_005aafb0();
    FUN_0072e2b0(*(undefined4 **)((int)pvStack_10 + 0x21e8));
    *(undefined4 *)((int)pvStack_10 + 0x21e8) = 0;
  }
  ...
  *(undefined1 **)((int)pvStack_10 + 0x21e8) = puVar3;
  if (puVar3 != (undefined1 *)0x0) {
    uVar8 = 0;
    cVar7 = '\x01';
    uVar6 = 0x10;
    ...
    if (uVar6 != 0) {
      iVar2 = *(int *)((int)pvStack_10 + 0x21e8);
      *(undefined1 *)(iVar2 + 2) = 0;
      *(undefined4 *)(iVar2 + 0x17) = 0xffffffff;
      uVar6 = *(uint *)(*(int *)((int)pvStack_10 + 0x21e8) + 3);
      if (-1 < (int)uVar6) {
  ...
  if (*(uint *)((int)pvStack_10 + 0x1c6f) != 0xffffffff) {
    FUN_006b3af0(*(int **)((int)pvStack_10 + 0x1cb3),*(uint *)((int)pvStack_10 + 0x1c6f));
  }
  if (*(uint *)((int)pvStack_10 + 0x1d00) != 0xffffffff) {
    FUN_006b3af0(*(int **)((int)pvStack_10 + 0x1d44),*(uint *)((int)pvStack_10 + 0x1d00));
  }
  if (*(uint *)((int)pvStack_10 + 0x1d91) != 0xffffffff) {
    FUN_006b3af0(*(int **)((int)pvStack_10 + 0x1dd5),*(uint *)((int)pvStack_10 + 0x1d91));
  }
  puVar4 = (uint *)((int)pvStack_10 + 0x20cc);
  iStack_c = 10;
  do {
  ...
  puVar4 = (uint *)((int)pvStack_10 + 0x2125);
  iStack_c = 0xe;
  do {
    if (*puVar4 != 0) {
      FUN_006e56b0(*(void **)((int)pvStack_10 + 0xc),*puVar4);
  ...
  if (*(int *)((int)pvStack_10 + 0x21f4) != 0) {
    thunk_FUN_005aafb0();
    FUN_0072e2b0(*(undefined4 **)((int)pvStack_10 + 0x21f4));
    *(undefined4 *)((int)pvStack_10 + 0x21f4) = 0;
  }
  puVar3 = (undefined1 *)FUN_0072e530(0x33);
  if (puVar3 == (undefined1 *)0x0) {
    puVar3 = (undefined1 *)0x0;
  ...
  *(undefined1 **)((int)pvStack_10 + 0x21f4) = puVar3;
  if (puVar3 != (undefined1 *)0x0) {
    uVar8 = 0;
    cVar7 = '\x01';
    uVar6 = 0x10;
    ...
    if (uVar6 != 0) {
      iVar2 = *(int *)((int)pvStack_10 + 0x21f4);
      *(undefined1 *)(iVar2 + 2) = 0;
      *(undefined4 *)(iVar2 + 0x17) = 0xffffffff;
      uVar6 = *(uint *)(*(int *)((int)pvStack_10 + 0x21f4) + 3);
      if (-1 < (int)uVar6) {
        FUN_006b3430(DAT_008075a8,uVar6);
      }
      thunk_FUN_005ab0a0();
  ...
  FUN_006b3af0(DAT_008075a8,*(uint *)((int)pvStack_10 + 0x1e22));
  if ((((*(char *)((int)pvStack_10 + 0x21e2) == '\0') ||
       (cVar7 = *(char *)((int)pvStack_10 + 0x1e26), cVar7 == '\x06')) || (cVar7 == '\a')) ||
     (cVar7 == '\x0e')) {
    ...
    *(undefined4 *)((int)pvStack_10 + 0x31) = 0;
    ...
    if (*(uint *)(DAT_0081176c + 0x389) != 0) {
      FUN_006e56b0(*(void **)((int)pvStack_10 + 0xc),*(uint *)(DAT_0081176c + 0x389));
    }
    ...
    *(uint **)(DAT_0081176c + 0x548) = puVar4;
    if (*(int *)((int)pvStack_10 + 0x21ec) != 0) {
      thunk_FUN_005aafb0();
      FUN_0072e2b0(*(undefined4 **)((int)pvStack_10 + 0x21ec));
      *(undefined4 *)((int)pvStack_10 + 0x21ec) = 0;
    }
    puVar3 = (undefined1 *)FUN_0072e530(0x33);
    if (puVar3 == (undefined1 *)0x0) {
      puVar3 = (undefined1 *)0x0;
    ...
    *(undefined1 **)((int)pvStack_10 + 0x21ec) = puVar3;
    if (puVar3 != (undefined1 *)0x0) {
      uVar8 = 0;
      cVar7 = '\x01';
      uVar6 = 0x10;
      ...
      if (uVar6 != 0) {
        iVar2 = *(int *)((int)pvStack_10 + 0x21ec);
        *(undefined1 *)(iVar2 + 2) = 0;
        *(undefined4 *)(iVar2 + 0x17) = 0xffffffff;
        uVar6 = *(uint *)(*(int *)((int)pvStack_10 + 0x21ec) + 3);
        if (-1 < (int)uVar6) {
          FUN_006b3430(DAT_008075a8,uVar6);
        }
        thunk_FUN_005ab0a0();
  ...
  if ((*(char *)((int)pvStack_10 + 0x21e3) != '\0') &&
     (((cVar7 = *(char *)((int)pvStack_10 + 0x1e26), cVar7 == '\x06' || (cVar7 == '\a')) ||
      (cVar7 == '\x0e')))) {
    puVar4 = (uint *)((int)pvStack_10 + 0x1f60);
    iStack_c = 7;
    do {
      if (*puVar4 != 0) {
        FUN_006e56b0(*(void **)((int)pvStack_10 + 0xc),*puVar4);
    ...
    if (*(int *)((int)pvStack_10 + 0x21f0) != 0) {
      thunk_FUN_005aafb0();
      FUN_0072e2b0(*(undefined4 **)((int)pvStack_10 + 0x21f0));
      *(undefined4 *)((int)pvStack_10 + 0x21f0) = 0;
    }
    puVar3 = (undefined1 *)FUN_0072e530(0x33);
    if (puVar3 == (undefined1 *)0x0) {
      puVar3 = (undefined1 *)0x0;
    ...
    *(undefined1 **)((int)pvStack_10 + 0x21f0) = puVar3;
    if (puVar3 != (undefined1 *)0x0) {
      uVar8 = 0;
      cVar7 = '\x01';
      uVar6 = 0x10;
      ...
      uVar6 = thunk_FUN_005aacb0(4,10,0xb4,iVar2,iVar5,uVar6,cVar7,uVar8);
      if (uVar6 != 0) {
        iVar2 = *(int *)((int)pvStack_10 + 0x21f0);
        *(undefined1 *)(iVar2 + 2) = 0;
        *(undefined4 *)(iVar2 + 0x17) = 0xffffffff;
        uVar6 = *(uint *)(*(int *)((int)pvStack_10 + 0x21f0) + 3);
        if (-1 < (int)uVar6) {
          FUN_006b3430(DAT_008075a8,uVar6);
        }
        thunk_FUN_005ab0a0();
    ...
    FUN_006b3af0(DAT_008075a8,*(uint *)((int)pvStack_10 + 0x1f80));
  }
  if (DAT_00802a30 != 0) {
    if (*(int *)(DAT_00802a30 + 0xa9) == 0) {
