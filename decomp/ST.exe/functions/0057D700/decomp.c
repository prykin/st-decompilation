...
undefined4 __thiscall FUN_0057d700(void *this,uint *param_1,uint *param_2,int *param_3,int *param_4)

{
  ...
  local_18 = (int)*(short *)((int)this + 0x4b) - (*(uint *)(DAT_00802a38 + 0xe4) & 1);
  if (local_18 < 0) {
    local_18 = 1;
  }
...
switchD_0057d76c_default:
  if ((uVar11 == (int)*(short *)((int)this + 0x47)) && (uVar10 == (int)*(short *)((int)this + 0x49))
    ...
    *(uint *)((int)this + 0x1c) = uVar3;
    local_18 = (int)*(short *)((int)this + 0x4b) - (int)(short)((ulonglong)(uVar3 >> 0x10) % 5);
    if (local_18 < 0) {
      local_18 = -local_18;
    }
    local_18 = local_18 % 5;
