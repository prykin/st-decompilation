...

{
  ...
  if (local_c == (ushort *)0x0) {
    ...
    FUN_006dc050(PTR_00807598,g_anonShape_GLOBAL_0080759C_9638EF10_0080759C,DAT_00807568,
  ...
  *(char *)(puVar7 + 1) = (char)puVar6[1];
  Library::MSVCRT::FUN_0072e150(0xc0000000,0x403ccccc);
  lVar9 = Library::MSVCRT::__ftol();
  FUN_006dc050(PTR_00807598,g_anonShape_GLOBAL_0080759C_9638EF10_0080759C,DAT_00807568,DAT_0080756c,
