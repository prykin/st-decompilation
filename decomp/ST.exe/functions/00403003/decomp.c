...

{
  ...
  uVar1 = Library::MSVCRT::__setjmp3(IStack_64.jumpBuffer,0,unaff_EDI,unaff_ESI);
  if (uVar1 != 0) {
  ...
  *(uint *)((int)puStack_8 + 0x77) = uVar1;
  ...
  thunk_FUN_006686c0((int *)&puStack_8);
  STPlaySystemC::CreateGameObject(DAT_00802a38,900,auStack_20 + 1,&pvStack_14,puStack_c,0);
  thunk_FUN_006686c0((int *)&puStack_c);
