...

{
  ...
  *(undefined1 *)((int)this + 0x316) = 0;
  iVar1 = *param_1;
  local_24[7] = iVar1;
  local_24[0] = Library::DKW::LIB::FUN_006aac70(0x44);
  iVar2 = 0;
  do {
    *(undefined4 *)(iVar2 + local_24[0]) = DAT_00806774;
    iVar2 = iVar2 + 4;
  } while (iVar2 < 0x44);
  *(undefined4 *)(local_24[0] + 0x24) = DAT_00806764;
  local_24[1] = 0;
  local_24[2] = 0;
  local_24[3] = 0;
  local_24[4] = 0;
  local_24[5] = 0x10;
  local_24[6] = 0;
  STT3DSprC::RestoreSpr((STT3DSprC *)((int)this + 0x1d5),local_24,param_1 + 1);
