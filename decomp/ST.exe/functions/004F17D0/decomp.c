...

{
  ...
  if (param_2 < 6) {
    ...
    if (param_1 == 0) {
      pCVar4 = &this->field_0BF5;
    }
    uVar2 = (uint)param_2;
    iVar1 = uVar2 + (uint)(param_1 == 0) * 6;
    (&this->field_0x780)[iVar1 * 0x27] = 1;

    iVar3 = thunk_FUN_00525390(*(Global_sub_00525390_param_1Enum *)(uVar2 + 9 + (int)pCVar4),*pCVar4
                              );
    *(int *)(&this->field_0x781 + iVar1 * 0x27) = iVar3;

    iVar3 = thunk_FUN_005272b0(*(Global_sub_005272B0_param_1Enum *)(uVar2 + 9 + (int)pCVar4));
