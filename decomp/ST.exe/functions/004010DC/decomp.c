...
void __thiscall thunk_FUN_006799b0(void *this,uint param_1)

{
  ...
  auStack_3c[2] = *(uint *)((int)this + 0x640);
  if (auStack_3c[2] != uStack_8) {
    puVar5 = auStack_3c;
    for (iVar3 = 0xd; iVar3 != 0; iVar3 = iVar3 + -1) {
      *puVar5 = 0;
      puVar5 = puVar5 + 1;
    }
    auStack_3c[1] = *(undefined4 *)((int)this + 0x6fe);
    auStack_3c[0] = 0x6a;
    thunk_FUN_0067a020(this,auStack_3c,-1);
  }
  return;
}
