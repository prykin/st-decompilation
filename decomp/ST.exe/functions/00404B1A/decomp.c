...

{
  ...
  if (0 < iVar4) {
    do {
      FUN_006acc70(*(int *)(this + 0x22e),uVar5,&uStack_34);
      if ((short)auStack_30[0] != -1) {
        uStack_34 = 0;
        uStack_22 = 0;
        FUN_006ae140(*(uint **)(this + 0x22e),uVar5,&uStack_34);
        uVar3 = thunk_FUN_0042b620(CONCAT31((int3)((uint)extraout_EDX >> 8),this[0x24]),
                                   auStack_30[0],1);
        if (uVar3 == 0) {
  ...
  FUN_006acc70(*(int *)(this + 0x22a),*(uint *)(this + 0x232),(undefined4 *)&sStack_1c);
  puVar2 = puStack_8;
  if (puStack_8[3] != 0) {
    InitWay(this,(int)puStack_8,(int)sStack_1c,(int)sStack_1a,(int)sStack_18);
  }
