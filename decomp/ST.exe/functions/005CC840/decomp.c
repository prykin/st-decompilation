  ...
  if (iVar2 == 0) {
    ...
    if (this_00->field_21E6 != '\0') {
      ...
      if (pHVar2 != nullptr) {
        ...
        pRVar3 = Library::DKW::DDX::FUN_006bf9f0((int *)g_ddxContext_008075A8,200,0x1f1,400,0x62);
        /* ST_CALLSITE[005CCA08]: CALL 0x0040459d; direct=0040459D HoloTy::Init */
        uVar7 = HoloTy::Init(this_00->field_21F8,CASE_1,200,0x1f1,pRVar3,iVar5,bVar6,cVar7,uVar8);
        if (uVar7 != 0) {
