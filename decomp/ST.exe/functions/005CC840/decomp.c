...

{
  ...
  if (iVar2 == 0) {
    ...
    this_00 = local_8;
    thunk_FUN_00540dc0(0,*(undefined4 *)&local_8->field_0x8,2,0xc0a1,2,0x1c,0,0,0,0,0,0);
    if (*(uint *)&this_00[1].field_0xdf != 0) {
      FUN_006e56b0(*(void **)&this_00->field_0xc,*(uint *)&this_00[1].field_0xdf);
      *(undefined4 *)&this_00[1].field_0xdf = 0;
    }
    if (-1 < (int)*(uint *)&this_00[1].field_0xe3) {
      FUN_006b3af0(DAT_008075a8,*(uint *)&this_00[1].field_0xe3);
    }
    if (this_00[1].field_0xc9 != '\0') {
      ...
      if (*(HoloTy **)&this_00[1].field_0xdb != (HoloTy *)0x0) {
        HoloTy::Done(*(HoloTy **)&this_00[1].field_0xdb);
        Library::MSVCRT::FUN_0072e2b0(*(undefined4 **)&this_00[1].field_0xdb);
        *(undefined4 *)&this_00[1].field_0xdb = 0;
      }
      ...
      *(undefined1 **)&this_00[1].field_0xdb = puVar3;
      if (puVar3 != (undefined1 *)0x0) {
        uVar7 = 0;
        cVar6 = '\x01';
        uVar5 = 0x10;
        ...
        uVar5 = HoloTy::Init(*(HoloTy **)&this_00[1].field_0xdb,1,200,0x1f1,iVar2,iVar4,uVar5,cVar6,
                             uVar7);
        if (uVar5 != 0) {
          iVar2 = *(int *)&this_00[1].field_0xdb;
          *(undefined1 *)(iVar2 + 2) = 0;
          *(undefined4 *)(iVar2 + 0x17) = 0xffffffff;
          uVar5 = *(uint *)(*(int *)&this_00[1].field_0xdb + 3);
          if (-1 < (int)uVar5) {
            Library::DKW::DDX::FUN_006b3430(DAT_008075a8,uVar5);
          }
          HoloTy::NextFas(*(HoloTy **)&this_00[1].field_0xdb);
        }
