...

{
  ...
  *(int *)((int)param_1 + 0x5837) = ((int *)param_1[2])[1] << 1;
  ...
  uVar12 = iVar6 * 4;
  local_d8 = uVar12;
  local_78 = FUN_006aac70(iVar6 * 0x38);
  local_c0 = (undefined4 *)FUN_006aac70(uVar12);
  local_8 = 0;
  FUN_0072da40();
  ...
  local_1c = &stack0xfffffe68;
  thunk_FUN_0069c360(param_1,local_78,(int *)(*(int *)param_1[2] << 1),((int *)param_1[2])[1] << 1);
  puVar2 = thunk_FUN_0069c8b0(local_78,*(int *)param_1[2] << 1,((int *)param_1[2])[1] << 1);
  local_138 = puVar2;
  if (puVar2 == (uint *)0x0) {
    uVar12 = FUN_0072e6c0();
        ...
        while ((0 < local_140 && (local_6c < local_7c))) {
          ...
          if (iVar6 == 0) {
            ...
            do {
              ...
              local_dc = *piVar3;
              if (((-1 < local_dc) && (iVar4 = local_78 + local_dc * 0xe, *(int *)(iVar4 + 6) < 0))
                 && ((*(byte *)(iVar4 + 1) & 4) != 0)) {
                ...
                if (local_c4 != 0) {
                  ...
                  *(undefined4 *)(local_78 + 6 + local_dc * 0xe) = 0x3ee;
                  thunk_FUN_0069e4d0(param_1,local_78,iVar8 * 100,iVar4 * 100,
          ...
          if (local_30 == 0) {
            ...
            if (0 < *(int *)(iVar11 + 0xc)) {
              ...
              do {
                ...
                if (0 < iVar11) {
                  do {
                    if ((*(int *)(local_78 + 2 + local_68[iVar6] * 0xe) == 0) &&
            ...
            local_b4 = FUN_006aac70(iVar8 * 8);
            local_28 = (undefined4 *)FUN_006aac70(iVar8 * 4);
            local_44 = 0;
            local_b8 = -1;
            local_24 = -1;
            local_d4 = 0;
...
LAB_0069d203:
              ...
              if (*(byte *)(local_dc + (int)local_c0) < 2) {
                ...
                local_24 = -1;
                if (local_44 == 0) {
                  *(int *)(local_b4 + local_178 * 8) = iVar11;
                  *(undefined4 *)(local_b4 + 4 + local_178 * 8) = 0xffffffff;
                  *local_28 = 0x10000;
                  local_44 = 1;
                  local_158 = 0;
                  uVar12 = 1;
...
LAB_0069d684:
                  ...
                  if (uVar7 < uVar14) {
                    do {
                      if (iVar6 == 0) {
LAB_0069d7b2:
                        iVar11 = *(int *)(local_b4 + local_154 * 8);
                        iVar6 = *(int *)(local_b4 + 4 + local_154 * 8);
                        if (-1 < iVar11) {
                          iVar8 = iVar11 * 0xe;
                          iVar4 = *(int *)(iVar8 + 6 + local_78);
                          if ((iVar4 < 0) || (iVar4 != 0x3ed)) {
                            ...
                            if (iVar6 < 0) {
                              ...
                              if ((int)uVar12 % 6 == 0) {
                                ...
                                *(undefined4 *)(iVar8 + 6 + local_78) = 0x3f0;
                              }
                              else {
                                uVar12 = FUN_0072e6c0();
                                if ((int)uVar12 % 9 == 0) {
                                  ...
                                  *(undefined4 *)(iVar8 + 6 + local_78) = 0x3f1;
                                }
                              }
                            }
                            else {
                              ...
                              *(undefined4 *)(iVar8 + 6 + local_78) = 0x3ed;
                            }
                          }
                        }
                      }
        ...
        while ((0 < local_140 && (local_b0 < local_170))) {
          ...
          if (iVar4 == 0) {
            ...
            do {
              ...
              local_dc = *piVar3;
              if (((-1 < local_dc) && (iVar11 = local_78 + local_dc * 0xe, *(int *)(iVar11 + 6) < 0)
                  ) && ((*(byte *)(iVar11 + 1) & 0xc) != 0)) {
                  ...
                  *(short *)(local_16c + local_40 * 4 + 2) = (short)iVar11;
                  ...
                  if (bVar15) {
                    ...
                    thunk_FUN_006a0ae0(param_1,iVar6 * 100 + 0x32,iVar11 * 100 + 0x32,0,0x3f2,
                                       uVar12 % DAT_007d9994);
                    *(undefined4 *)(local_78 + 6 + local_dc * 0xe) = 0x3f2;
                  }
                  else {
                    uVar12 = FUN_0072e6c0();
                    ...
                    if (bVar15) {
                      ...
                      *(undefined4 *)(local_78 + 6 + local_dc * 0xe) = 0x3f1;
                    }
                    else {
                      uVar12 = FUN_0072e6c0();
                      thunk_FUN_006a0ae0(param_1,iVar6 * 100 + 0x32,iVar11 * 100 + 0x32,0,0x3e9,
                                         uVar12 % DAT_007d88d4);
                      *(undefined4 *)(local_78 + 6 + local_dc * 0xe) = 0x3e9;
                    }
                  }
                  iVar11 = local_40 + 1;
...
LAB_0069d4ca:
  if (local_24 == -1) {
    ...
    *(int *)(local_b4 + local_178 * 8) = iVar11;
    *(int *)(local_b4 + 4 + local_178 * 8) = local_b8;
