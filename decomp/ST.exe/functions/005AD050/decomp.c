...
void FUN_005ad050(char param_1)

{
  ...
  if (((*(int *)(local_8 + 0x20bc) == 0) && (param_1 == '\0')) ||
     ((param_1 != '\0' && (*(char *)(local_8 + 0x20b4) == '\0')))) {
    thunk_FUN_005b68b0(DAT_0080759c,0,0,10,0xb4,0xf9,0x121,
                       (undefined4 *)(*(int *)(local_8 + 0x1a5b) + 0x140));
  }
  cVar1 = *(char *)(local_8 + 0x1a5f);
  if (((((cVar1 == '\f') || (cVar1 == '\x04')) || (cVar1 == '\x05')) || (cVar1 == '\x13')) &&
     (((*(int *)(local_8 + 0x20c0) == 0 && (param_1 == '\0')) ||
      ((param_1 != '\0' && (*(char *)(local_8 + 0x20b7) == '\0')))))) {
    thunk_FUN_005b69f0(DAT_0080759c,0,0,200,0x1f1,400,0x62,
                       (undefined4 *)(*(int *)(local_8 + 0x1a5b) + 0x140));
  }
  switch(*(undefined1 *)(local_8 + 0x1a5f)) {
  case 1:
  case 2:
  case 4:
  case 5:
