...

{
  ...
  if (DAT_007f4d50 == (undefined4 *)0x0) {
    RaiseInternalException
              (-2,g_overwriteContext_007ED77C,s_E____titans_wlad_Grpway3d_cpp_007a4ca8,0x55e);
    return;
  }
  ...
  if (DAT_007f4d54 == (undefined4 *)0x0) {
    RaiseInternalException
              (-2,g_overwriteContext_007ED77C,s_E____titans_wlad_Grpway3d_cpp_007a4ca8,0x567);
    return;
  }
