...

{
  ...
  if (g_sTAllPlayers_007FA174 != (STAllPlayersC *)0x0) {
    ...
    if (iVar6 == 0) {
      ...
      bVar14 = (byte)param_2;
      UVar7 = thunk_FUN_00523410(param_1,bVar14,0);
      DrawTitle(this_00,0x55fa,param_2,UVar7);
      DrawObj(this_00,(int *)&local_8,param_1,bVar14,this_00->field_0240);
      ...
      ccFntTy::WrStr(this_00->field_01E0,puVar8,iVar6,iVar15,uVar16);
      local_8 = local_8 + 0xf;
      UVar7 = 0;
      ...
      if (UVar7 != 0) {
        ...
        ccFntTy::WrStr(this_00->field_01E0,puVar8,iVar6,iVar15,uVar9);
        local_8 = local_8 + 0xf;
      }
      ccFntTy::SetSurf(this_00->field_01E0,(int)this_00->field_0218,0,0,local_8,0x91,0xf);
      uVar16 = 3;
      ...
      if (iVar6 != 0) {
        ...
        iVar15 = FUN_0070b3a0((AnonShape_GLOBAL_0081175C_57F682DD *)this_00->field_0238,
                              (-(uint)(param_2 != 3) & 0xfffffffe) + 3);
        FUN_006b5440((int)this_00->field_0218,0,0xb4,local_8,iVar15,0,0x3a);
        local_38 = 0xb4;
      ...
      if (iVar15 != 0) {
        ccFntTy::SetSurf(this_00->field_01E8,(int)this_00->field_0218,0,0x96,local_8 - 3,0x106,0x14)
        ;
        wsprintfA((LPSTR)&DAT_0080f33a,"%4d",iVar15);
        ccFntTy::WrStr(this_00->field_01E8,&DAT_0080f33a,1,-1,(DAT_0080874e != '\x03') - 1 & 4);
        iVar10 = FUN_0070b3a0((AnonShape_GLOBAL_0081175C_57F682DD *)this_00->field_0238,0);
      ...
      if (iVar10 != 0) {
        ...
        iVar11 = FUN_0070b3a0((AnonShape_GLOBAL_0081175C_57F682DD *)this_00->field_0238,2);
        FUN_006b5440((int)this_00->field_0218,0,0xb4,local_8,iVar11,0,0x3a);
        local_38 = 0xb4;
      ...
      do {
        ...
        pbVar12 = (byte *)FUN_0070b3a0((AnonShape_GLOBAL_0081175C_57F682DD *)this_00->field_0230,
                                       uVar9);
        DibPut((AnonShape_006B5B10_E0D06CF1 *)this_00->field_0218,0x96,local_8,'\x01',pbVar12);
        local_5c = 0x96;
      ...
      if (*(int *)(&DAT_007e3dc4 + iVar15 * 4) < (int)(local_10 + iVar6)) {
        local_10 = 0x5613;
      }
      else {
        local_10 = (((int)(local_10 + iVar6 * 2) <= *(int *)(&DAT_007e3dc4 + iVar15 * 4)) - 1 &
                   0xfffffffe) + 0x5616;
      }
      ccFntTy::SetSurf(this_00->field_01E0,(int)this_00->field_0218,0,0,local_8,0x91,0xf);
      uVar16 = 2;
      ...
      ccFntTy::WrStr(this_00->field_01E0,puVar8,iVar6,iVar10,uVar16);
      local_8 = local_8 + 0xf;
      ccFntTy::SetSurf(this_00->field_01E0,(int)this_00->field_0218,0,0x96,local_8,0x106,0xf);
      uVar9 = (DAT_0080874e != '\x03') - 1 & 5;
      iVar10 = -1;
      iVar6 = 1;
      puVar8 = (uint *)LoadResourceString(0x565a,HINSTANCE_00807618);
      ccFntTy::WrStr(this_00->field_01E0,puVar8,iVar6,iVar10,uVar9);
      ccFntTy::SetSurf(this_00->field_01E0,(int)this_00->field_0218,0,0,local_8,0x91,0xf);
      uVar16 = 2;
      iVar10 = -1;
      iVar6 = -3;
      puVar8 = (uint *)LoadResourceString(0x273f - (*(int *)(&DAT_00791b18 + iVar15 * 4) != 0),
                                          HINSTANCE_00807618);
      ccFntTy::WrStr(this_00->field_01E0,puVar8,iVar6,iVar10,uVar16);
      local_8 = local_8 + 0xf;
      iVar6 = param_1 + -0x32;
      ...
      iVar10 = -1;
      iVar6 = -3;
      puVar8 = (uint *)LoadResourceString((param_2 != 3) + 0x273e,HINSTANCE_00807618);
      ccFntTy::WrStr(this_00->field_01E0,puVar8,iVar6,iVar10,uVar16);
      local_8 = local_8 + 0xf;
      if (local_9 != '\0') {
        bVar13 = false;
        ...
        iVar15 = -1;
        iVar6 = -3;
        puVar8 = (uint *)LoadResourceString(0x273f - bVar13,HINSTANCE_00807618);
        ccFntTy::WrStr(this_00->field_01E0,puVar8,iVar6,iVar15,uVar16);
        local_8 = local_8 + 0xf;
        iVar15 = local_14;
      }
      if (param_2 != 3) {
        ...
        ccFntTy::WrStr(this_00->field_01E0,puVar8,iVar6,iVar10,uVar9);
        iVar6 = *(int *)(&DAT_007e29f0 + iVar15 * 4);
        ccFntTy::SetSurf(this_00->field_01E0,(int)this_00->field_0218,0,0,local_8,0x91,0xf);
        uVar16 = 2;
        iVar10 = -1;
        iVar15 = -3;
        puVar8 = (uint *)LoadResourceString(0x273f - (iVar6 != 0),HINSTANCE_00807618);
        ccFntTy::WrStr(this_00->field_01E0,puVar8,iVar15,iVar10,uVar16);
        local_8 = local_8 + 0xf;
        iVar15 = local_14;
        if (iVar6 != 0) {
          ccFntTy::SetSurf(this_00->field_01E0,(int)this_00->field_0218,0,0x96,local_8,0x106,0xf);
          ...
          ccFntTy::WrStr(this_00->field_01E0,puVar8,iVar15,iVar10,uVar9);
      ...
      iVar10 = -1;
      iVar6 = 1;
      puVar8 = (uint *)LoadResourceString(0x565b,HINSTANCE_00807618);
      ccFntTy::WrStr(this_00->field_01E0,puVar8,iVar6,iVar10,uVar9);
      local_10 = 0;
      uVar5 = 0;
      do {
        if ((&DAT_007e1988)[iVar15 * 3 + (uint)uVar5] != '\0') {
          local_10 = 0x273e;
          break;
        }
        uVar5 = uVar5 + 1;
      ...
      ccFntTy::WrStr(this_00->field_01E0,puVar8,iVar6,iVar15,uVar16);
      local_8 = local_8 + 0xf;
      UVar7 = thunk_FUN_00523410(param_1,bVar14,2);
    ...
    g_currentExceptionFrame = local_a0.previous;
    iVar15 = ReportDebugMessage("E:\\__titans\\Andrey\\helppan.cpp",0x7ec,0,iVar6,
