...
undefined4 __fastcall thunk_FUN_004ddd50(int *param_1)
    ...
    do {
      if (piVar5[0x137] != 0) {
        if (*piVar9 == 0) {
          ...
          iVar8 = piVar9[-2] + -0x96;
          iVar6 = thunk_FUN_004e60d0(param_1[9],iStack_8);
          iStack_c = *(int *)(&DAT_007e601c + (iVar6 + iVar8 * 5) * 4);
          ...
          if ((uint)(piVar9[2] + iStack_c) <= *(uint *)(DAT_00802a38 + 0xe4)) {
