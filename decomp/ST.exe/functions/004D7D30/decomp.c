...

{
  ...
  uVar4 = 0;
  iVar3 = param_2 * 0x44;
  if (param_4 <= *(int *)(&g_packedRecords_A62x8[iVar2].field_0x7e2 + iVar3)) {
    ...
    *(int *)(&g_packedRecords_A62x8[iVar2].field_0x7e2 + iVar3) =
         *(int *)(&g_packedRecords_A62x8[iVar2].field_0x7e2 + iVar3) - param_4;
    *(int *)(&g_packedRecords_A62x8[iVar2].field_0x812 + iVar3) =
         *(int *)(&g_packedRecords_A62x8[iVar2].field_0x812 + iVar3) - param_4;
    piVar5[2] = piVar5[2] - param_4;
    uVar4 = 1;
    if (*(int *)(&g_packedRecords_A62x8[iVar2].field_0x7e2 + iVar3) == 0) {
