...

{
  ...
  if (iVar2 != 0) {
    ...
    iVar4 = ReportDebugMessage(s_E____titans_grig_visible_cpp_007c92cc,0x105,0,iVar2,&DAT_007a4ccc,
    ...
    RaiseInternalException(iVar2,0,s_E____titans_grig_visible_cpp_007c92cc,0x106);
