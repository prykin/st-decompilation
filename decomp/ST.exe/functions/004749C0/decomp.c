...
LAB_00475068:
      ...
      if ((*(int *)(this->field_05A6 + 999) != 0) && (this->field_0716 < this->field_0712)) {
        ...
        if ((int)uVar3 == 0) {
          ...
          thunk_FUN_004d7480(*(char *)&this->field_0024,4,this->field_0018,(int)local_8,0,iVar21,0);
          iVar11 = thunk_FUN_004d7b10(*(char *)&this->field_0024,4);
          if (((int)local_8 <= iVar11) &&
             (iVar11 = thunk_FUN_004d7b90(*(char *)&this->field_0024,4), iVar21 <= iVar11)) {
            thunk_FUN_004d7c10(*(char *)&this->field_0024,4,this->field_0018,(int)local_8);
            thunk_FUN_004d7e50(*(char *)&this->field_0024,4,this->field_0018,iVar21);
...
switchD_00474a47_caseD_2:
    ...
    if (this->field_05C4 == 0) {
      ...
      case 3:
        this->field_05C0 = 0;
        iVar11 = STPlaySystemC::sub_006E62D0(g_playSystem_00802A38,this->field_05A2,(int *)&param_1);
        if (iVar11 != -4) {
