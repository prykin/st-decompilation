...

{
  ...
  if (DAT_00807598 != (void *)0x0) {
    ...
    pCVar6->field_00DF = local_218 >> 0x10;
    pCVar6->field_00E7 = (pCVar6->field_00C5 - pCVar6->field_04B2) - (local_218 >> 0x10);
    pCVar6->field_00E3 = local_214 >> 0x10;
    pCVar6->field_00EB = (pCVar6->field_00C9 - pCVar6->field_04B6) - (local_214 >> 0x10);
  }
  if (DAT_00802a38 == 0) {
    g_currentExceptionFrame = local_2c8.previous;
    return;
  }
  if (pCVar6->field_04DE != '\0') {
    if (((pCVar6->field_0494 == 0x48) && (piVar2 = (int *)pCVar6->field_049A, piVar2 != (int *)0x0))
       && (DAT_00801690 != (void *)0x0)) {
      iVar7 = (**(code **)(*piVar2 + 0x2c))();
      if (iVar7 == 0x78) {
        iVar7 = *(int *)(pCVar6->field_049A + 0x259);
      }
  ...
  sVar1 = pCVar6->field_0494;
  switch(sVar1) {
  case 1:
    switch(pCVar6->field_04A2) {
    case 3:
    case 10:
    case 0x2b:
      if (param_1 != 0) {
        ...
        if (DAT_007fa174 != (STAllPlayersC *)0x0) {
          local_4c = STAllPlayersC::GetScrObjList
                               (DAT_007fa174,(pCVar6->field_04A2 == 10) + 1,pCVar6->field_00DF,
                                pCVar6->field_00E3,pCVar6->field_00E7,pCVar6->field_00EB,
                                (int *)&local_9c);
        }
        if (local_4c != (ushort *)0x0) {
          ...
          if (local_94 != (char *)0x0) {
            *local_94 = (pCVar6->field_04A2 == 10) + '\x01';
            puVar10 = local_4c;
            pcVar11 = local_94 + 1;
    ...
    case 5:
      if (param_1 != 0) {
        ...
        if (DAT_007fa174 != (STAllPlayersC *)0x0) {
          local_1c = STAllPlayersC::GetScrObjList
                               (DAT_007fa174,3,pCVar6->field_00DF,pCVar6->field_00E3,
                                pCVar6->field_00E7,pCVar6->field_00EB,(int *)&local_a8);
        }
      ...
      *(undefined1 *)puVar14 = 0;
      ...
      local_1e4[0] = 1;
      local_1c7 = *(undefined4 *)(pCVar6->field_049A + 0x18);
      puVar15 = (uint *)local_1e4;
      puVar14 = (undefined4 *)0x17;
      goto cf_common_join_0054A19A;
    case 0xe:
      if (DAT_007fb2ac != 0) {
        local_b8 = *(undefined4 *)&pCVar6->field_0x4aa;
        local_b4 = 0;
        local_b0 = 0;
        local_ac = 0;
        if (*(int *)(DAT_007fb2ac + 0x24) != 0) {
          ...
          if (*(int *)(DAT_007fb2ac + 0x24) != 0) {
            ...
            iVar7 = FUN_006e1dd0(DAT_00807598,pCVar6->field_00C5 - pCVar6->field_04B2,
                                 pCVar6->field_00C9 - pCVar6->field_04B6,&local_10,&local_c,
                                 (float *)&local_8);
            if (iVar7 != 0) {
    ...
    case 0x2c:
      ...
      break;
    case 0x4e:
      local_f4 = (uint)(byte)pCVar6->field_0x4aa;
      local_f0 = 0;
      local_ec = 0;
      local_e8 = 0;
      local_e4 = 0;
      ...
      lVar13 = Library::MSVCRT::__ftol();
      uStack_e3 = pCVar6->field_00FB;
      local_ec._1_3_ = (undefined3)lVar13;
      puVar15 = &local_f4;
      local_e8._1_3_ = (undefined3)pCVar6->field_00F7;
      local_e8 = CONCAT31(local_e8._1_3_,(char)((ulonglong)lVar13 >> 0x18));
      local_e4 = (undefined1)((uint)pCVar6->field_00F7 >> 0x18);
      goto LAB_0054a196;
    }
    break;
  case 2:
  ...
  case 0xc:
    if (param_1 != 0) {
      ...
      if (DAT_007fa174 != (STAllPlayersC *)0x0) {
        local_3c = STAllPlayersC::GetScrObjList
                             (DAT_007fa174,(sVar1 == 0xc) + 1,pCVar6->field_00DF,pCVar6->field_00E3,
                              pCVar6->field_00E7,pCVar6->field_00EB,(int *)&local_98);
      }
      if (local_3c != (ushort *)0x0) {
        ...
        if (local_20 != (ushort *)0x0) {
          *(char *)local_20 = (pCVar6->field_0494 == 0xc) + '\x01';
          puVar10 = local_3c;
    ...
    if ((void *)pCVar6->field_049A == (void *)0x0) {
      iVar7 = FUN_006e1dd0(DAT_00807598,pCVar6->field_00C5 - pCVar6->field_04B2,
                           pCVar6->field_00C9 - pCVar6->field_04B6,&local_10,&local_c,
                           (float *)&local_8);
      if (iVar7 == 0) break;
      ...
      thunk_FUN_004162b0((void *)pCVar6->field_049A,(undefined2 *)local_5e,(undefined2 *)local_30,
                         (undefined2 *)local_32);
      local_11b = local_5e[0];
      local_11a = local_30[0];
      local_119 = local_32[0];
      local_120[0] = (pCVar6->field_0494 != 0xc) - 1U & 5;
      local_120._1_4_ = *(undefined4 *)(pCVar6->field_049A + 0x18);
      puVar15 = (uint *)local_120;
      puVar14 = (undefined4 *)0x16;
    }
    goto cf_common_join_0054A19A;
  ...
  case 0xb:
    ...
    local_160[0] = 1;
    local_160._1_4_ = *(undefined4 *)(pCVar6->field_049A + 0x18);
  ...
  case 0xe:
      ...
      if (sVar1 == 0xd) {
        ...
        if (DAT_007fa174 != (STAllPlayersC *)0x0) {
          local_44 = STAllPlayersC::GetScrObjList
                               (DAT_007fa174,3,pCVar6->field_00DF,pCVar6->field_00E3,
                                pCVar6->field_00E7,pCVar6->field_00EB,(int *)&local_a0);
        }
    ...
    *(undefined1 *)puVar14 = 0;
    ...
    local_1c0[0] = 1;
    local_1a3 = *(undefined4 *)(pCVar6->field_049A + 0x18);
  ...
  case 0x10:
    iVar7 = FUN_006e1dd0(DAT_00807598,pCVar6->field_00C5 - pCVar6->field_04B2,
                         ...
                         (float *)&local_8);
    if (iVar7 != 0) {
      local_19c = ((pCVar6->field_0494 != 0xf) - 1U & 0xf2) + 0x10;
      lVar13 = Library::MSVCRT::__ftol();
  ...
  case 0x12:
  case 0x13:
    if ((void *)pCVar6->field_049A == (void *)0x0) break;
    local_d0 = (sVar1 != 0x12) + '\x01';
    thunk_FUN_004162b0((void *)pCVar6->field_049A,&local_cf,&local_cd,&local_cb);
    puVar15 = (uint *)&local_d0;
    puVar14 = (undefined4 *)0x1f;
    goto cf_common_join_0054A19A;
  case 0x14:
    if (DAT_007fb2ac != 0) {
      local_c8 = *(undefined4 *)&pCVar6->field_0x4aa;
      local_c4 = 0;
      local_c0 = 0;
      local_bc = 0;
      if (*(int *)(DAT_007fb2ac + 0x24) != 0) {
  ...
  case 0x18:
    ...
    *(undefined1 *)puVar14 = 0;
    ...
    local_260[0] = ((pCVar6->field_0494 != 0x18) - 1U & 0xeb) + 0x18;
    puVar15 = (uint *)local_260;
    puVar14 = (undefined4 *)0x17;
    goto cf_common_join_0054A19A;
  case 0x17:
    if (pCVar6->field_049A == 0) break;
    uVar4 = *(undefined4 *)(pCVar6->field_049A + 0x18);
  ...
  case 0x1b:
    ...
    *(undefined1 *)puVar14 = 0;
    ...
    goto cf_common_join_0054A19A;
  case 0x1c:
    local_108 = (uint)(byte)pCVar6->field_0x4aa;
    local_104 = 0;
    local_100 = 0;
    local_fc = 0;
    local_f8 = 0;
    ...
    lVar13 = Library::MSVCRT::__ftol();
    uStack_f7 = pCVar6->field_00FB;
    local_100._1_3_ = (undefined3)lVar13;
    puVar15 = &local_108;
    local_fc._1_3_ = (undefined3)pCVar6->field_00F7;
    local_fc = CONCAT31(local_fc._1_3_,(char)((ulonglong)lVar13 >> 0x18));
    local_f8 = (undefined1)((uint)pCVar6->field_00F7 >> 0x18);
LAB_0054a196:
    puVar14 = (undefined4 *)0x18;
    goto cf_common_join_0054A19A;
  case 0x1d:
    if (pCVar6->field_04A2 == 0x18) {
      iVar7 = FUN_006e1dd0(DAT_00807598,pCVar6->field_00C5 - pCVar6->field_04B2,
                           pCVar6->field_00C9 - pCVar6->field_04B6,&local_10,&local_c,
                           (float *)&local_8);
      if (iVar7 == 0) break;
    ...
    local_e0 = 2;
    local_d4 = 0;
    thunk_FUN_004162b0((void *)pCVar6->field_049A,&local_64,&local_4e,&local_7a);
...
LAB_00549b36:
  ...
  case 0x1e:
    ...
    uStack_27 = 0;
    local_26 = 0;
    thunk_FUN_004162b0((void *)pCVar6->field_049A,&local_5c,&local_5a,&local_34);
    uStack_2b = local_5c;
...
switchD_00548db5_caseD_3:
  if (((pCVar6->field_04A2 != 0) && (pCVar6->field_00D3 == '\0')) &&
     (pCVar6->field_04A6 = 1, DAT_00801688 != (void *)0x0)) {
