...

{
  ...
  iVar6 = __setjmp3(local_2c4,0,unaff_EDI,unaff_ESI);
  if (iVar6 != 0) {
  ...
  if (DAT_00807598 != (void *)0x0) {
    ...
    *(int *)(local_124 + 0xdf) = local_218 >> 0x10;
    *(int *)(local_124 + 0xe7) =
         (*(int *)(local_124 + 0xc5) - *(int *)(local_124 + 0x4b2)) - (local_218 >> 0x10);
    *(int *)(local_124 + 0xe3) = local_214 >> 0x10;
    *(int *)(local_124 + 0xeb) =
         (*(int *)(local_124 + 0xc9) - *(int *)(local_124 + 0x4b6)) - (local_214 >> 0x10);
  }
  if (DAT_00802a38 == 0) {
    DAT_00858df8 = (undefined4 *)local_2c8;
    return;
  }
  if (*(char *)(local_124 + 0x4de) != '\0') {
    if (((*(short *)(local_124 + 0x494) == 0x48) &&
        (piVar2 = *(int **)(local_124 + 0x49a), piVar2 != (int *)0x0)) &&
       (DAT_00801690 != (void *)0x0)) {
      iVar6 = (**(code **)(*piVar2 + 0x2c))();
      if (iVar6 == 0x78) {
        iVar6 = *(int *)(*(int *)(local_124 + 0x49a) + 0x259);
      }
      iVar7 = (**(code **)(*piVar2 + 0xc))();
      thunk_FUN_00514bc0(DAT_00801690,iVar6,iVar7);
      *(undefined1 *)(local_124 + 0x4de) = 0;
    }
    goto switchD_00548db5_caseD_3;
  }
  sVar1 = *(short *)(local_124 + 0x494);
  switch(sVar1) {
  case 1:
    switch(*(int *)(local_124 + 0x4a2)) {
    case 3:
    case 10:
    case 0x2b:
      if (param_1 != 0) {
        local_4c = (ushort *)0x0;
        if (DAT_007fa174 != 0) {
          local_4c = thunk_FUN_0044c720((*(int *)(local_124 + 0x4a2) == 10) + 1,
                                        *(int *)(local_124 + 0xdf),*(int *)(local_124 + 0xe3),
                                        *(int *)(local_124 + 0xe7),*(int *)(local_124 + 0xeb),
                                        (int *)&local_9c);
        }
        if (local_4c != (ushort *)0x0) {
          ...
          if (local_94 != (char *)0x0) {
            *local_94 = (*(int *)(local_124 + 0x4a2) == 10) + '\x01';
            puVar9 = local_4c;
            pcVar10 = local_94 + 1;
    ...
    case 5:
      if (param_1 != 0) {
        local_1c = (ushort *)0x0;
        if (DAT_007fa174 != 0) {
          local_1c = thunk_FUN_0044c720(3,*(int *)(local_124 + 0xdf),*(int *)(local_124 + 0xe3),
                                        *(int *)(local_124 + 0xe7),*(int *)(local_124 + 0xeb),
                                        (int *)&local_a8);
        }
      ...
      *(undefined1 *)puVar13 = 0;
      ...
      local_1e4[0] = 1;
      local_1c7 = *(undefined4 *)(*(int *)(local_124 + 0x49a) + 0x18);
      puVar14 = (uint *)local_1e4;
      puVar13 = (undefined4 *)0x17;
      goto LAB_0054a19a;
    case 0xe:
      if (DAT_007fb2ac != 0) {
        local_b8 = *(undefined4 *)(local_124 + 0x4aa);
        local_b4 = 0;
        local_b0 = 0;
        local_ac = 0;
        if (*(int *)(DAT_007fb2ac + 0x24) != 0) {
          ...
          if (*(int *)(DAT_007fb2ac + 0x24) != 0) {
            ...
            iVar6 = FUN_006e1dd0(DAT_00807598,
                                 *(int *)(local_124 + 0xc5) - *(int *)(local_124 + 0x4b2),
                                 *(int *)(local_124 + 0xc9) - *(int *)(local_124 + 0x4b6),&local_10,
    ...
    case 0x2c:
      ...
      break;
    case 0x4e:
      local_f4 = (uint)*(byte *)(local_124 + 0x4aa);
      local_f0 = 0;
      local_ec = 0;
      local_e8 = 0;
      local_e4 = 0;
      ...
      lVar12 = __ftol();
      uStack_e3 = *(undefined1 *)(local_124 + 0xfb);
      local_ec._1_3_ = (undefined3)lVar12;
      puVar14 = &local_f4;
      local_e8._1_3_ = (undefined3)*(undefined4 *)(local_124 + 0xf7);
      local_e8 = CONCAT31(local_e8._1_3_,(char)((ulonglong)lVar12 >> 0x18));
      local_e4 = (undefined1)((uint)*(undefined4 *)(local_124 + 0xf7) >> 0x18);
      goto LAB_0054a196;
    }
    break;
  case 2:
  ...
  case 0xc:
    if (param_1 != 0) {
      local_3c = (ushort *)0x0;
      if (DAT_007fa174 != 0) {
        local_3c = thunk_FUN_0044c720((sVar1 == 0xc) + 1,*(int *)(local_124 + 0xdf),
                                      *(int *)(local_124 + 0xe3),*(int *)(local_124 + 0xe7),
                                      *(int *)(local_124 + 0xeb),(int *)&local_98);
      }
      if (local_3c != (ushort *)0x0) {
        local_18 = (undefined4 *)(local_98 + 1);
        local_20 = (ushort *)FUN_006aac10((uint)local_18);
        if (local_20 != (ushort *)0x0) {
          *(char *)local_20 = (*(short *)(local_124 + 0x494) == 0xc) + '\x01';
          puVar9 = local_3c;
    ...
    if (*(void **)(local_124 + 0x49a) == (void *)0x0) {
      iVar6 = FUN_006e1dd0(DAT_00807598,*(int *)(local_124 + 0xc5) - *(int *)(local_124 + 0x4b2),
                           *(int *)(local_124 + 0xc9) - *(int *)(local_124 + 0x4b6),&local_10,
                           &local_c,(float *)&local_8);
      if (iVar6 == 0) break;
      lVar12 = __ftol();
      ...
      thunk_FUN_004162b0(*(void **)(local_124 + 0x49a),(undefined2 *)local_5e,(undefined2 *)local_30
                         ,(undefined2 *)local_32);
      local_11b = local_5e[0];
      local_11a = local_30[0];
      local_119 = local_32[0];
      local_120[0] = (*(short *)(local_124 + 0x494) != 0xc) - 1U & 5;
      local_120._1_4_ = *(undefined4 *)(*(int *)(local_124 + 0x49a) + 0x18);
      puVar14 = (uint *)local_120;
      puVar13 = (undefined4 *)0x16;
    }
    goto LAB_0054a19a;
  ...
  case 6:
    iVar6 = FUN_006e1dd0(DAT_00807598,*(int *)(local_124 + 0xc5) - *(int *)(local_124 + 0x4b2),
                         *(int *)(local_124 + 0xc9) - *(int *)(local_124 + 0x4b6),&local_10,&local_c
                         ,(float *)&local_8);
    if (iVar6 != 0) {
      lVar12 = __ftol();
  ...
  case 0xb:
    ...
    local_160[0] = 1;
    local_160._1_4_ = *(undefined4 *)(*(int *)(local_124 + 0x49a) + 0x18);
  ...
  case 0xe:
    if (param_1 != 0) {
      if (sVar1 == 0xd) {
        local_44 = (ushort *)0x0;
        if (DAT_007fa174 != 0) {
          local_44 = thunk_FUN_0044c720(3,*(int *)(local_124 + 0xdf),*(int *)(local_124 + 0xe3),
                                        *(int *)(local_124 + 0xe7),*(int *)(local_124 + 0xeb),
                                        (int *)&local_a0);
        }
    ...
    *(undefined1 *)puVar13 = 0;
    ...
    local_1c0[0] = 1;
    local_1a3 = *(undefined4 *)(*(int *)(local_124 + 0x49a) + 0x18);
  ...
  case 0x10:
    iVar6 = FUN_006e1dd0(DAT_00807598,*(int *)(local_124 + 0xc5) - *(int *)(local_124 + 0x4b2),
                         *(int *)(local_124 + 0xc9) - *(int *)(local_124 + 0x4b6),&local_10,&local_c
                         ,(float *)&local_8);
    if (iVar6 != 0) {
      local_19c = ((*(short *)(local_124 + 0x494) != 0xf) - 1U & 0xf2) + 0x10;
      lVar12 = __ftol();
  ...
  case 0x12:
  case 0x13:
    if (*(void **)(local_124 + 0x49a) == (void *)0x0) break;
    local_d0 = (sVar1 != 0x12) + '\x01';
    thunk_FUN_004162b0(*(void **)(local_124 + 0x49a),&local_cf,&local_cd,&local_cb);
    puVar14 = (uint *)&local_d0;
    puVar13 = (undefined4 *)0x1f;
    goto LAB_0054a19a;
  case 0x14:
    if (DAT_007fb2ac != 0) {
      local_c8 = *(undefined4 *)(local_124 + 0x4aa);
      local_c4 = 0;
      local_c0 = 0;
      local_bc = 0;
      if (*(int *)(DAT_007fb2ac + 0x24) != 0) {
  ...
  case 0x18:
    ...
    *(undefined1 *)puVar13 = 0;
    ...
    local_260[0] = ((*(short *)(local_124 + 0x494) != 0x18) - 1U & 0xeb) + 0x18;
    puVar14 = (uint *)local_260;
    puVar13 = (undefined4 *)0x17;
    goto LAB_0054a19a;
  case 0x17:
    if (*(int *)(local_124 + 0x49a) == 0) break;
    uVar4 = *(undefined4 *)(*(int *)(local_124 + 0x49a) + 0x18);
  ...
  case 0x1b:
    ...
    *(undefined1 *)puVar13 = 0;
    ...
    goto LAB_0054a19a;
  case 0x1c:
    local_108 = (uint)*(byte *)(local_124 + 0x4aa);
    local_104 = 0;
    local_100 = 0;
    local_fc = 0;
    local_f8 = 0;
    ...
    lVar12 = __ftol();
    uStack_f7 = *(undefined1 *)(local_124 + 0xfb);
    local_100._1_3_ = (undefined3)lVar12;
    puVar14 = &local_108;
    local_fc._1_3_ = (undefined3)*(undefined4 *)(local_124 + 0xf7);
    local_fc = CONCAT31(local_fc._1_3_,(char)((ulonglong)lVar12 >> 0x18));
    local_f8 = (undefined1)((uint)*(undefined4 *)(local_124 + 0xf7) >> 0x18);
LAB_0054a196:
    puVar13 = (undefined4 *)0x18;
    goto LAB_0054a19a;
  case 0x1d:
    if (*(int *)(local_124 + 0x4a2) == 0x18) {
      iVar6 = FUN_006e1dd0(DAT_00807598,*(int *)(local_124 + 0xc5) - *(int *)(local_124 + 0x4b2),
                           *(int *)(local_124 + 0xc9) - *(int *)(local_124 + 0x4b6),&local_10,
                           &local_c,(float *)&local_8);
      if (iVar6 == 0) break;
    ...
    local_e0 = 2;
    local_d4 = 0;
    thunk_FUN_004162b0(*(void **)(local_124 + 0x49a),&local_64,&local_4e,&local_7a);
...
LAB_00549b36:
  ...
  case 0x1e:
    ...
    uStack_27 = 0;
    local_26 = 0;
    thunk_FUN_004162b0(*(void **)(local_124 + 0x49a),&local_5c,&local_5a,&local_34);
    uStack_2b = local_5c;
...
switchD_00548db5_caseD_3:
  if (((*(int *)(local_124 + 0x4a2) != 0) && (*(char *)(local_124 + 0xd3) == '\0')) &&
     (*(undefined4 *)(local_124 + 0x4a6) = 1, DAT_00801688 != (void *)0x0)) {
