...

{
  ...
  if (iVar4 == 0) {
    ...
    iVar9 = -1;
    iVar4 = 0;
    puVar6 = (uint *)FUN_006b0140(0x256b,HINSTANCE_00807618);
    ...
    iVar9 = -1;
    iVar4 = 0;
    puVar6 = (uint *)FUN_006b0140(0x256d,HINSTANCE_00807618);
    ccFntTy::WrStr(pFVar3->field_1A73,puVar6,iVar4,iVar9,uVar10);
    FUN_006c7570((AnonShape_006C7570_82D7EB54 *)pFVar3->field_1AC0,0,0x19,0xc5,(undefined4 *)0x186,
                 0x19,4,0xf);
    FUN_006c7570((AnonShape_006C7570_82D7EB54 *)pFVar3->field_1AC0,0,0x1b,199,(undefined4 *)0x182,
                 0x15,4,0xf);
  ...
  g_currentExceptionFrame = local_4c.previous;
  iVar9 = ReportDebugMessage(s_E____titans_Start_fsgs_obj_cpp_007cbf70,0x418,0,iVar4,&DAT_007a4ccc,
                             s_FSGSTy__PaintGameNew_007cc230);
  if (iVar9 != 0) {
    pcVar2 = (code *)swi(3);
    (*pcVar2)();
    return;
  }
  RaiseInternalException(iVar4,0,s_E____titans_Start_fsgs_obj_cpp_007cbf70,0x418);
  return;
}
