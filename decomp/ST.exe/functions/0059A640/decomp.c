...

{
  ...
  if (iVar2 == 0) {
    ...
    FUN_007119c0(puVar4,iVar2,iVar7,uVar8);
    FUN_006c7570(*(int *)(local_8 + 0x1ac0),0,0x19,0xc5,(undefined4 *)0x186,0x19,4,0xf);
    FUN_006c7570(*(int *)(local_8 + 0x1ac0),0,0x1b,199,(undefined4 *)0x182,0x15,4,0xf);
