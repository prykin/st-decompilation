...

{
  ...
  if (iVar3 == 0) {
    ...
    iVar8 = -1;
    iVar3 = 0;
    puVar5 = (uint *)FUN_006b0140(0x256b,HINSTANCE_00807618);
  ...
  g_currentExceptionFrame = local_4c.previous;
  iVar8 = ReportDebugMessage(s_E____titans_Start_fsgs_obj_cpp_007cbf70,0x418,0,iVar3,&DAT_007a4ccc,
  ...
  RaiseInternalException(iVar3,0,s_E____titans_Start_fsgs_obj_cpp_007cbf70,0x418);
  return;
}
