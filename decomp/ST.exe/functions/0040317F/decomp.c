...
void __thiscall STAllPlayersC::ActivateTV(STAllPlayersC *this,char param_1,int param_2,int param_3)
  ...
  if (0 < param_3) {
    if (*piVar8 == 0) {
      ...
      *piVar8 = *piVar7;
      ...
      piVar8[2] = piVar7[2];
      piVar8[3] = piVar7[3];
      Library::MSVCRT::FUN_0072da70(piVar7,piVar8 + (param_3 + 1) * 4,param_3 * -0x10 + 0x40);
      piVar8[0x10] = 0;
      piVar8[0x11] = 0xff;
      *(undefined4 *)((int)piVar8 + 0x4a) = 0;
      ...
      Library::MSVCRT::FUN_0072da70(piVar8 + 4,piVar8,param_3 * 0x10);
      *piVar8 = iVar5;
      piVar8[1] = iVar1;
      piVar8[2] = iVar2;
      piVar8[3] = iVar3;
