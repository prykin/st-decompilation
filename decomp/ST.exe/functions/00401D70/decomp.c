...

{
  ...
  uVar4 = uVar1;
  if (uVar1 != 0) {
    while (uStack_c = uVar4, uVar1 = uVar1 - 1, -1 < (int)uVar1) {
      FUN_006acc70(*(int *)(pSVar3 + 0x47b),uVar1,&iStack_20);
      uVar4 = uVar1;
      if (((sStack_1c != -1) && (uVar4 = uStack_c, iStack_20 == param_1)) && (sStack_1c == param_2))
      {
