...

{
  ...
  iVar2 = thunk_FUN_005845b0(iVar2,(int)param_1->field_0239 - (int)param_1->field_004B,iVar5,iVar7,
                             iVar6,iVar4,piVar9,piVar10,piVar11,uVar3);
  if (iVar2 == 0) {
    thunk_FUN_00417ff0(param_1,bVar8);
    thunk_FUN_00418010(param_1,bVar8 - 1);

    iVar2 = SubmarineTitans::Recovered::HiddenThis::RecoveredReceiver_004167A0::thunk_FUN_00418030
                      ((RecoveredReceiver_004167A0 *)param_1,param_1->field_0235,param_1->field_0237
                       ,param_1->field_0239);
    if (iVar2 != 0) {
  ...
  if ((iVar2 != 0) &&
     ...
     (iVar2 = SubmarineTitans::Recovered::HiddenThis::RecoveredReceiver_004167A0::thunk_FUN_00418030
                        ((RecoveredReceiver_004167A0 *)param_1,param_1->field_0235,
