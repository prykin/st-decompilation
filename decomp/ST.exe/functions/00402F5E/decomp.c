...

{
  ...
  *(undefined4 *)(this + 0x61) = *(undefined4 *)(this + 0x69);
  ...
  pMStack_10[0x6e] = (MTaskTy)param_1;
  if (param_1 == '\0') {
    pMStack_10[0x6f] = param_2;
  }
  else {
    pMStack_10[0x6f] = (MTaskTy)0x0;
  }
  if (pMStack_10[0x6e] == (MTaskTy)0x1) {
  ...
  *(int *)(pMVar3 + 0x74) = iVar4;
  if (iVar4 == 0) {
    ...
    *(uint **)(pMVar3 + 0x74) = puVar7;
    ...
    Library::DKW::TBL::FUN_006ae1c0(puVar7,auStack_a4);
  }
