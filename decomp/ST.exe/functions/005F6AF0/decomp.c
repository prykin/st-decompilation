...

{
  ...
  if (iVar2 == 0) {
    ...
    if (param_1 == 0) {
      STT3DSprC::LoadSequence
                ((STT3DSprC *)this_00,8,DAT_00806774,
                 (byte *)(s_Expb12_007ce718 + *(int *)&local_8[1].field_0x12 * 0x39),0x1d);
      STT3DSprC::LoadSequence
                ((STT3DSprC *)this_00,9,DAT_00806764,
                 (byte *)(s_expl_bbt0_007ce723 + *(int *)&this_01[1].field_0x12 * 0x39),0x1d);
      STT3DSprC::LoadSequence
                ((STT3DSprC *)this_00,10,DAT_00806774,
                 (byte *)(s_expmask3_007ce72e + *(int *)&this_01[1].field_0x12 * 0x39),0x1d);
    ...
    iVar2 = STT3DSprC::LoadSequence
                      ((STT3DSprC *)this_00,0xe,DAT_00806774,(byte *)s_coll3_007ce6d8,0x1d);
    if (iVar2 == 0) {
      ...
      iVar2 = STT3DSprC::LoadSequence
                        ((STT3DSprC *)this_00,0xc,DAT_00806774,
                         (&PTR_s_col3l0_007ce6e0)[*(int *)&this_01->field_0x235],0x1d);
      if (iVar2 != 0) {
        return local_c;
      }
      ...
      if (*(char *)&this_01[1].vtable != '\0') {
        thunk_FUN_0041c5a0((int *)this_01);
      }
      *(undefined1 *)&this_01[1].vtable = 0;
      g_currentExceptionFrame = local_50.previous;
      return local_c;
    }
  }
