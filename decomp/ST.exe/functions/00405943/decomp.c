...

{
  ...
  case 1:
    ...
    if ((((((sVar3 == iVar8) && (iStack_28 == *(short *)((int)param_1 + 0x49))) &&
          (uVar9 = (uint)*(short *)((int)param_1 + 0x4b), uStack_1c == uVar9)) ||
...
LAB_005829f4:
      ...
      if (((((((-1 < sVar3) && (sVar3 < DAT_007fb240)) && (-1 < sVar5)) &&
        ...
        uStack_1c = CONCAT31(uStack_1c._1_3_,bVar1);
        iStack_28 = CONCAT31(iStack_28._1_3_,bVar2);
...
LAB_00582bb0:
            ...
            uVar9 = (uint)bVar1;
            uVar12 = (uint)bVar2;
            cStack_5 = *(char *)(uVar12 + uVar9 * 8 + 0x142f + iVar8);
            if ((cStack_5 == '\0') && (*(char *)(uVar9 + uVar12 * 8 + 0x142f + iVar8) == '\0')) {
              iVar8 = -2;
            }
            else if ((cStack_5 == '\x01') &&
                    (*(char *)(uVar9 + uVar12 * 8 + 0x142f + iVar8) == '\0')) {
              iVar8 = -1;
            }
            else if ((cStack_5 == '\0') &&
                    (*(char *)(uVar9 + uVar12 * 8 + 0x142f + iVar8) == '\x01')) {
              iVar8 = 1;
            }
            else {
              if ((cStack_5 != '\x01') || (*(char *)(uVar9 + uVar12 * 8 + 0x142f + iVar8) != '\x01')
                 ) goto LAB_00582bb0;
              iVar8 = 2;
            }
          }
          ...
          iStack_2c = iVar8 + (uint)bVar2 * 0x48;
          bVar7 = *(char *)((uint)bVar2 * 9 + 0x11ca + iStack_2c) !=
...
LAB_00582958:
  ...
  case 4:
    ...
    return;
  case 3:
    iVar8 = thunk_FUN_00415ed0(param_1,&uStack_24,&uStack_20);
