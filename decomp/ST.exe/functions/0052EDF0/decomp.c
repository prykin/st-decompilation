...

{
  ...
  if (iVar4 == 0) {
    ...
    if (param_2 != 0) {
      ...
      do {
        pbVar5 = (byte *)FUN_0070b3a0(*(int *)&pOVar2->field_0x198,6);
        thunk_FUN_00540760(*(undefined4 **)&pOVar2->field_0x68,iVar4,local_c,'\x01',pbVar5);
        iVar4 = iVar4 + 4;
        local_10 = local_10 - 1;
      } while (local_10 != 0);
    }
    if ((byte)local_8 < 0x1e) {
      ...
      do {
        pbVar5 = (byte *)FUN_0070b3a0(*(int *)&pOVar2->field_0x198,0);
        thunk_FUN_00540760(*(undefined4 **)&pOVar2->field_0x68,iVar4,local_c,'\x01',pbVar5);
        iVar4 = iVar4 + 4;
        iVar6 = iVar6 + -1;
      } while (iVar6 != 0);
