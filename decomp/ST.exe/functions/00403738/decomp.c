...
void __cdecl thunk_FUN_005403c0(int param_1,int param_2,char param_3,BITMAPINFO *param_4)

{
  ...
  if ((DAT_0080759c != 0) && (param_4 != (BITMAPINFO *)0x0)) {
    ...
    DAT_00858df8 = (undefined1 *)uVar4;
    iVar3 = FUN_006ad4d0(s_E____titans_Andrey_support_cpp_007c7b2c,0x14,0,iVar2,&DAT_007a4ccc);
    if (iVar3 != 0) {
      pcVar1 = (code *)swi(3);
      (*pcVar1)();
      return;
    }
    FUN_006a5e40(iVar2,0,0x7c7b2c,0x14);
  }
  return;
}
