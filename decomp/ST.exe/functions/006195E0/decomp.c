...
undefined4 FUN_006195e0(int param_1)

{
  ...
  if (iVar2 == 0) {
    if (param_1 == 1) {
      ...
      FUN_006ea270(DAT_00807598,*puVar6,0,*(uint *)(local_8 + 0xab));
      uVar5 = *(undefined4 *)puVar3;
      *(ushort **)(local_8 + 0x9b) = puVar3;
      *(undefined4 *)(local_8 + 0xaf) = uVar5;
      if (DAT_00807326 != '\0') {
        FUN_006e9520(DAT_00807598,*puVar6,0,0x401109,local_8 + 0x4d);
      }
    }
    else {
      puVar6 = (uint *)(local_8 + 0x97);
      if (-1 < (int)*(uint *)(local_8 + 0x97)) {
        FUN_006e9520(DAT_00807598,*(uint *)(local_8 + 0x97),0,0,local_8);
      ...
      FUN_006e98e0(DAT_00807598,*puVar6,0,*(undefined4 *)puVar3,*(int *)((int)puVar3 + 0x21),1);
      FUN_006ea270(DAT_00807598,*puVar6,0,*(uint *)(local_8 + 0xab));
      *(undefined4 *)(local_8 + 0xaf) = *(undefined4 *)puVar3;
      ...
      FUN_006ea270(DAT_00807598,*puVar6,1,*(uint *)(local_8 + 0xbc));
      FUN_006ea800(DAT_00807598,*puVar6,1,1);
      FUN_006ea790(DAT_00807598,*puVar6,DAT_008032b8,0x10);
      *(undefined4 *)(local_8 + 0xc0) = *(undefined4 *)puVar3;
      *(undefined1 *)(local_8 + 0xbb) = 1;
      ...
      FUN_006ea270(DAT_00807598,*puVar6,2,*(uint *)(local_8 + 0xb7));
      FUN_006e9d40(DAT_00807598,(uint *)*puVar6,2);
      *(undefined4 *)(local_8 + 0xb3) = *(undefined4 *)puVar3;
    }
    FUN_006ea960(DAT_00807598,*puVar6,
                 (float)*(int *)(local_8 + 0x9f) * _DAT_007904f8 * _DAT_007904f0,
                 (float)*(int *)(local_8 + 0xa3) * _DAT_007904f8 * _DAT_007904f0,
                 (float)*(int *)(local_8 + 0xa7) * _DAT_007904f8 * _DAT_007904f0 + _DAT_007904fc);
