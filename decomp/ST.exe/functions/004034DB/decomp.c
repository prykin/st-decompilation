...
undefined4 thunk_FUN_004eb300(uint param_1,int param_2,int param_3,int param_4)

{
  ...
  if ((char)iVar1 == '\x03') {
    if (param_2 == 0xdd) {
      iVar1 = *(int *)(&DAT_007f57ca + param_1 * 0xa62);
      iVar2 = thunk_FUN_004d89b0(cVar3);
      if (iVar2 < param_4) goto LAB_004eb53a;
      thunk_FUN_004d8940(cVar3,param_4);
      param_4 = iVar1 * param_4;
    }
    else if (param_2 == 0xe2) {
      iVar1 = *(int *)(&DAT_007f57da + param_1 * 0xa62);
    ...
    if (param_4 == 0) goto LAB_004eb53a;
    if (param_3 != 0xdd) {
      if (param_3 == 0xe2) {
        thunk_FUN_004e4380(param_1,*(int *)(&DAT_007f57d2 + param_1 * 0xa62) * param_4);
      }
    ...
    iVar1 = param_4 / *(int *)((int)&DAT_007f57c2 + param_1 * 0xa62);
  }
  else {
    if (param_2 == 0xdc) {
      iVar1 = thunk_FUN_004d8870(cVar3);
      if (iVar1 < param_4) goto LAB_004eb53a;
      ...
      if (param_2 != 0xde) goto LAB_004eb53a;
      iVar1 = *(int *)(&DAT_007f57da + param_1 * 0xa62);
      iVar2 = thunk_FUN_004d8af0(cVar3);
      if (iVar2 < param_4) goto LAB_004eb53a;
    ...
    if (param_3 != 0xdd) {
      if (param_3 == 0xde) {
        thunk_FUN_004d8a30(cVar3,*(int *)(&DAT_007f57d2 + param_1 * 0xa62) * param_4);
      }
      goto LAB_004eb53a;
    }
    iVar1 = *(int *)((int)&DAT_007f57c2 + param_1 * 0xa62) * param_4;
  }
