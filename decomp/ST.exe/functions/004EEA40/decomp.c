...

{
  ...
  iVar9 = Library::MSVCRT::__setjmp3(local_b8.jumpBuffer,0,unaff_EDI,unaff_ESI);
  this_00 = local_1c;
  if (iVar9 != 0) {
    g_currentExceptionFrame = local_b8.previous;
    iVar8 = ReportDebugMessage(s_E____titans_Andrey_bldboat_cpp_007c17b4,0x3f,0,iVar9,&DAT_007a4ccc,
                               s_BldBoatPanelTy__InitBldBoatPanel_007c17dc);
    if (iVar8 == 0) {
      RaiseInternalException(iVar9,0,s_E____titans_Andrey_bldboat_cpp_007c17b4,0x3f);
      return;
    }
    pcVar2 = (code *)swi(3);
    (*pcVar2)();
