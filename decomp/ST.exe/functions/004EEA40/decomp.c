...

{
  ...
  iVar9 = __setjmp3(local_b4,0,unaff_EDI,unaff_ESI);
  if (iVar9 != 0) {
    DAT_00858df8 = local_b8;
  ...
  puVar5 = (undefined4 *)(local_1c + 0x27a);
  do {
  ...
  *(undefined4 **)(local_1c + 0x28a) = puVar5;
  puVar5[0x16] = 1;
  puVar5[0x17] = 0;
  iVar9 = 1;
  piVar13 = (int *)0x0;
  ...
  *(ushort **)(local_1c + 0x184) = puVar7;
  pbVar1 = (byte *)(local_1c + 0x6c);
