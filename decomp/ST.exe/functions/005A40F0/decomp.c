...
void __thiscall
FUN_005a40f0(void *this,undefined4 param_1,undefined4 param_2,int param_3,undefined4 *param_4)

{
  ...
  if (*(char *)((int)this + 0x1a5f) == '\t') {
    ...
    pvVar2 = local_8;
    if (iVar3 == 0) {
      puVar7 = (undefined4 *)((int)local_8 + 0x1edb);
      if (*(int *)((int)local_8 + 0x1edb) != 0) {
        FUN_006ab060(puVar7);
      }
      ...
      *puVar7 = puVar4;
      ...
      if ((*(int *)((int)pvVar2 + 0x1edf) == 0) ||
         (local_14 = 1, *(int *)((int)pvVar2 + 0x1a6b) == 0)) {
        local_14 = 0;
      }
      if (*(int *)((int)pvVar2 + 0x1ed3) != 0) {
        FUN_006e6080(pvVar2,2,*(int *)((int)pvVar2 + 0x1ed3),local_28);
      }
      ...
      if (*(int *)((int)pvVar2 + 0x1ed7) != 0) {
        FUN_006e6080(pvVar2,2,*(int *)((int)pvVar2 + 0x1ed7),local_28);
      }
