...
void thunk_FUN_005a1f00(uint param_1,byte *param_2,char *param_3,uint param_4)
...
LAB_005a1fc3:
  ...
  if (puStack_c != (uint *)0x0) {
    ...
    if (puVar6 != (uint *)0x0) {
      ...
      puVar7 = FUN_007121f0((int)puVar6,(uint *)s________________007c21d8,
                            0x1a6 - *(int *)((int)pvStack_14 + 0x1b4c),0,0xffffffff,1);
      if (*(char *)((int)pvStack_14 + 0x1a5f) == '\x06') {
        *(undefined4 *)((int)pvStack_14 + 0x2d) = 0x26;
        FUN_006e6080(pvStack_14,2,*(undefined4 *)((int)pvStack_14 + 0x1b14),
                     (undefined4 *)((int)pvStack_14 + 0x1d));
        uStack_10 = (uint)*(ushort *)((int)pvStack_14 + 0x33);
        if (*(int *)(*(int *)((int)pvStack_14 + 0x1e9e) + 8) + -0x19 <= (int)uStack_10) {
          cStack_5 = '\x01';
        }
      }
      if (puVar7 != (uint *)0x0) {
        FUN_007129d0(puVar7,puVar7);
        iVar5 = *(int *)((int)pvStack_14 + 0x1e9e);
...
LAB_005a2188:
            FUN_006b5aa0(*(int *)((int)pvStack_14 + 0x1e9e),pcVar8);
            iVar5 = iVar5 + 1;
      ...
      if (*(char *)((int)pvStack_14 + 0x1a5f) == '\x06') {
        *(undefined4 *)((int)pvStack_14 + 0x2d) = 0x28;
        *(undefined2 *)((int)pvStack_14 + 0x31) = 1;
        *(undefined2 *)((int)pvStack_14 + 0x33) =
             *(undefined2 *)(*(int *)((int)pvStack_14 + 0x1e9e) + 8);
        FUN_006e6080(pvStack_14,2,*(undefined4 *)((int)pvStack_14 + 0x1b14),
                     (undefined4 *)((int)pvStack_14 + 0x1d));
        *(undefined4 *)((int)pvStack_14 + 0x2d) = 0x22;
        *(undefined2 *)((int)pvStack_14 + 0x31) = 0;
        if (cStack_5 == '\0') {
          sVar4 = (short)uStack_10;
        }
        else {
          iVar5 = *(int *)(*(int *)((int)pvStack_14 + 0x1e9e) + 8);
          if (iVar5 < 0x19) {
            sVar4 = 0;
          }
          else {
        ...
        *(short *)((int)pvStack_14 + 0x33) = sVar4;
        FUN_006e6080(pvStack_14,2,*(undefined4 *)((int)pvStack_14 + 0x1b14),
                     (undefined4 *)((int)pvStack_14 + 0x1d));
      }
    }
