...

{
  ...
  if (pAVar10 != nullptr) {
    ...
    if (iVar4 == 0) {
      ...
      pBVar7_mg1 = FUN_0070b3a0((RecoveredGlobalRecordView_0081175C *)this_00->field_0240,uVar18);
      ...
      if (pAVar10->field_000D != 0) {
        ...
        pBVar7_mg3 = FUN_0070b3a0((RecoveredGlobalRecordView_0081175C *)this_00->field_023C,
                                  local_EAX_1380);
      ...
      do {
        ...
        if (*pGVar12 != 0) {
          ...
          pBVar7_mg5 = FUN_0070b3a0((RecoveredGlobalRecordView_0081175C *)this_00->field_0240,
                                    local_EAX_1813);
      ...
      if (pAVar10->field_001F != 0) {
        ...
        pBVar7 = FUN_0070b3a0((RecoveredGlobalRecordView_0081175C *)this_00->field_023C,
                              local_EAX_2923);
      ...
      if (pAVar10->field_0023 != 0) {
        ...
        ccFntTy::WrStr(this_00->field_01E0,(char *)&DAT_0080f33a,1,-1,
                       (DAT_0080874e != '\x03') - 1 & 5);
        local_8 = local_8 + 0xf;
        pBVar7_mg8 = FUN_0070b3a0((RecoveredGlobalRecordView_0081175C *)this_00->field_0248,4);
        ...
        pBVar7_mg9 = FUN_0070b3a0((RecoveredGlobalRecordView_0081175C *)this_00->field_0240,
                                  local_EAX_3381);
        /* ST_CALLSITE[005187AA]: CALL 0x00403229; direct=00403229 DibPut */
        DibPut((RecoveredSourceFamily_dibcopy *)this_00->field_0218,0xcd,local_8,'\x01',
               (RecoveredRecordView_006B84D0_87AF9D9B *)pBVar7_mg9);
        pBVar4 = local_10;
