...

{
  ...
  if (param_8 != 0) {
    ...
    if (errorCode == 0) {
      ...
      Library::DKW::DDX::FUN_006c6660(param_1,local_8,param_5 + 0x26,7,param_7 - 0xab,3,0);
      Library::DKW::DDX::FUN_006c6470
                (param_1,local_8,param_5 + 0x26,(undefined4 *)0x7,param_7 + -0xab,3,
                 *(undefined4 *)(DAT_0081176c + 0x140));
      uVar7 = 2;
      ...
      uVar5 = 0xffffffff;
      uVar4 = 0;
      puVar2 = (uint *)FUN_006b0140(0x2569,DAT_00807618);
      this_00 = (StartServTy *)(param_5 + -0x57 + param_7);
      StartServTy::WrTextDDX
                (this_00,0,param_4 + 10,(int)this_00,local_8,0xf,puVar2,uVar4,uVar5,pvVar6,uVar7);
      ...
      uVar5 = 0xffffffff;
      uVar4 = 0;
      puVar2 = (uint *)FUN_006b0140(0x2550,DAT_00807618);
      StartServTy::WrTextDDX
                ((StartServTy *)param_4,0,param_4 + 10,param_5 + -0x2f + param_7,local_8,0xf,puVar2,
                 uVar4,uVar5,pvVar6,uVar7);
      ...
      uVar5 = 0xffffffff;
      uVar4 = 0xffffffff;
      puVar2 = (uint *)FUN_006b0140(0x2566,DAT_00807618);
      StartServTy::WrTextDDX
