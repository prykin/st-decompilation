...

{
  ...
  *(int *)(local_8 + 0x998) = *(int *)(local_8 + 0x38);
  thunk_FUN_0052b330(local_8);
  FUN_006e6fb0(DAT_00807598,*(int *)(local_8 + 400),5,7,(uint)(*(short *)(local_8 + 0x23f) != 2));
  ...
  if (uVar9 != *(uint *)(local_8 + 0x9a0)) {
    *(uint *)(local_8 + 0x9a0) = uVar9;
    FUN_00710a90(*(int *)(local_8 + 400),0,(DAT_0080874e == '\x03') + 7,0x10,0x28,0xb);
    uVar5 = (uint)DAT_0080874d;
    if ((&DAT_008087f7)[uVar5 * 0x51] == '\0') {
      uVar9 = *(int *)(&DAT_008087f8 + uVar5 * 0x51) + *(int *)(local_8 + 0x9a0);
      uVar5 = uVar9 / 0xe10;
      cVar8 = (char)uVar5;
      _local_c = CONCAT31(uStack_b,cVar8);
      puVar1 = (uint *)(local_8 + 0x1e1);
      if (cVar8 == '\0') {
        puVar7 = &DAT_007c2198;
      ...
      uVar9 = *(int *)(local_8 + 0x9a0) - *(int *)(&DAT_008087fc + uVar5 * 0x51);
      if (uVar9 < *(uint *)(&DAT_008087f8 + uVar5 * 0x51)) {
        ...
        wsprintfA((LPSTR)(local_8 + 0x1e1),pCVar12,puVar7);
        uVar2 = (ulonglong)uVar9 % 0xe10;
        wsprintfA((LPSTR)(local_8 + 0x1e1),s__s_02d__02d_007c2184,(LPSTR)(local_8 + 0x1e1),
      ...
      uVar5 = FUN_00711b70((uint *)(local_8 + 0x1e1),0,0,(DAT_0080874e == '\x03') + 2,-1,-1);
      if (DAT_0080c4d3 != 2) {
        FUN_00711b70((uint *)(local_8 + 0x1e1),0xd,10,0,-1,-1);
        uVar5 = FUN_006b3640(DAT_008075a8,*(uint *)(local_8 + 0x174),0xffffffff,
                             *(uint *)(local_8 + 0xec),*(uint *)(local_8 + 0xf0));
      }
    }
  }
  if ((*(short *)(local_8 + 0x23f) != 2) && (uVar5 = *(uint *)(local_8 + 0x158), -1 < (int)uVar5)) {
    uVar5 = FUN_006b3640(DAT_008075a8,uVar5,0xffffffff,*(uint *)(local_8 + 0x4c),
                         *(uint *)(local_8 + 0xa4));
  }
  DAT_00858df8 = local_50;
  return uVar5;
