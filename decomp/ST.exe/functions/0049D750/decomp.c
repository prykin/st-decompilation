          ...
          if ((((short)local_8 != -1) &&
              (piVar4 = (int *)STAllPlayersC::GetObjPtr
                                         (DAT_007fa174,
                                          ...
                                          local_8,1), piVar4 != (int *)0x0)) &&
             (iVar2 = (**(code **)(*piVar4 + 0x2c))(), iVar2 == 0x33)) {
            Library::DKW::TBL::FUN_006ae1c0(*(uint **)(this_00 + 0x29f),&local_8);
          }
          uVar10 = uVar10 + 1;
          ...
          if ((short)local_8 != -1) {
            this_01 = (STBoatC *)
                      STAllPlayersC::GetObjPtr
                                (DAT_007fa174,
                                 CONCAT31((int3)((uint)extraout_ECX_00 >> 8),this_00[0x24]),local_8,
                                 1);
            iVar2 = thunk_FUN_0045ff10((int)this_01);
            uVar10 = local_c;
            if ((iVar2 == 4) ||
               (uVar5 = STBoatC::CheckPBoxCmd(this_01,4), uVar10 = local_c, uVar5 == 1)) break;
          }
          uVar8 = uVar8 + 1;
