...
undefined4 __thiscall FUN_0049ea00(void *this,int param_1)

{
  ...
  local_c = *(int *)(*(int *)((int)this + 0x29) + 0xc);
  local_18 = 2;
  local_14 = 0;
  ...
  if (iVar3 == 0) {
    if ((param_1 == 0) || (param_1 == 1)) {
      puVar8 = (undefined4 *)((int)local_1c + 0x89);
      ...
      *(undefined4 *)((int)local_1c + 0x2b3) = *(undefined4 *)((int)local_1c + 0x182);
      *(undefined4 *)((int)local_1c + 0x2b7) = *(undefined4 *)((int)local_1c + 0x186);
      *(undefined2 *)((int)local_1c + 699) = *(undefined2 *)((int)local_1c + 0x18a);
      local_24 = *(undefined2 *)((int)local_1c + 0x2b3);
      local_22 = *(undefined2 *)((int)local_1c + 0x2b5);
    ...
    if (*(uint *)(DAT_00802a38 + 0xe4) % 0x1e == 5) {
      ...
      if (0 < local_c) {
        do {
          FUN_006acc70(*(int *)((int)pvVar2 + 0x29),uVar9,&local_8);
          if ((short)local_8 != -1) {
            pvVar4 = (void *)thunk_FUN_0042b620(CONCAT31((int3)(local_8 >> 8),
                                                         *(undefined1 *)((int)pvVar2 + 0x24)),
                                                local_8,1);
            if (pvVar4 == (void *)0x0) {
