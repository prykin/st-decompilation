...
cf_common_exit_005091B9:
  ...
  if ((this_00->field_0BFB == '\x02') && (cVar9 == '\x01')) {
    cVar9 = '\0';
    cVar10 = '\0';
    iVar5 = 0;
    do {
      if ((&this_00->field_0BFE)[iVar5] != '\0') {
        cVar10 = cVar10 + '\x01';
      }
      iVar5 = iVar5 + 1;
    } while (iVar5 < 6);
    ...
    if (cVar10 == cVar9) {
      ...
      if ((!bVar19) || (this_00->field_0BFC != local_75)) {
    ...
    if (*(int *)&this_00->field_0xc12 == local_60._1_4_) {
      iVar5 = (*(int *)(this_00->field_0194 + 4) - *(int *)(this_00->field_09ED + 2)) / 2;
  ...
  case 0x33:
    if ((*(int *)&this_00->field_0xc12 == local_60._1_4_) && (this_00->field_0C16 == local_5b)) {
      ...
      iVar11 = (*(int *)(this_00->field_0194 + 4) - *(int *)(this_00->field_09ED + 2)) / 2;
      do {
        if (*local_8 != *local_10) {
  ...
  case 0x34:
    ...
    goto cf_common_exit_0050918D;
  case 0x35:
    iVar5 = (((undefined4 *)this_00->field_0194)[1] - *(int *)(this_00->field_09ED + 2)) / 2;
  ...
  case 0x6f:
    ...
    iVar5 = (*(int *)(this_00->field_0194 + 4) - *(int *)(this_00->field_09F5 + 2)) / 2;
    ...
    if (this_00->field_0C29 != '\0') {
      do {
        pbVar7 = (byte *)FUN_0070b3a0(this_00->field_02B6,3);
        DibPut((undefined4 *)this_00->field_0194,iVar5 + 6 + ((uint)local_8 & 0xff) * 4,0x75,'\x01',
               pbVar7);
        bVar3 = (byte)local_8 + 1;
        local_8 = (byte *)CONCAT31(local_8._1_3_,bVar3);
      } while (bVar3 < (byte)this_00->field_0C29);
    }
    if ((byte)local_8 < 0x28) {
      ...
      do {
        ...
        DibPut((undefined4 *)this_00->field_0194,iVar5,0x75,'\x01',pbVar7);
        iVar5 = iVar5 + 4;
        iVar11 = iVar11 + -1;
      } while (iVar11 != 0);
    }
...
cf_common_exit_0050918D:
      Library::DKW::DDX::FUN_006b3640(DAT_008075a8,uVar6,0xffffffff,uVar20,uVar21);
    }
    goto cf_common_exit_00509192;
  case 0x3a:
    iVar5 = (*(int *)(this_00->field_0194 + 4) - *(int *)(this_00->field_09ED + 2)) / 2;
    if (this_00->field_0C3A != local_37) {
      ...
      if (this_00->field_0C3A != '\0') {
        do {
          pbVar7 = (byte *)FUN_0070b3a0(this_00->field_02B6,3);
          DibPut((undefined4 *)this_00->field_0194,iVar5 + 0x70 + ((uint)local_8 & 0xff) * 4,0x54,
                 '\x01',pbVar7);
          bVar3 = (byte)local_8 + 1;
          local_8 = (byte *)CONCAT31(local_8._1_3_,bVar3);
      ...
      if ((byte)local_8 < 0xf) {
        ...
        do {
          pbVar7 = (byte *)FUN_0070b3a0(this_00->field_02B6,0);
          DibPut((undefined4 *)this_00->field_0194,iVar11,0x54,'\x01',pbVar7);
          iVar11 = iVar11 + 4;
          local_c = local_c - 1;
        } while (local_c != 0);
      }
    ...
    if (this_00->field_0C3B != local_36) {
      ...
      if (this_00->field_0C3B != '\0') {
        do {
          pbVar7 = (byte *)FUN_0070b3a0(this_00->field_02B6,3);
          DibPut((undefined4 *)this_00->field_0194,iVar5 + 0x70 + ((uint)local_8 & 0xff) * 4,0x5f,
                 '\x01',pbVar7);
          bVar3 = (byte)local_8 + 1;
          local_8 = (byte *)CONCAT31(local_8._1_3_,bVar3);
      ...
      if ((byte)local_8 < 0xf) {
        ...
        do {
          pbVar7 = (byte *)FUN_0070b3a0(this_00->field_02B6,0);
          DibPut((undefined4 *)this_00->field_0194,iVar11,0x5f,'\x01',pbVar7);
          iVar11 = iVar11 + 4;
          local_c = local_c - 1;
        } while (local_c != 0);
      }
    ...
    if (local_c != 0) {
      uVar6 = 0;
      do {
        pbVar7 = (byte *)FUN_0070b3a0(this_00->field_02B6,2);
        DibPut((undefined4 *)this_00->field_0194,iVar5 + 0xb + uVar6 * 4,0x76,'\x01',pbVar7);
        bVar3 = (byte)local_8 + 1;
        local_8 = (byte *)CONCAT31(local_8._1_3_,bVar3);
        uVar6 = (uint)bVar3;
      } while (uVar6 < local_c);
    ...
    if ((byte)local_8 < 0x28) {
      ...
      do {
        pbVar7 = (byte *)FUN_0070b3a0(this_00->field_02B6,0);
        DibPut((undefined4 *)this_00->field_0194,iVar5,0x76,'\x01',pbVar7);
        iVar5 = iVar5 + 4;
        iVar11 = iVar11 + -1;
      } while (iVar11 != 0);
    }
  ...
  case 0x3c:
    ...
    if (cVar9 == '\x01') {
      ...
      if (uVar6 != 0) {
        ...
        do {
          pbVar7 = (byte *)FUN_0070b3a0(this_00->field_02B6,3);
          DibPut((undefined4 *)this_00->field_0194,iVar11,0x5c,'\x01',pbVar7);
          iVar11 = iVar11 + 4;
          local_c = local_c - 1;
        } while (local_c != 0);
      }
      if (local_14 < 0x28) {
        iVar5 = iVar5 + 0xb + local_14 * 4;
        iVar11 = 0x28 - local_14;
        do {
          pbVar7 = (byte *)FUN_0070b3a0(this_00->field_02B6,0);
          DibPut((undefined4 *)this_00->field_0194,iVar5,0x5c,'\x01',pbVar7);
          iVar5 = iVar5 + 4;
          iVar11 = iVar11 + -1;
        } while (iVar11 != 0);
      }
...
joined_r0x00509177:
  ...
  case 0x50:
    iVar5 = 3;
    bVar19 = true;
    psVar13 = (short *)&this_00->field_0C11;
    psVar18 = (short *)local_60;
    do {
      if (iVar5 == 0) break;
      iVar5 = iVar5 + -1;
      bVar19 = *psVar13 == *psVar18;
