...

{
  ...
  this_02->field_007F = puVar5;
  uVar6 = FUN_0070aa50(g_cMf32_00806780,"RPT_IND",0,1);
  this_02->field_006F = uVar6;
  pcVar7 = (ccFntTy *)thunk_FUN_005defe0(this_02->field_005D,(undefined *)0x0,DAT_00807dd9);
  this_02->field_0083 = pcVar7;
  pcVar7->field_0058 = 1;
  pcVar7->field_005C = 0;
  pcVar7 = (ccFntTy *)thunk_FUN_005df290(this_02->field_005D,(undefined *)0x0,DAT_00807dd9);
  this_02->field_0087 = pcVar7;
  g_startSystem_0081176C->field_0038 = pcVar7;
  pcVar7 = (ccFntTy *)ccFntTy::operator(this_01,0x19d,g_cMf32_00806780,"RPT_FNTN",0);
  this_02->field_008B = pcVar7;
  pcVar7->field_0058 = 1;
  pcVar7->field_005C = 0;
  iVar3 = 1;
  puVar19 = (undefined4 *)(this_02->field_005D + 0x28);
  uVar8 = FUN_006b4fe0(this_02->field_005D);
  /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
  pAVar9 = (AnonPointee_MReportTy_0077 *)
           FUN_006b50c0(0x91,0x28,(uint)*(ushort *)(this_02->field_005D + 0xe),uVar8,puVar19,iVar3);
  this_02->field_0077 = pAVar9;
  iVar3 = 1;
  puVar19 = (undefined4 *)(this_02->field_005D + 0x28);
  uVar8 = FUN_006b4fe0(this_02->field_005D);
  /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
  uVar6 = FUN_006b50c0(300,0x1e,(uint)*(ushort *)(this_02->field_005D + 0xe),uVar8,puVar19,iVar3);
  this_02->field_007B = uVar6;
  iVar3 = 1;
  puVar19 = (undefined4 *)(this_02->field_005D + 0x28);
  uVar8 = FUN_006b4fe0(this_02->field_005D);
  /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
  pAVar10 = (AnonShape_006B5B10_E0D06CF1 *)
            FUN_006b50c0(0x2e9,0x15e,(uint)*(ushort *)(this_02->field_005D + 0xe),uVar8,puVar19,
                         iVar3);
  this_02->field_0073 = (AnonPointee_MReportTy_0073 *)pAVar10;
  FUN_006b4170(pAVar10,0,0,0,0x2e9,0x15e,0xff);
  FUN_006b5ee0((AnonShape_006B5B10_E0D06CF1 *)this_02->field_0073,0,0x2d,0,700,0x15e,0x18,0xd);
  Library::Ourlib::PALETTE::FUN_00718780
            ((int)local_6a4,0,0x100,0x1a,0x10,(undefined4 *)&this_02->field_0xa3);
  Library::Ourlib::PALETTE::FUN_00718780
            ((int)local_6a4,0,0x100,0x2e,0x10,(undefined4 *)&this_02->field_0x1a3);
  memset(&this_02->field_0x2c7, 0, 0x80); /* compiler bulk-zero initialization */
  this_02->field_0323 = (MReportTy *)&this_02->field_0xa3;
  pcVar7 = this_02->field_0087;
  this_02->field_02EF = this_02->field_0008;
  this_02->field_02CF = this_02->field_0008;
  this_02->field_02F3 = 2;
  this_02->field_02D3 = 2;
  this_02->field_0313 = this_02->field_005D;
  this_02->field_031B = 0x18;
  this_02->field_0317 = 0x4c;
  if (pcVar7->field_00A0 != 0) {
    FUN_00710790((AnonShape_00710790_4CBB90D4 *)pcVar7);
  }
  this_02->field_030B = *(undefined4 *)&pcVar7->field_0x8a;
  if (this_02->field_0066 == '\x01') {
    local_14 = (cMf32 *)0x0;
    ppDVar17 = &this_02->field_0347;
    iVar3 = 3;
    do {
    ...
    if (local_14 != (cMf32 *)0x0) {
      ...
      while (pcVar12 != (char *)0x0) {
        ...
        if (((iVar3 == 2) && (local_10 != 0)) && (local_10 < 4)) {
          Library::DKW::TBL::FUN_006ae1c0(*(uint **)(&this_02->field_0x343 + local_10 * 4),&local_c)
          ;
        }
    ...
    iVar3 = 2;
    piVar16 = &this_02->field_034F;
    do {
      if (*(int *)(*piVar16 + 0xc) != 0) {
        this_02->field_006A = (char)iVar3;
      }
      iVar3 = iVar3 + -1;
      piVar16 = piVar16 + -1;
    } while (-1 < iVar3);
  ...
  if (pHVar13 != (HoloTy *)0x0) {
    ...
    uVar8 = HoloTy::Init(this_02->field_0453,CASE_2,0x47,0x46,iVar3,iVar21,uVar8,cVar22,uVar14);
    if (uVar8 != 0) {
      pHVar13 = this_02->field_0453;
      pHVar13->field_0002 = 1;
      pHVar13->field_0017 = pHVar13->field_0013;
      uVar8 = this_02->field_0453->field_0003;
      if (-1 < (int)uVar8) {
  ...
  FUN_006b2330(PTR_008075a8,&local_8,0x32,0x401217,0x2e9,0x32,(uint)this_02);
  ...
  if (pHVar13 != (HoloTy *)0x0) {
    ...
    uVar8 = HoloTy::Init(this_02->field_0457,CASE_3,0x1a,10,iVar3,iVar21,uVar8,cVar22,uVar14);
    if (uVar8 != 0) {
      pHVar13 = this_02->field_0457;
      pHVar13->field_0002 = 1;
      pHVar13->field_0017 = pHVar13->field_0013;
      uVar8 = this_02->field_0457->field_0003;
      if (-1 < (int)uVar8) {
        FUN_006b3af0((int *)PTR_008075a8,uVar8);
      }
    }
  ...
  thunk_FUN_0055ddf0(DAT_0080759c,(int *)PTR_008075a8,this_02->field_005D,10,2);
  pHVar13 = this_02->field_0457;
