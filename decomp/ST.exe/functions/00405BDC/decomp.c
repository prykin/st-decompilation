...

{
  ...
  int iStack_20;
  int iStack_1c;
  STExplosionC *pSStack_18;
  int iStack_14;
  byte *pbStack_10;
  int iStack_c;
  byte *pbStack_8;
  
  iStack_c = *(int *)(this + 0x1e9);
  ...
  if ((param_3 != '\0') && (*(STT3DSprC **)(pSStack_18 + 0x2af) != (STT3DSprC *)0x0)) {
    pbStack_8 = (&PTR_s_expl_bbt0_007cedc0)[iStack_c];
    iVar5 = STT3DSprC::LoadSequence
                      (*(STT3DSprC **)(pSStack_18 + 0x2af),0xf,DAT_00806774,pbStack_8,0x1d);
    if (iVar5 != 0) {
      return 0xffff;
    }
  ...
  iVar5 = STT3DSprC::LoadSequence(*(STT3DSprC **)(pSVar4 + 0x2af),0xd,DAT_00806774,pbStack_8,0x1d);
  if (iVar5 == 0) {
    iVar5 = STT3DSprC::LoadSequence
                      (*(STT3DSprC **)(pSVar4 + 0x2af),0xe,DAT_00806774,pbStack_10,0x1d);
    if (iVar5 != 0) {
      return 0xffff;
    }
