...

{
  ...
  pCStack_8 = this;
  iVar3 = __setjmp3(auStack_48,0,unaff_ESI,uVar9);
  pCVar2 = pCStack_8;
  if (iVar3 == 0) {
  ...
  DAT_00858df8 = (undefined1 *)uVar9;
  iVar5 = FUN_006ad4d0(s_E____titans_Andrey_cpanel3_cpp_007c26a0,0x13,0,iVar3,&DAT_007a4ccc);
  if (iVar5 != 0) {
    pcVar1 = (code *)swi(3);
    (*pcVar1)();
    return;
  }
  FUN_006a5e40(iVar3,0,0x7c26a0,0x13);
  return;
}
