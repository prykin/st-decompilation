...
void FUN_0075df10(undefined4 *param_1)

{
  ...
  *(undefined4 *)(iVar1 + 0x1c) = uVar2;
  ...
  iVar4 = 0x2c8d00;
  do {
    *(int *)(*(int *)(iVar1 + 0x10) + iVar3) = iVar5 >> 0x10;
    iVar5 = iVar5 + 0x166e9;
    *(int *)(*(int *)(iVar1 + 0x14) + iVar3) = (int)param_1 >> 0x10;
    *(int *)(*(int *)(iVar1 + 0x18) + iVar3) = local_8;
    local_8 = local_8 + -0xb6d2;
    *(int *)(*(int *)(iVar1 + 0x1c) + iVar3) = iVar4;
    iVar4 = iVar4 + -0x581a;
