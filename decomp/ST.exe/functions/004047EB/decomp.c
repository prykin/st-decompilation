...
int __fastcall
thunk_FUN_0065e450(int param_1,undefined4 param_2,uint param_3,undefined4 param_4,undefined4 param_5
                  )
  ...
  if (0 < (int)uVar6) {
    do {
      ...
      case 0x1b:
        ...
        iStack_8 = iStack_8 + (uint)(uVar6 != 0);
