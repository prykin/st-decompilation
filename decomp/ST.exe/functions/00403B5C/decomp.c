...
void __thiscall
thunk_FUN_0062e240(void *this,undefined4 param_1,int param_2,int param_3,int param_4,int param_5,
                  uint param_6)

{
  ...
  if (((((((-1 < sVar5) && (sVar5 < DAT_007fb240)) && (sVar6 = (short)param_3, -1 < sVar6)) &&
     ...
     ((param_5 != 0 && (iVar4 = FUN_006e62d0(DAT_00802a38,param_5,(int *)&pvStack_8), iVar4 != -4)))
     ) {
    uVar7 = param_6;
    if (param_6 == 0) {
      uVar7 = 1;
