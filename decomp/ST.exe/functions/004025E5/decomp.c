...

{
  ...
  switch(param_4) {
  case 1:
    iStack_10 = *(int *)(&DAT_007d1530 + *param_2 * 8);
    iStack_c = *(int *)(&DAT_007d1534 + *param_2 * 8);
  default:
    ppuStack_8 = &PTR_s_rubb_w0_007d1480;
    break;
  case 2:
    ppuStack_8 = &PTR_s_rubb_g0_007d14a8;
    iStack_10 = *(int *)(&DAT_007d1530 + *param_2 * 8);
    iStack_c = *(int *)(&DAT_007d1534 + *param_2 * 8);
    break;
  case 3:
    ppuStack_8 = &PTR_s_rubb3_007d14d0;
    iStack_10 = 0xf;
    iStack_c = 0xf;
    break;
  case 4:
    ppuStack_8 = &PTR_s_rubb_gw0_007d1514;
    goto LAB_0062f450;
  case 5:
    ppuStack_8 = &PTR_s_rubb_gb0_007d14f8;
LAB_0062f450:
