...
undefined4 __thiscall thunk_FUN_004d8e70(void *this,int param_1,int param_2,undefined4 param_3)

{
  ...
  if (99 < *(int *)((int)this + 0x4ec)) {
    ...
    iVar1 = FUN_006e62d0(DAT_00802a38,*(int *)((int)this + 0x4f0),(int *)&pvStack_8);
    if (iVar1 == 0) {
      thunk_FUN_0058c560(pvStack_8,param_1,param_2);
      *(undefined4 *)((int)this + 0x4ec) = 0;
      *(undefined4 *)((int)this + 0x4d8) = *(undefined4 *)((int)DAT_00802a38 + 0xe4);
