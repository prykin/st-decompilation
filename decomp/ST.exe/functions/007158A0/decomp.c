...
undefined4
FUN_007158a0(int *param_1,uint param_2,char param_3,undefined4 *param_4,int param_5,int param_6)

{
  ...
  if (iVar2 == 0) {
    ...
    *(char *)(local_8 + 0x4c) = param_3;
    *(int **)(local_8 + 0x48) = param_1;
    *(uint *)(local_8 + 0x5d) = -(uint)(param_3 != -0x7f) & param_2;
    DAT_00858df8 = (undefined4 *)local_4c;
    return 0;
  }
  DAT_00858df8 = (undefined4 *)local_4c;
  iVar3 = FUN_006ad4d0(s_E__Ourlib_Sprite_cpp_007f0454,0x50,0,iVar2,&DAT_007a4ccc);
  if (iVar3 != 0) {
    pcVar1 = (code *)swi(3);
    uVar4 = (*pcVar1)();
    return uVar4;
  }
  FUN_006a5e40(iVar2,0,0x7f0454,0x52);
  return 0xfffffc18;
}
