...
void __fastcall thunk_FUN_0062f150(void *param_1)
  ...
  if ((*(char *)((int)param_1 + 0x1f9) != '\0') && (DAT_00802a88 != (void *)0x0)) {
    ...
    if ((DAT_0080874d != -1) && (*(int *)((int)DAT_00802a88 + 0xf8) != 0)) {
      thunk_FUN_00558c00(DAT_00802a88,*(undefined4 *)((int)DAT_00802a88 + 0x10c),
                         *(int *)((int)param_1 + 0x1d5),*(int *)((int)param_1 + 0x1d9),&iStack_8,
                         &iStack_10);
      if (((((-1 < iVar1) && (iVar1 < 5)) && (-1 < iStack_8)) &&
          (((iStack_8 < *(int *)((int)pvVar2 + 0x30) &&
            (iStack_10 = (&DAT_0079aed0)[iVar1] + iStack_10, -1 < iStack_10)) &&
           (iStack_10 < *(int *)((int)pvVar2 + 0x34))))) &&
         ((*(int *)((int)pvVar2 + 0x4c) != 0 &&
          (*(char *)(iStack_10 * *(int *)((int)pvVar2 + 0x30) + *(int *)((int)pvVar2 + 0x4c) +
                    iStack_8) == '\0')))) goto LAB_0062f208;
    }
    iStack_c = 1;
  }
LAB_0062f208:
        ...
        if (*(uint *)(DAT_00802a38 + 0xe4) % 5 == 0) {
          ...
          *(char *)(*piVar3 + 0x34) = *(char *)(*piVar3 + 0x34) + '\x01';
          if (*(short *)(DAT_00806724 + 0x23) <= (short)(ushort)*(byte *)(*piVar3 + 0x34)) {
            thunk_FUN_0062f6c0(param_1,iStack_8);
          }
        }
      }
