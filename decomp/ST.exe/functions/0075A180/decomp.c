...

{
  ...
  local_c = 0;
  iVar1 = *(int *)(param_1 + 0x12a);
  iVar2 = *(int *)(param_1 + 0x196);
  if (0 < *(int *)(param_1 + 0x1c)) {
    piVar9 = (int *)(*(int *)(param_1 + 0xd0) + 0xc);
    local_10 = (int *)(iVar2 + 8);
    do {
      iVar6 = (piVar9[6] * *piVar9) / *(int *)(param_1 + 0x12a);
      iVar12 = *local_10;
      ...
      local_c = local_c + 1;
      piVar9 = piVar9 + 0x15;
    } while (local_c < *(int *)(param_1 + 0x1c));
  }
  return;
}
