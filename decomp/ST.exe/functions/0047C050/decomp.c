...
undefined4 __thiscall FUN_0047c050(void *this,int *param_1)
        ...
        if (((param_1 != (int *)0x0) && (param_1[6] == *(int *)((int)this + 0x679))) &&
          ...
          if (param_1 != (int *)0x0) {
            if (*(int *)((int)this + 0x66b) == 0x14) {
              if (*(int *)((int)this + 0x675) == 99) {
                local_c = *(short *)((int)this + 0x673);
                local_e = *(short *)((int)this + 0x671);
                local_10 = *(short *)((int)this + 0x66f);
                ...
                local_8 = param_1;
                thunk_FUN_0045ef00(param_1,0xb,&local_14);
