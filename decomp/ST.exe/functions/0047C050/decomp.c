...

{
  ...
  if (SVar4 == CASE_0) {
    ...
    default:
      return 2;
    case 3:
      thunk_FUN_00481520(this,(int)(short)this->field_066F,(int)(short)this->field_0671,
  ...
  if (SVar4 != CASE_1) {
    ...
    if (SVar4 == CASE_3) {
      ...
      if (((this->field_07CA != 0) && (*(int *)&this->field_0x7c6 != 0)) && (iVar8 == 0)) {
        this->field_05D6 = 0;
        return 2;
      }
