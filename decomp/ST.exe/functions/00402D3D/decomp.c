...

{
  ...
  if (iVar2 == 0) {
    FUN_006b4170(*(int *)(iStack_8 + 0x1cb8),0,0,0x7d,*(int *)(*(int *)(iStack_8 + 0x1cc0) + 4),
                 *(int *)(*(int *)(iStack_8 + 0x1cc0) + 8),0xff);
    iVar2 = *(int *)(iStack_8 + 0x1cc0);
    ...
    FUN_00710a90(*(int *)(iStack_8 + 0x1cc0),0,0,0,0,0);
    if (*(char *)(iStack_8 + 0x1a5f) == '\0') {
      iVar10 = -1;
      iVar9 = -1;
      uVar4 = 0;
      iVar8 = -1;
    ...
    FUN_006b5440(*(int *)(iStack_8 + 0x1cb8),0,0,0x7d,*(int *)(iStack_8 + 0x1cc0),0,0xff);
    DAT_00858df8 = puStack_4c;
    return;
  }
  DAT_00858df8 = puStack_4c;
