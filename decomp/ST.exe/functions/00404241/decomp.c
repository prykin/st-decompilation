...

{
  ...
  if (iVar2 == 0) {
    ...
    bVar11 = 0;
    uVar10 = 0xffffffff;
    *(undefined4 **)(pPStack_14 + 0x17c) = puVar3;
    puVar3[0x16] = 0;
    puVar3[0x17] = 0;
    ...
    *(undefined4 *)(this_00 + 0x180) = uVar14;
    ...
    pPStack_c = (PanelTy *)(this_00 + 0x1a1);
    *(int *)(this_00 + 0x19d) = iVar2;
    ...
    iStack_10 = 5;
    do {
      uVar14 = PanelTy::CreateBut((PanelTy *)this_00,1,0,iStack_8,param_12,0,1,1,param_14,iVar2,
                                  iVar2 + 0x10,1,0,pPVar9,(char *)0x0,0);
      pPVar9 = pPVar9 + 0x27;
      iVar2 = iVar2 + 1;
      *(undefined4 *)pPStack_c = uVar14;
      iStack_8 = iStack_8 + param_13;
      pPStack_c = pPStack_c + 4;
  ...
  DAT_00858df8 = (undefined4 *)uStack_58;
  iVar12 = FUN_006ad4d0(s_E____titans_Andrey_specpan_cpp_007c7870,0x193,0,iVar2,&DAT_007a4ccc);
  if (iVar12 != 0) {
    pcVar1 = (code *)swi(3);
    (*pcVar1)();
    return;
