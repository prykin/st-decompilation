...
void thunk_FUN_0053ef20(UINT param_1,undefined4 param_2,undefined4 param_3,int param_4,int param_5,
...

{
  ...
  if (iVar2 == 0) {
    ...
    bVar10 = 0;
    uVar9 = 0xffffffff;
    *(undefined4 **)(iStack_14 + 0x17c) = puVar3;
    puVar3[0x16] = 0;
    puVar3[0x17] = 0;
    ...
    *(ushort **)(iStack_14 + 400) = puVar5;
    iVar2 = *(int *)(iStack_14 + 0x68);
    ...
    thunk_FUN_00540760(*(undefined4 **)(iStack_14 + 0x68),0,0,'\x01',*(byte **)(iStack_14 + 0x184));
    FUN_00710a90(*(int *)(iStack_14 + 0x68),0,param_2,param_3,param_4,param_5);
    uVar13 = 0;
    iVar11 = -1;
    iVar2 = -2;
    ...
    *(undefined4 *)(iStack_14 + 0x180) = uVar13;
    iVar2 = thunk_FUN_0053f940(param_8,param_10,param_9,param_10,0xc0a4,0,0,0);
    puStack_c = (undefined4 *)(iStack_14 + 0x1a1);
    *(int *)(iStack_14 + 0x19d) = iVar2;
    iVar2 = 0xc09f;
    iStack_8 = param_11;
    iStack_14 = iStack_14 + 0x1b5;
    iStack_10 = 5;
    do {
      uVar13 = thunk_FUN_00538690(1,0,iStack_8,param_12,0,1,1,param_14,iVar2,iVar2 + 0x10,1,0,
                                  iStack_14,(char *)0x0,0);
      iStack_14 = iStack_14 + 0x27;
      iVar2 = iVar2 + 1;
      *puStack_c = uVar13;
      iStack_8 = iStack_8 + param_13;
