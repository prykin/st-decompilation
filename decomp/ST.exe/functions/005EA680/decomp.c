...
undefined4 __thiscall FUN_005ea680(void *this,int param_1)
  ...
  *(undefined4 *)((int)this + 0x61) = uVar4;
  ...
  if (uVar7 < 0x6336) {
    if (uVar7 == 0x6335) {
      *(uint *)((int)DAT_0081176c + 0x4cf) =
      ...
      if (uVar7 == 0x610a) {
        *(undefined4 *)((int)this_01 + 0x45) = 0x200;
        *(undefined4 *)((int)this_01 + 0x49) = 0;
        *(undefined4 *)((int)this_01 + 0x4d) = *(undefined4 *)(param_1 + 0x10);
        *(undefined4 *)((int)this_01 + 0x51) = 8;
        ...
        if (uVar7 == 3) {
          ...
          thunk_FUN_005e84d0(this_01);
        }
        else if (uVar7 == 2) {
          thunk_FUN_005e6770(*(undefined4 *)(*(int *)(param_1 + 0x14) + 0x14),
        ...
        *(undefined4 *)((int)this_01 + 0x49) = 0;
        *(undefined4 *)((int)this_01 + 0x4d) = *(undefined4 *)(param_1 + 0x10);
        *(undefined4 *)((int)this_01 + 0x51) = *(undefined4 *)(param_1 + 0x14);
        *(undefined4 *)((int)this_01 + 0x55) = 0;
        thunk_FUN_005b66e0(this_01);
      }
    }
      ...
      if (uVar7 == 0x6333) {
        ...
        *(undefined4 *)((int)this_01 + 0x4d) = *(undefined4 *)(param_1 + 0x10);
        *(undefined4 *)((int)this_01 + 0x51) = *(undefined4 *)(param_1 + 0x14);
        *(undefined4 *)((int)this_01 + 0x55) = *(undefined4 *)(param_1 + 0x18);
        thunk_FUN_005b66e0(this_01);
      }
  ...
  if (uVar7 < 0x6943) {
    if (uVar7 == 0x6942) {
      *(undefined4 *)((int)this_01 + 0x45) = 0x200;
      *(undefined4 *)((int)this_01 + 0x49) = 0;
      *(undefined4 *)((int)this_01 + 0x4d) = 0x6102;
      *(undefined4 *)((int)this_01 + 0x51) = *(undefined4 *)(param_1 + 0x14);
      thunk_FUN_005b66e0(this_01);
    }
      ...
      if (uVar7 == 0x693f) {
        ...
        thunk_FUN_005b6560(*(int *)((int)this_01 + 0x1a5b) + 0x55c,param_1,0);
      }
      else if (uVar7 == 0x6341) {
        thunk_FUN_005b6560(*(int *)((int)this_01 + 0x1a5b) + 0x5ed,param_1,0);
      }
    }
    else if (uVar7 == 0x6940) {
  ...
  if (uVar7 < 0x6952) {
    ...
    (**(code **)(*this_01 + 8))();
    this_00 = *(void **)(*(int *)((int)this_01 + 0x1a5b) + 0x2e6);
    if (this_00 != (void *)0x0) {
      thunk_FUN_005b8c70(this_00,1,0,1);
    }
    goto LAB_005eab6a;
  }
  if (uVar7 != 0xc0a2) goto LAB_005eab6a;
  iVar5 = thunk_FUN_005ddb40(*(int *)((int)this_01 + 0x1a5b));
  if (iVar5 == 0) {
    if (DAT_008067a0 != '\0') {
      iVar5 = *(int *)(*(int *)((int)this_01 + 0x1a5b) + 0x686);
      if (*(int *)(iVar5 + 8) < 1) {
        pcVar9 = (char *)0x0;
      }
      else {
    ...
    *pcVar9 = '\0';
    ...
    local_8 = local_464;
    thunk_FUN_005dd850((int)local_4a4);
    FUN_00715360(DAT_00811764,0,'\x1b',local_4a4,0x451,1,0xffffffff);
  }
LAB_005eab28:
  FUN_006b6020(*(int *)(*(int *)((int)this_01 + 0x1a5b) + 0x686),0,&DAT_008016a0);
  *(undefined4 *)((int)this_01 + 0x2d) = 0x33;
  *(undefined4 *)((int)this_01 + 0x31) = *(undefined4 *)(*(int *)((int)this_01 + 0x1a5b) + 0x686);
  FUN_006e6080(this_01,2,*(undefined4 *)(*(int *)((int)this_01 + 0x1a5b) + 0x54c),
               (undefined4 *)((int)this_01 + 0x1d));
LAB_005eab6a:
  DAT_00858df8 = local_50;
