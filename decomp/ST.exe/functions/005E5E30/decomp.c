...

{
  ...
  if (iVar2 == 0) {
    if (*(char *)(local_8 + 0xb3) == '\x01') {
      if (DAT_00811778 != 0) {
        iVar2 = thunk_FUN_005ab0a0();
        if (iVar2 == 0) {
          *(undefined1 *)(local_8 + 0xb3) = 4;
        }
      }
    }
    else if ((*(char *)(local_8 + 0xb3) == '\x05') && (DAT_00811778 != 0)) {
      iVar2 = thunk_FUN_005ab0a0();
      if (iVar2 == 0) {
        *(undefined1 *)(local_8 + 0xb3) = 0;
        if (-1 < (int)*(uint *)(DAT_00811778 + 3)) {
          FUN_006b3af0(DAT_008075a8,*(uint *)(DAT_00811778 + 3));
        }
      }
    }
    _DAT_00811774 = *(undefined4 *)(local_8 + 0xa1);
