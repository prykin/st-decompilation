...

{
  ...
  if (param_1 == 0) {
    local_14 = *(undefined4 **)(this + 0x19c);
    CVar4 = this[0xc6c];
  }
  else {
    local_14 = *(undefined4 **)(this + 0x184);
    CVar4 = this[0xb7e];
  }
  local_c = CONCAT31(local_c._1_3_,CVar4);
  if (param_1 == 0) {
    local_5 = this[0xc53];
  }
  else {
  ...
  if ((byte)CVar4 < 0x65) {
    ...
    if (iVar5 == 0) {
      bVar3 = (byte)local_c;
      cVar7 = (char)(((local_c & 0xff) * 7) / 10);
      local_10 = CONCAT31(local_10._1_3_,cVar7);
      if (((byte)local_c != 0) && (cVar7 == '\0')) {
        local_10 = CONCAT31(local_10._1_3_,1);
      }
      if ((byte)local_c < 0x46) {
        iVar5 = (-(uint)((byte)local_c < 0x14) & 6) + 6;
      }
      else {
        iVar5 = 0;
      }
    ...
    g_currentExceptionFrame = local_5c.previous;
    iVar6 = ReportDebugMessage(s_E____titans_Andrey_cpanel1_cpp_007c23cc,0x2f,0,iVar5,&DAT_007a4ccc,
    ...
    RaiseInternalException(iVar5,0,s_E____titans_Andrey_cpanel1_cpp_007c23cc,0x2f);
  }
  return;
}
