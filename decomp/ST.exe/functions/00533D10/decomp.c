        ...
        if (SVar6 != MESS_OPTPANELTY_8164) {
          if (MESS_SHARED_8160 < SVar6) {
            ...
            if (SVar6 != MESS_OPTPANELTY_8162) {
              ...
              ccFntTy::WrStr(this_00->field_017C,pcVar26,iVar30,iVar33,uVar18);
              puVar19 = this_00->field_01E5;
              Library::DKW::WGR::FUN_006b55f0
                        ((RecoveredSourceFamily_dibcopy *)this_00->field_0068,0,0x26,0x1c,
                         (byte *)puVar19,0,0,0,*(int *)(puVar19 + 2),*(int *)(puVar19 + 4));
...
LAB_00534016:
      ...
      pcVar35 = thunk_FUN_00529fe0;
      pCVar13 = thunk_FUN_00571240(pcVar26,0);
      bVar28 = 6;
    }
LAB_00534654:
  ...
  case MESS_INTERCOMPANELTY_C0AF:
    ...
    case CASE_8:
      ...
      if (iVar17 == 1) {
        ...
        PaintDblBut(this_00,(AnonShape_0052EFB0_CC661192 *)message,pCVar13,UVar34,pcVar31,pcVar35,
                    iVar17);
        g_currentExceptionFrame = local_8c.previous;
        return 0;
      }
...
cf_common_exit_00536EE8:
    ...
    pCVar13 = FUN_006f2c00(pCVar13,iVar30,uVar27);
    PaintDblBut(this_00,(AnonShape_0052EFB0_CC661192 *)message,pCVar13,UVar34,pcVar31,pcVar35,iVar17
               );
    g_currentExceptionFrame = local_8c.previous;
    return 0;
  case 0xc0b0:
...
cf_common_exit_00536F92:
    ...
    iVar17 = 1;
    pCVar13 = thunk_FUN_00571240("BUT_BUTOPT",0);
    pCVar13 = FUN_006f2c00(pCVar13,iVar17,uVar27);
