...
void FUN_006c7610(int param_1,int param_2,int param_3,int param_4,uint param_5,uint param_6,
...

{
  ...
  if (((param_7 != 0) && (param_7 * 2 <= (int)param_5)) && (param_7 * 2 <= (int)param_6)) {
    ...
    FUN_006d7a30(((*(int *)(param_1 + 8) - param_4) + -1) * uVar1 + param_2 + param_3,-uVar1,param_5
