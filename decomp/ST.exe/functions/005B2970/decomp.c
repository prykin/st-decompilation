...
void FUN_005b2970(char param_1)

{
  ...
  if (*(int *)(DAT_0081176c + 0x28) != 0) {
    puVar6 = (undefined4 *)((int)local_8 + 0x1a7f);
    do {
      iVar3 = 0;
      bVar9 = 0;
  ...
  iVar3 = 0;
  do {
    iVar8 = *(int *)((int)local_8 + iVar3 * 4 + 0x1a7f);
    if (iVar8 != 0) {
      puVar6 = FUN_006c4a20(iVar8);
      *(undefined4 **)((int)local_8 + iVar3 * 4 + 0x1aa7) = puVar6;
...
switchD_005b2a8d_default:
    iVar3 = iVar3 + 1;
    if (9 < iVar3) {
      thunk_FUN_005b5240((undefined4 *)((int)local_8 + 0x9b),s_MM_MBUT00_007cbd98,0xf2,0x13a,7,8,0,0
                         ,0x9d,0x38,0x33,0x7cbda4,6,8,9,6,0x28,0,0,0,0,0,-1,-1);
      thunk_FUN_005b5240((undefined4 *)((int)local_8 + 0x296),s_MM_MBUT01_007cbd7c,0x191,0x13a,9,8,0
                         ,0,0x9d,0x38,0x33,0x7cbd88,8,8,8,6,0x32,0,0,0,0,0,-1,-1);
      thunk_FUN_005b5240((undefined4 *)((int)local_8 + 0x491),s_MM_MBUT02_007cbd60,0xf2,0x173,8,6,0,
                         0,0x9d,0x38,0x33,0x7cbd6c,8,7,10,5,0x28,0,0,0,0,0,-1,-1);
      thunk_FUN_005b5240((undefined4 *)((int)local_8 + 0x68c),s_MM_MBUT03_007cbd44,0x191,0x173,8,6,0
                         ,0,0x9d,0x38,0x33,0x7cbd50,8,7,8,5,0x32,0,0,0,0,0,-1,-1);
      thunk_FUN_005b5240((undefined4 *)((int)local_8 + 0x887),s_MM_MBUT04_007cbd28,0x143,0x1ac,7,8,0
                         ,0,0x9d,0x38,0x33,0x7cbd34,8,9,9,6,0x32,0,0,0,0,0,-1,-1);
      ...
      *(undefined4 *)(DAT_0081176c + 0x2c) = uVar7;
      ...
      pvVar1 = *(void **)(*(int *)((int)local_8 + 0x1a5b) + 0x2e6);
      if (pvVar1 != (void *)0x0) {
        thunk_FUN_005b8c70(pvVar1,0,0,1);
        thunk_FUN_005b7210();
        *(undefined4 *)(*(int *)(*(int *)((int)local_8 + 0x1a5b) + 0x2e6) + 0x1cab) =
             *(undefined4 *)((int)local_8 + 8);
      }
      FUN_006bc360(*(int *)(DAT_0081176c + 0x2c),(undefined4 *)((int)local_8 + 0x1adf),(int *)0x0);
      pvVar1 = DAT_00802a30;
      if (DAT_00802a30 != (void *)0x0) {
      ...
      thunk_FUN_005b3d60(local_8,param_1,1);
      thunk_FUN_00568bc0(&DAT_00807658,0);
      if ((DAT_00807300._1_1_ & 8) != 0) {
        thunk_FUN_0056a130(&DAT_00807658,0x10,'\x02',0,(uint *)0x0);
      }
      if (DAT_00808446 == '\0') {
        *(undefined4 *)((int)local_8 + 0x1a6b) = 2;
        *(undefined4 *)((int)local_8 + 0x1a67) = *(undefined4 *)((int)local_8 + 8);
        *(undefined4 *)((int)local_8 + 0x1a6f) = 0x6902;
      }
      DAT_00858df8 = local_4c;
      return;
    }
