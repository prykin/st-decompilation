...
undefined4 __fastcall thunk_FUN_00632e30(int *param_1)

{
  ...
  case 0:
    *(undefined4 *)((int)param_1 + 0x5d) = DAT_007d1a54;
    fStack_8 = _DAT_0079c5a4 / (float)*(int *)((int)param_1 + 0x19);
    ...
    if (0 < *(int *)((int)param_1 + 0x1d)) {
      ...
      do {
        fVar1 = *(float *)((int)param_1 + 0x91) -
                (float)(int)fStack_10 * *(float *)((int)param_1 + 0x7d);
        if (fVar1 < _DAT_0079034c) {
          if (_DAT_0079034c < *pfVar7) {
            uVar10 = *(int *)((int)param_1 + 0x19) * (int)fStack_10;
        ...
        *pfVar7 = fVar1;
        pfVar7 = pfVar7 + 1;
      } while ((int)fStack_10 < *(int *)((int)param_1 + 0x1d));
    }
    break;
  case 3:
    ...
    *(undefined4 *)((int)param_1 + 0x35) = 0;
    if (bVar4) {
      ...
      if (0 < iVar11) {
        do {
          *(float *)(iVar6 + (int)fStack_10 * 4) =
               (float)(int)fStack_10 * (fVar1 / (float)(iVar11 + -1)) +
               *(float *)((int)param_1 + 0x69);
          *(float *)(*(int *)((int)param_1 + 0x39) +
                    ((int)fStack_10 + *(int *)((int)param_1 + 0x19)) * 4) =
               (float)(int)fStack_10 * (fVar2 / (float)iVar11);
          iVar6 = *(int *)((int)param_1 + 0x39);
          if (*(float *)((int)param_1 + 0x45) < *(float *)(iVar6 + (int)fStack_10 * 4)) {
          ...
          fStack_10 = (float)((int)fStack_10 + 1);
        } while ((int)fStack_10 < *(int *)((int)param_1 + 0x19));
      }
    }
    ...
    *(undefined4 *)((int)param_1 + 0x71) = 0x40490fdb;
    if (bVar4) {
      ...
      *(float *)((int)param_1 + 0x81) = _DAT_0079d1a4 / (float)iStack_14;
    }
  ...
  case 4:
    ...
    *(undefined4 *)((int)param_1 + 0x89) = DAT_007d1ba0;
    if ((*param_1 != 0) && (iVar6 = *(int *)(*param_1 + 0xc), iVar6 != 0)) {
      uVar10 = 0;
      fStack_10 = 0.0;
      fStack_8 = _DAT_0079c5a4 / (float)*(int *)((int)param_1 + 0x1d);
      if (0 < *(int *)((int)param_1 + 0x1d)) {
        do {
          iVar11 = *param_1;
          if ((uVar10 < *(uint *)(iVar11 + 0xc)) &&
