...
LAB_00618ce0:
        ...
        iVar6 = sub_0061BDB0(this_00,CASE_0,this_00->field_00E7,this_00->field_00EB,
                             this_00->field_00EF);
        if (iVar6 == 0) {
          /* ST_CALLSITE[00618D42]: CALL 0x00403e6d; direct=00403E6D STJumpMineC::sub_0061BDB0 */
          iVar6 = sub_0061BDB0(this_00,CASE_1,this_00->field_00E7,this_00->field_00EB,
                               this_00->field_00EF);
      ...
      thunk_FUN_00619320((RecoveredRecord_00619320_830454A8 *)this_00);
      g_currentExceptionFrame = local_58.previous;
      return 0;
    }
  }
