...
void __thiscall FUN_00511ab0(void *this,int param_1,uint param_2)

{
  ...
  if ((*(int *)((int)this + 0x218) != 0) &&
    ...
    if (iVar4 == 0) {
      iVar8 = 1;
      iVar4 = *(int *)((int)local_c + 0x218);
      piVar1 = (int *)((int)local_c + 0x218);
      puVar6 = (undefined4 *)(*(int *)((int)local_c + 0x1dc) + 0x28);
      uVar5 = FUN_006b4fe0(*(int *)((int)local_c + 0x1dc));
      puVar6 = (undefined4 *)
