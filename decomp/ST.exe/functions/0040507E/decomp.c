...
undefined4 thunk_FUN_0054bf40(ushort param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  iVar2 = __setjmp3(auStack_54,0,unaff_ESI,uVar4);
  if (iVar2 != 0) {
  ...
  if (*(ushort *)((int)pvStack_14 + 0x494) == param_1) {
switchD_0054bfbc_caseD_20:
    DAT_00858df8 = (undefined1 *)uVar4;
    return uStack_10;
  }
  *(ushort *)((int)pvStack_14 + 0x494) = param_1;
  *(undefined4 *)((int)pvStack_14 + 0xc5) = param_2;
  *(undefined4 *)((int)pvStack_14 + 0xc9) = param_3;
  switch((uint)param_1) {
  case 0:
    switch(*(char *)((int)pvStack_14 + 0x493)) {
    case '\x01':
    ...
    iVar3 = -1;
    iVar2 = -1;
    if (*(char *)((int)pvStack_14 + 0x493) == '\x05') {
      uVar8 = 0x12;
...
LAB_0054c06f:
    ...
    thunk_FUN_00543c90(pvStack_14,*(int *)((int)pvStack_14 + 0xc5),*(int *)((int)pvStack_14 + 0xc9))
    ;
    DAT_00858df8 = (undefined1 *)uVar4;
    return 0;
  case 0x39:
