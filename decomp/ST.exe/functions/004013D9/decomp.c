...
LAB_00590d4c:
          puVar5 = *(undefined4 **)(this_01 + (iStack_c + iVar2) * 4 + 0x1b13);
          if (puVar5 != (undefined4 *)0x0) {
            if (iStack_8 == 2) {
              switch(iVar2) {
              case 0:
...
switchD_00590d73_default:
        ...
        if (2 < iStack_8) {
          ...
          *(undefined1 *)((int)puVar5 + 2) = 0;
          uStack_238 = *(undefined4 *)(this_01 + 8);
          ...
          *(undefined4 *)(this_01 + 0x1bf4) = 0;
          ...
          if (*(int *)(iVar2 + 0x2e6) != 0) {
            ...
            *(undefined2 *)puVar5 = 0xffff;
            MMsgTy::SetPanel(*(MMsgTy **)(iVar2 + 0x2e6),0,(int)&uStack_26c,0,0);
            MMsgTy::StatePanel(*(MMsgTy **)(*(int *)(this_01 + 0x1a5b) + 0x2e6),(int)auStack_70);
          }
