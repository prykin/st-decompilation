...

{
  ...
  *(short *)(this + 0x2e) = sVar2;
  ...
  if (param_1 == 0) {
    if (*(int *)(pCStack_8 + 0x9d0) != 0) {
      FUN_006e6080(pCStack_8,2,*(int *)(pCStack_8 + 0x9d0),(undefined4 *)(pCStack_8 + 0x18));
    }
    pCVar6 = pCVar5 + 0xa15;
    iVar4 = 6;
    do {
    ...
    if (*(int *)(pCStack_8 + 0x95c) != 0) {
      FUN_006e6080(pCStack_8,2,*(int *)(pCStack_8 + 0x95c),(undefined4 *)(pCStack_8 + 0x18));
    }
    pCVar6 = pCVar5 + 0x960;
    iVar4 = 4;
    do {
  ...
  if (((char)uStack_c != '\0') && (*(int *)(pCVar5 + uVar7 * 4 + 0x314) != 0)) {
