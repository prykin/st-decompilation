  ...
  if ((param_1 == (int *)0x0) || (param_1 == (int *)0x1)) {
    ...
    *(int *)(this + 0x6b9) = iVar5;
    if (iVar5 == 1) {
      ...
      pSStack_c = (STBoatC *)CONCAT22(extraout_var_03,*(short *)(this + 0x6ad));
      iStack_10 = CONCAT22(iStack_10._2_2_,sVar13);
      iStack_8 = 0;
      sVar16 = *(short *)(this + 0x6ad) + 1;
      uStack_14 = CONCAT22(uStack_14._2_2_,*(short *)(this + 0x6a9));
      do {
        iStack_18 = 0;
        sVar12 = (short)iStack_8 + *(short *)(this + 0x6a9);
        do {
    ...
    pSStack_c = (STBoatC *)CONCAT22(uVar3,*(short *)(this + 0x6ad));
    sVar13 = *(short *)(this + 0x6ab);
...
LAB_0047f4cd:
    ...
    *(undefined4 *)(this + 0xb7) = 3;
    thunk_FUN_00481520(this,(int)(short)uVar11,(int)sVar13,(short)pSStack_c + 1);
          ...
          do {
            puVar9 = (undefined4 *)
                     thunk_FUN_0041dc40(auStack_2c,*(undefined4 *)pSStack_c,
                                        *(undefined2 *)(pSStack_c + 4),*(short *)(this + 0x6c));
            uVar11 = *puVar9;
            ...
            if (DAT_0080732c == 1) {
              ...
              *(uint *)(this + 0x1c) = uStack_1c;
              ...
              TraksClassTy::TraksCreate
                        (DAT_00802a7c,1,2,7,
                         (uStack_1c >> 0x10) % 7 + (int)*(short *)(this + 0x41) + -3 +
                         (int)(short)uStack_24,
                         (((uVar10 >> 0x10) % 7 + (int)*(short *)(this + 0x43)) -
                         (int)uStack_24._2_2_) + -3,
                         (int)(short)lVar18 + (uVar8 >> 0x10) % 7 + (int)*(short *)(this + 0x45) +
                         -3 + (int)sStack_20,sVar13,sVar16,sVar12,sVar4,sVar19,sVar20,iVar5,sVar21,
                         bVar22);
            }
            else {
              ...
              *(uint *)(this + 0x1c) = uVar8;
              ...
              TraksClassTy::TraksCreate
                        (DAT_00802a7c,1,2,7,
                         ...
                         (uVar10 >> 0x10) % 7 + (int)*(short *)(this + 0x45) + -3 + (int)sStack_20,0
                         ,0,0,0,0,0,-1,0,0);
            }
            iStack_8 = iStack_8 + 1;
            pSStack_c = pSStack_c + 6;
          } while (iStack_8 < (int)(uint)(byte)this[0x2bf]);
        }
        if (iStack_10 == -1) {
                ...
                do {
                  ...
                  TraksClassTy::TraksCreate
                            (DAT_00802a7c,1,2,7,
                             ...
                             (int)(short)uStack_24,iVar15 + -3,iVar5,sVar13,sVar16,sVar12,sVar4,
