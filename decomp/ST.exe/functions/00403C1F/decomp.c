  ...
  if ((param_3 == (int *)0x0) || (param_3 == (int *)0x1)) {
    ...
    *(int *)((int)param_1 + 0x6b9) = iVar5;
    if (iVar5 == 1) {
      ...
      iStack_10 = CONCAT22(iStack_10._2_2_,sVar13);
      iStack_8 = 0;
      sVar16 = *(short *)((int)param_1 + 0x6ad) + 1;
      uStack_14 = CONCAT22(uStack_14._2_2_,*(short *)((int)param_1 + 0x6a9));
      do {
        iStack_18 = 0;
        sVar12 = (short)iStack_8 + *(short *)((int)param_1 + 0x6a9);
        do {
          sVar4 = sVar13 + (short)iStack_18;
...
LAB_0047f4cd:
    ...
    *(undefined4 *)((int)param_1 + 0xb7) = 3;
    thunk_FUN_00481520(param_1,(int)(short)uVar11,(int)sVar13,(short)puStack_c + 1);
          ...
          do {
            ...
            if (DAT_0080732c == 1) {
              ...
              thunk_FUN_00556760(DAT_00802a7c,1,2,7,
                                 ...
                                 (int)*(short *)((int)param_1 + 0x45) + -3 + (int)sStack_20,sVar13,
              ...
              param_1[7] = uVar8;
              uStack_24._2_2_ = (short)((uint)uVar11 >> 0x10);
              iVar5 = (int)uStack_24._2_2_;
              uStack_24._0_2_ = (short)uVar11;
              iVar15 = (int)(short)uStack_24;
              thunk_FUN_00556760(DAT_00802a7c,1,2,7,
            ...
            if (*(int *)((int)param_1 + 0x6c7) == 3) {
              ...
              if (*(char *)((int)param_1 + 0x2bf) != '\0') {
                ...
                do {
                  ...
                  thunk_FUN_00556760(DAT_00802a7c,1,2,7,
                                     (uVar8 >> 0x10) % 7 + (int)*(short *)((int)param_1 + 0x41) + -3
                                     + (int)(short)uStack_24,iVar15 + -3,iVar5,sVar13,sVar16,sVar12,
