...

{
  ...
  if (iVar3 == 0) {
    ...
    puVar9 = cMf32::RecGet(g_cMf32_00806790,1,pCVar7,piVar21,iVar3);
    iVar3 = 1;
    piVar21 = (int *)0x0;
    ...
    puVar9 = cMf32::RecGet(g_cMf32_00806790,bVar2,pcVar11,piVar21,iVar3);
    iVar3 = 1;
    piVar21 = (int *)0x0;
    ...
    puVar9 = cMf32::RecGet(g_cMf32_00806790,1,pcVar11,piVar21,iVar3);
    iVar3 = 1;
    piVar21 = (int *)0x0;
    ...
    if (((byte)_DAT_00807348 != 0) && ((byte)_DAT_00807348 < 3)) {
      ...
      cMf32::RecGet(g_cMf32_00806790,1,pCVar7,piVar21,iVar20);
    ...
    *piVar21 = iVar3;
    ...
    psVar25 = Library::Ourlib::MFIMG::mfQmtLoad(g_cMf32_00806790,pcVar11,bVar2,bVar19,psVar25);
