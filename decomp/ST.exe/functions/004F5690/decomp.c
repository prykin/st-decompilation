...

{
  ...
  if (iVar3 == 0) {
    ...
    pcVar6 = (ccFntTy *)ccFntTy::operator(this_01,0x19d,DAT_00806790,s_TIME_FONT_007c212c,0);
    ...
    puVar5[0x16] = 0;
    puVar5[0x17] = 0;
    pcVar6 = (ccFntTy *)ccFntTy::operator(this_02,0x19d,DAT_00806790,s_MONEY_FONT_007c211c,0);
    this_00->field_01C4 = pcVar6;
    pcVar6->field_0058 = 1;
    pcVar6->field_005C = 0;
    pcVar6 = (ccFntTy *)ccFntTy::operator(this_03,0x19d,DAT_00806790,s_TIMER_FONT_007c210c,0);
    this_00->field_01CC = pcVar6;
    pcVar6->field_0058 = 1;
    pcVar6->field_005C = 0;
    pcVar6 = (ccFntTy *)ccFntTy::operator(DAT_00806790,0x19d,DAT_00806790,s_HOLD_FONT_007c1844,0);
    ...
    iVar3 = FUN_0070a9f0(DAT_00806790,pCVar7,bVar2,iVar3);
    ...
    uVar8 = FUN_0070a9f0(DAT_00806790,pCVar7,bVar2,iVar3);
    ...
    puVar9 = mfRLoad(DAT_00806794,CASE_B,(byte *)s_IND_BKG_007c20c8,0xffffffff,0,1,0,
                     (undefined4 *)0x0);
    this_00->field_02B2 = puVar9;
    puVar9 = mfRLoad(DAT_00806794,CASE_B,(byte *)s_INF_WEAP_007c20bc,0xffffffff,0,1,0,
                     (undefined4 *)0x0);
    this_00->field_028E = puVar9;
    puVar9 = mfRLoad(DAT_00806794,CASE_B,(byte *)s_INF_WEAPD_007c20b0,0xffffffff,0,1,0,
                     (undefined4 *)0x0);
    this_00->field_0292 = puVar9;
    puVar9 = mfRLoad(DAT_00806794,CASE_B,(byte *)s_UPG_BOAT_007c20a4,0xffffffff,0,1,0,
                     (undefined4 *)0x0);
    this_00->field_0296 = puVar9;
    puVar9 = mfRLoad(DAT_00806794,CASE_B,&DAT_007c20a0,0xffffffff,0,1,0,(undefined4 *)0x0);
    ...
    if (DAT_0080874e != '\x03') {
      ...
      puVar9 = mfRLoad(DAT_00806794,CASE_B,pbVar10,uVar4,bVar2,iVar3,iVar20,puVar5);
    ...
    puVar9 = mfRLoad(DAT_00806794,CASE_B,&this_00->field_0x1e1,0xffffffff,0,1,0,(undefined4 *)0x0);
    this_00->field_02BA = puVar9;
    puVar9 = mfRLoad(DAT_00806794,CASE_B,(byte *)s_BOATS_R_007c206c,0xffffffff,0,1,0,
                     (undefined4 *)0x0);
    this_00->field_02BE = puVar9;
    puVar9 = mfRLoad(DAT_00806794,CASE_B,&DAT_007c1910,0xffffffff,0,1,0,(undefined4 *)0x0);
    this_00->field_02C2 = puVar9;
    puVar9 = mfRLoad(DAT_00806794,CASE_B,(byte *)s_SOBJS_007c2064,0xffffffff,0,1,0,(undefined4 *)0x0
                    );
    ...
    puVar9 = mfRLoad(DAT_00806794,CASE_B,(byte *)s_ARTEFACT_007c2050,0xffffffff,0,1,0,
                     (undefined4 *)0x0);
    this_00->field_02CE = puVar9;
    puVar9 = mfRLoad(DAT_00806794,CASE_B,&DAT_007c204c,0xffffffff,0,1,0,(undefined4 *)0x0);
    this_00->field_02D2 = puVar9;
    puVar9 = mfRLoad(DAT_00806794,CASE_B,&DAT_007c2048,0xffffffff,0,1,0,(undefined4 *)0x0);
    ...
    puVar9 = mfRLoad(DAT_00806794,CASE_B,(byte *)s_SPIMG_SI_007c202c,0xffffffff,0,1,0,
                     (undefined4 *)0x0);
    ...
    puVar9 = mfRLoad(DAT_00806794,CASE_B,(byte *)s_ENOBJ_007c2014,0xffffffff,0,1,0,(undefined4 *)0x0
                    );
    this_00->field_02DA = puVar9;
    puVar9 = mfRLoad(DAT_00806794,CASE_B,(byte *)s_BUT_MSK_SI_007c16f4,0xffffffff,0,1,0,
                     (undefined4 *)0x0);
    this_00->field_02DE = puVar9;
    puVar9 = mfRLoad(DAT_00806794,CASE_B,(byte *)s_MHELP_007c200c,0xffffffff,0,1,0,(undefined4 *)0x0
                    );
    ...
    do {
      ...
      iVar20 = FUN_00711110(this_00->field_01B8,puVar12);
      local_c = FUN_006b50c0(iVar20,iVar3,uVar14,uVar4,puVar5,iVar23);
      if (local_c != 0) {
        ...
        ccFntTy::SetSurf(this_00->field_01B8,local_c,0,0,0,0,0);
    ...
    do {
      ...
      bVar2 = 0;
      uVar4 = 0xffffffff;
      pbVar10 = (byte *)FUN_006f2c00(s_SM_TARGET__007c1eec,1,iVar3);
      puVar9 = mfRLoad(DAT_00806784,CASE_B,pbVar10,uVar4,bVar2,iVar20,iVar23,puVar24);
      *(ushort **)((int)puVar5 + -0x3f7) = puVar9;
      iVar20 = 1;
      piVar21 = (int *)0x0;
      *puVar5 = puVar9 + 0x18;
      pCVar7 = FUN_006f2c00(s_SM_CROSS__007c1ee0,1,iVar3);
      puVar9 = cMf32::RecGet(DAT_00806780,6,pCVar7,piVar21,iVar20);
      puVar5[-2] = puVar9;
      iVar3 = iVar3 + 1;
      puVar5 = puVar5 + 1;
      local_14 = local_14 + -1;
    ...
    STAllPlayersC::GetPanelInfo(DAT_007fa174,2,&this_00->field_0B99);
    STAllPlayersC::GetPanelInfo(DAT_007fa174,4,&this_00->field_0BF5);
    ...
    bVar2 = 0;
    uVar4 = 6;
    pbVar10 = (byte *)thunk_FUN_00526100(&this_00->field_0B63,0);
    puVar9 = mfRLoad(DAT_00806794,CASE_1F,pbVar10,uVar4,bVar2,iVar3,iVar20,puVar5);
    ...
    pbVar10 = (byte *)thunk_FUN_00526100(&this_00->field_0C51,0);
    puVar9 = mfRLoad(DAT_00806794,CASE_1F,pbVar10,uVar4,bVar2,iVar3,iVar20,puVar5);
    ...
    do {
      ...
      do {
        ...
        puVar9 = mfRLoad(DAT_00806794,CASE_1F,pbVar10,uVar4,bVar2,iVar3,iVar20,puVar24);
        puVar5[-0x12] = puVar9;
        puVar15[-0xc] = 0;
        *puVar15 = 1;
    ...
    *piVar21 = iVar3;
    ...
    iVar23 = iVar23 + this_00->field_0078;
    iVar20 = this_00->field_007C;
    this_00->field_0050 = iVar23;
    if (DAT_0080874e != '\x03') {
      iVar23 = iVar23 + iVar20;
      iVar20 = this_00->field_0080;
      this_00->field_0054 = iVar23;
    }
    this_00->field_0064 = iVar3;
    this_00->field_0058 = iVar23 + iVar20;
    this_00->field_005C = iVar23 + iVar20;
    iVar3 = 10;
    ...
    psVar13 = mfQmtLoad(DAT_00806790,pcVar11,bVar2,bVar19,iVar3);
    this_00->field_025B = psVar13;
    ...
    *(uint *)&this_00->field_0x2c = (uint)(DAT_00807327 & 2 | 1);
    ...
    uVar8 = CreateBut(this_00,4,3,*(int *)&this_00->field_0x2c,local_34 - this_00->field_004C,
                      local_30 - this_00->field_00A4,6,(int)pCVar7,uVar8,uVar16,sVar17,uVar18,iVar3,
                      pcVar11,iVar20,uVar22,uVar25);
    ...
    *(uint *)&this_00->field_0x2c = (uint)(byte)((DAT_00807327 & 4 | 2) >> 1);
    ...
    uVar8 = CreateBut(this_00,4,1,1,(DAT_0080874e == '\x03') + 0x58,0x6d,6,(int)pCVar7,uVar16,uVar22
                      ,sVar17,uVar18,iVar3,pcVar11,iVar20,uVar25,uVar26);
    uVar26 = 0;
    uVar25 = 0;
    iVar20 = 0;
    ...
    uVar8 = CreateBut(this_00,4,1,1,(DAT_0080874e == '\x03') + 0x5d,0x84,6,(int)pCVar7,uVar16,uVar22
                      ,sVar17,uVar18,iVar3,pcVar11,iVar20,uVar25,uVar26);
    uVar26 = 0;
    uVar25 = 0;
    iVar20 = 0;
    ...
    uVar8 = CreateBut(this_00,4,1,1,(DAT_0080874e == '\x03') + 0xd,0x84,6,(int)pCVar7,uVar16,uVar22,
                      sVar17,uVar18,iVar3,pcVar11,iVar20,uVar25,uVar26);
    uVar26 = 0;
    uVar25 = 0;
    iVar20 = 0;
    ...
    uVar8 = CreateBut(this_00,4,1,1,(DAT_0080874e == '\x03') + 0x1c,0x6d,6,(int)pCVar7,uVar16,uVar22
                      ,sVar17,uVar18,iVar3,pcVar11,iVar20,uVar25,uVar26);
    uVar26 = 0;
    uVar25 = 0;
    iVar20 = 0;
    ...
    uVar8 = CreateBut(this_00,4,3,(DAT_00807327 & 8 | 4) >> 2,6,0x20,6,(int)pCVar7,uVar16,uVar22,
                      sVar17,uVar18,iVar3,pcVar11,iVar20,uVar25,uVar26);
    ...
    *(uint *)&this_00->field_0x2c = (uint)(byte)this_00->field_0BAE;
    ...
    uVar8 = CreateBut(this_00,4,3,(uint)(byte)this_00->field_0BAE,local_34 - this_00->field_004C,
                      local_30 - this_00->field_00A4,1,(int)pCVar7,uVar8,uVar16,sVar17,uVar18,iVar3,
                      pcVar11,iVar20,uVar22,uVar25);
    ...
    *(uint *)((int)DAT_00807598 + 0x418) = (uint)DAT_00807327;
    ...
    if ((DAT_00807327 & 8) != 0) {
      FUN_006e6500(DAT_00807598,&this_00->field_0227);
    }
    puVar5 = (undefined4 *)puVar15;
  ...
  g_currentExceptionFrame = local_78.previous;
  iVar20 = ReportDebugMessage(s_E____titans_Andrey_cpanel_cpp_007c1bd8,0x1bf,0,iVar3,&DAT_007a4ccc,
