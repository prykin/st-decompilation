...

{
  ...
  pcVar4 = (char *)thunk_FUN_00649ff0(&DAT_0080f33a,&local_8,(undefined4 *)0x0,(int *)0x0);
  if (pcVar4 == (char *)0x0) {
    thunk_FUN_005a0ff0();
    DAT_00858df8 = local_90;
    return;
  ...
  FUN_00710a90(local_c[0x6b0],0,0,0x16,0x1b8,0xf0);
  iVar13 = -1;
  iVar12 = -1;
  uVar11 = 2;
  iVar10 = -1;
  ...
  FUN_006b35d0(DAT_008075a8,local_c[0x6af]);
  puVar5 = local_2c;
  ...
  local_4c[2] = local_c[2];
  local_2c[3] = 2;
  local_2c[4] = 0x6957;
  local_4c[3] = 2;
  local_4c[4] = 0x6956;
  this = *(void **)(*(int *)((int)local_c + 0x1a5b) + 0x2e6);
  local_2c[2] = local_4c[2];
  if (this != (void *)0x0) {
    thunk_FUN_005b7ef0(this,0x25b7,'\x01',local_2c,local_4c,(undefined4 *)0x0,local_8,0x25b8);
    DAT_00858df8 = local_90;
    return;
  }
