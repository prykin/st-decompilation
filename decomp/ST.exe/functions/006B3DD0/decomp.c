...

{
  ...
  exceptionCode =
       FUN_006b1d50(param_1,(uint *)(param_1 + 0x1e0),param_13,0,(int *)0x0,0,0xffffffff,0xffffffff,
                    0,1);
  if (exceptionCode == 0) {
    ...
    *(undefined4 *)(param_1 + 0x1b4) = 1;
    ...
    uVar3 = ((int)(param_4 + 7 + ((int)(param_4 + 7) >> 0x1f & 7U)) >> 3) * param_5;
    puVar2 = FUN_006b04d0(uVar3);
    *(undefined4 *)(param_1 + 0x210) = puVar2;
    if (puVar2 != (undefined4 *)0x0) {
      puVar2 = FUN_006b04d0(uVar3);
      *(undefined4 *)(param_1 + 0x220) = puVar2;
      if (puVar2 != (undefined4 *)0x0) {
        return 0;
      }
    }
  ...
  RaiseInternalException(exceptionCode,DAT_007ed77c,s_E__DKW_DDX_C_ddsinit_c_007edac0,0x87d);
