  ...
  *(uint *)((int)param_1 + 0x49) = *(uint *)((int)param_1 + 0x49) | 1;
  if (param_2 != -1) {
    *(int *)((int)param_1 + 0x4d) = param_2;
    FUN_006ab060((undefined4 *)((int)param_1 + 0x59));
  }
    ...
    if (0 < iVar5) {
      do {
        ...
        if (*psVar4 != -1) {
          ...
          if (iVar2 != 0) {
            iVar3 = *(int *)(iVar2 + 199);
            if ((((iVar3 < 0) || (DAT_007fb278 <= iVar3)) || (*(int *)(iVar2 + 0xcb) < 0)) ||
               ((((int)DAT_007fb27a <= *(int *)(iVar2 + 0xcb) || (*(int *)(iVar2 + 0xcf) < 0)) ||
                ((int)DAT_007fb27c <= *(int *)(iVar2 + 0xcf))))) {
