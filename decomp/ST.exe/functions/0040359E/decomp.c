...
void thunk_FUN_00556170(int param_1)

{
  ...
  if (iVar2 == 0) {
    *(undefined4 *)(iStack_c + 0x1c) = *(undefined4 *)(param_1 + 0x18);
    if (*(char *)(param_1 + 0x1c) == '\0') {
      puVar5 = FUN_006ae290((uint *)0x0,0x32,0x3c,0x32);
      *(uint **)(iStack_c + 0x24) = puVar5;
    }
    else {
      iVar2 = FUN_006b0060((uint *)0x0,(uint *)(param_1 + 0x5c));
      *(int *)(iStack_c + 0x24) = iVar2;
      *(undefined4 *)(iVar2 + 4) = 0;
      while( true ) {
        iVar2 = *(int *)(iStack_c + 0x24);
        uVar8 = *(uint *)(iVar2 + 4);
        ...
        psVar6[0x1b] = *puVar4;
        iVar2 = *psVar6 * 0x18;
        FUN_006e8660(DAT_00807598,(int *)&uStack_8,1,0,*(uint *)(&DAT_007c9000 + iVar2),
                     *(uint *)(&DAT_007c9004 + iVar2),*(uint *)(&DAT_007c8ff8 + iVar2),
                     *(uint *)(&DAT_007c8ffc + iVar2),0);
        *(uint *)(psVar6 + 0x19) = uStack_8;
        FUN_006e98e0(DAT_00807598,uStack_8,0,(int)psVar6[0x1b],*(int *)((int)puVar4 + 0x21),1);
        ...
        *(undefined4 *)(psVar6 + 0x12) = *(undefined4 *)(iStack_c + 0x20);
      }
    }
  ...
  g_currentExceptionFrame = IStack_54.previous;
  iVar10 = ReportDebugMessage(s_E____titans_grig_traks_cpp_007c9104,0x11b,0,iVar2,&DAT_007a4ccc,
  ...
  RaiseInternalException(iVar2,0,s_E____titans_grig_traks_cpp_007c9104,0x11c);
  return;
}
