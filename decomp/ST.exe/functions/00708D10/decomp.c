...
void __thiscall
SubmarineTitans::Recovered::HiddenThis::RecoveredReceiver_00702510::FUN_00708d10
    ...
    if (iVar1 != 0) {
      ...
      if (DAT_00856fc8 == DAT_00857008) {
        ...
        if (iVar1 < 1) {
          ...
          local_8 = FUN_006cfe10((RecoveredRecord_006CFE10_B59F6D2D *)param_3,iVar1);
        }
        if (param_8 == 0) {
          if (local_50 == local_10) {
            if (local_24 == 0) {
              FUN_006f4e70(pbVar8,param_2,local_20,this->field_0028 << 1,param_6,local_8,local_50,
                           local_4c);
            }
            else {
            ...
            FUN_006f5240(pbVar8,param_2,local_20,this->field_0028 << 1,param_6,local_8,(int)local_10
          ...
          if (local_24 == 0) {
            FUN_006f5c60(pbVar8,param_2,pbVar8,param_2,(ushort *)local_20,this->field_0028 << 1,
          ...
          FUN_006f7d10(pbVar8,param_2,pbVar8,param_2,(ushort *)local_20,this->field_0028 << 1,
        ...
        if (local_2c < 1) {
          ...
          local_8 = FUN_006cfe10((RecoveredRecord_006CFE10_B59F6D2D *)param_3,local_2c);
        }
        if (param_8 == 0) {
          if (local_24 == 0) {
            if (DAT_00857008 == 3) {
              FUN_006f8ab0(pbVar8,param_2,(ushort *)local_20,local_14->field_0028 << 1,param_6,
                           local_8,(int)local_10,local_38,iVar1 - local_38,iVar7 - local_2c,local_c,
                           local_18);
              this = local_14;
            }
            else {
              FUN_006f94d0(pbVar8,param_2,(ushort *)local_20,local_14->field_0028 << 1,param_6,
                           local_8,(int)local_10,local_38,iVar1 - local_38,iVar7 - local_2c,local_c,
                           local_18);
              this = local_14;
            }
          ...
          if (DAT_00857008 == 3) {
            FUN_00702510(pbVar8,param_2,pbVar8,param_2,(ushort *)local_20,local_14->field_0028 << 1,
                         param_6,local_8,(int)local_10,local_38,iVar1 - local_38,iVar7 - local_2c,
                         local_c,local_18,local_1c);
            this = local_14;
          }
          else {
            FUN_00702a30(pbVar8,param_2,pbVar8,param_2,(ushort *)local_20,local_14->field_0028 << 1,
                         param_6,local_8,(int)local_10,local_38,iVar1 - local_38,iVar7 - local_2c,
                         local_c,local_18,local_1c);
            this = local_14;
          }
