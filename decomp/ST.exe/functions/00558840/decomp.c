    ...
    if (uVar6 < 0x109) {
      if (uVar6 == 0x108) {
        if (*(int *)(local_14 + 0x114) != 0) {
          ...
          iVar2 = *(int *)(local_14 + 0x30);
          iVar5 = *(int *)(local_14 + 0x34);
          *(undefined4 *)(local_14 + 0x10c) = uVar3;
          puVar7 = *(undefined4 **)(local_14 + 0x50);
          ...
          iVar2 = *(int *)(local_14 + 0x30);
          iVar5 = *(int *)(local_14 + 0x34);
          puVar7 = *(undefined4 **)(local_14 + 0x4c);
        ...
        if ((local_8 == (ushort *)0x0) || (*(int *)(local_8 + 10) == 0)) {
          VisibleClassTy::InitData(local_14);
        }
        else {
          thunk_FUN_005585f0((int)local_8);
        }
        VisibleClassTy::Init(local_14);
