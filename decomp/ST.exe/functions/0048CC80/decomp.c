...
void FUN_0048cc80(char param_1,short param_2,int param_3)

{
  ...
  if (*(int *)(local_10 + 0x47b) == 0) {
    ...
    *(uint **)(local_10 + 0x47b) = puVar5;
  }
  uVar1 = (*(uint **)(local_10 + 0x47b))[3];
  uVar3 = uVar1;
  if (uVar1 != 0) {
    while (local_c = uVar3, uVar1 = uVar1 - 1, -1 < (int)uVar1) {
      FUN_006acc70(*(int *)(local_10 + 0x47b),uVar1,&local_20);
      uVar3 = uVar1;
      if (((local_1c != -1) && (uVar3 = local_c, local_20 == param_1)) && (local_1c == param_2)) {
        local_1a = local_1a + param_3;
        local_16 = local_8;
        FUN_006ae140(*(uint **)(local_10 + 0x47b),uVar1,&local_20);
    ...
    local_1a = param_3;
    local_16 = local_8;
    FUN_006ae140(*(uint **)(local_10 + 0x47b),local_c,&local_20);
    DAT_00858df8 = (undefined4 *)local_64;
    return;
  }
  local_20 = (int)param_1;
  ...
  local_1a = param_3;
  local_16 = local_8;
  FUN_006ae1c0(*(uint **)(local_10 + 0x47b),&local_20);
  DAT_00858df8 = (undefined4 *)local_64;
  return;
}
