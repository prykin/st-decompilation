...

{
  ...
  this_00 = local_10;
  if (iVar6 == 0) {
    if (*(byte **)&local_10->field_0x1ae8 != (byte *)0x0) {
      FUN_006b5570(*(byte **)&local_10->field_0x1ae8);
    }
    puVar2 = Library::DKW::TBL::FUN_006b54f0((uint *)0x0,1,1);
    *(uint **)&this_00->field_0x1ae8 = puVar2;
    ...
    uVar3 = FUN_006b4fe0(*(int *)&this_00->field_0x5d);
    uVar4 = FUN_006b50c0(0x2e1,0x175,(uint)*(ushort *)(*(int *)&this_00->field_0x5d + 0xe),uVar3,
                         puVar8,iVar6);
    ...
    *(undefined4 *)&this_00->field_0x1b24 = uVar4;
    ...
    local_8e0[2] = *(undefined4 *)&this_00->field_0x1a73;
    local_8e0[8] = *(undefined4 *)&this_00->field_0x1ae8;
    local_894 = *(undefined4 *)&this_00->field_0x8;
    local_850 = 2;
    local_890 = 2;
    local_8e0[0] = 1;
    local_8e0[1] = 0x89;
    ...
    local_88c = 0x6988;
    local_854 = local_894;
    (**(code **)(**(int **)&this_00->field_0xc + 8))(6,&this_00->field_0x1ac4,0,local_8e0,0);
