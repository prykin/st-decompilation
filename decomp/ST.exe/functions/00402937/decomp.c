...
void thunk_FUN_005dd470(int param_1)

{
  ...
  if (iVar6 == 0x633f) {
    if ((((*(int *)(iStack_8 + 0x67e) != 0) && (DAT_0080c4fa != 0)) &&
        (-1 < *(int *)(iStack_8 + 0x558))) &&
       ((param_1 != 0 && (iVar6 = *(int *)(param_1 + 0x1c), iVar6 != 0)))) {
      iVar5 = *(int *)(iStack_8 + 0x34);
      iStack_10 = iVar6;
      if (*(int *)(iVar5 + 0xa0) != 0) {
        FUN_00710790(iVar5);
      }
      ...
      if ((int)uVar7 < (int)(uVar7 + *(int *)(iVar6 + 0x1e0))) {
        do {
          ...
          if (puVar9 != (uint *)0x0) {
            FUN_00710a90(*(int *)(iStack_8 + 0x67e),0,0,(uVar8 - uVar7) * iStack_c,
                         *(int *)(*(int *)(iStack_8 + 0x67e) + 4),iStack_c);
      ...
      FUN_006b35d0(DAT_008075a8,*(uint *)(iStack_8 + 0x558));
    }
  }
  else {
    if (iVar6 == 0xc0a0) {
      iVar6 = *(int *)(iStack_8 + 0x682);
      ...
      FUN_00710a90(*(int *)(iStack_8 + 0x682),0,0,0,0,0);
      ...
      if ((uVar1 != 0xffff) || (*(short *)(param_1 + 0x1a) != -1)) {
        FUN_006b5b10(*(int *)(iStack_8 + 0x682),0,(uint)uVar1,*(ushort *)(param_1 + 0x1a) + 2,
                     (uint)uVar1,
                     (*(int *)(*(int *)(iStack_8 + 0x682) + 8) - (uint)*(ushort *)(param_1 + 0x1a))
                     + -5,9,0xd);
      }
      FUN_006b35d0(DAT_008075a8,*(uint *)(iStack_8 + 0x554));
      DAT_00858df8 = (undefined4 *)uStack_74;
      return;
    }
    if ((iVar6 == 0xc0a1) && (*(int *)(iStack_8 + 0x54c) != 0)) {
      uStack_20 = 0x21;
      FUN_006e5970(2,*(int *)(iStack_8 + 0x54c),(int)auStack_30);
      if (iStack_1c == 0) {
        uStack_20 = 0x20;
        iStack_1c = 1;
        FUN_006e5970(2,*(int *)(iStack_8 + 0x54c),(int)auStack_30);
