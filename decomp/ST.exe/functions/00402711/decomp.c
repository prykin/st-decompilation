...
void __thiscall thunk_FUN_0063d100(void *this,undefined4 *param_1)

{
  ...
  *(undefined4 *)((int)this + 0x347) = 0;
  ...
  aiStack_20[0] = FUN_006aac70(0x44);
  iVar2 = 0;
  do {
    *(undefined4 *)(iVar2 + aiStack_20[0]) = DAT_00806774;
    iVar2 = iVar2 + 4;
  } while (iVar2 < 0x44);
  aiStack_20[1] = 0;
  aiStack_20[2] = 0;
  ...
  aiStack_20[5] = 0x10;
  aiStack_20[6] = 0;
  STT3DSprC::RestoreSpr((STT3DSprC *)((int)this + 0x1d5),aiStack_20,piVar4);
