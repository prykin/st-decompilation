    ...
    if (param_1->field_05DF == 5) {
      if (param_1->field_04CC + 2 <= g_playSystem_00802A38->field_00E4) {
        ...
        STT3DSprC::sub_004ACE30
                  ((STT3DSprC *)&param_1->field_01D5,PTR_00806724[1].entries[iVar4 + -0xc],
      ...
      iVar4 = thunk_FUN_004ac910(puVar1,'\x04');
      if ((*(int *)&param_1->field_01F5->field_0xa4 <= iVar4) &&
         (iVar4 = thunk_FUN_004ac910(puVar1,'\x05'),
         *(int *)&param_1->field_01F5->field_0xc8 <= iVar4)) {
        local_18 = param_1->field_0008;
        local_24 = param_1->field_000C->systemId;
        local_20 = 0;
        local_1c = 10;
      ...
      param_1->vfunc_D8();
      iVar4 = thunk_FUN_004ac910(puVar1,'\x04');
      if (iVar4 == *(int *)(&DAT_007cdf52 + *(int *)(&DAT_0079125c + param_1->field_0235 * 4) * 0x32
                           )) {
      ...
      iVar4 = *(int *)(&DAT_0079125c + param_1->field_0235 * 4);
      iVar6 = thunk_FUN_004ac910(puVar1,'\x04');
      if (iVar6 == *(int *)(&DAT_007cdf5a + iVar4 * 0x32)) {
        iVar4 = STT3DSprC::LoadSequence
                          ((STT3DSprC *)puVar1,5,DAT_00806764,"expl_bbt0" + iVar4 * 0x32,
                           0x1d);
        if (iVar4 != 0) {
          return 0xffff;
        }
  ...
  if (TVar2 == CASE_5) {
    ...
    if (param_1->field_04BC != 4) {
      ...
      if ((char)iVar4 == '\x03') {
        ...
        iVar4 = thunk_FUN_004ac910(&param_1->field_01D5,'\x05');
        if (iVar4 != *(int *)&param_1->field_01F5->field_0xc8) goto cf_common_exit_004B9130;
...
cf_common_exit_004B9130:
    ...
    iVar4 = thunk_FUN_004ac910(puVar1,'\x04');
    if (iVar4 != *(int *)&param_1->field_01F5->field_0xa4) goto cf_common_exit_004B9130;
    ...
    if (uVar5 == 1) {
      ...
      if (uVar5 != 3) goto cf_common_exit_004B8F5A;
      pTVar7 = param_1->vtable;
      arg_2 = 0x6a;
    }
...
cf_common_exit_004B8F5A:
  ...
  if (((param_1->field_0255 == 0) || (param_1->field_0245 != CASE_0)) || (param_1->field_0249 != 2))
  {
    ...
    iVar4 = param_1->field_0259 / 0xf;
    if (*(int *)(&DAT_007be8c8 + iVar4 * 0x60) != 0) {
      iVar4 = (((*(int *)(&DAT_007be8c8 + iVar4 * 0x60) < 1) - 1 & 2) - 1) + iVar4;
      if (iVar4 < 0x18) {
        if (iVar4 < 0) {
          iVar4 = 0x17;
        }
        TLOBaseTy::sub_004B98E0(param_1,iVar4 * 0xf);
      }
      else {
...
cf_common_join_004B92EE:
  ...
  if (((iVar6 < iVar4) && (iVar4 = STT3DSprC::sub_004ACD30((STT3DSprC *)puVar1,'\r'), 1 < iVar4)) &&
     (iVar4 = thunk_FUN_004cba10(), iVar4 == 2)) {
    pAVar3 = param_1->field_01F5;
    iVar4 = pAVar3->field_0208;
    if (iVar4 < (int)pAVar3->field_020C) {
      iVar4 = pAVar3->field_0210 - iVar4;
    }
    else {
      iVar4 = iVar4 - pAVar3->field_0210;
    }
    local_c = (AnonShape_0060D340_D77FEBE7 *)STT3DSprC::sub_004ACD30((STT3DSprC *)puVar1,'\x0e');
    iVar6 = STT3DSprC::sub_004ACD30((STT3DSprC *)puVar1,'\r');
    if (((int)local_c + (-1 - iVar6) <= iVar4) && ((param_1->field_01F1 & 0x2000) == 0)) {
  ...
  if ((param_1->field_05DF != 0) && (param_1->field_04CC + 2 <= g_playSystem_00802A38->field_00E4))
  {
    ...
    if (iVar6 == 0) {
      ...
      uVar5 = PTR_00806724->entries[iVar4 + -1];
    }
    STT3DSprC::sub_004ACE30((STT3DSprC *)&param_1->field_01D5,uVar5,iVar6);
  }
  param_1->vfunc_D8();
  return 0;
}
