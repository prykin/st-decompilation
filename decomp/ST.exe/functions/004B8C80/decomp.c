...

{
  ...
  if (TVar6 == CASE_1) {
    if (param_1->field_05DF == 5) {
      ...
      (*param_1->vtable->vfunc_D8)(param_1);
      iVar3 = thunk_FUN_004ac910(puVar1,'\x04');
  ...
  if (TVar6 == CASE_5) {
    ...
    if (param_1->field_04BC != 4) {
      ...
      if ((char)iVar3 == '\x03') {
        ...
        if (iVar3 == 2) {
          ...
          if (*(int *)(&DAT_007e3dc0 + ((uVar4 & 0xff) + param_1->field_0235 * 3) * 4) / 3 +
            ...
            (*param_1->vtable->vfunc_90)(param_1,3,0x361);
      ...
      /* ST_PSEUDO[unresolved_register_input]: candidate live-in register: verify boundary, SEH/setjmp ABI, or convention */
      TLOBaseTy::LoadImages(param_1,unaff_EDI);
      (*param_1->vtable->vfunc_90)(param_1,3,0x362);
cf_common_exit_004B9130:
    ...
    if (iVar3 == 0x15) {
      ...
      iVar3 = (*param_1->vtable->vfunc_08)(param_1);
      if (iVar3 != 0) {
    ...
    if (uVar4 == 1) {
      ...
      if (uVar4 == 2) {
        (*param_1->vtable->vfunc_90)(param_1,6,0x69);
        goto cf_common_exit_004B8F5A;
      }
    ...
    (*pTVar8->vfunc_90)(param_1,6,arg_2);
  ...
  if (((param_1->field_0255 == 0) || (param_1->field_0245 != CASE_0)) || (param_1->field_0249 != 2))
  {
    if (param_1->field_0245 != CASE_4) {
      ...
      if (((iVar3 == param_1->field_01F5->field_020C) &&
        ...
        (*param_1->vtable->vfunc_90)(param_1,3,0x3d9);
      }
      if (*(int *)(&DAT_00791a10 + param_1->field_0235 * 4) != 0) {
