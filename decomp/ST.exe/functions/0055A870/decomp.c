...
void __thiscall
FUN_0055a870(void *this,int param_1,int param_2,undefined1 param_3,uint param_4,undefined *param_5,
            undefined4 param_6)

{
  ...
  if ((((*(int *)((int)this + 0x114) != 0) && (-1 < (int)param_5)) && (param_4 < 8)) &&
     (((DAT_00802a38 == 0 || ((byte)(&DAT_008087e9)[param_4 * 0x51] < 8)) &&
      (*(int *)((int)this + param_4 * 4 + 0xd4) != 0)))) {
    thunk_FUN_0055bbc0(this,6,(short)param_1,(short)param_2,param_3,param_4,(char)param_5,param_6);
      ...
      do {
        ...
        do {
          if (((puVar3 == (undefined *)0x0) || (param_5[iVar4] != '\0')) &&
            ...
            iVar6 = iVar8 * *(int *)((int)this + 0x20) + *(int *)((int)this + param_4 * 4 + 0xd4);
