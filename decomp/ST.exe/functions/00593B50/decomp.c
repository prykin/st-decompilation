...

{
  ...
  if ((puVar13 != nullptr) && (iVar7 = local_10->field_00D0, iVar7 != 0)) {
    ...
    pRVar4 = STPointerBoundaryCast<RecoveredSourceFamily_dibcopy *>(FUN_006b50c0(this_00->field_00F4,this_00->field_00F8,
    ...
    /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
    pRVar6_mg0 = FUN_006b50c0(this_00->field_00F4,this_00->field_00F8,
    ...
    puVar5 = STPointerBoundaryCast<byte *>(FUN_006b4fa0(pRVar6_mg0));
    iVar7 = 1;
    for (uVar8 = uVar9 >> 2; uVar8 != 0; uVar8 = uVar8 - 1) {
      *puVar5 = CONCAT22(CONCAT11(local_5,local_5),CONCAT11(local_5,local_5));
      puVar5 = (byte *)(puVar5 + 1);
