...
undefined4 * FUN_00580b60(int param_1,int param_2)

{
  ...
  if ((puVar3 != (ushort *)0x0) && (*(void **)(local_c + 0x211) != (void *)0x0)) {
    puVar4 = FUN_006e6460(*(void **)(local_c + 0x211),*(undefined4 *)((int)puVar3 + 0x21),
