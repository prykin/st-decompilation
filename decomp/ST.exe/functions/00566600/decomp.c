...

{
  ...
  puVar3 = FUN_006f0ec0(0x345,local_164,3,0,0);
  uVar5 = 0xffffffff;
  *(undefined4 **)(local_10 + 0x18) = puVar3;
  ...
  local_18 = local_367;
  local_14 = puVar3;
  FUN_006f12b0(FUN_006f2d10,&local_368);
  puVar3 = FUN_006f2790();
  uVar5 = local_c;
  ...
  if ((param_1 == 0) || ((param_1 < 0 && (*(int *)(local_10 + 0x28) < 1)))) {
    uVar6 = FUN_0072e6c0();
    *(uint *)(local_10 + 0x28) = uVar6 % uVar5 + 1;
  }
  if (0 < param_1) {
  ...
  iVar2 = 0;
  bVar11 = 0;
  pCVar4 = FUN_006f2c00(PTR_s_GM_SET_0079b010,1,*(undefined4 *)(local_10 + 0x28));
  local_8 = FUN_006f2d90(*(undefined4 *)(local_10 + 0x18),pCVar4,bVar11,iVar2);
  if (local_8 == (ushort *)0x0) {
    ...
    *(int *)(local_10 + 0x28) = iVar2;
    ...
    local_8 = FUN_006f2d90(*(undefined4 *)(local_10 + 0x18),pCVar4,bVar11,iVar12);
    if (local_8 == (ushort *)0x0) {
