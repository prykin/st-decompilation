...

{
  ...
  *(undefined1 *)puVar12 = 0;
  ...
  FUN_006f12b0(FUN_006f2d10,local_33c);
  ...
  do {
    ...
    if (local_c != (ushort *)0x0) {
      ...
      _strncpy(local_138,(char *)_Source,0x3f);
      _strncpy(local_ec,pcVar5,0x1f);
      uVar8 = 0xffffffff;
      ...
      FUN_0072ee80(pcVar5,local_5c);
      iVar7 = local_18;
      if (local_18 == 0) {
        _strncpy(local_c8,PTR_s_OBJECTIVES_0079d718,0x1f);
      }
      else {
        uVar8 = 0xffffffff;
      ...
      if (bVar4) {
        FUN_006ae1c0(local_8,(undefined4 *)local_138);
      }
