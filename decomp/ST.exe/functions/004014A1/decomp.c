...

{
  ...
  if (iVar3 == 0) {
    ...
    pCVar14 = pCStack_18 + 0x68;
    *(int *)(pCStack_18 + 0x90) = iVar3;
    *(int *)(pCStack_18 + 0x8c) = iVar3;
    pCStack_10 = (CPanelTy *)0xb;
    do {
      iVar3 = 1;
      ...
      *(int *)(pCVar14 + 0x118) = iVar3;
      ...
      pCVar14 = pCStack_8 + 4;
      pCStack_10 = (CPanelTy *)((int)pCStack_10 + -1);
    } while (pCStack_10 != (CPanelTy *)0x0);
    pCStack_8 = pCVar14;
    ...
    *(undefined4 *)(iVar3 + 0x5c) = 0xffffffff;
    pCStack_10 = *(CPanelTy **)(this_00 + 0x1d0);
    if (*(int *)((int)pCStack_10 + 0xa0) != 0) {
      FUN_00710790((int)pCStack_10);
    }
    *(int *)(this_00 + 0x108) = *(int *)((int)pCStack_10 + 0x8a) * 5 + -3;
    ...
    *(int *)(this_00 + 0x1b0) = iVar3;
    pCStack_10 = *(CPanelTy **)(iVar3 + 0x14);
    if (pCStack_10 == (CPanelTy *)0x0) {
      pCStack_10 = (CPanelTy *)
                   (((uint)*(ushort *)(iVar3 + 0xe) * *(int *)(iVar3 + 4) + 0x1f >> 3 & 0x1ffffffc)
                   * *(int *)(iVar3 + 8));
    }
    puVar5 = (undefined4 *)FUN_006b4fa0(iVar3);
    for (uVar4 = (uint)pCStack_10 >> 2; uVar4 != 0; uVar4 = uVar4 - 1) {
      *puVar5 = 0xffffffff;
      puVar5 = puVar5 + 1;
    }
    for (uVar4 = (uint)pCStack_10 & 3; uVar4 != 0; uVar4 = uVar4 - 1) {
    ...
    *(ushort **)(this_00 + 0x994) = puVar8;
    ...
    iStack_14 = 4;
    do {
      puVar11 = (uint *)FUN_006b0140((UINT)pCStack_8,DAT_00807618);
      iVar23 = 1;
      puVar5 = (undefined4 *)(DAT_0080679c + 0x28);
      puStack_1c = puVar11;
      uVar4 = FUN_006b4fe0(DAT_0080679c);
      ...
      uStack_c = FUN_006b50c0(iVar20,iVar3,uVar13,uVar4,puVar5,iVar23);
      if (uStack_c != 0) {
        uVar4 = *(uint *)(uStack_c + 0x14);
        if (uVar4 == 0) {
          uVar4 = ((uint)*(ushort *)(uStack_c + 0xe) * *(int *)(uStack_c + 4) + 0x1f >> 3 &
                  0x1ffffffc) * *(int *)(uStack_c + 8);
        }
        puVar5 = (undefined4 *)FUN_006b4fa0(uStack_c);
        for (uVar13 = uVar4 >> 2; uVar13 != 0; uVar13 = uVar13 - 1) {
          *puVar5 = 0x3a3a3a3a;
          puVar5 = puVar5 + 1;
        }
        ...
        ccFntTy::SetSurf(*(ccFntTy **)(this_00 + 0x1b8),uStack_c,0,0,0,0,0);
        ccFntTy::WrStr(*(ccFntTy **)(this_00 + 0x1b8),puStack_1c,0,0,0);
        FUN_006b4b20((int *)pCStack_10,uStack_c,0,0x3a);
    ...
    *(undefined4 *)(this_00 + 0x2f2) = *(undefined4 *)(this_00 + 0x38);
    pCStack_8 = this_00 + 0xc87;
    pCVar14 = this_00 + 0xd53;
    pCVar15 = this_00 + 0xd47;
    pCStack_10 = (CPanelTy *)0x2;
    do {
      iStack_14 = 6;
      do {
        puVar5 = (undefined4 *)0x0;
    ...
    *(short *)(this_00 + 0x241) = (short)DAT_00806734 - *(short *)(this_00 + 0x94);
    if ((-(uint)(DAT_00807348 != '\0') & 2) != 0xfffffff7) {
      ...
      do {
        ...
        bVar2 = bVar2 + 1;
        puStack_1c = (uint *)CONCAT31(puStack_1c._1_3_,bVar2);
        uVar4 = (uint)bVar2;
    ...
    *(uint *)(this_00 + 0x2c) = (uint)(DAT_00807327 & 2 | 1);
    ...
    iVar3 = 0x3afc;
    uVar18 = 0;
    iStack_34 = (DAT_0080874e == '\x03') + 0x68 + *(int *)(this_00 + 0x4c);
    sVar17 = 2;
    uVar16 = 0xb105;
    uVar7 = 0xb104;
    iStack_30 = *(int *)(this_00 + 0xa4) + 8;
    *(int **)(this_00 + 0x30) = &iStack_34;
    pCVar6 = thunk_FUN_00571240(s_BUT_MAPSCIV_007c1ce4,0);
    uVar7 = CreateBut(this_00,4,3,*(int *)(this_00 + 0x2c),iStack_34 - *(int *)(this_00 + 0x4c),
                      iStack_30 - *(int *)(this_00 + 0xa4),6,(int)pCVar6,uVar7,uVar16,sVar17,uVar18,
    ...
    *(uint *)(this_00 + 0x2c) = (uint)(byte)((DAT_00807327 & 4 | 2) >> 1);
    ...
    uVar16 = 0xb107;
    uVar7 = 0xb106;
    iStack_34 = (DAT_0080874e == '\x03') + 0x7b + *(int *)(this_00 + 0x4c);
    ...
    *(uint *)(this_00 + 0x2c) = (uint)(byte)this_00[0xbae];
    iStack_34 = (-(uint)(DAT_0080874e != '\x03') & 0xfffffffd) + 4 + *(int *)(this_00 + 0x4c);
    uVar24 = 0;
    uVar22 = 0;
    iVar20 = 0;
    pcVar10 = (char *)0x0;
    ...
    uVar16 = 0xb112;
    uVar7 = 0xb110;
    iStack_30 = (DAT_0080874e != '\x03') + 0x65 + *(int *)(this_00 + 0xa4);
    *(int **)(this_00 + 0x30) = &iStack_34;
    pCVar6 = thunk_FUN_00571240(s_BUT_AIASS_007c1c18,0);
    uVar7 = CreateBut(this_00,4,3,(uint)(byte)this_00[0xbae],iStack_34 - *(int *)(this_00 + 0x4c),
                      iStack_30 - *(int *)(this_00 + 0xa4),1,(int)pCVar6,uVar7,uVar16,sVar17,uVar18,
                      iVar3,pcVar10,iVar20,uVar22,uVar24);
    ...
    *(uint *)(this_00 + 0x2c) = (uint)(byte)this_00[0xc0a];
    ...
    iVar20 = 0;
    pcVar10 = (char *)0x0;
    iStack_34 = (-(uint)(DAT_0080874e != '\x03') & 3) + 0x81 + *(int *)(this_00 + 0x4c);
    iVar3 = 0x3b02;
    uVar18 = 0;
    sVar17 = 2;
    uVar16 = 0xb112;
    ...
    *(int **)(this_00 + 0x30) = &iStack_34;
    pCVar6 = thunk_FUN_00571240(s_BUT_AIASS_007c1c18,0);
    uVar7 = CreateBut(this_00,4,3,(uint)(byte)this_00[0xc0a],iStack_34 - *(int *)(this_00 + 0x4c),
                      iStack_30 - *(int *)(this_00 + 0xa4),1,(int)pCVar6,uVar7,uVar16,sVar17,uVar18,
                      iVar3,pcVar10,iVar20,uVar22,uVar24);
    *(undefined4 *)(this_00 + 0x9c4) = uVar7;
    ...
    thunk_FUN_0052ab40(DAT_00806750,(int *)(this_00 + 0x217),0x8b,abStack_24);
