...

{
  ...
  if (iVar3 == 0) {
    ...
    iVar3 = FUN_006b50c0(*(int *)((int)local_8 + 0x40),*(int *)((int)local_8 + 0x48),
                         (uint)*(ushort *)(DAT_0080679c + 0xe),uVar4,puVar5,iVar3);
    *(int *)((int)local_8 + 0x68) = iVar3;
    ...
    FUN_006b1a50((int)DAT_008075a8,3,(undefined4 *)0x0,(undefined4 *)((int)local_8 + 0x4c));
    puVar1 = (uint *)((int)local_8 + 0x60);
    FUN_006b2330((uint)DAT_008075a8,puVar1,*(uint *)((int)local_8 + 100),0x4057ea,
                 *(uint *)((int)local_8 + 0x40),*(uint *)((int)local_8 + 0x48),
                 *(uint *)((int)local_8 + 0x68));
    FUN_006b1b10((int)DAT_008075a8,*puVar1,3);
    FUN_006b3640(DAT_008075a8,*puVar1,0xffffffff,*(uint *)((int)local_8 + 0x3c),
                 *(uint *)((int)local_8 + 0x44));
    puVar5 = (undefined4 *)((int)local_8 + 0x18);
