...

{
  ...
  if (iVar2 == 0) {
    ...
    bVar11 = 0;
    uVar10 = 0xffffffff;
    *(undefined4 **)&local_14->field_0x17c = puVar3;
    puVar3[0x16] = 0;
    puVar3[0x17] = 0;
    pbVar4 = (byte *)thunk_FUN_00571240(s_FRAMES_007c205c,0);
    puVar5 = FUN_00709af0(DAT_00806794,CASE_B,pbVar4,uVar10,bVar11,iVar2,iVar12,puVar13);
    *(ushort **)&this_00->field_0x190 = puVar5;
    iVar2 = *(int *)&this_00->field_0x68;
    ...
    thunk_FUN_00540760(*(undefined4 **)&this_00->field_0x68,0,0,'\x01',
                       *(byte **)&this_00->field_0x184);
    ccFntTy::SetSurf(*(ccFntTy **)&this_00->field_0x17c,*(int *)&this_00->field_0x68,0,param_2,
                     param_3,param_4,param_5);
    uVar14 = 0;
    iVar12 = -1;
    iVar2 = -2;
    puVar6 = (uint *)FUN_006b0140(param_1,DAT_00807618);
    ccFntTy::WrStr(*(ccFntTy **)&this_00->field_0x17c,puVar6,iVar2,iVar12,uVar14);
    ...
    uVar14 = PanelTy::CreateBut((PanelTy *)this_00,0,1,param_6,param_7,0,1,1,pCVar7,0xbfff,0xc000,0,
                                0,0,(char *)0x0,0);
    *(undefined4 *)&this_00->field_0x180 = uVar14;
    iVar2 = CreateSlider(this_00,param_8,param_10,param_9,param_10,0xc0a4,0,0,0);
    local_c = (undefined4 *)&this_00[1].field_0xc;
    *(int *)&this_00[1].field_0x8 = iVar2;
    iVar2 = 0xc09f;
    local_8 = param_11;
    puVar9 = &this_00[1].field_0x20;
    local_10 = 5;
    do {
