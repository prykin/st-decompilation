...

{
  ...
  if (iVar3 == 0) {
    ...
    puVar6 = Library::Ourlib::MFRLOAD::mfRLoad
                       (DAT_00806794,CASE_B,pCVar5,uVar9,bVar10,iVar3,iVar11,puVar12);
    ...
    puVar12 = (undefined4 *)FUN_006b4fa0((int)pAVar1);
    ...
    ccFntTy::WrStr(this_00->field_017C,extraout_EAX,iVar3,iVar11,uVar13);
    pCVar5 = thunk_FUN_00571240(s_BUT_MEDIUM_007c3894,0);
    uVar13 = PanelTy::CreateBut((PanelTy *)this_00,0,1,param_6,param_7,0,1,1,pCVar5,0xbfff,0xc000,0,
                                0,0,(char *)0x0,0);
    ...
    local_10 = 5;
    do {
      uVar13 = PanelTy::CreateBut((PanelTy *)this_00,1,0,local_8,param_12,0,1,1,text,iVar3,
                                  iVar3 + 0x10,1,0,puVar8,(char *)0x0,0);
      puVar8 = puVar8 + 0x27;
      iVar3 = iVar3 + 1;
      *local_c = uVar13;
  ...
  g_currentExceptionFrame = local_58.previous;
  iVar11 = ReportDebugMessage(s_E____titans_Andrey_specpan_cpp_007c7870,0x193,0,iVar3,&DAT_007a4ccc,
