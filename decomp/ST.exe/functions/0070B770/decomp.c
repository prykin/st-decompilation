  ...
  if (sVar1 == 8) {
    if (param_2 != 8) {
      if (param_2 == 0x10) {
        ...
        iVar2 = FUN_006d1a10(nullptr,0,0,0,param_1,0,0,0,param_1->field_0004,
                             param_1->field_0008);
        g_currentExceptionFrame = local_d4.previous;
        return iVar2;
      }
      ...
      iVar2 = FUN_006d1a50(nullptr,0,0,0,param_1,0,0,0,param_1->field_0004,
                           param_1->field_0008);
      g_currentExceptionFrame = local_90.previous;
      return iVar2;
    }
    ...
    if (sVar1 == 0x10) {
      ...
      if (param_2 == 0x10) {
        ...
        iVar2 = FUN_006d1a90(nullptr,0,0,0,param_1,0,0,0,param_1->field_0004,
                             param_1->field_0008);
        g_currentExceptionFrame = local_4c.previous;
        return iVar2;
      }
