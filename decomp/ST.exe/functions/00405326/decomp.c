...

{
  ...
  pSStack_14 = *(STBoatC **)(*(int *)(this + 0x29) + 0xc);
  puStack_10 = (uint *)0x0;
  puStack_24 = (uint *)0x0;
  iStack_28 = 0;
  iStack_2c = 0;
  ...
  *(undefined4 *)(pSStack_30 + 0x65) = 0;
  iVar3 = FUN_006e62d0(DAT_00802a38,*(int *)(pSStack_30 + 0x1c5),(int *)&pSStack_8);
  if (iVar3 == -4) {
    return 0;
  }
  thunk_FUN_004162f0(pSStack_8,(undefined2 *)(pSVar2 + 0x304),(undefined2 *)(pSVar2 + 0x306),
                     (undefined2 *)(pSVar2 + 0x308));
  uStack_20 = 0;
  *(int *)(pSVar2 + 0x30a) = *(int *)(pSStack_8 + 0x18);
          ...
          if (iVar3 == 0) {
            ...
            if ((iVar3 == 7) || (iVar3 == 0x13)) {
              ...
              if (iVar3 == 0) {
                ...
                STBoatC::CmdToObj(pSStack_8,0xe,&uStack_40);
                puVar4 = puStack_10;
              ...
              STBoatC::CmdToObj(pSStack_8,3,&uStack_18);
            }
          }
          else {
            puVar4 = puVar5;
...
LAB_004a0b93:
      ...
      pSVar9 = pSStack_14;
    } while ((int)uStack_20 < (int)pSStack_14);
  }
  puVar4 = puStack_10;
  if (puStack_10 == (uint *)0x0) {
LAB_004a0bcc:
    if (puVar5 != (uint *)0x0) {
      pSStack_14 = (STBoatC *)puVar5[3];
      uVar11 = 0;
      if (0 < (int)pSStack_14) {
        do {
          ...
          STBoatC::CmdToObj(pSStack_8,3,&uStack_18);
          uVar11 = uVar11 + 1;
        } while ((int)uVar11 < (int)pSStack_14);
      }
      uStack_1c = 0;
    }
    puVar4 = puStack_10;
...
LAB_004a0c2b:
    ...
    if (puVar5 != (uint *)0x0) {
      STAllPlayersC::RegisterPGPair
                (DAT_007fa174,CONCAT31((int3)((uint)pSVar9 >> 8),pSVar2[0x24]),puStack_10,puVar5);
      goto LAB_004a0c2b;
    }
      ...
      do {
        ...
        if ((short)uStack_c != -1) {
          ...
          if ((iVar3 != 0) &&
            ...
            if ((iVar3 == 0xe) || (uVar6 = STBoatC::CheckPBoxCmd(pSStack_8,0xe), uVar6 == 1)) {
              iStack_2c = 1;
              break;
            }
          }
