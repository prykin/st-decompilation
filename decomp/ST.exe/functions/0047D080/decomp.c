...
int __thiscall FUN_0047d080(void *this,undefined4 *param_1)
        ...
        if ((*(int *)((int)this + 0x74a) <= (int)*(short *)(DAT_00806724 + 0x23) / 2) &&
          ...
          do {
            ...
            if (DAT_0080732c == 1) {
              ...
              bVar21 = 0;
              lVar12 = __ftol();
              iVar10 = (int)local_1c + *(short *)((int)this + 0x45) + local_8 + (int)(short)lVar12;
              iVar6 = (int)*(short *)((int)this + 0x43) - (int)local_20._2_2_;
              iVar11 = (int)(short)local_20 + iVar9 + *(short *)((int)this + 0x41);
            }
            else {
              iVar10 = (int)local_1c + local_8 + *(short *)((int)this + 0x45);
