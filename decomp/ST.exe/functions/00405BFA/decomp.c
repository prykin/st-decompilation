...
undefined4 __fastcall thunk_FUN_006239a0(int *param_1)

{
  ...
  case 0:
    return 1;
  case 1:
    iVar2 = thunk_FUN_00624920(param_1,*(undefined4 *)((int)param_1 + 0x2ee),&iStack_c,&iStack_10,
                               &iStack_14);
    if (0 < iVar2) {
      ...
      *(int *)((int)param_1 + 0x2c2) = iStack_c;
      *(int *)((int)param_1 + 0x2c6) = iStack_10;
      *(int *)((int)param_1 + 0x2ca) = iStack_14;
      return 1;
    }
    return uStack_8;
  case 2:
  ...
  case 3:
    ...
    *(undefined4 *)((int)param_1 + 0x2ae) = 4;
    ...
    uVar3 = thunk_FUN_00627db0(param_1,*(int *)((int)param_1 + 0x2c2),*(int *)((int)param_1 + 0x2c6)
                               ,iVar2);
    thunk_FUN_0044a150(CONCAT31((int3)((uint)uVar3 >> 8),*(undefined1 *)((int)param_1 + 0x262)),
...
switchD_006239c1_caseD_4:
  ...
  if (*(int *)(&DAT_007d04c0 + (uint)*(byte *)((int)param_1 + 0x2ad) * 4) <=
    ...
    if (*(char *)((int)param_1 + 0x2df) != '\0') {
      ...
      thunk_FUN_004abe40((void *)((int)param_1 + 0x1d5),'\t',*(undefined4 *)((int)param_1 + 0x2db));
      thunk_FUN_004ac040('\t');
    }
  ...
  if ((char)param_1[0xb8] != '\0') {
    if (*(int *)((int)param_1 + 0x2e1) == *(int *)((int)param_1 + 0x2e5)) {
      *(undefined1 *)(param_1 + 0xb8) = 0;
      ...
      thunk_FUN_004abe40((void *)((int)param_1 + 0x1d5),'\n',*(int *)((int)param_1 + 0x2e1));
      thunk_FUN_004ac040('\n');
  ...
  if (iVar2 < *(int *)((int)param_1 + 0x2d2)) {
    thunk_FUN_004abe40((void *)((int)param_1 + 0x1d5),'\x0e',iVar2);
  ...
  if (DAT_00802a88 != (void *)0x0) {
    ...
    if ((DAT_0080874d != -1) && (*(int *)((int)this + 0xf8) != 0)) {
      ...
      if ((((-1 < iVar2) &&
          ...
          (((iStack_1c = (&DAT_0079aed0)[iVar2] + iStack_1c, -1 < iStack_1c &&
            (iStack_1c < *(int *)((int)this + 0x34))) && (*(int *)((int)this + 0x4c) != 0)))) &&
         (*(char *)(iStack_1c * *(int *)((int)this + 0x30) + *(int *)((int)this + 0x4c) + iStack_18)
          == '\0')) {
