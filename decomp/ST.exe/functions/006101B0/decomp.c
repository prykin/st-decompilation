...

{
  ...
  case CASE_1:
    ...
    if (cVar1 == '\x01') {
      ...
      iVar12 = thunk_FUN_00615ad0((RecoveredRecordView_00615AD0_52CA5C0D *)param_1);
...
LAB_0061033a:
      ...
      if (param_1->field_0278 == 0) {
        ...
        param_1->field_0280 =
             ...
             10000000) /
             *(int *)(&DAT_007cfe74 + (short)param_1->field_02DD[param_1->field_02D9 * 0xe + 3] * 4);
        iVar12 = ((&SHORT_007ed574)[(short)param_1->field_02DD[param_1->field_02D9 * 0xe + 3] * 4] *
                 10000000) /
                 *(int *)(&DAT_007cfe74 +
...
LAB_00610886:
      ...
      if (0 < local_EAX_1692) {
        if (local_EAX_1692 == 5) {
          ...
          RVar5 = thunk_FUN_00615fd0(param_1,local_EAX_1692,param_1->field_020C);
      ...
      if (((DAT_0080874d == -1) || (g_visibleClass_00802A88->field_00F8 == 0)) ||
         ...
         ((VisibleClassTy::sub_00558C00
                     (g_visibleClass_00802A88,g_visibleClass_00802A88->field_010C,iVar7,iVar12,
                      (int *)&local_24,&local_20), local_c < 0 ||
...
LAB_00610d9f:
  ...
  case CASE_3:
    ...
    iVar12 = thunk_FUN_006164e0(param_1,&local_10,&local_14,&local_18);
    if (iVar12 < 1) {
...
LAB_00611185:
      ...
      if (0 < local_EAX_4124) {
        if (local_EAX_4124 == 5) {
          ...
          RVar5 = thunk_FUN_00615fd0(param_1,local_EAX_4124,param_1->field_020C);
          param_1->field_020C = RVar5;
        }
      }
    }
...
LAB_006117e5:
      ...
      if (0 < uVar6) {
        if (uVar6 == 5) {
          ...
          RVar5 = thunk_FUN_00615fd0(param_1,uVar6,param_1->field_020C);
          param_1->field_020C = RVar5;
        }
      }
    }
...
LAB_006115da:
  ...
  case CASE_7:
    if ((param_1->field_02E9 != '\0') && (param_1->field_0252 != nullptr)) {
      ...
      uVar15_mg2 = thunk_FUN_004ac910(param_1->field_0252,'\r');
      ...
      if (0xe < uVar15_mg2) {
        ...
        uVar5_mg0 = thunk_FUN_004ac910(param_1->field_0252,'\x0f');
        ...
        iVar12 = STT3DSprC::sub_004ACD30(param_1->field_0252,'\x0f');
        if (uVar5_mg0 < iVar12) {
          uVar5_mg0 = uVar5_mg0 + 1;
        }
        /* ST_CALLSITE[00611DBF]: CALL 0x00401064; direct=00401064 STT3DSprC::SetCurFase */
        STT3DSprC::SetCurFase(param_1->field_0252,'\x0f',uVar5_mg0);
      }
      if (param_1->field_0251 != '\0') {
        /* ST_CALLSITE[00611DD6]: CALL 0x004022ac; direct=004022AC STT3DSprC::sub_004ACD30 */
        iVar12 = STT3DSprC::sub_004ACD30(param_1->field_0252,'\x0e');

        iVar7 = thunk_FUN_004ac910(param_1->field_0252,'\x0e');
        if (iVar12 + -1 == iVar7) {
      ...
      iVar12 = STT3DSprC::sub_004ACD30(param_1->field_0252,'\r');

      iVar7 = thunk_FUN_004ac910(param_1->field_0252,'\r');
      if (iVar12 + -1 == iVar7) {
      ...
      iVar7 = thunk_FUN_004ac910(param_1->field_0252,'\x0f');
      if (iVar12 + -1 == iVar7) {
        param_1->field_020C = CASE_9;
        return local_1c;
      }
      ...
      STT3DSprC::SetCurFase(param_1->field_0252,'\x0e',uVar14);
      ...
      STT3DSprC::SetCurFase(param_1->field_0252,'\r',uVar15_mg2);
  ...
  case CASE_8:
    ...
    if (0x648 < iVar12) {
      ...
      local_1c = thunk_FUN_006173a0(param_1,iVar12,&local_10,&local_14,&local_18);
      if (0 < local_1c) {
...
LAB_006122dd:
      ...
      if (0 < local_EAX_8584) {
        if (local_EAX_8584 == 5) {
          ...
          RVar5 = thunk_FUN_00615fd0(param_1,local_EAX_8584,param_1->field_020C);
          param_1->field_020C = RVar5;
        }
      }
    }
...
cf_common_exit_006115EC:
    if ((-1 < param_1->field_0248) && (param_1->field_0250 != '\0')) {
      ...
      uVar14 = thunk_FUN_004ad650(param_1->field_0252);
      /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
