...

{
  ...
  if (iVar2 == 0) {
    ...
    local_34 = iVar7;
    local_c = cMf32::RecGet(param_1,8,param_2,(int *)0x0,param_5);
    if (local_c == (ushort *)0x0) {
      RaiseInternalException(-4,DAT_007ed77c,s_E__Ourlib_mfspr_cpp_007f0c8c,0x8e);
    }
            ...
            do {
              ...
              *(undefined4 *)(iVar7 + 0x12 + (int)local_8) = uVar5;
              if (*(int *)(iVar7 + 0x12 + (int)local_8) == 0) {
                RaiseInternalException(-4,DAT_007ed77c,s_E__Ourlib_mfspr_cpp_007f0c8c,0x9f);
              }
  ...
  if (local_8 != (short *)0x0) {
    if (0 < (int)local_8[1] * (int)*local_8) {
      iVar4 = 0;
      do {
        cMf32::RecMemFree(param_1,(uint *)(iVar4 + 0x12 + (int)local_8));
        iVar7 = iVar7 + 1;
        iVar4 = iVar4 + 10;
        iVar2 = local_34;
  ...
  if ((param_5 != 0) || (iVar2 != -4)) {
    iVar7 = ReportDebugMessage(s_E__Ourlib_mfspr_cpp_007f0c8c,0xb6,0,iVar2,&DAT_007a4ccc,
                               s_mfMSprLoad_007f0cb0);
    if (iVar7 != 0) {
      pcVar1 = (code *)swi(3);
      psVar6 = (short *)(*pcVar1)();
      return psVar6;
    }
    RaiseInternalException(iVar2,0,s_E__Ourlib_mfspr_cpp_007f0c8c,0xb8);
  }
  return (short *)0x0;
}
