...

{
  ...
  if (iVar4 == 0) {
    ...
    *(undefined4 *)&this_02->field_1A5B->field_0x140 = 0x1f;
    ...
    puVar8 = (undefined4 *)(this_02->field_005D + 0x28);
    this_02->field_1BA1 = 0;
    uVar7 = FUN_006b4fe0(this_02->field_005D);
    iVar4 = FUN_006b50c0(0x208,0x143,(uint)*(ushort *)(this_02->field_005D + 0xe),uVar7,puVar8,iVar4
                        );
    this_02->field_1C82 = iVar4;
    ...
    uVar7 = 0x67;
    do {
      FUN_006b2330((uint)DAT_008075a8,puVar5,0x31,0x40597f,*(uint *)(this_02->field_1C82 + 4),0x13,
                   (uint)this_02);
    ...
    puVar8 = (undefined4 *)(this_02->field_005D + 0x28);
    uVar7 = FUN_006b4fe0(this_02->field_005D);
    iVar4 = FUN_006b50c0(0x22e,0x2e,(uint)*(ushort *)(this_02->field_005D + 0xe),uVar7,puVar8,iVar4)
    ;
    ...
    FUN_006b2330((uint)DAT_008075a8,puVar8,0x31,0x4023f6,*(uint *)(uVar7 + 4),*(uint *)(uVar7 + 8),
                 uVar7);
    Library::DKW::DDX::FUN_006b3640(DAT_008075a8,*puVar8,0xffffffff,0x79,0x197);
    ...
    if (pHVar9 != (HoloTy *)0x0) {
      ...
      uVar7 = HoloTy::Init(this_02->field_1C96,CASE_2,0x79,0x51,iVar4,iVar12,uVar7,cVar11,uVar10);
      if (uVar7 != 0) {
    ...
    if (this_02->field_1A5F == '\0') {
      ...
      if (pHVar9 != (HoloTy *)0x0) {
        ...
        uVar7 = HoloTy::Init(this_02->field_1C9A,CASE_1,0x79,0x197,iVar4,iVar12,uVar7,cVar11,uVar10)
        ;
        if (uVar7 != 0) {
    ...
    pHVar9 = this_02->field_1C96;
    if (((pHVar9 != (HoloTy *)0x0) && (pHVar9->field_0000 != '\0')) &&
       (-1 < (int)pHVar9->field_0003)) {
      Library::DKW::DDX::FUN_006b3430(DAT_008075a8,pHVar9->field_0003);
    }
    pHVar9 = this_02->field_1C9A;
    if (((pHVar9 != (HoloTy *)0x0) && (pHVar9->field_0000 != '\0')) &&
       (-1 < (int)pHVar9->field_0003)) {
  ...
  g_currentExceptionFrame = local_54.previous;
  iVar12 = ReportDebugMessage(s_E____titans_Start_prov_obj_cpp_007ccd28,0xac,0,iVar4,&DAT_007a4ccc,
