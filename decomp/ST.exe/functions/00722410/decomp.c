...

{
  ...
  if (iVar4 != 0) {
    ...
    iVar4 = ReportDebugMessage(s_E__Ourlib__sedit_cpp_007f0b08,0x356,0,iVar4,&DAT_007a4ccc,
...
switchD_00722eb2_caseD_38:
  ...
  local_8 = iVar4;
  if (iVar4 != 0) {
    RaiseInternalException(iVar4,DAT_007ed77c,s_E__Ourlib__sedit_cpp_007f0b08,0x350);
  }
  if (param_1[4] == 0x24) {
