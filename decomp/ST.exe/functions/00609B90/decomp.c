...

{
  ...
  if (iVar2 == 0) {
    if ((*(int *)((int)local_8 + 0x234) != 0) &&
       (iVar2 = *(int *)(*(int *)((int)local_8 + 0x234) + 0xc), uVar5 = 0, 0 < iVar2)) {
      do {
        iVar3 = *(int *)((int)local_8 + 0x234);
        ...
        if (iVar3 != 0) {
          if ((*(int *)((int)local_8 + 0x1f5) == 0x4d) && (param_1 != 0)) {
            *(undefined4 *)(iVar3 + 4) = 0;
          }
          if (*(int *)(iVar3 + 0x3c) < 0) {
            thunk_FUN_00609d60(local_8,uVar5);
          }
        }
        uVar5 = uVar5 + 1;
