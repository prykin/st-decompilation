...
void FUN_00532d50(uint param_1)

{
  ...
  iVar5 = __setjmp3(local_6c,0,unaff_EDI,unaff_ESI);
  this = local_10;
  if (iVar5 != 0) {
    DAT_00858df8 = (undefined4 **)local_70;
  ...
  if (*(byte **)((int)local_10 + 0x1e9) != (byte *)0x0) {
    FUN_006b5570(*(byte **)((int)local_10 + 0x1e9));
  ...
  *(undefined4 *)((int)this + 0x2c) = 0;
  ...
  hFindFile = FindFirstFileA((LPCSTR)((int)this + 0x6c),&local_1f4);
  local_18 = hFindFile;
  if (hFindFile != (HANDLE)0xffffffff) {
    do {
      ...
      if (((byte)local_1f4.dwFileAttributes & 0x10) == 0) {
        ...
        uVar21 = 0;
        local_8 = 0;
        FUN_0072e730((byte *)pCVar20,(byte *)0x0,(byte *)0x0,local_2f8,(byte *)0x0);
        local_b4 = DAT_00858df8;
        DAT_00858df8 = &local_b4;
        iVar5 = __setjmp3(local_b0,0,pCVar20,uVar21);
        this = local_10;
        hFindFile = local_18;
        puVar7 = local_b4;
        if (iVar5 == 0) {
          ...
          uVar13 = ~uVar13;
          pcVar9 = pcVar17 + -uVar13;
          pcVar17 = (char *)((int)local_10 + 0x6c);
          for (uVar14 = uVar13 >> 2; uVar14 != 0; uVar14 = uVar14 - 1) {
            *(undefined4 *)pcVar17 = *(undefined4 *)pcVar9;
            pcVar9 = pcVar9 + 4;
            pcVar17 = pcVar17 + 4;
          ...
          puVar7 = FUN_006f0ec0(0x345,(byte *)((int)local_10 + 0x6c),0,0,0);
          puVar8 = FUN_006f1ce0(0x80,PTR_s_SAVE_DESC_0079ad04,(int *)&local_1c,0);
          if (puVar8 == (ushort *)0x0) {
            ...
            if (bVar19) {
              FUN_006ae1c0(*(uint **)((int)this + 0x1ed),&local_1f4.ftLastWriteTime.dwLowDateTime);
              uVar13 = 0xffffffff;
              pcVar9 = PTR_DAT_0079ad00;
              do {
                if (uVar13 == 0) break;
    ...
    *(undefined4 *)((int)this + 0x2c) = *(undefined4 *)((int)this + 0x1f1);
    ...
    if (1 < uVar13) {
      do {
        ...
        if (uVar13 != 1) {
          do {
            FUN_006acc70(*(int *)((int)this + 0x1ed),uVar14,&local_2c.dwLowDateTime);
            uVar1 = uVar14 + 1;
            FUN_006acc70(*(int *)((int)this + 0x1ed),uVar1,&local_24.dwLowDateTime);
