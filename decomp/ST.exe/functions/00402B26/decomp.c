...

{
  ...
  *(undefined4 *)(iVar6 + 0xab) = 0;
  ...
  iVar7 = Library::MSVCRT::__setjmp3(IStack_90.jumpBuffer,0,unaff_EDI,unaff_ESI);
  iVar6 = iStack_48;
  if (iVar7 != 0) {
...
LAB_0040b56a:
  if (*(int *)(iVar6 + 0x9f) == 0) {
    ...
    *(int *)(iVar6 + 0xaf) = iVar7;
    puStack_28 = Library::DKW::LIB::FUN_006aac10(0x2ae);
    sVar1 = *(short *)(iVar6 + 0x47);
    ...
    *(short **)(iVar6 + 0x9f) = psVar10;
    if (psVar10 == (short *)0x0) {
      ...
      psVar10 = Library::DKW::WAY::FUN_006a8270
                          ((int)puStack_2c,(int)DAT_007fb278,(int)DAT_007fb27a,
