...
LAB_006a2f2f:
  ...
  *(undefined2 *)(piStack_14 + 0x10f) = 0xeae8;
  ...
  psStack_8 = (short *)Library::DKW::LIB::FUN_006aac10(0x4b79);
  iVar13 = 0;
  iVar9 = 0;
  do {
    puVar6 = (undefined4 *)(piStack_14[10] * iVar13 + piStack_14[3]);
    puVar16 = (undefined4 *)((int)psStack_8 + iVar9);
  ...
  if (piStack_14 != (int *)0x0) {
    ...
    Library::MSVCRT::FUN_0072e2b0(piStack_14);
  }
