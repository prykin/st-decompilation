...
undefined4 __fastcall thunk_FUN_004e9c20(void *param_1)

{
  ...
  if (*(int *)((int)param_1 + 0x46c) != 0) {
    ...
    if (*(int *)((int)param_1 + 0x48c) != 0) {
      iVar1 = FUN_006e62d0(DAT_00802a38,*(int *)((int)param_1 + 0x470),(int *)&pvStack_8);
      if (iVar1 == 0) {
        thunk_FUN_004e95c0(pvStack_8,(int)param_1);
