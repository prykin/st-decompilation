...
int __cdecl thunk_FUN_00648e70(int param_1,char *param_2)

{
  ...
  if (iVar2 == 0) {
    ...
    puStack_8 = FUN_006f2d90(param_1,param_2,1,0);
    if (puStack_8 == (ushort *)0x0) {
      puStack_8 = (ushort *)thunk_FUN_00649eb0();
    }
    FUN_006e6200(DAT_00802a38,0x403,(undefined4 *)0x28,(undefined4 *)0x0,(int *)0x0,puStack_8,0);
