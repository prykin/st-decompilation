      ...
      *(undefined4 *)(iVar3 + 4) = 0;
      while( true ) {
        ...
        puVar5 = Library::Ourlib::MFRLOAD::mfRLoad
                           (piVar8,CASE_1D,pbVar4,uVar9,bVar10,iVar3,iVar11,puVar12);
        psVar7[0x1b] = *puVar5;
        iVar3 = *psVar7 * 0x18;
        ...
        *(uint *)(psVar7 + 0x19) = local_8;
        FUN_006e98e0(DAT_00807598,local_8,0,(int)psVar7[0x1b],*(int *)((int)puVar5 + 0x21),1);
