...

{
  ...
  if ((char)param_1 == '\x01') {
    ...
    if (iVar3 != 0x3c) {
      if (iVar3 != 0x1ae) {
        iVar2 = FUN_006ad4d0(s_E____titans_wlad_to_allpl_cpp_007a6004,0x1b8a,0,0,&DAT_007a4ccc);
        if (iVar2 == 0) {
          return;
        }
        pcVar1 = (code *)swi(3);
      ...
      local_c = (uint)(ushort)(&DAT_007f4f8b)[uVar11 * 0x531];
      uVar12 = 3;
      uVar11 = 0xffffffff;
      goto LAB_0043cb5c;
    }
    ...
    while (FUN_006acc70(iVar3,uVar11,&local_c), (short)local_c == -1) {
      uVar11 = uVar11 + 1;
      if ((int)local_14 <= (int)uVar11) {
        return;
      }
    }
    uVar11 = CONCAT31((int3)(local_c >> 8),*(undefined1 *)((int)&DAT_007f4f87 + iVar2));
  }
  else {
    if ((char)param_1 == '\x02') {
      uVar11 = (uint)DAT_0080874d;
      ...
      if (iVar3 != 0x3c) {
        if (iVar3 != 0x1ae) {
          iVar2 = FUN_006ad4d0(s_E____titans_wlad_to_allpl_cpp_007a6004,0x1d16,0,0,&DAT_007a4ccc);
          if (iVar2 == 0) {
            return;
          }
          pcVar1 = (code *)swi(3);
...
LAB_0043c293:
      ...
      *(undefined1 *)((int)piVar8 + 7) = 1;
      ...
      local_18 = thunk_FUN_0044d320(uVar11);
      ...
      *(undefined1 *)((int)piVar8 + 0x36) = 1;
      ...
      uVar9 = (undefined3)(local_24 >> 8);
      uVar10 = (undefined3)(local_14 >> 8);
      if (0x1000 < uVar11) {
        if (uVar11 < 0x100001) {
          if (uVar11 == 0x100000) {
...
switchD_0043c594_caseD_4:
    ...
    if ((char)param_1 == '\x04') {
      ...
      if (0x19a < iVar2) {
        if (iVar2 == 0x1a4) {
          local_c = (uint)(ushort)(&DAT_007f4fdb)[uVar11 * 0x531];
          uVar12 = 5;
          uVar11 = 0xffffffff;
        }
        else {
          if (iVar2 != 0x1b8) {
LAB_0043ca5a:
            iVar2 = FUN_006ad4d0(s_E____titans_wlad_to_allpl_cpp_007a6004,0x1d47,0,0,&DAT_007a4ccc);
            if (iVar2 == 0) {
              return;
            }
            pcVar1 = (code *)swi(3);
      ...
      uVar11 = CONCAT31((int3)(local_c >> 8),*(undefined1 *)((int)&DAT_007f4fd7 + uVar11 * 0xa62));
LAB_0043ca31:
      uVar12 = 1;
LAB_0043ca35:
    ...
    if ((char)param_1 != '\x05') {
      if ((char)param_1 == '\x06') {
        ...
        if (iVar2 != 0x19a) {
          iVar2 = FUN_006ad4d0(s_E____titans_wlad_to_allpl_cpp_007a6004,0x1d95,0,0,&DAT_007a4ccc);
          if (iVar2 == 0) {
            return;
          }
          pcVar1 = (code *)swi(3);
      ...
      if ((char)param_1 == '\a') {
        ...
        *(undefined4 *)(param_2[3] + 0xc) = 0;
        ...
        if (iVar2 != 0x19a) {
          iVar2 = FUN_006ad4d0(s_E____titans_wlad_to_allpl_cpp_007a6004,0x1db2,0,0,&DAT_007a4ccc);
          if (iVar2 == 0) {
            return;
          }
          pcVar1 = (code *)swi(3);
      ...
      if ((char)param_1 == '\b') {
        ...
        *(undefined4 *)(param_2[4] + 0xc) = 0;
        ...
        if (*(int *)((int)&DAT_007f4f83 + iVar2) != 0x3c) {
          iVar2 = FUN_006ad4d0(s_E____titans_wlad_to_allpl_cpp_007a6004,0x1dd0,0,0,&DAT_007a4ccc);
          if (iVar2 == 0) {
            return;
          }
          pcVar1 = (code *)swi(3);
      ...
      if ((char)param_1 == '\t') {
        ...
        if (iVar2 != 0x19a) {
          iVar2 = FUN_006ad4d0(s_E____titans_wlad_to_allpl_cpp_007a6004,0x1dec,0,0,&DAT_007a4ccc);
          if (iVar2 == 0) {
            return;
          }
          pcVar1 = (code *)swi(3);
      ...
      if ((char)param_1 == '\n') {
        uVar11 = (uint)DAT_0080874d;
        local_28 = (int)&DAT_007f4fd3 + uVar11 * 0xa62;
      ...
      if ((char)param_1 != '\v') {
        if ((char)param_1 == '\f') {
          ...
          if (iVar2 != 0x19a) {
            iVar2 = FUN_006ad4d0(s_E____titans_wlad_to_allpl_cpp_007a6004,0x1ea3,0,0,&DAT_007a4ccc);
            if (iVar2 == 0) {
              return;
            }
            pcVar1 = (code *)swi(3);
...
LAB_0043d41d:
              *(undefined1 *)piVar8 = 0;
              ...
              if (iVar2 != 0x1ae) {
                iVar2 = FUN_006ad4d0(s_E____titans_wlad_to_allpl_cpp_007a6004,0x1ecc,0,0,
                                     &DAT_007a4ccc);
                if (iVar2 != 0) {
                  pcVar1 = (code *)swi(3);
                  (*pcVar1)();
...
LAB_0043d5a6:
              *(undefined1 *)piVar8 = 0;
              ...
              if (iVar2 == 0x1a4) {
                ...
                if (iVar2 != 0x1b8) {
LAB_0043d581:
                  iVar2 = FUN_006ad4d0(s_E____titans_wlad_to_allpl_cpp_007a6004,0x1efe,0,0,
                                       &DAT_007a4ccc);
                  if (iVar2 != 0) {
                    pcVar1 = (code *)swi(3);
                    (*pcVar1)();
...
LAB_0043d5c4:
        ...
        if ((char)param_1 != '\x10') {
          if ((char)param_1 == '\x11') {
            ...
            if (iVar2 != 0x3c) {
              iVar2 = FUN_006ad4d0(s_E____titans_wlad_to_allpl_cpp_007a6004,0x1f4c,0,0,&DAT_007a4ccc
                                  );
              if (iVar2 == 0) {
                return;
              }
            ...
            piVar8 = (int *)thunk_FUN_0042b760(CONCAT31((int3)(local_20 >> 8),DAT_0080874d),local_20
                                              );
          ...
          iVar2 = FUN_006ad4d0(s_E____titans_wlad_to_allpl_cpp_007a6004,0x1f5d,0,0,&DAT_007a4ccc);
          if (iVar2 == 0) {
            return;
          }
          pcVar1 = (code *)swi(3);
        ...
        if (iVar2 != 0x3c) {
          ...
          iVar2 = FUN_006ad4d0(s_E____titans_wlad_to_allpl_cpp_007a6004,0x1f22,0,0,&DAT_007a4ccc);
          if (iVar2 == 0) {
            return;
          }
          pcVar1 = (code *)swi(3);
      ...
      if (iVar3 != 0x3c) {
        iVar2 = FUN_006ad4d0(s_E____titans_wlad_to_allpl_cpp_007a6004,0x1e85,0,0,&DAT_007a4ccc);
        if (iVar2 == 0) {
          return;
        }
        pcVar1 = (code *)swi(3);
...
switchD_0043d1bf_caseD_a:
      ...
      param_2 = (int *)(uint)(uVar11 == local_14);
      iVar2 = 0;
      uVar11 = 0;
      if (0 < (int)local_14) {
        do {
    ...
    if (0x19a < iVar2) {
      if (iVar2 == 0x1a4) {
        ...
        if (iVar2 != 0x1b8) {
LAB_0043cb81:
          iVar2 = FUN_006ad4d0(s_E____titans_wlad_to_allpl_cpp_007a6004,0x1d78,0,0,&DAT_007a4ccc);
          if (iVar2 == 0) {
            return;
          }
          pcVar1 = (code *)swi(3);
