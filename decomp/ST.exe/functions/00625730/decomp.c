...

{
  ...
  undefined4 uVar8;
  int iVar9;
  Global_sub_006263B0_param_1Enum GVar10;
  uint uVar11;
  int iVar12;
  short sVar13;
  int iVar14;
        ...
        do {
          ...
          for (; iVar14 < local_20; iVar14 = iVar14 + 1) {
            ...
            if ((((((sVar18 < 0) || (SHORT_007fb240 <= sVar18)) || (sVar19 < 0)) ||
               ...
               (pSVar16 = g_worldCells
                          [(int)sVar13 * (int)SHORT_007fb246 + (int)sVar19 * (int)SHORT_007fb240 +
                           (int)sVar18].objects[0], pSVar16 == (STWorldObject *)0x0))
            goto LAB_00625b06;
            if (in_stack_00000010 == 0) {
              if ((pSVar16[1].vtable < (STWorldObjectVTable *)0x8) &&
                 ((PTR_00802a38 == (STPlaySystemC *)0x0 ||
                  ((byte)(&DAT_008087e9)[(int)pSVar16[1].vtable * 0x51] < 8)))) {
                bVar1 = *(byte *)&pSVar16[1].vtable;
...
LAB_006259bf:
                    ...
                    uVar11 = (uint)bVar1;
                    uVar5 = (uint)bVar2;
                    cVar3 = *(char *)((int)&DAT_00808a4f + uVar11 * 8 + uVar5);
                    if ((cVar3 == '\0') &&
                       (*(char *)((int)&DAT_00808a4f + uVar5 * 8 + uVar11) == '\0')) {
                      iVar7 = -2;
                    }
                    else if ((cVar3 == '\x01') &&
                            (*(char *)((int)&DAT_00808a4f + uVar5 * 8 + uVar11) == '\0')) {
                      iVar7 = -1;
                            ...
                            (*(char *)((int)&DAT_00808a4f + uVar5 * 8 + uVar11) == '\x01')) {
                      iVar7 = 1;
                    }
                    else {
                      if ((cVar3 != '\x01') ||
                ...
                if ((bVar6) && (iVar7 = (*pSVar16->vtable[5].slots_00_28[2])(), iVar7 != 0))
                goto LAB_00625ad5;
              }
            }
            else {
              thunk_FUN_00416270(pSVar16,&local_a,(int *)&local_8,(int *)&local_6);
              ...
              if (iVar7 < *(int *)(&DAT_007d0294 + (uint)*(byte *)((int)this + 0x2ad) * 4)) {
                ...
                thunk_FUN_00601d10(*(undefined4 *)((int)this + 0x262),uVar8,(int)pSVar16,
                                   (short)*(undefined4 *)((int)this + 0x18),0xffff,
                                   *(undefined4 *)
                                    (&DAT_007d04d0 + (uint)*(byte *)((int)this + 0x2ad) * 4),0x110);
                if ((pSVar16->value_20 == 1000) || (pSVar16->value_20 == 0x14)) {
                  *(undefined4 *)((int)this + 0x241) = *(undefined4 *)&pSVar16->field_0x18;
                }
                if (DAT_00811798 != (void *)0x0) {
                  iVar7 = (**(code **)(*(int *)this + 0x2c))();
                  iVar9 = (*pSVar16->vtable->GetObjectTypeId)(pSVar16);
                  thunk_FUN_0061fe80(DAT_00811798,iVar14,iVar15,(uint)pSVar16[1].vtable,iVar9,iVar7)
                  ;
                }
              }
LAB_00625ad5:
              if (*(char *)((int)this + 0x2ad) == '\x02') {
                if (*(int *)((int)this + 0x342) != 0) {
                  GVar10 = (*pSVar16->vtable->GetObjectTypeId)(pSVar16);
                  uVar11 = thunk_FUN_006263b0(GVar10);
                  if ((*(uint *)((int)this + 0x342) & uVar11) != 0) goto LAB_00625aff;
                }
              }
              else {
LAB_00625aff:
...
LAB_00625b06:
              if (((((in_stack_00000010 != 0) && (*(char *)((int)this + 0x2ad) != '\x01')) &&
                 ...
                 (pSVar16 = g_worldCells
                            [(int)sVar13 * (int)SHORT_007fb246 + (int)sVar19 * (int)SHORT_007fb240 +
                             (int)sVar18].objects[1], pSVar16 != (STWorldObject *)0x0)) {
                iVar7 = (*pSVar16->vtable->GetObjectTypeId)(pSVar16);
                switch(iVar7) {
                case 0xa6:
                case 0xa7:
                case 0xaf:
                case 0xbd:
                  thunk_FUN_00627390((int)pSVar16);
                }
              }
            }
...
LAB_00625d60:
          if (in_stack_00000010 != 0) {
            ...
            iVar15 = FUN_006acf90(iVar9,iVar7,iVar14,iVar15);
            if (iVar15 < 2) {
              ...
              uVar11 = iVar15 - iVar12 >> 0x1f;
              if ((int)((iVar15 - iVar12 ^ uVar11) - uVar11) < 2) {
                if (((sVar13 < 0) || (SHORT_007fb240 <= sVar13)) ||
                   ((sVar19 < 0 ||
                    (((SHORT_007fb242 <= sVar19 || (sVar18 < 0)) || (SHORT_007fb244 <= sVar18))))))
                goto cf_continue_loop_0062607F;
                pSVar16 = g_worldCells
                          [(int)sVar18 * (int)SHORT_007fb246 + (int)sVar19 * (int)SHORT_007fb240 +
                           (int)sVar13].objects[1];
              }
            }
            if (pSVar16 != (STWorldObject *)0x0) {
              iVar12 = (*pSVar16->vtable->GetObjectTypeId)(pSVar16);
              switch(iVar12) {
              case 0xa6:
              case 0xa7:
              case 0xaf:
          ...
          if (pSVar16 == (STWorldObject *)0x0) goto LAB_00625d60;
          iVar7 = (*pSVar16->vtable[5].slots_00_28[0])();
          if (iVar7 != 0) {
            if (in_stack_00000010 != 0) {
              thunk_FUN_00416270(pSVar16,&local_a,(int *)&local_8,(int *)&local_6);
              iVar7 = FUN_006acf0d(*(int *)((int)this + 0x2c2),*(int *)((int)this + 0x2c6),
...
LAB_00625efc:
              ...
              if (((bVar17) && (iVar12 = (*pSVar16->vtable[5].slots_00_28[2])(), iVar12 != 0)) &&
                 (iVar12 = thunk_FUN_006264d0(this,(int *)pSVar16,local_20), iVar12 != 0)) {
                if (DAT_00811798 != (void *)0x0) {
                  iVar12 = (**(code **)(*(int *)this + 0x2c))();
                  iVar7 = (*pSVar16->vtable->GetObjectTypeId)(pSVar16);
                  thunk_FUN_0061fe80(DAT_00811798,iVar14,iVar15,(uint)pSVar16[1].vtable,iVar7,iVar12
                                    );
                }
                bVar6 = true;
              }
