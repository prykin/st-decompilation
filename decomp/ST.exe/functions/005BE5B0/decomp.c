...

{
  ...
  char local_11;
  uint local_10;
  AnonShape_005BE5B0_D9085402 *local_c;
  UINT local_8;
  size_t sVar15;
  ...
  FUN_006b4170((int)this_00->field_0073,0,0x2e,1,0x2ba,0x15c,0x4c);
  ...
  if (this_00->field_0067 == '\0') {
    ...
    iVar12 = -1;
    iVar5 = -1;
    puVar8 = (uint *)FUN_006b0140(0x2440,HINSTANCE_00807618);
  ...
  if (bVar3 == 0) {
    ...
    puVar8 = (uint *)FUN_006b0140(0x2440,HINSTANCE_00807618);
    ccFntTy::WrStr(this_00->field_0083,puVar8,iVar5,iVar12,uVar22);
    local_18 = (byte *)ccFntTy::CreateSurf(this_00->field_0083,(int)this_00->field_0073,0,0,0,0x136,
                                           0x22,0);
          ...
          if (DAT_00808aaf != 0) {
            do {
              ...
              if (((&DAT_00808af4)[iVar5] == bVar3) && ((&DAT_00808af5)[iVar5] != '\0')) {
                ...
                DibPut((AnonShape_006B84D0_7C7D97C6 *)this_00->field_0073,0x38,
                       (uVar10 & 0xff) * 0x26 + 0x2c,'\x01',local_18);
                break;
              }
...
LAB_005bf156:
    ...
    pbVar6 = (byte *)FUN_0070b3a0(this_00->field_007F,iVar5);
    DibPut((AnonShape_006B84D0_7C7D97C6 *)this_00->field_0073,0x2e,1,'\x06',pbVar6);
    local_c = (AnonShape_005BE5B0_D9085402 *)
              ccFntTy::CreateSurf(this_00->field_0083,(int)this_00->field_0073,0,0x2f,2,0x2b7,0x1e,0
                                 );
    if (local_c != (AnonShape_005BE5B0_D9085402 *)0x0) {
      local_11 = '\x01';
      ...
      if (DAT_00808aaf != 0) {
        do {
          ...
          local_18 = (byte *)CONCAT31(local_18._1_3_,bVar3);
      ...
      DibPut((AnonShape_006B84D0_7C7D97C6 *)this_00->field_0073,0x2f,2,'\x01',(byte *)local_c);
      ccFntTy::EraseSufr(this_00->field_0083);
      pcVar16 = wsprintfA_exref;
    }
    ...
    if (((-1 < iVar5) && (0 < iVar12)) && (iVar12 = (iVar5 * 0x26) / iVar12, 0 < iVar12)) {
      iVar5 = 0x1c7;
      do {
        DibPut((AnonShape_006B84D0_7C7D97C6 *)this_00->field_0073,iVar5,0x121,'\x06',
    ...
    if ((char)local_10 != '\0') {
      ...
      pcVar7 = (char *)FUN_006b0140(local_8,HINSTANCE_00807618);
      uVar10 = 0xffffffff;
      do {
        pcVar18 = pcVar7;
        if (uVar10 == 0) break;
...
LAB_005bef47:
            ...
            uVar10 = (uint)bVar3;
            cVar14 = *(char *)((int)&DAT_00808a4f + uVar11 * 8 + uVar10);
            if ((cVar14 == '\0') && (*(char *)((int)&DAT_00808a4f + uVar10 * 8 + uVar11) == '\0')) {
              iVar5 = -2;
            }
            else if ((cVar14 == '\x01') &&
                    (*(char *)((int)&DAT_00808a4f + uVar10 * 8 + uVar11) == '\0')) {
              iVar5 = -1;
            }
            else if ((cVar14 == '\0') &&
                    (*(char *)((int)&DAT_00808a4f + uVar10 * 8 + uVar11) == '\x01')) {
              iVar5 = 1;
            }
            else {
              if ((cVar14 != '\x01') ||
                 (*(char *)((int)&DAT_00808a4f + uVar10 * 8 + uVar11) != '\x01')) goto LAB_005bef47;
              iVar5 = 2;
            }
          }
          bVar19 = iVar5 < 0;
...
LAB_005bef6c:
    ...
    iVar12 = -1;
    iVar5 = -3;
    puVar8 = (uint *)FUN_006b0140(UVar20,HINSTANCE_00807618);
    ccFntTy::WrStr(this_00->field_0083,puVar8,iVar5,iVar12,uVar22);
  }
  iVar5 = 1;
  ...
  iVar12 = -1;
  iVar5 = -1;
  puVar8 = (uint *)FUN_006b0140(0x2444,HINSTANCE_00807618);
  ccFntTy::WrStr(this_00->field_0083,puVar8,iVar5,iVar12,uVar22);
  FUN_006b4170((int)local_c,0,local_c->field_0004 + -0x69,(local_c->field_0008 + -0x1c) / 2,0x50,
               0x1c,0);
