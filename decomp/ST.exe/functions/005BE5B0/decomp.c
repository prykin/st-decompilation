...
void FUN_005be5b0(char param_1)

{
  ...
  if ((*(int *)(local_20 + 0x457) == 0) && (param_1 == '\0')) {
    thunk_FUN_005bd4b0(DAT_0080759c,0,0,0x1a,10,0x2e9,0x32,local_20);
  }
  if (*(int *)(local_20 + 0x453) != 0) {
    DAT_00858df8 = local_64;
    return;
  }
  if (param_1 != '\0') {
  ...
  thunk_FUN_00540620(0x1a,0x46,0x1a,0x46,*(uint *)(*(int *)(local_20 + 0x73) + 4),
                     *(byte **)(*(int *)(local_20 + 0x73) + 8),'\x01',
                     *(BITMAPINFO **)(local_20 + 0x5d));
  FUN_006b4170(*(int *)(local_20 + 0x73),0,0x2e,1,0x2ba,0x15c,0x4c);
  pcVar14 = wsprintfA_exref;
  if (*(char *)(local_20 + 0x67) == '\0') {
    FUN_00710a90(*(int *)(local_20 + 0x73),0,0x37,10,*(int *)(*(int *)(local_20 + 0x73) + 4) + -0x41
                 ,0xf);
    uVar18 = 0;
    iVar10 = -1;
    iVar3 = -1;
  ...
  if (bVar1 == 0) {
    ...
    puVar6 = (uint *)FUN_006b0140(0x2440,DAT_00807618);
    FUN_007119c0(puVar6,iVar3,iVar10,uVar18);
    local_18 = (byte *)FUN_00710ba0(*(int *)(local_20 + 0x73),0,0,0,0x136,0x22,0);
          ...
          if (DAT_00808aaf != 0) {
            do {
              ...
              if (((&DAT_00808af4)[iVar3] == bVar1) && ((&DAT_00808af5)[iVar3] != '\0')) {
                ...
                thunk_FUN_00540760(*(undefined4 **)(local_20 + 0x73),0x38,
    ...
    if (*(char *)(local_20 + 0x68) == '\0') {
      iVar3 = 0;
      if (DAT_0080c83e != 0xffffffff) {
        do {
          if (iVar3 == 0) {
            uVar8 = *(uint *)(local_20 + 0x2a3);
            iVar21 = 0;
            iVar10 = DAT_0080c963;
          }
          else {
      ...
      iVar10 = 0;
      puVar7 = (undefined4 *)(local_20 + 0x2a7);
...
LAB_005bf156:
    ...
    pbVar4 = (byte *)FUN_0070b3a0(*(int *)(local_20 + 0x7f),iVar3);
    thunk_FUN_00540760(*(undefined4 **)(local_20 + 0x73),0x2e,1,'\x06',pbVar4);
    local_c = (byte *)FUN_00710ba0(*(int *)(local_20 + 0x73),0,0x2f,2,0x2b7,0x1e,0);
    if (local_c != (byte *)0x0) {
      local_11 = '\x01';
      ...
      if (DAT_00808aaf != 0) {
        do {
          ...
          if ((&DAT_00808af4)[uVar8 * 0x9c] == (char)local_1c) {
            ...
            iVar3 = FUN_00711110(*(void **)(local_20 + 0x83),&DAT_0080f33a);
      ...
      if (0x2a8 < iVar3) {
        ...
        _Count = (int)(0x2a8 / (longlong)
                               (*(int *)(*(int *)(local_20 + 0x83) + 0x58) + *(int *)(iVar3 + 0x86))
                      ) - 1;
        do {
          sVar13 = _Count;
          _Count = sVar13 + 1;
        ...
        if (_Count != ~uVar8 - 1) {
          ...
          _strncpy((char *)&DAT_0080f33a,local_898,sVar13 - 2);
          uVar8 = 0xffffffff;
          pcVar5 = &DAT_007c7274;
          do {
            pcVar16 = pcVar5;
      ...
      thunk_FUN_00540760(*(undefined4 **)(local_20 + 0x73),0x2f,2,'\x01',local_c);
      FUN_00710f00();
      pcVar14 = wsprintfA_exref;
    }
    if (*(byte *)(local_20 + 0x69) == 1) {
      uVar8 = 0xffffffff;
    }
    else {
      uVar8 = (uint)*(ushort *)(&DAT_0080c8a7 + (uint)*(byte *)(local_20 + 0x69) * 0x10);
    }
    ...
    if (*(byte *)(local_20 + 0x69) == 1) {
      ...
      uVar8 = (uint)*(ushort *)(&DAT_0080c8a9 + (uint)*(byte *)(local_20 + 0x69) * 0x10);
    }
    ...
    if (*(byte *)(local_20 + 0x69) == 1) {
      ...
      uVar8 = (uint)*(ushort *)(&DAT_0080c8ab + (uint)*(byte *)(local_20 + 0x69) * 0x10);
    }
    ...
    if (*(byte *)(local_20 + 0x69) == 1) {
      ...
      uVar8 = (uint)*(ushort *)(&DAT_0080c8ad + (uint)*(byte *)(local_20 + 0x69) * 0x10);
    }
    ...
    if (*(byte *)(local_20 + 0x69) == 1) {
      ...
      uVar8 = (uint)*(ushort *)(&DAT_0080c8af + (uint)*(byte *)(local_20 + 0x69) * 0x10);
    }
    ...
    if (*(byte *)(local_20 + 0x69) == 1) {
      ...
      uVar8 = (uint)*(ushort *)(&DAT_0080c8b1 + (uint)*(byte *)(local_20 + 0x69) * 0x10);
    }
    ...
    if (*(byte *)(local_20 + 0x69) == 1) {
      ...
      uVar8 = (uint)*(ushort *)(&DAT_0080c8b3 + (uint)*(byte *)(local_20 + 0x69) * 0x10);
    }
    ...
    if (*(byte *)(local_20 + 0x69) == 1) {
      ...
      uVar8 = (uint)*(ushort *)(&DAT_0080c8b5 + (uint)*(byte *)(local_20 + 0x69) * 0x10);
    }
    ...
    if ((char)local_10 == '\x03') {
      ...
      FUN_00710a90(*(int *)(local_20 + 0x73),0,0x8c,0x11f,0x62,0x14);
      FUN_007119c0(&DAT_0080f33a,-1,-1,8);
      uVar18 = DAT_0080c8bf;
      if (*(byte *)(local_20 + 0x69) != 1) {
        uVar18 = *(undefined4 *)(&DAT_0080c82f + (uint)*(byte *)(local_20 + 0x69) * 0x10);
      }
      (*pcVar14)(&DAT_0080f33a,&DAT_007ccfb8,uVar18);
      uVar18 = 0x12a;
    }
      ...
      FUN_00710a90(*(int *)(local_20 + 0x73),0,0x75,0x11f,0x3e,0x14);
      FUN_007119c0(&DAT_0080f33a,-1,-1,8);
      uVar18 = DAT_0080c8bb;
      if (*(byte *)(local_20 + 0x69) != 1) {
        uVar18 = *(undefined4 *)(&DAT_0080c82b + (uint)*(byte *)(local_20 + 0x69) * 0x10);
      }
      (*pcVar14)(&DAT_0080f33a,&DAT_007ccfb8,uVar18);
      FUN_00710a90(*(int *)(local_20 + 0x73),0,0xcc,0x11f,0x62,0x14);
      FUN_007119c0(&DAT_0080f33a,-1,-1,8);
      uVar18 = DAT_0080c8bf;
      if (*(byte *)(local_20 + 0x69) != 1) {
        uVar18 = *(undefined4 *)(&DAT_0080c82f + (uint)*(byte *)(local_20 + 0x69) * 0x10);
    ...
    FUN_00710a90(*(int *)(local_20 + 0x73),0,uVar18,0x11f,0x62,0x14);
    FUN_007119c0(&DAT_0080f33a,-1,-1,8);
    iVar3 = DAT_0080c8c3;
    if (*(byte *)(local_20 + 0x69) != 1) {
      iVar3 = *(int *)(&DAT_0080c833 + (uint)*(byte *)(local_20 + 0x69) * 0x10);
    }
    if ((char)local_1c == -1) {
      iVar10 = 0;
    }
    ...
    if (((-1 < iVar3) && (0 < iVar10)) && (iVar10 = (iVar3 * 0x26) / iVar10, 0 < iVar10)) {
      iVar3 = 0x1c7;
      do {
        thunk_FUN_00540760(*(undefined4 **)(local_20 + 0x73),iVar3,0x121,'\x06',
                           *(byte **)(local_20 + 0x6f));
        iVar3 = iVar3 + 6;
        iVar10 = iVar10 + -1;
      } while (iVar10 != 0);
    ...
    if ((char)local_10 != '\0') {
      ...
      FUN_00710a90(*(int *)(local_20 + 0x73),0,0x37,0x145,400,0xf);
      FUN_007119c0(&DAT_0080f33a,0,-1,0);
    }
    FUN_00710a90(*(int *)(local_20 + 0x73),0,500,0x145,0xe6,0xf);
    bVar1 = *(byte *)(local_20 + 0x69);
    if (bVar1 == 1) {
      UVar19 = 0x2441;
    }
...
LAB_005bef6c:
  ...
  iVar3 = 1;
  puVar7 = (undefined4 *)(*(int *)(local_20 + 0x5d) + 0x28);
  uVar8 = FUN_006b4fe0(*(int *)(local_20 + 0x5d));
  local_c = (byte *)FUN_006b50c0(400,0x32,(uint)*(ushort *)(*(int *)(local_20 + 0x5d) + 0xe),uVar8,
                                 puVar7,iVar3);
  ...
  FUN_00710a90((int)local_c,0,5,5,*(int *)(local_c + 4) + -0x69,*(int *)(local_c + 8) + -10);
  uVar18 = 0;
  iVar10 = -1;
  iVar3 = -1;
  ...
  wsprintfA((LPSTR)&DAT_0080f33a,s__s_02d__02d_007c2184,&DAT_0080f33a,
            ...
            (int)(((ulonglong)DAT_0080c83a % 0xe10) % 0x3c));
  FUN_00710a90((int)local_c,0,*(int *)(local_c + 4) + -0x69,(*(int *)(local_c + 8) + -0x1c) / 2,0x50
               ,0x1c);
  FUN_007119c0(&DAT_0080f33a,-1,-1,8);
  FUN_006c5000(DAT_0080759c,0x174,0x1a9,(int)local_c,0,0,0,*(uint *)(local_c + 4),
               *(int *)(local_c + 8),local_20 + 0xa3,0x4c);
  FUN_006ab060(&local_c);
LAB_005bf406:
  iVar3 = *(int *)(local_20 + 0x73);
  FUN_006b48e0(DAT_0080759c,0x1a,0x46,iVar3,0,0,0,*(uint *)(iVar3 + 4),*(int *)(iVar3 + 8),
               local_20 + 0xa3,0x4c,0x10000ff);
  DAT_00858df8 = local_64;
  return;
}
