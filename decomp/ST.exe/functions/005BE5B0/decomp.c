...

{
  ...
  if (iVar5 != 0) {
    ...
    iVar13 = ReportDebugMessage("E:\\__titans\\Start\\rpt_obj.cpp",0x1b4,0,iVar5,"%s"
                                ,"MReportTy::PaintMReport");
    if (iVar13 == 0) {
  ...
  if (this_00->field_0067 == '\0') {
    ...
    ccFntTy::WrStr(this_00->field_0083,puVar9,iVar5,iVar13,uVar11);
    goto LAB_005bf406;
  }
  ...
  if (bVar3 == 0) {
          ...
          if (DAT_00808aaf != 0) {
            do {
              ...
              if (((&DAT_00808af4)[iVar5] == bVar3) && ((&DAT_00808af5)[iVar5] != '\0')) {
                ...
                ccFntTy::WrStr(this_00->field_0083,&DAT_00808ab0 + (UVar21 & 0xff) * 0x27,0,-1,0);
                DibPut((AnonShape_006B5B10_E0D06CF1 *)this_00->field_0073,0x38,
                       (uVar11 & 0xff) * 0x26 + 0x2c,'\x01',(byte *)local_18);
                break;
              }
    ...
    if (this_00->field_0068 == '\0') {
      ...
      if (DAT_0080c83e != 0xffffffff) {
        do {
          if (iVar5 == 0) {
            uVar11 = this_00->field_02A3;
            iVar22 = 0;
            iVar13 = DAT_0080c963;
          }
          else {
            uVar11 = this_00->field_02A3;
            iVar13 = (&DAT_0080c943)[iVar5];
            iVar22 = iVar5;
          }
          PaintMainScore(this_00,iVar13,uVar11,iVar22);
          iVar5 = iVar5 + 1;
      ...
      if (DAT_0080c83e != 0xffffffff) {
        do {
          ...
          else if ((&DAT_0080c943)[iVar13] == 0) {
            uVar11 = this_00->field_02A3;
            iVar5 = iVar13;
LAB_005bf156:
            PaintMainScore(this_00,0,uVar11,iVar5);
          }
          iVar13 = iVar13 + 1;
        } while (iVar13 < (int)(DAT_0080c83e + 1));
      }
    }
  }
  else {
    ...
    if (local_c != (RecoveredRecord_MReportTy_005BD4B0 *)0x0) {
      ...
      if (DAT_00808aaf != 0) {
        do {
          uVar11 = (uint)local_18 & 0xff;
          if ((&DAT_00808af4)[uVar11 * 0x9c] == (char)local_1c) {
            if (local_11 == '\0') {
              wsprintfA((LPSTR)&DAT_0080f33a,"%s, %s",&DAT_0080f33a,
                        &DAT_00808ab0 + uVar11 * 0x27);
            }
            else {
              wsprintfA((LPSTR)&DAT_0080f33a,"%s",&DAT_00808ab0 + uVar11 * 0x27);
              local_11 = '\0';
            }
      ...
      if (0x2a8 < iVar5) {
        ...
        } while ((int)_Count < (int)(~uVar11 - 1));
        if (_Count != ~uVar11 - 1) {
          memset(&DAT_0080f33a, 0, 0x834); /* compiler bulk-zero initialization */
          Library::MSVCRT::_strncpy((char *)&DAT_0080f33a,local_898,sVar16 - 2);
          uVar11 = 0xffffffff;
          pcVar8 = &DAT_007c7274;
          do {
            pcVar19 = pcVar8;
    ...
    if (this_00->field_0069 == 1) {
      ...
      uVar11 = (uint)*(ushort *)(&DAT_0080c8a7 + (uint)(byte)this_00->field_0069 * 0x10);
    }
    PaintObjScore(this_00,uVar11,(uint)DAT_0080c937,0x69,0x6a);
    if (this_00->field_0069 == 1) {
      uVar11 = 0xffffffff;
    }
    else {
      uVar11 = (uint)*(ushort *)(&DAT_0080c8a9 + (uint)(byte)this_00->field_0069 * 0x10);
    }
    PaintObjScore(this_00,uVar11,(uint)DAT_0080c939,0xfb,0x6a);
    if (this_00->field_0069 == 1) {
      uVar11 = 0xffffffff;
    }
    else {
      uVar11 = (uint)*(ushort *)(&DAT_0080c8ab + (uint)(byte)this_00->field_0069 * 0x10);
    }
    PaintObjScore(this_00,uVar11,(uint)DAT_0080c93b,0x18d,0x6a);
    if (this_00->field_0069 == 1) {
      uVar11 = 0xffffffff;
    }
    else {
      uVar11 = (uint)*(ushort *)(&DAT_0080c8ad + (uint)(byte)this_00->field_0069 * 0x10);
    }
    PaintObjScore(this_00,uVar11,(uint)DAT_0080c93d,0x225,0x6a);
    if (this_00->field_0069 == 1) {
      uVar11 = 0xffffffff;
    }
    else {
      uVar11 = (uint)*(ushort *)(&DAT_0080c8af + (uint)(byte)this_00->field_0069 * 0x10);
    }
    PaintObjScore(this_00,uVar11,(uint)DAT_0080c93f,0x69,0xcb);
    if (this_00->field_0069 == 1) {
      uVar11 = 0xffffffff;
    }
    else {
      uVar11 = (uint)*(ushort *)(&DAT_0080c8b1 + (uint)(byte)this_00->field_0069 * 0x10);
    }
    PaintObjScore(this_00,uVar11,(uint)DAT_0080c941,0xfb,0xcb);
    if (this_00->field_0069 == 1) {
      uVar11 = 0xffffffff;
    }
    else {
      uVar11 = (uint)*(ushort *)(&DAT_0080c8b3 + (uint)(byte)this_00->field_0069 * 0x10);
    }
    PaintObjScore(this_00,uVar11,(uint)(ushort)DAT_0080c943,0x18d,0xcb);
    if (this_00->field_0069 == 1) {
      uVar11 = 0xffffffff;
    }
    else {
      uVar11 = (uint)*(ushort *)(&DAT_0080c8b5 + (uint)(byte)this_00->field_0069 * 0x10);
    }
    /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
    PaintObjScore(this_00,uVar11,(uint)DAT_0080c943._2_2_,0x225,0xcb);
    bVar3 = this_00->field_0069;
    if ((char)local_10 == '\x03') {
      ...
      (*pcVar17)(&DAT_0080f33a,"%11d",uVar7);
    ...
    if ((char)local_1c == -1) {
      ...
      iVar13 = (-(uint)((char)local_10 != '\x03') & 0xfffffff9) + 0x14;
    }
    if (((-1 < iVar5) && (0 < iVar13)) && (iVar13 = (iVar5 * 0x26) / iVar13, 0 < iVar13)) {
      iVar5 = 0x1c7;
      do {
...
LAB_005bef47:
            ...
            uVar11 = (uint)DAT_0080c846;
            bVar4 = g_playerRelationMatrix[uVar11][bVar3];
            if ((bVar4 == 0) && (g_playerRelationMatrix[bVar3][uVar11] == 0)) {
              iVar5 = -2;
            }
            else if ((bVar4 == 1) && (g_playerRelationMatrix[bVar3][uVar11] == 0)) {
              iVar5 = -1;
            }
            else if ((bVar4 == 0) && (g_playerRelationMatrix[bVar3][uVar11] == 1)) {
              iVar5 = 1;
            }
            else {
              if ((bVar4 != 1) || (g_playerRelationMatrix[bVar3][uVar11] != 1)) goto LAB_005bef47;
              iVar5 = 2;
            }
          }
          bVar20 = iVar5 < 0;
          ...
          bVar20 = (&DAT_008087ea)[(uint)bVar3 * 0x51] != (&DAT_008087ea)[(uint)DAT_0080c846 * 0x51]
          ;
        }
        if (bVar20) goto LAB_005bef67;
      }
...
LAB_005bef6c:
    ...
    iVar13 = -1;
    iVar5 = -3;
    puVar9 = (uint *)LoadResourceString(UVar21,g_module_00807618);
    ccFntTy::WrStr(this_00->field_0083,puVar9,iVar5,iVar13,uVar11);
  }
  iVar5 = 1;
  ...
  ;
  uVar11 = local_c->field_0014;
  if (uVar11 == 0) {
    uVar11 = ((uint)local_c->field_000E * local_c->field_0004 + 0x1f >> 3 & 0x1ffffffc) *
             local_c->field_0008;
  }
  ...
  cVar15 = (char)(DAT_0080c83a / 0xe10);
  /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
  local_8 = CONCAT31(local_8._1_3_,cVar15);
  if (cVar15 == '\0') {
    puVar14 = &DAT_007c2198;
    pcVar8 = "%s;";
  }
  else {
    puVar14 = (undefined *)(DAT_0080c83a / 0xe10 & 0xff);
    pcVar8 = "%2d:";
  }
  wsprintfA((LPSTR)&DAT_0080f33a,pcVar8,puVar14);
