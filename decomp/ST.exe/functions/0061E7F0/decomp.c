...

{
  ...
  local_40 = local_3c * 2;
  uVar16 = param_1->field_00AC * 0x41c64e6d + 0x3039;
  param_1->field_00AC = uVar16;
  local_1c = 0;
  local_28 = 0;
  local_2c = (uVar16 >> 0x10) % 3 + 3;
...
LAB_0061e865:
  ...
  uVar16 = *(uint *)(iVar14 + local_c * 4);
  if ((int)uVar16 < 0) {
    if ((uVar16 == 0xfffffffe) && (-1 < *(int *)(iVar14 + (local_c + local_30) * 4))) {
      uVar16 = *(uint *)(iVar14 + (local_c + local_30) * 4);
      goto LAB_0061e89d;
    }
  }
  else {
LAB_0061e89d:
    local_8 = 0;
    local_24 = 0;
    local_4c = (local_3c + uVar16) * 4;
    local_10 = *(int *)(local_4c + iVar14);
    local_50 = (local_40 + uVar16) * 4;
    local_14 = *(int *)(local_50 + iVar14);
    if (local_14 < *(int *)(param_1->field_009B + uVar16 * 4) + -1) {
      local_18 = local_14 * 0x14;
      do {
        if (((local_1c == 0) || ((int)local_1c <= local_28)) || (local_24 != 0)) {
LAB_0061eb1a:
          pfVar8 = (float *)(*(int *)(param_1->field_009F + uVar16 * 4) + local_18);
          ...
          ;
          iVar14 = *(int *)(param_1->field_009F + uVar16 * 4);
          ...
          if (((local_70 < _DAT_0079034c) || (local_6c < _DAT_0079034c)) ||
             ((local_68 < _DAT_0079034c ||
              (((lVar18 = Library::MSVCRT::__ftol(), g_worldGrid.sizeX <= (short)lVar18 ||
                (lVar18 = Library::MSVCRT::__ftol(), g_worldGrid.sizeY <= (short)lVar18)) ||
               (lVar18 = Library::MSVCRT::__ftol(), g_worldGrid.sizeZ <= (short)lVar18)))))) {
            *(undefined4 *)(param_1->field_0057 + local_c * 4) = 0xfffffffe;
            iVar14 = 0;
            if (param_1->field_0053 < 1) goto LAB_0061f035;
            piVar17 = (int *)param_1->field_0057;
            goto LAB_0061f028;
          }
          if ((uVar16 == 0) && (local_14 == *(int *)param_1->field_009B + -2)) {
            uVar21 = param_1->field_0044;
            iVar14 = param_1->field_0040;
            iVar19 = param_1->field_0020;
            iVar22 = 0xb1;
            iVar20 = 0x32;
            uVar7 = uVar16;
            uVar23 = uVar16;
            ...
            SubmarineTitans::Recovered::HiddenThis::AnonReceiver_00601500::thunk_FUN_00601500
                      ((AnonReceiver_00601500 *)(param_1 + 1),(int)lVar18,iVar13,iVar12,iVar11,
                       iVar10,iVar9,iVar19,iVar20,iVar14,uVar21,iVar22,uVar7,uVar23);
          }
          if (*(int *)(param_1->field_0057 + uVar16 * 4) == 0) {
            uVar15 = 2;
            local_5f = 2;
            local_64 = 2;
          }
...
LAB_0061eefe:
            ...
            if (g_visibleClass_00802A88 != (VisibleClassTy *)0x0) {
              if (local_74 < _DAT_0079034c) {
                lVar18 = Library::MSVCRT::__ftol();
                local_20 = (int *)((short)lVar18 + -1);
              }
              else {
                lVar18 = Library::MSVCRT::__ftol();
                local_20 = (int *)(int)(short)lVar18;
              }
              if (local_78 < _DAT_0079034c) {
                lVar18 = Library::MSVCRT::__ftol();
                local_34 = (int)(short)lVar18 - 1;
              }
              else {
                lVar18 = Library::MSVCRT::__ftol();
                local_34 = (uint)(short)lVar18;
              }
              if (local_7c < _DAT_0079034c) {
                lVar18 = Library::MSVCRT::__ftol();
                iVar14 = (short)lVar18 + -1;
              }
              else {
                lVar18 = Library::MSVCRT::__ftol();
                iVar14 = (int)(short)lVar18;
              }
          ...
          if (local_14 == *(int *)(param_1->field_009B + uVar16 * 4) + -2) {
            *(undefined4 *)(param_1->field_0057 + local_c * 4) = 0xfffffffe;
            iVar14 = 0;
          ...
          /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
          iVar14 = *(int *)(*(int *)(param_1->field_009F + uVar16 * 4) + 0x24 + local_18);
          if (0 < iVar14) {
            *(int *)(param_1->field_0057 + param_1->field_0053 * 4) = iVar14;
            *(undefined4 *)(param_1->field_0057 + (local_30 + param_1->field_0053) * 4) =
                 *(undefined4 *)(*(int *)(param_1->field_009F + uVar16 * 4) + 0x24 + local_18);
          ...
          pSVar2 = param_1->field_00A3;
          local_34 = pSVar2->count;
          if (local_8 < local_34) {
            dVar3 = pSVar2->elementSize;
            local_44 = pSVar2->data;
            local_20 = (int *)((int)&local_44->field_0000 + dVar3 * local_8);
            if (local_20 != (int *)0x0) {
              /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
              if ((byte)*(undefined1 *)((int)local_20 + 0x2e) != uVar16) {
                local_24 = 1;
                piVar17 = local_20;
                for (uVar7 = local_8; (int)uVar7 < (int)local_1c; uVar7 = uVar7 + 1) {
                  if (uVar7 < local_34) {
                    local_20 = piVar17;
                    if ((piVar17 != (int *)0x0) &&
                       ((byte)*(undefined1 *)((int)piVar17 + 0x2e) == uVar16)) {
                      local_24 = 0;
                      local_8 = uVar7;
                      break;
                    }
                  ...
                  piVar17 = (int *)((int)piVar17 + dVar3);
                }
              }
              /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
              if ((byte)*(undefined1 *)((int)local_20 + 0x2e) != uVar16) goto LAB_0061eb1a;
              if (local_8 < local_34) {
                piVar17 = (int *)((int)&local_44->field_0000 + dVar3 * local_8);
              }
              else {
                piVar17 = (int *)0x0;
              }
              ...
              piVar17[1] = (int)(local_7c + param_1->field_0063);
              piVar17[2] = (int)(local_78 + param_1->field_0067);
              piVar17[3] = (int)(local_74 + param_1->field_006B);
              iVar14 = *(int *)(param_1->field_009F + uVar16 * 4);
              /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
              fVar4 = *(float *)(local_18 + 0x1c + iVar14) * param_1->field_0047;
              /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
              ...
              local_68 = fVar4 * param_1->field_008F +
                         fVar6 * param_1->field_0083 + fVar5 * param_1->field_0077;
              piVar17[4] = (int)(local_70 + param_1->field_0063);
              piVar17[5] = (int)(local_6c + param_1->field_0067);
              local_44 = (STLightC_field_00A3Element *)(local_68 + param_1->field_006B);
              piVar17[6] = (int)local_44;
              Library::Ourlib::ST3DSMAP::SprGlowLineMove
                        (g_sT3DSMAPContext_00807598,*(undefined4 *)((int)piVar17 + 0x26),piVar17[1],
                         piVar17[2],piVar17[3],piVar17[4],piVar17[5],local_44);
              Library::Ourlib::ST3DSMAP::SprGlowLineSetColors
                        (g_sT3DSMAPContext_00807598,*(undefined4 *)((int)piVar17 + 0x26),
                         *(undefined4 *)((int)piVar17 + 0x21),local_2c * 0x200 + DAT_008032d0);
              local_28 = local_28 + 1;
              local_8 = local_8 + 1;
            }
          }
        ...
        local_14 = local_14 + 1;
      } while (local_14 < *(int *)(param_1->field_009B + uVar16 * 4) + -1);
    }
  }
  goto LAB_0061f043;
  while( true ) {
...
LAB_0061f028:
    if (-1 < *piVar17) goto LAB_0061f043;
  }
LAB_0061f035:
