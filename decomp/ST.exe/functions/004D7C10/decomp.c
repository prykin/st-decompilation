...

{
  ...
  uVar4 = 0;
  iVar3 = param_2 * 0x44;
  if (param_4 <= *(int *)(&g_playerRuntime[iVar2].field_0x7de + iVar3)) {
    ...
    *(int *)(&g_playerRuntime[iVar2].field_0x7de + iVar3) =
         *(int *)(&g_playerRuntime[iVar2].field_0x7de + iVar3) - param_4;
    *(int *)(&g_playerRuntime[iVar2].field_0x80e + iVar3) =
         *(int *)(&g_playerRuntime[iVar2].field_0x80e + iVar3) - param_4;
    piVar5[1] = piVar5[1] - param_4;
    uVar4 = 1;
    if (*(int *)(&g_playerRuntime[iVar2].field_0x7de + iVar3) == 0) {
