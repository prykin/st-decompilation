...

{
  ...
  uVar4 = 0;
  iVar3 = param_2 * 0x44;
  if (param_4 <= *(int *)(&g_packedRecords_A62x8[iVar2].field_0x7de + iVar3)) {
    ...
    *(int *)(&g_packedRecords_A62x8[iVar2].field_0x7de + iVar3) =
         *(int *)(&g_packedRecords_A62x8[iVar2].field_0x7de + iVar3) - param_4;
    *(int *)(&g_packedRecords_A62x8[iVar2].field_0x80e + iVar3) =
    ...
    uVar4 = 1;
    if (*(int *)(&g_packedRecords_A62x8[iVar2].field_0x7de + iVar3) == 0) {
