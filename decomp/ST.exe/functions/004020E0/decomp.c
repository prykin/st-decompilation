...
void __thiscall
thunk_FUN_005597a0(void *this,int param_1,int param_2,undefined1 param_3,uint param_4,int param_5,
...

{
  ...
  if ((((*(int *)((int)this + 0x114) != 0) && (-1 < param_5)) && (param_4 < 8)) &&
    ...
    pvStack_14 = this;
    if (*(int *)((int)this + param_4 * 4 + 0x54) == 0) {
      ...
      if (iVar4 != 0) {
        ...
        iVar4 = FUN_006ad4d0(s_E____titans_grig_visible_cpp_007c92cc,0x293,0,iVar4,&DAT_007a4ccc);
        if (iVar4 == 0) {
          return;
        }
        pcVar2 = (code *)swi(3);
      ...
      puVar5 = FUN_006aac10(*(int *)((int)pvStack_14 + 0x24) * *(int *)((int)pvStack_14 + 0x20));
      *(undefined4 **)((int)this + param_4 * 4 + 0x54) = puVar5;
      DAT_00858df8 = (undefined4 *)uStack_60;
    }
    if ((param_7 & 0x1000) != 0) {
      thunk_FUN_0055bb00(this,2,(short)param_1,(short)param_2,param_3,param_4,(char)param_5,param_6)
      ;
    }
    if ((param_7 & 4) != 0) {
      if (param_5 < 0) {
