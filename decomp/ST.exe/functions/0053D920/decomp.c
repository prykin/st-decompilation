...
void __thiscall
FUN_0053d920(void *this,int param_1,byte param_2,char *param_3,undefined4 param_4,UINT param_5,
            undefined *param_6)

{
  ...
  local_8 = (ushort *)0x0;
  local_14 = *local_18 - *(int *)((int)this + 0x3c);
  if (*(int *)((int)this + 0x5c) == 0) {
    local_c = local_18[1] + *(int *)((int)this + 0x48);
  }
  else {
  ...
  if (param_6 != (undefined *)0x0) {
    ...
    if (iVar3 == 0) {
      ...
      pvVar2 = local_10;
      iVar3 = local_14;
      thunk_FUN_00540760(*(undefined4 **)((int)local_10 + 0x68),local_14,local_c,param_2,
                         (byte *)local_8);
