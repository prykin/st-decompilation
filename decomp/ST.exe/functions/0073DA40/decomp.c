...

{
  ...
  if (DAT_008573fc == 1) {
    if ((local_18 == (LPWCH)0x0) && (local_18 = GetEnvironmentStringsW(), local_18 == (LPWCH)0x0)) {
      ...
      if ((cbMultiByte == 0) ||
         (local_1c = (LPCH)thunk_FUN_006a3c10(cbMultiByte,2,"a_env.c",100), local_1c == (LPSTR)0x0))
      {
        ...
        ;
        if (iVar4 == 0) {
          thunk_FUN_006a49c0((undefined4 *)local_1c,2);
          local_1c = (LPSTR)0x0;
        }
        FreeEnvironmentStringsW(local_18);
        pCVar3 = local_1c;
    ...
    if ((local_1c == (LPCH)0x0) && (local_1c = GetEnvironmentStrings(), local_1c == (LPCH)0x0)) {
      ...
      pCVar3 = (LPSTR)thunk_FUN_006a3c10((uint)(local_10 + (1 - (int)local_1c)),2,"a_env.c",0x8f);
      if (pCVar3 == (LPSTR)0x0) {
        FreeEnvironmentStringsA(local_1c);
        pCVar3 = (LPSTR)0x0;
      }
      else {
        FUN_0073a330((undefined4 *)pCVar3,(undefined4 *)local_1c,
