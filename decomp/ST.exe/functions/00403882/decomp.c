...
int __cdecl
thunk_FUN_00677be0(short param_1,short param_2,byte *param_3,short param_4,short param_5,
                  short param_6,short param_7,short param_8,short param_9,undefined *param_10,
                  undefined4 param_11)

{
  ...
  do {
    ...
    this = (int *)*puVar4;
    if (((this != (int *)0x0) &&
        (uStack_10 = uVar7, uStack_1c = (**(code **)(*this + 300))(), iVar3 = DAT_007fa160,
        (short)uStack_1c == param_1)) &&
       ((param_2 == 0 ||
...
LAB_00677cee:
      ...
      if (iVar5 != 0) {
        if ((((0 < param_7) && (0 < param_8)) && (0 < param_9)) &&
           ((((thunk_FUN_004162f0(this,&sStack_6,&sStack_8,&sStack_a), sStack_6 < param_4 ||
              (sStack_8 < param_5)) ||
             ((sStack_a < param_6 ||
              (((int)param_4 + (int)param_7 <= (int)sStack_6 ||
               ((int)param_5 + (int)param_8 <= (int)sStack_8)))))) ||
            (iVar5 = iStack_14, (int)param_6 + (int)param_9 <= (int)sStack_a)))) {
          iVar5 = 0;
        }
        iVar3 = DAT_007fa160;
        uVar7 = uStack_10;
