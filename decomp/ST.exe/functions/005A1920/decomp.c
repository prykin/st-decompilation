...
void __thiscall
FUN_005a1920(void *this,char *param_1,undefined4 param_2,int param_3,uint param_4,
            undefined4 *param_5)
  ...
  if (((param_5 != (undefined4 *)0x0) && (*(int *)((int)this + 0x1a97) != 0)) &&
    ...
    if (iVar4 == 0) {
      if ((param_3 == 1) || (param_3 == 8)) {
        if (*(undefined4 **)((int)local_c + 0x1a9f) != (undefined4 *)0x0) {
          FUN_006c6fc0(*(undefined4 **)((int)local_c + 0x1a9f));
        }
      ...
      if (param_3 == 1) {
          ...
          if (piVar7 != (int *)0x0) {
            ...
            do {
              ...
              *(undefined1 *)(iVar4 + 0x29 + *(int *)((int)pvVar12 + 0x1a97)) = *puVar1;
              iVar9 = iVar4 + 2;
              iVar4 = iVar4 + 4;
              puVar1[*(int *)((int)pvVar12 + 0x1a97) + (0xa8 - (int)(local_860 + 1))] =
        ...
        *(undefined4 *)((int)pvVar12 + 0x1aa3) = 0;
        ...
        if (iVar4 == 0) {
          ...
          pvVar12 = local_c;
          *(undefined4 **)((int)local_c + 0x1a9b) = puVar5;
          if (puVar5 != (undefined4 *)0x0) {
            ...
            puVar5 = FUN_006c7dc0(*(undefined4 *)((int)local_c + 0x1a9b));
            ...
            if (puVar5 != (undefined4 *)0x0) {
              ...
              do {
                ...
                *(undefined1 *)(iVar4 + 0x29 + *(int *)((int)pvVar12 + 0x1a97)) = *puVar1;
                iVar9 = iVar4 + 2;
                iVar4 = iVar4 + 4;
                puVar1[*(int *)((int)pvVar12 + 0x1a97) + (0xa8 - (int)(local_460 + 1))] =
