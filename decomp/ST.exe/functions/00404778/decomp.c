...
void __fastcall thunk_FUN_00664960(void *param_1)

{
  ...
  *(undefined4 *)((int)param_1 + 0x8f) = *(undefined4 *)((int)param_1 + 0x280);
  pvStack_8 = (void *)thunk_FUN_004357f0(*(char *)((int)param_1 + 0x24));
  iVar7 = thunk_FUN_00664540(param_1,auStack_44,&uStack_68);
  uVar13 = extraout_EDX;
  while (-1 < iVar7) {
    switch(auStack_44[0]) {
    case 0:
    ...
    case 1:
      *(undefined1 *)((int)param_1 + 0x139) = (undefined1)uStack_3c;
      *(uint *)((int)param_1 + 0x13a) =
           CONCAT13(uStack_38,CONCAT12(uStack_3c._3_1_,CONCAT11(uStack_3c._2_1_,uStack_3c._1_1_)));
      ...
      *(undefined4 *)((int)param_1 + 0x14a) = uStack_2b;
      break;
    case 2:
      *(undefined1 *)((int)param_1 + 0x187) = (undefined1)uStack_3c;
      ...
      *(uint *)((int)param_1 + 400) =
      ...
      break;
    case 3:
      *(undefined1 *)((int)param_1 + 0x152) = (undefined1)uStack_3c;
    ...
    case 5:
      ...
      break;
    case 6:
      *(undefined1 *)((int)param_1 + 0xff) = (undefined1)uStack_3c;
      break;
    case 7:
      *(undefined1 *)((int)param_1 + 0x163) = (undefined1)uStack_3c;
    ...
    case 8:
      uStack_c = 0;
      uStack_4c = *(uint *)(*(int *)((int)param_1 + 0x22f) + 0xc);
      if (0 < (int)uStack_4c) {
        iVar7 = (int)CONCAT11(uStack_3c._1_1_,(undefined1)uStack_3c);
        do {
          if (uStack_c < uStack_4c) {
            psVar8 = (short *)(*(int *)(*(int *)((int)param_1 + 0x22f) + 8) * uStack_c +
          ...
          iVar15 = (int)psVar8[1];
          iStack_50 = iVar7 + -1 + (int)CONCAT11(uStack_35,uStack_36);
          iVar11 = (int)*psVar8;
          pvStack_48 = (void *)(CONCAT11(uStack_3c._3_1_,uStack_3c._2_1_) + -1 +
                               (int)CONCAT11(uStack_33,uStack_34));
          iVar7 = (int)CONCAT11(uStack_3c._1_1_,(undefined1)uStack_3c);
          puStack_10 = (uint *)(int)psVar8[3];
          iStack_58 = (int)psVar8[4];
          iStack_54 = iVar15 + -1 + iStack_58;
          if (((iVar11 <= iVar7) && (iVar7 <= iVar11 + -1 + (int)puStack_10)) &&
             (((iVar15 <= CONCAT11(uStack_3c._3_1_,uStack_3c._2_1_) &&
               (((CONCAT11(uStack_3c._3_1_,uStack_3c._2_1_) <= iStack_54 && (iVar11 <= iStack_50))
                && (iStack_50 <= iVar11 + -1 + (int)puStack_10)))) &&
              ((iVar15 <= (int)pvStack_48 && ((int)pvStack_48 <= iVar15 + -1 + iStack_58))))))
          goto LAB_00665047;
          iStack_50 = iVar11 + -1 + (int)puStack_10;
          iVar16 = (int)CONCAT11(uStack_3c._3_1_,uStack_3c._2_1_);
          iStack_54 = iVar15 + -1 + iStack_58;
          pvStack_48 = (void *)(iVar16 + -1 + (int)CONCAT11(uStack_33,uStack_34));
          if ((iVar7 <= iVar11) &&
    ...
    case 9:
      ...
      break;
    case 10:
      *(undefined1 *)((int)param_1 + 0x176) = (undefined1)uStack_3c;
      *(ushort *)((int)param_1 + 0x177) = CONCAT11(uStack_3c._2_1_,uStack_3c._1_1_);
      *(ushort *)((int)param_1 + 0x179) = CONCAT11(uStack_38,uStack_3c._3_1_);
      ...
      *(uint *)((int)param_1 + 0x183) =
      ...
      break;
    case 0xb:
      *(undefined1 *)((int)param_1 + 0x100) = (undefined1)uStack_3c;
      *(ushort *)((int)param_1 + 0x101) = CONCAT11(uStack_3c._2_1_,uStack_3c._1_1_);
      *(ushort *)((int)param_1 + 0x103) = CONCAT11(uStack_38,uStack_3c._3_1_);
      *(ushort *)((int)param_1 + 0x105) = CONCAT11(uStack_36,uStack_37);
      *(undefined4 *)((int)param_1 + 0x111) = uStack_2b;
      ...
      *(ushort *)((int)param_1 + 0x10f) = CONCAT11(uStack_2c,uStack_2d);
      break;
    case 0xc:
      *(undefined1 *)((int)param_1 + 0x115) = (undefined1)uStack_3c;
      ...
      *(uint *)((int)param_1 + 0x11a) =
      ...
      break;
    case 0xd:
      *(undefined1 *)((int)param_1 + 0x122) = (undefined1)uStack_3c;
      ...
      *(uint *)((int)param_1 + 0x123) =
      ...
      break;
    case 0xe:
      thunk_FUN_00675950(CONCAT13(uStack_3c._3_1_,
                                  CONCAT12(uStack_3c._2_1_,
                                           CONCAT11(uStack_3c._1_1_,(undefined1)uStack_3c))),
                         CONCAT13(uStack_37,
                                  CONCAT12(uStack_38,CONCAT11(uStack_3c._3_1_,uStack_3c._2_1_))),
                         CONCAT11(uStack_37,uStack_38),(short *)&uStack_3c,
                         (short *)((int)&uStack_3c + 2),(short *)&uStack_38,0);
      ...
      if (0 < (int)uStack_4c) {
        ...
        do {
          ...
          if ((((CONCAT11(uStack_3c._1_1_,(undefined1)uStack_3c) == *psVar8) &&
               (CONCAT11(uStack_3c._3_1_,uStack_3c._2_1_) == psVar8[1])) &&
    ...
    case 0xf:
      ...
      break;
    case 0x10:
      *(undefined1 *)((int)param_1 + 0x194) = (undefined1)uStack_3c;
      break;
    default:
      iVar7 = thunk_FUN_00664650(param_1,auStack_44[0]);
...
LAB_00665024:
      if ((auStack_44[0] < 0x32) || (99 < auStack_44[0])) {
        if ((auStack_44[0] == 0) || (0x31 < auStack_44[0])) {
switchD_006649d9_caseD_0:
          thunk_FUN_00664650(param_1,auStack_44[0]);
              ...
              if (*(int *)((int)param_1 + 0xa3) == 0) {
                *(undefined4 *)((int)param_1 + 0xa3) = 1;
                ...
                if (pvStack_8 != (void *)0x0) {
                  thunk_FUN_0067bf60(pvStack_8,-1,*(uint *)((int)param_1 + 0xf7));
                }
              }
              else {
                if (*(int *)((int)param_1 + 0xa7) != 0) {
                  if (pvStack_8 != (void *)0x0) {
                    thunk_FUN_0067bf60(pvStack_8,'\x01',*(uint *)((int)param_1 + 0xf7));
      ...
      *(undefined4 *)((int)param_1 + 0xeb) = 0x40;
      if (*(int *)((int)param_1 + 0xa3) == 0) {
        ...
        *(int *)((int)param_1 + 0xb3) = iVar7;
        ...
        puStack_10 = thunk_FUN_0065e360((int)param_1,uVar10,iVar7);
        if (puStack_10 != (uint *)0x0) {
          ...
          if (0 < (int)uVar9) {
            do {
              if (uStack_c < uVar9) {
                puVar14 = (undefined2 *)(puStack_10[2] * uStack_c + puStack_10[7]);
              }
              else {
              ...
              case 0xbe:
                ...
                if (uVar9 != 0) {
                  ...
                  *(undefined4 *)((int)pvVar12 + 0x2ad) = 0;
                  ...
                  if (*(int *)((int)param_1 + 0xb3) <= (int)pvStack_8) goto LAB_0066703e;
                }
                break;
              case 0xb2:
                if (*(int *)((int)pvVar12 + 0x24) != *(int *)((int)pvVar12 + 0x23d)) {
                  uVar9 = thunk_FUN_004406c0((char)*(int *)((int)pvVar12 + 0x23d));
                  uStack_4c = ((uVar9 & 0xff) + *(int *)((int)pvVar12 + 0x235) * 3) * 3;
                  uVar9 = thunk_FUN_004406c0(*(char *)((int)pvVar12 + 0x24));
                  if ((&DAT_007e1984)[(uVar9 & 0xff) + uStack_4c] == '\0') break;
                }
                if ((*(int *)((int)pvStack_48 + 0x245) == 0) &&
                   (99 < *(int *)((int)pvStack_48 + 0x4ec))) {
                  thunk_FUN_004d8e70(pvStack_48,(int)*(short *)((int)param_1 + 199),
    ...
    *(undefined4 *)((int)param_1 + 0xa3) = 1;
    ...
    if ((*(uint *)((int)param_1 + 0x12d) < *(uint *)(iVar7 + 0xc)) &&
      ...
      *(undefined4 *)((int)param_1 + 0x135) = *(undefined4 *)(psVar8 + 3);
      ...
      uStack_5c = 1;
      uStack_5a = 1;
      iVar7 = thunk_FUN_00660180(param_1,&sStack_64,'\x02');
      if (iVar7 == 0) goto switchD_00665095_caseD_1;
    }
    *(undefined4 *)((int)param_1 + 0x9b) = 0x3c;
    break;
