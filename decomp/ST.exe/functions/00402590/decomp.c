...

{
  ...
  if (iVar5 != 0) {
    ...
    iVar12 = ReportDebugMessage(s_E____titans_Andrey_cpanel4_cpp_007c2700,0x6f0,0,iVar5,
  ...
  switch(pCStack_1c[0xbfa]) {
  case (CPanelTy)0x0:
  case (CPanelTy)0x3:
    thunk_FUN_00540760(*(undefined4 **)(pCStack_1c + 0x194),0,0x46,'\x01',
                       *(byte **)(pCStack_1c + 0x9d9));
    thunk_FUN_00540760(*(undefined4 **)(this_00 + 0x194),0,0,'\x06',*(byte **)(this_00 + 0x9fd));
    break;
  case (CPanelTy)0x1:
    if (pCStack_1c[0xbfb] == (CPanelTy)0x2) {
      thunk_FUN_00540760(*(undefined4 **)(pCStack_1c + 0x194),0,0,'\x06',
                         *(byte **)(pCStack_1c + 0xa05));
...
LAB_0050a4e4:
  ...
  if (this_00[0xbfb] == (CPanelTy)0x2) {
    if (*(int *)(this_00 + 0xc12) != 0) {
      ...
      if (pCStack_14 < (CPanelTy *)0x21) {
        iVar5 = (int)pCStack_14 * 4 + 0x35;
        do {
...
LAB_0050af64:
  ...
  case 0x53:
    ...
    case (CPanelTy)0x1:
      ...
      if (pCStack_8 < (CPanelTy *)0x21) {
        iVar5 = (int)pCStack_8 * 4 + 0x35;
        do {
          pbVar7 = (byte *)FUN_0070b3a0(*(int *)(this_00 + 0x2b6),0);
          thunk_FUN_00540760(*(undefined4 **)(this_00 + 0x194),iVar5,0x7d,'\x01',pbVar7);
          iVar5 = iVar5 + 4;
...
LAB_0050b386:
  ...
  case 0x6d:
    ...
    iStack_20 = -0xc24 - (int)this_00;
    iVar5 = 99;
    pCStack_14 = (CPanelTy *)0x2c;
    do {
      pCVar16 = pCStack_14;
      thunk_FUN_00540760(*(undefined4 **)(this_00 + 0x194),(int)(pCStack_14 + -2),0x55,'\x01',
                         *(byte **)(this_00 + 0xa11));
      uVar6 = thunk_FUN_00526ba0(*(undefined4 *)pCStack_10,(char)pCStack_8[-10]);
      pbVar7 = (byte *)FUN_0070b3a0(*(int *)(this_00 + 0x2c2),uVar6);
      ...
      pCStack_14 = pCStack_14 + 0x65;
      pCStack_8 = pCStack_8 + 1;
      iVar5 = iVar5 + 0x1a;
    } while (pCStack_8 + iStack_20 < (CPanelTy *)0x2);
