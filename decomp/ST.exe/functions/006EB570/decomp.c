...
undefined4 FUN_006eb570(int *param_1,int *param_2)

{
  ...
  iVar8 = param_2[1];
  local_8 = 0;
  if ((param_2[6] == 0) || (*(int *)((int)param_2 + 0x466) == 0)) {
    if (param_1 == (int *)0x0) {
      ExceptionList = &local_14;
      FUN_006cea60(*(undefined8 **)((int)param_2 + 0x4ea),*(int *)((int)param_2 + 0x4ee),
    ...
    ExceptionList = &local_14;
    local_1c = &stack0xffffff44;
    iVar1 = FUN_006b0460(&local_70,&local_34,(int *)((int)param_2 + 0x48e));
    if (iVar1 != 0) {
      iVar6 = (local_70 - *(int *)((int)param_2 + 0x476)) - *(int *)((int)param_2 + 0x48e);
      iVar1 = *(int *)((int)param_2 + 0x4e2);
      local_84 = iVar6 - iVar1 * (iVar6 / iVar1);
      iVar7 = (local_6c - *(int *)((int)param_2 + 0x492)) - *(int *)((int)param_2 + 0x47a);
      local_9c = *(int *)((int)param_2 + 0x4e6);
      local_5c = iVar7 - local_9c * (iVar7 / local_9c);
      local_4c = iVar6 / iVar1 + *(int *)((int)param_2 + 0x47e);
      local_58 = (int)((local_68 - 1) + iVar6) / iVar1 + *(int *)((int)param_2 + 0x47e);
      local_7c = iVar7 / local_9c + *(int *)((int)param_2 + 0x482);
      local_90 = (local_64 + -1 + iVar7) / local_9c + *(int *)((int)param_2 + 0x482);
      local_94 = *(int *)((int)param_2 + 0x4b2) * local_7c + param_2[6];
      if ((*(char *)(local_94 + local_4c) != -1) || (*(char *)(local_94 + local_58) != -1)) {
LAB_006eb7d3:
        pcVar3 = (char *)(*(int *)((int)param_2 + 0x4b2) * local_90 + param_2[6]);
        if ((pcVar3[local_4c] == -1) && (pcVar3[local_58] == -1)) {
          local_3c = local_64 + local_6c;
          iVar1 = ((local_3c -
                   (local_90 - *(int *)((int)param_2 + 0x482)) * *(int *)((int)param_2 + 0x4e6)) -
                  *(int *)((int)param_2 + 0x492)) - *(int *)((int)param_2 + 0x47a);
          local_38 = pcVar3;
          for (local_48 = local_90; iVar6 = local_4c, local_7c < local_48; local_48 = local_48 + -1)
          {
            ...
            iVar1 = *(int *)((int)param_2 + 0x4e6);
            local_38 = local_38 + -*(int *)((int)param_2 + 0x4b2);
          }
LAB_006eb87f:
        ...
        if ((*(char *)(local_94 + local_4c) == -1) && (pcVar3[local_4c] == -1)) {
          local_8c = *(int *)((int)param_2 + 0x4e2) - local_84;
          local_24 = local_70;
          for (local_44 = local_4c; local_44 <= local_58; local_44 = local_44 + 1) {
            ...
            local_8c = *(int *)((int)param_2 + 0x4e2);
          }
        ...
        if ((*(char *)(local_94 + local_58) == -1) && (pcVar3[local_58] == -1)) {
          ...
          iVar1 = ((local_24 -
                   (local_58 - *(int *)((int)param_2 + 0x47e)) * *(int *)((int)param_2 + 0x4e2)) -
                  *(int *)((int)param_2 + 0x48e)) - *(int *)((int)param_2 + 0x476);
        ...
        if (local_30 < local_6c) {
          FUN_006cea60((undefined8 *)
                       (*(int *)((int)param_2 + 0x4ee) * local_30 + *(int *)((int)param_2 + 0x4ea) +
                       local_34),*(int *)((int)param_2 + 0x4ee),
                       (undefined8 *)
        ...
        if (0 < iVar1) {
          FUN_006cea60((undefined8 *)
                       ((local_64 + local_6c) * *(int *)((int)param_2 + 0x4ee) +
                        *(int *)((int)param_2 + 0x4ea) + local_34),*(int *)((int)param_2 + 0x4ee),
                       (undefined8 *)
        ...
        if (local_34 < local_70) {
          FUN_006cea60((undefined8 *)
                       (*(int *)((int)param_2 + 0x4ee) * local_6c + *(int *)((int)param_2 + 0x4ea) +
                       local_34),*(int *)((int)param_2 + 0x4ee),
                       (undefined8 *)
        ...
        for (local_80 = local_7c; local_80 <= local_90; local_80 = local_80 + 1) {
          ...
          while( true ) {
            ...
            if (((uVar2 == 0xff) || (uVar2 == 0x20)) || (uVar2 == 0)) {
              ...
              if (uVar2 == 0xff) {
                FUN_006cea60(puVar5,*(int *)((int)param_2 + 0x4ee),(undefined8 *)local_54,
                             *(int *)(iVar8 + 0x478),local_8c,local_9c);
              }
              else {
                if (uVar2 == 0x20) {
                  iVar1 = param_2[0x55] + 0x1000;
                }
                else {
                  iVar1 = param_2[0x55] + 0x1800;
                }
                FUN_00750590((undefined1 *)puVar5,*(int *)((int)param_2 + 0x4ee),local_54,
              ...
              local_60 = (undefined1 *)
                         (*(int *)(*(int *)((int)param_2 + 0x472) + uVar2 * 4) +
                          *(int *)((int)param_2 + 0x4e2) * local_5c + local_50);
              FUN_00750660((undefined1 *)puVar5,*(int *)((int)param_2 + 0x4ee),local_54,
                           *(int *)(iVar8 + 0x478),local_60,*(int *)((int)param_2 + 0x4e2),local_8c,
                           local_9c,param_2[0x55]);
            }
            local_74 = local_74 + 1;
          ...
          local_9c = *(int *)((int)param_2 + 0x4e6);
          local_94 = local_94 + *(int *)((int)param_2 + 0x4b2);
          local_5c = 0;
        }
        ExceptionList = local_14;
        return 0;
...
LAB_006eb763:
  ...
  iVar4 = *(int *)((int)param_2 + 0x4ee);
  iVar8 = iVar4;
LAB_006ebde1:
  FUN_006cea60((undefined8 *)(iVar7 * iVar4 + *(int *)((int)param_2 + 0x4ea) + iVar6),iVar8,puVar5,
               iVar1,uVar2,iVar9);
  ExceptionList = local_14;
  return 0;
}
