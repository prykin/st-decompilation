...
void __fastcall thunk_FUN_0067b520(void *param_1)

{
  ...
  if (((*(int *)((int)param_1 + 0x695) != 0) && (DAT_007fa174 != 0)) &&
    ...
    *(undefined4 *)((int)param_1 + 0x672) = *(undefined4 *)((int)param_1 + 0x6fe);
    ...
    if (iVar4 == 0) {
      uStack_10 = 0;
      iVar4 = *(int *)((int)pvStack_18 + 0x6a1);
      if (0 < *(int *)(iVar4 + 0xc)) {
...
LAB_0067b724:
                      ...
                      if (pvStack_8 != (void *)0x0) {
                        ...
                        auStack_4c[1] = *(undefined4 *)((int)this + 0x6fe);
                        auStack_4c[0] = 0x73;
                        uStack_43 = 1;
                        iStack_42 = iVar8;
                        if (&stack0x00000000 != (undefined1 *)0x4c) {
                          thunk_FUN_0068fd00(auStack_4c);
                          uVar7 = uStack_c;
                        }
                        if ('\0' < cStack_44) {
          ...
          case 1:
            if (DAT_007fa174 == 0) {
              ...
              pvStack_8 = (void *)thunk_FUN_0042b620(CONCAT31((int3)(uVar7 >> 8),
            ...
            if (pvStack_8 == (void *)0x0) {
              ...
              *(undefined2 *)(iVar8 + 8) = 0;
              ...
              iVar4 = thunk_FUN_004e60d0(*(int *)((int)this + 0x5d7),(int)*(short *)(iVar8 + 1));
              if (iVar4 < sVar1) {
                iVar4 = thunk_FUN_004e3800(pvStack_8,(int)*(short *)(iVar8 + 1),
                                           (int)*(short *)(iVar8 + 3));
      ...
      if (((DAT_007fa174 != 0) && (*(char *)((int)this + 0x662) == '\x01')) &&
        ...
        thunk_FUN_004e7230(*(int *)((int)this + 0x5d7),(int)*(short *)((int)this + 0x660),aiStack_c8
                           ,aiStack_ac);
        iVar4 = 0;
        do {
          ...
          thunk_FUN_0067b3c0(this,*(int *)((int)aiStack_c8 + iVar4),
                             *(int *)((int)aiStack_ac + iVar4),(int)*(short *)((int)this + 0x663),
