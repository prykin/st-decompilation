...

{
  ...
  *param_1 = 0;
  ...
  iVar1 = __setjmp3(local_60.jumpBuffer,0,unaff_EDI,unaff_ESI);
  piVar3 = local_14;
  if (iVar1 != 0) {
  ...
  if (iVar1 != 0) {
    RaiseInternalException(iVar1,DAT_007ed77c,s_E__DKW_DDX_C_dplay2_cpp_007edbc4,0x2bf);
  }
  local_c = 0;
  ...
  if (iVar1 != -0x7788ffe2) {
    ...
    RaiseInternalException(iVar1,DAT_007ed77c,s_E__DKW_DDX_C_dplay2_cpp_007edbc4,0x2c5);
  }
  local_1c = 0;
  ...
  *piVar2 = local_c;
  ...
  if (iVar1 != 0) {
    RaiseInternalException(iVar1,DAT_007ed77c,s_E__DKW_DDX_C_dplay2_cpp_007edbc4,0x2ce);
  }
  piVar3 = piVar2 + 4;
  *(int *)(piVar2[2] + 0x28) = param_2;
  ...
  if (iVar1 != 0) {
    RaiseInternalException(iVar1,DAT_007ed77c,s_E__DKW_DDX_C_dplay2_cpp_007edbc4,0x2de);
  }
  iVar1 = (**(code **)(*local_8 + 0xc))(local_8,0,&local_10,0);
  if (iVar1 != 0) {
    RaiseInternalException(iVar1,DAT_007ed77c,s_E__DKW_DDX_C_dplay2_cpp_007edbc4,0x2e1);
  }
  piVar3 = FUN_006aac10(0x54);
  local_14 = piVar3;
  iVar1 = (**(code **)*local_10)(local_10,&DAT_0079ecc8,piVar3);
  if (iVar1 != 0) {
    RaiseInternalException(iVar1,DAT_007ed77c,s_E__DKW_DDX_C_dplay2_cpp_007edbc4,0x2e5);
  }
  piVar3[10] = iVar5;
  iVar1 = piVar2[2];
  ...
  if ((*(byte *)(piVar2 + 1) & 2) == 0) {
    ...
    if (iVar1 != 0) {
      iVar5 = 0x2f0;
LAB_006b6fe0:
      RaiseInternalException(iVar1,DAT_007ed77c,s_E__DKW_DDX_C_dplay2_cpp_007edbc4,iVar5);
    }
  }
  g_currentExceptionFrame = local_60.previous;
  iVar1 = local_1c;
LAB_006b700a:
  ...
  if (iVar1 != -0x7788fbd2) {
    RaiseInternalException(iVar1,DAT_007ed77c,s_E__DKW_DDX_C_dplay2_cpp_007edbc4,0x309);
  }
  return iVar1;
}
