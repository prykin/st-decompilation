...
void __thiscall
FUN_0055bbc0(void *this,undefined1 param_1,short param_2,undefined2 param_3,undefined1 param_4,
...

{
  ...
  if ((((*(int *)((int)this + 0x114) != 0) && (*(int *)((int)this + 0x110) != 0)) && (param_5 < 8))
    ...
    if (-1 < (int)uVar1) {
      FUN_006b0c70(*(AnonShape_006B0C70_7C4FE646 **)((int)this + 0x110),uVar1);
    }
  }
  return;
}
