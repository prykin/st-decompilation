...

{
  ...
  if (param_2 == '\0') {
    ...
    *(undefined2 *)&local_14->field_0x1af = 0x23;
    *(undefined2 *)&local_14->field_0x1b1 = 10;
  ...
  if (*(uint *)&this_00->field_0x19c != 0) {
    FUN_006e56b0(*(void **)&this_00->field_0xc,*(uint *)&this_00->field_0x19c);
  }
  ...
  ccFntTy::SetSurf(*(ccFntTy **)&this_00->field_0x1e4,*(int *)&this_00->field_0x68,0,0x21,0x16,0x19c
                   ,0x14);
  if (DAT_0080874e == 3) {
    iVar5 = 5;
  }
  ...
  ccFntTy::WrStr(*(ccFntTy **)&this_00->field_0x1e4,puVar6,iVar13,iVar14,iVar5);
  ccFntTy::SetSurf(*(ccFntTy **)&this_00->field_0x1e0,*(int *)&this_00->field_0x68,0,0x21,0x2a,0x19c
                   ,0xf);
  uVar7 = (DAT_0080874e != 3) - 1 & 5;
  iVar13 = -1;
  iVar5 = -1;
  puVar6 = (uint *)FUN_006b0140(UVar12,DAT_00807618);
  ccFntTy::WrStr(*(ccFntTy **)&this_00->field_0x1e0,puVar6,iVar5,iVar13,uVar7);
  ...
  pbVar9 = (byte *)FUN_0070b3a0(*(int *)&this_00->field_0x224,(uint)local_8 & 0xff);
  local_8 = pbVar9;
  thunk_FUN_00540760((undefined4 *)this_00->field_0218,0,0,'\x06',pbVar9);
...
LAB_00516776:
        ...
        iVar5 = *(int *)&this_00->field_0x228;
      }
      uVar7 = thunk_FUN_005276e0(pbVar9[-4],*pbVar9);
      pbVar10 = (byte *)FUN_0070b3a0(iVar5,uVar7);
      thunk_FUN_00540760((undefined4 *)this_00->field_0218,*(int *)(pbVar9 + 1),*(int *)(pbVar9 + 5)
                         ,'\x01',pbVar10);
      bVar3 = thunk_FUN_004e5910((uint)DAT_0080874d,*(uint *)(pbVar9 + -4));
      if (CONCAT31(extraout_var_01,bVar3) != 0) {
        ...
        if (iVar5 != 0) {
          ...
          thunk_FUN_00540760((undefined4 *)this_00->field_0218,*(int *)(pbVar9 + 1),
  ...
  iVar5 = *(int *)(pbVar9 + 8) + -0x118 + (uint)*(ushort *)&this_00->field_0x1af;
  if (iVar5 < 1) {
    iVar5 = 0;
  }
  else {
    iVar5 = (uint)(iVar5 % (int)(uint)*(ushort *)&this_00->field_0x1b1 != 0) +
            iVar5 / (int)(uint)*(ushort *)&this_00->field_0x1b1;
  }
