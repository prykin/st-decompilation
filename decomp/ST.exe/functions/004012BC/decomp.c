...
void __fastcall thunk_FUN_00623600(int *param_1)
  ...
  if (DAT_00802a88 == (void *)0x0) {
    ...
    if (((((DAT_0080874d == -1) || (*(int *)((int)DAT_00802a88 + 0xf8) == 0)) ||
         (thunk_FUN_00558c00(DAT_00802a88,*(undefined4 *)((int)DAT_00802a88 + 0x10c),
                             ...
                             (int)*(short *)((int)param_1 + 0x49),&iStack_8,&iStack_c), iVar6 < 0))
        || ((((4 < iVar6 || (iStack_8 < 0)) ||
             ((*(int *)((int)pvVar5 + 0x30) <= iStack_8 ||
              ((iStack_c = (&DAT_0079aed0)[iVar6] + iStack_c, iStack_c < 0 ||
               (*(int *)((int)pvVar5 + 0x34) <= iStack_c)))))) ||
            (*(int *)((int)pvVar5 + 0x4c) == 0)))) ||
       (*(char *)(iStack_c * *(int *)((int)pvVar5 + 0x30) + *(int *)((int)pvVar5 + 0x4c) + iStack_8)
        != '\0')) {
      bVar4 = false;
