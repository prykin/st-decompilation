    ...
    if (iVar6 == 0) {
      if (DAT_00808783 == '\x03') {
        ...
        if ((iVar6 == 0) && (uVar10 = 0, g_playSystem_00802A38 != nullptr)) {
          ...
          pcVar8 = LoadResourceString(0x42c3,g_hINSTANCE_00807618);
        ...
        if (iVar6 == 0) {
          ...
          uVar10 = 0;
          pcVar7 = LoadResourceString(0x2747 - (byte)DAT_0080735e,g_hINSTANCE_00807618);
          pcVar8 = LoadResourceString(0x42c5,g_hINSTANCE_00807618);
          wsprintfA((LPSTR)&DAT_0080f33a,"%s %s",pcVar8,pcVar7);
          if (g_popUp_008016D8 != nullptr) {
            if (DAT_0080874d == 0xff) {
              uVar11 = 8;
        ...
        if (iVar6 == 0) {
          ...
          pcVar7 = LoadResourceString(0x2747 - (DAT_0080733c != 0),g_hINSTANCE_00807618);
          pcVar8 = LoadResourceString(0x42c4,g_hINSTANCE_00807618);
          wsprintfA((LPSTR)&DAT_0080f33a,"%s %s",pcVar8,pcVar7);
          if (g_popUp_008016D8 != nullptr) {
            if (DAT_0080874d == 0xff) {
              uVar11 = 8;
