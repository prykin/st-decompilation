  ...
  if (param_1 == 0) {
    ...
    if (*(int *)((int)this + 0x2dc) == 0) {
      ...
      if (((*(uint *)(*(int *)((int)this + 4) + 0xc) & 0x1100) != 0x100) &&
        ...
        if (*(int **)this != (int *)0x0) {
          FUN_006b5f80(*(int **)this,iVar3,iVar5,iVar7,iVar1);
        }
      }
...
LAB_007258d0:
  FUN_006a5e40(iVar6,DAT_007ed77c,0x7f0c68,0x38);
  ExceptionList = local_14;
  return iVar6;
}
