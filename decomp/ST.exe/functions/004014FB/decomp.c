        ...
        if ((*(int *)(this + 0x74a) <= (int)*(short *)(DAT_00806724 + 0x23) / 2) &&
          ...
          do {
            ...
            if (DAT_0080732c == 1) {
              ...
              iVar10 = (int)sStack_1c + *(short *)(this + 0x45) + iStack_8 + (int)(short)lVar13;
              iVar6 = (int)*(short *)(this + 0x43) - (int)uStack_20._2_2_;
              iVar11 = (int)(short)uStack_20 + iVar9 + *(short *)(this + 0x41);
            }
            else {
              iVar10 = (int)sStack_1c + iStack_8 + *(short *)(this + 0x45);
