...
undefined4 __thiscall thunk_FUN_0061c5f0(void *this,undefined4 *param_1)
  ...
  if ((*(char *)((int)this + 0x14b) != '\0') && (*(short *)((int)this + 0x149) != -1)) {
    ...
    if (this_00 != (int *)0x0) {
      *(int **)((int)this + 0x139) = this_00;
      thunk_FUN_004162b0(this_00,&sStack_a,&sStack_e,&uStack_10);
      ...
      if (iVar3 < 0) {
        sStack_18 = (((short)(iVar3 / 200) + sVar1) - (short)((longlong)iVar3 * 0x51eb851f >> 0x3f))
                    + -1;
      }
      else {
        sStack_18 = ((short)(iVar3 / 200) + sVar1) - (short)((longlong)iVar3 * 0x51eb851f >> 0x3f);
      ...
      if ((((sStack_a - iVar3 <= iVar4) && (iVar4 < sStack_a + iVar3)) &&
          (sStack_e - iVar3 <= iVar5)) && (iVar5 < sStack_e + iVar3)) {
        thunk_FUN_00416270(this_00,&sStack_8,&sStack_6,&sStack_c);
        FUN_006aced8(*(int *)((int)this + 0x9f),*(int *)((int)this + 0xa3),(int)sStack_8,
                     (int)sStack_6);
        *(int *)((int)this + 0x127) = (int)sStack_8;
        *(int *)((int)this + 0x12f) = (int)sStack_c;
        *(int *)((int)this + 299) = (int)sStack_6;
        if ((iVar4 != *(short *)((int)this + 0x133)) || (iVar5 != *(short *)((int)this + 0x135))) {
          *param_1 = 1;
        }
        *(short *)((int)this + 0x133) = (short)iVar4;
        *(short *)((int)this + 0x135) = (short)iVar5;
        *(short *)((int)this + 0x137) = sStack_18;
        ...
        *(undefined4 *)((int)this + 0x123) = uVar2;
        uVar2 = FUN_006acf0d(*(int *)((int)this + 0x9f),*(int *)((int)this + 0xa3),
                             *(int *)((int)this + 0xa7),(int)sStack_8,(int)sStack_6,(int)sStack_c);
        *(undefined4 *)((int)this + 0x13d) = uVar2;
        uVar2 = FUN_006aced8(*(int *)((int)this + 0x9f),*(int *)((int)this + 0xa3),(int)sStack_8,
                             (int)sStack_6);
