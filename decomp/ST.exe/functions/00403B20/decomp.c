...
void __thiscall thunk_FUN_004a8220(void *this,char param_1,short param_2,undefined2 param_3)

{
  ...
  {
    while( true ) {
      FUN_006acc70(*(int *)((int)this + 0x20e),uVar2,&uStack_8);
      if ((uStack_8._2_2_ == param_2) && ((char)uStack_8 == param_1)) break;
      uVar2 = uVar2 + 1;
      if (iVar1 <= (int)uVar2) {
        return;
      }
