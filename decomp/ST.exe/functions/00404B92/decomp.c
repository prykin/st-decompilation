...
void __thiscall thunk_FUN_005a1630(void *this,int param_1)

{
  ...
  if (((*(char *)((int)this + 0x1a5f) == '\x01') && (*(int *)((int)this + 0x1ac0) != 0)) &&
    ...
    puStack_8 = this;
    iVar5 = __setjmp3(auStack_68,0,unaff_EDI,unaff_ESI);
    pvVar2 = DAT_00802a30;
    if (iVar5 == 0) {
      ...
      if (param_1 != 0) {
        DAT_0080fb76 = 1;
        *(undefined4 *)((int)puStack_8 + 0x4d) = 0x7102;
        *(undefined4 *)((int)puStack_8 + 0x49) = 1;
        FUN_006e6020(puStack_8,(undefined4 *)((int)puStack_8 + 0x3d));
        DAT_00858df8 = (undefined4 *)uStack_6c;
        return;
      }
      iVar5 = puStack_8[0x6b0];
      ...
      auStack_28[2] = puVar4[2];
      auStack_28[3] = 2;
      auStack_28[4] = 0x6956;
      pvVar2 = *(void **)(iVar5 + 0x2e6);
      if (pvVar2 != (void *)0x0) {
        thunk_FUN_005b7ef0(pvVar2,0x25bc,'\0',auStack_28,(undefined4 *)0x0,(undefined4 *)0x0,0,0);
        DAT_00858df8 = (undefined4 *)uStack_6c;
        return;
      }
      (**(code **)*puVar4)(auStack_28);
      DAT_00858df8 = (undefined4 *)uStack_6c;
      return;
    }
    DAT_00858df8 = (undefined4 *)uStack_6c;
