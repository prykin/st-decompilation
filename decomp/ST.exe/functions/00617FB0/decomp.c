...

{
  ...
  *(undefined2 *)puVar9 = *(undefined2 *)puVar7;
  ...
  if (*(uint **)((int)this + 0x62) != (uint *)0x0) {
    local_c = (uint *)FUN_006b0020(*(uint **)((int)this + 0x62),(int *)&local_8);
    *puVar6 = local_8;
    puVar8 = local_c;
    puVar10 = puVar6 + 1;
    for (uVar4 = local_8 >> 2; uVar4 != 0; uVar4 = uVar4 - 1) {
    ...
    puVar6 = (uint *)((int)(puVar6 + 1) + local_8);
    FUN_006ab060(&local_c);
  }
  if (*(uint **)((int)this + 0x66) != (uint *)0x0) {
    local_c = (uint *)FUN_006b0020(*(uint **)((int)this + 0x66),(int *)&local_8);
    *puVar6 = local_8;
    puVar8 = local_c;
    for (uVar4 = local_8 >> 2; puVar6 = puVar6 + 1, uVar4 != 0; uVar4 = uVar4 - 1) {
      *puVar6 = *puVar8;
      puVar8 = puVar8 + 1;
    }
