...
short * __cdecl thunk_FUN_0042a290(int param_1,char *param_2)
  ...
  if (iVar3 == 0) {
    ...
    *(undefined1 *)((int)psVar4 + 0x40b) = 0xff;
    ...
    if (puVar8 == (undefined4 *)0x0) {
      ...
      piStack_10 = (int *)FUN_006dbca0((int)puVar8);
    }
    this = piStack_10;
    ...
    puStack_c = Library::DKW::TBL::FUN_006ae290((uint *)0x0,100,8,100);
    iStack_18 = 0;
    if (0 < *(int *)((int)psVar4 + 0x455)) {
      piStack_14 = (int *)((int)psVar4 + 0x459);
      do {
        piVar1 = (int *)*piStack_14;
        if (piVar1 != (int *)0x0) {
          uStack_8 = puStack_c[3];
          puStack_c[1] = 0;
          do {
            uVar12 = puStack_c[1];
            if (uVar12 < uStack_8) {
              piVar9 = (int *)(puStack_c[2] * uVar12 + puStack_c[7]);
              puStack_c[1] = uVar12 + 1;
            }
            else {
              piVar9 = (int *)0x0;
            }
          ...
          if (piVar9 == (int *)0x0) {
            uStack_8 = (uint)(short)piVar1[1];
            iStack_28 = (int)*(short *)((int)piVar1 + 6);
            *(undefined2 *)(piVar1 + 1) = 0;
            *(undefined2 *)((int)piVar1 + 6) = 0;
            iStack_2c = (int)(short)piVar1[2];
            ...
            *piVar1 = this[0x50];
            ...
            this[0x50] = 0;
            this[0x4f] = 0;
            *(undefined2 *)((int)piVar1 + 6) = (undefined2)iStack_28;
            *(undefined2 *)(piVar1 + 1) = (undefined2)uStack_8;
            iStack_24 = piVar1[10];
            *(undefined2 *)(piVar1 + 2) = (undefined2)iStack_2c;
            puStack_20 = (undefined4 *)Library::DKW::LIB::FUN_006aac70(uVar13);
            ...
            piVar1[0x10] = (int)puStack_20;
            Library::DKW::TBL::FUN_006ae1c0(puStack_c,&iStack_24);
            this = piStack_10;
            iVar3 = iStack_30;
          }
          else {
        ...
        psVar4 = psStack_1c;
      } while (iStack_18 < *(int *)((int)psStack_1c + 0x455));
    }
    if (this != (int *)0x0) {
      FUN_006dbcf0(this);
