...

{
  ...
  *(undefined4 *)&param_1->field_0x654 = param_1->field_06FE;
  ...
  if (*(short *)&param_1->field_0x5ec != 3) {
    ...
    if ((iVar4 <= iVar5) && (0 < iVar5)) {
      ...
      for (iVar4 = 0xd; iVar4 != 0; iVar4 = iVar4 + -1) {
        *ppAVar9 = (AnonShape_0068FD00_A5257008 *)0x0;
        ppAVar9 = ppAVar9 + 1;
      }
    ...
    *(uint *)&param_1->field_0xa4 = uVar10;
    if (((uVar10 >> 0x10) % 0x5dd + 0x1d4c < (uint)param_1->field_06FE) &&
       (local_10 = thunk_FUN_004de4f0(g_sTAllPlayers_007FA174,param_1->field_05D7), 0 < local_10)) {
      uVar3 = thunk_FUN_0043e640((char)param_1->field_05D7,0x34,0,-1);
      ppAVar9 = &local_74;
      for (iVar4 = 0xd; iVar4 != 0; iVar4 = iVar4 + -1) {
        *ppAVar9 = (AnonShape_0068FD00_A5257008 *)0x0;
        ppAVar9 = ppAVar9 + 1;
    ...
    *(uint *)&param_1->field_0xa4 = uVar10;
    if (((uVar10 >> 0x10) % 0x5dd + 0x1d4c < (uint)param_1->field_06FE) &&
       (local_10 = thunk_FUN_004dfc70(g_sTAllPlayers_007FA174,(int *)param_1->field_05D7),
       0 < local_10)) {
  ...
  if (*(short *)&param_1->field_0x5ec != 3) {
    uVar10 = 0xffffffff;
    iVar4 = thunk_FUN_004e6fe0(param_1->field_05D7);
...
LAB_0067a8e6:
        ...
        uVar3 = thunk_FUN_0043e640((char)param_1->field_05D7,GVar6,0,-1);
        uVar10 = (uint)uVar3;
        if (uVar10 != 0) {
          iVar5 = local_8;
          if (100 < local_8) {
...
LAB_0067aabb:
        ...
        if (uVar10 != 0) {
          ...
          thunk_FUN_004eb300(param_1->field_05D7,0xdd,0xde,iVar4);
        }
      }
    }
    if (local_8 < local_14) {
...
LAB_0067abe0:
  ...
  local_c = thunk_FUN_004e4410(param_1->field_05D7);
...
LAB_0067adca:
  ...
  thunk_FUN_004eb300(param_1->field_05D7,0xe3,0xe2,iVar4);
  return;
}
