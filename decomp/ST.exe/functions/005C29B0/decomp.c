...

{
  ...
  if (iVar4 != 0) {
    ...
    cVar23 = local_18->field_1E26;
    if ((((cVar23 == '\r') || (cVar23 == '\x0e')) || (cVar23 == '\x0f')) ||
       (uVar8 = 0x6947, cVar23 == '\x10')) {
      uVar8 = 0x694d;
    }
  ...
  cVar23 = this_01->field_1E26;
  if (((cVar23 == '\x06') || (cVar23 == '\x01')) || (pAVar14 = PTR_0080c502, cVar23 == '\x02')) {
    pAVar14 = DAT_0080c506;
  }
  if ((uint)this_01->field_1C5F < (uint)pAVar14->field_000C) {
    if (((cVar23 == '\x06') || (cVar23 == '\x01')) || (pAVar14 = PTR_0080c502, cVar23 == '\x02')) {
      pAVar14 = DAT_0080c506;
    }
    if (((cVar23 == '\x06') || (cVar23 == '\x01')) || (pAVar6 = PTR_0080c502, cVar23 == '\x02')) {
      pAVar6 = DAT_0080c506;
    }
    iVar4 = pAVar6->field_0008 * this_01->field_1C5F + pAVar14->field_001C;
  }
  else {
    iVar4 = 0;
  }
  ...
  StartSystemTy::SetObjectives(PTR_0081176c,iVar25,pcVar18,iVar4);
  pDVar7 = (DArrayTy *)Library::DKW::TBL::FUN_006ae290((uint *)0x0,8,0x60,8);
  this_01->field_1F84 = pDVar7;
  ...
  *(undefined4 *)&this_01->field_0x21b1 = 0x4d;
  pDVar7 = (DArrayTy *)Library::DKW::TBL::FUN_006ae290((uint *)0x0,0xf,0x10c,5);
  this_01->field_1E2F = pDVar7;
  ...
  *(ushort **)&this_01->field_0x1f4b = puVar9;
  cVar23 = this_01->field_1E26;
  if (((cVar23 == '\x06') || (cVar23 == '\a')) || (cVar23 == '\x0e')) {
    this_01->field_0x21e3 = 1;
    iVar4 = 1;
    puVar5 = (undefined4 *)(this_01->field_005D + 0x28);
    uVar15 = FUN_006b4fe0(this_01->field_005D);
    iVar4 = FUN_006b50c0(0xf9,0x123,(uint)*(ushort *)(this_01->field_005D + 0xe),uVar15,puVar5,iVar4
                        );
    this_01->field_1C67 = iVar4;
    uVar15 = *(uint *)(iVar4 + 0x14);
    if (uVar15 == 0) {
      uVar15 = ((uint)*(ushort *)(iVar4 + 0xe) * *(int *)(iVar4 + 4) + 0x1f >> 3 & 0x1ffffffc) *
               *(int *)(iVar4 + 8);
    }
    ...
    iVar25 = -1;
    iVar4 = 0;
    puVar10 = (uint *)FUN_006b0140(0x2344,HINSTANCE_00807618);
    ccFntTy::WrStr(PTR_0081176c->field_0034,puVar10,iVar4,iVar25,uVar8);
    ccFntTy::SetSurf(PTR_0081176c->field_0034,this_01->field_1C67,0,0x10,0x2e,0xea,0x14);
    uVar8 = 2;
    iVar25 = -1;
    iVar4 = 0;
    puVar10 = (uint *)FUN_006b0140(0x2345,HINSTANCE_00807618);
    ccFntTy::WrStr(PTR_0081176c->field_0034,puVar10,iVar4,iVar25,uVar8);
    ccFntTy::SetSurf(PTR_0081176c->field_0034,this_01->field_1C67,0,0x10,0x56,0xea,0x14);
    uVar8 = 2;
    iVar25 = -1;
    iVar4 = 0;
    puVar10 = (uint *)FUN_006b0140(0x2350,HINSTANCE_00807618);
    ccFntTy::WrStr(PTR_0081176c->field_0034,puVar10,iVar4,iVar25,uVar8);
    ccFntTy::SetSurf(PTR_0081176c->field_0034,this_01->field_1C67,0,0x10,0x7e,0xea,0x14);
    uVar8 = 2;
    iVar25 = -1;
    iVar4 = 0;
    puVar10 = (uint *)FUN_006b0140(0x2352,HINSTANCE_00807618);
    ccFntTy::WrStr(PTR_0081176c->field_0034,puVar10,iVar4,iVar25,uVar8);
    ccFntTy::SetSurf(PTR_0081176c->field_0034,this_01->field_1C67,0,0x10,0xa6,0xea,0x14);
    uVar8 = 2;
    iVar25 = -1;
    iVar4 = 0;
    puVar10 = (uint *)FUN_006b0140(0x2351,HINSTANCE_00807618);
    ccFntTy::WrStr(PTR_0081176c->field_0034,puVar10,iVar4,iVar25,uVar8);
    ccFntTy::SetSurf(PTR_0081176c->field_0034,this_01->field_1C67,0,0x10,0xce,0xea,0x14);
    uVar8 = 2;
    iVar25 = -1;
    iVar4 = 0;
    puVar10 = (uint *)FUN_006b0140(0x2353,HINSTANCE_00807618);
    ccFntTy::WrStr(PTR_0081176c->field_0034,puVar10,iVar4,iVar25,uVar8);
    uVar15 = this_01->field_1C67;
    FUN_006b2330((uint)DAT_008075a8,&this_01->field_1F80,0x31,0x40407f,*(uint *)(uVar15 + 4),
                 *(uint *)(uVar15 + 8),uVar15);
    Library::DKW::DDX::FUN_006b3640(DAT_008075a8,this_01->field_1F80,0xffffffff,10,0xb4);
    pDVar7 = (DArrayTy *)Library::DKW::TBL::FUN_006ae290((uint *)0x0,5,0x20c,5);
    this_01->field_1F7C = pDVar7;
          ...
          if (iVar4 == 0) {
            ...
            if (-1 < iVar4) {
              ...
              if (puVar9 != (ushort *)0x0) {
                ...
                pcVar18 = (char *)FUN_006b0140(uID,HINSTANCE_00807618);
                uVar15 = 0xffffffff;
                do {
                  pcVar19 = pcVar18;
                  if (uVar15 == 0) break;
                ...
                local_510 = local_c;
                Library::DKW::TBL::FUN_006ae1c0(&pDVar7->flags,(undefined4 *)local_718);
                pcVar12 = extraout_ECX_01;
                this_00 = local_1c;
              }
            }
            cMf32::delete(pcVar12,this_00);
            hFindFile = local_14;
            pIVar3 = local_cc.previous;
          }
        }
    ...
    dVar1 = this_01->field_1F7C->count;
    if (1 < (int)dVar1) {
      pcVar12 = (cMf32 *)(dVar1 - 1);
      local_1c = pcVar12;
      do {
        local_10 = (uint *)0x0;
        uVar15 = 0;
        if (0 < (int)pcVar12) {
          do {
            pDVar7 = this_01->field_1F7C;
            if (uVar15 < pDVar7->count) {
              pvVar21 = (void *)(pDVar7->elementSize * uVar15 + (int)pDVar7->data);
            }
            else {
              pvVar21 = (void *)0x0;
            }
            ...
            if (uVar16 < pDVar7->count) {
              pvVar17 = (void *)(pDVar7->elementSize * uVar16 + (int)pDVar7->data);
            }
            else {
              pvVar17 = (void *)0x0;
            }
            if (*(uint *)((int)pvVar17 + 0x208) < *(uint *)((int)pvVar21 + 0x208)) {
              FUN_006b0cd0((AnonShape_006B0CD0_C8D121FA *)pDVar7,uVar15,uVar16);
              local_10 = (uint *)0x1;
            }
            pcVar12 = local_1c;
            uVar15 = uVar16;
  ...
  if ((((cVar23 == '\r') || (cVar23 == '\x0f')) || ((cVar23 == '\x0e' || (cVar23 == '\x10')))) &&
  ...
  *(undefined4 *)&this_01->field_0x1d04 = 0;
  ...
  local_c = 0x41;
  puVar10 = &this_01->field_20F4;
  do {
    iVar4 = 1;
    puVar5 = (undefined4 *)(this_01->field_005D + 0x28);
    uVar15 = FUN_006b4fe0(this_01->field_005D);
    uVar15 = FUN_006b50c0(0x1e5,0x14,(uint)*(ushort *)(this_01->field_005D + 0xe),uVar15,puVar5,
                          iVar4);
    *puVar10 = uVar15;
    ...
    puVar5 = (undefined4 *)FUN_006b4fa0(uVar15);
    ...
    uVar15 = *puVar10;
    FUN_006b2330((uint)DAT_008075a8,puVar10 + -10,0x31,0x40407f,*(uint *)(uVar15 + 4),
                 *(uint *)(uVar15 + 8),uVar15);
    Library::DKW::DDX::FUN_006b3640(DAT_008075a8,puVar10[-10],0xffffffff,0x113,local_c);
    puVar10 = puVar10 + 1;
  ...
  puVar5 = (undefined4 *)(this_01->field_005D + 0x28);
  uVar15 = FUN_006b4fe0(this_01->field_005D);
  iVar4 = FUN_006b50c0(0x205,0x8c,(uint)*(ushort *)(this_01->field_005D + 0xe),uVar15,puVar5,iVar4);
  ...
  cVar23 = this_01->field_1E26;
  if ((((cVar23 == '\x06') || (cVar23 == '\x01')) ||
      ((cVar23 == '\x04' || (((cVar23 == '\a' || (cVar23 == '\r')) || (cVar23 == '\x0e')))))) &&
    ...
    puVar10 = (uint *)FUN_006b0140(0x256d,HINSTANCE_00807618);
    puVar10 = thunk_FUN_00540c40(PTR_0081176c->field_0034,puVar10,puVar22,iVar4);
    ccFntTy::WrStr(PTR_0081176c->field_0034,puVar10,iVar25,iVar24,uVar8);
  }
  ...
  iVar4 = 0xa5;
  puVar22 = (uint *)&DAT_008016a0;
  puVar10 = (uint *)FUN_006b0140(0x1f4b,HINSTANCE_00807618);
  puVar10 = thunk_FUN_00540c40(PTR_0081176c->field_0034,puVar10,puVar22,iVar4);
  ccFntTy::WrStr(PTR_0081176c->field_0034,puVar10,iVar25,iVar24,uVar8);
  ...
  iVar4 = 0xa5;
  puVar22 = (uint *)&DAT_008016a0;
  puVar10 = (uint *)FUN_006b0140(0x1f4c,HINSTANCE_00807618);
  puVar10 = thunk_FUN_00540c40(PTR_0081176c->field_0034,puVar10,puVar22,iVar4);
  ccFntTy::WrStr(PTR_0081176c->field_0034,puVar10,iVar25,iVar24,uVar8);
  ...
  iVar4 = 0xa5;
  puVar22 = (uint *)&DAT_008016a0;
  puVar10 = (uint *)FUN_006b0140(0x1f4d,HINSTANCE_00807618);
  puVar10 = thunk_FUN_00540c40(PTR_0081176c->field_0034,puVar10,puVar22,iVar4);
  ccFntTy::WrStr(PTR_0081176c->field_0034,puVar10,iVar25,iVar24,uVar8);
  ...
  iVar4 = 0xa5;
  puVar22 = (uint *)&DAT_008016a0;
  puVar10 = (uint *)FUN_006b0140(0x1f4e,HINSTANCE_00807618);
  puVar10 = thunk_FUN_00540c40(PTR_0081176c->field_0034,puVar10,puVar22,iVar4);
  ccFntTy::WrStr(PTR_0081176c->field_0034,puVar10,iVar25,iVar24,uVar8);
  ...
  iVar4 = 0xa5;
  puVar22 = (uint *)&DAT_008016a0;
  puVar10 = (uint *)FUN_006b0140(0x1f4f,HINSTANCE_00807618);
  puVar10 = thunk_FUN_00540c40(PTR_0081176c->field_0034,puVar10,puVar22,iVar4);
  ccFntTy::WrStr(PTR_0081176c->field_0034,puVar10,iVar25,iVar24,uVar8);
  ...
  iVar4 = 0xa5;
  puVar22 = (uint *)&DAT_008016a0;
  puVar10 = (uint *)FUN_006b0140(0x1f56,HINSTANCE_00807618);
  puVar10 = thunk_FUN_00540c40(PTR_0081176c->field_0034,puVar10,puVar22,iVar4);
  ccFntTy::WrStr(PTR_0081176c->field_0034,puVar10,iVar25,iVar24,uVar8);
  ...
  iVar4 = 100;
  puVar22 = (uint *)&DAT_008016a0;
  puVar10 = (uint *)FUN_006b0140(0x1f51,HINSTANCE_00807618);
  puVar10 = thunk_FUN_00540c40(PTR_0081176c->field_0034,puVar10,puVar22,iVar4);
  ccFntTy::WrStr(PTR_0081176c->field_0034,puVar10,iVar25,iVar24,uVar8);
  ...
  iVar4 = 0x82;
  puVar22 = (uint *)&DAT_008016a0;
  puVar10 = (uint *)FUN_006b0140(0x1f58,HINSTANCE_00807618);
  puVar10 = thunk_FUN_00540c40(PTR_0081176c->field_0034,puVar10,puVar22,iVar4);
  ccFntTy::WrStr(PTR_0081176c->field_0034,puVar10,iVar25,iVar24,uVar8);
  ...
  iVar4 = 0xa0;
  puVar22 = (uint *)&DAT_008016a0;
  puVar10 = (uint *)FUN_006b0140(0x1f50,HINSTANCE_00807618);
  puVar10 = thunk_FUN_00540c40(PTR_0081176c->field_0034,puVar10,puVar22,iVar4);
  ccFntTy::WrStr(PTR_0081176c->field_0034,puVar10,iVar25,iVar24,uVar8);
  cVar23 = this_01->field_1E26;
  if (((cVar23 != '\x06') && (cVar23 != '\x01')) && (cVar23 != '\x02')) {
    ...
    iVar4 = 0xe1;
    puVar22 = (uint *)&DAT_008016a0;
    puVar10 = (uint *)FUN_006b0140(0x1f54,HINSTANCE_00807618);
    puVar10 = thunk_FUN_00540c40(PTR_0081176c->field_0034,puVar10,puVar22,iVar4);
    ccFntTy::WrStr(PTR_0081176c->field_0034,puVar10,iVar25,iVar24,uVar8);
    ...
    iVar4 = 0xe1;
    puVar22 = (uint *)&DAT_008016a0;
    puVar10 = (uint *)FUN_006b0140(0x1f53,HINSTANCE_00807618);
    puVar10 = thunk_FUN_00540c40(PTR_0081176c->field_0034,puVar10,puVar22,iVar4);
    ccFntTy::WrStr(PTR_0081176c->field_0034,puVar10,iVar25,iVar24,uVar8);
  }
  uVar15 = this_01->field_1E1E;
  puVar5 = &this_01->field_1E22;
  FUN_006b2330((uint)DAT_008075a8,puVar5,0x31,0x40407f,*(uint *)(uVar15 + 4),*(uint *)(uVar15 + 8),
               uVar15);
  ...
  if (this_01->field_0x21e2 != '\0') {
    ...
    if (pHVar13 != (HoloTy *)0x0) {
      ...
      uVar15 = HoloTy::Init(this_01->field_21EC,CASE_4,10,0xb4,iVar4,iVar25,uVar15,cVar23,uVar16);
      if (uVar15 != 0) {
  ...
  if (this_01->field_0x21e5 == '\0') {
    ...
    if (pHVar13 != (HoloTy *)0x0) {
      ...
      uVar15 = HoloTy::Init(this_01->field_21F4,CASE_2,0x112,0x149,iVar4,iVar25,uVar15,cVar23,uVar16
                           );
      if (uVar15 != 0) {
  ...
  if (this_01->field_0x21e1 == '\0') {
    ...
    if (pHVar13 != (HoloTy *)0x0) {
      ...
      uVar15 = HoloTy::Init(this_01->field_21E8,CASE_2,0x112,0x38,iVar4,iVar25,uVar15,cVar23,uVar16)
      ;
      if (uVar15 != 0) {
  ...
  if (this_01->field_0x21e3 != '\0') {
    ...
    if (pHVar13 != (HoloTy *)0x0) {
      ...
      uVar15 = HoloTy::Init(this_01->field_21F0,CASE_4,10,0xb4,iVar4,iVar25,uVar15,cVar23,uVar16);
      if (uVar15 != 0) {
  ...
  *(undefined1 *)((int)puVar5 + 2) = 0;
  ...
  local_1de = 0x24bc;
  local_1cd = 2;
  if ((((cVar23 == '\r') || (cVar23 == '\x0e')) || (cVar23 == '\x10')) || (cVar23 == '\x0f')) {
