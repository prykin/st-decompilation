...

{
  ...
  StartSystemTy::SetObjectives(PTR_0081176c,iVar25,pcVar19,iVar5);
  ...
  PTR_0081176c->field_002C = puVar9;
  this_02->field_005D = PTR_0081176c->field_002C;
  FUN_006bc360(PTR_0081176c->field_002C,local_b18,(int *)0x0);
  ...
  *(ushort **)&this_02->field_0x21ad = PTR_0081176c->field_002C;
  ...
  *(ushort **)&this_02->field_0x1f4b = puVar9;
  ...
  if (((SVar1 == 6) || (SVar1 == CASE_7)) || (SVar1 == 0xe)) {
    ...
    ccFntTy::WrStr(PTR_0081176c->field_0034,puVar11,iVar5,iVar25,uVar26);
    ...
    FUN_006b2330((uint)PTR_008075a8,&this_02->field_1F80,0x31,0x40407f,*(uint *)(uVar15 + 4),
  ...
  *(undefined4 *)&this_02->field_0x1d04 = 0;
  ...
  do {
    ...
    *puVar11 = uVar15;
    ...
    uVar15 = *puVar11;
    FUN_006b2330((uint)PTR_008075a8,puVar11 + -10,0x31,0x40407f,*(uint *)(uVar15 + 4),
                 *(uint *)(uVar15 + 8),uVar15);
  ...
  if ((((SVar1 == 6) || (SVar1 == 1)) ||
    ...
    puVar11 = thunk_FUN_00540c40(PTR_0081176c->field_0034,puVar11,puVar22,iVar5);
    ccFntTy::WrStr(PTR_0081176c->field_0034,puVar11,iVar25,iVar24,uVar26);
  }
  ...
  FUN_006b2330((uint)PTR_008075a8,puVar6,0x31,0x40407f,*(uint *)(uVar15 + 4),*(uint *)(uVar15 + 8),
               uVar15);
  ...
  if (this_02->field_0x21e5 == '\0') {
    ...
    FUN_006b2330((uint)PTR_008075a8,&local_8,0x32,0x403099,0x205,0x8c,
                 (uint)(this_02->field_1A5B + 0x140));
  ...
  if (this_02->field_0x21e1 == '\0') {
    ...
    FUN_006b2330((uint)PTR_008075a8,&local_8,0x32,0x4042d2,0x205,0x104,
                 (uint)(this_02->field_1A5B + 0x140));
  ...
  *(undefined1 *)((int)puVar6 + 2) = 0;
  ...
  if (PTR_00802a30 != (CursorClassTy *)0x0) {
    ...
    iVar25 = PTR_00802a30->field_00C5;
