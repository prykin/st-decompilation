...

{
  if (param_1 == (undefined4 *)0x0) {
    *(undefined4 *)&this->field_0x456 = 0;
    *(undefined4 *)&this->field_0x45a = 0;
    *(undefined4 *)&this->field_0x45e = 0;
    *(undefined4 *)&this->field_0x462 = 0;
    return;
  }
  *(undefined4 *)&this->field_0x456 = *param_1;
  *(undefined4 *)&this->field_0x45a = param_1[1];
  *(undefined4 *)&this->field_0x45e = param_1[2];
  *(undefined4 *)&this->field_0x462 = param_1[3];
  return;
}
