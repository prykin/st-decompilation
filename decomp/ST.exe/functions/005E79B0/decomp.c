...
void FUN_005e79b0(char param_1)

{
  ...
  if (iVar2 == 0) {
    ...
    if ((*(int *)(local_8 + 0x1af8) == 0) && (param_1 == '\0')) {
      thunk_FUN_005b67a0(DAT_0080759c,0,0,0x112,0x38,0x204,0x19d,
                         (undefined4 *)(*(int *)(local_8 + 0x1a5b) + 0x140));
    }
    if (((*(int *)(local_8 + 0x1b00) == 0) && (param_1 == '\0')) ||
       ((param_1 != '\0' && ((*(int *)(local_8 + 0x1a64) != 0 && (*(int *)(local_8 + 0x1a68) == 0)))
        ))) {
      thunk_FUN_005b68b0(DAT_0080759c,0,0,10,0xb4,0xf9,0x121,
                         (undefined4 *)(*(int *)(local_8 + 0x1a5b) + 0x140));
    }
    if (((*(int *)(local_8 + 0x1afc) == 0) && (param_1 == '\0')) ||
       ((param_1 != '\0' && (*(int *)(local_8 + 0x1a64) != 0)))) {
