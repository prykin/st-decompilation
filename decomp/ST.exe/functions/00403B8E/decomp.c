...

{
  ...
  if (iVar4 == 0) {
    ...
    *(int *)(this_01 + 0x1c8e) = iVar4;
    ...
    FUN_006b2330((uint)DAT_008075a8,&uStack_8,0x32,0x403c74,0x22e,0x145,(uint)this_01);
    Library::DKW::DDX::FUN_006b3640(DAT_008075a8,uStack_8,0xffffffff,0x79,0x51);
    ...
    *(undefined1 **)(this_01 + 0x1c96) = puVar9;
    ...
    if (this_01[0x1a5f] == (PrividerTy)0x0) {
      ...
      Library::DKW::DDX::FUN_006b3640(DAT_008075a8,uStack_8,0xffffffff,0x79,0x197);
      puVar9 = (undefined1 *)Library::MSVCRT::FUN_0072e530(0x33);
      if (puVar9 == (undefined1 *)0x0) {
        puVar9 = (undefined1 *)0x0;
      }
