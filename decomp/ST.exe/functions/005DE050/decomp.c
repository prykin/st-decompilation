...
void __thiscall FUN_005de050(void *this,int param_1)
    ...
    if (iVar3 == 0) {
      ...
      if ((int)uVar4 < (int)(*(int *)(local_c + 0x1e0) + uVar4)) {
        do {
          ...
          if (puVar6 != (uint *)0x0) {
            FUN_00710a90(*(int *)((int)pvVar2 + 0x544),0,0,(uVar7 - uVar4) * local_8,
                         *(int *)(*(int *)((int)pvVar2 + 0x544) + 4),local_8);
