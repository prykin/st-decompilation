...
undefined4 __fastcall FUN_004cd790(int param_1)

{
       ...
       ((-1 < sVar6 &&
        ((sVar6 < SHORT_007fb244 &&
         (piVar1 = *(int **)(DAT_007fb248 +
                            ((int)SHORT_007fb246 * (int)sVar6 + (int)SHORT_007fb240 * (int)sVar2 +
  ...
  iVar3 = *(int *)(param_1 + 0x5b4) + 1;
  if (((((iVar3 < SHORT_007fb242) && (sVar6 = *(short *)(param_1 + 0x5b8), -1 < sVar5)) &&
       (sVar5 < SHORT_007fb240)) &&
      (((sVar2 = (short)iVar3, -1 < sVar2 && (sVar2 < SHORT_007fb242)) &&
       ((-1 < sVar6 &&
        ((sVar6 < SHORT_007fb244 &&
  ...
  if (-1 < iVar4) {
    ...
    iVar3 = *(int *)(param_1 + 0x5b4) + 1;
    if (((((iVar3 < SHORT_007fb242) && (sVar5 = *(short *)(param_1 + 0x5b8), -1 < sVar6)) &&
