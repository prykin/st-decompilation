...
undefined4 thunk_FUN_004e51b0(int *param_1,uint *param_2,uint *param_3)

{
  ...
  iStack_c = (byte)(&DAT_007f4e20)[iVar8] - 1;
  ...
  *(undefined1 *)((int)puVar13 + 2) = *(undefined1 *)((int)puVar9 + 2);
  uStack_30 = (&DAT_00800f30)[iStack_c * 4] | *(uint *)(&DAT_00800fb0 + iVar6);
  uStack_2c = (&DAT_00800f34)[iStack_c * 4] | *(uint *)(&DAT_00800fb4 + iVar6);
  uStack_28 = (&DAT_00800f38)[iStack_c * 4] | *(uint *)(&DAT_00800fb8 + iVar6);
  uStack_24 = (&DAT_00800f3c)[iStack_c * 4] | *(uint *)(&DAT_00800fbc + iVar6);
  uStack_8 = 1;
  ppuStack_1c = &PTR_DAT_007bfc04 + iStack_c;
  do {
    if ((*ppuStack_1c)[uStack_8] != '\0') {
      iStack_18 = (int)&DAT_007f510b + iVar8;
      pbVar4 = (byte *)(iStack_18 + ((int)(uStack_8 ^ 7) >> 3));
      *pbVar4 = *pbVar4 | '\x01' << ((uStack_8 ^ 7) & 7);
    }
    uStack_8 = uStack_8 + 1;
  } while ((int)uStack_8 < 0x9b);
  if (0 < (int)param_2) {
    puStack_14 = param_2;
    param_2 = (uint *)(&DAT_00799074 + iStack_c * 0x1c2);
    do {
      iVar6 = 0;
      puVar10 = param_2;
      do {
  ...
  iVar6 = (int)param_3 + 1;
  if (iVar6 < 3) {
    puStack_14 = (uint *)(&DAT_00799074 + (iVar6 + iStack_c * 3) * 0x96);
    iStack_18 = 3 - iVar6;
    do {
      uStack_8 = 0;
      puVar10 = puStack_14;
      do {
        ...
        if (*(char *)((int)&DAT_00798fd8 + uVar3) == '\x01') {
          ...
          *pbVar4 = *pbVar4 & ~('\x01' << ((uVar3 ^ 7) & 7));
          iStack_20 = (int)&DAT_007f511f + iVar8;
          pbVar4 = (byte *)(iStack_20 + ((int)(uVar3 ^ 7) >> 3));
          *pbVar4 = *pbVar4 & ~('\x01' << ((uVar3 ^ 7) & 7));
        }
        else {
        ...
        uStack_8 = uStack_8 + 1;
        puVar10 = (uint *)((int)puVar10 + 5);
      } while ((int)uStack_8 < 0x1e);
      puStack_14 = (uint *)((int)puStack_14 + 0x96);
      iStack_18 = iStack_18 + -1;
    } while (iStack_18 != 0);
  }
  param_3 = (uint *)0x1;
LAB_004e5403:
  if (((*ppuStack_1c)[(int)param_3] != '\0') &&
    ...
    if (iVar6 < (int)(uint)*(byte *)((int)&DAT_007f555b + iVar8 + (int)param_3)) {
      iVar7 = 0;
      piVar5 = (int *)(&PTR_DAT_007c0dc8)[iStack_c];
      puVar10 = (uint *)*piVar5;
      piVar11 = piVar5;
...
LAB_004e5505:
  ...
  if (0x9a < (int)param_3) {
    ...
    iStack_10 = iVar8;
    do {
      iVar6 = FUN_006b0fd0((int)&uStack_30);
      if (iVar6 != 0) {
        iVar6 = 1;
        *param_3 = 1;
        cVar2 = puVar12[1];
        while( true ) {
          ...
          iStack_20 = (int)&DAT_007f510b + iVar8;
          ppuStack_1c = (undefined **)(uint)(byte)puVar12[iVar6];
          if ((*(byte *)(iStack_20 + ((int)((uint)ppuStack_1c ^ 7) >> 3)) >>
               (((uint)ppuStack_1c ^ 7) & 7) & 1) == 0) break;
...
LAB_004e5598:
    ...
    param_3 = (uint *)0x32;
    do {
      iVar8 = FUN_006b0fd0((int)&uStack_30);
      iVar6 = iStack_10;
      if (iVar8 != 0) {
        *param_2 = 1;
        iVar8 = 1;
        cVar2 = (&DAT_007c0e4d)[(iStack_c * 0x42 + -0x32 + (int)param_3) * 3];
        while( true ) {
          if ((cVar2 == '\0') || (2 < iVar8)) goto LAB_004e5655;
          iVar7 = (iStack_c * 0x42 + -0x32 + (int)param_3) * 3;
          ppuStack_1c = (undefined **)(uint)(byte)(&DAT_007c0e4c)[iVar8 + iVar7];
          iStack_20 = (int)&DAT_007f510b + iStack_10;
          if ((*(byte *)(iStack_20 + ((int)((uint)ppuStack_1c ^ 7) >> 3)) >>
               (((uint)ppuStack_1c ^ 7) & 7) & 1) == 0) break;
...
LAB_004e5655:
      ...
      param_2 = param_2 + 1;
      if (0x73 < (int)param_3) {
        if (*(int *)(&DAT_007f57ee + iStack_10) != 0) {
          *(undefined4 *)(*(int *)(&DAT_007f57ee + iStack_10) + 4) = 0;
          iVar8 = FUN_006b1190(*(int *)(&DAT_007f57ee + iStack_10),&param_1);
          while (-1 < iVar8) {
