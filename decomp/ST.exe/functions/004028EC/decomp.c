    ...
    if ((*(uint *)((int)pvVar2 + 0x1c) & 0x4000) != 0) {
      ...
      if (iVar5 == 0x15) {
        if (((*(uint *)((int)param_1 + 0x1f1) & 0x4000) == 0) && (param_1[0xbb] == 2)) {
          ...
          if ((param_1[0xaa] < 100) || (param_1[0xba] != 0)) {
            ...
            if (*(int *)(PTR_PTR_007bb198 + (param_1[0xda] * 3 + param_1[0xdb]) * 0xc + 4) != 0) {
              ...
              iVar11 = thunk_FUN_004ab880(0xd,DAT_0080678c,abStack_7c,0x1d);
              if (iVar11 != 0) {
        ...
        if (param_1[0xb7] != 0) {
          ...
          if ((int)uStack_14 < (int)(uStack_14 + iVar11)) {
            do {
              iVar5 = *(int *)((int)param_1 + 0x25d);
              if (iVar5 < iVar5 + iVar11) {
                do {
                  thunk_FUN_00496140((short)iVar5,(short)uStack_14,*(short *)((int)param_1 + 0x265))
                  ;
                  iVar5 = iVar5 + 1;
                } while (iVar5 < iVar11 + *(int *)((int)param_1 + 0x25d));
              }
              uStack_14 = uStack_14 + 1;
            } while ((int)uStack_14 < *(int *)((int)param_1 + 0x261) + iVar11);
          }
          ...
          if ((99 < param_1[0xaa]) && (param_1[0xba] == 0)) {
            ...
            thunk_FUN_004354e0(CONCAT31((int3)((uint)iStack_18 >> 8),(char)param_1[9]),
                               CONCAT22(uVar9,*(undefined2 *)((int)param_1 + 0x32)),
                               CONCAT22(uVar7,*(undefined2 *)(iStack_18 + 0x32)));
          }
          iStack_28 = param_1[2];
    ...
    if (*(int *)(*(int *)((int)param_1 + 0x1f5) + 0x18 + param_1[0xbc] * 0x24) ==
      ...
      case 0:
        ...
        if (*(int *)((int)param_1 + 0x241) == 0) {
          ...
          iVar11 = thunk_FUN_004ab880((-(param_1[0xdc] != 0) & 3U) + 5,DAT_0080678c,abStack_7c,0x1d)
          ;
          if (iVar11 != 0) {
            uVar4 = 0x2d1;
LAB_004d3b23:
...
LAB_004d428d:
              ...
              wsprintfA((LPSTR)abStack_7c,s_si_emb3_id_1d_007bf4e4,param_1[9]);
              iVar11 = thunk_FUN_004ab880((char)param_1[0xbc] - 1,DAT_0080678c,abStack_7c,0x1d);
              if (iVar11 != 0) {
                uVar15 = 0x336;
                goto LAB_004d428d;
              }
...
LAB_004d43f5:
        ...
        param_1[0xae] = iVar11;
        uVar3 = thunk_FUN_004406c0((char)param_1[9]);
        uStack_14 = *(uint *)(&DAT_007e3dc0 + ((uVar3 & 0xff) + param_1[0xda] * 3) * 4);
        if (DAT_0080c51e != 0) {
          uVar3 = 0;
          iVar11 = 0;
          do {
          ...
          uStack_14 = (uStack_14 * 0x5dc) / uVar3;
          if (0x5dc < uStack_14) {
            uStack_14 = 0x5dc;
          }
        }
        ...
        if (param_1[0xac] + uVar3 <= *(uint *)(DAT_00802a38 + 0xe4)) {
          ...
          uStack_14 = iVar11 / 100;
          if ((iVar11 != 0) && (uStack_14 == 0)) {
            uStack_14 = 1;
          }
          iStack_1c = *(int *)(&DAT_007e1c50 + iVar5);
          ...
          iStack_c = iVar10 / 100;
          if ((iVar10 != 0) && (iStack_c == 0)) {
            iStack_c = 1;
          }
          iVar5 = *(int *)(&DAT_007e3160 + iVar5);
          iStack_10 = iVar5 / 100;
          if ((iVar5 != 0) && (iStack_10 == 0)) {
            iStack_10 = 1;
          }
          if (iVar11 <= (int)(uStack_14 + param_1[0xb3])) {
            uStack_14 = iVar11 - param_1[0xb3];
          }
          if (iStack_1c <= param_1[0xb4] + iStack_8) {
            iStack_8 = iStack_1c - param_1[0xb4];
          }
          if (iVar10 <= param_1[0xb5] + iStack_c) {
            iStack_c = iVar10 - param_1[0xb5];
          }
          if (iVar5 <= param_1[0xb6] + iStack_10) {
            iStack_10 = iVar5 - param_1[0xb6];
          }
          if ((int)uStack_14 < 0) {
            uStack_14 = 0;
          }
          ...
          param_1[0xad] = 1;
          if ((uStack_14 == 0) ||
             (iVar11 = thunk_FUN_004d7b10((char)param_1[9],0), (int)uStack_14 <= iVar11)) {
            if ((iStack_8 == 0) ||
               (iVar11 = thunk_FUN_004d7b50((char)param_1[9],0), iStack_8 <= iVar11)) {
              if ((iStack_c == 0) ||
                 (iVar11 = thunk_FUN_004d7b90((char)param_1[9],0), iStack_c <= iVar11)) {
                if ((iStack_10 != 0) &&
                   (iVar11 = thunk_FUN_004d7bd0((char)param_1[9],0), iVar11 < iStack_10)) {
                  param_1[0xad] = 0;
                  param_1[0xb2] = 0;
                }
              }
