...
undefined4 __fastcall thunk_FUN_004d32c0(int *param_1)

{
  ...
  iVar10 = 0;
  if (param_1[0xa8] == 0) {
    this = (void *)param_1[0xd7];
    if ((*(uint *)((int)this + 0x1c) & 0x4000) != 0) {
      iVar4 = *(int *)(*(int *)((int)this + 0x20) + 0x210);
      if (iVar4 == 0x15) {
        if (((*(uint *)((int)param_1 + 0x1f1) & 0x4000) == 0) && (param_1[0xbb] == 2)) {
          ...
          thunk_FUN_004abe40(pSVar12,'\x0e',*(undefined4 *)(&DAT_0079104c + param_1[0xda] * 4));
          STT3DSprC::StartShow(pSVar12,0xe,*(undefined4 *)(DAT_00802a38 + 0xe4));
          ...
          iVar10 = STT3DSprC::LoadSequence
                             (pSVar12,0x10,DAT_0080678c,(&PTR_s_tlo_sha_ws_007bb1b4)[param_1[0xdb]],
                              0x1d);
          if (iVar10 != 0) {
            FUN_006a5e40(iVar10,DAT_007ed77c,0x7bf4bc,0x25e);
          }
          thunk_FUN_004abce0(pSVar12,0x10,*(int *)(&DAT_0079104c + param_1[0xda] * 4),
                             *(int *)(&DAT_0079104c + param_1[0xda] * 4),'\0');
          thunk_FUN_004abe40(pSVar12,'\x10',*(undefined4 *)(&DAT_0079104c + param_1[0xda] * 4));
          STT3DSprC::StartShow(pSVar12,0x10,*(undefined4 *)(DAT_00802a38 + 0xe4));
          ...
          do {
            ...
            param_1[7] = uVar2;
            iVar10 = iVar10 + -1;
            *piVar7 = (uVar2 >> 0x10) % 0x65 + 0x19 + *(int *)(DAT_00802a38 + 0xe4);
            piVar7 = piVar7 + 4;
          } while (iVar10 != 0);
          ...
          if ((param_1[0xaa] < 100) || (param_1[0xba] != 0)) {
            ...
            if ((*(byte **)(PTR_PTR_007bb198 + (param_1[0xda] * 3 + param_1[0xdb]) * 0xc) !=
               ...
               iVar10 != 0)) {
              FUN_006a5e40(iVar10,DAT_007ed77c,0x7bf4bc,0x26f);
            }
            if (*(int *)(PTR_PTR_007bb198 + (param_1[0xda] * 3 + param_1[0xdb]) * 0xc + 4) != 0) {
              wsprintfA((LPSTR)abStack_7c,s__s_1i_007ac908,
                        *(int *)(PTR_PTR_007bb198 + (param_1[0xda] * 3 + param_1[0xdb]) * 0xc + 4),
                        *(undefined4 *)((int)param_1 + 0x26d));
              iVar10 = STT3DSprC::LoadSequence
                                 ((STT3DSprC *)((int)param_1 + 0x1d5),0xd,DAT_0080678c,abStack_7c,
                                  0x1d);
              if (iVar10 != 0) {
                FUN_006a5e40(iVar10,DAT_007ed77c,0x7bf4bc,0x273);
              }
            }
            ...
            thunk_FUN_004abe40(pSVar12,'\x0e',iVar10);
            STT3DSprC::StartShow(pSVar12,0xe,*(undefined4 *)(DAT_00802a38 + 0xe4));
            if (**(int **)(*(int *)((int)param_1 + 0x1f5) + 0x1d4) < iVar10) {
              iVar10 = 0;
            }
            thunk_FUN_004abce0(pSVar12,0xd,iVar10,iVar10,'\0');
            thunk_FUN_004abe40(pSVar12,'\r',iVar10);
            STT3DSprC::StartShow(pSVar12,0xd,*(undefined4 *)(DAT_00802a38 + 0xe4));
            if (*(byte **)(PTR_PTR_007bb198 + (param_1[0xda] * 3 + param_1[0xdb]) * 0xc + 8) !=
              ...
              if (iVar10 != 0) {
                FUN_006a5e40(iVar10,DAT_007ed77c,0x7bf4bc,0x281);
              }
              iVar10 = thunk_FUN_004ab050();
              iVar10 = *(int *)(PTR_DAT_007b8310 +
                               (iVar10 + (param_1[0xda] * 3 + param_1[0xdb]) * 4) * 8);
              thunk_FUN_004abce0(pSVar12,0xc,iVar10,iVar10,'\0');
              thunk_FUN_004abe40(pSVar12,'\f',iVar10);
              STT3DSprC::StartShow(pSVar12,0xc,*(undefined4 *)(DAT_00802a38 + 0xe4));
            }
            thunk_FUN_004acef0(pSVar12,DAT_008073cc);
            iVar10 = STT3DSprC::LoadSequence
            ...
            if (iVar10 != 0) {
              FUN_006a5e40(iVar10,DAT_007ed77c,0x7bf4bc,0x289);
            }
            thunk_FUN_004abce0(pSVar12,0x10,*(int *)(&DAT_0079104c + param_1[0xda] * 4),
                               *(int *)(&DAT_0079104c + param_1[0xda] * 4),'\0');
            thunk_FUN_004abe40(pSVar12,'\x10',*(undefined4 *)(&DAT_0079104c + param_1[0xda] * 4));
      ...
      else if (iVar4 == *(int *)(*(int *)((int)this + 0x20) + 0x20c)) {
        thunk_FUN_004abe40(this,'\x0e',0);
        ...
        if (param_1[0xb7] != 0) {
          ...
          uStack_14 = *(uint *)((int)param_1 + 0x261);
          if ((int)uStack_14 < (int)(uStack_14 + iVar10)) {
            do {
              iVar4 = *(int *)((int)param_1 + 0x25d);
              if (iVar4 < iVar4 + iVar10) {
                do {
                  thunk_FUN_00496140((short)iVar4,(short)uStack_14,*(short *)((int)param_1 + 0x265))
                  ;
                  iVar4 = iVar4 + 1;
                } while (iVar4 < iVar10 + *(int *)((int)param_1 + 0x25d));
              }
              uStack_14 = uStack_14 + 1;
            } while ((int)uStack_14 < *(int *)((int)param_1 + 0x261) + iVar10);
          }
          iVar10 = thunk_FUN_004b7520(CONCAT31((int3)((uint)*(undefined4 *)((int)param_1 + 0x259) >>
                                                     8),(char)param_1[9]),
          ...
          if ((99 < param_1[0xaa]) && (param_1[0xba] == 0)) {
            thunk_FUN_0054cc20(*(int *)((int)param_1 + 0x245),0,&iStack_18,(int)param_1 + 0x245,0);
            param_1[0xb9] = 1;
            iVar10 = (**(code **)(*param_1 + 8))();
            uVar6 = 0;
            uVar8 = extraout_var_00;
            if (iVar10 != 0) {
              thunk_FUN_004353b0(CONCAT31((int3)((uint)iStack_18 >> 8),(char)param_1[9]),
                                 CONCAT22((short)((uint)iVar10 >> 0x10),
                                          *(undefined2 *)((int)param_1 + 0x32)),
                                 CONCAT22(extraout_var_02,*(undefined2 *)(iStack_18 + 0x32)));
              uVar8 = extraout_var_01;
              uVar6 = extraout_var;
            }
            STAllPlayersC::ReplaceObject
                      (DAT_007fa174,CONCAT31((int3)((uint)iStack_18 >> 8),(char)param_1[9]),
                       CONCAT22(uVar8,*(undefined2 *)((int)param_1 + 0x32)),
                       CONCAT22(uVar6,*(undefined2 *)(iStack_18 + 0x32)));
          }
          iStack_28 = param_1[2];
          uStack_34 = *(undefined4 *)(param_1[3] + 0x14);
          uStack_30 = 0;
          uStack_2c = 10;
          FUN_006e5810(auStack_3c);
        }
      }
    }
    if (*(int *)(*(int *)((int)param_1 + 0x1f5) + 0x18 + param_1[0xbc] * 0x24) ==
      ...
      case 0:
        ...
        if (*(int *)((int)param_1 + 0x241) == 0) {
          ...
          if (iVar10 != 0) {
            FUN_006a5e40(iVar10,DAT_007ed77c,0x7bf4bc,0x2cf);
          }
          wsprintfA((LPSTR)abStack_7c,s_si_emb3_id_1d_007bf4e4,param_1[9]);
          iVar10 = STT3DSprC::LoadSequence
                             ((STT3DSprC *)((int)param_1 + 0x1d5),(-(param_1[0xdc] != 0) & 3U) + 5,
                              DAT_0080678c,abStack_7c,0x1d);
          if (iVar10 != 0) {
            uVar3 = 0x2d1;
LAB_004d3b23:
            FUN_006a5e40(iVar10,DAT_007ed77c,0x7bf4bc,uVar3);
          }
        }
          ...
          if (iVar10 != 0) {
            FUN_006a5e40(iVar10,DAT_007ed77c,0x7bf4bc,0x2d5);
          }
          wsprintfA((LPSTR)abStack_7c,s_si_emb2_id_1d_007bf500,param_1[9]);
          iVar10 = STT3DSprC::LoadSequence
                             ((STT3DSprC *)((int)param_1 + 0x1d5),(-(param_1[0xdc] != 0) & 3U) + 5,
                              DAT_0080678c,abStack_7c,0x1d);
          if (iVar10 != 0) {
        ...
        thunk_FUN_004abe40(pSVar12,(char)param_1[0xbc],
                           *(undefined4 *)
                            (param_1[0xd9] +
                            (param_1[0xbb] + *(int *)((int)param_1 + 0x241) * 4) * 8));
        STT3DSprC::StartShow(pSVar12,*(byte *)(param_1 + 0xbc),*(undefined4 *)(DAT_00802a38 + 0xe4))
        ;
        iVar10 = param_1[0xbb] + *(int *)((int)param_1 + 0x241) * 4;
        thunk_FUN_004abce0(pSVar12,(char)param_1[0xbc] - 1,*(int *)(param_1[0xd9] + iVar10 * 8),
                           *(int *)(param_1[0xd9] + 4 + iVar10 * 8),'\0');
        thunk_FUN_004abe40(pSVar12,(char)param_1[0xbc] + -1,
                           *(undefined4 *)
                            (param_1[0xd9] +
                            (param_1[0xbb] + *(int *)((int)param_1 + 0x241) * 4) * 8));
...
LAB_004d4378:
      ...
      case 1:
        ...
        if (param_1[0xdc] != 0) {
          ...
          thunk_FUN_004abe40(pSVar12,(char)param_1[0xbc] + -1,
                             *(undefined4 *)
                              (param_1[0xd9] +
                              (param_1[0xbb] + *(int *)((int)param_1 + 0x241) * 4) * 8));
          STT3DSprC::StartShow(pSVar12,(char)param_1[0xbc] - 1,*(undefined4 *)(DAT_00802a38 + 0xe4))
          ;
        }
        ...
        STT3DSprC::StartShow((STT3DSprC *)param_1[0xd7],0xe,*(undefined4 *)(DAT_00802a38 + 0xe4));
...
LAB_004d3f38:
              ...
              thunk_FUN_004abe40(pSVar12,(char)param_1[0xbc],
                                 *(undefined4 *)
                                  ...
                                  (param_1[0xbb] + *(int *)((int)param_1 + 0x241) * 4) * 8));
              STT3DSprC::StartShow
                        (pSVar12,*(byte *)(param_1 + 0xbc),*(undefined4 *)(DAT_00802a38 + 0xe4));
              if (param_1[0xdc] != 0) {
                ...
                thunk_FUN_004abe40(pSVar12,(char)param_1[0xbc] + -1,
                                   *(undefined4 *)
                                    ...
                                    (param_1[0xbb] + *(int *)((int)param_1 + 0x241) * 4) * 8));
                STT3DSprC::StartShow
                          (pSVar12,(char)param_1[0xbc] - 1,*(undefined4 *)(DAT_00802a38 + 0xe4));
                goto LAB_004d3f38;
              }
            }
            piVar7 = param_1 + 0xd4;
          ...
          if (((iVar10 != 0x6c) || (*(int *)((int)param_1 + 0x251) != 3)) &&
            ...
            if (param_1[0xdc] == 0) {
              if (iVar10 == 0) {
                ...
                uVar15 = 0x343;
LAB_004d428d:
                FUN_006a5e40(iVar10,DAT_007ed77c,0x7bf4bc,uVar15);
              }
            }
            else if (iVar10 == 0) {
              iVar10 = STT3DSprC::LoadSequence
              ...
              if (iVar10 != 0) {
                FUN_006a5e40(iVar10,DAT_007ed77c,0x7bf4bc,0x334);
              }
              wsprintfA((LPSTR)abStack_7c,s_si_emb3_id_1d_007bf4e4,param_1[9]);
              iVar10 = STT3DSprC::LoadSequence
                                 (pSVar12,(char)param_1[0xbc] - 1,DAT_0080678c,abStack_7c,0x1d);
              if (iVar10 != 0) {
                uVar15 = 0x336;
                goto LAB_004d428d;
              }
              ...
              if (iVar10 != 0) {
                FUN_006a5e40(iVar10,DAT_007ed77c,0x7bf4bc,0x33a);
              }
              wsprintfA((LPSTR)abStack_7c,s_si_emb2_id_1d_007bf500,param_1[9]);
              iVar10 = STT3DSprC::LoadSequence
                                 (pSVar12,(char)param_1[0xbc] - 1,DAT_0080678c,abStack_7c,0x1d);
            ...
            thunk_FUN_004abce0(pSVar12,*(byte *)(param_1 + 0xbc),
                               *(int *)(param_1[0xd9] + iVar10 * 8),
                               *(int *)(param_1[0xd9] + 4 + iVar10 * 8),'\0');
            thunk_FUN_004abe40(pSVar12,(char)param_1[0xbc],uVar3);
            STT3DSprC::StartShow
                      (pSVar12,*(byte *)(param_1 + 0xbc),*(undefined4 *)(DAT_00802a38 + 0xe4));
            if (param_1[0xdc] != 0) {
              thunk_FUN_004ac6b0(pSVar12,(char)param_1[0xbc] + -1);
              ...
              thunk_FUN_004abce0(pSVar12,(char)param_1[0xbc] - 1,
                                 *(int *)(param_1[0xd9] + iVar10 * 8),
                                 *(int *)(param_1[0xd9] + 4 + iVar10 * 8),'\0');
              thunk_FUN_004abe40(pSVar12,(char)param_1[0xbc] + -1,uVar3);
              cVar1 = (char)param_1[0xbc];
              uVar3 = *(undefined4 *)(DAT_00802a38 + 0xe4);
              goto LAB_004d4378;
            }
    ...
    if ((param_1[0xbb] == 2) && ((*(uint *)((int)param_1 + 0x1f1) & 0x4000) != 0)) {
      if ((param_1[0xaa] < 100) && ((param_1[0xa9] == 0 && (param_1[0xa8] == 0)))) {
        iVar10 = thunk_FUN_004b7520(CONCAT31((int3)((uint)*(undefined4 *)((int)param_1 + 0x259) >> 8
                                                   ),(char)param_1[9]),
                                    *(undefined4 *)((int)param_1 + 0x259));
        if (iVar10 == 0) {
LAB_004d43f5:
        ...
        param_1[0xae] = iVar10;
        uVar2 = thunk_FUN_004406c0((char)param_1[9]);
        uStack_14 = *(uint *)(&DAT_007e3dc0 + ((uVar2 & 0xff) + param_1[0xda] * 3) * 4);
        if (DAT_0080c51e != 0) {
          uVar2 = 0;
          iVar10 = 0;
          do {
          ...
          uStack_14 = (uStack_14 * 0x5dc) / uVar2;
          if (0x5dc < uStack_14) {
            uStack_14 = 0x5dc;
          }
        }
        ...
        if (param_1[0xac] + uVar2 <= *(uint *)(DAT_00802a38 + 0xe4)) {
          param_1[0xac] = *(uint *)(DAT_00802a38 + 0xe4);
          iVar4 = (param_1[0xda] * 3 + param_1[0xdb]) * 4;
          iVar10 = *(int *)(&DAT_008545ac + iVar4);
          uStack_14 = iVar10 / 100;
          if ((iVar10 != 0) && (uStack_14 == 0)) {
            uStack_14 = 1;
          }
          iStack_1c = *(int *)(&DAT_007e1c50 + iVar4);
          iStack_8 = iStack_1c / 100;
          if ((iStack_1c != 0) && (iStack_8 == 0)) {
            iStack_8 = 1;
          }
          iVar9 = *(int *)(&DAT_007e24fc + iVar4);
          iStack_c = iVar9 / 100;
          if ((iVar9 != 0) && (iStack_c == 0)) {
            iStack_c = 1;
          }
          iVar4 = *(int *)(&DAT_007e3160 + iVar4);
          iStack_10 = iVar4 / 100;
          if ((iVar4 != 0) && (iStack_10 == 0)) {
            iStack_10 = 1;
          }
          if (iVar10 <= (int)(uStack_14 + param_1[0xb3])) {
            uStack_14 = iVar10 - param_1[0xb3];
          }
          if (iStack_1c <= param_1[0xb4] + iStack_8) {
            iStack_8 = iStack_1c - param_1[0xb4];
          }
          if (iVar9 <= param_1[0xb5] + iStack_c) {
            iStack_c = iVar9 - param_1[0xb5];
          }
          if (iVar4 <= param_1[0xb6] + iStack_10) {
            iStack_10 = iVar4 - param_1[0xb6];
          }
          if ((int)uStack_14 < 0) {
            uStack_14 = 0;
          }
          ...
          param_1[0xad] = 1;
          if ((uStack_14 == 0) ||
             (iVar10 = thunk_FUN_004d7b10((char)param_1[9],0), (int)uStack_14 <= iVar10)) {
            if ((iStack_8 == 0) ||
               (iVar10 = thunk_FUN_004d7b50((char)param_1[9],0), iStack_8 <= iVar10)) {
              if ((iStack_c == 0) ||
                 (iVar10 = thunk_FUN_004d7b90((char)param_1[9],0), iStack_c <= iVar10)) {
                if ((iStack_10 != 0) &&
                   (iVar10 = thunk_FUN_004d7bd0((char)param_1[9],0), iVar10 < iStack_10)) {
                  param_1[0xad] = 0;
                  param_1[0xb2] = 0;
                }
              }
          ...
          if (param_1[0xad] == 0) {
            ...
            if (uStack_14 != 0) {
              thunk_FUN_004d7c10((char)param_1[9],0,param_1[6],uStack_14);
            }
            if (iStack_8 != 0) {
              thunk_FUN_004d7d30((char)param_1[9],0,param_1[6],iStack_8);
            }
            if (iStack_c != 0) {
              thunk_FUN_004d7e50((char)param_1[9],0,param_1[6],iStack_c);
            }
            if (iStack_10 != 0) {
              thunk_FUN_004d7f70((char)param_1[9],0,param_1[6],iStack_10);
            }
            param_1[0xb3] = param_1[0xb3] + uStack_14;
            param_1[0xb6] = param_1[0xb6] + iStack_10;
            param_1[0xb4] = param_1[0xb4] + iStack_8;
            param_1[0xb5] = param_1[0xb5] + iStack_c;
      ...
      if (param_1[0xdc] == 0) {
        ...
        do {
          if (*piVar11 == 0) {
            if (((((uint)piVar11[1] <= *(uint *)(DAT_00802a38 + 0xe4)) && (param_1[0xad] != 0)) &&
              ...
              *piVar11 = 1;
              ...
              thunk_FUN_004abe40((void *)*piVar7,'\x0e',0);
              STT3DSprC::StartShow((STT3DSprC *)*piVar7,0xe,*(undefined4 *)(DAT_00802a38 + 0xe4));
            ...
            if (*(int *)(iVar10 + 0x210) < *(int *)(iVar10 + 0x20c)) {
              ...
              if (iVar10 + -1 == 0) {
                *piVar11 = 0;
                uVar2 = param_1[7] * 0x41c64e6d + 0x3039;
                param_1[7] = uVar2;
                piVar11[1] = (uVar2 >> 0x10) % 0x65 + 0x19 + *(int *)(DAT_00802a38 + 0xe4);
                thunk_FUN_004ad430(*piVar7);
              }
            }
          }
          thunk_FUN_004ac9e0((void *)*piVar7,*(int *)(DAT_00802a38 + 0xe4));
          piVar7 = piVar7 + 1;
          piVar11 = piVar11 + 4;
          uStack_14 = uStack_14 - 1;
        } while (uStack_14 != 0);
  ...
  if ((iVar10 < *(int *)(*(int *)((int)param_1 + 0x1f5) + 0xec)) ||
    ...
    if (iVar10 == 0x11) {
      ...
      if (iVar10 == 0x23) {
        ...
        STT3DSprC::StartShow(pSVar12,7,*(undefined4 *)(DAT_00802a38 + 0xe4));
      }
    }
  }
  else {
    ...
    uStack_30 = 0;
    uStack_2c = 10;
    FUN_006e60a0(param_1,auStack_3c);
  }
LAB_004d4d4f:
