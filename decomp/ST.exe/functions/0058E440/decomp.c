...
FUN_0058e440(void *this,short param_1,short param_2,short param_3,short param_4,short param_5,
            short param_6)

{
  ...
  sVar1 = *(short *)((int)this + 0x45) + -0xc;
  sVar4 = *(short *)((int)this + 0x45) + 0xc;
  sVar6 = *(short *)((int)this + 0x41) + -0x1c;
  sVar2 = *(short *)((int)this + 0x43) + -0xc;
  sVar3 = *(short *)((int)this + 0x41) + 0x1c;
  sVar5 = *(short *)((int)this + 0x43) + 0xc;
