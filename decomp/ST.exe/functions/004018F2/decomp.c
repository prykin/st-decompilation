...
void __thiscall
thunk_FUN_00559110(void *this,int param_1,undefined *param_2,int param_3,uint param_4,int param_5,
    ...
    if (*(char *)(uVar7 + 0xfc + (int)this) != '\0') {
      ...
      if (puVar9 != (undefined *)0x0) {
        ...
        if (((*(int *)((int)this + 0x38) != 0) && ((param_7 & 1) != 0)) &&
           (iVar13 = 0, iVar12 = param_5, puStack_c = puVar9, 0 < iVar11)) {
          do {
            iVar14 = 0;
            do {
              if (puStack_c[iVar14] != '\0') {
