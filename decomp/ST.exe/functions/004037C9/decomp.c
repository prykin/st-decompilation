...

{
  ...
  if (iVar3 == 0) {
    ...
    *(undefined4 *)(pAStack_18 + 0x20) = 0x38e;
    pAStack_18[0x38] = (AiTactClassTy)0x1;
    pAVar8 = pAStack_18 + 0xa5;
    iVar3 = 8;
    do {
      if (*(int *)pAVar8 != 0) {
      ...
      if (0 < *(short *)(pAVar2 + 0x125)) {
        do {
          ...
          *(AiTactClassTy *)(iVar4 + 0x6a) = pAVar2[0x88];
          STPlaySystemC::CreateGameObject(DAT_00802a38,900,&uStack_14,&iStack_c,iVar4,0);
          iStack_1c = iStack_c;
          uStack_20 = *(undefined4 *)(iStack_c + 0x18);
          Library::DKW::TBL::FUN_006ae1c0(*(uint **)(pAVar2 + 0xa5),&uStack_20);
          *(AiTactClassTy **)(iStack_c + 0x284) = pAVar2;
          iVar4 = iVar4 + *(int *)(iVar4 + 0x14);
          iVar3 = iVar3 + 1;
        } while (iVar3 < *(short *)(pAVar2 + 0x125));
      }
      puStack_10 = thunk_FUN_00668180(s___REPAIR_FLEET___007d571c,*(undefined2 *)(pAVar2 + 0x39),
                                      0x8000,0,pAVar2[0x24]);
      puStack_8 = thunk_FUN_006684e0(puStack_10,&uStack_14);
      thunk_FUN_006686c0((int *)&puStack_10);
      puStack_8[1] = *(undefined4 *)(pAVar2 + 0x24);
      *(undefined4 *)((int)puStack_8 + 0x77) = *(undefined4 *)(pAVar2 + 0x9d);
      *(AiTactClassTy *)((int)puStack_8 + 0x6a) = pAVar2[0x88];
      STPlaySystemC::CreateGameObject(DAT_00802a38,900,&uStack_14,&iStack_c,puStack_8,0);
      thunk_FUN_006686c0((int *)&puStack_8);
      iStack_1c = iStack_c;
      uStack_20 = *(undefined4 *)(iStack_c + 0x18);
      uVar6 = Library::DKW::TBL::FUN_006ae1c0(*(uint **)(pAVar2 + 0xa5),&uStack_20);
