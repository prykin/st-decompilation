...
BOOL __cdecl
FUN_00742a30(DWORD param_1,LPCWSTR param_2,int param_3,LPWORD param_4,UINT param_5,LCID param_6)
          ...
          if (&stack0x00000000 == (undefined1 *)0x44) {
            ...
            *(undefined2 *)(&stack0xffffffba + param_3 * 2) = 0xffff;
            ...
            if ((*(short *)(&stack0xffffffba + param_3 * 2) == -1) ||
              ...
              FUN_0072da70((undefined4 *)param_4,(undefined4 *)&stack0xffffffbc,param_3 << 1);
            }
          }
        }
      }
