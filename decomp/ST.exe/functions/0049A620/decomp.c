    ...
    *(undefined2 *)&local_14->field_0x310 = uVar2;
    ...
    if (local_10 != 0) {
      ...
      do {
        ...
        DArrayGetElement(this_00->field_0029,uVar5,local_c);
    ...
    if (g_playSystem_00802A38->field_00E4 % 3 == 0) {
      ...
      if (local_10 != 0) {
        do {
          ...
          DArrayGetElement(this_00->field_0029,uVar6,local_c);
          if (STPiece<0,2>(local_c) != 0xffff) {
            ...
            this_02 = STAllPlayersC::GetObjPtr
                                (g_allPlayers_007FA174,this_00->field_0024,STPiece<0,2>(local_c),CASE_1);
            if (this_02 == nullptr) {
              RaiseInternalException
                        (-0x5001fffc,g_overwriteContext_007ED77C,
