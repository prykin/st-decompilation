...

{
  ...
  if (g_allPlayers_007FA174 != nullptr) {
    ...
    if (iVar5 == 0) {
      ...
      iVar13 = -1;
      iVar5 = -1;
      puVar7 = (uint *)LoadResourceString(0x564a,g_hINSTANCE_00807618);
      ...
      if (param_1 == 0xfe) {
        ...
        iVar13 = -1;
        iVar5 = -3;
        puVar7 = (uint *)LoadResourceString(0x5661,g_hINSTANCE_00807618);
        ccFntTy::WrStr(this_00->field_01E0,puVar7,iVar5,iVar13,uVar15);
        ...
        pbVar9 = local_10;
        DibPut((RecoveredSourceFamily_dibcopy *)this_00->field_0218,0x94,local_8 - 2,'\x06',local_10
              );
        local_30 = 0x94;
      ...
      iVar13 = -1;
      iVar5 = -3;
      puVar7 = (uint *)LoadResourceString(0x5655,g_hINSTANCE_00807618);
      ccFntTy::WrStr(this_00->field_01E0,puVar7,iVar5,iVar13,uVar15);
      pHVar16 = g_hINSTANCE_00807618;
      ...
      ccFntTy::SetSurf(this_00->field_01E0,(int)this_00->field_0218,0,0x96,local_8,0x106,uVar15 + 2);
      ...
      iVar13 = -1;
      iVar5 = -3;
      puVar7 = (uint *)LoadResourceString(0x562a,g_hINSTANCE_00807618);
      ccFntTy::WrStr(this_00->field_01E0,puVar7,iVar5,iVar13,uVar15);
      ccFntTy::SetSurf(this_00->field_01E0,(int)this_00->field_0218,0,0x96,local_8,0x106,0xf);
      if (param_2 == 1) {
        local_c = CASE_7;
      ...
      local_8 = local_8 + 0xf;
      uVar15 = thunk_FUN_00526ba0(local_c,bVar12);
      pbVar9 = (byte *)FUN_0070b3a0((AnonShape_GLOBAL_0081175C_57F682DD *)this_00->field_023C,uVar15
                                   );
      DibPut((RecoveredSourceFamily_dibcopy *)this_00->field_0218,0x96,local_8,'\x01',pbVar9);
      pbVar9 = local_10;
      DibPut((RecoveredSourceFamily_dibcopy *)this_00->field_0218,0x94,local_8 - 2,'\x06',local_10);
      ...
      iVar13 = -1;
      iVar5 = -3;
      puVar7 = (uint *)LoadResourceString(0x5662,g_hINSTANCE_00807618);
      ccFntTy::WrStr(this_00->field_01E0,puVar7,iVar5,iVar13,uVar15);
      ccFntTy::SetSurf(this_00->field_01E0,(int)this_00->field_0218,0,0x96,local_8,0x106,0xf);
      ...
      iVar13 = -1;
      iVar5 = -3;
      puVar7 = (uint *)LoadResourceString(0x5625,g_hINSTANCE_00807618);
      ccFntTy::WrStr(this_00->field_01E0,puVar7,iVar5,iVar13,uVar15);
      ccFntTy::SetSurf(this_00->field_01E0,(int)this_00->field_0218,0,0x96,local_8,0x106,0xf);
      uVar15 = (DAT_0080874e != '\x03') - 1 & 5;
      iVar13 = -1;
      iVar5 = 1;
      puVar7 = (uint *)LoadResourceString(0x5d5a,g_hINSTANCE_00807618);
      ccFntTy::WrStr(this_00->field_01E0,puVar7,iVar5,iVar13,uVar15);
      local_8 = local_8 + 0xf;
