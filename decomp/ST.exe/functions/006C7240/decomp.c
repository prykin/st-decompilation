...

{
  ...
  if (iVar4 < iVar2) {
    ...
    if ((*(byte *)((int)param_1 + 0x5e) & 1) == 0) {
      FUN_006b55f0(puVar1,*(int *)((int)param_1 + 0x3e),iVar3,iVar4,*(int *)((int)param_1 + 0x2e),
                   param_2,0,0,iVar2,1);
      return 0;
    }
    FUN_006b5110((int)puVar1,*(int *)((int)param_1 + 0x3e),iVar3,iVar4,*(int *)((int)param_1 + 0x2e)
