...

{
  ...
  case CASE_0:
    param_3 = 0;
    iVar6 = *(int *)((int)&DAT_007f4e29 + objPtr * 0xa62);
    iVar7 = *(int *)(iVar6 + 0xc);
    if (0 < iVar7) {
      do {
        piVar5 = *(int **)(*(int *)(iVar6 + 0x1c) + param_3 * 4);
        if (((piVar5 != (int *)0x0) && (piVar5[8] == 0x14)) &&
           ((iVar3 = (**(code **)(*piVar5 + 0xf8))(), iVar3 == 1 &&
            (iVar3 = (**(code **)(*piVar5 + 0xec))(), iVar3 == 1)))) {
      ...
      do {
        ...
        if (((piVar5 != (int *)0x0) && (piVar5[8] == 0x14)) &&
           (((iVar3 = (**(code **)(*piVar5 + 0x2c))(),
             (*(uint *)(&DAT_00800f10 + (iVar3 + 0x41U >> 5) * 4) &
             1 << ((byte)(iVar3 + 0x41U) & 0x1f)) != 0 ||
             (iVar3 = (**(code **)(*piVar5 + 0x2c))(),
             ((&DAT_00800f00)[iVar3 + 0x41U >> 5] & 1 << ((byte)(iVar3 + 0x41U) & 0x1f)) != 0)) &&
            ((iVar3 = (**(code **)(*piVar5 + 0xf8))(), iVar3 == 1 &&
             (iVar3 = (**(code **)(*piVar5 + 0xec))(), iVar3 == 1)))))) {
          Library::DKW::TBL::FUN_006ae1c0(local_8,(undefined4 *)((int)piVar5 + 0x32));
        }
  ...
  case CASE_3:
    ...
    if (0 < iVar7) {
      do {
        ...
        if (((piVar5 != (int *)0x0) && (piVar5[8] == 0x14)) &&
           ((iVar3 = (**(code **)(*piVar5 + 0x2c))(),
            ((&DAT_00801000)[iVar3 + 0x41U >> 5] & 1 << ((byte)(iVar3 + 0x41U) & 0x1f)) != 0 &&
            ((iVar3 = (**(code **)(*piVar5 + 0xf8))(), iVar3 == 1 &&
             (iVar3 = (**(code **)(*piVar5 + 0xec))(), iVar3 == 1)))))) {
          Library::DKW::TBL::FUN_006ae1c0(local_8,(undefined4 *)((int)piVar5 + 0x32));
        }
  ...
  case CASE_4:
    ...
    if (0 < iVar7) {
      do {
        ...
        if ((((piVar5 != (int *)0x0) && (piVar5[8] == 0x14)) &&
            (iVar3 = (**(code **)(*piVar5 + 0x2c))(),
            ((&DAT_00800fa0)[iVar3 + 0x41U >> 5] & 1 << ((byte)(iVar3 + 0x41U) & 0x1f)) != 0)) &&
           ((iVar3 = (**(code **)(*piVar5 + 0xf8))(), iVar3 == 1 &&
            (iVar3 = (**(code **)(*piVar5 + 0xec))(), iVar3 == 1)))) {
          Library::DKW::TBL::FUN_006ae1c0(local_8,(undefined4 *)((int)piVar5 + 0x32));
        }
  ...
  case CASE_5:
    ...
    if (0 < iVar7) {
      do {
        ...
        if (((piVar5 != (int *)0x0) && (piVar5[8] == 0x14)) &&
           ((iVar3 = (**(code **)(*piVar5 + 0x2c))(),
            ((&DAT_00801010)[iVar3 + 0x41U >> 5] & 1 << ((byte)(iVar3 + 0x41U) & 0x1f)) != 0 &&
            ((iVar3 = (**(code **)(*piVar5 + 0xf8))(), iVar3 == 1 &&
             (iVar3 = (**(code **)(*piVar5 + 0xec))(), iVar3 == 1)))))) {
          Library::DKW::TBL::FUN_006ae1c0(local_8,(undefined4 *)((int)piVar5 + 0x32));
        }
  ...
  case CASE_6:
    ...
    if (((piVar5 != (int *)0x0) && (piVar5[9] == objPtr)) && (piVar5[8] == 0x14)) {
      ...
      local_8 = GetTOBJListFromDArr(this,objPtr,(int)local_c,SVar4,iVar6,cVar9);
  ...
  case CASE_7:
    ...
    if ((((iVar6 != 0) && (*(uint *)(iVar6 + 0x24) == objPtr)) && (*(int *)(iVar6 + 0x20) == 0x14))
      ...
      FUN_006ae110((byte *)local_8);
      local_8 = STGroupC::GetGroupContent((STGroupC *)this_00,unaff_EDI);
      param_2 = local_8[3];
      uVar8 = 0;
      if (0 < (int)param_2) {
        do {
  ...
  if (*(int *)((int)&DAT_007f5023 + iVar6) == 0) {
    ...
    if (iVar7 != 0) {
      if (iVar7 == 0x3c) {
        iVar7 = CheckTmps(objPtr,0,0x3c,bVar2,local_8,0);
        if (0 < iVar7) {
        ...
        PushTV(bVar2,0);
        if (*(uint *)((int)&DAT_007f4f97 + iVar6) == objPtr) {
          CalibrateTmp(this,bVar2,0,1,local_8,(int *)&local_10,(int *)0x0,(int *)0x0);
          ResetActivityFromObjs(this,objPtr,0x3c,(int)local_10,0,0);
...
cf_common_exit_0044BD3D:
    AddObjsToTmp(this,objPtr,0,0,(int)local_8);
  }
LAB_0044bd49:
