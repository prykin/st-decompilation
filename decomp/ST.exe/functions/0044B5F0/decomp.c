...

{
  ...
  case 0:
    ...
    break;
  case 1:
    thunk_FUN_0042ab00(bVar2,DAT_00807410,DAT_00807414,DAT_00807418,DAT_0080741c,(int *)&local_8,
                       (int *)0x0);
    param_3 = 0;
    param_2 = local_8[3];
    if (0 < (int)param_2) {
  ...
  case 6:
    ...
    if (((piVar5 != (int *)0x0) && (piVar5[9] == uVar3)) && (piVar5[8] == 0x14)) {
      ...
      thunk_FUN_0042ab00(bVar2,DAT_00807410,DAT_00807414,DAT_00807418,DAT_0080741c,(int *)&local_c,
                         (int *)0x0);
      cVar9 = -1;
      iVar7 = 0;
      iVar6 = (**(code **)(*piVar5 + 0x2c))();
      local_8 = thunk_FUN_0043eed0(uVar3,(int)local_c,iVar6,iVar7,cVar9);
  ...
  case 7:
    ...
    if ((((iVar6 != 0) && (*(uint *)(iVar6 + 0x24) == uVar3)) && (*(int *)(iVar6 + 0x20) == 0x14))
      ...
      FUN_006ae110((byte *)local_8);
      local_8 = thunk_FUN_004233e0(iVar6);
      param_2 = local_8[3];
      uVar8 = 0;
      if (0 < (int)param_2) {
        do {
    ...
    if (iVar7 != 0) {
      if (iVar7 == 0x3c) {
        ...
        if (*(uint *)((int)&DAT_007f4f97 + iVar6) == uVar3) {
          thunk_FUN_0044b280(bVar2,0,1,local_8,(int *)&local_10,(int *)0x0,(int *)0x0);
...
LAB_0044bd3d:
    thunk_FUN_0042c1c0(uVar3,0,0,(int)local_8);
  }
LAB_0044bd49:
