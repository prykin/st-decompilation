...

{
  ...
  if (exceptionCode == 0) {
    puStack_8 = Library::DKW::LIB::FUN_006aac10(0x49f);
    *(undefined4 *)((int)puStack_8 + 1) = 0x49f;
    *(undefined1 *)((int)puStack_8 + 5) = 2;
    Library::MSVCRT::_strncpy((char *)((int)puStack_8 + 6),param_1,0x3f);
    puVar1 = Library::DKW::TBL::FUN_006b54f0((uint *)0x0,5,5);
    *(uint **)((int)puStack_8 + 0x456) = puVar1;
    puVar1 = Library::DKW::TBL::FUN_006ae290((uint *)0x0,5,0x1b,5);
    *(uint **)((int)puStack_8 + 0x462) = puVar1;
