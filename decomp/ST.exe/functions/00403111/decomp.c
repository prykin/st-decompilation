...

{
  ...
  *(uint **)(this_00 + 0x1d7) = puVar4;
  ...
  uStack_8 = 0;
  if (*(int *)sizeHelp_exref != 0) {
    pUStack_c = (UPanelTy *)0x0;
    do {
      puVar11 = (undefined4 *)((int)pUStack_c + *(int *)(this_00 + 0x1c7));
      if (*(char *)(puVar11 + 2) != '\0') {
...
LAB_00510fa9:
      ...
      uStack_8 = uStack_8 + 1;
      pUStack_c = (UPanelTy *)((int)pUStack_c + 0x11);
  ...
  *(undefined4 *)(this_00 + 0x17c) = uVar9;
  ...
  do {
    ...
    iVar3 = iVar3 + 1;
    iVar23 = iVar23 + 0x2c;
    *(undefined4 *)pUStack_c = uVar9;
    pUStack_c = pUStack_c + 4;
    uStack_8 = uStack_8 + -1;
  } while (uStack_8 != 0);
