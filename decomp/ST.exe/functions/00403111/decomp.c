...

{
  ...
  DAT_00801690 = iStack_10;
  puVar4 = FUN_006ae290((uint *)0x0,300,0x14,0x32);
  *(uint **)(iStack_10 + 0x1b3) = puVar4;
  puVar4 = FUN_006ae290((uint *)0x0,200,0x14,0x32);
  *(uint **)(iStack_10 + 0x1bb) = puVar4;
  puVar4 = FUN_006ae290((uint *)0x0,100,9,0x32);
  *(uint **)(iStack_10 + 0x1cb) = puVar4;
  puVar4 = FUN_006ae290((uint *)0x0,0x14,0x19,0x14);
  *(uint **)(iStack_10 + 0x1d7) = puVar4;
  *(undefined1 *)(iStack_10 + 0x253) = 0;
  *(undefined1 *)(iStack_10 + 0x252) = 0;
  *(undefined1 *)(iStack_10 + 0x251) = 0;
  *(undefined1 *)(iStack_10 + 0x250) = 0;
  uVar14 = 0;
  if (*(int *)sizeHelp_exref != 0) {
    piVar10 = (int *)(*(int *)(iStack_10 + 0x1c7) + 0xd);
    do {
      if (*(char *)((int)piVar10 + -5) == '\b') {
        iVar3 = *piVar10;
        if (iVar3 == 1) {
          *(char *)(iStack_10 + 0x251) = *(char *)(iStack_10 + 0x251) + '\x01';
        }
        else if (iVar3 == 2) {
          *(char *)(iStack_10 + 0x252) = *(char *)(iStack_10 + 0x252) + '\x01';
        }
        else if (iVar3 == 3) {
          *(char *)(iStack_10 + 0x253) = *(char *)(iStack_10 + 0x253) + '\x01';
        }
        else {
          *(char *)(iStack_10 + 0x250) = *(char *)(iStack_10 + 0x250) + '\x01';
        }
      }
      uVar14 = uVar14 + 1;
  ...
  if (*(int *)sizeHelp_exref != 0) {
    ...
    do {
      puVar11 = (undefined4 *)((int)puStack_c + *(int *)(iStack_10 + 0x1c7));
      if (*(char *)(puVar11 + 2) != '\0') {
        puVar4 = *(uint **)(iStack_10 + 0x1bb);
        bVar2 = true;
        uVar14 = 0;
        pcStack_14 = (char *)0x1;
        if (puVar4[3] != 0) {
...
LAB_00510fa9:
        if (bVar2) {
          ...
          uStack_20 = puVar11[2];
          uStack_1c = puVar11[3];
          uStack_18 = *(undefined1 *)(puVar11 + 4);
          uStack_17 = 0;
          uStack_16 = 0;
          uStack_15 = 0;
      ...
      uStack_8 = uStack_8 + 1;
      puStack_c = (undefined4 *)((int)puStack_c + 0x11);
    } while (uStack_8 < *(uint *)sizeHelp_exref);
  }
  do {
    iVar3 = *(int *)(iStack_10 + 0x1bb);
    puStack_c = (undefined4 *)0x0;
    ...
    if (uVar14 != 1) {
      do {
        ...
        uStack_8 = uVar13 + 1;
        if (uStack_8 < uVar14) {
          pUVar12 = (UINT *)(*(int *)(iVar3 + 8) * uStack_8 + *(int *)(iVar3 + 0x1c));
        }
        else {
          pUVar12 = (UINT *)0x0;
        }
        if ((pUVar15 != (UINT *)0x0) && (pUVar12 != (UINT *)0x0)) {
          ...
          if (0 < iVar3) {
            FUN_006b0cd0(*(int *)(iStack_10 + 0x1bb),uVar13,uStack_8);
  ...
  *(undefined4 *)(iStack_10 + 0x218) = uVar9;
  ...
  thunk_FUN_00540760(*(undefined4 **)(iStack_10 + 0x68),0,0,'\x01',*(byte **)(iStack_10 + 0x1dc));
  FUN_00710a90(*(int *)(iStack_10 + 0x68),0,0x6c,2,0x117,0xc);
  uVar9 = 0;
  iVar23 = -1;
  iVar3 = -2;
  puVar4 = (uint *)FUN_006b0140(0x2734,DAT_00807618);
  FUN_007119c0(puVar4,iVar3,iVar23,uVar9);
  uVar25 = 0;
  uVar24 = 0;
  pcVar5 = (char *)0x0;
  uVar22 = 0;
  ...
  uVar9 = thunk_FUN_0053dea0(0,1,0x195,0x17b,1,(int)pCVar6,uVar9,uVar17,sVar19,uVar20,uVar22,pcVar5,
                             uVar24,uVar25);
  puStack_c = (undefined4 *)(iStack_10 + 0x180);
  *(undefined4 *)(iStack_10 + 0x17c) = uVar9;
  iVar3 = 0;
  iVar23 = 0x1e;
  uStack_8 = 7;
  do {
    ...
    uVar9 = thunk_FUN_0053dea0(0,1,iVar23,0x151,1,(int)pCVar6,iVar16,iVar18,sVar19,uVar20,uVar9,
                               pcVar5,uVar17,uVar22);
    iVar3 = iVar3 + 1;
    iVar23 = iVar23 + 0x2c;
    *puStack_c = uVar9;
