...
float * FUN_00671f10(void *param_1,int *param_2,int *param_3)

{
  ...
  Library::MSVCRT::_strncpy(&local_24->field_0004,&CHAR_00h_008016a0,0x7f);
  local_24->field_0084 = 0xffffffff;
  local_c = (RecoveredGlobalRecordView_00848A14 *)thunk_FUN_0064a630(10);
  local_20 = 0.0;
...
cf_continue_loop_006721A4:
    ...
    if ((local_10 == 0) && (local_14 == 0)) {
      ...
      if ((iVar2 < 0) || (iVar2 = thunk_FUN_00668a70((int)*psVar6), iVar2 != 0)) {
        ...
        local_8 = SubmarineTitans::Recovered::HiddenThis::RecoveredReceiver_0064A970::
                  thunk_FUN_0064a970(local_24,pcVar3,iVar2,piVar7);
      }
      else {
        iVar2 = (int)psVar6[1];
        piVar7 = &local_1c;
        ...
        pcVar3 = thunk_FUN_0064a910(local_c,iVar5);
        local_8 = (float *)SubmarineTitans::Recovered::HiddenThis::RecoveredReceiver_0064A970::
