...
LAB_005829e6:
        ...
        if ((this->field_023D != 0) &&
           ...
           ((pSVar13 = STAllPlayersC::GetObjPtr
            ...
            (iVar11 = (*pSVar13->vtable[1].vfunc_24)(pSVar13), iVar11 == 0)))) {
          this->field_023D = 0;
        }
LAB_005829f4:
      ...
      if (((((((-1 < sVar4) && (sVar4 < g_worldGrid.sizeX)) && (-1 < sVar6)) &&
         ...
         ((iVar11 = (*this_00->vtable[5].slots_00_28[0])(this_00), iVar11 != 0 &&
...
LAB_00582bb0:
        ...
        if ((bVar20) && (iVar11 = (*this_00->vtable[5].slots_00_28[2])(this_00), iVar11 != 0)) {
          ...
          iVar11 = (*this_00->vtable[4].slots_00_28[7])
                             (this_00,CONCAT22(uVar17,this->field_0041),
                              STReplaceLowWord((uint32_t)(local_14), (uint16_t)(this->field_0043)),
                              CONCAT22(uVar17,this->field_0045),local_14,local_10,local_c);
  ...
  case CASE_2:
    ...
    if ((uVar12 != iVar11 - 1U) || (this->field_0x24f != '\0')) {
      if (((int)uVar12 < 10) &&
        ...
        (*pSVar13->vtable[1].vfunc_0C)(pSVar13);
    ...
    if ((-1 < iVar11) && (iVar11 < 2)) {
      if ((this->field_0241 == 0xff) ||
         ...
         ((pSVar13 = STAllPlayersC::GetObjPtr
          ...
          || (iVar14 = (*pSVar13->vtable[1].vfunc_24)(pSVar13), iVar14 == 0)))) {
        this->field_023D = 0;
...
LAB_005827b7:
      ...
      iVar14 = (*pSVar13->vtable[1].vfunc_08)(pSVar13);
