    ...
    if (uVar8 != 0) {
      ...
      if (uVar8 != 0) {
        ...
        if (0 < (int)uVar8) {
          ...
          do {
            if (((bVar14) && (iVar7 = puVar6[2] * uVar9 + puVar6[7], iVar7 != 0)) &&
               ((*(int *)(iVar7 + 0x108) < 0 &&
                ((puVar2 = *(uint **)(iVar7 + 0x110), (int)local_c <= (int)puVar2 &&
                 (piVar3 = *(int **)(iVar7 + 0x10c), (int)piVar3 <= (int)local_c)))))) {
        ...
        if (0 < (int)uVar8) {
          ...
          do {
            if (((bVar14) && (iVar7 = puVar6[2] * uVar9 + puVar6[7], iVar7 != 0)) &&
               ((*(uint *)(iVar7 + 0x108) == local_c &&
                ((puVar2 = *(uint **)(iVar7 + 0x110), (int)local_18 <= (int)puVar2 &&
                 (piVar3 = *(int **)(iVar7 + 0x10c), (int)piVar3 <= (int)local_18)))))) {
              if ((int)param_4 < (int)piVar3) {
                uVar10 = uVar9;
                param_4 = piVar3;
              }
