...

{
  ...
  groupContent = thunk_FUN_00683c70(param_1,&stack0xfffffcd0,&local_14,param_4,(undefined *)0x0);
  if (groupContent != (uint *)0x0) {
    ...
    if (uVar7 != 0) {
      while (uVar7 = uVar7 - 1, -1 < (int)uVar7) {
        if (uVar7 < groupContent[3]) {
          pcVar5 = (char *)(groupContent[2] * uVar7 + groupContent[7]);
        }
        else {
          pcVar5 = (char *)0x0;
        }
        if (((*pcVar5 != '\0') &&
          ...
          FUN_006b0c70((int)groupContent,uVar7);
        }
      }
      uVar7 = groupContent[3];
      if (uVar7 != 0) {
        ...
        if (0 < (int)uVar7) {
          bVar13 = uVar7 != 0;
          do {
            if (((bVar13) && (iVar6 = groupContent[2] * uVar8 + groupContent[7], iVar6 != 0)) &&
               ((*(int *)(iVar6 + 0x108) < 0 &&
          ...
          if (((-1 < (int)uVar9) && (uVar9 < uVar7)) &&
             (iVar6 = groupContent[2] * uVar9 + groupContent[7], iVar6 != 0)) {
            uVar7 = 0xffffffff;
