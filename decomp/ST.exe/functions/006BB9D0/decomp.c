...
int FUN_006bb9d0(int param_1,int param_2,int param_3,int param_4,int param_5,int *param_6,
...

{
  ...
  local_28 = param_8;
  local_24.left = *(int *)(param_1 + 0x10) + param_2;
  local_24.top = *(int *)(param_1 + 0x14) + param_3;
  ...
  if (BVar3 != 0) {
                            ...
                            (piVar1,&local_44,param_6,&local_34,param_9 | 0x1000000,0), iVar4 != 0)
    {
      if (iVar4 == -0x7789fe3e) {
        ...
        if (((iVar4 != -0x7789ff60) && (iVar4 != -0x7789fe52)) || (param_1 != 0)) break;
        Sleep(2);
      }
      param_1 = param_1 + 1;
      if (1 < param_1) break;
