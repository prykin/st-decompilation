...
undefined4 * __thiscall FUN_005f1fa0(void *this,int *param_1)

{
  ...
  if (*(uint **)((int)this + 0x38) != (uint *)0x0) {
    local_10 = (undefined4 *)FUN_006b0020(*(uint **)((int)this + 0x38),(int *)&local_8);
    if (local_8 == 0) {
  ...
  *(undefined4 *)((int)this + 0x34) = uVar2;
  ...
  if (local_8 != 0) {
    *puVar6 = local_8;
    ...
    puVar6 = (uint *)((int)(puVar3 + 0xb) + local_8);
  }
  if (local_c != 0) {
    *puVar6 = local_c;
    puVar8 = local_14;
