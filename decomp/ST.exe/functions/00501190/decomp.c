...

{
  ...
  pCVar2 = local_10;
  if (iVar4 == 0) {
    pBVar4 = FUN_0070b3a0((RecoveredGlobalRecordView_0081175C *)local_10->field_02B2,0);
    ...
    pBVar4 = FUN_0070b3a0((RecoveredGlobalRecordView_0081175C *)pCVar2->field_02B2,
                          -(uint)(DAT_0080874e != '\x01') & 6);
    /* ST_CALLSITE[00501214]: CALL 0x00403229; direct=00403229 DibPut */
    DibPut(pCVar2->field_018C,iVar6,0x50,'\x01',(RecoveredRecordView_006B84D0_87AF9D9B *)pBVar4);
    ...
    if (pCVar2->field_0BB6 != '\0') {
      do {
        ...
        DibPut(pCVar2->field_018C,iVar6 + 3 + (local_8 & 0xff) * 4,0x53,'\x01',
    ...
    if (uVar7 < (byte)pCVar2->field_0BB7 + uVar7) {
      do {
        ...
        pBVar4 = FUN_0070b3a0((RecoveredGlobalRecordView_0081175C *)pCVar2->field_02B6,5);
        /* ST_CALLSITE[005012AB]: CALL 0x00403229; direct=00403229 DibPut */
        DibPut(pCVar2->field_018C,iVar6 + 3 + uVar7 * 4,0x53,'\x01',
               (RecoveredRecordView_006B84D0_87AF9D9B *)pBVar4);
    ...
    if (uVar7 < (byte)pCVar2->field_0BB5 + uVar7) {
      do {
        ...
        pBVar4 = FUN_0070b3a0((RecoveredGlobalRecordView_0081175C *)pCVar2->field_02B6,2);
