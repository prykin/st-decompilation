  ...
  if (iVar2 == 0) {
    if (param_2 == 0) {
      ...
      if ((local_10 == (DArrayTy *)0x0) && (g_allPlayers_007FA174 != (STAllPlayersC *)0x0)) {
        local_10 = (DArrayTy *)
                   STAllPlayersC::GetTOBJList(g_allPlayers_007FA174,pAVar1->field_0x24,param_1,0,-1)
        ;
      }
    }
    else if ((param_2 == 2) && (g_allPlayers_007FA174 != (STAllPlayersC *)0x0)) {
      local_10 = (DArrayTy *)
                 STAllPlayersC::GetTOBJList(g_allPlayers_007FA174,local_14->field_0x24,param_1,0,-1)
      ;
    }
  }
