...
bool __thiscall thunk_FUN_0048d650(void *this,void *param_1)
  ...
  do {
    ...
    do {
      ...
      if ((((sVar1 < 0) || (DAT_007fb240 <= sVar1)) || (sVar4 < 0)) ||
        ...
        if (iVar2 < iStack_14) {
          *(short *)((int)this + 0x4c5) = (short)iStack_10 + (short)param_1;
          *(short *)((int)this + 0x4c7) = (short)iVar5 + auStack_8[0];
          *(short *)((int)this + 0x4c9) = auStack_c[0] + 1;
          iStack_14 = iVar2;
        }
      }
      iVar5 = iVar5 + 1;
