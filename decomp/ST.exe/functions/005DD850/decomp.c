...

{
  ...
  if (iVar6 == 0) {
    if ((param_1 != 0) &&
      ...
      local_24 = 0x26;
      local_10 = puVar2;
      SystemClassTy::SendMessage(local_c,2,(int)local_c[0x2a].objects,(int)local_34);
...
LAB_005dd982:
      ...
      SystemClassTy::SendMessage(this_00,2,(int)this_00[0x2a].objects,(int)local_34);
      local_24 = 0x22;
      local_20 = 0;
      if (local_5 == '\0') {
