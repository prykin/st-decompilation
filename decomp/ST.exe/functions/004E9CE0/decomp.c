...

{
  ...
  case 1:
    ...
    break;
  case 2:
    iVar4 = FUN_006e62d0(DAT_00802a38,*(int *)&local_20->field_0x470,(int *)&local_8);
    if (iVar4 != 0) {
  ...
  case 4:
    ...
    if (iVar4 + 0x79U <= uVar5) {
      ...
      *(undefined4 *)&this_00->field_0x5b0 = *(undefined4 *)&this_00->field_0x480;
      *(undefined4 *)&this_00->field_0x5b8 = *(undefined4 *)&this_00->field_0x488;
      *(undefined4 *)&this_00->field_0x5b4 = *(undefined4 *)&this_00->field_0x484;
      iVar4 = thunk_FUN_00417a20(this_00,*(short *)&this_00->field_0x5b0,
