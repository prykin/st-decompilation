...

{
  ...
  switch(*(undefined4 *)(local_20 + 0x46c)) {
  case 1:
    if (*(int *)(local_20 + 0x3dc) == 0) {
      if (((*(int *)(local_20 + 0x5b0) == *(int *)(local_20 + 0x474)) &&
          (*(int *)(local_20 + 0x5b4) == *(int *)(local_20 + 0x478))) &&
         (*(int *)(local_20 + 0x5b8) == *(int *)(local_20 + 0x47c) + 1)) {
        bVar3 = true;
      }
      else {
        bVar3 = false;
      ...
      if (bVar3) {
        *(undefined4 *)(local_20 + 0x46c) = 2;
        g_currentExceptionFrame = local_64.previous;
        return 0;
      }
      thunk_FUN_004c6c70(local_20,*(int *)(local_20 + 0x474),*(undefined4 *)(local_20 + 0x478),
                         *(int *)(local_20 + 0x47c) + 1);
      g_currentExceptionFrame = local_64.previous;
      return 0;
    }
    break;
  case 2:
    iVar4 = FUN_006e62d0(DAT_00802a38,*(int *)(local_20 + 0x470),(int *)&local_8);
    if (iVar4 != 0) {
    ...
    if (iVar4 != 0) {
      ...
      *(undefined4 *)(this_00 + 0x46c) = 3;
      ...
      thunk_FUN_004e9650(local_8,(undefined4 *)(this_00 + 0x480),(undefined4 *)(this_00 + 0x484),
                         (undefined4 *)(this_00 + 0x488));
      thunk_FUN_004e96c0(local_8,*(int **)(this_00 + 0x18));
    ...
    break;
  case 3:
    iVar4 = thunk_FUN_00415ed0(local_20,&local_18,&local_1c);
    if (iVar4 == -1) {
    ...
    break;
  case 4:
    iVar4 = *(int *)(local_20 + 0x49c);
    uVar5 = *(uint *)((int)DAT_00802a38 + 0xe4);
    if ((iVar4 + 0x15U <= uVar5) && (*(int *)(local_20 + 0x490) == 0)) {
      iVar4 = 0;
      uVar5 = thunk_FUN_004ad650((int)(local_20 + 0x1d5));
    ...
    if ((iVar4 + 100U <= uVar5) && (*(int *)(local_20 + 0x498) == 0)) {
      uVar10 = 0;
      iVar7 = (int)(short)(*(short *)(local_20 + 0x488) * 200 + 100);
      iVar4 = (int)(short)(*(short *)(local_20 + 0x484) * 0xc9 + 100);
      iVar8 = (int)(short)(*(short *)(local_20 + 0x480) * 0xc9 + 100);
      iVar9 = 0;
      uVar5 = thunk_FUN_004ad650((int)(local_20 + 0x1d5));
    ...
    if (iVar4 + 0x79U <= uVar5) {
      if (*(int *)(local_20 + 0x494) != 0) {
        thunk_FUN_004d0a80(DAT_00800bcc,*(int *)(local_20 + 0x480),*(int *)(local_20 + 0x484),
                           *(int *)(local_20 + 0x488));
    ...
    break;
  case 5:
    if ((*(int *)(local_20 + 0x48c) != 0) &&
       (iVar4 = FUN_006e62d0(DAT_00802a38,*(int *)(local_20 + 0x470),(int *)&local_8), iVar4 == 0))
    {
