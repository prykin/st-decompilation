...

{
  ...
  if (iVar3 != 0) {
    ...
    iVar6 = FUN_006ad4d0(s_E____titans_Artem_TLO_tele_cpp_007c153c,0x1d5,0,iVar3,&DAT_007a4ccc);
    if (iVar6 == 0) {
      FUN_006a5e40(iVar3,0,0x7c153c,0x1d6);
      return iVar3;
    }
    pcVar1 = (code *)swi(3);
    iVar3 = (*pcVar1)();
  ...
  case 3:
    ...
    if (iVar3 == -1) {
      iVar3 = FUN_006ad4d0(s_E____titans_Artem_TLO_tele_cpp_007c153c,0x19a,0,-5,&DAT_007a4ccc);
      if (iVar3 == 0) {
        FUN_006a5e40(-5,DAT_007ed77c,0x7c153c,0x19a);
        DAT_00858df8 = (undefined4 *)local_64;
        return 0;
      }
      pcVar1 = (code *)swi(3);
  ...
  case 4:
    ...
    if (iVar3 + 0x79U <= uVar4) {
      ...
      if (iVar3 != 0) {
        FUN_006a5e40(-5,DAT_007ed77c,0x7c153c,0x1b3);
      }
