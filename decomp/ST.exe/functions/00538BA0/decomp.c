...
void __thiscall
FUN_00538ba0(void *this,int param_1,byte param_2,char *param_3,undefined4 param_4,UINT param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    local_10 = *local_18;
    iVar3 = DAT_00806730;
    if (*(int *)((int)this + 0x5c) == 0) goto LAB_00538bd9;
  }
  iVar3 = *(int *)((int)this + 0x3c);
LAB_00538bd9:
  local_10 = local_10 - iVar3;
  if (param_8 == 0) {
    local_c = local_18[1] - *(int *)((int)this + 0x44);
  }
  ...
  if (param_6 != (undefined *)0x0) {
    ...
    if (iVar3 == 0) {
      ...
      FUN_00710a90(*(int *)((int)pvVar2 + 0x68),0,iVar3,iVar6,local_18[2],local_18[3]);
    ...
    DAT_00858df8 = (undefined4 *)local_5c;
    iVar6 = FUN_006ad4d0(s_E____titans_Andrey_panel_cpp_007c7390,0xcc,0,iVar3,&DAT_007a4ccc);
    if (iVar6 != 0) {
      pcVar1 = (code *)swi(3);
      (*pcVar1)();
      return;
    }
    FUN_006a5e40(iVar3,0,0x7c7390,0xcc);
  }
  return;
}
