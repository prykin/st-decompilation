...
undefined4 __thiscall FUN_00620030(void *this,int param_1,int param_2,int param_3)

{
  ...
  if ((*(int *)((int)this + 0xc5) != 0) &&
     (uVar1 = *(int *)(*(int *)((int)this + 0xc5) + 0xc) - 1, -1 < (int)uVar1)) {
    do {
      groupContent = *(AnonShape_006B0C70_7C4FE646 **)((int)this + 0xc5);
