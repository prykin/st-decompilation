...
void __thiscall FUN_00555040(void *this,undefined4 param_1,uint param_2,char *param_3)

{
  ...
  case 0:
    ...
    thunk_FUN_00554ad0(local_8,local_450);
    DAT_00858df8 = (undefined4 *)local_50;
    return;
  case 1:
    pcVar5 = (char *)FUN_006b0140(0x267a,DAT_00807618);
    ...
    for (uVar8 = uVar8 & 3; pvVar10 = local_8, uVar8 != 0; uVar8 = uVar8 - 1) {
      *pcVar13 = *pcVar5;
      pcVar5 = pcVar5 + 1;
      pcVar13 = pcVar13 + 1;
    }
    if (*(int *)((int)local_8 + 0x3c) == 0) {
      uVar8 = *(uint *)((int)local_8 + 0x40);
      if (uVar8 < param_2) {
        param_2 = uVar8;
      }
    }
    ...
    if (uVar8 != *(uint *)((int)pvVar10 + 0x50)) {
      ...
      thunk_FUN_00554ad0(pvVar10,local_450);
...
joined_r0x00555393:
    ...
    thunk_FUN_00554c80(pvVar10,local_450);
    DAT_00858df8 = (undefined4 *)local_50;
    return;
  default:
    if (*(code **)((int)local_8 + 0x58) != (code *)0x0) {
      (**(code **)((int)local_8 + 0x58))(*(undefined4 *)((int)local_8 + 0x54));
    }
  }
  DAT_00858df8 = (undefined4 *)local_50;
  return;
