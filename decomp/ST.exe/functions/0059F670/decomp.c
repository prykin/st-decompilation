...

{
  ...
  switch(*(char *)(local_8 + 0x1a5f)) {
  case '\x02':
  case '\x04':
  case '\x05':
  case '\a':
    if (*(char *)(local_8 + 0x1a5f) == '\a') {
  ...
  case '\x01':
    ...
    *(undefined1 **)(local_8 + 0x1f23) = puVar3;
    if (puVar3 != (undefined1 *)0x0) {
      uVar8 = 0;
      cVar6 = '\x01';
      uVar5 = 0x10;
      ...
      if (uVar5 != 0) {
        iVar2 = *(int *)(local_8 + 0x1f23);
        *(undefined1 *)(iVar2 + 2) = 0;
        *(undefined4 *)(iVar2 + 0x17) = 0xffffffff;
        uVar5 = *(uint *)(*(int *)(local_8 + 0x1f23) + 3);
        if (-1 < (int)uVar5) {
      ...
      thunk_FUN_00540620(0xb4,0xaa,0xb4,0xaa,0x1b8,(byte *)0x106,'\x01',
                         *(BITMAPINFO **)(local_8 + 0x5d));
    }
    uVar5 = *(uint *)(local_8 + 0x1abc);
    piVar7 = DAT_008075a8;
    break;
  case '\x03':
    thunk_FUN_005a0590(local_8);
    ...
    *(undefined1 **)(local_8 + 0x1f23) = puVar3;
    ...
    thunk_FUN_00540620(0x22,0x72,0x22,0x72,0x2e1,(byte *)0x14c,'\x01',
                       *(BITMAPINFO **)(local_8 + 0x5d));
    if (*(uint *)(local_8 + 0x1b2c) != 0xffffffff) {
      FUN_006b3af0(*(int **)(local_8 + 0x1b70),*(uint *)(local_8 + 0x1b2c));
    }
    if (*(uint *)(local_8 + 0x1bbd) != 0xffffffff) {
      FUN_006b3af0(*(int **)(local_8 + 0x1c01),*(uint *)(local_8 + 0x1bbd));
    }
    uVar5 = *(uint *)(local_8 + 0x1c4e);
    if (uVar5 == 0xffffffff) goto switchD_0059f6f7_default;
    piVar7 = *(int **)(local_8 + 0x1c92);
    break;
  case '\x06':
    ...
    *(undefined1 **)(local_8 + 0x1f27) = puVar3;
    if (puVar3 != (undefined1 *)0x0) {
      uVar8 = 0;
      cVar6 = '\x01';
      uVar5 = 0x10;
      ...
      if (uVar5 != 0) {
        iVar2 = *(int *)(local_8 + 0x1f27);
        *(undefined1 *)(iVar2 + 2) = 0;
        *(undefined4 *)(iVar2 + 0x17) = 0xffffffff;
        uVar5 = *(uint *)(*(int *)(local_8 + 0x1f27) + 3);
        if (-1 < (int)uVar5) {
          FUN_006b3430(DAT_008075a8,uVar5);
        }
        thunk_FUN_005ab0a0();
      ...
      if (*(uint *)(local_8 + 0x1c4e) != 0xffffffff) {
        FUN_006b3af0(*(int **)(local_8 + 0x1c92),*(uint *)(local_8 + 0x1c4e));
      }
    }
    ...
    *(undefined1 **)(local_8 + 0x1f2b) = puVar3;
    if (puVar3 == (undefined1 *)0x0) goto switchD_0059f6f7_default;
    uVar8 = 0;
    cVar6 = '\x01';
    uVar5 = 0x10;
    ...
    if (uVar5 != 0) {
      iVar2 = *(int *)(local_8 + 0x1f2b);
      *(undefined1 *)(iVar2 + 2) = 0;
      *(undefined4 *)(iVar2 + 0x17) = 0xffffffff;
      uVar5 = *(uint *)(*(int *)(local_8 + 0x1f2b) + 3);
      if (-1 < (int)uVar5) {
        FUN_006b3430(DAT_008075a8,uVar5);
      }
      thunk_FUN_005ab0a0();
    ...
    thunk_FUN_00540620(0x1e9,0x5e,0x1e9,0x5e,0x124,(byte *)0x175,'\x01',
                       *(BITMAPINFO **)(local_8 + 0x5d));
    if (*(uint *)(local_8 + 0x1cdf) != 0xffffffff) {
      FUN_006b3af0(*(int **)(local_8 + 0x1d23),*(uint *)(local_8 + 0x1cdf));
    }
    if (*(uint *)(local_8 + 0x1d70) != 0xffffffff) {
      FUN_006b3af0(*(int **)(local_8 + 0x1db4),*(uint *)(local_8 + 0x1d70));
    }
    uVar5 = *(uint *)(local_8 + 0x1e01);
    if (uVar5 == 0xffffffff) goto switchD_0059f6f7_default;
    piVar7 = *(int **)(local_8 + 0x1e45);
    break;
  case '\b':
    ...
    *(undefined1 **)(local_8 + 0x1f2f) = puVar3;
    if (puVar3 != (undefined1 *)0x0) {
      uVar8 = 0;
      cVar6 = '\x01';
      uVar5 = 0x10;
      ...
      if (uVar5 != 0) {
        iVar2 = *(int *)(local_8 + 0x1f2f);
        *(undefined1 *)(iVar2 + 2) = 0;
        *(undefined4 *)(iVar2 + 0x17) = 0xffffffff;
        uVar5 = *(uint *)(*(int *)(local_8 + 0x1f2f) + 3);
        if (-1 < (int)uVar5) {
          FUN_006b3430(DAT_008075a8,uVar5);
        }
        thunk_FUN_005ab0a0();
