...

{
  ...
  *(undefined4 *)((int)this + 0x2b7) = 0xffffffff;
  aiStack_28[0] = Library::DKW::LIB::FUN_006aac70(0x44);
  iVar2 = 0;
  do {
  ...
  STT3DSprC::RestoreSpr
            ((STT3DSprC *)((int)this + 0x1d5),aiStack_28,(undefined4 *)((int)param_1 + 0xc6));
  ...
  piVar6 = piVar5 + 1;
  STAllPlayersC::RestoreGObjData(this,piVar6);
  iVar2 = *piVar5;
