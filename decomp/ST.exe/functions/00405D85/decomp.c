...
undefined4 __thiscall thunk_FUN_00697c50(void *this,int param_1,int param_2,int param_3)

{
  ...
  if ((((param_1 < 1) || (param_2 < 0)) || (param_3 < 0)) ||
    ...
    thunk_FUN_006a1370(*(int **)((int)this + 8),param_2,param_3,param_1,auStack_10);
