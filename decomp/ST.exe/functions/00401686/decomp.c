...
undefined4 * __cdecl thunk_FUN_0067d1d0(undefined4 *param_1)
  ...
  if (iVar1 == 0) {
    ...
    *(undefined1 *)(puStack_8 + 6) = 2;
    puVar2 = thunk_FUN_0065cb00((undefined4 *)
                                (*(int *)((int)puStack_8 + 0xfe) + 0x12a + (int)param_1));
    iVar1 = 0;
    *(undefined4 **)((int)puStack_8 + 0x106) = puVar2;
    ...
    do {
      if (*(int *)(iVar1 + 0xc2 + (int)puVar2) != 0) {
        ...
        *(undefined4 *)(iVar1 + 0xc2 + (int)puStack_8) = uVar3;
        puVar2 = puStack_8;
      }
      iVar1 = iVar1 + 0xc;
    } while (iVar1 < 0x3c);
    if (*(int *)((int)puVar2 + 0xc2) == 0) {
      ...
      *(uint **)((int)puStack_8 + 0xc2) = puVar4;
      puVar2 = puStack_8;
    }
