...
undefined4 thunk_FUN_0063f3d0(int param_1)
  ...
  if (iVar3 == 0) {
    if (*(int *)(iStack_c + 0x33a) == -1) {
      puVar4 = FUN_00709af0(DAT_00806774,0x1d,(byte *)s_expl_vc0_007d201c,0xffffffff,0,1,0,
                            (undefined4 *)0x0);
      FUN_006e8660(*(void **)(iStack_c + 0x211),(int *)&uStack_8,1,0,*(uint *)((int)puVar4 + 9),
                   *(uint *)((int)puVar4 + 0xd),(int)*(uint *)((int)puVar4 + 9) / 2,0xa9,0);
      FUN_006e98e0(*(void **)(iStack_c + 0x211),uStack_8,0,*(undefined4 *)puVar4,
      ...
      *(undefined4 *)(iStack_c + 0x342) = *(undefined4 *)puVar4;
    }
    if ((*(int *)(iStack_c + 0x353) == -1) && (param_1 != 0)) {
      puVar4 = FUN_00709af0(DAT_00806774,0x1d,(byte *)s_expl_fla_007d1f5c,0xffffffff,0,1,0,
                            (undefined4 *)0x0);
      *(ushort **)(iStack_c + 0x34b) = puVar4;
      *(undefined4 *)(iStack_c + 0x34f) = 0;
    }
    puVar1 = (uint *)(iStack_c + 0x363);
    if ((*(int *)(iStack_c + 0x363) == -1) && (param_1 != 0)) {
      puVar4 = FUN_00709af0(DAT_00806774,0x1d,(byte *)s_expl_vc1_007d2028,0xffffffff,0,1,0,
                            (undefined4 *)0x0);
      *(ushort **)(iStack_c + 0x35f) = puVar4;
      FUN_006e8660(*(void **)(iStack_c + 0x211),(int *)puVar1,1,0,*(uint *)((int)puVar4 + 9),
                   *(uint *)((int)puVar4 + 0xd),0xa8,0x43,0);
      FUN_006e98e0(*(void **)(iStack_c + 0x211),*puVar1,0,*(undefined4 *)puVar4,
                   *(int *)((int)puVar4 + 0x21),1);
      FUN_006ea270(*(void **)(iStack_c + 0x211),*puVar1,0,*(uint *)(iStack_c + 0x367));
      FUN_006ea960(*(void **)(iStack_c + 0x211),*puVar1,
                   (float)*(int *)(iStack_c + 0x266) * _DAT_007904f8 * _DAT_007904f0,
                   (float)*(int *)(iStack_c + 0x26a) * _DAT_007904f8 * _DAT_007904f0,
                   (float)*(int *)(iStack_c + 0x26e) * _DAT_007904f8 * _DAT_007904f0 + _DAT_007904fc
                  );
      FUN_006eaaa0(*(void **)(iStack_c + 0x211),*puVar1,0);
      *(undefined4 *)(iStack_c + 0x36b) = *(undefined4 *)puVar4;
    }
