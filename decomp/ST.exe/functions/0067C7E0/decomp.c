...

{
  ...
  *(undefined4 *)((int)local_10 + 0x6fe) = *(undefined4 *)((int)DAT_00802a38 + 0xe4);
  ...
  if (uVar9 < 0x5d98) {
    if (uVar9 == 0x5d97) {
      ...
      if (uVar9 == 0x10f) {
        local_14 = 0;
        pbVar4 = (byte *)thunk_FUN_00678be0(&local_14);
        bVar16 = 0xc;
        uVar9 = local_14;
        local_18 = pbVar4;
        pCVar5 = FUN_006f2c00(PTR_s_AIPLAYER_0079d6d0,2,*(undefined4 *)((int)local_10 + 0x5d7));
        thunk_FUN_0054d550(DAT_00802a38,pCVar5,pbVar4,uVar9,bVar16);
        pCVar5 = FUN_006f2c00(PTR_s_AIPLAYER_0079d6d0,2,*(undefined4 *)((int)local_10 + 0x5d7));
        uVar9 = 0xffffffff;
        do {
          pcVar11 = pCVar5;
        ...
        pcVar13 = &DAT_008087c8 + *(int *)((int)local_10 + 0x5d7) * 0x51;
        ...
        if ((&DAT_00809950)[*(int *)((int)local_10 + 0x5d7)] == '\0') {
          if (DAT_008117bc != (undefined4 *)0x0) {
            ...
            local_38[4] = 0x5deb;
            local_24 = CONCAT22(local_24._2_2_,*(undefined2 *)((int)local_10 + 0x5d7));
            if (local_10 == (void *)0x0) {
              local_20 = 0;
            }
            else {
              local_20 = (int)local_10 + 0x1c;
            }
            (**(code **)*DAT_008117bc)(local_38);
          }
          thunk_FUN_00652810((void *)((int)local_10 + 0x1c),param_1);
          if (*(int *)((int)local_10 + 0x658) == 0) {
            *(undefined4 *)((int)local_10 + 0x658) = 1;
            thunk_FUN_0067a2d0(local_10);
          }
          else {
            thunk_FUN_0067a390(local_10);
            thunk_FUN_0067b520(local_10);
            thunk_FUN_0067c180(local_10);
          }
        }
        else {
          thunk_FUN_00679470();
          ...
          local_38[2] = *(undefined4 *)(*(int *)((int)local_10 + 0xc) + 0x14);
          local_38[3] = 0;
        ...
        thunk_FUN_00678980(puVar12);
        if (DAT_007fa174 != 0) {
          thunk_FUN_004357b0(*(char *)((int)local_10 + 0x5d7),local_10);
        }
        if (puVar12[3] == 0) {
        ...
        thunk_FUN_0064a580();
        if (DAT_007fa174 != 0) {
          thunk_FUN_004357b0(*(char *)((int)local_10 + 0x5d7),0);
        }
        thunk_FUN_00678ba0((int)local_10);
      }
    }
    else if (uVar9 == 0x111) {
      iVar3 = *(int *)((int)local_10 + 0x695);
      uVar9 = 0;
      if (0 < *(int *)(iVar3 + 0xc)) {
      ...
      if (DAT_007fa174 == 0) {
        ...
        piVar6 = (int *)thunk_FUN_0042b620(CONCAT31(0x5d,*(undefined1 *)((int)local_10 + 0x5d7)),
      ...
      if (piVar6 != (int *)0x0) {
        ...
        if ((bVar15) && (iVar3 = thunk_FUN_00679e70(local_10,(short)piVar6[0x207]), iVar3 != 0)) {
    ...
    case 0x5d98:
      if (*(short *)(param_1 + 0x14) == 0) {
        thunk_FUN_00675dc0(*(uint *)((int)local_10 + 0x5d7),*(int *)(param_1 + 0x18));
      }
      else {
        local_8 = (byte *)0x0;
        ...
        if (local_8 != (byte *)0x0) {
          ...
          local_6c[1] = *(undefined4 *)((int)local_10 + 0x6fe);
          local_6c[0] = 0x72;
          local_6c[2] = 0;
          local_60 = pbVar4;
    ...
    case 0x5dd5:
      thunk_FUN_00652810((void *)((int)local_10 + 0x1c),param_1);
      if (*(int *)((int)local_10 + 0x645) + 10U <= *(uint *)((int)local_10 + 0x6fe)) {
        *(uint *)((int)local_10 + 0x645) = *(uint *)((int)local_10 + 0x6fe);
