...

{
  ...
  if (iVar2 != 0) {
    ...
    if (DAT_0080877e != '\0') {
      DVar5 = timeGetTime();
      *(DWORD *)((int)local_c + 0x1f53) = DVar5;
      thunk_FUN_005c7800();
      return;
    }
    (**(code **)(*local_c + 0x28))();
  ...
  if (*(undefined4 **)((int)local_c + 7999) != (undefined4 *)0x0) {
    FUN_006f1170(*(undefined4 **)((int)local_c + 7999));
  }
  ...
  *(undefined4 **)((int)local_c + 7999) = puVar3;
  if (*(int *)(DAT_0081176c + 0x2f4) != 0) {
    FUN_006ab060((undefined4 *)(DAT_0081176c + 0x2f4));
  }
  puVar4 = FUN_0070a5a0(*(undefined4 *)((int)local_c + 7999),0xc,PTR_s_SMALL_MAP_0079c114,2,0);
  *(ushort **)(DAT_0081176c + 0x2f4) = puVar4;
  ...
  if (DAT_0080877e == '\0') {
    *(undefined4 *)((int)local_c + 0x2121) = 0xffffffff;
    DAT_00808aab = 0xffffffff;
  }
  else {
    *(undefined4 *)((int)local_c + 0x2121) = 0;
    DAT_00808aab = 0;
  ...
  DAT_0080c4c7 = FUN_0071aa10(*(int *)((int)local_c + 7999),PTR_s_DESCRIPTION_0079c108,0);
  if (DAT_0080c4c7 == (uint *)0x0) {
  ...
  DAT_0080c4cb = FUN_0071aa10(*(int *)((int)local_c + 7999),PTR_s_OBJECTIVES_0079c10c,0);
  if (DAT_0080c4cb == (uint *)0x0) {
  ...
  local_8 = (undefined4 *)((int)local_c + 0x1f53);
  ...
  wsprintfA(&DAT_00853de4,s__s_s_s_007c6edc,&DAT_00807680,PTR_s_MISSIONS__0079c0e8,
            PTR_s_RANDOM_0079c0f4);
  *(undefined4 *)((int)local_c + 0x1f47) = 1;
  if (((DAT_0080877e != '\0') && (DAT_008067a0 != '\0')) && (DAT_00811764 != 0)) {
    FUN_006b6160((char *)((int)local_c + 0x1a5f),DAT_00811764 + 0x18);
    *(undefined1 *)((int)local_c + 0x1a7f) = 1;
    *(undefined1 *)(local_c + 0x6a0) = DAT_008087c4._2_1_;
    *(char *)((int)local_c + 0x1a81) = (char)(DAT_008087c2 >> 1);
    wsprintfA((LPSTR)&local_18,&DAT_007cc584,DAT_0080995c);
    *(undefined4 *)((int)local_c + 0x1a82) = local_18;
    *(undefined4 *)((int)local_c + 0x1a86) = local_14;
    _strncpy((char *)((int)local_c + 0x1a8a),(char *)&DAT_0080c3c3,0x1d5);
    *(undefined1 *)((int)local_c + 0x1c5e) = 0;
    CFsgsConnection::UpdateGame((CFsgsConnection *)&DAT_00802a90,4,(char *)((int)local_c + 0x1a5f));
  }
  (**(code **)(*local_c + 0x28))();
  thunk_FUN_005c4e20('\0');
  piVar9 = local_c + 0x7d8;
  puVar3 = local_38;
  for (iVar2 = 8; iVar2 != 0; iVar2 = iVar2 + -1) {
    *puVar3 = 0;
    puVar3 = puVar3 + 1;
