...

{
  ...
  if (*(undefined4 **)(local_c + 7999) != (undefined4 *)0x0) {
    cMf32::delete(this,*(undefined4 **)(local_c + 7999));
  }
  ...
  *(undefined4 **)(local_c + 7999) = puVar3;
  if (*(int *)(DAT_0081176c + 0x2f4) != 0) {
    FUN_006ab060((undefined4 *)(DAT_0081176c + 0x2f4));
  }
  puVar4 = FUN_0070a5a0(*(undefined4 *)(local_c + 7999),0xc,PTR_s_SMALL_MAP_0079c114,2,0);
  *(ushort **)(DAT_0081176c + 0x2f4) = puVar4;
  ...
  wsprintfA(&DAT_00853de4,s__s_s_s_007c6edc,&DAT_00807680,PTR_s_MISSIONS__0079c0e8,
            PTR_s_RANDOM_0079c0f4);
  *(undefined4 *)(local_c + 0x1f47) = 1;
  if (((DAT_0080877e != '\0') && (DAT_008067a0 != '\0')) && (DAT_00811764 != 0)) {
    FUN_006b6160((char *)(local_c + 0x1a5f),DAT_00811764 + 0x18);
    local_c[0x1a7f] = (SettMapTy)0x1;
    local_c[0x1a80] = DAT_008087c4._2_1_;
    local_c[0x1a81] = SUB21(DAT_008087c2 >> 1,0);
  ...
  do {
    if (*(int *)pSVar9 != 0) {
      FUN_006e6080(local_c,2,*(int *)pSVar9,local_38);
    }
    pSVar9 = pSVar9 + 4;
    iVar2 = iVar2 + -1;
  } while (iVar2 != 0);
