...

{
  ...
  if (iVar2 == 0) {
    ...
    if (*(char *)(iStack_8 + 0x18) != '\0') {
      FUN_00710a90(*(int *)(iStack_8 + 0x12a),0,0,0,0,0);
      FUN_007119c0((uint *)(iStack_8 + 0x18),0,-1,(uint)*(byte *)(iStack_8 + 0x11d));
    }
    thunk_FUN_005403c0((-(uint)(DAT_0080874e != '\x03') & 0xfffffff6) + 0x1e,DAT_00806734 + -0x1a,
                       '\x01',*(BITMAPINFO **)(iStack_8 + 0x12a));
