...
void __thiscall thunk_FUN_0063e9c0(void *this,int param_1)
...
LAB_0063eacd:
  ...
  if ((int)uVar9 < (int)(*(int *)((int)this + 700) + uVar9)) {
    do {
      ...
      if ((uStack_14 < *(uint *)(iVar10 + 0xc)) &&
         (iVar10 = *(int *)(iVar10 + 8) * uStack_14 + *(int *)(iVar10 + 0x1c), iVar10 != 0)) {
        *(int *)((int)this + 0x1c) = *(int *)((int)this + 0x1c) * 0x41c64e6d + 0x3039;
        if (param_1 == 10) {
          iVar4 = iStack_18 * *(int *)((int)this + 0x2c0) + *(int *)((int)this + 0x2b4);
        }
        else {
          iVar4 = *(int *)((int)this + 0x2c0);
          iVar4 = ((iVar4 * iVar4 * -0x5f) / 2000 - iVar4 * iStack_18) + *(int *)((int)this + 0x2b4)
          ;
        }
        ...
        *(int *)(iVar10 + 0xc) = iVar5;
        ...
        if (param_1 == 10) {
          if ((int)uStack_14 % (int)(uint)*(byte *)((int)this + 0x328) == 0) {
            iVar6 = (int)(uStack_14 - uVar9) / (int)(uint)*(byte *)((int)this + 0x328);
            if (iVar4 < 0) {
              iStack_c = (short)(((short)(iVar4 / 0xc9) + sVar8) -
                                (short)((longlong)iVar4 * 0x28c1979 >> 0x3f)) + -1;
            }
            else {
              iStack_c = (int)(short)(((short)(iVar4 / 0xc9) + sVar8) -
            ...
            if ((iStack_c != *(short *)((int)this + iVar6 * 4 + 0x2c4)) ||
               (iVar4 != *(short *)((int)this + iVar6 * 4 + 0x2c6))) {
              *(short *)((int)this + iVar6 * 4 + 0x2c4) = (short)iStack_c;
              ...
              *(short *)((int)this + iVar6 * 4 + 0x2c6) = sVar8;
              if (iVar5 < 1) {
                ...
                uStack_1c = (undefined4)(4000 / (longlong)iVar5);
              }
              iStack_10 = 0;
              do {
                if (-1 < (short)iStack_c) {
                  sVar3 = (short)iStack_10;
                  if ((((((short)iStack_c < DAT_007fb240) && (-1 < sVar8)) && (sVar8 < DAT_007fb242)
                       ) && ((-1 < sVar3 && (sVar3 < DAT_007fb244)))) &&
                     (iVar4 = *(int *)(DAT_007fb248 +
                                      ((int)sVar3 * (int)DAT_007fb246 +
                                       (int)DAT_007fb240 * (int)sVar8 + (int)(short)iStack_c) * 8),
                     iVar4 != 0)) {
                    thunk_FUN_00601d10(*(undefined4 *)((int)this + 0x259),uStack_1c,iVar4,
                                       (short)*(undefined4 *)((int)this + 0x25d),
                                       *(undefined2 *)((int)this + 0x261),0xa8,0x110);
                  }
                  if ((((short)iStack_c < DAT_007fb240) && (-1 < sVar8)) &&
                     ((sVar8 < DAT_007fb242 &&
                      (((-1 < sVar3 && (sVar3 < DAT_007fb244)) &&
                ...
                ((int)uStack_14 % (int)(uint)*(byte *)((int)this + 0x328) == 0)) {
          iVar6 = (int)(uStack_14 - uVar9) / (int)(uint)*(byte *)((int)this + 0x328);
          if (iVar4 < 0) {
            iStack_c = (short)(((short)(iVar4 / 0xc9) + sVar8) -
                              (short)((longlong)iVar4 * 0x28c1979 >> 0x3f)) + -1;
          ...
          if ((iStack_c != *(short *)((int)this + iVar6 * 4 + 0x2c4)) ||
            ...
            *(short *)((int)this + iVar6 * 4 + 0x2c6) = sVar8;
            ...
            iStack_10 = 0;
            do {
              if ((((-1 < (short)iStack_c) && ((short)iStack_c < DAT_007fb240)) && (-1 < sVar8)) &&
                 (((sVar8 < DAT_007fb242 && (sVar3 = (short)iStack_10, -1 < sVar3)) &&
                  ((sVar3 < DAT_007fb244 &&
                   (iVar4 = *(int *)(DAT_007fb248 +
                                    ((int)sVar3 * (int)DAT_007fb246 + (int)DAT_007fb240 * (int)sVar8
                                    + (int)(short)iStack_c) * 8), iVar4 != 0)))))) {
                thunk_FUN_00601d10(*(undefined4 *)((int)this + 0x259),uStack_1c,iVar4,
                                   (short)*(undefined4 *)((int)this + 0x25d),
                                   *(undefined2 *)((int)this + 0x261),0xa8,0x110);
              }
    ...
    } while ((int)uStack_14 < (int)(uVar9 + *(int *)((int)this + 700)));
  }
  iVar10 = *(int *)((int)this + 0x2c0) + 1;
  *(int *)((int)this + 0x2c0) = iVar10;
  if ((1 < *(uint *)((int)this + 0x245)) && (*(uint *)((int)this + 0x245) == 2)) {
    *(int *)((int)this + 0x2b8) =
         (*(int *)((int)this + 0x2b4) - (iVar10 * iVar10 * 0x5f) / 2000) - iVar10 * iStack_18;
    return;
  }
  *(int *)((int)this + 0x2b8) = iVar10 * iStack_18 + *(int *)((int)this + 0x2b4);
  return;
}
