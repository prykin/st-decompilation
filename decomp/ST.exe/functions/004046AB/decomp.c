...
thunk_FUN_0061b340(void *this,int param_1,int param_2,int param_3,int param_4,int param_5,
  ...
  if ((-1 < param_1) && (-1 < param_2)) {
    ...
    if (((param_1 < DAT_007fb240) && (param_2 < DAT_007fb242)) && (param_3 < 5)) {
      ...
      if (CONCAT31(extraout_var,bVar7) == 0) {
        iStack_10 = *(int *)((int)this + 0xa7) - *(int *)((int)this + 0xe3);
        ...
        if (((((uint)piVar4[9] < 8) &&
          ...
          _bStack_c = CONCAT31(uStack_b,bVar1);
          iStack_10 = CONCAT31(iStack_10._1_3_,bVar2);
          if (DAT_00808a8f == '\0') {
            if (bVar1 == bVar2) {
LAB_0061b627:
              iVar8 = 0;
      ...
      bVar1 = *(byte *)(piVar4 + 9);
      bVar2 = *(byte *)((int)this + 0x51);
      iStack_10 = CONCAT31(iStack_10._1_3_,bVar1);
