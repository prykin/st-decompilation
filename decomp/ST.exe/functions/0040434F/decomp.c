...

{
  ...
  if (iVar2 == 0) {
    DAT_008016e0 = iStack_8;
    iVar2 = DAT_00806730 + -0x1c;
    *(int *)(iStack_8 + 0x3c) = iVar2;
    *(int *)(iStack_8 + 0x174) = (*(int *)(iStack_8 + 0x40) - iVar2) + DAT_00806730;
    ...
    *(ushort **)(iStack_8 + 0x180) = puVar5;
    thunk_FUN_00540760(*(undefined4 **)(iStack_8 + 0x68),0,0,'\x01',(byte *)puVar5);
    FUN_00710a90(*(int *)(iStack_8 + 0x68),0,0x52,2,0xd1,0xc);
    iVar11 = -1;
    iVar10 = -1;
    uVar8 = 0;
    iVar7 = -1;
    ...
    FUN_00711b70(puVar6,iVar2,iVar7,uVar8,iVar10,iVar11);
    pCVar4 = thunk_FUN_00571240(s_BUT_MEDIUM_007c3894,0);
    uVar8 = thunk_FUN_00538690(0,1,0x115,0x8b,1,0,1,pCVar4,0xbfff,0xc000,0,0,0,(char *)0x0,1);
    *(undefined4 *)(iStack_8 + 0x184) = uVar8;
