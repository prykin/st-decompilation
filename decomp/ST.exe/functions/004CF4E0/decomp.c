...

{
  ...
  if (*(int *)((int)this + 0x361) != 0) {
    thunk_FUN_004c90c0((int)this);
  }
  if (*(int *)((int)this + 0x3d8) <= *(int *)((int)this + 0x3d4) + 1) {
    iVar1 = *(int *)((int)this + 0x3d8) + 0x14;
    *(int *)((int)this + 0x3d8) = iVar1;
    iVar1 = FUN_006acf50(*(undefined4 **)((int)this + 0x607),iVar1 * 0x27);
    *(int *)((int)this + 0x607) = iVar1;
  }
  FUN_0072da70((undefined4 *)((int)*(undefined4 **)((int)this + 0x607) + 0x27),
  ...
  *(undefined1 *)(iVar1 + 0x26) = 0;
  if (param_6 != (char *)0x0) {
    _strncpy((char *)(*(int *)((int)this + 0x607) + 0x18),param_6,0xf);
  }
