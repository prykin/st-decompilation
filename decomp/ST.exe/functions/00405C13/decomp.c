...
int __fastcall
thunk_FUN_0065e070(int param_1,undefined4 param_2,uint param_3,uint param_4,uint param_5,
...

{
  ...
  iStack_14 = 0;
  thunk_FUN_0044e260(CONCAT31((int3)((uint)aiStack_4c >> 8),*(undefined1 *)(param_1 + 0x24)),
                     CONCAT22((short)((uint)param_2 >> 0x10),uVar2),param_3,aiStack_4c);
  ...
  param_6 = cVar3;
  piStack_10 = aiStack_4c;
  uStack_c = 0;
  do {
    pbStack_1c = (byte *)*piStack_10;
    if (pbStack_1c != (byte *)0x0) {
      uStack_18 = 0;
      if (0 < *(int *)(pbStack_1c + 0xc)) {
        bVar12 = *(int *)(pbStack_1c + 0xc) != 0;
        do {
          if (bVar12) {
            puVar4 = (undefined2 *)
                     (*(int *)(pbStack_1c + 8) * uStack_18 + *(int *)(pbStack_1c + 0x1c));
          }
          else {
          ...
          thunk_FUN_004162b0(piVar5,&uStack_8,&uStack_6,(undefined2 *)((int)&param_3 + 2));
          if (param_5 != 0) {
            if (uVar6 == 0x78) {
...
LAB_0065e27e:
          ...
          bVar12 = uStack_18 < *(uint *)(pbStack_1c + 0xc);
        } while ((int)uStack_18 < (int)*(uint *)(pbStack_1c + 0xc));
      }
