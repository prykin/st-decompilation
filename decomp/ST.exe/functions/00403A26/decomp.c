...
uint __thiscall
thunk_FUN_006308f0(void *this,int param_1,int param_2,int param_3,int param_4,undefined4 param_5,
                  int param_6)

{
  ...
  uVar5 = 0xffffffff;
  iVar4 = (DAT_007fb240 * param_3 + param_2) * (int)DAT_007fb242 + param_1;
  iStack_8 = 0;
  if (param_4 == 1) {
    ...
    if (*(char *)(iVar3 + iStack_8) != '\0') {
      return 0xffffffff;
    }
    cVar1 = *(char *)(iVar3 + 1 + iStack_8);
  }
  if (cVar1 == '\0') {
    ...
    if ((puVar2 != (uint *)0x0) && (puVar2[3] < 0xfe)) {
      ...
      uStack_1a = (undefined2)param_4;
      uStack_18 = param_5;
      uStack_14 = *(undefined4 *)(DAT_00802a38 + 0xe4);
      sStack_20 = (short)param_1;
      ...
      if (-1 < (int)uVar5) {
        if (param_4 == 1) {
          ...
          *(undefined1 *)(*(int *)((int)this + 0x34) + iStack_8) = 1;
          *(undefined1 *)(*(int *)((int)this + 0x34) + 1 + iStack_8) = 1;
        }
