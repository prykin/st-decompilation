...
undefined4 __cdecl
thunk_FUN_0060e680(uint param_1,uint param_2,uint param_3,uint param_4,uint param_5,uint param_6,
  ...
  if ((iVar5 < iVar3) &&
    ...
    if ((iVar2 < param_7[2]) &&
      ...
      do {
        ...
        uStack_c = uVar8;
        uStack_10 = uVar4;
        uVar8 = (int)(uStack_c - param_2) / 2 + param_2;
        uVar7 = (int)(uStack_8 - uVar6) / 2 + uVar6;
        uVar4 = (int)(uStack_10 - param_6) / 2 + param_6;
        param_4 = param_4 - 1;
      } while (param_4 != 0);
      *param_9 = uVar7;
      *param_10 = uVar8;
