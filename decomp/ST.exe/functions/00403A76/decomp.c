...
LAB_0056f325:
  if ((param_1 != '\0') || (abStack_1a8[0] != 0)) {
    ...
    iVar3 = Library::MSVCRT::__setjmp3(IStack_a4.jumpBuffer,0,unaff_EDI,unaff_ESI);
    if (iVar3 == 0) {
      if ((param_1 == '\0') || (this_00 = extraout_ECX, param_1 == '\x03')) {
        pcStack_14 = (cMf32 *)FUN_006f0ec0(0x345,abStack_1a8,1,0,0);
        this_00 = extraout_ECX_00;
      }
      pcVar7 = pcStack_14;
      if ((param_1 == '\0') || (param_1 == '\x03')) {
        FUN_006efdb0(DAT_00806750,(int)pcStack_14,s_3D_MAP_007ca1e4,'\x01');
        pvVar2 = pvStack_10;
        ...
        if ((iVar3 == 0) && (*(uint **)((int)pvStack_10 + 0x4ea7) != (uint *)0x0)) {
          FUN_0071ab30(*(uint **)((int)pvStack_10 + 0x4ea7),(int)pcStack_14,
        ...
        if (DAT_00807598 != (void *)0x0) {
          ...
          if (pbStack_c != (byte *)0x0) {
            ...
            cMf32::RecPut(pcVar7,0xc,PTR_s_SMALL_MAP_0079b084,pbStack_c,uVar4,puVar12,cVar13,puVar14
                         );
        ...
        cMf32::RecPut(pcVar7,0x80,PTR_s_SAVE_PLAYER_0079b058,&bStack_1c,7,(undefined4 *)0x0,'\0',
                      (uint *)0x0);
        ...
        cMf32::RecPut(pcVar7,0x80,PTR_s_SAVE_DESC_0079b054,(byte *)&uStack_8,4,(undefined4 *)0x0,
                      '\0',(uint *)0x0);
