...
thunk_FUN_005ed1c0(void *this,int *param_1,int *param_2,int *param_3,int *param_4)

{
  ...
  *param_4 = iVar7;
  ...
  if (*(int *)((int)this + 0x26f) - iVar10 < 1) {
    iStack_8 = -(uint)(*(int *)((int)this + 0x26f) != iVar10);
  }
  else {
    iStack_8 = 1;
  }
...
LAB_005ed68c:
  ...
  if ((iVar7 + 0x1e < iVar10) && (0 < iStack_8)) {
...
joined_r0x005ed4b7:
    ...
    if ((iVar7 + -0x1e <= iVar10) || (-1 < iStack_8)) {
      if (((0 < iStack_8) && (*(int *)((int)this + 0x26f) <= iVar10)) ||
         ((iStack_8 < 0 && (iVar10 <= *(int *)((int)this + 0x26f))))) {
        *(undefined4 *)((int)this + 0x287) = 0;
        *param_1 = *(int *)((int)this + 0x277);
        *param_2 = *(int *)((int)this + 0x27b);
        *param_3 = *(int *)((int)this + 0x26f);
