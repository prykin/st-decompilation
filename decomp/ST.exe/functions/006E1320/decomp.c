...

{
  ...
  Library::Ourlib::STREND::FUN_006dd050(this,*(uint *)&this->field_0xa8,*param_1,*param_2);
  dVar1 = local_14;
  ...
  *param_4 = (local_2c - local_3c) + 0x8000 >> 0x10;
  ...
  Library::Ourlib::STREND::FUN_006dd050(this,*(uint *)&this->field_0xa8,local_c,dVar1);
  return;
}
