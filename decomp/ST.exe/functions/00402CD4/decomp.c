...

{
  ...
  pCStack_10 = this;
  iVar4 = Library::MSVCRT::__setjmp3(IStack_250.jumpBuffer,0,unaff_EDI,unaff_ESI);
  this_01 = pCStack_10;
  if (iVar4 != 0) {
  ...
  case (ChooseMapTy)0x5:
    ...
    uStack_c = ~uStack_c;
    pCVar16 = (ChooseMapTy *)(pcVar15 + -uStack_c);
    iVar4 = -1;
    pCVar17 = pCVar13;
    do {
      pCVar13 = pCVar17;
...
LAB_005ab4e5:
  ...
  *(undefined4 *)(*(int *)(this_01 + 0x1a5b) + 0x140) = 0x1f;
  FUN_00718780((int)auStack_86c,0,0x100,0x8b,0x15,(undefined4 *)(*(int *)(this_01 + 0x1a5b) + 0x144)
              );
...
switchD_005ab66b_caseD_6:
      ...
      default:
        ...
        *(undefined1 *)((int)puVar9 + 2) = 0;
        uStack_13c = *(undefined4 *)(this_01 + 8);
      ...
      if (*(int *)(iVar4 + 0x2e6) != 0) {
        ...
        *(undefined2 *)puVar9 = 0xffff;
        MMsgTy::SetPanel(*(MMsgTy **)(iVar4 + 0x2e6),0,(int)&uStack_20c,0,0);
        MMsgTy::StatePanel(*(MMsgTy **)(*(int *)(this_01 + 0x1a5b) + 0x2e6),(int)auStack_26c);
      }
