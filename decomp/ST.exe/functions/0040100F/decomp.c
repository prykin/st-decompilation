...

{
  ...
  if ((*(char *)((int)pvStack_c + 0x6d) == '\x03') || (*(char *)((int)pvStack_c + 0x6d) == '\x05'))
  {
    thunk_FUN_005e1330();
  }
  iVar3 = *(int *)((int)pvStack_c + 0x647);
  if (iVar3 != 0) {
    uVar7 = 0;
    if (*(int *)(iVar3 + 0xc) != 0) {
      if (*(int *)(iVar3 + 0xc) == 0) {
...
LAB_005e0b38:
        if (((-1 < (int)*puVar8) && (*(int *)((int)puVar8 + 0x3a) != 0)) &&
          ...
          if ((puVar8[7] - 3 < puVar8[4]) &&
             (puVar8[10] < *(int *)((int)pvStack_c + 0x69) - puVar8[9])) {
            if (puVar8[4] < puVar8[7]) {
              ...
              puVar8[4] = puVar8[4] + 1;
              puVar8[9] = *(uint *)((int)pvStack_c + 0x69);
            }
            else {
...
LAB_005e0d20:
        ...
        if (uVar7 != 0xffffffff) {
          ...
          case 1:
            if (*(uint *)(iVar3 + 0x40) <=
                (uint)(*(int *)((int)pvStack_c + 0x69) - *(int *)(iVar3 + 0x44))) {
              uVar4 = *(int *)(iVar3 + 8) + 1;
              *(uint *)(iVar3 + 8) = uVar4;
              *(undefined4 *)(iVar3 + 0x44) = *(undefined4 *)((int)pvStack_c + 0x69);
...
LAB_005e0edd:
        ...
        iVar3 = *(int *)((int)pvStack_c + 0x64b);
        uStack_8 = uVar6 + 1;
      } while (uStack_8 < *(uint *)(iVar3 + 0xc));
    }
  }
  *(int *)((int)pvStack_c + 0x69) = *(int *)((int)pvStack_c + 0x69) + 1;
  DAT_00858df8 = (undefined4 *)uStack_50;
  return;
}
