          ...
          if (iVar15 <= iVar8 + 8) {
            do {
              if (((-1 < iVar15) && (iVar15 < DAT_007fb240)) &&
                ...
                local_3c = (*(int *)(this_00 + 0x5b8) - local_24) + -1;
                if (local_3c <= *(int *)(this_00 + 0x5b8) + 1 + local_24) {
                  do {
...
LAB_004c41a5:
                    ...
                    local_3c = local_3c + 1;
                  } while (local_3c <= *(int *)(this_00 + 0x5b8) + 1 + local_24);
                }
              }
              iVar8 = *(int *)(this_00 + 0x5b0);
              iVar15 = iVar15 + 1;
