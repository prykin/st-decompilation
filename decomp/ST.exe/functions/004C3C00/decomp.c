...

{
  ...
  uint uVar12;
  short sVar13;
  AnonPointee_TLOBaseTy_0000 **ppAVar14;
  int iVar15;
  bool bVar16;
  ...
  short local_14;
  short local_12;
  AnonPointee_TLOBaseTy_0000 **local_10;
  short local_a;
  STFishC *local_8;
  ...
  if (iVar7 != 0) {
    ...
    iVar15 = ReportDebugMessage("E:\\__titans\\Artem\\TLO_bfire.cpp",0x126,0,iVar7,
  ...
  ppAVar14 = &local_60->vtable + param_1 * 0x20;
  *(undefined4 *)((int)ppAVar14 + 0x28d) = 0;
  *(AnonPointee_TLOBaseTy_0291 **)((int)ppAVar14 + 0x291) = (AnonPointee_TLOBaseTy_0291 *)0x0;
          ...
          if (iVar15 <= iVar8 + 8) {
            do {
              if (((-1 < iVar15) && (iVar15 < g_worldGrid.sizeX)) &&
                 (local_28 = iVar15, iVar8 = FUN_006aced8(iVar15,iVar7,iVar8,this_00->field_05B4),
                 iVar8 <= local_58)) {
                local_24 = iVar8 / 3;
                  ...
                  do {
                    if ((-1 < local_3c) && (local_3c < 5)) {
                      ...
                      if (((((TLOBaseTy *)local_8 != (TLOBaseTy *)0x0) &&
                          ...
                          (iVar8 = (*(code *)((TLOBaseTy *)local_8)->vtable->field_00F8)(),
                        ...
                        if ((int)(((uVar9 ^ uVar12) - uVar12) * 10) / iVar8 <=
                          ...
                          *(uint *)((int)local_10 + 0x295) = PTR_00802a38->field_00E4;
                          if ((param_2 == 0) || (this_00->field_0255 == 0)) goto LAB_004c4080;
                          /* ST_PSEUDO[raw_indirect_call]: expected typed vtable/callback call with explicit __thiscall receiver */
                          sVar6 = (*(code *)this_00->vtable->field_0010)
                          ...
                          if ((int)((*(uint *)(&DAT_007be8c8 +
                                              ((int)this_00->field_0259 / 0xf + iVar8 * 0x18) * 4) ^
                                    uVar9) - uVar9) <= *(int *)((int)local_10 + 0x279)) {
...
LAB_004c41a5:
                                    ...
                                    if (iVar8 != 0) {
                                      ...
                                      if (((local_20 == (STFishC *)0x0) || (local_6c < iVar11)) ||
                                         ((iVar11 == local_6c &&
                                          (ppAVar14 = local_10, iVar8 < local_5c)))) {
                                        local_20 = local_8;
                                        *(int *)((int)ppAVar14 + 0x2d5) = (int)local_12;
                                        *(int *)((int)ppAVar14 + 0x2d9) = (int)local_14;
                                        *(int *)((int)ppAVar14 + 0x2dd) = (int)local_a;
                                        local_6c = iVar11;
                                        local_5c = iVar8;
                                      }
                                    }
...
LAB_004c42b5:
  if (local_20 != (STFishC *)0x0) {
    *(undefined4 *)((int)ppAVar14 + 0x28d) = local_20->field_0018;
    *(STFishC **)((int)ppAVar14 + 0x291) = local_20;
    if ((((*(byte *)((int)ppAVar14 + 0x265) & 2) != 0) &&
        (*(int *)((int)ppAVar14 + 0x28d) != *(int *)((int)ppAVar14 + 0x26d))) &&
       (iVar7 = FUN_006e62d0(PTR_00802a38,*(int *)((int)ppAVar14 + 0x26d),(int *)&local_8),
       iVar7 != 0)) {
      *(uint *)((int)ppAVar14 + 0x265) = *(uint *)((int)ppAVar14 + 0x265) & 0xfffffffd;
      *(undefined4 *)((int)ppAVar14 + 0x26d) = 0;
    }
  }
  g_currentExceptionFrame = local_b8.previous;
  return 0;
