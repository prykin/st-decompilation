          ...
          if (iVar15 <= iVar8 + 8) {
            do {
              if (((-1 < iVar15) && (iVar15 < g_worldGrid.sizeX)) &&
                ...
                local_3c = (*(int *)&this_00->field_0x5b8 - local_24) + -1;
                if (local_3c <= *(int *)&this_00->field_0x5b8 + 1 + local_24) {
                  do {
...
LAB_004c41a5:
                                    ...
                                    iVar15 = local_28;
                                    if (iVar8 != 0) {
                                      iVar8 = FUN_006aadd0(*(int *)&this_00->field_0x5b0,
                                                           *(int *)&this_00->field_0x5b4,
                                      ...
                                      if (((local_20 == (STFishC *)0x0) || (local_6c < iVar11)) ||
                                        ...
                                        local_20 = local_8;
                                        *(int *)((int)ppTVar14 + 0x2d5) = (int)local_12;
                                        *(int *)((int)ppTVar14 + 0x2d9) = (int)local_14;
                                        *(int *)((int)ppTVar14 + 0x2dd) = (int)local_a;
                                        local_6c = iVar11;
                                        local_5c = iVar8;
                                      }
                                    }
                    ...
                    local_3c = local_3c + 1;
                  } while (local_3c <= *(int *)&this_00->field_0x5b8 + 1 + local_24);
                }
              }
              iVar8 = *(int *)&this_00->field_0x5b0;
              iVar15 = iVar15 + 1;
        ...
        ppTVar14 = local_10;
        local_18 = iVar7;
      } while (iVar7 <= *(int *)&this_00->field_0x5b4 + 8);
    }
  }
LAB_004c42b5:
