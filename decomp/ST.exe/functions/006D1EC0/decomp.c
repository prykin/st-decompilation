...
LAB_006d2041:
          ...
          if ((iVar3 < param_4) || (iVar7 = param_4 + param_6, iVar7 < iVar2)) goto LAB_006d2041;
...
LAB_006d2188:
              if ((param_5 != piVar1[2]) || (param_3 != *piVar1)) goto LAB_006d2041;
              if (param_4 == iVar3) {
LAB_006d244b:
                param_4 = piVar1[1];
              }
              else {
                if (iVar7 != iVar2) goto LAB_006d2041;
...
LAB_006d2232:
            ...
            if (iVar11 == param_4) {
              ...
              if (iVar3 < iVar7) goto LAB_006d22c3;
              param_6 = param_6 - iVar9;
              bVar14 = param_6 < 0;
              bVar13 = param_6 == 0;
            }
LAB_006d2038:
          ...
          if (iVar9 == param_6) {
            ...
            else if (iVar5 < iVar6) goto LAB_006d22c3;
...
LAB_006d22c3:
            ...
            if (iVar5 < iVar6) goto LAB_006d22c3;
            iVar4 = piVar1[2] - iVar4;
            piVar1[2] = iVar4;
            if (0 < iVar4) goto LAB_006d2041;
            if (local_c < local_10) {
              piVar10 = piVar1 + 4;
              piVar12 = piVar1;
              for (iVar5 = ((local_8 - local_c) - 1U & 0xfffffff) << 2; iVar5 != 0;
