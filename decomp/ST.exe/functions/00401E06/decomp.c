...
undefined4 __thiscall thunk_FUN_00427090(void *this,int param_1,int param_2,int param_3)

{
  ...
  if (param_3 == 0) {
    ...
    iStack_c = param_2 * 0x10;
    iVar7 = thunk_FUN_004248d0(this,iVar3,iVar5,*(int *)(iStack_c + DAT_007f4d74) + DAT_007f4d7c,
                               DAT_007f4d80 + param_2,1,0xffffffff);
    param_3 = thunk_FUN_004248d0(this,iVar3,iVar7,
                                 *(int *)(iStack_c + 0xc + DAT_007f4d74) + DAT_007f4d7c,
                                 DAT_007f4d80 + param_2,3,0xffffffff);
    iVar7 = DAT_007f4d74;
    if (param_1 < param_2) {
      do {
        iVar9 = *(int *)(iVar7 + 0xc + iStack_c);
        if ((iVar9 < *(int *)(iVar7 + -4 + iStack_c)) && (param_2 != iVar6)) {
          param_3 = thunk_FUN_004248d0(this,iVar3,param_3,iVar9 + DAT_007f4d7c,
                                       DAT_007f4d80 + param_2,3,0xffffffff);
          iVar7 = DAT_007f4d74;
        }
        iVar9 = *(int *)(iVar7 + 0xc + iStack_c);
        if (*(int *)(iVar7 + -4 + iStack_c) < iVar9) {
          param_3 = thunk_FUN_004248d0(this,iVar3,param_3,iVar9 + DAT_007f4d7c,
...
LAB_004278f1:
    ...
    if (param_3 == -1) {
      ...
      iVar7 = thunk_FUN_004248d0(this,iVar3,iVar5,*(int *)(iStack_c + DAT_007f4d74) + DAT_007f4d7c,
                                 DAT_007f4d80 + param_2,1,0xffffffff);
      param_3 = thunk_FUN_004248d0(this,iVar3,iVar7,
                                   *(int *)(iStack_c + 4 + DAT_007f4d74) + DAT_007f4d7c,
                                   DAT_007f4d80 + param_2,3,0xffffffff);
      iVar7 = DAT_007f4d74;
      if (param_1 < param_2) {
        do {
          iVar9 = *(int *)(iStack_c + 4 + iVar7);
          if ((iVar9 < *(int *)(iStack_c + -0xc + iVar7)) && (param_2 != iVar6)) {
            param_3 = thunk_FUN_004248d0(this,iVar3,param_3,iVar9 + DAT_007f4d7c,
                                         DAT_007f4d80 + param_2,3,0xffffffff);
            iVar7 = DAT_007f4d74;
          }
          iVar9 = *(int *)(iStack_c + 4 + iVar7);
          if (*(int *)(iStack_c + -0xc + iVar7) < iVar9) {
            param_3 = thunk_FUN_004248d0(this,iVar3,param_3,iVar9 + DAT_007f4d7c,
                                         DAT_007f4d80 + param_2,2,0xffffffff);
            iVar7 = DAT_007f4d74;
          }
    ...
    iStack_c = param_2 * 0x10;
    iVar7 = thunk_FUN_004248d0(this,iVar3,iVar5,*(int *)(iStack_c + 8 + DAT_007f4d74) + DAT_007f4d7c
                               ,DAT_007f4d80 + param_2,1,0xffffffff);
    param_3 = thunk_FUN_004248d0(this,iVar3,iVar7,
                                 *(int *)(iStack_c + 0xc + DAT_007f4d74) + DAT_007f4d7c,
                                 DAT_007f4d80 + param_2,3,0xffffffff);
    ...
    if (param_1 < param_2) {
      do {
        iVar9 = *(int *)(iStack_c + 0xc + iVar7);
        if ((iVar9 < *(int *)(iStack_c + -4 + iVar7)) && (param_2 != iVar6)) {
          param_3 = thunk_FUN_004248d0(this,iVar3,param_3,iVar9 + DAT_007f4d7c,
                                       DAT_007f4d80 + param_2,3,0xffffffff);
          iVar7 = DAT_007f4d74;
        }
        iVar9 = *(int *)(iStack_c + 0xc + iVar7);
        if (*(int *)(iStack_c + -4 + iVar7) < iVar9) {
          param_3 = thunk_FUN_004248d0(this,iVar3,param_3,iVar9 + DAT_007f4d7c,
                                       DAT_007f4d80 + param_2,2,0xffffffff);
          iVar7 = DAT_007f4d74;
        }
  ...
  iStack_8 = param_1 * 0x10;
  iVar6 = *(int *)(iStack_8 + 0xc + iVar7);
LAB_00427930:
