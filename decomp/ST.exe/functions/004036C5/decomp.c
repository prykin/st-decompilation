...
undefined4 __thiscall thunk_FUN_0049f100(void *this,int param_1)

{
  ...
  uStack_c = *(uint *)(*(int *)((int)this + 0x29) + 0xc);
  puStack_18 = (uint *)0x0;
  puStack_20 = (uint *)0x0;
  iStack_1c = 0;
  uStack_24 = 2;
  ...
  if ((param_1 == 0) || (uVar9 = extraout_EDX, uVar10 = extraout_var, param_1 == 1)) {
    puVar13 = (undefined4 *)((int)pvStack_38 + 0x89);
    for (iVar4 = 0x15; iVar4 != 0; iVar4 = iVar4 + -1) {
      *puVar13 = 0;
      puVar13 = puVar13 + 1;
    }
    *(undefined4 *)((int)pvStack_38 + 0x65) = 0;
    uStack_10 = 0;
    *(undefined4 *)((int)pvStack_38 + 0x2c3) = *(undefined4 *)((int)pvStack_38 + 0x192);
    *(undefined2 *)((int)pvStack_38 + 0x2c7) = *(undefined2 *)((int)pvStack_38 + 0x196);
    *(undefined1 *)((int)pvStack_38 + 0x2c9) = *(undefined1 *)((int)pvStack_38 + 0x198);
    uStack_2c = *(undefined1 *)((int)pvStack_38 + 0x192);
    uStack_2b = *(undefined2 *)((int)pvStack_38 + 0x193);
    *(undefined4 *)((int)pvStack_38 + 0x2ca) = 0;
    uStack_30 = *(undefined4 *)(DAT_00802a38 + 0xe4);
    uStack_29 = *(undefined4 *)((int)pvStack_38 + 0x195);
    puVar6 = puStack_20;
    uStack_14 = uStack_30;
    if (uStack_c != 0) {
      uVar11 = 0;
...
LAB_0049f2b2:
    ...
    puVar3 = puStack_18;
    thunk_FUN_00445a40(CONCAT31((int3)(uStack_c >> 8),*(undefined1 *)((int)pvVar2 + 0x24)),puVar6,
                       puStack_18);
  ...
  uVar11 = 0;
  if (*(int *)((int)pvVar2 + 0x2ca) == 0) {
    piVar5 = (int *)thunk_FUN_0042b620(CONCAT31((int3)((uint)uVar9 >> 8),
                                                *(undefined1 *)((int)pvVar2 + 0x2c3)),
                                       CONCAT22(uVar10,*(undefined2 *)((int)pvVar2 + 0x2c4)),1);
    if (((piVar5 == (int *)0x0) || (piVar5[6] != *(int *)((int)pvVar2 + 0x2c6))) ||
       (iVar4 = (**(code **)(*piVar5 + 0x108))((int)*(char *)((int)pvVar2 + 0x24)), iVar4 == 0)) {
      *(undefined4 *)((int)pvVar2 + 0x2ca) = 1;
      uStack_10 = 0;
...
LAB_0049f3f5:
    ...
    if (0 < (int)uStack_c) {
      uVar12 = 0;
      do {
        FUN_006acc70(*(int *)((int)pvVar2 + 0x29),uVar12,&uStack_8);
        if ((short)uStack_8 != -1) {
