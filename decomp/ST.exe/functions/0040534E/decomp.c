...
undefined4 thunk_FUN_004e7980(uint *param_1,int param_2,undefined1 param_3)
...
LAB_004e7b13:
      ...
      if (*piVar13 != 0) {
        _param_3 = 0;
        param_2 = 5;
        puStack_1c = (undefined4 *)((int)&DAT_00800bd0 + iStack_c * 5);
        do {
          ...
          if (*(int *)((int)piVar13 + param_2) != 0) {
            ...
            do {
              ...
              if ((*puVar9 == *param_1) && ((char)puVar9[1] == (char)param_1[1])) {
                *puStack_1c = *(undefined4 *)((int)piVar13 + _param_3);
                *(undefined1 *)(puStack_1c + 1) = *(undefined1 *)((int)piVar13 + _param_3 + 4);
                iStack_c = iStack_c + 1;
                puStack_1c = (undefined4 *)((int)puStack_1c + 5);
                break;
              }
