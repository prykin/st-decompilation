...

{
  ...
  if (pHVar5 != (HoloTy *)0x0) {
    ...
    uVar8 = HoloTy::Init(this_00->field_21E8,CASE_2,0x112,0x38,iVar4,iVar7,uVar8,cVar9,uVar10);
    if (uVar8 != 0) {
  ...
  if (pHVar5 != (HoloTy *)0x0) {
    ...
    uVar8 = HoloTy::Init(this_00->field_21F4,CASE_2,0x112,0x149,iVar4,iVar7,uVar8,cVar9,uVar10);
    if (uVar8 != 0) {
  ...
  if ((((this_00->field_0x21e2 == '\0') || (SVar1 = this_00->field_1E26, SVar1 == 6)) ||
    ...
    if (pHVar5 != (HoloTy *)0x0) {
      ...
      uVar8 = HoloTy::Init(this_00->field_21EC,CASE_4,10,0xb4,iVar4,iVar7,uVar8,cVar9,uVar10);
      if (uVar8 != 0) {
  ...
  if ((this_00->field_0x21e3 != '\0') &&
    ...
    if (pHVar5 != (HoloTy *)0x0) {
      ...
      uVar8 = HoloTy::Init(this_00->field_21F0,CASE_4,10,0xb4,iVar4,iVar7,uVar8,cVar9,uVar10);
      if (uVar8 != 0) {
