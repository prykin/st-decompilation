...

{
  ...
  if (iVar3 != 0) {
    ...
    iVar7 = FUN_006ad4d0(s_E____titans_Start_sett_obj_cpp_007cd0e8,0x3a4,0,iVar3,&DAT_007a4ccc);
    if (iVar7 != 0) {
      pcVar2 = (code *)swi(3);
      (*pcVar2)();
      return;
    }
    FUN_006a5e40(iVar3,0,0x7cd0e8,0x3a4);
    return;
  }
  if (DAT_00802a30 != 0) {
  ...
  this_00 = local_10;
  if (*(uint *)(local_10 + 0x215d) != 0) {
    FUN_006e56b0(*(void **)(local_10 + 0xc),*(uint *)(local_10 + 0x215d));
  }
