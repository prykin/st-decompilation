...

{
  ...
  if (iVar9 == 0) {
    ...
    *ppuVar1 = puVar5;
    DibPut((AnonShape_006B84D0_7C7D97C6 *)this_00->field_0068,0,0,'\x01',(byte *)puVar5);
    ...
    if (DAT_00808783 != '\x03') {
      ...
      puVar5 = cMf32::RecGet(DAT_00806790,1,pCVar6,piVar23,iVar9);
      *ppuVar1 = puVar5;
      DibPut((AnonShape_006B84D0_7C7D97C6 *)this_00->field_0068,0x20,0xa4,'\x01',(byte *)puVar5);
      cMf32::RecMemFree(DAT_00806790,(uint *)ppuVar1);
    }
    iVar9 = 1;
    piVar23 = (int *)0x0;
    ...
    *ppuVar1 = puVar5;
    ...
    iVar22 = -1;
    iVar9 = -2;
    puVar7 = (uint *)FUN_006b0140(0x2733,HINSTANCE_00807618);
