...

{
  ...
  if (iVar8 == 0) {
    ...
    bVar18 = 0;
    uVar17 = 0xffffffff;
    pCVar5 = thunk_FUN_00571240(s_GAMEB_ALLY_007c75f8,0);
    puVar4 = Library::Ourlib::MFRLOAD::mfRLoad
    ...
    uVar17 = *(uint *)(iVar8 + 0x14);
    if (uVar17 == 0) {
      uVar17 = ((uint)*(ushort *)(iVar8 + 0xe) * *(int *)(iVar8 + 4) + 0x1f >> 3 & 0x1ffffffc) *
               *(int *)(iVar8 + 8);
    }
    puVar24 = (undefined4 *)FUN_006b4fa0(iVar8);
    ...
    *ppuVar1 = puVar4;
    ...
    iVar21 = -1;
    iVar8 = -2;
    puVar6 = (uint *)FUN_006b0140(0x2733,HINSTANCE_00807618);
