...

{
  ...
  if (iVar8 == 0) {
    ...
    *(ushort **)((int)local_14 + 0x1d5) = puVar3;
    puVar2 = (undefined4 *)0x0;
    iVar22 = 0;
    iVar8 = 1;
    bVar19 = 0;
    ...
    puVar3 = FUN_00709af0(DAT_00806794,0xb,pbVar4,uVar18,bVar19,iVar8,iVar22,puVar2);
    *(ushort **)((int)local_14 + 0x1d9) = puVar3;
    iVar8 = *(int *)((int)local_14 + 0x68);
    ...
    puVar6 = (uint *)((int)local_14 + 0x1cd);
    *puVar6 = (uint)puVar3;
    thunk_FUN_00540760(*(undefined4 **)((int)local_14 + 0x68),0,0,'\x01',(byte *)puVar3);
    FUN_006f20e0(puVar6);
    if (DAT_00808783 != '\x03') {
      iVar8 = 1;
      piVar23 = (int *)0x0;
      ...
      puVar3 = FUN_006f1ce0(1,pCVar5,piVar23,iVar8);
      *puVar6 = (uint)puVar3;
      thunk_FUN_00540760(*(undefined4 **)((int)local_14 + 0x68),0x20,0xa4,'\x01',(byte *)puVar3);
      FUN_006f20e0(puVar6);
    }
    iVar8 = 1;
    piVar23 = (int *)0x0;
    ...
    puVar3 = FUN_006f1ce0(1,pCVar5,piVar23,iVar8);
    *puVar6 = (uint)puVar3;
    FUN_00710a90(*(int *)((int)local_14 + 0x68),0,0x6c,2,0xf3,0xc);
    ...
    *(undefined4 *)((int)local_14 + 0x17c) = uVar14;
    local_488[0] = 0;
    if (DAT_00808aaf < 9) {
      local_c8 = 0;
    }
    ...
    local_488[4] = *(int *)((int)local_14 + 0x3c) + 0x19c;
    iVar8 = *(int *)((int)local_14 + 0x5c);
    local_c4 = *(undefined4 *)((int)local_14 + 0x1c9);
    local_e0 = *(undefined4 *)((int)local_14 + 8);
    local_dc = 2;
    local_d8 = 0x6200;
    local_488[1] = 2;
    local_488[2] = 0;
    local_488[3] = 2;
    if (iVar8 == 0) {
      iVar22 = -*(int *)((int)local_14 + 0x48);
    }
    else {
      iVar22 = *(int *)((int)local_14 + 0x44);
    }
    local_420 = *(undefined4 *)((int)local_14 + 8);
    ...
    if (iVar8 == 0) {
      local_300[3] = -*(int *)((int)local_14 + 0x48);
    }
    else {
      local_300[3] = *(int *)((int)local_14 + 0x44);
    }
    local_300[3] = local_300[3] + 0x1a;
    local_298 = 0x6201;
    (**(code **)(**(int **)((int)local_14 + 0xc) + 8))
              (4,(undefined4 *)((int)local_14 + 0x1c5),0,local_488,0);
    if (8 < DAT_00808aaf) {
      *(undefined4 *)((int)local_14 + 0x28) = 0x20;
      *(undefined4 *)((int)local_14 + 0x2c) = 1;
      FUN_006e6080(local_14,2,*(undefined4 *)((int)local_14 + 0x1c5),
                   (undefined4 *)((int)local_14 + 0x18));
    }
    local_10 = (undefined4 *)((int)local_14 + 0x1a1);
    local_5 = 0;
    iVar22 = 0xb4ff;
    iVar8 = 0x1c;
    do {
      ...
      uVar14 = thunk_FUN_0053dea0(0,local_c,0x183,iVar8,1,(int)pCVar5,iVar10,iVar7,sVar16,uVar17,
    ...
    if (DAT_00808783 == '\x03') {
      ...
      puVar2 = local_6b8 + 1;
      iVar8 = *(int *)((int)local_14 + 0x3c) + 0x27;
      iVar7 = 4;
      do {
        iVar10 = *(int *)((int)local_14 + 0x5c);
        puVar2[-1] = iVar22;
        *puVar2 = 0;
        puVar2[2] = iVar8;
        puVar2[4] = 0x13;
      ...
      local_24 = local_6b8;
      local_5c = *(undefined4 *)((int)local_14 + 8);
      local_6c[0] = 1;
      local_20 = 1;
      local_1c = 1;
      local_18 = 1;
      ...
      local_34 = 0xb209;
      local_3c = local_5c;
      (**(code **)(**(int **)((int)local_14 + 0xc) + 8))(5,(int)local_14 + 0x1c1,0,local_6c,0);
      UVar12 = 0x42b8;
      iVar8 = 0x3c;
      local_c = 4;
      do {
        FUN_00710a90(*(int *)((int)local_14 + 0x68),0,iVar8,0xa9,0x46,0xe);
        uVar18 = (DAT_0080874e != '\x03') - 1 & 5;
        iVar7 = -1;
        iVar22 = 0;
