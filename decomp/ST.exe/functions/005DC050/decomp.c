  ...
  if (param_1 != (cMf32 *)0x0) {
    ...
    *value = puVar5;
    if (puVar5 != (ushort *)0x0) {
      ...
      FUN_006b5440((int)this_01->field_02F0,0,0x14,0x14,(int)*value,0,0);
    }
...
LAB_005dc22d:
          thunk_FUN_005411a0(this_01->field_0548,pcVar8,"@- %s");
          iVar4 = iVar4 + 1;
      ...
      *puVar6 = DAT_007cc854;
      local_14 = (AnonShape_006B5570_4D68B99C *)
                 ccFntTy::FormIndentSarr
                           (this_01->field_0034,this_01->field_0548," ,.;:!?/\\()[]{}",
                            (uint *)&DAT_007c21ec,this_01->field_0544->field_0004 + -0x14,0,
      ...
      Library::DKW::TBL::FUN_006b5aa0(this_01->field_0548,puVar6);
