...
void FUN_005dc050(int param_1,char param_2)
  ...
  if (param_1 != 0) {
    ...
    *piVar2 = (int)puVar5;
    if (puVar5 != (ushort *)0x0) {
      ...
      FUN_006b5440(*(int *)(local_1c + 0x2f0),0,0x14,0x14,*piVar2,0,0);
    }
...
LAB_005dc22d:
          thunk_FUN_005411a0(*(int *)(local_1c + 0x548),pcVar10,s_____s_007c72b4);
          iVar4 = iVar4 + 1;
      ...
      *(undefined1 *)puVar6 = DAT_007cc854;
      local_14 = FUN_007126e0(*(int *)(local_1c + 0x548),(uint *)s________________007c21d8,
                              (uint *)&DAT_007c21ec,*(int *)(*(int *)(local_1c + 0x544) + 4) + -0x14
                              ,0,0xffffffff,(char *)0x0,1);
      if (*(byte **)(local_1c + 0x548) != (byte *)0x0) {
        FUN_006b5570(*(byte **)(local_1c + 0x548));
      }
      puVar7 = FUN_006b54f0((uint *)0x0,10,10);
      *(uint **)(local_1c + 0x548) = puVar7;
      pCVar1 = (LPSTR)(local_1c + 0x3c);
      uVar8 = FUN_006b0140(0x2347,DAT_00807618);
      wsprintfA(pCVar1,s__2__s__007cd800,uVar8);
      FUN_006b5aa0(*(int *)(local_1c + 0x548),pCVar1);
      wsprintfA(pCVar1,s__0__s_007cd7f8,&DAT_0080c3c3);
      FUN_006b5aa0(*(int *)(local_1c + 0x548),pCVar1);
      FUN_006b5aa0(*(int *)(local_1c + 0x548),&DAT_007c3b5c);
      ...
      if (local_14 != (uint *)0x0) {
        if (local_14[2] != 0) {
          FUN_007129d0(local_14,local_14);
        }
        iVar4 = 0;
        if (0 < (int)puVar7[2]) {
          if ((int)puVar7[2] < 1) {
...
LAB_005dc430:
            FUN_006b5aa0(*(int *)(local_1c + 0x548),pcVar10);
            iVar4 = iVar4 + 1;
      ...
      local_2c = 0x28;
      local_28 = CONCAT22(*(undefined2 *)(*(int *)(local_1c + 0x548) + 8),1);
      if (*(int *)(local_1c + 0x389) != 0) {
        FUN_006e5970(2,*(int *)(local_1c + 0x389),(int)local_3c);
      }
      local_2c = 0x22;
      local_28 = 0;
      if (*(int *)(local_1c + 0x389) != 0) {
    ...
    if (this != (void *)0x0) {
      ...
      *(undefined2 *)puVar13 = 0;
      local_58._0_2_ = 1;
      local_58._2_2_ = 1;
      thunk_FUN_005b9010(this,(int)&local_58);
    }
  }
  DAT_00858df8 = local_9c;
  return;
