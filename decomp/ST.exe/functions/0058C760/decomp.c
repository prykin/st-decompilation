...
undefined4 __thiscall STSatC::GetMessage(STSatC *this,AnonShape_0058C760_1E722DF9 *param_1)

{
  ...
  if ((this->field_0231 == 7) && (param_1->field_0010 != 3)) {
    return 0;
  }
  ...
  if (uVar8 < 0x110) {
    if (uVar8 == 0x10f) {
      ...
      if (((local_18 != (byte *)0x0) && (local_14 != (byte *)0x0)) && (local_c != (byte *)0x0)) {
        puVar11 = (undefined4 *)&this_00->field_0x275;
        pbVar12 = local_c;
        ...
        *(undefined2 *)pbVar12 = *(undefined2 *)puVar11;
        ...
        local_c[0x4c] = uVar3;
        local_c[0x4d] = uVar4;
        *(STSprGameObjC_field_0259State *)(local_c + 0x4e) = this_00->field_0259;
        ...
        *(undefined4 *)&this_00->field_0x231 = 7;
        ...
        if (uVar8 < 2) {
          *(undefined4 *)&this_00->field_0x239 = 0;
          ...
          puVar13 = (undefined4 *)&this_00->field_0x275;
          for (iVar5 = 9; iVar5 != 0; iVar5 = iVar5 + -1) {
            *puVar13 = *puVar11;
            puVar11 = puVar11 + 1;
            puVar13 = puVar13 + 1;
          ...
          *(undefined2 *)puVar13 = *(undefined2 *)puVar11;
          ...
          iVar5 = STT3DSprC::LoadSequence((STT3DSprC *)puVar11,0xe,DAT_00806774,&DAT_007cbaa8,0x1d);
          if (iVar5 != 0) {
          ...
          *(int *)&this_00->field_0x255 = iVar5;
          ...
          local_20 = (AnonShape_0058C760_4470B7C6 *)param_1->field_0014;
          pAVar10 = local_20;
          puVar11 = (undefined4 *)&this_00->field_0x275;
          for (iVar5 = 9; iVar5 != 0; iVar5 = iVar5 + -1) {
            *puVar11 = *(undefined4 *)pAVar10;
            pAVar10 = (AnonShape_0058C760_4470B7C6 *)&pAVar10->field_0x4;
            puVar11 = puVar11 + 1;
          }
          *(undefined2 *)puVar11 = *(undefined2 *)pAVar10;
          ...
          pAVar10 = local_20;
          *(undefined4 *)&this_00->field_0x231 = local_20->field_0026;
          ...
          *(undefined4 *)&this_00->field_0x241 = local_20->field_0036;
