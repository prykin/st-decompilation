...

{
  ...
  if (*(int *)((int)pvStack_c + 0x1af8) != 0) {
    thunk_FUN_005aafb0();
    FUN_0072e2b0(*(undefined4 **)((int)pvStack_c + 0x1af8));
    *(undefined4 *)((int)pvStack_c + 0x1af8) = 0;
  }
  ...
  *(undefined1 **)((int)pvStack_c + 0x1af8) = puVar3;
  if (puVar3 != (undefined1 *)0x0) {
    uVar8 = 0;
    cVar7 = '\x01';
    uVar6 = 0x10;
    ...
    if (uVar6 != 0) {
      iVar2 = *(int *)((int)pvStack_c + 0x1af8);
      *(undefined1 *)(iVar2 + 2) = 0;
      *(undefined4 *)(iVar2 + 0x17) = 0xffffffff;
      uVar6 = *(uint *)(*(int *)((int)pvStack_c + 0x1af8) + 3);
      if (-1 < (int)uVar6) {
  ...
  puVar4 = (uint *)((int)pvStack_c + 0x1a94);
  iStack_8 = 0x16;
  do {
  ...
  if ((*(int *)((int)pvStack_c + 0x1a64) == 0) || (*(char *)((int)pvStack_c + 0x1a5f) == '\x0e')) {
    ...
    *(uint **)(DAT_0081176c + 0x548) = puVar4;
    if (*(int *)((int)pvStack_c + 0x1b00) != 0) {
      thunk_FUN_005aafb0();
      FUN_0072e2b0(*(undefined4 **)((int)pvStack_c + 0x1b00));
      *(undefined4 *)((int)pvStack_c + 0x1b00) = 0;
    }
    puVar3 = (undefined1 *)FUN_0072e530(0x33);
    if (puVar3 == (undefined1 *)0x0) {
      puVar3 = (undefined1 *)0x0;
    ...
    *(undefined1 **)((int)pvStack_c + 0x1b00) = puVar3;
    if (puVar3 != (undefined1 *)0x0) {
      uVar8 = 0;
      cVar7 = '\x01';
      uVar6 = 0x10;
      ...
      if (uVar6 != 0) {
        iVar2 = *(int *)((int)pvStack_c + 0x1b00);
        *(undefined1 *)(iVar2 + 2) = 0;
        *(undefined4 *)(iVar2 + 0x17) = 0xffffffff;
        uVar6 = *(uint *)(*(int *)((int)pvStack_c + 0x1b00) + 3);
        if (-1 < (int)uVar6) {
          FUN_006b3430(DAT_008075a8,uVar6);
        }
        thunk_FUN_005ab0a0();
  ...
  if (*(int *)((int)pvStack_c + 0x1a64) == 0) {
    ...
    if (*(int *)((int)pvStack_c + 0x1afc) != 0) {
      thunk_FUN_005aafb0();
      FUN_0072e2b0(*(undefined4 **)((int)pvStack_c + 0x1afc));
      *(undefined4 *)((int)pvStack_c + 0x1afc) = 0;
    }
    puVar3 = (undefined1 *)FUN_0072e530(0x33);
    if (puVar3 == (undefined1 *)0x0) {
      puVar3 = (undefined1 *)0x0;
    ...
    *(undefined1 **)((int)pvStack_c + 0x1afc) = puVar3;
    if (puVar3 != (undefined1 *)0x0) {
      uVar8 = 0;
      cVar7 = '\x01';
      uVar6 = 0x10;
      ...
      if (uVar6 != 0) {
        iVar2 = *(int *)((int)pvStack_c + 0x1afc);
        *(undefined1 *)(iVar2 + 2) = 0;
        *(undefined4 *)(iVar2 + 0x17) = 0xffffffff;
        uVar6 = *(uint *)(*(int *)((int)pvStack_c + 0x1afc) + 3);
        if (-1 < (int)uVar6) {
          FUN_006b3430(DAT_008075a8,uVar6);
        }
        thunk_FUN_005ab0a0();
