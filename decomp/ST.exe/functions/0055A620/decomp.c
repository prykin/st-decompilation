...

{
  ...
  if ((((this->field_0114 != 0) && (-1 < param_5)) && (param_4 < 8)) &&
    ...
    if ((&this->field_00D4)[param_4] == 0) {
      ...
      (&this->field_00D4)[param_4] = puVar5;
      g_currentExceptionFrame = local_60.previous;
    }
    if ((param_7 & 0x1000) != 0) {
      sub_0055BB00(this,6,(short)param_1,(short)param_2,param_3,param_4,(char)param_5,param_6);
    }
    if ((param_7 & 0x40) != 0) {
      if (param_5 < 0) {
        param_5 = CASE_0;
        ...
        do {
          ...
          do {
            if ((puVar6 == (undefined *)0x0) || (local_8[iVar7] != '\0')) {
              ...
              if (bVar3) {
                iVar8 = this->field_0020 * iVar4 + (&this->field_00D4)[param_4];
