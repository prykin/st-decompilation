...

{
  ...
  if ((((this->field_0114 != 0) && (-1 < param_5)) && (param_4 < 8)) &&
    ...
    local_14 = this;
    if (*(int *)(&this->field_0xd4 + param_4 * 4) == 0) {
      ...
      if (iVar4 != 0) {
        ...
        iVar4 = ReportDebugMessage("E:\\__titans\\grig\\visible.cpp",0x3a3,0,iVar4,
      ...
      *(undefined4 **)(&this->field_0xd4 + param_4 * 4) = puVar5;
      g_currentExceptionFrame = local_60.previous;
    }
    if ((param_7 & 0x1000) != 0) {
      SubmarineTitans::Recovered::HiddenThis::AnonReceiver_00558C00::sub_0055BB00
                ((AnonReceiver_00558C00 *)this,6,(short)param_1,(short)param_2,param_3,param_4,
        ...
        do {
          ...
          do {
            if ((puVar6 == (undefined *)0x0) || (local_8[iVar7] != '\0')) {
              ...
              if (bVar3) {
                iVar8 = this->field_0020 * iVar4 + *(int *)(&this->field_0xd4 + param_4 * 4);
