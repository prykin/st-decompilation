...

{
  ...
  *(undefined1 *)puVar12 = 0;
  ...
  if (iVar4 != 0) {
    ...
    iVar8 = ReportDebugMessage(s_E____titans_Andrey_helppan_cpp_007c383c,0x973,0,iVar4,&DAT_007a4ccc
...
LAB_0051d689:
  ...
  uVar9 = local_c;
  if (local_14 != 10000) {
    LoadResourceString(local_14,HINSTANCE_00807618);
    uVar9 = 0xffffffff;
    ...
    ccFntTy::SetSurf(this_00->field_01E0,(int)this_00->field_0218,0,0,0,0x19c,uVar9 + 2);
  ...
  pCVar5 = FUN_006f2c00(pCVar5,iVar4,uVar10);
  local_8 = cMf32::RecGet(DAT_00806790,1,pCVar5,piVar15,iVar8);
  uVar10 = uVar9 + 10;
  DibPut((AnonShape_006B5B10_E0D06CF1 *)this_00->field_0218,0x50,uVar10,'\x01',(byte *)local_8);
  local_18 = *(int *)(local_8 + 2);
  ccFntTy::SetSurf(this_00->field_01E0,(int)this_00->field_0218,0,local_18 + 0x5f,uVar10,
                   0x13d - local_18,0xf);
  uVar6 = (DAT_0080874e != '\x03') - 1 & 5;
  iVar8 = -1;
  iVar4 = 1;
  LoadResourceString(0x5c93,HINSTANCE_00807618);
  ccFntTy::WrStr(this_00->field_01E0,extraout_EAX_00,iVar4,iVar8,uVar6);
  local_34[0] = 0x50;
  local_34[2] = local_18;
