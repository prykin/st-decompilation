...

{
  ...
  local_30 = *(int *)&this->field_0x30;
  local_2c = *(int *)&this->field_0x34;
  local_28 = *(int *)&this->field_0x38 - local_30;
  local_24 = *(int *)&this->field_0x3c - local_2c;
  ...
  if ((iVar1 == 100) && (*(int *)&this->field_0x2f4 == 100)) {
    ...
    iVar2 = (int)((ulonglong)
                  ((longlong)((int)param_1->field_001E * *(int *)&this->field_0x2f4) * -0x51eb851f)
                 >> 0x20);
    local_1c = (iVar2 >> 5) - (iVar2 >> 0x1f);
    local_18 = (iVar1 * local_18) / 100;
    local_14 = (*(int *)&this->field_0x2f4 * local_14) / 100;
  }
