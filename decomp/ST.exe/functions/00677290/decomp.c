...

{
  ...
  if (exceptionCode == 0) {
    ...
    local_8 = pDVar1;
    _EnumPlObj(param_1,param_2,0x3fffffff,nullptr,param_3,param_4,param_5,param_6,param_7,
  ...
  local_8 = nullptr;
  RaiseInternalException(exceptionCode,0,"E:\\__titans\\ai\\ai_mdef.cpp",0x2c0);
  return nullptr;
}
