...
void __fastcall thunk_FUN_00597120(int param_1)

{
  ...
  *(DWORD *)(param_1 + 0x61) = DVar5;
  puStack_a8 = DAT_00858df8;
  DAT_00858df8 = &puStack_a8;
  iVar6 = __setjmp3(auStack_a4,0,unaff_EDI,unaff_ESI);
  iVar12 = iStack_28;
  if (iVar6 != 0) {
    DAT_00858df8 = puStack_a8;
  ...
  switch(*(undefined1 *)(iStack_28 + 0x65)) {
  case 1:
  ...
  case 8:
  case 10:
    if ((0 < *(int *)(iStack_28 + 0x1a93)) && (-1 < *(int *)(iStack_28 + 0x1a8f))) {
      if (*(int *)(iStack_28 + 0x1a93) == 9) {
...
joined_r0x00597872:
    ...
    case 10:
      if (*(char **)(iVar12 + 0x1b0c) != (char *)0x0) {
        ...
        CFsgsConnection::RequestInfo
                  ((CFsgsConnection *)&DAT_00802a90,*(char **)(iVar12 + 0x1b0c),0xf,&pcStack_64);
        pvVar3 = DAT_00802a30;
        goto joined_r0x00597872;
      }
    }
    ...
    if (pvVar3 != (void *)0x0) {
      thunk_FUN_005b9010(pvVar3,(int)&uStack_24);
      DAT_00858df8 = puStack_a8;
      return;
    }
    break;
  case 4:
    if (*(int *)(iStack_28 + 0x1f23) != 0) {
