...

{
  ...
  case 0:
    ...
    break;
  case 1:
    iVar4 = thunk_FUN_005ede30(param_1,&iStack_c,&iStack_10,&iStack_14);
    if (iVar4 != 0) {
  ...
  case 2:
    if (DAT_00802a38[7].messages < *(void **)((int)param_1 + 0x28f)) {
      ...
      iVar4 = thunk_FUN_005ed1c0(param_1,&iStack_c,&iStack_10,&iStack_14,&iStack_18);
      if (iVar4 != 0) {
        *(int *)((int)param_1 + 0x277) = iStack_c;
        *(int *)((int)param_1 + 0x27b) = iStack_10;
...
LAB_005ee9db:
  ...
  case 4:
    ...
    uStack_28 = 0x129;
    uStack_2c = 2;
    SystemClassTy::PostMessage(DAT_00802a38,auStack_38);
    return uStack_8;
  case 5:
