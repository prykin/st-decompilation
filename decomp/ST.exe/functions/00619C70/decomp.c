    ...
    case 2:
      ...
      if ((((-1 < iVar13) && (-1 < iVar14)) && (iVar3 = (int)g_worldGrid.sizeX, iVar13 < iVar3)) &&
        ...
        if ((((&DAT_007fb24c)[this->field_0051] == 0) ||
           ...
           (local_EAX_444 = thunk_FUN_00497030(iVar13,iVar14,this->field_0051,1,DAT_007e66ac),
           -1 < (int)local_EAX_444)) {
          this->field_00A7 = local_c;
          this->field_00AF = 0;
      ...
      if (((void *)this->field_007D != nullptr) &&
         (iVar13 = thunk_FUN_00618240((void *)this->field_007D,this->field_009F,this->field_00A3,
        ...
        this->field_014B = 1;
        iVar13 = thunk_FUN_0061bdb0(this,CASE_2,this->field_0127,this->field_012B,this->field_012F);
        if (iVar13 == 0) {
          return 1;
        }
      ...
      iVar13 = thunk_FUN_0061ca90(this,this->field_009F,this->field_00A3,this->field_00A7,
...
LAB_00619e5f:
  ...
  case CASE_2:
    ...
    case 1:
      ...
      this->field_00A7 = local_c;
      iVar13 = thunk_FUN_0061c5f0(this,&local_30);
      if ((iVar13 < 1) || (299 < this->field_0141)) {
        if (iVar13 == 0) {
          iVar13 = thunk_FUN_0061bdb0(this,CASE_1,this->field_009F,this->field_00A3,this->field_00A7
                                     );
          if (iVar13 == 0) {
LAB_0061a4f4:
...
LAB_0061a4fd:
        ...
        iVar13 = thunk_FUN_0061bdb0(this,CASE_3,this->field_0127,this->field_012B,this->field_012F);
        if (iVar13 != 0) {
    ...
    case 2:
      ...
      if (((((this->field_00C9 < 0) || (iVar3 < 0)) ||
        ...
        this->field_00A7 = local_c;
        this->field_00AF = 0;
        thunk_FUN_00637ae0(this->field_009F,iVar13,local_c);
        this->field_0093 = CASE_6;
      }
      break;
    case 3:
  ...
  case CASE_3:
    ...
    if (uVar5 != 5) {
      SVar6 = thunk_FUN_0061c910(this,uVar5,this->field_0093,local_28,local_24,local_20,iVar14,
                                 local_8,uVar12);
...
cf_common_exit_0061A55D:
    local_2c = 1;
    iVar13 = thunk_FUN_0061bdb0(this,CASE_1,iVar14,iVar13,uVar12);
    if (iVar13 != 0) {
      this->field_0093 = CASE_1;
      return local_2c;
    }
  ...
  case CASE_5:
    ...
    if ((int)uVar12 < this->field_00AF) {
      ST3DSMAPContext::sub_006EA270(g_sT3DSMAPContext_00807598,this->field_0097,0,uVar12);
LAB_0061acc2:
