...

{
  ...
  if (SVar3 < MESS_FSGSTY_6941) {
    if (SVar3 == MESS_SHARED_6940) {
      thunk_FUN_005bba40((RecoveredRecordView_005BB9F0_C0A10156 *)this_00);
    ...
    if (SVar3 < MESS_SHARED_6120) {
      ...
      if (MESS_SHARED_6501 < SVar3) {
        ...
        iVar14 = StartSystemTy::sub_005DA940
        ...
        if (iVar14 == 0) {
          ...
          iVar11_mg2 = thunk_FUN_005da980(iVar14);
          if ((iVar11_mg2 == 0) &&
             /* ST_CALLSITE[005BC942]: CALL 0x0040583a; direct=0040583A StartSystemTy::sub_005DAA90 */
             (iVar11_mg3 = StartSystemTy::sub_005DAA90(g_startSystem_0081176C), iVar11_mg3 == 0)) {
            DAT_0080877e = 0;
...
LAB_005bccb9:
      ...
      if (SVar3 != MESS_SHARED_6121) {
        if (SVar3 == MESS_PRIVIDERTY_631F) {
          ...
          if ((uVar2 != 0xffff) || ((message->arg1).words.high != 0xffff)) {
            ...
            iVar14 = uVar2 + 5;
            FUN_006b5b10((AnonShape_006E6FB0_BC494FEA *)this_00->field_1C8E,0,iVar14,uVar19 + 0x19,
          ...
          iVar11_mg5 = StartSystemTy::sub_005DAA90(g_startSystem_0081176C);
          if (iVar11_mg5 == 0) {
  ...
  if (MESS_SHARED_8160 < SVar3) {
    ...
    case MESS_SIDTY_8163:
      SVar7 = message->arg0;
      this_00->array_00BC[0xc].field_01F1 = 0;
      this_00->array_00BC[0xc].field_01E1 = (int)SVar7;
      break;
...
switchD_005bc9da_caseD_6949:
    ...
    iVar14 = StartSystemTy::sub_005DA940(g_startSystem_0081176C,this_00->array_00BC[0xc].field_01E1);
    ...
    iVar11_mgD = thunk_FUN_005dab70(g_startSystem_0081176C,0,uVar12);
    if (iVar11_mgD != 0) {
      pMVar15 = (this_00->array_00BC[0xc].field_01DB)->field_02E6;
      if (pMVar15 != nullptr) {
        /* ST_CALLSITE[005BCD2D]: CALL 0x00403fa8; direct=00403FA8 MMsgTy::SetMessage */
        MMsgTy::SetMessage(pMVar15,0x2134,'\0',nullptr,nullptr,nullptr
                           ,0,0);
      }
      break;
    }
  ...
  case 0x694e:
    ...
    iVar11_mgA = thunk_FUN_005dab70(g_startSystem_0081176C,this_00->array_00BC[0xc].field_01E1,
                                    &CHAR_00h_008016a0);
    if (iVar11_mgA == 0) {
      ...
      if (g_cursorClass_00802A30 != nullptr) {
        ...
        CursorClassTy::SetGCType(pCVar9,CASE_0,iVar5,iVar14);
  ...
  case MESS_PRIVIDERTY_6952:
    ...
    if (this_00->array_00BC[0xc].field_01DF == '\0') {
      ...
      if (pHVar10 != nullptr) {
        ...
        pRVar11 = Library::DKW::DDX::FUN_006bf9f0
                            ((int *)g_ddxContext_008075A8,0x79,0x197,0x22e,0x2e);
        /* ST_CALLSITE[005BCC41]: CALL 0x0040459d; direct=0040459D HoloTy::Init */
        uVar18 = HoloTy::Init(this_00->field_1C9A,CASE_1,0x79,0x197,pRVar11,iVar14,bVar17,cVar18,
                              uVar19);
        if (uVar18 != 0) {
