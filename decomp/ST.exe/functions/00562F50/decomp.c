...

{
  ...
  if ((param_4 != 0) && (0 < param_5)) {
    ...
    iVar13 = Library::MSVCRT::__setjmp3
    ...
    if (iVar13 == 0) {
      ...
      if (0 < param_5) {
        do {
          ...
          if (0 < iVar13) {
            ...
            if (0 < (int)uVar17) {
              do {
                if (**(int **)(&stack0xfffffe18 + iVar14 * 4) < iVar13) break;
                iVar14 = iVar14 + 1;
      ...
      for (iVar18 = uVar17 - 2; -1 < iVar18; iVar18 = iVar18 + -1) {
        iVar10 = *(int *)local_174[iVar18];
        if ((0xf < iVar10) &&
           (iVar6 = iVar10 - *(int *)local_174[iVar18 + 1], *(int *)local_174[iVar18 + 1] < iVar6))
        {
          if (iVar6 <= iVar13) {
...
LAB_00563368:
      ...
      iVar13 = 0;
      do {
        if (*(int *)local_174[iVar14 + 1] <= (int)(&DAT_007c9614)[iVar13]) break;
        iVar13 = iVar13 + 1;
      } while (iVar13 < 9);
      DAT_008032f0 = *(int *)(iVar13 * 8 + 0x7c9640);
      DAT_008032ec = *(int *)(iVar13 * 8 + 0x7c963c);
      DAT_0080330c = DAT_008032ec * DAT_008032f0;
      if (-1 < iVar14) {
        iVar13 = 0;
        do {
          if (*(int *)*local_174 <= (int)(&DAT_007c9614)[iVar13]) break;
          iVar13 = iVar13 + 1;
        } while (iVar13 < 9);
        DAT_00803374 = *(int *)(iVar13 * 8 + 0x7c9640);
        DAT_00803378 = *(int *)(iVar13 * 8 + 0x7c963c);
        ...
        do {
          ...
          if (0 < iVar13) {
            do {
              ...
              *(char *)(local_30 + iVar18 * 2) = (char)iVar13;
              if (iVar13 < 1) {
                *(undefined2 *)(local_cc + iVar18 * 2) = 0xffff;
              }
              else if (iVar13 < 3) {
                *(short *)(local_cc + iVar18 * 2) = 5 - (short)iVar13;
              }
              else {
      ...
      for (; iVar14 <= local_16c; iVar14 = iVar14 + 1) {
        local_cc = iVar14 * iVar13 * 2;
        local_30 = (int)DAT_00803380 + local_cc;
        local_cc = local_cc + (int)local_60[0];
        ...
        if (0 < local_9c) {
          do {
            ...
            *(char *)(local_30 + iVar18 * 2) = (char)iVar10;
            if (iVar10 < 1) {
              *(undefined2 *)(local_cc + iVar18 * 2) = 0xffff;
            }
            else if (iVar10 < 3) {
              *(short *)(local_cc + iVar18 * 2) = 5 - (short)iVar10;
            }
            else {
              *(undefined2 *)(local_cc + iVar18 * 2) = 0;
            }
        ...
        psVar8 = g_pathingGrid.cells +
                 (int)g_pathingGrid.sizeX * (DAT_008033c0 + iVar14) + local_9c + DAT_008033bc;
        local_164 = g_worldGrid.cells +
                    (int)g_worldGrid.sizeX * (DAT_008033c0 + iVar14) + local_9c + DAT_008033bc;
        local_94 = local_9c;
        while (local_94 <= local_c4) {
          ...
          do {
            if (*psVar7 == 0) {
              local_d4 = local_d4 + 1;
              if ((pSVar15->objects[1] != (STWorldObject *)0x0) &&
                 (pSVar15->objects[1]->value_20 == 0x1ae)) {
                local_64 = local_64 + 3;
LAB_005637b9:
              }
            }
            else if (pSVar15->objects[0] != (STWorldObject *)0x0) {
              if (param_1 != 0xff) {
                bVar2 = *(byte *)&pSVar15->objects[0][1].vtable;
                if (DAT_00808a8f == '\0') {
...
LAB_005637bc:
            local_34 = local_34 + 1;
            psVar7 = psVar7 + g_pathingGrid.planeStride;
            pSVar15 = pSVar15 + g_worldGrid.planeStride;
          } while (local_34 < 5);
        ...
        local_90 = g_pathingGrid.cells +
                   (iVar14 + DAT_008033c0) * (int)g_pathingGrid.sizeX + local_c4 + DAT_008033bc + 1;
        iVar18 = local_c4 + 1;
        if (iVar18 < iVar13) {
          do {
            iVar13 = 0;
        ...
        do {
          ...
          if (0 < iVar13) {
            do {
              ...
              *(char *)(local_30 + iVar14 * 2) = (char)iVar13;
              if (iVar13 < 1) {
                *(undefined2 *)(local_cc + iVar14 * 2) = 0xffff;
              }
              else if (iVar13 < 3) {
                *(short *)(local_cc + iVar14 * 2) = 5 - (short)iVar13;
              }
              else {
                *(undefined2 *)(local_cc + iVar14 * 2) = 0;
              }
              iVar14 = iVar14 + 1;
              local_90 = local_90 + 1;
              iVar13 = DAT_008033a4;
          ...
          if (0 < iVar14) {
            ...
            if ((-1 < local_84) && (local_84 < iVar13)) {
              ...
              if ((-1 < iVar10) && (iVar10 < DAT_008033a8)) {
                ...
                case 0:
                case 3:
                  iVar13 = *(int *)(&DAT_007a4bf8 + piVar9[4] * 4) * 2 + -2;
                  iVar18 = 0;
                  iVar6 = iVar13;
                  break;
                case 1:
                ...
                default:
                  iVar18 = 0;
                case -10:
                  iVar13 = *(int *)(&DAT_007a4c24 + piVar9[4] * 8);
                  iVar6 = *(int *)(&DAT_007a4c20 + piVar9[4] * 8);
                }
                local_c8 = FUN_00561240(iVar13,iVar6,iVar18);
                if (1 < *local_c8) {
                  local_13c = (iVar14 << 0x10) / *local_c8;
                  iVar14 = 0;
                  iVar13 = (int)DAT_00803380 + (local_c8[3] + iVar10) * DAT_008033a4 * 2;
                  local_ac = 0;
                  if (0 < local_c8[4]) {
                    do {
                      iVar18 = local_c8[3] + iVar10 + local_ac;
                      if ((-1 < iVar18) && (iVar18 < DAT_008033a8)) {
                        ...
                        for (iVar18 = local_c8[local_ac * 2 + 5] + local_84; iVar18 <= local_a8;
                          ...
                          if (((-1 < iVar18) && (iVar18 < DAT_008033a4)) &&
                            ...
                            bVar2 = *(byte *)(iVar13 + iVar18 * 2);
                            if ((int)((uint)(bVar2 >> 4) + (iVar14 >> 0x10)) < 0xf) {
                              *(byte *)(iVar13 + iVar18 * 2) =
                                   (char)((uint)iVar14 >> 0x10) * '\x10' + bVar2;
                            }
                            else {
                              *(byte *)(iVar13 + iVar18 * 2) = (bVar2 & 7) - 0x10;
                            }
                          }
                        }
                      }
            ...
            if ((-1 < iVar10) && (iVar10 < iVar13)) {
              ...
              if ((-1 < iVar6) && (iVar6 < DAT_008033a8)) {
                ...
                if ((0 < local_4c) && (iVar18 <= (*piVar9 * 100) / local_4c)) {
                  *(int *)(DAT_00803310 + iVar14 * 0x14) = iVar10;
      ...
      for (iVar10 = local_e0; iVar10 <= local_16c; iVar10 = iVar10 + 1) {
        local_30 = (int)DAT_00803380 + iVar10 * iVar13 * 2;
      ...
      iVar10 = DAT_00803308;
      if (0 < iVar14) {
        iVar13 = (iVar18 + iVar14 / 2) / iVar14;
        iVar10 = (local_dc + iVar14 / 2) / iVar14;
        iVar14 = FUN_006acf90(iVar13,iVar10,DAT_00803304,DAT_00803308);
        if (5 < iVar14) {
          iVar13 = ((iVar14 + -5) * DAT_00803304 + iVar13 * 5) / iVar14;
          iVar10 = ((iVar14 + -5) * DAT_00803308 + iVar10 * 5) / iVar14;
        }
      }
      DAT_00803308 = iVar10;
      DAT_00803304 = iVar13;
      piVar9 = local_134;
      for (iVar13 = 0x16; pbVar4 = local_a0, iVar14 = DAT_0080339c, piVar12 = local_80, iVar13 != 0;
          iVar13 = iVar13 + -1) {
        *piVar9 = 0;
        piVar9 = piVar9 + 1;
      }
      for (; local_80 = piVar12, iVar14 < 0xe; iVar14 = iVar14 + 1) {
        local_28 = FUN_0055ee70(pbVar4,iVar14,1);
        iVar13 = 0;
        if (0 < local_28) {
          do {
            iVar10 = (char)pbVar4[iVar13 * 2] + DAT_00803304;
            iVar18 = (char)pbVar4[iVar13 * 2 + 1] + DAT_00803308;
            if ((((-1 < iVar10) && (iVar10 < DAT_008033a4)) && (-1 < iVar18)) &&
               ((iVar18 < DAT_008033a8 &&
                ((*(byte *)((int)DAT_00803380 + (iVar18 * DAT_008033a4 + iVar10) * 2) & 0xf0) != 0))
               )) {
              local_134[iVar14] = local_134[iVar14] + 1;
            }
            iVar13 = iVar13 + 1;
          } while (iVar13 < local_28);
        }
        local_134[iVar14] = (local_134[iVar14] * 100) / local_28;
        piVar12 = local_80;
      }
      iVar13 = -30000;
      iVar14 = 0xc;
      if (DAT_0080339c < 0xd) {
        do {
          iVar18 = ((0xd - iVar14) * local_100 + local_134[iVar14]) / (0xe - iVar14) - local_100;
          if (iVar13 <= iVar18) {
      ...
      *piVar12 = DAT_00803304;
      ...
      do {
        ...
        piVar9 = FUN_00561240(DAT_008032f0,DAT_008032ec,iVar14);
        *(int **)(DAT_008032fc + iVar13 * 4) = piVar9;
        piVar9 = FUN_00561240(DAT_00803374,DAT_00803378,iVar14);
        *(int **)(DAT_008033b8 + iVar13 * 4) = piVar9;
        piVar9 = FUN_00561240(5,DAT_008032ec,iVar14);
        DAT_008033b0[iVar13] = piVar9;
        iVar13 = iVar13 + 1;
        iVar14 = DAT_0080339c;
        piVar9 = local_160;
      } while (iVar13 < 0x10);
      while (local_160 = piVar9, local_88 = iVar14, iVar14 < 0x16) {
        local_28 = FUN_0055ee70(local_a0,iVar14,1);
        iVar13 = DAT_00803384 - DAT_0080339c;
        iVar18 = 0x16 - DAT_00803384;
        if (iVar13 < iVar18) {
          uVar11 = DAT_00803384 - iVar14 >> 0x1f;
          iVar13 = (DAT_00803384 - iVar14 ^ uVar11) - uVar11;
          iVar13 = iVar18 * iVar18 - iVar13 * iVar13;
        }
        else {
          uVar11 = DAT_00803384 - iVar14 >> 0x1f;
          iVar14 = (DAT_00803384 - iVar14 ^ uVar11) - uVar11;
          iVar13 = iVar13 * iVar13 - iVar14 * iVar14;
        }
        DAT_00803388 = iVar13 / 2;
        local_50 = 0;
        if (0 < local_28) {
          do {
            iVar13 = (char)local_a0[local_50 * 2] + DAT_00803304;
            if (((-1 < iVar13) && (iVar13 < DAT_008033a4)) &&
               ((iVar14 = (char)local_a0[local_50 * 2 + 1] + DAT_00803308, -1 < iVar14 &&
                ((iVar14 < DAT_008033a8 &&
                 (0 < *(short *)((int)DAT_008033b4 + (iVar14 * DAT_008033a4 + iVar13) * 2))))))) {
              local_140 = 0;
              local_150 = 0;
              if (0 < DAT_0080338c) {
                do {
                  ...
                  iVar10 = FUN_006acf90(*piVar9,piVar9[1],iVar13,iVar14);
                  if (iVar10 < iVar18 / 2) {
                    local_140 = 1;
                    break;
                  }
              ...
              if (local_140 == 0) {
                iVar18 = 0x10;
                uVar11 = FUN_006db910(DAT_00803304,DAT_00803308,iVar13,iVar14);
                local_74 = (int *)FUN_006db990(uVar11,iVar18);
                ...
                if (local_b0 <= (int)((int)local_74 + 3U)) {
                  do {
                    ...
                    iVar18 = FUN_00561dc0(iVar13,iVar14,iVar18);
                    FUN_00564f30(iVar13,iVar14,iVar18,local_74,DAT_0080330c,local_88);
                    if (-1 < local_8c) {
                      FUN_00564f30(iVar13,iVar14,iVar18,local_74,DAT_008032e8,local_88);
                    }
                    local_b0 = local_b0 + 3;
      ...
      iVar13 = ((local_8c * 0x19 + 0x19) * 4) / (int)uVar17;
      ...
      if (0 < (int)DAT_00803398) {
        ...
        if (0 < DAT_0080337c) {
          do {
            ...
            piVar9[iVar14] = DAT_008032f8[iVar14 * 5 + 3];
            iVar14 = iVar14 + 1;
          } while (iVar14 < DAT_0080337c);
        }
        iVar14 = 0;
        if (0 < DAT_00803314) {
          do {
            ...
            piVar9[DAT_0080337c + iVar14] = DAT_008032f4[iVar14 * 5 + 3];
            iVar14 = iVar14 + 1;
          } while (iVar14 < DAT_00803314);
        }
        ...
        if (local_6c[0] == (int *)0x0) {
              ...
              if (0 < DAT_0080337c) {
                do {
                  if (-1 < piVar9[3]) {
                    ...
                    if (0 < local_158) {
                      do {
                        iVar18 = FUN_006acf90(DAT_00803300[local_40[iVar14] * 5],
                                              (DAT_00803300 + local_40[iVar14] * 5)[1],*piVar9,
                                              piVar9[1]);
                        if (iVar18 < iVar13) {
                          iVar13 = iVar18;
                        }
                        iVar14 = iVar14 + 1;
                      } while (iVar14 < local_158);
                    }
                    if (local_38 < iVar13) {
                      local_54 = local_150;
                      local_38 = iVar13;
          ...
          while (local_1c = puVar5, local_40 = piVar19, local_78 = iVar13 + 1, DAT_008032f4 = piVar9
                , local_78 < (int)uVar17) {
            local_38 = -30000;
            local_150 = 0;
            iVar13 = local_78;
        ...
        if (0 < (int)uVar17) {
          do {
            ...
            if (-1 < iVar14) {
              iVar18 = local_174[iVar13];
              *(int *)(iVar18 + 4) = DAT_00803300[iVar14 * 5] + DAT_008033bc;
              *(int *)(iVar18 + 8) = DAT_00803300[iVar14 * 5 + 1] + DAT_008033c0;
              if (local_8c < iVar13) {
              ...
              *(int *)(iVar18 + 0x10) = iVar10;
              *(int *)(iVar18 + 0x14) = DAT_00803300[iVar14 * 5 + 2];
            }
            iVar13 = iVar13 + 1;
      ...
      g_currentExceptionFrame = local_1b8.previous;
      iVar14 = ReportDebugMessage("E:\\__titans\\scoreai.cpp",0xdc2,0,iVar13,"%s",
                                  "AiAiCalcMinesFields");
      if (iVar14 != 0) {
    ...
    iVar14 = 0;
    do {
      FreeAndNull((void **)(DAT_008032fc + iVar14));
      iVar14 = iVar14 + 4;
    } while (iVar14 < 0x80);
    iVar14 = 0;
    do {
    ...
    if (iVar13 != 0) {
      RaiseInternalException
                (iVar13,g_overwriteContext_007ED77C,"E:\\__titans\\scoreai.cpp",0xdd4);
    }
  }
  ExceptionList = local_14;
  return;
