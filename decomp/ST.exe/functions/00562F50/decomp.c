      ...
      for (; iVar15 <= local_16c; iVar15 = iVar15 + 1) {
        ...
        if (0 < local_9c) {
          do {
            ...
            *(char *)(local_30 + iVar19 * 2) = (char)iVar10;
            if (iVar10 < 1) {
              *(undefined2 *)(local_cc + iVar19 * 2) = 0xffff;
            }
            else if (iVar10 < 3) {
              *(short *)(local_cc + iVar19 * 2) = 5 - (short)iVar10;
            }
            else {
              *(undefined2 *)(local_cc + iVar19 * 2) = 0;
            }
...
LAB_005637bc:
            ...
            if ((-1 < local_84) && (local_84 < iVar14)) {
              ...
              if ((-1 < iVar10) && (iVar10 < DAT_008033a8)) {
                ...
                if (1 < *local_c8) {
                  ...
                  iVar15 = 0;
                  iVar14 = (int)DAT_00803380 + (local_c8[3] + iVar10) * DAT_008033a4 * 2;
                  local_ac = 0;
                  if (0 < local_c8[4]) {
                    do {
                      iVar19 = local_c8[3] + iVar10 + local_ac;
      ...
      for (iVar10 = local_e0; iVar10 <= local_16c; iVar10 = iVar10 + 1) {
        local_30 = (int)DAT_00803380 + iVar10 * iVar14 * 2;
      ...
      if (0 < iVar15) {
        ...
        iVar15 = FUN_006acf90(iVar14,iVar10,DAT_00803304,DAT_00803308);
        if (5 < iVar15) {
            ...
            if (((-1 < iVar14) && (iVar14 < DAT_008033a4)) &&
              ...
              if (0 < DAT_0080338c) {
                do {
                  ...
                  iVar10 = FUN_006acf90(*piVar9,piVar9[1],iVar14,iVar15);
                  if (iVar10 < iVar19 / 2) {
                    local_140 = 1;
                    break;
                  }
              ...
              if (local_140 == 0) {
                iVar19 = 0x10;
                uVar11 = FUN_006db910(DAT_00803304,DAT_00803308,iVar14,iVar15);
                local_74 = (int *)FUN_006db990(uVar11,iVar19);
