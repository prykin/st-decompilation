...

{
  ...
  if (local_8[0x1be7] != (CampaignTy)0x0) goto LAB_00592b7c;
  local_24[5] = *(int *)(local_8 + 0x1be8);
  pCVar6 = local_8 + 0x1bd7;
  iVar3 = 4;
  do {
  ...
  if (*(int *)(this_00 + (local_24[2] + iVar3 * 0xf) * 4 + 0x1b13) == 0)
  ...
  if (*(int *)(*(int *)(this_00 + (local_24[2] + iVar3 * 0xf) * 4 + 0x1b13) + 0x14) -
      *(int *)(*(int *)(this_00 + (local_24[2] + iVar5 * 0xf) * 4 + 0x1b13) + 0x18) != 1)
  goto switchD_00592962_caseD_1;
  switch(uVar1) {
  case 0:
  case 1:
...
switchD_00592962_caseD_1:
  if (local_24[5] != *(int *)(this_00 + 0x1be8)) {
...
LAB_00592b82:
  ...
  do {
    ...
    if (iVar3 != 0) {
      ...
      if (uVar8 <= (uint)(*(int *)(local_8 + 0x61) - piVar7[4])) {
