...
int FUN_00678980(undefined4 *param_1)

{
  ...
  if (iVar2 == 0) {
    if (local_c == 0) {
      ...
      puVar10 = (undefined4 *)(local_c + 0x5d3);
    }
    puVar5 = param_1;
    ...
    *(undefined1 *)(local_c + 0x5eb) = 1;
    thunk_FUN_0064cd80((int *)(*(int *)(local_c + 0x6d1) + 0x12a + (int)param_1));
    piVar9 = (int *)(local_c + 0x695);
    iVar2 = 5;
    local_8 = piVar9;
    do {
      if (*piVar9 != 0) {
    ...
    if (*(int *)(local_c + 0x6a1) == 0) {
      puVar4 = FUN_006ae290((uint *)0x0,10,0x12,5);
      *(uint **)(local_c + 0x6a1) = puVar4;
    }
    if (*(int *)(local_c + 0x6ad) == 0) {
      puVar4 = FUN_006ae290((uint *)0x0,10,0x1c,5);
      *(uint **)(local_c + 0x6ad) = puVar4;
    }
    uVar8 = 0;
    iVar2 = *local_8;
    if (0 < *(int *)(iVar2 + 0xc)) {
