...

{
  ...
  pCVar3 = local_c;
  if (iVar4 == 0) {
    FUN_006b4170((AnonShape_006C7610_838EDECF *)local_c->field_018C,0,param_1 + 0x35,0x70,7,0x21,0);
    ...
    Library::DKW::WGR::FUN_006b55f0
              ((AnonShape_006B84D0_7C7D97C6 *)pCVar3->field_018C,0,param_1 + 0x36,0x91 - uVar5,
