...
LAB_0054f52c:
          ...
          case 0x38:
            ...
            goto LAB_0054f52c;
          case 0x42:
            pcVar13 = (char *)FUN_006b0140(0x426a,HINSTANCE_00807618);
            uVar9 = 0xffffffff;
            do {
              pcVar24 = pcVar13;
              if (uVar9 == 0) break;
              ...
              if (DAT_00808aaf != 0) {
                ...
                do {
                  if ((*(int *)(pcVar13 + -6) == local_30) && (*pcVar13 != '\0')) {
                    wsprintfA(local_17c,s__s___s__007c85fc,local_17c,pcVar13 + -0x46);
                    break;
                  }
                  uVar9 = uVar9 + 1;
...
LAB_0054f531:
    ...
    puVar11 = (undefined4 *)pSVar21->field_0039;
    piVar16 = &pSVar21->field_0039;
    if ((puVar11 == (undefined4 *)0x0) && (pSVar21->field_0028 == 0)) {
    ...
    *(undefined2 *)(pSVar21->field_003D + 5) = 0;
    ...
    if ((uint)pSVar21->field_0045 < uVar9) {
      iVar8 = Library::DKW::LIB::FUN_006acf50(pSVar21->field_003D,uVar9);
...
cf_common_exit_0054F76E:
  ...
  DVar12 = FUN_006e51b0(0x807620);
  if (*(short *)&pSVar21->field_0x7d * 4000 < (int)(DVar12 - pSVar21->field_0079)) {
    FUN_006b6500(g_int_00811764,1);
  ...
  if (pSVar21->field_0075 == 0) {
    ...
    if (iVar8 != 1) {
      ...
      if (iVar8 == 0) {
        FUN_006b6500(g_int_00811764,DAT_0080733c);
        if ((byte)pSVar21->field_00BB < 5) {
          DVar12 = FUN_006e51b0(0x807620);
          (&pSVar21->field_00A7)[(byte)pSVar21->field_00BB] = DVar12;
          cVar7 = pSVar21->field_00BB + '\x01';
          pSVar21->field_00BB = cVar7;
          g_currentExceptionFrame = local_78.previous;
          return (undefined4 *)CONCAT31((int3)(DVar12 >> 8),cVar7);
        }
        ...
        if (g_popUp_008016D8 != (PopUpTy *)0x0) {
          uVar9 = 9;
          pcVar13 = (char *)FUN_006b0140(17000,HINSTANCE_00807618);
          puVar11 = (undefined4 *)thunk_FUN_0052d320(g_popUp_008016D8,pcVar13,uVar9);
        }
  ...
  if ((DAT_0080735e != '\0') && (g_popUp_008016D8 != (PopUpTy *)0x0)) {
    uVar9 = 8;
    pcVar13 = (char *)FUN_006b0140(0x426c,HINSTANCE_00807618);
  ...
  do {
    ...
    case 0x31:
      if ((int)pSVar21->field_0045 < (int)local_18) {
        iVar8 = Library::DKW::LIB::FUN_006acf50(pSVar21->field_003D,local_18);
        pSVar21->field_003D = iVar8;
...
LAB_0054fbb7:
      ...
      if (*puVar19 < uVar9) {
        *(undefined2 *)((int)puVar19 + 5) = 0;
        ...
        if ((char)puVar19[1] != '\0') {
          pSVar21->field_0057 = *(undefined2 *)((int)puVar19 + 5);
          *(undefined2 *)((int)puVar19 + 5) = 0;
          pSVar21->field_0049 = *(undefined4 *)pSVar21->field_003D;
          pSVar21->field_004D = *(undefined1 *)((undefined4 *)pSVar21->field_003D + 1);
