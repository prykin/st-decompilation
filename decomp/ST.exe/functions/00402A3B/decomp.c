...
void thunk_FUN_004f2350(int param_1,ushort param_2,ushort param_3,uint param_4,uint param_5)

{
  ...
  if (iVar2 == 0) {
    ...
    if (param_2 != 0xffff) {
      wsprintfA((LPSTR)(iStack_8 + 0x1e1),&DAT_007c1ae4,param_2);
      FUN_00710a90(param_1,0,0x7d,0x5a,0x18,0xf);
      FUN_00711b70((uint *)(iStack_8 + 0x1e1),-3,-1,param_4 & 0xffff,-1,-1);
    }
    if (param_3 != 0xffff) {
      wsprintfA((LPSTR)(iStack_8 + 0x1e1),&DAT_007c1ae4,param_3);
      FUN_00710a90(param_1,0,0x5f,0x5a,0x18,0xf);
      FUN_00711b70((uint *)(iStack_8 + 0x1e1),-3,-1,param_5 & 0xffff,-1,-1);
    }
    DAT_00858df8 = puStack_4c;
    return;
  }
