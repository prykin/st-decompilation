...
void __fastcall FUN_00591bf0(void *param_1)

{
  ...
  *(DWORD *)((int)param_1 + 0x61) = DVar5;
  ...
  iVar6 = __setjmp3(local_c0,0,unaff_EDI,unaff_ESI);
  this = local_c;
  if (iVar6 != 0) {
  ...
  if (cVar1 == '\x01') {
    ...
    if (local_8 != 0) {
      ...
      local_70 = *(undefined4 *)((int)this + 8);
      ...
      local_48 = 0x697f;
      local_50 = local_70;
      (**(code **)(**(int **)((int)this + 0xc) + 8))(5,(int)this + 0x66,0,local_80,0);
      ...
      if (*(int *)(iVar6 + 0x2e6) != 0) {
        ...
        *(undefined2 *)puVar8 = 0;
        ...
        local_1e = 1;
        local_28._2_2_ = 1;
        thunk_FUN_005b9010(*(void **)(iVar6 + 0x2e6),(int)&local_28);
      }
