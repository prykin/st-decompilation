...
void __thiscall FUN_004fa570(void *this,int param_1,int param_2)

{
  ...
  *(short *)((int)this + 0x2e) = sVar2;
  ...
  if (param_1 == 0) {
    if (*(int *)((int)local_8 + 0x9d0) != 0) {
      FUN_006e6080(local_8,2,*(int *)((int)local_8 + 0x9d0),(undefined4 *)((int)local_8 + 0x18));
    }
    ...
    if (*(int *)((int)local_8 + 0x95c) != 0) {
      FUN_006e6080(local_8,2,*(int *)((int)local_8 + 0x95c),(undefined4 *)((int)local_8 + 0x18));
    }
  ...
  if (((char)local_c != '\0') && (iVar4 = *(int *)((int)this_00 + uVar7 * 4 + 0x314), iVar4 != 0)) {
    FUN_006e6080(this_00,2,iVar4,(undefined4 *)((int)this_00 + 0x18));
  }
  DAT_00858df8 = (undefined4 *)local_50;
  return;
