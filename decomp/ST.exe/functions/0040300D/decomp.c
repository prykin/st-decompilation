...
undefined4
thunk_FUN_00538690(undefined4 param_1,int param_2,int param_3,int param_4,int param_5,int param_6,
                  byte param_7,undefined4 param_8,undefined4 param_9,undefined4 param_10,
...

{
  ...
  iVar2 = __setjmp3(auStack_1cc,0,unaff_EDI,unaff_ESI);
  if (iVar2 == 0) {
    piVar5 = aiStack_18c;
    ...
    wsprintfA((LPSTR)(iStack_10 + 0x6c),&DAT_007c181c,param_8);
    puStack_c = FUN_006f1ce0(param_7,(LPSTR)(iStack_10 + 0x6c),(int *)0x0,1);
    uStack_17c = *(undefined4 *)(puStack_c + 2);
    uStack_178 = *(undefined4 *)(puStack_c + 4);
    if ((param_5 == 0) || (aiStack_18c[2] = DAT_00806730, *(int *)(iStack_10 + 0x5c) != 0)) {
      aiStack_18c[2] = *(int *)(iStack_10 + 0x3c);
    }
    aiStack_18c[2] = aiStack_18c[2] + param_3;
    if ((param_6 == 0) || (aiStack_18c[3] = DAT_00806734, *(int *)(iStack_10 + 0x5c) != 0)) {
      aiStack_18c[3] = *(int *)(iStack_10 + 0x44);
    }
    ...
    (**(code **)(**(int **)(iStack_10 + 0xc) + 8))(2,&uStack_8,0,aiStack_18c,0);
    DAT_00858df8 = puStack_1d0;
    return uStack_8;
  }
  DAT_00858df8 = puStack_1d0;
