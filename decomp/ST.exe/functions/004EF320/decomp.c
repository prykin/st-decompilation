...
void __thiscall FUN_004ef320(void *this,int param_1)

{
  ...
  local_1c = *local_14 - *(int *)((int)this + 0x3c);
  if (*(int *)((int)this + 0x5c) == 0) {
    local_c = local_14[1] - DAT_00806734;
  }
  else {
    local_c = local_14[1] - *(int *)((int)this + 0x44);
  }
  ...
  FUN_006b4170(*(int *)((int)local_18 + 0x68),0,local_1c,local_c,local_14[2],local_14[3],0);
  thunk_FUN_00540760(*(undefined4 **)((int)pvVar2 + 0x68),iVar7 + 1,iVar3 + 1,'\x01',local_10);
  ...
  if ((((local_8 != (undefined4 *)0x0) && (local_8[1] != 0)) && (*(char *)(local_8 + 2) != '\0')) &&
    ...
    wsprintfA((LPSTR)((int)pvVar2 + 0x6c),&DAT_007c1890,local_8[1]);
    FUN_00710a90(*(int *)((int)pvVar2 + 0x68),0,iVar7,iVar3,local_14[2],local_14[3]);
