...
void __thiscall
BldBoatPanelTy::PaintBldBut(BldBoatPanelTy *this,RecoveredRecordView_004EF320_A54422CD *param_1)

{
  ...
  if ((param_1->field_0014 == 0) || (local_8 == nullptr)) {
    ...
    if ((char)local_8[2] == 0) {
      pRVar7 = (RecoveredGlobalRecordView_0081175C *)this->field_018C;
    }
    else {
      pRVar7 = (RecoveredGlobalRecordView_0081175C *)this->field_0188;
    }

    iVar5 = thunk_FUN_00526ba0(*local_8,STField<byte>(local_8,9));
    local_10 = FUN_0070b3a0(pRVar7,iVar5);
  }
  ...
  DibPut((RecoveredSourceFamily_dibcopy *)pBVar3->field_0068,iVar5 + 1,uVar1 + 1,'\x01',
         (RecoveredRecordView_006B84D0_87AF9D9B *)local_10);
  if (param_1->field_0014 == 3) {
    if (local_8 == nullptr) goto LAB_004ef4e9;
    iVar8 = (-(uint)((char)local_8[2] != 0) & 2) + 3;
  }
  else {
    iVar8 = 4;
  }
  ...
  pBVar6 = FUN_0070b3a0(pBVar3->field_0190,iVar8);
  /* ST_CALLSITE[004EF47C]: CALL 0x00403229; direct=00403229 DibPut */
  DibPut((RecoveredSourceFamily_dibcopy *)pBVar3->field_0068,iVar5,uVar1,'\x06',
         (RecoveredRecordView_006B84D0_87AF9D9B *)pBVar6);
  if ((((local_8 != nullptr) && (local_8[1] != 0)) &&
    ...
    ccFntTy::SetSurf(pBVar3->field_028A,pBVar3->field_0068,0,iVar5,uVar1,local_14[2],local_14[3]);
