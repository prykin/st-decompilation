...

{
  ...
  uVar3 = this->field_0199 + -0xc0af + *(int *)(param_1 + 0x10);
  ...
  DibPut((undefined4 *)pBVar2->field_0068,iVar6 + 1,uVar3 + 1,'\x01',(byte *)local_10);
  ...
  DibPut((undefined4 *)pBVar2->field_0068,iVar6,uVar3,'\x06',pbVar5);
