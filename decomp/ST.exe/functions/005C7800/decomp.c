...

{
  ...
  iVar3 = __setjmp3(local_88,0,unaff_EDI,extraout_ECX);
  if (iVar3 != 0) {
    DAT_00858df8 = local_8c;
...
LAB_005c7ae0:
  ...
  if (DAT_00853ff8 != (undefined4 *)0x0) {
    ...
    thunk_FUN_006952b0(local_5a80,(byte *)&DAT_00853de0,(byte *)((int)piVar16 + 0x1f53));
  ...
  if (*(int *)((int)piVar16 + 7999) != 0) {
    ...
    *(ushort **)(DAT_0081176c + 0x2f4) = puVar6;
    ...
    if ((puVar6 == (ushort *)0x0) || ((char)DAT_0080c3c3 == '\0')) {
      FUN_0072e730(&DAT_00853de4,(byte *)0x0,(byte *)0x0,local_228,(byte *)0x0);
      uVar4 = 0xffffffff;
      pbVar9 = local_228;
      do {
        pbVar13 = pbVar9;
