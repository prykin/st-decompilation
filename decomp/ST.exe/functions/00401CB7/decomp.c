...
void __thiscall
thunk_FUN_00559ec0(void *this,int param_1,int param_2,undefined1 param_3,uint param_4,int param_5,
...

{
  ...
  if ((((*(int *)((int)this + 0x114) != 0) && (-1 < param_5)) && (param_4 < 8)) &&
    ...
    pvStack_14 = this;
    if (*(int *)((int)this + param_4 * 4 + 0x94) == 0) {
      ...
      if (iVar4 != 0) {
        ...
        iVar4 = FUN_006ad4d0(s_E____titans_grig_visible_cpp_007c92cc,0x31b,0,iVar4,&DAT_007a4ccc);
        if (iVar4 == 0) {
          return;
        }
        pcVar2 = (code *)swi(3);
      ...
      *(undefined4 **)((int)this + param_4 * 4 + 0x94) = puVar5;
      DAT_00858df8 = (undefined4 *)uStack_60;
    }
    if ((param_7 & 0x1000) != 0) {
