...

{
  ...
  FUN_006b4170((AnonShape_006C7610_838EDECF *)this_02->field_1CB8,0,3,0x15,0x142,0x62,0xff);
...
LAB_005d8dbf:
  ...
  if (iVar4 < 1) {
      ...
      do {
        ...
        if (0 < iVar4 + -1) {
          do {
            uVar10 = uVar9 + 1;
            if ((int)uVar10 < iVar4) {
              pcVar18 = *(char **)(pAVar5->field_0014 + 4 + uVar9 * 4);
            }
            else {
              pcVar18 = (char *)0x0;
            }
    ...
    if (0 < local_8) {
      ...
      do {
        pbVar14 = *(byte **)(this_02->field_1CCC->field_0014 + iVar11 * 4);
LAB_005d8fe2:
        pbVar15 = local_dc;
        do {
          bVar2 = *pbVar14;
