...
switchD_004806bc_caseD_a:
    uVar11 = ((0x18 - (int)*(short *)((int)param_1 + 0x6c) / 0xf) % 0x18 + (4 - DAT_008073fc) * 6) %
             0x18;
    uVar4 = thunk_FUN_004ac910(this,'\x0e');
    if (uVar11 != uVar4) {
      STT3DSprC::SetCurFase(this,'\x0e',uVar11);
      STT3DSprC::SetCurFase(this,'\f',uVar11);
      iVar3 = STT3DSprC::ShowCurFase(this,'\x0e');
      if (iVar3 != 0) {
        return 0xffffffff;
      }
...
LAB_00480a79:
                ...
                bVar1 = g_playerRelationMatrix[uVar4][bVar20];
                if ((bVar1 == 0) && (g_playerRelationMatrix[bVar20][uVar4] == 0)) {
                  iVar5 = -2;
                }
                else if ((bVar1 == 1) && (g_playerRelationMatrix[bVar20][uVar4] == 0)) {
                  iVar5 = -1;
                }
                else if ((bVar1 == 0) && (g_playerRelationMatrix[bVar20][uVar4] == 1)) {
                  iVar5 = 1;
                }
                else {
                  if ((bVar1 != 1) || (g_playerRelationMatrix[bVar20][uVar4] != 1))
                  goto LAB_00480a79;
                  iVar5 = 2;
                }
              }
...
LAB_00480b80:
              ...
              if (*(int *)((int)param_1 + 0x74a) == (int)*(short *)(DAT_00806724 + 0x23) / 2 + 1) {
                STAllPlayersC::DelObjFromTmps
                          (g_sTAllPlayers_007FA174,DAT_0080874d,*(int *)((int)param_1 + 0x20),
                           local_8,CONCAT22((short)((uint)*(int *)((int)param_1 + 0x74a) >> 0x10),
...
LAB_00480b30:
                  ...
                  uVar4 = (uint)DAT_0080874d;
                  bVar1 = g_playerRelationMatrix[bVar20][uVar4];
                  if ((bVar1 == 0) && (g_playerRelationMatrix[uVar4][bVar20] == 0)) {
                    iVar5 = -2;
                  }
                  else if ((bVar1 == 1) && (g_playerRelationMatrix[uVar4][bVar20] == 0)) {
                    iVar5 = -1;
                  }
                  else if ((bVar1 == 0) && (g_playerRelationMatrix[uVar4][bVar20] == 1)) {
                    iVar5 = 1;
                  }
                  else {
                    if ((bVar1 != 1) || (g_playerRelationMatrix[uVar4][bVar20] != 1))
                    goto LAB_00480b30;
                    iVar5 = 2;
                  }
                }
...
LAB_00480d55:
          ...
          if ((bVar1 == 0) && (g_playerRelationMatrix[bVar20][uVar4] == 0)) {
            ...
            if ((bVar1 != 1) || (g_playerRelationMatrix[bVar20][uVar4] != 1)) goto LAB_00480d55;
            iVar3 = 2;
          }
        }
        bVar2 = iVar3 < 0;
...
LAB_00480e0f:
            ...
            if ((bVar1 == 0) && (g_playerRelationMatrix[uVar4][bVar20] == 0)) {
              ...
              if ((bVar1 != 1) || (g_playerRelationMatrix[uVar4][bVar20] != 1)) goto LAB_00480e0f;
              iVar3 = 2;
            }
          }
          bVar2 = iVar3 < 0;
  ...
  if ((((*(char *)((int)param_1 + 0xe3) == '\x01') && (*(short *)((int)param_1 + 0xfa) == 0)) &&
    ...
    do {
      ...
      if (DAT_0080732c == 1) {
        ...
        iVar9 = (int)*(short *)((int)param_1 + 0x43) - (int)local_18._2_2_;
        iVar10 = (int)(short)local_18 + iVar3 + *(short *)((int)param_1 + 0x41);
      }
      else {
      ...
      TraksClassTy::TraksCreate
                (g_traksClass_00802A7C,1,2,7,iVar10,iVar9 + ((uVar4 >> 0x10) % 7 - 3),iVar7,sVar13,
