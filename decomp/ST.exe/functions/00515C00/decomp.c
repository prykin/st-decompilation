...
void FUN_00515c00(int *param_1,UINT param_2)

{
  ...
  if (param_2 != 10000) {
    FUN_00710a90(*(int *)((int)local_8 + 0x218),0,0,*param_1,0x19c,0xf);
    uVar10 = 3;
    iVar9 = -1;
    iVar3 = -1;
    ...
    *param_1 = *param_1 + 0xf;
    ...
    uVar6 = FUN_007113e0(*(void **)((int)local_8 + 0x1e0),&DAT_0080f33a);
    thunk_FUN_00511ab0(local_8,*param_1,uVar6);
    FUN_00710a90(*(int *)((int)local_8 + 0x218),0,0,*param_1,0x19c,uVar6 + 2);
