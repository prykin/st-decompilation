      ...
      do {
        ...
        if (((byte)*(undefined4 *)local_20 & 7) == 1) {
          ...
          if (0 < *piVar8) {
            local_a4 = 0;
            do {
              iVar6 = FUN_006b0460(&local_78,(int *)local_54,(int *)(local_a4 + 8 + (int)piVar8));
              if (iVar6 != 0) {
          ...
          if (0 < *piVar9) {
            ...
            do {
              ...
              if (((iVar12 != 0) && (*(uint *)local_20 = *(uint *)local_20 | 0x82, *piVar8 < 5)) &&
                 (iVar11 = FUN_006d1ad0(piVar8,4,local_78,local_74,local_70,local_6c,local_24[0x1b],
    ...
    if (param_1[0xc9] + iVar10 <= iVar12) {
      do {
        ...
        if ((*(byte *)local_20 & 2) == 0) {
          ...
          iVar5 = FUN_006d1ad0((int *)param_1[0xd5],100,*piVar8,piVar8[1],piVar8[2],piVar8[3],
                               local_2c,local_28,1);
          ...
          if (0 < *piVar9) {
            ...
            do {
              ...
              if ((iVar12 != 0) && (*(uint *)local_20 = *(uint *)local_20 | 2, *piVar8 < 5)) {
                ...
                local_EAX_1132 =
                     FUN_006d1ad0(piVar8,4,local_78,local_74,local_70,local_6c,local_24[0x1b],
                                  local_24[0x1c],0);
                if (local_EAX_1132 < 0) {
                  if ((*(byte *)(piVar8 + -5) & 0x40) != 0) {
                    *(undefined4 *)(param_1[0xcc] + 0x18 + iVar13 * 0x68) = 5;
        ...
        if ((((*(int *)(local_20->field_0064 + 0x90) != 0) && ((*(byte *)local_20 & 0x80) != 0)) &&
          ...
          do {
            if (((((byte)*puVar7 & 7) == 1) || ((int)puVar7[6] < 5)) &&
               (iVar12 = FUN_006b0460(&local_78,(int *)local_54,(int *)(puVar7[0x19] + 100)),
               iVar12 != 0)) {
              *puVar7 = *puVar7 | 2;
              if ((int)puVar7[6] < 5) {
                if ((puVar7[1] & 0x40) != 0) {
                ...
                local_EAX_1501 =
                     FUN_006d1ad0((int *)(puVar7 + 6),4,local_78,local_74,local_70,local_6c,
...
LAB_006ec68d:
    ...
    do {
      /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
      iVar10 = FUN_006bbe40(*(int **)(param_1[1] + 0x40),&local_48,&local_44,0);
      local_40 = iVar10;
    ...
    if (iVar10 == 0) {
      ...
      while (piVar8 = (int *)param_1[0xd4], iVar13 < *piVar8) {
        if ((param_1[0x51] == 0) || (param_1[7] == 0)) {
          ...
          CopyRows((byte *)(local_38 + local_48),local_44,pbVar11,iVar10,uVar1,local_88);
        }
        local_cc = iVar13 + 1;
        iVar10 = iVar13 * 0x10;
        iVar13 = local_cc;
        if ((int *)*param_1 != nullptr) {
          iVar12 = param_1[0xd4];
          /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
          FUN_006b5f80((int *)*param_1,*(int *)(iVar10 + 8 + iVar12) + param_1[8],
  ...
  if ((param_1[0x51] == 0) || (param_1[7] == 0)) {
    ...
    CopyRows((byte *)(local_38 + local_48),local_44,pbVar11,iVar10,iVar12 - iVar13,rowCount);
    local_8 = 0xffffffff;
    /* ST_PSEUDO[raw_indirect_call]: expected typed vtable/callback call with explicit __thiscall receiver */
    (**(code **)(**(int **)(param_1[1] + 0x40) + 0x80))(*(int **)(param_1[1] + 0x40),0);
  }
