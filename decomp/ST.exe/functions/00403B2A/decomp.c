...

{
  ...
  if (*(int *)(param_1 + 0x4efa) == 0) {
    ...
    iStack_c = param_1;
    iVar1 = Library::MSVCRT::__setjmp3(IStack_60.jumpBuffer,0,unaff_ESI,in_stack_fffffe9c);
    if (iVar1 == 0) {
      Library::DKW::DDX::FUN_006bd740(DAT_008075a8);
      Library::DKW::DDX::FUN_006c4630(DAT_0080759c,*(int **)(DAT_0080759c + 0x44),auStack_1c);
      ptStack_8 = Library::DKW::DDX::FUN_006c4880
                            (DAT_0080759c,0,0,DAT_00806730,DAT_00806734,DAT_00806738);
      Library::DKW::DDX::FUN_006c44e0(DAT_0080759c,auStack_1c);
      iVar1 = iStack_c;
      if (ptStack_8 != (LPBITMAPINFO)0x0) {
        wsprintfA(&stack0xfffffe9c,s__sscr_03d_bmp_007ca2e8,iStack_c + 0x60,
                  (uint)*(ushort *)(iStack_c + 0x1138));
        Library::DKW::WGR::FUN_006c4230(&stack0xfffffe9c,ptStack_8,(LPCVOID)0x0);
