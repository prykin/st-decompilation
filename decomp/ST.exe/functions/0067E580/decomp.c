...

{
  ...
  if (iVar3 != 0) {
    ...
    iVar5 = FUN_006ad4d0(s_E____titans_ai_ai_plr_d_cpp_007d2fa4,0x1eb,0,iVar3,&DAT_007a4ccc);
    if (iVar5 != 0) {
      pcVar1 = (code *)swi(3);
      pCVar4 = (LPSTR)(*pcVar1)();
      return pCVar4;
    }
    FUN_006a5e40(iVar3,0,0x7d2fa4,0x1ec);
    return (LPSTR)0x0;
  }
  if (param_1 == 0) {
    FUN_006a5e40(-0x34,DAT_007ed77c,0x7d2fa4,0x1e8);
  }
