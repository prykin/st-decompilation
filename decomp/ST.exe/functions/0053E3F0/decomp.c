...
void FUN_0053e3f0(char *param_1,undefined4 param_2,undefined4 param_3,int param_4,int param_5,
...

{
  ...
  if (iVar2 == 0) {
    local_8[0xf] = local_8[0xf] + (DAT_00806730 + -800) / 2;
    puVar3 = FUN_006f1ce0(1,param_1,(int *)0x0,1);
    *(ushort **)((int)local_8 + 0x185) = puVar3;
    puVar4 = FUN_0070df00(0x19d,*(int *)(DAT_00802a28 + 0x28));
    *(undefined4 **)((int)local_8 + 0x189) = puVar4;
    puVar4[0x16] = 0;
    puVar4[0x17] = 0;
    iVar2 = local_8[0x1a];
    ...
    thunk_FUN_00540760((undefined4 *)local_8[0x1a],0,0,'\x01',*(byte **)((int)local_8 + 0x185));
    FUN_00710a90(local_8[0x1a],0,param_2,param_3,param_4,param_5);
    uVar15 = 0;
    iVar13 = -1;
    iVar2 = -2;
