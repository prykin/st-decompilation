...

{
  ...
  if (iVar4 == 0) {
    ...
    iVar15 = -1;
    iVar4 = -2;
    LoadResourceString(param_6,HINSTANCE_00807618);
    ccFntTy::WrStr(pSVar3->field_0189,extraout_EAX,iVar4,iVar15,uVar17);
    uVar18 = 1;
  ...
  g_currentExceptionFrame = local_4c.previous;
  iVar15 = ReportDebugMessage(s_E____titans_Andrey_specpan_cpp_007c7870,0xeb,0,iVar4,&DAT_007a4ccc,
