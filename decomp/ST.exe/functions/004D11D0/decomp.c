...

{
  ...
  iVar11 = thunk_FUN_00417a20(this_01,(short)this_01->field_025D,(short)this_01->field_0261,
    ...
    do {
      ...
      if (iVar14 < iVar14 + local_c) {
        do {
          sVar18 = (short)iVar14;
          sVar19 = (short)iVar11;
          thunk_FUN_004960d0(sVar18,sVar19,this_01->field_0265);
  ...
  if (this_01->field_023D != 1) {
    if (this_01->field_023D == 2) {
      ...
      *local_28 = PTR_00806774;
      ...
      iVar11 = STT3DSprC::Init(pSVar6,PTR_008073cc,this_01->field_0300,this_01->field_0304,
      ...
      if (this_01->field_002C == 1) {
        uVar7 = thunk_FUN_004ad650(this_01->field_035C);
        Library::Ourlib::ST3DSMAP::SprSetSplit((void *)this_01->field_0211,uVar7);
      }
      ...
      FUN_006ea340((void *)this_01->field_0211,local_EAX_1989,iVar4,uVar7);
      memset(local_28, 0, 0x44); /* compiler bulk-zero initialization */
      local_28[0xe] = PTR_0080678c;
      local_24 = 0;
      local_10 = 0;
      ...
      if (this_01->field_0370 == 0) {
        ...
        do {
          ...
          *ppSVar17 = pSVar6;
          ...
          FUN_006ea340((void *)this_01->field_0211,uVar9,local_EAX_2184,uVar20);
          STT3DSprC::RestoreSpr
...
LAB_004d1bda:
  ...
  FUN_006ea340((void *)this_01->field_0211,uVar8,local_EAX_2619,uVar7);
  ...
  wsprintfA(local_88,"%s%1i",(&PTR_s_tlo_embws1_007bf3e8)[this_01->field_036C],uVar7);
  iVar11 = STT3DSprC::LoadSequence((STT3DSprC *)this_00,0xe,PTR_0080678c,local_88,CASE_1D);
  if (iVar11 != 0) {
    RaiseInternalException
...
LAB_004d204d:
    ...
    iVar11 = this_01->field_02EC + this_01->field_0241 * 4;
    ...
    do {
      ...
      *ppSVar17 = pSVar6;
      ...
      FUN_006ea340((void *)this_01->field_0211,local_EAX_4068,local_EAX_4060,(uint)pTVar21);
      STT3DSprC::sub_004AD3C0
...
LAB_004d1f0b:
      ...
      STT3DSprC::UnLoadSequence((STT3DSprC *)this_00,(byte)iVar11);
      uVar7 = this_01->field_02F4;
      local_EAX_3446 = thunk_FUN_004ad650((STT3DSprC *)this_00);
      local_EAX_3458 = thunk_FUN_004ad650(this_01->field_035C);
      FUN_006ea340((void *)this_01->field_0211,local_EAX_3458,local_EAX_3446,uVar7);
      STT3DSprC::StartShow
...
LAB_004d1df8:
  ...
  sub_00419C70((int *)this_01,uVar12,(uint)(this_01->field_023D == 0));
  ...
  iVar11 = thunk_FUN_004b7520(STReplaceLowByte((uint32_t)(this_01->field_0259), (uint8_t)(*(undefined1 *)&this_01->field_0024)),this_01->field_0259);
  if (iVar11 != 0) {
    iVar11 = this_01->vfunc_2C();
    thunk_FUN_004b76d0(STReplaceLowByte((uint32_t)(iVar11), (uint8_t)(*(undefined1 *)&this_01->field_0024)),
                       iVar11);
  }
