...
int thunk_FUN_00413050(int param_1,int param_2,int param_3,int param_4,int param_5)

{
      ...
      ((-1 < param_2 && (param_2 < DAT_007f4d30)))) && ((-1 < param_3 && (param_3 < DAT_007f4d34))))
  {
    ...
    if (iVar2 != -4) {
      RaiseInternalException(iVar2,DAT_007ed77c,s_E____titans_wlad_Grpway3d_cpp_007a4ca8,0xca9);
      return iVar2;
    }
  }
  return -4;
