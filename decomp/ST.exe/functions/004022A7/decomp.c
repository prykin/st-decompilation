...

{
  ...
  if (*(int *)((int)this + 0x5f3) == 0) {
    ...
    *(undefined4 *)(*(int *)((int)this + 0x1f5) + 0x1e4) = 0;
    ...
    iVar3 = STT3DSprC::LoadSequence
                      ((STT3DSprC *)((int)this + 0x1d5),0xd,DAT_0080678c,abStack_154,0x1d);
    if (iVar3 != 0) {
  ...
  if (*(int *)(&DAT_00791a10 + *(int *)((int)this + 0x235) * 4) != 0) {
    ...
    iVar3 = STT3DSprC::LoadSequence(this_00,9,DAT_0080678c,abStack_154,0x1d);
    if (iVar3 != 0) {
    ...
    if ((*(int *)((int)this + 0x5ac) != 0x40) && (*(int *)((int)this + 0x5ac) != 0x49)) {
      wsprintfA((LPSTR)abStack_154,s__s_cover_1i_007ac8ec,*(undefined4 *)((int)this + 0x5f3),
                *(undefined4 *)((int)this + 0x5c0));
      iVar3 = STT3DSprC::LoadSequence(this_00,8,DAT_0080678c,abStack_154,0x1d);
      if (iVar3 != 0) {
    ...
    if (*(int *)((int)this + 0x5ac) == 0x4e) {
      ...
      iVar3 = STT3DSprC::LoadSequence(this_00,7,DAT_0080678c,abStack_154,0x1d);
      if (iVar3 != 0) {
    ...
    if (*(int *)((int)this + 0x5ac) == 0x52) {
      ...
      wsprintfA((LPSTR)abStack_154,pcVar8);
      iVar3 = STT3DSprC::LoadSequence(this_00,7,DAT_0080678c,abStack_154,0x1d);
      if (iVar3 != 0) {
  ...
  if ((((iVar3 == 0) || (iVar3 == 5)) || ((iVar3 == 1 && (*(int *)((int)this + 0x24d) == 0)))) ||
    ...
    iVar3 = STT3DSprC::LoadSequence
                      (this_00,0x10,DAT_0080678c,(&PTR_s_tlo_sha_ws_007bb1b4)[iStack_8],0x1d);
    if (iVar3 != 0) {
