...

{
  ...
  iVar3 = *(int *)(pTStack_10 + 0x245);
  iStack_c = iVar3;
  thunk_FUN_004c96e0((int)pTStack_10);
  if ((iVar3 == 1) && (*(int *)(this_00 + 0x24d) == 4)) {
    iVar3 = (iStack_8 + *(int *)(this_00 + 0x235) * 3) * 0xc;
  ...
  if (*(int *)(this_00 + 0x5f3) == 0) {
    ...
    *(undefined4 *)(*(int *)(this_00 + 0x1f5) + 0x1e4) = 0;
    ...
    wsprintfA((LPSTR)abStack_154,s__s_1i_007ac908,*(int *)(this_00 + 0x5f3),
              *(undefined4 *)(this_00 + 0x5c0));
    iVar3 = STT3DSprC::LoadSequence
                      ((STT3DSprC *)(this_00 + 0x1d5),0xd,DAT_0080678c,abStack_154,0x1d);
    if (iVar3 != 0) {
  ...
  if (*(int *)(&DAT_00791a10 + *(int *)(this_00 + 0x235) * 4) != 0) {
    wsprintfA((LPSTR)abStack_154,s__s_cover_007ac8fc,*(undefined4 *)(this_00 + 0x5ef));
    iVar3 = STT3DSprC::LoadSequence(this_01,9,DAT_0080678c,abStack_154,0x1d);
    if (iVar3 != 0) {
    ...
    if ((*(int *)(this_00 + 0x5ac) != 0x40) && (*(int *)(this_00 + 0x5ac) != 0x49)) {
      wsprintfA((LPSTR)abStack_154,s__s_cover_1i_007ac8ec,*(undefined4 *)(this_00 + 0x5f3),
                *(undefined4 *)(this_00 + 0x5c0));
      iVar3 = STT3DSprC::LoadSequence(this_01,8,DAT_0080678c,abStack_154,0x1d);
      if (iVar3 != 0) {
    ...
    if (*(int *)(this_00 + 0x5ac) == 0x4e) {
      ...
      iVar3 = STT3DSprC::LoadSequence(this_01,7,DAT_0080678c,abStack_154,0x1d);
      if (iVar3 != 0) {
  ...
  RotateSpr(this_00,1);
  iVar3 = iStack_c;
  if ((iStack_c == 1) && (*(int *)(this_00 + 0x24d) == 4)) {
    iVar3 = 4;
  }
  ...
  if ((((iVar3 == 0) || (iVar3 == 5)) || ((iVar3 == 1 && (*(int *)(this_00 + 0x24d) == 0)))) ||
    ...
    iVar3 = STT3DSprC::LoadSequence
                      (this_01,0x10,DAT_0080678c,(&PTR_s_tlo_sha_ws_007bb1b4)[iStack_8],0x1d);
    if (iVar3 != 0) {
