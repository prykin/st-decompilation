...
void __thiscall
MMObjTy::InitSprBut(MMObjTy *this,undefined4 *param_1,byte *param_2,int param_3,int param_4,
...

{
  ...
  if (iVar4 == 0) {
    ...
    *param_1 = param_7;
    ...
    (*pSVar1->vtable->SetImagesReg)(pSVar1,DAT_00806784,7,0,param_2,0xffffffff);
    ...
    *(int *)((int)param_1 + 0xf9) = param_4 + param_6;
    if ((param_18 != 0) && (param_19 != 0)) {
      ...
      uVar10 = 0xffffffff;
      cVar9 = CASE_FFFFFFFE;
      puVar5 = (uint *)FUN_006b0140(param_18,DAT_00807618);
      psVar6 = (short *)ccFntTy::CreateTypeSSpr
                                  ((ccFntTy *)param_19,puVar5,param_20,param_21,cVar9,uVar10,
                                   param_22,param_23,param_24);
