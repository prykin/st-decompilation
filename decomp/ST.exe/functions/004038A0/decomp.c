...
thunk_FUN_0061ca90(void *this,int param_1,int param_2,int param_3,int *param_4)

{
  ...
  if (((((-1 < iVar17) && (-1 < iVar13)) && (-1 < iVar10)) &&
      ((iVar19 = (int)DAT_007fb240, iVar17 < iVar19 && (iVar15 = (int)DAT_007fb242, iVar13 < iVar15)
       ))) && (iVar10 < 5)) {
    iStack_20 = iVar13 + -1;
    if (iVar13 + -1 < 0) {
      iStack_20 = 0;
    ...
    do {
      ...
      if (iStack_20 < iVar10) {
        do {
          iVar17 = iStack_28;
          if (iStack_28 < iStack_1c) {
            piVar18 = aiStack_800 + iVar13 * 0xb;
            do {
              sVar9 = (short)iStack_28;
              if ((((-1 < sVar9) && (sVar9 < sVar16)) &&
                  ((sVar12 = (short)iStack_10, -1 < sVar12 &&
                   (((sVar12 < DAT_007fb242 && (sVar14 = (short)iVar19, -1 < sVar14)) &&
                    (sVar14 < DAT_007fb244)))))) &&
                 (((this_00 = *(int **)(DAT_007fb248 +
                                       ((int)sVar12 * (int)sVar16 + (int)sVar14 * (int)DAT_007fb246
                                       + (int)sVar9) * 8), this_00 != (int *)0x0 &&
                   (iVar17 = (**(code **)(*this_00 + 0xf0))(), iVar17 != 0)) &&
                  (((uint)this_00[9] < 8 &&
                   ((DAT_00802a38 == 0 || ((byte)(&DAT_008087e9)[this_00[9] * 0x51] < 8)))))))) {
                bVar1 = *(byte *)(this_00 + 9);
                bVar2 = *(byte *)((int)pvStack_44 + 0x51);
                _bStack_30 = CONCAT31(uStack_2f,bVar1);
                _bStack_40 = CONCAT31(uStack_3f,bVar2);
                if (DAT_00808a8f == '\0') {
                  if (bVar1 == bVar2) {
LAB_0061cd61:
                    iVar17 = 0;
                ...
                if ((bVar21) && (iVar17 = (**(code **)(*this_00 + 0xf8))(), iVar17 != 0)) {
                  thunk_FUN_00416270(this_00,&sStack_6,(undefined2 *)((int)&param_3 + 2),&sStack_22)
                  ;
                  ...
                  *(undefined4 *)((int)piVar18 + 0x22) = uVar11;
                  if (*(int *)((int)piVar18 + 0x1e) < iVar17) {
                    iStack_3c = *(int *)((int)piVar18 + 0x1e);
                    iStack_34 = iStack_c;
                  }
                  piVar18 = piVar18 + 0xb;
                  iStack_c = iStack_c + 1;
              ...
              iVar10 = iStack_2c;
              sVar16 = DAT_007fb240;
            } while (iStack_28 < iStack_1c);
          }
          iStack_10 = iStack_10 + 1;
          iStack_28 = iVar17;
        } while (iStack_10 < iVar10);
      }
      iStack_14 = iVar19 + 1;
    } while (iVar19 + 1 < 5);
    if (0 < iVar13) {
      uStack_38 = 1;
      piVar18 = aiStack_800 + iStack_34 * 0xb;
      for (iVar17 = 0xb; iVar17 != 0; iVar17 = iVar17 + -1) {
        *param_4 = *piVar18;
        piVar18 = piVar18 + 1;
        param_4 = param_4 + 1;
