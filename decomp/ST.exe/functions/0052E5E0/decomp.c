...

{
  ...
  if (iVar2 == 0) {
    ...
    *(undefined4 **)(local_8 + 0x17c) = puVar3;
    puVar3[0x16] = 0;
    puVar3[0x17] = 0;
    ...
    *(ushort **)(local_8 + 0x198) = puVar5;
    puVar3 = (undefined4 *)(*(int *)(local_8 + 0x184) + 0x28);
    iVar2 = 1;
    uVar12 = FUN_006b4fe0(*(int *)(local_8 + 0x184));
    uVar7 = FUN_006b50c0(0xde,0xb,(uint)*(ushort *)(*(int *)(local_8 + 0x184) + 0xe),uVar12,puVar3,
                         iVar2);
    *(undefined4 *)(local_8 + 0x1e5) = uVar7;
    puVar8 = FUN_006b54f0((uint *)0x0,1,1);
    *(uint **)(local_8 + 0x1f1) = puVar8;
    ...
    uVar14 = 0xc004;
    uVar9 = 0xc003;
    *(undefined4 *)(local_8 + 0x1ad) = uVar7;
    pCVar4 = thunk_FUN_00571240(s_BUT_MEDIUM_007c3894,0);
    uVar7 = thunk_FUN_0053dea0(0,0,0x93,0x9f,1,(int)pCVar4,uVar9,uVar14,sVar10,uVar11,uVar18,pcVar15
                               ,uVar19,uVar20);
    *(undefined4 *)(local_8 + 0x1b1) = uVar7;
    *(undefined4 *)(local_8 + 0x301) = *(undefined4 *)(local_8 + 0x38);
