...
void __thiscall
PanelTy::PaintLBut(PanelTy *this,RecoveredRecordView_00538FC0_46DCC163 *param_1,byte param_2,
...
LAB_00538ff6:
  ...
  if (param_5 != nullptr) {
    ...
    if (local_EAX_145 == 0) {
      ...
      DibPut((RecoveredSourceFamily_dibcopy *)local_14->field_0068,local_c,local_10,param_2,local_8);
      ...
      if (param_1->field_0014 == 3) {
        ...
        DibPut((RecoveredSourceFamily_dibcopy *)pPVar3->field_0068,local_c,iVar6,'\x06',local_8);
        cMf32::RecMemFree(g_cMf32_00806790,(uint *)&local_8);
      }
