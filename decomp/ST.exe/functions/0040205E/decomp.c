...
void __thiscall
thunk_FUN_0055a270(void *this,int param_1,int param_2,undefined1 param_3,uint param_4,int param_5,
...

{
  ...
  if ((((*(int *)((int)this + 0x114) != 0) && (-1 < param_5)) && (param_4 < 8)) &&
    ...
    pvStack_14 = this;
    if (*(int *)((int)this + param_4 * 4 + 0xb4) == 0) {
      ...
      *(undefined4 **)((int)this + param_4 * 4 + 0xb4) = puVar5;
      DAT_00858df8 = (undefined4 *)uStack_60;
    }
    if ((param_7 & 0x1000) != 0) {
