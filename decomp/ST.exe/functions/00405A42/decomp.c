...

{
  ...
  case 3:
    ...
    case '\f':
    case '\x0e':
      pOStack_c[0x1a9] = (OptPanelTy)0x1;
    case '\x01':
      if (param_1 == '\x01') {
    ...
    case '\r':
    default:
      if (*(short *)(pOStack_c + 0x172) == 1) {
        ShiftControls(pOStack_c,0);
      }
  ...
  case 2:
    if (DAT_008016e8 != (ProdPanelTy *)0x0) {
      iStack_8 = ProdPanelTy::SetPanel(DAT_008016e8,'\0');
    }
    bVar4 = iStack_8 != 0;
    if (DAT_0080167c != (ProdPanelTy *)0x0) {
      iStack_8 = ProdPanelTy::SetPanel(DAT_0080167c,'\0');
    }
    bVar5 = iStack_8 != 0;
    if (DAT_00801684 != (ProdPanelTy *)0x0) {
      iStack_8 = ProdPanelTy::SetPanel(DAT_00801684,'\0');
    }
    bVar6 = iStack_8 != 0;
    ...
    if (DAT_00801680 != (ProdPanelTy *)0x0) {
      iStack_8 = ProdPanelTy::SetPanel(DAT_00801680,'\0');
    }
    bVar13 = iStack_8 != 0;
    ...
    if (DAT_008016e4 != (PlayPanelTy *)0x0) {
      iStack_8 = PlayPanelTy::SetPanel(DAT_008016e4,'\0');
    }
    if ((iStack_8 != 0 ||
         (bVar14 ||
         (bVar13 ||
