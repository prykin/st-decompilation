...
void __thiscall thunk_FUN_0052f2b0(void *this,char param_1)

{
  ...
  switch(*(short *)((int)pvStack_c + 0x172)) {
  case 1:
  case 3:
    switch(param_1) {
    case '\x02':
    case '\f':
    case '\x0e':
      *(undefined1 *)((int)pvStack_c + 0x1a9) = 1;
    case '\x01':
      if (param_1 == '\x01') {
        *(undefined1 *)((int)pvStack_c + 0x1a9) = 0;
      }
      if (param_1 == *(char *)((int)pvStack_c + 0x1a4)) {
        DAT_00858df8 = (undefined4 *)uStack_5c;
        return;
      }
      *(char *)((int)pvStack_c + 0x1a4) = param_1;
      thunk_FUN_0052fb00();
      DAT_00858df8 = (undefined4 *)uStack_5c;
      return;
    case '\x03':
    ...
    case '\r':
    default:
      if (*(short *)((int)pvStack_c + 0x172) == 1) {
        thunk_FUN_0052f900(pvStack_c,0);
      }
  ...
  case 2:
    if (DAT_008016e8 != (void *)0x0) {
      iStack_8 = thunk_FUN_0053f650(DAT_008016e8,'\0');
    }
    bVar5 = iStack_8 != 0;
    if (DAT_0080167c != (void *)0x0) {
      iStack_8 = thunk_FUN_0053f650(DAT_0080167c,'\0');
    }
    bVar6 = iStack_8 != 0;
    if (DAT_00801684 != (void *)0x0) {
      iStack_8 = thunk_FUN_0053f650(DAT_00801684,'\0');
    }
    bVar7 = iStack_8 != 0;
    if (DAT_00801698 != (int *)0x0) {
      iStack_8 = (**(code **)(*DAT_00801698 + 0x1c))(0);
    }
    bVar8 = iStack_8 != 0;
    if (DAT_00802a44 != (void *)0x0) {
      iStack_8 = thunk_FUN_00552160(DAT_00802a44,'\0','\0');
    }
    bVar9 = iStack_8 != 0;
    if (DAT_00801678 != (int *)0x0) {
      iStack_8 = (**(code **)(*DAT_00801678 + 0x1c))(0);
    }
    bVar10 = iStack_8 != 0;
    if (DAT_008016ec != (int *)0x0) {
      iStack_8 = (**(code **)(*DAT_008016ec + 0x1c))(0);
    }
    bVar11 = iStack_8 != 0;
    if (DAT_00802a48 != (int *)0x0) {
      iStack_8 = (**(code **)(*DAT_00802a48 + 0x1c))(0);
    }
    bVar12 = iStack_8 != 0;
    if (DAT_0080168c != (int *)0x0) {
      iStack_8 = (**(code **)(*DAT_0080168c + 0x1c))(0);
    }
    bVar13 = iStack_8 != 0;
    if (DAT_00801680 != (void *)0x0) {
      iStack_8 = thunk_FUN_0053f650(DAT_00801680,'\0');
    }
    bVar14 = iStack_8 != 0;
    if (DAT_00801690 != (int *)0x0) {
      iStack_8 = (**(code **)(*DAT_00801690 + 0x18))(0);
    }
    bVar15 = iStack_8 != 0;
    if (DAT_008016e4 != (void *)0x0) {
      iStack_8 = thunk_FUN_0053a820(DAT_008016e4,'\0');
    }
    if ((iStack_8 != 0 ||
         (bVar15 ||
         (bVar14 ||
    ...
    uStack_10 = 0;
    uStack_14 = (uint)(DAT_00808783 != '\x03');
    uStack_18 = 1;
    thunk_FUN_0054edf0((undefined4 *)0x5,&uStack_18,1,0xffffffff);
    DAT_0080878c = 1;
