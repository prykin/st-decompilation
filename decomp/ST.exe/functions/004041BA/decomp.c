...
void thunk_FUN_004f2e40(undefined4 *param_1,byte param_2,undefined4 param_3,int param_4,int param_5,
...

{
  ...
  if (iVar3 == 0) {
    ...
    *param_1 = param_3;
    uVar2 = (uint)param_2;
    param_1[2] = *(int *)(iStack_c + 0x3c + uVar2 * 4) + param_4;
    iVar3 = *(int *)(iStack_c + 0x130);
    switch(uVar2) {
    case 0:
    case 1:
    case 2:
    case 3:
      iVar3 = *(int *)(iStack_c + 0x134);
      break;
    case 5:
    case 6:
    case 7:
    case 8:
      iVar3 = *(int *)(iStack_c + 0x138);
    }
    if (iVar3 == 0) {
      if ((param_2 == 1) || (param_2 == 7)) {
        iVar3 = *(int *)(iStack_c + 0xc0);
      }
      else {
        iVar3 = 0;
      }
      ...
      iVar3 = *(int *)(iStack_c + 0x94 + uVar2 * 4);
    }
    param_1[3] = iVar3 + param_5;
    param_1[0x42] = 1;
    param_1[0x43] = 1;
    wsprintfA((LPSTR)(iStack_c + 0x1e1),&DAT_007c181c,param_7);
    puStack_8 = FUN_006f1ce0(param_6,(LPSTR)(iStack_c + 0x1e1),(int *)0x0,1);
