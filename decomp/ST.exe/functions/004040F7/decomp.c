...

{
  ...
  if (iVar2 == 0) {
    if (*(char *)(iStack_8 + 0x9c) != '\0') {
      if (*(byte **)(iStack_8 + 0x98) != (byte *)0x0) {
        FUN_006b5570(*(byte **)(iStack_8 + 0x98));
      }
      puVar3 = FUN_006b54f0((uint *)0x0,10,10);
      *(uint **)(iStack_8 + 0x98) = puVar3;
      iVar2 = *(int *)(iStack_8 + 0x90);
