...

{
  ...
  do {
    ...
    if (0 < iVar8) {
      do {
        iVar4 = *(int *)(iVar8 + pAVar2->field_0008);
        if (*(int *)(pAVar2->field_0008 + iVar3 * 8) == iVar4) {
    ...
    iVar8 = iVar8 + 8;
    local_8 = local_8 + 1;
    iVar3 = *(int *)(pAVar2->field_0008 + iVar8);
  } while( true );
}
