  ...
  if ((int)DAT_00854edc < 5) {
    ...
    if (0 < (int)DAT_00854edc) {
      do {
        ...
        DAT_00854fec = FUN_006cef60(DAT_00854fd4,DAT_00854f00,DAT_00854fe0,(int)DAT_00854f44,
        ...
        if (((DAT_00854ed4 == 0) &&
           ...
           (iVar1 = FUN_006d1ad0((int *)DAT_00854fd4[0x70],100,DAT_00854ef0,DAT_00854ef4,
    ...
    if ((DAT_00854ed4 == 0) &&
       (iVar1 = FUN_006d1ad0((int *)DAT_00854fd4[0x70],100,DAT_00854ef0,DAT_00854ef4,DAT_00854ef8,
                             DAT_00854efc,DAT_00854fd4[3],DAT_00854fd4[4],1), iVar1 == -1)) {
      DAT_00854ed4 = 1;
    }
  }
  return;
