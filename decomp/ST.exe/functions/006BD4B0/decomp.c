...

{
  ...
  if (DAT_00854edc < 5) {
    DAT_00854fd8 = (int *)&PTR_00854f44->field_0x70;
    DAT_00854ed8 = 0;
    if (0 < DAT_00854edc) {
      do {
        ...
        DAT_00854fec = FUN_006cef60(g_int_00854FD4,PTR_00854f00,PTR_00854fe0,(int)PTR_00854f44,
                                    PTR_00854f68,DAT_00854f58,*DAT_00854fd8,DAT_00854fd8[1],
        ...
        if (((DAT_00854ed4 == 0) &&
            (iVar2 = FUN_006cfeb0(&DAT_00854ef0,DAT_00854fd8,PTR_00854f90), iVar2 != 0)) &&
           (local_EAX_386 =
