...

{
  ...
  iVar4 = __setjmp3(local_58,0,unaff_ESI,uVar6);
  this = DAT_00802a30;
  if (iVar4 == 0) {
    ...
    (**(code **)(*local_8 + 8))();
    *(undefined1 *)((int)local_8 + 0x1a61) = 2;
    if (*(int *)(*(int *)((int)local_8 + 0x1a5b) + 0x2e6) != 0) {
      local_18 = 0;
      local_14 = 0;
      local_10 = 0;
      local_c = 0;
      thunk_FUN_005b8f40(*(void **)(*(int *)((int)local_8 + 0x1a5b) + 0x2e6),&local_18);
    }
