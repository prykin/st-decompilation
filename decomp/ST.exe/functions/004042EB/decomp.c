...
void __thiscall thunk_FUN_00614400(void *this,int param_1)

{
  ...
  *(short *)((int)this + 0x2c5) = sVar10;
  if (sVar4 < 0) {
    iStack_8 = (short)((sVar4 / 0xc9 + (sVar4 >> 0xf)) -
                      (short)((longlong)(int)sVar4 * 0x28c1979 >> 0x3f)) + -1;
  }
  else {
    iStack_8 = (int)(short)((sVar4 / 0xc9 + (sVar4 >> 0xf)) -
                           (short)((longlong)(int)sVar4 * 0x28c1979 >> 0x3f));
  }
  *(short *)((int)this + 0x2c7) = (short)iStack_8;
  ...
  *(int *)((int)this + 0x2d1) = iVar9;
  if (((((((-1 < sVar10) && (sVar10 < DAT_007fb240)) && (-1 < (short)iStack_8)) &&
        (((short)iStack_8 < DAT_007fb242 && (-1 < sVar11)))) &&
       ((sVar11 < DAT_007fb244 &&
        ((piVar6 = *(int **)(DAT_007fb248 +
                            ((int)DAT_007fb246 * (int)sVar11 +
                             (int)DAT_007fb240 * (int)(short)iStack_8 + (int)sVar10) * 8),
    ...
    iStack_8 = CONCAT31(iStack_8._1_3_,bVar1);
    _bStack_c = CONCAT31(uStack_b,bVar2);
    if (DAT_00808a8f == '\0') {
      if (bVar1 == bVar2) {
LAB_0061478b:
        iVar9 = 0;
  ...
  iVar9 = FUN_006e62d0(DAT_00802a38,*(int *)((int)this + 0x2d1),&iStack_10);
  if (iVar9 == -4) {
    *(undefined4 *)((int)this + 0x2d1) = 0;
  }
  else {
    *(undefined4 *)((int)this + 0x2d1) = *(undefined4 *)(iStack_10 + 0x18);
  }
LAB_006147e6:
