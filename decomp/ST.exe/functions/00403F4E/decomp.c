...
undefined4 __fastcall thunk_FUN_0065ef70(int param_1)

{
  ...
  if (DAT_007fa174 != 0) {
    ...
    if (0 < *(int *)(iVar5 + 0xc)) {
      ...
      do {
        if (bVar9) {
          psVar7 = (short *)(*(int *)(iVar5 + 8) * uStack_1c + *(int *)(iVar5 + 0x1c));
          bVar6 = 0;
          pbVar8 = &DAT_008087e9;
        }
        else {
...
LAB_0065f095:
            ...
            if (bVar9) {
              ...
              if ((0 < iStack_10) || (0 < iStack_14)) {
                ...
                *(undefined4 *)(iStack_8 + 0x19d) = *(undefined4 *)(psVar7 + 4);
                return 1;
              }
            }
          }
        ...
        iVar5 = *(int *)(iStack_8 + 0x22f);
        bVar9 = uStack_1c < *(uint *)(iVar5 + 0xc);
      } while ((int)uStack_1c < (int)*(uint *)(iVar5 + 0xc));
    }
  }
  return 0;
}
