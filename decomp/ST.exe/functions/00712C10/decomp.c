...

{
  ...
  if (errorCode == 0) {
    ...
    if (puVar2 != (uint *)0x0) {
      local_c = puVar2;
      puVar3 = FormSarr(this_00,(int)puVar2,param_3,param_4,0,0xffffffff,param_5);
      local_10 = puVar3;
  ...
  g_currentExceptionFrame = local_58.previous;
  iVar4 = ReportDebugMessage(s_E__Ourlib_mfcfnt_cpp_007f0190,0x872,0,errorCode,&DAT_007a4ccc,
                             s_ccFntTy__FormText_007f0320);
  if (iVar4 != 0) {
    pcVar1 = (code *)swi(3);
    pcVar5 = (char *)(*pcVar1)();
    return pcVar5;
  ...
  RaiseInternalException(errorCode,0,s_E__Ourlib_mfcfnt_cpp_007f0190,0x878);
  return (char *)0x0;
}
