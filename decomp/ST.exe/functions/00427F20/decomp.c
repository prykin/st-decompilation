...

{
  ...
  *DAT_007f4d74 = iVar8;
  ...
  if (param_5 < 1) {
    local_30 = SubmarineTitans::Recovered::HiddenThis::AnonReceiver_00424E10::thunk_FUN_00427bb0
                         (this,iVar4,iVar3,0);
joined_r0x004286bb:
    puVar2 = local_1c;
    ...
    if ((iVar6 <= iVar8) &&
       ((local_30 = SubmarineTitans::Recovered::HiddenThis::AnonReceiver_00424E10::
