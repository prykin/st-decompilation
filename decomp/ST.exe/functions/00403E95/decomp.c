...

{
  ...
  pFStack_8 = this;
  errorCode = Library::MSVCRT::__setjmp3(auStack_48,0,unaff_ESI,pIVar7);
  ...
  DAT_0080877e = 1;
  pFStack_8[0x1a61] = (FSGSTy)0x0;
  DAT_008067a0 = 1;
  uVar3 = *(uint *)(pFStack_8 + 0x1ec2);
  if (uVar3 < 0x502) {
    if (uVar3 == 0x501) {
      DAT_00803400 = 5;
      goto LAB_005a33fb;
  ...
  DAT_00803400 = 4;
LAB_005a33fb:
  thunk_FUN_005b6350(pFStack_8,0x611f,0x13,0);
  (**(code **)(*(int *)pFVar5 + 8))();
