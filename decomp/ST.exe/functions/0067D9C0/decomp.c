...

{
  ...
  if (iVar2 == 0) {
    if (((param_1 == 0) || (param_2 == (char *)0x0)) || (*(char *)(param_3 + 6) != '\x02')) {
      FUN_006a5e40(-0x34,DAT_007ed77c,0x7d2fa4,0x10b);
    }
  ...
  DAT_00858df8 = (undefined4 *)local_58;
  iVar3 = FUN_006ad4d0(s_E____titans_ai_ai_plr_d_cpp_007d2fa4,0x112,0,iVar2,&DAT_007a4ccc);
  if (iVar3 != 0) {
    pcVar1 = (code *)swi(3);
    iVar2 = (*pcVar1)();
    return iVar2;
  ...
  thunk_FUN_0065d0f0((int *)&local_c);
  thunk_FUN_0067d160((int *)&local_8);
  FUN_006a5e40(iVar2,0,0x7d2fa4,0x115);
  return iVar2;
}
