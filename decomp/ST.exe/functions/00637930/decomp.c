...

{
  ...
  if ((((char)uVar1 != '\0') &&
      (puVar2 = FUN_00709af0(DAT_0080678c,CASE_1D,(byte *)s_tlo_emb6_007d1c3c,0xffffffff,0,1,0,
    ...
    FUN_006ea270(DAT_00807598,local_8,0,param_6);
    ...
    FUN_006ea460(DAT_00807598,local_8,param_1);
    if (param_2 == 0) {
      param_1 = 0xffffffff;
    }
    FUN_006ea050(DAT_00807598,local_8,1,param_1,param_7);
