...
undefined4 thunk_FUN_00495ff0(short param_1,short param_2,short param_3,uint param_4,int param_5)

{
  ...
  if ((((-1 < param_1) && (param_1 < DAT_007fb240)) && (-1 < param_2)) &&
    ...
    iVar1 = (param_4 & 0xff) +
            ((int)DAT_007fb240 * (int)param_2 + (int)DAT_007fb246 * (int)param_3 + (int)param_1) * 2
    ;
