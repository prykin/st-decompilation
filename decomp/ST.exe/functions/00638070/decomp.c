...

{
  ...
  puVar1 = FUN_00709af0(DAT_00806774,0x1d,(byte *)s_iso_frnt_007d1c80,0xffffffff,0,1,0,
                        (undefined4 *)0x0);
  ...
  puVar1 = FUN_00709af0(DAT_00806774,0x1d,(byte *)s_iso_back_007d1c8c,0xffffffff,0,1,0,
                        (undefined4 *)0x0);
  if ((puVar1 != (ushort *)0x0) && (DAT_00807598 != (void *)0x0)) {
    FUN_006e8660(DAT_00807598,(int *)&local_8,1,0,*(uint *)((int)puVar1 + 9),
                 *(uint *)((int)puVar1 + 0xd),0x5a,0x45,0);
