...
undefined4 __thiscall thunk_FUN_00625730(void *this)

{
  ...
  case 2:
  case 3:
    iStack_20 = (int)*(short *)((int)this + 0x47);
    iVar11 = (int)*(short *)((int)this + 0x49);
    iStack_34 = (int)*(short *)((int)this + 0x4b);
    if ((((-1 < iStack_20) && (-1 < iVar11)) &&
        ((-1 < iStack_34 &&
         ((iStack_20 < DAT_007fb240 && (iVar14 = (int)DAT_007fb242, iVar11 < iVar14)))))) &&
       (iStack_34 < 5)) {
      iVar13 = *(int *)(&DAT_007d03a8 + (uint)*(byte *)((int)this + 0x2ad) * 4);
      iStack_1c = iVar11 - iVar13;
      if (iStack_1c < 0) {
        iStack_1c = 0;
      }
      iStack_28 = iStack_20 - iVar13;
      if (iStack_28 < 0) {
        iStack_28 = 0;
      }
      ...
      iStack_20 = iVar13 + 1 + iStack_20;
      if (DAT_007fb240 < iStack_20) {
        iStack_20 = (int)DAT_007fb240;
      }
      iStack_14 = iStack_34 - iVar13;
      if (iStack_14 < 0) {
        iStack_14 = 0;
      }
      iStack_34 = iVar13 + 1 + iStack_34;
      if (5 < iStack_34) {
        iStack_34 = 5;
      }
      iVar14 = iStack_1c;
      if (iStack_14 < iStack_34) {
        do {
          while (iVar13 = iStack_28, iVar11 <= iVar14) {
            iStack_14 = iStack_14 + 1;
            iVar14 = iStack_1c;
            if (iStack_34 <= iStack_14) {
              return uStack_18;
            }
          }
          for (; iVar13 < iStack_20; iVar13 = iVar13 + 1) {
            sVar17 = (short)iVar13;
            sVar18 = (short)iVar14;
            sVar12 = (short)iStack_14;
...
LAB_006259bf:
              ...
              thunk_FUN_00416270(piVar15,&sStack_a,&sStack_8,&sStack_6);
              iVar7 = FUN_006acf0d(*(int *)((int)this + 0x2c2),*(int *)((int)this + 0x2c6),
                                   *(int *)((int)this + 0x2ca),(int)sStack_a,(int)sStack_8,
                                   (int)sStack_6);
...
switchD_00625b9f_caseD_a8:
  ...
  case 1:
    bVar6 = false;
    iStack_20 = 0;
    psStack_24 = &DAT_007d03ba;
    do {
      iStack_2c = 3;
      do {
        iVar13 = (int)psStack_24[-1] + (int)*(short *)((int)this + 0x47);
        iVar14 = (int)*psStack_24 + (int)*(short *)((int)this + 0x49);
        iVar11 = (int)psStack_24[1] + (int)*(short *)((int)this + 0x4b);
...
LAB_00625efc:
              ...
              if (((bVar16) && (iVar11 = (**(code **)(*piVar15 + 0xf8))(), iVar11 != 0)) &&
                 (iVar11 = thunk_FUN_006264d0(this,piVar15,iStack_20), iVar11 != 0)) {
                if (DAT_00811798 != (void *)0x0) {
...
switchD_00626071_caseD_a8:
        psStack_24 = psStack_24 + 3;
        iStack_2c = iStack_2c + -1;
      } while (iStack_2c != 0);
      iStack_20 = iStack_20 + 1;
    } while ((int)psStack_24 < 0x7d046e);
    if (bVar6) {
      uStack_18 = 1;
