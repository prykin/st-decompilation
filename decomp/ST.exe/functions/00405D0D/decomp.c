...
void __thiscall thunk_FUN_0069ada0(void *this,int param_1,int param_2)

{
  ...
  if (0 < *(int *)((int)psVar6 + 0x455)) {
    do {
      iVar9 = *(int *)((int)psVar6 + iStack_18 * 4 + 0x459);
      if (iVar9 != 0) {
        ...
        if (*(short *)(iVar9 + 8) == 0) {
          *psVar6 = -1;
          ...
          uVar11 = 0x80;
          if (param_2 <= iVar5) {
            iStack_14 = (iVar5 - param_2) + 1;
            bVar8 = (byte)iStack_14;
            uVar12 = 8 >> (bVar8 & 0x1f);
            psVar6 = psVar6 + -(iStack_14 * iVar4);
            uVar11 = 0x80 >> (bVar8 & 0x1f);
            uVar10 = 0x8000 >> (bVar8 & 0x1f);
          }
          if (iStack_14 < (int)(uint)*(byte *)(iVar9 + 0x48)) {
            iStack_14 = (uint)*(byte *)(iVar9 + 0x48) - iStack_14;
            do {
    ...
    } while (iStack_18 < *(int *)((int)psVar6 + 0x455));
  }
  iStack_10 = 0;
  if (0 < param_2) {
    do {
      ...
      if (0 < psVar6[1]) {
        do {
          psVar7 = (short *)(param_1 + (*psVar6 * param_2 + iStack_10 * iVar4) * 2);
          iVar9 = 0;
          if (0 < *psVar6) {
            psVar6 = psVar7 + iVar4;
            do {
              if ((*psVar7 == -1) &&
                 ((3 < iStack_10 || ((iStack_10 + 1 < iVar2 && (*psVar6 != 0)))))) {
                *psVar7 = -2;
              }
              iVar9 = iVar9 + 1;
              psVar6 = psVar6 + 1;
