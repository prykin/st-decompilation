...
undefined4 FUN_0042f140(char param_1,uint param_2,int param_3)

{
  ...
  if (iVar3 == 0) {
    ...
    puVar2 = local_c;
    uVar4 = FUN_006acc70((int)local_c,param_2 & 0xffff,&local_8);
    if ((uVar4 == 0xfffffffc) || (local_8 != param_3)) {
      FUN_006a5e40(-0x5001fffe,DAT_007ed77c,0x7a6004,0x6a9);
    }
    local_8 = 0;
    FUN_006ae140(puVar2,param_2 & 0xffff,&local_8);
