...
void __thiscall thunk_FUN_0051c980(void *this,int param_1,int param_2,char param_3)

{
  ...
  if (DAT_007fa174 != 0) {
    ...
    if (iVar3 == 0) {
      if (param_3 == '\0') {
        cVar1 = *(char *)((int)pvStack_14 + 0x1a1);
        if (((cVar1 == '\0') || (cVar1 == '\x06')) || (cVar1 == '\n')) {
          *(char *)((int)pvStack_14 + 0x1a2) = cVar1;
          *(undefined4 *)((int)pvStack_14 + 0x1ab) = *(undefined4 *)((int)pvStack_14 + 0x1a3);
        }
        else {
          *(undefined1 *)((int)pvStack_14 + 0x1a2) = 0;
          *(undefined4 *)((int)pvStack_14 + 0x1ab) = 0;
        }
        *(undefined1 *)((int)pvStack_14 + 0x1a1) = 0xb;
        *(int *)((int)pvStack_14 + 0x1a3) = param_1;
        *(int *)((int)pvStack_14 + 0x1a7) = param_2;
        *(undefined2 *)((int)pvStack_14 + 0x1af) = 0x32;
        *(undefined2 *)((int)pvStack_14 + 0x1b1) = 5;
        if (*(int *)((int)pvStack_14 + 0x178) != 0) {
          *(undefined4 *)((int)pvStack_14 + 0x28) = 0x4202;
          *(undefined2 *)((int)pvStack_14 + 0x2c) = 0;
          *(undefined2 *)((int)pvStack_14 + 0x2e) = 2;
          *(int *)((int)pvStack_14 + 0x30) = *(int *)((int)pvStack_14 + 0x178);
          if (DAT_00802a30 != (undefined4 *)0x0) {
            (**(code **)*DAT_00802a30)((int)pvStack_14 + 0x18);
          }
        }
      }
      bVar11 = (byte)param_2;
      ...
      thunk_FUN_00515650(&iStack_8,param_1,bVar11,*(int *)((int)this_00 + 0x23c));
      FUN_00710a90(*(int *)((int)this_00 + 0x218),0,0,iStack_8,0x19c,0xf);
      uVar13 = 3;
      iVar12 = -1;
      iVar3 = -1;
      ...
      if (param_1 == 0xfe) {
        ...
        UVar4 = thunk_FUN_00523410(iStack_c,bVar11,0);
        ...
        iVar3 = iStack_c;
        iStack_8 = iStack_8 + 0xf;
        uVar8 = thunk_FUN_00526ba0(iStack_c,bVar11);
        pbVar7 = (byte *)FUN_0070b3a0(*(int *)((int)this_00 + 0x240),uVar8);
        thunk_FUN_00540760(*(undefined4 **)((int)this_00 + 0x218),0x96,iStack_8,'\x01',pbVar7);
        pbVar7 = pbStack_10;
        thunk_FUN_00540760(*(undefined4 **)((int)this_00 + 0x218),0x94,iStack_8 + -2,'\x06',
                           pbStack_10);
        uStack_30 = 0x94;
        uStack_28 = *(undefined4 *)(pbVar7 + 4);
        iStack_2c = iStack_8 + -2;
        uStack_24 = *(undefined4 *)(pbVar7 + 8);
        uStack_20 = 2;
        iStack_1f = iVar3;
        iStack_1b = param_2;
        FUN_006ae1c0(*(uint **)((int)this_00 + 0x1d7),&uStack_30);
      ...
      thunk_FUN_00511ab0(this_00,iStack_8,uVar8);
      uVar9 = uVar8 & 0xffff;
      FUN_00710a90(*(int *)((int)this_00 + 0x218),0,0x96,iStack_8,0x106,uVar9 + 2);
      FUN_00711b70(&DAT_0080f33a,1,-1,(DAT_0080874e != '\x03') - 1 & 5,-1,-1);
      if ((ushort)uVar8 < 0x10) {
        uVar9 = 0xf;
      }
      iStack_8 = iStack_8 + uVar9;
      FUN_00710a90(*(int *)((int)this_00 + 0x218),0,0,iStack_8,0x91,0xf);
      uVar13 = 3;
      iVar12 = -1;
      iVar3 = -3;
      ...
      thunk_FUN_00540760(*(undefined4 **)((int)this_00 + 0x218),0x96,iStack_8,'\x01',pbVar7);
      pbVar7 = pbStack_10;
      thunk_FUN_00540760(*(undefined4 **)((int)this_00 + 0x218),0x94,iStack_8 + -2,'\x06',pbStack_10
                        );
      uStack_30 = 0x94;
      uStack_28 = *(undefined4 *)(pbVar7 + 4);
      iStack_2c = iStack_8 + -2;
      ...
      thunk_FUN_00515e30(this_00,&iStack_8,'\v',param_1,param_2);
