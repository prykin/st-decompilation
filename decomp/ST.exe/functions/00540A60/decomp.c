...
void __cdecl
FUN_00540a60(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6,uint param_7,
...

{
  ...
  if (iVar2 == 0) {
    ...
    FUN_00711f70(param_6,0,-1,param_7,param_8,param_10);
  ...
  DAT_00858df8 = (undefined4 *)local_50;
  iVar2 = FUN_006ad4d0(s_E____titans_Andrey_support_cpp_007c7b2c,0x95,0,iVar2,&DAT_007a4ccc);
  if (iVar2 != 0) {
    pcVar1 = (code *)swi(3);
    (*pcVar1)();
    return;
