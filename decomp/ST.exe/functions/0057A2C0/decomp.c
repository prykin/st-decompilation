...

{
  ...
  *param_3 = (int)pvVar9;
  ...
  if (((pvVar9 == nullptr) || (param_2 == 0)) || ((param_2 != 5 && (param_2 != 7)))) {
    iVar20 = ReportDebugMessage("E:\\__titans\\Igor\\to_etorp.cpp",0x4c,0,0,"%s",
...
LAB_0057ac02:
      iVar20 = FUN_006acf0d((int)*(short *)&param_1->field_0x34,(int)param_1->field_0036,
    ...
    if (local_dc != 0) {
      ...
      local_b8 = FUN_006aced8(iVar25,iVar20,local_68,local_64);
      if (local_b8 != 0) {
...
LAB_0057a96b:
                    ...
                    if ((bVar27) && (iVar16 = (*this->vtable[5].slots_00_28[2])(), iVar16 != 0)) {
                      ...
                      iVar14 = thunk_FUN_0057bc50(iVar25,iVar20,local_40,local_8c,local_98,local_a8,
