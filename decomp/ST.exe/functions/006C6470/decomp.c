...
int FUN_006c6470(int param_1,int param_2,int param_3,undefined4 *param_4,int param_5,int param_6,
                undefined4 param_7)

{
  ...
  if (((param_6 != 0) &&
     ...
     (ExceptionList = &local_14, puVar1 = &stack0xffffffc4, param_6 * 2 <= param_5)) {
    ...
    if (iVar2 != 0) {
      puVar1 = local_1c;
      if ((local_28 != param_4) || (local_24 != param_5)) goto LAB_006c663e;
...
LAB_006c663e:
  local_1c = puVar1;
  iVar2 = FUN_006c6850(param_1,param_2,param_3,(int)param_4,param_5,param_7);
  ExceptionList = local_14;
  return iVar2;
}
