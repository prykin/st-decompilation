...

{
  ...
  iVar3 = __setjmp3(local_68,0,pbVar9,pbVar8);
  if (iVar3 != 0) {
    DAT_00858df8 = (undefined4 *)local_6c;
    return 0;
  }
  uVar10 = 0;
  puVar4 = FUN_006f0ec0(0x345,local_170,0,0,0);
  piVar12 = (int *)&stack0xffffffe4;
  iVar3 = 0;
  uVar11 = 0x5db113;
  puVar5 = FUN_006f1ce0(0,PTR_s_DESCRIPTOR_0079c1d8,piVar12,0);
  if (puVar5 == (ushort *)0x0) goto LAB_005db1e1;
  if ((char)*piVar12 == '\x05') {
    iVar3 = 0;
    uVar11 = 0x5db13b;
    puVar5 = FUN_006f1ce0(0x80,PTR_s_SAVE_PLAYER_0079c1c8,(int *)&stack0xffffffe0,0);
    if (puVar5 == (ushort *)0x0) goto LAB_005db1e1;
  }
  bVar2 = false;
