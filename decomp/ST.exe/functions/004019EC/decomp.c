...
int __cdecl
thunk_FUN_004b1120(int param_1,int param_2,int *param_3,int *param_4,int *param_5,int param_6,
                  int param_7)

{
  ...
  iStack_10 = thunk_FUN_004ae0b0(*param_3,*param_4,*param_5,param_2,param_1,(undefined4 *)0x0,
    ...
    if ((&PTR_LAB_0079072c)[param_2] == (undefined *)0x1) {
      ...
      if (DAT_007fa150 != 0) {
        *(undefined4 *)(DAT_007fa150 + 4) = 0;
        iVar2 = FUN_006b1190(DAT_007fa150,&piStack_18);
        if (-1 < iVar2) {
          do {
            if (piStack_18 != (int *)0x0) {
              switch(param_2) {
              case 0x38:
                iVar2 = (**(code **)(*piStack_18 + 0x2c))();
                if (iVar2 == 0xdc) {
LAB_004b1226:
                  thunk_FUN_004162b0(piStack_18,&sStack_6,&sStack_8,&sStack_a);
                  if (((*(int *)(DAT_007fb248 +
                                ((int)DAT_007fb240 * (int)sStack_8 +
                                (int)sStack_6 + (int)DAT_007fb246 * (int)sStack_a) * 8) == 0) &&
                      (sStack_a < 4)) &&
                     ((iVar2 = FUN_006aced8((int)sStack_6,(int)sStack_8,*param_3,*param_4),
                      iStack_14 < 0 || (iVar2 < iStack_14)))) {
                    param_1 = (int)sStack_8;
                    param_7 = (int)sStack_a;
                    param_6 = (int)sStack_6;
                    iStack_10 = 1;
                    iStack_14 = iVar2;
                  }
                }
      ...
      if (1 < sVar1) {
        do {
          ...
          iVar5 = 0;
          iVar2 = iStack_14;
          if ((param_7 < iStack_14) && (DAT_007fb244 != 1 && -1 < DAT_007fb244 + -1)) {
            do {
              iVar6 = *param_3 - iVar2;
