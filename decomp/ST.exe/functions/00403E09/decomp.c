...
int __fastcall thunk_FUN_0063f790(int param_1)

{
  ...
  do {
    ...
    if ((uStack_c < *(uint *)(iVar12 + 0xc)) &&
       (iVar12 = *(int *)(iVar12 + 8) * uStack_c + *(int *)(iVar12 + 0x1c), iVar12 != 0)) {
...
LAB_0063fc75:
  ...
  if ((iStack_14 != 0) && (uVar10 = 0x3c, 0x3c < iVar3)) {
