...

{
  ...
  if (iVar2 == 0) {
    ...
    pcVar6 = (ccFntTy *)((local_8->field_0040 - iVar2) + DAT_00806730);
    local_8->field_0174 = pcVar6;
    pcVar6 = (ccFntTy *)ccFntTy::operator(pcVar6,0x19d,*(int *)(DAT_00802a28 + 0x28));
    ...
    iVar7 = -1;
    iVar2 = -2;
    puVar5 = (uint *)FUN_006b0140(0x2716,DAT_00807618);
    ccFntTy::WrTxt(this_00->field_017C,puVar5,iVar2,iVar7,uVar8,iVar10,iVar11);
    pCVar3 = thunk_FUN_00571240(s_BUT_MEDIUM_007c3894,0);
    uVar8 = PanelTy::CreateBut((PanelTy *)this_00,0,1,0x115,0x8b,1,0,1,pCVar3,0xbfff,0xc000,0,0,0,
                               (char *)0x0,1);
