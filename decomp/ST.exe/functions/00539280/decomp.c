...

{
  ...
  if (iVar2 == 0) {
    ...
    *(ushort **)(local_8 + 0x180) = puVar5;
    thunk_FUN_00540760(*(undefined4 **)(local_8 + 0x68),0,0,'\x01',(byte *)puVar5);
    FUN_00710a90(*(int *)(local_8 + 0x68),0,0x52,2,0xd1,0xc);
    iVar11 = -1;
    iVar10 = -1;
    uVar8 = 0;
    iVar7 = -1;
    ...
    *(undefined4 *)(local_8 + 0x184) = uVar8;
