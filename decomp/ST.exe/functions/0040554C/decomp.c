...
thunk_FUN_005f4c50(void *this,float param_1,undefined4 param_2,int param_3,int param_4,int param_5,
                  int param_6)

{
  ...
  iVar5 = param_4;
  fStack_8 = _DAT_0079c5a4 / (float)param_5;
        ...
        do {
          ...
          *(undefined1 *)((int)puVar3 + 2) = 0;
          if (param_4 == 0) {
            ...
            iStack_16 = *(int *)(iVar6 + 0x16);
            iStack_1a = iVar1;
          }
          iVar6 = *(int *)((int)this + param_4 * 4 + 0x139);
          auStack_2c._2_4_ = (iVar6 * iVar1) / 10000 + *(int *)((int)this + 0x111);
          iStack_26 = (iVar6 * iStack_16) / 10000 + *(int *)((int)this + 0x115);
          uStack_12 = DAT_007ce5ec;
          uStack_22 = *(undefined4 *)((int)this + 0x119);
          uStack_1e = 0;
          auStack_2c[1] = 3;
          uStack_d = 0xffffffff;
