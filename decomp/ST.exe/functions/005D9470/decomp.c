        ...
        if (this_00->field_1CD4 != '\0') {
          if (this_00->field_1A5F == '\0') {
            ...
            if (0 < (int)local_c) {
              ...
              do {
                pbVar16 = *(byte **)(*(int *)(this_00->field_1CCC + 0x14) + (int)puVar13 * 4);
LAB_005d979c:
...
LAB_005d97ca:
            ...
            if (*(int *)(this_00->field_1CD0 + 8) < 1) {
              ...
              uVar6 = **(undefined4 **)(this_00->field_1CD0 + 0x14);
            }
    ...
    if ((local_c & 0xff) == 1) {
      UVar14 = (this_00->field_1A5F != '\0') + 0x24b8;
    }
    else {
      UVar14 = (-(uint)(this_00->field_1A5F != '\0') & 0xfffffffd) + 0x24bd;
    }
