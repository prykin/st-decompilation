...
LAB_005d97ca:
            ...
            if ((int)local_8 < 0) {
              ...
              thunk_FUN_00572510((RecoveredRecordView_00572510_EB02076B *)&g_sound);
            }
            if (DAT_00808446 != '\0') {
            ...
            wsprintfA(&this_00->field_1CD4,"%s%s%s",&CHAR_00h_00807680,
                      PTR_s_SAVEGAME__0079c19c,uVar13);
            ...
            do {
              if (*puVar18 != 0) {
                FUN_006e6080(this_00,2,*puVar18,(undefined4 *)&this_00->field_0x1d);
              }
              puVar18 = puVar18 + 1;
              iVar20 = iVar20 + -1;
            } while (iVar20 != 0);
        ...
        if (this_00->array_00BC[0xc].field_01DF == '\0') {
          if ((CHAR_00h_00807ddd != '\0') && (this_00->field_1CCC->elementSize != 0)) {
            ...
            do {
              if (*puVar18 != 0) {
                FUN_006e6080(this_00,2,*puVar18,(undefined4 *)puVar1);
              }
              puVar18 = puVar18 + 1;
              local_8 = local_8 + -1;
    ...
    pRVar7 = (RecoveredRecord_006B4FA0_DAC3A217 *)this_00->field_1CC8;
    ...
    pRVar8 = (RecoveredRecordView_006B84D0_87AF9D9B *)this_00->field_1CC8;

    Library::DKW::WGR::FUN_006b55f0
              ((RecoveredSourceFamily_dibcopy *)this_00->field_1CB8,0,4,1,pRVar8,0,0,0,
    ...
    if (MESS_SIDTY_8163 < SVar5) {
      ...
      MMMObjTy::PaintSlBut
                ((MMMObjTy *)this_00,pRVar25,(RecoveredRecord_005B6560_90DC7408 *)message,0);
      goto cf_common_exit_005D9CCB;
    }
    ...
    if (MESS_SHARED_8160 < SVar5) {
      if (SVar5 == MESS_SIDTY_8161) {
        ...
        pRVar7 = (RecoveredRecord_006B4FA0_DAC3A217 *)this_00->field_1CBC;
    ...
    ccFntTy::WrStr(g_startSystem_0081176C->field_0034,pcVar12_mg2,iVar20,iVar26,uVar15);
  }
