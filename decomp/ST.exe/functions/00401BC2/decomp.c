...

{
  ...
  pSStack_c = this;
  iVar3 = Library::MSVCRT::__setjmp3(auStack_4c,0,unaff_ESI,pIVar5);
  pSVar2 = pSStack_c;
  if (iVar3 == 0) {
    iVar3 = thunk_FUN_0054cbb0(param_1,&uStack_8);
    if (iVar3 != 0) {
      RaiseInternalException(-4,DAT_007ed77c,s_E____titans_Andrey_tplaysys_cpp_007c8430,0xef);
    }
    iVar3 = (**(code **)(*(int *)pSVar2 + 8))(uStack_8,param_2,param_3,param_4,param_5);
    if (iVar3 != 0) {
