...

{
  ...
  if ((this->field_0231 == 4) && (*(int *)(param_1 + 0x10) != 3)) {
    return 0;
  }
  ...
  if (uVar8 < 0x110) {
    if (uVar8 == 0x10f) {
      ...
      if (((local_18 != (byte *)0x0) && (local_14 != (byte *)0x0)) && (local_c != (byte *)0x0)) {
        puVar10 = (undefined4 *)&this_00->field_0x258;
        pbVar11 = local_c;
        ...
        *(uint *)(local_c + local_8 + 99) = local_10;
        ...
        STPlaySystemC::SaveObjData
                  (DAT_00802a38,this_00->field_0018,local_c,local_10 + 0x67 + local_8);
      ...
      if (uVar8 == 2) {
        ...
        *(undefined4 *)&this_00->field_0x231 = 4;
        ...
        if (uVar8 < 2) {
          ...
          *(undefined4 *)&this_00->field_0x23d = DAT_00802a38->field_00E4;
          puVar10 = *(undefined4 **)(param_1 + 0x14);
          puVar12 = (undefined4 *)&this_00->field_0x258;
          for (iVar5 = 0xc; iVar5 != 0; iVar5 = iVar5 + -1) {
            *puVar12 = *puVar10;
            puVar10 = puVar10 + 1;
            puVar12 = puVar12 + 1;
          ...
          *(undefined2 *)puVar12 = *(undefined2 *)puVar10;
          ...
          puVar10 = local_20;
          *(undefined4 *)&this_00->field_0x231 = *(undefined4 *)((int)local_20 + 0x32);
          *(undefined4 *)&this_00->field_0x235 = *(undefined4 *)((int)local_20 + 0x36);
          *(undefined4 *)&this_00->field_0x23d = *(undefined4 *)((int)local_20 + 0x3a);
          *(undefined4 *)&this_00->field_0x24d = *(undefined4 *)((int)local_20 + 0x42);
          *(undefined4 *)&this_00->field_0x249 = *(undefined4 *)((int)local_20 + 0x3e);
          *(undefined4 *)&this_00->field_0x251 = *(undefined4 *)((int)local_20 + 0x4e);
          *(undefined4 *)&this_00->field_0x241 = *(undefined4 *)((int)local_20 + 0x46);
          *(undefined4 *)&this_00->field_0x245 = *(undefined4 *)((int)local_20 + 0x4a);
          this_00->field_0x255 = *(undefined1 *)(local_20 + 0x17);
          this_00->field_0x256 = *(undefined1 *)((int)local_20 + 0x5d);
          this_00->field_0x257 = *(undefined1 *)((int)local_20 + 0x5e);
