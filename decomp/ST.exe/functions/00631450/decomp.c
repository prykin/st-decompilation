...

{
  ...
  if ((param_1->field_0038 != 0) &&
    ...
    do {
      ...
      puVar2 = SubmarineTitans::Recovered::HiddenThis::AnonReceiver_006308F0::thunk_FUN_00630c50
                         ((AnonReceiver_006308F0 *)param_1,param_1->field_0040,param_1->field_004C,0
                          ,1,*(int *)(psVar4 + 10));
