...

{
  ...
  if ((this->field_0038 != (DArrayTy *)0x0) &&
    ...
    do {
      ...
      sub_00630BB0(this,*psVar4,psVar4[1],psVar4[2],*(undefined4 *)(psVar4 + 4),(int)psVar4[3],
                   *(undefined4 *)(psVar4 + 10));
      puVar2 = SubmarineTitans::Recovered::HiddenThis::AnonReceiver_006308F0::sub_00630C50
                         ((AnonReceiver_006308F0 *)this,this->field_0040,this->field_004C,0,1,
                          *(int *)(psVar4 + 10));
