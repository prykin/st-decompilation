...

{
  ...
  if (*(int *)(local_10 + 0x2e6) != 0) {
    if (param_1 == 1) {
      puVar2 = mfRLoad(DAT_00806774,CASE_1D,(byte *)s_rubb3_007ce700,0xffffffff,0,1,0,
                       (undefined4 *)0x0);
      ...
      puVar2 = mfRLoad(DAT_00806774,CASE_1D,(byte *)s_bulb_tel_007ce708,0xffffffff,0,1,0,
                       (undefined4 *)0x0);
      uVar4 = *(uint *)((int)puVar2 + 0xd);
      uVar3 = *(uint *)((int)puVar2 + 9);
      uVar6 = 0x2f;
