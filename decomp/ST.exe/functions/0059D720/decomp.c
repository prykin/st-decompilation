...
void __fastcall FUN_0059d720(void *param_1)
...
LAB_0059d780:
    ...
    if (iVar6 == 0) {
      ...
      this = local_c;
      *(uint **)((int)local_c + 0x1af8) = puVar4;
      ...
      *(uint **)((int)this + 0x1b04) = puVar4;
      ...
      local_8dc[2] = *(undefined4 *)((int)this + 0x1a73);
      local_8dc[8] = *(undefined4 *)((int)this + 0x1af8);
      local_8b0 = *(undefined4 *)((int)this + 8);
      local_68 = 2;
      local_8ac = 2;
      local_88c = 2;
      local_8dc[3] = 0xd2;
      ...
      local_890 = local_8b0;
      local_6c = local_8b0;
      (**(code **)(**(int **)((int)this + 0xc) + 8))(6,(int)this + 0x1ad8,0,local_8dc,0);
      local_8dc[8] = *(undefined4 *)((int)this + 0x1afc);
      local_8dc[3] = 0x15e;
      (**(code **)(**(int **)((int)this + 0xc) + 8))(6,(int)this + 0x1adc,0,local_8dc,0);
      local_8dc[8] = *(undefined4 *)((int)this + 0x1b00);
      local_8dc[3] = 0x1ea;
      (**(code **)(**(int **)((int)this + 0xc) + 8))(6,(int)this + 0x1ae0,0,local_8dc,0);
      local_8dc[1] = 200;
      if (iVar5 != 0) {
        local_8dc[1] = 0xcc;
      }
      local_8dc[8] = *(undefined4 *)((int)this + 0x1b04);
      local_8dc[3] = 0xd2;
      local_8dc[4] = 0xdd;
      local_8dc[5] = 0x17c;
      local_8dc[6] = 0x4b;
      local_888 = 0x6981;
      (**(code **)(**(int **)((int)this + 0xc) + 8))(6,(int)this + 0x1ae4,0,local_8dc,0);
