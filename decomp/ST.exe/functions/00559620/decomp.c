...
void __thiscall
FUN_00559620(void *this,int param_1,int param_2,undefined1 param_3,undefined *param_4,int param_5,
...

{
  ...
  if ((((*(int *)((int)this + 0x114) != 0) && (*(int *)((int)this + 0x38) != 0)) && (-1 < param_5))
    ...
    if ((param_7 & 0x1000) != 0) {
      thunk_FUN_0055bbc0(this,1,(short)param_1,(short)param_2,param_3,(uint)param_4,(char)param_5,
                         param_6);
    }
        ...
        do {
          ...
          do {
            if (((((puVar3 == (undefined *)0x0) || (param_4[iVar4] != '\0')) && (-1 < iVar7)) &&
              ...
              if (cVar2 != '\0') {
                *(char *)(*(int *)((int)this + 0x38) + iVar6 * 2 + 1) = cVar2 + -1;
              }
            }
            iVar4 = iVar4 + 1;
            iVar7 = iVar7 + 1;
