...

{
  ...
  if (iVar3 == 0) {
    thunk_FUN_005b6220();
    if (((*(int *)(iStack_8 + 0x4d) != 0x6121) && (DAT_00811764 != (undefined4 *)0x0)) &&
       (DAT_0080877e != '\0')) {
      FUN_00715360(DAT_00811764,0,'\x10',(char *)0x0,0,0,0xffffffff);
      thunk_FUN_005dac60();
    }
    if (*(HANDLE *)(iStack_8 + 0x1c8f) != (HANDLE)0x0) {
      FindCloseChangeNotification(*(HANDLE *)(iStack_8 + 0x1c8f));
      *(undefined4 *)(iStack_8 + 0x1c8f) = 0;
    }
    if (DAT_00802a30 != 0) {
    ...
    if (*(int *)(iStack_8 + 0x20b8) != 0) {
      thunk_FUN_005aafb0();
      FUN_0072e2b0(*(undefined4 **)(iStack_8 + 0x20b8));
      *(undefined4 *)(iStack_8 + 0x20b8) = 0;
    }
    FUN_00715ab0();
    FUN_00715ab0();
    FUN_00715ab0();
    puVar5 = (uint *)(iStack_8 + 0x1c23);
    iVar3 = 0x16;
    do {
    ...
    if (*(uint *)(iStack_8 + 0x1c87) != 0xffffffff) {
      FUN_006b3bb0(DAT_008075a8,*(uint *)(iStack_8 + 0x1c87));
    }
    *(undefined4 *)(iStack_8 + 0x1c87) = 0xffffffff;
    if (*(int *)(iStack_8 + 0x20bc) != 0) {
      thunk_FUN_005aafb0();
      FUN_0072e2b0(*(undefined4 **)(iStack_8 + 0x20bc));
      *(undefined4 *)(iStack_8 + 0x20bc) = 0;
    }
    if (*(char *)(iStack_8 + 0x20b4) != '\0') {
    ...
    if (*(int *)(iStack_8 + 0x20c0) != 0) {
      thunk_FUN_005aafb0();
      FUN_0072e2b0(*(undefined4 **)(iStack_8 + 0x20c0));
      *(undefined4 *)(iStack_8 + 0x20c0) = 0;
    }
    if ((*(char *)(iStack_8 + 0x20b7) != '\0') &&
       (((cVar1 = *(char *)(iStack_8 + 0x1a5f), cVar1 == '\f' || (cVar1 == '\x04')) ||
        ((cVar1 == '\x05' || (cVar1 == '\x13')))))) {
    ...
    if (*(int *)(iStack_8 + 0x1c7b) != 0) {
      FUN_006ab060((undefined4 *)(iStack_8 + 0x1c7b));
    }
    *(undefined4 *)(iStack_8 + 0x1c7f) = 0;
    if (*(int *)(iStack_8 + 0x1c8b) != 0) {
      FUN_006ab060((undefined4 *)(iStack_8 + 0x1c8b));
    }
    if ((*(char *)(iStack_8 + 0x20b6) != '\0') &&
       (*(int *)(*(int *)(iStack_8 + 0x1a5b) + 0x2e6) != 0)) {
      thunk_FUN_005b6ff0();
      *(undefined4 *)(*(int *)(*(int *)(iStack_8 + 0x1a5b) + 0x2e6) + 0x1cab) = 0;
    }
    if (*(byte **)(iStack_8 + 0x1c97) != (byte *)0x0) {
      FUN_006b5570(*(byte **)(iStack_8 + 0x1c97));
      *(undefined4 *)(iStack_8 + 0x1c97) = 0;
    }
    if (*(byte **)(iStack_8 + 0x1c9b) != (byte *)0x0) {
      FUN_006ae110(*(byte **)(iStack_8 + 0x1c9b));
      *(undefined4 *)(iStack_8 + 0x1c9b) = 0;
    }
    if (*(byte **)(iStack_8 + 0x1c9f) != (byte *)0x0) {
      FUN_006b5570(*(byte **)(iStack_8 + 0x1c9f));
      *(undefined4 *)(iStack_8 + 0x1c9f) = 0;
    }
