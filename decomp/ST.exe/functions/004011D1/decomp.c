...
uint __fastcall thunk_FUN_0046cf20(int *param_1,undefined4 param_2)
...
LAB_0046d1e2:
  ...
  if (param_1[0x14a] == 3) {
    iVar7 = thunk_FUN_00415ed0(param_1,&uStack_10,&uStack_c);
    if (iVar7 == -1) {
    ...
    if (iVar7 == 0) {
      uVar10 = 0;
      if ((param_1[0x149] != 0) &&
         (iVar7 = FUN_006e62d0(DAT_00802a38,param_1[0x149],(int *)&pvStack_8), iVar7 != -4)) {
        thunk_FUN_004cf3e0(pvStack_8,param_1[6]);
      ...
      if (iVar7 == 1) {
        if (((((short)param_1[0x147] < 0) || (*(short *)((int)param_1 + 0x51e) < 0)) ||
           ...
           iVar7 = thunk_FUN_0048dfd0(iVar8,iVar7,(uint)*(ushort *)(param_1 + 0x145),iVar8,iVar7,
                                      (int *)(uint)*(ushort *)(param_1 + 0x145),2,&sStack_18,
                                      &sStack_16,asStack_14), sVar2 = sStack_18, sVar3 = sStack_16,
           sVar4 = asStack_14[0], iVar7 == 0)) {
        ...
        sStack_16 = sVar3;
        sStack_18 = sVar2;
        thunk_FUN_00481520(param_1,(int)sStack_18,(int)sStack_16,(int)asStack_14[0]);
