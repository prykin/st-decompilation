...
undefined4 __thiscall FUN_0049f100(void *this,int param_1)

{
  ...
  local_c = *(uint *)(*(int *)((int)this + 0x29) + 0xc);
  local_18 = (uint *)0x0;
  local_20 = (uint *)0x0;
  local_1c = 0;
  local_24 = 2;
  ...
  if ((param_1 == 0) || (uVar9 = extraout_EDX, uVar10 = extraout_var, param_1 == 1)) {
    puVar13 = (undefined4 *)((int)local_38 + 0x89);
    for (iVar4 = 0x15; iVar4 != 0; iVar4 = iVar4 + -1) {
      *puVar13 = 0;
      puVar13 = puVar13 + 1;
    }
    *(undefined4 *)((int)local_38 + 0x65) = 0;
    local_10 = 0;
    *(undefined4 *)((int)local_38 + 0x2c3) = *(undefined4 *)((int)local_38 + 0x192);
    *(undefined2 *)((int)local_38 + 0x2c7) = *(undefined2 *)((int)local_38 + 0x196);
    *(undefined1 *)((int)local_38 + 0x2c9) = *(undefined1 *)((int)local_38 + 0x198);
    local_2c = *(undefined1 *)((int)local_38 + 0x192);
    local_2b = *(undefined2 *)((int)local_38 + 0x193);
    *(undefined4 *)((int)local_38 + 0x2ca) = 0;
    local_30 = *(undefined4 *)(DAT_00802a38 + 0xe4);
    local_29 = *(undefined4 *)((int)local_38 + 0x195);
    puVar6 = local_20;
    local_14 = local_30;
    if (local_c != 0) {
      uVar11 = 0;
...
LAB_0049f2b2:
    ...
    puVar3 = local_18;
    thunk_FUN_00445a40(CONCAT31((int3)(local_c >> 8),*(undefined1 *)((int)pvVar2 + 0x24)),puVar6,
                       local_18);
...
LAB_0049f3f5:
    ...
    if (0 < (int)local_c) {
      uVar12 = 0;
      do {
        FUN_006acc70(*(int *)((int)pvVar2 + 0x29),uVar12,&local_8);
        if ((short)local_8 != -1) {
