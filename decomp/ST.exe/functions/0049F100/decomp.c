...
int __thiscall STGroupBoatC::Capture(STGroupBoatC *this,int param_1)
    ...
    *(undefined4 *)&local_38->field_0x2ca = 0;
    ...
    if (local_c != 0) {
      ...
      do {
        ...
        DArrayGetElement(pSVar2->field_0029,uVar6,local_8);
        if (STPiece<0,2>(local_8) != 0xffff) {
          ...
          if (((dVar4 == 6) || (dVar4 = pSVar3->sub_0045EEE0(), dVar4 == 0x12)) ||
            ...
            iVar5 = thunk_FUN_00490d90((STGameObjC *)pSVar3);
            if (iVar5 != 0) {
              if (local_18 == nullptr) {
          ...
          STBoatC::CmdToObj(pSVar3,SVar10,puVar11);
        }
LAB_0049f2b2:
        local_10 = local_10 + 1;
      ...
      if (0 < (int)local_c) {
        ...
        do {
          ...
          if (STPiece<0,2>(local_8) != 0xffff) {
            ...
            iVar5 = STGameObjC::sub_0045FF10((STGameObjC *)pSVar3);
            if (iVar5 == 9) {
              puVar8 = (byte *)&pSVar3->field_05FC;
              puVar9 = (byte *)(local_9c);
...
LAB_0049f3f5:
    ...
    if (0 < (int)local_c) {
      ...
      do {
        ...
        DArrayGetElement(pSVar2->field_0029,uVar7,local_8);
        if (STPiece<0,2>(local_8) != 0xffff) {
          ...
          if ((iVar5 == 9) || (uVar7 = STBoatC::CheckPBoxCmd(pSVar3,CASE_9), uVar7 == 1)) {
            local_1c = local_1c + 1;
            break;
          }
        }
