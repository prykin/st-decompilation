...
int __thiscall STAllPlayersC::RegisterArtefact(STAllPlayersC *this,ushort param_1,void *param_2)

{
  ...
  if (iVar2 == 0) {
    ...
    if (param_1 == 0xffff) {
      ...
      iVar2 = DArrayGetElement((DArrayTy *)g_array_007FA154,(uint)param_1,&local_8);
    ...
    Library::DKW::TBL::DArrayPut((DArrayTy *)g_array_007FA154,(uint)param_1,&param_2);
