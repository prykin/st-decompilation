...
void __thiscall thunk_FUN_004fe6c0(void *this,int param_1)

{
  ...
  if (param_1 == 0) {
    iStack_8 = *(int *)((int)this + 0x194);
    bVar7 = *(byte *)((int)this + 0xc6d);
  }
  else {
    iStack_8 = *(int *)((int)this + 0x18c);
  ...
  if (bVar7 < 0x65) {
    ...
    if (param_1 == 0) {
      iVar3 = FUN_0070b3a0(*(int *)((int)pvStack_10 + 0x2da),2);
      iVar6 = iStack_8;
      ...
      iVar3 = FUN_0070b3a0(*(int *)((int)pvStack_10 + 0x2da),0);
      iVar6 = iStack_8;
