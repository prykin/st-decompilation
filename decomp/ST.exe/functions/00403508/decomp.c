...

{
  ...
  iStack_c = *piStack_14 - *(int *)(this + 0x3c);
  if (*(int *)(this + 0x5c) == 0) {
    iStack_8 = *(int *)(this + 0x48) + piStack_14[1];
  }
  else {
    iStack_8 = piStack_14[1] - *(int *)(this + 0x44);
  }
  ...
  if (puVar3 == (undefined4 *)0x0) {
    ...
    iVar10 = iStack_8;
    thunk_FUN_00540760(*(undefined4 **)(pUVar2 + 0x68),iStack_c,iStack_8,'\x01',(byte *)puVar6);
    ccFntTy::SetSurf(*(ccFntTy **)(DAT_00802a28 + 0x24),*(int *)(pUVar2 + 0x68),0,iStack_c,iVar10,
