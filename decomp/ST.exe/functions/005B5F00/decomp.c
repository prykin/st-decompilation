...

{
  ...
  FUN_006b4170((AnonShape_006C7610_838EDECF *)param_1,0,iVar2,0,param_2[5] + -2,param_1->field_0008,
               0xff);
  if (param_2[1] == 1) {
    FUN_006b4170((AnonShape_006C7610_838EDECF *)param_1,0,iVar2,3,param_2[5] + -2,param_2[6] + -3,0)
    ;
    FUN_006b4170((AnonShape_006C7610_838EDECF *)param_1,0,iVar2 + 2,1,param_2[5] + -6,2,0);
  ...
  FUN_006b4170((AnonShape_006C7610_838EDECF *)param_1,0,iVar2 + 1,4,param_2[5] + -4,param_2[6] + -5,
               0);
  FUN_006b4170((AnonShape_006C7610_838EDECF *)param_1,0,iVar2 + 2,2,param_2[5] + -6,2,0);
