...
void FUN_004f1f60(int param_1,int param_2,int param_3,uint param_4,UINT param_5)

{
  ...
  if (iVar2 == 0) {
    ...
    wsprintfA((LPSTR)(local_8 + 0x1e1),&DAT_007c1aa4,param_4 & 0xff);
    FUN_00710a90(param_1,0,param_2 + 0xc,param_3 + 10,0x14,0xf);
    FUN_00711b70((uint *)(local_8 + 0x1e1),-3,-1,1,-1,-1);
