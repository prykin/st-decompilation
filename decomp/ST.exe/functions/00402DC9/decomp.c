...
switchD_0066104e_caseD_9:
          if ((0x31 < *puStack_8) && (*puStack_8 < 0x74)) {
            ...
            uVar7 = CONCAT22((short)((uint)puStack_8 >> 0x10),sVar6);
            if ((sVar6 < 0) ||
              ...
              iVar2 = thunk_FUN_004b0d10(*(uint *)((int)this + 0x24),*puStack_8,&iStack_14,
                                         &iStack_18,&iStack_1c,(int)*(short *)(iVar2 + 0x82),
            ...
            iVar2 = thunk_FUN_006763f0(*(uint *)((int)this + 0x24),*puStack_8,
          ...
          *(undefined2 *)puVar8 = 0;
          ...
          uStack_66 = (short)uVar4;
          _strncpy(acStack_4f,(char *)((int)param_1 + 0x15),0xe);
          iVar5 = thunk_FUN_0068eb30(&uStack_6c,*(short *)((int)this + 0x7f));
          iVar2 = DAT_007fa174;
          if (iVar5 == 0) {
            param_1[9] = uStack_64;
            return;
...
LAB_0066137e:
        ...
        iStack_c = iStack_c + 1;
        sVar6 = *(short *)((int)this + 0x7b);
        if ((int)((-(uint)(sVar6 != 1) & 2) + 1) <= iStack_c) {
          return;
        }
      } while( true );
    }
