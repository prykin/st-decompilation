...
FUN_005b7ef0(void *this,UINT param_1,char param_2,undefined4 *param_3,undefined4 *param_4,
  ...
  if ((param_1 != 0) && (*(char *)((int)this + 0x1ca9) == '\0')) {
    ...
    if (iVar3 == 0) {
      ...
      if (iVar3 != 0) {
        ...
        local_34[4] = 0x6940;
        local_34[2] = iVar3;
        (**(code **)(**(int **)((int)this_00 + 0xc) + 0x18))(local_34);
      }
      ...
      *(UINT *)((int)this_00 + 0x1cd0) = param_1;
      if (param_6 == 0) {
        uVar5 = 0xffffffff;
        local_10 = *(int *)((int)this_00 + 0x1d88);
        uVar4 = 7;
        iVar15 = -1;
        iVar14 = -1;
        iVar12 = 1;
        ...
        uVar5 = 0xffffffff;
        uVar4 = 7;
        puVar6 = FUN_00713480(local_478,0x158,0x39,0xfffffffe,0xffffffff,1,-1,-1);
        ...
        *(undefined1 *)((int)this_00 + 0x1caa) = 1;
        ...
        if (*(char *)((int)this_00 + 0x9a) != '\0') {
          do {
            ...
            uVar10 = *(uint *)((int)this_00 + (local_8 & 0xff) * 0x1fb + 0x178);
