...

{
  ...
  piVar1 = param_4;
  piStack_14 = (int *)thunk_FUN_0042b760(param_1,param_2);
  if (piStack_14 != (int *)0x0) {
    puVar2 = thunk_FUN_004233e0((int)piStack_14);
    param_2 = puVar2[3];
    if (param_2 != 0) {
      ...
      if (0 < (int)param_2) {
        do {
          FUN_006acc70((int)puVar2,uVar10,&uStack_2c);
          piStack_14 = (int *)thunk_FUN_0042b620(param_1,uStack_2c,1);
          if ((piStack_14 == (int *)0x0) ||
             (iVar3 = (**(code **)(*piStack_14 + 0xf8))(), iVar3 == 0)) {
            FUN_006b0c70((int)puVar2,uVar10);
            param_2 = param_2 - 1;
            uVar10 = uVar10 - 1;
          }
          else {
            FUN_006ae140(puStack_18,uVar10,&piStack_14);
          }
          uVar10 = uVar10 + 1;
      ...
      if (param_2 != 0) {
        ...
        iStack_28 = 5;
        iVar4 = ((int)DAT_007fb240 * param_1 - (int)DAT_007fb246) + iStack_8;
        iVar3 = iStack_c;
        iVar9 = iStack_8;
        do {
