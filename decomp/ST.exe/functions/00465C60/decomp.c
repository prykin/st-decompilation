      ...
      if (*(int *)(this + 0x4cd) < 1) {
        ...
        case 1:
          ...
          if (CONCAT31(extraout_var_01,bVar3) == 1) {
            if ((*(int *)(this + 0x4a1) != -1) && (local_c == (STBoatC *)0x0))
            goto switchD_004660af_caseD_2;
            ...
            if (local_c != (STBoatC *)0x1) goto switchD_004660af_caseD_2;
LAB_00467018:
...
LAB_00468322:
        ...
        if (CONCAT31(extraout_var_03,bVar3) == 1) {
          ...
          if (local_c == (STBoatC *)0x0) {
            return 2;
          }
          if (*(int *)(this + 0x4a1) == -1) {
            return 2;
          }
          if (local_c != (STBoatC *)0x1) {
            return 2;
          }
          *(undefined4 *)(this + 0x4cd) = 0;
          *(undefined4 *)(this + 0x4d5) = 1;
...
LAB_00468b38:
        ...
        if ((piVar14[0x12d] == 0) && (*(int *)((int)piVar14 + 0x245) != 6)) {
          thunk_FUN_004e1930(piVar14,&local_8,0);
          iVar6 = thunk_FUN_00430910(local_8);
          local_18 = thunk_FUN_004e1930(piVar14,&local_8,iVar6);
          if (local_18 == iVar6) {
...
LAB_0046739a:
          ...
          if (((local_18 < iVar6) ||
             ...
             (iVar6 = (**(code **)(*piVar14 + 0x88))(&local_8), iVar6 == 0)) goto LAB_0046744c;
        }
        else {
LAB_0046744c:
          thunk_FUN_0048d930((int)this);
                  ...
                  do {
                    ...
                    if (DAT_0080732c == 1) {
                      ...
                      *(uint *)(this + 0x1c) = local_1c;
                      ...
                      iVar6 = (int)(short)lVar16 + (uVar10 >> 0x10) % 7 +
                              (int)*(short *)(this + 0x45) + -3 + (int)local_20;
                    ...
                    TraksClassTy::TraksCreate
                              (DAT_00802a7c,1,2,7,
                               ...
                               (int)(short)local_24,iVar7 + -3,iVar6,sVar17,sVar18,sVar19,sVar20,
...
LAB_00469198:
                if ((*(int *)(this + 0x4ab) != -1) && (local_c == (STBoatC *)0x0))
                goto LAB_004691ae;
              }
              *(undefined4 *)(this + 0x4cd) = 0;
...
LAB_00467fe4:
        ...
        if (CONCAT31(extraout_var_02,bVar3) == 1) {
          ...
          if (local_c != (STBoatC *)0x1) goto LAB_00466744;
          *(undefined4 *)(this + 0xb7) = 3;
          *(undefined4 *)(this + 0x4d5) = 1;
          thunk_FUN_00481520(this,(int)*(short *)(this + 0x49b),(int)*(short *)(this + 0x49d),
                             *(short *)(this + 0x49f) + 1);
