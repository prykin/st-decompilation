...
int __fastcall FUN_00465c60(int *param_1,undefined4 param_2,int param_3)
      ...
      if (*(int *)((int)param_1 + 0x4cd) < 1) {
        ...
        case 1:
          ...
          if (CONCAT31(extraout_var_01,bVar3) == 1) {
            if ((*(int *)((int)param_1 + 0x4a1) != -1) && (local_c == (undefined4 *)0x0))
            goto switchD_004660af_caseD_2;
                ...
                if (*(char *)((int)param_1 + 0x2bf) != '\0') {
                  ...
                  do {
                    ...
                    thunk_FUN_00556760(DAT_00802a7c,1,2,7,
                                       ...
                                       -3 + (int)(short)local_24,iVar7 + -3,iVar6,sVar16,sVar17,
                    ...
                    if (*(char *)((int)param_1 + 0x2bf) != '\0') {
                      ...
                      do {
                        ...
                        thunk_FUN_00556760(DAT_00802a7c,1,2,7,
                                           ...
                                           (int)(short)local_24,iVar7 + -3,iVar6,sVar16,sVar17,
                                           sVar18,sVar19,sVar20,sVar21,iVar8,sVar22,bVar23);
                        param_3 = param_3 + 1;
                        local_c = (undefined4 *)((int)local_c + 6);
                      } while (param_3 < (int)(uint)*(byte *)((int)param_1 + 0x2bf));
...
LAB_00469198:
                if ((*(int *)((int)param_1 + 0x4ab) != -1) && (local_c == (undefined4 *)0x0))
                goto LAB_004691ae;
              }
              *(undefined4 *)((int)param_1 + 0x4cd) = 0;
