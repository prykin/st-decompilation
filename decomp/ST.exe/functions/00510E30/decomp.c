    ...
    do {
      ...
      if (*(char *)(puVar16 + 2) != '\0') {
        ...
        if (pDVar6->count != 0) {
          ...
          do {
            /* ST_PSEUDO[dynamic_array_indexing]: expected DArrayAt<T>(pDVar6, uVar19) (runtime stride) */
...
LAB_00510fa9:
  ...
  do {
    ...
    if (uVar19 != 1) {
      do {
        if (uVar18 < uVar19) {
          /* ST_PSEUDO[dynamic_array_indexing]: expected DArrayAt<T>(pDVar6, uVar18) (runtime stride) */
        ...
        if ((pUVar20 != (UINT *)0x0) && (pUVar17 != (UINT *)0x0)) {
          local_14 = LoadResourceString(*pUVar17,HINSTANCE_00807618);
          pcVar9 = LoadResourceString(*pUVar20,HINSTANCE_00807618);
          iVar4 = Library::MSVCRT::__strcmpi(pcVar9,local_14);
          if (0 < iVar4) {
            FUN_006b0cd0((AnonShape_00413AF0_B6B4EE9A *)this_00->field_01BB,uVar18,local_8);
  ...
  iVar28 = -1;
  iVar4 = -2;
  puVar7 = (uint *)LoadResourceString(0x2734,HINSTANCE_00807618);
