...

{
  ...
  *(uint **)(local_10 + 0x1b3) = puVar4;
  puVar4 = FUN_006ae290((uint *)0x0,200,0x14,0x32);
  *(uint **)(local_10 + 0x1bb) = puVar4;
  puVar4 = FUN_006ae290((uint *)0x0,100,9,0x32);
  *(uint **)(local_10 + 0x1cb) = puVar4;
  puVar4 = FUN_006ae290((uint *)0x0,0x14,0x19,0x14);
  *(uint **)(local_10 + 0x1d7) = puVar4;
  *(undefined1 *)(local_10 + 0x253) = 0;
  *(undefined1 *)(local_10 + 0x252) = 0;
  *(undefined1 *)(local_10 + 0x251) = 0;
  *(undefined1 *)(local_10 + 0x250) = 0;
  uVar14 = 0;
  if (*(int *)sizeHelp_exref != 0) {
    piVar10 = (int *)(*(int *)(local_10 + 0x1c7) + 0xd);
    do {
      if (*(char *)((int)piVar10 + -5) == '\b') {
        iVar3 = *piVar10;
        if (iVar3 == 1) {
          *(char *)(local_10 + 0x251) = *(char *)(local_10 + 0x251) + '\x01';
        }
        else if (iVar3 == 2) {
          *(char *)(local_10 + 0x252) = *(char *)(local_10 + 0x252) + '\x01';
        }
        else if (iVar3 == 3) {
          *(char *)(local_10 + 0x253) = *(char *)(local_10 + 0x253) + '\x01';
        }
        else {
          *(char *)(local_10 + 0x250) = *(char *)(local_10 + 0x250) + '\x01';
        }
      }
      uVar14 = uVar14 + 1;
  ...
  if (*(int *)sizeHelp_exref != 0) {
    ...
    do {
      puVar11 = (undefined4 *)((int)local_c + *(int *)(local_10 + 0x1c7));
      if (*(char *)(puVar11 + 2) != '\0') {
        puVar4 = *(uint **)(local_10 + 0x1bb);
        bVar2 = true;
        uVar14 = 0;
        local_14 = (char *)0x1;
        if (puVar4[3] != 0) {
...
LAB_00510fa9:
    ...
    if (uVar14 != 1) {
      do {
        ...
        if ((pUVar15 != (UINT *)0x0) && (pUVar12 != (UINT *)0x0)) {
          ...
          iVar3 = __strcmpi(pcVar5,local_14);
          if (0 < iVar3) {
            FUN_006b0cd0(*(int *)(local_10 + 0x1bb),uVar13,local_8);
  ...
  *(undefined4 *)(local_10 + 0x218) = uVar9;
  ...
  thunk_FUN_00540760(*(undefined4 **)(local_10 + 0x68),0,0,'\x01',*(byte **)(local_10 + 0x1dc));
  FUN_00710a90(*(int *)(local_10 + 0x68),0,0x6c,2,0x117,0xc);
  uVar9 = 0;
  iVar23 = -1;
  iVar3 = -2;
  ...
  uVar9 = thunk_FUN_0053dea0(0,1,0x195,0x17b,1,(int)pCVar6,uVar9,uVar17,sVar19,uVar20,uVar22,pcVar5,
                             uVar24,uVar25);
  local_c = (undefined4 *)(local_10 + 0x180);
  *(undefined4 *)(local_10 + 0x17c) = uVar9;
  iVar3 = 0;
  iVar23 = 0x1e;
  local_8 = 7;
  do {
