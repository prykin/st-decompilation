...
LAB_004dd5bb:
  if ((g_manRub3_008117A4 != nullptr) && (param_1->field_04D0 == CASE_0)) {
    iVar1 = thunk_FUN_0062e640(g_manRub3_008117A4,(int)param_1->field_0024,(int)param_1->field_0018);
    if (iVar1 == 0) {
      ...
      if (param_1->field_04DC + 0x2ee <= g_playSystem_00802A38->field_00E4) {
        iVar1 = thunk_FUN_0062e6b0(g_manRub3_008117A4,(int)param_1->field_0024,
