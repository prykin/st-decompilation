...
undefined4 __cdecl FUN_0073f396(undefined4 param_1,uint param_2,ushort param_3)

{
  ...
  if ((((((CONCAT22(param_3,param_2._2_2_) ^ 0x700) & 0x700) == 0) &&
       ((&DAT_007f235c)[(param_2._2_2_ & 0x7800) >> 0xb] != '\0')) && ((param_3 & 0x7fff) != 0x7fff)
    ...
    if ((ushort)((param_3 & 0x7fff) + 0x3f) < (in_stack_00000024 & 0x7fff)) {
      ...
      do {
        ...
        fVar3 = fVar3 * (float10)_DAT_007f238c;
        iVar1 = iVar1 + -1;
      } while (iVar1 != 0);
    }
    else {
