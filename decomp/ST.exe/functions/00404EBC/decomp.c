...
void __fastcall thunk_FUN_00436f20(STAllPlayersC *param_1,undefined4 param_2,undefined1 *param_3)

{
  ...
  if (uVar11 != 0) {
    ...
    puStack_8 = (undefined4 *)thunk_FUN_0042b620(uVar19,uVar21,1);
...
switchD_0043702c_caseD_8:
    ...
    case 0x11:
      if (*(int *)(param_3 + 0x13) == 0) {
        ...
        if (0 < (short)(*(uint *)(param_3 + 0x13) >> 1)) {
          do {
            FUN_006ae1c0(puStack_c,(undefined4 *)(puVar7 + sVar22 * 2 + iVar20));
            sVar22 = sVar22 + 1;
      ...
      puVar12 = puStack_c;
      thunk_FUN_0044cdb0(CONCAT31((int3)(uVar21 >> 8),param_3[8]),(int)puStack_c,
  ...
  if (*(int *)(param_3 + 0x13) != 0) {
    ...
    if (0 < (short)uVar21) {
      do {
        FUN_006ae1c0(puStack_c,(undefined4 *)(iVar20 + iVar17 + sVar22 * 2));
        sVar22 = sVar22 + 1;
    ...
    STAllPlayersC::AddObjsToGroup
              (pSStack_20,CONCAT31((int3)(uVar21 >> 8),param_3[8]),0xfffe,(int)puStack_c,
  ...
  if (((puStack_30 != (undefined4 *)0x0) &&
      (pSVar13 = (STGroupC *)thunk_FUN_0042b760(CONCAT31((int3)(uVar21 >> 8),param_3[8]),uStack_1c),
    ...
    STAllPlayersC::AddObjsToGroup
              (pSStack_20,CONCAT31((int3)((uint)extraout_ECX_06 >> 8),param_3[8]),0xfffe,
               (int)puVar14,(undefined2 *)&uStack_1c);
    pSVar13 = (STGroupC *)FUN_006ae110((byte *)puVar14);
  }
  this_00 = (STGroupBoatC *)
            thunk_FUN_0042b760(CONCAT31((int3)((uint)pSVar13 >> 8),param_3[8]),uStack_1c);
  ...
  case 0x14:
    ...
    if (iVar20 != 0) {
      ...
      uStack_d8 = 1;
      puStack_dc = puVar12;
      (**(code **)(*(int *)this_00 + 8))(6,&puStack_dc);
      FUN_006ae110((byte *)puVar12);
      return;
    }
    ...
    (**(code **)(*(int *)this_00 + 8))(1,&uStack_4c);
    return;
  case 0x15:
    iStack_24 = 4 - (uint)**(byte **)(param_3 + 0x17);
    (**(code **)(*(int *)this_00 + 8))(7,&iStack_24);
    return;
  case 0x16:
    puVar7 = *(undefined1 **)(param_3 + 0x17);
    switch(*puVar7) {
...
LAB_00437842:
      ...
      uStack_150 = 0;
      puStack_148 = puVar12;
      (**(code **)(*(int *)this_00 + 8))(2,&uStack_150);
      FUN_006ae110((byte *)puVar12);
      return;
    case 1:
      FUN_006e62d0(DAT_00802a38,*(int *)(puVar7 + 1),(int *)&puStack_8);
      if (puStack_8 != (undefined4 *)0x0) {
        ...
        (**(code **)(*(int *)this_00 + 8))(0xf,&uStack_e4);
        return;
      }
      break;
    case 2:
      ...
      (**(code **)(*(int *)this_00 + 8))(0xe,&uStack_b0);
      return;
    }
    break;
  case 0x17:
    ...
    case 1:
      ...
      if (puStack_8 != (undefined4 *)0x0) {
        ...
        uStack_138 = 0;
        puStack_134 = puVar12;
        (**(code **)(*(int *)this_00 + 8))(5,&uStack_138);
        FUN_006ae110((byte *)puVar12);
        return;
      }
      break;
    ...
    case 3:
      ...
      if (((-1 < sVar6) && (sVar6 < DAT_007fb240)) &&
        ...
        uStack_d0 = 0;
        puStack_cc = puVar12;
        (**(code **)(*(int *)this_00 + 8))(4,&uStack_d0);
        FUN_006ae110((byte *)puVar12);
        return;
      }
      break;
    ...
    case 0x10:
      ...
      (**(code **)(*(int *)this_00 + 8))(0x14,&uStack_b8);
      return;
    case 0x13:
      ...
      if ((((-1 < sVar22) && (sVar22 < DAT_007fb240)) &&
        ...
        (**(code **)(*(int *)this_00 + 8))(0x11,&uStack_98);
        return;
      }
      break;
    case 0x14:
    ...
    case 0x18:
      ...
      (**(code **)(*(int *)this_00 + 8))(0x13,&uStack_a8);
      return;
    }
    break;
  case 0x18:
...
switchD_004375b6_caseD_a:
  ...
  case 0x19:
    ...
    (**(code **)(*(int *)this_00 + 8))(0xd,&uStack_124);
    return;
  case 0x1a:
    ...
    if (*pcVar8 == '\x01') {
      ...
      (**(code **)(*(int *)this_00 + 8))(0x10,&uStack_5c);
      return;
    }
    if (*pcVar8 == '\x02') {
  ...
  case 0x1f:
    ...
    if (*pcVar8 == '\x03') {
      ...
      (**(code **)(*(int *)this_00 + 8))(0x12,&sStack_a0);
      return;
    }
    if (*pcVar8 == '\x01') {
      puVar12 = FUN_006ae290((uint *)0x0,1,2,1);
      ...
      uStack_f2 = 0xffff;
      uStack_f4 = 0xffff;
      (**(code **)(*(int *)this_00 + 8))(8,auStack_118 + 1);
      FUN_006ae110((byte *)puStack_c);
      return;
    }
    puStack_c = STGroupC::GetGroupContent((STGroupC *)this_00,unaff_EDI);
    uVar21 = puStack_c[3];
    uStack_154 = uVar21;
...
LAB_00437e03:
      ...
      (**(code **)(*(int *)this_00 + 8))(10,&uStack_c0);
      puVar12 = puStack_30;
    }
    else {
      uVar21 = 0;
...
LAB_00437cb5:
      ...
      FUN_006ae1c0(puStack_30,(undefined4 *)(iVar20 + 0x32));
      puStack_f8 = puVar12;
      uStack_ea = 0xffff;
      uStack_ec = 0xffff;
      uStack_ee = 0xffff;
  ...
  case 0x21:
    ...
    if (cVar1 == '\x01') {
      ...
      (**(code **)(*(int *)this_00 + 8))(0x15,&uStack_64);
      return;
    }
    if (cVar1 == '\x03') {
      uStack_c4 = 0xffff;
      uStack_c6 = 0xffff;
      uStack_c8 = 0xffff;
      (**(code **)(*(int *)this_00 + 8))(0xc,&uStack_c8);
      return;
    }
    if (cVar1 == '\x04') {
      uStack_60 = *(undefined4 *)(pcVar8 + 1);
      (**(code **)(*(int *)this_00 + 8))(0xb,&uStack_60);
      return;
    }
    break;
  case 0x23:
    ...
    uStack_166 = 0;
    uStack_157 = 0xffff;
    (**(code **)(*(int *)this_00 + 8))(9,&uStack_174);
    return;
  case 0x28:
    if (**(char **)(param_3 + 0x17) == '\0') {
  ...
  case 0x31:
    ...
    case 2:
      ...
      if (*(short *)(puVar7 + 1) != 0) {
        iVar20 = 0;
        do {
          FUN_006ae1c0(puStack_148,(undefined4 *)(puVar7 + iVar20 * 4 + 4));
          sVar22 = sVar22 + 1;
          iVar20 = (int)sVar22;
    ...
    case 3:
      ...
      if (*(short *)(puVar7 + 1) != 0) {
        iVar20 = 0;
        do {
          FUN_006ae1c0(puStack_134,(undefined4 *)(puVar7 + iVar20 * 2 + 4));
          sVar22 = sVar22 + 1;
          iVar20 = (int)sVar22;
        } while (iVar20 < (int)(uint)*(ushort *)(puVar7 + 1));
      }
