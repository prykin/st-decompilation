...
undefined4 __thiscall thunk_FUN_004e2200(void *this,int param_1,int param_2,undefined4 param_3)

{
  ...
  if ((*(int *)((int)this + param_1 * 0x28 + 0x4d0) == param_2) &&
    ...
    *(undefined4 *)((int)this + param_1 * 0x28 + 0x4e8) = *(undefined4 *)(DAT_00802a38 + 0xe4);
