...
undefined4 __cdecl
FUN_004b2390(uint param_1,int param_2,int param_3,undefined4 param_4,undefined4 *param_5,int param_6
            )
      ...
      if (((((DAT_007fb240 <= sVar3) || (sVar1 < 0)) ||
         ...
         (((((sVar3 < DAT_007fb240 && (-1 < sVar1)) && (sVar1 < DAT_007fb242)) &&
          ...
          (((*(short *)(DAT_007fb280 +
                       ...
                       ) * 2) == 0 && ((local_8 = 1, param_6 != 0 && (DAT_00802a88 != (void *)0x0)))
            ) && (iVar2 = thunk_FUN_0055b1c0(DAT_00802a88,param_2,param_3,param_4,param_1),
                 iVar2 != 0)))))) {
        local_8 = 0;
        *param_5 = 1;
      }
