...
int __thiscall thunk_FUN_0065bd70(void *this,int param_1,int param_2)
...
LAB_0065c021:
          (**(code **)(*piVar2 + 0x74))(acStack_1c);
          Library::DKW::TBL::FUN_006b6020(*(int *)((int)this + 0x5b3),0,acStack_1c);
...
LAB_0065c4bb:
    ...
    *(int *)((int)this + 0x573) = (int)sStack_6;
    if (*(ushort *)(piVar2 + 0xc) == 0xffff) {
      uVar12 = 0xffffffff;
    }
    else {
