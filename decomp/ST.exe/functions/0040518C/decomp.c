...

{
  ...
  if (iVar4 == 0) {
    ...
    *param_2 = iStack_c + 0x10cU;
    puVar5 = FUN_006aac10(iStack_c + 0x10cU);
    puVar8 = param_1;
    puVar10 = puVar5;
      ...
      if (0 < *(int *)(iVar9 + 0xc)) {
        ...
        do {
          ...
          if (puVar5 != (undefined4 *)0x0) {
            ...
            puStack_8 = (undefined4 *)FUN_006acf50(puStack_8,puStack_8[5] + uStack_10);
            puVar5 = puStack_1c;
  ...
  iVar9 = FUN_006ad4d0(s_E____titans_ai_ai_tact_d_cpp_007d58fc,0x8c,0,iVar4,&DAT_007a4ccc);
  if (iVar9 == 0) {
    FUN_006a5e40(iVar4,0,0x7d58fc,0x8d);
