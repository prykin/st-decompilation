...
void __fastcall thunk_FUN_0051da70(int *param_1)

{
  ...
  if ((((DAT_0080734d != '\0') &&
    ...
    if (DAT_0080874e == '\x02') {
      ...
      iVar12 = ((bVar8 - uStack_8) - (uint)bVar4) + -1 + (uint)bVar3;
    }
    if (-1 < iVar12) {
      uVar10 = FUN_0072e6c0();
      uVar10 = uVar10 % (iVar12 + 1U);
      uVar5 = (uint)*(byte *)(param_1 + 0x94);
      uStack_8 = uVar10 & 0xff;
      if ((int)(uVar10 & 0xff) < (int)(uVar5 - bVar4)) {
        puVar11 = &DAT_0080734e;
        iStack_c = 0;
      }
      else {
        uStack_8 = (uint)(byte)((char)uVar10 + (bVar4 - *(byte *)(param_1 + 0x94)));
        if (DAT_0080874e == '\x01') {
      ...
      if (uVar5 != 0) {
        ...
        do {
          if ((*puVar11 & 1 << ((byte)uVar10 & 0x1f)) == 0) {
            if ((char)uStack_8 == '\0') {
              HelpPanelTy::TipProc((HelpPanelTy *)param_1,(void *)(uint)bVar1,iStack_c,'\0');
              (**(code **)(*param_1 + 0x18))(1);
              return;
            }
            uStack_8 = (uint)(byte)((char)uStack_8 - 1);
          }
          bVar1 = bVar1 + 1;
          uVar10 = (uint)bVar1;
        } while (uVar10 < uVar5);
