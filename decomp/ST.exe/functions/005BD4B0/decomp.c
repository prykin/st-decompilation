...
void FUN_005bd4b0(int param_1,undefined4 param_2,undefined4 param_3,int param_4,int param_5,
...

{
  ...
  if (param_8 != 0) {
    ...
    if (iVar2 == 0) {
      ...
      FUN_00710a90(local_8,0,5,5,*(int *)(local_8 + 4) + -10,0xf);
      ...
      FUN_00710a90(local_8,0,5,0x19,*(int *)(local_8 + 4) + -10,0xf);
      if (*(char *)(iVar8 + 0x67) == '\0') {
        UVar6 = 0x2711;
      }
      else {
