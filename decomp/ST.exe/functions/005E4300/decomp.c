  ...
  if (param_1 != (int *)0x0) {
    ...
    if (iVar4 == 0) {
      ...
      if (param_2 != 0) {
        ...
        ccFntTy::WrStr(pMVar2->field_0089,extraout_EAX,iVar9,iVar10,iVar4);
      }
      g_currentExceptionFrame = local_5c.previous;
      return;
    }
    g_currentExceptionFrame = local_5c.previous;
    iVar9 = ReportDebugMessage(s_E____titans_Start_task_obj_cpp_007cd994,0x4b9,0,iVar4,&DAT_007a4ccc
                               ,s_MTaskTy__PaintBut_007cdc8c);
    if (iVar9 != 0) {
      pcVar1 = (code *)swi(3);
      (*pcVar1)();
      return;
