  ...
  if ((param_3 == (int *)0x0) || (param_3 == (int *)0x1)) {
    ...
    *(int *)((int)param_1 + 0x6b9) = iVar5;
    if (iVar5 == 1) {
      ...
      local_10 = CONCAT22(local_10._2_2_,sVar12);
      local_8 = 0;
      sVar15 = *(short *)((int)param_1 + 0x6ad) + 1;
      local_14 = CONCAT22(local_14._2_2_,*(short *)((int)param_1 + 0x6a9));
      do {
        local_18 = 0;
        sVar11 = (short)local_8 + *(short *)((int)param_1 + 0x6a9);
        do {
          sVar4 = sVar12 + (short)local_18;
...
LAB_0047f4cd:
    ...
    *(undefined4 *)((int)param_1 + 0xb7) = 3;
    thunk_FUN_00481520(param_1,(int)(short)uVar22,(int)sVar12,(short)local_c + 1);
          ...
          do {
            ...
            if (DAT_0080732c == 1) {
              ...
              thunk_FUN_00556760(DAT_00802a7c,1,2,7,
                                 ...
                                 (int)*(short *)((int)param_1 + 0x45) + -3 + (int)local_20,sVar12,
              ...
              param_1[7] = uVar8;
              local_24._2_2_ = (short)((uint)uVar22 >> 0x10);
              iVar5 = (int)local_24._2_2_;
              local_24._0_2_ = (short)uVar22;
              iVar14 = (int)(short)local_24;
              thunk_FUN_00556760(DAT_00802a7c,1,2,7,
            ...
            if (*(int *)((int)param_1 + 0x6c7) == 3) {
              ...
              if (*(char *)((int)param_1 + 0x2bf) != '\0') {
                ...
                do {
                  ...
                  thunk_FUN_00556760(DAT_00802a7c,1,2,7,
                                     (uVar8 >> 0x10) % 7 + (int)*(short *)((int)param_1 + 0x41) + -3
                                     + (int)(short)local_24,iVar14 + -3,iVar5,sVar12,sVar15,sVar11,
