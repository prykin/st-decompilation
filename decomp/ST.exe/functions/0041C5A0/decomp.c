...
void __fastcall FUN_0041c5a0(int *param_1)

{
  undefined4 uVar1;
  
  if ((g_visibleClass_00802A88 != (VisibleClassTy *)0x0) &&
     ((*(byte *)((int)param_1 + 0x1d1) & 1) == 0)) {
    thunk_FUN_00559110(g_visibleClass_00802A88,(int)*(short *)((int)param_1 + 0x5b),
    ...
    case 0xb:
    case 0x23:
      thunk_FUN_00559d60(g_visibleClass_00802A88,(int)*(short *)((int)param_1 + 0x5b),
                         (int)*(short *)((int)param_1 + 0x5d),
