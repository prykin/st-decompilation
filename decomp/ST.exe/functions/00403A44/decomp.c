...
int __fastcall thunk_FUN_00416400(void *param_1)

{
  ...
  iVar4 = thunk_FUN_00415ed0(param_1,&iStack_28,&uStack_2c);
  if (iVar4 == -1) {
  ...
  if (iVar4 == 0) {
    *(undefined4 *)((int)param_1 + 0xf4) = 1;
    ...
    thunk_FUN_00416270(param_1,asStack_24,asStack_20,asStack_1c);
    ...
    *(int *)((int)param_1 + 0xd3) = iVar4;
    ...
    uVar5 = (int)sVar6 - (int)asStack_24[0];
    iStack_c = CONCAT22((short)((uint)iVar4 >> 0x10),
                        *(short *)(*(int *)((int)param_1 + 0x97) + 4 + iVar4 * 8) * 200) + 100;
    uVar7 = (int)uVar5 >> 0x1f;
    iStack_14 = (uVar5 ^ uVar7) - uVar7;
    uVar5 = (int)sVar8 - (int)asStack_20[0];
    uVar7 = (int)uVar5 >> 0x1f;
    iVar4 = (uVar5 ^ uVar7) - uVar7;
    uVar5 = (int)(short)iStack_c - (int)asStack_1c[0];
    uVar7 = (int)uVar5 >> 0x1f;
    iStack_18 = (uVar5 ^ uVar7) - uVar7;
    if (iStack_18 == 0) {
      bVar2 = *(byte *)((int)param_1 + 0x61);
    }
    else {
      bVar3 = 2 < iStack_18 / iStack_14;
      bStack_5 = iStack_14 == 0 || bVar3;
      if ((iStack_14 == 0 || bVar3) && (iVar4 == 0 || 2 < iStack_18 / iVar4)) {
    ...
    _bStack_10 = CONCAT31((int3)((uint)iVar4 >> 8),bVar2);
    iVar4 = thunk_FUN_00415b30(param_1,asStack_24[0],asStack_20[0],asStack_1c[0],sVar6,sVar8,
                               (short)iStack_c,bVar2);
    if (iVar4 != 0) {
      *(undefined1 *)((int)param_1 + 0xe3) = 0xff;
      return -1;
    }
