...

{
  ...
  pSStack_20 = this;
  iVar3 = Library::MSVCRT::__setjmp3(IStack_bc.jumpBuffer,0,unaff_EDI,unaff_ESI);
  this_00 = pSStack_20;
  if (iVar3 != 0) {
    ...
    if (*(int *)(this_00 + 0x10b) == 0) {
        ...
        do {
          ...
          if (((short)uStack_8 != -1) &&
             (piVar5 = (int *)STAllPlayersC::GetObjPtr
                                        (DAT_007fa174,
                                         CONCAT31((int3)((uint)extraout_EDX >> 8),this_00[0x24]),
            ...
            if (((iVar9 != iStack_14) && (iVar3 == *(int *)(this_00 + 0x25e))) &&
              ...
              Library::DKW::TBL::FUN_006ae1c0(*(uint **)(this_00 + 0x24e),&uStack_8);
            }
          }
          uVar14 = uVar14 + 1;
      ...
      *(undefined4 *)(this_00 + 0x10f) = 0;
      ...
      if (puVar4 == (uint *)0x0) {
        ...
        *(uint **)(this_00 + 0x24e) = puVar4;
        uStack_8 = 0xffff;
        Library::DKW::TBL::FUN_006ae1c0(puVar4,&uStack_8);
      }
      else {
      ...
      if (0 < (int)uVar14) {
        do {
          ...
          if ((((short)uStack_8 != -1) &&
              (piVar5 = (int *)STAllPlayersC::GetObjPtr
                                         (DAT_007fa174,
                                          CONCAT31((int3)((uint)extraout_ECX >> 8),this_00[0x24]),
                                          uStack_8,1), piVar5 != (int *)0x0)) &&
             ((iVar3 = (**(code **)(*piVar5 + 0x2c))(), iVar3 == 0x3b || (iVar3 == 0x60)))) {
            Library::DKW::TBL::FUN_006ae1c0(*(uint **)(this_00 + 0x266),&uStack_8);
          }
          uVar12 = uVar12 + 1;
        ...
        if (0 < (int)uStack_c) {
          do {
            ...
            uVar12 = STAllPlayersC::GetObjPtr
                               (DAT_007fa174,
                                CONCAT31((int3)((uint)extraout_EDX_01 >> 8),this_00[0x24]),uStack_8,
                                1);
            if (uVar12 != 0) {
              Library::DKW::TBL::FUN_006ae1c0(*(uint **)(this_00 + 0x266),&uStack_8);
            }
        ...
        *(uint **)(this_00 + 0x266) = puVar6;
        ...
        if (0 < (int)uStack_c) {
          do {
            ...
            uVar12 = STAllPlayersC::GetObjPtr
                               (DAT_007fa174,
                                CONCAT31((int3)((uint)extraout_EDX_02 >> 8),this_00[0x24]),uStack_8,
                                1);
            if (uVar12 != 0) {
              Library::DKW::TBL::FUN_006ae1c0(*(uint **)(this_00 + 0x266),&uStack_8);
            }
    ...
    if (0 < (int)uStack_c) {
      do {
        ...
        this_01 = (void *)STAllPlayersC::GetObjPtr
                                    (DAT_007fa174,
                                     CONCAT31((int3)((uint)extraout_EDX_03 >> 8),this_00[0x24]),
                                     uStack_8,1);
