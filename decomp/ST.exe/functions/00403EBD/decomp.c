...

{
  ...
  STGameObjC *pSStack_14;
  STGameObjC *pSStack_10;
  STGameObjC *pSStack_c;
  char *pcStack_8;
  ...
  if (iVar5 != 0) {
    ...
    iVar8 = ReportDebugMessage(s_E____titans_wlad_Tc_gobj_cpp_007a4e0c,0x7eb,0,iVar5,&DAT_007a4ccc,
    ...
    RaiseInternalException(iVar5,0,s_E____titans_wlad_Tc_gobj_cpp_007a4e0c,0x7ec);
    return 0xffff;
  }
  FUN_006e5fd0();
  ...
  if (uVar6 < 0x1af) {
    if (uVar6 == 0x1ae) {
      ...
      if (CONCAT31(extraout_var_07,bVar4) != 0) {
        ...
        if (!bVar4) {
          *(undefined4 *)pcVar10 = *(undefined4 *)pcStack_8;
          *(undefined4 *)(pcVar10 + 4) = *(undefined4 *)(pcStack_8 + 4);
          *(undefined2 *)(pcVar10 + 8) = *(undefined2 *)(pcStack_8 + 8);
          pcVar10[10] = pcStack_8[10];
...
LAB_0041b128:
          ...
          if ((DAT_00801688 != (void *)0x0) &&
            ...
            *(undefined4 *)(pSVar3 + 0x181) = 0;
            ...
            pSStack_c = *(STGameObjC **)(pSVar3 + 0x15d);
            bVar4 = false;
            iVar5 = *(int *)(*(int *)pSVar16 + 0xc);
            if (iVar5 == *(int *)(pSStack_c + 0xc)) {
              iVar5 = iVar5 * 0x30;
              bVar24 = true;
              pcVar10 = *(char **)(*(int *)pSVar16 + 0x1c);
              pcVar12 = *(char **)(pSStack_c + 0x1c);
              do {
                if (iVar5 == 0) break;
                iVar5 = iVar5 + -1;
...
LAB_0041b308:
            if (bVar4) {
              if (pSStack_c != (STGameObjC *)0x0) {
                FUN_006ae110((byte *)pSStack_c);
              }
          ...
          if ((DAT_00801688 != (void *)0x0) &&
            ...
            pSStack_c = *(STGameObjC **)(pSVar3 + 0x199);
            iVar5 = 0x13;
            bVar4 = true;
            pSVar11 = pSStack_c;
            pSVar19 = pSVar16;
            ...
            if (!bVar4) {
              *(int *)pSVar16 = *(int *)pSStack_c;
              *(int *)(pSVar16 + 4) = *(int *)(pSStack_c + 4);
              *(int *)(pSVar16 + 8) = *(int *)(pSStack_c + 8);
              *(int *)(pSVar16 + 0xc) = *(int *)(pSStack_c + 0xc);
              *(undefined2 *)(pSVar16 + 0x10) = *(undefined2 *)(pSStack_c + 0x10);
              pSVar16[0x12] = pSStack_c[0x12];
...
LAB_0041b6c6:
      iVar5 = ReportDebugMessage(s_E____titans_wlad_Tc_gobj_cpp_007a4e0c,0x7e4,0,0,&DAT_007a4ccc,
...
LAB_0041b92c:
  ...
  if (CONCAT31(extraout_var_14,bVar4) != 0) {
    ...
    *(undefined4 *)(pSVar3 + 0x159) = 0;
    ...
    pSStack_c = *(STGameObjC **)(pSVar3 + 0x13d);
    bVar4 = false;
    iVar5 = *(int *)(*(int *)pSVar16 + 0xc);
    if (iVar5 == *(int *)(pSStack_c + 0xc)) {
      iVar5 = iVar5 * 0x30;
...
LAB_0041bac6:
  ...
  if (CONCAT31(extraout_var_16,bVar4) != 0) {
    ...
    pSStack_c = *(STGameObjC **)(pSVar3 + 0x191);
    iVar5 = 4;
    bVar4 = true;
    pSVar16 = pSStack_c;
    piVar22 = piVar13;
    ...
    if (!bVar4) {
      *piVar13 = *(int *)pSStack_c;
      piVar13[1] = *(int *)(pSStack_c + 4);
      piVar13[2] = *(int *)(pSStack_c + 8);
      piVar13[3] = *(int *)(pSStack_c + 0xc);
...
LAB_0041bcad:
  ...
  if (CONCAT31(extraout_var_18,bVar4) != 0) {
    ...
    pSStack_14 = *(STGameObjC **)(pSVar3 + 0x1a9);
    iVar5 = 3;
    bVar4 = true;
    pSVar16 = pSStack_14;
    piVar22 = piVar13;
    ...
    if (!bVar4) {
      *piVar13 = *(int *)pSStack_14;
      piVar13[1] = *(int *)(pSStack_14 + 4);
      piVar13[2] = *(int *)(pSStack_14 + 8);
