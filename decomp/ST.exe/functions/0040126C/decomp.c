...
void __thiscall thunk_FUN_005c1340(void *this,int param_1)

{
  ...
  if (*(char *)((int)this + 0x66) == '\x01') {
    cStack_5 = *(char *)((int)this + 0x6a) + '\x01';
  }
  else {
  ...
  pvVar3 = pvStack_c;
  if (iVar4 == 0) {
    puVar1 = (uint *)((int)pvStack_c + 0x5d);
    FUN_006f20e0(puVar1);
    if (cStack_5 == '\x01') {
      puVar5 = &DAT_007ca250;
    }
    ...
    *puVar1 = uVar6;
    ...
    FUN_00718780((int)auStack_470,0,0x100,0x1a,0x10,(undefined4 *)((int)pvVar3 + 0xa3));
    FUN_00718780((int)auStack_470,0,0x100,0x2e,0x10,(undefined4 *)((int)pvVar3 + 0x1a3));
    ...
    *(undefined4 *)(DAT_0081176c + 0x38) = uVar7;
    if (param_1 != 0) {
      auStack_2c[2] = *(undefined4 *)((int)pvVar3 + 8);
      puVar9 = auStack_2c;
