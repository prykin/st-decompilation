...

{
  ...
  if ((((uint)param_2[1] < uVar1) || ((uint)param_2[3] < param_4)) || (*param_2 == 0)) {
    FUN_006a5e40(0x14,DAT_007ed77c,0x7f2dc8,0x2fd);
  }
  if ((param_3 < (uint)param_2[6]) || ((uint)(param_2[4] + param_2[6]) < uVar1)) {
    if (param_2[10] == 0) {
      FUN_006a5e40(0x44,DAT_007ed77c,0x7f2dc8,0x303);
    }
    if (param_2[9] != 0) {
  ...
  if (uVar4 < uVar1) {
    if ((uVar4 < param_3) && (uVar4 = param_3, param_5 != 0)) {
      FUN_006a5e40(0x14,DAT_007ed77c,0x7f2dc8,0x328);
    }
    if (param_5 != 0) {
      param_2[7] = uVar1;
    }
    ...
    if (param_5 == 0) {
      FUN_006a5e40(0x14,DAT_007ed77c,0x7f2dc8,0x339);
