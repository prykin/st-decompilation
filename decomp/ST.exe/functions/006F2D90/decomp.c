...

{
  ...
  g_currentExceptionFrame = pIVar5;
  iVar3 = ReportDebugMessage(s_E__Ourlib_mfaobj_cpp_007efd3c,0x1b,0,errorCode,&DAT_007a4ccc,
                             s_mfAObjLoad_007efd54);
  if (iVar3 != 0) {
    pcVar1 = (code *)swi(3);
    puVar2 = (ushort *)(*pcVar1)();
    return puVar2;
  }
  RaiseInternalException(errorCode,0,s_E__Ourlib_mfaobj_cpp_007efd3c,0x1d);
  return (ushort *)0x0;
}
