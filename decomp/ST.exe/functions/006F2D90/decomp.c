...

{
  ...
  if (iVar2 == 0) {
    ...
    puVar3 = FUN_006f1ce0(0xc,param_2,piVar5,param_4);
    DAT_00858df8 = (undefined1 *)uVar6;
    return puVar3;
  }
  DAT_00858df8 = (undefined1 *)uVar6;
  iVar4 = FUN_006ad4d0(s_E__Ourlib_mfaobj_cpp_007efd3c,0x1b,0,iVar2,&DAT_007a4ccc);
  if (iVar4 != 0) {
    pcVar1 = (code *)swi(3);
    puVar3 = (ushort *)(*pcVar1)();
    return puVar3;
  }
  FUN_006a5e40(iVar2,0,0x7efd3c,0x1d);
  return (ushort *)0x0;
}
