...

{
  ...
  if (((((param_1 < 0) || (iVar11 = iVar11 + param_1, SHORT_007fb240 < iVar11)) || (param_2 < 0)) ||
      ((iVar15 = iVar15 + param_2, SHORT_007fb242 < iVar15 || (param_3 < 0)))) ||
    ...
    for (; iVar7 < iVar15; iVar7 = iVar7 + 1) {
      ...
      if (param_3 < param_3 + 1) {
        do {
          ...
          sVar10 = (short)iVar7;
          sVar14 = (short)iVar6;
          if ((((sVar13 < SHORT_007fb240) && (-1 < sVar10)) &&
              ((sVar10 < SHORT_007fb242 &&
               (((-1 < sVar14 && (sVar14 < SHORT_007fb244)) &&
                (*(int *)(DAT_007fb248 +
                         ((int)sVar14 * (int)SHORT_007fb246 + (int)sVar10 * (int)SHORT_007fb240 +
                         (int)sVar13) * 8) != 0)))))) ||
             (((sVar13 < 0 || (SHORT_007fb240 <= sVar13)) ||
              ((sVar10 < 0 ||
               (((SHORT_007fb242 <= sVar10 || (sVar14 < 0)) ||
                ((SHORT_007fb244 <= sVar14 ||
                 (*(short *)(DAT_007fb280 +
                            ((int)sVar10 * (int)SHORT_007fb278 + (int)sVar14 * (int)SHORT_007fb27e +
        ...
        do {
          ...
          if ((-1 < sVar10) &&
             ((((((sVar4 = (short)iVar7, sVar10 < SHORT_007fb240 && (-1 < sVar4)) &&
               ...
               (*(int *)(DAT_007fb248 +
                        ((int)sVar14 * (int)SHORT_007fb246 + (int)sVar4 * (int)SHORT_007fb240 +
                        (int)sVar10) * 8) != 0)) ||
              (((-1 < sVar10 && (sVar10 < SHORT_007fb240)) &&
               ((-1 < sVar4 &&
                ((((sVar4 < SHORT_007fb242 && (-1 < sVar14)) && (sVar14 < SHORT_007fb244)) &&
                 (*(short *)(DAT_007fb280 +
                            ((int)sVar4 * (int)SHORT_007fb278 + (int)sVar14 * (int)SHORT_007fb27e +
                            (int)sVar10) * 2) != -1)))))))))) {
            local_18 = 0;
            goto LAB_004ae37e;
          }
...
LAB_004ae37e:
  if (((param_9 == 0) ||
      (iVar16 = thunk_FUN_004406c0((char)param_5), sVar14 = SHORT_007fb240, (char)iVar16 == '\x03'))
     && ((sVar14 = SHORT_007fb240, local_18 != 0 && (local_18 = 0, param_3 < 4)))) {
    local_18 = 1;
...
LAB_004ae41c:
  ...
  case CASE_61:
    ...
    if (local_10 != (STFishC *)0x0) {
      iVar11 = (*local_10->vtable->slot_2C)();
        ...
        if (param_3 < param_3 + 1) {
          do {
            ...
            if (((sVar10 < 0) || (sVar14 <= sVar10)) ||
              ...
              local_10 = *(STFishC **)
                          (DAT_007fb248 + 4 +
                          ((int)sVar4 * (int)sVar14 + (int)sVar5 * (int)SHORT_007fb246 + (int)sVar10
                          ) * 8);
            }
           ...
           ((sVar13 < 0 ||
            ((SHORT_007fb244 <= sVar13 ||
             (piVar1 = *(int **)(DAT_007fb248 +
                                ((int)sVar13 * (int)SHORT_007fb246 + (int)sVar14 * (int)sVar4 +
                                (int)sVar10) * 8), piVar1 == (int *)0x0)))))))) ||
         (((iVar11 = (**(code **)(*piVar1 + 0x2c))(), iVar11 != 0x53 ||
           ((param_10 != (int *)0x0 && ((int *)piVar1[6] != param_10)))) &&
          (((iVar11 = (**(code **)(*piVar1 + 0x2c))(), sVar14 = SHORT_007fb240, iVar11 < 0x54 ||
            (iVar11 = (**(code **)(*piVar1 + 0x2c))(), sVar14 = SHORT_007fb240, 0x5a < iVar11)) ||
           ((param_10 != (int *)0x0 && (*(int **)((int)piVar1 + 0x5d3) != param_10)))))))) {
        sVar4 = (short)param_2;
        if (((param_1 + -1 < 0) ||
            ((((sVar5 = (short)(param_1 + -1), sVar5 < 0 || (sVar14 <= sVar5)) || (sVar4 < 0)) ||
             (((SHORT_007fb242 <= sVar4 || (sVar13 < 0)) ||
              ((SHORT_007fb244 <= sVar13 ||
               (piVar1 = *(int **)(DAT_007fb248 +
                                  ((int)sVar13 * (int)SHORT_007fb246 + (int)sVar4 * (int)sVar14 +
          ...
          if (((param_1 + 1 < (int)sVar14) &&
              ((((((sVar5 = (short)(param_1 + 1), -1 < sVar5 && (sVar5 < sVar14)) && (-1 < sVar4))
                 && ((sVar4 < SHORT_007fb242 && (-1 < sVar13)))) && (sVar13 < SHORT_007fb244)) &&
               (piVar1 = *(int **)(DAT_007fb248 +
                                  ((int)sVar13 * (int)SHORT_007fb246 + (int)sVar4 * (int)sVar14 +
                                  (int)sVar5) * 8), piVar1 != (int *)0x0)))) &&
             (((iVar11 = (**(code **)(*piVar1 + 0x2c))(), piVar2 = param_10, iVar11 == 0x53 &&
               ((param_10 == (int *)0x0 || ((int *)piVar1[6] == param_10)))) ||
              ((iVar11 = (**(code **)(*piVar1 + 0x2c))(), sVar14 = SHORT_007fb240, 0x53 < iVar11 &&
               ((iVar11 = (**(code **)(*piVar1 + 0x2c))(), sVar14 = SHORT_007fb240, iVar11 < 0x5b &&
                ((piVar2 == (int *)0x0 || (*(int **)((int)piVar1 + 0x5d3) == piVar2)))))))))) {
            local_c = 1;
          }
                  ...
                  ((((sVar4 < SHORT_007fb242 && (-1 < sVar13)) &&
                    ((sVar13 < SHORT_007fb244 &&
                     (piVar1 = *(int **)(DAT_007fb248 +
                                        ((int)sVar13 * (int)SHORT_007fb246 +
                                         (int)sVar14 * (int)sVar4 + (int)sVar10) * 8),
                     piVar1 != (int *)0x0)))) &&
                   (((iVar11 = (**(code **)(*piVar1 + 0x2c))(), piVar2 = param_10, iVar11 == 0x53 &&
                     ((param_10 == (int *)0x0 || ((int *)piVar1[6] == param_10)))) ||
