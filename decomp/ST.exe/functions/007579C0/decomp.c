...

{
  ...
  if (iVar2 == 1) {
    ...
    if (*(int *)(iVar1 + 0x10) == 0) {
      RaiseInternalException(0x22,DAT_007ed77c,s_E__DKW_JPG_C_jdinput_c_007f2d98,0x137);
    }
    ...
    *(undefined4 *)(iVar1 + 0x14) = 1;
    if (*(int *)(iVar1 + 0x18) == 0) {
      ...
      RaiseInternalException(0x3a,DAT_007ed77c,s_E__DKW_JPG_C_jdinput_c_007f2d98,0x13f);
      return 2;
    }
  }
  return iVar2;
