...
void __fastcall FUN_00584d10(void *param_1)

{
  ...
  local_33 = *(undefined2 *)((int)param_1 + 0x284);
  local_38 = 0;
  local_37 = *(undefined4 *)((int)param_1 + 0x280);
  local_3c = 0xa3;
  local_64[0] = 0x28;
  local_64[3] = 1;
  local_c = 0;
  ...
  do {
    ...
    if ((((-1 < local_4a) && (-1 < sStack_48)) && (-1 < local_46)) &&
      ...
      thunk_FUN_0054cc20(0x28,0,0,local_64,0);
      if (0xc9 < local_46) {
