...
byte * __cdecl FUN_006a2ed0(RecoveredRecord_006A2ED0_9EFE711B *param_1)
...
LAB_006a2f2f:
  ...
  *(undefined2 *)((int)&local_14[0x15].field_000B + 2) = 0xeae8;
  ...
  if (0 < param_1->field_0455) {
    pRVar10 = param_1 + 1;
    do {
      puVar5 = (byte *)(*(undefined4 **)pRVar10);
      ...
      iVar6 = iVar6 + 1;
      pRVar10 = (RecoveredRecord_006A2ED0_9EFE711B *)&pRVar10->field_0x4;
    } while (iVar6 < param_1->field_0455);
  }
  ST3DSMAPContext::sub_006DD610
            ((ST3DSMAPContext *)local_14,8,(double)((float)(int)*(short *)param_1 * _DAT_007904f4),
  ...
  pRVar4 = FUN_006b50c0(0x8b,0x8b,8,0x100,(undefined4 *)(puVar3 + 0x14),1);
  ...
  puVar5 = STPointerBoundaryCast<byte *>(FUN_006b4fa0(pRVar4));
  ...
  do {
    ...
    param_1_after_write = (RecoveredRecord_006A2ED0_9EFE711B *)&param_1_after_write->field_0x8b;
