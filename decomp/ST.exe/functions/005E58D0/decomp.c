...

{
  ...
  if (iVar4 == 0) {
    ...
    *(undefined4 *)(DAT_0081176c + 0x140) = 0x1f;
    ...
    puVar6 = (undefined4 *)((int)local_8 + 0x61);
    for (iVar4 = 8; iVar4 != 0; iVar4 = iVar4 + -1) {
      *puVar6 = 0;
      puVar6 = puVar6 + 1;
    }
    *(undefined4 *)((int)local_8 + 0x71) = 0x13;
    *(undefined4 *)((int)local_8 + 0x75) = *(undefined4 *)((int)local_8 + 8);
    ...
    thunk_FUN_005e5d50();
    thunk_FUN_0055ddf0(DAT_0080759c,DAT_008075a8,*(int *)((int)local_8 + 0x5d),10,2);
    this = DAT_00802a30;
    if (DAT_00802a30 != (void *)0x0) {
