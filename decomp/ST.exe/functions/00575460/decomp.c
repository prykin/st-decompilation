...

{
  ...
  if (param_1 != (AnonShape_00575460_06C413C6 *)0x0) {
    ...
    *(undefined4 *)(param_1->field_0451 + 4) = 0;
    ...
    FUN_006ae110((byte *)param_1->field_0451);
...
LAB_0057554f:
  ...
  *(undefined4 *)(*(int *)&pAVar5->field_0x44d + 4) = 0;
  while( true ) {
    iVar2 = *(int *)&pAVar5->field_0x44d;
    uVar3 = *(uint *)(iVar2 + 4);
    if (*(uint *)(iVar2 + 0xc) <= uVar3) break;
    iVar6 = *(int *)(iVar2 + 8) * uVar3 + *(int *)(iVar2 + 0x1c);
    *(uint *)(iVar2 + 4) = uVar3 + 1;
  ...
  FUN_006ae110(*(byte **)&pAVar5->field_0x44d);
  *(undefined4 *)&pAVar5->field_0x44d = 0;
  return;
}
