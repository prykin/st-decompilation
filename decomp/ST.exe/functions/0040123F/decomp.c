...
void __cdecl thunk_FUN_00637d80(uint param_1,int param_2)

{
  ushort *puVar1;
  uint uStack_8;
  
  puVar1 = FUN_00709af0(DAT_00806774,0x1d,(byte *)s_mstarR_007d1c60,0xffffffff,0,1,0,
                        (undefined4 *)0x0);
  if ((puVar1 != (ushort *)0x0) && (DAT_00807598 != (void *)0x0)) {
    ...
    FUN_006ea050(DAT_00807598,uStack_8,2,param_1,param_2);
