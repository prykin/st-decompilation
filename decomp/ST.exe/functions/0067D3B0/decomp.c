...

{
  ...
  if (ppDVar7 == nullptr) {
    local_10 = param_3;
    if (((param_1->field_0x18 == '\x02') && (param_1->field_00C2 != nullptr)) &&
    ...
    *(byte **)(pbVar8 + 0xfe) = pbVar11 + (-0x12a - (int)pbVar8);
    ...
    if (0 < *(int *)(iVar14 + 0xc)) {
      ...
      do {
        ...
        if ((puVar17 != nullptr) && ((byte)puVar17[6] == 0)) {
          uVar19 = puVar13[3];
          puVar22 = puVar15;
    ...
    local_8 = pbVar8;
    do {
      if (*(uint **)(pbVar8 + iVar14 + 0xc2) != nullptr) {
    ...
    if ((((param_1->field_0x18 == '\x02') && (pDVar9 = *local_18, pDVar9 != nullptr)) &&
        (dVar2 = pDVar9->count, dVar2 != 0)) && (local_c != nullptr)) {
      uVar19 = 0;
      if (0 < (int)dVar2) {
        bVar23 = dVar2 != 0;
        do {
          ...
          /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
          if (((*ppvVar18 != nullptr) && (*(char *)((int)*ppvVar18 + 0x18) == '\0')) &&
  ...
  g_currentExceptionFrame = local_5c.previous;
  if (((param_1->field_0x18 == '\x02') && (pDVar9 = param_1->field_00C2, pDVar9 != nullptr))
     && ((dVar2 = pDVar9->count, dVar2 != 0 && (local_c != nullptr)))) {
    if (0 < (int)dVar2) {
      bVar23 = dVar2 != 0;
      do {
