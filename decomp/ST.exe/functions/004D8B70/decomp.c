...

{
  ...
  if ((uVar4 == DAT_0080874d) && (g_money_008016D4 != (MoneyTy *)0x0)) {
    if (g_playerRuntime[uVar4].raceId == 3) {
      ...
      MoneyTy::sub_0052BC30(g_money_008016D4,uVar4,uVar5,uVar6,bVar1,uVar7,iVar2);
      return 0;
    }
    ...
    if (iVar3 < 0) {
      MoneyTy::sub_0052BC30
                (g_money_008016D4,g_playerRuntime[uVar4].field16_0x1f,
                 g_playerRuntime[uVar4].field17_0x23,g_playerRuntime[uVar4].field18_0x27,0xd,0,0);
      return 0;
    }
    ...
    MoneyTy::sub_0052BC30
              (g_money_008016D4,g_playerRuntime[uVar4].field16_0x1f,
               g_playerRuntime[uVar4].field17_0x23,g_playerRuntime[uVar4].field18_0x27,(byte)iVar3,1
               ,0);
  }
  return 0;
}
