...
LAB_00460adb:
                iVar6 = thunk_FUN_00483e30(this,(RecoveredRecord_STBoatC_00482DB0 *)local_20);
                if (iVar6 == 1) {
...
LAB_00460fac:
    ...
    case 7:
    case 8:
      STFishC::sub_004162F0((STFishC *)pSVar7,&local_6,&local_8,(undefined2 *)((int)&param_1 + 2));
