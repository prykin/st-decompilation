...

{
  ...
  if (iVar10 != 0) {
    if (iVar10 == 1) {
      ...
      case 0:
      case 10:
        thunk_FUN_00416270(pSVar8,&local_14,&local_18,(short *)&local_1c);
        ...
        do {
          ...
          sStack_32 = *puVar12;
          local_34 = 0;
          puVar9 = (undefined4 *)thunk_FUN_0041dc40(local_2c,0,0,this->field_006C);
    ...
    if (iVar10 == 2) {
      ...
      if (iVar10 == 3) {
        ...
        if ((this->field_082E == 3) && (iVar10 = GetDefenceTarget(this,CASE_3), iVar10 == 0)) {
          pSVar8 = STAllPlayersC::GetObjPtr
                             (g_allPlayers_007FA174,*(char *)&this->field_0487,
                              *(ushort *)&this->field_048B,this->field_0483);
          /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
    ...
    case 10:
      ...
      if (this->field_02B2 != '\0') {
        ...
        do {
          ...
          sStack_32 = *puVar12;
          local_34 = 0;
          puVar9 = (undefined4 *)thunk_FUN_0041dc40(local_3c,0,0,this->field_006C);
          local_34 = (short)*puVar9;
          sStack_32 = (short)((uint)*puVar9 >> 0x10);
          local_30 = *(undefined2 *)(puVar9 + 1);
          local_64.field_0014 = local_34 + (short)local_14;
...
LAB_00460fac:
    ...
    case 7:
    case 8:
      STFishC::sub_004162F0((STFishC *)pSVar8,&local_6,&local_8,(undefined2 *)((int)&param_1 + 2));
