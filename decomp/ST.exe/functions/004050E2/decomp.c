...

{
  ...
  pcVar5 = (char *)thunk_FUN_00649ff0(&DAT_0080f33a,&iStack_8,(undefined4 *)0x0,(int *)0x0);
  pFVar3 = pFStack_c;
  if (pcVar5 == (char *)0x0) {
    DoLogon(pFStack_c);
    DAT_00858df8 = puStack_90;
  ...
  ccFntTy::WrTxt(*(ccFntTy **)(pFVar3 + 0x1a73),puVar7,iVar4,iVar11,uVar12,iVar13,iVar14);
  ...
  auStack_4c[2] = *(undefined4 *)(pFVar3 + 8);
  auStack_2c[3] = 2;
  auStack_2c[4] = 0x6957;
  auStack_4c[3] = 2;
  auStack_4c[4] = 0x6956;
