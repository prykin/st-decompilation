...
FUN_006d4ff0(void *this,undefined4 param_1,int param_2,undefined4 *param_3,
            RecoveredRecord_006D4FF0_C0FB69E1 *param_4)

{

  Library::Win32::COMSupport::FUN_0074abc4(this,(undefined4 *)&DAT_0079dad0,param_1,param_2);

  FUN_006d5720((void *)((int)this + 0x150),0,(int)this,(int)this + 0x7c,param_3,
               (char *)"Input");

  Library::Win32::COMSupport::FUN_0074b91d((undefined4 *)((int)this + 0x240));
  ...
  *(VTable_0079DB78 **)this = &VTable_0079DB78;
  ...
  Library::Win32::COMSupport::FUN_0074bb83((undefined4 *)((int)this + 0x240));
  ...
  if (DAT_007ee240 < 8) {
    ...
    MessageBoxA(param_4->field_0078,"Need compile \"vidrend.cpp\" with /Zp8 option.","Error",
                0x1010);
