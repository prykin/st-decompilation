...

{
  ...
  if (0 < (int)uVar2) {
    ...
    do {
      pbVar5 = *(byte **)(DAT_00848a34[5] + uVar6 * 4);
      pbVar3 = param_1;
LAB_0067f9ac:
      do {
        bVar1 = *pbVar3;
...
LAB_0067f9e1:
  if ((int)uVar6 < 0) {
    uVar6 = Library::DKW::TBL::FUN_006b5aa0(DAT_00848a34,(char *)param_1);
    local_8 = 0;
    uVar2 = Library::DKW::TBL::FUN_006ae1c0(DAT_00848a30,&local_8);
    if (uVar2 != uVar6) {
