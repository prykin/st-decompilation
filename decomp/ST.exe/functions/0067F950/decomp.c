...

{
  ...
  int uVar3;
  uint uVar5;
  AnonNested_AnonShape_GLOBAL_00848A34_1A834A18_0014_B03F56A9 *pAVar6;
  bool bVar7;
  ...
  if (0 < iVar2) {
    if (iVar2 < 1) {
      pAVar6 = (AnonNested_AnonShape_GLOBAL_00848A34_1A834A18_0014_B03F56A9 *)0x0;
      pbVar3 = param_1;
      goto LAB_0067f9ac;
    }
    do {
      pAVar6 = PTR_00848a34->entries_0014[uVar3];
      pbVar3 = param_1;
LAB_0067f9ac:
      do {
        bVar1 = *pbVar3;
...
LAB_0067f9d0:
        ...
        if (bVar1 != pAVar6->field_0001) goto LAB_0067f9d0;
        pAVar6 = pAVar6 + 1;
        pbVar3 = pbVar3 + 2;
      } while (bVar1 != 0);
      iVar4 = 0;
...
LAB_0067f9e1:
  if (uVar3 < 0) {
    ...
    local_8 = 0;
    uVar5 = Library::DKW::TBL::FUN_006ae1c0(&PTR_00848a30->flags,&local_8);
    if (uVar5 != uVar3) {
