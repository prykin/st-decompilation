...
void thunk_FUN_004a3cd0(int param_1,int param_2,int param_3)

{
  ...
  if (iVar2 == 0) {
      ...
      do {
        ...
        if ((short)uStack_8 != -1) {
          piVar3 = (int *)thunk_FUN_0042b620(CONCAT31((int3)((uint)extraout_EDX >> 8),
                                                      *(undefined1 *)(iStack_2c + 0x24)),uStack_8,1)
          ;
          if (piVar3 == (int *)0x0) {
          ...
          puVar6 = puStack_c;
          if (((iVar2 != 9) &&
              (iVar2 = (**(code **)(*piVar3 + 0x2c))(), puVar6 = puStack_c, iVar2 != 0x15)) &&
             (iVar2 = thunk_FUN_00486b40((int)piVar3), puVar6 = puStack_c, iVar2 != 0)) {
            puVar6 = puStack_20;
          }
          FUN_006ae1c0(puVar6,&uStack_8);
        }
        uVar9 = uVar9 + 1;
      } while ((int)uVar9 < (int)uStack_24);
    }
    puVar6 = puStack_20;
    if (puStack_20[3] == 0) {
      uVar9 = puStack_c[3];
      ...
      if ((uVar9 != 0) && (uVar10 = 0, 0 < (int)uVar9)) {
        do {
          uVar4 = FUN_006acc70((int)puStack_c,uVar10,&uStack_8);
          pvVar5 = (void *)thunk_FUN_0042b620(CONCAT31((int3)(uVar4 >> 8),
                                                       *(undefined1 *)(iStack_2c + 0x24)),uStack_8,1
                                             );
          thunk_FUN_0045ef00(pvVar5,3,&uStack_10);
          uVar10 = uVar10 + 1;
    ...
    puVar6 = thunk_FUN_00440aa0(CONCAT31((int3)((uint)puVar6 >> 8),*(undefined1 *)(iStack_2c + 0x24)
                                        ),param_2,(int)puStack_20);
    puStack_28 = puVar6;
    if (puVar6 == (uint *)0x0) {
    ...
    if (0 < (int)uStack_30) {
      do {
        FUN_006acc70((int)puVar6,uVar9,(undefined4 *)&uStack_38);
        uVar10 = CONCAT22(uStack_34,sStack_36);
        if (sStack_36 == -1) {
          pvVar5 = (void *)thunk_FUN_0042b620(CONCAT31((int3)((uint)extraout_ECX >> 8),
                                                       *(undefined1 *)(iStack_2c + 0x24)),
                                              CONCAT22(0xffff,uStack_38),1);
          thunk_FUN_0045ef00(pvVar5,3,&uStack_10);
        }
        else if (param_1 == 1) {
          pvVar5 = (void *)thunk_FUN_0042b620(CONCAT31((int3)(uVar10 >> 8),
                                                       *(undefined1 *)(iStack_2c + 0x24)),uVar10,1);
          thunk_FUN_004162b0(pvVar5,auStack_1c,auStack_18,auStack_14);
          uStack_40 = auStack_1c[0];
          uStack_3e = auStack_18[0];
          uStack_3c = auStack_14[0];
          pvVar5 = (void *)thunk_FUN_0042b620(CONCAT31((int3)(CONCAT22(extraout_var,auStack_18[0])
                                                             >> 8),*(undefined1 *)(iStack_2c + 0x24)
                                                      ),CONCAT22(sStack_36,uStack_38),1);
          thunk_FUN_0045ef00(pvVar5,4,&uStack_44);
        }
        else {
          pvVar5 = (void *)thunk_FUN_0042b620(CONCAT31((int3)((uint)extraout_EDX_02 >> 8),
                                                       *(undefined1 *)(iStack_2c + 0x24)),uVar10,1);
          uVar7 = thunk_FUN_004162b0(pvVar5,auStack_1c,auStack_18,auStack_14);
          pvVar5 = (void *)thunk_FUN_0042b620(CONCAT31((int3)((uint)uVar7 >> 8),
                                                       *(undefined1 *)(iStack_2c + 0x24)),
                                              CONCAT22(sStack_36,uStack_38),1);
          thunk_FUN_00490a00(pvVar5,auStack_1c[0],auStack_18[0],auStack_14[0]);
        }
        uVar9 = uVar9 + 1;
      } while ((int)uVar9 < (int)uStack_30);
    }
    uVar9 = puStack_c[3];
    uStack_24 = uVar9;
    if ((uVar9 != 0) && (uVar10 = 0, puVar6 = puStack_28, 0 < (int)uVar9)) {
      do {
        FUN_006acc70((int)puStack_c,uVar10,&uStack_8);
