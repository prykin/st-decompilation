...

{
  ...
  if (iVar7 == 0) {
    ...
    Library::Ourlib::ST3DSMAP::SprSetVisible(STField<void *>(param_1,0x211),uVar8,iVar7);
  ...
  FUN_006e6870(STField<void *>(param_1,0x211),iVar9,iVar7);
...
LAB_00587844:
      ...
      iVar7 = FUN_006acf0d((int)STField<short>(param_1,0x41),(int)STField<short>(param_1,0x43)
...
LAB_00587761:
    ...
    iVar7 = STT3DSprC::sub_004ACD30(this,'\b');
    if (pSVar10 == (STGameObjC *)(iVar7 - 1U)) {
      STT3DSprC::StopShow(this,8);
    }
    iVar7 = STT3DSprC::sub_004ACD30(this,'\n');
    if (pSVar10 == (STGameObjC *)(iVar7 - 1U)) {
