...

{
  ...
  if (param_1 == 0) {
    ...
    iVar4 = STT3DSprC::LoadSequence
                      (*(STT3DSprC **)(local_10 + 0x252),0xd,DAT_00806774,(byte *)s_exptem_007cf8cc,
                       0x1d);
    if (iVar4 != 0) {
      return 0xffff;
    }
    iVar4 = STT3DSprC::LoadSequence
                      (*(STT3DSprC **)(local_10 + 0x252),0xf,DAT_00806764,(byte *)s_bulb_n5_007cf8c4
                       ,0x1d);
    if (iVar4 != 0) {
      return 0xffff;
    }
    iVar4 = STT3DSprC::LoadSequence
                      (*(STT3DSprC **)(local_10 + 0x252),0xe,DAT_00806774,
                       (byte *)s_expmask2_007cf8d4,0x1d);
    if (iVar4 != 0) {
      return 0xffff;
    }
    STT3DSprC::StartShow(*(STT3DSprC **)(local_10 + 0x252),0xe,*(undefined4 *)(DAT_00802a38 + 0xe4))
    ;
    uVar12 = 0x53;
    uVar10 = 0x5a;
    iVar4 = 1;
    *(undefined1 *)(local_10 + 0x251) = 1;
    ...
    STT3DSprC::StartShow(*(STT3DSprC **)(local_10 + 0x252),0xd,*(undefined4 *)(DAT_00802a38 + 0xe4))
    ;
    ...
    *(undefined4 *)(local_10 + 0x237) = 0;
    ...
    STT3DSprC::ShowCurFase(*(STT3DSprC **)(local_10 + 0x252),'\r');
    ...
    if (iVar4 == 0) {
      iVar4 = STT3DSprC::LoadSequence
                        (*(STT3DSprC **)(local_10 + 0x252),0xd,DAT_00806774,
      ...
      iVar4 = STT3DSprC::LoadSequence
                        (*(STT3DSprC **)(local_10 + 0x252),0xd,DAT_00806774,(byte *)pcVar9,0x1d);
      if (iVar4 != 0) {
        return 0xffff;
      }
    }
