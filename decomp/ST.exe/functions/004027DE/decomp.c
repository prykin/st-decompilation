...

{
  ...
  if (DAT_0080874d != 0xff) {
    iStack_8 = 4;
    do {
      iVar4 = *(int *)((int)&DAT_007f4f83 + iStack_8 * 0x10 + (uint)bVar3 * 0xa62);
      iVar8 = iStack_8 * 0x10 + (uint)bVar3 * 0xa62;
      if (iVar4 != 0) {
        if (iVar4 == 0x3c) {
          ...
          if (iVar4 != 0) {
            ...
            if (0 < iVar4) {
              do {
                uVar6 = FUN_006acc70(*(int *)((int)&DAT_007f4f83 + iVar8 + 10),uVar10,&uStack_c);
          ...
          iVar4 = FUN_006ad4d0(s_E____titans_wlad_to_allpl_cpp_007a6004,0x10bb,0,0,&DAT_007a4ccc);
          if (iVar4 != 0) {
            pcVar2 = (code *)swi(3);
            (*pcVar2)();
            return;
    ...
    do {
      iVar11 = iStack_8;
      iVar7 = iStack_8 * 0x10 + iVar4;
      iVar1 = *(int *)(iStack_8 * 0x10 + iVar4);
      ...
      if (iVar1 < 0x19b) {
        if (iVar1 == 0x19a) {
          if (*(int *)(iVar7 + 10) != 0) {
            ...
            if (0 < iVar1) {
              do {
                uVar6 = FUN_006acc70(*(int *)(iVar7 + 10),uVar10,&uStack_c);
                piVar5 = (int *)thunk_FUN_0042b620(CONCAT31((int3)(uVar6 >> 8),
                                                            *(undefined1 *)(iVar7 + 4)),uStack_c,1);
...
LAB_00435287:
        iVar7 = FUN_006ad4d0(s_E____titans_wlad_to_allpl_cpp_007a6004,0x10ec,0,0,&DAT_007a4ccc);
