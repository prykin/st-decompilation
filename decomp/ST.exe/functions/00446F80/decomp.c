      ...
      if (local_48 != nullptr) {
        ...
        if (0 < (int)dVar4) {
          do {
            ...
            DArrayGetElement(pDVar5,local_8,&local_c);
      ...
      if (local_1c != nullptr) {
        ...
        if (0 < (int)pDVar5) {
          do {
            ...
            DArrayGetElement(array,local_8,&local_54);
            if (local_4e != 1) {
              local_4e = 1;

              Library::DKW::TBL::DArrayPut(array,local_8,&local_54);
...
LAB_0044738a:
      ...
      local_3c = uVar3;
      pDVar3_mg3 = Library::DKW::TBL::DArrayCreate(nullptr,uVar3,4,1);
      local_8 = 0;
        ...
        do {
          ...
          if (0 < (int)local_1c) {
            do {
              ...
              DArrayGetElement(local_70,local_14,&local_24);
              ...
              if (7 < (int)local_2c) {
                ...
                uVar7 = uVar3;
                if ((int)uVar3 < (int)(uVar3 + local_2c)) {
                  do {

                    local_EAX_1391 = DArrayGetElement(local_74,uVar7,&local_34);
                    if (local_EAX_1391 == -4) break;

                    Library::DKW::TBL::DArrayAppend(local_c,&local_34);
                    uVar7 = uVar7 + 1;
                  } while ((int)uVar7 < (int)(uVar3 + local_2c));
                }
              ...
              if (pDVar3_mg5 != nullptr) {
                ...
                if (0 < (int)pDVar5) {
                  do {
                    ...
                    DArrayGetElement(pDVar3_mg5,uVar3,&local_28);
                    ...
                    if (((iVar2 == 0) ||
                      ...
                      DArrayRemoveAt(pDVar3_mg5,uVar3);
                      uVar3 = uVar3 - 1;
                      local_14 = local_14 - 1;
                ...
                if (pDVar3_mg5->count != 0) {
                  pDVar3_mg5 = Library::DKW::TBL::DArrayCreate(nullptr,local_14,4,1);

                  Library::DKW::TBL::DArrayPut(pDVar3_mg5,uVar3 - 1,&local_44);
                  puVar8 = pDVar3_mg5->data;
                  ...
                  while (local_1c = pDVar5, local_14 = uVar7, local_1c != nullptr) {
                    ...
                    if (0 < (int)uVar7) {
                      do {
                        ...
                        DArrayGetElement(pDVar3_mg5,uVar3,&local_44);
                        if (local_44 != 1) {
                          local_44 = 1;

                          Library::DKW::TBL::DArrayPut(pDVar3_mg5,uVar3,&local_44);

                          DArrayGetElement(local_30,uVar3,&local_28);
                    ...
                    if ((int)uVar3 < (int)local_14) {
                      do {
                        ...
                        if (local_44 != 1) {
                          ...
                          if (((int)(((int)local_38 - (int)local_e ^ uVar7) - uVar7) < 3) &&
                ...
                if (0 < (int)local_1c) {
                  do {
                    if (uVar3 != 0) {
                      ...
                      DArrayGetElement(local_c,local_14,&local_9c);
                      local_2c = (uint)(local_8c * (int)local_30 * 10) / uVar3;
                      uVar3 = uVar3 - local_8c;
                      if (7 < (int)local_2c) {
                        if ((local_2c == 8) || (local_2c == 9)) {
                          local_2c = 10;
                        ...
                        if ((int)uVar7 < (int)(uVar7 + local_2c)) {
                          do {
                            ...
                            uVar6 = uVar6 + 1;
                          } while ((int)uVar6 < (int)(uVar7 + local_2c));
                        }
      ...
      if (local_7c != nullptr) {
        ...
        if (0 < (int)dVar4) {
          do {
            ...
            DArrayGetElement(pDVar5,local_8,&local_78);
            if (local_70 != nullptr) {
              DArrayDestroy(local_70);
              local_70 = Library::DKW::TBL::DArrayCreate(nullptr,1,4,1);

              Library::DKW::TBL::DArrayPut(pDVar5,local_8,&local_78);
            }
            local_8 = local_8 + 1;
          } while ((int)local_8 < (int)dVar4);
        }
      ...
      if (local_60 != nullptr) {
        ...
        if (0 < (int)dVar4) {
          do {
            ...
            DArrayGetElement(pDVar5,local_8,&local_54);
            /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
            ...
            if (local_c != nullptr) {
              ...
              if ((dVar4 != 0) && (uVar3 = 0, 0 < (int)dVar4)) {
                do {
                  ...
                  DArrayGetElement(local_c,uVar3,&local_9c);
                  if (local_88 != nullptr) {
                    DArrayDestroy(local_88);
                  }
                  uVar3 = uVar3 + 1;
...
LAB_00447106:
  do {
    ...
    /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
    DArrayGetElement((DArrayTy *)CONCAT22(uStack_50,uStack_52),local_14,&local_2c);
      ...
      do {
        ...
        if ((((local_4e != 1) &&
            ...
            && (STFishC::sub_004162B0(local_28,&local_38,&local_36,&local_66),
               ...
               (int)(((int)local_38 - (int)local_e ^ uVar3) - uVar3) < 3)) &&
           (uVar3 = (int)local_36 - (int)local_10 >> 0x1f,
           (int)(((int)local_36 - (int)local_10 ^ uVar3) - uVar3) < 3)) {
          local_4e = 1;
