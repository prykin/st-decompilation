...

{
  ...
  if (iVar4 == 0) {
    ...
    local_8d8[8] = (ccFntTy *)this_00->field_1AF4;
    local_8d8[4] = (ccFntTy *)0x147;
    (**(code **)(*(int *)this_00->field_000C + 8))(6,&this_00->field_1AD4,0,local_8d8,0);
    local_8d8[8] = (ccFntTy *)this_00->field_1AF0;
  ...
  g_currentExceptionFrame = local_4c.previous;
  iVar3 = ReportDebugMessage(s_E____titans_Start_fsgs_obj_cpp_007cbf70,0x624,0,iVar4,&DAT_007a4ccc,
  ...
  RaiseInternalException(iVar4,0,s_E____titans_Start_fsgs_obj_cpp_007cbf70,0x624);
  return;
}
