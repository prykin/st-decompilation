...
void __thiscall thunk_FUN_00566970(void *this,int param_1,int param_2)

{
  ...
  if (((*(int *)((int)this + 0x18) != 0) && (iVar2 = *(int *)((int)this + 0x28), iVar2 != 0)) &&
    ...
    case 1:
      ...
      pcVar3 = PTR_s_GM_PEACE_0079b014;
      break;
    case 2:
    ...
    case 3:
      ...
      iVar2 = param_1 + iVar2 * 100;
      pcVar3 = PTR_s_GM_WAR_0079b01c;
      break;
    default:
      goto switchD_005669a6_default;
    }
    puVar4 = (undefined4 *)0x0;
    pCVar1 = FUN_006f2c00(pcVar3,3,iVar2);
    iVar2 = thunk_FUN_0056a2a0(&DAT_00807658,*(uint **)((int)this + 0x18),pCVar1,param_2,puVar4);
    if (iVar2 == 0) {
