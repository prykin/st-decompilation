...
int __thiscall thunk_FUN_0061d8f0(void *this,undefined4 *param_1)

{
  ...
  iStack_c = thunk_FUN_0061d9c0(this,param_1 + 0x24,&iStack_10,1);
  ...
  *(int **)((int)this + 0x57) = piVar2;
  ...
  uVar3 = FUN_006b0060((uint *)0x0,(uint *)((int)piStack_8 + *piVar1 + 4));
