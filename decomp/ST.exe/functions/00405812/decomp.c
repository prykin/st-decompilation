...
void __thiscall
thunk_FUN_004f3a30(void *this,byte param_1,int param_2,byte param_3,char *param_4,UINT param_5,
                  undefined *param_6)

{
  ...
  iStack_c = *piStack_18 - *(int *)((int)this + uVar3 * 4 + 0x3c);
  switch(uVar3) {
  case 1:
  ...
  default:
    if (*(int *)((int)this + 0x130) != 0) {
      iStack_14 = iStack_14 - *(int *)((int)this + uVar3 * 4 + 0x94);
      goto LAB_004f3ac3;
    }
    break;
  case 3:
...
LAB_004f3aaa:
    ...
    iStack_14 = iStack_14 - *(int *)((int)this + 0xc0);
  }
...
LAB_004f3ac3:
  if (param_6 != (undefined *)0x0) {
    ...
    if (iVar5 == 0) {
      puStack_8 = FUN_006f1ce0(param_3,param_4,(int *)0x0,1);
      pvVar4 = pvStack_10;
      iVar5 = iStack_14;
      uVar3 = (uint)param_1;
      thunk_FUN_00540760(*(undefined4 **)((int)pvStack_10 + uVar3 * 4 + 0x180),iStack_c,iStack_14,
                         param_3,(byte *)puStack_8);
      FUN_006f20e0((uint *)&puStack_8);
      FUN_00710a90(*(int *)((int)pvVar4 + uVar3 * 4 + 0x180),0,iStack_c,iVar5,piStack_18[2],
                   piStack_18[3]);
      iVar10 = -1;
      iVar9 = -1;
