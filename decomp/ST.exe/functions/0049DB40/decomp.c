...

{
  ...
  if ((param_1 == 1) || (param_1 == 0)) {
    ...
    if (pSVar2->field_0164 == 1) {
      ...
      if (0 < local_18) {
        if (local_14 == 0) {
          ...
          if (0 < local_18) {
            do {
              FUN_006acc70((AnonShape_006ACC70_C8641025 *)local_10,uVar8,&local_c);
    ...
    if (0 < (int)local_20) {
      do {
        FUN_006acc70((AnonShape_006ACC70_C8641025 *)pSVar2->field_0029,local_2c,&local_c);
        if ((short)local_c != -1) {
          pSVar4 = (STBoatC *)
