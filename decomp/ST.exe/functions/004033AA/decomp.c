...
undefined4 __thiscall thunk_FUN_004ac9e0(void *this,int param_1)
...
LAB_004aca23:
  do {
    if (*(int *)((int)this + 0x14) <= (int)uStack_28) {
      ExceptionList = pvStack_14;
      return 0;
    }
    if ((*(uint *)((int)this + 0x1c) & uStack_20) != 0) {
      iVar5 = uStack_28 * 0x24;
      ...
      if ((*(byte *)(iVar3 + 0xe) & 1) == 0) {
        ...
        *(int *)(iVar3 + 0x1c) = param_1;
        ...
        if (iVar1 != 0) {
          *(undefined4 *)(iVar3 + 0x20) = 0;
          FUN_006e9cb0(*(void **)((int)this + 0x3c),*(uint **)((int)this + 0x18),uStack_28);
        }
        ...
        *(undefined4 *)(piVar4[1] + piVar4[6] * 4) = *(undefined4 *)(piVar4[6] * 4 + 0x31 + *piVar4)
        ...
        if ((iVar7 == 0) || ((*(byte *)(iVar3 + 0xe) & 4) == 0)) {
          iVar3 = thunk_FUN_004ac950(this,uStack_28);
          *(int *)(*(int *)((int)this + 0x20) + 0x18 + iVar5) = iVar3;
          if (uStack_28 == (int)*(char *)((int)this + 0x13)) {
...
LAB_004acb87:
        ...
        FUN_006ea270(*(void **)((int)this + 0x3c),*(uint *)((int)this + 0x18),uStack_28,
