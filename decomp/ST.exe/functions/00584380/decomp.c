...
undefined4 __fastcall FUN_00584380(int *param_1)

{
  ...
  iVar1 = STT3DSprC::LoadSequence(this,8,DAT_00806774,(byte *)s_Expb11_007cb3f8,0x1d);
  if (iVar1 == 0) {
    STT3DSprC::StartShow(this,8,*(undefined4 *)(DAT_00802a38 + 0xe4));
    STT3DSprC::LoadSequence(this,10,DAT_00806774,(byte *)s_expmask3_007cb400,0x1d);
    thunk_FUN_004acfe0(this,'\n');
    thunk_FUN_004acf20(this,DAT_008032b8,0x10);
    STT3DSprC::StartShow(this,10,*(undefined4 *)(DAT_00802a38 + 0xe4));
    (**(code **)(*param_1 + 0xd8))();
    iVar1 = STT3DSprC::LoadSequence(this,9,DAT_00806764,(byte *)s_bulb_n5_007cb40c,0x1d);
    if (iVar1 == 0) {
