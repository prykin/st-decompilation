    ...
    if (0 < (int)uStack_14) {
      do {
        ...
        if ((short)uStack_8 != -1) {
          ...
          iVar3 = (**(code **)(*(int *)pSVar4 + 0xf8))();
          if ((iVar3 != 0) &&
             ((((iVar3 = (**(code **)(*(int *)pSVar4 + 0x2c))(), iVar3 == 7 || (iVar3 == 0x13)) ||
               (iVar3 == 0x1b)) &&
              ((iVar3 = thunk_FUN_0045ff10((int)pSVar4), iVar3 == 0x10 ||
               (uVar7 = STBoatC::CheckPBoxCmd(pSVar4,0x10), uVar7 == 1)))))) {
            iStack_24 = 1;
            break;
          }
        }
