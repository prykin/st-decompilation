  ...
  *(undefined4 *)((int)this + 0x3c) = param_1;
  ...
  if (iVar3 == 0) {
    ...
    if (pcVar4 != (char *)0x0) {
      ...
      pBStack_8 = (BITMAPINFO *)Library::DKW::WGR::FUN_006bc260(pcVar4);
    }
  }
  ...
  if (pBStack_8 != (BITMAPINFO *)0x0) {
    ...
    iVar3 = Library::MSVCRT::__setjmp3(IStack_94.jumpBuffer,0,unaff_EDI,unaff_ESI);
    pCVar2 = pCStack_c;
    if (iVar3 == 0) {
      ...
      pBVar5 = Library::DKW::WGR::FUN_006bbfa0
                         (pBStack_8,(undefined4 *)0x0,*(HPALETTE *)(pCVar2 + 0x3c));
