...

{
  ...
  if (iVar6 == 0) {
    ...
    uVar10 = 3;
    uVar9 = 0x40;
    DAT_00801698 = (SpecPanelTy *)pIStack_10;
    ...
    *(undefined4 **)(this_00 + 0x3d5) = puVar17;
    ...
    iStack_14 = *(int *)(this_00 + 0x3c) + 0x1d;
    iVar13 = 0;
    iVar6 = 1;
    ...
    uStack_18 = 1;
    uStack_3c = uStack_5c;
    (**(code **)(**(int **)(this_00 + 0xc) + 8))(5,(SpecPanelTy *)(this_00 + 0x3d0),0,auStack_6c,0);
