...
LAB_0054b81b:
  ...
  if (-1 < param_1) {
    if (DAT_0080874e == '\x01') {
      pBVar3 = (BITMAPINFO *)
               FUN_0070b3a0((AnonShape_GLOBAL_0081175C_57F682DD *)pCVar1->field_04E3,0);
      iVar4 = pCVar1->field_04DF * -0x1d + 0x115;
      iVar2 = g_nWidth_00806730 + -0x18;
    }
    else if (DAT_0080874e == '\x02') {
      pBVar3 = (BITMAPINFO *)
               FUN_0070b3a0((AnonShape_GLOBAL_0081175C_57F682DD *)pCVar1->field_04E3,2);
      iVar4 = pCVar1->field_04DF * -0x1d + 0x115;
      iVar2 = g_nWidth_00806730 + -0x18;
    }
    else {
      ...
      pBVar3 = (BITMAPINFO *)
               FUN_0070b3a0((AnonShape_GLOBAL_0081175C_57F682DD *)pCVar1->field_04E3,4);
