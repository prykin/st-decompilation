...
LAB_004a35b6:
  ...
  if ((local_2c == (uint *)0x0) || (local_2c[3] == 0)) {
    ...
    if (0 < (int)local_20) {
      do {
        ...
        pSVar4 = (STBoatC *)
                 STAllPlayersC::GetObjPtr
                           (g_sTAllPlayers_007FA174,CONCAT31((int3)(uVar6 >> 8),pSVar2->field_0024),
                            local_8,CASE_1);
        if (param_1 == 1) {
  ...
  puVar7 = STAllPlayersC::_AssignMDPairs
                     (g_sTAllPlayers_007FA174,
                      CONCAT31((int3)((uint)local_28 >> 8),pSVar2->field_0024),pSVar2->field_025E,
                      (int)local_2c,(int)local_28,(int)local_1c);
  local_40 = puVar7;
  if (puVar7 == (uint *)0x0) {
  ...
  if (0 < (int)local_64) {
    do {
      ...
      if (param_1 == 1) {
        ...
        STBoatC::SetNewMD(pSVar4,1,local_c[0],local_14[0],local_10[0],pSVar8->field_0018,
        ...
        pSVar8 = (STFishC *)
                 STAllPlayersC::GetObjPtr
                           (g_sTAllPlayers_007FA174,
                            ...
                            CONCAT22(uStack_38,uStack_3a),CASE_1);
        STFishC::sub_004162B0(pSVar8,local_c,local_14,local_10);
        STBoatC::SetNewMD(pSVar4,0,local_c[0],local_14[0],local_10[0],pSVar8->field_0018,local_32);
      }
      local_20 = local_20 + 1;
      puVar7 = local_40;
  ...
  STAllPlayersC::RegisterPGPair
            (g_sTAllPlayers_007FA174,CONCAT31((int3)(local_64 >> 8),pSVar2->field_0024),local_1c,
             local_24);
  RaiseInternalException
