  ...
  if (0 < (int)local_64) {
    do {
      ...
      if (param_1 == 1) {
        ...
        pSVar9 = STAllPlayersC::GetObjPtr(g_allPlayers_007FA174,pSVar2->field_0024,local_3c,CASE_1);
        ...
        pSVar9 = STAllPlayersC::GetObjPtr(g_allPlayers_007FA174,pSVar2->field_0024,uStack_3a,CASE_1);
        ...
        pSVar3 = STAllPlayersC::GetObjPtr(g_allPlayers_007FA174,pSVar2->field_0024,uStack_38,CASE_1);
        ...
        STBoatC::SetNewMD(pSVar3,1,local_c[0],local_14[0],local_10[0],pSVar9->field_0018,
        ...
        STBoatC::SetNewMD(pSVar3,0,local_c[0],local_14[0],local_10[0],pSVar9->field_0018,local_32);
      }
      local_20 = local_20 + 1;
      pDVar8 = local_40;
