...

{
  ...
  iVar1 = STT3DSprC::LoadSequence((STT3DSprC *)this,8,PTR_00806774,"Expb23",0x1d);
  if (iVar1 == 0) {
    STT3DSprC::StartShow((STT3DSprC *)this,8,g_playSystem_00802A38->field_00E4);
    STT3DSprC::LoadSequence((STT3DSprC *)this,10,PTR_00806774,"expmask2",0x1d);
    ...
    iVar1 = STT3DSprC::LoadSequence((STT3DSprC *)this,9,PTR_00806764,"bulb_n4",0x1d);
    if (iVar1 == 0) {
