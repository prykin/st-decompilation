  ...
  if (DAT_007fa174 != 0) {
    ...
    if (iVar5 == 0) {
      if (param_2 == '\0') {
        ...
        local_40[0x1a1] = (HelpPanelTy)0x3;
      ...
      DrawObj(this_00,&local_8,param_1,(byte)local_20,*(int *)(this_00 + 0x23c));
      ...
      if (local_c != 0) {
        ...
        FUN_006b5440(*(int *)(this_00 + 0x218),0,0xb4,local_8,iVar5,0,0x3a);
        local_3c = 0xb4;
      ...
      if (local_c != 0) {
        ...
        local_14 = FUN_0070b3a0(*(int *)(this_00 + 0x238),0);
        FUN_006b5440(*(int *)(this_00 + 0x218),0,0xb4,local_8,local_14,0,0x3a);
        local_3c = 0xb4;
      ...
      if (local_c != 0) {
        ...
        local_14 = FUN_0070b3a0(*(int *)(this_00 + 0x238),2);
        FUN_006b5440(*(int *)(this_00 + 0x218),0,0xb4,local_8,local_14,0,0x3a);
        local_3c = 0xb4;
        local_34 = *(undefined4 *)(local_14 + 4);
        local_38 = local_8;
