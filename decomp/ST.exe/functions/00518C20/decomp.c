  ...
  if (g_sTAllPlayers_007FA174 != (STAllPlayersC *)0x0) {
    ...
    if (iVar6 == 0) {
      ...
      if (local_c != 0) {
        ...
        iVar14 = -1;
        iVar6 = 1;
        puVar8 = (uint *)FUN_006b0140(local_c,HINSTANCE_00807618);
      ...
      if (local_c != 0) {
        ...
        iVar6 = FUN_0070b3a0(this_00->field_0238,(-(uint)(cVar5 != '\x03') & 0xfffffffe) + 3);
        FUN_006b5440(this_00->field_0218,0,0xb4,local_8,iVar6,0,0x3a);
        local_3c = 0xb4;
      ...
      if (local_c != 0) {
        ...
        local_14 = (AnonShape_00518C20_0B2995D2 *)FUN_0070b3a0(this_00->field_0238,0);
        FUN_006b5440(this_00->field_0218,0,0xb4,local_8,(int)local_14,0,0x3a);
        local_3c = 0xb4;
      ...
      if (local_c != 0) {
        ...
        local_14 = (AnonShape_00518C20_0B2995D2 *)FUN_0070b3a0(this_00->field_0238,2);
        FUN_006b5440(this_00->field_0218,0,0xb4,local_8,(int)local_14,0,0x3a);
        local_3c = 0xb4;
        local_34 = local_14->field_0004;
        local_38 = local_8;
      ...
      do {
        ...
        puVar8 = (uint *)FUN_006b0140(UVar7,pHVar13);
        ccFntTy::WrStr(this_00->field_01E0,puVar8,iVar6,iVar14,uVar10);
        local_8 = local_8 + 0xf;
        uVar10 = thunk_FUN_005276e0(*pGVar3,0);
        pbVar9 = (byte *)FUN_0070b3a0(this_00->field_0230,uVar10);
      ...
      iVar14 = -1;
      iVar6 = 1;
      puVar8 = (uint *)FUN_006b0140(0x5658,HINSTANCE_00807618);
      ccFntTy::WrStr(this_00->field_01E0,puVar8,iVar6,iVar14,uVar10);
      ...
      iVar14 = -1;
      iVar6 = 1;
      puVar8 = (uint *)FUN_006b0140(0x5659,HINSTANCE_00807618);
      ccFntTy::WrStr(this_00->field_01E0,puVar8,iVar6,iVar14,uVar10);
      ccFntTy::SetSurf(this_00->field_01E0,this_00->field_0218,0,0,local_8,0x91,0xf);
      uVar16 = 2;
      iVar15 = -1;
      ...
      pHVar13 = HINSTANCE_00807618;
      iVar6 = FUN_006b0fd0(0x800f10);
      puVar8 = (uint *)FUN_006b0140(0x273f - (iVar6 != 0),pHVar13);
      ...
      iVar14 = -1;
      iVar6 = -3;
      puVar8 = (uint *)FUN_006b0140((cVar5 != '\x03') + 0x273e,HINSTANCE_00807618);
      ccFntTy::WrStr(this_00->field_01E0,puVar8,iVar6,iVar14,uVar16);
      local_8 = local_8 + 0xf;
      if (local_d != '\0') {
        bVar12 = false;
        ...
        iVar14 = -1;
        iVar6 = -3;
        puVar8 = (uint *)FUN_006b0140(0x273f - bVar12,HINSTANCE_00807618);
        ccFntTy::WrStr(this_00->field_01E0,puVar8,iVar6,iVar14,uVar16);
        local_8 = local_8 + 0xf;
      }
      ccFntTy::SetSurf(this_00->field_01E0,this_00->field_0218,0,0x96,local_8,0x106,0xf);
      ...
      iVar14 = -1;
      iVar6 = -3;
      puVar8 = (uint *)FUN_006b0140(0x273f - (local_c != 0),HINSTANCE_00807618);
      ccFntTy::WrStr(this_00->field_01E0,puVar8,iVar6,iVar14,uVar16);
      local_8 = local_8 + 0xf;
      if (local_c != 0) {
        ccFntTy::SetSurf(this_00->field_01E0,this_00->field_0218,0,0x96,local_8,0x106,0xf);
