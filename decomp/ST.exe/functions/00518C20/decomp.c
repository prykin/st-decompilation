  ...
  if (g_allPlayers_007FA174 != nullptr) {
    ...
    if (iVar6 == 0) {
      ...
      if (local_c != 0) {
        ...
        iVar13 = -1;
        iVar6 = 1;
        puVar8 = (uint *)LoadResourceString(local_c,g_hINSTANCE_00807618);
        ccFntTy::WrStr(this_00->field_01E0,puVar8,iVar6,iVar13,uVar15);
        local_8 = local_8 + 0xf;
      }
      ccFntTy::SetSurf(this_00->field_01E0,(int)this_00->field_0218,0,0,local_8,0x91,0xf);
      ...
      if (local_c != 0) {
        ...
        uVar15 = FUN_0070b3a0((AnonShape_GLOBAL_0081175C_57F682DD *)this_00->field_0238,
                              (-(uint)(cVar5 != '\x03') & 0xfffffffe) + 3);
        FUN_006b5440((ushort *)this_00->field_0218,0,0xb4,local_8,uVar15,0,0x3a);
        local_3c = 0xb4;
      ...
      if (local_c != 0) {
        ...
        FUN_006b5440((ushort *)this_00->field_0218,0,0xb4,local_8,(uint)local_14,0,0x3a);
        local_3c = 0xb4;
      ...
      do {
        ...
        puVar8 = (uint *)LoadResourceString(UVar7,pHVar12);
        ccFntTy::WrStr(this_00->field_01E0,puVar8,iVar6,iVar13,uVar15);
        local_8 = local_8 + 0xf;
        uVar15 = thunk_FUN_005276e0(*pGVar3,0);
      ...
      iVar13 = -1;
      iVar6 = 1;
      puVar8 = (uint *)LoadResourceString(0x5658,g_hINSTANCE_00807618);
      ccFntTy::WrStr(this_00->field_01E0,puVar8,iVar6,iVar13,uVar15);
      ...
      iVar13 = -1;
      iVar6 = 1;
      puVar8 = (uint *)LoadResourceString(0x5659,g_hINSTANCE_00807618);
      ccFntTy::WrStr(this_00->field_01E0,puVar8,iVar6,iVar13,uVar15);
      ccFntTy::SetSurf(this_00->field_01E0,(int)this_00->field_0218,0,0,local_8,0x91,0xf);
      uVar15 = 2;
      iVar14 = -1;
      ...
      pHVar12 = g_hINSTANCE_00807618;
      iVar6 = FUN_006b0fd0(0x800f10);
      puVar8 = (uint *)LoadResourceString(0x273f - (iVar6 != 0),pHVar12);
      ...
      iVar13 = -1;
      iVar6 = -3;
      puVar8 = (uint *)LoadResourceString((cVar5 != '\x03') + 0x273e,g_hINSTANCE_00807618);
      ccFntTy::WrStr(this_00->field_01E0,puVar8,iVar6,iVar13,uVar15);
      local_8 = local_8 + 0xf;
      if (local_d != '\0') {
        bVar11 = false;
        ...
        iVar13 = -1;
        iVar6 = -3;
        puVar8 = (uint *)LoadResourceString(0x273f - bVar11,g_hINSTANCE_00807618);
        ccFntTy::WrStr(this_00->field_01E0,puVar8,iVar6,iVar13,uVar15);
        local_8 = local_8 + 0xf;
      }
      ccFntTy::SetSurf(this_00->field_01E0,(int)this_00->field_0218,0,0x96,local_8,0x106,0xf);
      ...
      iVar13 = -1;
      iVar6 = -3;
      puVar8 = (uint *)LoadResourceString(0x273f - (local_c != 0),g_hINSTANCE_00807618);
      ccFntTy::WrStr(this_00->field_01E0,puVar8,iVar6,iVar13,uVar15);
      local_8 = local_8 + 0xf;
      if (local_c != 0) {
        ccFntTy::SetSurf(this_00->field_01E0,(int)this_00->field_0218,0,0x96,local_8,0x106,0xf);
        ...
        uVar15 = FUN_0070b3a0((AnonShape_GLOBAL_0081175C_57F682DD *)this_00->field_0238,
                              (-(uint)(cVar5 != '\x03') & 0xfffffffe) + 3);
        FUN_006b5440((ushort *)this_00->field_0218,0,0x7a,local_8,uVar15,0,0x3a);
        local_3c = 0x7a;
        local_34 = *(undefined4 *)(uVar15 + 4);
        local_38 = local_8;
        local_30 = *(undefined4 *)(uVar15 + 8);
      ...
      UVar7 = thunk_FUN_00523410(param_1,(char)_local_20,2);
    ...
    g_currentExceptionFrame = local_a4.previous;
    iVar13 = ReportDebugMessage("E:\\__titans\\Andrey\\helppan.cpp",0x6f4,0,iVar6,
