...

{
  ...
  if (SVar5 < MESS_SETTMAPSTY_6505) {
    if (SVar5 == MESS_SHARED_6504) {
      ...
      if ((uVar27 != 0xffffffff) && (this_00->field_1F84 != (DArrayTy *)0x0)) {
        ...
        if (DAT_0080877e == '\0') {
          ChgPlList(this_00,message->arg1,2,(uint)bVar21,0);
        }
        else {
          ChangePlayerCiv(this_00,(message->arg1).u32,bVar21);
      ...
      if (SVar5 == MESS_SHARED_6501) {
        ...
        if ((uVar27 != 0xffffffff) && (this_00->field_1F84 != (DArrayTy *)0x0)) {
          ...
          local_c = (AnonShape_005D1400_891386BF *)CONCAT31(local_c._1_3_,bVar21);
          if (DAT_0080877e == '\0') {
            ChgPlList(this_00,message->arg1,5,1,(uint)bVar21);
          }
          else {
            ChangePlayerTeam(this_00,(message->arg1).u32,1,(uint)bVar21);
            SendPlList(this_00,0);
          }
        }
      }
      ...
      local_c = (AnonShape_005D1400_891386BF *)CONCAT31(local_c._1_3_,bVar21);
      if (DAT_0080877e == '\0') {
        ChgPlList(this_00,message->arg1,1,(uint)bVar21,0);
      }
      else {
        ChangePlayerColor(this_00,(message->arg1).u32,bVar21);
        SendPlList(this_00,0);
      }
    }
...
LAB_005d1b5a:
            if (g_cursorClass_00802A30 != (CursorClassTy *)0x0) {
              ...
              CursorClassTy::SetGCType(pCVar12,CASE_0,iVar36,iVar14);
            ...
            if ((this_00->field_1E26 == CASE_7) || (this_00->field_1E26 == 0xe)) {
              ...
              if ((DAT_0080877e != '\0') && (this_00->field_1A5B->field_02E6 != (MMsgTy *)0x0)) {
                ...
                iVar14 = MMsgTy::SetMessage(pSVar7->field_02E6,0x251f,'\x01',local_90,local_b0,
                                            (undefined4 *)0x0,0,0);
                if (iVar14 != 0) {
                    ...
                    if (pAVar30 != (AnonShape_005D1400_891386BF *)0x0) {
                      if (((pAVar30->field_0x4 == '\x02') || (pAVar30->field_0x4 == '\x03')) &&
                        ...
                        Library::DKW::TBL::FUN_006ae1c0
                                  (&this_00->field_222F->flags,&pAVar30->field_0006);
                        Library::DKW::TBL::FUN_006ae1c0
...
LAB_005d1b17:
      ...
      iVar14 = thunk_FUN_005ddb40((int)this_00->field_1A5B);
      if (iVar14 == 0) {
        if (DAT_008067a0 != '\0') {
  ...
  if (SVar5 < MESS_SETTMAPMTY_654A) {
    ...
    case MESS_SETTMAPSTY_6505:
      ...
      if ((uVar27 != 0xffffffff) && (this_00->field_1F84 != (DArrayTy *)0x0)) {
        ...
        if (DAT_0080877e == '\0') {
          ChgPlList(this_00,message->arg1,3,*(undefined4 *)((int)pvVar16 + 0x104),
          ...
          ChangePlayerList(this_00,DAT_0080877f,(message->arg1).u32,*(int *)((int)pvVar16 + 0x104),
...
switchD_005d1877_caseD_6507:
  ...
  if (((0x69fe < SVar5) && (SVar5 < MESS_SHARED_6A7F)) && (this_00->field_0065 == '\x01')) {
    ...
    if ((pDVar18 == (DArrayTy *)0x0) ||
       (uVar27 = local_2c + this_00->field_1F88, pDVar18->count <= uVar27)) {
      ...
      case MESS_ID_NONE:
        if ((pAVar24->field_0x4 == '\x02') && (*(int *)&pAVar24->field_0x6 == DAT_0080877f)) {
          if (DAT_0080877e == '\0') {
            uVar28 = 0;
            uVar27 = 0;
            iVar14 = this_00->field_1F88 + local_2c;
            uVar37 = 0;
            goto LAB_005d34ee;
          }
          ...
          if (0 < (int)uVar27) {
            ...
            do {
              if (bVar34) {
                ...
                pcVar26 = (char *)(this_00->field_1F84->elementSize * uVar28 +
...
LAB_005d3188:
      ...
      case MESS_SHARED_0003:
        ...
        if (*(char *)pAVar24 == '\0') {
          uVar27 = local_2c + this_00->field_1F88;
          local_5 = '\0';
          if (-1 < (int)uVar27) {
            pDVar18 = this_00->field_1F84;
            do {
          ...
          if ((this_00->field_1E26 != CASE_5) || (pAVar24->field_0x4 != '\x04')) {
          ...
          if (DAT_00808a8f == '\0') {
            ...
            if (0 < (int)uVar27) {
              ...
              do {
                if (bVar34) {
                  /* ST_PSEUDO[dynamic_array_indexing]: expected DArrayAt<T>(array, index) (runtime elementSize cannot be a static C array) */
                  pvVar16 = (void *)(this_00->field_1F84->elementSize * uVar28 +
                                    (int)this_00->field_1F84->data);
                }
                else {
                  pvVar16 = (void *)0x0;
...
joined_r0x005d3229:
            ...
            if (0 < (int)uVar27) {
              do {
                ...
                if (uVar25 < local_30) {
                  /* ST_PSEUDO[dynamic_array_indexing]: expected DArrayAt<T>(array, index) (runtime elementSize cannot be a static C array) */
                  pcVar26 = (char *)(this_00->field_1F84->elementSize * uVar25 +
                                    (int)this_00->field_1F84->data);
                }
                else {
                  pcVar26 = (char *)0x0;
                ...
                if (pcVar26 != (char *)0x0) {
                  if (this_00->field_1F88 + uVar28 != uVar25) {
...
LAB_005d32d3:
            ...
            do {
              ...
              if (puVar17[uVar27 + 0x41] != '\0') {
                ...
                wsprintfA(&this_00->field_0x1e33,"%s%c",pcVar26,iVar14);
                this_00->field_1F37 = uVar27;
                Library::DKW::TBL::FUN_006ae1c0
                          (&this_00->field_1E2F->flags,(undefined4 *)&this_00->field_0x1e33);
      ...
      case 7:
        if (DAT_0080877e == '\0') {
          ...
          uVar37 = 7;
LAB_005d34ee:
          ChgPlList(this_00,iVar14,uVar37,uVar27,uVar28);
        }
        else {
  ...
  local_24 = 0;
  if ((pDVar18 != (DArrayTy *)0x0) &&
     (uVar27 = this_00->field_1F88 + (int)pcVar26, uVar27 < pDVar18->count)) {
    /* ST_PSEUDO[dynamic_array_indexing]: expected DArrayAt<T>(pDVar18, uVar27) (runtime stride) */
    pAVar32 = (AnonShape_005CBBE0_2D1CAA09 *)(pDVar18->elementSize * uVar27 + (int)pDVar18->data);
  }
  local_10 = pcVar26;
  FUN_006b4170((AnonShape_006B5B10_E0D06CF1 *)this_00->field_20CC[(int)pcVar26 + 10],0,
  ...
  case (undefined1 *)0x0:
    ...
    MMObjTy::PaintButDib
              ((MMObjTy *)this_00,this_00->field_20CC[(int)pcVar26 + 10],&local_28,2,
  ...
  case (undefined1 *)0x1:
    if (*(char *)pAVar32 != '\0') {
      ...
      local_1c = local_1c + -2;
      MMObjTy::PaintButDib
                ((MMObjTy *)this_00,this_00->field_20CC[(int)pcVar26 + 10],&local_28,0,
      ...
      if (pAVar32->field_0x2 != -1) {
        ...
        FUN_006b4170((AnonShape_006B5B10_E0D06CF1 *)this_00->field_20CC[(int)pcVar26 + 10],0,
                     local_28 + 2,local_24 + 2,local_20 + -4,local_1c + -4,bVar21);
      }
    }
    break;
  case (undefined1 *)0x2:
    ...
    MMObjTy::PaintButDib
              ((MMObjTy *)this_00,this_00->field_20CC[(int)pcVar26 + 10],&local_28,2,
               (-((message->arg0).words.low != 0) & 0xfcU) + 0x23,0x67);
    ccFntTy::SetSurf(g_startSystem_0081176C->field_0034,this_00->field_20CC[(int)pcVar26 + 10],0,
...
LAB_005d3780:
  ...
  case (undefined1 *)0x3:
    ...
    iVar14 = local_20;
    puVar15 = (uint *)thunk_FUN_005cbbe0(this_00,pAVar32);
    goto LAB_005d38bd;
  case (undefined1 *)0x4:
    MMObjTy::PaintButDib
              ((MMObjTy *)this_00,this_00->field_20CC[(int)pcVar26 + 10],&local_28,2,0x67,0x67);
    ...
    if (bVar21 < 4) {
      ...
      ccFntTy::WrStr(g_startSystem_0081176C->field_0034,puVar15,iVar14,iVar36,uVar27);
      break;
    }
    if (bVar21 != 4) break;
...
LAB_005d38bd:
  ...
  case (undefined1 *)0x5:
    ...
    iVar14 = iVar14 + -1;
    if (iVar14 < 0) break;
    pAVar22 = (AnonShape_GLOBAL_0081175C_57F682DD *)this_00->field_1F4B;
    goto LAB_005d3bfa;
  case (undefined1 *)0x6:
    MMObjTy::PaintButDib
              ((MMObjTy *)this_00,this_00->field_20CC[(int)pcVar26 + 10],&local_28,2,0x67,0x67);
  ...
  case (undefined1 *)0x7:
    ...
    iVar14 = 0;
LAB_005d3bf4:
    pAVar22 = (AnonShape_GLOBAL_0081175C_57F682DD *)this_00->field_1F4F;
LAB_005d3bfa:
    pbVar20 = (byte *)FUN_0070b3a0(pAVar22,iVar14);
    DibPut((AnonShape_006B5B10_E0D06CF1 *)this_00->field_20CC[(int)pcVar26 + 10],
