    ...
    if (SVar5 == MESS_SHARED_6504) {
      ...
      if (SVar5 == MESS_SETTMAPMTY_6340) {
        ...
        if (SVar5 == MESS_SHARED_6326) {
          this_01->field_0x2208 = '\x02' - *(char *)(message->arg0).ptr;
        }
        else if (SVar5 == MESS_ID_CREATE) {
          *(DWORD *)&this_01->field_0x2209 = this_01->field_0061;
        }
        else if (SVar5 == MESS_SHARED_0003) {
          if (*(int *)&this_01->field_0x2226 != 0) {
            FreeAndNull((void **)&this_01->field_0x2226);
            *(undefined4 *)&this_01->field_0x222a = 0;
          }
          if (*(DArrayTy **)&this_01->field_0x222f != (DArrayTy *)0x0) {
            DArrayDestroy(*(DArrayTy **)&this_01->field_0x222f);
          }
          *(undefined4 *)&this_01->field_0x222f = 0;
        ...
        thunk_FUN_005b5f00(this_01,*(AnonShape_006B5B10_E0D06CF1 **)&this_01->field_0x2204,piVar9);
        iVar14 = *piVar9;
        local_10 = (char *)piVar9[5];
        ccFntTy::SetSurf(PTR_0081176c->field_0034,*(int *)&this_01->field_0x2204,0,
                         (iVar14 + -1) * (int)local_10,0,(int)local_10,
                         *(int *)(*(int *)&this_01->field_0x2204 + 8) -
        ...
        FUN_006b35d0(DAT_008075a8,*(uint *)&this_01->field_0x2200);
      }
    }
...
LAB_005d1b5a:
            if (PTR_00802a30 != (CursorClassTy *)0x0) {
              iVar14 = PTR_00802a30->field_00C9;
              iVar36 = PTR_00802a30->field_00C5;
...
LAB_005d24b8:
                ...
                *(undefined2 *)puVar31 = 0;
                ...
                FUN_006b6500(g_int_00811764,DAT_0080733c);
                *(DWORD *)&this_01->field_0x2233 = this_01->field_0061;
                this_01->field_0x222e = 1;
                puVar15 = Library::DKW::TBL::FUN_006ae290((uint *)0x0,0x28,4,10);
                *(uint **)&this_01->field_0x222f = puVar15;
                    ...
                    if (pAVar30 != (AnonShape_005D1400_891386BF *)0x0) {
                      if (((pAVar30->field_0x4 == '\x02') || (pAVar30->field_0x4 == '\x03')) &&
                        ...
                        Library::DKW::TBL::FUN_006ae1c0
                                  (*(uint **)&this_01->field_0x222f,&pAVar30->field_0006);
...
LAB_005d22dd:
                ...
                /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
                if (*(int *)(*(int *)&this_01->field_0x222f + 0xc) == 0) {
                  this_01->field_0x222e = 0;
                  RunGame((SettMapMTy *)this_01);
                  if (DAT_008067a0 != '\0') {
...
LAB_005d3188:
      ...
      case MESS_ID_CREATE:
        if (*(char *)pAVar24 != '\0') {
          ...
          this_01->field_1E2F->count = 0;
          local_10 = (char *)0x1;
          pcVar26 = LoadResourceString(0x23f1,HINSTANCE_00807618);
          uVar27 = 0xffffffff;
          do {
            pcVar23 = pcVar26;
            if (uVar27 == 0) break;
          ...
          Library::DKW::TBL::FUN_006ae1c0
                    (&this_01->field_1E2F->flags,(undefined4 *)&this_01->field_0x1e33);
          pcVar26 = LoadResourceString(0x23f0,HINSTANCE_00807618);
          uVar27 = 0xffffffff;
          do {
            pcVar23 = pcVar26;
            if (uVar27 == 0) break;
          ...
          if (pcVar26 != (char *)0x0) {
            pcVar26 = LoadResourceString(0x23f2,HINSTANCE_00807618);
            uVar27 = 0xffffffff;
            do {
              pcVar23 = pcVar26;
              if (uVar27 == 0) break;
      ...
      case MESS_SHARED_0003:
        ...
        if (*(char *)pAVar24 == '\0') {
          ...
          if (local_5 != '\0') {
            pcVar26 = LoadResourceString(0x1f42,HINSTANCE_00807618);
            uVar27 = 0xffffffff;
            do {
              pcVar23 = pcVar26;
              if (uVar27 == 0) break;
            ...
            Library::DKW::TBL::FUN_006ae1c0
                      (&this_01->field_1E2F->flags,(undefined4 *)&this_01->field_0x1e33);
            if (DAT_00808aaa != '\0') {
              pcVar26 = LoadResourceString(0x1f46,HINSTANCE_00807618);
              uVar27 = 0xffffffff;
              do {
                pcVar23 = pcVar26;
                if (uVar27 == 0) break;
          ...
          pcVar26 = LoadResourceString(0x1f41,HINSTANCE_00807618);
          uVar27 = 0xffffffff;
          do {
            pcVar23 = pcVar26;
            if (uVar27 == 0) break;
          ...
          if ((this_01->field_1E26 != CASE_5) || (pAVar24->field_0x4 != '\x04')) {
            if ((DAT_0080877e != '\0') && (this_01->field_1E26 != CASE_5)) {
              pcVar26 = LoadResourceString(8000,HINSTANCE_00807618);
              uVar27 = 0xffffffff;
              do {
                pcVar23 = pcVar26;
                if (uVar27 == 0) break;
...
LAB_005d32d3:
            ...
            do {
              ...
              if (puVar17[uVar27 + 0x41] != '\0') {
                pcVar26 = LoadResourceString(0x1f4a,HINSTANCE_00807618);
...
LAB_005d38bd:
  ...
  case (undefined1 *)0x5:
    ...
    if (DAT_00808a8f != '\0') {
      ...
      pcVar23 = LoadResourceString(0x1f4a,HINSTANCE_00807618);
