...
LAB_00552481:
    ...
    if (uVar9 < 0xb200) {
      if (uVar9 == 0xb1ff) {
        ...
        uStack_15 = (uint)*(ushort *)(&this_00->field_0x1bc + (uint)bVar11 * 2);
        if (this_00->field_01BB == '\0') {
          uVar1 = *(undefined2 *)((int)&this_00->field_01AB + (uint)bVar11 * 8 + 2);
      ...
      if (uVar9 == 0xb200) {
        iVar3 = this_00->field_0000;
        iVar8 = (-(uint)(this_00->field_01BB != '\0') & 0xfffffffe) + 0x2753;
        goto LAB_00552481;
      }
      if (uVar9 == 0xb201) {
        bVar11 = this_00->field_01D0;
        ...
        local_24 = 3;
        uStack_21 = (uint)*(ushort *)(&this_00->field_0x1bc + (uint)bVar11 * 2);
