...

{
  ...
  if (param_1 != 0) {
    pSVar1 = pSStack_1c + 0x2f4;
    if (*(int *)(pSStack_1c + 0x2f4) != 0) {
...
LAB_005dc22d:
      ...
      *(undefined1 *)puVar6 = DAT_007cc854;
      puStack_14 = ccFntTy::FormIndentSarr
                              ...
                              *(int *)(*(int *)(pSVar3 + 0x544) + 4) + -0x14,0,0xffffffff,
                              (char *)0x0,1);
      ...
      *(uint **)(pSVar3 + 0x548) = puVar7;
      ...
      if (puStack_14 != (uint *)0x0) {
        if (puStack_14[2] != 0) {
          ccFntTy::SepColorStrInSarr(*(ccFntTy **)(pSVar3 + 0x34),puStack_14,puStack_14);
        }
        iVar4 = 0;
        if (0 < (int)puVar7[2]) {
          if ((int)puVar7[2] < 1) {
...
LAB_005dc430:
      ...
      uStack_2c = 0x28;
      uStack_28 = CONCAT22(*(undefined2 *)(*(int *)(pSVar3 + 0x548) + 8),1);
      if (*(int *)(pSVar3 + 0x389) != 0) {
        FUN_006e5970(2,*(int *)(pSVar3 + 0x389),(int)auStack_3c);
      }
      uStack_2c = 0x22;
      uStack_28 = 0;
      if (*(int *)(pSVar3 + 0x389) != 0) {
