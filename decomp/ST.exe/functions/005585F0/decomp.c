    ...
    *(undefined4 *)(local_14 + 0x100) = *(undefined4 *)(param_1 + 0x4c);
    if (*(int *)(local_14 + 0x114) != 0) {
      ...
      do {
        ...
        *local_c = puVar4;
        uVar7 = *(int *)(local_14 + 0x2c) * *(int *)(local_14 + 0x28);
        local_c = local_c + 1;
        puVar8 = local_8;
      ...
      puVar5 = FUN_006aac10(*(int *)(local_14 + 0x20) * *(int *)(local_14 + 0x24) * 2);
      *(undefined4 **)(local_14 + 0x38) = puVar5;
      puVar5 = FUN_006aac10(*(int *)(local_14 + 0x30) * *(int *)(local_14 + 0x34));
      *(undefined4 **)(local_14 + 0x4c) = puVar5;
      puVar5 = FUN_006aac10(*(int *)(local_14 + 0x30) * *(int *)(local_14 + 0x34) * 2);
      *(undefined4 **)(local_14 + 0x50) = puVar5;
      uVar6 = FUN_006b0060((uint *)0x0,puVar8);
      *(undefined4 *)(local_14 + 0xf4) = uVar6;
      uVar6 = FUN_006b0060((uint *)0x0,(uint *)((int)puVar8 + *(int *)(param_1 + 0x38)));
      *(undefined4 *)(local_14 + 0x110) = uVar6;
    }
