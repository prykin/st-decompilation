...

{
  ...
  if (iVar5 != 0) {
    ...
    iVar11 = FUN_006ad4d0(s_E____titans_Andrey_cpanel_cpp_007c1bd8,0x2c9,0,iVar5,&DAT_007a4ccc);
    if (iVar11 == 0) {
      FUN_006a5e40(iVar5,0,0x7c1bd8,0x2c9);
      return;
    }
    pcVar1 = (code *)swi(3);
    (*pcVar1)();
  ...
  do {
    ...
    pCStack_10 = this_00 + uVar14 + 0x2ec;
    ...
    case (CPanelTy)0x1:
      if ((DAT_0080731a != 0) &&
        ...
        *(int *)(this_00 + uVar14 * 4 + 0x2ee) = *(int *)(this_00 + 0x38);
        ...
        thunk_FUN_004f1890(this_00,(byte)uStack_c);
...
joined_r0x004f81d1:
    ...
    case (CPanelTy)0x3:
      if (0x31 < (uint)(*(int *)(this_00 + 0x38) - *(int *)(this_00 + uVar14 * 4 + 0x2ee))) {
        ...
        *(int *)(this_00 + uVar14 * 4 + 0x2ee) = *(int *)(this_00 + 0x38);
        ...
        thunk_FUN_004f1890(this_00,(byte)uStack_c);
        bVar12 = -((char)uStack_c != '\0');
        pCStack_1c = (CPanelTy *)(CONCAT31(pCStack_1c._1_3_,bVar12) & 0xffffff08);
        if ((bVar12 & 8) < 0xb) {
          uVar14 = bVar12 & 8;
    ...
    case (CPanelTy)0x4:
      if (0x31 < (uint)(*(int *)(this_00 + 0x38) - *(int *)(this_00 + uVar14 * 4 + 0x2ee))) {
        ...
        *pCVar13 = (CPanelTy)((char)CVar2 + 1U);
        ...
        thunk_FUN_004f1890(this_00,(byte)uStack_c);
        bVar12 = -((char)uStack_c != '\0');
        pCStack_20 = (CPanelTy *)(CONCAT31(pCStack_20._1_3_,bVar12) & 0xffffff08);
        if ((bVar12 & 8) < 0xb) {
          uVar6 = bVar12 & 8;
          uVar14 = *(uint *)(this_00 + uVar6 * 4 + 0x148);
    ...
    case (CPanelTy)0x5:
      if (0x41 < (uint)(*(int *)(this_00 + 0x38) - *(int *)(this_00 + uVar14 * 4 + 0x2ee))) {
        ...
        *(int *)(this_00 + uVar14 * 4 + 0x2ee) = *(int *)(this_00 + 0x38);
        CVar2 = *pCVar13;
        *pCVar13 = (CPanelTy)((char)CVar2 + 1U);
        pCStack_18 = this_00 + uVar14 * 4 + 0x2e2;
        if (**(short **)pCStack_18 <= (short)(ushort)(byte)((char)CVar2 + 1U)) {
          puVar8 = FUN_00709af0(DAT_00806794,0x1f,*(byte **)(this_00 + uVar14 * 4 + 0x2f6),6,0,1,0,
                                (undefined4 *)0x0);
          *(ushort **)pCStack_18 = puVar8;
          *pCStack_10 = (CPanelTy)0x1;
          *pCVar13 = (CPanelTy)0x0;
        }
        thunk_FUN_004f1890(this_00,(byte)uStack_c);
        bVar12 = -((char)uStack_c != '\0');
        pCStack_14 = (CPanelTy *)(CONCAT31(pCStack_14._1_3_,bVar12) & 0xffffff08);
        if ((bVar12 & 8) < 0xb) {
          uVar6 = bVar12 & 8;
          uVar14 = *(uint *)(this_00 + uVar6 * 4 + 0x148);
          goto joined_r0x004f81d1;
  ...
  pCStack_10 = (CPanelTy *)((uint)pCStack_10 & 0xffffff00);
  if (bStack_5 != 0) {
    pCStack_18 = this_00 + 0xd3b;
    pCStack_20 = this_00 + 0xc87;
    pCStack_1c = this_00 + 0xd53;
    do {
      uStack_c = uStack_c & 0xffffff00;
        ...
        if (CVar2 == (CPanelTy)0x1) {
          if ((DAT_0080731a != 0) && (0x41 < (uint)(*(int *)(this_00 + 0x38) - *(int *)pCVar13))) {
            ...
            *pCVar15 = (CPanelTy)((char)CVar2 + 1U);
            ...
            thunk_FUN_004f1c80(this_00,uStack_c,(uint)pCStack_10);
          ...
          if (0x31 < (uint)(*(int *)(this_00 + 0x38) - *(int *)pCVar13)) {
            *(int *)pCVar13 = *(int *)(this_00 + 0x38);
            if (*pCVar15 == (CPanelTy)0x0) {
              ...
              bVar12 = 0;
              uVar14 = 6;
              pbVar7 = (byte *)thunk_FUN_004f1d20(pCStack_14);
...
joined_r0x004f861b:
        ...
        bVar12 = (char)uStack_c + 1;
        pCStack_14 = pCStack_14 + 0x42;
        pCVar13 = pCVar13 + 0x18;
        pCVar15 = pCVar15 + 6;
        uStack_c = CONCAT31(uStack_c._1_3_,bVar12);
      } while (bVar12 < 2);
      bVar12 = (char)pCStack_10 + 1;
      pCStack_18 = pCStack_18 + 1;
      pCStack_1c = pCStack_1c + 4;
      pCStack_20 = pCStack_20 + 0xb;
      pCStack_10 = (CPanelTy *)CONCAT31(pCStack_10._1_3_,bVar12);
