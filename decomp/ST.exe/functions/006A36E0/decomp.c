...
undefined4 __cdecl
FUN_006a36e0(int *param_1,int param_2,int param_3,int param_4,undefined *param_5,undefined4 param_6)

{
  ...
  if ((((-1 < param_2) && (param_2 < *param_1)) && (-1 < param_3)) &&
    ...
    if (iVar1 != 0) {
      thunk_FUN_006a1370(param_1,param_2,param_3,param_4,(undefined4 *)local_c);
