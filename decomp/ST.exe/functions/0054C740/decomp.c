...

{
  ...
  if (errorCode == 0) {
    ...
    (*g_playSystem_00802A38->vtable->vfunc_08)
              (g_playSystem_00802A38,0x1100,0,&g_allPlayers_007FA174,0,0);
    (*g_playSystem_00802A38->vtable->vfunc_08)(g_playSystem_00802A38,0x109,0,0,0,0);
    (*g_playSystem_00802A38->vtable->vfunc_08)(g_playSystem_00802A38,0x121,0,0,0,0);
    (*g_playSystem_00802A38->vtable->vfunc_08)(g_playSystem_00802A38,0x143,&DAT_00811794,0,0,0);
    (*g_playSystem_00802A38->vtable->vfunc_08)(g_playSystem_00802A38,0x145,&DAT_008117a0,0,0,0);
    (*g_playSystem_00802A38->vtable->vfunc_08)(g_playSystem_00802A38,0x146,&DAT_008117ac,0,0,0);
    (*g_playSystem_00802A38->vtable->vfunc_08)(g_playSystem_00802A38,0x15b,&DAT_00811780,0,0,0);
    thunk_FUN_0058d6f0();
    if (DAT_0080879c == 0) {
      bVar3 = 0;
