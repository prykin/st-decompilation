...

{
  ...
  int iVar14;
  undefined4 *puVar15;
  InternalExceptionFrame IStack_1c8;
  uint auStack_184 [4];
  ...
  IStack_1c8.previous = g_currentExceptionFrame;
  g_currentExceptionFrame = &IStack_1c8;
  pIStack_8 = this;
  iVar4 = Library::MSVCRT::__setjmp3(IStack_1c8.jumpBuffer,0,unaff_EDI,unaff_ESI);
  pIVar3 = pIStack_8;
  if (iVar4 == 0) {
    if (DAT_0080874e == '\x01') {
    ...
    *(undefined4 *)(iVar4 + 0x5c) = 0;
    ...
    g_currentExceptionFrame = IStack_1c8.previous;
    return 0;
  }
  g_currentExceptionFrame = IStack_1c8.previous;
