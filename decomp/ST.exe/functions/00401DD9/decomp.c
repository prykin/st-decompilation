...
bool __thiscall thunk_FUN_00495420(void *this,short *param_1,short *param_2,short *param_3)

{
  ...
  if (*(int *)((int)this + 0x6b9) != 1) {
    ...
    if ((((-1 < sVar6) && (sVar6 < DAT_007fb240)) && (-1 < sVar1)) &&
       (((sVar1 < DAT_007fb242 && (-1 < sVar4)) &&
        ((sVar4 < DAT_007fb244 &&
...
LAB_00495607:
  ...
  do {
    ...
    do {
      ...
      sVar4 = (short)iStack_8;
      sVar3 = *(short *)((int)this + 0x6a9) + sVar4;
      if (((((sVar3 < 0) || (DAT_007fb240 <= sVar3)) || (sVar7 < 0)) ||
          ((DAT_007fb242 <= sVar7 || (sVar1 < 0)))) ||
         ((DAT_007fb244 <= sVar1 ||
          (pvVar2 = *(void **)(DAT_007fb248 +
                              ((int)DAT_007fb246 * (int)sVar1 + (int)DAT_007fb240 * (int)sVar7 +
                              (int)sVar3) * 8), pvVar2 == (void *)0x0)))) {
        iVar5 = FUN_006aadd0((int)*(short *)((int)this + 0x47),(int)*(short *)((int)this + 0x49),
                             (int)*(short *)((int)this + 0x4b),
                             *(short *)((int)this + 0x6a9) + iStack_8,
