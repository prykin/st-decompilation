...
FUN_00636260(void *this,uint param_1,int param_2,int param_3,int param_4,int param_5,int param_6,
            int param_7)
...
LAB_006362c5:
  ...
  *(uint **)((int)this + 0x2c) = puVar2;
  if ((puVar2 != (uint *)0x0) && (0 < param_4)) {
    ...
    *(undefined2 *)puVar5 = 0;
    FUN_006ae140(puVar2,param_5 * param_6 - 1,local_50);
    param_1 = 0;
      ...
      do {
        ...
        if (0 < param_6) {
          ...
          do {
            ...
            *piVar4 = param_7;
            if (*(int *)((int)local_8 + 0x28) == 0) {
              piVar4[1] = -1;
            }
            else {
              uVar3 = thunk_FUN_006364b0(*(int *)((int)local_8 + 4));
              piVar4[1] = uVar3;
            }
