...

{
  ...
  pDVar1 = g_playerRuntime[*(int *)(param_1 + 0x24)].field2167_0x9da;
  local_8 = param_1;
  if (pDVar1 != (DArrayTy *)0x0) {
      ...
      do {
        ...
        if (local_8 == param_1) {
          FUN_006b0c70((AnonShape_006B0C70_7C4FE646 *)
                       g_playerRuntime[*(int *)(param_1 + 0x24)].field2167_0x9da,uVar2);
          break;
        }
        uVar2 = uVar2 + 1;
        pDVar1 = g_playerRuntime[*(int *)(param_1 + 0x24)].field2167_0x9da;
    ...
    if ((g_playerRuntime[*(int *)(param_1 + 0x24)].field2167_0x9da)->count == 0) {
      FUN_006ae110((byte *)g_playerRuntime[*(int *)(param_1 + 0x24)].field2167_0x9da);
