...
LAB_004e63ab:
        if ((*(int *)((int)&DAT_007f5147 + *(uint *)(iVar8 + (int)piVar4) * 4 + iVar10) ==
           ...
           (iVar7 = 0, *(int *)(local_10 + (int)piVar4) != 0)) {
...
LAB_004e645f:
      if (*(int *)(&DAT_007f57ee + iVar10) != 0) {
        *(undefined4 *)(*(int *)(&DAT_007f57ee + iVar10) + 4) = 0;
        iVar8 = FUN_006b1190(*(int *)(&DAT_007f57ee + iVar10),&local_c);
        while (-1 < iVar8) {
      ...
      if (((((param_2 == 0x1d) || (param_2 == 0x89)) || (param_2 == 0x46)) ||
        ...
        do {
          FUN_006acc70(iVar8,uVar9,&local_8);
          if ((local_8 != (int *)0x0) &&
             (((iVar8 = (**(code **)(*local_8 + 0x2c))(), iVar8 == 0x36 ||
               (iVar8 = (**(code **)(*local_8 + 0x2c))(), iVar8 == 0x5d)) ||
              (iVar8 = (**(code **)(*local_8 + 0x2c))(), iVar8 == 0x3d)))) {
      ...
      if ((((((param_2 == 0x3c) || (param_2 == 0x91)) || (param_2 == 0x9a)) ||
        ...
        do {
          FUN_006acc70(iVar8,uVar9,&local_8);
          if ((local_8 != (int *)0x0) &&
             (((iVar8 = (**(code **)(*local_8 + 0x2c))(), iVar8 == 5 ||
               (iVar8 = (**(code **)(*local_8 + 0x2c))(), iVar8 == 0x21)) ||
              (iVar8 = (**(code **)(*local_8 + 0x2c))(), iVar8 == 0x11)))) {
            thunk_FUN_00494ae0((int)local_8);
          }
          iVar8 = *(int *)((int)&DAT_007f4e29 + iVar10);
          uVar9 = uVar9 + 1;
        } while (uVar9 < *(uint *)(iVar8 + 0xc));
