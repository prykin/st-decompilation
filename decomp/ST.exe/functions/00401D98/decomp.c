...
void __thiscall thunk_FUN_0056aa00(void *this,byte param_1,char param_2)
        ...
        if (param_1 == *(byte *)((int)this + 0x112d)) {
          ...
          do {
            if (((pcVar3[-1] != -1) && (bVar2 != param_1)) && (*pcVar1 == *pcVar3)) {
              thunk_FUN_0055b7f0(DAT_00802a88,0,puStack_8);
            }
            bVar2 = bVar2 + 1;
          ...
          thunk_FUN_0055b7f0(DAT_00802a88,0,puVar4);
        }
      }
      *pcVar1 = param_2;
      if ((DAT_00802a88 != (void *)0x0) && (*(char *)((int)this + 0x1474) != '\0')) {
        if (param_1 == *(byte *)((int)this + 0x112d)) {
          bVar2 = 0;
        ...
        if (param_2 == *(char *)((uint)*(byte *)((int)this + 0x112d) * 0x51 + 0x11ca + (int)this)) {
          thunk_FUN_0055b7f0(DAT_00802a88,1,puVar4);
        }
      }
    }
  }
