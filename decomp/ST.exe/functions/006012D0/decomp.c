...

{
  ...
  int local_14;
  int local_10;
  AnonPointee_TLOBaseTy_0607 *local_c;
  int local_8;
  ...
  *(undefined1 *)&pAVar10->field_0000 = *(undefined1 *)puVar7;
  ...
  if (local_8 + local_10 != 0) {
    ...
    if (0 < *(int *)((int)this + 0x226)) {
      do {
        ...
        *(int *)((int)&local_c[2].field_000C + local_14 + 1) = iVar4;
        puVar7 = (byte *)((int)&local_c[2].field_0010 + local_14 + 1);
        puVar9 = (byte *)(*(int *)((int)this + 0x233) + iVar3);
        puVar11 = puVar7;
    ...
    if (local_10 != 0) {
      *(int *)((int)&local_c[2].field_000C + local_8 + 1) = local_10;
      puVar7 = (byte *)((int)&local_c[2].field_0010 + local_8 + 1);
      puVar9 = (byte *)(*(undefined4 **)((int)this + 0x23b));
      puVar11 = puVar7;
      ...
      puVar9 = (byte *)(*(undefined4 **)((int)this + 0x23f));
