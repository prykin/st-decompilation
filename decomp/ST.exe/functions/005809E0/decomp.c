  ...
  if (param_3 != 0) {
    ...
    if ((((param_1 < SHORT_007fb240) && (-1 < param_2)) && (param_2 < SHORT_007fb242)) &&
       (((-1 < sVar3 && (sVar3 < SHORT_007fb244)) &&
        (*(short *)(DAT_007fb280 +
                   ((int)SHORT_007fb27e * (int)sVar3 + (int)SHORT_007fb278 * (int)param_2 +
                   (int)param_1) * 2) != -1)))) {
      return 0;
    }
  }
  if (((param_1 < 0) || (SHORT_007fb240 <= param_1)) ||
     (((param_2 < 0 || (((SHORT_007fb242 <= param_2 || (sVar5 < 0)) || (SHORT_007fb244 <= sVar5))))
      || (piVar1 = *(int **)(DAT_007fb248 +
                            ((int)SHORT_007fb246 * (int)sVar5 + (int)SHORT_007fb240 * (int)param_2 +
