...
void __thiscall thunk_FUN_005a26c0(void *this,byte *param_1)

{
  ...
  if ((*(char *)((int)this + 0x1a5f) == '\x06') && (*(char *)((int)this + 0x1a60) == '\0')) {
    ...
    this_00 = pvStack_10;
    if (iVar3 == 0) {
      *(undefined4 *)((int)pvStack_10 + 0x2d) = 0x26;
      FUN_006e6080(pvStack_10,2,*(undefined4 *)((int)pvStack_10 + 0x1b20),
                   (undefined4 *)((int)pvStack_10 + 0x1d));
      iVar3 = *(int *)((int)this_00 + 0x1ea6);
      uVar7 = *(uint *)(iVar3 + 0xc);
      if (*(ushort *)((int)this_00 + 0x31) < uVar7) {
        puStack_8 = (undefined4 *)
                    (*(int *)(iVar3 + 8) * (uint)*(ushort *)((int)this_00 + 0x31) +
                    *(int *)(iVar3 + 0x1c));
      }
      else {
      ...
      if (uVar7 != 0) {
        ...
        do {
          pbVar9 = (byte *)(*(int *)(*(int *)((int)this_00 + 0x1ea6) + 8) * uVar6 +
                           *(int *)(*(int *)((int)this_00 + 0x1ea6) + 0x1c));
LAB_005a278f:
          pbVar10 = param_1;
          if (pbVar9 != (byte *)0x0) {
            do {
...
LAB_005a27bf:
            uVar7 = uStack_c;
            if (iVar3 == 0) {
              FUN_006b0c70(*(int *)((int)this_00 + 0x1ea6),uVar6);
              break;
            }
          }
          uVar6 = uVar6 + 1;
      ...
      thunk_FUN_00540620(0x1e9,0x5e,0,0,0x124,(byte *)0xf3,'\x01',
                         *(BITMAPINFO **)((int)this_00 + 0x1e9a));
      *(undefined4 *)((int)this_00 + 0x2d) = 0x28;
      *(undefined4 *)((int)this_00 + 0x31) = *(undefined4 *)(*(int *)((int)this_00 + 0x1ea6) + 0xc);
      *(undefined2 *)((int)this_00 + 0x35) = 1;
      FUN_006e6080(this_00,2,*(undefined4 *)((int)this_00 + 0x1b20),
                   (undefined4 *)((int)this_00 + 0x1d));
      *(undefined4 *)((int)this_00 + 0x2d) = 0x20;
      if ((*(int *)(*(int *)((int)this_00 + 0x1ea6) + 0xc) == 0) ||
         (*(int *)((int)this_00 + 0x1a6b) == 0)) {
        uVar4 = 0;
      }
      else {
        uVar4 = 1;
      }
      *(undefined4 *)((int)this_00 + 0x31) = uVar4;
      FUN_006e6080(this_00,2,*(undefined4 *)((int)this_00 + 0x1b20),
                   (undefined4 *)((int)this_00 + 0x1d));
      if (puStack_8 != (undefined4 *)0x0) {
        uVar7 = 0;
        uStack_c = *(uint *)(*(int *)((int)this_00 + 0x1ea6) + 0xc);
        if (uStack_c != 0) {
          if (uStack_c == 0) {
            pbVar9 = (byte *)0x0;
            goto LAB_005a28be;
          ...
          do {
            pbVar9 = (byte *)(*(int *)(*(int *)((int)this_00 + 0x1ea6) + 8) * uVar7 +
                             *(int *)(*(int *)((int)this_00 + 0x1ea6) + 0x1c));
LAB_005a28be:
            if (pbVar9 != (byte *)0x0) {
              pbVar10 = abStack_40;
...
LAB_005a28ee:
              if (iVar3 == 0) {
                *(short *)((int)this_00 + 0x31) = (short)uVar7;
                *(undefined2 *)((int)this_00 + 0x37) = 1;
                *(undefined2 *)((int)this_00 + 0x35) = 1;
