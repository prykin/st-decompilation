...

{
  ...
  if (iVar2 == 0) {
    DAT_00801680 = iStack_8;
    puVar3 = FUN_006ae290((uint *)0x0,0x28,0x30,10);
    *(uint **)(iStack_8 + 0x27a) = puVar3;
    *(int *)(iStack_8 + 0x3c) = *(int *)(iStack_8 + 0x3c) + (DAT_00806730 + -800) / 2;
    puVar4 = FUN_006f1ce0(1,s_BKG_BUILDLABW_007c1918,(int *)0x0,1);
    *(ushort **)(iStack_8 + 0x184) = puVar4;
    puVar4 = FUN_00709af0(DAT_00806794,0xb,&DAT_007c1910,0xffffffff,0,1,0,(undefined4 *)0x0);
    *(ushort **)(iStack_8 + 0x188) = puVar4;
    puVar4 = FUN_00709af0(DAT_00806794,0xb,(byte *)s_OBJSD_007c1908,0xffffffff,0,1,0,
                          (undefined4 *)0x0);
    *(ushort **)(iStack_8 + 0x18c) = puVar4;
    thunk_FUN_0053ef20(0x2726,0x3f,2,0xc1,0xc,0x81,99,100,0xc0,99,0x25,0x14,0x31,s_OBJS_0_007c1900);
