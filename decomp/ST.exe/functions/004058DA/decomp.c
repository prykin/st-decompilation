...
undefined4 __fastcall thunk_FUN_004ce860(int param_1)

{
  ...
  if ((iVar1 != 0) && (uVar2 = 0, iStack_8 = param_1, 0 < *(int *)(iVar1 + 0xc))) {
    while( true ) {
      FUN_006acc70(iVar1,uVar2,&iStack_8);
      if (*(int *)(iStack_8 + 0x4dc + *(int *)(param_1 + 0x369) * 4) != 0) break;
      uVar2 = uVar2 + 1;
      iVar1 = *(int *)(&DAT_007f57fe + *(int *)(param_1 + 0x24) * 0xa62);
    ...
    *(int *)(iStack_8 + 0x4dc + *(int *)(param_1 + 0x369) * 4) =
         *(int *)(iStack_8 + 0x4dc + *(int *)(param_1 + 0x369) * 4) + -1;
