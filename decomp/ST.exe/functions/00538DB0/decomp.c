...
void __thiscall
FUN_00538db0(void *this,int param_1,char *param_2,UINT param_3,int param_4,int param_5)

{
  ...
  if (param_4 == 0) {
    ...
    local_8 = *local_14;
    iVar10 = DAT_00806730;
    if (*(int *)((int)this + 0x5c) == 0) goto LAB_00538de2;
  }
  iVar10 = *(int *)((int)this + 0x3c);
LAB_00538de2:
  ...
  iVar10 = local_c;
  thunk_FUN_00540760(*(undefined4 **)((int)pvVar2 + 0x68),local_8,local_c,'\x01',(byte *)puVar6);
  FUN_00710a90(*(int *)((int)pvVar2 + 0x68),0,local_8,iVar10,local_14[2],local_14[3]);
  uVar4 = thunk_FUN_00529fe0(param_1);
  iVar12 = -1;
  iVar10 = -2;
