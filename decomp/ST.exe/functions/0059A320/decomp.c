...

{
  ...
  if (iVar4 == 0) {
    ...
    FUN_006b5ee0((int)pFVar3->field_1AC0,0,0x18,0xc4,0xb6,0x16,0xf,0xd);
  ...
  g_currentExceptionFrame = local_4c.previous;
  iVar8 = ReportDebugMessage(s_E____titans_Start_fsgs_obj_cpp_007cbf70,0x401,0,iVar4,&DAT_007a4ccc,
