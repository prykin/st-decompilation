...

{
  ...
  if (iVar2 == 0) {
    ...
    *(undefined4 *)((int)pvStack_8 + 0x2c) = *(undefined4 *)((int)pvStack_8 + 8);
    ...
    if (-1 < (int)*(uint *)((int)pvStack_8 + 0x60)) {
      FUN_006b3bb0(DAT_008075a8,*(uint *)((int)pvStack_8 + 0x60));
    }
    *(undefined4 *)((int)pvStack_8 + 0x60) = 0xffffffff;
    if (*(int *)((int)pvStack_8 + 0x68) != 0) {
      FUN_006ab060((undefined4 *)((int)pvStack_8 + 0x68));
    }
