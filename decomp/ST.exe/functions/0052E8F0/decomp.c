...

{
  ...
  if (iVar2 == 0) {
    if (*(byte **)(local_8 + 0x1e9) != (byte *)0x0) {
      ...
      *(undefined4 *)(local_8 + 0x1e9) = 0;
    }
    if (*(byte **)(local_8 + 0x1ed) != (byte *)0x0) {
      FUN_006ae110(*(byte **)(local_8 + 0x1ed));
      *(undefined4 *)(local_8 + 0x1ed) = 0;
    }
    if (*(byte **)(local_8 + 0x1f1) != (byte *)0x0) {
      FUN_006b5570(*(byte **)(local_8 + 0x1f1));
      *(undefined4 *)(local_8 + 0x1f1) = 0;
    }
    if (*(int *)(local_8 + 0x1e5) != 0) {
      FUN_006ab060((undefined4 *)(local_8 + 0x1e5));
    }
    if (*(byte **)(local_8 + 0x2f9) != (byte *)0x0) {
      FUN_006b5570(*(byte **)(local_8 + 0x2f9));
    }
    *(undefined4 *)(local_8 + 0x2f9) = 0;
    if (*(byte **)(local_8 + 0x2fd) != (byte *)0x0) {
      FUN_006ae110(*(byte **)(local_8 + 0x2fd));
    }
    *(undefined4 *)(local_8 + 0x2fd) = 0;
    if (*(HANDLE *)(local_8 + 0x1dd) != (HANDLE)0x0) {
      FindCloseChangeNotification(*(HANDLE *)(local_8 + 0x1dd));
