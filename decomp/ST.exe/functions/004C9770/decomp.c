...
int __fastcall FUN_004c9770(void *param_1)

{
  ...
  iVar3 = *(int *)((int)local_10 + 0x245);
  local_c = iVar3;
  thunk_FUN_004c96e0((int)local_10);
  if ((iVar3 == 1) && (*(int *)((int)this + 0x24d) == 4)) {
    iVar3 = (local_8 + *(int *)((int)this + 0x235) * 3) * 0xc;
  ...
  if (*(byte **)((int)this + 0x5ef) != (byte *)0x0) {
    iVar3 = STT3DSprC::LoadSequence
                      ((STT3DSprC *)((int)this + 0x1d5),0xe,DAT_0080678c,
                       *(byte **)((int)this + 0x5ef),0x1d);
    if (iVar3 != 0) {
  ...
  if (*(int *)((int)this + 0x5f3) == 0) {
    ...
    *(undefined4 *)(*(int *)((int)this + 0x1f5) + 0x1e4) = 0;
    ...
    wsprintfA((LPSTR)local_154,s__s_1i_007ac908,*(int *)((int)this + 0x5f3),
              *(undefined4 *)((int)this + 0x5c0));
    iVar3 = STT3DSprC::LoadSequence
                      ((STT3DSprC *)((int)this + 0x1d5),0xd,DAT_0080678c,local_154,0x1d);
    if (iVar3 != 0) {
  ...
  if (*(byte **)((int)this + 0x5f7) == (byte *)0x0) {
    STT3DSprC::StopShow(this_00,0xc);
    *(undefined4 *)(*(int *)((int)this + 0x1f5) + 0x1c4) = 0;
    *(undefined4 *)(*(int *)((int)this + 0x1f5) + 0x1c0) = 0;
  }
  else {
    iVar3 = STT3DSprC::LoadSequence(this_00,0xc,DAT_0080678c,*(byte **)((int)this + 0x5f7),0x1d);
    if (iVar3 != 0) {
    ...
    if (*(int *)(&DAT_00790c2c + *(int *)((int)this + 0x235) * 4) != 0) {
      ...
      FUN_006ea190(*(void **)((int)this + 0x211),uVar2,uVar6,iVar3);
    }
  }
  if (*(int *)(&DAT_00791a10 + *(int *)((int)this + 0x235) * 4) != 0) {
    wsprintfA((LPSTR)local_154,s__s_cover_007ac8fc,*(undefined4 *)((int)this + 0x5ef));
    iVar3 = STT3DSprC::LoadSequence(this_00,9,DAT_0080678c,local_154,0x1d);
    if (iVar3 != 0) {
    ...
    if ((*(int *)((int)this + 0x5ac) != 0x40) && (*(int *)((int)this + 0x5ac) != 0x49)) {
      wsprintfA((LPSTR)local_154,s__s_cover_1i_007ac8ec,*(undefined4 *)((int)this + 0x5f3),
                *(undefined4 *)((int)this + 0x5c0));
      iVar3 = STT3DSprC::LoadSequence(this_00,8,DAT_0080678c,local_154,0x1d);
      if (iVar3 != 0) {
    ...
    if (*(int *)((int)this + 0x5ac) == 0x4e) {
      ...
      iVar3 = STT3DSprC::LoadSequence(this_00,7,DAT_0080678c,local_154,0x1d);
      if (iVar3 != 0) {
  ...
  if ((iVar4 < iVar3) &&
     (uVar2 = *(int *)(*(int *)((int)this + 0x1f5) + 0x1e4) -
              *(int *)(*(int *)((int)this + 0x1f5) + 0x1e8), uVar6 = (int)uVar2 >> 0x1f,
  ...
  iVar3 = local_c;
  if ((local_c == 1) && (*(int *)((int)this + 0x24d) == 4)) {
    iVar3 = 4;
  }
  ...
  if ((((iVar3 == 0) || (iVar3 == 5)) || ((iVar3 == 1 && (*(int *)((int)this + 0x24d) == 0)))) ||
    ...
    iVar3 = STT3DSprC::LoadSequence
                      (this_00,0x10,DAT_0080678c,(&PTR_s_tlo_sha_ws_007bb1b4)[local_8],0x1d);
    if (iVar3 != 0) {
    ...
    STT3DSprC::StartShow(this_00,0x10,uVar5);
    thunk_FUN_004acf50(this_00,'\x10');
  }
  else {
    thunk_FUN_004acf90(this_00,'\x10');
    STT3DSprC::StopShow(this_00,0x10);
  }
  if (*(int *)((int)this + 0x245) == 1) {
    if (*(int *)((int)this + 0x5df) == 5) {
      ...
      *(undefined4 *)((int)this + 0x4cc) = *(undefined4 *)(DAT_00802a38 + 0xe4);
      ...
      thunk_FUN_004abce0(this_00,4,0,iVar3,cVar7);
      thunk_FUN_004abe40(this_00,'\x04',0);
      STT3DSprC::StartShow(this_00,4,*(undefined4 *)(DAT_00802a38 + 0xe4));
      STT3DSprC::LoadSequence
                (this_00,6,DAT_00806774,
                 (byte *)(s_expmask3_007cdf44 +
                         *(int *)(&DAT_0079125c + *(int *)((int)this + 0x235) * 4) * 0x32),0x1d);
      thunk_FUN_004ac700(this_00,'\x06');
      STT3DSprC::StartShow(this_00,6,*(undefined4 *)(DAT_00802a38 + 0xe4));
  ...
  if (*(int *)((int)this + 0x4bc) == 4) {
    if (*(int *)((int)this + 0x2c) == 0) {
      iVar3 = STT3DSprC::LoadSequence(this_00,4,DAT_00806764,(byte *)s_tlo_emb5_007ad464,0x1d);
      if (iVar3 != 0) {
        iVar4 = 0x91;
LAB_004c9eda:
      ...
      iVar3 = STT3DSprC::LoadSequence(this_00,4,DAT_00806764,(byte *)s_tlo_emb5_big_007ad470,0x1d);
      if (iVar3 != 0) {
        iVar4 = 0x92;
        goto LAB_004c9eda;
      }
    ...
    if ((char)iVar4 == '\x03') {
      if (iVar3 == 0) {
        iVar3 = STT3DSprC::LoadSequence(this_00,5,DAT_0080678c,(byte *)s_si_emb5_007ad44c,0x1d);
        if (iVar3 != 0) {
          iVar4 = 0x9e;
LAB_004c9fb1:
          RaiseInternalException(iVar3,DAT_007ed77c,s_E____titans_Artem_TLO_bspr_cpp_007ad4d0,iVar4)
        ...
        iVar3 = STT3DSprC::LoadSequence(this_00,5,DAT_0080678c,(byte *)s_si_emb6_007ad458,0x1d);
        if (iVar3 != 0) {
          iVar4 = 0x9f;
          goto LAB_004c9fb1;
        }
      ...
      if (iVar3 == 0) {
        iVar3 = STT3DSprC::LoadSequence(this_00,5,DAT_0080678c,(byte *)s_tlo_emb2_007ad434,0x1d);
        if (iVar3 != 0) {
          iVar4 = 0xa5;
LAB_004ca02a:
          RaiseInternalException(iVar3,DAT_007ed77c,s_E____titans_Artem_TLO_bspr_cpp_007ad4d0,iVar4)
        ...
        iVar3 = STT3DSprC::LoadSequence(this_00,5,DAT_0080678c,(byte *)s_tlo_emb3_007ad440,0x1d);
        if (iVar3 != 0) {
          iVar4 = 0xa6;
          goto LAB_004ca02a;
        }
  ...
  STT3DSprC::StartShow(this_00,5,uVar5);
LAB_004ca0a2:
