...

{
  ...
  if (iVar2 == 0) {
    pAVar3 = (AnonShape_006DBCA0_EF06575F *)FUN_006b04d0(0x4f2);
    if (pAVar3 == nullptr) {
      g_sT3DSMAPContext_0080760C = nullptr;
    }
    else {
      g_sT3DSMAPContext_0080760C = (ST3DSMAPContext *)FUN_006dbca0(pAVar3);
    }
    if (g_sT3DSMAPContext_0080760C == nullptr) {
      RaiseInternalException
                (-2,g_overwriteContext_007ED77C,"E:\\__titans\\tinittxt.cpp",0x160);
    }
    iVar2 = (uint)param_1->field_0004 << 1;
    ST3DSMAPContext::sub_006DC050
              (g_sT3DSMAPContext_0080760C,g_dDXContext_0080759C,0,0,iVar2,iVar2,-10.0,10.0,-10.0,
    ...
    pDVar4 = Library::DKW::TBL::DArrayCreate(nullptr,0x14,8,0x14);
    param_1->field_044D = pDVar4;
    pDVar4 = Library::DKW::TBL::DArrayCreate(nullptr,0x14,0xc,0x14);
    param_1->field_0451 = pDVar4;
    ...
    iVar6 = (int)param_1->field_0002 / 2;
    iVar2 = (int)param_1->field_0000 / 2;
    local_10 = iVar6;
    ...
    if (0 < iVar6) {
      do {
        ...
        if (0 < iVar2) {
          do {
            thunk_FUN_00574920((AnonShape_00574920_7507981E *)param_1,iVar6,local_c,local_8);
            iVar6 = iVar6 + 1;
          } while (iVar6 < iVar2);
        }
        local_c = local_c + 1;
