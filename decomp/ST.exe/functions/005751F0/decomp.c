...
void __cdecl LandInit(RecoveredRecordView_005751F0_4081B804 *param_1)
  ...
  if (iVar2 == 0) {
    ...
    if (0 < param_1->field_0455) {
      ...
      do {
        if (*(undefined4 **)pRVar5 != nullptr) {
          thunk_FUN_005745e0((RecoveredRecordView_005745E0_17311247 *)param_1,*(undefined4 **)pRVar5
                            );
        }
        iVar6 = iVar6 + 1;
        pRVar5 = (RecoveredRecordView_005751F0_4081B804 *)&pRVar5->field_0004;
    ...
    if (0 < iVar4) {
      do {
        ...
        if (0 < iVar6) {
          do {
            thunk_FUN_00574920((RecoveredRecordView_00574920_F0A9E3AD *)param_1,iVar4,local_c,
                               local_8);
            iVar4 = iVar4 + 1;
          } while (iVar4 < iVar6);
        }
