        ...
        if ((*(int *)((int)this + 0x74a) <= (int)*(short *)(DAT_00806724 + 0x23) / 2) &&
          ...
          do {
            ...
            if (DAT_0080732c == 1) {
              ...
              bVar25 = 0;
              lVar16 = __ftol();
              iVar14 = (int)local_1c + *(short *)((int)this + 0x45) + local_10 + (int)(short)lVar16;
              iVar6 = (int)*(short *)((int)this + 0x43) - (int)local_20._2_2_;
              iVar9 = (int)(short)local_20 + iVar5 + *(short *)((int)this + 0x41);
            }
            else {
              iVar14 = (int)local_1c + local_10 + *(short *)((int)this + 0x45);
              local_20._2_2_ = (short)((uint)uVar26 >> 0x10);
              iVar6 = (int)*(short *)((int)this + 0x43) - (int)local_20._2_2_;
              local_20._0_2_ = (short)uVar26;
              iVar9 = (int)(short)local_20 + iVar5 + *(short *)((int)this + 0x41);
            }
    ...
    if (((int)uVar12 <= (int)*(short *)(DAT_00806724 + 0x23) / 2) &&
      ...
      do {
        ...
        if (DAT_0080732c == 1) {
          ...
          bVar25 = 0;
          lVar16 = __ftol();
          iVar14 = (int)local_1c + *(short *)((int)this + 0x45) + local_18 + (int)(short)lVar16;
          iVar6 = (int)*(short *)((int)this + 0x43) - (int)local_20._2_2_;
          iVar9 = (int)(short)local_20 + iVar5 + *(short *)((int)this + 0x41);
        }
        else {
          iVar14 = (int)local_1c + local_18 + *(short *)((int)this + 0x45);
          local_20._2_2_ = (short)((uint)uVar26 >> 0x10);
          iVar6 = (int)*(short *)((int)this + 0x43) - (int)local_20._2_2_;
          local_20._0_2_ = (short)uVar26;
          iVar9 = (int)(short)local_20 + iVar5 + *(short *)((int)this + 0x41);
