...

{
  ...
  if ((param_1 == 0) || (param_1 == 1)) {
    ...
    sVar21 = *(short *)&this->field_0x3a0;
    sVar22 = *(short *)&this->field_0x3a4;
    sVar23 = *(short *)&this->field_0x3a2;
    if (sVar21 < 0) {
      return 0;
    }
    if (SHORT_007fb240 <= sVar21) {
      return 0;
    }
    if (sVar23 < 0) {
      return 0;
    }
    if (SHORT_007fb242 <= sVar23) {
      return 0;
    }
    if (sVar22 < 0) {
      return 0;
    }
    if (SHORT_007fb244 <= sVar22) {
      return 0;
    }
    ...
    *(undefined4 *)&this->field_0x574 = 0;
    ...
    sVar23 = this->field_0556;
    sVar22 = this->field_0554;
    this->field_00B7 = 3;
LAB_00470e23:
    sub_00481520(this,(int)sVar22,(int)sVar23,sVar21 + 1);
...
cf_common_exit_00470E32:
  ...
  if (SVar2 == CASE_0) {
    ...
    case 0:
      ...
      sVar22 = this->field_0558;
      sVar23 = this->field_0556;
      if ((((sVar21 < 0) || (SHORT_007fb240 <= sVar21)) || (sVar23 < 0)) ||
         (((SHORT_007fb242 <= sVar23 || (sVar22 < 0)) || (SHORT_007fb244 <= sVar22)))) {
        piVar18 = (int *)0x0;
      }
      else {
        piVar18 = *(int **)(DAT_007fb248 +
...
LAB_0046f888:
      ...
      if (((piVar18 != (int *)0x0) &&
          (iVar27 = (**(code **)(*piVar18 + 0x2c))(), iVar7 = extraout_ECX_00,
          uVar6 = extraout_var_05, iVar27 == 0x33)) &&
         (iVar7 = piVar18[9], iVar7 == *(int *)&this->field_0x24)) {
        iVar27 = thunk_FUN_004e1eb0(piVar18,(int)this->field_0041,(int)this->field_0043,
                                    (int)this->field_0045);
        this->field_0568 = iVar27;
        iVar7 = extraout_ECX_01;
        uVar6 = extraout_var_06;
        if (iVar27 != -1) goto LAB_0046f794;
      }
    ...
    case 1:
      if (this->field_0564 != 1) {
        ...
        sVar22 = this->field_0558;
        sVar23 = this->field_0556;
        if ((((((-1 < sVar21) && (sVar21 < SHORT_007fb240)) && (-1 < sVar23)) &&
             ((sVar23 < SHORT_007fb242 && (-1 < sVar22)))) &&
            ((sVar22 < SHORT_007fb244 &&
             ((piVar18 = *(int **)(DAT_007fb248 +
    ...
    if (SVar2 == CASE_2) {
      *(int *)&this->field_0x574 = *(int *)&this->field_0x574 + 1;
      ...
      if ((((-1 < sVar21) && (sVar21 < SHORT_007fb240)) &&
          ((-1 < sVar23 && ((sVar23 < SHORT_007fb242 && (-1 < sVar22)))))) &&
         ((sVar22 < SHORT_007fb244 &&
          (((pSVar19 = *(STFishC **)
                        (DAT_007fb248 +
                        ((int)sVar22 * (int)SHORT_007fb246 + (int)sVar23 * (int)SHORT_007fb240 +
        ...
        bVar5 = thunk_FUN_004908a0(this,pSVar19,iVar7);
        if (CONCAT31(extraout_var_00,bVar5) != 1) {
          return 2;
        }
        this->field_055A = pSVar19->field_0018;
        thunk_FUN_004e1fb0(pSVar19,this->field_0568,this->field_0018);
        sVar23 = *(short *)&this->field_0x570;
        sVar22 = *(short *)&this->field_0x56e;
        sVar21 = *(short *)&this->field_0x56c;
        this->field_0580 = CASE_3;
        this->field_00B7 = 0;
LAB_00470bfe:
        sub_00481520(this,(int)sVar21,(int)sVar22,(int)sVar23);
        sub_00460260(this,0);
        return 2;
      }
LAB_0046fd37:
      ...
      case 1:
        if (this->field_0564 != 1) {
          ...
          if (((sVar21 < 0) || (SHORT_007fb240 <= sVar21)) ||
             (((sVar23 < 0 || ((SHORT_007fb242 <= sVar23 || (sVar22 < 0)))) ||
              ((SHORT_007fb244 <= sVar22 ||
               (((pSVar19 = *(STFishC **)
                             (DAT_007fb248 +
                             ((int)sVar22 * (int)SHORT_007fb246 + (int)sVar23 * (int)SHORT_007fb240
                             + (int)sVar21) * 8), pSVar19 == (STFishC *)0x0 ||
...
LAB_00470071:
        thunk_FUN_004908a0(this,pSVar19,this->field_0568);
    ...
    if (SVar2 == CASE_4) {
      if (*(int *)&this->field_0x584 == 0) {
        ...
        iVar27 = CONCAT22((short)((uint)iVar8 >> 0x10),this->field_0556 + 1) * 0xc9;
        iVar11 = CONCAT22((short)((uint)iVar27 >> 0x10),
        ...
        uVar6 = (*this->vtable->vfunc_10)
                          (CONCAT22(uVar6,this->field_0041),
                           ...
                           CONCAT22(uVar6,this->field_0045),iVar7,iVar27,iVar8);
...
LAB_004707ad:
        ...
        if (((int)this->field_074A <= (int)*(short *)(DAT_00806724 + 0x23) / 2) &&
          ...
          do {
            ...
            if (DAT_0080732c == 1) {
              ...
              iVar17 = (int)local_1c + this->field_0045 + local_10 + (int)(short)lVar20;
            ...
            TraksClassTy::TraksCreate
                      (g_traksClass_00802A7C,1,2,7,iVar11,iVar8 + ((uVar9 >> 0x10) % 7 - 3),iVar17,
                       sVar21,sVar22,sVar23,sVar24,sVar25,sVar26,iVar27,sVar28,bVar29);
    ...
    if (SVar2 == CASE_5) {
      ...
      if ((((-1 < sVar21) && (sVar21 < SHORT_007fb240)) && (-1 < sVar23)) &&
        ...
        if (PTR_00802a38->field_00E4 == *(int *)&this->field_0x574 + *(int *)&this->field_0x578) {
          ...
          uVar9 = this->field_001C * 0x41c64e6d + 0x3039;
          this->field_001C = uVar9;
          iVar27 = (*(short *)&this->field_0x237 * -2) / 10;
          uVar1 = this->field_001C * 0x41c64e6d + 0x3039;
          this->field_001C = uVar1;
          local_20 = CONCAT22((short)((uVar1 >> 0x10) %
                                     (((*(short *)&this->field_0x237 * 2) / 10 - iVar27) + 1U)) +
                              (short)iVar27,
                              (short)((uVar9 >> 0x10) %
    ...
    if (SVar2 != CASE_6) {
      if (SVar2 == CASE_7) {
        ...
        iVar27 = CONCAT22(extraout_var_08,this->field_0049);
        iVar17 = 1;
      ...
      thunk_FUN_0048dfd0(iVar11,iVar8,(uint)piVar12,iVar7,iVar27,piVar18,iVar17,&this->field_055E,
                         &this->field_0560,(short *)&this->field_0x562);
      sVar23 = *(short *)&this->field_0x562;
      sVar22 = this->field_0560;
      sVar21 = this->field_055E;
      goto LAB_00470bfe;
    }
    ...
    *(int *)&this->field_0x57c = iVar7;
    ...
    if (*(int *)&this->field_0x584 == 0) {
      iVar27 = (ushort)(*(short *)&this->field_0x570 * 200) + 100;
      iVar8 = CONCAT22((short)((uint)iVar7 >> 0x10),*(short *)&this->field_0x56e * 0xc9) + 100;
      iVar7 = CONCAT22((short)((uint)iVar27 >> 0x10),*(short *)&this->field_0x56c * 0xc9) + 100;
      uVar6 = (undefined2)((uint)iVar8 >> 0x10);
      uVar6 = (*this->vtable->vfunc_10)
                        (CONCAT22(uVar6,this->field_0041),
                         CONCAT22((short)((uint)iVar7 >> 0x10),this->field_0043),
                         CONCAT22(uVar6,this->field_0045),iVar7,iVar8,iVar27);
      *(undefined2 *)&this->field_0x572 = uVar6;
      *(undefined4 *)&this->field_0x584 = 1;
    }
    if (*(int *)&this->field_0x584 == 1) {
    ...
    if (((int)uVar14 <= (int)*(short *)(DAT_00806724 + 0x23) / 2) &&
      ...
      do {
        ...
        if (DAT_0080732c == 1) {
          ...
          bVar29 = 0;
          lVar20 = Library::MSVCRT::__ftol();
          iVar17 = (int)local_1c + this->field_0045 + local_18 + (int)(short)lVar20;
          iVar8 = (int)this->field_0043 - (int)local_20._2_2_;
          iVar11 = (int)(short)local_20 + iVar7 + this->field_0041;
        }
        else {
    ...
    iVar7 = 0;
    sVar22 = this->field_0558;
    psVar15 = (short *)CONCAT22((short)(uVar14 >> 0x10),sVar22);
    sVar23 = this->field_0556;
    if ((((sVar21 < 0) || (SHORT_007fb240 <= sVar21)) || (sVar23 < 0)) ||
       (((SHORT_007fb242 <= sVar23 || (sVar22 < 0)) || (SHORT_007fb244 <= sVar22)))) {
cf_common_exit_00470B14:
      ...
      iVar27 = CONCAT22((short)((uint)&this->field_055E >> 0x10),this->field_0047);
      this->field_0580 = CASE_7;
      thunk_FUN_0048dfd0(iVar27,iVar7,uVar9,iVar27,iVar7,(int *)uVar9,3,&this->field_055E,
                         &this->field_0560,(short *)&this->field_0x562);
    }
    else {
      psVar15 = (short *)((int)sVar22 * (int)SHORT_007fb246 + (int)sVar23 * (int)SHORT_007fb240 +
                         (int)sVar21);
      iVar7 = *(int *)(DAT_007fb248 + (int)psVar15 * 8);
      if ((iVar7 == 0) ||
         (psVar15 = *(short **)(iVar7 + 0x18), psVar15 != (short *)this->field_055A))
  ...
  case 1:
    ...
    this->field_0568 = iVar7;
    if ((iVar7 == -1) ||
       (bVar5 = thunk_FUN_004908a0(this,pSVar19,iVar7), CONCAT31(extraout_var,bVar5) != 1))
    goto cf_common_exit_004707B7;
    sub_004602B0(this);
    this->field_055A = pSVar19->field_0018;
    thunk_FUN_004e1fb0(pSVar19,this->field_0568,this->field_0018);
    iVar8 = (int)*(short *)&this->field_0x570;
    iVar27 = (int)*(short *)&this->field_0x56e;
...
LAB_0046fb98:
  sub_00481520(this,iVar7,iVar27,iVar8);
  sub_00460260(this,0);
