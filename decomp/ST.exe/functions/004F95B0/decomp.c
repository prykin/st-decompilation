...
void FUN_004f95b0(char *param_1,undefined4 param_2)

{
  ...
  errorCode = __setjmp3(local_4c,0,unaff_ESI,pIVar3);
  if (errorCode == 0) {
    local_8 = FUN_006b54f0((uint *)0x0,1,1);
    thunk_FUN_005411a0((int)local_8,param_1,s____s__007c221c);
    thunk_FUN_004f92b0((int *)&local_8,param_2);
