...

{
  ...
  if (iVar4 == 0) {
    ...
    if (*(uint *)(local_8 + 0x1c8a) != 0xffffffff) {
      FUN_006b3bb0(DAT_008075a8,*(uint *)(local_8 + 0x1c8a));
    }
    *(undefined4 *)(local_8 + 0x1c8a) = 0xffffffff;
    if (*(int *)(local_8 + 0x1c82) != 0) {
      FUN_006ab060((undefined4 *)(local_8 + 0x1c82));
    }
    if (*(int *)(local_8 + 0x1c8e) != 0) {
      FUN_006ab060((undefined4 *)(local_8 + 0x1c8e));
    }
    if (*(int *)(local_8 + 0x1c96) != 0) {
      thunk_FUN_005aafb0();
      FUN_0072e2b0(*(undefined4 **)(local_8 + 0x1c96));
      *(undefined4 *)(local_8 + 0x1c96) = 0;
    }
    if (*(int *)(local_8 + 0x1c9a) != 0) {
      thunk_FUN_005aafb0();
      FUN_0072e2b0(*(undefined4 **)(local_8 + 0x1c9a));
      *(undefined4 *)(local_8 + 0x1c9a) = 0;
    }
    ...
    if (*(byte **)(local_8 + 0x1c92) != (byte *)0x0) {
      FUN_006b5570(*(byte **)(local_8 + 0x1c92));
    }
    *(undefined4 *)(local_8 + 0x1c92) = 0;
