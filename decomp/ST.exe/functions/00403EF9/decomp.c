...
void thunk_FUN_00515310(UINT param_1,int param_2,UINT param_3)

{
  ...
  *(undefined4 *)(*(int *)(iStack_c + 0x1d7) + 0xc) = 0;
  *(undefined1 *)(iStack_c + 0x1db) = 0;
  FUN_006b55f0(*(undefined4 **)(iStack_c + 0x68),0,0x21,0x16,*(int *)(iStack_c + 0x1dc),0,0x21,0x16,
               0x1b8,0x118);
  iVar3 = iStack_8;
  FUN_00710a90(*(int *)(iStack_c + 0x68),0,0x21,iStack_8,0x19c,0x14);
  if (DAT_0080874e == '\x03') {
    iVar4 = 5;
  }
  else {
  ...
  if (param_2 != 0) {
    ...
    FUN_00710a90(*(int *)(iStack_c + 0x68),0,0x21,iStack_8,0x19c,0xf);
    uVar14 = 3;
    iVar12 = -1;
    iVar4 = -1;
