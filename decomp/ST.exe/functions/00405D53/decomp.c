...
undefined4 thunk_FUN_006298a0(int param_1)

{
  ...
  iVar6 = __setjmp3(auStack_5c,0,unaff_EDI,unaff_ESI);
  if (iVar6 != 0) {
  ...
  *(undefined4 *)(iStack_18 + 0xb6) = *(undefined4 *)puVar8;
  if (param_1 != 0) {
    ...
    FUN_006ea270(DAT_00807598,*puVar1,0,*(uint *)(iStack_18 + 0xb2));
    fStack_1c = (float)*(int *)(iStack_18 + 0x46) * _DAT_007904f8 * _DAT_007904f0;
    *(float *)(iStack_18 + 0x6a) = fStack_1c;
    fStack_c = (float)*(int *)(iStack_18 + 0x4a) * _DAT_007904f8 * _DAT_007904f0;
    *(float *)(iStack_18 + 0x6e) = fStack_c;
    fVar4 = (float)*(int *)(iStack_18 + 0x4e) * _DAT_007904f8 * _DAT_007904f0;
    *(float *)(iStack_18 + 0x72) = fVar4;
    FUN_006ea960(DAT_00807598,*puVar1,fStack_1c,fStack_c,fVar4 + _DAT_007904fc);
    FUN_006eaaa0(DAT_00807598,*puVar1,0);
    *(undefined1 *)(iStack_18 + 0xc1) = 1;
    pvVar5 = DAT_00802a88;
    if (DAT_00802a88 != (void *)0x0) {
      iVar6 = *(int *)(iStack_18 + 0x4e);
      sVar3 = (short)(iVar6 >> 0x1f);
      if (iVar6 < 0) {
        fStack_c = (float)((short)(((short)(iVar6 / 200) + sVar3) -
                                  (short)((longlong)iVar6 * 0x51eb851f >> 0x3f)) + -1);
      }
      else {
        fStack_c = (float)(int)(short)(((short)(iVar6 / 200) + sVar3) -
                                      (short)((longlong)iVar6 * 0x51eb851f >> 0x3f));
      }
      iVar6 = *(int *)(iStack_18 + 0x4a);
      sVar3 = (short)(iVar6 >> 0x1f);
      if (iVar6 < 0) {
      ...
      if ((((DAT_0080874d == -1) || (*(int *)((int)DAT_00802a88 + 0xf8) == 0)) ||
        ...
        if ((bVar11) && (*(int *)((int)pvVar5 + 0x4c) != 0)) {
          bVar11 = *(char *)(((&DAT_0079aed0)[(int)fStack_c] + iStack_10) *
      ...
      if (bVar11) {
        if (*(char *)(iStack_18 + 0xc1) == '\0') {
          FUN_006eaaa0(DAT_00807598,*puVar1,0);
          *(undefined1 *)(iStack_18 + 0xc1) = 1;
        }
      }
      else if (*(char *)(iStack_18 + 0xc1) == '\x01') {
        FUN_006eab60(DAT_00807598,*puVar1);
        *(undefined1 *)(iStack_18 + 0xc1) = 0;
      }
    }
    if (*(byte *)(iStack_18 + 0x14) < 4) {
      puVar8 = FUN_00709af0(DAT_00806764,0x1d,(byte *)s_expl_s1_007d0c48,0xffffffff,0,1,0,
                            (undefined4 *)0x0);
      if (0xe < *(int *)(iStack_18 + 0xb2)) {
        uStack_8 = *(int *)(iStack_18 + 0xb2) + 3;
      }
      FUN_006e98e0(DAT_00807598,*puVar1,1,*(undefined4 *)puVar8,*(int *)((int)puVar8 + 0x21),1);
      FUN_006ea270(DAT_00807598,*puVar1,1,uStack_8);
      puVar12 = (uint *)*puVar1;
    }
    else {
      puVar8 = FUN_00709af0(DAT_00806764,0x1d,(byte *)s_expl_s0_007d0c50,0xffffffff,0,1,0,
                            (undefined4 *)0x0);
      if (0xe < *(int *)(iStack_18 + 0xb2)) {
        uStack_8 = *(int *)(iStack_18 + 0xb2) - 0xf;
      }
      FUN_006e98e0(DAT_00807598,*puVar1,1,*(undefined4 *)puVar8,*(int *)((int)puVar8 + 0x21),1);
      FUN_006ea270(DAT_00807598,*puVar1,1,uStack_8);
      puVar12 = (uint *)*puVar1;
    ...
    iVar6 = *(int *)(iStack_18 + 0xeb);
    if (iVar6 != 0) {
      if (*(int *)(iStack_18 + 0xf3) == 0) {
