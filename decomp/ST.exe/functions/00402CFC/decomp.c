...
LAB_00491b42:
  ...
  do {
    iStack_8 = *(int *)((int)aiStack_20 + iVar10) * (int)DAT_007fb27e;
    if (0 < *(short *)((int)DAT_007fb238 + (iStack_8 + iVar11 + (int)param_4) * 2)) {
      piVar4 = &iStack_68;
      _param_3 = 1000000000;
      iVar12 = 0;
      do {
        ...
        if ((((-1 < iVar5) && (iVar5 <= DAT_007fb278 + -1)) && (iVar9 = piVar4[1], -1 < iVar9)) &&
          ...
          iVar5 = iVar9 * DAT_007fb278 + iStack_8 + iVar5;
          iVar9 = (int)*(short *)((int)DAT_007fb238 + iVar5 * 2);
          if (0 < iVar9) {
            pSVar2 = *(STBoatC **)(DAT_007fb248 + iVar5 * 8);
            if (pSVar2 == pSStack_c) {
              *(int *)((int)aiStack_48 + iVar10 + 0x14) = iVar12;
              *(undefined4 *)((int)aiStack_48 + iVar10) = 2;
              break;
            }
            if (pSVar2 == (STBoatC *)0x0) {
              if (*(int *)((int)aiStack_48 + iVar10) == 0) {
                *(int *)((int)aiStack_48 + iVar10 + 0x14) = iVar12;
                *(undefined4 *)((int)aiStack_48 + iVar10) = 1;
                _param_3 = iVar9;
                goto LAB_00491c1c;
              }
              if (*(int *)((int)aiStack_48 + iVar10) != 1) goto LAB_00491c08;
            }
            else {
LAB_00491c08:
              if (*(int *)((int)aiStack_48 + iVar10) != 0) goto LAB_00491c1c;
            }
            if (iVar9 < _param_3) {
              *(int *)((int)aiStack_48 + iVar10 + 0x14) = iVar12;
              _param_3 = iVar9;
...
LAB_00491c1c:
    ...
    if (0x13 < iVar10) {
      ...
      _param_6 = 0;
      do {
        iVar12 = *(int *)((int)aiStack_48 + iVar10 + 0x14);
        if (iVar12 != -1) {
          if ((iVar11 == -1) ||
             ((*(int *)((int)aiStack_48 + iVar10) == 1 && (aiStack_48[iVar11] == 0)))) {
            _param_3 = (int)*(short *)((int)DAT_007fb238 +
                                      (*(int *)((int)aiStack_64 + iVar12 * 8) * (int)DAT_007fb278 +
                                       *(int *)((int)aiStack_20 + iVar10) * (int)DAT_007fb27e +
                                      (&iStack_68)[iVar12 * 2]) * 2);
            iVar11 = _param_6;
          }
          else if (((*(int *)((int)aiStack_48 + iVar10) != 0) || (aiStack_48[iVar11] != 1)) &&
                  (iVar12 = (int)*(short *)((int)DAT_007fb238 +
                                           (*(int *)((int)aiStack_64 + iVar12 * 8) *
                                            (int)DAT_007fb278 +
                                            *(int *)((int)aiStack_20 + iVar10) * (int)DAT_007fb27e +
                                           (&iStack_68)[iVar12 * 2]) * 2), iVar12 < _param_3)) {
            iVar11 = _param_6;
            _param_3 = iVar12;
          }
        }
      ...
      if (iVar11 != -1) {
        iVar10 = aiStack_20[iVar11];
        uVar1 = *(undefined2 *)((int)aiStack_64 + aiStack_48[iVar11 + 5] * 8);
        *param_7 = (short)(&iStack_68)[aiStack_48[iVar11 + 5] * 2];
        *param_8 = uVar1;
