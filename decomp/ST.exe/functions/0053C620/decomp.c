...

{
  ...
  if (*(int *)((int)param_1 + (uint)*(byte *)((int)param_1 + 0x278) * 4 + 0x27a) != 0) {
    ...
    puVar7 = (undefined4 *)((int)param_1 + 0x1a1);
    local_c = 0;
    local_14 = 5;
    do {
      *(undefined4 *)((int)param_1 + 0x28) = 0x21;
      FUN_006e6080(param_1,2,*puVar7,(undefined4 *)((int)param_1 + 0x18));
...
LAB_0053c75b:
      ...
      if ((*(int *)((int)param_1 + 0x2c) != 0) &&
         (iVar5 = *(int *)((int)param_1 + (uint)*(byte *)((int)param_1 + 0x278) * 4 + 0x27a),
         iVar5 != 0)) {
        uVar4 = *(int *)((int)param_1 + 0x199) + local_c;
