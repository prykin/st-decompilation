  ...
  if (iVar3 == 0) {
    if ((param_1 == 0) || (param_1 == 2)) {
      puVar4 = FUN_00709af0(DAT_00806764,0x1d,(byte *)s_expl_vol_007d26b0,0xffffffff,0,1,0,
                            (undefined4 *)0x0);
      FUN_006e8660(DAT_00807598,(int *)&local_8,1,0,*(uint *)((int)puVar4 + 9),
                   *(uint *)((int)puVar4 + 0xd),0x5a,0x2f,0);
      FUN_006e98e0(DAT_00807598,local_8,0,*(undefined4 *)puVar4,*(int *)((int)puVar4 + 0x21),1);
      FUN_006ea270(DAT_00807598,local_8,0,*(uint *)(pSVar2 + 0x71));
      ...
      *(uint *)(pSVar2 + 0x5d) = local_8;
      puVar4 = FUN_00709af0(DAT_00806764,0x1d,(byte *)s_expl_vob_007d26c8,0xffffffff,0,1,0,
                            (undefined4 *)0x0);
      FUN_006e8660(DAT_00807598,(int *)&local_c,1,0,*(uint *)((int)puVar4 + 9),
                   *(uint *)((int)puVar4 + 0xd),0x40,0x6a,0);
      FUN_006e98e0(DAT_00807598,local_c,0,*(undefined4 *)puVar4,*(int *)((int)puVar4 + 0x21),1);
      FUN_006ea270(DAT_00807598,local_c,0,*(uint *)(pSVar2 + 0x8a));
      ...
      *(uint *)(pSVar2 + 0x86) = local_c;
    }
    if ((param_1 != 0) && (*(int *)(pSVar2 + 0x7a) < 0)) {
      puVar4 = FUN_00709af0(DAT_00806764,0x1d,(byte *)s_expl_vop_007d26bc,0xffffffff,0,1,0,
                            (undefined4 *)0x0);
      FUN_006e8660(DAT_00807598,(int *)&local_10,1,0,*(uint *)((int)puVar4 + 9),
                   *(uint *)((int)puVar4 + 0xd),0x4b,0x7e,0);
      FUN_006e98e0(DAT_00807598,local_10,0,*(undefined4 *)puVar4,*(int *)((int)puVar4 + 0x21),1);
      FUN_006ea270(DAT_00807598,local_10,0,*(uint *)(pSVar2 + 0x7e));
      FUN_006ea960(DAT_00807598,local_10,
                   (float)*(int *)(pSVar2 + 0x65) * _DAT_007904f8 * _DAT_007904f0,
                   (float)*(int *)(pSVar2 + 0x69) * _DAT_007904f8 * _DAT_007904f0,
                   (float)*(int *)(pSVar2 + 0x6d) * _DAT_007904f8 * _DAT_007904f0 + _DAT_007904fc);
      FUN_006eaaa0(DAT_00807598,local_10,0);
      FUN_006ea460(DAT_00807598,local_10,*(int *)(pSVar2 + 0x5d));
      *(uint *)(pSVar2 + 0x7a) = local_10;
    }
