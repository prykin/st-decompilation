...
switchD_004e04e5_caseD_0:
    ...
    case 1:
      if (iVar1 == 0x5e) {
        local_8 = (byte *)s_corisi_lid_007bf988;
      }
      else {
LAB_004e05d3:
        local_8 = (byte *)s_mine_ani1_lid_007bf934;
      }
      break;
    case 2:
      switch(iVar1) {
      case 0x38:
        local_8 = (byte *)s_mine_ani1_gld_007bf978;
        break;
      case 0x39:
        local_8 = (byte *)s_mine_ani1_cor_007bf954;
        break;
      case 0x4f:
        local_8 = (byte *)s_mine_ani1_met_007bf944;
        break;
      case 0x5e:
        local_8 = (byte *)s_corisi_ani1_cor_007bf964;
      }
      break;
    case 3:
  ...
  case 0x52:
    ...
    case 1:
    case 3:
      local_8 = (byte *)s_depo_ani1_lid_007bf998;
      break;
    case 2:
      iVar1 = *(int *)(param_1 + 0x4dc);
      if (iVar1 == 0xdc) {
        local_8 = (byte *)s_depo_ani1_gld_007bf9a8;
      }
      else if (iVar1 == 0xdd) {
        local_8 = (byte *)s_depo_ani1_cor_007bf9b8;
      }
      else if (iVar1 == 0xde) {
        local_8 = (byte *)s_depo_ani1_met_007bf9c8;
      }
    }
    break;
  case 0x60:
    ...
    case 1:
    case 3:
      local_8 = (byte *)s_silo_ani1_lid_007bf9d8;
      break;
    case 2:
      local_8 = (byte *)s_silo_ani1_cor_007bf9e8;
    }
  }
  ...
  iVar1 = STT3DSprC::LoadSequence(this,0xb,DAT_0080678c,local_8,0x1d);
  if (iVar1 != 0) {
