...

{
  ...
  AnonShape_006DDD50_309FA381 *this_00;
  int iVar7;
  undefined *puVar8;
  uint uVar9;
  ushort *puVar10;
  ...
  do {
    ...
    if (param_3 != 0) {
      ...
      *(char **)((int)this + iVar12 * 0x248 + 0x1950) = pcVar5;
...
LAB_0069177d:
      ...
      if (this_00 == (AnonShape_006DDD50_309FA381 *)0x0) goto LAB_0069177d;
    }
    iVar12 = local_20;
    iVar15 = (int)(0x28 / (longlong)*(int *)(&DAT_007dfa90 + local_20 * 4));
    FUN_006dc050((AnonShape_006DC050_D52EE3EA *)this_00,0,0,0,iVar15,iVar15,0,0xc0240000,0,
        ...
        if (((param_3 == 0) || (local_c != 0)) || (local_8 != 0)) {
          ...
          if (puVar10 != (ushort *)0x0) {
            ...
            local_28 = (int *)((int)local_14 +
                              ((int)local_1c + local_8 + iVar12 * 0x49) * 8 + 0x1954);
            *local_28 = (int)puVar4;
            ...
            *(undefined2 *)(*local_28 + 0x23) = 0;
            ...
            local_24 = (char *)0x0;
            *(short *)(*local_28 + 0x29) =
                 (short)(0x28 / (longlong)*(int *)(&DAT_007dfa90 + iVar12 * 4));
            *(short *)(*local_28 + 0x2b) =
                 (short)(0x28 / (longlong)*(int *)(&DAT_007dfa90 + iVar12 * 4));
            do {
              local_10 = (int *)0x0;
...
LAB_00691a65:
                    ...
                    *puVar4 = *(undefined4 *)(puVar10 + 2);
                    puVar4[1] = *(undefined4 *)(puVar10 + 4);
                    puVar4[2] = *(undefined4 *)(puVar10 + 6);
                    puVar4[3] = *(undefined4 *)(puVar10 + 8);
                  }
                  else if (local_c == 1) {
                    iVar15 = (int)local_10 * 0x10 + (local_18 + local_8 * 2) * 0xf0 + 0x2b68;
                    goto LAB_00691a65;
                  }
                  local_70 = (int)(short)*puVar10;
                  local_6c = puVar10 + 10;
                  local_68 = (int)(short)puVar10[1];
                  local_64 = puVar10 + (short)*puVar10 * 6 + 10;
                  ...
                  FUN_006ddbe0((AnonShape_006DDBE0_9835BAB9 *)this_00);
                  ...
                  if (iVar12 == 0) {
                    puVar11 = (undefined4 *)Library::DKW::LIB::FUN_006aac70(0x640);
                    *(undefined4 **)
                     ((int)local_14 +
                     (int)local_10 * 4 + (local_18 + ((int)local_1c + local_8) * 2) * 0x3c) =
                         puVar11;
                    puVar4 = (undefined4 *)this_00->field_000C;
                    for (iVar15 = 400; iVar12 = local_20, iVar15 != 0; iVar15 = iVar15 + -1) {
                      *puVar11 = *puVar4;
                      puVar4 = puVar4 + 1;
                      puVar11 = puVar11 + 1;
                    }
          ...
          if (puVar10 != (ushort *)0x0) {
            ...
            local_18 = local_c * 6 + iVar12 * 0x92;
          ...
          iVar15 = 0;
          do {
            local_24 = thunk_FUN_00692390(0,0,iVar15,iVar12);
            iVar7 = cMf32::RecChk(param_2,7,local_24);
            if (iVar7 != 0) break;
            pcVar5 = Library::Ourlib::MFSPR::mfSSprLoad(param_2,local_24,2,1);
            *(char **)((int)local_14 + (iVar15 + iVar12 * 0x92) * 4 + 0x1954) = pcVar5;
            thunk_FUN_00692ba0(pcVar5);
            iVar15 = iVar15 + 1;
          } while (iVar15 < 2);
          pvVar3 = local_14;
          ...
          if (iVar15 == 0) {
            ...
            *(char **)((int)pvVar3 + iVar12 * 0x248 + 0x1a74) = pcVar5;
            thunk_FUN_00692ba0(pcVar5);
          }
        }
        pvVar3 = local_14;
    ...
    if (this_00 != (AnonShape_006DDD50_309FA381 *)0x0) {
