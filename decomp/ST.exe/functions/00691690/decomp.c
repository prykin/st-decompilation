...

{
  ...
  if (local_30 != nullptr) {
    puVar4 = (byte *)(&DAT_007d5934);
    pbVar12 = local_30;
    do {
      uVar15 = *(undefined4 *)pbVar12;
      pbVar12 = pbVar12 + 4;
      *puVar4 = uVar15;
      puVar4 = (byte *)(puVar4 + 2);
      ...
      do {
        if (((param_3 == 0) || (local_c != 0)) || (local_8 != 0)) {
          ...
          if (puVar9_mg2 != nullptr) {
            ...
            puVar4 = (byte *)(Library::DKW::LIB::MemAlloc(0xa9));
...
LAB_00691a65:
          ...
          if (puVar9_mg4 != nullptr) {
            ...
            puVar4 = (byte *)(Library::DKW::LIB::MemAlloc(0x59));
          ...
          if (puVar9_mg6 != nullptr) {
            ...
            puVar4 = (byte *)(Library::DKW::LIB::MemAlloc(0x45));
            local_18 = local_c * 6 + iVar11 * 0x92;
