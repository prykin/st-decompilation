...

{
  ...
  this = local_c;
  if (iVar3 == 0) {
    if (*(uint *)((int)local_c + 0x8f) != 0) {
      FUN_006e56b0(*(void **)((int)local_c + 0xc),*(uint *)((int)local_c + 0x8f));
    ...
    if ((*(char *)((int)this + 0x66) == '\x01') &&
      ...
      iVar3 = __setjmp3(local_94,0,puVar9,pcVar10);
      if (iVar3 == 0) {
      ...
      if (local_8 != (undefined4 *)0x0) {
        ...
        iVar3 = *(int *)((int)local_c + (uint)*(byte *)((int)local_c + 0x6a) * 4 + 0x347);
        if (*(uint *)((int)local_c + 0x6b) < *(uint *)(iVar3 + 0xc)) {
          puVar4 = (undefined4 *)
                   (*(int *)(iVar3 + 8) * *(uint *)((int)local_c + 0x6b) + *(int *)(iVar3 + 0x1c));
        }
        else {
          puVar4 = (undefined4 *)0x0;
        }
        wsprintfA((LPSTR)&DAT_0080f33a,s__s_01d_02d_007cd074,PTR_DAT_0079c0dc,
                  *(byte *)((int)local_c + 0x6a) + 1,*puVar4);
        puVar5 = FUN_006f1ce0(0xc,(char *)&DAT_0080f33a,(int *)&local_10,0);
        if (puVar5 != (ushort *)0x0) {
          *(undefined1 *)((int)local_c + 0x67) = 1;
          puVar9 = &DAT_0080c967;
          puVar4 = &DAT_008087b6;
