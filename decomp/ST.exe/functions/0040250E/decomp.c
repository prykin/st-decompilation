...
void thunk_FUN_005bff00(int param_1,undefined4 param_2,int param_3,int param_4)

{
  ...
  if (iVar3 == 0) {
    if (param_1 != -1) {
      cVar1 = *(char *)((int)&DAT_0080c83a + *(byte *)(iStack_c + 0x69) + 3);
      uStack_8 = CONCAT31(uStack_8._1_3_,cVar1);
      wsprintfA((LPSTR)&DAT_0080f33a,&DAT_007c28fc,param_1);
      FUN_00710a90(*(int *)(iStack_c + 0x73),0,param_3 + 8,param_4 + 5,0x36,0x14);
      if (cVar1 == -1) {
        uVar4 = 8;
      }
      else {
    ...
    FUN_00710a90(*(int *)(iStack_c + 0x73),0,param_3 + 0x4c,param_4 + 5,0x36,0x14);
    if (cVar1 == -1) {
      uVar4 = 8;
    }
    else {
