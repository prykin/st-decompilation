...

{
  ...
  puVar1 = FUN_00709af0(DAT_00806774,CASE_1D,(byte *)s_star_pp_007d1c48,0xffffffff,0,1,0,
                        (undefined4 *)0x0);
  if ((puVar1 != (ushort *)0x0) && (DAT_00807598 != (void *)0x0)) {
    ...
    FUN_006ea960(DAT_00807598,local_8,(float)param_1 * _DAT_007904f8 * _DAT_007904f0,
    ...
    FUN_006ea4e0(DAT_00807598,local_8,1,0x5a,0x45);
