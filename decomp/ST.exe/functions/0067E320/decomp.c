...

{
  ...
  if (iVar3 != 0) {
    ...
    iVar4 = ReportDebugMessage("E:\\__titans\\ai\\ai_plr_d.cpp",0x1c7,0,iVar3,"%s",
                               "GetStrategNameDB");
    if (iVar4 != 0) {
  ...
  local_EAX_105 = FUN_006f2c00(PTR_s_STRATEG_0079d72c,1,param_2);
  uVar6 = 0xffffffff;
  do {
  ...
  do {
    ...
    iVar4 = cMf32::RecChk((cMf32 *)param_1,0xc,pCVar4);
    if (iVar4 != 0) {
      g_currentExceptionFrame = local_48.previous;
      return pCVar4;
    }
