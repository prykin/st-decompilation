...

{
  ...
  if (((g_playerRuntime[uVar2].field442_0x203 == 1) &&
      (g_playerRuntime[uVar2].field384_0x1b3 == 0x19a)) &&
     (g_playerRuntime[uVar2].field385_0x1b7 == (int)(char)param_1)) {
    FUN_006acc70((AnonShape_006ACC70_C8641025 *)g_playerRuntime[uVar2].field387_0x1bd,0,
    ...
    if (param_1._2_2_ == (short)param_2) {
      ...
      Library::DKW::TBL::FUN_006ae140
                ((uint *)g_playerRuntime[DAT_0080874d].field387_0x1bd,0,&param_3);
