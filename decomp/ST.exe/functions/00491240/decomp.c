...

{
  ...
  if (param_1 == *(int *)(this + 0x5a2)) {
    sVar1 = *(short *)(this + 0x5f);
    *(short *)(this + 0x5ac) = param_3;
    *(short *)(this + 0x5ae) = param_4;
    *(undefined2 *)(this + 0x5b0) = param_5;
    *(undefined4 *)(this + 0x5c0) = 1;
    *(short *)(this + 0x5aa) = param_2;
    switch((int)param_4 - (int)sVar1) {
    case 0:
      *(undefined2 *)(this + 0x5b2) = 0xffff;
      break;
    case 1:
      *(undefined2 *)(this + 0x5b4) = 0xffff;
      *(short *)(this + 0x5b2) = sVar1 + 1;
      break;
    case 2:
      *(short *)(this + 0x5b2) = sVar1 + 1;
      *(short *)(this + 0x5b4) = sVar1 + 2;
      *(undefined2 *)(this + 0x5b6) = 0xffff;
      break;
    case 3:
      *(short *)(this + 0x5b2) = sVar1 + 1;
      *(short *)(this + 0x5b4) = sVar1 + 2;
      *(short *)(this + 0x5b6) = sVar1 + 3;
      *(undefined2 *)(this + 0x5b8) = 0xffff;
      break;
    case 4:
      *(short *)(this + 0x5b2) = sVar1 + 1;
      *(short *)(this + 0x5b4) = sVar1 + 2;
      *(short *)(this + 0x5b6) = sVar1 + 3;
      *(short *)(this + 0x5b8) = sVar1 + 4;
      *(undefined2 *)(this + 0x5ba) = 0xffff;
      break;
    case -4:
      *(short *)(this + 0x5b2) = sVar1 + -1;
      *(short *)(this + 0x5b4) = sVar1 + -2;
    ...
    if (*(short *)(this + 0x5b2) != -1) {
      *(undefined4 *)(this + 0x5c4) = 0;
      *(undefined4 *)(this + 0x5bc) = 0;
      thunk_FUN_00481520(this,(int)param_2,(int)param_3,(int)*(short *)(this + 0x5b2));
    ...
    if ((*(short *)(this + 0x41) == (short)(*(short *)(this + 0x5aa) * 0xc9 + 100)) &&
      ...
      if (*(short *)(this + 0x6c) == *(short *)(this + 0x5b0)) {
        *(undefined4 *)(this + 0x5c4) = 6;
        return;
      }
      *(undefined4 *)(this + 0x5c4) = 5;
      return;
    }
