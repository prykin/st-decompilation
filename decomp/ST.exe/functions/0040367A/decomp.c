...

{
  ...
  if (0 < *(int *)((int)param_1 + 0x226)) {
    do {
      ...
      pvStack_c = (void *)iVar6;
      switch(*(undefined4 *)(iVar6 + 0x39 + *(int *)((int)param_1 + 0x233))) {
      case 1:
        uVar3 = thunk_FUN_006001e0(param_1,iStack_8);
        pvVar2 = DAT_00802a88;
        if (uVar3 == 0) {
          if (*(char *)((int)param_1 + 0x232) != '\0') {
            pvStack_c = *(void **)(iVar6 + 0x42 + *(int *)((int)param_1 + 0x233));
            iVar4 = iVar6 + *(int *)((int)param_1 + 0x233);
            if (DAT_00802a88 != (void *)0x0) {
              ...
              if ((((DAT_0080874d == -1) || (*(int *)((int)DAT_00802a88 + 0xf8) == 0)) ||
                  (((thunk_FUN_00558c00(DAT_00802a88,*(undefined4 *)((int)DAT_00802a88 + 0x10c),
                                        iVar4,iVar5,&iStack_1c,&iStack_24), iStack_10 < 0 ||
                    ((4 < iStack_10 || (iStack_1c < 0)))) ||
                   (*(int *)((int)pvVar2 + 0x30) <= iStack_1c)))) ||
                 ((((iVar4 = iStack_24 + (&DAT_0079aed0)[iStack_10], iVar4 < 0 ||
                    (*(int *)((int)pvVar2 + 0x34) <= iVar4)) || (*(int *)((int)pvVar2 + 0x4c) == 0))
                  || (*(char *)(iVar4 * *(int *)((int)pvVar2 + 0x30) + iStack_1c +
...
LAB_00600928:
      ...
      case 2:
        if (((*(uint *)(iVar4 + 0x3d) <= *(uint *)(DAT_00802a38 + 0xe4)) &&
            (iVar4 = thunk_FUN_005ff1f0(param_1,iStack_8,3,*(int *)((int)param_1 + 0x22e)),
            -1 < iVar4)) &&
           (iVar4 = thunk_FUN_005fff60(param_1,iStack_8,iVar4), iVar5 = iStack_8, iVar4 != 0)) {
          iVar4 = thunk_FUN_005fdb50(param_1,0,iStack_8);
      ...
      case 3:
        if (*(char *)((int)param_1 + 0x232) == '\0') {
          ...
          iStack_14 = thunk_FUN_004ac910(this,'\r');
          iStack_28 = thunk_FUN_004ac910(this,'\x0e');
          if (0x15 < iStack_14) {
            if (iStack_14 == 0x16) {
              STT3DSprC::StartShow(this,0xf,*(undefined4 *)(DAT_00802a38 + 0xe4));
            }
            iStack_10 = thunk_FUN_004ac910(this,'\x0f');
          ...
          thunk_FUN_004ad3c0(this,(float)iStack_28 * _DAT_007904f8 * _DAT_007904f0,
          ...
          if (DAT_00802a88 != (void *)0x0) {
            ...
            if (((((DAT_0080874d == -1) || (*(int *)((int)DAT_00802a88 + 0xf8) == 0)) ||
                 (thunk_FUN_00558c00(DAT_00802a88,*(undefined4 *)((int)DAT_00802a88 + 0x10c),iVar4,
                                     iVar6,&iStack_20,&iStack_2c), iStack_10 < 0)) ||
                (((4 < iStack_10 || (iStack_20 < 0)) ||
                 ((*(int *)((int)pvVar2 + 0x30) <= iStack_20 ||
                  ((iVar4 = (&DAT_0079aed0)[iStack_10] + iStack_2c, iVar4 < 0 ||
