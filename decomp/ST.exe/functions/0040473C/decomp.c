...
thunk_FUN_005f3bf0(void *this,int param_1,int param_2,undefined4 param_3,char param_4)
    ...
    *(int *)((int)this + 0xef) = iVar5;
    ...
    if (iVar5 < 0x1f7) {
      *(int *)((int)this + 0xf7) =
      ...
      lVar10 = __ftol();
      iVar9 = (int)lVar10 + 1;
      fVar4 = (float)(int)fStack_14 / (float)(iVar9 * 2);
      fStack_14 = (fVar4 * fVar4) / (float)(int)fStack_14;
      dVar1 = (double)(fVar4 / fStack_14 + _DAT_00790784);
      FUN_0072e150(SUB84(dVar1,0),(uint)((ulonglong)dVar1 >> 0x20));
      lVar10 = __ftol();
      iStack_10 = (int)lVar10;
      if (*(int *)((int)this + 0xef) != 0) {
        ...
        *(int *)((int)this + 0xcd) = (int)lVar10;
        lVar10 = __ftol();
        iStack_18 = -*(int *)((int)this + 0xdf);
        iVar6 = thunk_FUN_005f3b30((float)iStack_10,(float)*(int *)((int)this + 0xdf),
                                   (float)(0x4b0 - iVar6),(float)iStack_18,afStack_20);
        if (iVar6 != 0) {
          lVar11 = __ftol();
      ...
      *(int *)((int)this + 0xf7) = iVar5;
      if (iVar6 * iVar6 != 0) {
        ...
        *(int *)((int)this + 0xff) = iVar7;
        iStack_c = iVar6 * 0x1b9f;
        iVar9 = (iStack_c * iVar7) / 10000;
        iStack_10 = ((iStack_c / 100) * (iStack_c / 100)) / (iVar9 * 2);
        iVar8 = (int)((ulonglong)((longlong)iVar5 * -0x68db8bad) >> 0x20);
        iStack_18 = (iVar8 >> 0xc) - (iVar8 >> 0x1f);
        iVar5 = thunk_FUN_005f3b30((float)iStack_c / (float)iStack_10,(float)iVar6,
                                   (float)(((iVar9 - (iVar5 * iVar7) / 20000) -
                                           (int)*(short *)((int)this + 0x9b)) + 0x44c),
                                   (float)iStack_18,afStack_20);
        if (iVar5 != 0) {
          lVar10 = __ftol();
          ...
          *(int *)((int)this + 0xd7) =
               ((param_1 - *(short *)((int)this + 0xd1)) * iStack_10) / (int)fStack_14;
          *(int *)((int)this + 0xdb) =
               ((param_2 - *(short *)((int)this + 0xd3)) * iStack_10) / (int)fStack_14;
          uVar3 = *(undefined4 *)(DAT_00802a38 + 0xe4);
          *(undefined4 *)((int)this + 0xc9) = 1;
          *(undefined4 *)((int)this + 0xfb) = uVar3;
          *(int *)((int)this + 0xe7) = iStack_10;
