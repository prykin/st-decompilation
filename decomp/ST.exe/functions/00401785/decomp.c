...

{
  ...
  case 1:
    if ((*(uint *)((int)param_1 + 0x2e1) <= *(uint *)(DAT_00802a38 + 0xe4)) &&
  ...
  case 2:
    ...
    if (*(char *)((int)param_1 + 0x29f) == '\0') {
      if (*(char *)((int)param_1 + 0x29e) == '\0') {
        if ((*(int *)(DAT_00802a38 + 0xe4) + param_1[6] & 3U) != 0) {
          return;
        }
...
LAB_005f7400:
  ...
  case 3:
    *(int *)(*(int *)((int)param_1 + 0x2e6) + 0x20) =
    ...
    if (*(int *)(*(int *)((int)param_1 + 0x2e6) + 0x20) < 0x23) {
      thunk_FUN_005f9e40((int)param_1);
    }
    else {
  ...
  case 4:
    iVar5 = thunk_FUN_005fa180(param_1);
    if (iVar5 < 0) {
      if (*(int *)((int)param_1 + 0x2ea) != 0) {
        if (*(char *)((int)param_1 + 0x29e) != '\0') {
          thunk_FUN_005f9450((int)param_1);
...
LAB_005f79aa:
  ...
  case 8:
    if (*(int *)((int)param_1 + 0x2ea) == 0) {
      thunk_FUN_004162b0(param_1,&sStack_8,&sStack_6,&sStack_a);
      if ((int)sStack_8 != *(int *)((int)param_1 + 0x291)) {
        return;
      }
      if ((int)sStack_6 != *(int *)((int)param_1 + 0x295)) {
        return;
      }
      ...
      if (iVar5 != 0) {
        ...
        *(undefined2 *)puVar8 = *(undefined2 *)puStack_24;
        *(undefined1 *)((int)param_1 + param_1[0xa8] * 6 + 0x2a4) = 1;
        *(undefined4 *)((int)param_1 + (param_1[0xa8] + 0x71) * 6) = uStack_28;
        *(char *)((int)param_1 + param_1[0xa8] * 6 + 0x2a5) = (char)param_1[9];
        if (iVar5 == 2) {
          **(undefined4 **)((int)param_1 + 0x2e6) = uStack_2c;
        }
        ...
        iVar5 = thunk_FUN_005f95b0(param_1);
        if (iVar5 == 0) {
          return;
        }
        *(undefined4 *)(*(int *)((int)param_1 + 0x2e6) + 0x68) =
    ...
    *(undefined1 *)((int)param_1 + 699) = 1;
    *(undefined4 *)((int)param_1 + 0x2ef) = 0;
    *(int *)((int)param_1 + 0x2d9) = iVar5 + 0x32;
    *(undefined4 *)((int)param_1 + 0x76) = 1;
    if (0 < param_1[0xa8]) {
      *(undefined1 *)((int)param_1 + 0x29f) = 1;
      return;
...
LAB_005f7efc:
    *(undefined1 *)((int)param_1 + 0x29f) = 0;
    return;
  case 9:
    iVar5 = thunk_FUN_005f9cb0(param_1,*(int *)(DAT_00802a38 + 0xe4),&iStack_14,&iStack_18,
                               &iStack_10);
    if (iVar5 == 1) {
      *(int *)(*(int *)((int)param_1 + 0x2e6) + 0x14) = iStack_14;
      *(int *)(*(int *)((int)param_1 + 0x2e6) + 0x18) = iStack_18;
      *(int *)(*(int *)((int)param_1 + 0x2e6) + 0x1c) = iStack_10;
      *(int *)(*(int *)((int)param_1 + 0x2e6) + 0x20) =
           *(int *)(*(int *)((int)param_1 + 0x2e6) + 0x20) + 1;
    ...
    if (iVar5 == 3) {
      ...
      thunk_FUN_004162b0(param_1,&sStack_8,&sStack_6,&sStack_a);
      iVar5 = thunk_FUN_005fa360(param_1,(undefined4 *)auStack_1c,(int)sStack_8,(int)sStack_6,
                                 (int)sStack_a,&iStack_14,&iStack_18,&iStack_10);
      if (iVar5 != 0) {
        param_1[0xa8] = param_1[0xa8] + 1;
        iVar5 = thunk_FUN_005fb600(param_1);
        if (iVar5 == 0) {
          iVar5 = thunk_FUN_005fa7f0(param_1,iStack_14,iStack_18,iStack_10);
          if (iVar5 == 0) {
            return;
          }
          *(undefined4 *)((int)param_1 + 0x2dd) = 5;
          *(undefined1 *)((int)param_1 + 699) = 1;
          *(undefined1 *)((int)param_1 + 0x29d) = auStack_1c[0];
          *(undefined1 *)((int)param_1 + 0x29f) = 1;
          return;
        }
        *(undefined4 *)((int)param_1 + 0x2dd) = 0xc;
    ...
    break;
  case 10:
    iVar5 = thunk_FUN_005f9050(param_1,&iStack_10,&uStack_20);
    if (iVar5 != 0) {
      *(undefined4 *)((int)param_1 + 0x2dd) = 0xb;
      thunk_FUN_005fada0(param_1,iStack_10,uStack_20,1);
      return;
    }
    *(undefined4 *)((int)param_1 + 0x2dd) = 0xc;
    *(undefined4 *)((int)param_1 + 0x76) = 1;
    ...
    if (CONCAT31(extraout_var_00,bVar3) != 0) {
      ...
      *(undefined1 *)((int)param_1 + 0x29f) = 0;
      ...
      if (*(char *)((int)param_1 + 0x29e) == '\0') {
        iVar5 = thunk_FUN_005f89f0(param_1,2);
        if (iVar5 != 0) {
          uStack_20 = thunk_FUN_005fa7f0(param_1,*(undefined4 *)((int)param_1 + 0x291),
        ...
        *(int *)((int)param_1 + 0x2d9) = *(int *)(DAT_00802a38 + 0xe4) + 0x32;
        ...
        if (iVar5 != 0) {
          ...
          iVar5 = thunk_FUN_005fa360(param_1,(undefined4 *)auStack_1c,(int)sStack_8,(int)sStack_6,
                                     (int)sStack_a,&iStack_14,&iStack_18,&iStack_10);
          if ((iVar5 != 0) &&
             (iVar5 = thunk_FUN_005fa7f0(param_1,iStack_14,iStack_18,iStack_10), iVar5 != 0)) {
            *(undefined4 *)((int)param_1 + 0x2dd) = 5;
            *(undefined1 *)((int)param_1 + 699) = 1;
            *(undefined1 *)((int)param_1 + 0x29d) = auStack_1c[0];
            *(undefined1 *)((int)param_1 + 0x29f) = 0;
  ...
  case 0xc:
    ...
    if (*(char *)((int)param_1 + 0x29f) == '\0') {
      if (*(char *)((int)param_1 + 0x29e) == '\0') {
        if ((param_1[6] + *(uint *)(DAT_00802a38 + 0xe4) & 3) == 0) {
          thunk_FUN_005f9310(param_1,0);
          return;
        }
        if ((*(uint *)((int)param_1 + 0x2d9) < *(uint *)(DAT_00802a38 + 0xe4)) &&
