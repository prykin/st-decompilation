...
void __thiscall
FUN_00568dd0(void *this,undefined1 param_1,char *param_2,int param_3,int *param_4,int param_5)

{
  ...
  case 1:
    if (((DAT_00807300._1_1_ & 4) != 0) &&
       (puVar11 = (uint *)FUN_0071a990(*(int *)((int)local_8 + 0xdf3),param_3,-1,(undefined1 *)0x0),
       puVar11 != (uint *)0x0)) {
  ...
  case 2:
    ...
    if ((-1 < *param_4) && (-1 < param_4[1])) {
      uVar7 = *(int *)((int)local_8 + 0x10dd) - param_4[1];
      uVar13 = (int)uVar7 >> 0x1f;
      uVar8 = *(int *)((int)local_8 + 0x10d9) - *param_4;
      ...
      iVar4 = iVar4 + 1;
      *(int *)((int)local_8 + 0x10f1) = iVar4;
      iVar15 = *(int *)(&DAT_007c9788 + *(int *)((int)local_8 + 0x10e1) * 0x10);
      bVar3 = (byte)iVar15;
      if (iVar4 <= iVar15) {
        bVar3 = (byte)iVar4;
      }
    ...
    local_14 = *param_4;
    local_1c = puVar11;
    if (((int)local_14 < 0) || (local_10 = param_4[1], local_10 < 0)) {
      iVar15 = 10;
      iVar4 = 4;
LAB_0056959b:
  ...
  case 3:
    ...
    if ((-1 < *param_4) && (-1 < param_4[1])) {
      uVar9 = *(int *)((int)local_8 + 0x10dd) - param_4[1];
      uVar8 = (int)uVar9 >> 0x1f;
      uVar7 = *(int *)((int)local_8 + 0x10d9) - *param_4;
      ...
      iVar4 = iVar4 + 1;
      *(int *)((int)local_8 + 0x10f1) = iVar4;
      iVar15 = *(int *)((int)local_8 + 0x10e1) * 0x10;
...
LAB_005695ae:
  ...
  case 4:
    if (((DAT_00807300._1_1_ & 1) != 0) &&
      ...
      local_1c = (uint *)FUN_0071a990(*(int *)((int)pvVar14 + 0xdf3),param_3,-1,(undefined1 *)0x0);
  ...
  case 10:
    ...
    break;
  case 0xb:
    puVar11 = (uint *)FUN_00719d00(*(undefined4 *)((int)local_8 + 0xdef),param_2,0,0);
    if (puVar11 != (uint *)0x0) {
