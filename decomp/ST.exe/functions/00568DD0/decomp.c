...

{
  ...
  case SOUND_MODE_2:
    ...
    local_EAX_332 = FUN_0071a990(local_8->field_0DF3,soundId,-1,nullptr);
...
LAB_005695ae:
  ...
  case SOUND_MODE_4:
    if (((STPiece<1,1>(DAT_00807300) & 1) != 0) &&
      ...
      local_1c_mg0 = FUN_0071a990(pSVar14->field_0DF3,soundId,-1,nullptr);
  ...
  case SOUND_MODE_12:
    ...
    if ((soundName == nullptr) || (*soundName == '\0')) {
      if (0 < soundId) {
        puVar12_mg0 = FUN_0071a990(local_8->field_0DF3,soundId,-1,nullptr);
      }
LAB_00569cc6:
      ...
      if (g_cMf32_00806758 != nullptr) {
        puVar12_mg0 = (uint *)Library::Ourlib::MFWAV::mfWavLoad
