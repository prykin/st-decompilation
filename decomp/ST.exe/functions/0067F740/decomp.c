...

{
  ...
  /* ST_PSEUDO[dynamic_array_indexing]: expected DArrayAt<T>(g_array_00848A28, uVar1) (runtime stride) */
  if ((uVar1 < g_array_00848A28->count) &&
     (puVar2 = (undefined4 *)(g_array_00848A28->elementSize * uVar1 + (int)g_array_00848A28->data),
