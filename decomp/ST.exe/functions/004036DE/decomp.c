...

{
  ...
  iStack_10 = *(int *)(*(int *)(this + 0x29) + 0xc);
  puStack_c = (uint *)0x0;
  puStack_14 = (uint *)0x0;
  uStack_24 = 2;
  iStack_18 = 0;
  ...
  if (iVar4 == 0) {
    if ((param_1 == 0) || (param_1 == 1)) {
      ...
      *(undefined4 *)(pSStack_28 + 0x65) = 0;
      uStack_20 = 0;
      *(undefined4 *)(pSStack_28 + 0x2bd) = *(undefined4 *)(pSStack_28 + 0x18c);
      *(undefined2 *)(pSStack_28 + 0x2c1) = *(undefined2 *)(pSStack_28 + 400);
      uStack_30 = *(undefined2 *)(pSStack_28 + 0x2bd);
      uStack_34 = *(undefined4 *)(DAT_00802a38 + 0xe4);
      uStack_2c = *(undefined2 *)(pSStack_28 + 0x2c1);
      uStack_2e = *(undefined2 *)(pSStack_28 + 0x2bf);
      puVar6 = puStack_14;
      uStack_1c = uStack_34;
      if (0 < iStack_10) {
        do {
      ...
      STAllPlayersC::RegisterPGPair
                (DAT_007fa174,CONCAT31((int3)((uint)iStack_10 >> 8),pSVar2[0x24]),puVar6,puStack_c);
      if (puVar6 != (uint *)0x0) {
