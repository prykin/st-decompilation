...

{
  ...
  pCVar2 = local_8;
  if (iVar3 == 0) {
    thunk_FUN_00540760(*(undefined4 **)&local_8->field_0x190,0,0,'\x01',
                       *(byte **)&local_8->field_0x994);
    ccFntTy::SetSurf(*(ccFntTy **)&pCVar2->field_0x1b8,*(int *)&pCVar2->field_0x190,0,5,6,0x2a,10);
    iVar8 = -1;
    iVar7 = -1;
    ...
    ccFntTy::WrTxt(*(ccFntTy **)&pCVar2->field_0x1b8,puVar4,iVar5,iVar6,iVar3,iVar7,iVar8);
    if (-1 < (int)*(uint *)&pCVar2->field_0x158) {
      Library::DKW::DDX::FUN_006b3640
                (DAT_008075a8,*(uint *)&pCVar2->field_0x158,0xffffffff,*(uint *)&pCVar2->field_0x4c,
                 *(uint *)&pCVar2->field_0xa4);
    }
