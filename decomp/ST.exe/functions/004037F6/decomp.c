...
undefined4 __fastcall thunk_FUN_006367d0(int *param_1)

{
  ...
  bVar1 = false;
  if (param_1[0xb] != 0) {
    uVar10 = *(int *)(DAT_00802a38 + 0xe4) - param_1[0xc];
    iVar2 = param_1[1];
    if (iVar2 != 0) {
      if (iVar2 == 1) {
        ...
        if (0 < param_1[2]) {
          do {
            iVar11 = *param_1;
            iStack_8 = 0;
            uVar8 = iVar11 * iStack_c;
            if (iStack_c == param_1[9]) {
              if (0 < iVar11) {
                do {
                  iVar11 = param_1[0xb];
                     ...
                     (iVar11 = *(int *)(iVar11 + 8) * uVar8 + *(int *)(iVar11 + 0x1c), iVar11 != 0))
                  {
                    if (iVar2 < 300) {
                      ...
                      *(int *)(iVar11 + 0x22) = param_1[2] + 4;
                      ...
                      if (iVar5 < 0) {
                        sStack_10 = (((short)(iVar5 / 0xc9) + sVar6) -
                      ...
                      bVar1 = thunk_FUN_004961b0(sStack_10,sVar6,sVar7);
