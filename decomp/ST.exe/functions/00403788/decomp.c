...
void __thiscall thunk_FUN_00424620(void *this,uint param_1)

{
  ...
  if (((param_1 & 1) != 0) && ((*(uint *)((int)this + 0x35) & 1) != 0)) {
    *(uint *)((int)this + 0x35) = *(uint *)((int)this + 0x35) & 0xfffffffe;
  }
  if (((param_1 & 2) != 0) && ((*(uint *)((int)this + 0x35) & 2) != 0)) {
    *(uint *)((int)this + 0x35) = *(uint *)((int)this + 0x35) & 0xfffffffd;
  }
  if (((param_1 & 4) != 0) && ((*(uint *)((int)this + 0x35) & 4) != 0)) {
    *(uint *)((int)this + 0x35) = *(uint *)((int)this + 0x35) & 0xfffffffb;
  }
  if (((param_1 & 8) != 0) && ((*(uint *)((int)this + 0x35) & 8) != 0)) {
    *(uint *)((int)this + 0x35) = *(uint *)((int)this + 0x35) & 0xfffffff7;
  }
