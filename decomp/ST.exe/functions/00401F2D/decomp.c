...
undefined4 thunk_FUN_005ec9f0(int param_1)

{
  ...
  this = (void *)((int)pvStack_8 + 0x1d5);
  if (param_1 == 0) {
    thunk_FUN_004ad380(this,DAT_007cde88,DAT_007cde8c);
    iVar1 = thunk_FUN_004ab880(0xe,DAT_00806774,ppuStack_10[*(int *)((int)pvStack_8 + 0x2b1)],0x1d);
    if (iVar1 != 0) {
      return uStack_c;
    }
    thunk_FUN_004ac610(this,'\x0e');
    thunk_FUN_004abe40(this,'\x0e',*(undefined4 *)((int)pvStack_8 + 0x2ca));
    thunk_FUN_004ad3c0(this,(float)*(int *)((int)pvStack_8 + 0x2be) * _DAT_007904f8 * _DAT_007904f0,
                       (float)*(int *)((int)pvStack_8 + 0x2c2) * _DAT_007904f8 * _DAT_007904f0,
                       (float)*(int *)((int)pvStack_8 + 0x2c6) * _DAT_007904f8 * _DAT_007904f0 +
                       _DAT_007904fc);
    thunk_FUN_004ac1a0(0xe,*(undefined4 *)(DAT_00802a38 + 0xe4));
    thunk_FUN_004abf00('\x0e',*(int *)((int)pvStack_8 + 0x2ba) / 0xf);
    thunk_FUN_00417e70(pvStack_8,0x18);
    *(undefined1 *)((int)pvStack_8 + 0x2b9) = 1;
    uVar2 = thunk_FUN_004ad650((int)this);
    *(undefined4 *)((int)pvStack_8 + 0x2d6) = uVar2;
    if (*(char *)((int)pvStack_8 + 0x235) == '\x01') {
    ...
    thunk_FUN_004ab880(8,DAT_00806774,
                       (byte *)(s_expl_bt0_007cdf30 + (uint)*(byte *)((int)pvStack_8 + 0x2df) * 0x32
                               ),0x1d);
    thunk_FUN_004ab880(9,DAT_00806764,
                       (byte *)(s_expl_bbt0_007cdf3a +
                               (uint)*(byte *)((int)pvStack_8 + 0x2df) * 0x32),0x1d);
    thunk_FUN_004ab880(10,DAT_00806774,
                       (byte *)(s_expmask3_007cdf44 + (uint)*(byte *)((int)pvStack_8 + 0x2df) * 0x32
                               ),0x1d);
