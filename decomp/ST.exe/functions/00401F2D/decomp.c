...

{
  ...
  if (param_1 == 0) {
    ...
    iVar1 = STT3DSprC::LoadSequence
                      (this,0xe,DAT_00806774,ppuStack_10[*(int *)((int)pvStack_8 + 0x2b1)],0x1d);
    if (iVar1 != 0) {
      return uStack_c;
    }
    thunk_FUN_004ac610(this,'\x0e');
    STT3DSprC::SetCurFase(this,'\x0e',*(undefined4 *)((int)pvStack_8 + 0x2ca));
    ...
    STT3DSprC::SetCurShad(this,'\x0e',*(int *)((int)pvStack_8 + 0x2ba) / 0xf);
    ...
    *(undefined4 *)((int)pvStack_8 + 0x2d6) = uVar2;
    ...
    STT3DSprC::LoadSequence
              (this,8,DAT_00806774,
               (byte *)(s_expl_bt0_007cdf30 + (uint)*(byte *)((int)pvStack_8 + 0x2df) * 0x32),0x1d);
    STT3DSprC::LoadSequence
              (this,9,DAT_00806764,
               (byte *)(s_expl_bbt0_007cdf3a + (uint)*(byte *)((int)pvStack_8 + 0x2df) * 0x32),0x1d)
    ;
    STT3DSprC::LoadSequence
              (this,10,DAT_00806774,
               (byte *)(s_expmask3_007cdf44 + (uint)*(byte *)((int)pvStack_8 + 0x2df) * 0x32),0x1d);
