...

{
  ...
  if (iVar6 != 0) {
    ...
    iVar16 = ReportDebugMessage(s_E____titans_Andrey_cp_sup_cpp_007c1a4c,0x146,0,iVar6,&DAT_007a4ccc
  ...
  puVar14 = (undefined4 *)&local_38->field_0x31c;
...
LAB_004f27ff:
  ...
  if (pAVar13->field_001E == 0xff) {
    ...
    iVar10 = -1;
    iVar16 = -2;
    LoadResourceString(0x2715,HINSTANCE_00807618);
    ccFntTy::WrTxt(pCVar5->field_01B8,extraout_EAX,iVar16,iVar10,uVar7,iVar18,iVar19);
  }
  local_5 = '\x01';
  if (*(short *)&pAVar13->field_0x26 == -1) {
    ...
    wsprintfA(&pCVar5->field_0x1e1,&DAT_007c1890,*(short *)&pAVar13->field_0x26);
  }
  if (local_5 != '\0') {
    local_34 = 0;
