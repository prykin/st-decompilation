  ...
  if (*(short *)((int)param_1 + 0x5ec) != 3) {
    ...
    if ((iVar4 <= iVar5) && (0 < iVar5)) {
      ...
      if ((int)(iVar4 + auStack_74[2]) < iVar5 / 0x28 + 1) {
        ...
        if (0 < (int)uVar10) {
          do {
            if (((iVar4 != 0) && (-1 < (int)uVar7)) && ((int)uVar7 < (int)uVar10)) {
              if (uVar7 < uVar10) {
              ...
              if (((piVar6[1] != 0) && (*piVar6 != 0)) && (&stack0x00000000 != (undefined1 *)0x74))
              {
                thunk_FUN_0068fd00(auStack_74);
              }
            }
...
LAB_0067a8e6:
        ...
        if (uVar10 != 0) {
          ...
          iVar11 = 0xdc;
LAB_0067a9a0:
          thunk_FUN_004eb300(uVar7,iVar11,0xdd,iVar5);
        }
      }
