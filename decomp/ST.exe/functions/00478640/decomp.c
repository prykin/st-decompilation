...

{
  ...
  if ((param_1 == 0) || (param_1 == 1)) {
    ...
    this->field_02C4 = 0;
    iVar12 = thunk_FUN_004d6df0((int *)this);
    if ((iVar12 == 0) ||
       ((iVar12 = CheckForReplenisher(this,unaff_EDI), iVar12 == 1 &&
    ...
    *(int *)&this->field_0x619 = *(int *)&this->field_0x3f7;
    if (*(int *)&this->field_0x3f7 == 0) {
      ...
      *(short *)&this->field_0x621 = sVar4;
      ...
      iVar12 = (*pSVar5->vtable->GetObjectTypeId)(pSVar5);
      if (iVar12 != 0x62) {
        return 0;
      }
      ...
      iVar12 = (*pSVar5->vtable[5].slots_00_28[2])();
      if (iVar12 == 0) {
        return 0;
      }
      *(undefined4 *)&this->field_0x623 = *(undefined4 *)&pSVar5->field_0x18;
      ...
      iVar12 = thunk_FUN_004934b0(this,(short *)&this->field_0x61d,(short *)&this->field_0x61f,
    ...
    pSVar8 = this->vtable;
LAB_0047926a:
    iVar12 = (*pSVar8->vfunc_D8)();
    return (-(uint)(iVar12 != 0) & 0xfffffffd) + 2;
  }
  iVar12 = this->field_0631;
  if (iVar12 == 0) {
    iVar12 = this->field_062D + 1;
    this->field_062D = iVar12;
    pSVar8 = this->vtable;
    if (iVar12 != 2) goto LAB_0047926a;
    iVar12 = (*pSVar8->vfunc_D8)();
    if (iVar12 != 0) {
      return -1;
    }
      ...
      if ((iVar12 != 0) &&
        ...
        if (((-1 < sVar2) &&
           ...
           (((-1 < sVar3 && (sVar3 < g_worldGrid.sizeZ)) &&
            ((pSVar5 = g_worldGrid.cells
             ...
             ((*(int *)&pSVar5->field_0x18 == *(int *)&this->field_0x623 &&
              (iVar12 = (*pSVar5->vtable[5].slots_00_28[2])(), iVar12 != 0)))))))) {
          this->field_00B7 = 0;
          iVar12 = SubmarineTitans::Recovered::HiddenThis::AnonReceiver_00493610::thunk_FUN_00493610
          ...
          if (iVar12 == 1) {
            ...
            iVar13 = (int)*(short *)&this->field_0x629;
            iVar12 = (int)*(short *)&this->field_0x627;
            this->field_0631 = 3;
...
LAB_0047885b:
    ...
    case 3:
      ...
      return 2;
    case -1:
      iVar12 = ReportDebugMessage(s_E____titans_wlad_To_boat_cpp_007a9d3c,0x33d4,0,0,&DAT_007a4ccc,
...
LAB_00478b7a:
    ...
    if (iVar12 != 3) {
      if (iVar12 != 4) {
        ...
        iVar12 = CONCAT22(extraout_var_05,*(undefined2 *)&this->field_0x61f);
        ...
        SubmarineTitans::Recovered::HiddenThis::AnonReceiver_0048DFD0::thunk_FUN_0048dfd0
                  ((AnonReceiver_0048DFD0 *)this,iVar9,iVar12,(uint)*(ushort *)&this->field_0x621,
                   iVar9,iVar12,(int *)(uint)*(ushort *)&this->field_0x621,3,
...
LAB_00478b1a:
      ...
      if ((((sVar2 < 0) || (g_worldGrid.sizeX <= sVar2)) || (sVar4 < 0)) ||
        ...
        iVar13 = (int)*(short *)&this->field_0x61f;
        iVar12 = (int)*(short *)&this->field_0x61d;
        this->field_0631 = 1;
        this->field_00B7 = 3;
        goto cf_common_exit_00478B83;
      }
      ...
      (*this->vtable->vfunc_90)(3,0x1b2);
      uVar14 = (undefined2)((uint)extraout_EDX >> 0x10);
      uVar11 = (undefined2)((uint)extraout_ECX >> 0x10);
      puVar1 = &this->field_0x62b;
      if (*(int *)&pSVar5[0x1d].field_0x18 == 0) {
LAB_00478f91:
        iVar12 = CONCAT22(uVar11,*(undefined2 *)&this->field_0x61f);
        iVar9 = CONCAT22(uVar14,*(undefined2 *)&this->field_0x61d);
        SubmarineTitans::Recovered::HiddenThis::AnonReceiver_0048DFD0::thunk_FUN_0048dfd0
                  ((AnonReceiver_0048DFD0 *)this,iVar9,iVar12,(uint)*(ushort *)&this->field_0x621,
                   iVar9,iVar12,(int *)(uint)*(ushort *)&this->field_0x621,3,
        ...
        uVar11 = (undefined2)((uint)uVar10 >> 0x10);
        iVar12 = extraout_EDX;
        if (&this->field_0x629 != (undefined1 *)0x0) {
          iVar12 = pSVar5[0x1d].value_20;
          *(int *)&this->field_0x629 = iVar12;
        }
...
LAB_00478ff2:
    ...
    case 3:
      iVar12 = SubmarineTitans::Recovered::HiddenThis::AnonReceiver_00493610::thunk_FUN_00493610
                         ((AnonReceiver_00493610 *)this,(short *)&this->field_0x627,
                          (short *)&this->field_0x629,(short *)&this->field_0x62b);
      if (iVar12 != 1) goto LAB_00478d20;
      sVar2 = *(short *)&this->field_0x62b;
      sVar3 = *(short *)&this->field_0x629;
      sVar4 = *(short *)&this->field_0x627;
      break;
    case -1:
      iVar12 = ReportDebugMessage(s_E____titans_wlad_To_boat_cpp_007a9d3c,0x3451,0,0,&DAT_007a4ccc,
...
cf_common_exit_00478B83:
  sub_00481520(this,iVar12,iVar13,iVar9);
  sub_00460260(this,0);
  return 2;
}
