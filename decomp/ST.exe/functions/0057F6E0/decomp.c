...

{
  ...
  if (iVar6 != 0) {
    ...
    iVar11 = ReportDebugMessage(s_E____titans_Igor_To_gold_cpp_007cb19c,0x2b3,0,iVar6,&DAT_007a4ccc,
  ...
  case CASE_DC:
    ...
    do {
      ...
      if (((((iVar11 < g_worldGrid.sizeX) && (-1 < iVar11)) &&
        ...
        iVar11 = STT3DSprC::LoadSequence(pSVar7,0xe,DAT_00806774,pcVar8,bVar14);
        if (iVar11 != 0) goto cf_break_loop_0057FAA5;
        bVar14 = 0x1d;
        pcVar8 = (char *)thunk_FUN_0057f3a0(this_00,local_c,1);
        iVar11 = STT3DSprC::LoadSequence(pSVar7,0xd,DAT_00806774,pcVar8,bVar14);
        if (iVar11 != 0) goto cf_break_loop_0057FAA5;
