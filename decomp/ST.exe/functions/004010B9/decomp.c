...
void thunk_FUN_00543600(undefined4 param_1)

{
  ...
  if (iVar3 == 0) {
    ...
    FUN_006b88d0((undefined4 *)(iStack_c + 0xad),DAT_0080759c,0,(BITMAPINFO *)0x0,0x8000000,0,
                 (BITMAPINFO *)0x0,0);
    ...
    puVar4 = FUN_00709af0(DAT_00806784,0xb,(byte *)s_INF_DEEPS_007c7dc8,0xffffffff,0,1,0,
                          (undefined4 *)0x0);
    *(ushort **)(iStack_c + 0x4e3) = puVar4;
    puVar4 = FUN_00709af0(DAT_00806784,0x13,(byte *)s_CUR_CONFIRM_007c7db8,0xffffffff,0,1,0,
                          (undefined4 *)0x0);
    *(ushort **)(iStack_c + 0x4e7) = puVar4;
    puStack_8 = FUN_006f1ce0(1,s_CURSOR_PAL_007c7da8,(int *)0x0,1);
    puVar4 = puStack_8 + 0x14;
    iVar3 = 1;
    uVar5 = FUN_006b4fe0((int)puStack_8);
    uVar6 = FUN_006b50c0(800,0x96,(uint)puStack_8[7],uVar5,(undefined4 *)puVar4,iVar3);
    *(undefined4 *)(iStack_c + 0x4d2) = uVar6;
    FUN_006f20e0((uint *)&puStack_8);
    puVar1 = (uint *)(iStack_c + 0x4d6);
    FUN_006b2330((uint)DAT_008075a8,puVar1,1,0x4047ff,0,0,*(uint *)(iStack_c + 0x4d2));
