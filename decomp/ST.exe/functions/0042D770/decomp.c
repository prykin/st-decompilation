  ...
  *param_2 = (int)puVar3;
  ...
  if (0 < iVar1) {
    do {
      ...
      if ((short)local_c != -1) {
        uVar4 = thunk_FUN_0042b620(param_1,local_c,1);
        iVar5 = thunk_FUN_00493cd0(uVar4);
        puVar3 = local_10;
        if ((iVar5 == 0) &&
           (local_28[0] = CONCAT22((short)(uVar4 >> 0x10),*(short *)(uVar4 + 0x30)),
           *(short *)(uVar4 + 0x30) != -1)) {
          local_1c = iVar5;
          FUN_006ae1c0(local_10,local_28);
          FUN_006ae1c0((uint *)*param_2,&local_c);
          puVar3 = local_10;
        }
      }
      local_14 = local_14 + 1;
