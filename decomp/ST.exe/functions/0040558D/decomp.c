...
undefined4 __fastcall thunk_FUN_004c5f30(int param_1)

{
  ...
  if (*(int *)(param_1 + 0x4d0) == 0) {
    uStack_8 = thunk_FUN_004e81b0(*(int *)(param_1 + 0x24),*(int *)(param_1 + 0x235),0);
    uStack_8 = *(int *)(param_1 + 0x5b0) - uStack_8;
    if (uStack_8 < 0) {
      uStack_8 = 0;
    }
    ...
    iVar1 = thunk_FUN_00581120(uStack_8,iVar1,iVar2,iVar3,5,*(undefined4 *)(param_1 + 0x24),
