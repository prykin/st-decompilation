  ...
  if (hFindFile != (HANDLE)0xffffffff) {
    do {
      ...
      if (((byte)_Stack_1f4.dwFileAttributes & 0x10) == 0) {
        ...
        uVar23 = 0;
        uStack_8 = 0;
        FUN_0072e730((byte *)pCVar22,(byte *)0x0,(byte *)0x0,abStack_2f8,(byte *)0x0);
        puStack_b4 = DAT_00858df8;
        DAT_00858df8 = &puStack_b4;
        iVar6 = __setjmp3(auStack_b0,0,pCVar22,uVar23);
        this_01 = pOStack_10;
        ...
        if (iVar6 == 0) {
          ...
          puVar8 = FUN_006f0ec0(0x345,(byte *)(pOStack_10 + 0x6c),0,0,0);
          puVar9 = FUN_006f1ce0(0x80,PTR_s_SAVE_DESC_0079ad04,(int *)&puStack_1c,0);
    ...
    *(undefined4 *)(this_01 + 0x2c) = *(undefined4 *)(this_01 + 0x1f1);
    ...
    if (1 < uVar14) {
      do {
        ...
        if (uVar14 != 1) {
          do {
            FUN_006acc70(*(int *)(this_01 + 0x1ed),uVar15,&FStack_2c.dwLowDateTime);
            uVar1 = uVar15 + 1;
