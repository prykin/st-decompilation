...

{
  ...
  if ((param_1 < 0) || (9 < param_1)) {
    RaiseInternalException(-0x5001fff7,DAT_007ed77c,s_E____titans_wlad_to_allpl_cpp_007a6004,0x170e)
    ;
  }
  this_00 = pSStack_2c;
    ...
    if (iVar3 == 0x19a) {
      if (*(int *)((int)&DAT_007f5023 + iVar10) == 0) {
        *(undefined4 *)((int)&DAT_007f5023 + iVar10) = 1;
        ResetActivityFromTmp(pSStack_2c,(char)uStack_8,0,0,0);
        iVar3 = *(int *)((int)&DAT_007f4fd3 + iVar10);
        if (iVar3 < 0x19b) {
          if (iVar3 == 0x19a) {
            iVar3 = CheckTmps(uStack_8,1,0x19a,(char)piVar1[1],*(uint **)((int)piVar1 + 10),0);
            if (-1 < iVar3) {
              ActivateTV(this_00,(char)uStack_8,1,iVar3);
              goto LAB_0043a47c;
            }
...
LAB_00439cc7:
      ...
      if (iVar3 < 0x19b) {
        if (iVar3 == 0x19a) {
          ...
          if (iVar3 < 0) {
            PushTV((char)uStack_8,1);
            ResetActivityFromTmp(this_00,(char)uStack_8,1,1,0);
...
LAB_00439b10:
    ...
    if (0x5a < iVar3) {
      if (iVar3 == 0x172) {
        uVar5 = GetObjPtr(pSStack_2c,0xffffffff,CONCAT22(uVar9,(short)piVar1[2]),2);
        uVar4 = uStack_8;
...
LAB_0043986a:
            iVar3 = CheckTmps(uStack_8,1,*(int *)(uVar5 + 0x20),*(char *)(uVar5 + 0x24),(uint *)0x0,
...
LAB_00439cfb:
    ...
    if (iVar3 != 0x5a) {
      if (iVar3 == 0) {
        RaiseInternalException
                  (-0x5001fff7,DAT_007ed77c,s_E____titans_wlad_to_allpl_cpp_007a6004,0x1713);
      }
      ...
      if (*(int *)((int)&DAT_007f5023 + iVar10) == 0) {
        ...
        if (iVar3 == 0) {
LAB_00439369:
          iVar3 = CheckTmps(uStack_8,0,0x3c,(char)piVar1[1],*(uint **)((int)piVar1 + 10),0);
          if (0 < iVar3) {
            ActivateTV(this_00,(char)uStack_8,0,iVar3);
        ...
        if (iVar3 == 0x3c) {
          ...
          if ((*(uint *)((int)&DAT_007f4f97 + iVar10) == uStack_20) && (piVar1[1] == uStack_20)) {
            CalibrateTmp(this_00,(char)uStack_8,0,1,*(uint **)((int)piVar1 + 10),(int *)&pbStack_c,
                         (int *)0x0,(int *)0x0);
            ResetActivityFromObjs(this_00,uStack_8,0x3c,(int)pbStack_c,0,0);
            FUN_006ae110(pbStack_c);
          }
          else {
            ResetActivityFromTmp(this_00,(char)uStack_8,0,1,0);
          }
          goto LAB_0043953a;
        }
        if (iVar3 != 0x1ae) {
...
LAB_00439469:
        ...
        *(undefined4 *)((int)&DAT_007f5023 + iVar10) = 0;
        ResetActivityFromTmp(this_00,(char)uStack_8,1,0,0);
        iVar3 = *(int *)((int)&DAT_007f4f83 + iVar10);
...
LAB_00439566:
    ...
    uVar5 = GetObjPtr(pSStack_2c,0xffffffff,CONCAT22(uVar9,(short)piVar1[2]),4);
    uVar4 = uStack_8;
    cVar11 = (char)uStack_8;
    if (*(int *)((int)&DAT_007f5023 + iVar10) != 0) {
      if (*(int *)((int)&DAT_007f5023 + iVar10) != 1) {
...
LAB_0043a470:
    ...
    if (iVar3 == 0x1a4) {
      uVar5 = GetObjPtr(pSStack_2c,0xffffffff,(uint)*(ushort *)(piVar1 + 2),5);
      uVar4 = uStack_8;
      cVar11 = (char)uStack_8;
      if (*(int *)((int)&DAT_007f5023 + iVar10) != 0) {
        if (*(int *)((int)&DAT_007f5023 + iVar10) != 1) {
...
LAB_0043a463:
    ...
    if (iVar3 != 0x1ae) {
      ...
      uVar5 = GetObjPtr(pSStack_2c,0xffffffff,(uint)*(ushort *)(piVar1 + 2),6);
      uVar4 = uStack_8;
      cVar11 = (char)uStack_8;
      if (*(int *)((int)&DAT_007f5023 + iVar10) == 0) {
        *(undefined4 *)((int)&DAT_007f5023 + iVar10) = 1;
...
LAB_00439dfb:
    ...
    uStack_20 = GetObjPtr(pSStack_2c,(uint)*(byte *)(piVar1 + 1),
...
LAB_0043a177:
        uVar4 = uStack_8;
        iVar3 = CheckTmps(uStack_8,0,*(int *)(uStack_20 + 0x20),(char)piVar1[1],(uint *)0x0,
...
LAB_0043a47c:
  if (((iStack_24 == 1) &&
      ...
      iVar3 = GetCamPoint(*piStack_28,CONCAT31((int3)(uVar5 >> 8),(char)piStack_28[1]),
                          *(int *)((int)piStack_28 + 10),uVar5,&iStack_18,&iStack_14,&iStack_10,
                          &uStack_1c), iVar3 == 0)) &&
