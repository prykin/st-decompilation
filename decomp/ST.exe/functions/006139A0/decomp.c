...

{
  ...
  iVar7 = *(int *)(DAT_00802a38 + 0xe4);
  *(int *)((int)this + 0x298) = iVar7;
  local_14 = (iVar7 - iVar5) * *(int *)((int)this + 0x288);
  iVar7 = *(int *)((int)this + 0x28c) + local_14;
    ...
    *(undefined4 **)((int)this + 0x2d9) = local_c;
    if ((2 < *(int *)((int)this + 0x2d5)) && (*(int *)((int)this + 0x2d5) + -3 <= (int)local_c)) {
      if (*(char *)((int)this + 0x2ea) != '\0') {
        iVar5 = thunk_FUN_00616280(this,&local_24,&local_20,&local_1c);
        if ((-1 < iVar5) &&
           (iVar5 = thunk_FUN_00616a80(this,local_24,local_20,local_1c,param_1,param_2,param_3),
           iVar5 != 0)) {
          return 1;
        }
      ...
      if (*(int *)((int)this + 0x2d1) != 0) {
        ...
        iVar5 = thunk_FUN_006151e0(this,local_c,iVar3,iVar7,iVar5);
    ...
    if (*(int *)((int)this + 0x2d5) + -1 <= iVar7) {
      ...
      *(undefined4 *)((int)this + 0x256) = 2;
LAB_00613c8b:
      iVar5 = thunk_FUN_006173a0(this,local_14,param_1,param_2,param_3);
      if (0 < iVar5) {
        return iVar5;
      }
  ...
  if (iVar7 == 0) {
    local_14 = (iVar6 * 51000) / (*(int *)(&DAT_007cfe74 + *(short *)(iVar5 + 6) * 4) * 0xc9);
  }
  else {
    if (iVar7 == 8) {
      local_14 = (*(int *)((int)this + 0x2e1) * iVar6) / *(int *)(iVar5 + 8);
    }
    else {
      local_14 = (iVar6 * 51000) / (*(int *)(&DAT_007cfe74 + *(short *)(iVar5 + 6) * 4) * 0xc9);
    }
    local_18 = thunk_FUN_006141b0(this,local_14,iVar7,&local_28,&local_10);
  }
  psVar1 = (short *)(*(int *)((int)this + 0x2dd) + *(int *)((int)this + 0x2d9) * 0x1c);
  local_8 = (*(int *)((int)this + 0x27c) * iVar6) / 10000 + (int)*psVar1;
  local_c = (undefined4 *)((*(int *)((int)this + 0x280) * iVar6) / 10000 + (int)psVar1[1]);
  ...
  if (local_18 != 0) {
    ...
    iVar5 = iVar5 + (*(int *)(psVar1 + 10) * local_10) / 10000;
  }
  if (((*(int *)((int)this + 0x2d9) == 0) && (*(int *)((int)this + 0x278) != 0)) && (local_14 != 0))
  {
    ...
    iVar5 = iVar5 + (*(short *)((int)this + 0x270) * local_14) / 0x33;
  }
  *param_1 = local_8;
  *param_2 = (int)local_c;
  *param_3 = iVar5;
