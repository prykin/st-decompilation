...

{
  ...
  if (*(int *)((int)param_1 + 0x7e2) == 0) {
    /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
    if (*(int *)((int)param_1 + 0x7a2) != 0) goto LAB_00483342;
  }
  /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
  else if ((*(int *)((int)param_1 + 0x7a2) != 0) || (0x27 < *(int *)((int)param_1 + 0x72a))) {
/* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
LAB_00483342:
    this = STAllPlayersC::GetObjPtr
                     (g_allPlayers_007FA174,*(char *)((int)param_1 + 0x487),
                      *(ushort *)((int)param_1 + 0x48b),
    ...
    if (*(char *)((int)param_1 + 0x2b2) != '\0') {
      ...
      do {
        ...
        /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
        sVar7 = *(short *)((int)param_1 + 0x41) + (short)*puVar5;
