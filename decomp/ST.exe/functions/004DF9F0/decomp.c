...

{
  ...
  array = g_playerRuntime[(int)this->field_0024].field2165_0x9d2;
  if (array != (DArrayTy *)0x0) {
    ...
    if ((g_playerRuntime[(int)this->field_0024].field2165_0x9d2)->count == 0) {
      DArrayDestroy(g_playerRuntime[(int)this->field_0024].field2165_0x9d2);
      g_playerRuntime[(int)this->field_0024].field2165_0x9d2 = (DArrayTy *)0x0;
    }
  }
  return 0;
}
