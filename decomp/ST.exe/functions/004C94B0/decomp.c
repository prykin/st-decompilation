...

{
  ...
  pTVar2 = local_c;
  if (errorCode == 0) {
    switch(*(undefined4 *)(local_c + 0x361)) {
    case 1:
      uVar5 = thunk_FUN_004ceb00(local_c,*(undefined4 *)(local_c + 0x369));
      g_currentExceptionFrame = local_50.previous;
      return uVar5;
    case 2:
      uVar5 = thunk_FUN_004e2c30(local_c,*(uint *)(local_c + 0x369));
      g_currentExceptionFrame = local_50.previous;
      return uVar5;
    case 3:
    ...
    case 5:
      local_8 = 1;
      uVar3 = thunk_FUN_004406c0((char)local_c[0x23d]);
