...

{
  ...
  if (iVar2 == 0) {
    ...
    case 1:
      uVar5 = thunk_FUN_004ceb00(local_c,*(undefined4 *)((int)local_c + 0x369));
      DAT_00858df8 = (undefined4 *)local_50;
      return uVar5;
    case 2:
      uVar5 = thunk_FUN_004e2c30(local_c,*(uint *)((int)local_c + 0x369));
      DAT_00858df8 = (undefined4 *)local_50;
      return uVar5;
    case 3:
    ...
    case 5:
      local_8 = 1;
      uVar3 = thunk_FUN_004406c0(*(char *)((int)local_c + 0x23d));
      *(undefined4 *)((int)local_c + 0x241) =
           *(undefined4 *)
            (&DAT_007e4178 + ((uVar3 & 0xff) + *(int *)((int)local_c + 0x235) * 3) * 4);
      thunk_FUN_004cc900((int)local_c);
      DAT_00858df8 = (undefined4 *)local_50;
      return 1;
    case 6:
      uVar5 = thunk_FUN_004de820(local_c);
      DAT_00858df8 = (undefined4 *)local_50;
      return uVar5;
    default:
      DAT_00858df8 = (undefined4 *)local_50;
