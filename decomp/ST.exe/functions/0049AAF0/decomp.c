...
undefined4 FUN_0049aaf0(int param_1)
    ...
    *(undefined4 *)(iVar12 + 0x65) = 0;
    if (*(int *)(iVar12 + 0xe7) == 0) {
      ...
      *(uint **)(local_8 + 0x20e) = puVar7;
      ...
      if (0 < local_18) {
        uVar14 = 0;
        do {
          FUN_006acc70(*(int *)(iVar12 + 0xef),uVar14,(undefined4 *)&local_2c);
          if ((local_2c < 8) &&
             ((((DAT_00802a38 == 0 || ((byte)(&DAT_008087e9)[(char)local_2c * 0x51] < 8)) &&
               (piVar8 = (int *)thunk_FUN_0042b620(CONCAT22(uStack_2a,CONCAT11(cStack_2b,local_2c)),
                                                   CONCAT22(uStack_28,uStack_2a),(int)cStack_2b),
               iVar12 = local_8, piVar8 != (int *)0x0)) &&
              ((iVar6 = (**(code **)(*piVar8 + 0xf8))(), iVar12 = local_8, iVar6 == 1 &&
               (iVar6 = (**(code **)(*piVar8 + 0xf4))((int)*(char *)(local_8 + 0x24)),
               iVar12 = local_8, iVar6 == 1)))))) {
            FUN_006ae140(*(uint **)(local_8 + 0x20e),uVar14,(undefined4 *)&local_2c);
            iVar12 = local_8;
          }
          sVar5 = sVar5 + 1;
          uVar14 = (uint)sVar5;
    ...
    if (*(int *)(local_8 + 0xe7) == 1) {
      ...
      *(uint **)(iVar12 + 0x20e) = puVar7;
      local_c = CONCAT22((short)((uint)puVar7 >> 0x10),*(short *)(iVar12 + 0xf3));
      ...
      if (iVar6 < *(short *)(iVar12 + 0xf9) + iVar6) {
        do {
          ...
          if ((int)sVar5 < (int)*(short *)(iVar12 + 0xfb) + (int)sVar5) {
            do {
              local_10 = CONCAT22((short)((uint)iVar6 >> 0x10),*(short *)(iVar12 + 0xf7));
...
LAB_0049b073:
                          ...
                          uVar9 = CONCAT11(cStack_2b,local_2c) & 0xff;
                          uVar14 = (uint)bVar1;
                      ...
                      if (bVar15) {
                        ...
                        if ((iVar6 == 1) &&
                           ...
                           iVar6 == 1)) {
                          local_18 = iVar6;
                          FUN_006ae1c0(*(uint **)(iVar12 + 0x20e),(undefined4 *)&local_2c);
                        }
                      }
                    }
                  }
...
LAB_0049aec9:
                      ...
                      if (bVar15) {
                        ...
                        iVar12 = local_8;
                        if ((iVar11 == 1) &&
                           (iVar11 = (**(code **)(*piVar8 + 0xf4))((int)*(char *)(local_8 + 0x24)),
                           iVar11 == 1)) {
                          local_18 = iVar11;
                          FUN_006ae1c0(*(uint **)(iVar12 + 0x20e),(undefined4 *)&local_2c);
                        }
    ...
    *(int *)(iVar12 + 0x20a) = *(int *)(iVar12 + 0xeb);
    ...
    if (*(int *)(iVar12 + 0xeb) == 1) {
      sVar5 = 0;
      iVar12 = *(int *)(*(int *)(local_8 + 0x20e) + 0xc);
      if (0 < iVar12) {
        do {
          FUN_006acc70(*(int *)(local_8 + 0x20e),(int)sVar5,(undefined4 *)&local_2c);
          if ((cStack_2b != '\x01') ||
             (uVar14 = thunk_FUN_0042b620(CONCAT22(uStack_2a,CONCAT11(1,local_2c)),
