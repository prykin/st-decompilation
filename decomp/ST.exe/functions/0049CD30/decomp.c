...

{
  ...
  if (iVar6 != 0) {
    ...
    iVar8 = ReportDebugMessage(s_E____titans_wlad_to_grpb_cpp_007abe3c,0x944,0,iVar6,&DAT_007a4ccc,
                               s_STGroupBoatC__GrpBuild_007abfdc);
    if (iVar8 == 0) {
      RaiseInternalException(iVar6,0,s_E____titans_wlad_to_grpb_cpp_007abe3c,0x945);
      return 0xffffffff;
    }
    pcVar3 = (code *)swi(3);
    uVar9 = (*pcVar3)();
  ...
  if ((param_1 == 0) || (param_1 == 1)) {
    ...
    *(undefined1 *)((int)puVar13 + 2) = *(undefined1 *)((int)puVar12 + 2);
    ...
    local_28 = 0;
    local_c = 0;
    groupContent_00 = local_1c;
    if (local_14 != 0) {
      do {
        FUN_006acc70((AnonShape_006ACC70_C8641025 *)pSVar4->field_0029,uVar10,&local_8);
        if ((short)local_8 != -1) {
          pSVar7 = (STBoatC *)
          ...
          if (pSVar7 == (STBoatC *)0x0) {
            RaiseInternalException
                      (-0x5001fffc,g_overwriteContext_007ED77C,
                       s_E____titans_wlad_to_grpb_cpp_007abe3c,0x90f);
          }
          iVar6 = (*pSVar7->vtable->vfunc_2C)();
          if (((iVar6 == 0xc) || (iVar6 = (*pSVar7->vtable->vfunc_2C)(), iVar6 == 0x18)) ||
             (iVar6 = (*pSVar7->vtable->vfunc_2C)(), iVar6 == 0x19)) {
            if (groupContent_00 == (uint *)0x0) {
              groupContent_00 = Library::DKW::TBL::FUN_006ae290((uint *)0x0,1,2,1);
              local_1c = groupContent_00;
            }
          ...
          STBoatC::CmdToObj(pSVar7,SVar14,puVar12);
        }
LAB_0049cf10:
        local_c = local_c + 1;
    ...
    STAllPlayersC::RegisterPGPair
              (g_sTAllPlayers_007FA174,CONCAT31((int3)(uVar10 >> 8),pSVar4->field_0024),
               groupContent_00,&local_10->flags);
    if (groupContent_00 != (uint *)0x0) {
  ...
  if ((uint)PTR_00802a38->field_00E4 % 0x32 == 0) {
    ...
    if ((((sVar5 < 0) || (SHORT_007fb240 <= sVar5)) ||
      ...
      sVar5 = *(short *)(DAT_007fb280 +
                        ((int)sVar2 * (int)SHORT_007fb278 + (int)sVar1 * (int)SHORT_007fb27e +
                        (int)sVar5) * 2);
    }
    if (sVar5 != 0) {
      g_currentExceptionFrame = local_8c.previous;
    ...
    if (local_14 != 0) {
      uVar11 = 0;
      do {
        FUN_006acc70((AnonShape_006ACC70_C8641025 *)pSVar4->field_0029,uVar11,&local_8);
        if ((short)local_8 != -1) {
          pSVar7 = (STBoatC *)
                   STAllPlayersC::GetObjPtr
                             (g_sTAllPlayers_007FA174,
          ...
          if (pSVar7 == (STBoatC *)0x0) {
            RaiseInternalException
                      (-0x5001fffc,g_overwriteContext_007ED77C,
                       s_E____titans_wlad_to_grpb_cpp_007abe3c,0x938);
          }
          iVar6 = (*pSVar7->vtable->vfunc_2C)();
          if (((((iVar6 == 0xc) || (iVar6 = (*pSVar7->vtable->vfunc_2C)(), iVar6 == 0x18)) ||
               (iVar6 = (*pSVar7->vtable->vfunc_2C)(), iVar6 == 0x19)) &&
