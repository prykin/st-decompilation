    ...
    if (local_14 != 0) {
      do {
        ...
        if ((short)local_8 != -1) {
          ...
          dVar8 = (*pSVar7->vtable->slot_2C)(pSVar7);
          if (((dVar8 == 0xc) || (dVar8 = (*pSVar7->vtable->slot_2C)(pSVar7), dVar8 == 0x18)) ||
             (dVar8 = (*pSVar7->vtable->slot_2C)(pSVar7), dVar8 == 0x19)) {
          ...
          STBoatC::CmdToObj(pSVar7,SVar15,puVar13);
        }
LAB_0049cf10:
        local_c = local_c + 1;
    ...
    STAllPlayersC::RegisterPGPair
              (g_sTAllPlayers_007FA174,CONCAT31((int3)(uVar11 >> 8),pSVar4->field_0024),
