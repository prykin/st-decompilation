...

{
  ...
  *(undefined1 *)((int)puVar12 + 2) = 0;
  ...
  if (iVar8 == 0) {
    ...
    *(undefined4 *)(local_c + 0x4eea) = 0;
    *(undefined4 *)(local_c + 0x4ef2) = 0;
    *(undefined4 *)(local_c + 0x4efe) = 0;
    if (local_c[0x1195] == (STAppC)0x0) {
      *(undefined4 *)(local_c + 0x1181) = 0;
    }
    if (DAT_00811768 == '\x01') {
      DAT_00811768 = '\x02';
    }
    ...
    *(undefined4 *)((int)pvVar3 + 0x27c) = uVar7;
    ...
    local_34[4] = 0x6107;
    local_34[5] = 1;
    (**(code **)(*(int *)pSVar10 + 0x18))(local_34);
    thunk_FUN_0056a500();
    pSVar11 = pSVar10 + 0x5012;
    for (iVar8 = 0x41; iVar8 != 0; iVar8 = iVar8 + -1) {
      *(undefined4 *)pSVar11 = 0;
  ...
  if (iVar8 == 0) {
    ...
    DAT_00802a58 = (cLoadingTy *)0x0;
    local_44 = 0x6102;
    (**(code **)(*(int *)pSVar10 + 0x18))(local_54);
    pSVar10[0x1195] = (STAppC)0x0;
    return;
  }
  pcVar2 = (code *)swi(3);
