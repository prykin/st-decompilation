  ...
  *(undefined2 *)puVar13 = 0;
  ...
  if (iVar11 == 0) {
    ...
    if ((puVar7 == nullptr) || (local_14 = &pSVar11->field_7D1A, pSVar11->field_7D1A == '\0'))
    {
      ...
      Library::MSVCRT::_strncpy(&pSVar11->field_78FE,local_14,0x103);
      pSVar11->field_7A01 = 0;
      /* ST_CALLSITE[0056DEA3]: CALL dword ptr [0x0085bde8] */
      wsprintfA(local_14,"%s%s",&pSVar11->field_0x60,&pSVar11->field_78FE);
    ...
    *slotStorage = puVar7;
    ...
    wsprintfA((LPSTR)&local_224,"%s%s%s",&pSVar11->field_0x60,PTR_s_SYSTEM__0079b030,
              *slotStorage);
    ...
    if (pSVar11->field_7D0E == 0) {
      ...
      wsprintfA(&pSVar11->field_7D1A,"%s %s",pcVar8_mg1,puVar15);
      if (g_cLoading_00802A58 != nullptr) {
      ...
      wsprintfA(&pSVar11->field_7D1A,"%s %s",pcVar8_mg2,pbVar14);
      if (g_cLoading_00802A58 != nullptr) {
      ...
      if ((DArrayTy *)pSVar11->field_4EAB != nullptr) {
        FUN_006b5570((DArrayTy *)pSVar11->field_4EAB);
      }
