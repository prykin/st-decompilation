...

{
  ...
  *(undefined2 *)puVar14 = 0;
  ...
  if (iVar11 == 0) {
    ...
    g_cMf32_00806754 =
         (cMf32 *)Library::Ourlib::MF32INT::FUN_006f0ec0(0x345,&pSVar13->field_76F6,0,0,0);
    ...
    if ((puVar7 == nullptr) || (local_14 = &pSVar13->field_7D1A, pSVar13->field_7D1A == '\0'))
    {
      ...
      Library::MSVCRT::_strncpy(&pSVar13->field_78FE,local_14,0x103);
      pSVar13->field_7A01 = 0;
      wsprintfA(local_14,"%s%s",&pSVar13->field_0x60,&pSVar13->field_78FE);
    ...
    *slotStorage = puVar7;
    ...
    wsprintfA((LPSTR)&local_224,"%s%s%s",&pSVar13->field_0x60,PTR_s_SYSTEM__0079b030,
              *slotStorage);
