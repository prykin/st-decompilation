...

{
  ...
  *(undefined1 *)((int)puVar12 + 2) = 0;
  ...
  iVar8 = Library::MSVCRT::__setjmp3(IStack_98.jumpBuffer,0,unaff_EDI,unaff_ESI);
  pSVar10 = pSStack_c;
  if (iVar8 == 0) {
    ...
    *(int *)(pSVar10 + 0x1164) = 0;
    ...
    cMf32::RecGet(DAT_00806754,0xc,PTR_s_AUTOSAVETIME_GAME_0079b068,(int *)&pSStack_8,0);
    pSStack_8 = pSVar10 + 0x4eb3;
    cMf32::RecGet(DAT_00806754,0xc,PTR_s_STATETIMER_GAME_0079b064,(int *)&pSStack_8,0);
    pSStack_8 = pSVar10 + 0x4eb7;
    puVar6 = cMf32::RecGet(DAT_00806754,0xc,PTR_s_BRIEFING_GAME_0079b06c,(int *)&pSStack_8,0);
    pSStack_8 = pSVar10 + 0x1180;
    pSVar10[0x4ed9] = (STAppC)(puVar6 != (ushort *)0x0);
    if ((*pSStack_8 != (STAppC)0xc) && (*pSStack_8 != (STAppC)0x10)) {
      cMf32::RecGet(DAT_00806754,0xc,PTR_s_TYPE_START_0079b08c,(int *)&pSStack_8,0);
    }
    pSStack_8 = pSVar10 + 0x2b2f;
    cMf32::RecGet(DAT_00806754,0,PTR_s_RESTART_GAME_0079b060,(int *)&pSStack_8,0);
    ...
    puVar6 = cMf32::RecGet(DAT_00806754,0,PTR_s_ORIG_DB_0079b088,(int *)&pSStack_8,0);
    if ((puVar6 == (ushort *)0x0) || (pSStack_14 = pSVar10 + 0x7d1a, pSVar10[0x7d1a] == (STAppC)0x0)
      ...
      iVar8 = Library::MSVCRT::__setjmp3(IStack_dc.jumpBuffer,0,unaff_EDI,unaff_ESI);
      pSVar10 = pSStack_c;
      ...
      Library::MSVCRT::_strncpy((char *)(pSVar10 + 0x78fe),(char *)pSStack_14,0x103);
      ...
      iVar8 = Library::MSVCRT::__setjmp3(IStack_120.jumpBuffer,0,pSVar11,puVar13);
      pSVar10 = pSStack_c;
    ...
    *(int *)(pSVar10 + 0x7d16) = iVar8;
    ...
    if (*(int *)(pSVar10 + 0x7d0e) == 0) {
      ...
      puVar6 = cMf32::RecGet(DAT_00806754,0xc,PTR_s_TITLE_MISSION_0079b070,(int *)&pSStack_8,0);
      if ((puVar6 == (ushort *)0x0) || (pSVar11 = pSVar10 + 0x4da3, pSVar10[0x4da3] == (STAppC)0x0))
      {
        Library::MSVCRT::FUN_0072e730
                  ((byte *)(pSVar10 + 0x76f6),(byte *)0x0,(byte *)0x0,(byte *)aSStack_328,
                   (byte *)0x0);
        pSVar11 = aSStack_328;
      }
      uVar7 = FUN_006b0140(0x267f,DAT_00807618);
      ...
      if ((pSVar10[0x1180] == (STAppC)0xc) || (pSVar10[0x1180] == (STAppC)0x10)) {
        ...
        cMf32::RecGet(DAT_00806754,0,PTR_s_DESCRIPTOR_0079b080,(int *)&pSStack_10,0);
      ...
      *(uint **)(pSVar10 + 0x4eab) = puVar5;
      ...
      if ((*(int *)(pSVar10 + 0x117c) == 0) &&
        ...
        *(undefined4 *)(pSVar10 + 0x7d0e) = 0;
        ...
        puVar6 = cMf32::RecGet(DAT_00806754,0,PTR_s_REPORT_0079b090,(int *)&pSStack_10,0);
    ...
    *(undefined4 *)(pSVar10 + 0x4f02) = 0;
    ...
    cMf32::RecGet(DAT_00806754,0xc,PTR_s_RND_INIT_0079b05c,(int *)&pSStack_8,0);
    thunk_FUN_00577280();
