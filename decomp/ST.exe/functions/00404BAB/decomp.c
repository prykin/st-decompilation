...

{
  ...
  *(undefined1 *)((int)puVar11 + 2) = 0;
  ...
  piVar9 = piStack_c;
  if (iVar8 == 0) {
    *(undefined4 *)((int)piStack_c + 0x4eee) = 0;
    *(undefined4 *)((int)piStack_c + 0x4eea) = 0;
    *(undefined4 *)((int)piStack_c + 0x4ef2) = 0;
    *(undefined4 *)((int)piStack_c + 0x4efe) = 0;
    if (*(char *)((int)piStack_c + 0x1195) == '\0') {
      *(undefined4 *)((int)piStack_c + 0x1181) = 0;
    }
    if (DAT_00811768 == '\x01') {
      DAT_00811768 = '\x02';
    }
    ...
    *(int *)((int)piVar9 + 0x4eaf) = 0;
    ...
    piStack_8 = (int *)((int)piVar9 + 0x4eaf);
    FUN_006f1ce0(0xc,PTR_s_AUTOSAVETIME_GAME_0079b068,(int *)&piStack_8,0);
    piStack_8 = (int *)((int)piVar9 + 0x4eb3);
    FUN_006f1ce0(0xc,PTR_s_STATETIMER_GAME_0079b064,(int *)&piStack_8,0);
    piStack_8 = (int *)((int)piVar9 + 0x4eb7);
    puVar6 = FUN_006f1ce0(0xc,PTR_s_BRIEFING_GAME_0079b06c,(int *)&piStack_8,0);
    piStack_8 = piVar9 + 0x460;
    *(bool *)((int)piVar9 + 0x4ed9) = puVar6 != (ushort *)0x0;
    if (((char)*piStack_8 != '\f') && ((char)*piStack_8 != '\x10')) {
      FUN_006f1ce0(0xc,PTR_s_TYPE_START_0079b08c,(int *)&piStack_8,0);
    }
    piStack_8 = (int *)((int)piVar9 + 0x2b2f);
    FUN_006f1ce0(0,PTR_s_RESTART_GAME_0079b060,(int *)&piStack_8,0);
    if (DAT_00806758 != (undefined4 *)0x0) {
      FUN_006f1170(DAT_00806758);
    }
    piStack_8 = (int *)((int)piVar9 + 0x7d1a);
    ...
    puVar6 = FUN_006f1ce0(0,PTR_s_ORIG_DB_0079b088,(int *)&piStack_8,0);
    if ((puVar6 == (ushort *)0x0) ||
       (pCStack_14 = (LPSTR)((int)piVar9 + 0x7d1a), *(char *)((int)piVar9 + 0x7d1a) == '\0')) {
      ...
      ppuVar4 = ppuStack_dc;
      if (iVar8 == 0) {
        DAT_00806758 = FUN_006f0ec0(0x345,(byte *)((int)piStack_c + 0x76f6),0,0,0);
        DAT_00858df8 = ppuStack_dc;
        ppuVar4 = DAT_00858df8;
      }
    }
    else {
      _strncpy((char *)((int)piVar9 + 0x78fe),pCStack_14,0x103);
      *(undefined1 *)((int)piVar9 + 0x7a01) = 0;
      puVar13 = &DAT_007c6ee4;
      pCVar12 = pCStack_14;
      wsprintfA(pCStack_14,&DAT_007c6ee4,piVar9 + 0x18,(char *)((int)piVar9 + 0x78fe));
      ppuStack_120 = DAT_00858df8;
      DAT_00858df8 = &ppuStack_120;
      iVar8 = __setjmp3(auStack_11c,0,pCVar12,puVar13);
      piVar9 = piStack_c;
      ppuVar4 = ppuStack_120;
      if (iVar8 == 0) {
        DAT_00806758 = FUN_006f0ec0(0x345,(byte *)((int)piStack_c + 0x7d1a),0,0,0);
        DAT_00858df8 = ppuStack_120;
        ppuVar4 = DAT_00858df8;
      }
    }
    ...
    *(int *)((int)piVar9 + 0x7d16) = iVar8;
    wsprintfA((LPSTR)&bStack_224,s__s_s_s_007c6edc,piVar9 + 0x18,PTR_s_SYSTEM__0079b030,*puVar11);
    ...
    DAT_00806760 = FUN_006f0ec0(0x345,&bStack_224,0,0,0);
    ...
    if (*(int *)((int)piVar9 + 0x7d0e) == 0) {
      ...
      piStack_8 = (int *)((int)piVar9 + 0x4da3);
      piVar10 = piStack_8;
      for (iVar8 = 0x41; iVar8 != 0; iVar8 = iVar8 + -1) {
        *piVar10 = 0;
        piVar10 = piVar10 + 1;
      }
      puVar6 = FUN_006f1ce0(0xc,PTR_s_TITLE_MISSION_0079b070,(int *)&piStack_8,0);
      if ((puVar6 == (ushort *)0x0) ||
         (pbVar14 = (byte *)((int)piVar9 + 0x4da3), *(char *)((int)piVar9 + 0x4da3) == '\0')) {
        FUN_0072e730((byte *)((int)piVar9 + 0x76f6),(byte *)0x0,(byte *)0x0,abStack_328,(byte *)0x0)
        ;
        pbVar14 = abStack_328;
      }
      uVar7 = FUN_006b0140(0x267f,DAT_00807618);
      ...
      if (((char)piVar9[0x460] == '\f') || ((char)piVar9[0x460] == '\x10')) {
        ...
        puStack_10 = (undefined4 *)((int)piVar9 + 0x1196);
        FUN_006f1ce0(0,PTR_s_DESCRIPTOR_0079b080,(int *)&puStack_10,0);
      ...
      *(uint **)((int)piVar9 + 0x4eab) = puVar5;
      ...
      if ((piVar9[0x45f] == 0) &&
        ...
        *(undefined4 *)((int)piVar9 + 0x7d0e) = 0;
        ...
        puStack_10 = (undefined4 *)((int)piVar9 + 0x4f02);
        puVar6 = FUN_006f1ce0(0,PTR_s_REPORT_0079b090,(int *)&puStack_10,0);
        if (puVar6 == (ushort *)0x0) {
          puVar11 = (undefined4 *)((int)piVar9 + 0x4f02);
          for (iVar8 = 0x9fc; iVar8 != 0; iVar8 = iVar8 + -1) {
            *puVar11 = 0;
    ...
    *(undefined4 *)((int)piVar9 + 0x4f02) = 0;
    ...
    piStack_8 = piVar9 + 0x44d;
    FUN_006f1ce0(0xc,PTR_s_RND_INIT_0079b05c,(int *)&piStack_8,0);
    thunk_FUN_00577280();
  ...
  if (iVar8 == 0) {
    ...
    DAT_00802a58 = (uint *)0x0;
    uStack_44 = 0x6102;
    (**(code **)(*piStack_c + 0x18))(auStack_54);
    *(undefined1 *)((int)piStack_c + 0x1195) = 0;
    return;
  }
  pcVar2 = (code *)swi(3);
  (*pcVar2)();
