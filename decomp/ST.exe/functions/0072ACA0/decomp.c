...

{
  ...
  if (param_1 == (int *)0x0) {
    DVar1 = FUN_006a5e40(-0x34,DAT_007ed77c,0x7f1084,0x4e);
    return DVar1;
  }
  if (((0 < param_3) && (0 < param_4)) && (param_5 != 0)) {
    ...
    *(HANDLE *)(*DAT_00857134 + 0x508) = pvVar2;
    if (*(int *)(*DAT_00857134 + 0x508) == 0) {
      DVar1 = GetLastError();
      if (DVar1 == 0) {
        DVar1 = 0xffffff03;
      }
      FUN_006a5e40(DVar1,DAT_007ed77c,0x7f1084,0x5d);
      return DVar1;
    }
    ...
    if (DAT_0085713c == (HANDLE)0x0) {
      ...
      FUN_006a5e40(DVar1,DAT_007ed77c,0x7f1084,99);
      return DVar1;
    }
