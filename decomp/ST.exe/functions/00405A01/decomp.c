...

{
  ...
  if ((((iVar5 + -1 < *(int *)(this + 0x26d)) || (*(int *)(this + 0x26d) < 0)) ||
      (iVar4 + -1 < *(int *)(this + 0x271))) || (*(int *)(this + 0x271) < 0)) {
    ...
    *(int *)(this + 0x26d) = iVar5 + -1 >> 1;
    *(int *)(this + 0x271) = iVar4 + -1 >> 1;
  }
  if ((*(int *)(this + 0x275) < 0) || (4 < *(int *)(this + 0x275))) {
    ...
    *(undefined4 *)(this + 0x275) = 0;
  }
  if (0x167 < *(int *)(this + 0x27d)) {
    ...
    *(undefined4 *)(this + 0x27d) = 0;
  }
  iVar4 = 0;
  do {
    bVar2 = thunk_FUN_004961b0(*(short *)(this + 0x26d),*(short *)(this + 0x271),(short)iVar4);
    if (CONCAT31(extraout_var,bVar2) != 0) {
      *(int *)(this + 0x275) = iVar4;
      return;
    }
    iVar4 = iVar4 + 1;
  } while (iVar4 < 5);
