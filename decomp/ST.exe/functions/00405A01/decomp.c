...
void __fastcall thunk_FUN_00579170(int param_1)

{
  ...
  if ((((iVar5 + -1 < *(int *)(param_1 + 0x26d)) || (*(int *)(param_1 + 0x26d) < 0)) ||
    ...
    iVar3 = FUN_006ad4d0(s_E____titans_Igor_to_crab_cpp_007cad4c,0x202,0,0,&DAT_007a4ccc);
    if (iVar3 != 0) {
      pcVar1 = (code *)swi(3);
      (*pcVar1)();
      return;
  ...
  if ((*(int *)(param_1 + 0x275) < 0) || (4 < *(int *)(param_1 + 0x275))) {
    iVar4 = FUN_006ad4d0(s_E____titans_Igor_to_crab_cpp_007cad4c,0x207,0,0,&DAT_007a4ccc);
    if (iVar4 != 0) {
      pcVar1 = (code *)swi(3);
      (*pcVar1)();
      return;
  ...
  if (0x167 < *(int *)(param_1 + 0x27d)) {
    iVar4 = FUN_006ad4d0(s_E____titans_Igor_to_crab_cpp_007cad4c,0x20c,0,0,&DAT_007a4ccc);
    if (iVar4 != 0) {
      pcVar1 = (code *)swi(3);
      (*pcVar1)();
      return;
