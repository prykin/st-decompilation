...
void thunk_FUN_0065d760(int *param_1,int param_2)

{
  ...
  if (DAT_007fa174 != 0) {
    ...
    if (((bVar2) && (*(short *)(iStack_8 + 0x7b) != 1)) ||
    ...
    thunk_FUN_0042b7d0(CONCAT31((int3)((uint)extraout_ECX >> 8),*(undefined1 *)(iStack_8 + 0x24)),
                       *(ushort *)(iStack_8 + 0x7d),(int)puVar5,(undefined2 *)0x0);
