...
undefined4 __thiscall FUN_0060ea30(void *this,uint param_1)
    ...
    if (uVar1 == 0) {
      ...
      if (puVar4[3] != 2) {
        ...
        *(undefined4 *)((int)this + 0x24) = *(undefined4 *)((int)this + 0x1d9);
        thunk_FUN_00614400(this,*(int *)(param_1 + 0x14));
        thunk_FUN_00615390((int)this);
