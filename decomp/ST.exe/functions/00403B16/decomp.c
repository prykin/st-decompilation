...

{
  ...
  if (iVar2 == 0) {
    ...
    if (*(short *)(iStack_c + 0xc2f) != 0) {
      FUN_00710a90(*(int *)(iStack_c + 0x194),0,0x24,0x4c,0xa4,0x2b);
      uVar4 = FUN_006b0140(0x38ae,DAT_00807618);
      wsprintfA((LPSTR)&DAT_0080f33a,s__d__s_007c2840,(uint)*(ushort *)(iStack_c + 0xc2f),uVar4);
      FUN_00711b70(&DAT_0080f33a,-2,-1,5,-1,-1);
    }
    if (*(byte *)(iStack_c + 0xc29) != 0xff) {
      if (0x21 < *(byte *)(iStack_c + 0xc29)) {
        *(undefined1 *)(iStack_c + 0xc29) = 0x21;
      }
      bVar5 = 0;
      uStack_8 = uStack_8 & 0xffffff00;
      if (*(char *)(iStack_c + 0xc29) != '\0') {
        do {
          pbVar3 = (byte *)FUN_0070b3a0(*(int *)(iStack_c + 0x2b6),1);
          thunk_FUN_00540760(*(undefined4 **)(iStack_c + 0x194),(uStack_8 & 0xff) * 4 + 0x35,0x7d,
                             '\x01',pbVar3);
          bVar5 = bVar5 + 1;
          uStack_8 = CONCAT31(uStack_8._1_3_,bVar5);
        } while (bVar5 < *(byte *)(iStack_c + 0xc29));
      }
      if (bVar5 < 0x21) {
        ...
        do {
          ...
          thunk_FUN_00540760(*(undefined4 **)(iStack_c + 0x194),iVar2,0x7d,'\x01',pbVar3);
          iVar2 = iVar2 + 4;
          iVar6 = iVar6 + -1;
        } while (iVar6 != 0);
      }
