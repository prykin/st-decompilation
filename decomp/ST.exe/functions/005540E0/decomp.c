...
uint * __cdecl FUN_005540e0(uint param_1,int param_2,uint param_3)

{
  ...
  if (DAT_0080874e == '\x01') {
    ...
    FUN_006f12b0(FUN_006f2d10,&local_65c);
    puVar6 = FUN_006f2790();
    uVar5 = local_c;
    ...
    if (DAT_0080874e == '\x02') {
      ...
      FUN_006f12b0(FUN_006f2d10,&local_254);
      puVar6 = FUN_006f2790();
      while (puVar6 != (undefined4 *)0x0) {
        local_c = local_c + 1;
        puVar6 = FUN_006f2790();
...
LAB_00554324:
  ...
  local_8[2] = uVar5;
  puVar6 = FUN_00710ba0(*local_8,0,0,0,0,0,1);
