...

{
  ...
  if (iVar3 != 0) {
    ...
    FUN_006d2820((byte *)((int)pAVar4 * iVar3 + local_14 + param_2),
                 (AnonShape_006B84D0_7C7D97C6 *)param_1,param_5,local_14 - (param_3 + sVar1),
                 local_10 - (param_4 + sVar2),local_c,local_8,0,(byte *)0x0,0,0,(byte *)0x0);
  }
  return;
}
