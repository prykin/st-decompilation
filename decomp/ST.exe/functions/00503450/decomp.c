...

{
  ...
  this_00 = local_24;
  if (*(uint *)&local_24->field_0x2fe != 0) {
    FUN_006e56b0(*(void **)&local_24->field_0xc,*(uint *)&local_24->field_0x2fe);
  }
  *(undefined4 *)&this_00->field_0x2fe = 0;
  puVar10 = (uint *)&this_00->field_0x960;
  iVar7 = 4;
  do {
    if (*puVar10 != 0) {
  ...
  *(undefined4 *)&this_00->field_0x970 = 0;
  if (((cVar1 == '\0') || (cVar1 == '\x04')) || (cVar1 == '\x03')) {
    ...
    *(undefined4 *)&this_00->field_0x2c = 0;
    ...
    do {
      uVar12 = local_c & 0xff;
      if ((&this_00->field_0xba2)[uVar12] == '\0') goto LAB_005036ae;
      switch(uVar12) {
      case 0:
        iVar7 = 0x10;
        local_8 = 0x4c;
...
LAB_005035b5:
      ...
      if (this_00->field_0xba0 == '\0') {
        ...
        local_14 = (undefined4 *)(uint)(byte)(&this_00->field_0xba8)[uVar12];
      }
      pcVar20 = (char *)0x0;
      ...
      uVar15 = 1;
      iVar8 = 0;
      pcVar4 = thunk_FUN_00529590((&this_00->field_0xba2)[uVar12],*(int *)&this_00->field_0xb99);
...
LAB_00503678:
        iVar9 = 0;
LAB_0050367a:
        uVar6 = FUN_0070b3a0(*(int *)&this_00->field_0x2de,iVar9);
...
LAB_005036ae:
    ...
    local_3c = 0xb20e;
    local_44 = local_64;
    (**(code **)(**(int **)&this_00->field_0xc + 8))(9,&this_00->field_0x2fe,0,local_74,0);
...
LAB_00503776:
  if (((this_00->field_0xb9e == '\x01') || (this_00->field_0xb9e == '\x03')) &&
     ((iVar7 = *(int *)&this_00->field_0xb99, iVar7 != 9 &&
    ...
    uVar6 = CreateBut(this_00,3,0,(uint)(this_00->field_0xba0 != '\0'),0x40,0x2f,6,(int)pCVar5,uVar6
                      ,uVar13,sVar14,uVar15,iVar7,pcVar4,iVar8,uVar18,uVar21);
    *(undefined4 *)&this_00->field_0x970 = uVar6;
  }
  ...
  if (((this_00->field_0xb9e == '\x01') && (*(int *)&this_00->field_0xb99 != 0xbd)) ||
     (this_00->field_0xb9e == '\x02')) {
    local_14 = (undefined4 *)&this_00->field_0x960;
    local_c = local_c & 0xffffff00;
    local_8 = 0;
    iVar7 = local_20;
    iVar8 = local_18;
...
switchD_0050389f_default:
      ...
      if (this_00->field_0xba0 == '\0') {
        ...
        uVar12 = (uint)(byte)(&this_00->field_0xbcf)[local_8];
      }
