...
undefined4 __fastcall thunk_FUN_0060dab0(int param_1)
  ...
  if ((iVar8 != 0) && (*(int *)(param_1 + 0x240) == 1)) {
    ...
    *(int *)(*(int *)(param_1 + 0x244) + 0x14) = *(int *)(param_1 + 0x1fd) + iVar9;
    ...
    if (iVar9 < *(int *)(iVar8 + 0x1c)) {
      iStack_14 = (*(int *)(iVar8 + 0x10) * iVar9) / *(int *)(iVar8 + 0x1c);
    }
    else {
      iStack_14 = *(int *)(iVar8 + 0x10);
    }
      ...
      do {
        ...
        if (0 < iStack_14) {
          ...
          do {
              ...
              *(int *)(iVar9 + 0x14) = *(int *)(iVar9 + 0x20) + (int)sVar3 / (iVar7 * 0x50 + 200);
              if (iVar5 - (iVar4 * sVar2) / 10000 < *(int *)(param_1 + 0x1f9)) {
                if ((*(int *)(iVar9 + 4) == 0) && (-1 < (int)*(uint *)(iVar9 + 0x3c))) {
                  *(int *)(iVar9 + 0x24) = *(int *)(*(int *)(param_1 + 0x244) + 0x20) + iStack_c;
            ...
            iStack_c = iStack_c + 1;
            iStack_10 = iStack_10 + 0x33;
          } while (iStack_c < iStack_14);
        }
        iVar8 = *(int *)(param_1 + 0x244);
        iStack_18 = iStack_18 + 1;
      } while (iStack_18 < *(int *)(iVar8 + 0xc));
    }
    uVar6 = 1;
  }
  return uVar6;
