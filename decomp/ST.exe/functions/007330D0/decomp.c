...

{
  ...
  BVar2 = IsBadWritePtr(DAT_0085a5c0,DAT_0085a5bc * 0x14);
  if (BVar2 == 0) {
    local_140 = DAT_0085a5c0;
    for (local_124 = 0; local_124 < DAT_0085a5bc; local_124 = local_124 + 1) {
