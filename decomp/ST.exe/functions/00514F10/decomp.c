...

{
  ...
  if ((DArrayTy *)local_8->field_01D3 != (DArrayTy *)0x0) {
...
LAB_00514f85:
      thunk_FUN_005411a0((DArrayTy *)this_00->field_01D3,pcVar5,"@- %s@ ");
      iVar3 = iVar3 + 1;
  ...
  if ((DArrayTy *)this_00->field_01D3 != (DArrayTy *)0x0) {
    FUN_006b5570((DArrayTy *)this_00->field_01D3);
  }
