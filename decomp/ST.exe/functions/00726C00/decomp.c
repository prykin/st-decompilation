...
/* [STSourceProvenanceApplier begin]
   ...
   Diagnostic line evidence: 502 | 506 | 508 (metadata/report site, not the function definition)
   [STSourceProvenanceApplier end] */

int __cdecl mfQSprGetNumFas(cMf32 *param_1,char *param_2,int param_3)
