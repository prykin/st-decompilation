...
undefined4 __fastcall thunk_FUN_004cc370(int *param_1)

{
  ...
  if (iVar2 == 2) {
    ...
    if (iVar2 != 0) {
      uVar5 = 0x381;
LAB_004cc50a:
      FUN_006a5e40(iVar2,DAT_007ed77c,0x7ad4d0,uVar5);
    }
  }
  uVar6 = 6;
  iVar2 = thunk_FUN_004ad650((int)param_1 + 0x1d5);
  uVar1 = thunk_FUN_004ad650(*(int *)((int)param_1 + 0x603));
  FUN_006ea340(*(void **)((int)param_1 + 0x211),uVar1,iVar2,uVar6);
  ...
  param_1[7] = uVar1;
  iVar3 = *(int *)((int)param_1 + 0x235) * 0x44;
  uVar1 = (uVar1 >> 0x10) % *(uint *)(&DAT_00797748 + iVar3);
  param_1[0x113] = uVar1;
  iVar2 = param_1[0x10f];
  if (iVar2 == 2) {
    uVar6 = (*(int *)((int)param_1 + 0x613) - *(int *)(&DAT_0079774c + uVar1 * 8 + iVar3)) + 0x28;
    uVar1 = (*(int *)((int)param_1 + 0x617) - *(int *)(&DAT_00797750 + uVar1 * 8 + iVar3)) + 0x1f;
  }
  else {
    if ((iVar2 == 3) || (iVar4 = 0x17, iVar2 == 4)) {
      iVar4 = 0x10;
    }
    uVar6 = (*(int *)((int)param_1 + 0x613) - *(int *)(&DAT_0079774c + uVar1 * 8 + iVar3)) + iVar4;
    if ((iVar2 == 3) || (iVar4 = 0x5c, iVar2 == 4)) {
      iVar4 = 0x15;
    }
    uVar1 = (*(int *)((int)param_1 + 0x617) - *(int *)(&DAT_00797750 + uVar1 * 8 + iVar3)) + iVar4;
  }
