...
LAB_0056016e:
        ...
        if (0 < local_28) {
          do {
            ...
            if (((-1 < local_94) && (local_94 < DAT_008033a4)) &&
              ...
              if (local_148 == 0) {
                iVar16 = 0x10;
                uVar12 = FUN_006db910(DAT_00803304,DAT_00803308,local_94,iVar15);
                local_74 = (int *)FUN_006db990(uVar12,iVar16);
                ...
                if (iVar16 <= (int)((int)local_74 + 3U)) {
                  do {
                    ...
                    iVar20 = FUN_00561dc0(local_94,iVar15,iVar20);
                    FUN_005623c0(local_94,iVar15,iVar20,local_74,DAT_0080330c);
                    if (-1 < local_98) {
                      FUN_005623c0(local_94,iVar15,iVar20,local_74,DAT_008032e8);
                    }
                    iVar16 = iVar16 + 3;
              ...
              if (0 < DAT_0080337c) {
                do {
                  if (-1 < piVar10[3]) {
                    ...
                    if (0 < local_15c) {
                      do {
                        iVar20 = FUN_006acf90(DAT_00803300[local_40[iVar16] * 5],
    ...
    iVar16 = 0;
    do {
      FreeAndNull((void **)(DAT_008032fc + iVar16));
      iVar16 = iVar16 + 4;
    } while (iVar16 < 0x80);
    iVar16 = 0;
    do {
      FreeAndNull((void **)(iVar16 + (int)DAT_008033b0));
      iVar16 = iVar16 + 4;
    } while (iVar16 < 0x40);
    if (iVar15 != 0) {
