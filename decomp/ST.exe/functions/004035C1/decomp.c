...

{
  ...
  piVar5 = piStack_18;
  if (iVar2 == 0) {
    if (*(int *)((int)piStack_18 + 0x11) == 3) {
      iVar2 = *(int *)((int)piStack_18 + 0x25);
      if (iVar2 < 4) {
    ...
    if (*piVar5 != 0) {
      iStack_20 = *(int *)((int)piVar5 + 0x19);
      iStack_24 = *(int *)(*piVar5 + 0xc);
      uStack_1c = 0;
      if (0 < iStack_24) {
        do {
          iVar2 = *piVar5;
          ...
          if (piVar6 != (int *)0x0) {
            ...
            if ((*(int *)((int)piVar5 + 0x11) == 1) && (iStack_20 <= (int)uStack_1c)) {
              puStack_8 = puStack_10;
              *(undefined4 *)((int)piVar6 + 0x1d) = *(undefined4 *)puStack_10;
              puVar3 = puStack_10;
            }
            if ((*(int *)((int)piVar5 + 0x11) == 4) &&
               (((int)uStack_1c < *(int *)((int)piVar5 + 0x1d) ||
                (puVar3 = puStack_10, puStack_8 = puStack_10,
                *(int *)((int)piVar5 + 0x1d) * 2 <= (int)uStack_1c)))) {
              puVar3 = puStack_14;
              puStack_8 = puStack_14;
            }
