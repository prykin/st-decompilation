...
int FUN_006b3640(int *param_1,uint param_2,uint param_3,uint param_4,uint param_5)

{
  ...
  if (param_2 < (uint)param_1[0x68]) {
    ...
    if ((*puVar1 & 0x8000) != 0) {
      ...
      if (exceptionCode != 0) {
        RaiseInternalException(exceptionCode,DAT_007ed77c,s_E__DKW_DDX_C_ddsinit_c_007edac0,0x6f6);
