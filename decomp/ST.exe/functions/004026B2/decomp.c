...
undefined4 __thiscall thunk_FUN_004e2c30(void *this,uint param_1)

{
  ...
  uStack_10 = thunk_FUN_004e60d0(*(int *)((int)this + 0x24),param_1);
  ...
  thunk_FUN_004e6310(iVar2,param_1,uStack_10 + 1);
  ...
  if (DAT_008117bc != (undefined4 *)0x0) {
    ...
    uStack_4a = *(undefined2 *)((int)this + 0x32);
    uStack_4c = *(undefined2 *)((int)this + 0x24);
    uStack_50 = 0x5de7;
    uStack_48 = (undefined2)param_1;
    uVar4 = thunk_FUN_004e60d0(iVar2,param_1);
    sStack_46 = (short)uVar4;
    (**(code **)*DAT_008117bc)(auStack_60);
    puVar7 = auStack_60;
    ...
    do {
      uVar5 = uStack_10;
      if (((((*(byte *)((int)puStack_14 + ((int)(uStack_10 ^ 7) >> 3)) >> ((uStack_10 ^ 7) & 7) & 1)
             != 0) &&
           (pbStack_18 = abStack_40,
           (pbStack_18[(int)(uStack_10 ^ 7) >> 3] >> ((uStack_10 ^ 7) & 7) & 1) == 0)) &&
          (pbStack_18 = (byte *)((int)&DAT_007f510b + *(int *)((int)this + 0x24) * 0xa62),
          (pbStack_18[(int)(uStack_10 ^ 7) >> 3] >> ((uStack_10 ^ 7) & 7) & 1) != 0)) &&
         (pbStack_18 = (byte *)((int)&DAT_007f511f + *(int *)((int)this + 0x24) * 0xa62),
         (pbStack_18[(int)(uStack_10 ^ 7) >> 3] >> ((uStack_10 ^ 7) & 7) & 1) != 0)) {
        uVar1 = thunk_FUN_004e6140(*(int *)((int)this + 0x24),uStack_10);
        iVar2 = thunk_FUN_004e60d0(*(int *)((int)this + 0x24),uVar5);
        if (iVar2 < CONCAT31(extraout_var_00,uVar1)) {
          uStack_48 = (undefined2)uVar5;
          uVar4 = thunk_FUN_004e60d0(*(int *)((int)this + 0x24),uVar5);
          sStack_46 = (short)uVar4 + 1;
          (**(code **)*DAT_008117bc)(auStack_60);
        }
      }
      uStack_10 = uVar5 + 1;
    } while ((int)uStack_10 < 0x9b);
  }
