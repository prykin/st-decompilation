      ...
      if ((0 < param_5) && (0 < param_6)) {
        ...
        if ((((param_7[7] != 0) &&
          ...
          if (((param_7[7] == 1) && ((*pbVar25 & 4) == 0)) && (local_2c == 0)) {
            ...
            if (iVar4 <= local_f0) {
              local_a0 = (short *)FUN_006aac70(iVar4 * 8);
              iVar22 = 0;
              if (0 < iVar4) {
                psVar19 = psVar5 + 1;
                do {
...
LAB_004259c4:
        ...
        if (local_9c <= local_d0) {
          puVar13 = (uint *)FUN_006acf50(local_a8,(local_9c * 3 + 0x1e) * 4);
          if (puVar13 == (uint *)0x0) {
LAB_0042678e:
            local_4c = -2;
            puVar9 = local_1c;
        ...
        do {
          if (200 < local_90) {
            ...
            if (0 < local_d0) {
              iVar22 = 0;
              do {
                FUN_006a5e90(*(undefined4 **)(iVar22 + 8 + (int)local_a8));
                iVar22 = iVar22 + 0xc;
                local_d0 = local_d0 + -1;
              } while (local_d0 != 0);
            }
          ...
          if (local_44 + -1 <= (int)uVar15) {
            local_a0 = (short *)FUN_006acf50((undefined4 *)local_a0,local_44 * 8 + 0x50);
...
LAB_00426163:
                uVar15 = thunk_FUN_004248d0(this,(int)local_a0,uVar15,iVar10 + local_48,
                                            iVar18 + local_54,uVar21,0xffffffff);
              }
LAB_00426186:
              iVar11 = iVar22 << 2;
LAB_0042618f:
...
LAB_004267d5:
  ...
  if (local_4c == 0) {
    ...
    if ((param_7[7] != 0) && (puVar13 = (uint *)param_7[8], puVar13 != (uint *)0x0)) {
      ...
      if (0 < param_7[7]) {
        do {
          FUN_006a5e90((undefined4 *)local_a8[2]);
          local_a8 = local_a8 + 3;
          iVar22 = iVar22 + 1;
...
LAB_00426637:
  ...
  if ((int)uVar15 < 3) {
    FUN_006a5e90((undefined4 *)local_a0);
    local_2c = 1;
  }
  else {
