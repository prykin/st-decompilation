...
int __thiscall
thunk_FUN_0058f680(void *this,undefined2 *param_1,undefined2 *param_2,undefined2 *param_3,
                  short *param_4)

{
  ...
  if (iVar4 + -1 < *(int *)((int)this + 0x27f)) {
    iStack_18 = *(int *)((int)this + 0x27f);
  }
  iStack_14 = iVar6 + -1;
  if (iVar6 + -1 < *(int *)((int)this + 0x283)) {
    iStack_14 = *(int *)((int)this + 0x283);
  }
  ...
  do {
    ...
    case 5:
      ...
      uVar7 = iVar6 * 0x41c64e6d + 0x3039;
      *(uint *)((int)this + 0x1c) = uVar7;
      uVar7 = (uVar7 >> 0x10) % ((*(int *)((int)this + 0x28b) - iStack_8) + 1U) + iStack_8;
      uVar9 = *(int *)((int)this + 0x1c) * 0x41c64e6d + 0x3039;
      *(uint *)((int)this + 0x1c) = uVar9;
      uVar9 = (uVar9 >> 0x10) % (iStack_18 + 1U);
      break;
    case 6:
      if (iStack_8 < 0) {
        iVar6 = *(int *)((int)this + 0x1c);
