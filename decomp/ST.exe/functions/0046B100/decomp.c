...
int __thiscall FUN_0046b100(void *this,uint param_1)

{
  ...
  if (iVar12 == 0) {
    ...
    case 2:
      ...
      {
        iVar12 = FUN_006ad4d0(s_E____titans_wlad_To_boat_cpp_007a9d3c,0x23c0,0,0,&DAT_007a4ccc);
        if (iVar12 == 0) {
          return -1;
        }
        pcVar4 = (code *)swi(3);
...
LAB_0046b5ac:
    ...
    case 3:
      ...
      goto LAB_0046c3be;
    case 0xffffffff:
      iVar12 = FUN_006ad4d0(s_E____titans_wlad_To_boat_cpp_007a9d3c,0x2395,0,0,&DAT_007a4ccc);
      if (iVar12 == 0) {
        FUN_006a5e40(0xffff,DAT_007ed77c,0x7a9d3c,0x2395);
        return 0xffff;
      }
      pcVar4 = (code *)swi(3);
      iVar12 = (*pcVar4)();
    ...
    if (iVar12 == 2) {
      ...
      if (*(int *)((int)this + 0x50c) == 1) {
        ...
        if (uVar9 == 0xffffffff) {
          iVar12 = FUN_006ad4d0(s_E____titans_wlad_To_boat_cpp_007a9d3c,0x23f3,0,0,&DAT_007a4ccc);
          if (iVar12 != 0) {
            pcVar4 = (code *)swi(3);
            iVar12 = (*pcVar4)();
            return iVar12;
        ...
        if (*(char *)((int)this + 0x2bf) != '\0') {
          ...
          do {
            ...
            if (DAT_0080732c == 1) {
              ...
              *(uint *)((int)this + 0x1c) = uVar9;
              iVar12 = (uVar11 >> 0x10) % 7 + (int)*(short *)((int)this + 0x45) + -3 + (int)local_8;
            ...
            thunk_FUN_00556760(DAT_00802a7c,1,2,7,
                               ...
                               (int)(short)local_c,iVar15 + -3,iVar12,sVar19,sVar20,sVar21,sVar22,
                               sVar23,sVar24,iVar7,sVar25,bVar26);
            local_20 = local_20 + 1;
            local_10 = (undefined4 *)((int)local_10 + 6);
          } while (local_20 < (int)(uint)*(byte *)((int)this + 0x2bf));
        }
        if (local_1c == -1) {
          iVar12 = FUN_006ad4d0(s_E____titans_wlad_To_boat_cpp_007a9d3c,0x2419,0,0,&DAT_007a4ccc);
          if (iVar12 == 0) {
            FUN_006a5e40(0xffff,DAT_007ed77c,0x7a9d3c,0x241a);
            return 0xffff;
          }
          pcVar4 = (code *)swi(3);
          iVar12 = (*pcVar4)();
    ...
    if (iVar12 == 3) {
      ...
      if (uVar9 == 0xffffffff) {
        iVar12 = FUN_006ad4d0(s_E____titans_wlad_To_boat_cpp_007a9d3c,0x2434,0,0,&DAT_007a4ccc);
        if (iVar12 != 0) {
          pcVar4 = (code *)swi(3);
          iVar12 = (*pcVar4)();
          return iVar12;
    ...
    if (iVar12 == 4) {
      ...
      if (*(int *)((int)this + 0x50c) == 3) {
        ...
        if (local_1c == -1) {
          iVar12 = FUN_006ad4d0(s_E____titans_wlad_To_boat_cpp_007a9d3c,0x245f,0,0,&DAT_007a4ccc);
          if (iVar12 == 0) {
            FUN_006a5e40(0xffff,DAT_007ed77c,0x7a9d3c,0x2460);
            return 0xffff;
          }
          pcVar4 = (code *)swi(3);
          iVar12 = (*pcVar4)();
...
LAB_0046b6e2:
    ...
    if (iVar12 == 5) {
      ...
      *(undefined1 *)((int)puVar10 + 2) = 0;
      local_d4 = *(undefined4 *)((int)this + 0x24);
      local_b0 = *(undefined4 *)((int)this + 0x4e3);
      local_a8 = (int)*(short *)((int)this + 0x4df);
      local_a4 = (int)*(short *)((int)this + 0x4e1);
      local_9c = *(undefined4 *)((int)this + 0x4e7);
      local_6d = (int)*(short *)((int)this + 0x6c);
      local_a0 = (uint)*(ushort *)((int)this + 0x4fa);
      local_85 = 100;
      local_81 = 100;
      local_89 = *(undefined4 *)((int)this + 0x18);
      local_cc = 1;
      local_d0 = 1;
      local_d8 = 0x3e9;
      local_b8 = 1;
      ...
      local_b4 = uVar6;
      local_ac = (int)sVar19;
      _strncpy(local_98,(char *)((int)this + 0x4eb),0xe);
      local_8a = 0;
      if (*(int *)((int)this + 0x502) == 0) {
        ...
        uVar6 = extraout_EDX;
        if ((iVar12 != 0) &&
           (thunk_FUN_0054cc20(0x3e9,0,0,&local_d8,0), uVar6 = extraout_EDX_00,
        ...
        if ((iVar12 != 0) &&
           (thunk_FUN_0054cc20(0x3e9,0,0,&local_d8,0), uVar6 = extraout_EDX_02,
           *(int *)((int)this + 0x6f7) == 0x19)) {
          local_30 = &local_68;
          local_68 = 10000;
          local_64 = 0;
...
LAB_0046c04e:
    ...
    if (iVar12 == 6) {
      ...
      if (*(int *)((int)this + 0x50c) == 1) {
        ...
        uVar9 = thunk_FUN_00417910(this,(short)uVar9);
        if (uVar9 == 0xffffffff) {
          iVar12 = FUN_006ad4d0(s_E____titans_wlad_To_boat_cpp_007a9d3c,0x24c1,0,0,&DAT_007a4ccc);
          if (iVar12 != 0) {
            pcVar4 = (code *)swi(3);
            iVar12 = (*pcVar4)();
            return iVar12;
      ...
      if (*(int *)((int)this + 0x50c) == 3) {
        ...
        if (local_1c == -1) {
          iVar12 = FUN_006ad4d0(s_E____titans_wlad_To_boat_cpp_007a9d3c,0x24e7,0,0,&DAT_007a4ccc);
          if (iVar12 == 0) {
            FUN_006a5e40(0xffff,DAT_007ed77c,0x7a9d3c,0x24e8);
            return 0xffff;
          }
          pcVar4 = (code *)swi(3);
          iVar12 = (*pcVar4)();
    ...
    if (iVar12 != 7) {
      iVar12 = FUN_006ad4d0(s_E____titans_wlad_To_boat_cpp_007a9d3c,0x2510,0,0,&DAT_007a4ccc);
      if (iVar12 == 0) {
        return -1;
      }
      pcVar4 = (code *)swi(3);
    ...
    if (iVar12 == -1) {
      iVar12 = FUN_006ad4d0(s_E____titans_wlad_To_boat_cpp_007a9d3c,0x24fe,0,0,&DAT_007a4ccc);
      if (iVar12 != 0) {
        pcVar4 = (code *)swi(3);
        iVar12 = (*pcVar4)();
        return iVar12;
      ...
      uVar6 = 0x24fe;
LAB_0046c422:
      FUN_006a5e40(0xffff,DAT_007ed77c,0x7a9d3c,uVar6);
      return 0xffff;
    }
    if (iVar12 == 0) {
      iVar12 = (**(code **)(*(int *)this + 0xd8))();
