...
undefined4 thunk_FUN_00449e60(uint param_1,uint param_2)

{
  ...
  if (iVar2 == 0) {
    ...
    uVar5 = extraout_ECX;
    if (uVar3 != param_2) {
      FUN_006a5e40(-0x5001fff9,DAT_007ed77c,0x7a6004,0x2eea);
    ...
    FUN_006ae140(DAT_007fa154,param_1 & 0xffff,&uStack_8);
    DAT_00858df8 = (undefined4 *)uStack_50;
  }
  else {
    DAT_00858df8 = (undefined4 *)uStack_50;
    if (iVar2 != -0x5001fff7) {
      iVar4 = FUN_006ad4d0(s_E____titans_wlad_to_allpl_cpp_007a6004,0x2ef5,0,iVar2,&DAT_007a4ccc);
      if (iVar4 != 0) {
        pcVar1 = (code *)swi(3);
        uVar5 = (*pcVar1)();
        return uVar5;
      }
      FUN_006a5e40(iVar2,0,0x7a6004,0x2ef6);
      return 0xffffffff;
    }
  }
  return 0;
