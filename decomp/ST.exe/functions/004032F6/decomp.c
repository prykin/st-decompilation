...
undefined4 thunk_FUN_004d7f70(char param_1,int param_2,int param_3,int param_4)

{
  ...
  if (param_4 <= *(int *)(&DAT_007f560a + iVar1)) {
    *(undefined4 *)(&DAT_007f5612 + iVar1) = 0;
    ...
    thunk_FUN_004e43c0((int)param_1,param_4);
    *(int *)(&DAT_007f560a + iVar1) = *(int *)(&DAT_007f560a + iVar1) - param_4;
    *(int *)(&DAT_007f563a + iVar1) = *(int *)(&DAT_007f563a + iVar1) - param_4;
    piVar4[4] = piVar4[4] - param_4;
    uVar3 = 1;
    if (*(int *)(&DAT_007f560a + iVar1) == 0) {
