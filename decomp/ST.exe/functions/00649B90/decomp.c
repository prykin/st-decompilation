...

{
  ...
  if (iVar3 != 0) {
    ...
    iVar4 = FUN_006ad4d0(s_E____titans_ai_ai_creat_cpp_007d2880,0x1a7,0,iVar3,&DAT_007a4ccc);
    if (iVar4 != 0) {
      pcVar2 = (code *)swi(3);
      puVar5 = (undefined4 *)(*pcVar2)();
      return puVar5;
    }
    FUN_006a5e40(iVar3,0,0x7d2880,0x1a8);
  ...
  FUN_006a5e40(local_34[0],DAT_007ed77c,0x7d2880,0x1a1);
  DAT_00858df8 = (undefined4 *)local_78;
  return local_c;
}
