...

{
  ...
  case CASE_0:
    ...
    *param_4 = this->field_02CA;
    ...
    iVar7 = sub_00624570(this,CASE_1,this->field_02C2,this->field_02C6,this->field_02CA);
    if (iVar7 != 0) {
      ...
      if (this->field_0302 < 1) {
        if (iVar7 < iVar10 - *(int *)(&DAT_007d0398 + (uint)this->field_02AD * 4)) {
          ...
          *param_4 = (iVar10 - *(int *)(&DAT_007d0398 + (uint)this->field_02AD * 4)) + 1;
          ...
          sub_00624570(this,CASE_1,this->field_02C2,this->field_02C6,
        ...
        *param_4 = *(int *)(&DAT_007d0398 + (uint)this->field_02AD * 4) + -1 + iVar10;
        ...
        iVar7 = sub_00624570(this,CASE_1,this->field_02C2,this->field_02C6,
  ...
  case CASE_2:
    ...
    if ((1 < iVar9) &&
       ...
       (iVar7 = SubmarineTitans::Recovered::HiddenThis::RecoveredReceiver_00601500::
                thunk_FUN_00601500((RecoveredReceiver_00601500 *)&this->field_0x231,iVar10,iVar5,
    ...
    *param_4 = iVar8;
    if (this->field_02F6 <= iVar11) {
      ...
      *param_4 = (int)sVar4;
      ...
      iVar7 = sub_00624570(this,CASE_0,(int)sVar13,(int)sVar3,(int)sVar4);
      if (iVar7 != 0) {
        this->field_02EE = 0;
        this->field_02AE = CASE_1;
    ...
    if (puVar12 != (undefined *)(int)this->field_004B) {
      ...
      if (iVar6 != 0) {
        ...
        if (((((sVar3 < 0) || (g_worldGrid.sizeX <= sVar3)) || (sVar4 < 0)) ||
          ...
          iVar5 = thunk_FUN_00495ff0(sVar3,sVar4,this->field_004B,this->field_008E,
      ...
      iVar5 = sub_00624570(this,CASE_2,(int)this->field_003A,(int)this->field_003C,
...
LAB_00625067:
    ...
    *param_4 = iVar10;
    if ((this->field_02F6 <= iVar7) &&
       ...
       (iVar7 = sub_00624570(this,CASE_0,(int)this->field_003A,(int)this->field_003C,iVar10),
       iVar7 != 0)) {
      this->field_02EE = 0;
      this->field_02AE = CASE_1;
      this->field_030F = g_playSystem_00802A38->field_00E4;
