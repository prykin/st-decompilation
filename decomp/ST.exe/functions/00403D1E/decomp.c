...
undefined4 __fastcall thunk_FUN_005738d0(void *param_1)

{
  int iVar1;
  CHAR aCStack_108 [260];
  
  thunk_FUN_005734c0(param_1,0,(HKEY)0x1);
  thunk_FUN_00573260();
  wsprintfA(aCStack_108,s__s_s_s_007c6edc,(int)param_1 + 0x28,PTR_s_SAVEGAME__0079b0cc,
            (int)param_1 + 0x785);
