...
thunk_FUN_0065e9a0(void *this,uint param_1,short *param_2,uint param_3,uint param_4,byte *param_5,
...

{
  ...
  if (uVar2 != 0) {
    piStack_8 = Library::DKW::LIB::FUN_006aac10((uint)uVar2 * 0x2c);
    DAT_00811900 = 0;
    if ((char)param_6 == '\b') {
    ...
    thunk_FUN_00676d80(uVar4,param_3,param_4,param_5,(char)param_6,0,0,0,-1,-1,-1,&LAB_0040559c,
                       piStack_8,(undefined *)(~-(uint)(param_7 != 0) & 0x404935));
    if (DAT_00811900 != 0) {
      iVar3 = thunk_FUN_00423220((void *)((int)pvStack_10 + 0x1c),piStack_8,DAT_00811900);
      if ((void *)piStack_8[iVar3 * 0xb + 3] != (void *)0x0) {
        thunk_FUN_004162b0((void *)piStack_8[iVar3 * 0xb + 3],(undefined2 *)&param_1,asStack_14,
                           (undefined2 *)((int)&param_2 + 2));
        *psVar1 = (short)param_1 + -1;
        psVar1[2] = 0;
        psVar1[1] = asStack_14[0] + -1;
        psVar1[3] = 3;
        psVar1[4] = 3;
        psVar1[5] = 5;
