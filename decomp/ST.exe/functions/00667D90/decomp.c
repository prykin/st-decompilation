  ...
  if (uVar4 < 0x112) {
    if (uVar4 == 0x111) {
      ...
      if (uVar4 == 3) {
        ...
        if (*(int *)&local_10->field_0x93 == 0) {
          *(undefined4 *)&local_10->field_0x93 = 1;
        ...
        if (puVar1[3] == 0) {
          ...
          *(undefined4 *)&this_00->field_0x1c = *(undefined4 *)&this_00->field_0x86;
        }
        iVar3 = puVar1[3];
        ...
        if (iVar3 == 0) {
          ...
          *(short *)&this_00->field_0x7d = (short)uVar4;
          thunk_FUN_0065d6a0((int)this_00);
          uVar4 = *(int *)&this_00->field_0x1c * 0x41c64e6d + 0x3039;
          *(uint *)&this_00->field_0x1c = uVar4;
          *(uint *)&this_00->field_0x8b = (uVar4 >> 0x10 & 7) + 8;
          uVar4 = *(int *)&this_00->field_0x1c * 0x41c64e6d + 0x3039;
          *(uint *)&this_00->field_0x1c = uVar4;
          *(uint *)&this_00->field_0x1fb = (uVar4 >> 0x10) % 0x1a + 0x19;
          uVar4 = *(int *)&this_00->field_0x1c * 0x41c64e6d + 0x3039;
          *(uint *)&this_00->field_0x1c = uVar4;
          this_00->field_0203 = (uVar4 >> 0x10) % 0x1a + 0x19;
          thunk_FUN_00676c40(*(int *)&this_00->field_0x20b,&LAB_004013cf);
          iVar5 = *(int *)&this_00->field_0x223;
          *(undefined2 *)&this_00->field_0x170 =
               *(undefined2 *)(*(int *)&this_00->field_0x22f + 0xc);
          iVar3 = CONCAT22((short)((uint)*(int *)&this_00->field_0x22f >> 0x10),
                           *(undefined2 *)(iVar5 + 0xc));
          *(undefined2 *)&this_00->field_0x127 = *(undefined2 *)(iVar5 + 0xc);
        }
        if ((*(short *)&this_00->field_0x7d == -2) || (DAT_007fa174 == 0)) {
    ...
    *(undefined4 *)&local_10->field_0xa7 = 1;
  }
  else {
    if (uVar4 != 0x5d96) {
