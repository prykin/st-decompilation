...

{
  ...
  if ((param_1 & 1) != 0) {
    ...
    pbVar7 = abStack_158;
    puVar8 = &DAT_007ca69c;
    wsprintfA((LPSTR)pbVar7,&DAT_007ca69c,abStack_158,PTR_s_PL_LOG_0079b0d0);
    IStack_54.previous = g_currentExceptionFrame;
    g_currentExceptionFrame = &IStack_54;
    iVar5 = __setjmp3(IStack_54.jumpBuffer,0,pbVar7,puVar8);
    if (iVar5 == 0) {
      puVar6 = FUN_006f0ec0(0x345,abStack_158,2,0,0);
      if (puVar6 != (undefined4 *)0x0) {
        FUN_006f13f0(0xc,PTR_s_OPTIONS_PLAYER_0079b0d4,&DAT_008072f8,0x82,(undefined4 *)0x0,'\0',
                     (uint *)0x0);
        pvVar1 = pvStack_10;
        FUN_006f13f0(0xc,PTR_s_LASTLOG_0079b0e8,(byte *)((int)pvStack_10 + 0x7c5),0x40,
