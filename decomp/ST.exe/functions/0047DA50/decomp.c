      ...
      if ((*(int *)((int)param_1 + 0x74a) <= (int)*(short *)(DAT_00806724 + 0x23) / 2) &&
        ...
        do {
          ...
          if (DAT_0080732c == 1) {
            ...
            bVar19 = 0;
            lVar11 = __ftol();
            iVar8 = (int)local_20 + *(short *)((int)param_1 + 0x45) + local_c + (int)(short)lVar11;
            iVar9 = (int)*(short *)((int)param_1 + 0x43) - (int)local_24._2_2_;
            iVar10 = (int)(short)local_24 + iVar6 + *(short *)((int)param_1 + 0x41);
          }
          else {
            iVar8 = (int)local_20 + local_c + *(short *)((int)param_1 + 0x45);
            local_24._2_2_ = (short)((uint)uVar20 >> 0x10);
            iVar9 = (int)*(short *)((int)param_1 + 0x43) - (int)local_24._2_2_;
            local_24._0_2_ = (short)uVar20;
            iVar10 = (int)(short)local_24 + iVar6 + *(short *)((int)param_1 + 0x41);
          }
