...
uint __thiscall thunk_FUN_0062dbd0(void *this,int param_1,int param_2)

{
  ...
  if (0 < iVar3) {
    ...
    if ((-1 < (int)uStack_8) && (iVar3 = *(int *)((int)this + param_1 * 4 + 0x70), iVar3 != 0)) {
      uVar4 = 0;
      if (0 < *(int *)(iVar3 + 0xc)) {
        bVar5 = *(int *)(iVar3 + 0xc) != 0;
        do {
          if (((bVar5) && (iVar3 = *(int *)(iVar3 + 8) * uVar4 + *(int *)(iVar3 + 0x1c), iVar3 != 0)
              ) && ((int)uStack_8 < *(int *)(iVar3 + 4))) {
