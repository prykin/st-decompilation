...

{
  ...
  if ((char)iVar1 == '\x03') {
    ...
    if (param_2 == 0xdc) {
      ...
      iVar2 = thunk_FUN_004d8af0(playerId);
      if (iVar2 < param_4) goto cf_common_exit_004EB53A;
      thunk_FUN_004d8a80(playerId,param_4);
      param_4 = param_4 / iVar1;
    }
    if (param_4 == 0) goto cf_common_exit_004EB53A;
    if (param_3 == 0xdc) {
      thunk_FUN_004d87b0(playerId,param_4);
      goto cf_common_exit_004EB53A;
    }
    if (param_3 != 0xdd) {
      if (param_3 == 0xde) {
        thunk_FUN_004d8a30(playerId,*(int *)&g_playerRuntime[param_1].field_0x9b2 * param_4);
      }
      goto cf_common_exit_004EB53A;
    }
...
cf_common_exit_004EB53A:
  thunk_FUN_004d78e0(playerId);
  if (param_1 == DAT_0080874d) {
    thunk_FUN_004d8b70(playerId);
  }
  return 0;
}
