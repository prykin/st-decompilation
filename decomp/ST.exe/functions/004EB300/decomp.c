...

{
  ...
  if (bVar1 == 3) {
    ...
    if (param_2 == 0xdd) {
      iVar4 = g_packedRecords_A62x8[param_1].field2310_0x9aa;
    ...
    /* ST_PSEUDO[stack_slot_reuse]: compiler reused a dead incoming argument slot; split the post-write lifetime into a local variable */
      ...
      iVar4 = *(int *)&g_packedRecords_A62x8[param_1].field_0x9ba;
    ...
    iVar4 = param_4 / (int)g_packedRecords_A62x8[param_1].field2305_0x9a2;
  }
  else {
    /* ST_PSEUDO[stack_slot_reuse]: compiler reused a dead incoming argument slot; split the post-write lifetime into a local variable */
    if (param_2 == 0xdc) {
    ...
    iVar4 = g_packedRecords_A62x8[param_1].field2305_0x9a2 * param_4;
  }
