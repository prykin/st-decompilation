    ...
    case MESS_ID_NONE:
      ...
      if (uVar13 == 1) {
        ...
        if (uVar14 != uVar3) {
          ...
          puVar17 = (undefined4 *)FUN_006b4fa0((int *)puVar8);
          ...
          puVar8 = this_00->field_0072;
          ccFntTy::SetSurf(this_00->field_006A,(int)puVar8,0,0,0,*(int *)(puVar8 + 2),
                           *(int *)(puVar8 + 4));
