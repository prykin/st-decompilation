...

{
  ...
  bVar19 = command->playerId;
  sVar16 = command->objectId;
  /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
  local_38 = CONCAT22((short)((uint)this >> 0x10),sVar16);
  ...
  uVar6 = uVar6 >> 0x10;
  pAVar18 = g_playerRuntime[bVar19].aiPlayer;
  local_30 = pAVar18;
  local_20 = this;
  if (uVar6 != 0) {
    if (uVar6 != 1) {
      ...
      pSVar7 = GetObjPtr(g_sTAllPlayers_007FA174,bVar19,local_38,CASE_3);
    ...
    local_8 = GetObjPtr(g_sTAllPlayers_007FA174,bVar19,local_38,CASE_1);
    if (local_8 == (STGameObjC *)0x0) {
      return;
    }
    local_8c.id = MESS_TLOEMBRYOTY_4401;
    ...
    case 0x14:
      ...
      /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
      sVar16 = *(short *)((int)&(local_68->packed).value_01.words.high + 1);
      ...
      local_6c = (DArrayTy *)(int)sVar16;
      local_30 = (AiPlrClassTy *)(int)(short)uVar2;
      iVar14 = (int)(short)uVar1;
      if ((g_pathingGrid.cells
           [(int)g_pathingGrid.planeStride * (int)local_30 + iVar14 +
            (int)g_pathingGrid.sizeX * (int)local_6c] != 0) &&
         ((((((((short)uVar1 < 0 || (g_worldGrid.sizeX <= (short)uVar1)) || (sVar16 < 0)) ||
             ((g_worldGrid.sizeY <= sVar16 || ((short)uVar2 < 0)))) ||
            (g_worldGrid.sizeZ <= (short)uVar2)) ||
           (g_worldGrid.cells
            [(int)g_worldGrid.sizeX * (int)local_6c +
             iVar14 + (int)g_worldGrid.planeStride * (int)local_30].objects[0] ==
            (STWorldObject *)0x0)) && (local_28 = (uint)local_2c, (short)uVar2 < 5)))) {
        while( true ) {
          sVar15 = (short)local_28;
          if (g_pathingGrid.cells
              [(int)g_pathingGrid.planeStride * (int)sVar15 + iVar14 +
          ...
          if (((((-1 < (short)uVar1) && ((short)uVar1 < g_worldGrid.sizeX)) &&
              ...
              && (g_worldGrid.cells
                  [(int)g_worldGrid.planeStride * (int)sVar15 +
                   iVar14 + (int)g_worldGrid.sizeX * (int)sVar16].objects[0] != (STWorldObject *)0x0
                 )) || (local_28 = local_28 + 1, 4 < (short)local_28)) goto cf_common_exit_00437191;
        }
        *(int *)((int)&(local_68->packed).value_05 + 3) = (int)sVar15;
      }
cf_common_exit_00437191:
      local_8c.data = command;
      (*local_8->vtable->GetMessage)(local_8,(AnonShape_0041AF40_F59F8577 *)&local_8c);
      return;
    /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
    case 0x29:
      if ((command->payload->packed).variant == 0) {
        if (pAVar18 == (AiPlrClassTy *)0x0) {
          return;
        }
        pDVar8 = (DArrayTy *)Library::DKW::TBL::FUN_006ae290((uint *)0x0,1,2,1);
        Library::DKW::TBL::FUN_006ae1c0((uint *)pDVar8,&local_38);
        /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
        local_8c.data = (void *)((uint)local_8c.data._2_2_ << 0x10);
      }
      else {
        if (pAVar18 == (AiPlrClassTy *)0x0) {
          return;
        ...
        Library::DKW::TBL::FUN_006ae1c0((uint *)pDVar8,&local_38);
        /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
        local_8c.data = (void *)CONCAT22(local_8c.data._2_2_,1);
      }
      local_8c.id = 0x5d98;
      local_74 = pDVar8;
      (*pAVar18->vtable->GetMessage)(pAVar18,&local_8c);
  ...
  if (command->commandType == 0x17) {
    ...
    case 0x11:
      if (command->secondaryPayloadSize == 0) {
        pSVar9 = thunk_FUN_0042b760(bVar19,local_38);
        ...
        if (0 < (short)(command->secondaryPayloadSize >> 1)) {
          do {
            Library::DKW::TBL::FUN_006ae1c0
                      ((uint *)local_c,(undefined4 *)((int)pSVar4 + sVar16 * 2 + dVar21));
            sVar16 = sVar16 + 1;
            uVar6 = command->secondaryPayloadSize >> 1;
          } while (sVar16 < (short)uVar6);
        }
      }
      /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
    ...
    case 0x15:
      if (command->secondaryPayloadSize == 0) {
        ...
        if (0 < (short)(command->secondaryPayloadSize >> 1)) {
          do {
            Library::DKW::TBL::FUN_006ae1c0
                      ((uint *)pDVar8,(undefined4 *)((int)pSVar4 + sVar16 * 2 + dVar21));
            sVar16 = sVar16 + 1;
            /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
            uVar12 = extraout_ECX_00;
          } while (sVar16 < (short)(command->secondaryPayloadSize >> 1));
        }
      }
      /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
  ...
  /* ST_PSEUDO[unresolved_register_input]: candidate live-in register: verify boundary, SEH/setjmp ABI, or convention */
  case 0x14:
    iVar14 = STGroupBoatC::IsAgAtt(pSVar9,unaff_EDI);
    if (iVar14 != 0) {
...
LAB_00437842:
  ...
  case 0x17:
    ...
    case 0x10:
      ...
      return;
    case 0x13:
      sVar16 = (pSVar4->position16).x;
      sVar15 = (pSVar4->position16).z;
      sVar3 = (pSVar4->position16).y;
      if ((((-1 < sVar16) && (sVar16 < g_worldGrid.sizeX)) &&
          ((-1 < sVar3 &&
           (((sVar3 < g_worldGrid.sizeY && (-1 < sVar15)) && (sVar15 < g_worldGrid.sizeZ)))))) &&
         (g_worldGrid.cells
          [(int)sVar15 * (int)g_worldGrid.planeStride + (int)sVar3 * (int)g_worldGrid.sizeX +
           (int)sVar16].objects[0] != (STWorldObject *)0x0)) {
        orderData11.mode = 0;
  ...
  case 0x18:
    ...
    /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
    case 1:
      dVar21 = (pSVar4->packed).value_0d.whole;
      pSVar13 = pSVar9->vtable;
      /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
      bVar19 = (pSVar4->packed).value_11;
      uVar12 = 1;
      break;
    /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
    case 2:
    ...
    case 9:
      pSVar13 = pSVar9->vtable;
      uVar12 = (*pSVar13->vfunc_24)();
      iVar14 = (*pSVar9->vtable->vfunc_20)(uVar12);
      (*pSVar13->vfunc_18)(pSVar9,0xffffffff,iVar14 + 1);
      goto switchD_004384bc_default;
    case 10:
      pSVar13 = pSVar9->vtable;
      uVar12 = (*pSVar13->vfunc_24)();
    ...
    case 0xb:
      pSVar13 = pSVar9->vtable;
      iVar14 = (*pSVar13->vfunc_24)();
      uVar12 = (*pSVar9->vtable->vfunc_20)(iVar14 + 0x2d);
      (*pSVar13->vfunc_18)(pSVar9,0xffffffff,uVar12);
      goto switchD_004384bc_default;
    case 0xc:
      pSVar13 = pSVar9->vtable;
      iVar14 = (*pSVar13->vfunc_24)();
    ...
    (*pSVar13->vfunc_18)(pSVar9,uVar12,bVar19,dVar21);
...
cf_common_exit_0043824D:
  ...
  case 0x1a:
    ...
    if ((pSVar4->packed).variant == 2) {
      ...
      if ((((-1 < orderData10.sourcePosition.x) &&
        ...
        iVar14 = (*pSVar11->vtable->GetObjectTypeId)(pSVar11);
        if (iVar14 == 0x37) {
          orderData10.mode = 0;
          ...
          iVar14 = thunk_FUN_004e9960(pSVar11,(undefined4 *)&orderData10.targetPosition,
  ...
  case 0x1f:
    ...
    /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
    sVar15 = (pSVar4->packed).value_01.words.high;
    ...
    pSVar11 = g_worldGrid.cells
              [(int)sVar15 * (int)g_worldGrid.sizeX + (int)sVar16 * (int)g_worldGrid.planeStride +
...
cf_common_exit_00437E03:
      ...
      do {
        ...
        iVar14 = (*pSVar7->vtable->vfunc_2C)();
        if ((((iVar14 == 8) || (iVar14 = (*pSVar7->vtable->vfunc_2C)(), iVar14 == 0x14)) ||
            (iVar14 = (*pSVar7->vtable->vfunc_2C)(), iVar14 == 0x1a)) &&
           (iVar14 = thunk_FUN_0045ff10((int)pSVar7), iVar14 == 0xc)) {
          ...
          *(undefined2 *)puVar17 = *(undefined2 *)puVar10;
          iVar14 = FUN_006e62d0(PTR_00802a38,local_1f6,(int *)&local_40);
          /* ST_PSEUDO[raw_indirect_call]: expected typed vtable/callback call with explicit __thiscall receiver */
          if ((iVar14 == 0) && (iVar14 = (**(code **)(*local_40 + 0x88))(&local_e8), 0 < iVar14)) {
            if (local_e8 == 0xdc) {
              local_d4 = local_d4 + 1;
              pDVar20 = local_6c;
            }
              ...
              if (local_e8 != 0xde) {
                iVar14 = ReportDebugMessage(s_E____titans_wlad_to_allpl_cpp_007a6004,0x14ca,0,0,
                                            &DAT_007a4ccc,
            ...
            Library::DKW::TBL::FUN_006ae1c0(&pDVar20->flags,(undefined4 *)((int)local_40 + 0x32));
          }
        }
LAB_00437c45:
        local_28 = local_28 + 1;
        uVar6 = (uint)(short)local_28;
      } while ((int)uVar6 < (int)dVar21);
...
LAB_00437cb5:
      ...
      if (iVar14 == 0) {
        ...
        local_110 = local_34;
        iVar14 = GetPlayerRaceId(pSVar9->field_0024);
        local_100 = (-(uint)((char)iVar14 != '\x03') & 0xffffffdb) + 0x5e;
      }
      else if (iVar14 == 2) {
        local_100 = 0x4f;
        local_110 = local_2c;
      ...
      sVar15 = (pSVar4->packed).value_01.words.high;
      sVar3 = (pSVar4->position16).x;
      if (((((sVar3 < 0) || (g_worldGrid.sizeX <= sVar3)) || (sVar15 < 0)) ||
    ...
    DArrayDestroy((DArrayTy *)pAVar18);
    return;
  case 0x21:
    pSVar4 = command->payload;
    /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
    bVar19 = (pSVar4->packed).variant;
    if (bVar19 == 1) {
      /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
  ...
  /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
  case 0x28:
    bVar19 = (command->payload->packed).variant;
    if (bVar19 == 0) {
  ...
  case 0x31:
    ...
    case 2:
      ...
      if ((pSVar4->position16).x != 0) {
        ...
        do {
          Library::DKW::TBL::FUN_006ae1c0
                    (&local_148->flags,(undefined4 *)((int)pSVar4 + iVar14 * 4 + 4));
          sVar16 = sVar16 + 1;
          iVar14 = (int)sVar16;
        } while (iVar14 < (int)(uint)(ushort)(pSVar4->position16).x);
      }
      (*pSVar9->vtable->vfunc_08)(pSVar9,CASE_2,&local_150);
    ...
    case 3:
      ...
      if ((pSVar4->position16).x != 0) {
        ...
        do {
          Library::DKW::TBL::FUN_006ae1c0
                    (&local_134->flags,(undefined4 *)((int)pSVar4 + iVar14 * 2 + 4));
          sVar16 = sVar16 + 1;
          iVar14 = (int)sVar16;
        } while (iVar14 < (int)(uint)(ushort)(pSVar4->position16).x);
      }
    ...
    case 4:
      break;
    default:
      iVar14 = ReportDebugMessage(s_E____titans_wlad_to_allpl_cpp_007a6004,0x1427,0,0,&DAT_007a4ccc,
