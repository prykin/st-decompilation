...

{
  ...
  if (uVar14 != 0) {
    if (uVar14 != 1) {
      ...
      pSVar15 = GetObjPtr(g_allPlayers_007FA174,bVar1,uVar24,CASE_3);
      if (pSVar15 == nullptr) {
        return;
      }
    ...
    local_8 = GetObjPtr(g_allPlayers_007FA174,bVar1,uVar24,CASE_1);
    if (local_8 == nullptr) {
      return;
    }
...
cf_common_exit_00437191:
  ...
  if (STField<char>(command,0xe) == '\x17') {
    ...
    case 0x11:
      if (STField<int>(command,0x13) == 0) {
        ...
        local_c = (DArrayTy *)STGroupC::GetGroupContent((STGroupC *)pSVar17);
        /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
  ...
  case 0x16:
    ...
    case 5:
      ...
      pDVar16 = Library::DKW::TBL::DArrayCreate(nullptr,1,4,1);
    ...
    case 1:
      STPlaySystemC::sub_006E62D0
                (g_playSystem_00802A38,*(AnonShape_005EFAE0_B406B78B **)(puVar6 + 0x1d),
                 (int *)&local_8);
      if (local_8 != nullptr) {
        pDVar16 = Library::DKW::TBL::DArrayCreate(nullptr,1,2,1);
        Library::DKW::TBL::DArrayAppend(pDVar16,&local_8->field_0032);
        local_138 = 0;
        local_134 = pDVar16;
    ...
    case 3:
      ...
      if (((-1 < sVar5) && (sVar5 < g_worldGrid.sizeX)) &&
         ((((-1 < sVar4 && ((sVar4 < g_worldGrid.sizeY && (-1 < sVar13)))) &&
          ...
          pSVar20 != nullptr)))) {
        pDVar16 = Library::DKW::TBL::DArrayCreate(nullptr,1,2,1);
        Library::DKW::TBL::DArrayAppend(pDVar16,&pSVar20[1].field_0xe);
        uStack_d0 = 0;
        pDStack_cc = pDVar16;
...
cf_common_exit_0043824D:
    ...
    case 0xb:
    case 0xc:
      STGroupBoatC::sub_0049A500(pSVar17,&uStack_4c,&uStack_4a,auStack_48);
      pSVar17->sub_00498D20(1,(short)&uStack_4c);
      return;
    }
    break;
    ...
    if (*pcVar8 == '\x02') {
      ...
      if ((((-1 < sStack_58) && (sStack_58 < g_worldGrid.sizeX)) &&
        ...
        if (iVar25 == 0x37) {
          ...
          iVar25 = thunk_FUN_004e9960(pSVar20,(undefined4 *)&uStack_52,(undefined4 *)&uStack_50,
...
cf_common_exit_00437E03:
      ...
      do {
        ...
        if ((((iVar25 == 8) || (iVar25 = (*pSVar15->vtable->vfunc_2C)(), iVar25 == 0x14)) ||
           ...
           (iVar25 = thunk_FUN_0045ff10(pSVar15), iVar25 == 0xc)) {
          puVar19 = (byte *)thunk_FUN_0048dc90(pSVar15,local_1b8);
          puVar26 = (byte *)(&local_1fc);
          memmove(puVar26, puVar19, 0x42); /* compiler REP MOVS byte copy */
          iVar25 = STPlaySystemC::sub_006E62D0(g_playSystem_00802A38,local_1f6,(int *)&local_40);
          /* ST_PSEUDO[raw_indirect_call]: expected typed vtable/callback call with explicit __thiscall receiver */
          if ((iVar25 == 0) && (iVar25 = (**(code **)(*local_40 + 0x88))(&local_e8), 0 < iVar25)) {
            if (local_e8 == 0xdc) {
              ...
              if (local_e8 != 0xde) {
                iVar25 = ReportDebugMessage("E:\\__titans\\wlad\\to_allpl.cpp",0x14ca,0,0,
                                            "%s",
            ...
            Library::DKW::TBL::DArrayAppend(pDVar16,(void *)((int)local_40 + 0x32));
          }
        }
LAB_00437c45:
...
LAB_00437cb5:
      ...
      if (iVar25 == 0) {
        ...
        local_110 = local_34;
        bVar11 = LookupRecordByte(pSVar17->field_0024);
      ...
      Library::DKW::TBL::DArrayAppend(local_30,&pSVar20[1].field_0xe);
      local_f8 = pDVar16;
      local_ea = 0xffff;
      local_ec = 0xffff;
      local_ee = 0xffff;
  ...
  case 0x31:
    ...
    case 2:
      ...
      if (*(short *)(puVar6 + 1) != 0) {
        iVar25 = 0;
        do {
          Library::DKW::TBL::DArrayAppend(local_148,puVar6 + iVar25 * 4 + 4);
          sVar13 = sVar13 + 1;
          iVar25 = (int)sVar13;
    ...
    case 3:
      ...
      if (*(short *)(puVar6 + 1) != 0) {
        iVar25 = 0;
        do {
          Library::DKW::TBL::DArrayAppend(local_134,puVar6 + iVar25 * 2 + 4);
          sVar13 = sVar13 + 1;
          iVar25 = (int)sVar13;
        } while (iVar25 < (int)(uint)*(ushort *)(puVar6 + 1));
      }
