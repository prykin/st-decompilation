...

{
  ...
  if (uVar11 != 0) {
    ...
    local_8 = (undefined4 *)GetObjPtr(DAT_007fa174,uVar19,uVar21,1);
...
switchD_0043702c_caseD_8:
    ...
    case 0x29:
      if (**(char **)(param_1 + 0x17) == '\0') {
        ...
        Library::DKW::TBL::FUN_006ae1c0(puVar12,&local_38);
    ...
    case 0x11:
      if (*(int *)(param_1 + 0x13) == 0) {
        ...
        if (0 < (short)(*(uint *)(param_1 + 0x13) >> 1)) {
          do {
            Library::DKW::TBL::FUN_006ae1c0(local_c,(undefined4 *)(puVar7 + sVar22 * 2 + iVar20));
            sVar22 = sVar22 + 1;
      ...
      puVar12 = local_c;
      thunk_FUN_0044cdb0(CONCAT31((int3)(uVar21 >> 8),param_1[8]),(int)local_c,
  ...
  if (*(int *)(param_1 + 0x13) != 0) {
    ...
    if (0 < (short)uVar21) {
      do {
        Library::DKW::TBL::FUN_006ae1c0(local_c,(undefined4 *)(iVar20 + iVar17 + sVar22 * 2));
        sVar22 = sVar22 + 1;
        uVar21 = extraout_EDX_03;
      } while (sVar22 < (short)(*(uint *)(param_1 + 0x13) >> 1));
    }
    puVar12 = local_c;
    AddObjsToGroup(local_20,CONCAT31((int3)(uVar21 >> 8),param_1[8]),0xfffe,(int)local_c,
                   (undefined2 *)&local_1c);
  ...
  if (((local_30 != (undefined4 *)0x0) &&
      (pSVar13 = (STGroupC *)thunk_FUN_0042b760(CONCAT31((int3)(uVar21 >> 8),param_1[8]),local_1c),
    ...
    AddObjsToGroup(local_20,CONCAT31((int3)((uint)extraout_ECX_06 >> 8),param_1[8]),0xfffe,
                   (int)puVar14,(undefined2 *)&local_1c);
    pSVar13 = (STGroupC *)FUN_006ae110((byte *)puVar14);
  }
  this_01 = (STGroupBoatC *)
            thunk_FUN_0042b760(CONCAT31((int3)((uint)pSVar13 >> 8),param_1[8]),local_1c);
  ...
  case 0x14:
    ...
    if (iVar20 != 0) {
      ...
      Library::DKW::TBL::FUN_006ae1c0(puVar12,&local_14);
      local_d8 = 1;
      local_dc = puVar12;
      (**(code **)(*(int *)this_01 + 8))(6,&local_dc);
      FUN_006ae110((byte *)puVar12);
      return;
    }
    ...
    (**(code **)(*(int *)this_01 + 8))(1,&local_4c);
    return;
  case 0x15:
    local_24 = 4 - (uint)**(byte **)(param_1 + 0x17);
    (**(code **)(*(int *)this_01 + 8))(7,&local_24);
    return;
  case 0x16:
    puVar7 = *(undefined1 **)(param_1 + 0x17);
    switch(*puVar7) {
    ...
    case 5:
      ...
      local_17 = 1;
LAB_00437842:
      Library::DKW::TBL::FUN_006ae1c0(puVar12,(undefined4 *)&local_18);
      local_14c = (uint)(**(char **)(param_1 + 0x17) != '\0');
      local_150 = 0;
      local_148 = puVar12;
      (**(code **)(*(int *)this_01 + 8))(2,&local_150);
      FUN_006ae110((byte *)puVar12);
      return;
    case 1:
      FUN_006e62d0(DAT_00802a38,*(int *)(puVar7 + 1),(int *)&local_8);
      if (local_8 != (undefined4 *)0x0) {
        ...
        local_e1 = local_8[6];
        (**(code **)(*(int *)this_01 + 8))(0xf,&local_e4);
        return;
      }
      break;
    case 2:
      ...
      (**(code **)(*(int *)this_01 + 8))(0xe,&local_b0);
      return;
    }
    break;
  case 0x17:
    ...
    case 1:
      ...
      if (local_8 != (undefined4 *)0x0) {
        puVar12 = Library::DKW::TBL::FUN_006ae290((uint *)0x0,1,2,1);
        Library::DKW::TBL::FUN_006ae1c0(puVar12,(undefined4 *)((int)local_8 + 0x32));
        local_138 = 0;
        local_134 = puVar12;
        (**(code **)(*(int *)this_01 + 8))(5,&local_138);
        FUN_006ae110((byte *)puVar12);
        return;
      }
      break;
    ...
    case 0x10:
      ...
      (**(code **)(*(int *)this_01 + 8))(0x14,&local_b8);
      return;
    case 0x13:
      ...
      if ((((-1 < sVar22) && (sVar22 < DAT_007fb240)) &&
        ...
        (**(code **)(*(int *)this_01 + 8))(0x11,&local_98);
        return;
      }
      break;
    case 0x14:
    ...
    case 0x18:
      ...
      (**(code **)(*(int *)this_01 + 8))(0x13,&local_a8);
      return;
    }
    break;
  case 0x18:
...
switchD_004375b6_caseD_a:
  ...
  case 0x19:
    ...
    (**(code **)(*(int *)this_01 + 8))(0xd,&local_124);
    return;
  case 0x1a:
    ...
    if (*pcVar8 == '\x01') {
      ...
      (**(code **)(*(int *)this_01 + 8))(0x10,&local_5c);
      return;
    }
    if (*pcVar8 == '\x02') {
  ...
  case 0x1f:
    ...
    if (*pcVar8 == '\x03') {
      ...
      (**(code **)(*(int *)this_01 + 8))(0x12,&local_a0);
      return;
    }
    if (*pcVar8 == '\x01') {
      puVar12 = Library::DKW::TBL::FUN_006ae290((uint *)0x0,1,2,1);
      ...
      local_f2 = 0xffff;
      local_f4 = 0xffff;
      (**(code **)(*(int *)this_01 + 8))(8,local_118 + 1);
...
LAB_00437e03:
      ...
      (**(code **)(*(int *)this_01 + 8))(10,&local_c0);
      puVar12 = local_30;
    }
    else {
      uVar21 = 0;
        ...
        if ((((iVar20 == 8) || (iVar20 = (**(code **)(*piVar15 + 0x2c))(), iVar20 == 0x14)) ||
          ...
          *(undefined2 *)puVar23 = *(undefined2 *)puVar16;
          ...
          if ((iVar20 == 0) && (iVar20 = (**(code **)(*local_40 + 0x88))(&local_e8), 0 < iVar20)) {
            ...
            Library::DKW::TBL::FUN_006ae1c0(puVar12,(undefined4 *)((int)local_40 + 0x32));
          }
        }
LAB_00437c45:
        local_28 = local_28 + 1;
...
LAB_00437cb5:
      ...
      Library::DKW::TBL::FUN_006ae1c0(local_30,(undefined4 *)(iVar20 + 0x32));
      local_f8 = puVar12;
      local_ea = 0xffff;
      local_ec = 0xffff;
      local_ee = 0xffff;
  ...
  case 0x21:
    ...
    if (cVar1 == '\x01') {
      ...
      (**(code **)(*(int *)this_01 + 8))(0x15,&local_64);
      return;
    }
    if (cVar1 == '\x03') {
      local_c4 = 0xffff;
      local_c6 = 0xffff;
      local_c8 = 0xffff;
      (**(code **)(*(int *)this_01 + 8))(0xc,&local_c8);
      return;
    }
    if (cVar1 == '\x04') {
      local_60 = *(undefined4 *)(pcVar8 + 1);
      (**(code **)(*(int *)this_01 + 8))(0xb,&local_60);
      return;
    }
    break;
  case 0x23:
    ...
    local_166 = 0;
    local_157 = 0xffff;
    (**(code **)(*(int *)this_01 + 8))(9,&local_174);
    return;
  case 0x28:
    if (**(char **)(param_1 + 0x17) == '\0') {
  ...
  case 0x31:
    ...
    case 2:
      ...
      if (*(short *)(puVar7 + 1) != 0) {
        iVar20 = 0;
        do {
          Library::DKW::TBL::FUN_006ae1c0(local_148,(undefined4 *)(puVar7 + iVar20 * 4 + 4));
          sVar22 = sVar22 + 1;
          iVar20 = (int)sVar22;
    ...
    case 3:
      ...
      if (*(short *)(puVar7 + 1) != 0) {
        iVar20 = 0;
        do {
          Library::DKW::TBL::FUN_006ae1c0(local_134,(undefined4 *)(puVar7 + iVar20 * 2 + 4));
          sVar22 = sVar22 + 1;
          iVar20 = (int)sVar22;
        } while (iVar20 < (int)(uint)*(ushort *)(puVar7 + 1));
      }
