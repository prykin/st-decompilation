...
cf_common_exit_00437191:
  ...
  if (command->commandType == 0x17) {
        ...
        if (0 < (short)(command->secondaryPayloadSize >> 1)) {
          do {
            Library::DKW::TBL::FUN_006ae1c0
                      (&local_c->flags,(undefined4 *)((int)pSVar4 + sVar17 * 2 + dVar13));
            sVar17 = sVar17 + 1;
    ...
    case 0x15:
      if (command->secondaryPayloadSize == 0) {
        ...
        dVar13 = command->primaryPayloadSize;
        pDVar8 = Library::DKW::TBL::DArrayCreate((DArrayTy *)0x0,0,2,1);
        sVar17 = 0;
        /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
        uVar20 = extraout_ECX;
        if (0 < (short)(command->secondaryPayloadSize >> 1)) {
          do {
            Library::DKW::TBL::FUN_006ae1c0
                      (&pDVar8->flags,(undefined4 *)((int)pSVar4 + sVar17 * 2 + dVar13));
            sVar17 = sVar17 + 1;
            /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
  ...
  if (command->secondaryPayloadSize != 0) {
    ...
    AddObjsToGroup(local_20,command->playerId,0xfffe,&pDVar8->flags,(undefined2 *)&local_1c);
    DArrayDestroy(pDVar8);
  }
  pAVar19 = local_30;
  ...
  case 0x14:
    ...
    if (iVar15 != 0) {
      ...
      (*pSVar9->vtable->SetOrderData)(pSVar9,CASE_6,&orderData6);
      DArrayDestroy(pDVar8);
      return;
    }
    ...
    (*pSVar9->vtable->SetOrderData)(pSVar9,CASE_1,&orderData);
    return;
  /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
  case 0x15:
    local_24 = 4 - (uint)(command->payload->packed).variant;
    (*pSVar9->vtable->SetOrderData)(pSVar9,CASE_7,&local_24);
    return;
  case 0x16:
    pSVar4 = command->payload;
    /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
    ...
    case 5:
      ...
      pDVar8 = Library::DKW::TBL::DArrayCreate((DArrayTy *)0x0,1,4,1);
      ...
      local_17 = 1;
LAB_00437842:
      Library::DKW::TBL::FUN_006ae1c0(&pDVar8->flags,(undefined4 *)&local_18);
      /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
      local_14c = (uint)((command->payload->packed).variant != 0);
      local_150 = 0;
      local_148 = pDVar8;
      (*pSVar9->vtable->SetOrderData)(pSVar9,CASE_2,&local_150);
      DArrayDestroy(pDVar8);
      return;
    case 1:
      FUN_006e62d0(g_playSystem_00802A38,(pSVar4->position32).x,(int *)&local_8);
      if (local_8 != (STGameObjC *)0x0) {
        ...
        (*pSVar9->vtable->SetOrderData)(pSVar9,CASE_F,&orderDataF);
        return;
      }
      break;
    /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
    case 2:
      ...
      (*pSVar9->vtable->SetOrderData)(pSVar9,CASE_E,&orderDataE);
      return;
    }
    break;
  case 0x17:
    ...
    case 1:
      ...
      if (local_8 != (STGameObjC *)0x0) {
        ...
        local_138 = 0;
        local_134 = pDVar8;
        (*pSVar9->vtable->SetOrderData)(pSVar9,CASE_5,&local_138);
        DArrayDestroy(pDVar8);
        return;
      }
      break;
    ...
    case 3:
      ...
      if (((-1 < sVar3) && (sVar3 < g_worldGrid.sizeX)) &&
        ...
        (*pSVar9->vtable->SetOrderData)(pSVar9,CASE_4,&orderData4);
        DArrayDestroy(pDVar8);
        return;
      }
      break;
    ...
    case 0x10:
      ...
      (*pSVar9->vtable->SetOrderData)(pSVar9,CASE_14,&orderPosition14);
      return;
    case 0x13:
      ...
      if ((((-1 < sVar17) && (sVar17 < g_worldGrid.sizeX)) &&
        ...
        (*pSVar9->vtable->SetOrderData)(pSVar9,CASE_11,&orderData11);
        return;
      }
      break;
    case 0x14:
    ...
    case 0x18:
      ...
      (*pSVar9->vtable->SetOrderData)(pSVar9,CASE_13,&orderPosition13);
      return;
    }
    break;
  case 0x18:
...
cf_common_exit_0043824D:
      (*pSVar9->vtable->SetOrderData)(pSVar9,CASE_3,(void *)0x0);
      return;
    case 9:
    case 10:
    case 0xb:
  ...
  case 0x19:
    ...
    (*pSVar9->vtable->SetOrderData)(pSVar9,CASE_D,&orderDataD);
    return;
  case 0x1a:
    pSVar4 = command->payload;
    /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
    if ((pSVar4->packed).variant == 1) {
      ...
      (*pSVar9->vtable->SetOrderData)(pSVar9,CASE_10,&orderData10);
      return;
    }
    /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
  ...
  case 0x1f:
    ...
    if ((pSVar4->packed).variant == 3) {
      ...
      (*pSVar9->vtable->SetOrderData)(pSVar9,CASE_12,&orderPosition12);
      return;
    }
    /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
    if ((pSVar4->packed).variant == 1) {
      ...
      local_f2 = 0xffff;
      local_f4 = 0xffff;
      (*pSVar9->vtable->SetOrderData)(pSVar9,CASE_8,local_118 + 1);
      DArrayDestroy(pDVar8);
      return;
    }
    /* ST_PSEUDO[unresolved_register_input]: candidate live-in register: verify boundary, SEH/setjmp ABI, or convention */
...
cf_common_exit_00437E03:
      ...
      (*pSVar9->vtable->SetOrderData)(pSVar9,CASE_A,&orderPositionA);
      pAVar19 = local_30;
    }
    else {
      uVar6 = 0;
...
LAB_00437cb5:
  ...
  case 0x21:
    ...
    if (bVar21 == 1) {
      ...
      (*pSVar9->vtable->SetOrderData)(pSVar9,CASE_15,&local_64);
      return;
    }
    if (bVar21 == 3) {
      orderPositionC.z = -1;
      orderPositionC.y = -1;
      orderPositionC.x = -1;
      (*pSVar9->vtable->SetOrderData)(pSVar9,CASE_C,&orderPositionC);
      return;
    }
    if (bVar21 == 4) {
      /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
      local_60 = (pSVar4->packed).value_01;
      (*pSVar9->vtable->SetOrderData)(pSVar9,CASE_B,&local_60);
      return;
    }
    break;
  case 0x23:
    ...
    (*pSVar9->vtable->SetOrderData)(pSVar9,CASE_9,&orderData9);
    return;
  /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
  case 0x28:
