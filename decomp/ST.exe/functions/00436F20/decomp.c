...
void __fastcall FUN_00436f20(undefined4 param_1,undefined4 param_2,undefined1 *param_3)

{
  ...
  if (uVar11 != 0) {
    ...
    local_8 = (undefined4 *)thunk_FUN_0042b620(uVar19,uVar20,1);
    ...
    case 0x14:
      ...
      if ((*(short *)(DAT_007fb280 +
                     ((int)DAT_007fb27e * (int)local_30 + iVar13 + (int)DAT_007fb278 * (int)local_6c
                     ) * 2) != 0) &&
         ((((((((short)uVar3 < 0 || (DAT_007fb240 <= (short)uVar3)) || ((short)uVar2 < 0)) ||
             ((DAT_007fb242 <= (short)uVar2 || ((short)uVar4 < 0)))) ||
            (DAT_007fb244 <= (short)uVar4)) ||
           (*(int *)(DAT_007fb248 +
                    ((int)DAT_007fb240 * (int)local_6c + iVar13 + (int)DAT_007fb246 * (int)local_30)
...
switchD_0043702c_caseD_8:
  ...
  if (param_3[0xe] == '\x17') {
    ...
    case 0x11:
      if (*(int *)(param_3 + 0x13) == 0) {
        ...
        local_c = thunk_FUN_004233e0(iVar13);
        ...
        if (0 < (short)(*(uint *)(param_3 + 0x13) >> 1)) {
          do {
            FUN_006ae1c0(local_c,(undefined4 *)(puVar7 + sVar21 * 2 + iVar13));
            sVar21 = sVar21 + 1;
      ...
      puVar12 = local_c;
      thunk_FUN_0044cdb0(CONCAT31((int3)(uVar20 >> 8),param_3[8]),(int)local_c,
  ...
  if (*(int *)(param_3 + 0x13) != 0) {
    ...
    if (0 < (short)uVar20) {
      do {
        FUN_006ae1c0(local_c,(undefined4 *)(iVar13 + iVar17 + sVar21 * 2));
        sVar21 = sVar21 + 1;
        uVar20 = extraout_EDX_03;
      } while (sVar21 < (short)(*(uint *)(param_3 + 0x13) >> 1));
    }
    puVar12 = local_c;
    thunk_FUN_0042b7d0(CONCAT31((int3)(uVar20 >> 8),param_3[8]),0xfffe,(int)local_c,
                       (undefined2 *)&local_1c);
  ...
  if (((local_30 != (undefined4 *)0x0) &&
      (iVar13 = thunk_FUN_0042b760(CONCAT31((int3)(uVar20 >> 8),param_3[8]),local_1c), iVar13 != 0))
     && (*(int *)(iVar13 + 0x1c) != 0)) {
  ...
  this_00 = (int *)thunk_FUN_0042b760(CONCAT31((int3)((uint)iVar13 >> 8),param_3[8]),local_1c);
  if (this_00 == (int *)0x0) {
    return;
  }
  ...
  case 0x14:
    ...
    (**(code **)(*this_00 + 8))(1,&local_4c);
    return;
  case 0x15:
    local_24 = 4 - (uint)**(byte **)(param_3 + 0x17);
    (**(code **)(*this_00 + 8))(7,&local_24);
    return;
  case 0x16:
    puVar7 = *(undefined1 **)(param_3 + 0x17);
    switch(*puVar7) {
...
switchD_004375b6_caseD_a:
    ...
    if (*pcVar8 == '\x02') {
      ...
      if ((((-1 < local_58) && (local_58 < DAT_007fb240)) &&
        ...
        if (iVar13 == 0x37) {
          ...
          iVar13 = thunk_FUN_004e9960(piVar15,(undefined4 *)&local_52,(undefined4 *)&local_50,
                                      (undefined4 *)&local_4e);
          if (iVar13 != 1) {
            return;
          }
  ...
  case 0x1f:
    ...
    if (*pcVar8 == '\x01') {
      ...
      local_f2 = 0xffff;
      local_f4 = 0xffff;
      (**(code **)(*this_00 + 8))(8,local_118 + 1);
      FUN_006ae110((byte *)local_c);
      return;
    }
    local_c = thunk_FUN_004233e0((int)this_00);
    uVar20 = local_c[3];
    local_154 = uVar20;
...
LAB_00437e03:
      iVar13 = *(int *)(param_3 + 0x17);
      local_c0 = *(undefined2 *)(iVar13 + 1);
      local_be = *(undefined2 *)(iVar13 + 3);
      local_bc = *(undefined2 *)(iVar13 + 5);
      (**(code **)(*this_00 + 8))(10,&local_c0);
      puVar12 = local_30;
    }
    else {
      uVar20 = 0;
      do {
        ...
        if ((((iVar13 == 8) || (iVar13 = (**(code **)(*piVar15 + 0x2c))(), iVar13 == 0x14)) ||
          ...
          *(undefined2 *)puVar22 = *(undefined2 *)puVar16;
          iVar13 = FUN_006e62d0(DAT_00802a38,local_1f6,(int *)&local_40);
          if ((iVar13 == 0) && (iVar13 = (**(code **)(*local_40 + 0x88))(&local_e8), 0 < iVar13)) {
            if (local_e8 == 0xdc) {
              local_d4 = local_d4 + 1;
              puVar12 = local_6c;
            }
...
LAB_00437cb5:
      ...
      if (iVar13 == 0) {
        ...
        local_100 = (-(uint)((char)iVar13 != '\x03') & 0xffffffdb) + 0x5e;
      }
      else if (iVar13 == 2) {
        local_100 = 0x4f;
        local_110 = local_2c;
      ...
      FUN_006ae1c0(local_30,(undefined4 *)(iVar13 + 0x32));
      local_f8 = puVar12;
      local_ea = 0xffff;
      local_ec = 0xffff;
      local_ee = 0xffff;
  ...
  case 0x21:
    ...
    if (cVar1 == '\x03') {
      ...
      local_c6 = 0xffff;
      local_c8 = 0xffff;
      (**(code **)(*this_00 + 8))(0xc,&local_c8);
      return;
    }
    if (cVar1 == '\x04') {
      local_60 = *(undefined4 *)(pcVar8 + 1);
      (**(code **)(*this_00 + 8))(0xb,&local_60);
      return;
    }
    break;
  case 0x23:
  ...
  case 0x29:
    if (**(char **)(param_3 + 0x17) != '\0') {
      ...
      local_7c = 0x5d98;
      local_78 = (undefined1 *)CONCAT22(local_78._2_2_,1);
      local_74 = *(uint **)((int)this_00 + 0x29);
  ...
  case 0x31:
    ...
    case 2:
      ...
      if (*(short *)(puVar7 + 1) != 0) {
        iVar13 = 0;
        do {
          FUN_006ae1c0(local_148,(undefined4 *)(puVar7 + iVar13 * 4 + 4));
          sVar21 = sVar21 + 1;
          iVar13 = (int)sVar21;
    ...
    case 3:
      ...
      if (*(short *)(puVar7 + 1) != 0) {
        iVar13 = 0;
        do {
          FUN_006ae1c0(local_134,(undefined4 *)(puVar7 + iVar13 * 2 + 4));
          sVar21 = sVar21 + 1;
          iVar13 = (int)sVar21;
        } while (iVar13 < (int)(uint)*(ushort *)(puVar7 + 1));
      }
