...

{
  ...
  local_20 = this;
  iVar7 = Library::MSVCRT::__setjmp3(local_84.jumpBuffer,0);
  this_00 = local_20;
  if (iVar7 != 0) {
  ...
  if (uVar16 < 0xc001) {
      ...
      if (0x60 < uVar16) {
        ...
        if (uVar16 == 0x6200) {
          ...
          Library::DKW::WGR::FUN_006b55f0
                    ((AnonShape_006B5B10_E0D06CF1 *)this_00->field_0068,0,0x21,iVar7,
    ...
    case 0x8161:
      ...
      if (local_8 != (UINT *)0x0) {
        ...
        pcVar11 = LoadResourceString(local_18,HINSTANCE_00807618);
        uVar16 = 0xffffffff;
        do {
          pcVar21 = pcVar11;
          if (uVar16 == 0) break;
