...

{
  ...
  if (uVar14 < 0xc001) {
    ...
    if (uVar14 < 0x8161) {
      if (uVar14 == 0x8160) {
        iVar5 = *(int *)&this_00->field_0x1e4;
        if (*(int *)(iVar5 + 0xa0) != 0) {
          FUN_00710790(iVar5);
        }
        *(int *)(param_1 + 0x18) = *(int *)(iVar5 + 0x8a) + 1;
        g_currentExceptionFrame = local_84.previous;
        return 0;
      }
      if (0x60 < uVar14) {
        if (uVar14 == 0x61) {
          ...
          case 0xc:
            local_1c = (uint *)0x0;
            local_14 = *(undefined4 **)(*(int *)&this_00->field_0x1d7 + 0xc);
            if (local_14 == (undefined4 *)0x0) {
              g_currentExceptionFrame = local_84.previous;
              return 0;
            }
            local_18 = (uint)*(ushort *)&this_00->field_0x1af -
                       (uint)*(ushort *)&this_00->field_0x1b1 * *(int *)&this_00->field_0x1c3;
            while( true ) {
              if (local_1c < local_14) {
                piVar6 = (int *)(*(int *)(*(int *)&this_00->field_0x1d7 + 8) * (int)local_1c +
                                *(int *)(*(int *)&this_00->field_0x1d7 + 0x1c));
              }
              else {
                piVar6 = (int *)0x0;
              }
              local_24 = piVar6[3];
              local_30 = *(int *)&this_00->field_0x3c + 0x21 + *piVar6;
              local_2c = piVar6[1] + local_18 + 0x16 + *(int *)&this_00->field_0x44;
              local_28 = piVar6[2];
              ...
              if ((bVar19) && ((int)local_8 < *(int *)&this_00->field_0x44 + 300)) break;
          ...
          default:
            ...
            return 0;
          case 8:
            if (*(int *)(*(int *)&this_00->field_0x1d7 + 0xc) == 0) {
              piVar6 = (int *)0x0;
            }
            else {
              piVar6 = *(int **)(*(int *)&this_00->field_0x1d7 + 0x1c);
            }
            local_30 = *(int *)&this_00->field_0x3c + 0x21 + *piVar6;
            local_2c = ((uint)*(ushort *)&this_00->field_0x1af -
                       (uint)*(ushort *)&this_00->field_0x1b1 * *(int *)&this_00->field_0x1c3) +
                       piVar6[1] + 0x16 + *(int *)&this_00->field_0x44;
            local_28 = piVar6[2];
            local_24 = piVar6[3];
            if (((((int)local_c < local_30) || (local_28 + local_30 <= (int)local_c)) ||
                ((int)local_8 < local_2c)) || (local_24 + local_2c <= (int)local_8)) {
            ...
            if (*(int *)&this_00->field_0x44 + 300 <= (int)local_8) {
              g_currentExceptionFrame = local_84.previous;
              return 0;
            }
        ...
        if (uVar14 == 0x6200) {
          *(undefined4 *)&this_00->field_0x1c3 = *(undefined4 *)(param_1 + 0x14);
          iVar5 = *(ushort *)&this_00->field_0x1af + 0x16;
          Library::DKW::WGR::FUN_006b55f0
                    (*(undefined4 **)&this_00->field_0x68,0,0x21,iVar5,*(int *)&this_00->field_0x1dc
                     ,0,0x21,iVar5,0x19c,0x117 - (uint)*(ushort *)&this_00->field_0x1af);
          Library::DKW::WGR::FUN_006b5110
                    (*(int *)&this_00->field_0x68,0,0x21,*(ushort *)&this_00->field_0x1af + 0x16,
                     this_00->field_0218,0,0,
                     (uint)*(ushort *)&this_00->field_0x1b1 * *(int *)&this_00->field_0x1c3,0x19c,
                     0x117 - (uint)*(ushort *)&this_00->field_0x1af,0xff);
        ...
        if ((int)uVar15 < (int)(uVar15 + *(int *)((int)local_10 + 0x1e0))) {
          do {
            if ((int)uVar14 < *(int *)(*(int *)&this_00->field_0x1d3 + 8)) {
              local_1c = *(uint **)(*(int *)(*(int *)&this_00->field_0x1d3 + 0x14) + uVar14 * 4);
            }
            else {
              local_1c = (uint *)0x0;
            }
            if (local_1c != (uint *)0x0) {
              ccFntTy::SetSurf(*(ccFntTy **)&this_00->field_0x1e4,this_00->field_0218,0,0,
                               (uVar14 - uVar15) * local_18,*(int *)(this_00->field_0218 + 4),
                               local_18);
              ccFntTy::WrStr(*(ccFntTy **)&this_00->field_0x1e4,local_1c,0,-1,(uint)local_14 & 0xff)
              ;
            }
            uVar15 = (uint)*(ushort *)(param_1 + 0x16);
            uVar14 = uVar14 + 1;
        ...
        Library::DKW::WGR::FUN_006b5110
                  (*(int *)&this_00->field_0x68,0,0x21,0x16,this_00->field_0218,0,0,0,0x19c,0x118,
                   0xff);
        g_currentExceptionFrame = local_84.previous;
        return 0;
      }
      if (uVar14 != 0x60) {
        if (uVar14 == 0) {
          if (*(short *)&this_00->field_0x172 == 3) {
            iVar5 = *(int *)&this_00->field_0x50;
            if (*(int *)&this_00->field_0x44 < iVar5) {
              *(int *)&this_00->field_0x44 = *(int *)&this_00->field_0x44 + 0x28;
            }
            if (iVar5 <= *(int *)&this_00->field_0x44) {
              *(int *)&this_00->field_0x44 = iVar5;
          ...
          iVar5 = *(int *)&this_00->field_0x50 - *(int *)&this_00->field_0x48;
          if (iVar5 < *(int *)&this_00->field_0x44) {
            *(int *)&this_00->field_0x44 = *(int *)&this_00->field_0x44 + -0x28;
          }
          if (*(int *)&this_00->field_0x44 <= iVar5) {
      ...
      if (*(short *)&this_00->field_0x172 == 1) {
        ...
        case 0xc:
          ...
          if (local_14 != (undefined4 *)0x0) {
            do {
              if (local_8 < local_14) {
                piVar6 = (int *)(*(int *)(*(int *)&this_00->field_0x1d7 + 8) * (int)local_8 +
                                *(int *)(*(int *)&this_00->field_0x1d7 + 0x1c));
              }
              else {
                piVar6 = (int *)0x0;
              }
              local_40 = *(int *)&this_00->field_0x3c + 0x21 + *piVar6;
              local_3c = piVar6[1] +
                         ((uint)*(ushort *)&this_00->field_0x1af -
                         (uint)*(ushort *)&this_00->field_0x1b1 * *(int *)&this_00->field_0x1c3) +
                         0x16 + *(int *)&this_00->field_0x44;
              local_38 = piVar6[2];
              local_34 = piVar6[3];
              ...
              if ((bVar19) && ((int)local_c < *(int *)&this_00->field_0x44 + 300))
              goto LAB_0051e1b2;
    ...
    switch(uVar14) {
    case 0x8161:
      cVar2 = this_00->field_01A1;
      if (cVar2 == '\0') {
        iVar5 = *(int *)&this_00->field_0x1b3;
      }
      else {
        if (cVar2 != '\n') {
          g_currentExceptionFrame = local_84.previous;
        ...
        iVar5 = *(int *)&this_00->field_0x1bb;
      }
      uVar14 = (uint)*(ushort *)(param_1 + 0x14);
      if (uVar14 < *(uint *)(iVar5 + 0xc)) {
        if (cVar2 == '\0') {
          local_8 = (UINT *)(*(int *)(*(int *)&this_00->field_0x1b3 + 8) * uVar14 +
                            *(int *)(*(int *)&this_00->field_0x1b3 + 0x1c));
        }
        else {
          local_8 = (UINT *)(*(int *)(*(int *)&this_00->field_0x1bb + 8) * uVar14 +
                            *(int *)(*(int *)&this_00->field_0x1bb + 0x1c));
        }
      }
      else {
        local_8 = (UINT *)0x0;
      ...
      if (local_8 != (UINT *)0x0) {
        ...
        Library::DKW::WGR::FUN_006b55f0
                  (*(undefined4 **)&this_00->field_0x68,0,0x21,iVar5,*(int *)&this_00->field_0x1dc,0
                   ,0x21,iVar5,0x19c,*(int *)(*(int *)&this_00->field_0x1ec + 8));
        iVar5 = *(int *)&this_00->field_0x1ec;
        ...
        ccFntTy::SetSurf(*(ccFntTy **)&this_00->field_0x1e4,*(int *)&this_00->field_0x1ec,0,0,0,0,0)
        ;
        ...
        ccFntTy::WrStr(*(ccFntTy **)&this_00->field_0x1e4,&DAT_0080f33a,
        ...
        if ((this_00->field_01A1 == '\0') && (*(byte *)((int)pUVar4 + 0x11) != 0)) {
          ...
          iVar5 = *(int *)(*(int *)&this_00->field_0x1ec + 8) / 2;
          FUN_006b5b10(*(int *)&this_00->field_0x1ec,0,iVar12,iVar5,iVar12 + 8,iVar5,(byte)local_1c,
                       0xd);
          if (*(char *)((int)local_8 + 0x13) == '\0') {
            iVar5 = *(int *)(*(int *)&this_00->field_0x1ec + 8);
          }
          iVar12 = (uint)*(byte *)((int)local_8 + 0x11) * 0x14;
          FUN_006b5b10(*(int *)&this_00->field_0x1ec,0,iVar12,0,iVar12,iVar5,(byte)local_10,0xd);
          local_14 = (undefined4 *)0x0;
          local_c = (uint)*(ushort *)(param_1 + 0x14);
          local_18 = *(uint *)(*(int *)&this_00->field_0x1b3 + 0xc);
          local_1c = (uint *)local_c;
joined_r0x0051eec7:
          local_1c = (uint *)((int)local_1c + 1);
          if (local_1c < local_18) {
            if (local_1c < local_18) {
              iVar5 = *(int *)(*(int *)&this_00->field_0x1b3 + 8) * (int)local_1c +
                      *(int *)(*(int *)&this_00->field_0x1b3 + 0x1c);
            }
            else {
              iVar5 = 0;
            ...
            if (bVar17 < *(byte *)((int)local_8 + 0x11)) {
              do {
                ...
                if (uVar14 < local_18) {
                  iVar5 = *(int *)(*(int *)&this_00->field_0x1b3 + 8) * uVar14 +
                          *(int *)(*(int *)&this_00->field_0x1b3 + 0x1c);
                }
                else {
                  iVar5 = 0;
...
LAB_0051ef61:
          ...
          do {
            if (((uint)local_14 & 1 << (bVar17 & 0x1f)) != 0) {
              FUN_006b5b10(*(int *)&this_00->field_0x1ec,0,iVar5,0,iVar5,
                           *(int *)(*(int *)&this_00->field_0x1ec + 8),(byte)local_10,0xd);
            }
            iVar5 = iVar5 + 0x14;
            bVar17 = bVar17 + 1;
          } while (iVar5 < 0x280);
        }
        FUN_006b5440(*(int *)&this_00->field_0x68,0,0x21,*(ushort *)(param_1 + 0x1a) + 0x16,
                     *(int *)&this_00->field_0x1ec,0,0xff);
      }
      Library::DKW::DDX::FUN_006b3640
    ...
    case 0x8162:
      ...
      if (uVar14 < *(uint *)(iVar5 + 0xc)) {
        if (cVar2 == '\0') {
          local_1c = (uint *)(*(int *)(*(int *)&this_00->field_0x1b3 + 8) * uVar14 +
                             *(int *)(*(int *)&this_00->field_0x1b3 + 0x1c));
        }
        else {
          local_1c = (uint *)(*(int *)(*(int *)&this_00->field_0x1bb + 8) * uVar14 +
                             *(int *)(*(int *)&this_00->field_0x1bb + 0x1c));
        }
      }
      else {
...
switchD_0051ea9b_caseD_0:
    ...
    case 0x8163:
      if (this_00->field_01A1 != '\n') {
        *(undefined4 *)&this_00->field_0x1b7 = *(undefined4 *)(param_1 + 0x14);
        g_currentExceptionFrame = local_84.previous;
        return 0;
      }
    ...
    case 0x8165:
      ...
      break;
    case 0x8166:
      pbVar8 = (byte *)FUN_0070b3a0(*(int *)&this_00->field_0x220,0);
      thunk_FUN_00540760(*(undefined4 **)&this_00->field_0x68,0x1c3,0x2d,'\x06',pbVar8);
      pbVar8 = (byte *)FUN_0070b3a0(*(int *)&this_00->field_0x220,
                                    (*(int *)(*(int *)(param_1 + 0x1c) + 0x1c) != 1) + 1);
      thunk_FUN_00540760(*(undefined4 **)&this_00->field_0x68,0x1c3,
                         *(ushort *)(param_1 + 0x16) + 0x2d,'\x06',pbVar8);
      Library::DKW::DDX::FUN_006b3640
                (DAT_008075a8,*(uint *)&this_00->field_0x60,0xffffffff,*(uint *)&this_00->field_0x3c
                 ,*(uint *)&this_00->field_0x44);
      g_currentExceptionFrame = local_84.previous;
...
switchD_0051e4d9_caseD_6:
  ...
  local_1c = (uint *)(uint)*(ushort *)&this_00->field_0x1af;
  while( true ) {
    local_30 = *(int *)((int)local_10 + (uint)uVar16 * 0xd + 5) + 0x21 +
               *(int *)&this_00->field_0x3c;
  ...
  return 0;
LAB_0051e1b2:
  this_00->field_0x1db = 0x46;
switchD_0051dfcc_caseD_7:
  iVar5 = *(int *)&this_00->field_0x178;
  ...
  *(undefined4 **)&this_00->field_0x178 = local_10;
  if (local_10 == (undefined4 *)0x0) {
    g_currentExceptionFrame = local_84.previous;
    return 0;
  }
