...
void FUN_00503bb0(uint param_1)

{
  ...
  *(undefined4 *)((int)local_10 + 300) = 0;
  if (*(char *)((int)local_10 + 0xb64) == '\0') {
    thunk_FUN_004f8020(local_10,'\x01',0);
  }
  *(undefined4 *)((int)local_10 + 300) = 1;
  ...
  bVar1 = *(byte *)((param_1 & 0xff) + 0xba2 + (int)local_10);
  switch((uint)bVar1) {
  case 1:
    local_5 = 0;
