...

{
  ...
  MVar1 = pMStack_c[0x65];
  if (MVar1 == (MReportTy)0x1) {
    if (((pMStack_c[0x67] != (MReportTy)0x0) && (pMStack_c[0x69] == (MReportTy)0x0)) &&
       (pMStack_c[0x68] != (MReportTy)0x0)) {
      bVar3 = false;
...
LAB_005bfb27:
    ...
    if (*(HoloTy **)(pMStack_c + 0x453) != (HoloTy *)0x0) {
      iVar4 = HoloTy::NextFas(*(HoloTy **)(pMStack_c + 0x453));
      if (iVar4 != 0) {
        iStack_8 = 0;
      }
    }
