      ...
      case 0:
        *(undefined4 *)((int)this + 0xb7) = 0;
        ...
        if ((CONCAT31(extraout_var,bVar5) != 1) ||
           (iVar7 = thunk_FUN_004e91e0(piStack_8,this), iVar7 != 1)) {
LAB_00479e39:
...
LAB_0047b2dc:
      ...
      case 1:
        ...
        if (((piStack_8 != (int *)0x0) && (piStack_8[6] == *(int *)((int)this + 0x63f))) &&
           (iVar7 = (**(code **)(*piStack_8 + 0xf8))(), iVar7 != 0)) {
          if (*(int *)((int)this + 0x635) != 1) {
            return 2;
          }
          sVar16 = *(short *)((int)this + 0x643);
...
LAB_00479ba6:
      ...
      if (iVar7 == 1) {
        *(int *)((int)this + 0x65d) = *(int *)((int)this + 0x65d) + 1;
        ...
        iVar7 = thunk_FUN_004e91e0(piStack_8,this);
        if (iVar7 != 1) {
          return 2;
        }
        *(undefined4 *)((int)this + 0x663) = 2;
              ...
              if (*(int *)((int)this + 0x667) == 0) {
                ...
                if ((((iVar7 == 7) || (iVar7 == 0x13)) || (iVar7 == 0x1b)) &&
                   ((*(int *)((int)this + 0x7ca) != 0 &&
                    (iVar7 = FUN_006e62d0(DAT_00802a38,*(int *)((int)this + 0x7ca),(int *)&piStack_8
                                         ), iVar7 != -4)))) {
                  ...
                  uVar25 = 0;
                  iVar11 = 0;
                  uVar9 = thunk_FUN_004ad650((int)piStack_8 + 0x1d5);
                }
                else {
                  iVar21 = (int)*(short *)((int)this + 0x45);
                  iVar7 = (int)*(short *)((int)this + 0x43);
...
LAB_0047acdc:
            ...
            *(uint *)((int)this + 0x1c) = uVar25;
            ...
            if ((*(int *)((int)this + 0x74a) <= (int)*(short *)(DAT_00806724 + 0x23) / 2) &&
              ...
              do {
                ...
                if (DAT_0080732c == 1) {
                  ...
                  bVar23 = 0;
                  lVar15 = __ftol();
                  iVar14 = (int)sStack_24 +
                           *(short *)((int)this + 0x45) + iStack_20 + (int)(short)lVar15;
                  iVar8 = (int)*(short *)((int)this + 0x43) - (int)uStack_28._2_2_;
                  iVar11 = (int)(short)uStack_28 + iVar7 + *(short *)((int)this + 0x41);
                }
                else {
                  iVar14 = (int)sStack_24 + iStack_20 + *(short *)((int)this + 0x45);
                  uStack_28._2_2_ = (short)((uint)uVar24 >> 0x10);
                  iVar8 = (int)*(short *)((int)this + 0x43) - (int)uStack_28._2_2_;
                  uStack_28._0_2_ = (short)uVar24;
                  iVar11 = (int)(short)uStack_28 + iVar7 + *(short *)((int)this + 0x41);
                }
            ...
            if ((((sVar16 < 0) || (DAT_007fb240 <= sVar16)) || (sVar13 < 0)) ||
              ...
              piStack_8 = *(int **)(DAT_007fb248 +
                                   ((int)sVar17 * (int)DAT_007fb246 +
                                    (int)sVar13 * (int)DAT_007fb240 + iVar7) * 8);
            }
            if ((piStack_8 != (int *)0x0) &&
               (iVar7 = piStack_8[6], iVar7 == *(int *)((int)this + 0x63f))) {
              iVar21 = (**(code **)(*piStack_8 + 0xf8))();
              iVar7 = 0;
              if (iVar21 != 0) {
                iVar7 = thunk_FUN_004e95c0(piStack_8,(int)this);
              }
            }
            sVar16 = *(short *)((int)this + 0x643);
...
joined_r0x0047b202:
              ...
              if (piStack_8[0x10b] != 0) {
                ...
                if (piVar12 != (int *)0x0) {
                  *piVar12 = piStack_8[0x10e];
                }
              }
              if (piStack_8[0x10b] == 0) {
                uVar9 = CONCAT22((short)((uint)piStack_8 >> 0x10),*(short *)((int)this + 0x647) + 1)
                ;
                iVar7 = CONCAT22((short)((uint)((int)this + 0x651) >> 0x10),
                                 *(undefined2 *)((int)this + 0x643));
          ...
          if ((*(int *)((int)this + 0x74a) <= (int)*(short *)(DAT_00806724 + 0x23) / 2) &&
            ...
            do {
              ...
              if (DAT_0080732c == 1) {
                ...
                lVar15 = __ftol();
                iVar14 = (int)sStack_24 +
                         *(short *)((int)this + 0x45) + iStack_18 + (int)(short)lVar15;
                iVar8 = (int)*(short *)((int)this + 0x43) - (int)uStack_28._2_2_;
                iVar11 = (int)(short)uStack_28 + iVar7 + *(short *)((int)this + 0x41);
              }
              else {
                iVar14 = (int)sStack_24 + iStack_18 + *(short *)((int)this + 0x45);
                uStack_28._2_2_ = (short)((uint)uVar24 >> 0x10);
                iVar8 = (int)*(short *)((int)this + 0x43) - (int)uStack_28._2_2_;
                uStack_28._0_2_ = (short)uVar24;
                iVar11 = (int)(short)uStack_28 + iVar7 + *(short *)((int)this + 0x41);
