  ...
  if (((this->field_1E8E != 0) && (this->field_1E92 != 0)) && (local_14 != 0)) {
    ...
    if (iVar4 == 0) {
      ...
      thunk_FUN_00540620(0x18a,0x90,0x168,0x32,100,(byte *)0x19,'\x01',
                         (BITMAPINFO *)local_10->field_1E92);
      wsprintfA((LPSTR)local_48,s__6d____6d_007cc2a4,*(int *)(pFVar2 + 1),
                *(int *)&pFVar2[1].field_0x4 + -1 + *(int *)(pFVar2 + 1));
      StartServTy::WrTextDDX
                (local_48,0,0x18b,0x91,0x62,0x17,(uint *)local_48,0xffffffff,0xffffffff,
                 *(void **)&pFVar2->field_0x1a7f,0);
      thunk_FUN_00540620(0x22,0xd6,0,0x78,0x2e1,(byte *)0xfd,'\x01',(BITMAPINFO *)pFVar2->field_1E92
                        );
      if (*(int *)&pFVar2[1].field_0x4 != 0) {
        local_8 = (StartServTy *)0xdb;
        piVar9 = (int *)(local_14 + 0xc);
        local_c = 0;
        do {
          wsprintfA((LPSTR)local_48,&DAT_007c28fc,*(int *)(pFVar2 + 1) + local_c);
          StartServTy::WrTextDDX
          ...
          if (iVar4 != -2) {
            ...
            pSVar3 = local_8;
            StartServTy::WrTextDDX
                      (*(StartServTy **)&pFVar2->field_0x1a7f,0,0x13b,(int)local_8,0x44,0x10,
                       (uint *)local_48,0xffffffff,0xffffffff,*(StartServTy **)&pFVar2->field_0x1a7f
                       ,0);
            wsprintfA((LPSTR)local_48,s__6d____6d____6d_007cc290,piVar9[-2],piVar9[-1],*piVar9);
            StartServTy::WrTextDDX
                      (*(StartServTy **)&pFVar2->field_0x1a7f,0,0x181,(int)pSVar3,0x8f,0x10,
                       (uint *)local_48,0xffffffff,0xffffffff,*(StartServTy **)&pFVar2->field_0x1a7f
                       ,0);
            ...
            StartServTy::WrTextDDX
                      (*(StartServTy **)&pFVar2->field_0x1a7f,0,0x28a,(int)pSVar3,0x76,0x10,
                       (uint *)local_48,0xffffffff,0xffffffff,*(StartServTy **)&pFVar2->field_0x1a7f
                       ,0);
            local_8 = pSVar3;
          }
        ...
        } while (local_c < *(uint *)&pFVar2[1].field_0x4);
      }
