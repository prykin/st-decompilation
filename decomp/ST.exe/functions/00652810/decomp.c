...
uint * __thiscall FUN_00652810(void *this,int param_1)

{
  ...
  puVar5 = (uint *)0x0;
  if ((DAT_007fa174 != 0) &&
     (local_188 = this, puVar5 = (uint *)thunk_FUN_0065bd70(this,param_1,0), -1 < (int)puVar5)) {
    local_194 = puVar5;
    ...
    *(undefined4 *)((int)this + 0x52b) = uVar6;
    ...
    iVar7 = __setjmp3(local_280,0,unaff_EDI,unaff_ESI);
    this_00 = local_188;
    if (iVar7 == 0) {
      local_14 = 0;
      iVar7 = *(int *)((int)local_188 + 0x4ee);
      bVar28 = *(int *)(iVar7 + 0xc) != 0;
      if (0 < *(int *)(iVar7 + 0xc)) {
        do {
          uVar25 = local_14;
          if (bVar28) {
            pcVar22 = (char *)(*(int *)(iVar7 + 8) * local_14 + *(int *)(iVar7 + 0x1c));
          }
          else {
            pcVar22 = (char *)0x0;
          }
          local_178 = pcVar22;
          if (*pcVar22 == '\0') {
            if (*(uint **)(pcVar22 + 5) == local_194) {
              if (local_198 == 0) {
                thunk_FUN_0065bd70(this_00,param_1,1);
                local_198 = 1;
              }
              iVar7 = thunk_FUN_00672440((int)this_00 + 0x4fa,(int)*(short *)(pcVar22 + 9),local_16c
                                        );
              uVar29 = uVar25;
              if (iVar7 < 0) {
                iVar30 = this_00[0x21];
                  ...
                  if (local_164 != (uint ************)0x0) {
                    *pcVar22 = '\x01';
                    ...
                    if (0 < (int)ppppppppppppuVar23) {
                      do {
                        if (local_170 < ppppppppppppuVar23) {
                          psVar9 = (short *)(*(int *)(iVar7 + 8) * (int)local_170 +
                                            *(int *)(iVar7 + 0x1c));
                        }
                        else {
                          psVar9 = (short *)0x0;
                        }
                        iVar7 = thunk_FUN_00672440((int)this_00 + 0x4fa,(int)*psVar9,local_16c);
                        if (iVar7 < 0) {
                          ...
                          if (0x5c8 < iVar7) {
                            if (iVar7 < 0x76d) {
                              if (iVar7 != 0x76c) {
                                switch(iVar7) {
                                case 0x5dc:
                                  iVar30 = thunk_FUN_00651010(local_16c);
                                  if (iVar30 != 0) {
                                    iVar30 = (**(code **)(*this_00 + 0x18))();
                                    if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                      ppppppppppppuVar23 =
                                           (uint ************)
                                           thunk_FUN_00668f50(this_00,(char *)local_164,
                                                              (uint)local_160,(uint *)local_34);
                                      if (0 < (int)ppppppppppppuVar23) {
                                        ppppppppppppuVar16 = (uint ************)local_34;
                                        local_c = ppppppppppppuVar23;
                                        do {
                                          thunk_FUN_0064e300((int)*ppppppppppppuVar16,
                                                             (char *)local_15c,(short)local_158,
                                                             (char)local_154,(short)local_150,
                                                             (char)local_14c,(uint)local_148);
                                  ...
                                  break;
                                case 0x5dd:
                                  bVar28 = thunk_FUN_00651120((int)local_16c);
                                  if (CONCAT31(extraout_var_15,bVar28) != 0) {
                                    iVar30 = (**(code **)(*this_00 + 0x18))();
                                    if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                      iVar30 = thunk_FUN_00668f50(this_00,(char *)local_164,
                                                                  (uint)local_160,(uint *)local_34);
                                      if (0 < iVar30) {
                                        local_10 = (uint ************)local_34;
                                        local_c = (uint ************)iVar30;
                                        do {
                                          iVar30 = thunk_FUN_0042b760(CONCAT31((int3)((uint)local_10
                                                                                     >> 8),
                                                                               *(char *)local_10),
                                                                      (uint)local_15c);
                                          if (iVar30 == 0) {
                                  ...
                                  break;
                                case 0x5de:
                                  bVar28 = thunk_FUN_00651160((int)local_16c);
                                ...
                                case 0x5df:
                                      ...
                                      if (0 < iVar30) {
                                        ...
                                        do {
                                          ...
                                          if (iVar30 == 0) {
                                            ...
                                            local_17c = (void *)thunk_FUN_00423300(iVar30);
                                  ...
                                  break;
                                case 0x5e0:
                                  bVar28 = thunk_FUN_006511a0((int)local_16c);
                                      ...
                                      if (0 < (int)ppppppppppppuVar23) {
                                        ...
                                        do {
                                          ...
                                          if (pvVar13 == (void *)0x0) {
                                            ...
                                            thunk_FUN_00424530(pvVar13,(uint)local_158);
                                ...
                                case 0x5e1:
                                      ...
                                      if (0 < (int)ppppppppppppuVar23) {
                                        ...
                                        do {
                                          ...
                                          if (pvVar13 == (void *)0x0) {
                                            ...
                                            thunk_FUN_00424620(pvVar13,(uint)local_158);
                                  ...
                                  break;
                                case 0x5e2:
                                  bVar28 = thunk_FUN_006511e0((int)local_16c);
                                        ...
                                        do {
                                          ...
                                          if (iVar30 == 0) {
                                            ...
                                            if (local_17c == (void *)0x0) {
                                              ...
                                              if (pvVar13 != (void *)0x0) {
                                                local_8 = (uint ************)
                                                          thunk_FUN_00678ef0(pvVar13,(byte *)
                                                  local_158);
                                              }
                                              if (local_8 == (uint ************)0x0) {
                                                thunk_FUN_0064d0e0(this_00,-4,local_158,uVar25,
                                                                   (int)*local_10);
                                              }
                                              else {
                                  ...
                                  break;
                                case 0x5e3:
                                  bVar28 = thunk_FUN_00651250((int)local_16c);
                                  ...
                                  break;
                                case 0x5e4:
                                  iVar30 = thunk_FUN_00651290(local_16c);
                                  if (iVar30 != 0) {
                                    iVar30 = (**(code **)(*this_00 + 0x18))();
                                    if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                      iVar30 = thunk_FUN_00668f50(this_00,(char *)local_164,
...
LAB_006577ae:
                                            ...
                                            iVar30 = local_140 * 0x19;
                                            uStack_4f = (undefined1)iVar30;
                                            local_4e = (undefined2)((uint)iVar30 >> 8);
                                            uStack_4c = (undefined1)((uint)iVar30 >> 0x18);
                                            thunk_FUN_00662240(local_68);
                                            uVar25 = local_14;
                                          }
                                          local_10 = local_10 + 1;
                                          local_c = (uint ************)((int)local_c + -1);
                                  ...
                                  break;
                                case 0x5e5:
                                  bVar28 = thunk_FUN_006514d0(local_16c);
...
LAB_00657a41:
                                  ...
                                  break;
                                case 0x5e6:
                                  iVar30 = thunk_FUN_006513c0(local_16c);
                                  if (iVar30 != 0) {
                                    iVar30 = (**(code **)(*this_00 + 0x18))();
                                    if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                      iVar30 = thunk_FUN_00668f50(this_00,(char *)local_164,
...
LAB_006578fe:
                                  ...
                                  break;
                                case 0x5e7:
                                  iVar30 = thunk_FUN_006515b0(local_16c);
                                  if (iVar30 != 0) {
                                    iVar30 = (**(code **)(*this_00 + 0x18))();
                                    if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                      iVar30 = thunk_FUN_00668f50(this_00,(char *)local_164,
                                      ...
                                      if (0 < iVar30) {
                                        ...
                                        local_c = (uint ************)iVar30;
                                        do {
                                          iVar30 = thunk_FUN_0042b760(CONCAT31((int3)((uint)local_8
                                                                                     >> 8),
                                                                               *(char *)local_8),
                                                                      (uint)local_15c);
                                          uVar29 = uVar25;
                                          if (iVar30 == 0) {
                                            pppppppppppuVar11 = *local_8;
                                            pcVar22 = &DAT_008016a0;
                                            iVar30 = -0xaa;
LAB_00657bce:
                                            thunk_FUN_0064d0e0(this_00,iVar30,pcVar22,uVar29,
                                            ...
                                            local_10 = (uint ************)thunk_FUN_00423300(iVar30)
                                            ;
                                            if ((local_10 == (uint ************)0x0) ||
                                               (*(short *)((int)local_10 + 0x7b) == -0x8000)) {
                                              pppppppppppuVar11 = *local_8;
                                              pcVar22 = thunk_FUN_00674af0(iVar7);
                                              iVar30 = -0xab;
                                              goto LAB_00657bce;
                                            ...
                                            uVar25 = (uint)local_150 & 0x3fffffff;
                                            local_4e = (undefined2)local_140;
                                            local_58 = (undefined1)uVar25;
                                  ...
                                  break;
                                case 0x5e8:
                                  bVar28 = thunk_FUN_00651730((int)local_16c);
...
LAB_00657ccf:
                                  ...
                                  break;
                                case 0x5e9:
                                  iVar30 = thunk_FUN_00651770((int)local_16c);
                                  if (iVar30 != 0) {
                                    iVar30 = (**(code **)(*this_00 + 0x18))();
                                    if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                      iVar30 = thunk_FUN_00668f50(this_00,(char *)local_164,
...
LAB_00657dd9:
                                  ...
                                  break;
                                case 0x5ea:
                                  bVar28 = thunk_FUN_006517c0(local_16c);
...
LAB_00657f1c:
                                  ...
                                  break;
                                case 0x5eb:
                                  bVar28 = thunk_FUN_00651880((int)local_16c);
...
LAB_0065806e:
                                  ...
                                  break;
                                case 0x5ec:
                                  bVar28 = thunk_FUN_006518c0((int)local_16c);
...
LAB_00658177:
                                  ...
                                  break;
                                case 0x5ed:
                                  iVar30 = thunk_FUN_00651df0(local_16c);
                                  if (iVar30 != 0) {
                                    iVar30 = (**(code **)(*this_00 + 0x18))();
                                    if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                      iVar30 = thunk_FUN_00668f50(this_00,(char *)local_164,
...
LAB_00658b70:
                                            ...
                                            local_58 = (undefined1)((uint)iVar30 >> 0x10);
                                  ...
                                  break;
                                case 0x5ee:
                                  bVar28 = thunk_FUN_00651ed0(local_16c);
...
LAB_00658d01:
                                            ...
                                            _strncpy((char *)&local_4a,pcVar22,0xe);
                                  ...
                                  break;
                                case 0x5ef:
                                  bVar28 = thunk_FUN_00652030(local_16c);
...
LAB_00658e8e:
                                  ...
                                  break;
                                case 0x5f0:
                                  bVar28 = thunk_FUN_00652100(local_16c);
...
LAB_00658fc8:
                                            ...
                                            iVar30 = (int)local_14c * 0x19;
                                            local_68[0] = 0x35;
                                            local_58 = (undefined1)iVar30;
                                  ...
                                  break;
                                case 0x5f1:
                                  bVar28 = thunk_FUN_00651900(local_16c);
...
LAB_006582b3:
                                  ...
                                  break;
                                case 0x5f2:
                                  iVar30 = thunk_FUN_006519e0(local_16c);
                                  if (iVar30 != 0) {
                                    iVar30 = (**(code **)(*this_00 + 0x18))();
                                    if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                      iVar30 = thunk_FUN_00668f50(this_00,(char *)local_164,
...
LAB_00658416:
                                            ...
                                            local_58 = (undefined1)((uint)iVar30 >> 8);
                                  ...
                                  break;
                                case 0x5f3:
                                  iVar30 = thunk_FUN_00651b40(local_16c);
                                  if (iVar30 != 0) {
                                    iVar30 = (**(code **)(*this_00 + 0x18))();
                                    if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                      iVar30 = thunk_FUN_00668f50(this_00,(char *)local_164,
...
LAB_00658543:
                                  ...
                                  break;
                                case 0x5f4:
                                  iVar30 = thunk_FUN_00651bd0(local_16c);
                                  if (iVar30 != 0) {
                                    iVar30 = (**(code **)(*this_00 + 0x18))();
                                    if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                      iVar30 = thunk_FUN_00668f50(this_00,(char *)local_164,
...
LAB_00658670:
                                  ...
                                  break;
                                case 0x5f5:
                                  iVar30 = thunk_FUN_00651cd0(local_16c);
                                  if (iVar30 != 0) {
                                    iVar30 = (**(code **)(*this_00 + 0x18))();
                                    if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                      iVar30 = thunk_FUN_00668f50(this_00,(char *)local_164,
...
LAB_006587e2:
                                  ...
                                  break;
                                case 0x5f6:
                                  bVar28 = thunk_FUN_00651db0((int)local_16c);
...
LAB_006588eb:
                                  ...
                                  break;
                                case 0x5f7:
                                  iVar30 = thunk_FUN_00651c60(local_16c);
                                  if (iVar30 != 0) {
                                    iVar30 = (**(code **)(*this_00 + 0x18))();
                                    if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                      iVar30 = thunk_FUN_00668f50(this_00,(char *)local_164,
...
LAB_006589fe:
                                  ...
                                  break;
                                case 0x5f8:
                                  bVar28 = thunk_FUN_006521c0(local_16c);
...
LAB_00659143:
                                            ...
                                            uStack_52 = SUB41(local_148,0);
                                            uStack_51 = (undefined1)((uint)local_148 >> 8);
                                            iVar30 = (int)local_138 * 0x19;
                                            local_4e = (undefined2)local_140;
                                            local_68[0] = 0x36;
                                            uStack_4c = (undefined1)iVar30;
                                            cStack_4b = (char)((uint)iVar30 >> 8);
                                            local_4a._0_2_ = (undefined2)((uint)iVar30 >> 0x10);
                                            thunk_FUN_00662240(local_68);
                                            uVar25 = local_14;
                                          }
                                          local_8 = local_8 + 1;
                                  ...
                                  break;
                                case 0x5f9:
                                  bVar28 = thunk_FUN_00652460(local_16c);
...
LAB_006594ec:
                                  ...
                                  break;
                                case 0x5fa:
                                  bVar28 = thunk_FUN_00652540(local_16c);
...
LAB_00659640:
                                  ...
                                  break;
                                case 0x5fb:
                                  bVar28 = thunk_FUN_006525e0(local_16c);
...
LAB_00659785:
                                  ...
                                  break;
                                case 0x5fc:
                                  bVar28 = thunk_FUN_00652670(local_16c);
...
LAB_006598ca:
                                  ...
                                  break;
                                case 0x5fd:
                                  bVar28 = thunk_FUN_00652300(local_16c);
...
LAB_0065937a:
                                            ...
                                            ppuVar27 = &local_20c;
                                            for (iVar30 = 0x12; puVar5 = local_158, iVar30 != 0;
                                                iVar30 = iVar30 + -1) {
                                              *ppuVar27 = (uint *)0x0;
                                              ppuVar27 = ppuVar27 + 1;
                                            }
                                            *(undefined2 *)ppuVar27 = 0;
                                            ...
                                            if (((int)local_148 < 0) ||
                                               (pcVar22 = local_148, 7 < (int)local_148)) {
                                              bVar1 = *(byte *)((int)local_10 + 0x81);
                                              pcVar22 = (char *)(uint)bVar1;
                                              if (((char)bVar1 < '\0') || ('\a' < (char)bVar1)) {
                                                pcVar22 = (char *)(uint)*(byte *)(local_10 + 9);
                                              }
                                            }
                                            local_1f0 = SUB41(pcVar22,0);
                                  ...
                                  break;
                                case 0x5fe:
                                  iVar30 = thunk_FUN_00652700(local_16c);
                                  if (iVar30 != 0) {
                                    iVar30 = (**(code **)(*this_00 + 0x18))();
                                    if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                      iVar30 = thunk_FUN_00668f50(this_00,(char *)local_164,
...
LAB_00659a1c:
                          ...
                          switch(iVar7) {
                          case 0x594:
                            iVar30 = thunk_FUN_0064feb0((int)local_16c);
                            if (iVar30 == 0) break;
                            ...
                            goto switchD_00652a7f_caseD_3;
                          case 0x595:
                            iVar30 = thunk_FUN_0064fef0(local_16c);
                            if (iVar30 == 0) break;
                            if (((local_164 == (uint ************)0xdd) ||
                                (local_164 == (uint ************)0xde)) ||
                               (local_164 == (uint ************)0xe0)) {
                              bVar28 = true;
                            }
                            ...
                            if (bVar28) {
                              ...
                              local_190 = local_15c;
                              local_184 = local_158;
                              iVar30 = thunk_FUN_004b1cf0((int)local_164,(int *)&local_18c,
                            ...
                            goto switchD_00652a7f_caseD_3;
                          case 0x596:
                            iVar30 = thunk_FUN_0064ff70(local_16c);
                            if (iVar30 == 0) break;
                            DAT_008118fc = 0;
                            ...
                            goto switchD_00652a7f_caseD_3;
                          case 0x597:
                            iVar30 = thunk_FUN_00650090(local_16c);
                            if (iVar30 == 0) break;
                            ...
                            goto switchD_00652a7f_caseD_3;
                          case 0x598:
                            iVar30 = thunk_FUN_006501a0(local_16c);
                            if (iVar30 != 0) {
                              iVar30 = thunk_FUN_0064dda0((short)local_164,(short)local_160,
                                                          (short)local_15c,(short)local_158,
                                                          (short)local_154,(char *)local_150,
                                                          local_14c,local_148);
                              goto LAB_00655f44;
                            }
                            break;
                          case 0x599:
                            iVar30 = thunk_FUN_00650240(local_16c);
                            if (iVar30 == 0) break;
                            DAT_008118fc = 0;
                            ...
                            goto switchD_00652a7f_caseD_3;
                          case 0x59a:
                            iVar30 = thunk_FUN_00650370((int)local_16c);
                            if (iVar30 == 0) break;
                            if (local_160 != (uint ************)0x0) {
                            ...
                            goto switchD_00652a7f_caseD_3;
                          case 0x59b:
                            iVar30 = thunk_FUN_006503b0(local_16c);
                            if (iVar30 != 0) {
                              iVar30 = (**(code **)(*this_00 + 0x18))();
                              if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                iVar30 = thunk_FUN_00668f50(this_00,(char *)local_164,
                                ...
                                if (0 < iVar30) {
                                  ...
                                  local_c = (uint ************)iVar30;
                                  do {
                                    iVar30 = thunk_FUN_0064dfa0(*(ushort *)local_8,(short)local_15c,
                                                                (int)local_158,(int)local_154,
                                                                local_150,(ushort)local_14c,
                            ...
                            break;
                          case 0x59c:
                            iVar30 = thunk_FUN_00650480(local_16c);
                            if (iVar30 != 0) {
                              iVar30 = (**(code **)(*this_00 + 0x18))();
                              if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                ppppppppppppuVar23 =
                                ...
                                if (0 < (int)ppppppppppppuVar23) {
                                  ...
                                  do {
                                    DAT_008118fc = 0;
                                    thunk_FUN_00678240((int)*ppppppppppppuVar16,(short)local_15c,
                            ...
                            break;
                          case 0x59d:
                            iVar30 = thunk_FUN_00650600(local_16c);
                            if (iVar30 != 0) {
                              iVar30 = (**(code **)(*this_00 + 0x18))();
                              if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                ppppppppppppuVar23 =
                                ...
                                if (0 < (int)ppppppppppppuVar23) {
                                  ...
                                  do {
                                    DAT_008118fc = 0;
                                    thunk_FUN_00678240((int)*ppppppppppppuVar16,(short)local_158,
                          ...
                          default:
                            goto switchD_00652a7f_caseD_3;
                          case 0x5aa:
                            iVar30 = thunk_FUN_00650760(local_16c);
                            if (iVar30 != 0) {
                              iVar30 = (**(code **)(*this_00 + 0x18))();
                              if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                ppppppppppppuVar23 =
                                ...
                                if (0 < (int)ppppppppppppuVar23) {
                                  ...
                                  local_c = ppppppppppppuVar23;
                                  do {
                                    thunk_FUN_004e76e0((int)*ppppppppppppuVar16,(uint *)local_15c,
                                                       (char)local_158);
                                    ppppppppppppuVar16 = ppppppppppppuVar16 + 1;
                                    local_c = (uint ************)((int)local_c + -1);
                                  } while (local_c != (uint ************)0x0);
                          ...
                          case 0x5ab:
                            ...
                            if (iVar30 != 0) {
                              ...
                              if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                ...
                                if (0 < (int)ppppppppppppuVar23) {
                                  ...
                                  local_c = ppppppppppppuVar23;
                                  do {
                                    thunk_FUN_004e7980((uint *)*ppppppppppppuVar16,(int)local_15c,
                                                       (char)local_158);
                                    ppppppppppppuVar16 = ppppppppppppuVar16 + 1;
                                    local_c = (uint ************)((int)local_c + -1);
                                  } while (local_c != (uint ************)0x0);
                            ...
                            break;
                          case 0x5ac:
                            iVar30 = thunk_FUN_00650820(local_16c);
                            if (iVar30 != 0) {
                              iVar30 = (**(code **)(*this_00 + 0x18))();
                              if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                iVar30 = thunk_FUN_00668f50(this_00,(char *)local_164,
                                ...
                                if (0 < iVar30) {
                                  ...
                                  do {
                                    local_c = (uint ************)iVar30;
                                    pvVar13 = (void *)thunk_FUN_004357f0(*(char *)local_8);
                                    if (pvVar13 == (void *)0x0) {
                                      pppppppppppuVar11 = *local_8;
                                      uVar29 = uVar25;
                                      pcVar22 = thunk_FUN_00674af0(iVar7);
                                      ...
                                      thunk_FUN_0067b3c0(pvVar13,(int)local_15c,(int)local_158,
                                                         (int)local_154,0xff);
                                    }
                                    local_8 = local_8 + 1;
                                    iVar30 = (int)local_c + -1;
                                  } while (iVar30 != 0);
                                  local_c = (uint ************)0x0;
                                }
                                goto switchD_00652a7f_caseD_3;
                            ...
                            break;
                          case 0x5ad:
                            iVar30 = thunk_FUN_006508c0(local_16c);
                            if (iVar30 != 0) {
                              iVar30 = (**(code **)(*this_00 + 0x18))();
                              if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                ppppppppppppuVar23 =
                                ...
                                if (0 < (int)ppppppppppppuVar23) {
                                  ...
                                  local_c = ppppppppppppuVar23;
                                  do {
                                    thunk_FUN_004e6310((int)*ppppppppppppuVar16,(uint)local_15c,
                                                       (uint)local_158);
                                    ppppppppppppuVar16 = ppppppppppppuVar16 + 1;
                                    local_c = (uint ************)((int)local_c + -1);
                                  } while (local_c != (uint ************)0x0);
                            ...
                            break;
                          case 0x5ae:
                            iVar30 = thunk_FUN_006509e0((int)local_16c);
                            if (iVar30 != 0) {
                              iVar30 = (**(code **)(*this_00 + 0x18))();
                              if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                ppppppppppppuVar23 =
                            ...
                            break;
                          case 0x5af:
                            iVar30 = thunk_FUN_00650a20(local_16c);
                            if (iVar30 != 0) {
                              iVar30 = (**(code **)(*this_00 + 0x18))();
                              if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                iVar30 = thunk_FUN_00668f50(this_00,(char *)local_164,
                                ...
                                if (0 < iVar30) {
                                  ...
                                  do {
                                    ...
                                    if (pvVar13 == (void *)0x0) {
                                      ...
                                      thunk_FUN_0067b210(pvVar13,(int)local_15c,(int)local_158);
                                    }
                                    local_8 = local_8 + 1;
                                    iVar30 = (int)local_c + -1;
                                  } while (iVar30 != 0);
                            ...
                            break;
                          case 0x5b0:
                            iVar30 = thunk_FUN_00650a90((int)local_16c);
                            if (iVar30 != 0) {
                              iVar30 = (**(code **)(*this_00 + 0x18))();
                              if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                iVar30 = thunk_FUN_00668f50(this_00,(char *)local_164,
                                ...
                                if (0 < iVar30) {
                                  ...
                                  do {
                                    local_c = (uint ************)iVar30;
                                    iVar30 = thunk_FUN_004357f0(*(char *)local_8);
                                    if (iVar30 == 0) {
                                      pppppppppppuVar11 = *local_8;
                                      uVar29 = uVar25;
                                      pcVar22 = thunk_FUN_00674af0(iVar7);
                            ...
                            break;
                          case 0x5b1:
                            iVar30 = thunk_FUN_006507e0((int)local_16c);
                            if (iVar30 != 0) {
                              iVar30 = (**(code **)(*this_00 + 0x18))();
                              if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                ppppppppppppuVar23 =
                          ...
                          case 0x5b2:
                            ...
                            break;
                          case 0x5b3:
                            iVar30 = thunk_FUN_00650940(local_16c);
                            if (iVar30 != 0) {
                              iVar30 = (**(code **)(*this_00 + 0x18))();
                              if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                ppppppppppppuVar23 =
                                ...
                                if (0 < (int)ppppppppppppuVar23) {
                                  ...
                                  local_c = ppppppppppppuVar23;
                                  do {
                                    thunk_FUN_004e7390((int)*ppppppppppppuVar16,(uint)local_15c,
                            ...
                            break;
                          case 0x5b4:
                            iVar30 = thunk_FUN_00650b10(local_16c);
                            if (iVar30 != 0) {
                              iVar30 = (**(code **)(*this_00 + 0x18))();
                              if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                ppppppppppppuVar23 =
                                ...
                                if (0 < (int)ppppppppppppuVar23) {
                                  ...
                                  do {
                                    ...
                                    if (iVar7 != 0) {
                                      local_c = (uint ************)
                                                thunk_FUN_00679120((byte *)local_15c,(int)local_158,
                                                                   (int)local_154,(int)local_150);
                                    }
                                    if ((int)local_c < 0) {
                                      thunk_FUN_0064d0e0(this_00,-4,local_15c,uVar25,
                                                         (int)*ppppppppppppuVar16);
                                    }
                                    ppppppppppppuVar16 = ppppppppppppuVar16 + 1;
                                    ppppppppppppuVar23 = (uint ************)((int)local_8 + -1);
                                    local_8 = ppppppppppppuVar23;
                            ...
                            break;
                          case 0x5b5:
                            iVar30 = thunk_FUN_00650f50((int)local_16c);
                            if (iVar30 != 0) {
                              iVar30 = (**(code **)(*this_00 + 0x18))();
                              if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                iVar30 = thunk_FUN_00668f50(this_00,(char *)local_164,
                                ...
                                if (0 < iVar30) {
                                  ...
                                  do {
                                    ...
                                    if (pvVar13 == (void *)0x0) {
                                      ...
                                      *(undefined1 *)((int)pvVar13 + 0x644) = local_15c._0_1_;
                                      *(uint **)((int)pvVar13 + 0x640) = local_158;
                            ...
                            break;
                          case 0x5b6:
                            bVar28 = thunk_FUN_00650f90(local_16c);
                                ...
                                if (0 < iVar30) {
                                  ...
                                  do {
                                    ...
                                    if (pvVar13 == (void *)0x0) {
                                      ...
                                      thunk_FUN_0065bd20(pvVar13,(char)local_15c,(short)local_158,
                                                         (short)local_154,(short)local_150,local_14c
                                                        );
                                    }
                                    local_8 = local_8 + 1;
                                    iVar30 = (int)local_c + -1;
                            ...
                            break;
                          case 0x5b7:
                            iVar30 = thunk_FUN_00650bd0(local_16c);
                            if (iVar30 != 0) {
                              iVar30 = (**(code **)(*this_00 + 0x18))();
                              if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                iVar30 = thunk_FUN_00668f50(this_00,(char *)local_164,
                                ...
                                if (0 < iVar30) {
                                  ...
                                  do {
                                    local_c = (uint ************)
                                              thunk_FUN_00677290(*local_10,(uint)local_15c,
                            ...
                            break;
                          case 0x5b8:
                            iVar30 = thunk_FUN_00650cf0(local_16c);
                            if (iVar30 != 0) {
                              iVar30 = (**(code **)(*this_00 + 0x18))();
                              if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                iVar30 = thunk_FUN_00668f50(this_00,(char *)local_164,
                                ...
                                if (0 < iVar30) {
                                  ...
                                  do {
                                    local_c = (uint ************)
                                              thunk_FUN_006773b0(*local_10,(uint)local_15c,
                                                                 (char)local_158,(short)local_154,
                                                                 (short)local_150,(short)local_14c,
                                                                 (short)local_148,(short)local_144,
                                                                 (short)local_140,1);
                            ...
                            break;
                          case 0x5b9:
                            iVar30 = thunk_FUN_00650e10(local_16c);
                            if (iVar30 != 0) {
                              iVar30 = (**(code **)(*this_00 + 0x18))();
                              if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                iVar30 = thunk_FUN_00668f50(this_00,(char *)local_164,
                                ...
                                if (0 < iVar30) {
                                  ...
                                  do {
                                    local_c = (uint ************)
                                              thunk_FUN_006774c0(*local_10,(byte *)local_15c,
                                                                 (char)local_158,(short)local_154,
                                                                 (short)local_150,(short)local_14c,
                                                                 (short)local_148,(short)local_144,
                                                                 (short)local_140,1);
                        ...
                        if (iVar7 == 0x593) {
                          iVar7 = thunk_FUN_0064fd80(local_16c);
                          if (iVar7 == 0) {
                            iVar7 = -1;
                            uVar29 = uVar25;
                          ...
                          if (iVar7 == 0x54d) {
                            ...
                            if (iVar7 == 0) {
                              ...
                              if ((iVar7 == 8) && (local_164 == (uint ************)0x9)) {
                                ...
                                iVar7 = thunk_FUN_00668f50(this_00,(char *)local_164,(uint)local_160
                                                           ,(uint *)local_34);
                                iVar30 = 0;
                                if (0 < iVar7) {
                                  ppppppppppppuVar23 = (uint ************)local_34;
                                  do {
                          ...
                          if (iVar7 < 0x51b) {
                            if (iVar7 == 0x51a) {
                              ...
                              if (iVar7 == 0) {
                                ...
                                *(uint *************)((int)this_00 + (int)local_164 * 4 + 0x52f) =
                                     local_160;
                              }
                              goto switchD_00652a7f_caseD_3;
                            }
                            if (0x3e < iVar7) {
                              if (iVar7 < 0x517) {
                                if (iVar7 == 0x516) {
                                  iVar7 = thunk_FUN_0064e7c0(local_16c);
                                  if (iVar7 == 0) {
                                    iVar7 = -1;
                                    uVar29 = uVar25;
                                    ...
                                    if (local_164 == (uint ************)0x9) {
                                      ...
                                      if (iVar7 == 8) {
                                        ...
                                        if ((int)local_15c <= (int)local_158) {
                                          ...
                                          } while ((int)ppppppppppppuVar23 <= (int)local_158);
                                        }
                                        goto switchD_00652a7f_caseD_3;
                                      }
                                    }
                                    iVar7 = thunk_FUN_00668f50(this_00,(char *)local_164,
                                                               (uint)local_160,(uint *)local_34);
                                    if (0 < iVar7) {
                                      local_8 = (uint ************)local_34;
                                      do {
                                  ...
                                  if (iVar7 == 0) {
                                    ...
                                    ppppppppppppuVar23 = local_160;
                                    if (local_164 == (uint ************)0x0) goto LAB_00659a80;
                                  }
                                }
                                else if (iVar7 == 0x322) {
                                  local_174 = 1;
                                  ...
                                  iVar7 = thunk_FUN_0064e780(local_16c);
                                  if (iVar7 == 0) {
                                    iVar7 = -1;
                                    uVar29 = uVar25;
                                    ...
                                    *local_178 = '\x01';
                                    *(uint *************)(local_178 + 0xb) = local_164;
                                  }
                                }
                              }
                              else if (iVar7 == 0x517) {
                                iVar7 = thunk_FUN_0064e830(local_16c);
                                if (iVar7 == 0) {
                                  iVar7 = -1;
                                  uVar29 = uVar25;
                                ...
                                if (iVar7 == 0) {
                                  ...
                                  if (local_164 == (uint ************)0x9) {
                                    iVar7 = (**(code **)(*this_00 + 0x18))();
                                    if (iVar7 == 8) {
                                      *(uint **)((int)this_00 + (int)local_15c * 4 + 0xde) =
                                           local_158;
                                      goto switchD_00652a7f_caseD_3;
                                    }
                                  }
                                  ...
                                  if (0 < (int)ppppppppppppuVar23) {
                                    ...
                                    do {
                                      ...
                                      ppppppppppppuVar16 = ppppppppppppuVar16 + 1;
                                      ppppppppppppuVar23 = (uint ************)((int)local_c + -1);
                                      local_c = ppppppppppppuVar23;
                                    } while (ppppppppppppuVar23 != (uint ************)0x0);
                                  }
                                }
...
switchD_00652b42_switchD:
                              switch(local_15c) {
                              case (uint ************)0x0:
                                iVar30 = thunk_FUN_0064ea10((int)local_16c);
                                if (iVar30 == 0) goto LAB_00652a99;
                                switch(iVar7) {
                                case 2:
                                  piVar8 = (int *)((int)this_00 + (int)local_164 * 4 + 0xde);
                                  *piVar8 = (int)(*piVar8 + (int)local_160);
                                  break;
                                case 5:
                                  *(uint *************)((int)this_00 + (int)local_164 * 4 + 0xde) =
                                       local_160;
                                  break;
                                case 0x17:
                                  if (local_160 == (uint ************)0x0) {
                                    ...
                                    *(int *)((int)this_00 + (int)local_164 * 4 + 0xde) =
                                         *(int *)((int)this_00 + (int)local_164 * 4 + 0xde) /
                                         (int)local_160;
                                  }
                                  break;
                              ...
                              case (uint ************)0x1:
                                ...
                                case 2:
                                  (&DAT_0080e43b)[(int)local_164] =
                                       (char *)((&DAT_0080e43b)[(int)local_164] + (int)local_160);
                                  break;
                                case 5:
                                  (&DAT_0080e43b)[(int)local_164] = local_160;
                                  break;
                                ...
                                break;
                              case (uint ************)0x2:
                                iVar30 = thunk_FUN_0064ea60((int)local_16c);
                                if (iVar30 == 0) goto LAB_00652a99;
                                switch(iVar7) {
                                case 2:
                                  piVar8 = (int *)((int)this_00 + (int)local_164 * 4 + 0x52f);
                                  *piVar8 = (int)(*piVar8 + (int)local_160);
                                  break;
                                case 5:
                                  *(uint *************)((int)this_00 + (int)local_164 * 4 + 0x52f) =
                                ...
                                case 0x17:
                                  if (local_160 == (uint ************)0x0) {
                                    ...
                                    *(int *)((int)this_00 + (int)local_164 * 4 + 0x52f) =
                                         *(int *)((int)this_00 + (int)local_164 * 4 + 0x52f) /
                                         (int)local_160;
                                  }
                                  break;
                                ...
                                break;
                              case (uint ************)0x3:
                                iVar30 = thunk_FUN_0064eaa0((int)local_16c);
                                if (iVar30 == 0) goto LAB_00652a99;
                                if (iVar7 == 5) {
                                  FUN_006b6020(*(int *)((int)this_00 + 0x5b3),(uint)local_164,
                                               (char *)local_160);
                                }
                              }
                              goto switchD_00652a7f_caseD_3;
                            ...
                            case 0x19:
                              iVar30 = thunk_FUN_0064e6c0((int)local_16c);
                              if (iVar30 == 0) goto LAB_00652a99;
                              if (local_174 != 0) {
                                local_174 = 0;
                                local_170 = local_164;
                                ppppppppppppuVar23 = local_170;
                                goto LAB_00659a80;
                              }
                              local_174 = 0;
                              break;
                            case 0x21:
                              iVar30 = thunk_FUN_0064e740((int)local_16c);
                              ppppppppppppuVar23 = local_164;
                              if (iVar30 == 0) goto LAB_00652a99;
                              goto LAB_00659a80;
                            case 0x23:
                              iVar30 = thunk_FUN_0064e680((int)local_16c);
                              if (iVar30 == 0) goto LAB_00652a99;
                              if (local_164 == (uint ************)0x0) {
                                local_170 = local_160;
                                ppppppppppppuVar23 = local_170;
                          ...
                          switch(iVar7) {
                          case 0x51b:
                            iVar30 = thunk_FUN_0064e9a0((int)local_16c);
                            if (iVar30 == 0) goto LAB_00652a99;
                            FUN_006b6020(*(int *)((int)this_00 + 0x5b3),(uint)local_164,
                                         (char *)local_160);
                            break;
                          case 0x528:
                            bVar28 = thunk_FUN_0064eb20((int)local_16c);
                            ...
                            goto LAB_00652a99;
                          case 0x529:
                            iVar30 = thunk_FUN_0064eb60((int)local_16c);
                            if (iVar30 != 0) {
                              iVar30 = (**(code **)(*this_00 + 0x18))();
                              if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                ppppppppppppuVar23 =
                            ...
                            goto LAB_00652a99;
                          case 0x52a:
                            iVar30 = thunk_FUN_0064eba0((int)local_16c);
                            if (iVar30 != 0) {
                              iVar30 = (**(code **)(*this_00 + 0x18))();
                              if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                iVar7 = thunk_FUN_00668f50(this_00,(char *)local_164,(uint)local_160
                            ...
                            goto LAB_00652a99;
                          case 0x532:
                            bVar28 = thunk_FUN_0064ebe0((int)local_16c);
                            ...
                            break;
                          case 0x533:
                            bVar28 = thunk_FUN_0064ec30((int)local_16c);
                            ...
                            break;
                          case 0x534:
                            bVar28 = thunk_FUN_0064ec80((int)local_16c);
...
LAB_006536dd:
                            ...
                            break;
                          case 0x535:
                            bVar28 = thunk_FUN_0064ecd0((int)local_16c);
...
LAB_00653778:
                            ...
                            break;
                          case 0x536:
                            bVar28 = thunk_FUN_0064ed20((int)local_16c);
                            ...
                            break;
                          case 0x537:
                            bVar28 = thunk_FUN_0064ed70((int)local_16c);
                            if (CONCAT31(extraout_var_05,bVar28) == 0) goto LAB_00652a99;
                            if (local_164 == (uint ************)0x9) {
                              iVar7 = (**(code **)(*this_00 + 0x18))();
                              if (iVar7 == 8) {
                                if (DAT_00801688 != (void *)0x0) {
                                  thunk_FUN_004f9cd0((char *)local_15c);
                                }
                                break;
                              }
                            }
                            ...
                            break;
                          case 0x546:
                            iVar30 = thunk_FUN_0064edc0((int)local_16c);
                            if (iVar30 != 0) {
                              iVar30 = (**(code **)(*this_00 + 0x18))();
                              if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                iVar7 = thunk_FUN_00668f50(this_00,(char *)local_164,(uint)local_160
                                    ...
                                    if (*ppppppppppppuVar23 == (uint ***********)(uint)DAT_0080874d)
                                    {
                                      if (DAT_00802a88 != (void *)0x0) {
                                        ...
                                        thunk_FUN_0055a9d0(DAT_00802a88,(int)local_15c,
                                                           ...
                                                           (uint)local_34[iVar30],local_150,iVar7);
                                      }
                                      break;
                                    }
                                    iVar30 = iVar30 + 1;
                          ...
                          case 0x547:
                          case 0x548:
                            iVar30 = thunk_FUN_0064ee00((int)local_16c);
                            if (iVar30 != 0) {
                              iVar30 = (**(code **)(*this_00 + 0x18))();
                              if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                local_10 = (uint ************)
                            ...
                            goto LAB_00652a99;
                          case 0x549:
                            iVar30 = thunk_FUN_0064ee40(local_16c);
                            if (iVar30 != 0) {
                              iVar30 = (**(code **)(*this_00 + 0x18))();
                              if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                iVar7 = thunk_FUN_00668f50(this_00,(char *)local_164,(uint)local_160
                            ...
                            goto LAB_00652a99;
                          case 0x54a:
                            iVar30 = thunk_FUN_0064ee90((int)local_16c);
                            if (iVar30 != 0) {
                              iVar30 = (**(code **)(*this_00 + 0x18))();
                              if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                local_10 = (uint ************)
...
LAB_00653bb7:
                                  ...
                                  if (DAT_007fb2a0 != 0) {
                                    ...
                                    (**(code **)(*this_00 + 0x30))(3,0x100,local_1c0);
                                    uVar25 = local_14;
                                  }
                                }
                                break;
                          ...
                          case 0x54b:
                          case 0x54c:
                            iVar30 = thunk_FUN_0064eed0((int)local_16c);
                            if (iVar30 != 0) {
                              iVar30 = (**(code **)(*this_00 + 0x18))();
                              if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                                local_10 = (uint ************)
                        ...
                        switch(iVar7) {
                        case 0x54e:
                          iVar30 = thunk_FUN_0064ef50((int)local_16c);
                          if (iVar30 != 0) {
                            iVar30 = (**(code **)(*this_00 + 0x18))();
                            if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                              iVar7 = thunk_FUN_00668f50(this_00,(char *)local_164,(uint)local_160,
                              ...
                              if (0 < iVar7) {
                                ...
                                do {
                                  if (*ppppppppppppuVar23 == (uint ***********)(uint)DAT_0080874d) {
                                    thunk_FUN_0052af90((byte)local_15c,(int)local_158,(int)local_154
                                                      );
                                    break;
                                  }
                                  iVar30 = iVar30 + 1;
                        ...
                        default:
                          goto switchD_00652a7f_caseD_3;
                        case 0x55a:
                          iVar30 = thunk_FUN_0064f080((int)local_16c);
                          if (iVar30 != 0) {
                            iVar30 = (**(code **)(*this_00 + 0x18))();
                            if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                              ppppppppppppuVar23 =
                              ...
                              if (0 < (int)ppppppppppppuVar23) {
                                ...
                                do {
                                  ...
                                  (&DAT_00809950)[(int)pppppppppppuVar11] =
                                       (local_15c != (uint ************)0x1) + '\x01';
                                  if (pppppppppppuVar11 == (uint ***********)(uint)DAT_0080874d) {
                                    DAT_0080c522 = (uint)(local_15c == (uint ************)0x1);
                                  }
                                  ppppppppppppuVar16 = ppppppppppppuVar16 + 1;
                                  local_c = (uint ************)((int)local_c + -1);
                                } while (local_c != (uint ************)0x0);
                          ...
                          break;
                        case 0x55b:
                          bVar28 = thunk_FUN_0064f0c0((int)local_16c);
                          ...
                          break;
                        case 0x55c:
                          iVar30 = thunk_FUN_0064f110(local_16c);
                          if (iVar30 != 0) {
                            iVar30 = (**(code **)(*this_00 + 0x18))();
                            if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                              iVar7 = thunk_FUN_00668f50(this_00,(char *)local_164,(uint)local_160,
                              ...
                              if (0 < iVar7) {
                                do {
                                  (&DAT_0080c947)[iVar30] = local_158;
                                  if (local_34[iVar30] == (uint ************)(uint)DAT_0080874d) {
                          ...
                          break;
                        case 0x55d:
                          bVar28 = thunk_FUN_0064f160((int)local_16c);
...
LAB_006540b9:
                          ...
                          break;
                        case 0x55e:
                          bVar28 = thunk_FUN_0064f1b0(local_16c);
                                ...
                                do {
                                  if (*ppppppppppppuVar23 == (uint ***********)(uint)DAT_0080874d) {
                                    ...
                                    if (DAT_008087a0 == '\x03') {
                                      ...
                                      wsprintfA(&DAT_0080e323,&DAT_007c6ee4,&DAT_00807784,local_158)
                                      ;
                                    }
                                    break;
                                  }
                          ...
                          break;
                        case 0x55f:
                          bVar28 = thunk_FUN_0064ef90((int)local_16c);
                          if (CONCAT31(extraout_var_09,bVar28) != 0) {
                            ...
                            if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                              ...
                              if (0 < iVar7) {
                                ...
                                do {
                                  if (*ppppppppppppuVar23 == (uint ***********)(uint)DAT_0080874d) {
                                    iVar7 = FUN_006b5aa0((int)DAT_0080c4cb,(char *)local_158);
                                    if (DAT_008016dc != 0) {
                                      thunk_FUN_005380e0();
                                    }
                                    if (-1 < iVar7) {
                                      *(int *)((int)this_00 + (int)local_15c * 4 + 0xde) = iVar7;
                                    }
                                    break;
                                  }
                                  iVar30 = iVar30 + 1;
                          ...
                          break;
                        case 0x560:
                          iVar30 = thunk_FUN_0064f000((int)local_16c);
                          if (iVar30 != 0) {
                            iVar30 = (**(code **)(*this_00 + 0x18))();
                            if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                              iVar7 = thunk_FUN_00668f50(this_00,(char *)local_164,(uint)local_160,
...
LAB_00654386:
                          ...
                          break;
                        case 0x561:
                          iVar30 = thunk_FUN_0064f040((int)local_16c);
                          if (iVar30 != 0) {
                            iVar30 = (**(code **)(*this_00 + 0x18))();
                            if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                              iVar7 = thunk_FUN_00668f50(this_00,(char *)local_164,(uint)local_160,
                              ...
                              if (0 < iVar7) {
                                ...
                                do {
                                  if (*ppppppppppppuVar23 == (uint ***********)(uint)DAT_0080874d) {
                                    ...
                                    iVar7 = FUN_006b5aa0((int)DAT_0080c4c7,(char *)local_158);
                                    if (-1 < iVar7) {
                                      *(int *)((int)this_00 + (int)local_15c * 4 + 0xde) = iVar7;
                                    }
                                    break;
                        ...
                        case 0x565:
                        case 0x566:
                          iVar30 = thunk_FUN_0064f320((int)local_16c);
                          if (iVar30 != 0) {
                            iVar30 = (**(code **)(*this_00 + 0x18))();
                            if (((iVar30 != 8) ||
                                ((local_15c != (uint ************)0x9 &&
                                 (local_164 != (uint ************)0x9)))) &&
                               (local_15c != (uint ************)0xff)) {
                              iVar30 = thunk_FUN_00668f50(this_00,(char *)local_15c,0,
                                                          (uint *)local_34);
                              if (iVar30 == 1) {
                                local_8 = local_34[0];
                                ppppppppppppuVar23 =
                                ...
                                if ((DAT_008016e4 != (void *)0x0) &&
                                  ...
                                  *(undefined4 *)((int)DAT_008016e4 + 0x28) = 5;
                                  ...
                                  do {
                                    if (*local_8 != (uint ***********)0x0) {
                                      FUN_006e6080(pvVar13,2,*local_8,
                          ...
                          break;
                        case 0x567:
                          iVar30 = thunk_FUN_0064f360((int)local_16c);
                          if (iVar30 != 0) {
                            iVar30 = (**(code **)(*this_00 + 0x18))();
                            if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                              local_10 = (uint ************)
                          ...
                          break;
                        case 0x568:
                          iVar30 = thunk_FUN_0064f3b0((int)local_16c);
                          if (iVar30 != 0) {
                            iVar30 = (**(code **)(*this_00 + 0x18))();
                            if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                              iVar7 = thunk_FUN_00668f50(this_00,(char *)local_164,(uint)local_160,
                          ...
                          break;
                        case 0x56a:
                          iVar30 = thunk_FUN_0064f3f0((int)local_16c);
                          if (iVar30 == 0) break;
                          thunk_FUN_0056abc0(&DAT_00807620,(char *)local_164);
                          goto switchD_00652a7f_caseD_3;
                        case 0x578:
                          bVar28 = thunk_FUN_0064f430((int)local_16c);
                          ...
                          break;
                        case 0x579:
                          bVar28 = thunk_FUN_0064f470((int)local_16c);
                          ...
                          break;
                        case 0x57a:
                          bVar28 = thunk_FUN_0064f4c0((int)local_16c);
                          ...
                          goto switchD_00652a7f_caseD_3;
                        case 0x57b:
                          iVar30 = thunk_FUN_0064f500(local_16c);
                          if (iVar30 != 0) {
                            iVar30 = (**(code **)(*this_00 + 0x18))();
                            if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                              local_8 = local_15c;
                              ...
                              if (0 < (int)ppppppppppppuVar23) {
                                ...
                                do {
                                  ...
                                  uVar21 = (undefined2)((uint)local_150 >> 0x10);
                                  if (cVar3 == '\x01') {
                                    if ((int)local_8 < 3) {
                                      if (local_8 == (uint ************)0x2) {
                                        ...
                                        thunk_FUN_0064d270(CONCAT22((short)((uint)local_150 >> 0x10)
                                                                    ,*(undefined2 *)
                                        ...
                                        if (local_8 != (uint ************)0x1) goto LAB_00655324;
                                        thunk_FUN_0064d270(CONCAT22(uVar21,*(undefined2 *)
                                                                            ppppppppppppuVar16),0xc,
                                                           (int)local_158,(int)local_154,local_150,
                                                           0xfffe,0xffffffff,(char *)0x0,100,1,0,0);
...
LAB_00655324:
                                    ...
                                    if (local_8 == (uint ************)0x2) {
                                      ...
                                      thunk_FUN_0064d270(CONCAT22((short)((uint)local_150 >> 0x10),
                                                         ...
                                                         local_150,0xfffe,0xffffffff,(char *)0x0,100
                                                         ,1,0,0);
                                      thunk_FUN_0064d270(CONCAT22((short)((uint)local_150 >> 0x10),
                                                                  *(undefined2 *)ppppppppppppuVar16)
                                                         ,0xd,(int)local_158,(int)local_154,
                          ...
                          break;
                        case 0x582:
                          iVar30 = thunk_FUN_0064f5a0((int)local_16c);
                          if (iVar30 != 0) {
                            iVar30 = (**(code **)(*this_00 + 0x18))();
                            if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                              ppppppppppppuVar23 =
                                ...
                                do {
                                  ...
                                  case (uint ************)0xdc:
                                    if (local_158 == (uint *)0x0) {
                                      thunk_FUN_004d88b0(*(char *)ppppppppppppuVar16,local_154);
                                    }
                                    else if ((int)local_158 < 1) {
                                      thunk_FUN_004d8800(*(char *)ppppppppppppuVar16,(int)local_154)
                                      ;
                                    }
                                    else {
                                      thunk_FUN_004d87b0(*(char *)ppppppppppppuVar16,(int)local_154)
                                      ;
                                    }
                                    break;
                                  case (uint ************)0xdd:
                                    if (local_158 == (uint *)0x0) {
                                      thunk_FUN_004d89f0(*(char *)ppppppppppppuVar16,local_154);
                                    }
                                    else if ((int)local_158 < 1) {
                                      thunk_FUN_004d8940(*(char *)ppppppppppppuVar16,(int)local_154)
                                      ;
                                    }
                                    else {
                                      thunk_FUN_004d88f0(*(char *)ppppppppppppuVar16,(int)local_154)
                                      ;
                                    }
                                    break;
                                  case (uint ************)0xde:
                                    if (local_158 == (uint *)0x0) {
                                      thunk_FUN_004d8b30(*(char *)ppppppppppppuVar16,local_154);
                                    }
                                    else if ((int)local_158 < 1) {
                                      thunk_FUN_004d8a80(*(char *)ppppppppppppuVar16,(int)local_154)
                                      ;
                                    }
                                    else {
                                      thunk_FUN_004d8a30(*(char *)ppppppppppppuVar16,(int)local_154)
                                      ;
                                    }
                                    break;
                                  case (uint ************)0xdf:
                                  ...
                                  case (uint ************)0xe2:
                                    if (local_158 == (uint *)0x0) {
                                      thunk_FUN_004e4440((int)*ppppppppppppuVar16,local_154);
                                    }
                                    else if ((int)local_158 < 1) {
                                      thunk_FUN_004e43c0((int)*ppppppppppppuVar16,(int)local_154);
                                    }
                                    else {
                                      thunk_FUN_004e4380((int)*ppppppppppppuVar16,(int)local_154);
                                    }
                                    break;
                                  case (uint ************)0xe3:
                                    if (local_158 == (uint *)0x0) {
                                      thunk_FUN_004e41f0((int)*ppppppppppppuVar16,local_154);
                                    }
                                    else if ((int)local_158 < 1) {
                                      thunk_FUN_004e4330((int)*ppppppppppppuVar16,(int)local_154);
                                    }
                                    else {
                                      thunk_FUN_004e4270((int)*ppppppppppppuVar16,(int)local_154);
                                    }
                                  }
                          ...
                          break;
                        case 0x583:
                          iVar30 = thunk_FUN_0064f5e0((int)local_16c);
                          if (iVar30 == 0) break;
                          if (local_164 == (uint ************)0x0) {
                          ...
                          if ((int)local_164 < 1) {
                            ...
                            if ((int)local_c < iVar7) {
                              iVar7 = thunk_FUN_004d82b0(0);
                              pcVar22 = (char *)(iVar7 - (int)local_c);
                              goto LAB_0065565b;
                            }
                          }
                          else {
...
LAB_0065565b:
                          ...
                          goto switchD_00652a7f_caseD_3;
                        case 0x584:
                          iVar30 = thunk_FUN_0064f620(local_16c);
                          if (iVar30 == 0) break;
                          thunk_FUN_0064e5c0((char)local_164,local_160,local_15c,local_158,local_154
                                            );
                          goto switchD_00652a7f_caseD_3;
                        case 0x585:
                          ...
                          goto switchD_00652a7f_caseD_3;
                        case 0x58c:
                          iVar30 = thunk_FUN_0064f700(local_16c);
                          if (iVar30 == 0) break;
                          piVar8 = (int *)0x0;
                          sVar15 = (short)local_160;
                          sVar14 = (short)local_15c;
...
LAB_00655871:
                          ...
                          if ((piVar8 != (int *)0x0) && (local_164 != (uint ************)0x0)) {
                            (**(code **)(*piVar8 + 0x70))(local_164);
                          }
                          goto switchD_00652a7f_caseD_3;
                        case 0x58d:
                          iVar30 = thunk_FUN_0064f780(local_16c);
                          if (iVar30 != 0) {
                            iVar30 = (**(code **)(*this_00 + 0x18))();
                            if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                              iVar30 = thunk_FUN_00668f50(this_00,(char *)local_164,(uint)local_160,
                                                          (uint *)local_34);
                              if (0 < iVar30) {
                                local_10 = (uint ************)local_34;
                                local_8 = (uint ************)iVar30;
                                do {
                                  ...
                                  if ((int)local_144 < 0) {
                                    local_c = (uint ************)0xfffe;
LAB_00655972:
                                    iVar30 = thunk_FUN_0064d270(CONCAT22((short)((uint)local_158 >>
                                                                                0x10),
                                                                         *(undefined2 *)local_10),
                                                                (short)local_15c,(int)local_158,
                                                                (int)local_154,local_150,local_c,
...
LAB_006559d6:
                                    ...
                                    iVar30 = thunk_FUN_0042b760(CONCAT31((int3)((uint)local_144 >> 8
                                                                               ),*(char *)local_10),
                                                                (uint)local_144);
                                    if (iVar30 != 0) {
                                      iVar30 = thunk_FUN_00423300(iVar30);
...
LAB_006559e3:
                          ...
                          break;
                        case 0x58e:
                          iVar30 = thunk_FUN_0064f900(local_16c);
                          if (iVar30 != 0) {
                            iVar30 = (**(code **)(*this_00 + 0x18))();
                            if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                              iVar7 = thunk_FUN_00668f50(this_00,(char *)local_164,(uint)local_160,
                              ...
                              if (0 < iVar7) {
                                ...
                                local_c = (uint ************)iVar7;
                                do {
                                  local_8 = (uint ************)thunk_FUN_00676170(*local_10);
                                  if (local_8 != (uint ************)0x0) {
                                    pppppppppppuVar24 = (uint ***********)0x0;
                                    pppppppppppuVar11 = local_8[3];
                                    pppppppppppuVar18 = extraout_EDX_01;
                                    if (0 < (int)pppppppppppuVar11) {
                                      do {
                                        if (pppppppppppuVar24 < pppppppppppuVar11) {
                                          pppppppppppuVar18 = local_8[7];
                                          pppppppppppuVar11 =
                                               (uint ***********)
                                               ((int)local_8[2] * (int)pppppppppppuVar24 +
                                               (int)pppppppppppuVar18);
                                        }
                                        else {
                                        ...
                                        thunk_FUN_00449b60((undefined4 *)
                                                           CONCAT31((int3)((uint)local_15c >> 8),
                                                                    *(char *)local_10),
                                                           CONCAT22((short)((uint)pppppppppppuVar18
                                                                           >> 0x10),
                                        ...
                                        pppppppppppuVar11 = local_8[3];
                                        pppppppppppuVar18 = (uint ***********)local_8;
                          ...
                          break;
                        case 0x58f:
                          iVar30 = thunk_FUN_0064f950(local_16c);
                          if (iVar30 != 0) {
                            iVar30 = (**(code **)(*this_00 + 0x18))();
                            if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                              iVar7 = thunk_FUN_00668f50(this_00,(char *)local_164,(uint)local_160,
                              ...
                              if (0 < iVar7) {
                                ...
                                do {
                                  ...
                                  puVar5 = thunk_FUN_006775e0(*local_10,(uint)local_158,
                                                              (uint)local_15c,local_150,cVar3,
                                                              (short)local_14c,(short)local_148,
                                                              (short)local_144,(short)local_140,
                          ...
                          break;
                        case 0x590:
                          iVar30 = thunk_FUN_0064fb00(local_16c);
                          if (iVar30 != 0) {
                            iVar30 = (**(code **)(*this_00 + 0x18))();
                            if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                              iVar30 = thunk_FUN_00668f50(this_00,(char *)local_164,(uint)local_160,
                              ...
                              if (0 < iVar30) {
                                ...
                                local_c = (uint ************)iVar30;
                                do {
                                  iVar30 = thunk_FUN_0064d890(CONCAT22((short)((uint)local_158 >>
                                                                              0x10),
                                                                       *(ushort *)local_8),
                                                              (short)local_15c,(int)local_158,
                          ...
                          break;
                        case 0x591:
                          iVar30 = thunk_FUN_0064fb80(local_16c);
                          if (iVar30 != 0) {
                            iVar30 = (**(code **)(*this_00 + 0x18))();
                            if ((iVar30 != 8) || (local_164 != (uint ************)0x9)) {
                              ppppppppppppuVar23 =
                              ...
                              if (0 < (int)ppppppppppppuVar23) {
                                ...
                                do {
                                  DAT_008118fc = 0;
                                  thunk_FUN_00677be0(*(short *)ppppppppppppuVar16,(short)local_15c,
                          ...
                          break;
                        case 0x592:
                          iVar30 = thunk_FUN_0064fce0(local_16c);
                          if (iVar30 == 0) break;
                          iVar30 = thunk_FUN_0064db00((short)local_164,(short)local_160,
...
switchD_00652a7f_caseD_3:
                        ppppppppppppuVar23 = (uint ************)((int)local_170 + 1);
LAB_00659a80:
                        local_170 = ppppppppppppuVar23;
                        iVar7 = *(int *)(local_178 + 0xf);
                        ppppppppppppuVar23 = *(uint *************)(iVar7 + 0xc);
                      } while ((int)local_170 < (int)ppppppppppppuVar23);
                    }
                  }
                  goto LAB_00659aae;
                }
...
LAB_00659aae:
          ...
          local_14 = uVar25 + 1;
          bVar28 = local_14 < *(uint *)(iVar7 + 0xc);
    ...
    local_180 = (byte *)0x0;
    puVar5 = (uint *)thunk_FUN_0064d0e0(local_188,iVar7,&DAT_008016a0,local_14,-1);
  }
  return puVar5;
code_r0x00653bbb:
  iVar30 = iVar30 + 1;
  ppppppppppppuVar23 = ppppppppppppuVar23 + 1;
  if ((int)local_10 <= iVar30) goto switchD_00652a7f_caseD_3;
  goto LAB_00653bb7;
code_r0x00654366:
  iVar30 = iVar30 + 1;
  ppppppppppppuVar23 = ppppppppppppuVar23 + 1;
