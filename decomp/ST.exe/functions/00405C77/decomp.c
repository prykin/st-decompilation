...
uint * thunk_FUN_0043f7b0(byte param_1,int *param_2,int param_3,int param_4,int param_5,int *param_6
...

{
  ...
  iStack_c = param_3 + (int)param_6;
  if (DAT_007fb240 + -1 < param_3 + (int)param_6) {
    iStack_c = DAT_007fb240 + -1;
  }
  if (param_4 < 0) {
    param_4 = 0;
  }
  ...
  puVar8 = Library::DKW::TBL::FUN_006ae290((uint *)0x0,0xf,4,10);
  iVar10 = DAT_007fb240 * param_4 + iStack_8 + (iVar11 + -1) * (int)DAT_007fb246;
  if (iVar11 <= iVar7) {
    iStack_14 = (iVar7 - iVar11) + 1;
    do {
...
LAB_0043f9bd:
                ...
                if (iVar9 == 1) {
                  Library::DKW::TBL::FUN_006ae1c0(puVar8,&param_6);
                }
              }
LAB_0043f9fa:
