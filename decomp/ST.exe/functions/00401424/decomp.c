...
void __fastcall thunk_FUN_0061dfe0(int param_1)
  ...
  *(uint *)(param_1 + 0xac) = uVar2;
  ...
  if (iVar4 != 0) {
    ...
    if (0 < *(int *)(iVar4 + 0xc)) {
      ...
      do {
        if ((bVar5) && (iVar4 = *(int *)(iVar4 + 8) * uStack_8 + *(int *)(iVar4 + 0x1c), iVar4 != 0)
           ) {
        ...
        iVar4 = *(int *)(param_1 + 0xa3);
        uStack_8 = uStack_8 + 1;
        bVar5 = uStack_8 < *(uint *)(iVar4 + 0xc);
      } while ((int)uStack_8 < (int)*(uint *)(iVar4 + 0xc));
    }
  }
  return;
}
