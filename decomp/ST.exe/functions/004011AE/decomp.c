...
int __thiscall thunk_FUN_004758e0(void *this,undefined4 *param_1)
    ...
    if (uVar8 != 0xffffffff) {
      if (uVar8 == 0) {
        *(undefined4 *)((int)this + 0x5d6) = 1;
        FUN_006e62d0(DAT_00802a38,*(int *)((int)this + 0x7ca),(int *)&piStack_c);
      ...
      do {
        ...
        if (DAT_0080732c == 1) {
          ...
          *(uint *)((int)this + 0x1c) = uVar10;
          ...
          sVar17 = 0;
          *(uint *)((int)this + 0x1c) = uStack_1c;
          sVar5 = 0;
          lVar16 = __ftol();
          iVar6 = (int)(short)lVar16 + (uVar8 >> 0x10) % 7 + (int)*(short *)((int)this + 0x45) + -3
                  + (int)sStack_24;
          iVar7 = ((uVar10 >> 0x10) % 7 + (int)*(short *)((int)this + 0x43)) - (int)uStack_28._2_2_;
          uVar8 = uStack_1c;
        }
        else {
          ...
          *(uint *)((int)this + 0x1c) = uVar8;
          ...
          sVar17 = 0;
          sVar5 = 0;
          iVar6 = (uVar10 >> 0x10) % 7 + (int)*(short *)((int)this + 0x45) + -3 + (int)sStack_24;
          uStack_28._2_2_ = (short)((uint)uStack_28 >> 0x10);
          iVar7 = ((uVar13 >> 0x10) % 7 + (int)*(short *)((int)this + 0x43)) - (int)uStack_28._2_2_;
        }
        thunk_FUN_00556760(DAT_00802a7c,1,2,7,
                           (uVar8 >> 0x10) % 7 + (int)*(short *)((int)this + 0x41) + -3 +
                           (int)(short)uStack_28,iVar7 + -3,iVar6,sVar5,sVar17,sVar18,sVar19,sVar20,
                           sVar21,iVar12,sVar22,bVar23);
        iStack_10 = iStack_10 + 1;
        param_1 = (undefined4 *)((int)param_1 + 6);
      } while (iStack_10 < (int)(uint)*(byte *)((int)this + 0x2bf));
    }
    if (iStack_20 == -1) {
