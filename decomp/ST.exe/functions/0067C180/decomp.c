    ...
    if (iVar4 == 0) {
      ...
      if (local_20->field_0689 == 0) {
        if ((iVar4 == 0) || ((uint)(iVar4 * 3 + local_20->field_0685) <= (uint)local_20->field_06FE)
          ...
          groupContent = Library::DKW::TBL::FUN_006ae290((uint *)0x0,5,0x10,5);
          local_c = groupContent;
          thunk_FUN_0067a240(this_00,&LAB_00403544,groupContent);
          uVar10 = groupContent[3];
          uVar13 = 0;
          iVar4 = 0;
          bVar14 = uVar10 != 0;
          local_10 = 0;
          ...
          if (0 < (int)uVar10) {
            do {
              if (bVar14) {
                psVar5 = (short *)(groupContent[2] * uVar13 + groupContent[7]);
              }
              else {
                psVar5 = (short *)0x0;
              }
          ...
          if ((((this_00->field_0677 <= local_1c) && (0 < (int)uVar10)) && (0 < local_1c)) &&
            ...
            if (((this_00->field_0679 <= local_1c) || (local_14 < 1)) ||
              ...
              *(undefined4 *)(this_00->field_06AD + 0xc) = 0;
              ...
              if (0 < *(int *)(iVar4 + 0xc)) {
                do {
                  ...
                  if ((pSVar1 != (STFishC *)0x0) &&
                     (iVar7 = (*pSVar1->vtable->slot_F8)(), iVar7 != 0)) {
                    puVar9 = &local_3c;
                    ...
                    local_3c._2_2_ = (*pSVar1->vtable->slot_2C)();
                    thunk_FUN_0067bda0(local_38,pSVar1);
                    local_2c = (*pSVar1->vtable->slot_D4)();
              ...
              thunk_FUN_00676c40(this_00->field_06AD,&LAB_004026fd);
              thunk_FUN_00676c40((int)groupContent,&LAB_004029b4);
              thunk_FUN_0067bfd0(this_00,(int)groupContent,this_00->field_06AD);
...
LAB_0067c61b:
        ...
        if ((iVar4 == 0) ||
          ...
          local_20->field_0685 = local_20->field_06FE;
          thunk_FUN_0067be20((int)local_20,uVar10,local_20->field_06AD);
          ...
          if (iVar4 == 0) {
            ...
            if (0 < (int)puVar11[3]) {
                ...
                if (iVar4 != 0) {
                  ...
                  if (0 < *(int *)(iVar4 + 0xc)) {
                    ...
                    do {
                      ...
                      pSVar1 = (STFishC *)*puVar9;
                      if (((pSVar1 != (STFishC *)0x0) &&
                          (iVar7 = (*pSVar1->vtable->slot_F8)(), iVar4 = local_18, iVar7 != 0)) &&
                         (puVar12 = thunk_FUN_0067bd00(this_00->field_06AD,uVar10), iVar4 = local_18
                         , puVar12 == (ushort *)0x0)) {
              ...
              if (*(int *)(this_00->field_06AD + 0xc) == 0) {
                ...
                thunk_FUN_0067bfd0(this_00,(int)local_c,this_00->field_06AD);
                groupContent = local_c;
              }
            }
          }
