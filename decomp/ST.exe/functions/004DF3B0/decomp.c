  ...
  if (TVar1 == CASE_0) {
    ...
    if ((param_1->field_04D8 == 0) || (param_1->field_04D4 == 2)) {
      ...
      if (iVar3 == param_1->field_01F5->field_020C) {
        ...
        iVar3 = (**(code **)&param_1->vtable->field_0x2c)();
        /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
        thunk_FUN_004b76d0(CONCAT31((int3)((uint)iVar3 >> 8),*(undefined1 *)&param_1->field_0024),
                           iVar3);
        ...
        /* ST_PSEUDO[raw_indirect_call]: expected typed vtable/callback call with explicit __thiscall receiver */
        (*(code *)param_1->vtable->field_0090)(3,0x26c);
        return 0;
      }
    }
    else {
      if (param_1->field_0408 == 0) {
        thunk_FUN_004c2c10((AnonShape_004C2C10_59B6D93C *)param_1);
        /* ST_PSEUDO[raw_indirect_call]: expected typed vtable/callback call with explicit __thiscall receiver */
        (*(code *)param_1->vtable->field_0090)(3,0x26b);
      }
      if (param_1->field_04DC + 7 <= PTR_00802a38->field_00E4) {
    ...
    if (param_1->field_04DC + iVar4 <= PTR_00802a38->field_00E4) {
      ...
      if (9999 < iVar3) {
        ...
        iVar3 = (**(code **)&param_1->vtable->field_0x2c)();
        /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
        thunk_FUN_004b7710(CONCAT31((int3)((uint)iVar3 >> 8),*(undefined1 *)&param_1->field_0024),
                           iVar3);
        /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
        if (param_1->field_0024 == (uint)*(byte *)(param_1->field_0010 + 0x112d)) {
          thunk_FUN_004d8b70((char)param_1->field_0024);
