...

{
  ...
  thunk_FUN_005daf20(*(int *)(local_c + 0x1a5b));
  ...
  *(ushort **)(this_01 + 0x1a8b) = puVar6;
  FUN_006bc360(*(int *)(this_01 + 0x5d),local_450,(int *)0x0);
  *(undefined4 *)(*(int *)(this_01 + 0x1a5b) + 0x140) = 0xf;
  FUN_00718780((int)local_450,0,0x100,0x8b,0x15,(undefined4 *)(*(int *)(this_01 + 0x1a5b) + 0x144));
