...

{
  ...
  if (iVar17 != 0) {
    ...
    iVar38 = ReportDebugMessage("E:\\__titans\\Artem\\TLO_base.cpp",0x6d9,0,iVar17,
  ...
  if (SVar5 < MESS_STOCTOPUSC_0112) {
    ...
    if (SVar5 < MESS_STSPRGAMEOBJC_0109) {
      if (SVar5 == MESS_SHARED_0108) {
        ...
        iVar17 = 0;
        do {
          piVar44 = (int *)(&this_01->field_01F5->field_0x0 + iVar17);
          auStack_588[iVar38] = *(undefined4 *)(&this_01->field_01F5->field_0x1c + iVar17);
          aiStack_6dc[iVar38] = piVar44[8];
          if (*piVar44 != 0) {
            cVar43 = (char)iVar38;
            iVar24 = thunk_FUN_004ac910(&this_01->field_01D5,cVar43);
            aiStack_500[iVar38] = iVar24;
            iVar24 = thunk_FUN_004ac910(&this_01->field_01D5,cVar43);
            uVar25 = thunk_FUN_004acdd0(&this_01->field_01D5,cVar43,iVar24);
            auStack_698[iVar38] = uVar25;
          }
          iVar17 = iVar17 + 0x24;
          iVar38 = iVar38 + 1;
        } while (iVar17 < 0x264);
        if (this_01->field_05FF != (STT3DSprC *)0x0) {
          ...
          iVar17 = 0;
          do {
            pSVar21 = this_01->field_05FF;
            pAVar6 = pSVar21->field_0020;
            piVar44 = (int *)(&pAVar6->field_0x0 + iVar17);
            auStack_610[iVar38] = *(undefined4 *)(&pAVar6->field_0x1c + iVar17);
            aiStack_544[iVar38] = piVar44[8];
            if (*piVar44 != 0) {
              cVar43 = (char)iVar38;
              iVar24 = thunk_FUN_004ac910(pSVar21,cVar43);
              pSVar21 = this_01->field_05FF;
              aiStack_5cc[iVar38] = iVar24;
              iVar24 = thunk_FUN_004ac910(pSVar21,cVar43);
              uVar25 = thunk_FUN_004acdd0(this_01->field_05FF,cVar43,iVar24);
              auStack_654[iVar38] = uVar25;
            }
            iVar17 = iVar17 + 0x24;
            iVar38 = iVar38 + 1;
          } while (iVar17 < 0x264);
        ...
        iVar17 = 0;
        do {
          *(undefined4 *)(&this_01->field_01F5->field_0x1c + iVar17) = auStack_588[iVar38];
          *(int *)(&this_01->field_01F5->field_0x20 + iVar17) = aiStack_6dc[iVar38];
          piVar44 = (int *)(&this_01->field_01F5->field_0x0 + iVar17);
          iVar24 = *piVar44;
          if (iVar24 != 0) {
            *(undefined4 *)(piVar44[1] + aiStack_500[iVar38] * 4) =
                 *(undefined4 *)(aiStack_500[iVar38] * 4 + 0x31 + iVar24);
            uVar25 = auStack_698[iVar38];
            iVar24 = thunk_FUN_004ac910(&this_01->field_01D5,(char)iVar38);
            thunk_FUN_004ace00(&this_01->field_01D5,(char)iVar38,iVar24,uVar25);
          }
          iVar17 = iVar17 + 0x24;
          iVar38 = iVar38 + 1;
        } while (iVar17 < 0x264);
        ...
        do {
          *(undefined4 *)(&this_01->field_05FF->field_0020->field_0x1c + iVar17) =
               auStack_610[iVar38];
          *(int *)(&this_01->field_05FF->field_0020->field_0x20 + iVar17) = aiStack_544[iVar38];
          pAVar6 = this_01->field_05FF->field_0020;
          iVar24 = *(int *)(&pAVar6->field_0x0 + iVar17);
          if (iVar24 != 0) {
            *(undefined4 *)(*(int *)(&pAVar6->field_0x4 + iVar17) + aiStack_5cc[iVar38] * 4) =
                 *(undefined4 *)(aiStack_5cc[iVar38] * 4 + 0x31 + iVar24);
            uVar25 = auStack_654[iVar38];
            iVar24 = thunk_FUN_004ac910(this_01->field_05FF,(char)iVar38);
            thunk_FUN_004ace00(this_01->field_05FF,(char)iVar38,iVar24,uVar25);
          }
          iVar17 = iVar17 + 0x24;
          iVar38 = iVar38 + 1;
        } while (iVar17 < 0x264);
      ...
      if (SVar5 == MESS_ID_NONE) {
        ...
        if (this_00 == (void *)0x0) {
          puVar22 = thunk_FUN_00631fd0();
          this_01->field_061F = puVar22;
          dVar23 = this_01->slot_2C();
          thunk_FUN_006324c0(this_01->field_061F,CASE_2,dVar23);
          g_currentExceptionFrame = local_c4.previous;
          return 0;
        }
      ...
      if (SVar5 == MESS_ID_CREATE) {
        ...
        if (this_01 == (TLOBaseTy *)0x0) {
          pTVar36 = (TLOBaseTy_field_05ACState *)0x0;
        }
        else {
          pTVar36 = &this_01->field_05AC;
        }
        ...
        *(short *)pTVar36 = (short)*pTVar32;
        *(byte *)((int)pTVar36 + 2) = *(byte *)((int)pTVar32 + 2);
        this_01->field_0231 = *(TLOBaseTy_field_0231State *)(dVar23 + 0xc);
        this_01->field_0235 = this_01->field_05AC - CASE_32;
        local_EAX_394 = GetPlayerRaceId(*(char *)&this_01->field_0024);
        this_01->field_0239 = (local_EAX_394 & 0xffU) - 1;
        ...
        case CASE_3:
          ...
          local_EAX_833 = GetPlayerRaceId(*(char *)&this_01->field_023D);
          this_01->field_0241 =
               (*(int *)(&DAT_007e4178 + ((local_EAX_833 & 0xffU) + this_01->field_0235 * 3) * 4) *
               this_01->field_05D7) / 100;
          this_01->field_0410 = 0;
          ...
          if ((((TVar7 != CASE_4D) || (this_01->field_04D0 == CASE_2)) &&
            ...
            thunk_FUN_004b76d0(CONCAT31((int3)(dVar23 >> 8),*(undefined1 *)&this_01->field_0024),
                               dVar23);
          }
          ...
          if (this_01->field_0245 == CASE_0) {
            ...
            iVar38 = this_01->field_01F5->field_0208;
            if (iVar38 < iVar17) {
              uVar27 = this_01->field_001C * 0x41c64e6d + 0x3039;
              this_01->field_001C = uVar27;
              uVar27 = (uVar27 >> 0x10) % ((iVar17 - iVar38) + 1U) + iVar38;
              STT3DSprC::SetCurFase((STT3DSprC *)&this_01->field_01D5,'\x0e',uVar27);
              STT3DSprC::SetCurFase((STT3DSprC *)&this_01->field_01D5,'\r',uVar27);
            }
          }
          ...
          TLOEmbryoTy::sub_0041C3F0((TLOEmbryoTy *)this_01,puVar18);
          ...
          local_EAX_1723 = GetPlayerRaceId(*(char *)&this_01->field_023D);
          if (this_01->field_0241 !=
              *(int *)(&DAT_007e4178 + ((local_EAX_1723 & 0xffU) + this_01->field_0235 * 3) * 4)) {
          ...
          if (((this_01->field_0231 == CASE_1) &&
             ...
             (local_EAX_1838 = GetPlayerRaceId(*(char *)&this_01->field_023D),
             *(int *)(&DAT_007952b8 + ((local_EAX_1838 & 0xffU) + this_01->field_0235 * 3) * 4) != 0
             )) {
            pTVar28 = this_01->vtable;
            local_EAX_1886 = GetPlayerRaceId(*(char *)&this_01->field_023D);
            (*pTVar28->vfunc_90)
                      (this_01,4,
                       *(undefined4 *)
                        (&DAT_007952b8 + ((local_EAX_1886 & 0xffU) + this_01->field_0235 * 3) * 4));
          }
          if (((this_01->field_0231 == CASE_0) || (this_01->field_0231 == CASE_3)) &&
             (g_manBasis_00811784 != (STManBasisC *)0x0)) {
            local_EAX_1961 = GetPlayerRaceId(*(char *)&this_01->field_0024);
            /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
          ...
          if (this_01->field_05DF != 0) {
            puVar22 = &this_01->field_01D5;
            this_01->field_04C8 = PTR_00806724->entryCount + -1;
            this_01->field_04CC = g_playSystem_00802A38->field_00E4;
            STT3DSprC::sub_004ACE60((STT3DSprC *)puVar22,'\x0e');
            STT3DSprC::sub_004ACE60((STT3DSprC *)puVar22,'\r');
            STT3DSprC::sub_004ACE60((STT3DSprC *)puVar22,'\f');
            STT3DSprC::sub_004ACE60((STT3DSprC *)puVar22,'\v');
            STT3DSprC::sub_004ACE60((STT3DSprC *)puVar22,'\t');
            STT3DSprC::sub_004ACE60((STT3DSprC *)puVar22,'\b');
            STT3DSprC::sub_004ACE60((STT3DSprC *)puVar22,'\a');
            STT3DSprC::sub_004ACE30
                      ((STT3DSprC *)puVar22,PTR_00806724->entries[this_01->field_04C8],
        ...
        case CASE_2:
          ...
          puVar22 = (undefined4 *)&local_c->field_0x57;
          puVar37 = (undefined4 *)
          ...
          *(undefined2 *)puVar37 = *(undefined2 *)puVar22;
          *(undefined1 *)((int)puVar37 + 2) = *(undefined1 *)((int)puVar22 + 2);
          ...
          *local_34 = DAT_00806774;
          ...
          if (this_01->field_0245 == CASE_1) {
            if (this_01->field_05DF == 5) {
              local_30 = PTR_00806724->entries[this_01->field_04C8];
          ...
          if ((this_01->field_05F7 != 0) && (*(int *)(&DAT_00790c2c + this_01->field_0235 * 4) != 0)
            ...
            FUN_006ea190((void *)this_01->field_0211,uVar18,uVar27,iVar17);
          }
          if (*(int *)&pAVar26->field_0x3de != 0) {
            ...
            local_EAX_2934 = thunk_FUN_004ad650(this_01->field_05FF);
            FUN_006ea340((void *)this_01->field_0211,local_EAX_2934,iVar17,uVar27);
            pAVar26 = local_c;
          }
          if (*(int *)&pAVar26->field_0x3ee != 0) {
            ...
            this_01->field_0603 = pSVar21;
            iVar17 = STT3DSprC::Init(pSVar21,DAT_008073cc,this_01->field_0613,this_01->field_0617,
            ...
            if (((this_01->field_0444 != 0) && (this_01->field_0448 != 0)) &&
              ...
              uVar27 = 6;
              iVar17 = thunk_FUN_004ad650((STT3DSprC *)&this_01->field_01D5);
              local_EAX_3206 = thunk_FUN_004ad650(this_01->field_0603);
              FUN_006ea340((void *)this_01->field_0211,local_EAX_3206,iVar17,uVar27);
            }
          }
          FreeAndNull(&local_34);
          if ((this_01->field_046C == CASE_4) && (this_01->field_0490 != 0)) {
            iVar17 = 0;
            uVar27 = thunk_FUN_004ad650((STT3DSprC *)&this_01->field_01D5);
            Library::Ourlib::ST3DSMAP::SprSetVisible((void *)this_01->field_0211,uVar27,iVar17);
            if (this_01->field_05FF != (STT3DSprC *)0x0) {
              iVar17 = 0;
              uVar27 = thunk_FUN_004ad650(this_01->field_05FF);
              Library::Ourlib::ST3DSMAP::SprSetVisible((void *)this_01->field_0211,uVar27,iVar17);
            }
            if (this_01->field_0603 != (STT3DSprC *)0x0) {
              iVar17 = 0;
              uVar27 = thunk_FUN_004ad650(this_01->field_0603);
              Library::Ourlib::ST3DSMAP::SprSetVisible((void *)this_01->field_0211,uVar27,iVar17);
            }
          }
          ...
          /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
          uVar25 = CONCAT22(extraout_var,this_01->field_0032);
          TLOEmbryoTy::sub_00419CF0((int *)this_01,uVar25,uVar25);
          if (this_01->field_0251 != 0) {
            ...
            if ((int)local_8 < (int)(local_8 + iVar17)) {
              do {
                iVar38 = this_01->field_05B0;
                if (iVar38 < iVar38 + iVar17) {
                  do {
                    iVar24 = thunk_FUN_004960d0((short)iVar38,(short)local_8,
                                                *(short *)&this_01->field_05B8);
                    if (iVar24 != 0) {
                      RaiseInternalException
                    ...
                    iVar38 = iVar38 + 1;
                  } while (iVar38 < this_01->field_05B0 + iVar17);
                }
                local_8 = local_8 + 1;
    ...
    if (SVar5 == MESS_SHARED_010F) {
      uVar25 = this_01->field_002C;
      ppbVar34 = local_4bc;
      for (iVar17 = 0xfd; iVar17 != 0; iVar17 = iVar17 + -1) {
        *ppbVar34 = (byte *)0x0;
        ppbVar34 = ppbVar34 + 1;
      }
      pbVar35 = this_01->field_0024;
      pTVar36 = (TLOBaseTy_field_05ACState *)0x0;
      ...
      *(short *)pTVar32 = (short)*pTVar36;
      *(byte *)((int)pTVar32 + 2) = *(byte *)((int)pTVar36 + 2);
      if (this_01 == (TLOBaseTy *)0x0) {
      ...
      *(short *)pTVar40 = (short)*pTVar33;
      *(byte *)((int)pTVar40 + 2) = *(byte *)((int)pTVar33 + 2);
      local_ea = 0x3f6;
      local_4bc[1] = pbVar35;
      ...
      pbVar35 = local_10;
      for (iVar17 = 0xfd; iVar17 != 0; iVar17 = iVar17 + -1) {
        *(byte **)pbVar35 = *ppbVar34;
        ppbVar34 = ppbVar34 + 1;
        pbVar35 = pbVar35 + 4;
      }
      *(undefined2 *)pbVar35 = *(undefined2 *)ppbVar34;
      uVar30 = this_01->field_03D4 * 0x27;
      pAVar19 = this_01->field_0607;
      pbVar35 = local_10 + local_ea;
      for (uVar27 = uVar30 >> 2; uVar27 != 0; uVar27 = uVar27 - 1) {
        *(undefined4 *)pbVar35 = pAVar19->field_0000;
        pAVar19 = (AnonPointee_TLOBaseTy_0607 *)&pAVar19->field_0004;
        pbVar35 = pbVar35 + 4;
      }
      for (uVar30 = uVar30 & 3; uVar30 != 0; uVar30 = uVar30 - 1) {
        *pbVar35 = *(byte *)&pAVar19->field_0000;
        pAVar19 = (AnonPointee_TLOBaseTy_0607 *)((int)&pAVar19->field_0000 + 1);
        pbVar35 = pbVar35 + 1;
      }
      pbVar35 = local_40;
      ...
      for (uVar27 = local_e6 >> 2; uVar27 != 0; uVar27 = uVar27 - 1) {
        *(undefined4 *)pbVar41 = *(undefined4 *)pbVar35;
        pbVar35 = pbVar35 + 4;
        pbVar41 = pbVar41 + 4;
      }
    ...
    if ((0x9a < local_5c[1]) &&
       (((local_5c[1] < 0x9f || (local_5c[1] == 0xa5)) &&
        (iVar38 = thunk_FUN_004e60d0((int)this_01->field_0024,0x68), iVar38 != 0)))) {
    ...
    if (local_5c[1] == 0x9a) {
      ...
      if ((this_01->field_04A0 == 0) || (this_01->field_04A8 < (int)pAVar26)) {
        this_01->field_04A8 = (int)pAVar26;
    ...
    if (local_5c[1] != 0x42) {
      ...
      case 0xbb:
      case 0xbf:
        pAVar26 = (AnonShape_004B9FA0_0EE05DAC *)thunk_FUN_004e60d0((int)this_01->field_0024,0x67);
        iVar17 = 0;
...
LAB_004bb547:
      ...
      local_EAX_5569 = GetPlayerRaceId(*(char *)&this_01->field_0024);
      uVar27 = local_EAX_5569 & 0xff;
      if (uVar27 == 1) {
        pbVar35 = this_01->field_0024;
        iVar17 = 4;
LAB_004bb58d:
        pAVar26 = (AnonShape_004B9FA0_0EE05DAC *)thunk_FUN_004e60d0((int)pbVar35,iVar17);
        local_c = pAVar26;
      }
      else {
        if (uVar27 == 2) {
    ...
    local_EAX_5336 = GetPlayerRaceId(*(char *)&this_01->field_0024);
    uVar27 = local_EAX_5336 & 0xff;
    if (uVar27 == 1) {
      pbVar35 = this_01->field_0024;
      iVar38 = 0x2d;
LAB_004bb4a1:
      pAVar26 = (AnonShape_004B9FA0_0EE05DAC *)thunk_FUN_004e60d0((int)pbVar35,iVar38);
      local_c = pAVar26;
    }
    else {
      if (uVar27 == 2) {
  ...
  if (SVar5 < MESS_SHARED_0129) {
    if (SVar5 == MESS_HITKILL) {
      ...
      if ((TVar9 != CASE_1) && (TVar9 != CASE_6)) {
        ...
        if ((this_01->field_05DF == 0) || (this_01->field_05DF == 4)) {
          uVar27 = (uint)(this_01->field_024D == 4);
          local_EAX_7611 = GetPlayerRaceId(*(char *)&this_01->field_0024);
    ...
    if (SVar5 != MESS_SHARED_0121) {
      if (SVar5 == MESS_SHARED_0122) {
        piVar44 = (message->arg0).ptr;
        if ((byte *)*piVar44 != this_01->field_0024) {
          g_currentExceptionFrame = local_c4.previous;
          return 0;
        }
        this_01->field_0410 = 1;
        this_01->field_0414 = piVar44[2];
        this_01->field_0418 = g_playSystem_00802A38->field_00E4;
        this_01->field_041C = piVar44[1];
        g_currentExceptionFrame = local_c4.previous;
        return 0;
      }
...
LAB_004bbc2b:
      ...
      bVar42 = (&DAT_008087ea)[(uint)bVar2 * 0x51] != (&DAT_008087ea)[(uint)bVar1 * 0x51];
    }
    if ((bVar42) && (iVar17 = FUN_006b0fd0(0x800f90), iVar17 != 0)) {
...
LAB_004bc117:
      ...
      local_EAX_8505 = GetPlayerRaceId((char)(byte *)this_01->field_023D);
  ...
  case 0x14:
    ...
    case CASE_6C:
      ...
      this_01->field_0430 = **(undefined4 **)(dVar23 + 0x17);
      this_01->field_0434 = *(undefined4 *)(*(int *)(dVar23 + 0x17) + 4);
  ...
  case 0x15:
    ...
    iVar38 = this_01->field_05B0;
LAB_004bc4c0:
    sub_004C6C70(this_01,iVar38,iVar17,iVar24);
    if (this_01->field_0249 != -1) {
      this_01->field_0249 = 0xffffffff;
      g_currentExceptionFrame = local_c4.previous;
      return 0;
    ...
    if (TVar7 == CASE_4C) {
      ...
      if (TVar7 != CASE_43) {
        if (((TVar7 == CASE_36) || (TVar7 == CASE_5D)) && (*pcVar13 == '\v')) {
          ...
          local_EAX_11034 = GetPlayerRaceId(*(char *)&this_01->field_023D);
        ...
        if ((TVar7 == CASE_3C) || (TVar7 == CASE_53)) {
          if (*pcVar13 == '\f') {
            ...
            uVar27 = this_01->field_001C * 0x41c64e6d + 0x3039;
            this_01->field_001C = uVar27;
            thunk_FUN_004db020((int)this_01->field_0024,uVar27 >> 0x10);
            g_currentExceptionFrame = local_c4.previous;
            return 0;
          }
          if (*pcVar13 != '\r') {
  ...
  case 0x1e:
    ...
    if ((this_01->field_0024 == (byte *)(uint)(byte)this_01->field_0010->field_112D) &&
      ...
      local_EAX_8211 = GetPlayerRaceId(*(char *)&this_01->field_023D);
      uVar27 = local_EAX_8211 & 0xff;
      if (uVar27 == 1) {
        pTVar28 = this_01->vtable;
        uVar25 = 0x208;
LAB_004bbfe9:
        (*pTVar28->vfunc_90)(this_01,4,uVar25);
      }
      else if (uVar27 == 2) {
    ...
    iVar17 = sub_004C7860(this_01,(uint)*pbVar35,*(uint *)(pbVar35 + 1),(int)*(short *)(pbVar35 + 5)
                          ,0,1);
    if (iVar17 != 0) {
      thunk_FUN_004c7cc0(this_01,(uint)*pbVar35,*(uint *)(pbVar35 + 1),(int)*(short *)(pbVar35 + 5),
                         (uint)(*pbVar35 != 2),*(uint *)(pbVar35 + 7),0,0xff,(char *)0x0);
      g_currentExceptionFrame = local_c4.previous;
      return 0;
    }
    break;
  case 0x1f:
    if ((this_01->field_05AC == CASE_3A) && (**(char **)(dVar23 + 0x17) == '\x02')) {
      thunk_FUN_004d9b20((int)this_01);
      g_currentExceptionFrame = local_c4.previous;
      return 0;
    }
    if ((this_01->field_05AC == CASE_64) && (**(char **)(dVar23 + 0x17) == '\x02')) {
  ...
  case 0x20:
    ...
    if ((this_01->field_05AC == CASE_52) || (this_01->field_05AC == CASE_5F)) {
      if (*pbVar35 == 1) {
        thunk_FUN_004ebab0(this_01,(uint)*(ushort *)(pbVar35 + 1),*(int *)(pbVar35 + 3));
        g_currentExceptionFrame = local_c4.previous;
        return 0;
      }
      thunk_FUN_004eb6d0(this_01,(uint)*pbVar35,(uint)*(ushort *)(pbVar35 + 1),*(int *)(pbVar35 + 3)
  ...
  case 0x23:
    ...
    if (((((-1 < (int)uVar27) && ((int)uVar27 < (int)g_worldGrid.sizeX)) &&
      ...
      if (this_01->field_05AC == CASE_53) {
        thunk_FUN_004cdfd0(this_01,uVar12,uVar27,uVar30,uVar11);
        g_currentExceptionFrame = local_c4.previous;
        return 0;
      }
      if (this_01->field_05AC == CASE_6C) {
        thunk_FUN_004e99e0(this_01,uVar27,uVar30,uVar11);
        g_currentExceptionFrame = local_c4.previous;
        return 0;
      }
    }
  ...
  case 0x27:
    TVar7 = this_01->field_05AC;
    if (TVar7 == CASE_50) {
      thunk_FUN_004b6e30(this_01,(uint)**(byte **)(dVar23 + 0x17),
                         (uint)(*(byte **)(dVar23 + 0x17))[1]);
      g_currentExceptionFrame = local_c4.previous;
      return 0;
    }
    if ((TVar7 == CASE_34) && (**(char **)(dVar23 + 0x17) == '\x02')) {
      thunk_FUN_004de1e0(this_01,(uint)(byte)(*(char **)(dVar23 + 0x17))[1]);
      g_currentExceptionFrame = local_c4.previous;
      return 0;
    }
    if ((TVar7 == CASE_5B) && (**(char **)(dVar23 + 0x17) == '\x02')) {
      thunk_FUN_004de300(this_01,(uint)(byte)(*(char **)(dVar23 + 0x17))[1]);
      g_currentExceptionFrame = local_c4.previous;
      return 0;
    }
    break;
  ...
  case 0x2a:
    ...
    case 4:
      ...
      goto LAB_004bd06b;
    case 5:
      piVar44 = (int *)((int)&puRam00000000 + 1);
LAB_004bd06b:
      thunk_FUN_004dbf30(this_01,piVar44);
    }
  }
  g_currentExceptionFrame = local_c4.previous;
  return 0;
