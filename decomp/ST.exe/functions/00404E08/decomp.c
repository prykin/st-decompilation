...
int __thiscall thunk_FUN_004749c0(void *this,void *param_1)
...
LAB_00475068:
      ...
      uStack_44 = *(undefined4 *)((int)this + 8);
      uStack_3c = 0x129;
      uStack_40 = 2;
      FUN_006e5810(auStack_4c);
    ...
    if (iVar10 == 4) {
      ...
      *(uint *)((int)this + 0x1c) = uVar1;
      ...
      if ((*(int *)((int)this + 0x74a) <= (int)*(short *)(DAT_00806724 + 0x23) / 2) &&
         (iStack_10 = 0, *(char *)((int)this + 0x2bf) != '\0')) {
        ...
        do {
          ...
          if (DAT_0080732c == 1) {
            ...
            bVar22 = 0;
            lVar14 = __ftol();
            iVar13 = (int)sStack_20 + *(short *)((int)this + 0x45) + iStack_c + (int)(short)lVar14;
            iVar12 = (int)*(short *)((int)this + 0x43) - (int)uStack_24._2_2_;
            iVar9 = (int)(short)uStack_24 + iVar10 + *(short *)((int)this + 0x41);
          }
          else {
            iVar13 = (int)sStack_20 + iStack_c + *(short *)((int)this + 0x45);
