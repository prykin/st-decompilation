...
LAB_00475068:
      ...
      if ((*(int *)(*(int *)(this + 0x5a6) + 0x7ce) != 0) &&
        ...
        if ((int)uVar3 == 0) {
          ...
          pSStack_8 = (STBoatC *)((*(int *)(&DAT_0085442c + iVar10 * 4) * iVar12) / iVar6);
          iVar6 = (*(int *)(&DAT_007e07a0 + iVar10 * 4) * iVar12) / iVar6;
          thunk_FUN_004d7480((char)this[0x24],4,*(undefined4 *)(this + 0x18),(int)pSStack_8,0,iVar6,
                             0);
          iVar10 = thunk_FUN_004d7b10((char)this[0x24],4);
          if (((int)pSStack_8 <= iVar10) &&
             (iVar10 = thunk_FUN_004d7b90((char)this[0x24],4), iVar6 <= iVar10)) {
            thunk_FUN_004d7c10((char)this[0x24],4,*(int *)(this + 0x18),(int)pSStack_8);
      ...
      uStack_44 = *(undefined4 *)(this + 8);
      uStack_3c = 0x129;
      uStack_40 = 2;
      SystemClassTy::PostMessage(DAT_00802a38,auStack_4c);
      ...
      if ((*(int *)(this + 0x74a) <= (int)*(short *)(DAT_00806724 + 0x23) / 2) &&
        ...
        do {
          ...
          if (DAT_0080732c == 1) {
            ...
            iVar13 = (int)sStack_20 + *(short *)(this + 0x45) + iStack_c + (int)(short)lVar14;
            iVar12 = (int)*(short *)(this + 0x43) - (int)uStack_24._2_2_;
            iVar9 = (int)(short)uStack_24 + iVar10 + *(short *)(this + 0x41);
          }
          else {
            iVar13 = (int)sStack_20 + iStack_c + *(short *)(this + 0x45);
