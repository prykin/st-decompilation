...
undefined4 __cdecl
thunk_FUN_006a34e0(int *param_1,uint param_2,int param_3,uint param_4,int param_5,int param_6,
...

{
  ...
  if ((((((-1 < (int)param_2) && ((int)param_2 < *param_1)) && (-1 < param_3)) &&
    ...
    iVar2 = thunk_FUN_006a1370(param_1,param_4,param_5,param_6,(undefined4 *)auStack_c);
    iVar2 = thunk_FUN_006a24e0(auStack_c,(int)(short)iVar2,param_7,param_6,0xff);
    if (iVar2 == 0) {
    ...
    iVar2 = thunk_FUN_006a1370(param_1,param_2,param_3,param_6,(undefined4 *)auStack_c);
    iVar2 = thunk_FUN_006a24e0(auStack_c,(int)(short)iVar2,param_7,param_6,0xff);
    if (iVar2 == 0) {
