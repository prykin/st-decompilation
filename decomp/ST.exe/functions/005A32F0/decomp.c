...

{
  ...
  iVar6 = __setjmp3(local_48,0,unaff_ESI,uVar8);
  pvVar4 = DAT_00802a30;
  if (iVar6 != 0) {
  ...
  if (param_1 != 0) {
    pvVar4 = *(void **)(*(int *)((int)local_8 + 0x1a5b) + 0x2e6);
    if (pvVar4 == (void *)0x0) {
      DAT_00858df8 = (undefined1 *)uVar8;
      return;
    }
  ...
  DAT_0080877e = 1;
  *(undefined1 *)((int)local_8 + 0x1a61) = 0;
  DAT_008067a0 = 1;
  uVar3 = *(uint *)((int)local_8 + 0x1ec2);
  if (uVar3 < 0x502) {
    if (uVar3 == 0x501) {
      DAT_00803400 = 5;
      goto LAB_005a33fb;
