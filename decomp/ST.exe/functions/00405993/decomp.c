...
LAB_0061364b:
  ...
  if (iVar5 < 0) {
    iStack_c = (short)(((short)(iVar5 / 200) + sVar2) -
                      (short)((longlong)iVar5 * 0x51eb851f >> 0x3f)) + -1;
  }
  else {
    iStack_c = (int)(short)(((short)(iVar5 / 200) + sVar2) -
  ...
  if ((((DAT_0080874d == -1) || (*(int *)((int)DAT_00802a88 + 0xf8) == 0)) ||
    ...
    if ((bVar9) && (*(int *)((int)pvVar3 + 0x4c) != 0)) {
      bVar9 = *(char *)(((&DAT_0079aed0)[iStack_c] + iStack_18) * *(int *)((int)pvVar3 + 0x30) +
