...
int __thiscall
thunk_FUN_0065eb70(void *this,uint param_1,int param_2,uint *param_3,uint param_4,uint param_5,
  ...
  if (((DAT_007fa174 != 0) && (param_3 != (uint *)0x0)) && (0 < param_2)) {
    ...
    if (param_1 != 0xff) {
      ...
      if (uVar1 == 0) {
        ...
        piStack_c = Library::DKW::LIB::FUN_006aac10((uint)uVar1 * 0x2c);
        DAT_00811900 = 0;
        if ((char)param_7 == '\b') {
        ...
        thunk_FUN_00676d80(param_1,param_4,param_5,param_6,(char)param_7,0,0,0,-1,-1,-1,
                           &LAB_0040559c,piStack_c,(undefined *)0x0);
        if (DAT_00811900 == 0) {
          iStack_8 = 0;
        }
          ...
          if (0 < iVar4) {
            do {
              iVar2 = thunk_FUN_00423220((void *)((int)this + 0x1c),piStack_c,DAT_00811900);
              if (piStack_c[iVar2 * 0xb + 3] != 0) {
                param_2._0_2_ = CONCAT11(1,cVar5);
                param_2 = CONCAT22((short)piStack_c[iVar2 * 0xb + 4],(undefined2)param_2);
          ...
          if (0 < DAT_00811900) {
            do {
              if (*(int *)(iVar2 + 0xc + (int)piStack_c) != 0) {
                param_2._0_2_ = CONCAT11(1,cVar5);
                param_2 = CONCAT22(*(undefined2 *)(iVar2 + 0x10 + (int)piStack_c),
                                   (undefined2)param_2);
                Library::DKW::TBL::FUN_006ae1c0(param_3,&param_2);
                iStack_8 = iStack_8 + 1;
                iVar4 = DAT_00811900;
