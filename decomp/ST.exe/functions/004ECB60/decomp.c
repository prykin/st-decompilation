...

{
  ...
  array = *(DArrayTy **)&g_packedRecords_A62x8[(int)param_1->field_0024].field_0x9f2;
  if (array != (DArrayTy *)0x0) {
    ...
    if (0 < (int)array->count) {
      do {
        ...
        if (local_8 == param_1) {
          DArrayRemoveAt(*(DArrayTy **)&g_packedRecords_A62x8[(int)param_1->field_0024].field_0x9f2,
                         index);
          break;
        }
        index = index + 1;
