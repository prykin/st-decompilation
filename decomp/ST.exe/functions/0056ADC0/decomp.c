...

{
  ...
  local_34 = (AppClassTy *)(local_c + 0x38);
  local_40 = DAT_00806748;
  local_138.previous = g_currentExceptionFrame;
  g_currentExceptionFrame = &local_138;
  iVar7 = Library::MSVCRT::__setjmp3(local_138.jumpBuffer,0,unaff_EDI,unaff_ESI);
  pAVar25 = local_34;
  if (iVar7 == 0) {
    *(undefined4 *)local_34 = 1;
    iVar7 = Library::DKW::SND::FUN_006b7920((undefined4 *)(local_34 + 4),(DWORD_PTR)local_40);
    if (iVar7 != 0) {
  ...
  iVar7 = thunk_FUN_00571e40((AppClassTy *)(local_c + 0x38),1);
  if (iVar7 == 0) {
  ...
  iVar7 = Library::MSVCRT::__setjmp3(local_248.jumpBuffer,0,unaff_EDI,unaff_ESI);
  pSVar20 = local_c;
  if (iVar7 == 0) {
    pAVar25 = (AppClassTy *)(local_c + 0x60);
    pAVar1 = (AppClassTy *)(local_c + 0x7d1a);
  ...
  iVar7 = Library::MSVCRT::__setjmp3(local_1c0.jumpBuffer,0,unaff_EDI,unaff_ESI);
  if (iVar7 == 0) {
  ...
  thunk_FUN_005672a0((AppClassTy *)(local_c + 0x38),DAT_00856d78);
  local_f4.previous = g_currentExceptionFrame;
  g_currentExceptionFrame = &local_f4;
  iVar7 = Library::MSVCRT::__setjmp3(local_f4.jumpBuffer,0,unaff_EDI,unaff_ESI);
  pSVar20 = local_c;
  ...
  *(uint **)(pSVar20 + 0x4eda) = puVar8;
  ...
  if (pcVar11 == (char *)0x0) {
    if ((DAT_00807330 & 1) != 0) {
      ...
      puVar8 = thunk_FUN_00683c70((uint *)(pSVar20 + 0x7d1a),&stack0xfffffaa0,&local_38,(int *)0x0,
                                  (undefined *)0x0);
      ...
      *(int *)(pSVar20 + 0x8552) = *(char *)(*(int *)(DAT_00857168 + 4) + 5) + -0x30;
      ...
      if (iVar7 == 0) {
        ...
        case 0x62:
          ...
          iVar7 = Library::MSVCRT::__setjmp3(local_204.jumpBuffer,0,unaff_EDI,unaff_ESI);
          pSVar20 = local_c;
          if (iVar7 == 0) {
            pcVar10 = (cMf32 *)FUN_006f0ec0(0x345,(byte *)(local_c + 0x76f6),0,0,0);
            local_3c = (AppClassTy *)(pSVar20 + 0x1196);
            cMf32::RecGet(pcVar10,0,PTR_s_DESCRIPTOR_0079b080,(int *)&local_3c,0);
...
switchD_0056b4ce_caseD_57:
    ...
    if (*(char **)(DAT_00857168 + 8) != (char *)0x0) {
      ...
      if (iVar7 != -2) {
        ...
        if ((hFile != (HANDLE)0xffffffff) &&
          ...
          WriteFile(hFile,pSVar20 + 0x1134,4,&local_44,(LPOVERLAPPED)0x0);
          CloseHandle(hFile);
  ...
  case '~':
    if (*(int *)(DAT_00857168 + 8) != 0) {
      ...
      iVar7 = Library::MSVCRT::__setjmp3(local_17c.jumpBuffer,0,pSVar19,puVar27);
      pSVar20 = local_c;
      if (iVar7 == 0) {
        pcVar10 = (cMf32 *)FUN_006f0ec0(0x345,(byte *)(local_c + 0x76f6),2,0,0);
        local_8 = (AppClassTy *)(pSVar20 + 0x1196);
        cMf32::RecGet(pcVar10,0,PTR_s_DESCRIPTOR_0079b080,(int *)&local_8,0);
  ...
  if ((*(AppClassTy *)(pSVar20 + 0xe26) == (AppClassTy)0x0) && (local_1c != 0x6104)) {
    local_1c = 0x6123;
  }
LAB_0056c034:
