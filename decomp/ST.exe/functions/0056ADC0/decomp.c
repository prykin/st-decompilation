...

{
  ...
  iVar6 = __setjmp3(local_134,0,unaff_EDI,unaff_ESI);
  pSVar19 = local_34;
  if (iVar6 == 0) {
    *(int *)local_34 = 1;
  ...
  iVar6 = __setjmp3(local_244,0,unaff_EDI,unaff_ESI);
  pSVar19 = local_c;
  if (iVar6 == 0) {
  ...
  iVar6 = __setjmp3(local_1bc,0,unaff_EDI,unaff_ESI);
  if (iVar6 == 0) {
  ...
  iVar6 = __setjmp3(local_f0,0,unaff_EDI,unaff_ESI);
  pSVar19 = local_c;
      ...
      *(int *)(pSVar19 + 0x8552) = *(char *)(*(int *)(DAT_00857168 + 4) + 5) + -0x30;
      ...
      if (iVar6 == 0) {
        ...
        case 0x62:
          ...
          iVar6 = __setjmp3(local_200,0,unaff_EDI,unaff_ESI);
          pSVar19 = local_c;
          if (iVar6 == 0) {
...
switchD_0056b4ce_caseD_57:
  ...
  case '~':
    if (*(int *)(DAT_00857168 + 8) != 0) {
      ...
      iVar6 = __setjmp3(local_178,0,pSVar18,puVar24);
      pSVar19 = local_c;
      if (iVar6 == 0) {
