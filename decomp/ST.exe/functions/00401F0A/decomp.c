...
int __fastcall
thunk_FUN_0065dd30(int param_1,undefined4 param_2,uint param_3,uint param_4,char param_5,
                  byte *param_6,short param_7,short param_8,short param_9,short param_10,
                  short param_11,short param_12)

{
  ...
  iStack_10 = 0;
  iStack_18 = param_1;
  puStack_1c = thunk_FUN_0065da10(param_1,param_2);
  if (puStack_1c != (uint *)0x0) {
    ...
    if (0 < (int)uVar4) {
      do {
        if (uStack_14 < uVar4) {
          puVar3 = (undefined2 *)(puStack_1c[2] * uStack_14 + puStack_1c[7]);
        }
        else {
...
LAB_0065deef:
          ...
          if (((param_5 == -1) || (iVar8 = (**(code **)(*this + 0x6c))(), param_5 == iVar8)) &&
             (((param_10 < 1 || ((param_11 < 1 || (param_12 < 1)))) ||
              ((thunk_FUN_004162b0(this,&sStack_6,&sStack_8,&sStack_a), param_7 <= sStack_6 &&
               ((((param_8 <= sStack_8 && (param_9 <= sStack_a)) &&
                 ((int)sStack_6 < (int)param_7 + (int)param_10)) &&
                (((int)sStack_8 < (int)param_8 + (int)param_11 &&
                 ((int)sStack_a < (int)param_9 + (int)param_12)))))))))) {
