...

{
  ...
  local_14[3] = *(uint *)(DAT_00802a38 + 0xe4);
  if ((((DAT_0080874d == param_3) && (*(uint *)((int)this + 0xb5) <= (uint)local_14[3])) &&
      ...
      ) && (((uVar2 = thunk_FUN_0061fa40(this,local_14[3],param_1,param_2), (int)uVar2 < 0 &&
             (uVar2 = thunk_FUN_0061fb70(this,local_14[3],param_1,param_2,param_3), -1 < (int)uVar2)
             ) || (uVar2 == 2)))) {
    if (DAT_0080874e == '\x01') {
      iVar1 = 0x3b;
    }
