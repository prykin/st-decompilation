...
void __thiscall
ProdPanelTy::PaintTab(ProdPanelTy *this,AnonShape_0053FEE0_A49592EB *param_1,undefined *param_2)

{
  ...
  if (param_2 != (undefined *)0x0) {
    ...
    if (piVar4 == (int *)0x0) {
      ...
      iVar7 = 2;
      pCVar6 = thunk_FUN_00571240(s_BUT_MFTABS_007c2374,0);
      ...
      if (param_1->field_0014->field_0004 == 3) {
        iVar8 = 1;
        piVar4 = (int *)0x0;
        pCVar6 = thunk_FUN_00571240(s_BUT_MFFRAMES_007c2384,0);
    ...
    g_currentExceptionFrame = local_58.previous;
    iVar7 = ReportDebugMessage(s_E____titans_Andrey_specpan_cpp_007c7870,0x270,0,(int)piVar4,
                               &DAT_007a4ccc,s_ProdPanelTy__PaintTab_007c7ac8);
    if (iVar7 != 0) {
      STDebugBreak(); /* noreturn in standalone pseudocode */
    }
    RaiseInternalException((int)piVar4,0,s_E____titans_Andrey_specpan_cpp_007c7870,0x270);
  }
  return;
}
