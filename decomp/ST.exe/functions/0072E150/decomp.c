...
float10 __cdecl FUN_0072e150(uint param_1,uint param_2)

{
  ...
  if ((param_2._2_2_ & 0x7ff0) != 0x7ff0) {
    ...
    fVar4 = FUN_00735400(0x10,0xb,param_1,param_2,local_c,uStack_8,uVar2);
    return fVar4;
  }
  ...
  if (0 < iVar3) {
    ...
    if (iVar3 == 3) {
      fVar4 = FUN_00735330(0xb,param_1,param_2);
      return fVar4;
    }
  }
  dVar1 = (double)CONCAT26(param_2._2_2_,CONCAT24((undefined2)param_2,param_1)) + _DAT_0079cd88;
  fVar4 = FUN_00735400(8,0xb,param_1,param_2,SUB84(dVar1,0),(int)((ulonglong)dVar1 >> 0x20),uVar2);
  return fVar4;
}
