...
uint __thiscall
thunk_FUN_00614c80(void *this,undefined4 *param_1,int param_2,int param_3,int param_4,int param_5,
...

{
  ...
  *(undefined4 *)(iVar4 + 0x18 + *(int *)((int)this + 0x2dd)) = uVar1;
  if (*(int *)(iVar4 + 0x18 + *(int *)((int)this + 0x2dd)) == 8) {
    ...
    uStack_14 = 0;
    uStack_c = 0;
    iStack_20 = (int)(param_8 * 0x1e) / 100;
    uStack_8 = 0;
    iStack_1c = (int)(param_8 * 0x46) / 100;
    uStack_18 = param_8;
    param_9 = uVar3;
    iStack_10 = iStack_20;
