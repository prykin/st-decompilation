...

{
  ...
  if (iVar3 != 0) {
    DAT_00858df8 = ppuStack_88;
    cVar18 = *(char *)((int)piStack_18 + 0x1e26);
    if ((((cVar18 == '\r') || (cVar18 == '\x0e')) || (cVar18 == '\x0f')) ||
       (uVar6 = 0x6947, cVar18 == '\x10')) {
      uVar6 = 0x694d;
    }
    *(undefined4 *)((int)piStack_18 + 0x2d) = uVar6;
    (**(code **)*piStack_18)((int)piStack_18 + 0x1d);
    return;
  }
  *(char *)((int)piStack_18 + 0x1e26) = param_1;
  ...
  *(undefined4 *)(*(int *)((int)this_00 + 0x1a5b) + 0x140) = 0x1f;
  FUN_00718780((int)auStack_b18,0,0x100,0x8b,0x15,
  ...
  if ((DAT_008067a0 != '\0') && (DAT_00811764 != 0)) {
    ...
    *(undefined4 *)((int)this_00 + 0x1a82) = uStack_28;
    *(undefined4 *)((int)this_00 + 0x1a86) = uStack_24;
      ...
      do {
        ...
        if (((byte)_Stack_50c.dwFileAttributes & 0x10) == 0) {
          ...
          if (iVar3 == 0) {
            ...
            puVar4 = FUN_006f0ec0(0x345,(byte *)auStack_3cc,0,0,0);
            puStack_1c = puVar4;
            ...
            if (-1 < iVar3) {
              ...
              puVar7 = FUN_006f1ce0(0xc,s_TEXTURE_DSCR_007cd130,(int *)&puStack_10,0);
              if (puVar7 != (ushort *)0x0) {
                FUN_0072e730((byte *)_Stack_50c.cFileName,(byte *)0x0,(byte *)0x0,abStack_718,
                             (byte *)0x0);
                ...
                uStack_510 = uStack_c;
                FUN_006ae1c0(puVar5,(undefined4 *)abStack_718);
                puVar4 = puStack_1c;
              }
            }
            FUN_006f1170(puVar4);
        ...
        BVar9 = FindNextFileA(hFindFile,&_Stack_50c);
      } while (BVar9 != 0);
    }
    if (hFindFile != (HANDLE)0xffffffff) {
      FindClose(hFindFile);
      ...
      do {
        ...
        if (0 < (int)puVar4) {
          do {
            ...
            puVar4 = puStack_1c;
            uVar11 = uVar12;
          } while ((int)uVar12 < (int)puStack_1c);
        }
  ...
  *(undefined4 *)((int)this_00 + 0x1d95) = 0;
  ...
  do {
    ...
    uVar11 = FUN_006b50c0(0x1e5,0x14,(uint)*(ushort *)(*(int *)((int)this_00 + 0x5d) + 0xe),uVar11,
                          puVar4,iVar3);
    *puVar5 = uVar11;
    pvStack_14 = *(HANDLE *)(uVar11 + 0x14);
    if (pvStack_14 == (HANDLE)0x0) {
      pvStack_14 = (HANDLE)(((uint)*(ushort *)(uVar11 + 0xe) * *(int *)(uVar11 + 4) + 0x1f >> 3 &
                            0x1ffffffc) * *(int *)(uVar11 + 8));
    }
    puVar4 = (undefined4 *)FUN_006b4fa0(uVar11);
    for (uVar11 = (uint)pvStack_14 >> 2; uVar11 != 0; uVar11 = uVar11 - 1) {
      *puVar4 = 0xffffffff;
      puVar4 = puVar4 + 1;
    }
    for (uVar11 = (uint)pvStack_14 & 3; uVar11 != 0; uVar11 = uVar11 - 1) {
      *(undefined1 *)puVar4 = 0xff;
      puVar4 = (undefined4 *)((int)puVar4 + 1);
    }
    uVar11 = *puVar5;
    FUN_006b2330((uint)DAT_008075a8,puVar5 + -10,0x31,0x40407f,*(uint *)(uVar11 + 4),
                 *(uint *)(uVar11 + 8),uVar11);
    FUN_006b3640(DAT_008075a8,puVar5[-10],0xffffffff,0x113,uStack_c);
    puVar5 = puVar5 + 1;
  ...
  *(int *)((int)this_00 + 0x1e1e) = iVar3;
  ...
  if (*(char *)((int)this_00 + 0x21e5) == '\0') {
    ...
    FUN_006b2330((uint)DAT_008075a8,&uStack_8,0x32,0x403099,0x205,0x8c,
                 *(int *)((int)this_00 + 0x1a5b) + 0x140);
    FUN_006b3640(DAT_008075a8,uStack_8,0xffffffff,0x112,0x149);
    puVar10 = (undefined1 *)FUN_0072e530(0x33);
    if (puVar10 == (undefined1 *)0x0) {
      puVar10 = (undefined1 *)0x0;
    }
  ...
  *(undefined1 *)((int)puVar4 + 2) = 0;
  ...
  if (*(int *)(*(int *)((int)this_00 + 0x1a5b) + 0x2e6) != 0) {
    ...
    *(int *)(*(int *)(*(int *)((int)this_00 + 0x1a5b) + 0x2e6) + 0x1cab) = this_00[2];
    thunk_FUN_005b87d0(*(void **)(*(int *)((int)this_00 + 0x1a5b) + 0x2e6),0,(int)&uStack_2c8,0,0);
    thunk_FUN_005b9010(*(void **)(*(int *)((int)this_00 + 0x1a5b) + 0x2e6),(int)auStack_44);
  }
