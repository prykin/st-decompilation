...
uint thunk_FUN_006364b0(int param_1)

{
  ...
  uStack_8 = 0xffffffff;
  if (param_1 == 0) {
    puVar1 = FUN_00709af0(DAT_00806764,0x1d,(byte *)s_blast_p_007d1c14,0xffffffff,0,0,0,
                          (undefined4 *)0x0);
    ...
    if ((puVar1 != (ushort *)0x0) && (DAT_00807598 != (void *)0x0)) {
      ...
      FUN_006ea8a0(DAT_00807598,uStack_8,0,2,DAT_008032b8);
      return uStack_8;
    }
  }
  return uStack_8;
