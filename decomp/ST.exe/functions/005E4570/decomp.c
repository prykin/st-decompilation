    ...
    if (SVar2 < MESS_PLAYPANELTY_6201) {
      ...
      case MESS_SHARED_0064:
        ...
        if (local_18->field_006D != '\x01') {
          ...
          iVar23 = 0x1f;
          do {
            thunk_FUN_00568bc0(&g_sound,iVar20);
            iVar20 = iVar20 + 1;
            iVar23 = iVar23 + -1;
          } while (iVar23 != 0);
          break;
...
LAB_005e496b:
  ...
  if (SVar2 < MESS_WAITTY_6335) {
    if (SVar2 == MESS_SHARED_6334) {
      ...
      if (SVar2 == MESS_MTASKTY_6217) {
        ...
        puVar10 = (undefined4 *)FUN_006b4fa0((int *)pRVar3);
  ...
  case MESS_SHARED_6334|MESS_ID_CREATE:
    if (((-1 < (int)local_18->field_0484) && (message != nullptr)) &&
      ...
      puVar12 = (undefined4 *)FUN_006b4fa0((int *)pRVar3);
      puVar10 = local_24;
      for (uVar16 = (uint)local_14 >> 2; uVar16 != 0; uVar16 = uVar16 - 1) {
        *puVar12 = 0xffffffff;
        puVar12 = puVar12 + 1;
...
LAB_005e5255:
    Library::DKW::DDX::FUN_006b3730(puVar17,uVar16,uVar21,uVar24,uVar13);
  }
