...
void thunk_FUN_005bd7a0(undefined1 param_1)

{
  ...
  DAT_0080877e = 1;
  DAT_0080877f = 0;
  *(undefined1 *)((int)pvStack_18 + 0x66) = param_1;
  if (DAT_0080874e == '\x01') {
    puVar4 = &DAT_007ca250;
  }
  else {
  ...
  *(int *)((int)pvVar13 + 0x5d) = iVar3;
  FUN_006bc360(iVar3,auStack_6a4,(int *)0x0);
  ...
  *(int *)((int)pvVar13 + 0x73) = iVar3;
  ...
  FUN_00718780((int)auStack_6a4,0,0x100,0x1a,0x10,(undefined4 *)((int)pvVar13 + 0xa3));
  FUN_00718780((int)auStack_6a4,0,0x100,0x2e,0x10,(undefined4 *)((int)pvVar13 + 0x1a3));
  ...
  *(undefined4 *)((int)pvVar13 + 0x30b) = *(undefined4 *)(iVar3 + 0x8a);
  if (*(char *)((int)pvVar13 + 0x66) == '\x01') {
    ...
    iVar3 = __setjmp3(auStack_9c,0,puVar7,pcVar16);
    if (iVar3 == 0) {
      puStack_14 = FUN_006f0ec0(0x345,(byte *)&DAT_0080f33a,0,0,0);
    }
    DAT_00858df8 = ppuStack_a0;
    if (puStack_14 != (undefined4 *)0x0) {
      puVar7 = (undefined4 *)auStack_2a4;
      ...
      *(undefined1 *)puVar7 = 0;
      ...
      piStack_c = (int *)(auStack_2a4 + 1);
      FUN_006f12b0(FUN_006f2d10,auStack_2a4);
      puVar7 = puStack_14;
      ...
      while (pcVar16 != (char *)0x0) {
        ...
        if (((iVar3 == 2) && (uStack_10 != 0)) && (uStack_10 < 4)) {
          FUN_006ae1c0(*(uint **)((int)pvStack_18 + uStack_10 * 4 + 0x343),&piStack_c);
        }
        pcVar16 = (char *)FUN_006f2790();
      }
      FUN_006f1170(puVar7);
    ...
    do {
      piStack_c = (int *)((int)pvStack_18 + 0x347);
      uStack_8 = 0;
      uStack_10 = 3;
      do {
        uVar8 = 0;
        if (*(int *)(*piStack_c + 0xc) != 1 && -1 < *(int *)(*piStack_c + 0xc) + -1) {
          do {
            iVar3 = *piStack_c;
            ...
            uVar8 = uVar10;
          } while ((int)uVar10 < *(int *)(*piStack_c + 0xc) + -1);
        }
    ...
    iVar3 = 2;
    piVar12 = (int *)((int)pvStack_18 + 0x34f);
    do {
      if (*(int *)(*piVar12 + 0xc) != 0) {
        *(char *)((int)pvStack_18 + 0x6a) = (char)iVar3;
      }
      iVar3 = iVar3 + -1;
      piVar12 = piVar12 + -1;
    } while (-1 < iVar3);
  ...
  *(undefined1 **)((int)pvVar13 + 0x453) = puVar4;
  ...
  FUN_006b2330((uint)DAT_008075a8,&uStack_8,0x32,0x401217,0x2e9,0x32,(uint)pvVar13);
