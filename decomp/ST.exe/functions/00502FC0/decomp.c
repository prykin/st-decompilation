  ...
  if (STPiece<5,1>(local_68) == this_00->field_0B9E) {
    ...
    case CASE_1:
      if ((STPiece<0,4>(local_68) == this_00->field_0B99) && (STPiece<4,1>(local_68) == this_00->field_0B9D)) {
        ...
        sub_00501D00(this_00,(RecoveredRecordView_00501D00_08D99E75 *)&this_00->field_0B99,&local_68
                    );
        ...
        case CASE_24:
          ...
          if ((cVar2 != -1) && (local_8 = (uint)STPiece<1,3>(local_8) << 8, cVar2 != '\0')) {
            do {
              ...
              pBVar5 = FUN_0070b3a0((RecoveredGlobalRecordView_0081175C *)this_00->field_02B6,1);
              /* ST_CALLSITE[005031D7]: CALL 0x00403229; direct=00403229 DibPut */
              DibPut(this_00->field_018C,(local_8 & 0xff) * 4 + 0x3f,0x87,'\x01',
          ...
          if ((byte)local_8 < 0x14) {
            ...
            do {
              ...
              pBVar5 = FUN_0070b3a0((RecoveredGlobalRecordView_0081175C *)this_00->field_02B6,0);
              /* ST_CALLSITE[0050322B]: CALL 0x00403229; direct=00403229 DibPut */
              DibPut(this_00->field_018C,iVar6,0x87,'\x01',
                     (RecoveredRecordView_006B84D0_87AF9D9B *)pBVar5);
              iVar6 = iVar6 + 4;
              iVar9 = iVar9 + -1;
            } while (iVar9 != 0);
...
switchD_005030a2_caseD_1a:
  ...
  if ((this_00->field_0BB6 & 0xfe) != 0) {
    do {
      ...
      pBVar5 = FUN_0070b3a0((RecoveredGlobalRecordView_0081175C *)this_00->field_02B6,3);
  ...
  if ((byte)local_8 < 0x14) {
    ...
    do {
      ...
      DibPut(this_00->field_018C,iVar6,0x87,'\x01',(RecoveredRecordView_006B84D0_87AF9D9B *)pBVar5);
      iVar6 = iVar6 + 4;
      iVar9 = iVar9 + -1;
    } while (iVar9 != 0);
  }
