...
/* [STSourceProvenanceApplier begin]
   ...
   Diagnostic line evidence: 78 | 80 (metadata/report site, not the function definition)
   [STSourceProvenanceApplier end] */

int __cdecl mfImgGetWidth(cMf32 *param_1,byte param_2,char *param_3,int param_4)

{
  ...
  if (iVar2 == 0) {
    puVar3 = cMf32::RecGetParam(param_1,param_2,param_3,(undefined4 *)local_10,param_4);
