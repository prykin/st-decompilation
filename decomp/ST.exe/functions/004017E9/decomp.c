...

{
  ...
  void *unaff_EDI;
  int *piVar7;
  InternalExceptionFrame IStack_1d0;
  int aiStack_18c [4];
  int iStack_17c;
  ...
  pCStack_10 = this;
  iVar4 = Library::MSVCRT::__setjmp3(IStack_1d0.jumpBuffer,0,unaff_EDI,unaff_ESI);
  pCVar3 = pCStack_10;
  if (iVar4 == 0) {
    piVar7 = aiStack_18c;
    ...
    if (param_7 != 0) {
      ...
      puStack_8 = cMf32::RecGet(DAT_00806790,param_6,(char *)(pCVar3 + 0x1e1),(int *)0x0,1);
    }
    if (param_6 == 1) {
    ...
    g_currentExceptionFrame = IStack_1d0.previous;
    return uStack_c;
  }
  g_currentExceptionFrame = IStack_1d0.previous;
