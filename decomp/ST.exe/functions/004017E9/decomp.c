...
undefined4
thunk_FUN_004f3130(byte param_1,undefined4 param_2,int param_3,int param_4,int param_5,byte param_6,
                  int param_7,undefined4 param_8,undefined4 param_9,short param_10,
                  undefined2 param_11,int param_12,char *param_13,int param_14,undefined4 param_15,
                  undefined4 param_16)

{
  ...
  if (iVar3 == 0) {
    ...
    if (param_7 != 0) {
      wsprintfA((LPSTR)(iStack_10 + 0x1e1),&DAT_007c181c,param_7);
      puStack_8 = FUN_006f1ce0(param_6,(LPSTR)(iStack_10 + 0x1e1),(int *)0x0,1);
    }
    if (param_6 == 1) {
    ...
    if (param_4 < 0) {
      param_4 = (*(int *)(iStack_10 + 0x68 + (uint)param_1 * 4) - iStack_17c) / 2;
    }
    uVar2 = (uint)param_1;
    aiStack_18c[2] = *(int *)(iStack_10 + 0x3c + uVar2 * 4) + param_4;
    iVar3 = *(int *)(iStack_10 + 0x130);
    switch(uVar2) {
    case 0:
    case 1:
    case 2:
    case 3:
      iVar3 = *(int *)(iStack_10 + 0x134);
      break;
    case 5:
    case 6:
    case 7:
    case 8:
      iVar3 = *(int *)(iStack_10 + 0x138);
    }
    if (iVar3 == 0) {
      if ((param_1 == 1) || (param_1 == 7)) {
        aiStack_18c[3] = *(int *)(iStack_10 + 0xc0);
      }
      else {
        aiStack_18c[3] = 0;
      }
    ...
    (**(code **)(**(int **)(iStack_10 + 0xc) + 8))(2,&uStack_c,0,aiStack_18c,0);
    DAT_00858df8 = puStack_1d0;
    return uStack_c;
  }
  DAT_00858df8 = puStack_1d0;
