...
void FUN_006c7570(AnonShape_006C7570_82D7EB54 *param_1,int param_2,int param_3,int param_4,
...

{
  ...
  FUN_006b5ee0((int)param_1,param_2,param_3,param_4,(int)param_5,param_6,param_8,0xd);
  return;
}
