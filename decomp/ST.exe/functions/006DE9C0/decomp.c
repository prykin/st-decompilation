...

{
  ...
  if (*(int *)&param_1->field_0x124 == 1) {
    ...
    local_a0 = (*(int *)&param_1->field_0x30 + *(int *)&param_1->field_0x374) / local_c0;
    if (local_a0 < 0) {
      local_a0 = 0;
    }
    local_f8 = (int)**(short **)&param_1->field_0x280;
    if (local_f8 <= local_a0) {
      local_a0 = local_f8 + -1;
    }
    local_c4 = (*(int *)&param_1->field_0x38 + *(int *)&param_1->field_0x374) / local_c0;
    if (local_c4 < 0) {
      local_c4 = 0;
    }
    ...
    local_9c = (*(int *)&param_1->field_0x34 + *(int *)&param_1->field_0x378) / local_c0;
    if (local_9c < 0) {
      local_9c = 0;
    }
    iVar11 = (int)*(short *)(*(int *)&param_1->field_0x280 + 2);
    if (iVar11 <= local_9c) {
      local_9c = iVar11 + -1;
    }
    local_c0 = (*(int *)&param_1->field_0x3c + *(int *)&param_1->field_0x378) / local_c0;
    if (local_c0 < 0) {
      local_c0 = 0;
    }
    ...
    ExceptionList = &local_14;
    sub_006E1C20(param_1,*(float *)&param_1->field_0x30,*(int *)&param_1->field_0x34,
                 -(float)*(double *)&param_1->field_0xd0,&local_20,&local_28);
    lVar12 = Library::MSVCRT::__ftol();
    iVar5 = (int)lVar12;
    if (iVar5 < 0) {
      iVar5 = 0;
    }
    psVar2 = *(short **)&param_1->field_0x280;
    iVar11 = (int)*psVar2;
    if (iVar11 <= iVar5) {
      iVar5 = iVar11 + -1;
    }
    ...
    sub_006E1C20(param_1,*(float *)&param_1->field_0x30,*(int *)&param_1->field_0x3c + -1,
                 -(float)*(double *)&param_1->field_0xd0,&local_20,&local_28);
    lVar12 = Library::MSVCRT::__ftol();
    iVar5 = (int)lVar12;
    if (iVar5 < 0) {
    ...
    sub_006E1C20(param_1,(float)(*(int *)&param_1->field_0x38 + -1),
                 *(int *)&param_1->field_0x3c + -1,-(float)*(double *)&param_1->field_0xd0,&local_20
                 ,&local_28);
    lVar12 = Library::MSVCRT::__ftol();
    iVar5 = (int)lVar12;
    if (iVar5 < 0) {
    ...
    sub_006E1C20(param_1,(float)(*(int *)&param_1->field_0x38 + -1),*(int *)&param_1->field_0x34,
                 -(float)*(double *)&param_1->field_0xd0,&local_20,&local_28);
    lVar12 = Library::MSVCRT::__ftol();
    iVar5 = (int)lVar12;
    if (iVar5 < 0) {
    ...
    fVar1 = (float)((float10)*(double *)&param_1->field_0xd0 * (float10)_DAT_0079df90);
    sub_006E1C20(param_1,*(float *)&param_1->field_0x30,*(int *)&param_1->field_0x34,fVar1,&local_20
                 ,&local_28);
    lVar12 = Library::MSVCRT::__ftol();
    iVar5 = (int)lVar12;
    if (iVar5 < 0) {
    ...
    sub_006E1C20(param_1,*(float *)&param_1->field_0x30,*(int *)&param_1->field_0x3c + -1,fVar1,
                 &local_20,&local_28);
    lVar12 = Library::MSVCRT::__ftol();
    iVar5 = (int)lVar12;
    if (iVar5 < 0) {
    ...
    sub_006E1C20(param_1,(float)(*(int *)&param_1->field_0x38 + -1),
                 *(int *)&param_1->field_0x3c + -1,fVar1,&local_20,&local_28);
    lVar12 = Library::MSVCRT::__ftol();
    iVar5 = (int)lVar12;
    if (iVar5 < 0) {
      iVar5 = 0;
...
LAB_006defd4:
  ...
  *(undefined4 *)&param_1->field_0x13c = 0;
  ...
  do {
    ...
    for (local_5c = local_9c; local_a0 = iVar11, local_5c <= iVar6; local_5c = local_5c + 1) {
      if (iVar11 <= iVar5) {
        piVar9 = (int *)(local_4c +
                        ((**(short **)&param_1->field_0x280 * local_5c) / 2 + iVar11) * 4);
        do {
          if ((*piVar9 != 0) && (iVar7 = FUN_006de570(param_1,iVar11,local_5c), iVar7 != 0)) {
            puVar10 = (undefined4 *)*piVar9;
            *puVar10 = *(undefined4 *)&param_1->field_0x140;
            *(undefined4 **)&param_1->field_0x140 = puVar10;
            *(int *)&param_1->field_0x13c = *(int *)&param_1->field_0x13c + 1;
          }
          iVar11 = iVar11 + 1;
          piVar9 = piVar9 + 1;
        } while (iVar11 <= iVar5);
  ...
  for (; iVar7 = local_9c, local_5c <= iVar6; local_5c = local_5c + 1) {
    local_a0 = iVar11;
    if (iVar11 <= iVar5) {
      iVar7 = ((**(short **)&param_1->field_0x280 * local_5c) / 2 + iVar11) * 4;
      do {
        iVar8 = *(int *)(iVar7 + 0x459 + *(int *)&param_1->field_0x280);
        if (((iVar8 != 0) && (*(int *)(iVar8 + 0x24) < 3)) &&
           (iVar8 = FUN_006de570(param_1,iVar11,local_5c), iVar8 != 0)) {
          puVar10 = *(undefined4 **)(iVar7 + 0x459 + *(int *)&param_1->field_0x280);
          *puVar10 = *(undefined4 *)&param_1->field_0x140;
          *(undefined4 **)&param_1->field_0x140 = puVar10;
          *(int *)&param_1->field_0x13c = *(int *)&param_1->field_0x13c + 1;
        }
  ...
  local_50 = *(undefined4 *)&param_1->field_0x140;
  uVar3 = *(undefined4 *)&param_1->field_0x13c;
  if ((*(int *)&param_1->field_0x124 != 10) && (*(int *)&param_1->field_0x124 != 1)) {
    if (local_9c == 0) {
      for (; iVar11 <= iVar5; iVar11 = iVar11 + 1) {
        ...
        if (iVar7 != 0) {
          ...
          *(undefined1 **)&param_1->field_0x140 = &stack0xfffffee8;
          *(int *)&param_1->field_0x13c = *(int *)&param_1->field_0x13c + 1;
        }
      ...
      iVar11 = (int)**(short **)&param_1->field_0x280 / 2;
      if (iVar11 + -1 <= iVar5) {
        iVar7 = FUN_006de570(param_1,iVar11,-1);
        if (iVar7 != 0) {
          local_8 = 6;
    ...
    iVar7 = (int)*(short *)(*(int *)&param_1->field_0x280 + 2) / 2;
    iVar11 = local_a0;
    if (iVar7 + -1 <= iVar6) {
    ...
    iVar7 = (int)**(short **)&param_1->field_0x280 / 2;
    iVar11 = local_9c;
    if (iVar7 + -1 <= iVar5) {
      for (; iVar11 <= iVar6; iVar11 = iVar11 + 1) {
  ...
  *(undefined4 *)&param_1->field_0x140 = local_50;
  *(undefined4 *)&param_1->field_0x13c = uVar3;
  local_38 = *(int *)&param_1->field_0x30;
  local_34 = *(int *)&param_1->field_0x34;
  local_30 = *(int *)&param_1->field_0x38 - local_38;
  local_2c = *(int *)&param_1->field_0x3c - local_34;
  local_24 = 0;
  if (0 < *(int *)&param_1->field_0x28c) {
    ...
    do {
      ...
      if (pbVar4 != (byte *)0x0) {
        ...
        local_90 = puVar10[1];
        local_8c = puVar10[2];
        sub_006E25D0(param_1,&local_48);
        if (*(int *)&param_1->field_0x2f0 == 100) {
          ...
          local_a4 = (local_ac * *(int *)&param_1->field_0x2f0) / 100;
          iVar5 = (local_88 * *(int *)&param_1->field_0x2f4) / 100;
          /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
          iVar11 = (int)((ulonglong)
                         ((longlong)((int)*(short *)(puVar10 + 5) * *(int *)&param_1->field_0x2f0) *
                         -0x51eb851f) >> 0x20);
          local_54 = (local_48 >> 0x10) + ((iVar11 >> 5) - (iVar11 >> 0x1f));
          /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
          iVar11 = (int)((ulonglong)
                         ((longlong)
                          ((int)*(short *)((int)puVar10 + 0x16) * *(int *)&param_1->field_0x2f4) *
                         -0x51eb851f) >> 0x20);
        ...
        if (iVar5 != 0) {
          SubmarineTitans::Recovered::HiddenThis::AnonReceiver_00702510::FUN_00708d10
                    ((AnonReceiver_00702510 *)param_1,*(int *)&param_1->field_0xc,
                     param_1->field_0028,pbVar4,local_54,local_5c,local_40,puVar10[4],1);
        }
      }
      local_24 = local_24 + 1;
      puVar10 = puVar10 + 0xb;
  ...
  for (puVar10 = *(undefined4 **)&param_1->field_0x294; puVar10 != (undefined4 *)0x0;
    ...
    if (pbVar4 != (byte *)0x0) {
      ...
      if (*(int *)&param_1->field_0x2f0 == 100) {
        ...
        /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
        iVar11 = (int)((ulonglong)
                       ((longlong)((int)*(short *)(puVar10 + 7) * *(int *)&param_1->field_0x2f0) *
                       -0x51eb851f) >> 0x20);
        local_54 = (local_48 >> 0x10) + ((iVar11 >> 5) - (iVar11 >> 0x1f));
        /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
        iVar11 = (int)((ulonglong)
                       ((longlong)
                        ((int)*(short *)((int)puVar10 + 0x1e) * *(int *)&param_1->field_0x2f4) *
                       -0x51eb851f) >> 0x20);
        local_5c = (local_44 >> 0x10) + ((iVar11 >> 5) - (iVar11 >> 0x1f));
        local_b4 = (local_ac / 2 + *(short *)(pbVar4 + 0xe) * local_a4) / local_ac + local_54;
        local_b0 = (local_88 / 2 + *(short *)(pbVar4 + 0x10) * iVar5) / local_88 + local_5c;
      ...
      if (iVar5 != 0) {
        SubmarineTitans::Recovered::HiddenThis::AnonReceiver_00702510::FUN_00708d10
                  ((AnonReceiver_00702510 *)param_1,*(int *)&param_1->field_0xc,param_1->field_0028,
                   pbVar4,local_54,local_5c,puVar10[6] + local_40,0,1);
      }
    }
  }
  local_24 = 0;
  if (0 < *(int *)&param_1->field_0x28c) {
    ...
    do {
      ...
      if (iVar5 != 0) {
        SubmarineTitans::Recovered::HiddenThis::AnonReceiver_00702510::FUN_00708d10
                  ((AnonReceiver_00702510 *)param_1,*(int *)&param_1->field_0xc,param_1->field_0028,
                   pbVar4,local_54,local_5c,local_40,puVar10[4],0);
      }
      local_24 = local_24 + 1;
      puVar10 = puVar10 + 0xb;
    } while (local_24 < *(int *)&param_1->field_0x28c);
  ...
  for (puVar10 = *(undefined4 **)&param_1->field_0x294; puVar10 != (undefined4 *)0x0;
    ...
    if (iVar5 != 0) {
      SubmarineTitans::Recovered::HiddenThis::AnonReceiver_00702510::FUN_00708d10
                ((AnonReceiver_00702510 *)param_1,*(int *)&param_1->field_0xc,param_1->field_0028,
                 pbVar4,local_54,local_5c,puVar10[6] + local_40,0,0);
    }
  }
  /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
  if (((((*(int *)&param_1->field_0x124 != 10) && (*(int *)&param_1->field_0x124 != 1)) &&
       (*(int *)&param_1->field_0x298 != 0)) &&
      ((*(int *)&param_1->field_0x4 != 0 &&
       ((*(uint *)(*(int *)&param_1->field_0x4 + 0xc) & 0x1100) != 0x100)))) &&
     ((*(int *)&param_1->field_0x2dc == 0 || (param_1->field_02D8 != 0)))) {
    iVar5 = *(int *)&param_1->field_0x30;
    iVar11 = *(int *)&param_1->field_0x38;
    iVar7 = param_1->field_0028 * *(int *)&param_1->field_0x34 + *(int *)&param_1->field_0xc + iVar5
    ;
    iVar6 = *(int *)&param_1->field_0x3c - *(int *)&param_1->field_0x34;
    while (iVar6 != 0) {
      for (iVar8 = 0; iVar8 < iVar11 - iVar5; iVar8 = iVar8 + 1) {
        *(undefined1 *)(iVar8 + iVar7) =
             *(undefined1 *)(*(int *)&param_1->field_0x298 + (uint)*(byte *)(iVar8 + iVar7));
      }
