...

{
  ...
  if (*(int *)((int)&DAT_007f5023 + iVar4) == 0) {
    if (*(uint *)((int)&DAT_007f4f87 + iVar4) == uVar5) {
      if (*(int *)((int)&DAT_007f4f83 + iVar4) == 0x3c) {
        puStack_10 = (uint *)thunk_FUN_0042d770(CONCAT31((int3)((uint)unaff_EBX >> 8),DAT_0080874d),
                                                (int *)&pbStack_8);
        iStack_c = 0;
        if ((short)puStack_10 == 0x7fff) {
          uVar5 = *(int *)(pbStack_8 + 0xc) * *(int *)(pbStack_8 + 8);
          if (puVar3 != (uint *)0x0) {
            *puVar3 = uVar5;
          }
          if (param_1 != (undefined4 *)0x0) {
        ...
        iStack_c = 2;
        puStack_10 = (uint *)(uint)(ushort)(&DAT_007f4f8b)[uVar5 * 0x531];
      }
    }
  }
  ...
  return iStack_c << 0x10 | (uint)puStack_10 & 0xffff;
}
