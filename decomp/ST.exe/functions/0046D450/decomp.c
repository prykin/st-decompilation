      ...
      if (iVar5 == 4) {
        ...
        if (*(int *)(this + 0x550) == 3) {
          ...
          if (this[0x2bf] != (STBoatC)0x0) {
            ...
            do {
              puVar9 = (undefined4 *)
                       thunk_FUN_0041dc40(local_28,*(undefined4 *)local_8,
                                          *(undefined2 *)(local_8 + 4),*(short *)(this + 0x6c));
              local_20 = *puVar9;
              ...
              if (DAT_0080732c == 1) {
                ...
                *(uint *)(this + 0x1c) = uVar8;
                ...
                sVar20 = 0;
                sVar19 = 0;
                iVar5 = (uVar10 >> 0x10) % 7 + (int)*(short *)(this + 0x45) + -3 + (int)local_1c;
                local_20._2_2_ = (short)((uint)local_20 >> 0x10);
                iVar14 = ((uVar12 >> 0x10) % 7 + (int)*(short *)(this + 0x43)) - (int)local_20._2_2_
                ;
              }
              TraksClassTy::TraksCreate
                        (DAT_00802a7c,1,2,7,
                         (uVar8 >> 0x10) % 7 + (int)*(short *)(this + 0x41) + -3 +
                         (int)(short)local_20,iVar14 + -3,iVar5,sVar19,sVar20,sVar21,sVar22,sVar23,
                ...
                if (this[0x2bf] != (STBoatC)0x0) {
                  ...
                  do {
                    ...
                    if (DAT_0080732c == 1) {
                      ...
                      *(uint *)(this + 0x1c) = local_18;
                      ...
                      iVar5 = (int)(short)lVar18 + (uVar8 >> 0x10) % 7 +
                              (int)*(short *)(this + 0x45) + -3 + (int)local_1c;
                    ...
                    TraksClassTy::TraksCreate
                              (DAT_00802a7c,1,2,7,
                               (uVar8 >> 0x10) % 7 + (int)*(short *)(this + 0x41) + -3 +
                               (int)(short)local_20,iVar14 + -3,iVar5,sVar19,sVar20,sVar21,sVar22,
