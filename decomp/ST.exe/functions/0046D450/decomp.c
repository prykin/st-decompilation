...

{
  ...
  if ((param_1 == 0) || (param_1 == 1)) {
    ...
    this->field_02C4 = 0;
    if (*(int *)&this->field_0x7da + *(int *)&this->field_0x7d6 + *(int *)&this->field_0x7d2 == 0) {
      return 0;
    }
...
switchD_0046d492_caseD_2:
    ...
    if (SVar1 != CASE_3) {
      ...
      if (SVar1 != CASE_5) {
        ...
        if (iVar7 != 3) goto switchD_0046d492_caseD_2;
      ...
      if (iVar7 % 10 != 1) goto switchD_0046d492_caseD_2;
      sVar21 = *(short *)&this->field_0x52c;
      sVar22 = *(short *)&this->field_0x530;
      sVar23 = *(short *)&this->field_0x52e;
      if (((((-1 < sVar21) && (sVar21 < DAT_007fb240)) && (-1 < sVar23)) &&
...
LAB_0046e2c8:
        ...
        if (iVar7 < 1) {
          ...
          if (iVar7 < 1) {
            ...
            if (0 < iVar7) {
              ...
              *(int *)&this->field_0x7da = *(int *)&this->field_0x7da - iVar16;
            }
          }
          else {
            if (iVar7 < 1) {
            ...
            thunk_FUN_004e16d0(pvVar2,this->field_0018);
            *(int *)&this->field_0x7d6 = *(int *)&this->field_0x7d6 - iVar16;
          }
        }
        else {
          if (iVar7 < 1) {
        ...
        if (*(int *)&this->field_0x7da + *(int *)&this->field_0x7d6 + *(int *)&this->field_0x7d2 !=
