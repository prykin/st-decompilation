  ...
  if (param_3 == 0) {
    ...
    for (iVar8 = param_1; iVar8 <= param_2; iVar8 = iVar8 + 1) {
      ...
      if ((iVar8 < param_2) &&
        ...
        iVar5 = thunk_FUN_004248d0(this,iVar3,iVar5,iVar7,DAT_007f4d80 + iVar8,CASE_1,~CASE_0);
      }
...
LAB_004278f1:
    ...
    for (iVar8 = param_1; iVar8 <= param_2; iVar8 = iVar8 + 1) {
      ...
      if (iVar1 < iVar7) {
        iVar5 = thunk_FUN_004248d0(this,iVar3,iVar5,iVar1 + DAT_007f4d7c,DAT_007f4d80 + iVar8,CASE_0
                                   ,~CASE_0);
      }
      if ((iVar8 < param_2) &&
...
LAB_00427930:
  iVar6 = thunk_FUN_004248d0(this,iVar3,param_3,iVar6 + DAT_007f4d7c,DAT_007f4d80 + param_1,CASE_2,
                             ~CASE_0);
