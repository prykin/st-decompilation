...
void FUN_005b5690(int param_1,uint param_2,int param_3,int param_4,int param_5)

{
  ...
  case 1:
  case 3:
    pvVar5 = (void *)((param_2 & 0xff) * 0x1fb + (int)local_8);
...
switchD_005b56d4_default:
  ...
  uVar7 = *(uint *)((int)local_8 + (param_2 & 0xff) * 0x1fb + 0xe7);
  if (uVar7 != 0xffffffff) {
    FUN_006b3730(*(uint **)((int)local_8 + iVar4 + 299),uVar7,*(uint *)((int)local_8 + iVar4 + 0xeb)
