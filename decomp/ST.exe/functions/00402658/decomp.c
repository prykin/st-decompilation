      ...
      if ((*(int *)(this + 0x74a) <= (int)*(short *)(DAT_00806724 + 0x23) / 2) &&
        ...
        do {
          ...
          if (DAT_0080732c == 1) {
            ...
            iVar7 = (int)sStack_20 + *(short *)(this + 0x45) + iStack_c + (int)(short)lVar10;
            iVar8 = (int)*(short *)(this + 0x43) - (int)uStack_24._2_2_;
            iVar9 = (int)(short)uStack_24 + iVar4 + *(short *)(this + 0x41);
          }
          else {
            iVar7 = (int)sStack_20 + iStack_c + *(short *)(this + 0x45);
