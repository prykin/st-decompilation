...

{
  ...
  this_00 = pSStack_c;
  if (errorCode == 0) {
    uVar2 = GetObjPtr(pSStack_c,0xffffffff,param_1,5);
    uVar4 = extraout_ECX;
    if (uVar2 != param_2) {
      RaiseInternalException
                (-0x5001fff9,DAT_007ed77c,s_E____titans_wlad_to_allpl_cpp_007a6004,0x2f85);
    ...
    Library::DKW::TBL::FUN_006ae140(DAT_007fa160,param_1 & 0xffff,&uStack_8);
