...
void thunk_FUN_004353b0(uint param_1,uint param_2,uint param_3)

{
  ...
  if (((*(int *)((int)&DAT_007f5023 + iVar2) == 1) &&
    ...
    if (param_1._2_2_ == (short)param_2) {
      piVar3 = (int *)STAllPlayersC::GetObjPtr(in_ECX,uVar1,param_2,1);
      piVar4 = (int *)0x0;
      (**(code **)(*piVar3 + 0xe8))();
      Library::DKW::TBL::FUN_006ae140
                (*(uint **)((int)&DAT_007f4fdd + (uint)DAT_0080874d * 0xa62),0,&param_3);
      this = (STGameObjC *)STAllPlayersC::GetObjPtr(in_ECX,uVar1,param_3,1);
