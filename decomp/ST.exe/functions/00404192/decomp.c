...
void __thiscall thunk_FUN_0041d3e0(void *this,int param_1)

{
  ...
  *(int *)((int)this + 0x111) = param_1;
  if (DAT_00802a88 != (void *)0x0) {
    thunk_FUN_00559ec0(DAT_00802a88,(int)*(short *)((int)this + 0x5b),
  ...
  if ((iVar1 == 1) && (*(uint *)((int)this + 0x24) == (uint)DAT_0080874d)) {
    FUN_006e6710(DAT_00807598,
                 ...
                 (float)*(int *)((int)this + 0x109) * _DAT_007904f8 + _DAT_007904f4,0x22,
