...

{
  ...
  FUN_006afe40((int *)&local_10,local_18);
  FUN_006afe40((int *)&local_c,param_4);
  uVar7 = 0;
  if (0 < (int)uVar5) {
    do {
      ...
      if ((local_8 != -1) && (uVar6 = 0, 0 < (int)local_14)) {
        do {
          ...
          if (local_8 == local_6) {
            if (param_6 != (int *)0x0) {
              FUN_006ae1c0((uint *)*param_6,(undefined4 *)&local_6);
            }
  ...
  if (param_5 != (int *)0x0) {
    FUN_006afe40(param_5,local_10);
  }
  if (param_7 != (int *)0x0) {
    FUN_006afe40(param_7,local_c);
  }
