...
undefined4 thunk_FUN_0056fa60(int param_1)

{
  ...
  pppuStack_a4 = DAT_00858df8;
  DAT_00858df8 = &pppuStack_a4;
  ...
  FUN_006e5150(piStack_18,param_1);
  pvVar6 = DAT_00802a30;
...
switchD_0056fad2_caseD_6105:
      ...
      *(undefined1 *)((int)DAT_00802a30 + 0x493) = 0;
      ...
      aiStack_44[5] = *(undefined4 *)(param_1 + 0x14);
      aiStack_44[3] = 0;
      aiStack_44[4] = *(undefined4 *)(param_1 + 0x10);
      aiStack_44[2] = 0x200;
      aiStack_44[6] = uVar12;
      FUN_006e3db0((int)aiStack_44);
      DAT_00858df8 = pppuStack_a4;
      return 0;
    }
    switch(uVar23) {
...
switchD_0056fad2_caseD_6102:
      ...
      *(undefined1 *)((int)DAT_00802a30 + 0x493) = 0;
      ...
      aiStack_44[3] = 0;
      aiStack_44[4] = *(int *)(param_1 + 0x10);
      aiStack_44[2] = 0x200;
      if (aiStack_44[4] != 0x6103) {
        if (aiStack_44[4] == 0x6104) {
          aiStack_44[6] = *(undefined4 *)(param_1 + 0x18);
        }
        else if (aiStack_44[4] != 0x610a) {
          FUN_006e3db0((int)aiStack_44);
          DAT_00858df8 = pppuStack_a4;
          return 0;
        }
    ...
    case 0x6108:
      ...
      *(undefined1 *)((int)DAT_00802a30 + 0x493) = 0;
      ...
      if ((aiStack_44[4] == 0x6102) && (DAT_008067a0 != '\0')) {
        if ((DAT_00802a98 == '\0') ||
    ...
    if (uVar23 < 0x7101) {
      ...
      *(undefined1 *)((int)DAT_00802a30 + 0x493) = 0;
      ...
      pppuStack_14c = DAT_00858df8;
      DAT_00858df8 = &pppuStack_14c;
      iStack_4c = __setjmp3(auStack_148,0,unaff_EDI,unaff_ESI);
      if (iStack_4c != 0) {
        DAT_00858df8 = pppuStack_14c;
        if (iStack_10 != 0) {
        ...
        *(undefined4 *)((int)piStack_18 + 0x4efa) = 0;
        thunk_FUN_00567220((int)(piStack_18 + 0xe));
        thunk_FUN_00567180(piStack_18 + 0xe,DAT_00856d78);
        FUN_006e3db0((int)piStack_18 + 0x113a);
        DAT_00858df8 = pppuStack_a4;
        return 0;
      }
      uVar23 = 0;
      ...
      do {
        ...
        iVar14 = 0;
        puStack_c = (uint *)0x0;
        piVar15 = *(int **)((int)piStack_18 + 0x115a);
        piVar11 = piVar15 + 1;
        if (0 < *piVar11) {
          do {
            if (((piVar15[2] == iStack_24) && (piVar15[3] == iStack_20)) && (piVar15[4] == iVar5)) {
              puStack_c = (uint *)0x1;
              break;
            }
            iVar14 = iVar14 + 1;
        ...
        if (puStack_c != (uint *)0x0) {
          pppuStack_108 = DAT_00858df8;
          DAT_00806738 = iVar5;
          DAT_00858df8 = &pppuStack_108;
          iVar14 = __setjmp3(auStack_104,0,unaff_EDI,unaff_ESI);
          iVar5 = iStack_1c;
          if (iVar14 == 0) {
            DVar7 = FUN_006b9b40(DAT_0080759c,0x10000001,iStack_24,iStack_20,iStack_1c,iStack_24,
                                 iStack_20,0,0,0);
            uStack_48 = (uint)(DVar7 == 0);
          }
          uVar23 = uStack_48;
          DAT_00858df8 = pppuStack_108;
...
LAB_0057073b:
      thunk_FUN_00567220((int)(piStack_18 + 0xe));
      *(undefined4 *)((int)piStack_18 + 0x4efa) = 1;
      if (iVar5 == 0) {
      ...
      FUN_006a5e40(iStack_4c,DAT_007ed77c,0x7ca0c8,0x7bc);
      DAT_00858df8 = pppuStack_a4;
      return 0;
    }
    if (uVar23 != 0x7101) {
    ...
    if (iVar5 == 1) {
      ...
      *(undefined4 *)((int)piVar11 + 0x114e) = 0;
      ...
      if ((DAT_00807330 & 2) != 0) {
        ...
        FUN_0072e730((byte *)((int)piVar11 + 0x7c0a),abStack_14,abStack_24c,abStack_44c,abStack_54c)
        ;
        __makepath((char *)((int)piVar11 + 0x7d1a),(char *)abStack_14,(char *)abStack_24c,
                   PTR_s_CAMPAIGN_VPS_0079b03c,(char *)0x0);
        puStack_c = thunk_FUN_00683c70((uint *)((int)piVar11 + 0x7d1a),&stack0xfffff65c,&iStack_50,
                                       (int *)0x0,(undefined *)0x0);
        if ((iStack_50 == 0x40) && (puStack_c != (uint *)0x0)) {
          uVar23 = puStack_c[1];
          if (*(int *)(param_1 + 0x18) == 0) {
            if (uVar23 < puStack_c[3]) {
              pcVar8 = (char *)(puStack_c[2] * uVar23 + puStack_c[7]);
            ...
            if (pcVar8 != (char *)0x0) {
              ...
              __makepath((char *)&DAT_00803408,(char *)abStack_14,(char *)abStack_24c,pcVar8,
                         (char *)0x0);
            }
          }
          else {
...
LAB_00570c2f:
    ...
    pvVar10 = FindFirstFileA((LPCSTR)&DAT_00803408,&_Stack_68c);
    if (pvVar10 != (HANDLE)0xffffffff) {
      (**(code **)(*piVar11 + 0x18))(aiStack_44);
      DAT_00858df8 = pppuStack_a4;
      return 0;
    }
    iVar5 = *piVar11;
