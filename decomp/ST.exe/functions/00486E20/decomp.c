  ...
  *(undefined1 *)((int)puVar2 + 6) = 1;
  ...
  if (bVar1 != 0) {
    if (bVar1 < 3) {
      ...
      if ((char)iVar3 == '\x03') goto LAB_00486ed3;
    }
    else if ((bVar1 == 3) &&
            ((iVar3 = thunk_FUN_004406c0(*(char *)((int)this + 0x24)), (char)iVar3 == '\x01' ||
             (iVar3 = thunk_FUN_004406c0(*(char *)((int)this + 0x24)), (char)iVar3 == '\x02')))) {
LAB_00486ed3:
  ...
  case 0x12:
    ...
    *(undefined1 *)((int)puVar2 + 0xe) = 7;
    ...
    if (*(short *)(&DAT_007f4f7b + *(char *)((int)this + 0x24) * 0xa62) != 0) {
      bVar5 = *(int *)((int)this + 0x716) == *(int *)((int)this + 0x712);
LAB_00487a9b:
      if (!bVar5) {
        *(undefined1 *)((int)puVar2 + 0x12) = 1;
        goto LAB_00487aad;
...
LAB_00487782:
      ...
      iVar3 = thunk_FUN_00492550(this,*(short *)((int)this + 0x5b),*(short *)((int)this + 0x5d),
    ...
    *(undefined1 *)((int)puVar2 + 0xe) = 0x12;
    ...
    if ((*(int *)((int)this + 0x45d) != 0x16) && (*(int *)((int)this + 0x459) != 0x7a)) {
      if ((*(short *)(&DAT_007f4f7f + *(char *)((int)this + 0x24) * 0xa62) != 0) &&
         (iVar3 = thunk_FUN_004e41c0(*(int *)((int)this + 0x24)), iVar3 != 0)) {
        iVar3 = thunk_FUN_004d6df0(this);
        bVar5 = iVar3 == 0;
        goto LAB_00487b9d;
      }
      goto LAB_00487ba5;
...
LAB_00487e0b:
    ...
    if ((*(int *)((int)this + 0x45d) == 0x16) || (*(int *)((int)this + 0x459) == 0x7a)) {
      *(undefined1 *)((int)puVar2 + 0x12) = 3;
             ...
             (iVar3 = thunk_FUN_004e41c0(*(int *)((int)this + 0x24)), iVar3 == 0)) ||
            (iVar3 = thunk_FUN_004d6df0(this), iVar3 == 0)) {
      *(undefined1 *)((int)puVar2 + 0x12) = 0;
    }
    else {
      *(undefined1 *)((int)puVar2 + 0x12) = 1;
    ...
    *(undefined1 *)((int)puVar2 + 0x13) = 1;
    iVar3 = thunk_FUN_004e60d0(*(int *)((int)this + 0x24),0x5f);
    if (0 < iVar3) {
...
LAB_00487eb7:
    if (*(int *)((int)this + 0x71e) < 10) goto LAB_004881b5;
    break;
  case 0x25:
    *(undefined1 *)((int)puVar2 + 9) = 2;
    *(undefined1 *)((int)puVar2 + 10) = 3;
...
switchD_00486f27_default:
  iVar3 = thunk_FUN_004357f0(*(char *)((int)this + 0x24));
  if (iVar3 == 0) {
    *(undefined1 *)((int)puVar2 + 0x15) = 0;
  }
  else {
    iVar3 = thunk_FUN_0042b760(CONCAT31((int3)((uint)iVar3 >> 8),*(undefined1 *)((int)this + 0x24)),
