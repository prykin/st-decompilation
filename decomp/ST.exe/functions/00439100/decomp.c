    ...
    if (iVar3 == 0x19a) {
      if (*(int *)((int)&DAT_007f5023 + iVar10) == 0) {
        *(undefined4 *)((int)&DAT_007f5023 + iVar10) = 1;
        thunk_FUN_0042d4f0((char)local_8,0,0,0);
        iVar3 = *(int *)((int)&DAT_007f4fd3 + iVar10);
        if (iVar3 < 0x19b) {
          if (iVar3 == 0x19a) {
            iVar3 = thunk_FUN_0044ab90(local_8,1,0x19a,(char)piVar1[1],*(uint **)((int)piVar1 + 10),
                                       0);
            if (-1 < iVar3) {
              thunk_FUN_0044b030((char)local_8,1,iVar3);
              goto LAB_0043a47c;
            }
            iVar3 = thunk_FUN_0044af50((char)local_8,1);
LAB_00439c32:
...
LAB_00439c87:
          iVar3 = thunk_FUN_0044ab90(local_8,1,0x19a,(char)piVar1[1],*(uint **)((int)piVar1 + 10),0)
          ;
          if (0 < iVar3) {
            thunk_FUN_0044b030((char)local_8,1,iVar3);
            goto LAB_0043a47c;
          }
          thunk_FUN_0044af50((char)local_8,1);
          uVar9 = extraout_var_05;
LAB_00439cc7:
          uVar5 = CONCAT31((int3)((uint)*(int *)((int)piVar1 + 10) >> 8),(char)piVar1[1]);
          uVar4 = CONCAT22(uVar9,**(undefined2 **)(*(int *)((int)piVar1 + 10) + 0x1c));
        }
        thunk_FUN_0042bb30((char)local_8,1,0,uVar5,uVar4);
        *(undefined4 *)((int)&DAT_007f4fd3 + iVar10) = 0x19a;
        goto LAB_0043a47c;
      }
      ...
      if (iVar3 < 0x19b) {
        if (iVar3 == 0x19a) {
          ...
          if (iVar3 < 0) {
            thunk_FUN_0044af50((char)local_8,1);
            thunk_FUN_0042d4f0((char)local_8,1,1,0);
...
LAB_0043986a:
            iVar3 = thunk_FUN_0044ab90(local_8,1,*(int *)(uVar5 + 0x20),*(char *)(uVar5 + 0x24),
                                       (uint *)0x0,
...
LAB_00439cfb:
    ...
    if (iVar3 != 0x5a) {
      ...
      if (*(int *)((int)&DAT_007f5023 + iVar10) == 0) {
        ...
        if (iVar3 == 0) {
LAB_00439369:
          iVar3 = thunk_FUN_0044ab90(local_8,0,0x3c,(char)piVar1[1],*(uint **)((int)piVar1 + 10),0);
          if (0 < iVar3) {
            thunk_FUN_0044b030((char)local_8,0,iVar3);
...
LAB_0043953a:
          uVar5 = piVar1[1];
          if (uVar5 == local_20) {
            thunk_FUN_0042c1c0(local_8,0,0,*(int *)((int)piVar1 + 10));
            *(undefined4 *)((int)&DAT_007f4f83 + iVar10) = 0x3c;
            goto LAB_0043a47c;
          }
          goto LAB_00439566;
        ...
        if (iVar3 == 0x3c) {
          ...
          thunk_FUN_0044af50((char)local_8,0);
          if ((*(uint *)((int)&DAT_007f4f97 + iVar10) == local_20) && (piVar1[1] == local_20)) {
            thunk_FUN_0044b280((char)local_8,0,1,*(uint **)((int)piVar1 + 10),(int *)&local_c,
                               (int *)0x0,(int *)0x0);
            thunk_FUN_0042d190(local_8,0x3c,(int)local_c,0,0);
            FUN_006ae110(local_c);
          }
          else {
            thunk_FUN_0042d4f0((char)local_8,0,1,0);
          }
          goto LAB_0043953a;
        }
        if (iVar3 != 0x1ae) {
...
LAB_00439469:
        ...
        *(undefined4 *)((int)&DAT_007f5023 + iVar10) = 0;
        thunk_FUN_0042d4f0((char)local_8,1,0,0);
        iVar3 = *(int *)((int)&DAT_007f4f83 + iVar10);
...
LAB_00439566:
      ...
      thunk_FUN_0042bb30((char)local_8,0,0,uVar4,uVar5);
      *(undefined4 *)((int)&DAT_007f4f83 + iVar10) = 0x3c;
      goto LAB_0043a47c;
    }
...
LAB_00439dfb:
    ...
    local_20 = thunk_FUN_0042b620((uint)*(byte *)(piVar1 + 1),
...
LAB_0043a177:
        uVar4 = local_8;
        iVar3 = thunk_FUN_0044ab90(local_8,0,*(int *)(local_20 + 0x20),(char)piVar1[1],(uint *)0x0,
...
LAB_0043a47c:
  if (((local_24 == 1) &&
      ...
      iVar3 = thunk_FUN_0043aaf0(*local_28,CONCAT31((int3)(uVar5 >> 8),(char)local_28[1]),
                                 *(int *)((int)local_28 + 10),uVar5,&local_18,&local_14,&local_10,
                                 &local_1c), iVar3 == 0)) &&
