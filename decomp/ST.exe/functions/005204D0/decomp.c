...

{
  ...
  if (iVar2 == 0) {
    ...
    *(undefined4 *)(local_8 + 0x3d0) = 0;
    if (*(uint **)(local_8 + 0x3d5) != (uint *)0x0) {
      FUN_00710560(*(uint **)(local_8 + 0x3d5));
      *(undefined4 *)(local_8 + 0x3d5) = 0;
    }
    *(undefined4 *)(local_8 + 0x3cc) = 0;
    *(undefined4 *)(local_8 + 0x3c8) = 0;
    *(undefined4 *)(local_8 + 0x3c4) = 0;
    DAT_00801698 = 0;
