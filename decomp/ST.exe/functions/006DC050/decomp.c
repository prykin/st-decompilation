...

{
  ...
  puVar3 = (undefined4 *)Library::DKW::LIB::FUN_006acf50(*(int *)&param_1->field_0x350,0x658);
  iVar5 = 0;
  *(undefined4 **)&param_1->field_0x350 = puVar3;
  *puVar3 = 0;
  *(undefined4 *)(*(int *)&param_1->field_0x350 + 4) = 0;
  puVar3 = (undefined4 *)Library::DKW::LIB::FUN_006acf50(*(int *)&param_1->field_0x354,0x658);
  *(undefined4 **)&param_1->field_0x354 = puVar3;
  *puVar3 = 0;
  *(undefined4 *)(*(int *)&param_1->field_0x354 + 4) = 0;
  *(undefined8 *)&param_1->field_0xc8 = param_15;
  *(undefined8 *)&param_1->field_0xd0 = param_16;
  ...
  *(undefined4 *)&param_1->field_0x124 = 0;
  ...
  if (0 < param_17) {
    ...
    *(double *)&param_1->field_0x368 = *(double *)&param_1->field_0xc8 / (double)param_17;
    ...
    *(undefined8 *)(*(int *)&param_1->field_0x358 + 0xd0) = param_16;
    ...
    *(int *)(*(int *)&param_1->field_0x358 + 0x380) = param_17;
