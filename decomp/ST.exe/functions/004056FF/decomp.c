...

{
  ...
  if (*(int *)((int)&DAT_007f5023 + iVar4) == 0) {
    piStack_8 = (int *)((int)&DAT_007f4f83 + iVar4);
  }
  else if (*(int *)((int)&DAT_007f5023 + iVar4) == 1) {
    piStack_8 = (int *)((int)&DAT_007f4fd3 + iVar4);
  }
  else {
  ...
  piVar3 = piStack_8;
  if (*piStack_8 != 0) {
    puStack_c = (undefined4 *)((int)&DAT_007f5027 + iVar4 + param_1 * 0x10);
    if (*(byte **)((int)puStack_c + 10) != (byte *)0x0) {
      FUN_006ae110(*(byte **)((int)puStack_c + 10));
      *(undefined4 *)((int)puStack_c + 10) = 0;
      *puStack_c = 0;
    }
  }
  iVar5 = *piVar3;
