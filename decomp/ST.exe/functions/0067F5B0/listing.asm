...
FUN_0067f5b0::override::prt_67f5b7_5e552bb4:
0067F5B7  E8 9B 54 D8 FF            CALL 0x00404a57  ; [STCallResultViewApplier] readability_validated; exact direct-call result=pointer:/uint; signature=__cdecl;pointer:/uint;pointer:/byte
