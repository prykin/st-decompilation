  ...
  do {
    ...
    if (*pbVar11 != 0xff) {
      if (DAT_0080874e == '\x03') {
        ...
        bVar5 = (-(DAT_0080874e != '\x01') & 0x89U) + 0x3a;
      }
      FUN_006b4170((AnonShape_006B5B10_E0D06CF1 *)this_00->field_0068,0,0x30,uVar8,0x22,0xc,bVar5);
      if (local_5 < (byte)this_00->field_01AB) {
        ccFntTy::SetSurf(this_00->field_0189,this_00->field_0068,0,0x31,uVar8,0x10,0xc);
        cVar2 = (&DAT_008087e8)[(uint)*pbVar11 * 0x51];
        if (cVar2 == '\x01') {
          resourceId = 0x2742;
        }
        else if (cVar2 == '\x02') {
        ...
        ccFntTy::WrStr(this_00->field_0189,resourceString,iVar6,iVar12,uVar13);
      }
      if (DAT_00808a8f == '\0') {
        iVar6 = -1;
        bVar5 = *local_c;
        /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
        _local_18 = CONCAT31(uStack_17,bVar5);
        if (DAT_0080874d == bVar5) {
LAB_00520987:
          uVar7 = 0;
        }
        else {
          uVar8 = (uint)DAT_0080874d;
          bVar3 = g_playerRelationMatrix[uVar8][bVar5];
          if ((bVar3 == 0) && (g_playerRelationMatrix[bVar5][uVar8] == 0)) {
            uVar7 = 0xfffffffe;
          }
          else if ((bVar3 == 1) && (g_playerRelationMatrix[bVar5][uVar8] == 0)) {
            uVar7 = 0xffffffff;
          }
          else if ((bVar3 == 0) && (g_playerRelationMatrix[bVar5][uVar8] == 1)) {
            uVar7 = 1;
          }
          else {
            if ((bVar3 != 1) || (g_playerRelationMatrix[bVar5][uVar8] != 1)) goto LAB_00520987;
            uVar7 = 2;
          }
        }
        switch(uVar7) {
