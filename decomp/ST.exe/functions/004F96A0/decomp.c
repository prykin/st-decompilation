...
void __fastcall FUN_004f96a0(int param_1)

{
  ...
  if ((DAT_0080c4f7 == 1) && (*(int *)(param_1 + 0x24b) != 0)) {
    ...
    iVar9 = local_10;
    if (iVar3 == 0) {
      iVar3 = *(int *)(local_10 + 0x24b);
      uVar10 = *(uint *)(iVar3 + 0xc);
      if (*(uint *)(local_10 + 0x24f) < uVar10) {
        do {
          ...
          case 2:
            ...
            if (iVar3 < (int)local_c) {
              do {
                ...
                thunk_FUN_005411a0((int)local_8,pcVar6,&DAT_007c2260);
                iVar3 = iVar3 + 1;
              } while (iVar3 < (int)local_c);
            }
            puVar4 = FUN_007126e0((int)local_8,(uint *)s________________007c21d8,
            ...
            if (puVar12[5] == '\0') {
              ...
              if (pbVar5 != (byte *)0x0) {
                FUN_00711f70((int)local_8,0,-1,0,0,0);
              ...
              *(int *)(iVar9 + 0x1d8) = iVar3;
              iVar3 = FUN_00713f30((int)local_8,*(void **)(iVar9 + 0x1d4),0,0,0,0x226,0x55,0,0,0,1,2
                                   ,0xff);
...
LAB_004f9a8a:
                ...
                *piVar1 = (int)psVar7;
                ...
                psVar7 = FUN_0070b430(DAT_00806758,local_c,6,0,0);
                *piVar1 = (int)psVar7;
                if (psVar7 == (short *)0x0) {
                  bVar14 = 6;
                  bVar13 = 0;
