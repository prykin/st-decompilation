...

{
  ...
  if (uVar4 == 0) {
    if (*(int *)(this_00 + 0x1fa) == 1) {
      if ((this_00[0x1f9] == (STGameObjC)0x0) &&
         (iVar7 = thunk_FUN_0062fea0(this_00,*(int *)(this_00 + 0x1d5),*(int *)(this_00 + 0x1d9)),
         iVar7 != 0)) {
  ...
  if (((*(int *)(this_00 + 0x1d5) < 0) || (*(int *)(this_00 + 0x1d9) < 0)) ||
    ...
    *(int *)(this_00 + 0x1dd) = iVar8;
    bVar6 = thunk_FUN_004961b0(*(short *)(this_00 + 0x1d5),*(short *)(this_00 + 0x1d9),(short)iVar8)
    ;
    if (CONCAT31(extraout_var,bVar6) != 0) {
      sVar1 = *(short *)(this_00 + 0x1d5);
      sVar2 = *(short *)(this_00 + 0x1dd);
      sVar3 = *(short *)(this_00 + 0x1d9);
      ...
      if ((iVar8 == 0) &&
         (iVar8 = DumpClassC::WritePtr
                            ((short)*(undefined4 *)(this_00 + 0x1d5),
                             (short)*(undefined4 *)(this_00 + 0x1d9),
                             (short)*(undefined4 *)(this_00 + 0x1dd),1,(int)this_00),
        ...
        *(int *)(this_00 + 0x1dd) = iVar9;
        iVar8 = thunk_FUN_0062fea0(this_00,iVar8,iVar11);
        this_00[0x1f9] = SUB41(iVar8,0);
        goto LAB_0062ea02;
      }
    }
    thunk_FUN_0062f900(this_00);
