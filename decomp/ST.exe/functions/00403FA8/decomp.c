  ...
  if ((param_1 != 0) && (this[0x1ca9] == (MMsgTy)0x0)) {
    ...
    if (iVar3 == 0) {
      ...
      if (iVar3 != 0) {
        ...
        aiStack_34[4] = 0x6940;
        aiStack_34[2] = iVar3;
        (**(code **)(**(int **)(this_00 + 0xc) + 0x18))(aiStack_34);
      }
      ...
      *(undefined2 *)pMVar9 = 0;
      ...
      if (this_00[0x9a] != (MMObjTy)0x0) {
        do {
          ...
          *(undefined2 *)pMVar12 = *(undefined2 *)pMVar9;
          pMVar12[2] = pMVar9[2];
          MVar2 = (MMObjTy)((char)uStack_8 + 1);
          uStack_8 = CONCAT31(uStack_8._1_3_,MVar2);
        } while ((byte)MVar2 < (byte)this_00[0x9a]);
      }
      *(UINT *)(this_00 + 0x1cd0) = param_1;
      if (param_6 == 0) {
        uVar5 = 0xffffffff;
        iStack_10 = *(int *)(this_00 + 0x1d88);
        uVar4 = 7;
        iVar16 = -1;
        iVar15 = -1;
        iVar13 = 1;
...
LAB_005b8415:
      ...
      if (this_00[0x9a] != (MMObjTy)0x0) {
        do {
          ...
          *(uint *)(this_00 + uVar11 * 0x1fb + 0x123) = ((uStack_c & 0xff) + 1) * 100;
