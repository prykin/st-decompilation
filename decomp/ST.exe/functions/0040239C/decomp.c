...

{
  ...
  *(undefined4 *)(pSVar14 + 0x291) = 0;
  ...
  if (*(int *)(&DAT_00792a90 + (param_1 + *(int *)(pSStack_60 + 0x235) * 2) * 4) == 1) {
    ...
    ;
    iVar7 = *(int *)(this_00 + 0x5b4) + -8;
    iStack_18 = iVar7;
    if (iVar7 <= *(int *)(this_00 + 0x5b4) + 8) {
      do {
        if ((-1 < iVar7) && (iVar7 < DAT_007fb242)) {
          iVar8 = *(int *)(this_00 + 0x5b0);
          iVar15 = iVar8 + -8;
          iStack_28 = iVar15;
          iStack_18 = iVar7;
          if (iVar15 <= iVar8 + 8) {
            do {
              if (((-1 < iVar15) && (iVar15 < DAT_007fb240)) &&
                 (iStack_28 = iVar15,
                 iVar8 = FUN_006aced8(iVar15,iVar7,iVar8,*(int *)(this_00 + 0x5b4)),
                 iVar8 <= iStack_58)) {
                iStack_24 = iVar8 / 3;
                if (3 < *(int *)(pSStack_10 + 0x281)) {
                  iStack_24 = 5;
                }
                iStack_3c = (*(int *)(this_00 + 0x5b8) - iStack_24) + -1;
                if (iStack_3c <= *(int *)(this_00 + 0x5b8) + 1 + iStack_24) {
                  do {
                    if ((-1 < iStack_3c) && (iStack_3c < 5)) {
                      ...
                      if ((((pSStack_8 != (STSprGameObjC *)0x0) && (pSStack_8 != this_00)) &&
                         ...
                         ((*(int *)(pSStack_8 + 0x24) != 0xff &&
                          (iVar8 = (**(code **)(*(int *)pSStack_8 + 0xf4))
                                             (*(undefined4 *)(this_00 + 0x24)), iVar7 = iStack_18,
                          iVar15 = iStack_28, iVar8 != 0)))) {
                        ...
                        if ((int)(((uVar9 ^ uVar12) - uVar12) * 10) / iVar8 <=
                          ...
                          *(undefined4 *)(pSStack_10 + 0x295) =
                          ...
                          if ((param_2 == 0) || (*(int *)(this_00 + 0x255) == 0)) goto LAB_004c4080;
                          sVar6 = (**(code **)(*(int *)this_00 + 0x10))
                          ...
                          uVar9 = (int)*(uint *)(&DAT_007be8c8 +
                                                (*(int *)(this_00 + 0x259) / 0xf + iVar8 * 0x18) * 4
                                                ) >> 0x1f;
                          iVar7 = iStack_18;
                          iVar15 = iStack_28;
                          if ((int)((*(uint *)(&DAT_007be8c8 +
                                              (*(int *)(this_00 + 0x259) / 0xf + iVar8 * 0x18) * 4)
                                    ^ uVar9) - uVar9) <= *(int *)(pSStack_10 + 0x279)) {
                            iVar11 = param_1 + *(int *)(this_00 + 0x235) * 2;
...
LAB_004c41a5:
                                    ...
                                    iVar15 = iStack_28;
                                    if (iVar8 != 0) {
                                      iVar8 = FUN_006aadd0(*(int *)(this_00 + 0x5b0),
                                                           *(int *)(this_00 + 0x5b4),
                                                           *(int *)(this_00 + 0x5b8),iStack_28,
                                                           iStack_18,iStack_3c);
                                      pSVar14 = pSStack_10;
                              ...
                              if (0 < *(int *)(&DAT_007932d0 + iVar11)) {
                                ...
                                do {
                                  ...
                                  iVar15 = STSprGameObjC::CheckRay
                                                     (this_00,sStack_68 + (short)uStack_2c,
                                                      sStack_66 + (short)uStack_34,
                                                      sStack_64 + (short)uStack_30,asStack_40[0],
                                                      asStack_38[0],asStack_1c[0],
                                                      (&DAT_00792ca0)
                                                      [(param_1 + *(int *)(this_00 + 0x235) * 2) * 3
                                                      ],&iStack_44,*(int *)(this_00 + 0x420));
                                  if ((iVar15 != 0) ||
                                  ...
                                  iVar7 = iVar7 + 6;
                                  iVar11 = (param_1 + *(int *)(this_00 + 0x235) * 2) * 0x16;
                  ...
                  } while (iStack_3c <= *(int *)(this_00 + 0x5b8) + 1 + iStack_24);
                }
              }
              iVar8 = *(int *)(this_00 + 0x5b0);
              iVar15 = iVar15 + 1;
        ...
        pSVar14 = pSStack_10;
        iStack_18 = iVar7;
      } while (iVar7 <= *(int *)(this_00 + 0x5b4) + 8);
    }
  }
LAB_004c42b5:
  if (pSStack_20 != (STSprGameObjC *)0x0) {
