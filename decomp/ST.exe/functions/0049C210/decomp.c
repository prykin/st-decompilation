...

{
  ...
  if ((param_1 == 1) || (param_1 == 0)) {
    ...
    if (this_00->field_010B == 0) {
      ...
      if (0 < (int)local_c) {
        do {
          FUN_006acc70((AnonShape_006ACC70_C8641025 *)this_00->field_010F,uVar15,&local_8);
          if (((short)local_8 != -1) &&
      ...
      if (pAVar6 == (AnonShape_006ACC70_C8641025 *)0x0) {
        ...
        if (0 < (int)local_c) {
          do {
            FUN_006acc70(pAVar6,uVar15,&local_8);
            piVar5 = (int *)STAllPlayersC::GetObjPtr
                                      (g_sTAllPlayers_007FA174,
    ...
    if (this_00->field_0262 == 0) {
      if ((this_00->field_0127 == 0) ||
         (uVar15 = *(uint *)(this_00->field_0127 + 0xc), local_c = uVar15, uVar15 == 0)) {
        uVar15 = local_c;
        RaiseInternalException
                  (-0x5001fff7,g_overwriteContext_007ED77C,s_E____titans_wlad_to_grpb_cpp_007abe3c,
                   0x855);
      ...
      if (0 < (int)uVar15) {
        do {
          FUN_006acc70((AnonShape_006ACC70_C8641025 *)this_00->field_0127,uVar13,&local_8);
          if ((((short)local_8 != -1) &&
              (piVar5 = (int *)STAllPlayersC::GetObjPtr
                                         (g_sTAllPlayers_007FA174,
    ...
    if (this_00->field_0262 == 2) {
      ...
      if (pAVar6 == (AnonShape_006ACC70_C8641025 *)0x0) {
        ...
        if (0 < (int)local_c) {
          do {
            FUN_006acc70(pAVar6,uVar15,&local_8);
            uVar13 = STAllPlayersC::GetObjPtr
                               (g_sTAllPlayers_007FA174,
    ...
    if (this_00->field_0262 == 1) {
      ...
      pAVar6 = (AnonShape_006ACC70_C8641025 *)
               STAllPlayersC::GetTOBJList(g_sTAllPlayers_007FA174,cVar17,SVar25,0,-1);
            ...
            *psVar16 = *psVar7;
            ...
            if (local_1c == 1) {
                ...
                if ((((local_78[0] < 0) || (SHORT_007fb240 <= local_78[0])) || (local_78[1] < 0)) ||
                  ...
                  pSVar10 = g_worldCells
                            [(int)local_78[2] * (int)SHORT_007fb246 +
                             (int)local_78[1] * (int)SHORT_007fb240 + (int)local_78[0]].objects[0];
                }
                  ...
                  ((SHORT_007fb242 <= local_6c || (local_6a < 0)))) || (SHORT_007fb244 <= local_6a))
              {
                ...
                pSVar10 = g_worldCells
                          [(int)local_6a * (int)SHORT_007fb246 + (int)local_6c * (int)SHORT_007fb240
                           + (int)local_6e].objects[0];
              }
