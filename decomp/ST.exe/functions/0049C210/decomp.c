        ...
        do {
          ...
          if (((short)local_8 != -1) &&
            ...
            if (((iVar9 != local_14) && (iVar3 == *(int *)(this_00 + 0x25e))) &&
              ...
              Library::DKW::TBL::FUN_006ae1c0(*(uint **)(this_00 + 0x24e),&local_8);
            }
          }
          uVar14 = uVar14 + 1;
      ...
      if (0 < (int)uVar14) {
        do {
          ...
          if ((((short)local_8 != -1) &&
            ...
            Library::DKW::TBL::FUN_006ae1c0(*(uint **)(this_00 + 0x266),&local_8);
          }
          uVar12 = uVar12 + 1;
        ...
        if (0 < (int)local_c) {
          do {
            ...
            uVar12 = STAllPlayersC::GetObjPtr
                               (DAT_007fa174,
                                CONCAT31((int3)((uint)extraout_EDX_01 >> 8),this_00[0x24]),local_8,1
                               );
            if (uVar12 != 0) {
              Library::DKW::TBL::FUN_006ae1c0(*(uint **)(this_00 + 0x266),&local_8);
            }
