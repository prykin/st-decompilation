...

{
  ...
  if (iVar2 == 0) {
    if ((*(short *)((int)pvStack_8 + 0x172) == 1) || (*(short *)((int)pvStack_8 + 0x172) == 3)) {
      *(undefined1 *)((int)pvStack_8 + 0x1aa) = 0;
      *(undefined1 *)((int)pvStack_8 + 0x1a9) = 0;
      *(undefined1 *)((int)pvStack_8 + 0x1a4) = 1;
      thunk_FUN_0052fb00();
      if (*(short *)((int)pvStack_8 + 0x172) == 1) {
        thunk_FUN_0052f900(pvStack_8,0);
      }
