...
void __fastcall FUN_005ad390(undefined4 *param_1)

{
  ...
  *(DWORD *)((int)param_1 + 0x61) = DVar4;
  ...
  if (((*(char *)((int)local_20 + 0x65) == '\x01') &&
      (*(HANDLE *)((int)local_20 + 0x1c8f) != (HANDLE)0x0)) &&
     (DVar4 = WaitForSingleObject(*(HANDLE *)((int)local_20 + 0x1c8f),0), DVar4 == 0)) {
  ...
  if (cVar1 == '\x01') {
    if (DAT_0080877e != '\0') {
      ...
      case 0x13:
        ...
        if (0 < local_14) {
          do {
            iVar5 = FUN_00715630(DAT_00811764,-1,&local_18,&local_1c,&local_c,&local_4c,-1,0);
            if (iVar5 == -0x4d) {
              piVar8 = local_6c;
              ...
              if (local_18 == 0x1a) {
                if (*(char *)(local_c + 2) == '\x04') {
                  ...
                  local_41 = (*(char *)((int)this + 0x1a5f) != '\f') - 1 & DAT_00808750;
