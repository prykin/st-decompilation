...

{
  ...
  undefined4 *puVar6;
  int *piVar7;
  InternalExceptionFrame IStack_d4;
  ...
  *(undefined2 *)puVar6 = *(undefined2 *)pbVar5;
  ...
  if (iVar4 != 0) {
    ...
    iStack_8 = Library::DKW::LIB::FUN_006aac70(uStack_28 * 4);
    puVar6 = auStack_90;
    for (iVar4 = 8; iVar4 != 0; iVar4 = iVar4 + -1) {
      *puVar6 = 0;
      puVar6 = puVar6 + 1;
    }
    puStack_54 = Library::DKW::TBL::FUN_006ae290((uint *)0x0,10,0x40,10);
    puStack_78 = Library::DKW::TBL::FUN_006ae290((uint *)0x0,10,0x40,10);
    puStack_50 = Library::DKW::TBL::FUN_006ae290((uint *)0x0,uStack_1c,0xf,10);
    puStack_74 = Library::DKW::TBL::FUN_006ae290((uint *)0x0,uStack_1c,0xf,10);
    iStack_14 = 0x32;
    ...
    if (iStack_c == 1) {
      ...
      IStack_d4.previous = g_currentExceptionFrame;
      g_currentExceptionFrame = &IStack_d4;
      iVar4 = Library::MSVCRT::__setjmp3(IStack_d4.jumpBuffer,0,unaff_EDI,unaff_ESI);
      pvVar2 = pvStack_4c;
      if (iVar4 == 0) {
        if (param_2 != (byte *)0x0) {
          cMf32::RecPut(*(cMf32 **)((int)pvStack_4c + 0x18),0xc,PTR_s_GENERATE_RND_0079d774,param_1,
        ...
        g_currentExceptionFrame = IStack_d4.previous;
      }
      else {
        g_currentExceptionFrame = IStack_d4.previous;
      }
