...
int FUN_006ad3a0(LPCSTR param_1,LPCSTR param_2,uint param_3)

{
  ...
  if (DAT_00854a84 != 0) {
    iVar1 = MessageBoxA(hWnd,param_1,s_Debug_Message___SECOND_CALL_007ed7dc,
  ...
  iVar1 = MessageBoxA(hWnd,param_1,param_2,param_3 | 0x10000);
  if ((DAT_00854eb8 != (undefined4 *)0x0) && ((*(byte *)(DAT_00854eb8 + 2) & 1) != 0)) {
