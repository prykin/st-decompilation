...
undefined4 __thiscall FUN_006051b0(void *this,undefined4 param_1,undefined4 param_2,char param_3)

{
  ...
  if ((param_3 != '\0') && (*(int *)((int)local_18 + 0x2af) != 0)) {
    local_8 = (&PTR_s_expl_bbt0_007cedc0)[local_c];
    iVar5 = thunk_FUN_004ab880(0xf,DAT_00806774,local_8,0x1d);
    if (iVar5 != 0) {
      return 0xffff;
    }
  ...
  iVar5 = thunk_FUN_004ab880(0xd,DAT_00806774,local_8,0x1d);
  if (iVar5 == 0) {
    iVar5 = thunk_FUN_004ab880(0xe,DAT_00806774,local_10,0x1d);
    if (iVar5 != 0) {
      return 0xffff;
    }
