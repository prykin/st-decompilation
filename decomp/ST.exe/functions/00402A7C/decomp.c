...
undefined4 __cdecl thunk_FUN_004b1690(int param_1,int param_2,int param_3,int param_4,int param_5)
...
LAB_004b1816:
  ...
  if (param_4 == 0xdd) {
    uStack_8 = &DAT_007907ac;
  }
  else if (param_4 == 0xde) {
    uStack_8 = &DAT_007907d0;
  }
  if (bVar1) {
    iStack_c = 1;
    sVar7 = (short)param_3;
    if ((0 < param_3) && (iVar8 = param_1 + -1, iVar8 < param_1 + 2)) {
      do {
        ...
        if (iVar5 < param_2 + 2) {
          param_4 = iVar5 * 0xc;
          do {
            if (*(int *)(uStack_8 + param_4 + param_2 * -0xc + param_1 * -4 + iVar8 * 4 + 0x10) == 1
               ) {
              sVar2 = sVar7 + -1;
              sVar6 = (short)iVar8;
              if ((-1 < sVar6) &&
...
LAB_004b199c:
    sVar2 = DAT_007fb240;
    if (((param_5 == 0) && (iStack_c != 0)) &&
       ((iStack_c = 0, param_3 < 3 && (iStack_c = 1, iVar8 = param_1, param_1 < param_1 + 3)))) {
      do {
...
LAB_004b1a39:
          ...
          do {
            ...
            if (param_3 < param_3 + 1) {
              do {
                ...
                if ((pvStack_10 != (void *)0x0) && (*(int *)((int)pvStack_10 + 0x20) != 0xbe)) {
                  bVar1 = false;
                  goto LAB_004b1b6e;
                }
                iVar3 = iVar3 + 1;
    ...
    if (DAT_007fa150 != 0) {
      *(undefined4 *)(DAT_007fa150 + 4) = 0;
      iVar8 = FUN_006b1190(DAT_007fa150,&pvStack_10);
      while (-1 < iVar8) {
        if (pvStack_10 != (void *)0x0) {
          thunk_FUN_004162b0(pvStack_10,(undefined2 *)((int)&param_4 + 2),
                             (undefined2 *)((int)&param_5 + 2),(undefined2 *)((int)&uStack_8 + 2));
          if (((param_4._2_2_ == param_1) && (param_5._2_2_ == param_2)) &&
             (uStack_8._2_2_ == param_3)) {
            bVar1 = false;
          }
        }
        iVar8 = FUN_006b1190(DAT_007fa150,&pvStack_10);
