...

{
  ...
  if (iVar2 == 0) {
    ...
    FUN_006b55f0(*(undefined4 **)((int)pvStack_8 + 0x68),0,0x21,0x16,
                 *(int *)((int)pvStack_8 + 0x1dc),0,0x21,0x16,0x19c,0x118);
    aiStack_520[0] = 0;
    aiStack_520[2] = *(int *)((int)pvStack_8 + 0x3c) + 0x21;
    if (*(int *)((int)pvStack_8 + 0x5c) == 0) {
      aiStack_520[3] = -*(int *)((int)pvStack_8 + 0x48);
    }
    else {
      aiStack_520[3] = *(int *)((int)pvStack_8 + 0x44);
    }
    aiStack_520[3] = aiStack_520[3] + 0x16;
    uStack_510 = 0x19c;
    uStack_50c = 0x118;
    if (*(char *)((int)pvStack_8 + 0x1a1) == '\0') {
      iVar2 = *(int *)((int)pvStack_8 + 0x1b3);
    }
    else {
      iVar2 = *(int *)((int)pvStack_8 + 0x1bb);
    }
    uStack_508 = *(undefined4 *)(iVar2 + 0xc);
    uStack_504 = 0;
    uStack_4f8 = *(undefined4 *)((int)pvStack_8 + 8);
    aiStack_3f0[0] = 0;
    aiStack_3f0[2] = *(int *)((int)pvStack_8 + 0x3c) + 0x1c3;
    uStack_4f4 = 2;
    uStack_4f0 = 0x8160;
    uStack_4d4 = 2;
    uStack_4d0 = 0x8161;
    ...
    uStack_2e4 = 1;
    if (*(int *)((int)pvStack_8 + 0x5c) == 0) {
      aiStack_3f0[3] = -*(int *)((int)pvStack_8 + 0x48);
    }
    else {
      aiStack_3f0[3] = *(int *)((int)pvStack_8 + 0x44);
    }
    ...
    uStack_390 = *(undefined4 *)((int)pvStack_8 + 8);
    ...
    if (iVar2 == 0) {
      aiStack_270[3] = -*(int *)((int)pvStack_8 + 0x48);
    }
    else {
      aiStack_270[3] = *(int *)((int)pvStack_8 + 0x44);
    }
    ...
    iStack_e4 = *(int *)((int)pvStack_8 + 0x3c) + 0x1c3;
    uStack_208 = 0x8165;
    uStack_f4 = 3;
    uStack_f0 = 1;
    uStack_e8 = 0;
    if (*(int *)((int)pvStack_8 + 0x5c) == 0) {
      iStack_e0 = -*(int *)((int)pvStack_8 + 0x48);
    }
    else {
      iStack_e0 = *(int *)((int)pvStack_8 + 0x44);
    }
    uStack_a0 = *(undefined4 *)((int)pvStack_8 + 8);
    ...
    (**(code **)(**(int **)((int)pvStack_8 + 0xc) + 8))
              (7,(int *)((int)pvStack_8 + 0x19c),0,aiStack_520,0);
