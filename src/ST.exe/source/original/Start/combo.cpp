...

{
  ...
  if (param_8 != 0) {
    ...
    if (errorCode == 0) {
      ...
      st::fn_006B4640(param_1,param_4 + 3,param_5,*(BITMAPINFO **)&pAVar3->field_0x74,nullptr);
      g_currentExceptionFrame = local_4c.previous;
      return;
    }
    g_currentExceptionFrame = local_4c.previous;

    iVar4 = st::fn_006AD4D0(st::mutable_c_string("E:\\__titans\\Start\\combo.cpp"),0x12,0,errorCode,st::mutable_c_string("%s")
                               ,"ComboTy::OutBmpProc");
    if (iVar4 != 0) {
      STDebugBreak(); /* noreturn in standalone pseudocode */
    }
    st::fn_006A5E40(errorCode,0,st::mutable_c_string("E:\\__titans\\Start\\combo.cpp"),0x12);
  }
  return;
}
