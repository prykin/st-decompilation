...

{
  ...
  if (iVar3 == 0) {
    ...
    do {
      ...
      st::external_00000080(st::pointer_boundary_cast<LPSTR>(&pSVar2->field_003C),st::mutable_c_string("MM_ACC%02d"),iVar14);
    ...
    pHVar4 = st::fn_004034EF(puVar5,nullptr,DAT_00807dd9);
    pSVar2->field_0030 = pHVar4;
    pHVar4[0x16].unused = 1;
    pHVar4[0x17].unused = 0;
    pcVar5 = (ccFntTy *)st::fn_00403E5E((int)pSVar2->field_02F0,nullptr,DAT_00807dd9);
    pSVar2->field_0034 = pcVar5;
    puVar8 = pSVar2->field_02F0;
    puVar7 = &pSVar2->field_02EC;
    st::fn_006B2330(g_ddxContext_008075A8,puVar7,0x32,0x4023f6,*(uint *)(puVar8 + 2),
                 *(uint *)(puVar8 + 4),puVar8);
    st::fn_006B3640((int *)g_ddxContext_008075A8,*puVar7,0xffffffff,1,0);
    ...
    local_EAX_1035 = st::fn_006B4FE0(pSVar2->field_02F0);
    pAVar6 = (AnonPointee_StartSystemTy_0544 *)
             st::fn_006B50C0(0xd5,0x119,(uint)pSVar2->field_02F0[7],local_EAX_1035,(undefined4 *)puVar8
                          ,iVar14);
    ...
    puVar7 = (undefined4 *)st::fn_006B4FA0((int *)pAVar6);
    ...
    st::fn_006B2330(g_ddxContext_008075A8,puVar7,0x31,0x4023f6,pAVar6->field_0004,pAVar6->field_0008,
                 (ushort *)pAVar6);
    st::fn_006B3640((int *)g_ddxContext_008075A8,*puVar7,0xffffffff,0xd,0xb9);
    st::fn_006B3AF0((int *)g_ddxContext_008075A8,*puVar7);
    iVar14 = 1;
    puVar8 = pSVar2->field_02F0 + 0x14;
    uVar8 = st::fn_006B4FE0(pSVar2->field_02F0);
    puVar8 = (ushort *)
             st::fn_006B50C0(0x186,0x14,(uint)pSVar2->field_02F0[7],uVar8,(undefined4 *)puVar8,iVar14);
    ...
    puVar7 = (undefined4 *)st::fn_006B4FA0((int *)puVar8);
    for (uVar11 = local_8 >> 2; uVar11 != 0; uVar11 = uVar11 - 1) {
      *puVar7 = 0xffffffff;
      puVar7 = puVar7 + 1;
    }
    ...
    st::fn_006B2330(g_ddxContext_008075A8,puVar7,0x31,0x4023f6,*(uint *)(puVar8 + 2),
                 *(uint *)(puVar8 + 4),puVar8);
    st::fn_006B3640((int *)g_ddxContext_008075A8,*puVar7,0xffffffff,0xcb,0x23f);
    st::fn_006B3AF0((int *)g_ddxContext_008075A8,*puVar7);
    ...
    pSVar2->field_05F5 = 0;
    local_EAX_1618 = st::fn_006B4FE0(pSVar2->field_02F0);
    puVar8 = (ushort *)
             st::fn_006B50C0(0x16d,0x49,(uint)pSVar2->field_02F0[7],local_EAX_1618,(undefined4 *)puVar8
                          ,iVar14);
    ...
    st::fn_006B2330(g_ddxContext_008075A8,&pSVar2->field_0558,0x31,0x4023f6,*(uint *)(puVar8 + 2),
                 *(uint *)(puVar8 + 4),puVar8);
    st::fn_006B3640
