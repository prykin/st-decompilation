...

{
  ...
  case MESS_FSGSTY_694A:
    if ((((DAT_00807dd1 & 0xffff0000) == 0xd0dd0000) && (DAT_0080874e == 3)) &&
      ...
      st::external_00000080(&DAT_0080ed16,"%s%s%s%d01",&DAT_00807680,PTR_s_MISSIONS__0079bfe8,
                pcVar9_mg0,(uint)DAT_0080874e);
      pcVar9_mg1 = PTR_s_TUTOR_0079bff0;
      if (this_00->field_1FFC == 0) {
        pcVar9_mg1 = PTR_DAT_0079bfec;
      }
      st::external_00000080(&DAT_0080ef1e,"%s%s%d01",PTR_s_MISSIONS__0079bfe8,pcVar9_mg1,
                (uint)DAT_0080874e);
      uVar11 = 0xffffffff;
