...

{
  ...
  if (g_startSystem_0081176C->field_0028 != 0) {
    ...
    do {
      ...
      do {
        iVar16 = 0;
        bVar14 = 0;
        pCVar3 = st::fn_006F2C00("CMPG_FLC",3,iVar2);
        puVar4 = st::fn_0071AD00(g_cMf32_00806780,pCVar3,bVar14,iVar16);
        *puVar5 = puVar4;
        puVar5 = puVar5 + 1;
        iVar2 = iVar2 + 1;
        local_c = local_c + -1;
    ...
    do {
      iVar16 = 0;
      bVar14 = 0;
      pCVar3 = st::fn_006F2C00("CMPG_FONFLC",2,iVar2);
      puVar4 = st::fn_0071AD00(g_cMf32_00806780,pCVar3,bVar14,iVar16);
      *puVar5 = puVar4;
      iVar2 = iVar2 + 1;
      puVar5 = puVar5 + 1;
  ...
  do {
    if (this_02->field_1BD7[iVar2 + -4] != 0) {
      puVar5 = st::fn_006C4A20(this_02->field_1BD7[iVar2 + -4]);
      ...
      if (puVar5 != nullptr) {
        ...
        st::fn_006C4A00(puVar5,g_dDXContext_0080759C,uVar15,uVar17);
      }
    }
...
LAB_00590d2d:
            ...
            if ((&this_02->field_1A5F)[iVar16] != 0) {
              puVar5 = st::fn_006C4A20((&this_02->field_1A5F)[iVar16]);
...
switchD_00590d73_default:
        ...
        if (2 < local_8) {
          ...
          puVar4 = (ushort *)st::fn_0070A9F0(g_cMf32_00806780,"CMPGN_BKG",0,1);
          ...
          if (g_cursorClass_00802A30 != nullptr) {
            ...
            st::fn_0040507E(this_01,CASE_0,iVar16,iVar2);
          ...
          if (*(int *)(iVar2 + 0x2e6) != 0) {
            ...
            *(undefined2 *)puVar5 = 0xffff;
            st::fn_00401717(*(MMsgTy **)(iVar2 + 0x2e6),0,(int)&local_26c,0,0);
            /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
...

{
  ...
  if (iVar3 == 0) {
    ...
    do {
      ...
      do {
        if ((undefined4 *)*puVar4 != nullptr) {
          st::fn_006C4A70((undefined4 *)*puVar4);
          *puVar4 = 0;
        }
        if (puVar4[-0x2d] != 0) {
          st::fn_006F20E0(g_cMf32_00806780,puVar4 + -0x2d);
        }
        pCVar2 = local_8;
        puVar4 = puVar4 + 1;
        iVar6 = iVar6 + -1;
    ...
    do {
      ...
      if (puVar5[-4] != 0) {
        st::fn_006F20E0(g_cMf32_00806780,puVar5 + -4);
      }
      puVar5 = puVar5 + 1;
      iVar3 = iVar3 + -1;
    } while (iVar3 != 0);
...

{
  ...
  if (g_startSystem_0081176C->field_0028 == 0) {
    ...
    pBVar4 = (BITMAPINFO *)st::fn_0070A9F0(g_cMf32_00806780,text,bVar10,iVar5);
    st::fn_00403738(0xa5,0x37,'\x01',pBVar4);
  }
  else {
  ...
  if (cVar1 == '\x01') {
    ...
    if (local_8 != 0) {
      ...
      if (*(int *)(iVar6 + 0x2e6) != 0) {
        ...
        st::fn_00404B51(*(MMsgTy **)(iVar6 + 0x2e6),(int)&local_28);
      }
...
LAB_00591d08:
          ...
          if (*(char *)((int)puVar12 + -0xbd) != '\0') {
            if (*puVar12 != 0xffffffff) {
              st::fn_006B3AF0((int *)puVar12[0x11],*puVar12);
            }
            if ((*(char *)((int)puVar12 + -0x96) != '\0') &&
               (STField<uint>(puVar12,0x91) != 0xffffffff)) {
              st::fn_006B3AF0(STField<int *>(puVar12,0xd5),STField<uint>(puVar12,0x91));
            }
...
LAB_00592933:
  ...
  st::fn_00404BF1(this_00,uVar10,cVar11,iVar3);
switchD_00592962_caseD_1:
  ...
  do {
    ...
    if ((&this_00->field_1B13)[*piVar9 + iVar3 * 0xf] != 0) {
      ...
      st::fn_00403409((int *)(&this_00->field_1B13)[*piVar9 + iVar3 * 0xf]);
    }
    piVar9 = piVar9 + 1;
    local_24[5] = local_24[5] + -1;
  } while (local_24[5] != 0);
  ...
  do {
    ...
    if (pAVar1 != nullptr) {
      ...
      if (uVar10 <= local_8->field_0061 - piVar9[4]) {
        pBVar4 = (BITMAPINFO *)st::fn_0070B3A0(pAVar1,(int)(short)pAVar1->field_0029);
        st::fn_006B5F80((int *)g_ddxContext_008075A8,*piVar9,piVar9[1],(int)*(short *)(pAVar1 + 1),
                     (int)*(short *)&pAVar1[1].field_0x2);
        st::fn_00403738(*piVar9,piVar9[1],'\x01',pBVar4);
        if ((char)piVar9[5] != '\0') {
...

{
  ...
  local_54.previous = g_currentExceptionFrame;
  g_currentExceptionFrame = &local_54;
  iVar7 = st::fn_0072D7F0(local_54.jumpBuffer,0);
  this_00 = local_8;
  if (iVar7 != 0) {
    g_currentExceptionFrame = local_54.previous;
    iVar11 = st::fn_006AD4D0("E:\\__titans\\Start\\camp_obj.cpp",0x24f,0,iVar7,
                                "%s","CampaignTy::GetMessage");
    if (iVar11 != 0) {
      STDebugBreak(); /* noreturn in standalone pseudocode */
    }
    st::fn_006A5E40(iVar7,0,"E:\\__titans\\Start\\camp_obj.cpp",0x24f);
    return 0xffff;
  }
  ...
  if (SVar2 < MESS_FSGSTY_6941) {
    if (SVar2 == MESS_SHARED_6940) {
      ...
      if (g_startSystem_0081176C->field_0028 == 0) {
        ...
        bVar18 = 0;
        text = st::fn_006F2C00("CMPG_BKG",1,(uint)DAT_0080874e);
        pBVar8 = (BITMAPINFO *)st::fn_0070A9F0(g_cMf32_00806780,text,bVar18,iVar7);
        st::fn_00403738(0xa5,0x37,'\x01',pBVar8);
      }
  ...
  case MESS_SHARED_6940|MESS_SHARED_0008:
    st::external_00000080((LPSTR)&DAT_0080f22a,"%sMISS%d00.AVI",&DAT_00807784,(uint)DAT_0080874e);
  ...
  case MESS_FSGSTY_694A:
    if ((((DAT_00807dd1 & 0xffff0000) == 0xd0dd0000) && (DAT_0080874e == 3)) &&
      ...
      st::external_00000080(&DAT_0080ed16,"%s%s%s%d01",&DAT_00807680,PTR_s_MISSIONS__0079bfe8,puVar10,
                (uint)DAT_0080874e);
      puVar10 = PTR_s_TUTOR_0079bff0;
      if (this_00->field_1FFC == 0) {
        puVar10 = PTR_DAT_0079bfec;
      }
      st::external_00000080(&DAT_0080ef1e,"%s%s%d01",PTR_s_MISSIONS__0079bfe8,puVar10,
                (uint)DAT_0080874e);
      uVar13 = 0xffffffff;
      ...
      DAT_008087a0 = 8;
      iVar7 = st::fn_00404B4C((STAppC *)&DAT_00807620,1);
      if (iVar7 != 0) {
