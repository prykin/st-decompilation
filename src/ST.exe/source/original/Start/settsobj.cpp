...

{
  ...
  if (iVar6 != 0) {
    ...
    iVar9 = st::fn_006AD4D0("E:\\__titans\\Start\\settsobj.cpp",0x3b,0,iVar6,"%s",
                               "SettMapSTy::SetListCtrls");
    if (iVar9 == 0) {
      st::fn_006A5E40(iVar6,0,"E:\\__titans\\Start\\settsobj.cpp",0x3b);
      return;
    }
        ...
        if (pcVar10 != nullptr) {
          ...
          case 0:
            if (*(DArrayTy **)(pcVar10 + 0x50) != nullptr) {
              st::fn_006AE110(*(DArrayTy **)(pcVar10 + 0x50));
            }
            if (pSVar5->field_1E26 == '\x02') {
              puVar7 = st::fn_0040466A((int)local_8,(uint)(byte)pcVar10[2],0xffffffff);
            }
            else {
              puVar7 = st::fn_00403F44(local_8,(uint)(byte)pcVar10[3],DAT_0080995c);
            }
...

{
  ...
  if (iVar4 != 0) {
    ...
    iVar8 = st::fn_006AD4D0("E:\\__titans\\Start\\settsobj.cpp",0x86,0,iVar4,"%s",
                               "SettMapSTy::PrepPlList");
    if (iVar8 == 0) {
      st::fn_006A5E40(iVar4,0,"E:\\__titans\\Start\\settsobj.cpp",0x86);
      return;
    }
    STDebugBreak(); /* noreturn in standalone pseudocode */
  }
    ...
    if (0 < (int)pDVar6->count) {
      ...
      do {
        ...
        if ((pvVar5 != nullptr) && (STField<DArrayTy *>(pvVar5,0x50) != nullptr)) {
          st::fn_006AE110(STField<DArrayTy *>(pvVar5,0x50));
        }
...

{
  ...
  if (iVar13 != 0) {
    ...
    iVar23 = st::fn_006AD4D0("E:\\__titans\\Start\\settsobj.cpp",0x27d,0,iVar13,
                                "%s","SettMapSTy::GetMessage");
    if (iVar23 != 0) {
      STDebugBreak(); /* noreturn in standalone pseudocode */
    }
    st::fn_006A5E40(iVar13,0,"E:\\__titans\\Start\\settsobj.cpp",0x27d);
    return 0xffff;
  }
      ...
      if (pvVar18 != nullptr) {
        ...
        if (cVar25 == '\0') {
          if (STField<byte>(pvVar18,2) != 0xff) {
            st::fn_00403F67(&DAT_00807620,STField<byte>(pvVar18,2));
          }
      ...
      if (this_00->field_1E26 == CASE_6) {
        if ((this_00->field_1F47 == 0) && ((message->arg0).u32 == 0)) {
          ...
          if (*(int *)(pMVar6 + 0x2e6) != 0) {
            ...
            local_74 = 0x693f;
            local_64[2] = local_7c;
            iVar13 = st::fn_00403FA8(*(MMsgTy **)(pMVar6 + 0x2e6),0x251f,'\x01',local_64,local_84
                                        ,nullptr,0,0);
            if (iVar13 != 0) {
              this_00->vfunc_24();
            }
...
LAB_005d619b:
      ...
      case 2:
        ...
        memmove(pcVar32, pcVar15, uVar28); /* compiler REP MOVS byte copy */
        uVar27 = 0;
        for (puVar19 = st::fn_0072E560((uint *)&this_00->field_0x1e33,'\n');
            puVar19 != nullptr; puVar19 = st::fn_0072E560(puVar19,'\n')) {
...
LAB_005d6784:
  ...
  local_28 = uVar28;
  st::fn_006B4170((RecoveredSourceFamily_dibcopy *)this_00->field_20F4[uVar28],0,*piVar9 + -0x113,0,
  ...
  case (undefined1 *)0x1:
    if (*(char *)pAVar34 != '\0') {
      ...
      if (pAVar34->field_0x2 != -1) {
        ...
        st::fn_006B4170((RecoveredSourceFamily_dibcopy *)this_00->field_20F4[uVar28],0,local_24 + 2,
...
LAB_005d6c37:
    ...
    st::fn_007119C0(pSVar11->field_0034,&DAT_0080f33a,-1,-1,2);
    uVar28 = local_28;
    break;
  case (undefined1 *)0x3:
    st::fn_00404C5F
    ...
    iVar13 = local_1c;
    puVar19 = (uint *)st::fn_00401C0D(this_00,pAVar34);
    goto LAB_005d6d70;
  case (undefined1 *)0x4:
    st::fn_00404C5F((MMObjTy *)this_00,this_00->field_20F4[uVar28],&local_24,2,0x67,0x67);
    if (pAVar34->field_0x4 == '\x02') {
      ...
      iVar23 = -1;
      iVar13 = -1;
      puVar19 = st::fn_0040326F(g_startSystem_0081176C->field_0034,(uint *)&pAVar34->field_0xa,
                                   (uint *)&DAT_007c7274,local_1c);
      st::fn_007119C0(g_startSystem_0081176C->field_0034,puVar19,iVar13,iVar23,uVar27);
      break;
    }
    ...
    iVar13 = local_1c;
LAB_005d6d70:
    puVar19 = st::fn_0040326F(g_startSystem_0081176C->field_0034,puVar19,puVar36,iVar13);
    st::fn_007119C0(g_startSystem_0081176C->field_0034,puVar19,iVar23,iVar37,uVar27);
    break;
  case (undefined1 *)0x5:
    if ((*(char *)pAVar34 != '\0') &&
       (st::fn_00404C5F
      ...
      if (DAT_00808a8f == '\0') {
        if (((DAT_0080874d != 0xff) && (bVar22 = pAVar34->field_0x2, bVar22 != 0xff)) &&
          ...
          if (-1 < iVar13 + -1) {
            pbVar16 = (byte *)st::fn_0070B3A0((AnonShape_GLOBAL_0081175C_57F682DD *)this_00->field_1F4B
                                           ,iVar13 + -1);
            st::fn_00403229((RecoveredSourceFamily_dibcopy *)this_00->field_20F4[uVar28],
...
switchD_005d6abd_default:
  st::fn_006B35D0((int *)g_ddxContext_008075A8,this_00->field_20CC[uVar28]);
