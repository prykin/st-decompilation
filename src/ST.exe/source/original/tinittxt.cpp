...

{
  ...
  if (iVar2 == 0) {
    pAVar3 = (AnonShape_006DBCA0_EF06575F *)st::fn_006B04D0(0x4f2);
    if (pAVar3 == nullptr) {
      g_sT3DSMAPContext_0080760C = nullptr;
    }
    else {
      g_sT3DSMAPContext_0080760C = (ST3DSMAPContext *)st::fn_006DBCA0(pAVar3);
    }
    ...
    pDVar4 = st::fn_006AE290(nullptr,0x14,8,0x14);
    param_1->field_044D = pDVar4;
    pDVar4 = st::fn_006AE290(nullptr,0x14,0xc,0x14);
    ...
    if (0 < iVar6) {
      do {
        ...
        if (0 < iVar2) {
          do {
            st::fn_00404B79((AnonShape_00574920_7507981E *)param_1,iVar6,local_c,local_8);
            iVar6 = iVar6 + 1;
          } while (iVar6 < iVar2);
        }
        local_c = local_c + 1;
