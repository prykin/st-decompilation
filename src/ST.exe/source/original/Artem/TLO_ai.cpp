...

{
  ...
  if (iVar3 != 0) {
    ...
    iVar5 = st::fn_006AD4D0("E:\\__titans\\Artem\\TLO_ai.cpp",0x313,0,iVar3,"%s",
  ...
  if (((-1 < *param_3) && (local_8 = *param_4, -1 < local_8)) && (-1 < *param_5)) {
    ...
    iVar3 = st::fn_00402829((short)*param_3,local_8,*param_5,param_2,param_1,nullptr,
  ...
  if (piVar1 == (icall_004A0EE0_FUN_004a0ee0_for_STGroupBoatC *)0x1) {
    uVar4 = st::fn_004033FA(param_1,param_2,param_3,param_4,param_5,param_6,param_7);
    g_currentExceptionFrame = local_50.previous;
    return uVar4;
  }
  ...
  uVar4 = st::fn_00405632(param_1,param_2,param_3,param_4,param_5,param_6,param_7);
  g_currentExceptionFrame = local_50.previous;
  return uVar4;
}
