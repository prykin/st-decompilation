...
undefined4 __fastcall st::fn_004D9C80(RecoveredRecordView_004D9C80_63C53606 *param_1)

{
  ...
  if (*(int *)&param_1->field_0x4d0 == 4) {
    ...
    st::external_00000080(reinterpret_cast<LPSTR>(local_108),st::mutable_c_string("%s"),"lasbom");
...
undefined4 __fastcall st::fn_004DA230(RecoveredRecord_004DA230_146070EB *param_1)
...
undefined4 __fastcall st::fn_004DA2B0(RecoveredRecord_004DA2B0_CDACE95B *param_1)

{
  ...
  case 2:
    ...
    break;
  case 4:
    if (param_1->field_04D4 < DAT_00798eb0) {
      return 0;
    }
  case 0:
  case 1:
