...

{
  ...
  iVar10 = st::fn_0072D7F0
                     (local_2c0.jumpBuffer,2,Library::MSVCRT::FUN_0072da21,0xffffffff);
  local_1c = &stack0xfffffc94;
  if (iVar10 != 0) {
    g_currentExceptionFrame = local_2c0.previous;
    iVar27 = st::fn_006AD4D0("E:\\__titans\\Artem\\TLO_ai_fnd.cpp",0x3c1,0,iVar10,
                                "%s","TLOAiBldPlacesFind error !");
    if (iVar27 == 0) {
      st::fn_006A5E40(iVar10,0,"E:\\__titans\\Artem\\TLO_ai_fnd.cpp",0x3c2);
      ExceptionList = local_14;
      return iVar10;
    }
  ...
  if (param_2[3] == 0) {
    pDVar11 = st::fn_006AE290(nullptr,10,0x14,10);
  ...
  *(undefined4 *)(param_2[3] + 4) = 0;
  ...
  if (0 < (int)pDVar11->count) {
    do {
      st::fn_006ACC70(pDVar11,uVar22,&local_a0);
      iVar10 = st::fn_00402829((short)local_9c,local_98,local_94,local_a0,param_1,
      ...
      if (iVar10 == 0) {
        ...
        st::fn_006B0C70((DArrayTy *)param_2[5],uVar22);
      }
      else {
        bVar29 = true;
        *(undefined4 *)(param_2[4] + 4) = 0;
        iVar10 = st::fn_006B1190((DArrayTy *)param_2[4],(byte *)&local_70);
        while (-1 < iVar10) {
  ...
  if (((local_4c[0] != 0) || (local_4c[1] != 0)) && (g_array_007FA150 != nullptr)) {
    ...
    local_a4 = pDVar11;
    iVar10 = st::fn_006B1190(g_array_007FA150,(byte *)&local_58);
    while (-1 < iVar10) {
      if (local_58 != nullptr) {
      ...
      while (-1 < iVar10) {
        ...
        while( true ) {
          ...
          if (uVar22 < pDVar11->count) {
            pbVar12 = DArrayAt<byte>(pDVar11, uVar22);
          ...
          if ((((((bVar8 & 1) != 0) && ((bVar8 & 4) == 0)) && (*(int *)(pbVar12 + 5) == iVar10)) &&
              (pbVar25 = pbVar12, pbVar24 != nullptr)) &&
             ((pDVar11 = local_a4, (bVar8 & 0x20) < (*pbVar24 & 0x20) ||
...
switchD_004b38f0_caseD_3a:
    ...
    if (*ppDVar2 != nullptr) {
      ...
      iVar10 = st::fn_006B1190(*ppDVar2,(byte *)&local_58);
      while (iVar10 != 0) {
        st::fn_004018C5(local_58,local_7c,local_8c,local_a8);
        local_88 = -1;
        pDVar11->iteratorIndex = 0;
        ...
        while( true ) {
          uVar22 = pDVar11->iteratorIndex;
          if (uVar22 < pDVar11->count) {
            pbVar24 = DArrayAt<byte>(pDVar11, uVar22);
            pDVar11->iteratorIndex = uVar22 + 1;
          }
          else {
            pbVar24 = nullptr;
          ...
          if ((((*pbVar24 & 6) != 0) && ((*pbVar24 & 0x18) == 0)) &&
             ((iVar10 = st::fn_006ACED8((int)local_7c[0],(int)local_8c[0],*(int *)(pbVar24 + 9),
                                     *(int *)(pbVar24 + 0xd)), pbVar25 == nullptr ||
              (iVar10 < local_88)))) {
            pbVar25 = pbVar24;
            local_88 = iVar10;
          }
    ...
    if (local_4c[1] != 0) {
      ...
      if (0 < (int)pDVar11->count) {
        do {
          st::fn_006ACC70(pDVar11,uVar22,&local_2ec);
          if (((local_2ec & 0x18) == 0) && (((local_2ec & 1) == 0 || ((local_2ec & 4) != 0)))) {
            uVar22 = uVar22 + 1;
          }
          else {
            st::fn_006B0C70(pDVar11,uVar22);
          }
        } while ((int)uVar22 < (int)pDVar11->count);
      }
        ...
        do {
          ...
          if (uVar22 != 1 && -1 < (int)(uVar22 - 1)) {
            do {
              pDVar11 = local_a4;
              if (uVar19 < uVar22) {
                pbVar25 = DArrayAt<byte>(pDVar23, uVar19);
              }
              else {
                pbVar25 = nullptr;
              }
              uVar1 = uVar19 + 1;
              if (uVar1 < uVar22) {
                pbVar24 = DArrayAt<byte>(pDVar23, uVar1);
              }
              else {
                pbVar24 = nullptr;
              }
              if (((*pbVar24 & 0x20) < (*pbVar25 & 0x20)) ||
                ...
                st::fn_006B0CD0((AnonShape_00413AF0_B6B4EE9A *)local_a4,uVar19,uVar1);
                local_50 = 1;
              }
              uVar22 = pDVar11->count;
              pDVar23 = pDVar11;
      ...
      local_134 = (-(uint)(bVar8 != 3) & 0xffffffdb) + 0x60;
      *(undefined4 *)(param_2[3] + 4) = 0;
      iVar10 = st::fn_006B1190((DArrayTy *)param_2[3],(byte *)local_108);
      while (-1 < iVar10) {
        if (local_108[0] == local_134) {
          uVar22 = pDVar11->iteratorIndex;
          if (uVar22 < pDVar11->count) {
            pbVar25 = DArrayAt<byte>(pDVar11, uVar22);
            pDVar11->iteratorIndex = uVar22 + 1;
          }
          else {
            pbVar25 = nullptr;
          }
          if (pbVar25 == nullptr) break;
          local_11c = *(int *)(pbVar25 + 9);
          local_138 = *(int *)(pbVar25 + 0xd);
          local_254[0] = *(int *)(pbVar25 + 0x11);
          iVar10 = st::fn_004019EC(param_1,local_134,&local_11c,&local_138,local_254,0,1);
          /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
          if ((iVar10 != 0) &&
             ((*(int *)(pbVar25 + 0x19) < 0 ||
              (iVar10 = st::fn_006ACED8(local_11c,local_138,*(int *)(pbVar25 + 9),
...
cf_break_loop_004B60CD:
    ...
    iVar10 = 0x42;
    do {
      if ((DArrayTy *)*puVar26 != nullptr) {
        st::fn_006AE110((DArrayTy *)*puVar26);
      }
      puVar26 = puVar26 + 1;
      iVar10 = iVar10 + -1;
    } while (iVar10 != 0);
  ...
  if (local_4c[2] != 0) {
    local_27c = &stack0xfffffc94;
    local_1c = &stack0xfffffc94;
    pDVar11 = st::fn_006AE290(nullptr,10,0xc,10);
    local_22c = pDVar11;
    if ((g_array_007FA16C != nullptr) && (uVar22 = 0, 0 < (int)g_array_007FA16C->count)) {
      do {
        st::fn_006ACC70(g_array_007FA16C,uVar22,&local_58);
        st::fn_004018C5(local_58,local_7c,local_8c,local_a8);
        local_144 = (int)local_7c[0];
        local_140 = (int)local_8c[0];
        local_13c = (int)local_a8[0];
        st::fn_006AE1C0(pDVar11,&local_144);
        uVar22 = uVar22 + 1;
  ...
  iVar21 = local_13c;
  if (local_4c[3] != 0) {
    local_184 = st::fn_006AE290(nullptr,10,0xc,10);
    pDVar11 = g_packedRecords_A62x8[param_1].field1968_0x9d6;
    if ((pDVar11 != nullptr) && (uVar22 = 0, 0 < (int)pDVar11->count)) {
      do {
        st::fn_006ACC70(pDVar11,uVar22,&local_58);
        st::fn_004018C5(local_58,local_7c,local_8c,local_a8);
        local_144 = (int)local_7c[0];
        local_140 = (int)local_8c[0];
        local_13c = (int)local_a8[0];
        st::fn_006AE1C0(local_184,&local_144);
        uVar22 = uVar22 + 1;
        pDVar11 = g_packedRecords_A62x8[param_1].field1968_0x9d6;
      } while ((int)uVar22 < (int)pDVar11->count);
    }
  ...
  local_20 = st::fn_006AE290(nullptr,10,0x30,10);
  local_64 = 0;
  local_114 = 0;
LAB_004b40f9:
  do {
...
LAB_004b4689:
      *(undefined4 *)(param_2[5] + 4) = 0;
      ...
      pSVar6 = local_58;
      pDVar7 = local_20;
      while (local_27c = puVar28, local_22c = pDVar11, local_184 = pDVar23, local_a4 = pDVar5,
            local_a0 = GVar16, local_9c = iVar10, local_98 = iVar27, local_94 = iVar21,
            local_58 = pSVar6, local_20 = pDVar7, -1 < iVar13) {
        ...
        *(undefined4 *)(param_2[3] + 4) = 0;
        ...
        while (-1 < iVar10) {
          if (*(int *)(&DAT_00790888 + local_108[0] * 4) == 4) {
            ...
            local_f4[0] = 0;
            st::fn_006AE1C0(local_20,local_f4);
          }
          iVar10 = st::fn_006B1190((DArrayTy *)param_2[3],(byte *)local_108);
        }
      }
                      ...
                      if (bVar8 == 3) {
                        if (local_4c[3] != 0) {
                          if ((local_184 == nullptr) || (local_184->count == 0)) {
                            ...
                            if (0 < (int)local_184->count) {
                              do {
                                st::fn_006ACC70(pDVar23,uVar22,&local_144);
                        ...
                        if ((local_22c != nullptr) && (local_22c->count != 0)) {
                          ...
                          if (0 < (int)local_22c->count) {
                            do {
                              st::fn_006ACC70(pDVar11,uVar22,&local_144);
                              iVar10 = st::fn_006ACED8(local_11c,local_138,local_144,local_140);
...
LAB_004b4c78:
                      if (((local_270 == 0) || (bVar8 = st::fn_004049B7(recordIndex), bVar8 == 3))
                         && (local_10c != 0)) {
                        if (local_124 != 0) {
                          uVar22 = 0;
                          do {
                      ...
                      if ((local_4c[4] == 0) || (uVar22 != 0)) {
                        ...
                        *(undefined4 *)(param_2[3] + 4) = 0;
                        ...
                        while (local_20 = pDVar11, -1 < iVar27) {
                          ...
                          {
                            bVar8 = st::fn_004049B7(recordIndex);
                            GVar16 = (-(uint)(bVar8 != 3) & 0xffffffd6) + 100;
                            if (local_270 == 0) {
                              if (local_108[0] == GVar16) goto cf_common_join_004B5648;
LAB_004b5614:
                              if (((local_270 != 0) &&
                                  (bVar8 = st::fn_004049B7(recordIndex), bVar8 != 3)) ||
                                 (*(int *)(&DAT_00791d68 + local_108[0] * 4) == iVar10)) {
                                local_a0 = local_108[0];
                                local_90 = local_f8;
                                local_9c = local_11c;
...
LAB_004b50f4:
                                ...
                                if (0 < (int)pDVar11->count) {
                                  do {
                                    st::fn_006ACC70(pDVar11,uVar22,&local_144);
                                    iVar27 = st::fn_006ACED8(local_11c,local_138,local_144,local_140);
                              ...
                              local_140 = local_138;
                              local_13c = local_254[0];
                              st::fn_006AE1C0((DArrayTy *)*piVar17,&local_144);
...
LAB_004b52b6:
                            ...
                            if (*(int *)(&DAT_00790888 + local_108[0] * 4) == 10) {
                              ...
                              local_78 = st::fn_00405C45(param_1,GVar16 - 0x32,0);
                              puVar28 = local_27c;
          ...
          do {
            ...
            if (local_58 == nullptr) {
              ...
              if (((((sVar18 < 0) || (g_worldGrid.sizeX <= sVar18)) ||
                ...
                sVar18 = STGridAt3D(g_pathingGrid, sVar18, sVar9, sVar20);
              }
              if (sVar18 == 0) {
                ...
                *(ushort *)(puVar28 + iVar10 * 2) =
                ...
                if ((uVar22 < 8) &&
                   ((g_playSystem_00802A38 == nullptr ||
                    (g_bulkInitializedRecords_008087C7[uVar22].field_0022 < 8)))) {
                  bVar8 = *(byte *)&local_58->field_0024;
                  if (g_app_00806728->field_146F == '\0') {
                    if (bVar8 == recordIndex) {
                      iVar27 = 0;
                    }
                    else {
                      uVar22 = (uint)bVar8;
                      uVar19 = param_1 & 0xff;
                      cVar3 = (&g_app_00806728->field_0x142f)[uVar19 + uVar22 * 8];
                      puVar28 = local_27c;
                      if ((cVar3 == '\0') &&
                         ((&g_app_00806728->field_0x142f)[uVar22 + uVar19 * 8] == '\0')) {
                        iVar27 = -2;
                      }
                      else if ((cVar3 == '\x01') &&
                              ((&g_app_00806728->field_0x142f)[uVar22 + uVar19 * 8] == '\0')) {
                        iVar27 = -1;
                              ...
                              ((&g_app_00806728->field_0x142f)[uVar22 + uVar19 * 8] == '\x01')) {
                        iVar27 = 1;
                      }
                      else if ((cVar3 == '\x01') &&
                              ((&g_app_00806728->field_0x142f)[uVar22 + uVar19 * 8] == '\x01')) {
                    ...
                    bVar29 = (&g_app_00806728->field_0x11ca)[(param_1 & 0xff) * 0x51] !=
                             (&g_app_00806728->field_0x11ca)[(uint)bVar8 * 0x51];
                  }
                  if (bVar29) {
                    *(ushort *)(puVar28 + iVar10 * 2) =
...
LAB_004b56e4:
    uVar22 = pDVar11->iteratorIndex;
    if (uVar22 < pDVar11->count) {
      piVar17 = DArrayAt<int>(pDVar11, uVar22);
      pDVar11->iteratorIndex = uVar22 + 1;
    }
    else {
      piVar17 = nullptr;
    }
    if (piVar17 == nullptr) goto LAB_004b5727;
  }
  *piVar17 = 1;
  piVar17[1] = local_11c;
  piVar17[2] = local_138;
