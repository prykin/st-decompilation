...
undefined4 __fastcall st::fn_004DCE00(RecoveredRecordView_004DCE00_6036DD04 *param_1)

{
  float fVar1;
  STT3DSprC *pSVar2;
  int iVar3;
  STT3DSprC *pSVar2_mg2;
  int uVar4;
  uint uVar5;
  CHAR local_108 [256];
  int local_8;
  ...
  if (param_1->field_05FF == nullptr) {
    ...
    iVar3 = st::fn_0040537B(pSVar2,PTR_008073cc,0x5a,0x45,nullptr,0xb4,0x8c,0x11);
    if (iVar3 != 0) {
      st::fn_006A5E40
  ...
  if (*(int *)&param_1->field_0x4d0 == 1) {
    ...
    st::external_00000080(reinterpret_cast<LPSTR>(local_108),st::mutable_c_string("%s"),"jmpmine");
    /* ST_CALLSITE[004DCECB]: CALL 0x00404183; direct=00404183 STT3DSprC::LoadSequence */
    iVar3 = st::fn_00404183(param_1->field_05FF,0xe,PTR_00806774,reinterpret_cast<char *>(local_108),CASE_1D);
    if (iVar3 != 0) {
      st::fn_006A5E40
    ...
    pSVar2_mg2 = st::pointer_boundary_cast<STT3DSprC *>(st::fn_004052CC(reinterpret_cast<STT3DSprC *>(&param_1->field_0x1d5)));

    uVar4 = st::fn_004052CC(param_1->field_05FF);
    st::fn_006EA340(param_1->field_0211,uVar4,(int)pSVar2_mg2,uVar5);
    ...
    *(uint *)&param_1->field_0x4d8 = uVar5;
    ...
    st::fn_00402982(param_1->field_05FF,1);
  ...
  st::fn_00403D0F(param_1->field_05FF);
  return 0;
}
