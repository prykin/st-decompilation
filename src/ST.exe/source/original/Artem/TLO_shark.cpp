...
undefined4 __fastcall st::fn_004E3880(RecoveredRecordView_004E3880_20FD9D65 *param_1)

{
  ...
  exceptionCode =
       st::fn_00404183
                 (reinterpret_cast<STT3DSprC *>(&param_1->field_0x1d5),0xb,PTR_0080678c,st::mutable_c_string("sha_ani1"),CASE_1D);
  if (exceptionCode != 0) {
    st::fn_006A5E40
