...

{
  ...
  if (local_EAX_51 != 0) {
    ...
    iVar10 = st::fn_006AD4D0("E:\\__titans\\Artem\\TLO_embryo.cpp",0x166,0,local_EAX_51,
                                "%s","Int TLOEmbryoTy::Create(LPtrTy _param) error !");
    if (iVar10 == 0) {
      st::fn_006A5E40(local_EAX_51,0,"E:\\__titans\\Artem\\TLO_embryo.cpp",0x167);
      return local_EAX_51;
    }
  ...
  if (this_00->field_023D != 1) {
    if (this_00->field_023D == 2) {
      ...
      *local_28 = PTR_00806774;
      ...
      local_EAX_1470 =
           st::fn_006AD4D0("E:\\__titans\\Artem\\TLO_embryo.cpp",0x160,0,0,"%s",
...
LAB_004d1bda:
  ...
  st::external_00000080(local_88,"%s%1i",(&PTR_s_tlo_embws1_007bf3e8)[this_00->field_036C],uVar7);
...
LAB_004d204d:
    ...
    do {
      ...
      *ppSVar17 = pSVar6;
      ...
      iVar11 = st::fn_00404183(*ppSVar17,0xe,PTR_0080678c,PTR_s_tlo_emb6_00790c20,CASE_1D);
      if (iVar11 != 0) {
        st::fn_006A5E40
                  (iVar11,g_overwriteContext_007ED77C,"E:\\__titans\\Artem\\TLO_embryo.cpp",
                   0x10e);
...

{
  ...
  if (local_EAX_39 != 0) {
    ...
    iVar12 = st::fn_006AD4D0("E:\\__titans\\Artem\\TLO_embryo.cpp",0x4e5,0,local_EAX_39,
                                "%s","TLOEmbryoTy::GetMessage error");
    if (iVar12 == 0) {
      st::fn_006A5E40(local_EAX_39,0,"E:\\__titans\\Artem\\TLO_embryo.cpp",0x4e6);
      return local_EAX_39;
    }
    STDebugBreak(); /* noreturn in standalone pseudocode */
  }
