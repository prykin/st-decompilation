...

{
  ...
  do {
    ...
    if (param_3 != 0) {
      iVar16 = 1;
      bVar13 = 2;
      pcVar5 = st::fn_0040456B((char *)&DAT_007d59a4,local_20);
...
LAB_00691a65:
                  ...
                  if (iVar10 == 0) {
                    puVar9 = static_cast<uint *>(st::fn_006AAC70(0x640));
                    *(undefined4 **)
                     ((int)local_14 +
          ...
          uVar17 = 0;
          uVar14 = 0;
          pcVar5 = st::fn_0040456B(st::mutable_c_string("STONE"),iVar10);
    ...
    if (param_3 != 0) {
      iVar16 = 1;
      bVar13 = 2;
      pcVar5 = st::fn_0040456B(st::mutable_c_string("CRACK"),iVar10);
      pcVar5 = st::fn_00725C60(param_2,pcVar5,bVar13,iVar16);
