...

{
  ...
  iVar9 = 4;
  g_bldBoatPanel_0080167C = reinterpret_cast<ProdPanelTy *>(local_1c);
  ...
  /* ST_CALLSITE[004EEAEE]: CALL 0x0070ceb0; direct=0070CEB0 ccFntTy::operator_new; [STCallResultViewApplier] readability_validated; exact direct-call result=pointer:/ccFntTy; signature=__cdecl;pointer:/ccFntTy;/uint;pointer:/cMf32;pointer:/char;/byte */
  pcVar4 = st::pointer_boundary_cast<ccFntTy *>(st::fn_0070CEB0(0x19d,g_cMf32_00806790,st::mutable_c_string("HOLD_FONT"),0));
  ...
  puVar6 = st::fn_006F1CE0(g_cMf32_00806790,1,reinterpret_cast<char *>(pCVar5),piVar14,iVar9);
  ...
  st::external_00000080(reinterpret_cast<LPSTR>(text),st::mutable_c_string("%s0"),pCVar5);
  ...
  st::external_00000080(reinterpret_cast<LPSTR>(text),st::mutable_c_string("BOATS_%d"),iVar9);
  ...
  st::fn_00404241
            (reinterpret_cast<ProdPanelTy *>(this_00),0x2723,0x3f,2,0xc1,0xc,0x85,99,0x68,0xc4,99,0x20,0x13,0x33,
             reinterpret_cast<char *>(pCVar5));
...
switchD_004eed0b_default:
  ...
  local_20 = 1;
  local_44 = local_64;
  /* ST_CALLSITE[004EEDB2]: CALL dword ptr [EDX + 0x8]; [STIndirectCallsiteApplier] exact slot 0x8; mode=structural-presentation; signature=__thiscall;/undefined4;pointer:/void;/undefined4;/undefined4;/undefined4;/undefined4;/undefined4 */
...

{
  ...
  if (errorCode == 0) {
    ...
    st::fn_004035BC
              (g_allPlayers_007FA174,7,reinterpret_cast<RecoveredRecordView_0043BEB0_8330D129 *>(&local_8->field_027A)
              );
...
void __thiscall
st::fn_004EF320(BldBoatPanelTy *this,RecoveredRecordView_004EF320_A54422CD *param_1)

{
  ...
  BITMAPINFO *pBVar6;
  int iVar6;
  RecoveredGlobalRecordView_0081175C *pRVar7;
  int iVar8;
  ...
  if ((iVar5 == 0) || (STField<uint>(iVar5,0xC) <= uVar1)) {
    local_8 = nullptr;
  }
  else {
    local_8 = (Global_sub_00526BA0_param_1Enum *)
              (STField<int>(iVar5,0x8) * uVar1 + STField<int>(iVar5,0x1C));
  }
  local_18 = this;
  if ((param_1->field_0014 == 0) || (local_8 == nullptr)) {
    local_10 = reinterpret_cast<BITMAPINFO *>(this->field_028E);
  }
  else {
    if ((char)local_8[2] == 0) {
      pRVar7 = reinterpret_cast<RecoveredGlobalRecordView_0081175C *>(this->field_018C);
    }
    else {
      pRVar7 = reinterpret_cast<RecoveredGlobalRecordView_0081175C *>(this->field_0188);
    }

    iVar5 = st::fn_004056F5(*local_8,STField<byte>(local_8,9));
    local_10 = st::fn_0070B3A0(pRVar7,iVar5);
  }
  ...
  st::fn_00403229((RecoveredSourceFamily_dibcopy *)pBVar3->field_0068,iVar5 + 1,uVar1 + 1,'\x01',
  ...
  if (param_1->field_0014 == 3) {
    ...
    iVar8 = (-st::storage_bit_cast<uint>(static_cast<uint32_t>((char)local_8[2] != 0)) & 2) + 3;
  }
  else {
    iVar8 = 4;
  }
  /* ST_CALLSITE[004EF46E]: CALL 0x0070b3a0; direct=0070B3A0 FUN_0070b3a0; [STCallResultViewApplier] presentation_only; exact direct-call result=pointer:/SubmarineTitans/Recovered/PointerShapes/RecoveredRecordView_006B84D0_87AF9D9B; source view only; no Ghidra override */
  pBVar6 = st::fn_0070B3A0(pBVar3->field_0190,iVar8);
  /* ST_CALLSITE[004EF47C]: CALL 0x00403229; direct=00403229 DibPut */
  st::fn_00403229((RecoveredSourceFamily_dibcopy *)pBVar3->field_0068,iVar5,uVar1,'\x06',
  ...
  if ((((local_8 != nullptr) && (local_8[1] != 0)) &&
    ...
    st::external_00000080(reinterpret_cast<LPSTR>(&pBVar3->field_006C),st::mutable_c_string("%d"),local_8[1]);

    st::fn_00710A90(pBVar3->field_028A,pBVar3->field_0068,0,iVar5,uVar1,local_14[2],local_14[3]);
...
LAB_004ef4e9:
  ...
  st::fn_006B3640
            (reinterpret_cast<int *>(g_ddxContext_008075A8),pBVar3->field_0060,0xffffffff,pBVar3->field_003C,
             pBVar3->field_0044);
  g_currentExceptionFrame = local_60.previous;
  return;
}
...

{
  ...
  if (SVar1 < 0xb203) {
    if (SVar1 == MESS_SHARED_B202) {
      ...
      st::fn_00401CE4
                (reinterpret_cast<ProdPanelTy *>(this_00),reinterpret_cast<AnonShape_0053FCD0_D10A885A *>(message),st::function_address_boundary_cast<code *>(st::fn_004EF5F0));
      g_currentExceptionFrame = local_58.previous;
      return 0;
    }
    ...
    if (SVar1 == MESS_SHARED_0003) {
      st::fn_00404DAE(reinterpret_cast<RecoveredRecordView_004EEF20_EAA30B4A *>(this_00));
      g_currentExceptionFrame = local_58.previous;
      return 0;
    }
    ...
    case MESS_SHARED_C0A3:
      ...
      if ((puVar6 != nullptr) && (((char *)puVar6)[2] != '\0')) {
        ...
        st::fn_00403C33
                  (g_playSystem_00802A38,(undefined4 *)0x1e,reinterpret_cast<uint *>(&local_14),0,0xffffffff);
        st::fn_00405E2F(0xae);
        g_currentExceptionFrame = local_58.previous;
        return 0;
      }
    ...
    case MESS_BLDLABPANELTY_C0B3:
      ...
      st::fn_004011EA(this_00,reinterpret_cast<RecoveredRecordView_004EF320_A54422CD *>(message));
    }
  }
  g_currentExceptionFrame = local_58.previous;
  return 0;
