...

{
  ...
  if (iVar2 == 0) {
    ...
    uVar3 = st::fn_006B4FE0(DAT_0080679c);
    piVar3 = (int *)st::fn_006B50C0(this_00->field_0040,this_00->field_0048,
    ...
    puVar4 = (undefined4 *)st::fn_006B4FA0(piVar3);
    ...
    st::fn_006B2330(g_ddxContext_008075A8,puVar4,this_00->field_0064,0x4057ea,this_00->field_0040,
                 this_00->field_0048,(ushort *)this_00->field_0068);
    st::fn_006B1B10((AnonShape_006B1B10_121F236C *)g_ddxContext_008075A8,*puVar4,3);
    st::fn_006B3640
  ...
  g_currentExceptionFrame = local_4c.previous;
  iVar5 = st::fn_006AD4D0("E:\\__titans\\Andrey\\panel.cpp",0x2a,0,iVar2,"%s",
                             "PanelTy::InitPanel");
  if (iVar5 != 0) {
    STDebugBreak(); /* noreturn in standalone pseudocode */
  }
  st::fn_006A5E40(iVar2,0,"E:\\__titans\\Andrey\\panel.cpp",0x2a);
  return;
}
...

{
  ...
  if (iVar3 == 0) {
    ...
    st::fn_006E6000(local_8,3,1,(undefined4 *)&local_8->field_0x18);
    if (-1 < (int)pPVar2->field_0060) {
      st::fn_006B3BB0((int *)g_ddxContext_008075A8,pPVar2->field_0060);
    }
    pPVar2->field_0060 = 0xffffffff;
    if (pPVar2->field_0068 != 0) {
      st::fn_006AB060((void **)&pPVar2->field_0068);
    }
    g_currentExceptionFrame = local_4c.previous;
    return;
  }
  g_currentExceptionFrame = local_4c.previous;
  iVar4 = st::fn_006AD4D0("E:\\__titans\\Andrey\\panel.cpp",0x3c,0,iVar3,"%s",
                             "PanelTy::DonePanel");
  if (iVar4 != 0) {
    STDebugBreak(); /* noreturn in standalone pseudocode */
  }
  st::fn_006A5E40(iVar3,0,"E:\\__titans\\Andrey\\panel.cpp",0x3c);
  return;
}
...

{
  ...
  g_currentExceptionFrame = local_4c.previous;
  iVar5 = st::fn_006AD4D0("E:\\__titans\\Andrey\\panel.cpp",0x52,0,iVar4,"%s",
                             "PanelTy::GetMessage");
  if (iVar5 != 0) {
    STDebugBreak(); /* noreturn in standalone pseudocode */
  }
  st::fn_006A5E40(iVar4,0,"E:\\__titans\\Andrey\\panel.cpp",0x52);
  return 0xffff;
}
...

{
  ...
  g_currentExceptionFrame = local_48.previous;
  iVar2 = st::fn_006AD4D0("E:\\__titans\\Andrey\\panel.cpp",0x5c,0,errorCode,"%s",
                             "UPanelTy::OutProc");
  if (iVar2 != 0) {
    STDebugBreak(); /* noreturn in standalone pseudocode */
  }
  st::fn_006A5E40(errorCode,0,"E:\\__titans\\Andrey\\panel.cpp",0x5c);
  return;
}
...

{
  ...
  if (iVar3 == 0) {
    ...
    local_18c[1] = param_1;
    local_18c[0] = param_2;
    st::external_00000080(&pPVar2->field_006C,"%s0",param_8);
  ...
  g_currentExceptionFrame = local_1d0.previous;
  iVar4 = st::fn_006AD4D0("E:\\__titans\\Andrey\\panel.cpp",0x97,0,iVar3,"%s",
                             "PanelTy::CreateBut");
  if (iVar4 != 0) {
    STDebugBreak(); /* noreturn in standalone pseudocode */
  }
  st::fn_006A5E40(iVar3,0,"E:\\__titans\\Andrey\\panel.cpp",0x97);
  return 0;
}
...
LAB_00538a14:
  ...
  if (param_4 != nullptr) {
    ...
    g_currentExceptionFrame = local_58.previous;
    iVar5 = st::fn_006AD4D0("E:\\__titans\\Andrey\\panel.cpp",0xb2,0,(int)errorCode,
                               "%s","PanelTy::PaintBut");
    if (iVar5 != 0) {
      STDebugBreak(); /* noreturn in standalone pseudocode */
    }
    st::fn_006A5E40((int)errorCode,0,"E:\\__titans\\Andrey\\panel.cpp",0xb2);
  }
  return;
}
...
LAB_00538bd9:
  ...
  if (param_6 != nullptr) {
    ...
    g_currentExceptionFrame = local_5c.previous;
    iVar5 = st::fn_006AD4D0("E:\\__titans\\Andrey\\panel.cpp",0xcc,0,iVar3,"%s",
                               "PanelTy::PaintTxtBut");
    if (iVar5 != 0) {
      STDebugBreak(); /* noreturn in standalone pseudocode */
    }
    st::fn_006A5E40(iVar3,0,"E:\\__titans\\Andrey\\panel.cpp",0xcc);
  }
  return;
}
...
LAB_00538de2:
  ...
  if (errorCode != nullptr) {
    g_currentExceptionFrame = local_58.previous;
    iVar7 = st::fn_006AD4D0("E:\\__titans\\Andrey\\panel.cpp",0xdf,0,(int)errorCode,
                               "%s","PanelTy::PaintIBut");
    if (iVar7 == 0) {
      st::fn_006A5E40((int)errorCode,0,"E:\\__titans\\Andrey\\panel.cpp",0xdf);
      return;
    }
    STDebugBreak(); /* noreturn in standalone pseudocode */
  }
...
void __thiscall
st::fn_00538FC0(PanelTy *this,AnonShape_00538FC0_B5E96243 *param_1,byte param_2,char *param_3,
  ...
  if (param_5 != nullptr) {
    ...
    if (iVar4 == 0) {
      ...
      if (param_1->field_0014 == 3) {
        ...
        st::fn_00403229((RecoveredSourceFamily_dibcopy *)pPVar3->field_0068,local_c,iVar4,'\x06',
               (byte *)local_8);
        st::fn_006F20E0(g_cMf32_00806790,(uint *)&local_8);
      }
      st::fn_006B3640
    ...
    g_currentExceptionFrame = local_58.previous;
    iVar6 = st::fn_006AD4D0("E:\\__titans\\Andrey\\panel.cpp",0x102,0,iVar4,"%s",
                               "PanelTy::PaintLBut");
    if (iVar6 != 0) {
      STDebugBreak(); /* noreturn in standalone pseudocode */
    }
    st::fn_006A5E40(iVar4,0,"E:\\__titans\\Andrey\\panel.cpp",0x102);
  }
  return;
}
