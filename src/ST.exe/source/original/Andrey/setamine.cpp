...

{
  ...
  if (iVar3 == 0) {
    ...
    st::fn_00403800
              (reinterpret_cast<SpecPanelTy *>(local_14),st::mutable_c_string("BKG_SETANYW"),0x2f,2,0xc6,0xc,0x2735,0xc9,0x77);
    puVar16 = nullptr;
    iVar14 = 0;
    iVar12 = 1;
    bVar10 = 0;
    ...
    puVar4 = st::fn_00709AF0
                       (PTR_00806794,CASE_B,reinterpret_cast<char *>(pCVar3),uVar9,bVar10,iVar12,iVar14,puVar16);
    ...
    do {
      ...
      pCVar3 = st::fn_0040577C(st::mutable_c_string("BUT_PRODWEAP"),0);
      pCVar3 = st::fn_006F2C00(reinterpret_cast<char *>(pCVar3),iVar6,uVar7);
      iVar6 = local_8;
      /* ST_CALLSITE[0053CFE2]: CALL dword ptr [EDX + 0x4] */
      uVar7 = (*pSVar1->CreateBut)
                        (reinterpret_cast<PanelTy *>(this_00),0,1,0x24,local_8 + 1,0,1,1,pCVar3,arg_9,iVar14,sVar8,
      ...
      *local_c = uVar7;
      ...
      pRVar5 = st::pointer_boundary_cast<RecoveredRecordView_006B84D0_87AF9D9B *>(st::fn_00710BA0(this_00->field_0189,this_00->field_0185,0,0x37,iVar6,0xd2,0xc,0));
      if (pRVar5 != nullptr) {
        uVar9 = 0;
        iVar6 = -1;
        iVar14 = 0;
        ...
        pcVar17_mg1 = st::fn_006B0140(iVar12 - 0x842b,g_hINSTANCE_00807618);

        st::fn_007119C0(this_00->field_0189,pcVar17_mg1,iVar14,iVar6,uVar9);
        /* ST_CALLSITE[0053D041]: CALL 0x00403229; direct=00403229 DibPut */
        st::fn_00403229((RecoveredSourceFamily_dibcopy *)this_00->field_0068,0x37,local_8,'\x01',pRVar5);
    ...
    uVar7 = (*pSVar1->CreateBut)
                      (reinterpret_cast<PanelTy *>(this_00),0,1,0xa0,0x5c,0,1,1,pCVar3,uVar7,uVar13,sVar8,uVar11,
...

{
  ...
  if (param_1 != this->field_005C) {
    ...
    if (iVar3 == 0) {
      ...
      do {
        if (*piVar6 != 0) {
          st::fn_006E6080(this_00,2,*piVar6,reinterpret_cast<undefined4 *>(&this_00->field_0x18));
        }
        piVar6 = piVar6 + 1;
        iVar5 = iVar5 + -1;
      } while (iVar5 != 0);
  ...
  if (iVar2 == 0) {
    ...
    st::fn_004035BC
              (g_allPlayers_007FA174,0x12,
               reinterpret_cast<RecoveredRecordView_0043BEB0_8330D129 *>(&local_8->field_01AB));
    this_00->field_0028 = 5;
    piVar5 = reinterpret_cast<int *>(&this_00->field_01B5);
    iVar4 = 6;
    do {
      if (*piVar5 != 0) {
        st::fn_006E6080(this_00,2,*piVar5,reinterpret_cast<undefined4 *>(&this_00->field_0x18));
      }
      piVar5 = piVar5 + 1;
      iVar4 = iVar4 + -1;
    } while (iVar4 != 0);
...

{
  ...
  if (SVar1 < 0xb509) {
    if (SVar1 == MESS_SAMPANELTY_B508) {
      ...
      st::fn_00403C33
                (g_playSystem_00802A38,(undefined4 *)0x2a,reinterpret_cast<uint *>(&local_6),0,0xffffffff);
      g_currentExceptionFrame = local_54.previous;
      return 0;
    }
    if (SVar1 < 4) {
      ...
      st::fn_00403C33
                (g_playSystem_00802A38,(undefined4 *)0x2a,reinterpret_cast<uint *>(&local_5),0,0xffffffff);
      g_currentExceptionFrame = local_54.previous;
      return 0;
    }
  }
    ...
    if (SVar1 < MESS_SAMPANELTY_B518) {
      ...
      pBVar8 = st::fn_0070B3A0(reinterpret_cast<RecoveredGlobalRecordView_0081175C *>(this_00->field_01B1),
                            st::storage_bit_cast<uint>(static_cast<uint32_t>(*(char *)((int)&this_00->field_01AB + (uint)bVar5) == '\0')));
      ...
      st::fn_00403229((RecoveredSourceFamily_dibcopy *)this_00->field_0068,iVar12 - iVar10,iVar3 - iVar7,
             '\x01',reinterpret_cast<RecoveredRecordView_006B84D0_87AF9D9B *>(pBVar8));
      ...
      (*pSVar2->PaintIBut)(reinterpret_cast<PanelTy *>(this_00),(int)message,reinterpret_cast<char *>(pCVar6),UVar9,iVar10,iVar12);
      g_currentExceptionFrame = local_54.previous;
      return 0;
    }
  }
