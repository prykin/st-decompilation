...

{
  ...
  if (iVar7 == 0) {
    ...
    case MESS_ID_NONE:
      ...
      if (uVar13 == 1) {
        ...
        if (uVar13 != uVar3) {
          ...
          st::external_00000080((LPSTR)local_18,text_00,uVar13);
          ...
          puVar15 = (undefined4 *)st::fn_006B4FA0((int *)puVar9);
          ...
          puVar9 = this_00->field_0072;
          st::fn_00710A90(this_00->field_006A,(int)puVar9,0,0,0,*(int *)(puVar9 + 2),
                           *(int *)(puVar9 + 4));
        ...
        if (uVar13 != uVar3) {
          ...
          st::external_00000080((LPSTR)local_40,"%6d",iVar7);
        ...
        if (uVar13 != uVar3) {
          ...
          st::external_00000080((LPSTR)local_48,"%6d",iVar7);
    ...
    case MESS_ID_CREATE:
      ...
      pcVar8->field_0058 = 1;
      pcVar8->field_005C = 0;
      pcVar8 = (ccFntTy *)st::fn_0070CEB0(0x19d,g_cMf32_00806790,"TIME_FONT",0);
      ...
      puVar9 = (ushort *)
               st::fn_006B50C0(this_00->field_0040,this_00->field_0044,
      ...
      puVar15 = (undefined4 *)(DAT_0080679c + 0x28);
      local_EAX_597 = st::fn_006B4FE0(DAT_0080679c);
      puVar9 = (ushort *)
               st::fn_006B50C0(this_00->field_0048,this_00->field_004C,
      ...
      puVar15 = (undefined4 *)(DAT_0080679c + 0x28);
      local_EAX_719 = st::fn_006B4FE0(DAT_0080679c);
      puVar9 = (ushort *)
               st::fn_006B50C0(this_00->field_0050,this_00->field_0054,
      ...
      puVar15 = (undefined4 *)(DAT_0080679c + 0x28);
      local_EAX_841 = st::fn_006B4FE0(DAT_0080679c);
      puVar9 = (ushort *)
               st::fn_006B50C0(this_00->field_0060,this_00->field_0064,
  ...
  g_currentExceptionFrame = local_bc.previous;
  iVar10 = st::fn_006AD4D0("E:\\__titans\\Andrey\\money.cpp",0x12a,0,iVar7,"%s",
                              "MoneyTy::GetMessage");
  if (iVar10 != 0) {
    STDebugBreak(); /* noreturn in standalone pseudocode */
  }
  st::fn_006A5E40(iVar7,0,"E:\\__titans\\Andrey\\money.cpp",0x12a);
  return 0xffff;
}
