...

{
  ...
  if (iVar2 == 0) {
    ...
    st::fn_00403800
              (reinterpret_cast<SpecPanelTy *>(this_00),reinterpret_cast<char *>(pCVar2),iVar4,uVar5,iVar7,iVar10,UVar11,uVar12,uVar13);
    ...
    puVar3 = st::fn_00709AF0
                       (PTR_00806794,CASE_B,reinterpret_cast<char *>(pCVar2),uVar8,bVar9,iVar4,iVar7,puVar14);
...

{
  ...
  if (iVar3 == 0) {
    ...
    st::fn_004035BC
              (g_allPlayers_007FA174,0x10,reinterpret_cast<RecoveredRecordView_0043BEB0_8330D129 *>(puVar8));
    iVar6 = 0x19;
    puVar8 = &pUVar2->field_01AB;
    local_8 = 3;
    do {

      iVar4 = st::fn_004033F0((Global_sub_005276E0_param_1Enum)*puVar8,(byte)(*puVar8 >> 0x10));
      if (*(Global_sub_005276E0_param_1Enum *)(puVar8 + 2) == CASE_0) {
        pRVar10 = reinterpret_cast<RecoveredGlobalRecordView_0081175C *>(pUVar2->field_03EF);
      }
      else {
        pRVar10 = reinterpret_cast<RecoveredGlobalRecordView_0081175C *>(pUVar2->field_03EB);
      }
      ...
      pBVar5 = st::fn_0070B3A0(pRVar10,iVar4);
      /* ST_CALLSITE[00552C6B]: CALL 0x00403229; direct=00403229 DibPut */
      st::fn_00403229((RecoveredSourceFamily_dibcopy *)pUVar2->field_0068,0x24,iVar6,'\x01',
    ...
    do {
      ...
      st::fn_00403229((RecoveredSourceFamily_dibcopy *)pUVar2->field_0068,0xd3,iVar6,'\x01',
             reinterpret_cast<RecoveredRecordView_006B84D0_87AF9D9B *>(pBVar5));
      puVar8 = puVar8 + 0xc;
      iVar6 = iVar6 + 0x1b;
      local_c = local_c + -1;
