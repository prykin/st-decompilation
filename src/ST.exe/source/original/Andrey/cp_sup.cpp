...

{
  ...
  if (iVar3 == 0) {
    ...
    iVar5 = -1;
    iVar3 = 0;
    /* ST_CALLSITE[004F1DF9]: CALL 0x006b0140; direct=006B0140 LoadResourceString; [STCallResultViewApplier] presentation_only; exact direct-call result=pointer:/ccFntTy; source view only; no Ghidra override */
    pcVar4 = st::fn_006B0140(param_5,g_hINSTANCE_00807618);

    st::fn_00711B70(pCVar2->field_01B8,pcVar4,iVar3,iVar5,uVar6,iVar7,iVar8);
    /* ST_CALLSITE[004F1E20]: CALL dword ptr [0x0085bde8] */
    st::external_00000080(reinterpret_cast<LPSTR>(&pCVar2->field_01E1),st::mutable_c_string("%d"),param_4);
    ...
    iVar5 = -1;
    iVar3 = -1;
    /* ST_CALLSITE[004F1E8F]: CALL 0x006b0140; direct=006B0140 LoadResourceString; [STCallResultViewApplier] presentation_only; exact direct-call result=pointer:/ccFntTy; source view only; no Ghidra override */
...

{
  ...
  if (iVar3 == 0) {
    ...
    st::external_00000080(reinterpret_cast<LPSTR>(&pCVar2->field_01E1),st::mutable_c_string("%3d"),param_4);
...

{
  ...
  if (iVar3 == 0) {
    if ((param_4 != 0xffff) || (param_5 != 0xffff)) {
      ...
      iVar4 = -1;
      iVar3 = 0;
      /* ST_CALLSITE[004F21AE]: CALL 0x006b0140; direct=006B0140 LoadResourceString; [STCallResultViewApplier] presentation_only; exact direct-call result=pointer:/ccFntTy; source view only; no Ghidra override */
    ...
    if (param_5 != 0xffff) {
      ...
      st::external_00000080(reinterpret_cast<LPSTR>(&pCVar2->field_01E1),st::mutable_c_string("%d"),param_5);
...

{
  ...
  if (iVar3 == 0) {
    ...
    if (param_2 != 0xffff) {
      ...
      st::external_00000080(reinterpret_cast<LPSTR>(&pCVar2->field_01E1),st::mutable_c_string("%4d"),param_2);
    ...
    if (param_3 != 0xffff) {
      ...
      st::external_00000080(reinterpret_cast<LPSTR>(&pCVar2->field_01E1),st::mutable_c_string("%4d"),param_3);
...

{
  ...
  local_18 = reinterpret_cast<AnonShape_004F2560_DB98CB49 *>(&this->field_0B63);
  if (param_1 == 0) {
    local_20 = this->field_019C;
    local_18 = reinterpret_cast<AnonShape_004F2560_DB98CB49 *>(&this->field_0C51);
  ...
  if (local_18->field_0020 != 0) {
    ...
    local_10 = (AnonShape_004F2560_E9671A44 *)
               ...
               st::fn_0070B3A0(reinterpret_cast<RecoveredGlobalRecordView_0081175C *>(pCVar5->field_028E),local_EAX_218);
    iVar8 = local_30;
    ...
    st::fn_00403229((RecoveredSourceFamily_dibcopy *)local_20,local_30,local_34,'\x06',
    ...
    if (uVar2 != 0xffff) {
      ...
      st::external_00000080(reinterpret_cast<LPSTR>(&pCVar5->field_01E1),st::mutable_c_string("%d"),(uint)uVar2);

      st::fn_00710A90(pCVar5->field_01B8,local_20,0,iVar8 + 0x2f,
                       (local_10->field_0008 + -0xc) / 2 + local_1c + local_14,0x11,0xc);

      st::fn_00711B70(pCVar5->field_01B8,&pCVar5->field_01E1,-3,-1,0,-1,-1);
      piVar11 = reinterpret_cast<int *>((local_24 + (local_c & 0xff) * 0x1c));
      *piVar11 = iVar8 + 0x2f + local_28;
      piVar11[1] = local_34 + local_2c;
      piVar11[2] = 0x11;
      piVar11[3] = 0xc;

      iVar7 = st::fn_00404494(local_18->field_0020);
      piVar11[6] = iVar7;
      local_c = STReplaceLowByte(st::storage_bit_cast<uint32_t>(static_cast<uint32_t>(local_c)), (uint8_t)((char)local_c + '\x01'));
    }
    piVar11 = reinterpret_cast<int *>((local_24 + (local_c & 0xff) * 0x1c));
  ...
  if (GVar3 == 0xdd) {
    pRVar17 = reinterpret_cast<RecoveredGlobalRecordView_0081175C *>(pCVar5->field_02D6);
    iVar7 = 0;
  }
  else {
    if (GVar3 != 0xde) {
      ...
      local_10 = reinterpret_cast<AnonShape_004F2560_E9671A44 *>(st::fn_0070B3A0(reinterpret_cast<RecoveredGlobalRecordView_0081175C *>(pCVar5->field_028E),uVar7));
      goto LAB_004f27ff;
    }
    pRVar17 = reinterpret_cast<RecoveredGlobalRecordView_0081175C *>(pCVar5->field_02D6);
    iVar7 = 1;
  }
  local_10 = reinterpret_cast<AnonShape_004F2560_E9671A44 *>(st::fn_0070B3A0(pRVar17,iVar7));
LAB_004f27ff:
  ...
  st::fn_00403229((RecoveredSourceFamily_dibcopy *)local_20,iVar7,iVar10,'\x06',
         reinterpret_cast<RecoveredRecordView_006B84D0_87AF9D9B *>(local_10));
  if (pAVar13->field_001E == 0xff) {

    st::fn_00710A90(pCVar5->field_01B8,local_20,0,iVar8 + 1,local_14 + 2,local_10->field_0004,
                     local_10->field_0008);
    iVar19 = -1;
    iVar18 = -1;
    uVar16 = 1;
    ...
    st::fn_00711B70(pCVar5->field_01B8,pcVar7_mg0,iVar7,iVar10,uVar16,iVar18,iVar19);
  }
  local_5 = '\x01';
  if (*(short *)&pAVar13->field_0x26 == -1) {
    ...
    st::external_00000080(reinterpret_cast<LPSTR>(&pCVar5->field_01E1),st::mutable_c_string("%d"),*(short *)&pAVar13->field_0x26);
  }
  if (local_5 != '\0') {
    local_34 = 0;
    ...
    *piVar11 = iVar8 + 0x2f + local_28;
    ...
    iVar7 = st::fn_00404494(local_18->field_001E);
    piVar11[6] = iVar7;
    local_c = STReplaceLowByte(st::storage_bit_cast<uint32_t>(static_cast<uint32_t>(local_c)), (uint8_t)((char)local_c + '\x01'));
    pAVar13 = local_18;
  }
  ...
  iVar8 = st::fn_00404494(pAVar13->field_001E);
  piVar11[6] = iVar8;
  g_currentExceptionFrame = local_7c.previous;
  return;
}
...

{
  ...
  if (local_EAX_42 == 0) {
    ...
    *(undefined4 *)param_1 = param_3;
    uVar2 = (uint)param_2;
    *(int *)&param_1->field_0x8 = st::machine_word_boundary_cast<int>((&local_c->field_003C)[uVar2] + param_4);
    ...
    *(int *)&param_1->field_0xc = iVar6 + param_5;
    ...
    st::external_00000080(reinterpret_cast<LPSTR>(text),st::mutable_c_string("%s0"),param_7);
...

{
  ...
  if (iVar4 == 0) {
    ...
    if (text != nullptr) {
      ...
      st::external_00000080(reinterpret_cast<LPSTR>(&pCVar3->field_01E1),st::mutable_c_string("%s0"),text);
    ...
    if (param_4 < 0) {
      param_4 = st::machine_word_boundary_cast<int>(((&pCVar3->field_0068)[param_1] - local_17c) / 2);
    }
    uVar2 = (uint)param_1;
    local_18c[2] = st::machine_word_boundary_cast<int>((&pCVar3->field_003C)[uVar2] + param_4);
    ...
    (*pCVar3->field_000C->vtable->CreateObject)
              (reinterpret_cast<SystemClassTy *>(pCVar3->field_000C),2,reinterpret_cast<undefined4 *>(&local_c),nullptr,st::machine_word_boundary_cast<undefined4>(local_18c),0);
...

{
  ...
  errorCode = STPointerBoundaryCast<int *>(st::fn_0072D7F0(local_54.jumpBuffer,0));
  if (errorCode != nullptr) {
    ...
    if (iVar6 == 0) {
      st::fn_006A5E40(st::machine_word_boundary_cast<int>(errorCode),0,st::mutable_c_string("E:\\__titans\\Andrey\\cp_sup.cpp"),0x1cd);
      return;
    }
    STDebugBreak(); /* noreturn in standalone pseudocode */
  }
  ...
  uVar4 = (*param_5)(st::machine_word_boundary_cast<undefined4>(param_2));
  ...
  local_c = st::pointer_boundary_cast<RecoveredRecordView_006B84D0_87AF9D9B *>(st::fn_006F1CE0(g_cMf32_00806790,param_3,reinterpret_cast<char *>(text_00),errorCode,iVar7));
  pCVar3 = local_8;
  uVar2 = (uint)param_1;
  iVar7 = local_10[1];
  iVar5 = DAT_00806734;
...
LAB_004f3636:
  ...
  st::fn_00403229(reinterpret_cast<RecoveredSourceFamily_dibcopy *>(local_8->field_0148[uVar2 + 0xe]),
  ...
  if ((param_1 < 0xb) && (-1 < (int)pCVar3->field_0148[uVar2])) {
    ...
    st::fn_006B3640
              (reinterpret_cast<int *>(g_ddxContext_008075A8),(uint)pCVar3->field_0148[uVar2],0xffffffff,
...

{
  ...
  if (errorCode != nullptr) {
    ...
    st::fn_006A5E40(st::machine_word_boundary_cast<int>(errorCode),0,st::mutable_c_string("E:\\__titans\\Andrey\\cp_sup.cpp"),0x1de);
    return;
  }
  iVar6 = 1;
  ...
  local_c = st::pointer_boundary_cast<RecoveredRecordView_006B84D0_87AF9D9B *>(st::fn_006F1CE0(g_cMf32_00806790,param_3,reinterpret_cast<char *>(text),errorCode,iVar6));
  pCVar3 = local_8;
  uVar2 = (uint)param_1;
  iVar6 = local_10[1];
  iVar4 = DAT_00806734;
...
cf_common_join_004F3AC3:
  if (param_6 != nullptr) {
    ...
    if (iVar4 == 0) {
      ...
      local_8 = st::pointer_boundary_cast<RecoveredRecordView_006B84D0_87AF9D9B *>(st::fn_006F1CE0(g_cMf32_00806790,param_3,param_4,nullptr,1));
      pCVar3 = local_10;
      uVar4 = local_14;
      uVar2 = (uint)param_1;
      /* ST_CALLSITE[004F3B32]: CALL 0x00403229; direct=00403229 DibPut */
      st::fn_00403229(reinterpret_cast<RecoveredSourceFamily_dibcopy *>(local_10->field_0148[uVar2 + 0xe]),local_c,local_14,
             param_3,local_8);
      st::fn_006F20E0(g_cMf32_00806790,reinterpret_cast<uint *>(&local_8));
...
cf_common_join_004F3D83:
  if (param_6 != nullptr) {
    ...
    errorCode = STPointerBoundaryCast<int *>(st::fn_0072D7F0(local_5c.jumpBuffer,0));
    if (errorCode == nullptr) {
      iVar9 = 1;
      /* ST_CALLSITE[004F3DC2]: CALL dword ptr [EBP + 0x1c] */
      uVar4 = (*param_6)(reinterpret_cast<RecoveredRecord_00529FE0_85E582CB *>(param_2));
      ...
      local_8 = st::pointer_boundary_cast<RecoveredRecordView_006B84D0_87AF9D9B *>(st::fn_006F1CE0(g_cMf32_00806790,param_3,reinterpret_cast<char *>(text),errorCode,iVar9));
      pCVar3 = local_14;
      uVar2 = (uint)param_1;
      /* ST_CALLSITE[004F3E08]: CALL 0x00403229; direct=00403229 DibPut */
      st::fn_00403229(reinterpret_cast<RecoveredSourceFamily_dibcopy *>(local_14->field_0148[uVar2 + 0xe]),local_10,local_c,
             param_3,local_8);
      st::fn_006F20E0(g_cMf32_00806790,reinterpret_cast<uint *>(&local_8));

      st::fn_00710A90(reinterpret_cast<ccFntTy *>(g_interSystem_00802A28->field_0024),
                       (int)pCVar3->field_0148[uVar2 + 0xe],0,local_10,local_c,local_18[2],
                       local_18[3]);
      iVar10 = -1;
      iVar7 = -1;
      /* ST_CALLSITE[004F3E4F]: CALL dword ptr [EBP + 0x1c] */
      uVar5 = (*param_6)(reinterpret_cast<RecoveredRecord_00529FE0_85E582CB *>(param_2));
      iVar6 = -1;
      iVar9 = -2;
      ...
      resourceString = st::pointer_boundary_cast<ccFntTy *>(st::fn_006B0140(param_5,g_hINSTANCE_00807618));

      st::fn_00711B70(reinterpret_cast<ccFntTy *>(g_interSystem_00802A28->field_0024),reinterpret_cast<char *>(resourceString),iVar9,
    ...
    st::fn_006A5E40(st::machine_word_boundary_cast<int>(errorCode),0,st::mutable_c_string("E:\\__titans\\Andrey\\cp_sup.cpp"),0x212);
  }
  return;
}
...

{
  ...
  local_10 = param_2->field_0018->field_0000 - (&this->field_003C)[uVar2];
  switch(uVar2) {
  case 1:
    iVar6 = this->field_0134;
    goto LAB_004f4057;
...
cf_common_join_004F4070:
  if (param_6 != nullptr) {
    ...
    if (iVar4 == 0) {
      ...
      uVar4 = (*(code *)param_6)(param_2);
      text = st::fn_006F2C00(param_4,1,uVar4);
      /* ST_CALLSITE[004F40CC]: CALL 0x006f1ce0; direct=006F1CE0 cMf32::RecGet; [STCallResultViewApplier] readability_validated; exact direct-call result=pointer:/SubmarineTitans/Recovered/PointerShapes/RecoveredRecordView_006B84D0_87AF9D9B; signature=__thiscall;pointer:/SubmarineTitans/Recovered/PointerShapes/RecoveredRecordView_006B84D0_87AF9D9B;pointer:/cMf32;/byte;pointer:/char;pointer:/int;/int */
      local_8 = st::pointer_boundary_cast<RecoveredRecordView_006B84D0_87AF9D9B *>(st::fn_006F1CE0(g_cMf32_00806790,param_3,reinterpret_cast<char *>(text),nullptr,1));
      pCVar3 = local_14;
      uVar2 = (uint)param_1;
      ...
      if (param_2->field_0014 == 3) {
        /* ST_CALLSITE[004F4122]: CALL 0x006f1ce0; direct=006F1CE0 cMf32::RecGet; [STCallResultViewApplier] readability_validated; exact direct-call result=pointer:/SubmarineTitans/Recovered/PointerShapes/RecoveredRecordView_006B84D0_87AF9D9B; signature=__thiscall;pointer:/SubmarineTitans/Recovered/PointerShapes/RecoveredRecordView_006B84D0_87AF9D9B;pointer:/cMf32;/byte;pointer:/char;pointer:/int;/int */
        local_8 = st::pointer_boundary_cast<RecoveredRecordView_006B84D0_87AF9D9B *>(st::fn_006F1CE0(g_cMf32_00806790,6,param_5,nullptr,1));
        /* ST_CALLSITE[004F413D]: CALL 0x00403229; direct=00403229 DibPut */
        st::fn_00403229(reinterpret_cast<RecoveredSourceFamily_dibcopy *>(pCVar3->field_0148[uVar2 + 0xe]),local_10,local_c,
               '\x06',local_8);
        st::fn_006F20E0(g_cMf32_00806790,reinterpret_cast<uint *>(&local_8));
      }
      if ((param_1 < 0xb) && (-1 < (int)pCVar3->field_0148[uVar2])) {
...
cf_common_join_004F4331:
  if (param_6 != nullptr) {
    ...
    if (iVar4 == 0) {
      ...
      uVar4 = (*param_6)(reinterpret_cast<AnonShape_0052A7B0_DD603BF4 *>(param_2));
      text_00 = st::fn_006F2C00(text,2,uVar4);
      /* ST_CALLSITE[004F438D]: CALL 0x006f1ce0; direct=006F1CE0 cMf32::RecGet; [STCallResultViewApplier] readability_validated; exact direct-call result=pointer:/SubmarineTitans/Recovered/PointerShapes/RecoveredRecordView_006B84D0_87AF9D9B; signature=__thiscall;pointer:/SubmarineTitans/Recovered/PointerShapes/RecoveredRecordView_006B84D0_87AF9D9B;pointer:/cMf32;/byte;pointer:/char;pointer:/int;/int */
      local_8 = st::pointer_boundary_cast<RecoveredRecordView_006B84D0_87AF9D9B *>(st::fn_006F1CE0(g_cMf32_00806790,param_3,reinterpret_cast<char *>(text_00),nullptr,1));
      pCVar3 = local_14;
      uVar2 = (uint)param_1;
      ...
      if ((*(int *)((param_2->arg0).u32 + 4) == 3) && (param_5 != nullptr)) {
        /* ST_CALLSITE[004F43EA]: CALL 0x006f1ce0; direct=006F1CE0 cMf32::RecGet; [STCallResultViewApplier] readability_validated; exact direct-call result=pointer:/SubmarineTitans/Recovered/PointerShapes/RecoveredRecordView_006B84D0_87AF9D9B; signature=__thiscall;pointer:/SubmarineTitans/Recovered/PointerShapes/RecoveredRecordView_006B84D0_87AF9D9B;pointer:/cMf32;/byte;pointer:/char;pointer:/int;/int */
        local_8 = st::pointer_boundary_cast<RecoveredRecordView_006B84D0_87AF9D9B *>(st::fn_006F1CE0(g_cMf32_00806790,6,param_5,nullptr,1));
