...
LAB_00535ef1:
  ...
  case MESS_INTERCOMPANELTY_C0AF:
    ...
    case CASE_1:
      if (DAT_0080874e == '\x03') {
        pcVar35 = (code *)st::fn_0052A280;
        UVar34 = 0x3e81;
      }
      else {
        pcVar35 = (code *)st::fn_0052A1E0;
        if (DAT_0080874e != '\x01') {
          pcVar35 = (code *)st::fn_0052A230;
        }
        UVar34 = 0x3e81;
      }
    ...
    case CASE_6:
      if (DAT_0080874e == '\x03') {
        iVar18 = 0;
        pcVar35 = (code *)st::fn_0052A770;
        pcVar31 = (code *)st::fn_0052A6C0;
        UVar34 = 0x3efc;
      }
      else {
        pcVar35 = (code *)st::fn_0052A6F0;
        if (DAT_0080874e != '\x01') {
          pcVar35 = (code *)st::fn_0052A730;
        }
        iVar18 = 0;
        pcVar31 = (code *)st::fn_0052A6C0;
        UVar34 = 0x3efc;
    ...
    case CASE_7:
      ...
      if (iVar18 == 1) {
        if (DAT_0080874e == '\x03') {
          iVar18 = 1;
          pcVar35 = (code *)st::fn_0052A640;
          pcVar31 = (code *)st::fn_0052A4D0;
          UVar34 = 0x3ee7;
        }
        else {
          pcVar35 = (code *)st::fn_0052A540;
          if (DAT_0080874e != '\x01') {
            pcVar35 = (code *)st::fn_0052A5C0;
          }
          iVar18 = 1;
          pcVar31 = (code *)st::fn_0052A4D0;
          UVar34 = 0x3ee7;
