...

{
  ...
  if (iVar2 == 0) {
    ...
    puVar4_mg1 = st::pointer_boundary_cast<ushort *>(st::fn_006B50C0(0xde,0xb,(uint)this_00->field_0184[7],uVar11,reinterpret_cast<undefined4 *>(puVar16),
                              iVar18));
    ...
    uVar9_mg0 = st::fn_0040398B(reinterpret_cast<UPanelTy *>(this_00),0,1,0xc9,0x9f,1,pCVar3,uVar5,uVar6,sVar7,
    ...
    uVar9_mg1 = st::fn_0040398B(reinterpret_cast<UPanelTy *>(this_00),0,0,0x93,0x9f,1,pCVar3,uVar5,uVar6,sVar7,
                                    uVar8,uVar12,pcVar13,uVar17,uVar20);
...
LAB_00530592:
    ...
    st::fn_007119C0(this_00->field_017C,pcVar7_mg27,iVar12,iVar30,uVar32);
    pRVar11 = reinterpret_cast<RecoveredRecordView_006B84D0_87AF9D9B *>(this_00->field_0190);
LAB_005305a9:
    pRVar27 = (RecoveredSourceFamily_dibcopy *)this_00->field_0068;
LAB_005305b4:
    /* ST_CALLSITE[005305B4]: CALL 0x00403229; direct=00403229 DibPut */
    st::fn_00403229(pRVar27,0x1d,0x13,'\x01',pRVar11);
  ...
  case CASE_B:
    ...
    st::fn_007119C0(this_00->field_017C,pcVar7_mg10,iVar12,iVar30,uVar32);
...
LAB_0052ff02:
  ...
  case CASE_6:
    ...
    st::fn_007119C0(this_00->field_017C,pcVar7_mgC,iVar12,iVar30,uVar32);
    ...
    st::fn_007119C0(this_00->field_017C,pcVar7_mgD,iVar12,iVar30,uVar32);
    ...
    st::fn_007119C0(this_00->field_017C,pcVar7_mgE,iVar12,iVar30,uVar32);
    ...
    st::fn_007119C0(this_00->field_017C,pcVar7_mgF,iVar12,iVar30,uVar32);
  ...
  case CASE_7:
    ...
    st::fn_007119C0(this_00->field_017C,pcVar7_mg8,iVar12,iVar30,uVar32);
    ...
    st::fn_007119C0(this_00->field_017C,pcVar7_mg9,iVar12,iVar30,uVar32);
    ...
    st::fn_007119C0(this_00->field_017C,pcVar7_mgA,iVar12,iVar30,uVar32);
    ...
    st::fn_007119C0(this_00->field_017C,pcVar7_mgB,iVar12,iVar30,uVar32);
...
LAB_00530554:
  ...
  case CASE_8:
    ...
    st::fn_007119C0(this_00->field_017C,pcVar7_mg5,iVar12,iVar30,uVar32);
    ...
    st::fn_007119C0(this_00->field_017C,pcVar7_mg6,iVar12,iVar30,uVar32);
    ...
    st::fn_007119C0(this_00->field_017C,pcVar7_mg7,iVar12,iVar30,uVar32);
  ...
  case CASE_C:
    ...
    st::fn_007119C0(this_00->field_017C,pcVar7_mg4,iVar12,iVar30,uVar32);
    pRVar11 = reinterpret_cast<RecoveredRecordView_006B84D0_87AF9D9B *>(this_00->field_0194);
    goto LAB_005305a9;
  case CASE_D:
    uVar32 = 0;
    iVar30 = -1;
    ...
    st::fn_007119C0(this_00->field_017C,pcVar7_mg1,iVar12,iVar30,uVar32);
    ...
    st::fn_007119C0(this_00->field_017C,pcVar7_mg2,iVar12,iVar30,uVar32);
    ...
    st::fn_007119C0(this_00->field_017C,pcVar7_mg3,iVar12,iVar30,uVar32);
  ...
  case CASE_E:
    ...
    st::fn_007119C0(this_00->field_017C,pcVar7_mg0,iVar12,iVar30,uVar32);
    pRVar11 = reinterpret_cast<RecoveredRecordView_006B84D0_87AF9D9B *>(this_00->field_0190);
    pRVar27 = (RecoveredSourceFamily_dibcopy *)this_00->field_0068;
    goto LAB_005305b4;
  }
  ...
  st::fn_007119C0(this_00->field_017C,pcVar7_mg28,iVar12,iVar30,uVar32);
cf_common_join_005305BC:
  ...
  case CASE_1:
    ...
    do {
      ...
      pCVar9 = st::fn_0040577C(st::mutable_c_string("BUT_BUTOPT"),0);
      /* ST_CALLSITE[00530650]: CALL 0x0040398b; direct=0040398B UPanelTy::CreateBut */
      uVar32_mg51 = st::fn_0040398B(reinterpret_cast<UPanelTy *>(this_00),1,iVar12,0x1d,uVar32 * 0x12 + 0x13,1,
  ...
  case CASE_2:
    ...
    do {
      ...
      uVar32_mg50 = st::fn_0040398B(reinterpret_cast<UPanelTy *>(this_00),1,1,0x1d,iVar30,1,pCVar9,iVar21,iVar22,
  ...
  case CASE_E:
    if (this_00->field_01A4 != CASE_E) {
      ...
      pvVar7 = st::external_00000074(reinterpret_cast<LPCSTR>(&this_00->field_006C),0,1);
      this_00->field_01DD = pvVar7;
      if (st::machine_word_boundary_cast<uint>(pvVar7) == st::machine_word_boundary_cast<uint>((HANDLE)0xffffffff)) {
        this_00->field_01DD = (HANDLE)0x0;
      }
    }
    ...
    uVar8 = 0xc0a1;
    if (this_00->field_01A4 == CASE_E) {
      pCVar9 = st::fn_0040577C(st::mutable_c_string("BUT_MEDIUM"),0);
      /* ST_CALLSITE[005318F0]: CALL 0x0040398b; direct=0040398B UPanelTy::CreateBut */
      uVar32_mg4C = st::fn_0040398B(reinterpret_cast<UPanelTy *>(this_00),0,1,0x78,0x7d,1,pCVar9,uVar8,uVar23,
      ...
      uVar32_mg4E = st::fn_0040398B(reinterpret_cast<UPanelTy *>(this_00),0,1,0x5d,0x7c,1,pCVar9,uVar8,uVar23,
                                        sVar24,uVar25,uVar28,pcVar29,uVar31,uVar33);
      uVar33 = 0;
      uVar31 = 0;
      pcVar29 = nullptr;
      ...
      uVar32_mg4F = st::fn_0040398B(reinterpret_cast<UPanelTy *>(this_00),0,1,0x94,0x7c,1,pCVar9,uVar8,uVar23,
                                        sVar24,uVar25,uVar28,pcVar29,uVar31,uVar33);
  ...
  case CASE_5:
    ...
    uVar32_mg40 = st::fn_0040398B(reinterpret_cast<UPanelTy *>(this_00),0,1,0x5e,0x7d,1,pCVar9,uVar8,uVar23,sVar24
    ...
    uVar32_mg41 = st::fn_0040398B(reinterpret_cast<UPanelTy *>(this_00),0,1,0x97,0x7d,1,pCVar9,uVar8,uVar23,sVar24
                                      ,uVar25,uVar28,pcVar29,uVar31,uVar33);
  ...
  case CASE_6:
    ...
    do {
      ...
      uVar32_mg3E = st::fn_0040398B(reinterpret_cast<UPanelTy *>(this_00),3,(-(uint)(bVar5 != 0) & 2) + 1,0x1d,
      ...
      if (uVar10 == 5) {
        ...
        if (uVar10 == 0) {
          ...
          if (local_EAX_4865 == 0) {
            ...
            uVar10 = st::storage_bit_cast<uint>(static_cast<uint32_t>(local_74 + local_70)) >> 1;
          }
          else {
            uVar10 = 0;
          }
...
LAB_00530da0:
        ...
        if (uVar10 != 0) {
          ...
          if (local_EAX_4632 == 0) {
            ...
            uVar10 = st::storage_bit_cast<uint>(static_cast<uint32_t>(local_60 + local_6c)) >> 1;
          }
          else {
            uVar10 = 0;
          }
      ...
      uVar9_mg15 = st::fn_00403EE0(this_00,0x6d,iVar12,0xf9,iVar12,uVar10 + 0xc09f,0x1f,uVar32,local_14
                               );
  ...
  case CASE_7:
    ...
    uVar32_mg35 = st::fn_00402680(reinterpret_cast<UPanelTy *>(this_00),3,(byte)local_2c,0x1d,0x16,0xe9,0x11,0,
                                      0x12,0xc09f,0xc0af);
...
LAB_005311d8:
        ...
        case 2:
          ...
          if (local_EAX_5906 == 0) {
            ...
            uVar10 = st::storage_bit_cast<uint>(static_cast<uint32_t>(local_50 + local_4c)) >> 1;
          }
          else {
            uVar10 = 0;
          }
...
LAB_0053108d:
        ...
        case 4:
          ...
          if (local_EAX_6096 == 0) {
            ...
            uVar10 = st::storage_bit_cast<uint>(static_cast<uint32_t>(local_64 + local_5c)) >> 1;
          }
          else {
            uVar10 = 0;
          }
...
LAB_0053108f:
        ...
        if (uVar10 == 6) {
          ...
          if (local_EAX_5605 == 0) {
            ...
            uVar10 = st::storage_bit_cast<uint>(static_cast<uint32_t>(local_68 + local_48)) >> 1;
          }
          else {
            uVar10 = 0;
          }
        ...
        if (uVar10 == 7) {
          ...
          if (local_EAX_5376 == 0) {
            ...
            uVar10 = st::storage_bit_cast<uint>(static_cast<uint32_t>(local_58 + local_54)) >> 1;
          }
          else {
            uVar10 = 0;
          }
...
cf_common_join_0053138B:
      ...
      uVar9_mgE = st::fn_00403EE0(this_00,0x6d,iVar12,0xf9,iVar12,uVar10 + 0xc09f,0x1f,uVar32,local_20);
...
switchD_005311ec_caseD_3:
  ...
  case CASE_8:
    ...
    uVar32_mg30 = st::fn_00402680(reinterpret_cast<UPanelTy *>(this_00),3,3 - DAT_0080733b,0x1d,0x20,0x72,0x11,0,
                                      0x12,0xc09f,0xc0af);
    this_00->field_01B5[0] = uVar32_mg30;
    /* ST_CALLSITE[00530BB8]: CALL 0x00402680; direct=00402680 UPanelTy::CreateTab */
    uVar32_mg31 = st::fn_00402680(reinterpret_cast<UPanelTy *>(this_00),3,2 - DAT_0080733a,0x99,0x20,0x72,0x11,0,
                                      0x12,0xc0a0,0xc0b0);
    this_00->field_01B5[1] = uVar32_mg31;
    /* ST_CALLSITE[00530BE4]: CALL 0x00402680; direct=00402680 UPanelTy::CreateTab */
    uVar32_mg32 = st::fn_00402680(reinterpret_cast<UPanelTy *>(this_00),2,DAT_00807349,0x5d,0x68,0x72,0x11,0,0x12,
                                      0xc0a2,0xc0b2);
  ...
  case CASE_9:
    ...
    do {
      ...
      uVar32_mg2F = st::fn_0040398B(reinterpret_cast<UPanelTy *>(this_00),3,1,0x1d,iVar12,1,pCVar9,iVar22,iVar30,
                                        sVar24,uVar25,uVar8,pcVar29,uVar23,uVar28);
      iVar12 = iVar12 + 0x12;
  ...
  case CASE_B:
    ...
    uVar32_mg2E = st::fn_0040398B(reinterpret_cast<UPanelTy *>(this_00),0,1,0x7d,0x7d,1,pCVar9,uVar8,uVar23,sVar24
                                      ,uVar25,uVar28,pcVar29,uVar31,uVar33);
  ...
  case CASE_D:
    ...
    do {
      ...
      puVar13[-1] = st::storage_bit_cast<uint>(static_cast<uint32_t>((int)local_18 + 1));
      *puVar13 = 2;
    ...
    uVar32_mg29 = st::fn_0040398B(reinterpret_cast<UPanelTy *>(this_00),1,0,0x1d,0x49,1,pCVar9,uVar8,uVar23,sVar24
                                      ,uVar25,uVar28,pcVar29,uVar31,uVar33);
    uVar33 = 0;
    uVar31 = 0;
    pcVar29 = nullptr;
    ...
    uVar32_mg2A = st::fn_0040398B(reinterpret_cast<UPanelTy *>(this_00),3,(-(uint)(DAT_00807342 != 0) & 2) + 1,
    ...
    uVar32_mg2B = st::fn_00403EE0(this_00,0x94,0x70,*(int *)(this_00->field_018C + 2) + 0xaf,0x70,
    ...
    uVar32_mg2C = st::fn_00403EE0(this_00,0x94,0x82,*(int *)(puVar2 + 2) + 0xaf,0x82,0xc0a3,3,
                               (uint)DAT_00807347,1);
