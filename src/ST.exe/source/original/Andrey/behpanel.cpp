...

{
  ...
  if (iVar7 != 0) {
    ...
    iVar13 = st::fn_006AD4D0("E:\\__titans\\Andrey\\behpanel.cpp",0x68,0,iVar7,
                                "%s","BehPanelTy::InitBehPanel");
    if (iVar13 == 0) {
      st::fn_006A5E40(iVar7,0,"E:\\__titans\\Andrey\\behpanel.cpp",0x68);
      return;
    }
  ...
  pCVar3 = st::fn_0040577C("BKG_BEHAVIOURW",0);
  st::fn_00403800
...
switchD_004ed72f_default:
    ...
    if (DAT_0080874e == '\x03') {
      pcVar5 = st::fn_00405493((&this_00->field_0x1af)[uVar8],0);
      pCVar3 = st::fn_0040577C(pcVar5,iVar7);
      pCVar3 = st::fn_006F2C00(pCVar3,iVar13,uVar11);
      GVar10 = CASE_6;
    }
    else {
      pcVar5 = st::fn_00405493((&this_00->field_0x1af)[uVar8],0);
    ...
    *(undefined1 *)(local_14 + 0x1ce) = 1;
    iVar7 = st::fn_00401A78((&this_00->field_0x1af)[uVar8],0);
    *(int *)(local_14 + 0x1cf) = iVar7;
    uVar11 = st::fn_0040371F((&this_00->field_0x1af)[uVar8]);
    iVar13 = local_14;
...
LAB_004eda0d:
      ...
      uVar11 = st::fn_0070B3A0((AnonShape_GLOBAL_0081175C_57F682DD *)this_00->field_02B8,iVar13);
      bVar6 = (byte)local_10;
...
LAB_004eda47:
    ...
    if (5 < (byte)(bVar6 + 1)) {
      ...
      uVar18 = 0xc0af;
      uVar11 = 0xc09f;
      pCVar3 = st::fn_0040577C("BUT_BHOLD",0);
      ...
      pCVar3 = st::fn_0040577C("BUT_BAGR",0);
      uVar11 = (*pBVar1->CreateBut)
                         ((PanelTy *)this_00,0,0,
...

{
  ...
  g_currentExceptionFrame = local_4c.previous;
  iVar3 = st::fn_006AD4D0("E:\\__titans\\Andrey\\behpanel.cpp",0x77,0,errorCode,
                             "%s","BehPanelTy::DoneBehPanel");
  if (iVar3 != 0) {
    STDebugBreak(); /* noreturn in standalone pseudocode */
  }
  st::fn_006A5E40(errorCode,0,"E:\\__titans\\Andrey\\behpanel.cpp",0x77);
  return;
}
...

{
  ...
  if (param_1 != this->field_005C) {
    ...
    *(short *)&this->field_0x2e = sVar2;
    ...
    g_currentExceptionFrame = local_4c.previous;
    iVar3 = st::fn_006AD4D0("E:\\__titans\\Andrey\\behpanel.cpp",0x87,0,errorCode,
                               "%s","BehPanelTy::ShiftControls");
    if (iVar3 != 0) {
      STDebugBreak(); /* noreturn in standalone pseudocode */
    }
    st::fn_006A5E40(errorCode,0,"E:\\__titans\\Andrey\\behpanel.cpp",0x87);
  }
  return;
}
...

{
  ...
  if (iVar2 != 0) {
    ...
    iVar3 = st::fn_006AD4D0("E:\\__titans\\Andrey\\behpanel.cpp",0xb2,0,iVar2,"%s"
                               ,"BehPanelTy::Update");
    if (iVar3 == 0) {
      st::fn_006A5E40(iVar2,0,"E:\\__titans\\Andrey\\behpanel.cpp",0xb2);
      return;
    }
    STDebugBreak(); /* noreturn in standalone pseudocode */
  }
    ...
    *(uint *)&this_00->field_0x2c = (uint)pGVar6[6];
    ...
    if (*pGVar6 != *local_8) {
      *(undefined1 *)((int)piVar4 + -1) = 1;
      iVar2 = st::fn_00401A78(*pGVar6,this_00->field_01AB);
      *piVar4 = iVar2;
      iVar2 = st::fn_0040371F(*pGVar6);
      piVar4[2] = iVar2;
...

{
  ...
  g_currentExceptionFrame = local_58.previous;
  iVar4 = st::fn_006AD4D0("E:\\__titans\\Andrey\\behpanel.cpp",0xc5,0,(int)errorCode,
                             "%s","BehPanelTy::PaintBBut");
  if (iVar4 != 0) {
    STDebugBreak(); /* noreturn in standalone pseudocode */
  }
  st::fn_006A5E40((int)errorCode,0,"E:\\__titans\\Andrey\\behpanel.cpp",0xc5);
  return;
}
...

{
  ...
  if (iVar4 != 0) {
    ...
    iVar10 = st::fn_006AD4D0("E:\\__titans\\Andrey\\behpanel.cpp",0xf3,0,iVar4,
                                "%s","BehPanelTy::GetMessage");
    if (iVar10 != 0) {
      STDebugBreak(); /* noreturn in standalone pseudocode */
    }
    st::fn_006A5E40(iVar4,0,"E:\\__titans\\Andrey\\behpanel.cpp",0xf3);
    return 0xffff;
  }
  ...
  if (SVar1 < 0xb20f) {
    if (SVar1 == 0xb20e) {
      ...
      iVar4 = 0;
      pcVar5 = st::fn_00405493((&this_00->field_0x1af)[(message->arg0).words.high],
                                  this_00->field_01AB);
      pCVar6 = st::fn_0040577C(pcVar5,iVar4);
  ...
  pCVar6 = st::fn_0040577C(pcVar5,0);
  st::fn_004042BE(this_00,(AnonShape_004EE350_18D491EA *)message,pCVar6,bVar8);
