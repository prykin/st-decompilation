  ...
  *(undefined4 *)&this_00->field_0x84 = 0xffffffff;
  ...
  if (iVar4 < 0x7f7) {
    if (iVar4 == 0x7f6) {
      ...
      iVar12 = st::fn_004016B8(this_00,(char *)local_8,uVar5,(uint *)ppAVar20);
      DAT_00811980 = 0;
      if (0 < iVar12) {
        ...
        local_2c = st::machine_word_boundary_cast<undefined4>(param_1 + 0x23);
        local_1c = st::machine_word_boundary_cast<undefined4>(param_1 + 0x1e);
        ...
        do {
          uVar33 = 0;
          pcVar31 = st::function_address_boundary_cast<code *>(st::fn_00677ED0);
          ...
          st::fn_00403882(*(short *)ppAVar20,(short)uVar13,pbVar14,sVar25,sVar26,sVar27,sVar28,sVar29,
...
LAB_0066bdcc:
      ...
      if (iVar4 < 0x7d7) {
        if (iVar4 == 0x7d6) {
          ...
          puVar15 = (uint *)st::fn_006C49B0(local_c);
          if (param_3 == nullptr) {
            g_currentExceptionFrame = local_260.previous;
            return puVar15;
          }
        ...
        if (iVar4 < 0x7d1) {
          if (iVar4 == 2000) {
            ...
            local_10 = st::machine_word_boundary_cast<undefined4>((char *)this_00->slot_00(param_1 + 5));
            local_c = nullptr;
            if ((local_8 == (AiFltClassTy *)0x9) &&
...
LAB_0066bff3:
    ...
    case 0x7ee:
      ...
      local_EAX_5889 = st::fn_004016B8(this_00,(char *)local_8,uVar5,(uint *)ppAVar20);
      DAT_00811980 = 0;
      if (0 < local_EAX_5889) {
        local_10 = st::machine_word_boundary_cast<undefined4>(param_1 + 0x2d);
        local_18 = st::machine_word_boundary_cast<undefined4>(param_1 + 0x28);
        ...
        do {
          puVar32 = nullptr;
          puVar15 = nullptr;
          pcVar31 = st::function_address_boundary_cast<code *>(st::fn_006771E0);
          ...
          st::fn_004012F8(st::machine_word_boundary_cast<undefined4>(*ppAVar20),uVar5,uVar19,pbVar14,cVar3,sVar25,sVar26,sVar27,sVar28,sVar29,sVar30,
    ...
    case 0x7ef:
      ...
      local_EAX_6313 = st::fn_004016B8(this_00,(char *)local_8,uVar5,(uint *)ppAVar20);
      DAT_00811980 = 0;
      if (0 < local_EAX_6313) {
        local_10 = st::machine_word_boundary_cast<undefined4>(param_1 + 0x2d);
        local_18 = st::machine_word_boundary_cast<undefined4>(param_1 + 0x28);
        ...
        do {
          ...
          st::fn_004012F8(st::machine_word_boundary_cast<undefined4>(*ppAVar20),0,uVar5,pbVar14,cVar3,sVar25,sVar26,sVar27,sVar28,sVar29,sVar30,
                     pcVar31,puVar15,puVar32);
          ppAVar20 = ppAVar20 + 1;
    ...
    case 0x7f0:
      ...
      local_EAX_6908 = st::fn_004016B8(this_00,(char *)local_8,uVar5,(uint *)ppAVar20);
      DAT_00811980 = 0;
      if (0 < local_EAX_6908) {
        local_10 = st::machine_word_boundary_cast<undefined4>(param_1 + 0x2d);
        local_18 = st::machine_word_boundary_cast<undefined4>(param_1 + 0x28);
        ...
        do {
          ...
          st::fn_004012F8(st::machine_word_boundary_cast<undefined4>(*ppAVar20),0,0x3fffffff,pbVar14,cVar3,sVar25,sVar26,sVar27,sVar28,sVar29,sVar30,
                     pcVar31,puVar15,puVar32);
          ppAVar20 = ppAVar20 + 1;
...
cf_common_exit_0066DF5E:
    ...
    case 0x7f1:
      ...
      pcVar22 = (char *)st::fn_004016B8(this_00,(char *)local_8,uVar5,(uint *)ppAVar20);
      local_10 = 0;
      if (0 < (int)pcVar22) {
        local_c = param_1 + 10;
        ...
        do {
          ...
          puVar9 = (byte *)(st::fn_004044E4(local_4f0,*(char *)&local_8->vtable));
          pcVar22 = local_c;
...
cf_common_join_0066CACB:
              local_10 = st::machine_word_boundary_cast<undefined4>((char *)((int)local_10 + iVar8));
            }
            else {
              if (0x100000 < uVar19) {
                iVar8 = local_124;
...
cf_continue_loop_0066CACD:
          ...
          pcVar22 = st::pointer_boundary_cast<char *>(local_18 + -1);
          local_18 = st::machine_word_boundary_cast<undefined4>(pcVar22);
    ...
    case 0x7f2:
      ...
      if (0 < (int)pcVar22) {
        ...
        do {
          uVar13 = STReplaceLowByte((uint32_t)(pcVar22), (uint8_t)(*(char *)&local_8->vtable));
          local_18 = st::machine_word_boundary_cast<undefined4>(pcVar22);
          puVar9 = (byte *)(st::fn_004044E4(local_3b8,*(char *)&local_8->vtable));
          pcVar22 = local_c;
          puVar21 = (byte *)(local_19c);
          memmove(puVar21, puVar9, 0x138); /* compiler REP MOVS byte copy */
    ...
    case 0x7f3:
      ...
      if (0 < (int)pcVar22) {
        ...
        do {
          uVar13 = STReplaceLowByte((uint32_t)(pcVar22), (uint8_t)(*(char *)&local_8->vtable));
          local_18 = st::machine_word_boundary_cast<undefined4>(pcVar22);
          puVar9 = (byte *)(st::fn_004044E4(local_628,*(char *)&local_8->vtable));
          pcVar22 = local_c;
          puVar21 = (byte *)(local_19c);
          memmove(puVar21, puVar9, 0x138); /* compiler REP MOVS byte copy */
...
cf_continue_loop_0066CFCA:
    ...
    case 0x7f4:
      ...
      pAVar7 = (AiFltClassTy *)st::fn_004016B8(this_00,(char *)local_8,uVar5,(uint *)ppAVar20);
      pcVar22 = nullptr;
      if (0 < (int)pAVar7) {
        local_c = param_1 + 10;
        ppAVar20 = local_50;
        ...
        do {
          ...
          local_EAX_9288 = st::fn_004021FD((int)*ppAVar20,GVar10);
    ...
    case 0x7f5:
      ...
      uVar12 = st::fn_00403440(GVar11,(int)param_1,iVar8,st::machine_word_boundary_cast<undefined4>(pcVar24),iVar4,(int)pcVar22);
      *local_14 = uVar12;
      break;
    default:
      goto cf_common_exit_00670456;
  ...
  case 0x7f7:
    ...
    local_EAX_11396 = st::fn_004016B8(this_00,(char *)local_8,uVar5,(uint *)ppAVar20);
    DAT_00811980 = 0;
    if (0 < local_EAX_11396) {
      ...
      do {
        uVar33 = 0;
        pcVar31 = st::function_address_boundary_cast<code *>(st::fn_00677EF0);
  ...
  case 0x7f8:
    ...
    st::fn_00402932((short)uVar13,(byte *)param_1,sVar25,sVar28,sVar26,sVar29,sVar27,sVar30,st::pointer_boundary_cast<code *>(puVar32),st::machine_word_boundary_cast<undefined4>(pcVar22)
            );
  ...
  case 0x7f9:
    ...
    DAT_00811980 = 0;
    uVar33 = 0;
    pcVar31 = st::function_address_boundary_cast<code *>(st::fn_00678870);
    ...
    st::fn_004013F2(pbVar14,cVar3,sVar25,sVar26,sVar27,sVar28,sVar29,sVar30,pcVar31,uVar33);
    goto cf_common_exit_0066DCED;
  case 0x7fa:
    local_8 = nullptr;
    do {
    ...
    local_EAX_12752 = st::fn_004016B8(this_00,(char *)local_8,uVar5,(uint *)ppAVar20);
    DAT_00811980 = 0;
    if (0 < local_EAX_12752) {
      ...
      do {
        uVar33 = 0;
        pcVar31 = st::function_address_boundary_cast<code *>(st::fn_00678560);
        ...
        st::fn_00403675((int)*ppAVar20,(short)uVar13,cVar3,pbVar14,sVar25,sVar26,sVar27,sVar28,sVar29,
                   sVar30,pcVar31,uVar33);
        ppAVar20 = ppAVar20 + 1;
  ...
  case 0x7fb:
    ...
    DAT_00811980 = 0;
    uVar33 = 0;
    pcVar31 = st::function_address_boundary_cast<code *>(st::fn_00677BC0);
...
cf_common_exit_0066DCED:
  ...
  case 0x80c:
    ...
    if (local_EAX_14021 == 1) {
      puVar32 = nullptr;
      puVar15 = nullptr;
      pcVar31 = st::function_address_boundary_cast<code *>(st::fn_00677200);
      sVar25 = -1;
      sVar26 = -1;
      sVar27 = -1;
      sVar28 = 0;
      ...
      local_EAX_14081 =
           st::fn_004012F8(st::machine_word_boundary_cast<undefined4>(local_50[0]),0,0x3fffffff,pbVar14,cVar3,sVar30,sVar29,sVar28,sVar27,sVar26,
  ...
  case 0x80d:
    ...
    if (local_EAX_14752 == 1) {
      uVar13 = 0;
      pcVar31 = st::function_address_boundary_cast<code *>(st::fn_00677F20);
      sVar25 = -1;
      sVar26 = -1;
      sVar27 = -1;
      sVar28 = 0;
      ...
      local_EAX_14803 =
           st::fn_00403882((short)local_50[0],0,pbVar14,sVar30,sVar29,sVar28,sVar27,sVar26,sVar25,
                       pcVar31,uVar13);
  ...
  case 0x80e:
    ...
    uVar13 = 0;
    pcVar31 = st::function_address_boundary_cast<code *>(st::fn_00678220);
    sVar25 = -1;
    sVar26 = -1;
    sVar27 = -1;
    sVar28 = 0;
    ...
    local_EAX_15327 = st::fn_00402932(0,pbVar14,sVar30,sVar29,sVar28,sVar27,sVar26,sVar25,pcVar31,uVar13);
  ...
  case 0x80f:
    ...
    uVar13 = 0;
    pcVar31 = st::function_address_boundary_cast<code *>(st::fn_00678890);
    sVar25 = -1;
    sVar26 = -1;
    sVar27 = -1;
    sVar28 = 0;
    ...
    local_EAX_15768 =
         st::fn_004013F2(pbVar14,cVar3,sVar30,sVar29,sVar28,sVar27,sVar26,sVar25,pcVar31,uVar13);
  ...
  case 0x810:
    ...
    if (local_EAX_16356 == 1) {
      uVar13 = 0;
      pcVar31 = st::function_address_boundary_cast<code *>(st::fn_00678580);
      sVar25 = -1;
      sVar26 = -1;
      sVar27 = -1;
      sVar28 = 0;
      ...
      local_EAX_16409 =
           st::fn_00403675((int)local_50[0],0,-1,pbVar14,sVar30,sVar29,sVar28,sVar27,sVar26,sVar25,
                      pcVar31,uVar13);
      if ((local_EAX_16409 == -1) && (g_fish_00811984 != nullptr)) {
        local_1c = st::machine_word_boundary_cast<undefined4>((char *)0x1);
  ...
  case 0x81c:
    ...
    local_10 = st::machine_word_boundary_cast<undefined4>((char *)this_00->slot_00(param_1));
  ...
  case 0x82b:
    ...
    uVar13 = this_00->slot_00(param_1 + 5);
    this_01 = (AnonReceiver_0065DA50 *)st::fn_00402496((char)local_50[0],(ushort)uVar13);
    pAVar7 = local_50[0];
    pcVar22 = local_c;
    if (this_01 != nullptr) {
      ...
      iVar4 = this_00->slot_00(param_1 + 10);
      pcVar22 = (char *)st::fn_0065DA50(this_01,iVar4,cVar3);
      pAVar7 = local_50[0];
      local_c = pcVar22;
    }
  ...
  case 0x82c:
    ...
    uVar13 = this_00->slot_00(param_1 + 5);
    pAVar17 = (AiFltClassTy *)st::fn_00402496((char)local_50[0],(ushort)uVar13);
    pAVar7 = local_50[0];
    pcVar22 = local_c;
    if (pAVar17 != nullptr) {
      ...
      pcVar22 = (char *)st::fn_004041BF(pAVar17,(int)(uVar23 >> 0x20),(uint)uVar23,cVar3);
      pAVar7 = local_50[0];
      local_c = pcVar22;
    }
    goto joined_r0x006703e6;
  ...
  case 0x82e:
    ...
    if (pAVar17 != nullptr) {
      ...
      uVar23 = this_00->slot_00(param_1 + 10);
      pcVar22 = (char *)st::fn_00401F0A(pAVar17,(int)(uVar23 >> 0x20),(uint)uVar23,uVar5,cVar3,
  ...
  case 0x82f:
    ...
    local_EAX_21310 = st::fn_004016B8(this_00,pcVar22,uVar5,puVar15);
    ...
    if (local_EAX_21372 != 0) {
      ...
      pcVar22 = (char *)st::fn_00405C13(local_EAX_21372,(int)(uVar23 >> 0x20),(uint)local_8,
...
LAB_0066fbc1:
  ...
  case 0x830:
    ...
    uVar13 = this_00->slot_00(param_1 + 5);
    local_8 = (AiFltClassTy *)st::fn_00402496((char)local_50[0],(ushort)uVar13);
    pAVar7 = local_50[0];
    pcVar22 = (char *)0xffffffff;
    if (local_8 != nullptr) {
  ...
  case 0x831:
    ...
    uVar13 = this_00->slot_00(param_1 + 5);
    pAVar18 = (AnonShape_0065E360_B94C37CB *)st::fn_00402496((char)local_50[0],(ushort)uVar13);
    pAVar7 = local_50[0];
    pcVar22 = local_c;
    if (pAVar18 != nullptr) {
      ...
      uVar23 = this_00->slot_00(param_1 + 10);
      pcVar22 = (char *)st::fn_004047EB(pAVar18,(int)(uVar23 >> 0x20),
...
LAB_0066d630:
    puVar15 = (uint *)st::fn_006C49B0((char *)pAVar7);
    if (param_3 == nullptr) {
      g_currentExceptionFrame = local_260.previous;
      return puVar15;
    }
...

{
  ...
  if (iVar3 != 0) {
    ...
    st::fn_0040193D((undefined4 *)&local_c);
    if (0 < iVar3) {
      iVar3 = -0x6b;
    }
    if (param_2 != nullptr) {
...
cf_continue_loop_006721A4:
    ...
    if ((local_10 == 0) && (local_14 == 0)) {
      ...
      if ((iVar2 < 0) || (iVar2 = st::fn_004016B3((int)*psVar6), iVar2 != 0)) {
        ...
        piVar7 = &local_1c;
        pcVar3 = st::fn_00403779(local_c,iVar5);
        local_8 = (float *)st::fn_00402545(local_24,pcVar3,iVar2,piVar7);
      }
    }
    else {
      local_1c = 1;
