  ...
  case 100:
    if (((local_c->field_007B != -0x8000) && (local_c->field_007B != 1)) &&
      ...
      if (STField<ushort>(param_1,0xe) == 1) {
        uVar24 = local_c->field_009B;
        if ((uVar24 < 0x8c) || (0x95 < uVar24)) {
          bVar25 = false;
        }
        else {
          bVar25 = true;
        ...
        if ((uVar24 == 0x23) || ((0xb < uVar24 && (uVar24 < 0x14)))) {
          bVar25 = true;
        }
        else {
          bVar25 = false;
