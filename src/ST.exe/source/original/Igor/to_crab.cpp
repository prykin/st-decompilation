...

{
  ...
  if (MESS_SHARED_010F < SVar1) {
    if (SVar1 != MESS_HITKILL) {
      ...
      st::fn_00402761(reinterpret_cast<STT3DSprC *>(puVar11),0xe);
      /* ST_CALLSITE[00578E72]: CALL 0x00402761; direct=00402761 STT3DSprC::sub_004AD070 */
      st::fn_00402761(reinterpret_cast<STT3DSprC *>(puVar11),0xd);
      g_currentExceptionFrame = local_80.previous;
      return 0;
    }

    uVar10 = st::fn_004052CC(reinterpret_cast<STT3DSprC *>(&this_00->field_01D5));
  ...
  if (SVar1 == MESS_SHARED_010F) {
    ...
    puVar11 = reinterpret_cast<byte *>(&this_00->field_0x259);
    pAVar14 = local_c;
    ...
    *(undefined4 *)&local_c->field_0x5c = 0;
    ...
    for (uVar10 = local_8 >> 2; uVar10 != 0; uVar10 = uVar10 - 1) {
      ...
      pbVar12 = pbVar12 + 4;
      pAVar14 = reinterpret_cast<AnonShape_00578630_C5BC66E1 *>(reinterpret_cast<byte *>(pAVar14) + 0x4);
    }
    for (uVar10 = local_8 & 3; uVar10 != 0; uVar10 = uVar10 - 1) {
      *(byte *)pAVar14 = *pbVar12;
      pbVar12 = pbVar12 + 1;
      pAVar14 = reinterpret_cast<AnonShape_00578630_C5BC66E1 *>(reinterpret_cast<byte *>(pAVar14) + 0x1);
    }
  ...
  if (SVar1 == MESS_ID_NONE) {
    ...
    st::fn_00405BD2(reinterpret_cast<RecoveredRecordView_00579350_91ECCCD1 *>(this_00));
    g_currentExceptionFrame = local_80.previous;
    return 0;
  }
  ...
  if ((uint)local_20[3] < 2) {
    ...
    puVar13 = reinterpret_cast<byte *>(&this_00->field_0x259);
    ...
    if (((((this_00->field_026D < 0) || ((int)g_worldGrid.sizeX <= this_00->field_026D)) ||
      ...
      st::fn_00404CB9(reinterpret_cast<RecoveredRecord_005783F0_545AD987 *>(this_00));
      ...
      case CASE_F2:
        ...
        iVar9 = st::fn_00404183
                          (reinterpret_cast<STT3DSprC *>(&this_00->field_01D5),0xe,PTR_0080676c,st::mutable_c_string("crab1l"),
                           CASE_1D);
        if (iVar9 != 0) {
          st::fn_006A5E40
        ...
        iVar9 = st::fn_00404183
                          (reinterpret_cast<STT3DSprC *>(&this_00->field_01D5),0xd,PTR_0080676c,st::mutable_c_string("crab1l_m"),
                           CASE_1D);
        if (iVar9 != 0) {
          iVar9 = 0xd5;
cf_error_exit_00578B5D:
      ...
      case CASE_F3:
        ...
        iVar9 = st::fn_00404183
                          (reinterpret_cast<STT3DSprC *>(&this_00->field_01D5),0xe,PTR_0080676c,st::mutable_c_string("crab2l"),
                           CASE_1D);
        if (iVar9 != 0) {
          st::fn_006A5E40
        ...
        iVar9 = st::fn_00404183
                          (reinterpret_cast<STT3DSprC *>(&this_00->field_01D5),0xd,PTR_0080676c,st::mutable_c_string("crab2l_m"),
                           CASE_1D);
        if (iVar9 != 0) {
          iVar9 = 0xdd;
      ...
      case CASE_F4:
        ...
        iVar9 = st::fn_00404183
                          (reinterpret_cast<STT3DSprC *>(&this_00->field_01D5),0xe,PTR_0080676c,st::mutable_c_string("crab1b"),
                           CASE_1D);
        if (iVar9 != 0) {
          st::fn_006A5E40
        ...
        iVar9 = st::fn_00404183
                          (reinterpret_cast<STT3DSprC *>(&this_00->field_01D5),0xd,PTR_0080676c,st::mutable_c_string("crab1b_m"),
                           CASE_1D);
        if (iVar9 != 0) {
          iVar9 = 0xe5;
          goto cf_error_exit_00578B5D;
      ...
      case CASE_F5:
        ...
        iVar9 = st::fn_00404183
                          (reinterpret_cast<STT3DSprC *>(&this_00->field_01D5),0xe,PTR_0080676c,st::mutable_c_string("crab2b"),
                           CASE_1D);
        if (iVar9 != 0) {
          st::fn_006A5E40
        ...
        iVar9 = st::fn_00404183
                          (reinterpret_cast<STT3DSprC *>(&this_00->field_01D5),0xd,PTR_0080676c,st::mutable_c_string("crab2b_m"),
                           CASE_1D);
        if (iVar9 != 0) {
          iVar9 = 0xed;
          goto cf_error_exit_00578B5D;
      ...
      case CASE_F6:
        ...
        iVar9 = st::fn_00404183
                          (reinterpret_cast<STT3DSprC *>(&this_00->field_01D5),0xe,PTR_0080676c,st::mutable_c_string("langus2"),
                           CASE_1D);
        if (iVar9 != 0) {
          st::fn_006A5E40
        ...
        iVar9 = st::fn_00404183
                          (reinterpret_cast<STT3DSprC *>(&this_00->field_01D5),0xd,PTR_0080676c,st::mutable_c_string("langus2m"),
                           CASE_1D);
        if (iVar9 != 0) {
          iVar9 = 0xfd;
          goto cf_error_exit_00578B5D;
      ...
      case CASE_F7:
        ...
        iVar9 = st::fn_00404183
                          (reinterpret_cast<STT3DSprC *>(&this_00->field_01D5),0xe,PTR_0080676c,st::mutable_c_string("langus1"),
                           CASE_1D);
        if (iVar9 != 0) {
          st::fn_006A5E40
        ...
        iVar9 = st::fn_00404183
                          (reinterpret_cast<STT3DSprC *>(&this_00->field_01D5),0xd,PTR_0080676c,st::mutable_c_string("langus1m"),
                           CASE_1D);
        if (iVar9 != 0) {
          iVar9 = 0xf5;
          goto cf_error_exit_00578B5D;
      ...
      st::fn_00403AFD(reinterpret_cast<STT3DSprC *>(puVar11),'\r');
      ...
      st::fn_00405240(reinterpret_cast<STT3DSprC *>(puVar11),0xd,g_playSystem_00802A38->field_00E4);
      ...
      SVar7 = st::fn_0040104B(this_00,reinterpret_cast<short *>(&this_00->field_004E),reinterpret_cast<short *>(&this_00->field_0050),
                                 reinterpret_cast<undefined2 *>(&this_00->field_006C));
      this_00->field_0239 = SVar7;
    }
  }
  else if (local_20[3] == 2) {
    puVar11 = reinterpret_cast<byte *>((local_20));
    puVar13 = reinterpret_cast<byte *>(&this_00->field_0x259);
    memmove(puVar13, puVar11, 0x28); /* compiler REP MOVS byte copy */
    local_8 = local_20[0x18];
    /* ST_CALLSITE[00578720]: CALL 0x0040551f; direct=0040551F STAllPlayersC::RestoreGObjData */
    st::fn_0040551F
              (reinterpret_cast<STAllPlayersC *>(this_00),(undefined4 *)(local_8 + 0x68 + (int)local_20));
    puVar11 = reinterpret_cast<byte *>((local_20));
    ...
    if (local_3c != nullptr) {
      ...
      st::fn_00404CA5
                (reinterpret_cast<STT3DSprC *>(&this_00->field_01D5),reinterpret_cast<int *>(&local_3c),
                 reinterpret_cast<RecoveredRecordView_004AD790_D4DB5A31 *>((puVar11 + 0x19)));
  ...
  iVar9 = st::fn_004010C3(reinterpret_cast<RecoveredRecord_0058CFE0_6E80059E *>(this_00));
  if (iVar9 != 0) {
    g_currentExceptionFrame = local_80.previous;
    return 0;
  }
