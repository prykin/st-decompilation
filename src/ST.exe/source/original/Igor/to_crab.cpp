...

{
  ...
  if (iVar7 != 0) {
    ...
    iVar9 = st::fn_006AD4D0("E:\\__titans\\Igor\\to_crab.cpp",0x1b7,0,iVar7,"%s",
                               "STCrabC::GetMessage");
    if (iVar9 != 0) {
      STDebugBreak(); /* noreturn in standalone pseudocode */
    }
    st::fn_006A5E40(iVar7,0,"E:\\__titans\\Igor\\to_crab.cpp",0x1b8);
    return 0xffff;
  }
...
cf_error_exit_00578B5D:
      ...
      *(short *)&this_00->field_0x6c =
      ...
      uVar8 = st::fn_0040104B(this_00,(undefined2 *)&this_00->field_0x4e,
  ...
  iVar7 = st::fn_004010C3((int)this_00);
  if (iVar7 != 0) {
    g_currentExceptionFrame = local_80.previous;
    return 0;
  }
...

{
  ...
  if (0x167 < this->field_027D) {
    iVar4 = st::fn_006AD4D0("E:\\__titans\\Igor\\to_crab.cpp",0x20c,0,0,"%s",
  ...
  iVar4 = 0;
  do {
    iVar5 = st::fn_00404D3B((short)this->field_026D,(short)this->field_0271,(short)iVar4);
    if (iVar5 != 0) {
