  ...
  if (SVar3 != MESS_ID_NONE) {
    if (SVar3 != MESS_ID_CREATE) {
      ...
      if (*(int *)&this_00->field_0x26d != 0) {
        ...
        *(int *)&this_00->field_0x265 = iVar11;
        while (-1 < iVar11) {
          st::fn_004021D5(*(STT3DSprC **)(*(int *)&this_00->field_0x26d + iVar11 * 4));
          st::fn_0072E2B0
    ...
    if (local_18[3] < CASE_2) {
      ...
      *(uint *)&this_00->field_0x261 = *(uint *)&this_00->field_0x261 | 1;
      ...
      local_EAX_1359 = st::fn_00401ED3((STDcResourcC *)this_00);
      ...
      *(uint *)&this_00->field_0x261 = *(uint *)&this_00->field_0x261 | 1;
      ...
      st::fn_0040295F(this_00,*(short *)((int)&this_00->field_0244 + 1),
                         *(short *)&this_00->field_0x249,*(short *)&this_00->field_0x24d,0);
      local_EAX_826 = st::fn_00401ED3((STDcResourcC *)this_00);
...
LAB_0057e6f0:
  ...
  st::fn_006E6580(this_00->field_0211,piVar24);
  *(undefined4 *)&this_00->field_0x273 = 0;
cf_common_join_0057E9C2:
  this_00->vfunc_D8();
  if ((*(int *)&this_00->field_0x255 != 0xe0) && (iVar11 = 0, 0 < *(int *)&this_00->field_0x265)) {
    do {
      st::fn_004033AA(*(void **)(*(int *)&this_00->field_0x26d + iVar11 * 4),
