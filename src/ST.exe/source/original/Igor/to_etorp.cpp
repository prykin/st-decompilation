...

{
  ...
  *param_3 = (int)pvVar9;
  ...
  if (((pvVar9 == nullptr) || (param_2 == 0)) || ((param_2 != 5 && (param_2 != 7)))) {
    iVar18 = st::fn_006AD4D0("E:\\__titans\\Igor\\to_etorp.cpp",0x4c,0,0,"%s",
                                "ConusExplosion:Bad parameters or memory error");
    if (iVar18 != 0) {
      STDebugBreak(); /* noreturn in standalone pseudocode */
    }
    if (*param_3 != 0) {
      st::fn_006AB060((void **)param_3);
    }
  }
  else {
...
LAB_0057ac02:
      iVar18 = st::fn_006ACF0D((int)*(short *)&param_1->field_0x34,(int)param_1->field_0036,
    ...
    if (local_dc != 0) {
      ...
      local_b8 = st::fn_006ACED8(iVar22,iVar18,local_68,local_64);
      if (local_b8 != 0) {
...
LAB_0057a96b:
                    ...
                    if ((bVar24) && (iVar14 = (*this->vtable[5].slots_00_28[2])(), iVar14 != 0)) {
                      st::fn_004031E3(this,local_b4,(int *)local_e8,(int *)local_20);
                      iVar14 = st::fn_00401726(iVar22,iVar18,local_40,local_8c,local_98,local_a8,
                                                  (int)local_b4[0],(int)local_e8[0],(int)local_20[0]
                                                 );
                      if ((iVar14 < 0) ||
                         (iVar15 = st::fn_006ACF0D((iVar14 * local_8c) / 10000 + iVar22,
...

{
  ...
  if ((param_2 < 0x1a) || (0x23 < param_2)) {
    ...
    *param_3 = (int)pvVar7;
    ...
    iVar8 = st::fn_006AD4D0("E:\\__titans\\Igor\\to_etorp.cpp",0x15d,0,0,"%s",
