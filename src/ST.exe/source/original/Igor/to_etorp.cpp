...
/* [STSourceProvenanceApplier begin]
   ...
   Evidence: 0057B670 -> 0057A2C0 @ 0057B6F7; FUN_0057b670 parameter param_1 */

undefined4 __cdecl
st::fn_0057A2C0(RecoveredRecordView_0057A2C0_3DDE89E7 *param_1,uint param_2,int *param_3,short *param_4
            ,int param_5,RecoveredRecord_0057B670_1C4E1DA6 *param_6,short *param_7)

{
  alignas(4) byte st_stack_frame[348];

  AnonShape_0057A2C0_ED849BD2 *pAVar1;
  ushort *puVar2;
  byte bVar3;
  byte bVar4;
  byte bVar5;
  ...
  int local_d4;
  int local_d0;
  AnonShape_0057A2C0_ED849BD2 *local_cc;
  int local_c8;
  int local_c4;
  int local_b8;
  short local_b4 [6];
  ...
  pvVar11 = st::fn_006AAC70(param_2 * 8);
  *param_3 = (int)pvVar11;
  /* ST_PSEUDO[stack_slot_reuse]: compiler reused a dead incoming argument slot; split the post-write lifetime into a local variable */
  if (((pvVar11 == nullptr) || (param_2 == 0)) || ((param_2 != 5 && (param_2 != 7)))) {
    ...
    sVar15 = param_1->field_003A;
    sVar9 = *(short *)&param_1->field_0x34;
    sVar20 = *(short *)&param_1->field_0x3c;
...
LAB_0057ac02:
      ...
      local_a0 = (((int)*(short *)&param_1->field_0x3c - (int)param_1->field_0036) * 10000) /
                 iVar11_mg3;
      iVar21 = (((int)param_1->field_003A - (int)*(short *)&param_1->field_0x34) * 10000) /
               iVar11_mg3;
      iVar25 = (((int)param_1->field_003E - (int)*(short *)&param_1->field_0x38) * 10000) /
               iVar11_mg3;
      ...
      iVar13 = param_2 - 1;
      if (-1 < iVar13) {
        local_120 = reinterpret_cast<int *>((local_f0 + iVar13 * 4));
        iVar17 = iVar13 * 0xc;
        do {
          if ((local_f0 == nullptr) || (*local_120 == 0)) {
            uVar16 = *(int *)&param_1->field_0x1c * 0x41c64e6d + 0x3039;
            *(uint *)&param_1->field_0x1c = uVar16;
            local_78 = local_78 +
                       ((uVar16 >> 0x10) % ((st::storage_bit_cast<int>(static_cast<uint32_t>((local_78 >> 0x1f & 7U) + local_78)) >> 3) + 1U) -
                       (st::storage_bit_cast<int>(static_cast<uint32_t>(local_78 + (local_78 >> 0x1f & 0xfU))) >> 4));
            if (param_2 == 7) {
              iVar23 = STField<int>(iVar17,0x7CAE80);
              iVar18 = (int)((ulonglong)
                             ((longlong)(local_78 * STField<int>(iVar17,0x7CAE7C)) * 0x68db8bad) >>
                            0x20);
            }
            else {
              iVar23 = STField<int>(iVar17,0x7CAED4);
              iVar18 = (int)((ulonglong)
                             ((longlong)(STField<int>(iVar17,0x7CAED0) * local_78) * 0x68db8bad) >>
                            0x20);
            }
            local_d4 = (iVar23 * local_78) / 10000;
            local_6c = (iVar18 >> 0xc) - (iVar18 >> 0x1f);
            iVar18 = (local_50 * param_5) / 10000 - (iVar25 * local_d4) / 10000;
            iVar12 = local_6c * iVar21;
            iVar24 = iVar18 * local_a0;
            sVar15 = param_1->field_0043;
            local_4c = ((iVar25 * param_5) / 10000 - (local_50 * local_d4) / 10000) +
                       (short)param_1->field_0045;
            iVar18 = iVar18 * iVar21;
            iVar23 = local_6c * local_a0;
            *(short *)(*param_3 + iVar13 * 8) =
                 ((((short)(iVar18 / 10000) + (short)(iVar18 >> 0x1f)) -
                  (short)((longlong)iVar18 * 0x68db8bad >> 0x3f)) -
                 (((short)(iVar23 / 10000) + (short)(iVar23 >> 0x1f)) -
                 (short)((longlong)iVar23 * 0x68db8bad >> 0x3f))) + param_1->field_0041;
            *(short *)(*param_3 + 2 + iVar13 * 8) =
                 (((short)(iVar24 / 10000) + (short)(iVar24 >> 0x1f) +
                  (((short)(iVar12 / 10000) + (short)(iVar12 >> 0x1f)) -
                  (short)((longlong)iVar12 * 0x68db8bad >> 0x3f))) -
                 (short)((longlong)iVar24 * 0x68db8bad >> 0x3f)) + sVar15;
            iVar23 = *param_3;
            *(undefined2 *)(iVar23 + 4 + iVar13 * 8) = (undefined2)local_4c;
            puVar2 = (undefined2 *)(*param_3 + iVar13 * 8);
            uVar19 = (undefined2)((uint)iVar23 >> 0x10);
            uVar10 = (undefined2)((uint)puVar2 >> 0x10);
            local_d0 = iVar13;
            /* ST_CALLSITE[0057AF75]: CALL dword ptr [EDX + 0x10]; [STIndirectCallsiteApplier] exact slot 0x10; mode=structural-presentation; signature=__thiscall;/undefined4;pointer:/void;/undefined4;/undefined4;/undefined4;/undefined4;/undefined4;/undefined4 */
            ...
            uVar10 = (**(code **)(param_1->field_0000 + 0x10))
                               (CONCAT22(uVar19,param_1->field_0041),
                                CONCAT22(uVar10,param_1->field_0043),
                                CONCAT22(uVar19,param_1->field_0045),CONCAT22(uVar10,*puVar2),
                                CONCAT22(uVar19,puVar2[1]));
            *(undefined2 *)(*param_3 + 6 + iVar13 * 8) = uVar10;
          }
          iVar13 = iVar13 + -1;
    ...
    local_dc = st::fn_006ACF0D((int)*(short *)&param_1->field_0x34,(int)param_1->field_0036,
                            ...
                            (int)*(short *)&param_1->field_0x3c,(int)param_1->field_003E);
    if (local_dc != 0) {
      local_8c = (((int)sVar15 - (int)sVar9) * 10000) / local_dc;
      local_98 = (((int)sVar20 - (int)sVar6) * 10000) / local_dc;
      local_a8 = (local_40 * 10000) / local_dc;
      sVar15 = param_1->field_0041;
      iVar25 = (int)sVar15;
      sVar9 = param_1->field_0043;
      iVar21 = (int)sVar9;
      local_40 = (short)param_1->field_0045;
      local_68 = (local_8c * 0x324) / 10000 + iVar25;
      local_64 = (local_98 * 0x324) / 10000 + iVar21;

      iVar11_mg1 = st::fn_006ACED8(iVar25,iVar21,local_68,local_64);
      if (iVar11_mg1 != 0) {
        local_94 = ((local_64 - iVar21) * 10000) / iVar11_mg1;
        local_b8 = ((iVar25 - local_68) * 10000) / iVar11_mg1;
        if (((int)param_2 < 0) || (10 < (int)param_2)) {
          param_2 = 7;
        }
        iVar13 = param_2 * -4;
        local_1c = (st_stack_frame + 32) + iVar13;
        puVar26 = reinterpret_cast<uint *>(((st_stack_frame + 32) + iVar13));
        for (uVar16 = param_2 & 0x3fffffff; uVar16 != 0; uVar16 = uVar16 - 1) {
          *puVar26 = 0;
          puVar26 = puVar26 + 1;
        }
        ...
        local_8 = 0xffffffff;
        if (iVar25 < 0) {
          local_38[0] = sVar15 / 0xc9 + -1;
        }
        else {
          local_38[0] = (sVar15 / 0xc9 + (sVar15 >> 0xf)) -
        ...
        iVar17 = ((param_5 + 0xc9) * local_94) / 10000;
        iVar23 = local_68 + iVar17;
        if (iVar23 < 0) {
          local_30 = (short)(iVar23 / 0xc9) + -1;
        }
        else {
          local_30 = ((short)(iVar23 / 0xc9) + (short)(iVar23 >> 0x1f)) -
                     (short)((longlong)iVar23 * 0x28c1979 >> 0x3f);
        }
        iVar23 = ((param_5 + 0xc9) * local_b8) / 10000;
        iVar18 = local_64 + iVar23;
        if (iVar18 < 0) {
          local_2e = (short)(iVar18 / 0xc9) + -1;
        }
        else {
          local_2e = ((short)(iVar18 / 0xc9) + (short)(iVar18 >> 0x1f)) -
                     (short)((longlong)iVar18 * 0x28c1979 >> 0x3f);
        }
        local_2c = 0;
        iVar17 = local_68 - iVar17;
        if (iVar17 < 0) {
          local_28 = (short)(iVar17 / 0xc9) + -1;
        }
        else {
          local_28 = ((short)(iVar17 / 0xc9) + (short)(iVar17 >> 0x1f)) -
                     (short)((longlong)iVar17 * 0x28c1979 >> 0x3f);
        }
        iVar23 = local_64 - iVar23;
        if (iVar23 < 0) {
          local_26 = (short)(iVar23 / 0xc9) + -1;
        }
        else {
          local_26 = ((short)(iVar23 / 0xc9) + (short)(iVar23 >> 0x1f)) -
                     (short)((longlong)iVar23 * 0x28c1979 >> 0x3f);
        }
        local_24 = 5;
        if (((((-1 < local_38[0]) && (local_38[0] < g_worldGrid.sizeX)) && (-1 < local_38[1])) &&
            ((local_38[1] < g_worldGrid.sizeY && (-1 < local_38[2])))) && (local_38[2] < 5)) {
          iVar17 = (int)local_38[0];
          local_5c = iVar17;
          ...
          local_fc = iVar17;
          do {
            iVar18 = (int)local_38[iVar23 * 4];
            if (iVar18 < iVar17) {
              local_5c = iVar18;
              iVar17 = iVar18;
            }
            iVar12 = (int)local_38[iVar23 * 4 + 1];
            if (iVar12 < local_58) {
              local_58 = iVar12;
            }
            if (local_fc < iVar18) {
          ...
          if ((int)g_worldGrid.sizeX < local_fc + 1) {
            iVar23 = (int)g_worldGrid.sizeX;
          }
          iVar18 = local_84 + 1;
          if ((int)g_worldGrid.sizeY < local_84 + 1) {
            iVar18 = (int)g_worldGrid.sizeY;
          }
          local_84 = iVar18;
          *(undefined4 *)((st_stack_frame + 28) + iVar13) = 0x57a7b7;
          local_1c = (st_stack_frame + 32);
          local_cc = reinterpret_cast<AnonShape_0057A2C0_ED849BD2 *>((st_stack_frame + 32));
          local_8 = 0xffffffff;
          local_d8 = 0;
          local_74 = 0;
          do {
            ...
            if (local_58 < iVar18) {
              do {
                while (iVar17 = local_5c, local_5c = iVar17, iVar8 < iVar23) {
                  sVar15 = (short)iVar12;
                  if (((sVar15 < 0) || (g_worldGrid.sizeX <= sVar15)) ||
                     ((sVar9 = (short)local_80, sVar9 < 0 ||
                      (((g_worldGrid.sizeY <= sVar9 || (sVar20 = (short)local_74, sVar20 < 0)) ||
                       (g_worldGrid.sizeZ <= sVar20)))))) {
                    this = nullptr;
                  }
                  else {
                    this = STGridAt3D(g_worldGrid, sVar15, sVar9, sVar20).objects[0];
                  }
                  local_74 = iVar24;
                  if (((this != nullptr) &&
...
LAB_0057a96b:
                      ...
                      bVar27 = g_bulkInitializedRecords_008087C7[bVar4].field_0023 !=
                    ...
                    if ((bVar27) && (iVar17 = this->vfunc_F8(), iVar17 != 0))
                    {
                      st::fn_004031E3(this,reinterpret_cast<uint *>(local_b4),local_e8,local_20);

                      iVar14 = st::fn_00401726(iVar25,iVar21,local_40,local_8c,local_98,local_a8,
                                                  (int)local_b4[0],(int)local_e8[0],(int)local_20[0]
                                                 );
                      if ((iVar14 < 0) ||

                         (iVar15 = st::fn_006ACF0D((iVar14 * local_8c) / 10000 + iVar25,
                                                (iVar14 * local_98) / 10000 + iVar21,
                                                (iVar14 * local_a8) / 10000 + local_40,
                                                (int)local_b4[0],(int)local_e8[0],(int)local_20[0]),
                         iVar15 * 0x324 <= iVar14 * local_c4 * 2)) {
                        pAVar1 = local_cc + local_d8;
                        *(STWorldObjectVTable **)pAVar1 = this[1].vtable;
                        *(undefined4 *)&pAVar1->field_0x26 = *(undefined4 *)&this->field_0x18;
                        *(undefined2 *)&pAVar1->field_0x2a = *(undefined2 *)&this[1].field_0xe;
                        *(STWorldObject **)&pAVar1->field_0x1a = this;
                        *(short *)&pAVar1->field_0x14 = sVar15;
                        *(undefined2 *)&pAVar1->field_0x16 = (undefined2)local_80;
                        *(undefined2 *)&pAVar1->field_0x18 = (undefined2)local_74;
                        *(int *)&pAVar1->field_0008 = (int)local_b4[0];
                        *(int *)&pAVar1->field_000C = (int)local_e8[0];
                        *(int *)&pAVar1->field_0010 = (int)local_20[0];
                        *(undefined4 *)&pAVar1->field_0x1e = 0;
                        local_d8 = local_d8 + 1;
                      }
                    }
                  }
                ...
                iVar12 = iVar17;
                iVar8 = iVar17;
              } while (local_80 < iVar18);
            }
            local_74 = local_74 + 1;
          } while (local_74 < 5);
          local_f0 = (st_stack_frame + 32) + iVar13;
          if (local_d8 != 0) {
            ...
            if (0 < local_d8) {
              do {
                local_f0 = (st_stack_frame + 32) + iVar13;
                if ((int)param_2 <= iVar21) break;
                iVar25 = local_c8 + iVar21;
                if (local_d8 <= iVar25) {
                  iVar25 = iVar25 - local_d8;
                }
                *(undefined2 *)(*param_3 + iVar21 * 8) = local_cc[iVar25].field_0008;
                *(undefined2 *)(*param_3 + 2 + iVar21 * 8) = local_cc[iVar25].field_000C;
                iVar17 = *param_3;
                *(undefined2 *)(iVar17 + 4 + iVar21 * 8) = local_cc[iVar25].field_0010;
                puVar2 = (undefined2 *)(*param_3 + iVar21 * 8);
                uVar19 = (undefined2)((uint)iVar17 >> 0x10);
                uVar10 = (undefined2)((uint)puVar2 >> 0x10);
                /* ST_CALLSITE[0057ABDE]: CALL dword ptr [EDX + 0x10]; [STIndirectCallsiteApplier] exact slot 0x10; mode=structural-presentation; signature=__thiscall;/undefined4;pointer:/void;/undefined4;/undefined4;/undefined4;/undefined4;/undefined4;/undefined4 */
                /* ST_PSEUDO[raw_indirect_call,packed_or_unaligned_piece]: expected typed vtable or function-table callback call with the machine-proven calling convention; expected named packed member, bit extract/compose, or unaligned load */
                uVar10 = (**(code **)(param_1->field_0000 + 0x10))
                                   (CONCAT22(uVar19,param_1->field_0041),
                                    CONCAT22(uVar10,param_1->field_0043),
                                    CONCAT22(uVar19,param_1->field_0045),CONCAT22(uVar10,*puVar2),
                                    CONCAT22(uVar19,puVar2[1]));
                *(undefined2 *)(*param_3 + 6 + iVar21 * 8) = uVar10;
                *(undefined4 *)((st_stack_frame + 32) + iVar21 * 4 + iVar13) = 1;
                iVar21 = iVar21 + 1;
                local_f0 = (st_stack_frame + 32) + iVar13;
              } while (iVar21 < local_d8);
            }
          }
          goto LAB_0057ac02;
        }
