...

{
  ...
  st::fn_00404F07(reinterpret_cast<STSprGameObjC *>(local_1c),message);
  SVar2 = message->id;
  if (MESS_TORPHIT < SVar2) {
    ...
    case MESS_HITKILL:
      ...
      uVar7 = st::fn_004052CC(reinterpret_cast<STT3DSprC *>(&this_00->field_01D5));
  ...
  if (SVar2 == MESS_TORPHIT) {
    ...
    puVar9 = reinterpret_cast<byte *>((&this_00->field_01D5));
    this_00->field_023B = CASE_5;
    /* ST_CALLSITE[0057C608]: CALL 0x00404264; direct=00404264 STT3DSprC::StopShow */
    st::fn_00404264(reinterpret_cast<STT3DSprC *>(puVar9),0xe);
    st::fn_00402A90(reinterpret_cast<STT3DSprC *>(puVar9));
    /* ST_CALLSITE[0057C626]: CALL 0x00404183; direct=00404183 STT3DSprC::LoadSequence */
    st::fn_00404183(reinterpret_cast<STT3DSprC *>(puVar9),8,PTR_00806774,st::mutable_c_string("explsna"),CASE_1D);
    /* ST_CALLSITE[0057C63B]: CALL 0x00405240; direct=00405240 STT3DSprC::StartShow */
    st::fn_00405240(reinterpret_cast<STT3DSprC *>(puVar9),8,g_playSystem_00802A38->field_00E4);
    g_currentExceptionFrame = local_80.previous;
    return 0;
  }
  if (MESS_SHARED_0003 < SVar2) {
    ...
    puVar9 = reinterpret_cast<byte *>(&this_00->field_0x243);
    pAVar12 = local_c;
  ...
  local_20 = (undefined4 *)(message->arg0).ptr;
  if (1 < (uint)local_20[3]) {
    if (local_20[3] == 2) {
      puVar9 = reinterpret_cast<byte *>((local_20));
      puVar11 = reinterpret_cast<byte *>(&this_00->field_0x243);
      ...
      st::fn_0040551F
                (reinterpret_cast<STAllPlayersC *>(this_00),(undefined4 *)(local_8 + 0x46 + (int)local_20));
      puVar9 = reinterpret_cast<byte *>((local_20));
      ...
      if (local_3c != nullptr) {
        ...
        st::fn_00404CA5
                  (reinterpret_cast<STT3DSprC *>(&this_00->field_01D5),reinterpret_cast<int *>(&local_3c),
                   (RecoveredRecordView_004AD790_D4DB5A31 *)((int)puVar9 + 0x42));
        ...
        st::fn_00401064(reinterpret_cast<STT3DSprC *>(&this_00->field_01D5),'\x0e',0);
      }
    }
  ...
  memmove(puVar11, puVar9, 0x28); /* compiler REP MOVS byte copy */
  iVar6 = 0;
  st::fn_004034B8(reinterpret_cast<RecoveredRecordView_0057CB30_39CFDDE6 *>(this_00));
  ...
  case CASE_E7:
    ...
    iVar6 = st::fn_00404183(reinterpret_cast<STT3DSprC *>(puVar9),0xe,PTR_0080676c,st::mutable_c_string("fish1"),CASE_1D);
    if (iVar6 != 0) {
      st::fn_006A5E40
    ...
    st::fn_00401064(reinterpret_cast<STT3DSprC *>(puVar9),'\x0e',0);
  ...
  case CASE_E8:
    ...
    iVar6 = st::fn_00404183
                      (reinterpret_cast<STT3DSprC *>(&this_00->field_01D5),0xe,PTR_0080676c,st::mutable_c_string("fish_b"),CASE_1D);
    if (iVar6 != 0) {
      iVar6 = 0xea;
cf_error_exit_0057C332:
  ...
  case CASE_E9:
    ...
    iVar6 = st::fn_00404183
                      (reinterpret_cast<STT3DSprC *>(&this_00->field_01D5),0xe,PTR_0080676c,st::mutable_c_string("fish_gr"),CASE_1D
                      );
    if (iVar6 != 0) {
      iVar6 = 0xf0;
  ...
  case CASE_EA:
    ...
    iVar6 = st::fn_00404183
                      (reinterpret_cast<STT3DSprC *>(&this_00->field_01D5),0xe,PTR_0080676c,reinterpret_cast<char *>(&DAT_007cb008),CASE_1D);
    if (iVar6 != 0) {
      iVar6 = 0xfd;
      goto cf_error_exit_0057C332;
    }
  ...
  case CASE_EB:
    ...
    iVar6 = st::fn_00404183
                      (reinterpret_cast<STT3DSprC *>(&this_00->field_01D5),0xe,PTR_0080676c,reinterpret_cast<char *>(&DAT_007cb010),CASE_1D);
    if (iVar6 != 0) {
      iVar6 = 0x104;
      goto cf_error_exit_0057C332;
    }
...
switchD_0057c210_default:
  ...
  st::fn_00405240(reinterpret_cast<STT3DSprC *>(&this_00->field_01D5),0xe,g_playSystem_00802A38->field_00E4);
  /* ST_CALLSITE[0057C3A1]: CALL 0x004045d9; direct=004045D9 STT3DSprC::sub_004AD3C0 */
  st::fn_004045D9
            (reinterpret_cast<STT3DSprC *>(&this_00->field_01D5),
...
cf_common_exit_0057C3E4:
  if ((this_00->field_023B != CASE_6) &&

     (iVar6 = st::fn_004010C3(reinterpret_cast<RecoveredRecord_0058CFE0_6E80059E *>(this_00)), iVar6 == 0)) {
...
switchD_0057c669_caseD_127:
  ...
  iVar6 = st::fn_004019E7(0,0,g_worldGrid.sizeX + -1,g_worldGrid.sizeY + -1,
                             ...
                             (short)((message->arg1).words.high * 0xc9 + 100),reinterpret_cast<undefined2 *>(psVar1),reinterpret_cast<undefined2 *>(psVar1),
                             &this_00->field_0239);
  if (iVar6 == 0) {
    g_currentExceptionFrame = local_80.previous;
    return 0;
...

{
  ...
  iVar3 = st::fn_00401A3C(reinterpret_cast<RecoveredRecordView_0041C710_A35B7121 *>(this));
  this_00 = &this->field_01D5;
  if (iVar3 == 0) {
    iVar3 = 0;

    uVar4 = st::fn_004052CC(reinterpret_cast<STT3DSprC *>(this_00));

    st::fn_006EABF0((void *)this->field_0211,uVar4,iVar3);

    iVar2 = st::fn_004050D8(reinterpret_cast<RecoveredRecordView_0041CAF0_18493751 *>(this));
    if (iVar2 == 1) {
      iVar3 = 1;
    }
    else {
  ...
  iVar4 = st::fn_004052CC(reinterpret_cast<STT3DSprC *>(this_00));
  ...
  if (SVar1 == CASE_4) {
    ...
    if (iVar3 == -1) {
      ...
      st::fn_00404318
                (reinterpret_cast<RecoveredReceiver_004167A0 *>(this),this->field_0235,this->field_0237,
                 this->field_0239);
    ...
    /* ST_PSEUDO[unresolved_register_input]: candidate live-in register: verify boundary, SEH/setjmp ABI, or convention */
    iVar3 = (*this->vtable->MoveStep)(reinterpret_cast<STGameObjC *>(this),unaff_EDI);
    if (iVar3 != 0) {
      if (iVar3 == 1) {
        uVar4 = 0;
      }
    ...
    iVar3 = st::fn_0040314D(reinterpret_cast<RecoveredRecordView_00417830_39C1D071 *>(this));
    if (iVar3 == 0) {
    ...
    iVar3 = st::fn_004022AC(reinterpret_cast<STT3DSprC *>(this_00),'\b');
...
LAB_0057cfe0:
  ...
  case CASE_E7:
    ...
    st::fn_00401064(reinterpret_cast<STT3DSprC *>(this_00),'\x0e',g_playSystem_00802A38->field_00E4 % 0x78 >> 1);
    break;
  case CASE_E8:
...
LAB_0057d24b:
    ...
    st::fn_00401064(reinterpret_cast<STT3DSprC *>(this_00),'\x0e',uVar4);
    /* ST_CALLSITE[0057D25D]: CALL 0x004052fe; direct=004052FE STT3DSprC::SetCurShad */
    st::fn_004052FE(reinterpret_cast<STT3DSprC *>(this_00),'\x0e',local_8);
    break;
  case CASE_EA:
    iVar3 = (0x18 - (int)this->field_006C / 0xf) % 0x18;
    ...
    st::fn_004052FE(reinterpret_cast<STT3DSprC *>(this_00),'\x0e',iVar3 / 3);
    break;
  case CASE_EB:
    iVar3 = (0x18 - (int)this->field_006C / 0xf) % 0x18;
    ...
    st::fn_004052FE(reinterpret_cast<STT3DSprC *>(this_00),'\x0e',uVar4 + (iVar3 / 3) * 0x14);
    break;
  default:
