...

{
  ...
  if (MESS_SHARED_010F < SVar1) {
    if (SVar1 == MESS_STJELLYMANC_0124) {
      ...
      *(undefined4 *)((int)pSVar4->field_0207 + iVar9 * 4) = 0;
      ...
      if (SVar1 == MESS_STJELLYMANC_0125) {
        ...
        iVar7_mg1 = st::fn_006E5380(g_playSystem_00802A38,(message->arg0).i32,reinterpret_cast<undefined4 *>(&local_c));
        if (iVar7_mg1 != 0) {
          g_currentExceptionFrame = local_54.previous;
          return 0;
        }
    ...
    st::fn_00405038(reinterpret_cast<RecoveredRecord_005811C0_696D31CF *>(pSVar4));
    g_currentExceptionFrame = local_54.previous;
    return 0;
  }
  if (SVar1 == MESS_SHARED_010F) {

    local_8 = (byte *)st::fn_006AAC70(0x3a);
    if (local_8 == nullptr) {
      g_currentExceptionFrame = local_54.previous;
      return 0;
    }
    puVar12 = reinterpret_cast<byte *>(&pSVar4->field_0x1d9);
    pbVar14 = local_8;
  ...
  if (uVar10 < 2) {
    pSVar4->field_01D5 = 0;
    pSVar4->field_020F = 0;
    puVar12 = reinterpret_cast<byte *>(((message->arg0).ptr));
    puVar11 = reinterpret_cast<byte *>(&pSVar4->field_0x1d9);
    ...
    pvVar5 = st::fn_006AAC70(pSVar4->field_01FD << 2);
    ...
    puVar12 = reinterpret_cast<byte *>(((message->arg0).ptr));
    puVar11 = reinterpret_cast<byte *>((puVar12));
    puVar13 = reinterpret_cast<byte *>(&pSVar4->field_0x1d9);
...
cf_common_exit_00581D62:
  puVar12 = reinterpret_cast<byte *>((pSVar4->field_0207));
  ...
  puVar12 = reinterpret_cast<byte *>((pSVar4->field_020B));
  for (uVar10 = pSVar4->field_01FD & 0x3fffffff; uVar10 != 0; uVar10 = uVar10 - 1) {
    *puVar12 = 0;
    puVar12 = reinterpret_cast<byte *>((puVar12 + 1));
  }
