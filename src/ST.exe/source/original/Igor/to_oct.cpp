...

{
  ...
  if ((this->field_02A5 != CASE_F8) && (this->field_02A5 != CASE_F9)) {
    iVar3 = param_1 * 6;
...

{
  ...
  st::fn_00404F07(reinterpret_cast<STSprGameObjC *>(local_28),message);
  SVar1 = message->id;
  if (MESS_STOCTOPUSC_0112 < SVar1) {
    if (MESS_HITKILL < SVar1) {
      ...
      if (DAT_0080732c == 0) {
        ...
        st::fn_00402761(reinterpret_cast<STT3DSprC *>(puVar7),0xe);
        /* ST_CALLSITE[0058A5C4]: CALL 0x00402761; direct=00402761 STT3DSprC::sub_004AD070 */
        st::fn_00402761(reinterpret_cast<STT3DSprC *>(puVar7),8);
        g_currentExceptionFrame = local_88.previous;
        return 0;
      }
      st::fn_00404854(puVar7,0xe);
      st::fn_00404854(puVar7,8);
      g_currentExceptionFrame = local_88.previous;
      return 0;
    }
    if (SVar1 == MESS_HITKILL) {
      ...
      uVar6 = st::fn_004052CC(reinterpret_cast<STT3DSprC *>(&this_00->field_01D5));
      st::fn_006EAB60((void *)this_00->field_0211,uVar6);
      st::fn_00403427(reinterpret_cast<RecoveredRecord_005899E0_1FE8750F *>(this_00));
    ...
    if (SVar1 != MESS_STSPRGAMEOBJC_0113) {
      ...
      iVar5 = st::fn_004019E7(0,0,g_worldGrid.sizeX + -1,g_worldGrid.sizeY + -1,
                                 ...
                                 reinterpret_cast<undefined2 *>(&local_1c),reinterpret_cast<undefined2 *>(local_24),reinterpret_cast<short *>(&local_20));
      if (iVar5 == 0) {
        g_currentExceptionFrame = local_88.previous;
        return 0;
      }
      /* ST_CALLSITE[0058A443]: CALL 0x004024f5; direct=004024F5 STOctopusC::sub_0058AF70 */
      st::fn_004024F5(this_00,(short)local_1c,local_24[0],(short)local_20);
      ...
      this_00->field_0251 = st::storage_bit_cast<int>(static_cast<uint32_t>(iVar5 + (iVar5 >> 0x1f & 0xfffU))) >> 0xc;
      iVar5 = this_00->field_0255 * 0x1850;
      this_00->field_0255 = st::storage_bit_cast<int>(static_cast<uint32_t>(iVar5 + (iVar5 >> 0x1f & 0xfffU))) >> 0xc;
      iVar5 = this_00->field_0259 * 0x1850;
      this_00->field_0259 = st::storage_bit_cast<int>(static_cast<uint32_t>(iVar5 + (iVar5 >> 0x1f & 0xfffU))) >> 0xc;
      g_currentExceptionFrame = local_88.previous;
      return 0;
    }
  ...
  if (MESS_SHARED_0003 < SVar1) {
    ...
    puVar7 = reinterpret_cast<byte *>(&this_00->field_0x285);
    pAVar10 = local_c;
  ...
  if (SVar1 == MESS_ID_NONE) {
    ...
    st::fn_00402261(reinterpret_cast<RecoveredRecordView_0058A9E0_0338C9E5 *>(this_00));
    g_currentExceptionFrame = local_88.previous;
    return 0;
  }
  ...
  if ((uint)local_1c[3] < 2) {
    ...
    puVar9 = reinterpret_cast<byte *>(&this_00->field_0x285);
    ...
    if (((((this_00->field_0299 < 0) || ((int)g_worldGrid.sizeX <= this_00->field_0299)) ||
        ...
        (((int)g_worldGrid.sizeY <= this_00->field_029D || (iVar5 = this_00->field_02A1, iVar5 < 0))
               ...
               (iVar7 = st::fn_00404D3B((short)this_00->field_0299,(short)this_00->field_029D,
    ...
    case CASE_F8:
      ...
      iVar5 = st::fn_00404183
                        (reinterpret_cast<STT3DSprC *>(&this_00->field_01D5),0xe,PTR_0080676c,st::mutable_c_string("octopus2"),
                         CASE_1D);
      if (iVar5 != 0) {
        iVar5 = 0xe9;
cf_error_exit_0058A005:
        st::fn_006A5E40
                  (-1,g_overwriteContext_007ED77C,st::mutable_c_string("E:\\__titans\\Igor\\to_oct.cpp"),iVar5);
      }
      break;
    case CASE_F9:
      /* ST_CALLSITE[00589F5C]: CALL 0x00404183; direct=00404183 STT3DSprC::LoadSequence */
      iVar5 = st::fn_00404183
                        (reinterpret_cast<STT3DSprC *>(&this_00->field_01D5),0xe,PTR_0080676c,st::mutable_c_string("octopus1"),
                         CASE_1D);
      if (iVar5 != 0) {
        iVar5 = 0xe4;
    ...
    case CASE_FA:
      ...
      iVar5 = st::fn_00404183
                        (reinterpret_cast<STT3DSprC *>(&this_00->field_01D5),0xe,PTR_0080676c,st::mutable_c_string("medusa2"),
                         CASE_1D);
      if (iVar5 != 0) {
        iVar5 = 0xf3;
        goto cf_error_exit_0058A005;
    ...
    case CASE_FB:
      ...
      iVar5 = st::fn_00404183
                        (reinterpret_cast<STT3DSprC *>(&this_00->field_01D5),0xe,PTR_0080676c,st::mutable_c_string("medusa1"),
                         CASE_1D);
      if (iVar5 != 0) {
        iVar5 = 0xee;
        goto cf_error_exit_0058A005;
    ...
    SVar4 = st::fn_00401A05(this_00,reinterpret_cast<short *>(&this_00->field_004E),reinterpret_cast<short *>(&this_00->field_0050),reinterpret_cast<short *>(&this_00->field_0052),
                         &this_00->field_006C);
    ...
    st::fn_0040551F
              (reinterpret_cast<STAllPlayersC *>(this_00),(undefined4 *)(local_8 + 0x96 + (int)local_1c));
    puVar7 = reinterpret_cast<byte *>((local_1c));
    ...
    if (local_44 != nullptr) {
      ...
      st::fn_00404CA5
                (reinterpret_cast<STT3DSprC *>(&this_00->field_01D5),reinterpret_cast<int *>(&local_44),
  ...
  if ((this_00->field_0249 == CASE_3) ||
     ...
     (iVar5 = st::fn_004010C3(reinterpret_cast<RecoveredRecord_0058CFE0_6E80059E *>(this_00)), iVar5 != 0)) {
    g_currentExceptionFrame = local_88.previous;
    return 0;
  }
LAB_0058a0d0:
