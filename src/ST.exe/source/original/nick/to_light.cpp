...

{
  ...
  if (SVar3 < 4) {
    ...
    if (SVar3 == MESS_ID_NONE) {
      ...
      st::fn_00404BD8((SoundClassTy *)&g_sound,SOUND_MODE_2,nullptr,iVar5,&local_1c,0);
      ...
      if (this_00->field_00A7 == '\0') {
        uVar6 = st::fn_00403CF1(this_00);
        this_00->field_00A7 = (char)uVar6;
      }
      iVar5 = st::fn_00401CE9(this_00,(uint)(byte)this_00->field_00A7);
      ...
      uVar6 = st::fn_00403CF1(local_8);
      this_00->field_00A7 = (char)uVar6;
      iVar5 = st::fn_00405D6C(this_00);
      if (iVar5 != 0) {
