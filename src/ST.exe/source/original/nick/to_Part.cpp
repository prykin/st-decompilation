...

{
  ...
  local_10 = this;
  iVar7 = st::fn_0072D7F0(local_7c.jumpBuffer,0);
  this_00 = local_10;
  if (iVar7 != 0) {
  ...
  if (SVar2 == MESS_SHARED_010F) {
    local_14 = (void *)st::fn_00403C7E(local_10,&local_18);
  ...
  if (SVar2 != MESS_ID_NONE) {
    ...
    st::fn_0040396D(local_10,puVar9);
...
LAB_006282e0:
  ...
  case CASE_3:
    ...
    if (((this_00->field_00B2 == 5) && (iVar7 = st::fn_00404AAC((int)this_00), iVar7 != 0)) &&
       (this_00->field_0076 != 2)) {
    ...
    if ((int)uVar12 < this_00->field_00B6) {
      st::fn_006EA270(g_sT3DSMAPContext_00807598,this_00->field_00C6,0,uVar12);
      local_c = (float)this_00->field_0046 * _DAT_007904f8 * _DAT_007904f0;
      this_00->field_006A = local_c;
      local_8 = (float)this_00->field_004A * _DAT_007904f8 * _DAT_007904f0;
      this_00->field_006E = local_8;
...
switchD_006288e6_caseD_0:
  if (*(byte *)&this_00->field_0014 < 4) {
    st::fn_006EA270(g_sT3DSMAPContext_00807598,this_00->field_00C6,1,iVar7 + 3);
    g_currentExceptionFrame = local_7c.previous;
    return 0;
  }
  st::fn_006EA270(g_sT3DSMAPContext_00807598,this_00->field_00C6,1,iVar7 - 0xf);
  g_currentExceptionFrame = local_7c.previous;
  return 0;
}
