...

{
  ...
  if (SVar1 == MESS_SHARED_010F) {
    ...
    local_20 = st::fn_0040323D(local_14,reinterpret_cast<int *>(&local_1c));
  ...
  if (SVar1 != MESS_ID_NONE) {
    ...
    if (puVar11[3] != 2) {
      puVar13 = reinterpret_cast<byte *>(&local_14->field_0x4d);
      memmove(puVar13, puVar11, 0x3a); /* compiler REP MOVS byte copy */
      iVar8 = local_14->field_006D;
      uVar12 = iVar8 - local_14->field_0061;
      if ((st::storage_bit_cast<int>(static_cast<uint32_t>((uVar12 ^ (int)uVar12 >> 0x1f) - ((int)uVar12 >> 0x1f))) < 4) &&
         (uVar10 = local_14->field_0071 - local_14->field_0065,
         st::storage_bit_cast<int>(static_cast<uint32_t>((uVar10 ^ (int)uVar10 >> 0x1f) - ((int)uVar10 >> 0x1f))) < 4)) {
    ...
    st::fn_00404E6C(local_14,reinterpret_cast<undefined4 *>(puVar11));
  ...
  case CASE_0:
    ...
    uVar7 = st::fn_00404516
                      (reinterpret_cast<RecoveredReceiver_00601500 *>(&this_00->field_0x20),local_8,local_10,local_c,
...
LAB_005f2d8b:
    ...
    if (this_00->field_0108 != '\0') {
      ...
      st::fn_00405853(reinterpret_cast<AnonShape_005F5440_D27C3BDE *>(this_00));
    }
    goto switchD_005f29cb_default;
  case CASE_4:
