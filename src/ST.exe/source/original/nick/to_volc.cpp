...

{
  ...
  if (SVar2 < 4) {
    ...
    if (SVar2 == MESS_ID_NONE) {
      ...
      case CASE_1:
        if (local_8->field_00A4 < g_playSystem_00802A38->field_00E4) {
          ...
          st::fn_00404B60(reinterpret_cast<RecoveredRecordView_00647370_DB694E9C *>(local_8));
      ...
      case CASE_2:
        ...
        if (this_00->field_00A8 == '\0') {
          ...
          st::fn_00402DCE(reinterpret_cast<RecoveredRecord_STVolcanoC_00647960 *>(this_00));
          g_currentExceptionFrame = local_54.previous;
          return 0;
        }
        break;
      ...
      case CASE_4:
        if (g_playSystem_00802A38->field_00E4 % 5 == 0) {
          ...
          if (local_8->field_00A8 != '\0') {
            st::fn_00402DCE(reinterpret_cast<RecoveredRecord_STVolcanoC_00647960 *>(local_8));
            g_currentExceptionFrame = local_54.previous;
            return 0;
          }
      ...
      case CASE_5:
        ...
        st::fn_00404836(reinterpret_cast<RecoveredRecord_00646D00_34D7A97E *>(local_8));
        g_currentExceptionFrame = local_54.previous;
        return 0;
      case CASE_6:
        local_8->field_00A9 = CASE_1;
      ...
      if (puVar8[3] == 2) {
        ...
        st::fn_0040236F(local_8,reinterpret_cast<undefined4 *>(puVar8));
      ...
      st::fn_00404836(reinterpret_cast<RecoveredRecord_00646D00_34D7A97E *>(this_00));
      g_currentExceptionFrame = local_54.previous;
      return 0;
    }
  }
    ...
    local_10 = st::fn_00403F35(local_8,&local_c);
...

{
  ...
  if (errorCode == 0) {
    if ((param_1 == 0) || (param_1 == 2)) {
      ...
      st::fn_006E8660
                (g_sT3DSMAPContext_00807598,reinterpret_cast<int *>(&local_8),1,0,STField<uint>(puVar3,9),
      ...
      st::fn_006E8660
                (g_sT3DSMAPContext_00807598,reinterpret_cast<int *>(&local_c),1,0,STField<uint>(puVar3,9),
    ...
    if ((param_1 != 0) && (pSVar2->field_007A < 0)) {
      ...
      st::fn_006E8660
                (g_sT3DSMAPContext_00807598,reinterpret_cast<int *>(&local_10),1,0,STField<uint>(puVar3,9),
