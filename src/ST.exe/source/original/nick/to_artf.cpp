...

{
  ...
  local_8 = this;
  iVar8 = st::fn_00404F07((STSprGameObjC *)this,message);
  if (iVar8 != 0xffff) {
    ...
    if (iVar8 == 0) {
      ...
      if (MESS_TORPHIT < SVar4) {
        ...
        case MESS_HITKILL:
          ...
          case 3:
            ...
            iVar18 = 1;
            uVar10 = st::fn_004052CC((STT3DSprC *)&this_00->vtable_at_1d5);
            st::fn_004051A5(uVar10,iVar18,iVar19,iVar12,iVar8,uVar20);
            g_currentExceptionFrame = local_60.previous;
            return 0;
          case 5:
      ...
      if (SVar4 == MESS_TORPHIT) {
        ...
        iVar8 = local_8->vfunc_124((short)*puVar15);
        if (iVar8 == 0) {
          g_currentExceptionFrame = local_60.previous;
          return 0;
        }
      ...
      if (SVar4 == MESS_SHARED_0003) {
        iVar8 = st::fn_00404EC1(local_8->field_0242,local_8->field_0244,local_8->field_0246,0,
      ...
      if (SVar4 != MESS_ID_NONE) {
        ...
        puVar15 = (byte *)((message->arg0).ptr);
        if (puVar15[3] == 2) {
          iVar8 = st::fn_004029C3(local_8,puVar15);
          if (iVar8 < 0) {
            g_currentExceptionFrame = local_60.previous;
            return 0;
          }
        ...
        iVar8 = st::fn_004044E9((AnonShape_005EBD80_1A4ED01F *)local_8);
        if (iVar8 == 0) {
          st::fn_00404462(this_00);
          g_currentExceptionFrame = local_60.previous;
          return 0;
        ...
        st::fn_00401F2D(0);
        if (g_allPlayers_007FA174 != nullptr) {
          iVar8 = st::fn_0040440D(g_allPlayers_007FA174,0xffff,this_00);
          if (iVar8 != 0) {
            st::fn_00404462(this_00);
            g_currentExceptionFrame = local_60.previous;
            return 0;
      ...
      uVar9 = st::fn_00405DE9((AnonShape_005EE6E0_AB6798ED *)local_8);
      ...
      if ((char)uVar9 != '\0') {
        ...
        if ((-1 < this_00->field_02D2) &&
           (iVar8 = st::fn_00405CE5((AnonShape_005F0BA0_C8D654C5 *)this_00), iVar8 != 0)) {
...
switchD_005eb5ad_caseD_129:
  ...
  if ((local_8->field_02AB == -1) &&
     (iVar8 = st::fn_006E62D0(g_playSystem_00802A38,local_8->field_02A7,&local_14),
     iVar8 != -4)) {
