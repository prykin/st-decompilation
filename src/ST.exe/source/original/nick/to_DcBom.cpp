...
// 005FDB50 SubmarineTitans::Recovered::HiddenThis::RecoveredReceiver_005FDB50::FUN_005fdb50
...
joined_r0x005fe09b:
          ...
          st::fn_00402A90(this_00);
          if (param_1 == 0) {
            st::fn_004021D5(this_00);
          }
          else {
