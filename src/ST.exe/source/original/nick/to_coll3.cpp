...

{
  ...
  if (MESS_SHARED_010F < SVar1) {
    ...
    case MESS_STSPRGAMEOBJC_0113:
      ...
      (*local_8->vtable_at_1d5->vfunc_00)(reinterpret_cast<STColl3C *>(&local_8->vtable_at_1d5));
      g_currentExceptionFrame = local_60.previous;
      return 0;
    case MESS_HITKILL:
      /* ST_CALLSITE[005F637D]: CALL 0x00403d0f; direct=00403D0F STT3DSprC::sub_004AD430 */
      st::fn_00403D0F(reinterpret_cast<STT3DSprC *>(&local_8->vtable_at_1d5));
  ...
  pRVar9 = static_cast<RecoveredRecord_005F68B0_23767193 *>((message->arg0).ptr);
  if (*(int *)&pRVar9->field_0xc != 2) {
    puVar10 = reinterpret_cast<byte *>(&local_8->field_0x231);
  ...
  local_EAX_456 = st::fn_00402DFB(local_8,pRVar9);
  if (local_EAX_456 == 0) {
  ...
  st::fn_004018C5(reinterpret_cast<STFishC *>(this_00),local_14,local_10,local_c);
       ...
       ((this_00->field_02DD == CASE_1 ||
        ...
        (iVar8 = st::fn_00401325
                           (local_14[0],local_10[0],local_c[0],0,
                            reinterpret_cast<RecoveredRecord_DumpClassC_00495EC0 *>(this_00)), iVar8 == 0))))
    goto LAB_005f61e2;
  }
...

{
  ...
  if (local_EAX_41 == 0) {
    ...
    if (param_1 == 0) {
      ...
      st::fn_00404183
                (reinterpret_cast<STT3DSprC *>(this_00),8,PTR_00806774,st::mutable_c_string("Expb12" + local_8->field_02CD * 0x39),
                 CASE_1D);
      ...
      iVar2 = st::fn_004052CC(reinterpret_cast<STT3DSprC *>(this_00));
      this_01->field_02B7 = iVar2;
      g_currentExceptionFrame = local_50.previous;
      return local_c;
    }
    /* ST_CALLSITE[005F6B50]: CALL 0x00404183; direct=00404183 STT3DSprC::LoadSequence */
    iVar4 = st::fn_00404183(reinterpret_cast<STT3DSprC *>(this_00),0xe,PTR_00806774,st::mutable_c_string("coll3"),CASE_1D);
    if (iVar4 == 0) {
      ...
      local_EAX_247 = st::fn_004052CC(reinterpret_cast<STT3DSprC *>(this_00));
      this_01->field_02B7 = local_EAX_247;
      /* ST_CALLSITE[005F6BF4]: CALL 0x00403d0f; direct=00403D0F STT3DSprC::sub_004AD430 */
      st::fn_00403D0F(reinterpret_cast<STT3DSprC *>(this_00));
