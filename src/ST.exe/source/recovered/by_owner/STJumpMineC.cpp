...

{
  ...
  case CASE_1:
    ...
    uVar2 = st::fn_004046AB(this,this->field_00C9,this->field_00CB,iVar13,this->field_009F,
    ...
    case 2:
      ...
      if ((((-1 < iVar12) && (-1 < iVar13)) && (iVar3 = (int)g_worldGrid.sizeX, iVar12 < iVar3)) &&
        ...
        if ((((&DAT_007fb24c)[this->field_0051] == 0) ||
           ...
           (uVar11 = st::fn_00403B66(iVar12,iVar13,this->field_0051,1,DAT_007e66ac),
           -1 < (int)uVar11)) {
          this->field_00A7 = local_c;
          this->field_00AF = 0;
      ...
      if (((void *)this->field_007D != nullptr) &&
         (iVar12 = st::fn_00402E19((void *)this->field_007D,this->field_009F,this->field_00A3,
                                      local_c,(undefined4 *)&this->field_0x11f), iVar12 != 0)) {
        if (this->field_014B != '\0') {
          st::fn_00405C59((void *)this->field_007D,this->field_0145,0);
        }
        this->field_014B = 1;
        iVar12 = st::fn_00403E6D(this,CASE_2,this->field_0127,this->field_012B,this->field_012F);
        if (iVar12 == 0) {
          return 1;
        }
      ...
      iVar12 = st::fn_004038A0(this,this->field_009F,this->field_00A3,this->field_00A7,
...
LAB_00619e5f:
  ...
  case CASE_2:
    ...
    iVar3 = st::fn_004046AB(this,(short)local_28,(short)local_24,local_20,iVar13,iVar12,local_1c,
                         &local_c);
    switch(iVar3) {
    case 0:
    ...
    case 1:
      ...
      this->field_00A7 = local_c;
      iVar12 = st::fn_0040169A(this,&local_30);
      if ((iVar12 < 1) || (299 < this->field_0141)) {
        if (iVar12 == 0) {
          iVar12 = st::fn_00403E6D(this,CASE_1,this->field_009F,this->field_00A3,this->field_00A7
                                     );
          if (iVar12 == 0) {
LAB_0061a4f4:
            st::fn_004023EC(this);
...
LAB_0061a4fd:
        ...
        iVar12 = st::fn_00403E6D(this,CASE_3,this->field_0127,this->field_012B,this->field_012F);
        if (iVar12 != 0) {
    ...
    case 2:
      ...
      if (((((this->field_00C9 < 0) || (iVar3 < 0)) ||
        ...
        this->field_00A7 = local_c;
        this->field_00AF = 0;
        st::fn_00405B82(this->field_009F,iVar12,local_c);
        this->field_0093 = CASE_6;
      }
      break;
    case 3:
  ...
  case CASE_3:
    ...
    if (uVar5 != 5) {
      SVar6 = st::fn_004028E7(this,uVar5,this->field_0093,local_28,local_24,local_20,iVar13,
                                 local_8,uVar11);
  ...
  case CASE_4:
    ...
    local_10 = (int)sVar10;
    local_28 = st::fn_004046AB(this,sVar9,sVar8,local_30,iVar12,local_8,local_1c,&local_c);
    switch(local_28) {
    case 0:
      this->field_00DB = this->field_009F;
      this->field_00DF = this->field_00A3;
...
cf_common_exit_0061A55D:
    local_2c = 1;
    iVar12 = st::fn_00403E6D(this,CASE_1,iVar13,iVar12,uVar11);
    if (iVar12 != 0) {
      this->field_0093 = CASE_1;
      return local_2c;
    }
  ...
  case CASE_5:
    ...
    if ((int)uVar11 < this->field_00AF) {
      st::fn_006EA270(g_sT3DSMAPContext_00807598,this->field_0097,0,uVar11);
LAB_0061acc2:
  ...
  *param_7 = param_6;
  ...
  if ((-1 < in_stack_00000006) && (-1 < in_stack_0000000a)) {
    ...
    if (((_param_1 < g_worldGrid.sizeX) && (_param_2 < g_worldGrid.sizeY)) && (param_3 < 5)) {
      ...
      iVar6 = st::fn_00404D3B(param_1,param_2,sVar12);
      if (iVar6 == 0) {
        ...
        if (((((param_1 < 0) || (g_worldGrid.sizeX <= param_1)) || (param_2 < 0)) ||
          ...
          if (local_10 < 0) {
            ...
            if (((local_14 <= iVar6) && (iVar6 < 5)) &&
               (iVar6 = st::fn_00404D3B(param_1,param_2,sVar12 + 1), iVar6 == 0)) {
              return 3;
            }
            if (iVar5 * 200 < iVar9) {
              return 3;
            ...
            if ((iVar6 < 5) && (iVar6 = st::fn_00404D3B(param_1,param_2,sVar12 + -1), iVar6 != 0)
               ) {
              *param_7 = param_3 * 200;
              return 1;
            }
...
LAB_0061b993:
      ...
      if (bVar10) {
        ...
        SVar8 = this->field_0093;
LAB_0061b6ac:
        SVar8 = st::fn_004028E7(this,uVar7,SVar8,_param_1,_param_2,param_3,param_4,param_5,
                                   param_6);
