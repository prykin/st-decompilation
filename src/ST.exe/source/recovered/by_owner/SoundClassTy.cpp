...

{
  ...
  case SOUND_MODE_1:
    if (((STPiece<1,1>(DAT_00807300) & 4) != 0) &&
       (puVar11 = st::fn_0071A990(local_8->field_0DF3,soundId,-1,nullptr),
       puVar11 != nullptr)) {
      st::fn_006C1390(puVar11,0,1,DAT_0080730e,0,2,3);
      g_currentExceptionFrame = local_64.previous;
      return;
    }
    break;
  case SOUND_MODE_2:
    ...
    if ((-1 < position->x) && (-1 < position->y)) {
      uVar6 = local_8->field_10DD - position->y;
      uVar13 = (int)uVar6 >> 0x1f;
      uVar7 = local_8->field_10D9 - position->x;
      iVar4 = (uVar6 ^ uVar13) - uVar13;
      uVar6 = (int)uVar7 >> 0x1f;
      iVar8 = (uVar7 ^ uVar6) - uVar6;
      if (iVar4 < iVar8) {
        iVar4 = iVar8;
      }
      iVar4 = iVar4 + 1;
      local_8->field_10F1 = iVar4;
      iVar8 = *(int *)(&DAT_007c9788 + local_8->field_10E1 * 0x10);
      bVar3 = (byte)iVar8;
      if (iVar4 <= iVar8) {
        bVar3 = (byte)iVar4;
      }
    ...
    if (((int)local_14 < 0) || (local_10 = position->y, local_10 < 0)) {
      ...
      iVar4 = 4;
LAB_0056959b:
      iVar4 = st::fn_006C1390(puVar11,0,0,DAT_0080730e,0,iVar4,iVar8);
    }
    else if (DAT_00807363 == '\0') {
      iVar4 = pSVar14->field_10E9;
      iVar8 = pSVar14->field_10ED;
      uVar9 = (iVar4 * local_14 - local_10) + iVar8;
      uVar6 = (int)uVar9 >> 0x1f;
      iVar2 = (int)(((uVar9 ^ uVar6) - uVar6) * 7) / 10;
      ...
      if (iVar10 < *(int *)(&DAT_007c9790 + iVar12)) {
        uVar9 = (iVar4 * position->x - position->y) + iVar8;
        uVar6 = (int)uVar9 >> 0x1f;
        iVar2 = (int)(((uVar9 ^ uVar6) - uVar6) * 7) / 10;
        pSVar14->field_10F1 = iVar2;
      ...
      iVar8 = iVar4 * position->x + iVar8;
      pSVar14->field_10F1 = iVar8;
      iVar4 = position->y;
      if (iVar8 == iVar4) {
        local_14 = 0;
      }
      ...
      if (iVar4 < (int)local_18) {
        iVar8 = *(int *)(&DAT_007c978c + iVar12);
        if (iVar8 < (int)local_18) {
          ...
          uVar9 = (iVar2 * 2 + -16000) / 3 +
                  (int)((((8000 - iVar2) * 2) / 3 + -4000 + iVar2) * (iVar8 - local_18)) /
                  (iVar8 - iVar4);
          pSVar14 = local_8;
        }
      }
      ...
      iVar4 = st::fn_006C1390(puVar11,bVar3,4,uVar9,local_14 * local_10,4,10);
    }
    else {
      ...
      if ((int)local_c < (int)uVar9) {
        iVar8 = *(int *)(&DAT_007c9788 + iVar4);
        if (iVar8 < (int)uVar9) {
          bVar3 = 0;
        }
        else {
          bVar3 = (byte)((int)((iVar8 - uVar9) * 0xff) / iVar8);
        }
      }
      else {
        bVar3 = 0xff;
      }
      iVar4 = st::fn_006C21E0(puVar11,bVar3,4,DAT_0080730e,(uint)(float)(int)local_14,
  ...
  case SOUND_MODE_3:
    ...
    if ((-1 < position->x) && (-1 < position->y)) {
      ...
      uVar6 = local_8->field_10D9 - position->x;
      iVar4 = (uVar9 ^ uVar7) - uVar7;
      ...
      iVar4 = iVar4 + 1;
      local_8->field_10F1 = iVar4;
      iVar8 = local_8->field_10E1 * 0x10;
      bVar3 = (byte)*(int *)(&DAT_007c9788 + iVar8);
    ...
    if (DAT_00807363 == '\0') {
      ...
      if (iVar4 < (int)local_14) {
        ...
        if (iVar8 < (int)local_14) {
          ...
          iVar4 = *(int *)(&DAT_007c9790 + iVar12);
          uVar9 = (iVar2 * 2 + -16000) / 3 +
                  (int)((((8000 - iVar2) * 2) / 3 + -4000 + iVar2) * (iVar8 - local_14)) /
                  (iVar8 - iVar4);
          pSVar14 = local_8;
        }
      }
      ...
      iVar4 = st::fn_006C1390(puVar11,bVar3,4,uVar9,local_10 * local_c,0xb,0x11);
    }
    else {
      iVar4 = pSVar14->field_10E1 * 0x10;
      uVar9 = local_18 & 0xff;
...
LAB_005695ae:
  ...
  case SOUND_MODE_4:
    if (((STPiece<1,1>(DAT_00807300) & 1) != 0) &&
       (iVar4 = st::fn_0040352B(local_8,0x12,0x14), iVar4 != 0)) {
      uVar9 = local_c >> 8;
      local_c = local_c & 0xffffff00;
      if ((-1 < position->x) && (-1 < position->y)) {
        uVar6 = pSVar14->field_10DD - position->y;
        uVar13 = (int)uVar6 >> 0x1f;
        uVar7 = pSVar14->field_10D9 - position->x;
        iVar4 = (uVar6 ^ uVar13) - uVar13;
        uVar6 = (int)uVar7 >> 0x1f;
        iVar8 = (uVar7 ^ uVar6) - uVar6;
        if (iVar4 < iVar8) {
        ...
        iVar8 = *(int *)(&DAT_007c9788 + pSVar14->field_10E1 * 0x10);
        bVar3 = (byte)iVar8;
        if (iVar4 <= iVar8) {
          bVar3 = (byte)iVar4;
        }
      ...
      local_1c = st::fn_0071A990(pSVar14->field_0DF3,soundId,-1,nullptr);
      if (local_1c != nullptr) {
        local_14 = position->x;
        if (((int)local_14 < 0) || (local_10 = position->y, local_10 < 0)) {
          iVar4 = st::fn_006C1390(local_1c,0,2,DAT_0080730e,0,0x12,0x14);
        }
        else if (DAT_00807363 == '\0') {
          iVar4 = pSVar14->field_10E9;
          iVar8 = pSVar14->field_10ED;
          ...
          if (iVar8 == iVar4) {
            ...
            local_18 = ((iVar8 <= iVar4) - 1 & 2) - 1;
          }
          else {
            local_18 = ((iVar4 <= iVar8) - 1 & 2) - 1;
          }
          iVar4 = *(int *)(&DAT_007c9790 + iVar12);
          local_20 = (uint *)(local_c & 0xff);
          if (iVar4 < (int)local_20) {
            iVar8 = *(int *)(&DAT_007c978c + iVar12);
            if (iVar8 < (int)local_20) {
              uVar9 = (((int)(*(int *)(&DAT_007c9794 + iVar12) * (DAT_0080730e + 4000)) / 100) * 2 +
                      -16000) / 3;
            }
            else {
              iVar2 = (int)(*(int *)(&DAT_007c9794 + iVar12) * (DAT_0080730e + 4000)) / 100;
              uVar9 = (iVar2 * 2 + -16000) / 3 +
                      ((((8000 - iVar2) * 2) / 3 + -4000 + iVar2) * (iVar8 - (int)local_20)) /
                      (iVar8 - iVar4);
            }
          }
          else {
          ...
          local_c = iVar4;
          iVar4 = st::fn_006C1390(local_1c,0,6,uVar9,local_18 * local_14,0x12,0x14);
        }
        else {
          iVar4 = pSVar14->field_10E1 * 0x10;
          uVar9 = local_c & 0xff;
          ...
          iVar4 = st::fn_006C21E0(local_1c,bVar3,6,DAT_0080730e,(uint)(float)(int)local_14,
                               (uint)(float)local_10,0,(uint)(float)(int)local_c,
  ...
  case SOUND_MODE_5:
    if (((STPiece<1,1>(DAT_00807300) & 8) != 0) &&
       (puVar11 = st::fn_0071A990(local_8->field_0DF3,soundId,-1,nullptr),
       puVar11 != nullptr)) {
      st::fn_006C1390(puVar11,0,(-(uint)(flags != 0) & 0xfffffffe) + 2,DAT_0080730e,0,0x15,0x19);
      g_currentExceptionFrame = local_64.previous;
      return;
    }
    break;
  case SOUND_MODE_6:
    if (((STPiece<1,1>(DAT_00807300) & 1) != 0) &&
       (puVar11 = st::fn_0071A990(local_8->field_0DF3,soundId,-1,nullptr),
       puVar11 != nullptr)) {
      st::fn_006C1390(puVar11,0,2,DAT_0080730e,0,0x1b,0x1d);
      g_currentExceptionFrame = local_64.previous;
      return;
    }
    break;
  case SOUND_MODE_7:
    if (((STPiece<1,1>(DAT_00807300) & 4) != 0) &&
       (puVar11 = st::fn_0071A990(local_8->field_0DF3,soundId,-1,nullptr),
       puVar11 != nullptr)) {
      st::fn_006C1390(puVar11,0,2,DAT_0080730e,0,0x1e,0x1f);
      g_currentExceptionFrame = local_64.previous;
      return;
    }
    break;
  case SOUND_MODE_8:
    if (soundId == 0) {
      iVar4 = 0x10;
      pAVar15 = local_8->field_0DF3;
    }
    else {
      pAVar15 = local_8->field_0DF3;
      iVar4 = soundId;
    }
    puVar11 = st::fn_0071A990(pAVar15,iVar4,-1,nullptr);
    if (puVar11 != nullptr) {
  ...
  case SOUND_MODE_10:
    ...
    break;
  case SOUND_MODE_11:
    puVar11 = (uint *)st::fn_00719D00
                                (local_8->field_0DEF,soundName,0,nullptr);
    if (puVar11 != nullptr) {
      pSVar14->field_0E03 = pSVar14->field_0E07;
      iVar4 = st::fn_006C1390(puVar11,0,1,DAT_0080730a,0,0,1);
...
LAB_00569cc6:
    ...
    st::fn_006C1390(puVar11,bVar3,2,DAT_0080730e,0,0x1a,0x1a);
  }
  g_currentExceptionFrame = local_64.previous;
  return;
}
