...
#line 1 "decomp/ST.exe/functions/00644410/decomp.c"
                ...
                do {
                  ...
                  if ((-1 < iVar6) && (iVar7 = (int)g_worldGrid.sizeX, iVar6 <= iVar7 + -1)) {
                    if (local_34 < 0) {
                      ...
                      if (((((sVar10 < 0) || (g_worldGrid.sizeX <= sVar10)) || (sVar3 < 0)) ||
                        ...
                        this_00 = g_worldGrid.cells
                                  [(int)sVar12 * (int)g_worldGrid.planeStride + sVar3 * iVar7 +
                                   (int)sVar10].objects[0];
                      }
                      if (((local_10->field_0287 != '\0') && (this_00 == nullptr)) &&
                         ((((sVar10 < 0 ||
                            (((g_worldGrid.sizeX <= sVar10 || (sVar3 < 0)) ||
                             (g_worldGrid.sizeY <= sVar3)))) ||
                           ((sVar12 < 0 || (g_worldGrid.sizeZ <= sVar12)))) ||
                          ((this_00 = g_worldGrid.cells
                                      [(int)sVar12 * (int)g_worldGrid.planeStride + sVar3 * iVar7 +
                                       (int)sVar10].objects[1], this_00 != nullptr &&
                      ...
                      if (((((undefined4 *)iVar13 == local_30) && (local_1c == local_28)) &&
                          (iVar6 == local_24)) &&
                         ((STGridAt3D(g_pathingGrid, iVar6, local_1c, iVar13) < 0 &&
                          (this_00 == nullptr)))) {
                        *param_1 = 1;
                        local_10->field_0270 = 0;
                        *param_2 = local_20;
                        ...
                        *param_4 = (int)local_18;
                        sVar3 = (short)((int)local_18 >> 0x1f);
                        if ((int)local_18 < 0) {
                          iVar13 = (short)(((short)((int)local_18 / 200) + sVar3) -
                                          (short)((longlong)(int)local_18 * 0x51eb851f >> 0x3f)) +
                                   -1;
                        }
                        else {
                          iVar13 = (int)(short)(((short)((int)local_18 / 200) + sVar3) -
                                               (short)((longlong)(int)local_18 * 0x51eb851f >> 0x3f)
                                               );
                        }
                        sVar3 = (short)(local_14 >> 0x1f);
                        ...
                        local_34 = (int)sVar3;
                        if (sVar3 < 0) {
                          iVar11 = (short)((sVar3 / 0xc9 + (sVar3 >> 0xf)) -
                                          (short)((longlong)local_34 * 0x28c1979 >> 0x3f)) + -1;
                        }
                        else {
                          iVar11 = (int)(short)((sVar3 / 0xc9 + (sVar3 >> 0xf)) -
                        ...
                        if (-1 < STGridAt3D(g_pathingGrid, iVar5, iVar11, iVar8)) {
                          if (STGridAt3D(g_pathingGrid, iVar4, iVar6, iVar13) ==
                              STGridAt3D(g_pathingGrid, iVar5, iVar11, iVar8)) {
                            return;
                          }
                      ...
                      if (((this_00 != nullptr) &&
                         ...
                         (iVar13 = (*this_00->vtable[4].slots_00_28[7])
                        ...
                        *param_1 = 1;
                        ...
                        if (((((iVar6 == 0x9c) || (iVar6 == 0x9d)) || (iVar6 == 0x9e)) ||
                           ...
                           (((local_10->field_0285 == '\0' &&
                            ...
                            (iVar6 = st::fn_0040186B((int)this_00[1].vtable,0x1b), iVar6 != 0))))
                        {
                          (*this_00->vtable[4].slots_00_28[8])
                                    (iVar13,&local_6,&local_8,&local_a,local_48);
                          *param_2 = (int)local_6;
                          *param_3 = (int)local_8;
                          *param_4 = (int)local_a;
...
#line 1 "decomp/ST.exe/functions/00645F10/decomp.c"
