...
// Generated translation unit: source/recovered/by_owner/SubmarineTitans__Recovered__HiddenThis__RecoveredReceiver_0065DA50.cpp

// 0065DA50 SubmarineTitans::Recovered::HiddenThis::RecoveredReceiver_0065DA50::FUN_0065da50
#line 4 "decomp/ST.exe/functions/0065DA50/decomp.c"
...

{
  ...
  if ((((this->field_007D != 0xfffe) && (g_allPlayers_007FA174 != nullptr)) &&
    ...
    if (((param_2 != '\b') && ((param_2 < '\0' || (cVar7 = param_2, '\b' < param_2)))) ||
       (param_2 = cVar7, uVar6 = STReplaceLowByte(st::storage_bit_cast<uint32_t>(static_cast<uint32_t>(extraout_EDX)), (uint8_t)(param_2)), param_2 < '\0'))
    {
      if (param_1 != 0) {
        /* ST_CALLSITE[0065DAF1]: CALL 0x00403828; direct=00403828 STGroupC::GetTOBJQty */
        uVar2 = st::fn_00403828(reinterpret_cast<STGroupC *>(this_00),param_1);
        return uVar2 & 0xffff;
      }
    ...
    if (param_1 == 0) {
      ...
      array = reinterpret_cast<DArrayTy *>(st::fn_004018CF(reinterpret_cast<AiFltClassTy *>(this),uVar6));
    }
    else {
      /* ST_CALLSITE[0065DB17]: CALL 0x004059b6; direct=004059B6 AiFltClassTy::sub_0065E360 */
      array = reinterpret_cast<DArrayTy *>(st::fn_004059B6(reinterpret_cast<AiFltClassTy *>(this),uVar6,param_1));
    }
    if (array != nullptr) {
      dVar3 = array->count;
      uVar2 = 0;
