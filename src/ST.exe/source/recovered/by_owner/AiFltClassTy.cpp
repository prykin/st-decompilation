...

{
  ...
  while (-1 < iVar24) {
    ...
    case 8:
      ...
      if (0 < (int)local_4c) {
        iVar26 = (int)STReplaceLowByte16((uint32_t)(local_3c), (uint8_t)((undefined1)local_3c));
        do {
          if (local_c < local_4c) {
            psVar25 = (short *)(param_1->field_022F->field_0008 * local_c +
                               param_1->field_022F->field_001C);
          }
          else {
            psVar25 = nullptr;
          }
          iVar30 = (int)psVar25[1];
          /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
          local_50 = iVar26 + -1 + (int)CONCAT11(uStack_35,uStack_36);
          iVar24 = (int)*psVar25;
          /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
          local_48 = (STGameObjC *)
          ...
          iVar26 = (int)STReplaceLowByte16((uint32_t)(local_3c), (uint8_t)((undefined1)local_3c));
          local_10 = (DArrayTy *)(int)psVar25[3];
          local_58 = (int)psVar25[4];
          local_54 = iVar30 + -1 + local_58;
          /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
          if (((iVar24 <= iVar26) && (iVar26 <= iVar24 + -1 + (int)local_10)) &&
             (((iVar30 <= CONCAT11(STPiece<3,1>(local_3c),STPiece<2,1>(local_3c)) &&
               (((CONCAT11(STPiece<3,1>(local_3c),STPiece<2,1>(local_3c)) <= local_54 && (iVar24 <= local_50)) &&
                (local_50 <= iVar24 + -1 + (int)local_10)))) &&
              ((iVar30 <= (int)local_48 && ((int)local_48 <= iVar30 + -1 + local_58))))))
          goto LAB_00665047;
          local_50 = iVar24 + -1 + (int)local_10;
          /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
          iVar32 = (int)CONCAT11(STPiece<3,1>(local_3c),STPiece<2,1>(local_3c));
          local_54 = iVar30 + -1 + local_58;
          /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
          local_48 = (STGameObjC *)(iVar32 + -1 + (int)CONCAT11(uStack_33,uStack_34));
          /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
          if ((iVar26 <= iVar24) &&
             (((iVar1 = iVar26 + -1 + (int)CONCAT11(uStack_35,uStack_36), iVar24 <= iVar1 &&
               (iVar32 <= iVar30)) &&
              ((iVar30 <= (int)local_48 &&
               ((((iVar26 <= local_50 && (local_50 <= iVar1)) && (iVar32 <= local_54)) &&
    ...
    case 0xe:
      ...
      if (0 < (int)local_4c) {
        ...
        do {
          if (bVar36) {
            psVar25 = (short *)(pAVar5->field_0008 * uVar27 + pAVar5->field_001C);
          }
          else {
            psVar25 = nullptr;
          }
          /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
          if ((((STReplaceLowByte16((uint32_t)(local_3c), (uint8_t)((undefined1)local_3c)) == *psVar25) &&
               (CONCAT11(STPiece<3,1>(local_3c),STPiece<2,1>(local_3c)) == psVar25[1])) &&
              (CONCAT11(uStack_37,uStack_38) == psVar25[2])) &&
             (((CONCAT11(uStack_31,uStack_32) == psVar25[5] &&
               (CONCAT11(uStack_2f,uStack_30) == psVar25[6])) &&
              (CONCAT11(uStack_2d,uStack_2e) == psVar25[7])))) goto cf_common_join_00665024;
          uVar27 = uVar27 + 1;
          bVar36 = uVar27 < local_4c;
        } while ((int)uVar27 < (int)local_4c);
      }
      if (pAVar5 != nullptr) {
    ...
    case 0x10:
      ...
      break;
    default:
      iVar26 = st::fn_00404386(param_1,local_44[0]);
      if (iVar26 < 1) goto cf_common_join_00665024;
      break;
    case 0x32:
      puVar33 = local_44;
      puVar34 = (uint *)&param_1->field_0xb7;
      memmove(puVar34, puVar33, 0x34); /* compiler REP MOVS byte copy */
      iVar26 = 0;
...
cf_common_join_00664FF6:
      param_1->field_009B = uVar27;
      param_1->field_009F = 0;
      param_1->field_00A3 = 0;
      param_1->field_00A7 = 0;
      param_1->field_00B3 = uVar27;
...
LAB_00666934:
          uVar21 = st::fn_0040343B(param_1);
          /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
          if ((int)*(short *)&param_1->field_0xd3 < CONCAT22(extraout_var_12,uVar21))
          goto cf_common_join_00666DC1;
          goto cf_common_join_00667047;
        }
        iVar26 = param_1->field_00EF;
        param_1->field_00A3 = 1;
        if ((iVar26 == 0x200) || (iVar26 == 0x400)) {
          psVar25 = &param_1->field_01A1;
          iVar11 = st::fn_00401C6C
                             ((AnonReceiver_0065ED90 *)param_1,st::pointer_boundary_cast<short *>(&param_1->field_0195),psVar25,iVar26);
          if ((iVar11 == 0x200) || (iVar11 == 0x400)) {
            if (param_1->field_00F3 != 2) {
              sVar23 = param_1->field_01AB / 2 + param_1->field_01A5;
              iVar26 = (int)param_1->field_01A9 / 2 + (int)param_1->field_01A3;
              sVar22 = param_1->field_01A7;
              sVar4 = *psVar25;
              goto LAB_006668ef;
            }
            iVar26 = st::fn_004028E2((AnonReceiver_00660180 *)param_1,psVar25,'\x02');
            goto LAB_006668f9;
          }
        }
LAB_00666901:
        ...
        if (uVar27 != 0x1f5) {
          if (uVar27 < 0x86) {
            if (uVar27 == 0x85) {
              ...
              if (param_1->field_00A3 == 0) {
                param_1->field_00A3 = 1;
                iVar26 = st::fn_004028E2((AnonReceiver_00660180 *)param_1,st::pointer_boundary_cast<short *>(&param_1->field_0195),
                                            (char)param_1->field_00FB);
                if (iVar26 == 0) goto cf_common_exit_00667066;
                if (local_8 != nullptr) {
                ...
                uVar21 = st::fn_0040343B(param_1);
                /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
                if (((int)param_1->field_018E < CONCAT22(extraout_var_06,uVar21)) &&
              ...
              if (param_1->field_00A3 == 0) {
                param_1->field_00A3 = 1;
                iVar26 = st::fn_004028E2((AnonReceiver_00660180 *)param_1,&param_1->field_01A1,
                                            '\x02');
                if (iVar26 == 0) goto cf_common_exit_00667066;
LAB_00665eba:
              ...
              uVar21 = st::fn_0040343B(param_1);
              /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
              if (((int)param_1->field_018E < CONCAT22(extraout_var_05,uVar21)) &&
                 ((*(int *)&param_1->field_00AB == 0 ||
                  (param_1->field_0280 <= param_1->field_00AF + *(int *)&param_1->field_00AB))))
              goto cf_common_exit_00667066;
              if (local_8 != nullptr) {
              ...
              if (uVar27 != 0x84) goto cf_common_exit_00667066;
              param_1->field_00EB = 0x40;
              if (param_1->field_00A3 == 0) {
                param_1->field_00A3 = 1;
                if (((param_1->field_00EF == 0x200) || (param_1->field_00EF == 0x400)) &&
                   (uVar27 = st::machine_word_boundary_cast<uint>(param_1->field_001C * 0x41c64e6d + 0x3039), param_1->field_001C = uVar27
                   , (uVar27 & 0x10000) != 0)) {
                  local_EAX_5229 =
                  ...
                  if ((local_EAX_5229 == 0x200) || (local_EAX_5229 == 0x400)) {
                    iVar26 = st::fn_004028E2((AnonReceiver_00660180 *)param_1,
              ...
              uVar21 = st::fn_0040343B(param_1);
              /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
              if (((int)param_1->field_018E < CONCAT22(extraout_var_04,uVar21)) &&
                 ((*(int *)&param_1->field_00AB == 0 ||
                  (param_1->field_0280 <= param_1->field_00AF + *(int *)&param_1->field_00AB))))
              goto cf_common_exit_00667066;
              if (local_8 != nullptr) {
            ...
            if (uVar27 != 0x8c) {
              if (uVar27 != 500) goto cf_common_exit_00667066;
              uVar21 = *(undefined2 *)&param_1->field_00E6;
              uVar20 = *(undefined2 *)((int)&param_1->field_00E6 + 2);
              param_1->field_00EB = 0x40;
              param_1->field_00AB = uVar21;
              param_1->field_00AD = uVar20;
              param_1->field_00AF = param_1->field_0280;
              st::fn_0040528B((AnonShape_0065FA10_37C5A4D3 *)param_1,param_1->field_0280,0,0,0);
              STPiece<0,2>(uVar27) = param_1->field_00BF;
              STPiece<2,2>(uVar27) = param_1->field_00C1;
              uVar28 = uVar27 & 1;
              param_1->field_00F3 = uVar28;
              if (uVar28 == 0) {
                param_1->field_00F3 = uVar27 & 2;
              }
              if (param_1->field_00F3 == 0) {
                uVar27 = st::machine_word_boundary_cast<uint>(param_1->field_001C * 0x41c64e6d + 0x3039);
                param_1->field_001C = uVar27;
                param_1->field_00F3 = (uVar27 >> 0x10 & 1) + 1;
              }
              STPiece<0,2>(uVar6) = param_1->field_00C3;
              STPiece<2,2>(uVar6) = param_1->field_00C5;
              if ((uVar6 & 0x100) == 0) {
                uVar28 = uVar6 & 0x200;
                param_1->field_00EF = uVar28;
                if (uVar28 == 0) {
                  uVar28 = uVar6 & 0x400;
                  param_1->field_00EF = uVar28;
                }
                if ((param_1->field_00EF == 0) && ((uVar6 & 0x800) != 0)) {
                  uVar27 = st::machine_word_boundary_cast<uint>(param_1->field_001C * 0x41c64e6d + 0x3039);
                  param_1->field_001C = uVar27;
                  param_1->field_00EF = (-(uint)((uVar27 & 0x10000) != 0) & 0xfffffe00) + 0x400;
                }
              }
              else {
              ...
              if ((param_1->field_00EF == 0x100) && (param_1->field_00F3 == 1)) {
                ...
                STPiece<0,2>(uVar7) = param_1->field_00CF;
                STPiece<2,2>(uVar7) = param_1->field_00D1;
                STPiece<0,2>(uVar8) = param_1->field_00CB;
                STPiece<2,2>(uVar8) = param_1->field_00CD;
                iVar26 = st::fn_0040586C(param_1,*(short **)&param_1->field_00C7,
                                            st::pointer_boundary_cast<short *>(&param_1->field_0195),uVar8,uVar7,st::pointer_boundary_cast<byte *>(&param_1->field_0xd5),
                                            STReplaceLowByte((uint32_t)(uVar28), (uint8_t)(param_1->field_0xd3)),1);
                if (iVar26 != 0) goto cf_common_join_00667047;
                iVar26 = param_1->field_00EF;
                if (((iVar26 == 0x200) || (iVar26 == 0x400)) &&
                   (local_EAX_6228 =
                         st::fn_00401C6C((AnonReceiver_0065ED90 *)param_1,st::pointer_boundary_cast<short *>(&param_1->field_0195),
                                            &param_1->field_01A1,iVar26),
            ...
            if (param_1->field_00A3 == 0) {
              param_1->field_00A3 = 1;
              uVar21 = *(undefined2 *)((int)&param_1->field_015B + 2);
              param_1->field_00AB = *(undefined2 *)&param_1->field_015B;
              param_1->field_00AD = uVar21;
              param_1->field_00AF = param_1->field_0280;
              st::fn_0040528B((AnonShape_0065FA10_37C5A4D3 *)param_1,param_1->field_0280,0,0,0);
              iVar26 = st::fn_004028E2((AnonReceiver_00660180 *)param_1,st::pointer_boundary_cast<short *>(&param_1->field_0195),
              ...
              if (((param_1->field_00A7 == 0) &&
                  (uVar21 = st::fn_0040343B(param_1),
                  (int)param_1->field_0159 < CONCAT22(extraout_var_07,uVar21))) &&
                 ((*(int *)&param_1->field_00AB == 0 ||
                  (param_1->field_0280 <= param_1->field_00AF + *(int *)&param_1->field_00AB))))
              goto cf_common_exit_00667066;
              if (param_1->field_0284 != nullptr) {
        ...
        if (param_1->field_00A3 == 0) {
          param_1->field_00A3 = 1;
          if (param_1->field_00F3 == 2) {
            iVar26 = st::fn_004028E2((AnonReceiver_00660180 *)param_1,&param_1->field_01A1,'\x02'
                                       );
          }
          else {
            sVar22 = param_1->field_01AB / 2 + param_1->field_01A5;
            iVar26 = (int)param_1->field_01A9 / 2 + (int)param_1->field_01A3;
            iVar24 = (int)param_1->field_01A7 / 2 + (int)param_1->field_01A1;
LAB_00666413:
            iVar26 = st::fn_004055A6(param_1,iVar24,iVar26,sVar22,0);
          }
LAB_0066641b:
          if (iVar26 == 0) goto cf_common_exit_00667066;
          goto LAB_00666423;
        ...
        STPiece<0,2>(uVar28) = param_1->field_00C3;
        STPiece<2,2>(uVar28) = param_1->field_00C5;
        if ((uVar28 & 0x800) == 0) goto LAB_00666423;
      ...
      case 0x1f6:
        ...
        if (param_1->field_00A3 != 0) {
          ...
          uVar21 = st::fn_0040343B(param_1);
          /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
          if (CONCAT22(extraout_var_08,uVar21) <= (int)param_1->field_00E4)
          goto cf_common_join_00667047;
          goto cf_common_join_00666DC1;
        }
        iVar26 = param_1->field_00EF;
        ...
        if ((iVar26 == 0x200) || (iVar26 == 0x400)) {
          ...
          if ((local_EAX_6733 == 0x200) || (local_EAX_6733 == 0x400)) {
            if (param_1->field_00F3 != 2) {
              sVar22 = param_1->field_01AB / 2 + param_1->field_01A5;
              iVar26 = (int)param_1->field_01A9 / 2 + (int)param_1->field_01A3;
              iVar24 = (int)param_1->field_01A7 / 2 + (int)*psVar25;
              goto LAB_00666413;
            }
            iVar26 = st::fn_004028E2((AnonReceiver_00660180 *)param_1,psVar25,'\x02');
            goto LAB_0066641b;
...
LAB_006664d8:
          uVar21 = st::fn_0040343B(param_1);
          /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
          iVar26 = CONCAT22(extraout_var_09,uVar21);
          sVar22 = param_1->field_00E4;
          goto LAB_006664e6;
        }
        param_1->field_00A3 = 1;
        iVar26 = st::fn_004028E2
      ...
      case 0x1f8:
        ...
        if (param_1->field_00A3 != 0) {
          ...
          uVar21 = st::fn_0040343B(param_1);
          /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
          if ((int)param_1->field_00E4 < CONCAT22(extraout_var_11,uVar21))
          goto cf_common_join_00666DC1;
          goto cf_common_join_00667047;
        }
        param_1->field_00A3 = 1;
        ...
        uVar21 = st::fn_0040343B(param_1);
        /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
        uVar27 = CONCAT22(extraout_var_10,uVar21) / ((uVar27 >> 0x10) % 3 + 5);
        if (uVar27 == 0) {
          uVar27 = 1;
        }
        STPiece<0,2>(uVar9) = param_1->field_00CF;
        STPiece<2,2>(uVar9) = param_1->field_00D1;
        STPiece<0,2>(uVar10) = param_1->field_00CB;
        STPiece<2,2>(uVar10) = param_1->field_00CD;
        STPiece<0,2>(uVar11) = param_1->field_00C7;
        STPiece<2,2>(uVar11) = param_1->field_00C9;
        local_EAX_7232 =
             st::fn_004056C3(param_1,uVar11,uVar27,st::pointer_boundary_cast<uint *>(&param_1->field_023B->flags),uVar10,uVar9,
        ...
        iVar26 = st::fn_004029BE(param_1,st::machine_word_boundary_cast<undefined4>(param_1->field_023B));
        goto joined_r0x00666ceb;
      default:
        goto cf_common_exit_00667066;
      case 0x1fe:
        param_1->field_00EB = 0x40;
        iVar26 = *(int *)&param_1->field_0xd5;
        param_1->field_00AB = (short)iVar26;
        param_1->field_00AD = (short)((uint)iVar26 >> 0x10);
        param_1->field_00AF = param_1->field_0280;
        st::fn_0040528B((AnonShape_0065FA10_37C5A4D3 *)param_1,iVar26,0,0,0);
        ...
        STPiece<0,2>(uVar14) = param_1->field_00BF;
        STPiece<2,2>(uVar14) = param_1->field_00C1;
        param_1->field_00F3 = uVar14 & 1;
        if ((uVar14 & 1) == 0) {
          param_1->field_00F3 = uVar14 & 2;
        }
        if (param_1->field_00F3 == 0) {
          uVar27 = st::machine_word_boundary_cast<uint>(param_1->field_001C * 0x41c64e6d + 0x3039);
          param_1->field_001C = uVar27;
        ...
        STPiece<0,2>(uVar15) = param_1->field_00C3;
        STPiece<2,2>(uVar15) = param_1->field_00C5;
        if ((uVar15 & 0x100) == 0) {
          param_1->field_00EF = uVar15 & 0x200;
          if ((uVar15 & 0x200) == 0) {
            param_1->field_00EF = uVar15 & 0x400;
          }
...
LAB_006668ef:
            iVar26 = st::fn_004055A6(param_1,(int)sVar22 / 2 + (int)sVar4,iVar26,sVar23,0);
          }
LAB_006668f9:
          if (iVar26 == 0) goto cf_common_exit_00667066;
          goto LAB_00666901;
        ...
        STPiece<0,2>(uVar16) = param_1->field_00C3;
        STPiece<2,2>(uVar16) = param_1->field_00C5;
        if ((uVar16 & 0x800) == 0) goto LAB_00666901;
        param_1->field_009B = 0x200;
      }
      goto cf_common_join_00667054;
    }
    if (0x4d < uVar27 - 0x201) goto cf_common_exit_00667066;
    bVar2 = *(byte *)(uVar27 + 0x667073);
    switch(uVar27) {
    case 0x201:
      param_1->field_00EB = 0x40;
      if (param_1->field_00A3 == 0) {
      ...
      uVar21 = st::fn_0040343B(param_1);
      /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
      if ((int)*(short *)&param_1->field_0xd3 < CONCAT22(extraout_var_13,uVar21))
      goto cf_common_join_00666DC1;
      break;
    default:
      goto cf_common_exit_00667066;
    case 0x208:
      ...
      if (param_1->field_00A3 == 0) {
        param_1->field_00A3 = 1;
        param_1->field_00AB = param_1->field_00C5;
        ...
        STPiece<0,2>(uVar17) = param_1->field_00CF;
        STPiece<2,2>(uVar17) = param_1->field_00D1;
        iVar26 = st::fn_004055A6(param_1,(int)param_1->field_00BF,(int)param_1->field_00C1,
                                    param_1->field_00C3,uVar17);
        goto joined_r0x00666ceb;
      }
      if (param_1->field_00A7 != 0) break;
      if (*(int *)&param_1->field_00AB == 0) goto cf_common_exit_00667066;
      uVar27 = param_1->field_00AF + *(int *)&param_1->field_00AB;
      bVar36 = param_1->field_0280 < uVar27;
      bVar37 = param_1->field_0280 == uVar27;
LAB_00666ddf:
      if (bVar36 || bVar37) goto cf_common_exit_00667066;
      break;
    case 0x212:
      ...
      if (param_1->field_00A3 == 0) {
        ...
        /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
        uVar31 = CONCAT22(extraout_var_16,param_1->field_00C3);
        iVar26 = st::fn_00403F6C((AnonShape_00660620_6BCED4D7 *)param_1,uVar31,uVar31);
        goto joined_r0x00666ceb;
      }
      if (param_1->field_00A7 == 0) {
        uVar21 = st::fn_0040343B(param_1);
        /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
        iVar26 = CONCAT22(extraout_var_14,uVar21);
        sVar22 = param_1->field_00C5;
LAB_006664e6:
        if (sVar22 < iVar26) {
          if (*(int *)&param_1->field_00AB == 0) goto cf_common_exit_00667066;
          uVar27 = param_1->field_00AF + *(int *)&param_1->field_00AB;
    ...
    case 0x21c:
      ...
      if (param_1->field_00A3 == 0) {
        ...
        STPiece<0,2>(iVar24) = param_1->field_00C3;
        STPiece<2,2>(iVar24) = param_1->field_00C5;
        param_1->field_00AF = param_1->field_0280;
        iVar26 = st::fn_00401FB9(param_1,st::machine_word_boundary_cast<undefined4>(&param_1->field_00C7),iVar24,&param_1->field_00C7);
        goto joined_r0x00666ceb;
      }
LAB_00666db5:
      if (param_1->field_00A7 == 0) {
cf_common_join_00666DC1:
    ...
    case 0x226:
      ...
      param_1->field_00AF = param_1->field_0280;
      iVar26 = st::fn_0040451B(param_1,param_1->field_00C3,param_1->field_00C5,
                                  param_1->field_00C7,(int)param_1->field_00C9,
                                  (int)param_1->field_00CB,(int)param_1->field_00CD);
      goto joined_r0x00666ceb;
    case 0x230:
      ...
      if (param_1->field_00A3 == 0) {
        ...
        param_1->field_00AF = param_1->field_0280;
        iVar26 = st::fn_00404CB4(param_1,param_1->field_00C3,param_1->field_00C5,
                                    param_1->field_00C7);
        goto joined_r0x00666ceb;
      }
      /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
      if (((param_1->field_00A7 == 0) &&
          (uVar21 = st::fn_0040343B(param_1),
          (int)param_1->field_00C9 < CONCAT22(extraout_var_15,uVar21))) &&
         ((*(int *)&param_1->field_00AB == 0 ||
          (param_1->field_0280 <= param_1->field_00AF + *(int *)&param_1->field_00AB))))
      goto cf_common_exit_00667066;
      break;
    case 0x23a:
      ...
      if (param_1->field_00A3 == 0) {
        ...
        param_1->field_00AF = param_1->field_0280;
        iVar26 = st::fn_00402009(param_1,param_1->field_00C3,param_1->field_00C5,
                                    param_1->field_00C7);
        goto joined_r0x00666ceb;
      }
      if ((param_1->field_00A7 == 0) &&
    ...
    case 0x246:
      param_1->field_00EB = 0x800;
      if (param_1->field_00A3 != 0) goto LAB_00666db5;
      STPiece<0,2>(iVar26) = param_1->field_00BF;
      STPiece<2,2>(iVar26) = param_1->field_00C1;
      param_1->field_00A3 = 1;
      iVar26 = st::fn_0040569B((AnonShape_00660620_6BCED4D7 *)param_1,
                                  (int)(short)param_1->field_00C3,param_1->field_00C3,
                                  param_1->field_00C5,(int)param_1->field_00C7,iVar26);
joined_r0x00666ceb:
      if (iVar26 == 0) goto cf_common_exit_00667066;
      break;
    case 0x24e:
      ...
      if (param_1->field_00A3 == 0) {
        param_1->field_00A3 = 1;
        STPiece<0,2>(uVar18) = param_1->field_00C3;
        STPiece<2,2>(uVar18) = param_1->field_00C5;
        local_EAX_9418 =
             st::fn_004047EB((AnonShape_0065E360_B94C37CB *)param_1,uVar18,uVar18,
                                (int)param_1->field_00C7,(int)param_1->field_00C9);
        param_1->field_00B3 = local_EAX_9418;
        if (0 < local_EAX_9418) {
          iVar26 = (*(int *)&param_1->field_00CD * local_EAX_9418) / 100;
          param_1->field_00B3 = iVar26;
          if (iVar26 == 0) {
        ...
        STPiece<0,2>(uVar31) = param_1->field_00C3;
        STPiece<2,2>(uVar31) = param_1->field_00C5;
        local_8 = nullptr;
        switch(uVar31) {
        case 0xa3:
          iVar26 = 0x4e;
        ...
        local_10 = (DArrayTy *)st::fn_004059B6(param_1,(uint)bVar2,iVar26);
        if (local_10 != nullptr) {
          uVar27 = local_10->count;
          local_c = 0;
          if (0 < (int)uVar27) {
            do {
              if (local_c < uVar27) {
                puVar29 = DArrayAt<ushort>(local_10, local_c);
              }
              else {
                puVar29 = nullptr;
              }
              this_00 = st::fn_004028BA
                                  (g_allPlayers_007FA174,*(char *)&param_1->field_0024,*puVar29,
                                   CASE_1);
              STPiece<0,2>(uVar19) = param_1->field_00C3;
              STPiece<2,2>(uVar19) = param_1->field_00C5;
              local_48 = this_00;
              switch(uVar19) {
              case 0xa3:
              case 0xa8:
...
cf_common_join_00667047:
       ...
       (local_EAX_5022 =
             st::fn_00401C6C
                       ((AnonReceiver_0065ED90 *)param_1,st::pointer_boundary_cast<short *>(&param_1->field_0195),&param_1->field_01A1,
                        iVar26), local_EAX_5022 == param_1->field_00EF)) {
  ...
  case 0:
    ...
    if (0x10 < uVar3) {
      ...
      st::fn_0040148D((AnonShape_0065FD00_EB74ED0C *)param_1,iVar26);
...
LAB_00665315:
  ...
  case 0x19:
    ...
    param_1->field_00A3 = 1;
    uVar31 = param_1->field_011A;
    param_1->field_00AB = (short)uVar31;
    param_1->field_00AD = (short)((uint)uVar31 >> 0x10);
    param_1->field_00AF = param_1->field_0280;
    iVar26 = st::fn_00401FB9(param_1,uVar31,param_1->field_011E,nullptr);
    if (-1 < iVar26) goto cf_common_exit_00667066;
    param_1->field_009B = 0x28;
    break;
  case 0x1e:
    param_1->field_00EB = 4;
  ...
  case 0x23:
    param_1->field_00EB = 4;
    if (param_1->field_00A3 == 0) {
      uVar21 = *(undefined2 *)&param_1->field_01BB;
      uVar20 = *(undefined2 *)((int)&param_1->field_01BB + 2);
      param_1->field_00A3 = 1;
      param_1->field_00AB = uVar21;
      param_1->field_00AD = uVar20;
      param_1->field_00AF = param_1->field_0280;
      iVar26 = st::fn_00403BE8(param_1,param_1->field_01AD,param_1->field_01C3,
...
LAB_00665607:
    ...
    uVar21 = *(undefined2 *)&param_1->field_0123;
    uVar20 = *(undefined2 *)((int)&param_1->field_0123 + 2);
...
LAB_00665327:
    if (param_1->field_0139 != '\0') {
      uVar27 = param_1->field_014E + param_1->field_014A;
      bVar36 = param_1->field_0280 < uVar27;
      bVar37 = param_1->field_0280 == uVar27;
/* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
LAB_0066534b:
      if ((!bVar36 && !bVar37) &&
         (uVar21 = st::fn_0040343B(param_1), (int)param_1->field_013E <= CONCAT22(extraout_var,uVar21))
         ) {
LAB_0066586a:
...
LAB_00665886:
    if ((param_1->field_0163 == '\0') ||
       (iVar26 = st::fn_00403F4E((AnonShape_0065EF70_E78A8204 *)param_1), iVar26 == 0))
    goto cf_common_exit_00667066;
...
LAB_006655ba:
        ...
        if (param_1->field_0131 + iVar26 < param_1->field_0280) goto LAB_006655ba;
        if (iVar26 == 0) goto LAB_006655b2;
      }
      if ((*(int *)&param_1->field_00AB != 0) &&
         (param_1->field_00AF + *(int *)&param_1->field_00AB < param_1->field_0280))
      goto LAB_00665607;
    ...
    if ((param_1->field_012D < *(uint *)&pAVar5->field_0xc) &&
       (psVar25 = (short *)(pAVar5->field_0008 * param_1->field_012D + pAVar5->field_001C),
       psVar25 != nullptr)) {
      param_1->field_0131 = param_1->field_0280;
      param_1->field_0135 = *(undefined4 *)(psVar25 + 3);
      st::fn_0040528B((AnonShape_0065FA10_37C5A4D3 *)param_1,(int)psVar25[6],(int)psVar25[5],
                         (int)psVar25[6],(int)psVar25[7]);
      local_64 = *psVar25;
      local_62 = psVar25[1];
      local_60 = psVar25[2];
      local_5e = 1;
  ...
  case 0x34:
    if (param_1->field_00A3 == 0) {
      ...
      uVar21 = st::fn_0040343B(param_1);
      /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
      if (CONCAT22(extraout_var_00,uVar21) != 0 && -1 < extraout_var_00) {
        uVar27 = param_1->field_0280;
        memset(&stack0xffffff64, 0, 0x34); /* compiler bulk-zero initialization */
        local_9c = 0x72;
        local_94 = 2;
        local_98 = uVar27;
        local_90 = (DArrayTy *)st::fn_004018CF(param_1,uVar27);
        if ((AiTactClassTy *)param_1->field_0284 != nullptr) {
          st::fn_004010E1
  ...
  case 0x41:
    ...
    if (param_1->field_00A3 == 0) {
      param_1->field_00A3 = 1;
      uVar21 = *(undefined2 *)((int)&param_1->field_0107 + 2);
    ...
    if (((param_1->field_0139 == '\0') ||
       ...
       (uVar21 = st::fn_0040343B(param_1), CONCAT22(extraout_var_01,uVar21) < (int)param_1->field_013E)
       ) goto LAB_00665886;
    goto LAB_0066586a;
  case 100:
  ...
  case 0x6e:
    ...
    uVar21 = *(undefined2 *)((int)&param_1->field_0142 + 2);
    param_1->field_00AB = *(undefined2 *)&param_1->field_0142;
    param_1->field_00AD = uVar21;
    param_1->field_00AF = param_1->field_0280;
    st::fn_0040528B((AnonShape_0065FA10_37C5A4D3 *)param_1,iVar26,0,0,0);
    if ((short *)param_1->field_0097 != (short *)0xff) {
      iVar26 = st::fn_0040586C(param_1,(short *)param_1->field_0097,st::pointer_boundary_cast<short *>(&param_1->field_0195),0,
...
LAB_00665a76:
      uVar21 = st::fn_0040343B(param_1);
      /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
      if (((int)param_1->field_0140 < CONCAT22(extraout_var_02,uVar21)) &&
         ((*(int *)&param_1->field_00AB == 0 ||
          (param_1->field_0280 <= param_1->field_00AF + *(int *)&param_1->field_00AB))))
      goto cf_common_exit_00667066;
LAB_00665aac:
...
LAB_00665b57:
  ...
  case 0x70:
    ...
    if (param_1->field_00A3 != 0) {
      ...
      uVar21 = st::fn_0040343B(param_1);
      /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
      if ((int)param_1->field_0140 < CONCAT22(extraout_var_03,uVar21)) {
        if ((*(int *)&param_1->field_00AB == 0) ||
           (param_1->field_0280 <= param_1->field_00AF + *(int *)&param_1->field_00AB))
        goto cf_common_exit_00667066;
        param_1->field_014E = param_1->field_0280;
    ...
    if (((param_1->field_00EF != 0x200) && (param_1->field_00EF != 0x400)) ||
       (uVar27 = st::machine_word_boundary_cast<uint>(param_1->field_001C * 0x41c64e6d + 0x3039), param_1->field_001C = uVar27,
       (uVar27 & 0x10000) == 0)) goto LAB_00665b57;
    local_EAX_4547 =
         st::fn_00401C6C
                   ((AnonReceiver_0065ED90 *)param_1,st::pointer_boundary_cast<short *>(&param_1->field_0195),&param_1->field_01A1,
                    param_1->field_00EF);
...
cf_common_join_0066704E:
  ...
  case 0x78:
    ...
    if (param_1->field_00A3 == 0) {
      uVar21 = *(undefined2 *)&param_1->field_01F7;
      uVar20 = *(undefined2 *)((int)&param_1->field_01F7 + 2);
      param_1->field_00A3 = 1;
      param_1->field_00AB = uVar21;
      param_1->field_00AD = uVar20;
      param_1->field_00AF = param_1->field_0280;
