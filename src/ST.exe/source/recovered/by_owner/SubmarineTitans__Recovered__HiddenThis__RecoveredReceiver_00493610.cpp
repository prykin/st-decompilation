...
// Generated translation unit: source/recovered/by_owner/SubmarineTitans__Recovered__HiddenThis__RecoveredReceiver_00493610.cpp

// 00493610 SubmarineTitans::Recovered::HiddenThis::RecoveredReceiver_00493610::FUN_00493610
          ...
          do {
            if (((-1 < iVar2) && (iVar4 = (int)g_worldGrid.sizeX, iVar2 <= iVar4 + -1)) &&
              ...
              if ((((sVar7 < 0) ||
                 ...
                 (iVar3 = st::fn_006AADD0((int)this->field_0047,(int)this->field_0049,
