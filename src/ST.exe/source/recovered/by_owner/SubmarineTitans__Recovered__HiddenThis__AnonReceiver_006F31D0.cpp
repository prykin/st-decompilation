      ...
      if ((uVar2 & 1) == 0) {
        ...
        if (((iVar12 != 0) && (param_4 == (uVar2 & 4) >> 2)) &&
          ...
          if (((DAT_00857030 == 0) || ((puVar19[1] & 4) != 0)) ||
            ...
            pAVar8 = (int)*(short *)(local_34 + 0x10);
            /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
            pAVar16 = st::machine_word_boundary_cast<uint>(((byte *)pAVar8 + *(short *)(local_34 + 0x14)));
...
LAB_006f397a:
              ...
              do {
                iVar12 = st::fn_006B0460(reinterpret_cast<int *>(&DAT_00856fd0),&local_70,(int *)puVar11);
                if (iVar12 == 1) {
                  if (local_54 != nullptr) {
