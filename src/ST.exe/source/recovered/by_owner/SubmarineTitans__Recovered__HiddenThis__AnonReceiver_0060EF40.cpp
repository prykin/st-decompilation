...
#line 1 "decomp/ST.exe/functions/0060EF40/decomp.c"
        ...
        if (iVar1 < local_84) {
          do {
            ...
            if (((pSVar9 == nullptr) ||
              ...
              iVar1 = st::fn_00404D3B(sVar10,(short)local_50,(short)local_4c);
...
LAB_0060f230:
  ...
  if (local_6c == nullptr) {
    ...
    if (*(int *)value == 0) {
      pvVar2 = st::fn_006AAC70((local_68[0] + 1) * 0x1c);
      *(void **)value = pvVar2;
    }
    else {
    ...
    *(int *)&this->field_0x2d5 = local_68[0] + 1;
    ...
    if (1 < local_68[0] + -1) {
      do {
        ...
        uVar4 = st::fn_00402EFF((int)*(short *)&pAVar3->field_0x6,
