...

{
  ...
  local_1c = (st_stack_frame + 20) + iVar11;
  local_54 = (st_stack_frame + 20) + iVar11;
  puVar13 = (byte *)((st_stack_frame + 20) + iVar11);
...
LAB_0060f21b:
              iVar3 = local_50;
              *(int *)((st_stack_frame + 16) + iVar11) = local_4c;
              *(int *)((st_stack_frame + 12) + iVar11) = iVar3;
              *(int *)((int)local_b8 + iVar11 + -0x1c) = iVar14;
              *(undefined4 *)((int)local_b8 + iVar11 + -0x20) = 0x60f22c;
              /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
              iVar1 = st::fn_00404D3B(*(short *)((int)local_b8 + iVar11 + -0x1c),
                                         *(short *)((st_stack_frame + 12) + iVar11),
                                         *(short *)((st_stack_frame + 16) + iVar11));
              if (iVar1 == 0) {
LAB_0060f230:
  ...
  *(short **)((st_stack_frame + 16) + iVar11) = local_60;
  *(undefined4 *)((st_stack_frame + 12) + iVar11) = 1;
  *(undefined4 *)((int)local_b8 + iVar11 + -0x1c) = 0;
  *(undefined4 *)((int)local_b8 + iVar11 + -0x20) = 0;
  *(int *)((st_stack_frame + 0) + iVar11) = (int)*(short *)&this->field_0x1f5;
  *(undefined4 *)((int)aiStackY_108 + iVar11 + 0x28) = 0x60f28e;
  /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
  st::fn_0040156E(*(Global_sub_00615BB0_param_1Enum *)((st_stack_frame + 0) + iVar11),
                     *(undefined4 **)((int)local_b8 + iVar11 + -0x20),
                     *(undefined4 **)((int)local_b8 + iVar11 + -0x1c),
                     *(int *)((st_stack_frame + 12) + iVar11),*(undefined2 **)((st_stack_frame + 16) + iVar11)
                    );
  iVar8 = 0;
  do {
  ...
  *(undefined4 *)((st_stack_frame + 16) + iVar11) = 2;
  *(int **)((st_stack_frame + 12) + iVar11) = local_68;
  *(int *)((int)local_b8 + iVar11 + -0x1c) = local_34;
  iVar8 = local_38;
  *(int *)((int)local_b8 + iVar11 + -0x20) = local_b0 - local_38;
  *(int *)((st_stack_frame + 0) + iVar11) = local_80 - iVar3;
  ...
  *(undefined4 *)((int)aiStackY_108 + iVar11 + 0xc) = 0x60f37c;
  ...
  local_6c = st::fn_006AFBA0
                        ...
                        *(short **)((st_stack_frame + 0) + iVar11),
                        *(short **)((int)local_b8 + iVar11 + -0x20),
                        *(short **)((int)local_b8 + iVar11 + -0x1c),
                        *(int **)((st_stack_frame + 12) + iVar11),((st_stack_frame + 16))[iVar11]);
  if (local_6c == nullptr) {
    local_68[0] = 0;
  }
  else {
    ...
    if (*(int *)puVar1 == 0) {
      ...
      *(undefined4 *)((st_stack_frame + 12) + iVar11) = 0x60f3ca;
      pvVar4 = st::fn_006AAC70(*(uint *)((st_stack_frame + 16) + iVar11));
      *(void **)puVar1 = pvVar4;
    }
    else {
      if (*(int *)&this->field_0x2d5 <= local_68[0]) {
        *(undefined1 **)((st_stack_frame + 16) + iVar11) = puVar1;
        *(undefined4 *)((st_stack_frame + 12) + iVar11) = 0x60f3a3;
        st::fn_006AB060(*(void **)((st_stack_frame + 16) + iVar11));
      }
    ...
    *(int *)&this->field_0x2d5 = st::machine_word_boundary_cast<int>(local_68[0] + 1);
    ...
    if (1 < local_68[0] + -1) {
      do {
        ...
        *(undefined4 *)((st_stack_frame + 16) + iVar11) = 0;
        *(undefined4 *)((st_stack_frame + 12) + iVar11) = 0;
        *(undefined4 *)((int)local_b8 + iVar11 + -0x1c) = 0;
        *(undefined4 *)((int)local_b8 + iVar11 + -0x20) = 0;
        *(undefined4 *)((st_stack_frame + 0) + iVar11) = 0;
        ...
        *(undefined4 *)((int)aiStackY_108 + iVar11) = 0x60f549;
        uVar5 = st::fn_00402EFF(*(int *)((int)aiStackY_108 + iVar11 + 4),
                                   ...
                                   *(int *)((st_stack_frame + 0) + iVar11),
                                   *(int *)((int)local_b8 + iVar11 + -0x20),
                                   *(int *)((int)local_b8 + iVar11 + -0x1c),
                                   *(int **)((st_stack_frame + 12) + iVar11),
                                   *(int **)((st_stack_frame + 16) + iVar11));
    ...
    if (1 < local_68[0]) {
      ...
      *(undefined4 **)((st_stack_frame + 16) + iVar11) = &local_70;
      *(undefined4 **)((st_stack_frame + 12) + iVar11) = &local_44;
      *(undefined4 **)((int)local_b8 + iVar11 + -0x1c) = &local_30;
      *(int *)((int)local_b8 + iVar11 + -0x20) = (int)*(short *)&this->field_0x1f5;
      *(undefined4 *)((st_stack_frame + 0) + iVar11) = 0x60f64f;
      /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
      st::fn_004047AF(*(int *)((int)local_b8 + iVar11 + -0x20),
                         *(int **)((int)local_b8 + iVar11 + -0x1c),
                         *(int **)((st_stack_frame + 12) + iVar11),*(int **)((st_stack_frame + 16) + iVar11));
      iVar3 = *(int *)puVar1;
      *(int *)((st_stack_frame + 16) + iVar11) =
      ...
      *(undefined4 *)((st_stack_frame + 0) + iVar11) = local_44;
      ...
      *(undefined4 *)((int)aiStackY_108 + iVar11 + 0x18) = 0x60f6d4;
      /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
      st::fn_004037FB(this,*(int *)((int)aiStackY_108 + iVar11 + 0x1c),
                         *(int *)((int)aiStackY_108 + iVar11 + 0x20),
                         *(int *)((int)aiStackY_108 + iVar11 + 0x24),
                         *(int *)((int)aiStackY_108 + iVar11 + 0x28),
                         *(int *)((st_stack_frame + 0) + iVar11),
  ...
  if (local_6c != nullptr) {
    *(short ***)((st_stack_frame + 16) + iVar11) = &local_6c;
    *(undefined4 *)((st_stack_frame + 12) + iVar11) = 0x60f6ee;
    st::fn_006AB060(*(void **)((st_stack_frame + 16) + iVar11));
  }
  ExceptionList = local_14;
  return local_68[0];
