...

{
  ...
  if (pHVar1 != nullptr) {
    ...
    uVar7 = st::fn_0040459D(this->field_0453,CASE_2,0x47,0x46,iVar2,iVar4,bVar5,cVar6,uVar7);
    if (uVar7 != 0) {
  ...
  if (pHVar1 != nullptr) {
    ...
    uVar7 = st::fn_0040459D(this->field_0457,CASE_3,0x1a,10,iVar2,iVar4,bVar5,cVar6,uVar7);
    if (uVar7 != 0) {
