...
// Generated translation unit: source/recovered/by_owner/SubmarineTitans__Recovered__HiddenThis__RecoveredReceiver_00636260.cpp

// 00636260 SubmarineTitans::Recovered::HiddenThis::RecoveredReceiver_00636260::FUN_00636260
...
LAB_006362c5:
  pDVar1 = st::fn_006AE290(nullptr,param_5 * param_6,0x32,10);
    ...
    if (0 < param_5) {
      do {
        ...
        if (0 < param_6) {
          ...
          do {
            pDVar1 = st::pointer_boundary_cast<DArrayTy *>(this->field_002C);
            ...
            *piVar3 = param_7;
            if (local_8->field_0028 == 0) {
              ...
              iVar2 = st::fn_00402A22(local_8->field_0004);
              piVar3[1] = iVar2;
            }
...
// 00636FC0 SubmarineTitans::Recovered::HiddenThis::RecoveredReceiver_00636260::sub_00636FC0
