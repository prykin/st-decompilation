...

{
  ...
  if (iVar1 == 0) {
    ...
    if (uVar2 != 0) {
      st::fn_006B7E00(*(int *)&local_8->field_0x4,3,&local_14,&local_24);
    }
  ...
  if (iVar1 == 0) {
    ...
    if (uVar2 != 0) {
      st::fn_006B7E00(*(int *)&local_8->field_0x4,1,&local_1c,&local_20);
    }
  ...
  if (iVar1 == 0) {
    ...
    if (uVar2 != 0) {
      st::fn_006B7E00(*(int *)&local_8->field_0x4,2,&local_c,&local_28);
    }
  ...
  if (iVar1 == 0) {
    ...
    if (uVar2 != 0) {
      st::fn_006B7E00(*(int *)&local_8->field_0x4,0,&local_18,&local_10);
    }
