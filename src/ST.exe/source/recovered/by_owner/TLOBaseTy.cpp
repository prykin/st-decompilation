...
LAB_004beb6d:
    ...
    if (((this->field_0245 == CASE_0) && (iVar20 = st::fn_00403594(this), iVar20 != 0)) &&
       (iVar20 = st::fn_00405330((int)this->field_0024), iVar20 != 0)) {
      uVar7 = 1;
    }
    else {
LAB_004bebed:
...
switchD_004bec4d_caseD_36:
    ...
    if (this->field_05AC == CASE_36) {
      ...
      if (((this->field_04D4 < 0x28) || (this->field_0245 != CASE_0)) ||
         (iVar20 = st::fn_0040186B((int)this->field_0024,iVar20), iVar20 == 0)) {
        uVar7 = 0;
      }
      else {
        uVar7 = 1;
    ...
    if (*(int *)(&DAT_00791b14 + ((uint)(byte)local_EAX_770 + this->field_0235 * 3) * 4) != 0) {
      if (((iVar20 == 0) || (iVar11 = st::fn_0040186B((int)this->field_0024,iVar20), iVar11 == 0)
      ...
      if ((this->field_0245 == CASE_4) || (this->field_0245 == CASE_3)) {
        *(undefined1 *)(param_1 + 3) = 0x16;
        if ((this->field_0245 != CASE_4) || (iVar20 = st::fn_004015A5(this,0), iVar20 == 0))
        goto LAB_004bee65;
        uVar7 = 1;
      }
      else {
...
LAB_004bee65:
  ...
  case CASE_40:
    ...
    if (this->field_0024 == (byte *)this->field_023D) {
LAB_004bf5fe:
      if ((this->field_0245 != CASE_0) || (iVar20 = st::fn_00405ACE(this,1,9,1,0,1), iVar20 == 0))
      goto LAB_004bf624;
      uVar7 = 1;
    }
    else {
...
joined_r0x004bf200:
  ...
  case CASE_44:
    ...
    if (this->field_0245 == CASE_0) {
      iVar20 = 0x19;
LAB_004bf708:
      iVar20 = st::fn_0040186B((int)this->field_0024,iVar20);
  ...
  case CASE_49:
    ...
    if (this->field_0024 == (byte *)this->field_023D) {
LAB_004bf508:
      if ((this->field_0245 != CASE_0) || (iVar20 = st::fn_00405ACE(this,1,0x15,1,0,1), iVar20 == 0))
      goto LAB_004bf52e;
      uVar7 = 1;
    }
    else {
...
LAB_004beff1:
      if (((this->field_0245 != CASE_0) ||
          (iVar20 = st::fn_0040186B((int)this->field_0024,0x31), iVar20 == 0)) ||
...
LAB_004c00cc:
      if ((((this->field_0245 == CASE_0) &&
           (iVar20 = st::fn_0040186B((int)this->field_0024,0x75), iVar20 != 0)) &&
  ...
  case CASE_5C:
    if (*(int *)&this->field_0x361 == 1) {
      ...
      if (this->field_05AC == CASE_40) {
        iVar20 = st::fn_00401B59(this,1,9,-1);
        ...
        iVar20 = st::fn_00401B59(this,1,0x15,-1);
        STField<char>(param_1,0x31) = (char)iVar20;
      ...
      if (TVar3 == CASE_35) {
        do {
          if ((&PTR_DAT_007bfc04)[this->field_0239][(int)param_1] == '\0') {
            iVar20 = st::fn_0040186B((int)this->field_0024,(int)param_1);
            iVar20 = st::fn_00402342((int)this->field_0024,(int)param_1,iVar20 + 1);
          }
          else {
            iVar20 = st::fn_0040524F((int)this->field_0024,(uint)param_1);
          }
          if (iVar20 != 0) {
            ...
            if (((iVar20 < CONCAT31(extraout_var_01,uVar7)) &&
                (iVar20 = st::fn_00401E1F((int)this->field_0024,(uint)param_1), iVar20 == 0)) &&
...
switchD_004bef7c_caseD_52:
  ...
  case CASE_61:
    *(char *)(param_1 + 0xd) = (char)((int)(this->field_04E0[0xe] * 0x21) / DAT_007be8c4);
    ...
    break;
  case CASE_62:
    uVar17 = st::fn_004036A7((int)this->field_0024);
    STField<uint>(param_1,0x1d) = uVar17;
    iVar20 = st::fn_00405D80((int)this->field_0024);
...
LAB_004c0fcc:
  ...
  if (iVar20 != 0) {
    ...
    switch(pAVar18) {
    case nullptr:
      iVar20 = st::fn_00402815((int)this->field_0024);
      if (iVar20 == 0) {
        piVar4[0x16] = 0xbdf;
        return false;
      }
  ...
  case CASE_6C:
    ...
    if ((pAVar18 == (AnonPointee_TLOBaseTy_061B *)0xffff) &&
      ...
      iVar20 = st::fn_00404160((int)this);
      pAVar18 = nullptr;
      if ((((iVar20 != 0) &&
           (pAVar18 = this->field_061B, pAVar18 != nullptr)) &&
  ...
  if (iVar9 == 1) {
    ...
    if ((&this->field_0291)[(int)param_1 * 0x20] != nullptr) {
      if ((&DAT_00792ca0)[iVar3 * 3] == 0xb1) {
        ...
        *(undefined2 *)ppbVar10 = 0;
        ...
        st::fn_00401BC2(g_playSystem_00802A38,0x168,0,0,local_b0,0);
        return 0;
      }
      *(undefined4 *)(&this->field_0x29d + iVar9) = 1;
      ppbVar10 = local_84;
        ...
        do {
          if (((int)piVar8 < 1) || (local_14 == *(int *)(&this->field_0x2c1 + iVar9))) {
            ...
            if (*(int *)(&DAT_007932d0 + iVar3) != 0) {
              puVar4 = (undefined4 *)
                       st::fn_0040342C(local_b8,(short)*(undefined4 *)
              ...
              puVar4 = (undefined4 *)st::fn_0040342C(local_c0,0,0,-(short)this->field_0259);
              local_2c = (short)*puVar4;
              sStack_2a = (short)((uint)*puVar4 >> 0x10);
            ...
            if ((*(int *)(&DAT_00793e28 + iVar1 * 4) == 0) ||
              ...
              if (iVar3 == 0xab) {
                ...
                st::fn_00401BC2(g_playSystem_00802A38,iVar3,0,0,local_84,0);
              }
    ...
    *(undefined4 *)(&this->field_0x29d + (int)param_1 * 0x80) = 1;
    ...
    case 0xa8:
      ...
      st::fn_004044CB(0xa8,this->field_0024,this->field_0018,this->field_0032,
    ...
    case 0xbe:
      ...
      st::fn_00403909
                (g_allPlayers_007FA174,(int)this->field_0024,0xa8,
                 (int *)(&this->field_0x2a5 + iVar9),&this->field_02A9 + iVar3,
                 (int *)(&this->field_0x2ad + iVar11),&local_1c);
      st::fn_004044CB(0xbe,this->field_0024,this->field_0018,this->field_0032,
                         (ushort)this->field_04E0[0],(ushort)this->field_04E0[1],
                         (ushort)this->field_04E0[2],(short)*param_1 * 0xc9 + 100,
                         (short)(&this->field_02A9)[iVar3] * 0xc9 + 100,(ushort)local_1c);
...

{
  ...
  switch(param_1 + -1) {
  case 0:
    iVar3 = st::fn_0040413D(this->field_0024,param_2);
  ...
  case 1:
    ...
    if (iVar3 == 0) {
      ...
      iVar3 = st::fn_00402342((int)this->field_0024,param_2,iVar3 + 1);
      if (iVar3 == 0) break;
    }
...
switchD_004c787f_caseD_2:
  ...
  case 3:
    ...
    goto LAB_004c795c;
  case 5:
    iVar5 = st::fn_00405821(this,param_1,param_2,param_3);
    goto LAB_004c7967;
  case 7:
    pbVar6 = this->field_0024;
    iVar5 = 0x75;
LAB_004c795c:
    iVar5 = st::fn_0040186B((int)pbVar6,iVar5);
LAB_004c7967:
    if (iVar5 != 0) {
LAB_004c796d:
      if (param_5 != 0) {
        iVar3 = st::fn_00401B59(this,param_1,param_2,-1);
  ...
  case 5:
    ...
    break;
  case 6:
    iVar3 = st::fn_00405470((STBoatC *)this);
    if (iVar3 != 0) {
      if (param_2 == 0xdd) {
        iVar3 = st::fn_00403954(*(char *)&this->field_0024);
        if (param_3 <= iVar3) {
          return 1;
        }
      }
      else if ((param_2 == 0xde) &&
              (iVar3 = st::fn_00402284(*(char *)&this->field_0024), param_3 <= iVar3)) {
        return 1;
      }
    }
    break;
...
LAB_004c7d8c:
    ...
    if (iVar6 != 0) {
      iVar6 = st::fn_00405ACE(this,param_1,param_2,param_3,1,0);
      if ((iVar6 == 0) || (iVar6 = st::fn_0040283D(this), iVar6 == 0)) {
        if (param_4 != 0) {
          iVar6 = st::fn_00401B59(this,param_1,param_2,-1);
          if ((*(int *)&this->field_0x361 == param_1) && (*(uint *)&this->field_0x369 == param_2)) {
          ...
          if ((int)(iVar6 + param_3) < 100) {
            if (this->field_03D8 <= this->field_03D4 + 1) {
              ...
              pAVar7 = st::fn_006ACF50(this->field_0607,iVar6 * 0x27);
...

{
  ...
  if (TVar1 != CASE_0) {
    ...
    if ((iVar2 != 0) && (this->field_04DC != 0)) {
      st::fn_00401DD4(DAT_00800bcc,this->field_04E0[0],this->field_04E0[1],this->field_04E0[2]);
      this->field_04DC = 0;
    }
  }
  return iVar2;
...
switchD_004ceb68_caseD_32:
  ...
  case CASE_2:
    ...
    if (iVar6 == 0) {
      ...
      st::fn_00402AF4(DAT_00811798,this->field_0024,8);
      return local_10;
    }
      ...
      if ((int)local_18 < local_14) {
        ...
        do {
          ...
          if ((((sVar4 < 0) || (g_worldGrid.sizeX <= sVar4)) || (sVar7 = (short)local_c, sVar7 < 0))
            ...
            st::fn_00401582(DAT_00800bcc,this->field_04E0[0],this->field_04E0[1],
                               this->field_04E0[2]);
  ...
  case CASE_3:
    ...
    *(undefined1 *)ppbVar13 = 0;
    ...
    st::fn_00401BC2(g_playSystem_00802A38,0x14,0,&local_24,local_6c,0);
    /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
...

{
  ...
  if (this->field_03D8 <= this->field_03D4 + 1) {
    ...
    pAVar2 = st::fn_006ACF50(this->field_0607,iVar1 * 0x27);
...

{
  ...
  st::fn_00405448(local_EAX_634,param_1,piVar11,piVar13);
  if (local_8 != 0) {
...

{
  ...
  if (this->field_0245 == CASE_4) {
    ...
    if (this->field_0494 != 0) {
      st::fn_00401DD4(DAT_00800bcc,this->field_0480,this->field_0484,this->field_0488);
      this->field_0494 = 0;
    }
  }
  return 1;
