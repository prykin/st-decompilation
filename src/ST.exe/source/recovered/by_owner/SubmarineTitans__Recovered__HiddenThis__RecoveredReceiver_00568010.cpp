...
// Generated translation unit: source/recovered/by_owner/SubmarineTitans__Recovered__HiddenThis__RecoveredReceiver_00568010.cpp

// 00568010 SubmarineTitans::Recovered::HiddenThis::RecoveredReceiver_00568010::FUN_00568010
...

{
  ...
  if (this->field_0F8B != 0) {
    ...
    local_c = reinterpret_cast<SoundClassTy *>(this);
    ...
    if (iVar1 == 0) {
      ...
      case CASE_1:
        iVar1 = 2;
        puVar2 = reinterpret_cast<uint *>(&local_c->field_0xe23);
        do {
      ...
      case CASE_2:
        iVar1 = 4;
        puVar2 = reinterpret_cast<uint *>(&local_c->field_0xe3b);
        do {
      ...
      case CASE_8:
        iVar1 = 0x15;
        puVar2 = reinterpret_cast<uint *>(&local_c->field_0xf07);
        do {
          st::fn_006C1F00(iVar1,&local_8,nullptr);
          if (local_8 == 1) {
            *puVar2 = 0;
