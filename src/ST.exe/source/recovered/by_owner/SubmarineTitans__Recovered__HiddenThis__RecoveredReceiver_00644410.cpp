...
// Generated translation unit: source/recovered/by_owner/SubmarineTitans__Recovered__HiddenThis__RecoveredReceiver_00644410.cpp

// 00644410 SubmarineTitans::Recovered::HiddenThis::RecoveredReceiver_00644410::FUN_00644410
...

{
  ...
  local_2c = st::fn_006AADD0((int)this->field_0268,(int)this->field_026A,(int)this->field_026C,local_3c
                          ,local_40,local_44);
                  ...
                  if ((-1 < iVar6) && (iVar7 = (int)g_worldGrid.sizeX, iVar6 <= iVar7 + -1)) {
                    if (local_34 < 0) {
                      ...
                      if (((((sVar11 < 0) || (g_worldGrid.sizeX <= sVar11)) || (sVar3 < 0)) ||
                        ...
                        this_00 = reinterpret_cast<RecoveredRecord_00645F10_DD339E8F *>(g_worldGrid.cells
                          ...
                          *param_1 = 1;
                          ...
                          if (((((iVar6 == 0x9c) || (iVar6 == 0x9d)) || (iVar6 == 0x9e)) ||
                             ...
                             (((local_10->field_0285 == '\0' &&
                               ...
                               (bVar2 = st::fn_004049B7((char)this_00->field_0024), bVar2 != 3)

                               ) && (iVar6 = st::fn_0040186B(this_00->field_0024,0x1b),
                                    iVar6 != 0)))) {
                            ...
                            *param_4 = (int)local_a;
                            ...
                            st::fn_00401159(pRVar1,this_00,(ushort)*param_2,(ushort)*param_3,local_a);
                            pRVar1->field_0285 = 2;
                          }
                          pRVar1->field_0270 = 1;
...
// 00645F10 SubmarineTitans::Recovered::HiddenThis::RecoveredReceiver_00644410::sub_00645F10
