...
// Generated translation unit: source/recovered/by_owner/SubmarineTitans__Recovered__HiddenThis__RecoveredReceiver_00728640.cpp

// 00728A80 SubmarineTitans::Recovered::HiddenThis::RecoveredReceiver_00728640::FUN_00728a80
...

{
  ...
  iVar6 = st::fn_007287E0(&local_38,g_runtimeRecordCount_00857114);
  if (iVar6 != 0) {
    local_54 = -1;

    iVar6 = st::fn_007287E0(&local_54,g_runtimeRecordCount_00857114);
      ...
      do {
        if (this->field_0034 <= iVar15) {
          ...
          if (iVar6 - iVar7 != 0 && iVar7 <= iVar6) {
            local_18 = local_24;
            DAT_00857108 = st::storage_bit_cast<int>(static_cast<uint32_t>(local_40 - local_24)) / (iVar6 - iVar7);
            ...
            if (iVar8 != 0 && iVar7 <= iVar6) {
              ...
              if (DAT_00857108 * iVar8 + local_18 < *(uint *)(iVar6 + -4 + iVar8 * 2)) {
                ...
                puVar13 = (uint *)(iVar7 + param_1_after_write);
...
LAB_00728cb0:
                puVar17 = (undefined1 *)(iVar7 + param_1_after_write);
                pbVar16 = (byte *)(local_8 + iVar7);
...
LAB_00728cf9:
        ...
        if (local_34 == 0) {
          ...
          iVar6 = st::fn_007287E0(&local_38,local_30);
          if (iVar6 == 0) {
            return;
          }
        }
        ...
        if (local_50 == 0) {
          ...
          iVar6 = st::fn_007287E0(&local_54,local_4c);
          if (iVar6 == 0) {
            return;
          }
        }
