...
// Generated translation unit: source/recovered/by_owner/SubmarineTitans__Recovered__HiddenThis__RecoveredReceiver_00567510.cpp

// 00567510 SubmarineTitans::Recovered::HiddenThis::RecoveredReceiver_00567510::FUN_00567510
...

{
  ...
  if (DAT_00807363 == '\0') {
    ...
    local_8 = 2;
    local_10 = reinterpret_cast<int *>(&local_20->field_0E23);
    do {
      iVar13 = local_8;
      ...
      if ((local_18 == 1) &&
        ...
        if (*(int *)(&DAT_007c9790 + iVar9) < iVar11) {
          ...
          if (*(int *)(&DAT_007c978c + iVar9) < iVar11) {
            ...
            uVar6 = (int)uVar6 / 3 + ((int)uVar6 >> 0x1f) +
                    st::storage_bit_cast<int>(static_cast<uint32_t>((iVar13 / 3 + (iVar13 >> 0x1f) + local_28 + local_14) *
        ...
        iVar11 = st::storage_bit_cast<int>(static_cast<uint32_t>(((iVar13 - local_1c ^ uVar6) - uVar6) * 7)) / 10;
...
switchD_005675bc_default:
  if (pRVar3->field_10E1 != param_4) {
    ...
    iVar13 = 2;
    piVar12 = reinterpret_cast<int *>(&pRVar3->field_0E23);
    do {
