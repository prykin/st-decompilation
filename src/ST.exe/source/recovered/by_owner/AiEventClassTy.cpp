...
LAB_0065c021:
  ...
  case MESS_AIBOSSCLASSTY_5DD0|MESS_CURSORCLASSTY_0009:
  case MESS_AIBOSSCLASSTY_5DD0|MESS_SYSTEMCLASSTY_000A:
    pSVar4 = st::fn_004028BA(g_allPlayers_007FA174,'\0',(message->arg0).words.high,CASE_5);
    if (pSVar4 != nullptr) {
      uVar5 = pSVar4->vfunc_12C();
  ...
  case MESS_AIBOSSCLASSTY_5DD0|MESS_SHARED_0008|MESS_SHARED_0005:
  case 0x5dde:
    pSVar4 = st::fn_004028BA(g_allPlayers_007FA174,'\0',(message->arg0).words.high,CASE_2);
    if (pSVar4 != nullptr) {
      this->field_052F = 0;
      uVar5 = pSVar4->vfunc_0C();
      this->field_0533 = uVar5;
...
LAB_0065c4bb:
    if ((uVar8 == 0xffff) ||
       (pSVar4 = st::fn_004028BA(g_allPlayers_007FA174,(char)wVar7,uVar8,CASE_1),
       pSVar4 == nullptr)) {
      this->field_0563 = 0;
      goto cf_common_exit_0065C65B;
    }
