...
AiEventClassTy * __thiscall st::fn_0064CC90(AiEventClassTy *this)
...
int __thiscall st::fn_0065BD70(AiEventClassTy *this,STMessage *message,int param_2)
...
LAB_0065c021:
  ...
  case MESS_AIBOSSCLASSTY_5DD0|MESS_SYSTEMCLASSTY_000A:
    ...
    pSVar5 = st::fn_004028BA(g_allPlayers_007FA174,'\0',(message->arg0).words.high,CASE_5);
    if (pSVar5 != nullptr) {
  ...
  case 0x5dde:
    ...
    pSVar5 = st::fn_004028BA(g_allPlayers_007FA174,'\0',(message->arg0).words.high,CASE_2);
    if (pSVar5 != nullptr) {
      this->field_052F[0] = 0;
...
LAB_0065c4bb:
    if ((uVar8 == 0xffff) ||
       ...
       (pSVar5 = st::fn_004028BA(g_allPlayers_007FA174,(char)wVar7,uVar8,CASE_1),
       pSVar5 == nullptr)) {
