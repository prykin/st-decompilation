...

{
  ...
  *(undefined2 *)pbVar10 = *(undefined2 *)puVar8;
  ...
  if (this->field_005E != nullptr) {
    local_c = st::pointer_boundary_cast<uint *>(st::fn_006B0020(&this->field_005E->flags,(int *)&local_8));
    *puVar7 = local_8;
    puVar7 = local_c;
  ...
  if (this->field_0062 != nullptr) {
    local_c = st::pointer_boundary_cast<uint *>(st::fn_006B0020(&this->field_0062->flags,(int *)&local_8));
    *puVar7 = local_8;
    puVar9 = local_c;
    puVar11 = puVar7 + 1;
  ...
  if (this->field_0066 != nullptr) {
    local_c = st::pointer_boundary_cast<uint *>(st::fn_006B0020(&this->field_0066->flags,(int *)&local_8));
    *puVar7 = local_8;
    puVar9 = local_c;
