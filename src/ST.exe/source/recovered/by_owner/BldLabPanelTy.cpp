...
#line 1 "decomp/ST.exe/functions/004EFE20/decomp.c"
...

{
  ...
  if (this->field_027A != nullptr) {
    ...
    do {
      ...
      st::fn_006E6080(this,2,*puVar7,(undefined4 *)&this->field_0x18);
...
LAB_004eff2c:
      ...
      st::fn_006E6080(this,2,uVar9,(undefined4 *)&this->field_0x18);
      ...
      if ((((this->field_002C != 0) &&
        ...
        *(char *)((int)local_c + -9) = ((char)pGVar5[2] == 0) + '\x03';
        UVar2 = st::fn_00403684(*pGVar5,'\x03',0);
        local_c[-2] = UVar2;
        if ((char)pGVar5[2] == 0) {
