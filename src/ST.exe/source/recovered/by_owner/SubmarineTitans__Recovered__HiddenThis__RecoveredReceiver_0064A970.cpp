...
// Generated translation unit: source/recovered/by_owner/SubmarineTitans__Recovered__HiddenThis__RecoveredReceiver_0064A970.cpp

// 00668F50 SubmarineTitans::Recovered::HiddenThis::RecoveredReceiver_0064A970::sub_00668F50
...

{
  ...
  if (param_2 == 0) {
    /* ST_PSEUDO[stack_slot_reuse]: compiler reused a dead incoming argument slot; split the post-write lifetime into a local variable */
    if (st::machine_word_boundary_cast<uint>(param_1) == st::machine_word_boundary_cast<uint>((char *)0x9)) {
      ...
      if (st::machine_word_boundary_cast<uint>(param_1) == st::machine_word_boundary_cast<uint>((char *)0x8)) {
        if (DAT_0080874d != 0xff) {
          *param_3 = (uint)DAT_0080874d;
          return 1;
        }
      }
      else if (st::machine_word_boundary_cast<uint>(param_1) == st::machine_word_boundary_cast<uint>((char *)0xff)) {
        uVar2 = 0;
    ...
    if (param_2 == 0xffffffff) {
      if (st::machine_word_boundary_cast<uint>(param_1) == st::machine_word_boundary_cast<uint>((char *)0x9)) {
        ...
        if ((st::machine_word_boundary_cast<uint>(param_1) == st::machine_word_boundary_cast<uint>((char *)0x8)) && (DAT_0080874d != 0xff)) {
          uVar2 = 0;
          pbVar3 = &g_bulkInitializedRecords_008087C7[0].field_0022;
          do {
      ...
      if (st::machine_word_boundary_cast<uint>(param_1) == st::machine_word_boundary_cast<uint>((char *)0x9)) {
        ...
        if (((-1 < (int)uVar2) && ((int)uVar2 < 8)) &&
          ...
          do {
            if (*pbVar3 != 0xff) {
              if (DAT_00808a8f == '\0') {
                if ((char)param_2_after_write == (char)uVar2) {
LAB_00669807:
                  iVar6 = 0;
                }
                else {
                  uVar7 = param_2_after_write & 0xff;
                  uVar4 = uVar2 & 0xff;
                ...
                bVar9 = g_bulkInitializedRecords_008087C7[uVar2 & 0xff].field_0023 !=
                        g_bulkInitializedRecords_008087C7[param_2_after_write & 0xff].field_0023;
              }
              if (!bVar9) {
                if (DAT_00808a8f == '\0') {
                  if ((char)uVar2 == (char)param_2_after_write) {
LAB_006698b9:
                    iVar6 = 0;
                  }
                  else {
                  ...
                  bVar9 = g_bulkInitializedRecords_008087C7[param_2_after_write & 0xff].field_0023 !=
                          g_bulkInitializedRecords_008087C7[uVar2 & 0xff].field_0023;
                }
                if (!bVar9) {
                  *param_3 = param_2_after_write;
                  local_8 = local_8 + 1;
                  param_3 = param_3 + 1;
                }
              }
        ...
        if ((st::machine_word_boundary_cast<uint>(param_1) == st::machine_word_boundary_cast<uint>((char *)0x8)) && (DAT_0080874d != 0xff)) {
          auto param_2_after_write_2 = 0; /* compiler stack-slot lifetime split */
          param_1 = reinterpret_cast<char *>(&g_bulkInitializedRecords_008087C7[0].field_0022);
          bVar5 = DAT_0080874d;
          do {
            if (*param_1 != -1) {
              if (DAT_00808a8f == '\0') {
                if ((byte)param_2_after_write_2 == bVar5) {
LAB_00669b3a:
                  iVar6 = 0;
                }
                else {
                  uVar2 = param_2_after_write_2 & 0xff;
                ...
                bVar9 = g_bulkInitializedRecords_008087C7[bVar5].field_0023 !=
                        g_bulkInitializedRecords_008087C7[param_2_after_write_2 & 0xff].field_0023;
              }
              if (!bVar9) {
                if (DAT_00808a8f == '\0') {

                  iVar6 = st::fn_00405D8F(&DAT_00807620,bVar5,(byte)param_2_after_write_2);
                  bVar9 = iVar6 < 0;
                  bVar5 = DAT_0080874d;
                }
                else {
                  bVar9 = g_bulkInitializedRecords_008087C7[param_2_after_write_2 & 0xff].field_0023 !=
                          g_bulkInitializedRecords_008087C7[bVar5].field_0023;
                }
                if (!bVar9) {
                  local_8 = local_8 + 1;
                  *param_3 = param_2_after_write_2;
                  param_3 = param_3 + 1;
                  bVar5 = DAT_0080874d;
                }
              }
            ...
            param_2_after_write_2 = param_2_after_write_2 + 1;
...
// 00672440 SubmarineTitans::Recovered::HiddenThis::RecoveredReceiver_0064A970::FUN_00672440
...
int __thiscall
st::fn_00672440
          (RecoveredReceiver_0064A970 *this,RecoveredGlobalRecordView_00848A14 *param_1,int param_2,
          short *param_3)

{
  ...
  int local_20;
  RecoveredReceiver_0064A970 *local_1c;
  int local_18;
  int local_14;
  int local_10;
  float *local_c;
  ...
  st::fn_0072E340(&local_1c->field_0004,&CHAR_00h_008016a0,0x7f);
  ...
  do {
    ...
    case '\v':
      ...
      break;
    default:
      local_c = st::fn_00401F5F(arg_1,&local_14,&local_20);
      if (local_c == nullptr) {
        this_00->field_0084 = 0xffffffff;
LAB_0067276f:
