...
// Generated translation unit: source/recovered/by_owner/SubmarineTitans__Recovered__HiddenThis__RecoveredReceiver_0060EF40.cpp

// 0060EF40 SubmarineTitans::Recovered::HiddenThis::RecoveredReceiver_0060EF40::FUN_0060ef40
...

{
  ...
  local_2c = (int)sVar8;
  local_20 = (int)sVar9;
  st::fn_0040156E((int)this->field_01F5,reinterpret_cast<undefined4 *>(local_b8),reinterpret_cast<undefined4 *>(&local_74),0,nullptr);
  ...
  local_1c = (st_stack_frame + 20) + iVar10;
  local_54 = (st_stack_frame + 20) + iVar10;
  puVar12 = reinterpret_cast<byte *>(((st_stack_frame + 20) + iVar10));
...
LAB_0060f21b:
              iVar3 = local_50;
              *(int *)((st_stack_frame + 16) + iVar10) = local_4c;
              *(int *)((st_stack_frame + 12) + iVar10) = iVar3;
              *(int *)((int)local_b8 + iVar10 + -0x1c) = iVar13;
              *(undefined4 *)((int)local_b8 + iVar10 + -0x20) = 0x60f22c;

              /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
              iVar1 = st::fn_00404D3B(*(short *)((int)local_b8 + iVar10 + -0x1c),
                                         *(short *)((st_stack_frame + 12) + iVar10),
                                         *(short *)((st_stack_frame + 16) + iVar10));
              if (iVar1 == 0) {
LAB_0060f230:
              ...
              pcVar2 = (code *)this_00->vtable[5].slots_00_28[2];
              *(undefined4 *)((st_stack_frame + 16) + iVar10) = 0x60f1e8;
              ...
              if (((iVar3 == 0) || (st::machine_word_boundary_cast<uint>((STWorldObjectVTable *)0x7) < st::machine_word_boundary_cast<uint>(this_00[1].vtable))) ||
  ...
  *(short **)((st_stack_frame + 16) + iVar10) = local_60;
  *(undefined4 *)((st_stack_frame + 12) + iVar10) = 1;
  *(undefined4 *)((int)local_b8 + iVar10 + -0x1c) = 0;
  *(undefined4 *)((int)local_b8 + iVar10 + -0x20) = 0;
  *(int *)((st_stack_frame + 0) + iVar10) = (int)this->field_01F5;
  *(undefined4 *)((int)aiStackY_108 + iVar10 + 0x28) = 0x60f28e;
  /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
  st::fn_0040156E(*(Global_sub_00615BB0_param_1Enum *)((st_stack_frame + 0) + iVar10),
                     *(undefined4 **)((int)local_b8 + iVar10 + -0x20),
                     *(undefined4 **)((int)local_b8 + iVar10 + -0x1c),
                     *(int *)((st_stack_frame + 12) + iVar10),*(undefined2 **)((st_stack_frame + 16) + iVar10)
                    );
  iVar7 = 0;
  do {
  ...
  *(undefined4 *)((st_stack_frame + 16) + iVar10) = 2;
  *(int **)((st_stack_frame + 12) + iVar10) = local_68;
  *(int *)((int)local_b8 + iVar10 + -0x1c) = local_34;
  iVar7 = local_38;
  *(int *)((int)local_b8 + iVar10 + -0x20) = local_b0 - local_38;
  *(int *)((st_stack_frame + 0) + iVar10) = local_80 - iVar3;
  ...
  *(undefined4 *)((int)aiStackY_108 + iVar10 + 0xc) = 0x60f37c;
  ...
  local_6c = st::fn_006AFBA0
                        ...
                        *(short **)((st_stack_frame + 0) + iVar10),
                        *(short **)((int)local_b8 + iVar10 + -0x20),
                        *(short **)((int)local_b8 + iVar10 + -0x1c),
                        *(int **)((st_stack_frame + 12) + iVar10),static_cast<byte>(st::machine_word_boundary_cast<uint>(((st_stack_frame + 16))[iVar10])));
  if (local_6c == nullptr) {
    local_68[0] = 0;
  }
  else {
    ...
    if (*ppuVar1 == nullptr) {
      *(int *)((st_stack_frame + 16) + iVar10) = (local_68[0] + 1) * 0x1c;
      *(undefined4 *)((st_stack_frame + 12) + iVar10) = 0x60f3ca;
      ...
      puVar4 = static_cast<ushort *>(st::fn_006AAC70(*(uint *)((st_stack_frame + 16) + iVar10)));
      *ppuVar1 = puVar4;
    }
    else {
      if (this->field_02D5 <= local_68[0]) {
        *(ushort ***)((st_stack_frame + 16) + iVar10) = ppuVar1;
        *(undefined4 *)((st_stack_frame + 12) + iVar10) = 0x60f3a3;
        st::fn_006AB060(*(void **)((st_stack_frame + 16) + iVar10));
      }
      this->field_02D5 = 0;
    }
    iVar3 = 1;
    ...
    if (1 < local_68[0] + -1) {
      do {
        ...
        *(undefined4 *)((st_stack_frame + 16) + iVar10) = 0;
        *(undefined4 *)((st_stack_frame + 12) + iVar10) = 0;
        *(undefined4 *)((int)local_b8 + iVar10 + -0x1c) = 0;
        *(undefined4 *)((int)local_b8 + iVar10 + -0x20) = 0;
        *(undefined4 *)((st_stack_frame + 0) + iVar10) = 0;
        ...
        *(undefined4 *)((int)aiStackY_108 + iVar10) = 0x60f549;
        ...
        iVar7 = st::fn_00402EFF(*(int *)((int)aiStackY_108 + iVar10 + 4),
                                   ...
                                   *(int *)((st_stack_frame + 0) + iVar10),
                                   *(int *)((int)local_b8 + iVar10 + -0x20),
                                   *(int *)((int)local_b8 + iVar10 + -0x1c),
                                   *(int **)((st_stack_frame + 12) + iVar10),
                                   *(int **)((st_stack_frame + 16) + iVar10));
    ...
    if (1 < local_68[0]) {
      ...
      *(undefined4 *)((int)aiStackY_108 + iVar10) = 0x60f609;
      ...
      iVar3 = st::fn_00402EFF(*(int *)((int)aiStackY_108 + iVar10 + 4),
                                 *(int *)((int)aiStackY_108 + iVar10 + 8),
                                 *(RecoveredRecordView_0060F940_8057A92D **)
                                  /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
                                  ((int)aiStackY_108 + iVar10 + 0xc),
      ...
      *(undefined4 **)((st_stack_frame + 16) + iVar10) = &local_70;
      *(undefined4 **)((st_stack_frame + 12) + iVar10) = &local_44;
      *(undefined4 **)((int)local_b8 + iVar10 + -0x1c) = &local_30;
      *(int *)((int)local_b8 + iVar10 + -0x20) = (int)this->field_01F5;
      *(undefined4 *)((st_stack_frame + 0) + iVar10) = 0x60f64f;

      /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
      st::fn_004047AF(*(int *)((int)local_b8 + iVar10 + -0x20),
                         *(int **)((int)local_b8 + iVar10 + -0x1c),
                         *(int **)((st_stack_frame + 12) + iVar10),*(int **)((st_stack_frame + 16) + iVar10));
      puVar4 = *ppuVar1;
      *(int *)((st_stack_frame + 16) + iVar10) = (int)this->field_01F3 % 200 + (short)puVar4[0x10] * 200;
      *(int *)((st_stack_frame + 12) + iVar10) = (short)puVar4[0xf] * 0xc9 + (int)this->field_01F1 % 0xc9
      ;
      *(int *)((int)local_b8 + iVar10 + -0x1c) =
           (short)puVar4[0xe] * 0xc9 + (int)this->field_01EF % 0xc9;
      *(undefined4 *)((int)local_b8 + iVar10 + -0x20) = local_70;
      *(undefined4 *)((st_stack_frame + 0) + iVar10) = local_44;
      ...
      *(undefined4 *)((int)aiStackY_108 + iVar10 + 0x18) = 0x60f6d4;
      /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
      st::fn_004037FB(this,*(int *)((int)aiStackY_108 + iVar10 + 0x1c),
                         *(int *)((int)aiStackY_108 + iVar10 + 0x20),
                         *(int *)((int)aiStackY_108 + iVar10 + 0x24),
                         *(int *)((int)aiStackY_108 + iVar10 + 0x28),
                         *(int *)((st_stack_frame + 0) + iVar10),
  ...
  if (local_6c != nullptr) {
    *(short ***)((st_stack_frame + 16) + iVar10) = &local_6c;
    *(undefined4 *)((st_stack_frame + 12) + iVar10) = 0x60f6ee;
    st::fn_006AB060(*(void **)((st_stack_frame + 16) + iVar10));
  }
  ExceptionList = local_14;
  return local_68[0];
