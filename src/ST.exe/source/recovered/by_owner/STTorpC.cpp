...
st::fn_00643E20(RecoveredRecordView_00643E20_2E427F9C *param_1,undefined4 param_2)

{
  ...
  if (param_1->field_023D == 1) {
    ...
    if (bVar7 == 8) {
      st::fn_006EA2F0(param_1->field_0211,param_1->field_01ED);
      uVar6 = st::fn_0040503D(reinterpret_cast<RecoveredRecord_STTorpC_0041DA30 *>(param_1));
      return uVar6;
    }
  }
  else {
    ...
    st::fn_00404264(reinterpret_cast<STT3DSprC *>(&param_1->field_0x1d5),1);
  }
