...
// Generated translation unit: source/recovered/by_owner/SubmarineTitans__Recovered__HiddenThis__RecoveredReceiver_006CEC40.cpp

// 006D63E0 SubmarineTitans::Recovered::HiddenThis::RecoveredReceiver_006CEC40::FUN_006d63e0
#line 4 "decomp/ST.exe/functions/006D63E0/decomp.c"
...
{
  alignas(4) byte st_stack_frame[248];
  ...
  if ((*(uint *)(this->field_0288->field_0028 + 0xc) & 0x100) == 0) {
    ...
    if ((STField<uint>(iVar7,0x8) & 0x4000000) != 0) {
      ...
      st::external_00000018((LPCRITICAL_SECTION)(iVar7 + 0x4f0));
    }
    ...
    if (((pAVar3->field_0004 & 8) == 0) &&
      ...
      st::fn_006B42D0
                ((DDXContext *)pAVar3->field_0028,iVar7,iVar10,reinterpret_cast<BITMAPINFO *>(lpbmi),local_bc,
      ...
      if ((*(int *)(pAVar3->field_0028 + 0x20) < 0x11) &&
        ...
        BVar9 = st::external_00000023((uint *)(((*(int *)&pBVar2[1].bmiHeader.biPlanes - pAVar3->field_000C)
        ...
        if (BVar9 == 0) {
          ...
          do {
            ...
            st::fn_006CEC40((AnonShape_006CEC40_BB23E716 *)this->field_0288->field_0028);
            iVar10 = iVar10 + 1;
          } while (iVar10 < 2);
          if (iVar7 == 0) {
LAB_006d666f:
            ...
            if (*(int *)(pAVar3->field_0028 + 0x20) == 8) {
              ...
              iVar7 = ((*(int *)&pBVar2[1].bmiHeader.biPlanes - pAVar3->field_000C) + -1) * uVar8 +
                      pAVar3->field_0008;
              if (local_c0 == 0) {
                st::fn_006DB310(reinterpret_cast<undefined4 *>(local_74),local_88,local_a0,local_9c,iVar7 + (int)local_bc
                             ,-uVar8,pAVar3->field_0010,pAVar3->field_0014);
              }
              else {
                st::fn_006DB450(reinterpret_cast<undefined4 *>(local_74),local_88,
              ...
              if (uVar1 == 8) {
                ...
                if (local_c0 == 0) {
                  st::fn_006DB0D0(reinterpret_cast<undefined4 *>(local_74),local_88,local_a0,local_9c,
                               iVar7 + (int)local_bc,-uVar8,pAVar3->field_0010,pAVar3->field_0014,
                               pvVar6);
                }
                else {
                  st::fn_006DB1F0(local_74,local_88,(byte *)(iVar7 + (int)local_bc),-uVar8,
                ...
                iVar7 = ((*(int *)&pBVar2[1].bmiHeader.biPlanes - pAVar3->field_000C) + -1) * uVar8
                        + pAVar3->field_0008 * 2;
                if (local_c0 == 0) {
                  st::fn_006DAED0(reinterpret_cast<undefined4 *>(local_74),local_88,local_a0,local_9c,
                               iVar7 + (int)local_bc,-uVar8,pAVar3->field_0010,pAVar3->field_0014);
                }
                else {
                  st::fn_006DAFD0(local_74,local_88,(ushort *)(iVar7 + (int)local_bc),-uVar8,
                               pAVar3->field_0010,pAVar3->field_0014);
                }
              }
            }
...
LAB_006d68c8:
          ...
          st::external_000000B4(local_b4[0],STField<int>(iVar7,0x10),STField<int>(iVar7,0x14),(LPPOINT)0x0);
          /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
          hrgn = *(HRGN *)(this->field_0288->field_0028 + 0x494);
          if (st::machine_word_boundary_cast<uint>(hrgn) != st::machine_word_boundary_cast<uint>((HRGN)0x0)) {
          ...
          *(int **)(this->field_0288->field_0028 + 0x480) = piVar5;
          ...
          st::external_000000B1(local_b4[0],local_a8,local_a4,local_a0,local_9c,pAVar3->field_0008,
                        pAVar3->field_000C,pAVar3->field_0010,pAVar3->field_0014,local_bc,
                        reinterpret_cast<BITMAPINFO *>(lpbmi),0,0xcc0020);
          iVar7 = 0;
          do {
    ...
    if ((STField<uint>(iVar7,0x8) & 0x4000000) != 0) {
      ...
      st::external_00000019((LPCRITICAL_SECTION)(iVar7 + 0x4f0));
    }
  }
  ExceptionList = local_14;
  return 0;
