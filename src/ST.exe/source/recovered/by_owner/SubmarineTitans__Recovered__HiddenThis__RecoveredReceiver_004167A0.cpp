...
// Generated translation unit: source/recovered/by_owner/SubmarineTitans__Recovered__HiddenThis__RecoveredReceiver_004167A0.cpp

// 00418030 SubmarineTitans::Recovered::HiddenThis::RecoveredReceiver_004167A0::FUN_00418030
...

{
  ...
  local_58 = reinterpret_cast<STBoatC *>(this);
  ...
  if (((st::storage_bit_cast<int>(static_cast<uint32_t>((uVar4 ^ uVar11) - uVar11)) < 2) &&
      (iVar15 = (int)param_2, uVar4 = iVar15 - local_58->field_005D, uVar11 = (int)uVar4 >> 0x1f,
      st::storage_bit_cast<int>(static_cast<uint32_t>((uVar4 ^ uVar11) - uVar11)) < 2)) &&
    ...
    if (pSVar5 == nullptr) {
      *(undefined4 *)&local_58->field_0x9b = 2;
      ...
      uVar7 = st::fn_006A5EB0((int)this_00->field_005B,(int)this_00->field_005D,
        ...
        if ((int)local_38 <= local_28) {
          ...
          do {
            ...
            if (((sVar3 < 0) || (g_worldGrid.sizeX <= sVar3)) ||
              ...
              pSVar9 = reinterpret_cast<STBoatC *>(STGridAt3D(g_worldGrid, sVar3, sVar12, sVar10).objects[0]);
            }
            psVar14 = local_50;
            if (pSVar9 == nullptr) {
              if (this_00->field_008E != '\0') {
                if (((((sVar3 < 0) || (g_worldGrid.sizeX <= sVar3)) || (sVar12 < 0)) ||
                  ...
                  pSVar9 = reinterpret_cast<STBoatC *>(STGridAt3D(g_worldGrid, sVar3, sVar12, sVar10).objects[1]);
...
LAB_004183b8:
  ...
  puVar6_mg0 = st::fn_006AE7D0
                         ((int)g_pathingGrid.cells,(int)g_pathingGrid.sizeX,
                          ...
                          reinterpret_cast<int *>(&this_00->field_0x9b),reinterpret_cast<undefined4 *>(local_14),psVar14);
  this_00->field_0097 = reinterpret_cast<ushort *>(puVar6_mg0);
  if (puVar6_mg0 == nullptr) {
    ...
    puVar6_mg1 = st::fn_006AFBA0
                           ((int)g_pathingScratchGrid.cells,(int)g_pathingScratchGrid.sizeX,
                            ...
                            reinterpret_cast<int *>(&this_00->field_0x9b),0);
    this_00->field_0097 = reinterpret_cast<ushort *>(puVar6_mg1);
  }
  st::fn_006AB060(&local_14);
LAB_0041862b:
  g_currentExceptionFrame = local_9c.previous;
