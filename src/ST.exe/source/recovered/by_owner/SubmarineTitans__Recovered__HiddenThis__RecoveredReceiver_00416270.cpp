...
// Generated translation unit: source/recovered/by_owner/SubmarineTitans__Recovered__HiddenThis__RecoveredReceiver_00416270.cpp

// 005FAA10 SubmarineTitans::Recovered::HiddenThis::RecoveredReceiver_00416270::FUN_005faa10
  ...
  if (local_10->field_02E6 !=
    ...
    if (param_1 == 1) {
      puVar3 = st::fn_00709AF0
                         (PTR_00806774,CASE_1D,st::mutable_c_string("rubb3"),0xffffffff,0,1,0,nullptr);
      ...
      puVar3 = st::fn_00709AF0
                         (PTR_00806774,CASE_1D,st::mutable_c_string("bulb_tel"),0xffffffff,0,1,0,
                          nullptr);
      uVar5 = STField<uint>(puVar3,0xd);
      uVar4 = STField<uint>(puVar3,9);
      uVar7 = 0x2f;
    ...
    st::fn_006E8660(pRVar2->field_0211,reinterpret_cast<int *>(&local_8),1,0,uVar4,uVar5,uVar6,uVar7,0);
    st::fn_006E98E0
              (pRVar2->field_0211,local_8,0,*(int *)puVar3,STField<int>(puVar3,0x21),1);
    st::fn_006EA270(pRVar2->field_0211,local_8,0,0);
    ...
    st::fn_006E9EF0(pRVar2->field_0211,local_8,0,1,0,0,30000);
    st::fn_006EAAA0(pRVar2->field_0211,local_8,0);
