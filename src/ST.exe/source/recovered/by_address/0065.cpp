...
undefined4 __cdecl st::fn_006503B0(RecoveredRecord_006503B0_3B1FB22E *param_1)
...
int __cdecl st::fn_00650760(short *param_1)
...
int __cdecl st::fn_006507E0(int param_1)
...
undefined4 __cdecl st::fn_00650A20(RecoveredRecordView_00650A20_3149A900 *param_1)
...
undefined4 __cdecl st::fn_00650F50(RecoveredRecord_00650F50_B7B27450 *param_1)
...
int __cdecl st::fn_00651120(RecoveredRecord_00651120_F461859C *param_1)
...
int __cdecl st::fn_00651160(RecoveredRecord_00651160_26346523 *param_1)
...
int __cdecl st::fn_006511A0(RecoveredRecord_006511A0_EA666092 *param_1)
...
int __cdecl st::fn_006511E0(RecoveredRecord_006511E0_D143FD4C *param_1)
...
int __cdecl st::fn_00651250(RecoveredRecord_00651250_A6EBE57F *param_1)
...
int __cdecl st::fn_00651730(RecoveredRecord_00651730_E89B8086 *param_1)
...
undefined4 __cdecl st::fn_00651770(RecoveredRecordView_00651770_AFECD81B *param_1)
...
int __cdecl st::fn_00651880(RecoveredRecord_00651880_B0B7072C *param_1)
...
int __cdecl st::fn_006518C0(RecoveredRecord_006518C0_AF8C168C *param_1)
...
int __cdecl st::fn_00651DB0(RecoveredRecord_00651DB0_B471A58B *param_1)
...
int __cdecl st::fn_006525E0(RecoveredRecordView_006525E0_3E62F5FD *param_1)
...
int __cdecl st::fn_00652670(RecoveredRecordView_00652670_3E62F5FD *param_1)
...
void __cdecl st::fn_0065D030(RecoveredRecordView_0065D030_884B498B *param_1)

{
  ...
  if (param_1->field_0005 != '\0') {
    ...
    st::fn_00402FA4(reinterpret_cast<undefined4 *>(&param_1[1].field_0x6));
  }
  return;
}
...

{
  if ((RecoveredRecordView_0065D030_884B498B *)*param_1 !=
      nullptr) {
    st::fn_00402F8B((RecoveredRecordView_0065D030_884B498B *)*param_1);
...
void __fastcall st::fn_0065D590(RecoveredRecordView_0065D590_F2A3738B *param_1)
...
void __fastcall st::fn_0065D600(RecoveredRecordView_0065D590_F2A3738B *param_1)

{
  if ((AiTactClassTy *)param_1->field_0284 != 0) {

    st::fn_00403080((AiTactClassTy *)param_1->field_0284,param_1);
  }
  return;
}
...
void __fastcall st::fn_0065D630(RecoveredRecordView_0065DA10_5A1C53AF *param_1,undefined4 param_2)

{
  uint uVar1;
  uint local_24 [8];
  st::fn_00401EF1(param_1,param_2);
  st::fn_004037E7(reinterpret_cast<RecoveredRecordView_0065D590_F2A3738B *>(param_1));
  ...
  if (param_1 != nullptr) {
    ...
    if (0 < (int)param_1->count) {
      ...
      do {
        ...
        /* ST_CALLSITE[0065D97B]: CALL 0x004028ba; direct=004028BA STAllPlayersC::GetObjPtr; [STCallResultViewApplier] presentation_only; exact direct-call result=pointer:/AiFltClassTy; source view only; no Ghidra override */
        ...
        if (objPtr != nullptr) {
          ...
          st::fn_00404200(static_cast<AiFltClassTy *>(this),reinterpret_cast<RecoveredRecord_0065D760_A4BF8285 *>(objPtr),param_2);
        }
        uVar2 = uVar2 + 1;
...

{
  ...
  array = reinterpret_cast<DArrayTy *>(st::fn_004018CF(param_1,param_2));
  if (array != nullptr) {
...

{
  ...
  local_1c = reinterpret_cast<DArrayTy *>(st::fn_004018CF(param_1,param_2));
  if (local_1c != nullptr) {
...
LAB_0065deef:
          ...
          if (((param_5_after_write_2 == -1) || (iVar9 = this->vfunc_6C(), param_5_after_write_2 == iVar9)) &&
             (((param_10 < 1 || ((param_11 < 1 || (param_12 < 1)))) ||
              ...
              ((st::fn_004018C5(reinterpret_cast<STFishC *>(this),&local_6,&local_8,&local_a),
               param_7 <= local_6 &&
...
int __fastcall
st::fn_0065E070(void *param_1,undefined4 param_2,uint param_3,uint param_4,uint param_5,char param_6,
            byte *param_7)

{
  ...
  iVar9 = 0;
  local_14 = 0;
  st::fn_004026C1(g_allPlayers_007FA174,
                     STReplaceLowByte((uint32_t)(local_4c), (uint8_t)(STField<undefined1>(param_1,0x24))),
                     STReplaceLowWord(st::storage_bit_cast<uint32_t>(static_cast<uint32_t>(param_2)), (uint16_t)(uVar2)),param_3,local_4c);
    ...
    if (local_1c != nullptr) {
      ...
      if (0 < (int)local_1c->count) {
        ...
        do {
          ...
          st::fn_004018C5(reinterpret_cast<STFishC *>(this),&local_8,&local_6,(short *)((int)&param_3 + 2));
          if (param_5 != 0) {
            if (uVar5 == 0x78) {
...
int __fastcall st::fn_0065E3B0(RecoveredRecordView_0065DA10_5A1C53AF *param_1,undefined4 param_2)
...
int __fastcall
st::fn_0065E450(RecoveredRecordView_0065E360_071C1E69 *param_1,undefined4 param_2,
...

{
  ...
  array = reinterpret_cast<DArrayTy *>(st::fn_004059B6(reinterpret_cast<AiFltClassTy *>(param_1),param_2,iVar3));
  if (array == nullptr) {
    return 0;
  }
  GVar4 = array->count;
  ...
  if (0 < (int)GVar4) {
    do {
      ...
      case 0x1b:
        ...
        iVar3 = st::fn_004012C1(this,0,nullptr,param_4,param_5,0,0,0);
...
void __fastcall st::fn_0065E6C0(RecoveredRecordView_0065DA10_5A1C53AF *param_1,undefined4 param_2)
...
st::fn_0065E700(RecoveredReceiver_0065ED90 *param_1,undefined4 param_2,int *param_3,int *param_4,
            int *param_5)
  ...
  *param_3 = 0;
  if (0 < (int)array->count) {
    ...
    do {
      ...
      this = st::pointer_boundary_cast<STFishC *>(st::fn_004028BA(g_allPlayers_007FA174,param_1->field_0024,*puVar1,CASE_1));
      if (this != nullptr) {
...
undefined4 __cdecl
st::fn_0065E860(ushort param_1,ushort param_2,int param_3,
...
undefined4 __cdecl
st::fn_0065E900(ushort param_1,ushort param_2,int param_3,AnonShape_0065E900_F86511DB *param_4)
...
/* [STPrototypeApplier] Propagated parameter 1.
   ...
   void/unsized transport requires at least two callers; sites=00664960 @ 0066598F -> read as EAX on
   every CFG path | 00664960 @ 00666160 -> read as EAX on every CFG path */
...

{
  ...
  if (st::machine_word_boundary_cast<uint>(psVar4) == st::machine_word_boundary_cast<uint>((short *)0x8)) {
    psVar4 = (short *)(uint)DAT_0080874d;
  }
  if (st::machine_word_boundary_cast<uint>(psVar4) == st::machine_word_boundary_cast<uint>((short *)0xff)) {
    return -1;
  }
  local_10 = this;
  ...
  if (uVar2 != 0) {
    ...
    if ((char)param_6 == '\b') {
      param_6 = STReplaceLowByte(st::storage_bit_cast<uint32_t>(static_cast<uint32_t>(param_6)), (uint8_t)((char)psVar4));
    }
    else if (((char)param_6 < '\0') || ('\b' < (char)param_6)) {
      param_6 = STReplaceLowByte(st::storage_bit_cast<uint32_t>(static_cast<uint32_t>(param_6)), (uint8_t)(0xff));
    }
    ...
    if (DAT_00811900 != 0) {
      ...
      iVar3 = st::fn_00402423((void *)((int)local_10 + 0x1c),reinterpret_cast<int *>(local_8),DAT_00811900);
      if ((STFishC *)local_8[iVar3 * 0xb + 3] != 0) {
        /* ST_CALLSITE[0065EAAE]: CALL 0x004018c5; direct=004018C5 STFishC::sub_004162B0 */
        st::fn_004018C5
                  ((STFishC *)local_8[iVar3 * 0xb + 3],reinterpret_cast<short *>(&param_1),local_14,
                   (short *)((int)&param_2 + 2));
  ...
  if (((g_allPlayers_007FA174 != nullptr) && (param_3 != nullptr)) && (0 < param_2)
    ...
    if (param_1 != 0xff) {
      ...
      if (uVar1 == 0) {
        ...
        /* ST_PSEUDO[stack_slot_reuse]: compiler reused a dead incoming argument slot; split the post-write lifetime into a local variable */
        if ((char)param_7 == '\b') {
          param_7 = STReplaceLowByte(st::storage_bit_cast<uint32_t>(static_cast<uint32_t>(param_7)), (uint8_t)(cVar6));
        }
        else if (((char)param_7 < '\0') || ('\b' < (char)param_7)) {
          param_7 = STReplaceLowByte(st::storage_bit_cast<uint32_t>(static_cast<uint32_t>(param_7)), (uint8_t)(0xff));
        }
        ...
        if (DAT_00811900 == 0) {
          ...
          if (0 < iVar5) {
            do {
              ...
              iVar2 = st::fn_00402423((void *)((int)this + 0x1c),reinterpret_cast<int *>(local_c),DAT_00811900);
              if (local_c[iVar2 * 0xb + 3] != 0) {
                ...
                st::fn_006AE1C0(reinterpret_cast<DArrayTy *>(param_3),&param_2);
                local_8 = local_8 + 1;
              }
              iVar5 = iVar5 + -1;
            } while (iVar5 != 0);
...

{
  ...
  if (g_allPlayers_007FA174 != nullptr) {
    ...
    if (0 < (int)pDVar3->count) {
      ...
      local_8 = reinterpret_cast<AnonShape_0065EF70_EB9B857D *>(param_1);
      do {
        if (bVar8) {
...

{
  ...
  if ((((param_1 != nullptr) && (param_1->count != 0)) &&
    ...
    if ((int)param_2 < (int)uVar2) {
      do {
        if (param_3 <= st::storage_bit_cast<int>(static_cast<uint32_t>(uVar4 - param_2))) {
          g_currentExceptionFrame = local_54.previous;
          return &array->flags;
        }
        if (uVar4 < uVar2) {
...
void __fastcall
st::fn_0065FA10(RecoveredRecordView_0065FA10_071C1E69 *param_1,int param_2,int param_3,int param_4,
            int param_5)
...
uint __fastcall st::fn_0065FD00(RecoveredRecordView_0065FD00_071C1E69 *param_1,undefined4 param_2)
...
int __thiscall st::fn_0065FD50(void *this,int param_1,int param_2,short param_3,undefined4 param_4)
...
int __fastcall st::fn_0065FE10(AiFltClassTy *param_1,undefined4 param_2,int param_3,short *param_4)

{
  ...
  array = reinterpret_cast<DArrayTy *>(st::fn_004038E1(param_1,uVar3,1,param_4));
  if (array != nullptr) {
    sVar1 = param_1->field_0039;
    if (sVar1 < 1) {
LAB_0065fec9:
    ...
    local_c = reinterpret_cast<DArrayTy *>(st::fn_004038E1(param_1,iVar4,1,nullptr));
    if (local_c != nullptr) {
      sVar1 = param_1->field_0039;
      local_38[0] = nullptr;
      if (param_3 == 0xdd) {
