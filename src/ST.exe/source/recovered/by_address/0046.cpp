...
LAB_004604c9:
                iVar3 = st::fn_00401451(this,(RecoveredRecord_STBoatC_00482DB0 *)param_1);
                if (iVar3 == 1) {
...
LAB_00460581:
                  ...
                  st::fn_00404F6B(this,iVar3,iVar7,iVar6);
  ...
  if ((STField<int>(this,0x82e) == 2) && (iVar6 = st::fn_00405E57(this), iVar6 == 1)) {
    sVar1 = STField<short>(this,0x469);
    STField<short>(this,0x469) = -sVar1;
    /* ST_PSEUDO[return_width_artifact,raw_indirect_call]: candidate call-output artifact: verify return width, clobbers, or x87 state; expected typed vtable/callback call with explicit __thiscall receiver */
    iVar6 = (**(code **)(*(int *)this + 0x18))
...
LAB_00462c49:
            ...
            if ((bVar24) &&
              ...
              st::fn_00404F6B(this,(int)*(short *)&local_c->vtable,(int)*psVar2,(int)*psVar1);
          ...
          pSVar12 = st::fn_00405CF9(STField<char>(this,0x24),STField<ushort>(this,0x30));
...
LAB_00462a36:
        ...
        if (iVar15 != 2) {
          ...
          iVar15 = st::fn_00402847(this,local_74,&local_10);
          if (iVar15 == -1) {
            return -1;
          }
          if (iVar15 == 0) {
            ...
            if (-1 < iVar15) {
              iVar15 = st::fn_004016E0(*(char *)&pSVar14->field_0024);
              if (200 < iVar15) {
                iVar15 = 200;
              }
              st::fn_00403166(*(char *)&pSVar14->field_0024,iVar15);
              st::fn_00404336(STField<char>(this,0x24),iVar15);
              iVar15 = st::fn_00403954(*(char *)&pSVar14->field_0024);
              if (100 < iVar15) {
                iVar15 = 100;
              }
              st::fn_00403418(*(char *)&pSVar14->field_0024,iVar15);
              st::fn_00404412(STField<char>(this,0x24),iVar15);
              iVar15 = st::fn_00402284(*(char *)&pSVar14->field_0024);
              if (0x5dc < iVar15) {
                iVar15 = 0x5dc;
              }
              st::fn_00405367(*(char *)&pSVar14->field_0024,iVar15);
              st::fn_004055E7(STField<char>(this,0x24),iVar15);
              st::fn_004028F6(*(char *)&pSVar14->field_0024);
              ...
              if (DAT_00811798 != nullptr) {
                ...
                pSVar14->slot_2C();
                st::fn_00404E62(DAT_00811798,(int)STPiece<2,2>(local_14),(int)STPiece<2,2>(local_28),
                                   pSVar14->field_0024);
                /* ST_PSEUDO[raw_indirect_call]: expected typed vtable/callback call with explicit __thiscall receiver */
                iVar15 = (**(code **)(*(int *)this + 0xd8))();
                return (-(uint)(iVar15 != 0) & 0xfffffffd) + 2;
...
LAB_004625fd:
            ...
            if (STField<char>(this,0x2b2) != '\0') {
              ...
              do {
                puVar11 = (undefined4 *)
                          st::fn_0040342C(local_74,(short)*(undefined4 *)(puVar22 + -1),
                ...
                puVar11 = (undefined4 *)
                          st::fn_0040342C(&local_c,0,0,STField<short>(this,0x6c));
                uVar8 = *puVar11;
...
LAB_004624c3:
          ...
          case 8:
            ...
            if (STField<int>(this,0x818) < iVar21) {
              STField<undefined4>(this,0x83a) = 0;
              iVar15 = st::fn_00405E66(this,(short)iVar15,(short *)&local_24,(short *)&local_1c,
                                          (short *)&local_20);
              if (iVar15 != 0) {
                STField<undefined4>(this,0x82e) = 3;
                st::fn_00404F6B
...
LAB_0046470b:
          st::fn_004031E3(local_c,(undefined2 *)&local_10,&local_28,(int *)&local_14);
          /* ST_PSEUDO[raw_indirect_call]: expected typed vtable/callback call with explicit __thiscall receiver */
          ...
          uVar10 = st::fn_004030B2(this,sVar9);
          ...
          STField<undefined4>(this,0x7a) = 0;
          iVar15 = st::fn_00402847(this,&local_30,local_74);
          if (iVar15 == -1) {
            return -1;
          }
          if (iVar15 == 0) {
...
cf_common_exit_00463FD6:
            st::fn_00404F6B(this,iVar15,(int)sVar6,(int)sVar9);
            st::fn_004031DE(this,0);
            STField<undefined2>(this,0xf8) = 0;
...

{
  ...
  if (STField<int>(this,0x497) == 0) {
    iVar1 = st::fn_00402266(this,2);
    switch(iVar1) {
    case 0:
      pSVar2 = st::fn_00405CF9(STField<char>(this,0x24),STField<ushort>(this,0x30));
      /* ST_PSEUDO[return_width_artifact]: candidate call-output artifact: verify return width, clobbers, or x87 state */
      uVar3 = st::fn_0040547F
                        (pSVar2,0,CONCAT22(extraout_var_00,STField<undefined2>(this,0x32)),
                         STField<uint>(this,0x48f));
      if (uVar3 == 0) {
        iVar1 = st::fn_00403A2B(this,0);
        if (iVar1 == -1) {
          return -1;
        }
