...

{
  ...
  if (0 < (int)DAT_007f4d20) {
    ...
    do {
      iVar4 = st::fn_006AAE60(iVar9,iVar11,(iVar3 + local_74) / (int)puVar13,piVar4[-1] * 4 + 2,
  ...
  if (0 < (int)DAT_007f4d20) {
    ...
    do {
      iVar2 = st::fn_006AAE60(DAT_007f4d0c,DAT_007f4d10,DAT_007f4d1c,piVar4[-1] * 4 + 2,*piVar4 * 4 + 2
                           ,piVar4[1] * 4 + 2);
      piVar4[2] = iVar2;
