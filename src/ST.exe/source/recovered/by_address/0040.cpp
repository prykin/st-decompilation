            ...
            *param_6 = uVar3;
            ...
            if (psVar9[1] == param_2->field_0049) {
              if ((psVar2[iVar7 + iVar8] & 0xc000U) != 0xc000) {
                iVar6 = st::fn_004044AD((RecoveredRecord_STBoatC_0040AE40 *)param_2,(int)*psVar9,
...

{
  ...
  if (pSVar7->field_009F == nullptr) {
    iVar8 = st::fn_006AADD0(iVar8,(int)pSVar7->field_0049,(int)pSVar7->field_004B,pSVar7->field_00BB,
              ...
              if (local_10 != pSVar7->field_00AF) {
                ...
                if (0 < (int)local_44) {
                  do {
                    ...
                    uVar3 = *puVar11;
                    if (((uVar3 != 0xffff) &&
                        ((((pSVar12 = st::fn_0040286F(param_1,uVar3),
                       ...
                       ((((puVar11[4] == *puVar13 && (puVar11[5] == puVar13[1])) &&
                         (puVar11[6] == puVar13[2])) ||
                        ((((local_48 = st::fn_006A5EB0((int)pSVar12->field_0047,
                           ...
                           ((local_48 != pSVar12->field_00AF ||
                            (pSVar12->field_009F
                             ...
                             local_38)))) &&
                          (iVar9 = st::fn_00402513(param_1,(AnonShape_0040CE20_D3328A6B *)pSVar12
...
LAB_0040dd8a:
  ...
  if (local_14 == 30000) {
    iVar8 = st::fn_00402513(param_1,(AnonShape_0040CE20_D3328A6B *)pSVar7,&local_28,&local_2c,
                               &local_30,&local_20);
    if (iVar8 == 0) {
      return 2;
    }
...

{
  ...
  local_30 = 30000;
  local_4c = -30000;
  local_7c = st::fn_006ACED8(DAT_007f4d0c,DAT_007f4d10,iVar7,iVar9);
  if (local_7c == 0) {
    local_7c = 1;
  }
  iVar6 = local_7c >> 1;
  ...
  if (0 < (int)DAT_007f4d20) {
    ...
    do {
      iVar4 = st::fn_006AAE60(iVar7,iVar9,(iVar2 + local_74) / (int)puVar11,piVar3[-1] * 4 + 2,
  ...
  if (0 < (int)DAT_007f4d20) {
    ...
    do {
      iVar2 = st::fn_006AAE60(DAT_007f4d0c,DAT_007f4d10,DAT_007f4d1c,piVar3[-1] * 4 + 2,*piVar3 * 4 + 2
                           ,piVar3[1] * 4 + 2);
      piVar3[2] = iVar2;
      ...
      do {
        ...
        if (0 < (int)DAT_007f4d20) {
          ...
          do {
            if (-1 < piVar10[-2]) {
              piVar1 = (int *)*piVar10;
              iVar7 = st::fn_006AAE60(*piVar1,piVar1[1],piVar1[2],piVar3[-1],*piVar3,piVar3[1]);
      ...
      do {
        ...
        if (0 < (int)DAT_007f4d20) {
          ...
          do {
            if (-1 < piVar10[-1]) {
              piVar1 = (int *)*piVar3;
              iVar7 = st::fn_006AAE60(piVar10[-1],*piVar10,piVar10[1],*piVar1,piVar1[1],piVar1[2]);
