...
void __thiscall st::fn_005F00B0(void *this,RecoveredRecord_005F00B0_88BE3B54 *param_1)

{
  ...
  *(undefined1 *)param_1 = 4;
  ...
  st::fn_0072E340(reinterpret_cast<char *>((param_1 + 1)),local_14,0xe);
...
void __thiscall st::fn_005F0150(void *this,RecoveredRecordView_005F0150_C2558006 *param_1)
...
void __thiscall st::fn_005F0240(void *this,RecoveredRecord_005F0240_1A9CFE11 *param_1)
...
void __thiscall st::fn_005F0280(void *this,RecoveredRecord_005F0280_83C341D9 *param_1)

{
  ...
  *(undefined1 *)param_1 = 4;
  param_1->field_0x1 = 1;
  /* ST_CALLSITE[005F0293]: CALL dword ptr [EAX + 0x2c] */
  /* ST_PSEUDO[raw_indirect_call]: expected typed vtable or function-table callback call with the machine-proven calling convention */
  uVar2 = (**(code **)(*(int *)this + 0x2c))();
  param_1->field_0002 = uVar2;
  /* ST_CALLSITE[005F029D]: CALL dword ptr [EDX + 0xc]; [STIndirectCallsiteApplier] exact slot 0xC; mode=structural-presentation; signature=__thiscall;/undefined4;pointer:/void */
  uVar1 = STStructuralVirtualCall<undefined4>(this, 0xC);
  param_1->field_0x6 = uVar1;
  param_1->field_0007 = STField<undefined4>(this,0x18);
  return;
...
void __fastcall st::fn_005F0310(RecoveredRecordView_005F0310_7C41AA23 *param_1)
...

{
  ...
  iVar3_mg0 = st::fn_006E62D0
                        (g_playSystem_00802A38,reinterpret_cast<RecoveredRecordView_005EFAE0_855D930D *>(param_1),
  ...
  if (iVar3_mg0 != -4) {
    ...
    if (((iVar3 == 0x1b) || (iVar3 == 7)) || (iVar3 == 0x13)) {
      ...
      iVar3 = st::fn_00404EC1(STField<short>(this,0x242),STField<short>(this,0x244),
                                 STField<short>(this,0x246),0,static_cast<RecoveredRecordView_00495FF0_A2A90B23 *>(this));
      if (iVar3 == 0) {
...
void __fastcall st::fn_005F0620(RecoveredRecordView_005F0620_3EDDC37E *param_1)
...
void __fastcall st::fn_005F06E0(RecoveredRecordView_005F0620_3EDDC37E *param_1)
      ...
      if ((((-1 < sVar1) && (sVar1 < g_worldGrid.sizeX)) && (-1 < sVar2)) &&
         (((sVar2 < g_worldGrid.sizeY && (-1 < sVar3)) &&
          ((sVar3 < g_worldGrid.sizeZ &&
           (this = reinterpret_cast<STFishC *>(STGridAt3D(g_worldGrid, sVar1, sVar2, sVar3).objects[0]), this != nullptr)))))) {
        /* ST_CALLSITE[005F0883]: CALL dword ptr [EDX + 0x2c]; [STIndirectCallsiteApplier] exact slot 0x2C; mode=structural-presentation; signature=__thiscall;/dword;pointer:/STFishC */
        dVar4 = this->vfunc_2C();
        if (dVar4 == 99) {
          ...
          if (iVar5 != 0) {
            ...
            iVar5 = st::fn_00403E9A(param_1,reinterpret_cast<RecoveredRecordView_005EFAE0_855D930D *>(this));
            if (iVar5 != 0) {

              iVar4 = st::fn_00405083(reinterpret_cast<int *>(this));
              if (iVar4 != 0) {
...
undefined4 __thiscall st::fn_005F09B0(void *this,RecoveredRecordView_005EFAE0_855D930D *param_1)
      ...
      if ((((-1 < sVar1) && (sVar1 < g_worldGrid.sizeX)) && (-1 < sVar2)) &&
        ...
        if (this != nullptr) {
          ...
          if (uVar5 == 99) {
            ...
            uVar5 = 0;
            if (iVar6 != 0) {
              st::fn_00403BA2(reinterpret_cast<int *>(this));
              bVar3 = st::fn_00402743(this,reinterpret_cast<STBoatC *>(param_1));
              uVar5 = (uint)bVar3;
            }
          }
        }
...
int __fastcall st::fn_005F0BA0(RecoveredRecordView_005F0BA0_EE8C5420 *param_1)

{
  ...
  if (g_playSystem_00802A38->field_00E4 % 5 == 0) {
    ...
    if (param_1->field_02B5 == 1) {
      ...
      st::fn_0040116D
                (reinterpret_cast<STT3DSprC *>(this),PTR_00806724->entries[param_1->field_02D2],
                 (int)PTR_00806724->field_002C);
      iVar2 = param_1->field_02D2 + -1;
      param_1->field_02D2 = iVar2;
      if (iVar2 == (int)PTR_00806724->entryCount / 2) {
        bVar1 = st::fn_004056CD(reinterpret_cast<RecoveredRecord_004AD610_D99117A2 *>(this));
        if (bVar1 != 0) {
          st::fn_00404903(reinterpret_cast<RecoveredRecord_005EF5F0_8C51B92F *>(param_1));
      ...
      if ((int)param_1->field_02D2 < 0) {
        ...
        st::fn_0040116D(reinterpret_cast<STT3DSprC *>(this),0,(int)PTR_00806724->field_002C);
        return 1;
      }
    }
    else {
      ...
      if (PTR_00806724->entryCount <= iVar3) {
        ...
        st::fn_00403D0F(reinterpret_cast<STT3DSprC *>(this));
        return 1;
      }
...

{
  ...
  if ((param_2 != nullptr) && (this = (void *)(uint)DAT_0080874d, st::machine_word_boundary_cast<uint>((void *)param_2[9]) == st::machine_word_boundary_cast<uint>(this))) {
    ...
    else if ((st::machine_word_boundary_cast<uint>(this) == st::machine_word_boundary_cast<uint>((void *)0x3e8)) || (st::machine_word_boundary_cast<uint>(this) == st::machine_word_boundary_cast<uint>((void *)0x3e9))) {
...

{
  ...
  this = st::pointer_boundary_cast<STManBasisC *>(st::fn_006B04D0(0x48));
  if (this != nullptr) {
...
int __fastcall st::fn_005F1380(RecoveredRecord_005F1380_AD368A85 *param_1)
...

{
  ...
  if (iVar1 != 0) {
    ...
    if (0 < (int)uVar2) {
      ...
      do {
        if ((((bVar5) &&
             (psVar3 = (short *)(STField<int>(iVar1,0x8) * uVar4 + STField<int>(iVar1,0x1C)),
...

{
  ...
  if (-1 < (int)param_7) {
    ...
    if (iVar3 != 0) {
      ...
      STField<uint>(iVar3,0x18) = local_8;
      st::fn_006E98E0
                (g_sT3DSMAPContext_00807598,local_8,0,*(int *)puVar2,STField<int>(puVar2,0x21),1);
      st::fn_006EA270(g_sT3DSMAPContext_00807598,local_8,0,STField<uint>(iVar3,0xE));
      ...
      STField<undefined1>(iVar3,0x6) = 1;
      g_currentExceptionFrame = local_5c.previous;
      return puVar2;
    }
  }
...

{
  ...
  pSVar1 = st::pointer_boundary_cast<STBHEShellC *>(st::fn_006B04D0(0x175));
  if (pSVar1 != nullptr) {
...
int st::fn_005F3530(RecoveredReceiver_004248D0 *param_1,undefined4 param_2,int *param_3,
                RecoveredRecordView_005F3530_2D2C1A49 *param_4)
...
int st::fn_005F3B30(float param_1,float param_2,float param_3,float param_4,float *param_5)
...

{
  ...
  if (local_c != 0) {
    uVar2 = (uint)param_2;
    local_14 = reinterpret_cast<AnonShape_005F4A30_D28DC55A *>(st::fn_00709AF0
                         (PTR_00806764,CASE_1D,local_10[uVar2],0xffffffff,0,1,0,nullptr));
    puVar1 = (uint *)(iVar3 + 0x1f);
    st::fn_006E8660
              (g_sT3DSMAPContext_00807598,reinterpret_cast<int *>(puVar1),1,0,local_14->field_0009,
    ...
    st::fn_006EA270(g_sT3DSMAPContext_00807598,*puVar1,0,STField<uint>(iVar3,0xE));
    st::fn_006EA960
...

{
  ...
  pSVar1 = st::pointer_boundary_cast<STColl3C *>(st::fn_006B04D0(0x2f3));
  if (pSVar1 != nullptr) {
...

{
  ...
  st::fn_004045D9
            (reinterpret_cast<STT3DSprC *>(this),(float)*(int *)&param_1->field_0x2c1 * _DAT_007904f8 * _DAT_007904f0,
  ...
  st::fn_00401AB9(reinterpret_cast<STColl3C *>(param_1));
...
/* [STReturnSemanticsApplier] machine_word_predicate.
   ...
   and at least two resolved callers consume the machine word; machine CFG audit: used=7, ignored=0,
   unknown=0 */

int __thiscall st::fn_005F89F0(void *this,int param_1)
...

{
  ...
  case 0:
    ...
    if (STField<char>(param_1,0x29d) == '\x01') {
      if (STField<char>(param_1,699) == '\x01') {
        ...
        st::fn_004018C5(reinterpret_cast<STFishC *>(param_1),&local_a,&local_8,&local_6);
        ...
        iVar3 = st::fn_004057B3(reinterpret_cast<RecoveredRecordView_005FA180_30990B79 *>(param_1));
        if (PTR_00806724->entryCount <= iVar3) {
  ...
  case 1:
    if (STField<int>(param_1,0x2ea) != 0) {
      ...
      st::fn_00404AE3(reinterpret_cast<STColl3C *>(param_1));
...
{
  RecoveredRecord_004DD740_33371182 *this_00;
  short sVar1;
  int iVar3;
  int iVar2;
  short local_c [2];
  ...
  st::fn_004018C5(static_cast<STFishC *>(this),reinterpret_cast<short *>(&local_8),(short *)((int)&local_8 + 2),local_c);
  sVar1 = local_c[0] + -1;
  if (((((-1 < (short)local_8) && ((short)local_8 < g_worldGrid.sizeX)) && (-1 < STPiece<2,2>(local_8))) &&
      ((((STPiece<2,2>(local_8) < g_worldGrid.sizeY && (-1 < sVar1)) &&
        ((sVar1 < g_worldGrid.sizeZ &&
         ((this_00 = reinterpret_cast<RecoveredRecord_004DD740_33371182 *>(STGridAt3D(g_worldGrid, local_8, STPiece<2,2>(local_8), sVar1).objects[0]),
          this_00 != nullptr &&
          (*(int *)&this_00->field_0x20 == 1000)))))) &&
       /* ST_CALLSITE[005F90FF]: CALL dword ptr [EDX + 0x2c]; [STIndirectCallsiteApplier] exact slot 0x2C; mode=structural-presentation; signature=__thiscall;/undefined4;pointer:/void */
       (iVar3 = STStructuralVirtualCall<undefined4>(this_00, 0x2C), iVar3 == 0x6e)))) &&
     (((*(int *)&this_00->field_0x18 == STField<int>(this,0x255) &&

       (iVar3 = st::fn_00401C7B(this_00), iVar3 == 0)) &&

      (iVar3 = st::fn_004029E1(this_00,STField<undefined4>(this,0x18)), iVar3 != 0)))) {

    st::fn_004043EF(this_00,STField<int>(this,0x18));
    st::fn_004031E3(this_00,&local_8,(short *)((int)&local_8 + 2),local_c);

    iVar2 = st::fn_004052CC(reinterpret_cast<STT3DSprC *>(&this_00->field_0x1d5));
    *param_2 = iVar2;
...

{
  ...
  /* ST_CALLSITE[005F91F8]: CALL 0x004018c5; direct=004018C5 STFishC::sub_004162B0 */
  st::fn_004018C5(static_cast<STFishC *>(this),&local_6,&local_8,local_c);
  ...
  if (((((-1 < local_6) && (local_6 < g_worldGrid.sizeX)) && (-1 < local_8)) &&
    ...
    if ((this_00 != nullptr) && (this_00->value_20 == 1000)) {
      /* ST_CALLSITE[005F9283]: CALL dword ptr [EDX + 0x2c] */
...
int __thiscall st::fn_005F9310(void *this,int param_1)

{
  ...
  if (STField<char>(this,0x29e) != '\0') {
    ...
    st::fn_00404AE3(static_cast<STColl3C *>(this));
  }
  return (uint)STField<byte>(this,0x29e);
}
...
undefined4 __fastcall st::fn_005F95B0(RecoveredRecordView_005F95B0_EAB4932B *param_1)

{
  ...
  *(int *)(param_1->field_02E6 + 0x54) = (int)lVar10;
  st::fn_004031E3(param_1,reinterpret_cast<uint *>(&local_8),&local_6,reinterpret_cast<short *>(&local_c));
  ...
  *(int *)(param_1->field_02E6 + 0x3c) = (int)sVar5;
  ...
  iVar9_mg5 = st::fn_00405B3C(&local_64,st::machine_word_boundary_cast<undefined4>(&local_44),local_18,(int)local_14,local_10);
  if (iVar9_mg5 != 0) {
...
void __fastcall st::fn_005F9E40(RecoveredRecordView_005F9E40_46F0E2B5 *param_1)

{
  ...
  if (pAVar1 != nullptr) {
    ...
    if (-1 < (int)*(uint *)&pAVar1->field_0x4) {
      st::fn_006EA270
                (static_cast<ST3DSMAPContext *>(param_1->field_0211),*(uint *)&pAVar1->field_0x4,0,*(uint *)(pAVar1 + 1));
      pAVar1 = param_1->field_02E6;
      st::fn_006EA960
...
void __fastcall st::fn_005F9F70(STColl3C *param_1)

{
  ...
  if (param_1->field_02E6 != nullptr) {
    ...
    if (-1 < (int)*(uint *)(param_1->field_02E6 + 2)) {
      st::fn_006E8BA0(param_1->field_0211,*(uint *)(param_1->field_02E6 + 2));
      puVar2 = param_1->field_02E6;
      puVar2[2] = 0xffff;
      puVar2[3] = 0xffff;
    }
...
void __fastcall st::fn_005F9FF0(STColl3C *param_1)
...

{
  ...
  st::fn_00401064(reinterpret_cast<STT3DSprC *>(this),'\x0e',uVar1);
  /* ST_CALLSITE[005FA108]: CALL 0x00401064; direct=00401064 STT3DSprC::SetCurFase */
  st::fn_00401064(reinterpret_cast<STT3DSprC *>(this),'\f',uVar1);
  /* ST_CALLSITE[005FA138]: CALL 0x004052fe; direct=004052FE STT3DSprC::SetCurShad */
  st::fn_004052FE(reinterpret_cast<STT3DSprC *>(this),'\x0e',(0x18 - (int)param_1->field_006C / 0xf) % 0x18);
...
int __fastcall st::fn_005FA180(RecoveredRecordView_005FA180_30990B79 *param_1)

{
  ...
  if (param_1->field_02BB == '\x02') {
    ...
    st::fn_0040116D
              (reinterpret_cast<STT3DSprC *>(puVar1),PTR_00806724->entries[iVar3],(int)PTR_00806724->field_002C);
    iVar3 = param_1->field_02D1 + -1;
    param_1->field_02D1 = iVar3;
    if (iVar3 == (int)PTR_00806724->entryCount / 2) {
      bVar2 = st::fn_004056CD(reinterpret_cast<RecoveredRecord_004AD610_D99117A2 *>(puVar1));
      if (bVar2 != 0) {
        st::fn_00401AB9(reinterpret_cast<STColl3C *>(param_1));
    ...
    if (iVar3 < 0) {
      ...
      st::fn_0040116D(reinterpret_cast<STT3DSprC *>(puVar1),0,(int)PTR_00806724->field_002C);
    }
    return iVar3;
  }
  puVar1 = &param_1->field_0x1d5;
  ...
  if (PTR_00806724->entryCount <= iVar6) {
    ...
    st::fn_00404EC1((short)param_1->field_025D,(short)param_1->field_0261,
                       (short)param_1->field_0265,0,reinterpret_cast<RecoveredRecordView_00495FF0_A2A90B23 *>(param_1)
                      );
    /* ST_CALLSITE[005FA2A3]: CALL 0x00403d0f; direct=00403D0F STT3DSprC::sub_004AD430 */
    st::fn_00403D0F(reinterpret_cast<STT3DSprC *>(puVar1));
...
int __thiscall st::fn_005FA7F0(void *this,undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  iVar1 = st::fn_00404318
                    (static_cast<RecoveredReceiver_004167A0 *>(this),(short)param_1,(short)param_2,(short)param_3);
  if (iVar1 == 0) {
...

{
  ...
  if (STField<int>(this,0x2e6) != 0) {
    ...
    if (_param_1 == 0) {
      ...
      st::fn_004031E3(this,reinterpret_cast<uint *>(&_param_1),&param_4,&param_5);
    }
    if (param_2 == 1) {
...

{
  ...
  if (STField<int>(this,0x2e6) == 0) {
    ...
    st::fn_00401168(static_cast<STColl3C *>(this));
  }
  else {
    st::fn_00403F8A(static_cast<STColl3C *>(this));
  }
  if (STField<int>(this,0x2e6) != 0) {
    memset((void *)(STField<int>(this,0x2e6) + 8), 0, 0x2a); /* compiler bulk-zero initialization */
    st::fn_004031E3(this,reinterpret_cast<uint *>(&local_6),&local_8,&local_a);
    if (param_3 == 1) {
...

{
  ...
  /* ST_CALLSITE[005FAF8D]: CALL dword ptr [EAX + 0x10]; [STIndirectCallsiteApplier] exact slot 0x10; mode=structural-presentation; signature=__thiscall;/undefined4;pointer:/void;/undefined4;/undefined4;/undefined4;/undefined4;/undefined4;/undefined4;/undefined4 */
  /* ST_PSEUDO[raw_indirect_call]: expected typed vtable or function-table callback call with the machine-proven calling convention */
...
void __fastcall st::fn_005FB030(RecoveredRecordView_005FB030_E5A27901 *param_1)
...
void __fastcall st::fn_005FB100(RecoveredRecordView_005FB100_73CA5C15 *param_1)

{
  ...
  uVar2 = st::fn_004052CC(reinterpret_cast<STT3DSprC *>(&param_1->field_0x1d5));
...
undefined4 __fastcall st::fn_005FB600(RecoveredRecord_005FB600_0B8C3724 *param_1)

{
  ...
  if (param_1->field_02A0 < 3) {
    ...
    iVar2 = st::fn_00403A49(param_1,1);
    if (iVar2 == 0) {
      return 0;
    }
    uVar1 = 1;
...

{
  ...
  this = STPointerBoundaryCast<STContainerC *>(st::fn_006B04D0(0x47b));
  if (this != nullptr) {
    /* ST_CALLSITE[005FC3B3]: CALL 0x00401807; direct=00401807 STSprGameObjC::STSprGameObjC */
    st::fn_00401807(reinterpret_cast<STSprGameObjC *>(this));
...
undefined4 __fastcall st::fn_005FC4A0(RecoveredRecordView_005FC4A0_75D5CD83 *param_1)

{
  ...
  if ((((((sVar8 < 0) || (g_worldGrid.sizeX <= sVar8)) ||
     ...
     (iVar6 = st::fn_00401325
                        (sVar8,sVar2,sVar3,0,reinterpret_cast<RecoveredRecord_DumpClassC_00495EC0 *>(param_1)),
     iVar6 == 0)) {
  ...
  if (bVar4) {
    if (param_1->field_0342 == 1) {
      ...
      iVar6 = st::fn_00403FC6(param_1,(short)(param_1->field_0242 * 0xc9 + 100),
...
void __fastcall st::fn_005FCEB0(RecoveredRecordView_005FCEB0_0C5FE3FD *param_1)
  ...
  if (g_aiBossClass_008117BC != nullptr) {
    ...
    iVar1_mg1 = st::fn_006E62D0
                          (g_playSystem_00802A38,
                           (RecoveredRecordView_005EFAE0_855D930D *)param_1->field_0358,&local_8);
    if (iVar1_mg1 != -4) {
...

{
  ...
  *param_7 = 0;
  if ((param_3 == 0xe) || (param_3 == 0xc)) {
    if (param_1 == 1) {
      pcVar4 = st::mutable_c_string("cont1");
    }
    else if (param_1 == 2) {
      pcVar4 = st::mutable_c_string("cont2");
    }
    else {
      if (param_1 != 3) {
        return;
...

{
  ...
  /* ST_CALLSITE[005FD13D]: CALL dword ptr [EDX + 0x8] */
  g_playSystem_00802A38->vfunc_8(0x157,nullptr,nullptr,(short)local_15c,0);
  return;
}
...

{
  ...
  /* ST_CALLSITE[005FD2DD]: CALL dword ptr [EDX + 0x8] */
  g_playSystem_00802A38->vfunc_8(0x157,nullptr,&local_8,(short)local_160,0);
  if (local_8 == 0) {
    return 0;
  }
...
int __thiscall st::fn_005FD3A0(void *this,STMessage *message)

{
  ...
  iVar4 = st::fn_00403EBD(static_cast<STGameObjC *>(this),message);
  if (iVar4 == 0xffff) {
    return 0xffff;
  }
  SVar1 = pSVar2->id;
  if (SVar1 < 4) {
    if (SVar1 == MESS_SHARED_0003) {
      st::fn_00405C4F(static_cast<RecoveredRecordView_005FDA60_59035400 *>(this));
      return 0;
    }
    if (SVar1 == MESS_ID_NONE) {

      iVar4 = st::fn_0040367A(static_cast<RecoveredRecordView_00600750_34156DAE *>(this));
      if (iVar4 != 0) {
LAB_005fd4eb:
      ...
      puVar5 = static_cast<uint *>((pSVar2->arg0).ptr);
      if (puVar5[3] != 2) {
        ...
        local_EAX_152 = st::fn_0040227F(static_cast<RecoveredRecordView_005FD850_C5173AC4 *>(this));
        if ((-1 < local_EAX_152) &&

           (iVar4 = st::fn_004026C6(this,reinterpret_cast<uint *>(&local_6),(short *)((int)&message + 2),&local_8),
           iVar4 != 0)) {
          st::fn_00405EB1(static_cast<RecoveredRecordView_005FEA50_4A5A0C2A *>(this));

          st::fn_00403A17(this,(int)local_6,(int)STPiece<2,2>(message),(int)local_8);
          st::fn_00404610(this,(int)local_6,(int)STPiece<2,2>(message),0x45f);
          return 0;
        }
        goto LAB_005fd4eb;
      }
      ...
      if (iVar3 != 0) {
        ...
        if (STField<char>(this,0x232) != '\0') {
          ...
          st::fn_00403E27
                    (static_cast<RecoveredReceiver_005FDB50 *>(this),0,-1);
          return 0;
        }
      }
    }
          ...
          (local_10 = STPointerBoundaryCast<byte *>(st::fn_00403161(this,reinterpret_cast<int *>(&local_c))), local_10 != nullptr)) {
...
int __fastcall st::fn_005FD6A0(RecoveredRecord_005FD6A0_EC193285 *param_1)
...
int __fastcall st::fn_005FD850(RecoveredRecordView_005FD850_C5173AC4 *param_1)

{
  ...
  if (param_1->field_0226 != 0) {
    ...
    puVar1 = reinterpret_cast<byte *>((st::fn_006AAC70(param_1->field_0226 * 0x52)));
  ...
  if (((param_1->field_0233 != 0) && (param_1->field_0232 != '\0')) &&
    ...
    do {
      ...
      pSVar2 = st::pointer_boundary_cast<STT3DSprC *>(st::fn_0072E530(0x40));
      if (pSVar2 == nullptr) {
        pSVar2 = nullptr;
      }
      else {
        /* ST_CALLSITE[005FD8D2]: CALL 0x00401316; direct=00401316 STT3DSprC::STT3DSprC */
        pSVar2 = st::fn_00401316(pSVar2);
      }
      iVar6 = iVar6 + 0x52;
...
void __fastcall st::fn_005FDA60(RecoveredRecordView_005FDA60_59035400 *param_1)
...
int st::fn_005FE280(short *param_1,int param_2,int *param_3,int *param_4,int *param_5)

{
  ...
  iVar3 = st::fn_00402FE5((int *)((int)param_1 + 0x29),param_2,&param_2,reinterpret_cast<int *>(&param_1));
  if (iVar3 == 1) {
...
int __thiscall
st::fn_005FE5D0(void *this,int param_1,undefined2 *param_2,RecoveredRecord_005FE5D0_FE3006E4 *param_3)
        ...
        if (((iVar3 != local_20) || (iVar7 != local_24)) || (iVar6 != local_28)) {
          ...
          if ((iVar4 == 0) &&
             ((((((-1 < sVar8 && (sVar8 < g_worldGrid.sizeX)) && (-1 < sVar9)) &&
              ...
              (iVar3 = st::fn_00404A3E(local_10,local_14,local_18), -1 < iVar3)))) {
            local_c = 0;
          }
        }
        piVar5 = reinterpret_cast<int *>((psVar1 + 0x27));
        iVar3 = local_8 * 6;
        local_8 = local_8 + 1;
...
void __fastcall st::fn_005FEA50(RecoveredRecordView_005FEA50_4A5A0C2A *param_1)
...

{
  ...
  undefined *puStack_c;
  uint local_8;
  puStack_c = (undefined *)&DAT_0079c9a0;
  ...
  if (local_50 < 1) {
    ...
    uStack_a0 = 0x5fec55;
    local_1c = reinterpret_cast<byte *>(auStack_69c);
    local_8 = 0xffffffff;
    local_44 = 0;
...
LAB_005fee45:
              ...
              if ((bVar18) && (iVar8 = this_00->vfunc_F8(), iVar8 != 0)) {
                st::fn_004031E3(this_00,reinterpret_cast<uint *>(local_20),local_30,local_2c);
...
LAB_005fef0e:
        ...
        puVar16 = reinterpret_cast<uint *>(local_1c);
      } while (local_44 < local_50);
    }
    local_1c = reinterpret_cast<byte *>(puVar16);
    ...
    if (iVar13 != 0) {
      ...
      if (STField<int>(this,0x226) < iVar13) {
        st::fn_0040305D(STField<RecoveredRecordView_005FF150_0B034029 *>(this,0x23b),
...
void st::fn_005FF150(RecoveredRecordView_005FF150_0B034029 *param_1,int *param_2,int param_3)
  ...
  do {
    ...
    if (0 < iVar3) {
      ...
      do {
        ...
        iVar7 = iVar7 + iVar4;
        if (st::storage_bit_cast<int>(static_cast<uint32_t>((uVar6 >> 0x10) % local_8)) <= iVar7) goto LAB_005ff2fa;
        iVar2 = iVar2 + 1;
        piVar5 = piVar5 + 1;
      } while (iVar2 < iVar3);
      iVar2 = 0;
...
int __thiscall st::fn_005FF3A0(void *this,uint *param_1,short *param_2,short *param_3)

{
  ...
  if (this_00 != nullptr) {
    ...
    if (iVar1 != 0) {
      st::fn_004031E3(this_00,param_1,param_2,param_3);
...
st::fn_005FF430(void *this,Global_sub_005FF430_param_1Enum param_1,int param_2,uint param_3,
...

{
  ...
  if (param_2 != 30000) {
    ...
    st::fn_004031E3(this_00,&param_3,reinterpret_cast<short *>(&param_4),(short *)((int)&param_5 + 2));
...
switchD_005ff553_default:
    if ((short)param_5 < 0) {
      ...
      iVar4 = st::storage_bit_cast<int>(static_cast<uint32_t>((short)param_5 / 200));
    }
    sVar2 = (short)param_3;
    switch(iVar4) {
    case 0:
...

{
  ...
  RecoveredRecord_005FE5D0_FE3006E4 local_14 [2];
  int local_8;

  iVar4 = STField<int>(this,0x226);
  local_8 = iVar4;

  iVar2 = st::fn_004026C6(this,&local_1c,(short *)((int)&local_1c + 2),&sStack_18);
  iVar5 = param_2;
  if (iVar2 == 0) {
  ...
  while( true ) {
    ...
    iVar4 = st::fn_00403DCD(this,param_1,param_2,STReplaceLowWord(st::storage_bit_cast<uint32_t>(static_cast<uint32_t>(local_1c)), (uint16_t)((short)local_1c)),
                               CONCAT22(sStack_18,STPiece<2,2>(local_1c)),CONCAT22(uStack_16,sStack_18),
                               reinterpret_cast<short *>(local_14),reinterpret_cast<short *>(&local_14[0].field_0x2),
                               reinterpret_cast<undefined2 *>(&local_14[0].field_0004));
    if (((iVar4 != 0) &&

        (iVar4 = st::fn_00402978((short *)(STField<int>(this,0x233) + param_1 * 0x52),
                                    (short)local_1c,(int)STPiece<2,2>(local_1c),sStack_18,
                                    (short)STPiece<0,2>(local_14[0]),STPiece<2,2>(local_14[0]),
                                    local_14[0].field_0004), -1 < iVar4)) &&

       (iVar3 = st::fn_004051FF(this,param_1,reinterpret_cast<undefined2 *>(&local_1c),local_14), iVar3 != 0))
    break;
