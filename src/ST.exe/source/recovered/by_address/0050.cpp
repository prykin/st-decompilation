...

{
  ...
  if (cVar3 != local_5) {
    if (DAT_0080874e != '\x03') {
      ...
      st::fn_0040556F(static_cast<CPanelTy *>(this));
      return;
    }
    /* ST_CALLSITE[00501D5E]: CALL 0x0040296e; direct=0040296E CPanelTy::SetControlBoatSI */
    st::fn_0040296E(static_cast<CPanelTy *>(this));
    return;
  }
  iVar7 = 3;
  bVar10 = true;
    ...
    if (*(int *)param_1 != *(int *)param_2) {
      ...
      do {
        if (*pcVar4 != '\0') {
          ...
          st::fn_0040313E(static_cast<CPanelTy *>(this),1,bVar1);
        }
        bVar1 = bVar1 + 1;
        pcVar4 = pcVar4 + 1;
      } while (bVar1 < 6);
      /* ST_CALLSITE[00501E34]: CALL 0x00404ba1; direct=00404BA1 CPanelTy::sub_004F1610 */
      st::fn_00404BA1(static_cast<CPanelTy *>(this),'\x01');
  ...
  if ((!bVar10) || (param_1->field_0007 != param_2->field_0007)) {
    ...
    st::fn_00404F89(static_cast<CPanelTy *>(this),'\x01',(int)param_1,(int)param_2);
  }
