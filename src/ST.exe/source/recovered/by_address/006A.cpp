...
{
  st::fn_0040113B((RecoveredRecordView_006A00B0_C4D66491 *)param_1);
  st::fn_0040173F((int *)(param_1 + 0x1c03));
  /* ST_CALLSITE[006A0089]: CALL 0x00403ca1; direct=00403CA1 thunk_FUN_00694890 */
  st::fn_00403CA1((RecoveredRecord_00694890_E22E6A2C *)(param_1 + 0x1bef));
  st::fn_00403783();
  return;
}
...
void __fastcall st::fn_006A00B0(RecoveredRecordView_006A00B0_C4D66491 *param_1)
...

{
  ...
  *(void **)this = pvVar2;
  puVar5 = reinterpret_cast<byte *>((&local_9c));
...

{
  ...
  *(int *)(*param_1 + 0x14) = param_1[1];
  ...
  st::external_00000080(reinterpret_cast<LPSTR>(local_108),st::mutable_c_string("%s%08u"),&DAT_007c8400,*(undefined4 *)(*param_1 + 0x14));
  /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
  st::fn_006F13F0((cMf32 *)param_1[6],0xc,reinterpret_cast<char *>(local_108),(byte *)*param_1,
...
#line 4 "decomp/ST.exe/functions/006A0C90/decomp.c"
/* [STReturnSemanticsApplier] ignored_eax_void.
  ...
  do {
    ...
    if ((((iVar3 < 0) || (*param_1 <= iVar3)) || (iVar4 < 0)) ||
      ...
      if (iVar1 != 0) {
        ...
        iVar3 = st::fn_0040414C(param_1,iVar3,iVar4,param_4,&local_1c);

        iVar3 = st::fn_00404D5E(param_6,param_4,reinterpret_cast<ushort *>(&local_1c),(short)iVar3,param_5);
        if (iVar3 != 0) {
          if (param_5 == 0xff) {
            uVar2 = (uint)local_1c.field_0004;
          }
          else {
            /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
            uVar2 = CONCAT22(local_1c.field_0004,STPiece<2,2>(local_1c));
            if (param_5 != 1) {
              uVar2 = STReplaceLowWord(static_cast<uint32_t>(STPiece<0,4>(local_1c)), (uint16_t)(STPiece<0,2>(local_1c)));
            }
          }
...

{
  ...
  return STReplaceLowWord(st::storage_bit_cast<uint32_t>(static_cast<uint32_t>(iVar1)), (uint16_t)(0xffff));
}
...

{
  ...
  if ((((-1 < param_2) && (param_2 < *param_1)) && (-1 < param_3)) &&
    ...
    iVar3 = st::fn_0040414C(param_1,param_2,param_3,param_4,&local_c);
    if (param_5 == 0xff) {
...
int __cdecl
st::fn_006A1370(int *param_1,int param_2,int param_3,int param_4,
...

{
  ...
  iVar3 = st::fn_0040414C(param_1,param_2,param_3,param_4,
  ...
  if (param_5 == 0xff) {
    ...
    if ((STPiece<4,4>(local_14) & 0x1000) != 0) {
      local_c = STReplaceLowWord(st::storage_bit_cast<uint32_t>(static_cast<uint32_t>(local_c)), (uint16_t)(1));
    ...
    do {
      ...
      do {
        ...
        if ((((-1 < iVar2) && (iVar2 < *param_1)) && (-1 < iVar7)) &&
          ...
          iVar3 = st::fn_0040414C(param_1,iVar2,iVar7,iVar1,&local_14);

          local_EAX_219 =
               st::fn_00404D5E(reinterpret_cast<ushort *>(&local_14),iVar1,param_6,(short)iVar3,param_5);
          if (local_EAX_219 != 0) {
            if (param_5 == 0xff) {
            ...
            if (param_5 == 0xff) {
              ...
              uVar5 = STReplaceLowWord(static_cast<uint32_t>(STPiece<0,4>(local_14)), (uint16_t)(STPiece<0,2>(local_14)));
            }
...

{
  ...
  st::fn_0040414C(param_1,param_2,param_3,param_4,&local_14);
    ...
    if (CONCAT31(extraout_var,bVar4) == 0) {
      ...
      if (param_5 == 0xff) {
        ...
        if (param_5 == 1) {
          ...
          local_c = STReplaceLowWord(st::storage_bit_cast<uint32_t>(static_cast<uint32_t>(local_c)), (uint16_t)(uVar2 ^ ((byte)local_c ^ bVar8) & 0xf));

          uVar7 = st::fn_0072E6C0();
          bVar8 = ((char)((int)uVar7 % (int)*(short *)(&DAT_007df9c8 + (short)uVar5 * 2)) + '\x01')
                  * '\x10' ^ (byte)local_c;
          local_c = STReplaceLowWord(st::storage_bit_cast<uint32_t>(static_cast<uint32_t>(local_c)), (uint16_t)((ushort)local_c ^ bVar8 & 0xf0));
        }
      }
      st::fn_00404CF5(param_1,param_2,param_3,param_4,param_5,reinterpret_cast<ushort *>(&local_c),param_7,param_8);
    }
  }
  return 1;
}
...

{
  ...
  if (((((-1 < (int)param_2) && ((int)param_2 < *param_1)) && (-1 < param_3)) &&
    ...
    if ((param_5 == 0xff) && (iVar4 == 0)) {
      ...
      iVar4 = st::fn_00404F93(param_1,uVar2,param_3,0,0,reinterpret_cast<ushort *>(&local_c),param_6,param_7);
      if (iVar4 == 0) {
        return 0;
      }

      iVar4 = st::fn_0040125D(param_1,uVar2,param_3,0,0,reinterpret_cast<ushort *>(&local_c),param_6,param_7);
      if (iVar4 == 0) {
        return 0;
      }

      iVar4 = st::fn_00404F93(param_1,uVar2,param_3,0,1,reinterpret_cast<ushort *>(&local_c),param_6,param_7);
      if (iVar4 == 0) {
        return 0;
      }
      param_5 = 1;
      ...
      iVar5 = st::fn_00404F93(param_1,uVar2,param_3,iVar4,param_5,reinterpret_cast<ushort *>(&local_c),param_6,
                                 param_7);
      if (iVar5 == 0) {
        return 0;
      }
    ...
    iVar4 = st::fn_0040125D(param_1,uVar2,param_3,iVar4,param_5,reinterpret_cast<ushort *>(&local_c),param_6,
                               param_7);
    if (iVar4 == 0) {
      return 0;
    }
...

{
  ...
  if ((((-1 < param_2) && (param_2 < *param_1)) && (-1 < param_3)) &&
    ...
    if (iVar1 != 0) {
      ...
      local_EAX_102 = st::fn_0040414C(param_1,param_2,param_3,param_4,&local_18);
      iVar1 = param_5;
    ...
    do {
      ...
      local_8 = param_4;
      if (st::storage_bit_cast<int>(static_cast<uint32_t>(param_4 - ((param_6[2] & 0xf00) >> 8))) < param_4) {
        do {
          if (((-1 < (int)uVar6) && ((int)uVar6 < *param_1)) &&
             ((-1 < iVar1 && (((iVar1 < param_1[1] && (-1 < local_8)) && (local_8 < 6)))))) {

            iVar2 = st::fn_0040414C(param_1,uVar6,iVar1,local_8,&local_18);
            local_c = (short)iVar2;
            iVar5 = param_5;
            if (local_c != 0) {
              iVar5 = 0xff;
            ...
            if (((iVar4 != 0) &&
                ...
                (iVar3 = st::fn_00404D5E(param_6,param_4,reinterpret_cast<ushort *>(&local_18),local_c,iVar5),
                iVar3 == 0)) &&
          ...
          local_8 = local_8 + -1;
        } while (st::storage_bit_cast<int>(static_cast<uint32_t>(param_4 - ((param_6[2] & 0xf00) >> 8))) < local_8);
      }
      local_10 = local_10 + 2;
...
/* [STReturnSemanticsApplier] machine_word_predicate.
   Evidence: every reachable RET is immediately dominated by an exact full-EAX definition of 0 or 1,
   and at least two resolved callers consume the machine word; machine CFG audit: used=17,
   ignored=0, unknown=0 */

int __cdecl st::fn_006A20E0(int *param_1,int param_2,int param_3,int param_4,int param_5)
...
undefined4 __cdecl
st::fn_006A21F0(int *param_1,uint param_2,int param_3,int param_4,
...

{
  ...
  if (((((-1 < (int)param_2) && ((int)param_2 < *param_1)) && (-1 < param_3)) &&
    ...
    if ((((param_5->field_0005 & 0x20) == 0) &&
      ...
      iVar1 = st::fn_00402AB3(param_1,param_2,param_3,param_4,reinterpret_cast<short *>(param_5),param_6,param_7);
      if (iVar1 == 0) {
        return 0;
      }
      st::fn_00404CF5(param_1,param_2,param_3,param_4,local_8,reinterpret_cast<ushort *>(param_5),param_6,param_7);
    }
    else {

      iVar1 = st::fn_00404C14(param_1,param_2,param_3,param_4,local_8,reinterpret_cast<ushort *>(param_5),param_6,
                                 param_7);
      if (iVar1 == 0) {
        return 0;
      }
      ...
      iVar1 = st::fn_0040125D(param_1,param_2,param_3,param_4,local_8,reinterpret_cast<ushort *>(param_5),param_6,
                                 param_7);
      if (iVar1 == 0) {
        return 0;
      }
...

{
  ...
  iVar3 = param_4;
  if (st::storage_bit_cast<int>(static_cast<uint32_t>(param_4 - (((ushort)param_5[2] & 0xf00) >> 8))) < param_4) {
    do {
      ...
      if ((((iVar2 != 0) && (-1 < (int)param_2)) && ((int)param_2 < *param_1)) &&
        ...
        iVar1 = st::fn_0040414C(param_1,param_2,param_3,iVar3,&local_10);
        if ((short)iVar1 != 0) {
          local_8 = 0xff;
        }
      ...
      iVar3 = iVar3 + -1;
    } while (st::storage_bit_cast<int>(static_cast<uint32_t>(param_4 - (((ushort)param_5[2] & 0xf00) >> 8))) < iVar3);
  }
  return 1;
}
...
st::fn_006A2700(int *param_1,uint param_2,int param_3,int param_4,uint param_5,int param_6,
            RecoveredRecord_006A2700_663AFE5D *param_7,undefined *param_8,undefined4 param_9)

{
  if ((param_7->field_0005 & 0x40) == 0) {

    st::fn_00404282(param_1,param_5,param_6,param_4,reinterpret_cast<RecoveredRecord_006A21F0_E7E9FC50 *>(param_7),
                       param_8,param_9);
    return;
  }

  st::fn_00403067(param_1,param_2,param_3,param_5,param_6,param_4,reinterpret_cast<ushort *>(param_7),param_8,
                     param_9);
  return;
}
...
{
  ulonglong local_c;
  st::fn_0040414C(param_1,param_2,param_3,param_4,reinterpret_cast<RecoveredRecord_006A1370_30F34641 *>(&local_c));
...

{
  ...
  st::external_00000080(reinterpret_cast<LPSTR>(&DAT_00854188),st::mutable_c_string("%s%03u"),"MAPTXTR",uVar1 & 0x7fff);
...

{
  ...
  st::external_00000080(reinterpret_cast<LPSTR>(&DAT_00854084),st::mutable_c_string("%s%03u"),"MAPTXTR",param_1 & 0x7fff);
...

{
  ...
  if (param_1 == 1) {
    ...
    if (param_1 == 0) {
      ...
      return (uint)STReplaceLowByte16(st::storage_bit_cast<uint32_t>(static_cast<uint32_t>(uVar1)), (uint8_t)((undefined1)param_5));
    }
    if (param_1 == 2) {
      /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
    ...
    do {
      ...
      if (0 < param_2[1]) {
        do {
          ...
          iVar1 = st::fn_0040414C(param_2,iVar2,iVar3,0,&local_c);
          ...
          st::fn_00404CF5(param_2,iVar2,iVar3,(short)iVar1,0xff,reinterpret_cast<ushort *>(&local_c),
                             nullptr,0);
          iVar3 = iVar3 + 1;
...

{
  ...
  if ((((((-1 < (int)param_2) && ((int)param_2 < *param_1)) && (-1 < param_3)) &&
    ...
    /* ST_CALLSITE[006A3556]: CALL 0x00405506; direct=00405506 thunk_FUN_006a3390; [STCallResultViewApplier] readability_validated; exact direct-call result=pointer:/ushort; signature=__cdecl;pointer:/ushort;/int;/int;/int;/int */
    puVar1 = st::pointer_boundary_cast<ushort *>(st::fn_00405506(param_2,param_3,param_4,param_5));
    st::fn_00404480(param_7,puVar1);

    iVar2 = st::fn_0040414C(param_1,param_4,param_5,param_6,&local_c);

    iVar2 = st::fn_00404D5E(reinterpret_cast<ushort *>(&local_c),(short)iVar2,param_7,param_6,0xff);
    if (iVar2 == 0) {
    ...
    iVar2 = st::fn_0040414C(param_1,param_2,param_3,param_6,&local_c);
...

{
  ...
  if ((((-1 < param_2) && (param_2 < *param_1)) && (-1 < param_3)) &&
    ...
    if (iVar1 != 0) {
      ...
      st::fn_0040414C(param_1,param_2,param_3,param_4,&local_c);
      st::fn_00403729(param_1,param_2,param_3,param_4,0xff,param_5,param_6);

      st::fn_00404066(param_1,param_2,param_3,param_4,reinterpret_cast<ushort *>(&local_c),param_5,param_6);
    }
  }
  return 1;
}
...

{
  ...
  do {
    ...
    if ((((-1 < iVar3) && (iVar3 < *param_1)) && (-1 < iVar4)) &&
      ...
      iVar1 = st::fn_0040414C(param_1,iVar3,iVar4,param_4,&local_10);

      local_EAX_119 = st::fn_00404D5E(reinterpret_cast<ushort *>(&local_10),(short)iVar1,param_5,param_4,0xff);
      if (local_EAX_119 != 0) {
...

{
  ...
  puVar2 = STPointerBoundaryCast<ushort *>(st::fn_00401B54(uVar1));

  iVar3 = st::fn_0040414C(param_1,param_2,param_3,param_4,
                             reinterpret_cast<RecoveredRecord_006A1370_30F34641 *>(&local_c));

  iVar3 = st::fn_00404D5E(reinterpret_cast<ushort *>(&local_c),(short)iVar3,param_5,param_4,0xff);
...

{
  ...
  do {
    ...
    if ((((-1 < iVar2) && (iVar2 < *param_1)) && (-1 < iVar3)) &&
      ...
      iVar2 = st::fn_0040414C(param_1,iVar2,iVar3,param_4,
                                 reinterpret_cast<RecoveredRecord_006A1370_30F34641 *>(&local_10));

      iVar2 = st::fn_00404D5E(reinterpret_cast<ushort *>(&local_10),(short)iVar2,param_5,param_4,0xff);
      if (iVar2 != 0) {
        bVar1 = (byte)iVar4 & 0x1f;
        local_8 = local_8 | ((&DAT_007dfaf0)[STPiece<4,4>(local_10) & 0xf] << 0x10 |
                            st::storage_bit_cast<uint>(static_cast<uint32_t>((&DAT_007dfaf0)[STPiece<4,4>(local_10) & 0xf])) >> 0x10) &
...

{
  ...
  lp = reinterpret_cast<undefined4 *>((st_stack_frame + 12));
  iVar3 = 0;
  DAT_00854970 = 0;
  lp_00 = reinterpret_cast<undefined4 *>((st_stack_frame + 12));
  if (0 < param_1) {
    do {
...

{
  ...
  while( true ) {
    ...
    iVar4 = st::fn_00730FA0
                      (0,0,0,0,st::pointer_boundary_cast<byte *>("memory check error at 0x%08X = 0x%02X, should be 0x%02X.\n"));
    if (iVar4 == 1) break;
    uVar3 = 0;
  }
...

{
  ...
  do {
    ...
    iVar4 = st::fn_006A5130(reinterpret_cast<char *>((puVar3 + 7)),(char)DAT_007ec184,4);
    if (iVar4 == 0) {

      iVar4 = st::fn_00730FA0
                        (0,0,0,0,st::pointer_boundary_cast<byte *>("DAMAGE: before %hs block (#%d) at 0x%08X.\n"));
      if (iVar4 == 1) {
        STDebugBreak(); /* noreturn in standalone pseudocode */
      }
      bVar2 = false;
    ...
    if (iVar4 == 0) {
      ...
      iVar4 = st::fn_00730FA0
                        (0,0,0,0,st::pointer_boundary_cast<byte *>("DAMAGE: after %hs block (#%d) at 0x%08X.\n"));
      if (iVar4 == 1) {
        STDebugBreak(); /* noreturn in standalone pseudocode */
      }
      bVar2 = false;
    ...
    if ((puVar3[5] == 0) &&
       ...
       (iVar4 = st::fn_006A5130(reinterpret_cast<char *>((puVar3 + 8)),STPiece<1,1>(DAT_007ec184),puVar3[4]), iVar4 == 0)) {

      iVar4 = st::fn_00730FA0
                        (0,0,0,0,st::pointer_boundary_cast<byte *>("DAMAGE: on top of Free block at 0x%08X.\n"));
      if (iVar4 == 1) {
        STDebugBreak(); /* noreturn in standalone pseudocode */
      }
LAB_006a541d:
      if ((puVar3[2] != 0) &&
         ...
         (iVar4 = st::fn_00730FA0
                            (0,0,0,0,st::pointer_boundary_cast<byte *>("%hs allocated at file %hs(%d).\n")), iVar4 == 1)
         ) {
        STDebugBreak(); /* noreturn in standalone pseudocode */
      }

      iVar4 = st::fn_00730FA0
                        (0,0,0,0,st::pointer_boundary_cast<byte *>("%hs located at 0x%08X is %u bytes long.\n"));
      if (iVar4 == 1) {
        STDebugBreak(); /* noreturn in standalone pseudocode */
      }
      local_c = 0;
...
int __cdecl st::fn_006A55D0(void *param_1,UINT_PTR ucb,int param_3)
    ...
    *param_1 = st::machine_word_boundary_cast<undefined4>(PTR_0085496c);
    ...
    for (; puVar3 != nullptr; puVar3 = (undefined4 *)*puVar3) {
      ...
      if (uVar5 < 5) {
        ...
        iVar4 = st::fn_00730FA0
                          (0,0,0,0,st::pointer_boundary_cast<byte *>("Bad memory block found at 0x%08X.\n"));
        if (iVar4 == 1) {
          STDebugBreak(); /* noreturn in standalone pseudocode */
        }
      }
...

{
  ...
  pRVar2 = reinterpret_cast<RecoveredRecord_006A5BE0_E638A786 *>(PTR_0085496c);
  if (param_1 != nullptr) {
  ...
  do {
    ...
    if (((uVar4 != 3) && (uVar4 != 0)) && ((uVar4 != 2 || ((DAT_007ec178 & 0x10) != 0)))) {
      if (*(void **)&pRVar2->field_0x8 != nullptr) {
        ...
        iVar3 = st::fn_00402DE2(*(void **)&pRVar2->field_0x8,1,0);
        if (iVar3 == 0) {

          iVar3 = st::fn_00730FA0(0,0,0,0,st::pointer_boundary_cast<byte *>("#File Error#(%d) : "));
          if (iVar3 == 1) {
            STDebugBreak(); /* noreturn in standalone pseudocode */
          }
        }
          ...
          iVar3 = st::fn_00730FA0(0,0,0,0,st::pointer_boundary_cast<byte *>("%hs(%d) : "));
          if (iVar3 == 1) {
            STDebugBreak(); /* noreturn in standalone pseudocode */
          }
        }
      ...
      iVar3 = st::fn_00730FA0(0,0,0,0,st::pointer_boundary_cast<byte *>("{%ld} "));
      if (iVar3 == 1) {
        STDebugBreak(); /* noreturn in standalone pseudocode */
      }
      uVar4 = *(uint *)(pRVar2 + 1) & 0xffff;
      if (uVar4 == 4) {
        ...
        iVar3 = st::fn_00730FA0
                          (0,0,0,0,st::pointer_boundary_cast<byte *>("client block at 0x%08X, subtype %x, %u bytes long.\n"));
        if (iVar3 == 1) {
          STDebugBreak(); /* noreturn in standalone pseudocode */
        }
        if (DAT_0085751c != 0) {
          /* ST_CALLSITE[006A5AC3]: CALL EAX */
          (*st::storage_bit_cast<code *>(DAT_0085751c))(&pRVar2[1].field_0xc,pRVar2->field_0010);
        ...
        iVar3 = st::fn_00730FA0
                          (0,0,0,0,st::pointer_boundary_cast<byte *>("normal block at 0x%08X, %u bytes long.\n"));
        if (iVar3 == 1) {
          STDebugBreak(); /* noreturn in standalone pseudocode */
        }
      }
        ...
        iVar3 = st::fn_00730FA0
                          (0,0,0,0,st::pointer_boundary_cast<byte *>("crt block at 0x%08X, subtype %x, %u bytes long.\n"));
        if (iVar3 == 1) {
          STDebugBreak(); /* noreturn in standalone pseudocode */
        }
      }
      st::fn_006A5BE0(pRVar2);
    }
...
void __cdecl st::fn_006A5BE0(RecoveredRecord_006A5BE0_E638A786 *param_1)

{
  ...
  while( true ) {
    ...
    bVar2 = static_cast<byte>(st::machine_word_boundary_cast<uint>((&param_1[1].field_0xc)[iVar6]));
    /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
  ...
  iVar6 = st::fn_00730FA0(0,0,0,0,st::pointer_boundary_cast<byte *>(" Data: <%s> %s\n"));
  if (iVar6 == 1) {
    STDebugBreak(); /* noreturn in standalone pseudocode */
  }
  return;
...
void __cdecl st::fn_006A5D60(void *param_1)

{
  ...
  if (param_1 != nullptr) {
    ...
    do {
      ...
      iVar2 = st::fn_00730FA0(0,0,0,0,st::pointer_boundary_cast<byte *>("%ld bytes in %ld %hs Blocks.\n"));
      if (iVar2 == 1) {
        STDebugBreak(); /* noreturn in standalone pseudocode */
      }
      ppuVar3 = ppuVar3 + 1;
    ...
    iVar2 = st::fn_00730FA0
                      (0,0,0,0,st::pointer_boundary_cast<byte *>("Largest number used: %ld bytes.\n"));
    if (iVar2 == 1) {
      STDebugBreak(); /* noreturn in standalone pseudocode */
    }

    iVar2 = st::fn_00730FA0(0,0,0,0,st::pointer_boundary_cast<byte *>("Total allocations: %ld bytes.\n"));
    if (iVar2 == 1) {
      STDebugBreak(); /* noreturn in standalone pseudocode */
    }
  }
...
{
  if (param_1 != nullptr) {
    st::fn_00405D8A(reinterpret_cast<int *>(param_1));
  }
  return;
}
...

{
  ...
  if (((st::storage_bit_cast<int>(static_cast<uint32_t>((uVar3 ^ (int)uVar3 >> 0x1f) - ((int)uVar3 >> 0x1f))) < 2) &&
      (uVar2 = param_5 - param_2, st::storage_bit_cast<int>(static_cast<uint32_t>((uVar2 ^ (int)uVar2 >> 0x1f) - ((int)uVar2 >> 0x1f))) < 2))
     && (uVar1 = param_6 - param_3, st::storage_bit_cast<int>(static_cast<uint32_t>((uVar1 ^ (int)uVar1 >> 0x1f) - ((int)uVar1 >> 0x1f))) < 2))
  {
...
#line 1 "decomp/ST.exe/functions/006A5F20/decomp.c"
...
int st::fn_006A5F20(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6,
                int *param_7)
...
#line 1 "decomp/ST.exe/functions/006A6100/decomp.c"


/* [STAbiConsistencyApplier] full_eax_return target=return:-1: return=/int Evidence: all observed
   callers consume full EAX (3), none consume AL/AX, and every RET path defines full EAX; generic
   void/unsized transport requires at least two callers; sites=006A7D50 @ 006A7E7C -> read as EAX on
   every CFG path | 006A9190 @ 006A93A3 -> read as EAX on every CFG path | 006A9190 @ 006AA350 ->
   read as EAX on every CFG path */

int st::fn_006A6100(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6,
                int *param_7)

{
  ...
  /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
  return *(int *)(((uVar5 + local_2c * 3) * 3 + local_14) * 4 + 0x7ed500);
}
...

{
  ...
  return st::storage_bit_cast<int>(static_cast<uint32_t>((&SHORT_007ed576)[iVar1 * 4]));
}
...

{
  ...
  if (uVar1 != 0xffe) {
    uVar1 = st::storage_bit_cast<int>(static_cast<uint32_t>(uVar1 + 0xb4)) % 0x168;
  }
  if ((param_1 & 0x4000) != 0) {
    return uVar1 | 0x2000;
  }
...
int st::fn_006A6360(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6)
...

{
  ...
  *(undefined2 *)(param_1 + (param_2 * param_6 + param_5 + local_14 * param_7) * 2) = 1;
  ...
  local_20 = iVar17 * 2;
  local_24 = reinterpret_cast<byte *>(st::fn_006BFB70(iVar17 * 0x10));
  if (local_24 == nullptr) {
LAB_006a6ed7:
    local_34 = 0xfffffffe;
  }
    ...
    while( true ) {
      ...
      do {
        ...
        if (local_20 < param_6_after_write + 0x1a) {
          ...
          pbVar6 = reinterpret_cast<byte *>(st::fn_006BFB50(reinterpret_cast<int *>(local_24),local_20 * 8));
          ...
          st::fn_0072DA70
                    (reinterpret_cast<RecoveredRecord_006BFE70_3123BCE8 *>((pbVar6 + local_20 * 4)),
                     reinterpret_cast<AnonPointee_TLOBaseTy_0607 *>((pbVar6 + local_20 * 4 + -0x200)),
                     local_20 * 4 - 0x200);
        }
        pbVar6 = local_1c;
        local_c = 0xff;
        ...
        if ((((((-1 < param_8) && (-1 < param_9)) && (-1 < param_10)) &&
             ((st::storage_bit_cast<int>(static_cast<uint32_t>(uVar16 - 1)) <= param_8 && (param_8 <= st::storage_bit_cast<int>(static_cast<uint32_t>(uVar16 + 1)))))) &&
            ((st::storage_bit_cast<int>(static_cast<uint32_t>(uVar7 - 1)) <= param_9 &&
             ((param_9 < st::storage_bit_cast<int>(static_cast<uint32_t>(uVar7 + 1)) && (st::storage_bit_cast<int>(static_cast<uint32_t>(uVar8 - 1)) <= param_10)))))) &&
           (param_10 < st::storage_bit_cast<int>(static_cast<uint32_t>(uVar8 + 1)))) {
          bVar5 = true;
        }
        local_2c = local_2c + 1;
...

{
  ...
  iVar17 = (param_2 + param_3) * param_4;
  local_14 = iVar17 * 2;
  local_18 = reinterpret_cast<byte *>(st::fn_006BFB70(iVar17 * 0x10));
  if (local_18 == nullptr) {
LAB_006a76ae:
    local_1c = 0xfffffffe;
  }
    ...
    while( true ) {
      ...
      do {
        ...
        if (local_14 < param_5_after_write + 0x1a) {
          ...
          pbVar6 = reinterpret_cast<byte *>(st::fn_006BFB50(reinterpret_cast<int *>(local_18),local_14 * 8));
          ...
          st::fn_0072DA70
                    (reinterpret_cast<RecoveredRecord_006BFE70_3123BCE8 *>((pbVar6 + local_14 * 4)),
                     reinterpret_cast<AnonPointee_TLOBaseTy_0607 *>((pbVar6 + local_14 * 4 + -0x200)),
                     local_14 * 4 - 0x200);
        }
        pbVar6 = local_c;
        param_6_after_write = 0xff; /* compiler stack-slot lifetime split */
...
#line 1 "decomp/ST.exe/functions/006A76D0/decomp.c"
...
int st::fn_006A76D0(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6,int param_7
...
LAB_006a8234:
  ...
  local_14 = local_2c;
  do {
    param_13_after_write = 30000; /* compiler stack-slot lifetime split */
    ...
    if (uVar7 == 0) {
      ...
      iVar8 = st::fn_006A6100(local_30,local_c,local_10,param_8,param_9,param_10,reinterpret_cast<int *>(&local_4c));
      if (iVar8 < 0x1a) {
        local_34 = st::storage_bit_cast<uint>(static_cast<uint32_t>((&SHORT_007ed576)[iVar8 * 4]));
        local_14 = local_34;
      }
      else {
        local_34 = local_14;
    ...
    local_24 = 0;
    local_1c = reinterpret_cast<ushort *>(&SHORT_007ed576);
...
LAB_006a80b6:
                ...
                if (((local_20 == param_5) && (local_38 == param_6)) && (local_48 == param_7)) {
                  local_2c = local_24;
                  param_13_after_write = st::machine_word_boundary_cast<int>((&DAT_007ed640)[local_24] + local_4c);
                  local_44 = local_38;
                  local_40 = local_20;
                  local_18 = local_48;
                  break;
...
int st::fn_006AB090(int param_1,int param_2,Global_sub_006C8EC0_param_3Enum param_3,int param_4,
...

{
  ...
  *(undefined2 *)(param_1 + (param_2 * param_6 + param_5 + local_c * param_7) * 2) = 1;
  ...
  local_34 = iVar22 * 2;
  local_38 = reinterpret_cast<byte *>(st::fn_006BFB70(iVar22 * 0x10));
  if (local_38 == nullptr) {
LAB_006acc40:
    local_4c = -2;
  }
    ...
    while( true ) {
      ...
      do {
        ...
        if (local_34 < param_5_after_write + 0x1a) {
          ...
          pbVar11 = reinterpret_cast<byte *>(st::fn_006BFB50(reinterpret_cast<int *>(local_38),local_34 * 8));
          ...
          st::fn_0072DA70
                    (reinterpret_cast<RecoveredRecord_006BFE70_3123BCE8 *>((pbVar11 + local_34 * 4)),
                     reinterpret_cast<AnonPointee_TLOBaseTy_0607 *>((pbVar11 + local_34 * 4 + -0x200)),
                     local_34 * 4 - 0x200);
        }
        pbVar11 = local_24;
        local_14 = 0xff;
...
LAB_006acb91:
        ...
        if (local_48 != nullptr) {
          ...
          if ((((bVar8) && (st::storage_bit_cast<int>(static_cast<uint32_t>(uVar21 - 1)) <= param_8)) &&
              ((param_8 <= st::storage_bit_cast<int>(static_cast<uint32_t>(uVar21 + 1)) &&
               (((st::storage_bit_cast<int>(static_cast<uint32_t>(uVar12 - 1)) <= param_9 && (param_9 <= st::storage_bit_cast<int>(static_cast<uint32_t>(uVar12 + 1)))) &&
                (st::storage_bit_cast<int>(static_cast<uint32_t>(uVar10 - 1)) <= param_10)))))) && (param_10 <= st::storage_bit_cast<int>(static_cast<uint32_t>(uVar10 + 1)))) {
            bVar9 = true;
          }
        }
        local_40 = local_40 + 1;
...

{
  ...
  /* ST_PSEUDO[unresolved_register_input]: candidate live-in register: verify boundary, SEH/setjmp ABI, or convention */
  puVar3 = reinterpret_cast<byte *>((*(undefined4 **)(unaff_EBP + 8)));
...
cf_continue_loop_006ACD0D:
    ...
    if (7 < iVar4) {
      st::fn_006CE700(reinterpret_cast<byte *>(arg_2),(byte *)((int)&arg_2->field_0000 + (iVar4 / 2) * param_3),param_3);
      arg_1 = arg_2;
cf_continue_loop_006ACD37:
    ...
    for (pRVar5_mg1 = (RuntimeRecord_007F4D3C_0014 *)((int)local_8 - param_3); local_8 = arg_2,
      ...
      st::fn_006CE700(reinterpret_cast<byte *>(local_8),reinterpret_cast<byte *>(pRVar5_mg1),param_3);
    }
    if (0 < (int)param_1) {
...
LAB_006acd4f:
  ...
  if (arg_1 <= pRVar4_mg0) {
    st::fn_006CE700(reinterpret_cast<byte *>(arg_1),reinterpret_cast<byte *>(pRVar4_mg0),param_3);
    goto cf_continue_loop_006ACD37;
  }
  st::fn_006CE700(reinterpret_cast<byte *>(arg_2),reinterpret_cast<byte *>(pRVar4_mg0),param_3);
  pRVar5_mg0 = arg_2;
  pRVar3 = pRVar4_mg0;
...
int st::fn_006ACE70(uint lowWord,uint highWord)
...

{
  ...
  if (-1 < lVar3) {
    ...
    if ((SCARRY4(iVar7,iVar6) != SCARRY4(iVar2,uVar1)) == (int)highWord < 0) {
      ...
      iVar6 = st::fn_006ACE70(uVar5 + (uint)lVar3,highWord);
      return iVar6;
    }
  }
  return 0x7fffffff;
  ...
  if (-1 < lVar1) {
    ...
    if ((SCARRY4(iVar6,iVar7) != SCARRY4(iVar8,uVar3)) == iVar9 < 0) {
      ...
      if ((SCARRY4(iVar8,iVar9) != SCARRY4(iVar6,uVar3)) == (int)highWord < 0) {
        ...
        iVar6 = st::fn_006ACE70(uVar4 + uVar5,highWord);
        return iVar6;
      }
    }
  }
...

{
  ...
  if ((text != nullptr) && (*text != '\0')) {
    ...
    piVar1 = st::pointer_boundary_cast<int *>(st::fn_0072EA70(reinterpret_cast<LPCSTR>(text),pcVar2));
    if (piVar1 == nullptr) {
      return DAT_00857148;
    }
...
{
  g_anonShape_GLOBAL_0080759C_9638EF10_00854EB8 = reinterpret_cast<RecoveredGlobalRecordView_00854EB8 *>(param_1);
  return;
}
...

{
  ...
  DVar2 = st::external_0000001A((HMODULE)0x0,reinterpret_cast<LPSTR>(local_10c),0x104);
  if (DVar2 == 0) {
  ...
  local_30c[0] = '\0';
  if ((param_1 != nullptr) &&
     (iVar3 = st::fn_007300E0(reinterpret_cast<undefined1 *>(local_30c),0x200,param_1,reinterpret_cast<undefined4 *>((st_stack_frame + 796))),
     iVar3 < 0)) {
    uVar3 = 0xffffffff;
    pcVar6 = st::mutable_c_string("User message too long");
    do {
      pcVar8 = pcVar6;
      if (uVar3 == 0) break;
      uVar3 = uVar3 - 1;
  ...
  st::fn_006AD3A0(reinterpret_cast<LPCSTR>(local_30c),reinterpret_cast<LPCSTR>(local_10c),0x40);
  return;
}
...

{
  ...
  if ((g_anonShape_GLOBAL_0080759C_9638EF10_00854EB8 != nullptr)
    ...
    st::fn_006B0BA0(reinterpret_cast<DDXContext *>(g_anonShape_GLOBAL_0080759C_9638EF10_00854EB8),st::machine_word_boundary_cast<undefined4>(&DAT_00854aa4),0,0x100);
...

{
  ...
  if ((format != nullptr) &&
     ...
     (local_EAX_79 = st::fn_007300E0
                               (reinterpret_cast<undefined1 *>(local_34c),0x200,reinterpret_cast<byte *>(format),reinterpret_cast<undefined4 *>((st_stack_frame + 1916))),
     local_EAX_79 < 0)) {
    uVar4 = 0xffffffff;
    pcVar9 = st::mutable_c_string("User message too long");
    do {
      pcVar10 = pcVar9;
      if (uVar4 == 0) break;
      uVar4 = uVar4 - 1;
  ...
  if (DAT_00854ebc != 0) {
    ...
    pcVar8 = reinterpret_cast<char *>(local_14c);
    /* ST_CALLSITE[006AD627]: CALL dword ptr [0x0085bb94] */
    DVar2 = st::external_0000001A((HMODULE)0x0,reinterpret_cast<LPSTR>(local_14c),0x104);
    if (DVar2 == 0) {
      ...
      uVar4 = 0xffffffff;
      pcVar9 = reinterpret_cast<char *>(local_14c);
      do {
        if (uVar4 == 0) break;
        uVar4 = uVar4 - 1;
        cVar1 = *pcVar9;
      ...
      puVar12 = reinterpret_cast<uint *>((pcVar9 + -uVar4));
      puVar13 = &uStack_743;
  ...
  *(undefined1 *)puVar7 = 10;
  ...
  if (sourceFile != nullptr) {
    ...
    *(undefined4 *)pcVar9 = STLiteralPiece<0,4>("File: ");
    ...
    if (0 < sourceLine) {
      ...
      iVar5 = st::fn_00730C40(reinterpret_cast<undefined1 *>(pcVar10),0x7ed884);
      pcVar10 = pcVar10 + iVar5;
    }
    ...
    if (((g_int_00854EB4 != nullptr) && (BVar3 = st::external_00000023((st_stack_frame + 1888),4), BVar3 == 0))
      ...
      iVar5 = st::fn_00730C40(reinterpret_cast<undefined1 *>(pcVar10),0x7ed87c);
      pcVar10 = pcVar10 + iVar5;
      ...
      if (BVar3 == 0) {
        ...
        iVar5 = st::fn_00730C40(reinterpret_cast<undefined1 *>(pcVar10),0x7ed874);
        pcVar10 = pcVar10 + iVar5;
      }
    }
    *pcVar10 = '\n';
  ...
  if ((g_exceptionSourceFile != 0) && (g_exceptionCode == errorCode)) {
    ...
    *(undefined2 *)(pcVar9 + 8) = STLiteralPiece<8,2>("ExcRaise: ");
    ...
    if (iVar5 < 0x37) {
      ...
      uVar6 = 0xffffffff;
      pcVar9 = st::pointer_boundary_cast<char *>(g_exceptionSourceFile + (~uVar4 - 0x37));
      do {
        pcVar14 = pcVar9;
        if (uVar6 == 0) break;
        uVar6 = uVar6 - 1;
    ...
    iVar5 = st::fn_00730C40(reinterpret_cast<undefined1 *>(pcVar10),0x7ed864);
    pcVar10[iVar5] = '\n';
  ...
  if (errorCode != 0) {
    ...
    iVar5 = st::fn_00730C40(reinterpret_cast<undefined1 *>(pcVar9),0x7ed848);
    pcVar9 = pcVar9 + iVar5;
  }
  *pcVar9 = '\n';
  pcVar10 = pcVar9 + 1;
  ...
  if (g_int_00854EB4 == nullptr) {
    if (DAT_00854ebc != 0) {
      *pcVar10 = '\n';
      pcVar9 = st::mutable_c_string("(Press Retry to debug the application)");
      pcVar10 = pcVar10 + 1;
      ...
      if (isFatal == 0) {
        ...
        pcVar9 = st::mutable_c_string("Debug Error Message");
      ...
      if ((g_anonShape_GLOBAL_0080759C_9638EF10_00854EB8 ==
        ...
        uVar4 = 0xffffffff;
        pcVar9 = st::mutable_c_string(" (UNSAFE)");
        do {
          pcVar10 = pcVar9;
          if (uVar4 == 0) break;
          uVar4 = uVar4 - 1;
        ...
        pcVar10 = pcVar14 + -1;
        memmove(pcVar10, pcVar9, uVar4); /* compiler REP MOVS byte copy */
        pcVar10 = reinterpret_cast<char *>(((byte *)pcVar10 + uVar4));
      }
      if ((g_anonShape_GLOBAL_0080759C_9638EF10_00854EB8 !=
           nullptr) &&
      ...
      iVar2 = st::fn_006AD3A0((LPCSTR)&local_74c,reinterpret_cast<LPCSTR>(debugMessage),2);
      if (iVar2 == 4) {
        iVar5 = 1;
        if ((g_anonShape_GLOBAL_0080759C_9638EF10_00854EB8 !=
             nullptr) &&
    ...
    *pcVar10 = '\0';
    ...
    st::fn_0072EB70(reinterpret_cast<char *>(&local_74c),g_int_00854EB4);
    uVar4 = 0;
    if (0 < DAT_00858ddc) {
      do {
...

{
  ...
  if ((param_4 != nullptr) &&
     (local_EAX_41 = st::fn_007300E0
                               (reinterpret_cast<undefined1 *>(local_204),0x200,param_4,reinterpret_cast<undefined4 *>((st_stack_frame + 556))),
     local_EAX_41 < 0)) {
    uVar3 = 0xffffffff;
    pcVar6 = st::mutable_c_string("User message too long");
    do {
...

{
  ...
  PTR_00854eb0 = (undefined4 *)ExceptionList;
  ...
  if (g_int_00854EB4 != nullptr) {
    ...
    if (*(int *)(*param_1 + 0x10) != 0) {
      ...
      st::fn_00733F70(g_int_00854A9C,reinterpret_cast<char *>(&DAT_007ed984));
      DAT_00854aa0 = 0;
      ...
      if ((int)DAT_00854aa0 < *(int *)(*param_1 + 0x10)) {
        do {
          ...
          st::fn_00733F70(g_int_00854A9C,reinterpret_cast<char *>(&DAT_007ed978));
      ...
      st::fn_00733F70(g_int_00854A9C,reinterpret_cast<char *>(&DAT_007ed974));
    }
    ...
    /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
    if ((st::machine_word_boundary_cast<undefined4>(*(uint **)(param_1[1] + 0xc4)) <= DAT_00854ea4) && (DAT_00854ea4 < st::machine_word_boundary_cast<undefined4>(PTR_00854eb0))) {
      DAT_00854aa0 = 0;

      st::fn_00733F70(g_int_00854A9C,st::mutable_c_string("%08X  "));
      _DAT_00854ea8 = DAT_00854ea4;
      puVar1 = *st::storage_bit_cast<uint *>(DAT_00854ea4);
      bVar4 = DAT_00854ea4 < puVar1;
      DAT_00854ea4 = st::machine_word_boundary_cast<undefined4>((uint *)puVar1);
      if (bVar4) {
        do {
          DAT_00854ea4 = st::machine_word_boundary_cast<undefined4>((uint *)puVar1);
          if (st::machine_word_boundary_cast<uint>(PTR_00854eb0) <= puVar1) break;
          DAT_00854aa0 = DAT_00854aa0 + 1;
    ...
    st::fn_00733F70(g_int_00854A9C,st::mutable_c_string("----------------\n"));
    /* ST_PSEUDO[raw_pointer_offset]: candidate structure field after proof; otherwise retain buffer arithmetic */
    DAT_00854a80 = st::machine_word_boundary_cast<undefined4>(*(undefined4 **)(param_1[1] + 0xc4));
    DAT_00854aa0 = 0;
    do {
      if (st::machine_word_boundary_cast<undefined4>(PTR_00854eb0) <= DAT_00854a80) break;
...

{
  if (array != nullptr) {
    ...
    if ((array->flags & 8) != 0) {
      st::fn_006A5E90(reinterpret_cast<short *>(array));
    }
  }
  return;
}
...

{
  ...
  *(undefined2 *)((int)param_11 + local_8 * 8 + 6) = 0;
  ...
  uVar5_mg0 = st::fn_006A6360(param_5,param_6,param_7,param_8,param_9,param_10);

  local_3c = st::fn_006A6320(uVar5_mg0);
  local_28 = local_3c;
  /* ST_PSEUDO[stack_slot_reuse]: compiler reused a dead incoming argument slot; split the post-write lifetime into a local variable */
  if (((param_8 == param_5) && (param_9 == param_6)) && (param_10 == param_7)) {
    local_8 = param_12 + -2;
    ...
    *(short *)(param_11 + local_8 * 2 + 1) = (short)param_7;
    ...
    do {
      ...
      uVar5_mg1 = st::fn_006A6360(param_5,param_6,param_7,local_30,param_9,param_10);

      uVar5 = st::fn_006A6320(uVar5_mg1);
      param_8_after_write = 0; /* compiler stack-slot lifetime split */
      local_18 = reinterpret_cast<ushort *>(&SHORT_007ed576);
...
joined_r0x006ae66d:
      ...
      local_8 = local_8 + -1;
      local_3c = st::storage_bit_cast<uint>(static_cast<uint32_t>((&SHORT_007ed576)[local_28 * 4]));
      puVar10 = local_2c + -2;
