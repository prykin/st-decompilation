...

{
  ...
  switch(param_1) {
  case CASE_0:
    return st::pointer_boundary_cast<byte *>(&DAT_007c89e4);
  case CASE_1:
    return st::pointer_boundary_cast<byte *>(&DAT_007c89e8);
  case CASE_2:
    return st::pointer_boundary_cast<byte *>(&DAT_007c89f4);
  case CASE_3:
    return st::pointer_boundary_cast<byte *>(&DAT_007c8a10);
  case CASE_4:
    return st::pointer_boundary_cast<byte *>(&DAT_007c8a44);
  case CASE_5:
    return st::pointer_boundary_cast<byte *>(&DAT_007c8a98);
  case CASE_6:
    return st::pointer_boundary_cast<byte *>(&DAT_007c8b14);
  case CASE_7:
    return st::pointer_boundary_cast<byte *>(&DAT_007c8bc0);
  case CASE_8:
    return st::pointer_boundary_cast<byte *>(&DAT_007c8ca4);
  default:
...

{
  ...
  if (param_3 != nullptr) {
    ...
    if (0 < iVar2) {
      ...
      param_2 = iVar2;
      /* ST_PSEUDO[stack_slot_reuse]: compiler reused a dead incoming argument slot; split the post-write lifetime into a local variable */
      param_6 = st::pointer_boundary_cast<undefined *>(pbVar3);
      while( true ) {
        do {
          iVar1 = iVar6 + iVar5;
...

{
  ...
  if (STField<int>(this,0x644) != 0) {
    st::fn_006AB060((undefined4 *)((int)this + 0x644));
  }
  /* ST_PSEUDO[stack_slot_reuse]: compiler reused a dead incoming argument slot; split the post-write lifetime into a local variable */
...
LAB_0055e048:
        ...
        if ((local_20 < 1) || (iVar9 < local_20)) {
          ...
          local_1c = local_8;
          int scalar_puVar13 = DAT_008033a4 * (int)local_18 + (int)local_8; /* split integer lifetime from pointer-typed SSA storage */
...
cf_continue_loop_0055E2E9:
  ...
  if (0 < DAT_008033a8) {
    do {
      ...
      iVar11 = 0;
      if (0 < iVar5) {
        puVar7 = (undefined1 *)(iVar5 * iVar9 * 2 + 1 + DAT_00803380);
        do {
          iVar11 = iVar11 + 1;
          *puVar7 = (char)*psVar8;
          puVar7 = puVar7 + 2;
  ...
  if ((iVar5 < 5) || (DAT_008033a8 < 5)) {
    ...
    if (0 < DAT_008033a8) {
      do {
        ...
        iVar11 = 0;
        if (0 < iVar5) {
          pbVar17 = (byte *)(iVar5 * iVar9 * 2 + 1 + DAT_00803380);
          do {
...
LAB_0055eb08:
    ...
    do {
      ...
      iVar9 = 0;
      if (0 < iVar5) {
        pbVar17 = (byte *)(DAT_00803380 + (iVar11 + 2) * iVar5 * 2 + 1);
    ...
    if (iVar9 < DAT_008033a8 + -2) {
      ...
      do {
        ...
        if (0 < iVar5) {
          /* ST_PSEUDO[stack_slot_reuse]: compiler reused a dead incoming argument slot; split the post-write lifetime into a local variable */
          param_1 = (byte *)(DAT_00803380 + iVar11 * iVar5 * 2 + 1);
          pbVar17 = (byte *)(DAT_00803380 + (iVar11 + -5) * iVar5 * 2 + 1);
          psVar8 = local_14 + iVar5 * iVar9;
          do {
            bVar1 = *pbVar17;
            pbVar17 = pbVar17 + 2;
    ...
    if (iVar9 < DAT_008033a8) {
      ...
      do {
        iVar11 = 0;
        if (0 < iVar5) {
          pbVar17 = (byte *)(DAT_00803380 + (int)param_1 * iVar5 * 2 + 1);
          psVar8 = local_14 + iVar5 * iVar9;
          do {
            bVar1 = *pbVar17;
            pbVar17 = pbVar17 + 2;
    ...
    param_1 = nullptr;
    local_30 = 0xf;
    local_34 = st::pointer_boundary_cast<undefined1 *>(&DAT_0000000c);
    local_38 = 9;
    do {
      iVar11 = 0;
    ...
    if ((int)param_1 < DAT_008033a8) {
      do {
        ...
        int scalar_local_40 = iVar11 * 4; /* split integer lifetime from pointer-typed SSA storage */
        local_3c = local_8 + 3;
        pbVar17 = (byte *)((int)local_10 + 3);
        local_44 = (undefined1 *)0x2;
        local_c = 3;
...

{
  ...
  puStack_c = st::pointer_boundary_cast<undefined *>(&DAT_0079afb0);
  puStack_10 = st::pointer_boundary_cast<undefined1 *>(&st_image_0072D964);
  local_14 = ExceptionList;
  pbVar8 = st::pointer_boundary_cast<byte *>(&stack0xffffffb0);
  pcVar9 = st::pointer_boundary_cast<char *>(&stack0xffffffb0);
  pcVar10 = st::pointer_boundary_cast<char *>(&stack0xffffffb0);
  pbVar11 = st::pointer_boundary_cast<byte *>(&stack0xffffffb0);
  puVar6 = st::pointer_boundary_cast<undefined1 *>(&stack0xffffffb0);
  local_8 = 0;
...

{
  ...
  puStack_c = st::pointer_boundary_cast<undefined *>(&DAT_0079afc0);
  puStack_10 = st::pointer_boundary_cast<undefined1 *>(&st_image_0072D964);
  local_14 = ExceptionList;
  local_1c = st::pointer_boundary_cast<undefined1 *>(&stack0xffffff88);
  local_48 = param_2;
  if (9 < (int)param_2) {
    local_48 = 10;
  }
  ...
  local_1c = st::pointer_boundary_cast<undefined1 *>(&stack0xffffff88);
  local_44[0] = st::pointer_boundary_cast<int *>(st::fn_006AAC70(param_3 * 4));
  if (param_4 < 0) {
    param_4 = 1;
  }
  local_2c = -1;
    ...
    do {
      ...
      if (0 < (int)param_3) {
        ...
        do {
          ...
          *local_64 = iVar3;
          local_24[iVar3] = -1;
          (*param_7)(st::machine_word_boundary_cast<undefined4>(local_30),local_50,st::machine_word_boundary_cast<undefined4>(local_24),iVar3);
          local_50 = local_50 + 1;
          local_64 = local_64 + 1;
        } while (local_50 < (int)param_3);
      }
      if (((int)param_3 <= local_50) && (iVar3 = (*param_6)(st::machine_word_boundary_cast<undefined4>(local_30),param_3), local_2c < iVar3)) {
        piVar4 = local_30;
        piVar7 = local_44[0];
