        ...
        do {
          ...
          if (((((sVar9 < 0) || (g_worldGrid.sizeX <= sVar9)) || (sVar12 = (short)iVar7, sVar12 < 0)
            ...
            if (((uint)param_1[9] < 8) &&
              ...
              /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
              auto _local_50 = CONCAT31(uStack_4f,bVar4);
              /* ST_PSEUDO[packed_or_unaligned_piece]: expected named packed member, bit extract/compose, or unaligned load */
...

{
  ...
  if (puVar1 != nullptr) {
    puVar2 = st::pointer_boundary_cast<uint *>(st::fn_00402225(puVar1));
    return puVar2;
  }
  return nullptr;
}
...

{
  ...
  *param_1 = 0;
  local_c = 0x3d;
  puVar1 = st::pointer_boundary_cast<undefined4 *>(st::fn_006AAC70(0x3d));
  if (puVar1 != nullptr) {
    *puVar1 = 0xbe;
    puVar1[1] = 0xff;
    puVar1[2] = 0;
    ...
    piVar4 = st::pointer_boundary_cast<int *>(puVar1 + 9);
    piVar3 = piVar5;
    do {
      *piVar4 = *piVar3;
      if (*piVar3 != 0) {
