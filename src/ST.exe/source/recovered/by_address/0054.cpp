...
undefined4 * __cdecl
st::fn_00540C40(RecoveredRecord_00540C40_D825DD02 *param_1,uint *param_2,uint *param_3,int param_4)

{
  ...
  if ((param_1 != nullptr) && (param_2 != nullptr)) {
    ...
    iVar3 = st::fn_00711110(param_1,reinterpret_cast<char *>(param_2));
    if (param_4 < iVar3) {
      if (param_3 != nullptr) {

        local_8 = st::fn_00711110(param_1,reinterpret_cast<char *>(param_3));
      }
      puVar9 = param_2;
      iVar3 = local_8;
      if (param_4 < local_8) goto LAB_00540d59;
      while (iVar3 < param_4) {
        uVar2 = st::fn_00710FB0(param_1,reinterpret_cast<byte *>(puVar9));
      ...
      st::fn_0072E340(&CHAR_00h_008016f0,reinterpret_cast<char *>(param_2),local_c - 1);
      uVar4 = 0xffffffff;
...

{
  ...
  if (((param_1 != nullptr) && (param_2 != nullptr)) && (text != nullptr)) {
    ...
    /* ST_CALLSITE[00541202]: CALL 0x006aac70; direct=006AAC70 Library::DKW::LIB::MemAlloc; [STCallResultViewApplier] presentation_only; exact direct-call result=/winnt.h/LPSTR; source view only; no Ghidra override */
    ...
    if (local_8 != nullptr) {
      ...
      st::fn_006B5AA0(param_1,reinterpret_cast<char *>(local_8));
...

{
  ...
  this = STPointerBoundaryCast<CursorClassTy *>(st::fn_006B04D0(0x4fb));
  if (this != nullptr) {

    st::fn_006E5FB0(this);
    st::fn_00715820(reinterpret_cast<SpriteClassTy *>(&this->field_0018));
    ...
    *pCVar5 = CASE_0;
    ...
    this->field_010B = -1;
    iVar3 = 0;
    puVar1 = reinterpret_cast<uint *>(&this->field_0x11b);
    do {
      puVar1[-1] = 0xffffffff;
      bVar2 = (byte)iVar3;
...
undefined4 __fastcall st::fn_00548B90(RecoveredRecord_00548B90_C039E281 *param_1)

{
  ...
  uVar1 = st::fn_00405687((int)param_1);
  return uVar1;
}

// 00548BC0 FUN_00548bc0
#line 4 "decomp/ST.exe/functions/00548BC0/decomp.c"
undefined4 __fastcall st::fn_00548BC0(RecoveredRecord_00548BC0_697C8B62 *param_1)
...

{
  ...
  uVar2 = st::storage_bit_cast<uint>(static_cast<uint32_t>(iVar1 < param_1));
...

{
  ...
  uVar5 = 0xffffffff;
  pcVar6 = reinterpret_cast<char *>(PTR_DAT_007c83b0);
  do {
    if (uVar5 == 0) break;
    uVar5 = uVar5 - 1;
    cVar1 = *pcVar6;
  ...
  if (param_1 != nullptr) {
    st::fn_006F20E0(param_3,reinterpret_cast<uint *>(&param_1));
  }
  return iVar4;
}
