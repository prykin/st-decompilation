...
#line 1 "decomp/ST.exe/functions/00600110/decomp.c"
...
#line 1 "decomp/ST.exe/functions/006001E0/decomp.c"
...
#line 1 "decomp/ST.exe/functions/00600580/decomp.c"
...

{
  ...
  if ((int)uVar6 < 1) {
    ...
    iVar4 = st::fn_006ACFD0(iVar7,iVar3,param_1,iVar4);
...
#line 1 "decomp/ST.exe/functions/00600750/decomp.c"
          ...
          *(undefined4 *)(iVar7 + 0x39 + param_1->field_0233) = 3;
          if ((param_1->field_0232 == '\0') ||
             (iVar4 = SubmarineTitans::Recovered::HiddenThis::AnonReceiver_005FDB50::
                      st::fn_00403E27((AnonReceiver_005FDB50 *)param_1,1,iVar5), iVar4 != 0)) {
LAB_00600928:
            st::fn_004035A8(param_1,iVar5);
          }
          else {
            ...
            st::fn_00404610(param_1,iVar7,iVar4,0x460);
      ...
      case 2:
        if (((*(uint *)(iVar4 + 0x3d) <= g_playSystem_00802A38->field_00E4) &&
           ...
           (iVar4 = st::fn_004028CE(param_1,local_8,iVar4), iVar5 = local_8, iVar4 != 0)) {
          iVar4 = st::fn_00403E27
      ...
      case 3:
        if (param_1->field_0232 == '\0') {
          ...
          if (0x15 < (int)local_14) {
            ...
            iVar4 = st::fn_004022AC(pSVar2,'\x0f');
          ...
          if (*(char *)(iVar7 + 0x28 + param_1->field_0233) != '\0') {
            iVar4 = st::fn_004022AC(pSVar2,'\x0e');
            iVar7 = st::fn_004042AF(pSVar2,'\x0e');
            if (iVar4 + -1 == iVar7) {
              st::fn_00404264(pSVar2,0xe);
            }
          }
          iVar4 = st::fn_004022AC(pSVar2,'\r');
          iVar7 = st::fn_004042AF(pSVar2,'\r');
          if (iVar4 + -1 == iVar7) {
            st::fn_00404264(pSVar2,0xd);
          }
          iVar4 = st::fn_004022AC(pSVar2,'\x0f');
          iVar7 = st::fn_004042AF(pSVar2,'\x0f');
          if (iVar4 + -1 == iVar7) {
          ...
          st::fn_00401064(pSVar2,'\x0e',uVar6);
          st::fn_004030BC(pSVar2,'\x0e');
          st::fn_00401064(pSVar2,'\r',uVar8);
...
#line 1 "decomp/ST.exe/functions/006010A0/decomp.c"
...

{
  ...
  *(undefined1 *)puVar4 = *(undefined1 *)puVar9;
  ...
  puVar4 = (byte *)(st::fn_006AAC70(uVar8));
...
#line 1 "decomp/ST.exe/functions/00601D10/decomp.c"
...
#line 1 "decomp/ST.exe/functions/006023C0/decomp.c"
...
#line 1 "decomp/ST.exe/functions/00602700/decomp.c"
...
#line 1 "decomp/ST.exe/functions/00602740/decomp.c"
...
#line 1 "decomp/ST.exe/functions/006027F0/decomp.c"
...
#line 1 "decomp/ST.exe/functions/00602880/decomp.c"
...
#line 1 "decomp/ST.exe/functions/006028A0/decomp.c"
...

{
  ...
  if (iVar2 == 0) {
    ...
    iVar2 = st::fn_00404183((STT3DSprC *)this,0xe,DAT_00806774,text,0x1d);
    if (iVar2 == 0) {
      ...
      st::fn_00405CA9((STT3DSprC *)this,DAT_008073cc);
...
#line 1 "decomp/ST.exe/functions/00603090/decomp.c"
...
#line 1 "decomp/ST.exe/functions/006033D0/decomp.c"
...
#line 1 "decomp/ST.exe/functions/00603470/decomp.c"
...
#line 1 "decomp/ST.exe/functions/006034E0/decomp.c"
/* [STPrototypeApplier] Propagated parameter 0.
...
#line 1 "decomp/ST.exe/functions/006036A0/decomp.c"
...
#line 1 "decomp/ST.exe/functions/00604050/decomp.c"
/* [STUnclaimedCodeApplier] Exact function entry recovered from thunk_target.
...
#line 1 "decomp/ST.exe/functions/00604160/decomp.c"
...
#line 1 "decomp/ST.exe/functions/006042D0/decomp.c"
...
#line 1 "decomp/ST.exe/functions/00604820/decomp.c"
...
#line 1 "decomp/ST.exe/functions/00604870/decomp.c"
...
#line 1 "decomp/ST.exe/functions/006048E0/decomp.c"
...
#line 1 "decomp/ST.exe/functions/00604A00/decomp.c"
...
#line 1 "decomp/ST.exe/functions/00604EE0/decomp.c"
...
#line 1 "decomp/ST.exe/functions/00604FC0/decomp.c"
...

{
  ...
  if (STField<int>(this,0x215) != 0) {
    iVar3 = *piVar9;
    uVar1 = st::fn_006B0060(nullptr,(uint *)&param_1[1].field_0x2);
...
#line 1 "decomp/ST.exe/functions/006057C0/decomp.c"
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
...
#line 1 "decomp/ST.exe/functions/00605B60/decomp.c"
...
#line 1 "decomp/ST.exe/functions/00606A50/decomp.c"
/* [STSwitchEnumApplier] Switch target param_1 uses
...
#line 1 "decomp/ST.exe/functions/00606CD0/decomp.c"
/* [STSwitchEnumApplier] Switch target param_1 uses
...
#line 1 "decomp/ST.exe/functions/00606FD0/decomp.c"
/* [STSwitchEnumApplier] Switch target param_1 uses
...
#line 1 "decomp/ST.exe/functions/00607200/decomp.c"
int __thiscall
...

{
  ...
  local_c = iVar6;
  iVar2 = st::fn_00403D8C(this,iVar6);
...
#line 1 "decomp/ST.exe/functions/00607A60/decomp.c"
...
#line 1 "decomp/ST.exe/functions/00607EE0/decomp.c"
/* [STSwitchEnumApplier] Switch target param_1 uses
...
#line 1 "decomp/ST.exe/functions/00608B50/decomp.c"
int __thiscall
...
#line 1 "decomp/ST.exe/functions/00608E90/decomp.c"
...

{
  ...
  iVar2 = st::fn_00403EBD(this,(STMessage *)param_1);
  if (iVar2 == 0xffff) {
    return 0xffff;
  }
  ...
  if (uVar3 == 3) {
    if (STField<int>(this,0x1f5) == 0x4d) {
      ...
      st::fn_00402554(iVar5,iVar6,iVar2,STField<int>(this,0x18));
    }
  ...
  if (uVar3 == 0) {
    ...
    if (STField<int>(this,0x248) == 1) {
      if (STField<uint>(this,0x250) <= g_playSystem_00802A38->field_00E4) {
        if ((STField<int>(this,0x20d) == 5) && (iVar2 = st::fn_0040202C(this), iVar2 == 0)) {
          st::fn_00401CC1(this);
        }
...
LAB_00609164:
      ...
      st::fn_00402CE8(iVar5,iVar6,STField<uint>(this,0x1d9),iVar2,STField<uint>(this,0x18),
                         this);
      if (STField<int>(this,0x209) != 0) {
        if ((STField<int>(this,0x221) == 0) &&
...
LAB_00609202:
  ...
  case 4:
    ...
    break;
  case 5:
    iVar2 = st::fn_0040576D(this,6);
    if (iVar2 != 0) {
      iVar2 = st::fn_0040202C(this);
joined_r0x0060929e:
      if (iVar2 != 0) break;
    }
    goto LAB_006092a0;
  case 6:
    iVar2 = st::fn_0040576D(this,5);
    if (iVar2 != 0) {
      iVar2 = st::fn_00402135(this,5,0x14);
...
#line 1 "decomp/ST.exe/functions/00609920/decomp.c"
/* [STUnclaimedCodeApplier] Exact function entry recovered from thunk_target.
...
#line 1 "decomp/ST.exe/functions/00609950/decomp.c"
...
#line 1 "decomp/ST.exe/functions/006099A0/decomp.c"
/* [STPrototypeApplier] Propagated return.
...
#line 1 "decomp/ST.exe/functions/0060A000/decomp.c"
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
...
#line 1 "decomp/ST.exe/functions/0060A430/decomp.c"
...
#line 1 "decomp/ST.exe/functions/0060A470/decomp.c"
...
#line 1 "decomp/ST.exe/functions/0060A4B0/decomp.c"
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
...
#line 1 "decomp/ST.exe/functions/0060A800/decomp.c"
...
#line 1 "decomp/ST.exe/functions/0060A940/decomp.c"
...
#line 1 "decomp/ST.exe/functions/0060A9D0/decomp.c"
...
#line 1 "decomp/ST.exe/functions/0060AA00/decomp.c"
...
#line 1 "decomp/ST.exe/functions/0060AEF0/decomp.c"
...

{
  ...
  if (STField<int>(param_1,0x1f5) == 0x42) {
    ExceptionList = &local_14;
    iVar12 = st::fn_0040186B(STField<int>(param_1,0x1d9),0x1c);
    if (iVar12 == 0) {
    ...
    STField<int>(param_1,0x24c) = iVar12;
    puVar9 = local_1c;
  }
  local_1c = puVar9;
  iVar12 = STField<int>(param_1,0x1e9);
  sVar18 = (short)(iVar12 >> 0x1f);
  if (iVar12 < 0) {
    local_7c = (short)(((short)(iVar12 / 0xc9) + sVar18) -
                      (short)((longlong)iVar12 * 0x28c1979 >> 0x3f)) + -1;
  }
  else {
    local_7c = (int)(short)(((short)(iVar12 / 0xc9) + sVar18) -
                           (short)((longlong)iVar12 * 0x28c1979 >> 0x3f));
  }
  iVar12 = STField<int>(param_1,0x1ed);
  sVar18 = (short)(iVar12 >> 0x1f);
  if (iVar12 < 0) {
    local_8c = (short)(((short)(iVar12 / 0xc9) + sVar18) -
                      (short)((longlong)iVar12 * 0x28c1979 >> 0x3f)) + -1;
  }
  else {
    local_8c = (int)(short)(((short)(iVar12 / 0xc9) + sVar18) -
                           (short)((longlong)iVar12 * 0x28c1979 >> 0x3f));
  }
  iVar12 = STField<int>(param_1,0x24c);
  iVar19 = local_8c - iVar12;
  if (iVar19 < 0) {
    iVar19 = 0;
  }
  ...
  iVar21 = iVar12 + 1 + local_8c;
  if (g_worldGrid.sizeY < iVar21) {
    iVar21 = (int)g_worldGrid.sizeY;
  }
        ...
        do {
          ...
          do {
            ...
            if (((((sVar18 < 0) || (g_worldGrid.sizeX <= sVar18)) ||
              ...
              pSVar20 = (STFishC *)
                        STGridAt3D(g_worldGrid, sVar18, sVar17, sVar11).objects[0];
            }
            if ((pSVar20 != nullptr) &&
              ...
              if ((*(int *)&pSVar20->field_0x20 == 1000) &&
                ...
                if (0 < local_a4) {
                  do {
                    if (*(int *)(local_a8 + iVar12 * 4) == pSVar20->field_0018) {
                      bVar22 = true;
                      break;
                    }
                    iVar12 = iVar12 + 1;
                ...
                if (bVar22) goto cf_continue_loop_0060B649;
                *(undefined4 *)(local_a8 + local_a4 * 4) = pSVar20->field_0018;
                local_a4 = local_a4 + 1;
              }
              uVar16 = pSVar20->field_0024;
              if (STField<int>(param_1,0x1f5) == 0x43) {
                if ((uVar16 < 8) &&
...
LAB_0060b2ce:
                  ...
                  if ((bVar22) && (iVar12 = (*pSVar20->vtable->vfunc_F8)(), iVar12 != 0)) {
                    ...
                    *puVar1 = pSVar20;
                    uVar14 = (*pSVar20->vtable->vfunc_78)();
                    puVar1[1] = uVar14;
                    iVar12 = STField<int>(param_1,0x1ed);
                    sVar18 = (short)(iVar12 >> 0x1f);
                    if (iVar12 < 0) {
                      iVar12 = (short)(((short)(iVar12 / 0xc9) + sVar18) -
                                      (short)((longlong)iVar12 * 0x28c1979 >> 0x3f)) + -1;
                    }
                    else {
                      iVar12 = (int)(short)(((short)(iVar12 / 0xc9) + sVar18) -
                                           (short)((longlong)iVar12 * 0x28c1979 >> 0x3f));
                    }
                    iVar19 = STField<int>(param_1,0x1e9);
                    sVar18 = (short)(iVar19 >> 0x1f);
                    if (iVar19 < 0) {
                      iVar19 = (short)(((short)(iVar19 / 0xc9) + sVar18) -
                                      (short)((longlong)iVar19 * 0x28c1979 >> 0x3f)) + -1;
                    }
                    else {
                      iVar19 = (int)(short)(((short)(iVar19 / 0xc9) + sVar18) -
                                           (short)((longlong)iVar19 * 0x28c1979 >> 0x3f));
                    }
                    iVar12 = st::fn_006ACF90(local_98,local_40,iVar19,iVar12);
                    puVar1[2] = iVar12;
                    dVar13 = pSVar20->slot_2C();
                    if (dVar13 == 0x23) {
                      local_4c = local_4c + 1;
...
LAB_0060b48b:
                  ...
                  if (bVar22) {
                    ...
                    if ((iVar12 != 0) && (STField<int>(param_1,0x1f5) != 0x4c)) {
                      st::fn_00403FE4(param_1,&pSVar20->vtable);
                      goto LAB_0060b643;
                    }
                ...
                if (STField<int>(param_1,0x1f5) == 0x4c) {
                  ...
                  uVar16 = STField<int>(param_1,0x1c) * 0x41c64e6d + 0x3039;
                  STField<uint>(param_1,0x1c) = uVar16;
                  iVar12 = iVar12 + (uVar16 >> 0x10) % (iVar12 * 3 + 1U);
                  st::fn_004018C5(pSVar20,local_70,local_a0,local_34);
                  ...
                  if (g_visibleClass_00802A88 != nullptr) {
                    ...
                    if ((((DAT_0080874d == -1) || (g_visibleClass_00802A88->field_00F8 == 0)) ||
                      ...
                      if (((local_d4[0] < 0) || (pVVar8->field_0030 <= local_d4[0])) ||
                         ((local_d8 + g_centeredOffsets5[iVar19] < 0 ||
                          (pVVar8->field_0034 <= local_d8 + g_centeredOffsets5[iVar19])))) {
                        bVar22 = false;
                      }
                      else {
                        bVar22 = true;
                    ...
                    if (bVar22) {
                      dVar13 = pSVar20->slot_2C();
                      uVar16 = (uint)(*(int *)(&DAT_00791d68 + dVar13 * 4) == 1);
                      uVar15 = st::fn_004052CC((STT3DSprC *)&pSVar20->field_01D5);
                      st::fn_00405CDB(uVar15,uVar16,iVar12);
                    }
                  }
LAB_0060b643:
                  local_88 = local_88 + 1;
...
cf_continue_loop_0060B649:
  ...
  if (STField<int>(param_1,0x1f5) == 0x43) {
    ...
    if (0 < local_88) {
      do {
        pSVar20 = *(STFishC **)(local_74 + local_6c * 0xc);
        local_48 = 1;
        dVar13 = pSVar20->slot_2C();
        if (((dVar13 != 0x23) && (local_4c != 0)) && (iVar12 = 0, 0 < local_4c)) {
          do {
            this = *(void **)(local_ac + iVar12 * 0xc);
            if ((STField<int>(this,0x24) == pSVar20->field_0024) &&
               (STField<int>(this,0x72e) != 0)) {
              st::fn_004031E3(pSVar20,local_50,local_94,&local_20);
              st::fn_004031E3(this,local_60,(int *)local_9c,(int *)local_28);
              iVar19 = st::fn_006ACF0D((int)local_50[0],(int)(short)local_94[0],(int)(short)local_20,
        ...
        if ((local_48 != 0) && (*(int *)(local_74 + local_6c * 0xc + 8) != 0)) {
          st::fn_004018C5(pSVar20,local_50,(undefined2 *)local_94,(undefined2 *)&local_20);
          iVar12 = st::fn_006ACF90(local_7c,local_8c,(int)local_50[0],(int)(short)local_94[0]);
          uVar16 = STField<int>(param_1,0x1c) * 0x41c64e6d + 0x3039;
          STField<uint>(param_1,0x1c) = uVar16;
          iVar12 = iVar12 + (uVar16 >> 0x10) % (iVar12 * 3 + 1U);
          local_EAX_2593 = st::fn_004052CC((STT3DSprC *)&pSVar20->field_01D5);
          st::fn_0040123F(local_EAX_2593,iVar12);
          st::fn_00403FE4(param_1,&pSVar20->vtable);
          if (DAT_00811798 != nullptr) {
            pSVar20->slot_2C();
            st::fn_00401BBD(DAT_00811798,local_7c,local_8c,pSVar20->field_0024);
          }
          local_84 = local_84 + 1;
          if (9 < local_84) {
            ExceptionList = local_14;
...
#line 1 "decomp/ST.exe/functions/0060BC80/decomp.c"
...
#line 1 "decomp/ST.exe/functions/0060BCB0/decomp.c"
/* [STReturnSemanticsApplier] ignored_eax_void.
...
#line 1 "decomp/ST.exe/functions/0060BD30/decomp.c"
/* [STReturnSemanticsApplier] ignored_eax_void.
...
#line 1 "decomp/ST.exe/functions/0060BDD0/decomp.c"
...
#line 1 "decomp/ST.exe/functions/0060C020/decomp.c"
/* [STPrototypeApplier] Propagated return.
...
#line 1 "decomp/ST.exe/functions/0060C2D0/decomp.c"
...
#line 1 "decomp/ST.exe/functions/0060C320/decomp.c"
                ...
                if ((bVar19) &&
                  ...
                  *puVar1 = pSVar17;
                  ...
                  if (0 < iVar11) {
                    ...
                    iVar13 = st::fn_006ACF90(local_7c,local_40,iVar15,iVar13);
                    puVar1[2] = iVar13;
  ...
  if (local_2c != 0) {
    ...
    if (0 < local_74) {
      do {
        ...
        st::fn_004031E3(puVar1,local_54,(int *)local_80,(int *)local_28);
        ...
        if (bVar19) {
          st::fn_004044F8(param_1,puVar1,iVar13);
          STField<undefined4>(param_1,0x209) = 0;
        }
        else {
          st::fn_004044F8(param_1,puVar1,iVar13 * 5);
...
#line 1 "decomp/ST.exe/functions/0060CA20/decomp.c"
...
#line 1 "decomp/ST.exe/functions/0060CA40/decomp.c"
/* [STReturnSemanticsApplier] ignored_eax_void.
   Evidence: all observed direct callers ignore the return register (ignored=2, used=0), and
   decompilation contains no value return
...
#line 1 "decomp/ST.exe/functions/0060CB60/decomp.c"
...
#line 1 "decomp/ST.exe/functions/0060CBE0/decomp.c"
...
#line 1 "decomp/ST.exe/functions/0060CCF0/decomp.c"
...
#line 1 "decomp/ST.exe/functions/0060CEF0/decomp.c"
...
#line 1 "decomp/ST.exe/functions/0060D070/decomp.c"
...
#line 1 "decomp/ST.exe/functions/0060D220/decomp.c"
/* [STReturnSemanticsApplier] ignored_eax_void.
...
#line 1 "decomp/ST.exe/functions/0060D300/decomp.c"
/* [STReturnSemanticsApplier] ignored_eax_void.
   Evidence: all observed direct callers ignore the return register (ignored=2, used=0), and
   decompilation contains no value return */
...
#line 1 "decomp/ST.exe/functions/0060D340/decomp.c"
...
#line 1 "decomp/ST.exe/functions/0060D390/decomp.c"
...
#line 1 "decomp/ST.exe/functions/0060D810/decomp.c"
...
#line 1 "decomp/ST.exe/functions/0060D940/decomp.c"
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
...
#line 1 "decomp/ST.exe/functions/0060DAB0/decomp.c"
...
#line 1 "decomp/ST.exe/functions/0060DD70/decomp.c"
...
#line 1 "decomp/ST.exe/functions/0060E210/decomp.c"
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* [STPrototypeApplier] Propagated parameter 3.
...
#line 1 "decomp/ST.exe/functions/0060E470/decomp.c"
undefined4 __cdecl
...
#line 1 "decomp/ST.exe/functions/0060E680/decomp.c"
undefined4 __cdecl
...
#line 1 "decomp/ST.exe/functions/0060EA30/decomp.c"
...
#line 1 "decomp/ST.exe/functions/0060EC00/decomp.c"
/* [STPrototypeApplier] Propagated return.
...
#line 1 "decomp/ST.exe/functions/0060EC40/decomp.c"
/* [STUnclaimedCodeApplier] Exact function entry recovered from thunk_target.
...
#line 1 "decomp/ST.exe/functions/0060EC70/decomp.c"
...
#line 1 "decomp/ST.exe/functions/0060ECC0/decomp.c"
...
#line 1 "decomp/ST.exe/functions/0060ECE0/decomp.c"
/* [STReturnSemanticsApplier] ignored_eax_void.
   Evidence: all observed direct callers ignore the return register (ignored=2, used=0, unknown=0),
   and decompilation contains no value return */
...

{
  ...
  if (param_4 == 0) {
    ...
    iVar4 = st::fn_006ACF0D(param_8,param_9,param_10,param_11,param_12,param_13);
    if ((iVar6 != 0) && (iVar4 != 0)) {
      ...
      *param_15 = iVar4;
      ...
      iVar6 = st::fn_006ACF0D(param_3->field_000C,param_3->field_0010,param_3->field_0014,0,0,0);
      if (iVar6 != 0) {
        local_8 = 8;
  ...
  if (iVar8 < 0x1f5) {
    if (iVar8 == 500) {
      ...
      if (iVar8 == -0x14d) {
        ...
        iVar4 = st::fn_006ACF0D(param_3->field_000C,param_3->field_0010,iVar6,0,0,0);
      ...
      if (iVar7 == iVar5) {
        ...
        param_3->field_0014 = iVar6;
        iVar6 = st::fn_006ACF0D(param_3->field_000C,param_3->field_0010,iVar6,0,0,0);
        param_3->field_000C = (param_3->field_000C * 10000) / iVar6;
        param_3->field_0010 = (param_3->field_0010 * 10000) / iVar6;
        param_3->field_0014 = (param_3->field_0014 * 10000) / iVar6;
        return 6;
