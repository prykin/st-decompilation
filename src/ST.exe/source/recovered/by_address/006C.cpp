  ...
  *(undefined4 *)(&DAT_00855040 + iVar5) = param_10;
  ...
  if (iVar2 != 0) {
    ...
    if (piVar1 != nullptr) {
      ...
      piVar1 = static_cast<int *>((&PTR_00855008)[param_11 * 0x31]);
      if (piVar1 != nullptr) {
            ...
            if (((&DAT_00854ffc)[uVar2 * 0x31] & 0x8000) == 0) {
              ...
              if (local_14 < local_20) {
                ...
                iVar4 = (**(code **)(*(int *)(&PTR_00855004)[uVar2 * 0x31] + 0x2c))
                                  ((&PTR_00855004)[uVar2 * 0x31],local_20,
                ...
                if (iVar4 == 0) {
                  ...
                  for (uVar6 = local_1c >> 2; uVar6 != 0; uVar6 = uVar6 - 1) {
                    *pRVar11 = st::storage_bit_cast<RecoveredRecord_006BFE70_3123BCE8>(static_cast<uint32_t>(CONCAT22(CONCAT11(bVar3,bVar3),CONCAT11(bVar3,bVar3)) & 0x80808080));
                    pRVar11 = pRVar11 + 1;
                  }
              ...
              if (iVar4 == 0) {
                ...
                if (*(int *)(&DAT_008550b8 + iVar9) < 1) {
                  ...
                  *(undefined1 **)(&DAT_00855010 + iVar9) =
                       &local_24->field_0x0 + (int)&local_ESI_1151->field_0x0;
                  if ((uVar6 & 1) == 0) {
                    if ((local_ESI_1151 < local_ECX_632) &&
...
cf_common_join_006C0E05:
          ...
          for (; piVar1 != nullptr; piVar1 = (int *)*piVar1) {
            if ((piVar1[0xd] <= (int)local_c) && ((int)local_c <= piVar1[0xe])) {
              ...
              if ((uVar2 & 0x2000) == 0) {
                st::fn_006C0800((short *)piVar1[3],((byte *)piVar1)[4],uVar2,st::machine_word_boundary_cast<undefined4>(pRVar8),iVar9,piVar1[8],
                             piVar1[9],piVar1[10],piVar1[0xb],piVar1[0xc],local_c);
              }
              else {
                st::fn_006C2460((RecoveredRecord_006C2460_ADD01A02 *)piVar1[1],piVar1[2],
                             ((byte *)piVar1)[4],uVar2,st::machine_word_boundary_cast<undefined4>(pRVar8),iVar9,local_c);
              }
              if (local_18 != 0) {
    ...
    if ((-1 < param_1) && (param_1 < 0x20)) {
      if ((*(uint *)(&DAT_00854ff8 + param_1 * 0xc4) & 1) != 0) {
        *(uint *)(&DAT_00854ff8 + param_1 * 0xc4) =
        ...
        piVar1 = static_cast<int *>((&PTR_00855004)[param_1 * 0x31]);
        if (piVar1 != nullptr) {
          /* ST_CALLSITE[006C1C01]: CALL dword ptr [ECX + 0x48] */
          /* ST_PSEUDO[raw_indirect_call]: expected typed vtable or function-table callback call with the machine-proven calling convention */
          (**(code **)(*piVar1 + 0x48))(piVar1);
          piVar1 = static_cast<int *>((&PTR_00855008)[param_1 * 0x31]);
          if (piVar1 != nullptr) {
...

{
  ...
  if ((PTR_008568b4 != nullptr) && (st::machine_word_boundary_cast<uint>(g_hThread_008568C0) != st::machine_word_boundary_cast<uint>((HANDLE)0x0))) {
    ...
    if (DAT_008568c4 == 0) {
      ...
      do {
        if (((uint)ppvVar3[-3] & 1) != 0) {
          ...
          piVar1 = static_cast<int *>(*ppvVar3);
          if (piVar1 != nullptr) {
            /* ST_CALLSITE[006C1E84]: CALL dword ptr [ECX + 0x48] */
            /* ST_PSEUDO[raw_indirect_call]: expected typed vtable or function-table callback call with the machine-proven calling convention */
            (**(code **)(*piVar1 + 0x48))(piVar1);
            piVar1 = static_cast<int *>(ppvVar3[1]);
            if (piVar1 != nullptr) {
  ...
  if (PTR_008568b4 != nullptr) {
    ...
    do {
      if (((uint)ppvVar2[-4] & 1) != 0) {
        ...
        piVar1 = static_cast<int *>(ppvVar2[-1]);
        if (piVar1 != nullptr) {
          /* ST_CALLSITE[006C20C5]: CALL dword ptr [ECX + 0x48] */
          /* ST_PSEUDO[raw_indirect_call]: expected typed vtable or function-table callback call with the machine-proven calling convention */
          (**(code **)(*piVar1 + 0x48))(piVar1);
          piVar1 = static_cast<int *>(*ppvVar2);
          if (piVar1 != nullptr) {
...

{
  ...
  *(undefined4 *)(&DAT_0085502c + iVar3) = param_6;
  ...
  piVar1 = static_cast<int *>((&PTR_00855004)[param_7 * 0x31]);
  if (piVar1 != nullptr) {
...

{
  ...
  BVar1 = st::external_0000004F(hFile,&lpBuffer,4,(LPDWORD)&local_8,(LPOVERLAPPED)0x0);
  ...
  while (DVar3 == 0) {
    ...
    if (iVar4 == 0) {
      ...
      if (((int)param_1 < 1) || (3 < (int)param_1)) {
        ...
        st::fn_006C4110(st::storage_bit_cast<RecoveredSourceFamily_dvideo *>(WVar2));
...

{
  ...
  if (param_1 != nullptr) {
    ...
    pcVar2 = static_cast<char *>(st::fn_006AAC70(~uVar3));
    if (pcVar2 != nullptr) {
      uVar3 = 0xffffffff;
      do {
        pcVar5_mg0 = param_1;
...
void st::fn_006C6850(int param_1,int param_2,int param_3,int local_8,int param_5,undefined4 param_6)
...
HPALETTE st::fn_006C6A60(ushort *param_1)
...

{
  ...
  if (bVar1) {
    ...
    param_1->field_001E = reinterpret_cast<undefined4 *>(local_c);
    if (local_c == nullptr) {
      return 0xfffffffe;
    }
    if (0x380 < param_2) {
...
int st::fn_006C7D20(RecoveredRecord_FSGSTy_006C7D20 *param_1,int param_2,int *param_3)
...

{
  ...
  piVar3 = static_cast<int *>(st::fn_006AAC70(param_5 * 8));
  if (piVar3 == nullptr) {
    return nullptr;
  }
  *piVar3 = param_1;
