...
LAB_0070503b:
      ...
      if ((0 < iVar6) && (((uint)param_3 & 0x80) != 0)) {
        if (((uint)param_3 & 0x40) == 0) {
          if (0 < iVar7) {
            if (iVar7 == 1) {
              pbVar8 = pbVar8 + 1;
...

{
  ...
  if (((param_1 < STField<uint>(this,0x310)) &&
    ...
    st::fn_00709470(st::pointer_boundary_cast<ST3DSMAPContext *>(this),(int *)&stack0xffffffc4,puVar1[0x25],param_2,param_3,param_4);
  }
  ExceptionList = local_14;
  return;
}
...
#line 4 "decomp/ST.exe/functions/007098A0/decomp.c"
undefined4 __cdecl
...
#line 4 "decomp/ST.exe/functions/00709990/decomp.c"
...
#line 4 "decomp/ST.exe/functions/0070A460/decomp.c"
...
#line 4 "decomp/ST.exe/functions/0070AAB0/decomp.c"
/* [STPrototypeApplier] Propagated parameter 0.
...
#line 4 "decomp/ST.exe/functions/0070ABF0/decomp.c"
/* [STPrototypeApplier] Propagated parameter 0.
...
#line 4 "decomp/ST.exe/functions/0070AD40/decomp.c"
/* [STPrototypeApplier] Propagated parameter 0.
...
#line 4 "decomp/ST.exe/functions/0070B6D0/decomp.c"
...

{
  ...
  iVar1 = st::fn_0072E620((char *)local_104,st::pointer_boundary_cast<char *>(&DAT_007f00d0));
  if (iVar1 == 0) {
    return 0;
  }
  iVar1 = st::fn_0072E620((char *)local_104,st::pointer_boundary_cast<char *>(&DAT_007f00c8));
  if (iVar1 == 0) {
    return 2;
  }
  iVar1 = st::fn_0072E620((char *)local_104,st::pointer_boundary_cast<char *>(&DAT_007f00c0));
  if (iVar1 == 0) {
    return 1;
  }
  iVar1 = st::fn_0072E620((char *)local_104,st::pointer_boundary_cast<char *>(&DAT_007f00b8));
  return (-(uint)(iVar1 != 0) & 0xfffffffc) + 3;
}

// 0070B770 FUN_0070b770
#line 4 "decomp/ST.exe/functions/0070B770/decomp.c"
  ...
  if (sVar1 == 8) {
    if (param_2 != 8) {
      if (param_2 == 0x10) {
        ...
        iVar3 = st::fn_006D1A10(nullptr,0,0,0,param_1,0,0,0,param_1->field_0004,
                             param_1->field_0008);
        g_currentExceptionFrame = local_d4.previous;
        return iVar3;
      }
      ...
      local_EAX_212 = st::fn_0072D7F0(local_90.jumpBuffer,0);
      if (local_EAX_212 != 0) {
        g_currentExceptionFrame = local_90.previous;
        return local_8;
      }
      iVar3 = st::fn_006D1A50(nullptr,0,0,0,param_1,0,0,0,param_1->field_0004,
                           param_1->field_0008);
      g_currentExceptionFrame = local_90.previous;
      return iVar3;
    }
    ...
    if (sVar1 == 0x10) {
      ...
      if (param_2 == 0x10) {
        ...
        local_EAX_84 = st::fn_0072D7F0(local_4c.jumpBuffer,0);
        if (local_EAX_84 != 0) {
          g_currentExceptionFrame = local_4c.previous;
          return local_8;
        }
        iVar3 = st::fn_006D1A90(nullptr,0,0,0,param_1,0,0,0,param_1->field_0004,
                             param_1->field_0008);
        g_currentExceptionFrame = local_4c.previous;
        return iVar3;
      }
...
#line 4 "decomp/ST.exe/functions/0070C270/decomp.c"
...

{
  ...
  puVar2 = st::pointer_boundary_cast<undefined4 *>(st::fn_006AAC10(iVar5 * 4));
  if (puVar2 == nullptr) {
    return nullptr;
  }
  if (iVar5 != 0) {
...
#line 4 "decomp/ST.exe/functions/0070C390/decomp.c"
...

{
  ...
  puVar1 = st::pointer_boundary_cast<undefined4 *>(st::fn_006AAC10(iVar4 * 4));
  if (puVar1 == nullptr) {
    return nullptr;
  }
  if (iVar4 != 0) {
...

{
  ...
  if (0 < local_8) {
    /* ST_PSEUDO[stack_slot_reuse]: compiler reused a dead incoming argument slot; split the post-write lifetime into a local variable */
    param_3 = st::pointer_boundary_cast<int *>(&DAT_007f0150);
    /* ST_PSEUDO[stack_slot_reuse]: compiler reused a dead incoming argument slot; split the post-write lifetime into a local variable */
    param_8 = local_8;
    puVar7 = local_54 + 1;
    do {
